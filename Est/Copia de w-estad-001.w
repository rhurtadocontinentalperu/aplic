...
DEF TEMP-TABLE Detalle
    ...
    FIELD ListaBase AS CHAR LABEL 'Lista Base'  FORMAT 'x(6)'
...
RADIO-SET-Tipo DesdeF HastaF TOGGLE-NoVentas 
...
DEFINE FRAME fMain
     ...
     TOGGLE-CodDiv AT ROW 3.15 COL 5 WIDGET-ID 2
     COMBO-BOX-CodDiv AT ROW 3.15 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     TOGGLE-CodCli AT ROW 4.73 COL 5 WIDGET-ID 6
     FILL-IN-CodCli AT ROW 4.73 COL 23 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-NomCli AT ROW 4.73 COL 38 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     BUTTON-5 AT ROW 5.81 COL 102 WIDGET-ID 66
     FILL-IN-file AT ROW 5.85 COL 23 COLON-ALIGNED WIDGET-ID 68
     TOGGLE-Resumen-Depto AT ROW 6.88 COL 25 WIDGET-ID 64
     TOGGLE-CodMat AT ROW 8.23 COL 5 WIDGET-ID 14
     COMBO-BOX-CodFam AT ROW 8.23 COL 23 COLON-ALIGNED WIDGET-ID 36
     TOGGLE-Resumen-Linea AT ROW 8.23 COL 75 WIDGET-ID 92
     TOGGLE-Resumen-solo-linea AT ROW 9.04 COL 75 WIDGET-ID 90
     COMBO-BOX-SubFam AT ROW 9.31 COL 23 COLON-ALIGNED WIDGET-ID 38
     TOGGLE-Resumen-Marca AT ROW 9.85 COL 75 WIDGET-ID 94
     FILL-IN-CodMat AT ROW 10.65 COL 23 COLON-ALIGNED WIDGET-ID 70
     FILL-IN-DesMat AT ROW 10.65 COL 38.14 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     BUTTON-6 AT ROW 11.69 COL 102 WIDGET-ID 74
     FILL-IN-file-2 AT ROW 11.73 COL 23 COLON-ALIGNED WIDGET-ID 76
     FILL-IN-CodPro AT ROW 12.81 COL 23 COLON-ALIGNED WIDGET-ID 40
     FILL-IN-NomPro AT ROW 12.81 COL 38 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     TOGGLE-CodVen AT ROW 14.15 COL 5 WIDGET-ID 18
     FILL-IN-CodVen AT ROW 14.15 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     FILL-IN-NomVen AT ROW 14.15 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     RADIO-SET-Tipo AT ROW 15.77 COL 25 NO-LABEL WIDGET-ID 56
     DesdeF AT ROW 16.77 COL 23 COLON-ALIGNED WIDGET-ID 10
     HastaF AT ROW 16.77 COL 45 COLON-ALIGNED WIDGET-ID 12
     TOGGLE-NoVentas AT ROW 16.77 COL 73 WIDGET-ID 96
     RECT-1 AT ROW 2.62 COL 2 WIDGET-ID 78
     RECT-2 AT ROW 4.46 COL 2 WIDGET-ID 80
     RECT-3 AT ROW 7.96 COL 2 WIDGET-ID 82
     RECT-4 AT ROW 13.88 COL 2 WIDGET-ID 84
     RECT-5 AT ROW 15.5 COL 2 WIDGET-ID 86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 118.14 BY 18.85 WIDGET-ID 100.
...
/*     MESSAGE detalle.division SKIP */
/*         detalle.proxmesmn SKIP    */
/*         detalle.ctoxmesmn.        */
END.
...
FOR EACH VentasxProducto NO-LOCK WHERE VentasxProducto.DateKey >= DesdeF
    ...
    FIRST DimProducto OF VentasxProducto NO-LOCK WHERE DimProducto.codfam BEGINS x-CodFam
        AND DimProducto.CodPro[1] BEGINS x-CodPro
        AND DimProducto.subfam BEGINS x-SubFam,
