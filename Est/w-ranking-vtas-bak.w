...
lDivisiones = "00023,00027,00501,00502,00503,00504,00506,00024".    /* Utilex + institucionales */
...
&Scoped-Define ENABLED-OBJECTS ChkBx-General ChkBx-todos-menos-inst ~
Chkbx-Utilex-Inst optGrpCampana chk_saveranking pVenta pMargen pCreci ~
pFactor rb_cuales qValor_A qValor_B qValor_C qValor_D qValor_E dDesde ~
dHasta FamiliaNoConsideradas btnRecalcularQtyArt btnProcesar RECT-1 RECT-2 
&Scoped-Define DISPLAYED-OBJECTS ChkBx-General ChkBx-todos-menos-inst ~
Chkbx-Utilex-Inst optGrpCampana chk_saveranking txt-msg pVenta pMargen ~
pCreci pTotal pFactor rb_cuales qValor_A qValor_B qValor_C qValor_D ~
qValor_E qValor_F qTot_Arti dDesde dHasta FamiliaNoConsideradas 
...
DEFINE VARIABLE FamiliaNoConsideradas AS CHARACTER FORMAT "X(256)":U INITIAL "008,009,020,015,050,888,999" 
...
DEFINE FRAME fMain
     ChkBx-General AT ROW 18.69 COL 15 WIDGET-ID 54
     ChkBx-todos-menos-inst AT ROW 20.23 COL 15 WIDGET-ID 58
     Chkbx-Utilex-Inst AT ROW 19.46 COL 15 WIDGET-ID 56
     optGrpCampana AT ROW 18.69 COL 60 NO-LABEL WIDGET-ID 62
     chk_saveranking AT ROW 13.69 COL 40.57 WIDGET-ID 48
     txt-msg AT ROW 16.88 COL 2.86 NO-LABEL WIDGET-ID 42
     ...
     dDesde AT ROW 15.04 COL 11.43 COLON-ALIGNED WIDGET-ID 30
     dHasta AT ROW 15.04 COL 36 COLON-ALIGNED WIDGET-ID 32
     FamiliaNoConsideradas AT ROW 12.15 COL 2.28 WIDGET-ID 38
     btnRecalcularQtyArt AT ROW 10.69 COL 49.29 WIDGET-ID 36
     btnProcesar AT ROW 15.04 COL 62 WIDGET-ID 34
...
DO:   
    ...
    */
    ...
    xQTotArt = 0.  /* Cantidad de Articulos Normales */
...
------------------------------------------------------------------------------*/
  DISPLAY ChkBx-General ChkBx-todos-menos-inst Chkbx-Utilex-Inst optGrpCampana 
          chk_saveranking txt-msg pVenta pMargen pCreci pTotal pFactor rb_cuales 
          qValor_A qValor_B qValor_C qValor_D qValor_E qValor_F qTot_Arti dDesde 
          dHasta FamiliaNoConsideradas 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE ChkBx-General ChkBx-todos-menos-inst Chkbx-Utilex-Inst optGrpCampana 
         chk_saveranking pVenta pMargen pCreci pFactor rb_cuales qValor_A 
         qValor_B qValor_C qValor_D qValor_E dDesde dHasta 
         FamiliaNoConsideradas btnRecalcularQtyArt btnProcesar RECT-1 RECT-2 
      WITH FRAME fMain IN WINDOW wWin.
...
IF p-especial = NO THEN DO:
    X-archivo = "c:\ciman\data-paretro-standard.txt".
END.
ELSE DO:
    X-archivo = "c:\ciman\data-paretro-especial.txt".
END.
...
IF rb_cuales = 1 THEN lDivisiones = "*AAA*,*BBB*".      /* Todos */
