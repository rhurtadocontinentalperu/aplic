...
FOR EACH dwh_ventas_cli NO-LOCK WHERE dwh_ventas_cli.codcia = s-codcia
    ...
    END.
     ...
     ASSIGN
         ...
         Detalle.VtaxMesMe = Detalle.VtaxMesMe + dwh_ventas_cli.ImpExtCIGV
         Detalle.VtaxMesMn = Detalle.VtaxMesMn + dwh_ventas_cli.ImpNacCIGV
         Detalle.CtoxMesMe = Detalle.CtoxMesMe + dwh_ventas_cli.CostoExtCIGV
         Detalle.CtoxMesMn = Detalle.CtoxMesMn + dwh_ventas_cli.CostoNacCIGV
         Detalle.ProxMesMe = Detalle.ProxMesMe + dwh_ventas_cli.PromExtCIGV
         Detalle.ProxMesMn = Detalle.ProxMesMn + dwh_ventas_cli.PromNacCIGV.
END.
