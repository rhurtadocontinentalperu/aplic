...
FOR EACH dwh_ventas_cli NO-LOCK WHERE dwh_ventas_cli.codcia = s-codcia
    AND dwh_ventas_cli.fecha >= INTEGER(STRING(YEAR(DesdeF),"9999") + STRING(MONTH(DesdeF),"99") + STRING(DAY(DesdeF), "99"))
    AND dwh_ventas_cli.fecha <= INTEGER(STRING(YEAR(HastaF),"9999") + STRING(MONTH(HastaF),"99") + STRING(DAY(HastaF), "99"))
    ...
    END.
     ...
     END.
     ASSIGN
         tmp-detalle.VtaxMesMe = tmp-detalle.VtaxMesMe + dwh_ventas_cli.ImpExtCIGV
         tmp-detalle.VtaxMesMn = tmp-detalle.VtaxMesMn + dwh_ventas_cli.ImpNacCIGV
         tmp-detalle.CtoxMesMe = tmp-detalle.CtoxMesMe + dwh_ventas_cli.CostoExtCIGV
         tmp-detalle.CtoxMesMn = tmp-detalle.CtoxMesMn + dwh_ventas_cli.CostoNacCIGV
         tmp-detalle.ProxMesMe = tmp-detalle.ProxMesMe + dwh_Ventas_cli.PromExtCIGV
         tmp-detalle.ProxMesMn = tmp-detalle.ProxMesMn + dwh_Ventas_cli.PromNacCIGV.
END.
