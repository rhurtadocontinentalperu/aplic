...
/*     FIRST DimCliente OF VentasxCliente NO-LOCK, */
    ...
    IF TOGGLE-CodDiv = YES THEN DO:
        ...
        ASSIGN
            cListaBase = VentasxCliente.ListaBase
            x-Llave = x-LLave + VentasxCliente.ListaBase + '|'.
        FIND FIRST DimDivision WHERE DimDivision.coddiv = VentasxCliente.ListaBase NO-LOCK NO-ERROR.
        IF AVAILABLE DimDivision THEN cListaBase  = VentasxCliente.ListaBase + ' ' + DimDivision.DesDiv.
    ...
    IF TOGGLE-CodCli = YES THEN DO:
        ASSIGN
            ...
            x-ClfCli = ""
            x-Zona = "".
        FIND FIRST DimCliente OF VentasxCliente NO-LOCK NO-ERROR.
        ...
        IF TOGGLE-Resumen-Depto = NO THEN DO:
             ...
             ASSIGN
                 cCliente = VentasxCliente.codcli + ' ' + (IF AVAILABLE DimCliente THEN DimCliente.NomCli ELSE "")
                 cTarjeta = "".
            IF AVAILABLE DimCliente THEN DO:
    ...
    ASSIGN
        Detalle.ProxMesMe2 = Detalle.ProxMesMe2 + VentasxCliente.PromExtSIGV
        Detalle.ProxMesMn2 = Detalle.ProxMesMn2 + VentasxCliente.PromNacSIGV.
END.
