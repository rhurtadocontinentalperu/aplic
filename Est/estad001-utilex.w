...
DO:
   ...
   IF ComBo-Box-CodDiv = '' THEN DO:
       MESSAGE "Debe Seleccionar una división para generar el reporte"
...
------------------------------------------------------------------------------*/
  ...
  /*IF s-user-id BEGINS 'GWK'   THEN cCodDiv = '00023'.*/
  IF s-user-id BEGINS 'LPA'   THEN cCodDiv = '00023,00024,00026,00501'.
  ELSE cCodDiv = s-coddiv.
  
  FOR EACH dwh_Division NO-LOCK WHERE dwh_Division.codcia = s-codcia
      AND LOOKUP(dwh_Division.CodDiv,cCodDiv) > 0:
