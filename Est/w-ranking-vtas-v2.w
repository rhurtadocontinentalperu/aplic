...
&SCOPED-DEFINE CostoNacCIGV VentasxProducto.PromNacCIGV
&SCOPED-DEFINE CostoExtCIGV VentasxProducto.PromExtCIGV
   ...
   */ 
        ...
        IF p-especial = NO THEN DO:
            ...
            IF p-Llave = 'ACTUAL' THEN DO:
                ...
                Detalle.CtoxMesMn_act = Detalle.CtoxMesMn_act + {&CostoNacCIGV}.
            END.
            ELSE DO:
                Detalle.VtaxMesMn_ant = Detalle.VtaxMesMn_ant + VentasxProducto.ImpNacCIGV.
                Detalle.CtoxMesMn_ant = Detalle.CtoxMesMn_ant + {&CostoNacCIGV}.
            END.
            /* Lo elimino */
            ...
            IF NOT AVAILABLE detalle THEN DO:        
                ...
                IF AVAILABLE art-esp THEN DO:
                    ...
                    IF p-Llave = 'ACTUAL' THEN DO:
                        ...
                        Detalle-esp.CtoxMesMn_act = Detalle-esp.CtoxMesMn_act + {&CostoNacCIGV}.
                    END.
                    ELSE DO:
                        Detalle-esp.VtaxMesMn_ant = Detalle-esp.VtaxMesMn_ant + VentasxProducto.ImpNacCIGV.
                        Detalle-esp.CtoxMesMn_ant = Detalle-esp.CtoxMesMn_ant + {&CostoNacCIGV}.
                    END.
