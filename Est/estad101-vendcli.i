...
FOR EACH dwh_ventas_vendcli NO-LOCK WHERE dwh_ventas_vendcli.codcia = s-codcia
    ...
    END.
     ...
     ASSIGN
         ...
         /*Detalle.CanxMes   = Detalle.CanxMes   + dwh_ventas_vendcli.Cantidad*/
         Detalle.VtaxMesMe = Detalle.VtaxMesMe + dwh_ventas_vendcli.ImpExtCIGV
         Detalle.VtaxMesMn = Detalle.VtaxMesMn + dwh_ventas_vendcli.ImpNacCIGV
         Detalle.CtoxMesMe = Detalle.CtoxMesMe + dwh_ventas_vendcli.CostoExtCIGV
         Detalle.CtoxMesMn = Detalle.CtoxMesMn + dwh_ventas_vendcli.CostoNacCIGV
         Detalle.ProxMesMe = Detalle.ProxMesMe + dwh_ventas_vendcli.PromExtCIGV
         Detalle.ProxMesMn = Detalle.ProxMesMn + dwh_ventas_vendcli.PromNacCIGV.
END.
