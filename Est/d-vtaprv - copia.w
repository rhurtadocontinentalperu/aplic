...
DEFINE VARIABLE F-Almacen AS CHARACTER FORMAT "X(15)":U 
     LABEL "Stock Almacén" 
     VIEW-AS FILL-IN 
...
FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = S-CODCIA
        ...
        AND (Almmmatg.CodPr1 BEGINS F-prov1 OR Almmmatg.CodPr2 BEGINS F-prov1)
        AND Almmmatg.Codmar BEGINS F-Marca
        USE-INDEX matg09:
    DO x-Item = 1 TO NUM-ENTRIES(x-CodDiv):
        ...
        FOR EACH dwh_ventas_mat NO-LOCK WHERE dwh_ventas_mat.CodCia = S-CODCIA
            ...
            AND dwh_ventas_mat.Codmat = Almmmatg.codmat
