...
Almmmatg.DesMat VtaDDocu.UndVta VtaDDocu.CanPed VtaDDocu.ImpLin 
...
<SORTBY-OPTIONS>
NroItm|y||INTEGRAL.VtaDDocu.NroItm|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'NroItm' + '",
     SortBy-Case = ':U + 'NroItm').
...
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[6]   = INTEGRAL.VtaDDocu.ImpLin
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'NroItm':U THEN DO:
      &Scope SORTBY-PHRASE BY VtaDDocu.NroItm
