...
&Scoped-define DATA-FIELD-DEFS "aplic/nxtl/dcdocu.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table NroPed CodVen CodCli NomCli FmaPgo ~
ImpTot FchPed 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      NroPed FORMAT "X(9)":U
      CodVen FORMAT "X(3)":U
      CodCli FORMAT "x(11)":U
      NomCli FORMAT "x(60)":U
      FmaPgo FORMAT "X(8)":U
      ImpTot FORMAT "->>>,>>>,>>9.99":U
      FchPed FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.NroPed
     _FldNameList[2]   = _<SDO>.rowObject.CodVen
     _FldNameList[3]   = _<SDO>.rowObject.CodCli
     _FldNameList[4]   = _<SDO>.rowObject.NomCli
     _FldNameList[5]   = _<SDO>.rowObject.FmaPgo
     _FldNameList[6]   = _<SDO>.rowObject.ImpTot
     _FldNameList[7]   = _<SDO>.rowObject.FchPed
