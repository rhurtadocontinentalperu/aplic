...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 125 BY 8
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 9.08 COL 16 COLON-ALIGNED
     F-TotBrt AT ROW 10.42 COL 18 NO-LABEL
     F-ImpExo AT ROW 10.42 COL 30 NO-LABEL
     F-ValVta AT ROW 10.42 COL 52.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 10.42 COL 64.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 10.42 COL 77.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 10.42 COL 90 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 10.46 COL 40 COLON-ALIGNED NO-LABEL
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.88 COL 42.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.88 COL 55.86
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 9.85 COL 82.14
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 9.85 COL 92.14
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.85 COL 20
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.85 COL 30.57
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 9.85 COL 70.57
...
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol. o Prom." ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
