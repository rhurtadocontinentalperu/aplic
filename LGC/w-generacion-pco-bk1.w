...
&SCOPED-DEFINE CONDICION ( ~
            ...
            lookup(faccpedi.coddiv,x-lista-precios) > 0 and ~
...
FacCPedi.NomCli FacCPedi.FchPed FacCPedi.FchEnt FacCPedi.CodDiv ~
FacCPedi.Libre_c01 
...
&Scoped-Define ENABLED-OBJECTS BROWSE-4 txtDesde FILL-IN-contenga BUTTON-1 ~
BROWSE-5 BUTTON-2 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-peso txtDesde txtHasta ~
FILL-IN-contenga txtUltFechaTope FILL-IN-importe 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-4 W-Win _STRUCTURED
  QUERY BROWSE-4 NO-LOCK DISPLAY
      ...
      FacCPedi.Libre_c01 COLUMN-LABEL "Lista" FORMAT "x(6)":U WIDTH 15.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 112 BY 10.46 ROW-HEIGHT-CHARS .62 FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-5 W-Win _STRUCTURED
  QUERY BROWSE-5 NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 38.43 COLUMN-FONT 0
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 96.86 BY 11.15 FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-peso AT ROW 20.69 COL 98 COLON-ALIGNED NO-LABEL WIDGET-ID 108
     ...
     txtUltFechaTope AT ROW 1.38 COL 96.57 COLON-ALIGNED WIDGET-ID 98
     BUTTON-1 AT ROW 1.19 COL 61 WIDGET-ID 100
     BROWSE-5 AT ROW 15 COL 2.14 WIDGET-ID 300
     FILL-IN-importe AT ROW 22.65 COL 98 COLON-ALIGNED NO-LABEL WIDGET-ID 110
     BUTTON-2 AT ROW 15.23 COL 101 WIDGET-ID 116
     ...
     "Que contengan" VIEW-AS TEXT
          ...
          FGCOLOR 9 FONT 6
     "Peso" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 20.04 COL 100.29 WIDGET-ID 112
          FGCOLOR 4 
     "Importe" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 22 COL 100.29 WIDGET-ID 114
          FGCOLOR 4 
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 116 BY 25.38 WIDGET-ID 100.
...
"FacCPedi.NomCli" "Nombre del Cliente" ? "character" ? ? 4 ? ? ? no ? no no "39.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.FchEnt" "Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = INTEGRAL.FacCPedi.CodDiv
     _FldNameList[7]   > INTEGRAL.FacCPedi.Libre_c01
"FacCPedi.Libre_c01" "Lista" "x(6)" "character" ? ? ? ? ? ? no ? no no "15.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-4 */
&ANALYZE-RESUME
...
"Almmmatg.DesMat" ? ? "character" ? ? 0 ? ? ? no ? no no "38.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.FacDPedi.UndVta
     _FldNameList[4]   = INTEGRAL.FacDPedi.CanPed
     _FldNameList[5]   > INTEGRAL.FacDPedi.canate
"FacDPedi.canate" "Atendido" ? "decimal" ? ? ? ? ? ? no ? no no "12.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"(facdpedi.canped - facdpedi.canate) @ x-por-atender" "x Atender" "->>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no "13.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-5 */
&ANALYZE-RESUME
...
DO:
  ...
  IF AVAILABLE faccpedi THEN DO:
      RUN lgc/w-generacion-pco-grabar.r(INPUT faccpedi.coddoc, faccpedi.nroped,txtUltFechaTope).      
  END.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-peso txtDesde txtHasta FILL-IN-contenga txtUltFechaTope 
          FILL-IN-importe 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE BROWSE-4 txtDesde FILL-IN-contenga BUTTON-1 BROWSE-5 BUTTON-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE vtatabla THEN DO:
      ...
      txtUltFechaTope:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(vtatabla.rango_fecha[2] + 1,"99/99/9999").
