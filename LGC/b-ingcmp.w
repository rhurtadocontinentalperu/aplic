...
&Scoped-define FIELDS-IN-QUERY-br_table Almcmov.FchDoc Almcmov.NroDoc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Almcmov WHERE Almcmov.CodCia = LG-COCmp.CodCia ~
  AND Almcmov.CodAlm = LG-COCmp.CodAlm ~
  AND INTEGER(INTEGRAL.Almcmov.NroRf1) = LG-COCmp.NroDoc ~
      AND Almcmov.TipMov = "I" ~
 AND (INTEGRAL.Almcmov.CodMov = 2 ~
  OR Almcmov.CodMov = 6) NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almcmov WHERE Almcmov.CodCia = LG-COCmp.CodCia ~
  AND Almcmov.CodAlm = LG-COCmp.CodAlm ~
  AND INTEGER(INTEGRAL.Almcmov.NroRf1) = LG-COCmp.NroDoc ~
      AND Almcmov.TipMov = "I" ~
 AND (INTEGRAL.Almcmov.CodMov = 2 ~
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Almcmov WHERE INTEGRAL.LG-COCmp <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.Almcmov.CodCia = INTEGRAL.LG-COCmp.CodCia
  AND INTEGRAL.Almcmov.CodAlm = INTEGRAL.LG-COCmp.CodAlm
  AND INTEGER(INTEGRAL.Almcmov.NroRf1) = INTEGRAL.LG-COCmp.NroDoc"
     _Where[1]         = "INTEGRAL.Almcmov.TipMov = ""I""
 AND (INTEGRAL.Almcmov.CodMov = 2
  OR INTEGRAL.Almcmov.CodMov = 6)"
