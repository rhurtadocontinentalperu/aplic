...
/*DEF VAR s-flgsit AS CHAR INIT 'P' NO-UNDO.*/
...
LG-COCmp.FchVto LG-COCmp.NomPro fMoneda(lg-cocmp.Codmon) @ s-CodMon ~
LG-COCmp.ImpTot 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LG-COCmp WHERE ~{&KEY-PHRASE} ~
 ...
 AND LG-COCmp.FlgSit = s-flgsit NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LG-COCmp.Fchdoc COLUMN-LABEL "<Emision>" FORMAT "99/99/99"
      LG-COCmp.FchVto COLUMN-LABEL "Vencimiento" FORMAT "99/99/99"
      LG-COCmp.NomPro COLUMN-LABEL "Nombre" FORMAT "X(50)"
      fMoneda(lg-cocmp.Codmon) @ s-CodMon COLUMN-LABEL "Mon" FORMAT "x(3)"
      LG-COCmp.ImpTot FORMAT "->>>,>>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  MESSAGE 'Procedemos a CERRAR LA ORDEN' STRING(lg-cocmp.nrodoc, '999999') '?'
  ...
  ASSIGN
    Lg-cocmp.flgsit = 'C'
    LG-COCmp.FchAte = today.
/*    Lg-cocmp.usract = s-user-id
 *     Lg-cocmp.fchact = today.*/
