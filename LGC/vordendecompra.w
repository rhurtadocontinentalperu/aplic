...
------------------------------------------------------------------------------*/
  ...
  MESSAGE 'Opcion Denegado' VIEW-AS ALERT-BOX WARNING.
  RETURN "ADM-ERROR".
...
------------------------------------------------------------------------------*/
  ...
  /* RHC 20/08/2015 Bloqueamos el correlativo sí o sí */
  {lib/lock-genericov2.i &Tabla="Lg-Corr" ~
      &Condicion="LG-CORR.CodCia = S-CODCIA ~
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      REPEAT:
          IF NOT CAN-FIND(FIRST LG-COCmp WHERE LG-COCmp.CodCia = S-CODCIA
...
*/
  ...
  IF INPUT LG-COCmp.FchEnt < INPUT LG-COCmp.Fchdoc 
      OR INPUT LG-COCmp.FchVto < INPUT LG-COCmp.Fchdoc THEN DO:
  ...
  FIND FIRST DCMP WHERE DCMP.CanPedi <= 0 OR DCMP.ImpTot <= 0
      NO-LOCK NO-ERROR.
