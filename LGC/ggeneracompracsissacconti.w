...
DEFINE FRAME gDialog
     FILL-IN-CodAlm AT ROW 1.19 COL 16 COLON-ALIGNED WIDGET-ID 4
     COMBO-BOX-NroSerCot AT ROW 2.15 COL 16 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-NroCot AT ROW 2.15 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     COMBO-BOX-NroSerPed AT ROW 3.12 COL 16 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-NroPed AT ROW 3.12 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     COMBO-BOX-NroSerOD AT ROW 4.08 COL 16 COLON-ALIGNED WIDGET-ID 24
     FILL-IN-NroOD AT ROW 4.08 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     COMBO-BOX-NroSerGR AT ROW 5.04 COL 16 COLON-ALIGNED WIDGET-ID 16
     FILL-IN-NroGR AT ROW 5.04 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     COMBO-BOX-NroSerFac AT ROW 6 COL 16 COLON-ALIGNED WIDGET-ID 20
     FILL-IN-NroFac AT ROW 6 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     Btn_OK AT ROW 9.46 COL 7
     Btn_Cancel AT ROW 9.46 COL 22
     SPACE(28.13) SKIP(1.67)
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-CodAlm COMBO-BOX-NroSerCot FILL-IN-NroCot COMBO-BOX-NroSerPed 
          ...
          FILL-IN-NroGR COMBO-BOX-NroSerFac FILL-IN-NroFac 
      WITH FRAME gDialog.
...
DO TRANSACTION ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    FOR EACH integral.Lg-docmp OF integral.Lg-cocmp, 
        ...
        ASSIGN 
            ...
            cissac.FacDPedi.ImpLin = ROUND( (integral.Lg-docmp.CanAte * integral.Lg-docmp.PreUni) * 
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    FIND integral.Lg-comp WHERE ROWID(integral.Lg-cocmp) = pRowid EXCLUSIVE-LOCK NO-ERROR.
    IF ERROR-STATUS:ERROR THEN DO:

    END.
    ASSIGN
        integral.Lg-cocmp.flgsit = "P".
    FIND cissac.gn-clie WHERE cissac.gn-clie.CodCia = cl-codcia 
