...
DO:
    ...
    DEF VAR pDsctos AS DEC EXTENT 3.
    DEF VAR pIgvMat AS DEC.
    DEF VAR pPreUni AS DEC.
    DEF VAR pOk AS LOG.
    RUN lgc/preciodecompra (s-Provee,
                            SELF:SCREEN-VALUE,
                            s-CodMon,
                            s-TpoCmb,
                            s-Contrato-Marco,
    ...
    DISPLAY 
        pDsctos[1] @ DCMP.Dsctos[1]
        pDsctos[2] @ DCMP.Dsctos[2]
        pDsctos[3] @ DCMP.Dsctos[3]
        pIgvMat    @ DCMP.IgvMat 
        pPreUni @ DCMP.PreUni
        WITH BROWSE {&BROWSE-NAME}.
