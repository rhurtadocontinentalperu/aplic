...
&Scoped-define FIELDS-IN-QUERY-br_table ITEM.codmat Almmmatg.DesMat ITEM.CodUnd ITEM.CanDes ITEM.CanDev ITEM.StkSub ITEM.PreUni ITEM.ImpCto   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table ITEM.StkSub   
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table~
 ~{&FP1}StkSub ~{&FP2}StkSub ~{&FP3}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.CanDes FORMAT ">,>>>,>>9.99" COLUMN-LABEL "Cantidad!Ing."
      ITEM.CanDev FORMAT ">,>>>,>>9.99" COLUMN-LABEL "Cantidad!Dev-Liq"
      ITEM.StkSub FORMAT ">,>>>,>>9.99" COLUMN-LABEL "Cantidad!A Liquidar"
      ITEM.PreUni FORMAT ">,>>>,>>9.9999" COLUMN-LABEL "Precio"
      ITEM.ImpCto FORMAT ">,>>>,>>9.99" COLUMN-LABEL "Total"
  ENABLE
      ITEM.StkSub
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 77 BY 9.08
         FONT 4.
...
ON "RETURN":U OF ITEM.StkSub
DO:
   APPLY "TAB":U.
   RETURN NO-APPLY.
END.

ON "LEAVE":U OF ITEM.StkSub
DO:
   ...
   IF Almtconv.CodUnid = "Und" AND Almtconv.Equival = 1 THEN DO:
      IF DECIMAL(ITEM.StkSub:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) <> INT(ITEM.StkSub:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) THEN DO:
