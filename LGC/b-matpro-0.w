...
"LG-dmatpr.CodMon" "M" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"LG-dmatpr.IgvMat" ? ">9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"LG-dmatpr.Dsctos[3]" "%Dscto!3" "->>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"LG-dmatpr.ArtPro" ? "X(13)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* QUE PASA SI HAY UN MARGEN NEGATIVO? 
  IF Almmmatg.MrgUti < 0 OR Almmmatg.MrgUti-A < 0
      OR Almmmatg.MrgUti-B < 0 OR Almmmatg.MrgUti-C < 0
      OR Almmmatg.DEC__01 < 0 THEN DO:
      CREATE T-MATG.
      BUFFER-COPY Almmmatg TO T-MATG.
  END.*/
                                         
  /* QUE PASA SI HAY UN MARGEN NEGATIVO? y EL COSTO DIFERENTE A CERO */  
  IF Almmmatg.CtoLis > 0 AND
      (Almmmatg.MrgUti < 0 OR Almmmatg.MrgUti-A < 0
        OR Almmmatg.MrgUti-B < 0 OR Almmmatg.MrgUti-C < 0
        OR Almmmatg.DEC__01 < 0) THEN DO:
      CREATE T-MATG.
      BUFFER-COPY Almmmatg TO T-MATG.
...
x-Llave = x-Llave + "Neto sin IGV" + CHR(9).
x-Llave = x-Llave + "".
