...
&Scoped-define QUERY-STRING-Query-Main FOR EACH LG-COCmp WHERE ~{&KEY-PHRASE} ~
      AND LG-COCmp.CodCia = S-CODCIA ~
 AND LG-COCmp.TpoDoc = S-TPODOC ~
 AND LG-COCmp.CodDiv = S-CODDIV ~
 AND LG-COCmp.codpro = s-provee NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LG-COCmp WHERE ~{&KEY-PHRASE} ~
      AND LG-COCmp.CodCia = S-CODCIA ~
 AND LG-COCmp.TpoDoc = S-TPODOC ~
 AND LG-COCmp.CodDiv = S-CODDIV ~
 AND LG-COCmp.codpro = s-provee NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main LG-COCmp
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main LG-COCmp
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND integral.LG-COCmp.codpro = s-provee"
     _Design-Parent    is WINDOW q-tables @ ( 1 , 10.57 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
