...
LG-DOCmp.CanPedi LG-DOCmp.CanAten LG-DOCmp.UndCmp 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LG-DOCmp.CanPedi COLUMN-LABEL "Pedido"
      LG-DOCmp.CanAten COLUMN-LABEL "Atendido"
...
"LG-DOCmp.CanPedi" "Pedido" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[4]   > INTEGRAL.LG-DOCmp.CanAten
"LG-DOCmp.CanAten" "Atendido" ? "decimal" ? ? ? ? ? ? no ?
