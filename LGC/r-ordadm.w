...
DEFINE VAR s-CodDoc AS CHAR INIT 'OCA'.
...
DEFINE FRAME F-Main
     fechaD AT ROW 1.58 COL 11 COLON-ALIGNED
     fechaH AT ROW 1.58 COL 28 COLON-ALIGNED
     x-proveedor AT ROW 2.54 COL 11 COLON-ALIGNED
     x-nompro AT ROW 2.54 COL 24 COLON-ALIGNED NO-LABEL
     x-CodCco AT ROW 3.5 COL 11 COLON-ALIGNED
     x-NomCco AT ROW 3.5 COL 19 COLON-ALIGNED NO-LABEL
     x-CodSer AT ROW 4.46 COL 11 COLON-ALIGNED
     x-NomSer AT ROW 4.46 COL 24 COLON-ALIGNED NO-LABEL
     x-Userid-com AT ROW 5.42 COL 11 COLON-ALIGNED WIDGET-ID 6
     TOGGLE-1 AT ROW 6.38 COL 13
     Btn_OK AT ROW 7.35 COL 6
     Btn_OK-2 AT ROW 7.35 COL 19 WIDGET-ID 2
     Btn_Cancel AT ROW 7.35 COL 32
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REPORTE DE COMPRAS ADMINISTRATIVAS"
         HEIGHT             = 8.08
         WIDTH              = 70
         MAX-HEIGHT         = 9.23
         MAX-WIDTH          = 70
...
ON END-ERROR OF W-Win /* REPORTE DE COMPRAS ADMINISTRATIVAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REPORTE DE COMPRAS ADMINISTRATIVAS */
DO:
...
cRange = "D" + cColumn.                                                                                                                                
chWorkSheet:Range(cRange):Value = "RELACIONES DE COMPRAS ADMINISTRATIVAS DESDE " + STRING(fechaD,"99/99/9999") + " HASTA " + STRING(FechaH,"99/99/9999").
t-column = t-column + 1. 
cColumn = STRING(t-Column).
cRange = "A" + cColumn.                                                                                                                                
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-Cab
    ...
    lg-coser.nroref COLUMN-LABEL "Referencia"       FORMAT "x(40)"
  ...
  DEFINE FRAM F-Header
    HEADER
        ...
        "REPORTE DE COMPRAS ADMINISTRATIVAS" AT 50
