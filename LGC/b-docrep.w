...
Almmmatg.DesMar DCMP.UndCmp DCMP.CanPedi DCMP.PreUni DCMP.ImpTot ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DCMP.CanPedi FORMAT "ZZ,ZZ9.99"
      DCMP.PreUni
      DCMP.ImpTot FORMAT ">>>,>>9.99"
      DCMP.Dsctos[1] COLUMN-LABEL "Dsct1!%"
      DCMP.Dsctos[2] COLUMN-LABEL "Dsct2!%"
      DCMP.Dsctos[3] COLUMN-LABEL "Dsct3!%"
      DCMP.IgvMat
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 102 BY 6.69
         FONT 4.
...
"DCMP.UndCmp" "Und.!Cmp." ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > Temp-Tables.DCMP.CanPedi
"DCMP.CanPedi" ? "ZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[6]   = Temp-Tables.DCMP.PreUni
     _FldNameList[7]   > Temp-Tables.DCMP.ImpTot
"DCMP.ImpTot" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[8]   > Temp-Tables.DCMP.Dsctos[1]
"DCMP.Dsctos[1]" "Dsct1!%" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[9]   > Temp-Tables.DCMP.Dsctos[2]
"DCMP.Dsctos[2]" "Dsct2!%" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[10]   > Temp-Tables.DCMP.Dsctos[3]
"DCMP.Dsctos[3]" "Dsct3!%" ? "decimal" ? ? ? ? ? ? no ?
