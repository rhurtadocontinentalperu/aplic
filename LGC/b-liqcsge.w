...
&Scoped-define FIELDS-IN-QUERY-br_table EvtArti.CodDiv EvtArti.Codano ~
EvtArti.Codmes 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      EvtArti.CodDiv COLUMN-LABEL "Division"
      EvtArti.Codano
      EvtArti.Codmes
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 18.43 BY 2.6
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
 ...
 AND REPORTE.EvtArti.Nrofch >= X-NROFCH"
     _FldNameList[1]   > REPORTE.EvtArti.CodDiv
"REPORTE.EvtArti.CodDiv" "Division" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   = REPORTE.EvtArti.Codano
     _FldNameList[3]   = REPORTE.EvtArti.Codmes
