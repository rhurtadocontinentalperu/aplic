...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH lg-liqcsg WHERE ~{&KEY-PHRASE} ~
      AND lg-liqcsg.NroSer = S-NROSER NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS C-NroSer RECT-2 F-Numero BUTTON-1 
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "INTEGRAL.lg-liqcsg.NroSer = S-NROSER"
