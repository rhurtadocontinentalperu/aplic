...
&Scoped-define INTERNAL-TABLES LG-CFGCOM

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LG-CFGCOM WHERE ~{&KEY-PHRASE} ~
      AND LG-CFGCOM.Codcia = S-CODCIA NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main LG-CFGCOM
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main LG-CFGCOM
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.LG-CFGCOM"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.LG-CFGCOM.Codcia = S-CODCIA"
     _Design-Parent    is WINDOW q-tables @ ( 1.15 , 5.72 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
