...
Alm03b Alm04 txtDivisiones txtListaPrecio chbDetalleCot ~
...
/* SETTINGS FOR FILL-IN Alm04b IN FRAME fMain
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX ChbxGrabaCot IN FRAME fMain
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 txtDesde txtFechaTope txtAlmOtros BROWSE-2 Alm01 Tonelaje01 
         ...
         txtDivisiones txtListaPrecio chbDetalleCot TOGGLE-Bonificaciones 
         btnProcesar rdBtnCual 
      WITH FRAME fMain IN WINDOW wWin.
...
FOR EACH faccpedi WHERE faccpedi.codcia = s-codcia AND 
    ...
    /*
    (P) : PENDIENTE PEDIDO LOGISTICO
    (C) : ATENDIDO TOTAL
    (E) : POR APROBAR POR SUPERVISOR
    (PA) : POR APROBAR POR ADMINISTRADOR
    */

    /* IF LOOKUP(Faccpedi.FlgEst, 'P,C,E') = 0 THEN NEXT.*/
    IF LOOKUP(Faccpedi.FlgEst, 'P,E,PA') = 0 THEN NEXT.
    /*IF faccpedi.flgest <> "P" AND faccpedi.flgest <> "C"  AND faccpedi.flgest <> "E" THEN NEXT .*/
