...
DEFINE TEMP-TABLE tt-oc-seguimiento
        ...
        FIELDS tt-imp-oc AS DECIMAL
        FIELDS tt-ranking AS DECIMAL EXTENT 25
        FIELDS tt-stk-art-oc AS DECIMAL
        FIELDS tt-nro-dias AS DECIMAL
        FIELDS tt-plazo AS CHAR FORMAT 'x(80)'
        FIELDS tt-rotacion AS INT
        FIELDS tt-stk-arts AS DECIMAL
        FIELDS tt-presupuesto AS DECIMAL INIT 0
        FIELDS tt-acumulado AS DEC INIT 0
        FIELDS tt-items AS INT INIT 0
...
cRange = "J" + cColumn.
chWorkSheet:Range(cRange):Value = "NUEVO".
cRange = "K" + cColumn.
...
chWorkSheet:Range(cRange):Value = "Stock Actual".
cRange = "O" + cColumn.
chWorkSheet:Range(cRange):Value = "Presupuesto".
cRange = "P" + cColumn.
...
FOR EACH tt-oc-seguimiento NO-LOCK :
     ...
     cRange = "A" + cColumn.
     chWorkSheet:Range(cRange):Value = "'" + tt-codpro.
     cRange = "B" + cColumn.
     chWorkSheet:Range(cRange):Value = "'" + tt-nompro.
     cRange = "C" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-imp-oc.
     cRange = "D" + cColumn.
     chWorkSheet:Range(cRange):Value = (tt-ranking[1] / tt-imp-oc) * 100.
     cRange = "E" + cColumn.
     chWorkSheet:Range(cRange):Value = (tt-ranking[2] / tt-imp-oc) * 100.
     cRange = "F" + cColumn.
     chWorkSheet:Range(cRange):Value = (tt-ranking[3] / tt-imp-oc) * 100.
     cRange = "G" + cColumn.
     chWorkSheet:Range(cRange):Value = (tt-ranking[4] / tt-imp-oc) * 100.
     cRange = "H" + cColumn.                           
     chWorkSheet:Range(cRange):Value = (tt-ranking[5] / tt-imp-oc) * 100.
     cRange = "I" + cColumn.
     chWorkSheet:Range(cRange):Value = (tt-ranking[6] / tt-imp-oc) * 100.
     cRange = "J" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-ranking[7] /*(tt-ranking[7] / tt-imp-oc) * 100*/.
     cRange = "K" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-stk-art-oc.
     cRange = "L" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-nro-dias.
     cRange = "M" + cColumn.
     chWorkSheet:Range(cRange):Value = "'" + tt-plazo.
     cRange = "N" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-stk-arts.
     cRange = "O" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-presupuesto.
     cRange = "P" + cColumn.
     chWorkSheet:Range(cRange):Value = tt-acumulado.
     cRange = "Q" + cColumn.
