...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DCMP.UndCmp COLUMN-LABEL "Unid.!Cmp." FORMAT "X(3)":U
      DCMP.CanPedi FORMAT "Z,ZZZ,ZZ9.99":U
      DCMP.PreFob COLUMN-LABEL "Precio!Unitario" FORMAT ">>>,>>9.9999":U
      DCMP.ImpTot FORMAT ">>,>>>,>>9.99":U
  ENABLE
      DCMP.Codmat
      DCMP.CanPedi
      DCMP.PreFob
...
"DCMP.UndCmp" "Unid.!Cmp." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.DCMP.CanPedi
"DCMP.CanPedi" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.DCMP.PreFob
"DCMP.PreFob" "Precio!Unitario" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
********/
/**Rd01 - Calculo de importe total*/
        DCMP.PreUni = DCMP.PreFob
