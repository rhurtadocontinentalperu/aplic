...
Almmmatg.DesMar LG-DOCmp.UndCmp LG-DOCmp.CanPedi LG-DOCmp.PreUni ~
LG-DOCmp.ImpTot X-MARGEN @ X-MARGEN x-undmin @ x-undmin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LG-DOCmp.PreUni FORMAT ">>>,>>9.999999":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 93 BY 7.88
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-ImpTot AT ROW 9.58 COL 77 COLON-ALIGNED NO-LABEL
     "Total Importe" VIEW-AS TEXT
          SIZE 9.29 BY .5 AT ROW 9.08 COL 79.57
...
"LG-DOCmp.UndCmp" "Unid!Cmp." "X(4)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[6]   > integral.LG-DOCmp.PreUni
"LG-DOCmp.PreUni" ? ">>>,>>9.999999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
