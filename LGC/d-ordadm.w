...
&Scoped-Define ENABLED-OBJECTS RECT-5 RECT-4 Btn_OK Btn_Cancel 
...
DEFINE FRAME D-Dialog
     ...
     SPACE(19.71) SKIP(9.57)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "DETALLE DEL BIEN ADMINISTRATIVO".
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* DETALLE DEL BIEN ADMINISTRATIVO */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE T-DOSER THEN 
    DISPLAY T-DOSER.glosa[1] T-DOSER.glosa[2] T-DOSER.glosa[3] T-DOSER.glosa[4] 
      ...
      WITH FRAME D-Dialog.
  ENABLE RECT-5 RECT-4 T-DOSER.glosa[1] T-DOSER.glosa[2] T-DOSER.glosa[3] 
