...
&Scoped-define INTERNAL-TABLES LG-CFGCPR

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LG-CFGCPR WHERE ~{&KEY-PHRASE} ~
      AND LG-CFGCPR.Codcia = S-CODCIA NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main LG-CFGCPR
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main LG-CFGCPR
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.LG-CFGCPR"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.LG-CFGCPR.Codcia = S-CODCIA"
