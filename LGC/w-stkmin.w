...
x-Dias x-Entrega x-Tramites BROWSE-1 BUTTON-3 BUTTON-4 Btn_Done 
...
DEFINE BUTTON BUTTON-4 
     ...
     LABEL "Button 4" 
     SIZE 15 BY 1.54 TOOLTIP "Actualizar la Base de Datos".
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 3.31 COL 78
     BUTTON-4 AT ROW 4.85 COL 78
...
------------------------------------------------------------------------------*/
  ...
  ENABLE x-CodAlm x-CodPro x-FchDoc-1 x-FchDoc-2 x-Dias x-Entrega x-Tramites 
         BROWSE-1 BUTTON-3 BUTTON-4 Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
