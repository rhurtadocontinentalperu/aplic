...
&Scoped-define FIELDS-IN-QUERY-br_table LG-COCmp.Fchdoc LG-COCmp.NroDoc ~
LG-COCmp.Userid-com LG-COCmp.CodAlm LG-COCmp.NomPro ~
fMoneda(LG-COCmp.Codmon) @ s-CodMon LG-COCmp.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LG-COCmp.Fchdoc COLUMN-LABEL "<<Emision>>"
      LG-COCmp.NroDoc COLUMN-LABEL "Numero"
      LG-COCmp.Userid-com COLUMN-LABEL "Usuario"
      LG-COCmp.CodAlm
      LG-COCmp.NomPro
      fMoneda(LG-COCmp.Codmon) @ s-CodMon COLUMN-LABEL "Mon" FORMAT "x(3)"
      LG-COCmp.ImpTot
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 78 BY 6.69
         FONT 4
         TITLE "ORDENES DE COMPRA EN REVISION".
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > INTEGRAL.LG-COCmp.Fchdoc
"LG-COCmp.Fchdoc" "<<Emision>>" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.LG-COCmp.NroDoc
"LG-COCmp.NroDoc" "Numero" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.LG-COCmp.Userid-com
"LG-COCmp.Userid-com" "Usuario" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   = INTEGRAL.LG-COCmp.CodAlm
     _FldNameList[5]   = INTEGRAL.LG-COCmp.NomPro
     _FldNameList[6]   > "_<CALC>"
"fMoneda(LG-COCmp.Codmon) @ s-CodMon" "Mon" "x(3)" ? ? ? ? ? ? ? no ?
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* ORDENES DE COMPRA EN REVISION */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* ORDENES DE COMPRA EN REVISION */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* ORDENES DE COMPRA EN REVISION */
DO:
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  MESSAGE 'Procedemos a APROBAR LA ORDEN' STRING(lg-cocmp.nrodoc, '999999') '?'
