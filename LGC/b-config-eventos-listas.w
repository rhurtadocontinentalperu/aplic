...
DEF VAR s-tabla AS CHAR INIT "EVENTOS_LISTAS" NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "Lista" FORMAT "x(8)":U
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 6.69
         FONT 4
         TITLE "LISTA DE PRECIOS VALIDAS" FIT-LAST-COLUMN.
...
"FacTabla.Codigo" "Lista" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* LISTA DE PRECIOS VALIDAS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* LISTA DE PRECIOS VALIDAS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* LISTA DE PRECIOS VALIDAS */
DO:
...
IF NOT CAN-FIND(FIRST gn-divi WHERE GN-DIVI.CodCia = s-codcia AND
                ...
                NO-LOCK)
    THEN DO:
    MESSAGE 'Lista inválida' VIEW-AS ALERT-BOX ERROR.
