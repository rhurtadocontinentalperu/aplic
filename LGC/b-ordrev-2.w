...
LG-DOCmp.CanPedi LG-DOCmp.UndCmp LG-DOCmp.ImpTot fProyectado() @ x-StkMin ~
fStock(LG-DOCmp.Codmat) @ x-StkAct 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LG-DOCmp.CanPedi COLUMN-LABEL "Cantidad"
      LG-DOCmp.UndCmp COLUMN-LABEL "Unidad"
      LG-DOCmp.ImpTot COLUMN-LABEL "Importe"
      fProyectado() @ x-StkMin COLUMN-LABEL "Proyectado" FORMAT "Z,ZZZ,ZZ9.99"
      fStock(LG-DOCmp.Codmat) @ x-StkAct COLUMN-LABEL "Stock Total" FORMAT "->>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.LG-DOCmp WHERE INTEGRAL.LG-COCmp ...,INTEGRAL.Almmmatg OF INTEGRAL.LG-DOCmp"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.LG-DOCmp.CodCia = INTEGRAL.LG-COCmp.CodCia
  AND INTEGRAL.LG-DOCmp.TpoDoc = INTEGRAL.LG-COCmp.TpoDoc
  AND INTEGRAL.LG-DOCmp.CodDiv = INTEGRAL.LG-COCmp.CodDiv
  AND INTEGRAL.LG-DOCmp.NroDoc = INTEGRAL.LG-COCmp.NroDoc"
     _FldNameList[1]   = INTEGRAL.LG-DOCmp.Codmat
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.LG-DOCmp.CanPedi
"LG-DOCmp.CanPedi" "Cantidad" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[4]   > INTEGRAL.LG-DOCmp.UndCmp
"LG-DOCmp.UndCmp" "Unidad" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > INTEGRAL.LG-DOCmp.ImpTot
"LG-DOCmp.ImpTot" "Importe" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[6]   > "_<CALC>"
"fProyectado() @ x-StkMin" "Proyectado" "Z,ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ?
     _FldNameList[7]   > "_<CALC>"
"fStock(LG-DOCmp.Codmat) @ x-StkAct" "Stock Total" "->>>,>>9.99" ? ? ? ? ? ? ? no ?
