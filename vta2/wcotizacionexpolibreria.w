...
/* GRAN PARCHE */
IF s-coddiv = '00018' AND pcoddiv = '80015' THEN s-codalm = '60'.
...
DEFINE VAR xfileXls AS CHAR INIT "".
DEFINE VAR xfileProcesado AS CHAR INIT "".
...
DEFINE BUTTON BUTTON-Migrar-Provincias 
     LABEL "MIGRAR A PROVINCIAS" 
     SIZE 22 BY 1.12.

DEFINE BUTTON BUTTON-TRF 
...
DEFINE FRAME F-Main
     ...
     BUTTON-2 AT ROW 3.88 COL 120 WIDGET-ID 32
     B-CCTE AT ROW 5.23 COL 120 WIDGET-ID 12
     BUTTON-COT AT ROW 6.38 COL 120 WIDGET-ID 14
     BUTTON-TRF AT ROW 7.54 COL 120 WIDGET-ID 34
     BUTTON-Importar-Pedido AT ROW 8.69 COL 120 WIDGET-ID 36
     BUTTON-Migrar-Provincias AT ROW 9.85 COL 120 WIDGET-ID 38
...
/* SETTINGS FOR BUTTON BUTTON-Importar-Pedido IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON BUTTON-Migrar-Provincias IN FRAME F-Main
   NO-ENABLE                                                            */
...
DO:
   /*RUN Importar-Excel-Pedidos IN h_vcotizacionexpolibreria.*/
   
   RUN Importar-Excel-2015 IN h_vcotizacionexpolibreria .
...
&Scoped-define SELF-NAME BUTTON-Migrar-Provincias
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Migrar-Provincias W-Win
ON CHOOSE OF BUTTON-Migrar-Provincias IN FRAME F-Main /* MIGRAR A PROVINCIAS */
DO:
    MESSAGE 'Se va a migrar la COTIZACION a PROVINCIAS' SKIP
        '¿Continuamos con el proceso?'
        VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO UPDATE rpta AS LOG.
    IF rpta = NO THEN RETURN NO-APPLY.
   RUN Migrar-a-Provincias IN h_vcotizacionexpolibreria.
END.
...
&Scoped-define SELF-NAME BUTTON-TRF
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-TRF W-Win
ON CHOOSE OF BUTTON-TRF IN FRAME F-Main /* TRANSFERIR SALDO */
DO:
   DEF VAR pRowidS AS ROWID.
   RUN Transferencia-de-Saldos IN h_vcotizacionexpolibreria
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-pedido ,
             BUTTON-Migrar-Provincias:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/bcotizacionexpolibreria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bcotizacionexpolibreria ).
       RUN set-position IN h_bcotizacionexpolibreria ( 12.27 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_tcotizacioncreditomay ( 12.92 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 25.42 , 4.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-24 COMBO-NroSer BTN-Excel BUTTON-2 BUTTON-TRF 
      WITH FRAME F-Main IN WINDOW W-Win.
...
CASE L-Handle:
    WHEN "Pagina1"  THEN DO WITH FRAME {&FRAME-NAME}:
         ...
         ASSIGN
             ...
             BUTTON-TRF:SENSITIVE = YES
             Btn-Excel:SENSITIVE = YES
             BUTTON-Importar-Pedido:SENSITIVE = NO.
             /*BUTTON-Migrar-Provincias:SENSITIVE = YES.*/
    ...
    WHEN "Pagina2"  THEN DO WITH FRAME {&FRAME-NAME}:
         ...
         ASSIGN
             ...
             BUTTON-TRF:SENSITIVE = NO
             Btn-Excel:SENSITIVE    = NO
             BUTTON-Importar-Pedido:SENSITIVE = YES.
             /*BUTTON-Migrar-Provincias:SENSITIVE = NO.*/
         CASE s-TpoPed:
