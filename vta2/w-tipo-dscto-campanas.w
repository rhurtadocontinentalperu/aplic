...
DEFINE VARIABLE FILL-IN-titulo AS CHARACTER FORMAT "X(50)":U INITIAL "Tipo de descuentos - Campañas" 
     VIEW-AS FILL-IN 
     SIZE 31.86 BY 1.12
...
DEFINE FRAME F-Main
     FILL-IN-titulo AT ROW 1.19 COL 6 NO-LABEL WIDGET-ID 16
     BUTTON-cargar AT ROW 1.19 COL 39 WIDGET-ID 20
     COMBO-BOX-procesos AT ROW 2.46 COL 13 COLON-ALIGNED WIDGET-ID 2
     BUTTON-cancelar AT ROW 14.27 COL 39 WIDGET-ID 22
     BUTTON-grabar AT ROW 15.81 COL 39 WIDGET-ID 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Tipo de descuento - Campañas"
         HEIGHT             = 19.08
         WIDTH              = 61.43
         MAX-HEIGHT         = 21.5
         MAX-WIDTH          = 135.57
...
ON END-ERROR OF W-Win /* Tipo de descuento - Campañas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipo de descuento - Campañas */
DO:
...
ON CHOOSE OF BUTTON-grabar IN FRAME F-Main /* Grabar las campañas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-tipo-dscto-campanas.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rbte-config-linea-movimiento ).
       RUN set-position IN h_b-rbte-config-linea-movimiento ( 3.73 , 2.14 ) NO-ERROR.
       RUN set-size IN h_b-rbte-config-linea-movimiento ( 13.50 , 36.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv10 ,
             BUTTON-grabar:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
