...
DEFINE FRAME F-Main
     ...
     Almmmatg.DesMat AT ROW 2.31 COL 1.14 COLON-ALIGNED NO-LABEL
          ...
          SIZE 40.57 BY .69
          BGCOLOR 15 FGCOLOR 1 
     VtaListaMinGn.DtoVolR[1] AT ROW 4.19 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ...
     VtaListaMinGn.DtoVolR[2] AT ROW 5.04 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ...
     VtaListaMinGn.DtoVolR[3] AT ROW 5.85 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[1]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[1]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[10]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[2]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[2]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[3]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[4]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[5]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[6]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[7]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[8]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMinGn.DtoVolR[9]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMinGn.DtoVolD[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi ) * 100, 4 ) ).
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Almmmatg THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     F-PRECIO-1 = IF VtaListaMinGn.DtoVolR[1] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[1] / 100 ) ),4) ELSE 0.     
     F-PRECIO-2 = IF VtaListaMinGn.DtoVolR[2] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[2] / 100 ) ),4) ELSE 0.
     F-PRECIO-3 = IF VtaListaMinGn.DtoVolR[3] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[3] / 100 ) ),4) ELSE 0.
     F-PRECIO-4 = IF VtaListaMinGn.DtoVolR[4] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[4] / 100 ) ),4) ELSE 0.
     F-PRECIO-5 = IF VtaListaMinGn.DtoVolR[5] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[5] / 100 ) ),4) ELSE 0.
     F-PRECIO-6 = IF VtaListaMinGn.DtoVolR[6] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[6] / 100 ) ),4) ELSE 0.
     F-PRECIO-7 = IF VtaListaMinGn.DtoVolR[7] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[7] / 100 ) ),4) ELSE 0.
     F-PRECIO-8 = IF VtaListaMinGn.DtoVolR[8] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[8] / 100 ) ),4) ELSE 0.
     F-PRECIO-9 = IF VtaListaMinGn.DtoVolR[9] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[9] / 100 ) ),4) ELSE 0.
     F-PRECIO-10 = IF VtaListaMinGn.DtoVolR[10] <> 0 THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( VtaListaMinGn.DtoVolD[10] / 100 ) ),4) ELSE 0.
...
DO WITH FRAME {&FRAME-NAME} :
   ...
   */
   /*
   DO I = 1 TO 10 :
      IF INTEGER(VtaListaMinGn.DtoVolR[I]:SCREEN-VALUE) = 0 THEN NEXT .
