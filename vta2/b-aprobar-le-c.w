...
&Scoped-define INTERNAL-TABLES FacCPedi B-CPEDI
...
FacCPedi.CodCli FacCPedi.NomCli B-CPEDI.ImpTot FacCPedi.ImpTot ~
B-CPEDI.ImpTot - FacCPedi.ImpTot @ FacCPedi.Libre_d01 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.TpoPed = "LF" NO-LOCK, ~
  ...
  AND B-CPEDI.NroPed = FacCPedi.NroPed ~
      AND B-CPEDI.CodDoc = "CLE" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table FacCPedi B-CPEDI
&Scoped-define FIRST-TABLE-IN-QUERY-br_table FacCPedi
&Scoped-define SECOND-TABLE-IN-QUERY-br_table B-CPEDI
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      B-CPEDI.ImpTot COLUMN-LABEL "Importe!Web" FORMAT ">>>,>>9.99":U
            WIDTH 9.72
      FacCPedi.ImpTot COLUMN-LABEL "Importe!Total" FORMAT ">>>,>>9.99":U
            WIDTH 10.43
      B-CPEDI.ImpTot - FacCPedi.ImpTot @ FacCPedi.Libre_d01 COLUMN-LABEL "Diferencia" FORMAT "(>>>,>>9.99)":U
            WIDTH 8.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacCPedi,B-CPEDI WHERE INTEGRAL.FacCPedi ..."
 ...
 AND FacCPedi.CodDoc = ""COT""
 AND FacCPedi.FlgEst = ""E""
 AND FacCPedi.TpoPed = ""LF"""
     _JoinCode[2]      = "B-CPEDI.CodCia = FacCPedi.CodCia
  AND B-CPEDI.CodDiv = FacCPedi.CodDiv
  AND B-CPEDI.NroPed = FacCPedi.NroPed"
     _Where[2]         = "B-CPEDI.CodDoc = ""CLE"""
...
"FacCPedi.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "45.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.B-CPEDI.ImpTot
"B-CPEDI.ImpTot" "Importe!Web" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"B-CPEDI.ImpTot - FacCPedi.ImpTot @ FacCPedi.Libre_d01" "Diferencia" "(>>>,>>9.99)" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE Faccpedi THEN DO:
    MESSAGE 'Aprobamos la Cotización?' VIEW-AS ALERT-BOX QUESTION
