...
T-DMatriz.Libre-char[1] T-DMatriz.Libre-logi[1] T-DMatriz.Cantidad[1] ~
T-DMatriz.UndVta[1] T-DMatriz.PreUni[1] T-DMatriz.Cantidad[2] ~
T-DMatriz.UndVta[2] T-DMatriz.PreUni[2] T-DMatriz.Cantidad[3] ~
T-DMatriz.UndVta[3] T-DMatriz.PreUni[3] T-DMatriz.Cantidad[4] ~
T-DMatriz.UndVta[4] T-DMatriz.PreUni[4] T-DMatriz.Cantidad[5] ~
T-DMatriz.UndVta[5] T-DMatriz.PreUni[5] T-DMatriz.Cantidad[6] ~
T-DMatriz.UndVta[6] T-DMatriz.PreUni[6] fCantidad() @ x-Cantidad 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpLin-1 AT ROW 14.46 COL 36 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-ImpLin-2 AT ROW 14.46 COL 51 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN-ImpLin-3 AT ROW 14.46 COL 67 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     ...
     FILL-IN-ImpLin-6 AT ROW 14.46 COL 113 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     FILL-IN-DesMat AT ROW 15.81 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN-ImpTot AT ROW 15.81 COL 126 COLON-ALIGNED WIDGET-ID 32
...
"Temp-Tables.T-DMatriz.LabelFila" ? ? "character" ? ? ? ? ? ? no ? no no "20" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-DMatriz.Libre-char[1]
"Temp-Tables.T-DMatriz.Libre-char[1]" "Marca" "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-DMatriz.Libre-logi[1]
"Temp-Tables.T-DMatriz.Libre-logi[1]" "Tipo" "Propio/Terceros" "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-DMatriz.Cantidad[1]
"Temp-Tables.T-DMatriz.Cantidad[1]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-DMatriz.UndVta[1]
"Temp-Tables.T-DMatriz.UndVta[1]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-DMatriz.PreUni[1]
"Temp-Tables.T-DMatriz.PreUni[1]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-DMatriz.Cantidad[2]
"Temp-Tables.T-DMatriz.Cantidad[2]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-DMatriz.UndVta[2]
"Temp-Tables.T-DMatriz.UndVta[2]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-DMatriz.PreUni[2]
"Temp-Tables.T-DMatriz.PreUni[2]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-DMatriz.Cantidad[3]
"Temp-Tables.T-DMatriz.Cantidad[3]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-DMatriz.UndVta[3]
"Temp-Tables.T-DMatriz.UndVta[3]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-DMatriz.PreUni[3]
"Temp-Tables.T-DMatriz.PreUni[3]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-DMatriz.Cantidad[4]
"Temp-Tables.T-DMatriz.Cantidad[4]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-DMatriz.UndVta[4]
"Temp-Tables.T-DMatriz.UndVta[4]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > Temp-Tables.T-DMatriz.PreUni[4]
"Temp-Tables.T-DMatriz.PreUni[4]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.T-DMatriz.Cantidad[5]
"Temp-Tables.T-DMatriz.Cantidad[5]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > Temp-Tables.T-DMatriz.UndVta[5]
"Temp-Tables.T-DMatriz.UndVta[5]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > Temp-Tables.T-DMatriz.PreUni[5]
"Temp-Tables.T-DMatriz.PreUni[5]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > Temp-Tables.T-DMatriz.Cantidad[6]
"Temp-Tables.T-DMatriz.Cantidad[6]" "" ">>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > Temp-Tables.T-DMatriz.UndVta[6]
"Temp-Tables.T-DMatriz.UndVta[6]" "" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > Temp-Tables.T-DMatriz.PreUni[6]
"Temp-Tables.T-DMatriz.PreUni[6]" "Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[1] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[1] 
        NO-LOCK NO-ERROR.
    ...
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[1] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[1] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[1] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[1] Almmmatg.UndBas
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[1] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[1] IN BROWSE br_table
DO:
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[1]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
...
DO:
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN RETURN.
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[2] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[2] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almmmatg THEN RETURN.
    ...
    DEF VAR x-Factor AS DEC NO-UNDO.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[2]
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[2] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[2] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[2] Almmmatg.UndBas
            VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    FILL-IN-DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[2] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[2] IN BROWSE br_table
DO:
    /****    Selecciona las unidades de medida   ****/
    RUN vtagn/c-uniabc ("Unidades de Venta",
                        T-DMatriz.CodMat[2],
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[2]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
...
DO:
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN RETURN.
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[3] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[3] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almmmatg THEN RETURN.
    ...
    DEF VAR x-Factor AS DEC NO-UNDO.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[3]
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[3] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[3] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[3] Almmmatg.UndBas
            VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    FILL-IN-DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[3] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[3] IN BROWSE br_table
DO:
    /****    Selecciona las unidades de medida   ****/
    RUN vtagn/c-uniabc ("Unidades de Venta",
                        T-DMatriz.CodMat[3],
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[3]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
...
DO:
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN RETURN.
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[4] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[4] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almmmatg THEN RETURN.
    ...
    DEF VAR x-Factor AS DEC NO-UNDO.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[4]
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[4] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[4] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[4] Almmmatg.UndBas
            VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    FILL-IN-DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[4] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[4] IN BROWSE br_table
DO:
    /****    Selecciona las unidades de medida   ****/
    RUN vtagn/c-uniabc ("Unidades de Venta",
                        T-DMatriz.CodMat[4],
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[4]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
...
DO:
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN RETURN.
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[5] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[5] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almmmatg THEN RETURN.
    ...
    DEF VAR x-Factor AS DEC NO-UNDO.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[5]
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[5] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[5] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[5] Almmmatg.UndBas
            VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    FILL-IN-DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[5] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[5] IN BROWSE br_table
DO:
    /****    Selecciona las unidades de medida   ****/
    RUN vtagn/c-uniabc ("Unidades de Venta",
                        T-DMatriz.CodMat[5],
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[5]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
...
DO:
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN RETURN.
    IF VtaCMatriz.FlgMinimo = NO OR T-DMatriz.Minimo[6] = 0 THEN RETURN.
    FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
        AND Almmmatg.codmat = T-DMatriz.CodMat[6] 
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almmmatg THEN RETURN.
    ...
    DEF VAR x-Factor AS DEC NO-UNDO.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
        AND Almtconv.Codalter = T-DMatriz.UndVta[6]
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almtconv THEN RETURN.
    x-FACTOR = Almtconv.Equival / Almmmatg.FacEqu.
    IF DECIMAL(SELF:SCREEN-VALUE) * x-Factor < T-DMatriz.Minimo[6] THEN DO:
        MESSAGE 'ERROR EL EL PRODUCTO:' Almmmatg.desmat SKIP(1)
            'La venta es de ' SELF:SCREEN-VALUE T-DMatriz.UndVta[6] SKIP
            'NO se puede vender menos de' T-DMatriz.Minimo[6] Almmmatg.UndBas
            VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    FILL-IN-DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-DMatriz.Cantidad[6] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF T-DMatriz.Cantidad[6] IN BROWSE br_table
DO:
    /****    Selecciona las unidades de medida   ****/
    RUN vtagn/c-uniabc ("Unidades de Venta",
                        T-DMatriz.CodMat[6],
    ...
    IF output-var-1 <> ? THEN 
        T-DMatriz.UndVta[6]:SCREEN-VALUE IN BROWSE {&browse-name} = output-var-2.
