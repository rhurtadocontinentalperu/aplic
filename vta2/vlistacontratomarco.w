...
T-MATG.UndStk T-MATG.MonVta T-MATG.TpoCmb T-MATG.DesMar T-MATG.CtoLis ~
T-MATG.CtoTot T-MATG.Prevta[1] T-MATG.MrgUti-A T-MATG.Prevta[2] T-MATG.UndA ~
...
T-MATG.PreAlt[1] T-MATG.UndAlt[1] 
...
DEFINE MENU POPUP-MENU-br_table 
       ...
       MENU-ITEM m_LIMA_-_PROVINCIAS_-_DEscuen LABEL "LIMA - PROVINCIAS - Descuento Promocional".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.CtoLis COLUMN-LABEL "Costo S/IGV!S/." FORMAT ">>>,>>9.9999":U
...
"T-MATG.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-MATG.CtoLis
"T-MATG.CtoLis" "Costo S/IGV!S/." ">>>,>>9.9999" "decimal" 14 0 ? ? ? ? no ? no no "9.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.CtoTot
...
"T-MATG.UndAlt[1]" "UTILEX!UM" "x(6)" "character" 2 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define SELF-NAME T-MATG.CtoLis
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-MATG.CtoLis br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF T-MATG.CtoLis IN BROWSE br_table /* Costo S/IGV!S/. */
DO:
    ASSIGN
        X-CTOTOT = DECIMAL(T-MATG.CtoLis:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).

    T-MATG.CtoTot:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = IF T-MATG.AftIgv THEN 
...
DO:
    IF AVAILABLE Almmmatg THEN RUN Vta2/D-Lima-Dtoprom (Almmmatg.codmat).
END.
...
&Scoped-define SELF-NAME m_LIMA_-_PROVINCIAS_-_DEscuen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_LIMA_-_PROVINCIAS_-_DEscuen B-table-Win
ON CHOOSE OF MENU-ITEM m_LIMA_-_PROVINCIAS_-_DEscuen /* LIMA - PROVINCIAS - Descuento Promocional */
DO:
    IF AVAILABLE Almmmatg THEN RUN Vta2/D-Lima-Dtoprom-Prov (Almmmatg.codmat).
END.
...
ON 'RETURN':U OF T-MATG.CtoLis, T-MATG.MonVta, 
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    IF T-MATG.PreAlt[1] > 0 AND T-MATG.UndAlt[1] <> '' THEN DO:
...
------------------------------------------------------------------------------*/
   ...
   IF T-MATG.UndAlt[1]:SCREEN-VALUE IN BROWSE {&browse-name} <> "" 
