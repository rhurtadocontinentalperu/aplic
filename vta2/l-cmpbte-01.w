...
&SCOPED-DEFINE CONDICION CcbcDocu.CodCia = S-CODCIA ~
        ...
        AND LOOKUP(TRIM(CcbcDocu.CodDoc), 'BOL,FAC,N/C,N/D,CHQ,CHC,LET,TCK,BD,A/R,A/C,DCO') > 0 ~
        AND (c-CmpBte = '' OR CcbcDocu.CodDoc = C-CMPBTE) ~
...
CcbCDocu.CodRef CcbCDocu.NroRef CcbCDocu.NomCli CcbCDocu.FmaPgo ~
CcbCDocu.CodVen CcbCDocu.FchDoc CcbCDocu.FchCbd CcbCDocu.FchVto ~
CcbCDocu.FchCan X-MON @ X-MON CcbCDocu.ImpTot CcbCDocu.SdoAct ~
CcbCDocu.ImpDto fEstado() @ X-EST ~
...
DEFINE VARIABLE C-CMPBTE AS CHARACTER FORMAT "X(256)":U 
     LABEL "Tipo Cmpbte." 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "","Fac","Bol","N/C","N/D","CHQ","CHC","LET","TCK","BD","A/R","A/C","DCO" 
     DROP-DOWN-LIST
     SIZE 9.43 BY 1
     BGCOLOR 15  NO-UNDO.
...
"CcbCDocu.NroDoc" ? "XXX-XXXXXXXX" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.CcbCDocu.CodRef
...
"CcbCDocu.FmaPgo" "Cnd.!Venta" "XXX" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > integral.CcbCDocu.CodVen
...
"CcbCDocu.FchDoc" "     Fecha    !    Emision" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.CcbCDocu.FchCbd
"CcbCDocu.FchCbd" "Fecha!Recepción" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbCDocu.SdoAct" "Saldo" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > integral.CcbCDocu.ImpDto
...
"fSituacion() @ x-Situacion" "Situación" "x(15)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[25]   > INTEGRAL.CcbCDocu.NroSal
...
CASE xcodmod:
    WHEN 1 THEN DO:
        ...
        chWorkSheet:Range("O2"):Value = "Usuario anulación".
