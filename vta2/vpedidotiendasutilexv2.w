...
&Scoped-Define ENABLED-FIELDS FacCPedi.ordcmp FacCPedi.CodCli ~
FacCPedi.NomCli FacCPedi.fchven FacCPedi.Cmpbnte FacCPedi.DirCli ~
FacCPedi.FlgSit FacCPedi.FlgIgv FacCPedi.RucCli FacCPedi.Atencion ~
...
FacCPedi.ordcmp FacCPedi.CodCli FacCPedi.NomCli FacCPedi.fchven ~
FacCPedi.Cmpbnte FacCPedi.DirCli FacCPedi.FlgSit FacCPedi.FlgIgv ~
FacCPedi.RucCli FacCPedi.Atencion FacCPedi.CodMon FacCPedi.LugEnt ~
FacCPedi.TpoCmb FacCPedi.Glosa FacCPedi.CodVen FacCPedi.FmaPgo ~
...
DEFINE FRAME F-Main
     ...
     FacCPedi.NomCli AT ROW 1.77 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 48 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.fchven AT ROW 1.77 COL 86 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Cmpbnte AT ROW 1.77 COL 118 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
     ...
     FacCPedi.FlgSit AT ROW 2.54 COL 88 NO-LABEL
...
"Cupón de Descuento", "CD":U
          SIZE 19 BY 3.08
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgIgv AT ROW 2.54 COL 120 NO-LABEL WIDGET-ID 28
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
          SIZE 11.57 BY .81
     FacCPedi.RucCli AT ROW 3.31 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.Atencion AT ROW 3.31 COL 30 COLON-ALIGNED WIDGET-ID 4
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 3.31 COL 120 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.57 BY .81
     FacCPedi.LugEnt AT ROW 4.08 COL 9 COLON-ALIGNED WIDGET-ID 20
          LABEL "Entregar en"
          VIEW-AS FILL-IN 
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 4.08 COL 118 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Glosa AT ROW 4.85 COL 6.28
          VIEW-AS FILL-IN 
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodVen AT ROW 5.62 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-nOMvEN AT ROW 5.62 COL 15 COLON-ALIGNED NO-LABEL
     COMBO-BOX-Proveedor AT ROW 5.62 COL 86 COLON-ALIGNED WIDGET-ID 48
     FacCPedi.FmaPgo AT ROW 6.38 COL 9 COLON-ALIGNED
...
DEFINE FRAME F-Main
     F-CndVta AT ROW 6.38 COL 15 COLON-ALIGNED NO-LABEL
     FacCPedi.Libre_c05 AT ROW 6.38 COL 86 COLON-ALIGNED WIDGET-ID 50 PASSWORD-FIELD 
          LABEL "Cupón de descuento" FORMAT "x(60)"
          VIEW-AS FILL-IN 
          SIZE 21 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.NroCard AT ROW 7.15 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 7.15 COL 22 COLON-ALIGNED NO-LABEL
     FacCPedi.Libre_c03 AT ROW 7.15 COL 86 COLON-ALIGNED WIDGET-ID 52
          LABEL "Cliente Asociado" FORMAT "x(60)"
          VIEW-AS COMBO-BOX INNER-LINES 20
          LIST-ITEM-PAIRS "Seleccione Cliente Asociado","Seleccione Cliente Asociado"
          DROP-DOWN-LIST
          SIZE 44 BY 1
     FacCPedi.NroRef AT ROW 7.92 COL 9 COLON-ALIGNED WIDGET-ID 10
          LABEL "Vitrinas" FORMAT "X(254)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 15 FGCOLOR 12 
     FacCPedi.Libre_c04 AT ROW 7.92 COL 86 COLON-ALIGNED WIDGET-ID 54
          LABEL "Código de Personal" FORMAT "x(60)"
          VIEW-AS FILL-IN 
          SIZE 21 BY .81
          BGCOLOR 11 FGCOLOR 0 
     BtnExcel AT ROW 8.19 COL 117 WIDGET-ID 56
     ...
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 3.5 COL 113
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* SETTINGS FOR FILL-IN FacCPedi.Glosa IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR COMBO-BOX FacCPedi.Libre_c03 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
...
DO:
  ...
  *******/
  ...
  btnExcel:VISIBLE = NO.
  IF faccpedi.codcli:SCREEN-VALUE = '11111111119' THEN  DO:
  ...
  CASE TRUE:
      ...
      WHEN s-FlgSit = "CD" THEN DO:
          ...
          IF AVAILABLE Vtadtabla THEN DO:
               FacCPedi.Libre_c03:DELETE(FacCPedi.Libre_c03:LIST-ITEM-PAIRS).
               FacCPedi.Libre_c03:ADD-LAST('Seleccione Cliente Asociado','Seleccione Cliente Asociado').
               FOR EACH  Vtadtabla NO-LOCK WHERE Vtadtabla.codcia = s-codcia
                   AND Vtadtabla.tabla = "UTILEX-ENCARTE"
                   AND Vtadtabla.llave = SELF:SCREEN-VALUE
                   AND Vtadtabla.tipo  = "CA":
                   FacCPedi.Libre_c03:ADD-LAST(VtaDTabla.Libre_c01, VtaDTabla.LlaveDetalle).
               END.
               FacCPedi.Libre_c03:SCREEN-VALUE = 'Seleccione Cliente Asociado'.
...
/*       END.                                                                     */
      ...
      ELSE DO:
          ...
          DISPLAY COMBO-BOX-Proveedor.
      END.
    /* Ic - 07Mar2016, Pruebas de Promociones */      
      btnExcel:VISIBLE = NO.
      IF AVAILABLE faccpedi THEN DO:          
          IF faccpedi.codcli = '11111111119' THEN DO:        
              IF lh_Handle <> ? THEN RUN Procesa-Handle IN lh_Handle ('ProbarPromocionesOFF').
          END.
          ELSE DO:
              IF lh_Handle <> ? THEN RUN Procesa-Handle IN lh_Handle ('ProbarPromocionesON').
          END.              
      END.      
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME} :
    ...
    IF Faccpedi.FlgSit:SCREEN-VALUE = "CD" THEN DO:
        ...
        END.
        /* RHC 20/01/2016 */
        IF FacCPedi.Libre_c03:SENSITIVE = YES AND FacCPedi.Libre_c03:SCREEN-VALUE BEGINS 'Seleccione Cliente' 
            THEN DO:
    ...
    IF Faccpedi.FlgSit:SCREEN-VALUE = "KC" THEN DO:
        ...
        IF s-CodPro = '10003814' THEN DO:
            ...
            IF NOT AVAILABLE h-vtatabla  THEN DO:
                ...
                FIND FIRST h-vtatabla WHERE h-vtatabla.codcia  = s-codcia
                    AND  h-vtatabla.tabla = 'VUTILEXTCK' 
                    AND  h-vtatabla.llave_c5 = s-NroVale NO-LOCK NO-ERROR.
                IF NOT AVAILABLE h-vtatabla THEN DO:
        ...
        /*
             IF s-CodPro = '10003814' AND 
                  NOT (s-Nrovale BEGINS '0001' OR s-NroVale BEGINS '0002' OR 
                     s-NroVale BEGINS '0003' OR s-NroVale BEGINS '0004' OR
                   s-NroVale BEGINS '0005')
                THEN DO:
