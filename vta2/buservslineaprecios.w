...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almtfami.desfam FORMAT "X(30)":U WIDTH 30.43
  ENABLE
      VtaTabla.Llave_c2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 41 BY 6.69
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaTabla WHERE INTEGRAL.PF-G004 <external> ...,INTEGRAL.Almtfami WHERE INTEGRAL.VtaTabla ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.VtaTabla.Llave_c1 = INTEGRAL.PF-G004.User-Id"
     _Where[1]         = "INTEGRAL.VtaTabla.CodCia = s-codcia
 AND INTEGRAL.VtaTabla.Tabla = s-tabla"
     _JoinCode[2]      = "INTEGRAL.Almtfami.CodCia = INTEGRAL.VtaTabla.CodCia
  AND INTEGRAL.Almtfami.codfam = INTEGRAL.VtaTabla.Llave_c2"
...
"Almtfami.desfam" ? ? "character" ? ? ? ? ? ? no ? no no "30.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH VtaTabla WHERE VtaTabla.codcia = s-codcia
    ...
    AND VtaTabla.Llave_c1 = pf-g004.USER-ID:
    DELETE VtaTabla.
END.
