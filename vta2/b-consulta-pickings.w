...
DEF VAR x-Comprobante AS CHAR FORMAT 'x(15)' NO-UNDO.
...
FacCPedi.CodDoc FacCPedi.NroPed fComprobante() @ x-Comprobante ~
fBultos() @ x-Bultos FacCPedi.FchPed FacCPedi.FchEnt FacCPedi.CodCli ~
FacCPedi.NomCli FacCPedi.Hora FacCPedi.FlgEst FacCPedi.FlgSit ~
FacCPedi.TpoPed FacCPedi.Peso FacCPedi.Volumen FacCPedi.Items ~
FacCPedi.AcuBon[9] FacCPedi.AcuBon[8] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fComprobante B-table-Win 
FUNCTION fComprobante RETURNS CHARACTER
  ( /* parameter-definitions */ )  FORWARD.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      fComprobante() @ x-Comprobante COLUMN-LABEL "Comprobante"
            WIDTH 13
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123.43 BY 7.65
...
"fComprobante() @ x-Comprobante" "Comprobante" ? ? ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "38.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.FacCPedi.Hora
...
"FacCPedi.FlgSit" ? "x(2)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.FacCPedi.TpoPed
"FacCPedi.TpoPed" ? "X(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   = INTEGRAL.FacCPedi.Peso
     _FldNameList[15]   = INTEGRAL.FacCPedi.Volumen
     _FldNameList[16]   = INTEGRAL.FacCPedi.Items
     _FldNameList[17]   > INTEGRAL.FacCPedi.AcuBon[9]
"FacCPedi.AcuBon[9]" "Bultos" "->>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > INTEGRAL.FacCPedi.AcuBon[8]
...
CASE TRUE:
    ...
    WHEN txtNumero > '' THEN DO:
        FIND FIRST Faccpedi WHERE faccpedi.codcia = s-codcia AND 
            ...
            NO-LOCK NO-ERROR.
        IF AVAILABLE Faccpedi THEN MESSAGE "Si esta".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fComprobante B-table-Win 
FUNCTION fComprobante RETURNS CHARACTER
  ( /* parameter-definitions */ ) :
/*------------------------------------------------------------------------------
  Purpose:  
...
------------------------------------------------------------------------------*/
  ...
  FIND LAST b-Ccbcdocu WHERE b-Ccbcdocu.codcia = s-codcia AND
      b-Ccbcdocu.codped = t-Faccpedi.codref AND
      b-Ccbcdocu.nroped = t-Faccpedi.nroref AND
      b-Ccbcdocu.libre_c01 = t-Faccpedi.coddoc AND
      b-Ccbcdocu.libre_c02 = t-Faccpedi.nroped AND
      LOOKUP(b-Ccbcdocu.coddoc, 'FAC,BOL') > 0 AND
      b-Ccbcdocu.flgest <> 'A'
      NO-LOCK NO-ERROR.
  IF AVAILABLE b-Ccbcdocu THEN RETURN b-Ccbcdocu.coddoc + " " + b-Ccbcdocu.nrodoc.
