...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMinGn.CodCia = S-CODCIA ~
 AND VtaListaMinGn.codmat = S-CODMAT ~
 NO-LOCK, ~
      EACH Almmmatg OF VtaListaMinGn NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMinGn.CodCia = S-CODCIA ~
 AND VtaListaMinGn.codmat = S-CODMAT ~
 NO-LOCK, ~
      EACH Almmmatg OF VtaListaMinGn NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaListaMinGn Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaListaMinGn
