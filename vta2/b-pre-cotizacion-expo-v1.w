...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 130 BY 12.38
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 14.19 COL 14 NO-LABEL WIDGET-ID 12
     F-ImpExo AT ROW 14.19 COL 27 NO-LABEL WIDGET-ID 4
     F-ImpDes AT ROW 14.19 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     F-ValVta AT ROW 14.19 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-ImpIsc AT ROW 14.19 COL 65 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpIgv AT ROW 14.19 COL 78 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     F-ImpTot AT ROW 14.19 COL 92 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.65 COL 15 WIDGET-ID 26
          FONT 1
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.65 COL 41 WIDGET-ID 24
          FONT 1
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.65 COL 94 WIDGET-ID 22
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.65 COL 55 WIDGET-ID 20
          FONT 1
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.65 COL 69 WIDGET-ID 18
          FONT 1
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.65 COL 28 WIDGET-ID 16
          FONT 1
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.65 COL 82 WIDGET-ID 28
          FONT 1
