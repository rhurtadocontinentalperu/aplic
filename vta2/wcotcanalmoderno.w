...
IF s-TpoPed <> "S" THEN RETURN ERROR.
...
DEFINE FRAME F-Main
     ...
     BTN-Excel AT ROW 2.35 COL 123.72 WIDGET-ID 16
     B-CLI AT ROW 3.69 COL 123.43 WIDGET-ID 22
     B-CCTE AT ROW 4.77 COL 123.43 WIDGET-ID 12
     BUTTON-COT AT ROW 5.85 COL 123.43 WIDGET-ID 14
     BUTTON-SUPERMERCADOS-B2Bv2 AT ROW 6.92 COL 123.43 WIDGET-ID 52
     BUTTON-SUPERMERCADOS AT ROW 8 COL 123.43 WIDGET-ID 18
     BUTTON-EDI AT ROW 10.42 COL 123.43 WIDGET-ID 24
     BUTTON-IMP-HIST-COT AT ROW 11.5 COL 123.43 WIDGET-ID 36
     "Buscar:" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_p-updv04 ( 1.42 , 64.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_vcotgralcredmayoristav23 ).
...
CASE L-Handle:
    ...
    WHEN "Pagina2"  THEN DO WITH FRAME {&FRAME-NAME}:
         ...
         RUN dispatch IN h_tcotgralcredmayoristav21 ('open-query':U).
      END.
    WHEN "Pagina5"  THEN DO WITH FRAME {&FRAME-NAME}:
         RUN select-page(5).
         ASSIGN
             COMBO-NroSer:SENSITIVE = NO
             B-CCTE:SENSITIVE = YES
