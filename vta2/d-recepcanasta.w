...
&Scoped-Define ENABLED-OBJECTS FILL-IN-Canasta COMBO-BOX-Anaquel Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Canasta COMBO-BOX-Anaquel 
...
DEFINE VARIABLE COMBO-BOX-Anaquel AS CHARACTER FORMAT "X(256)":U 
     LABEL "Anaquel" 
...
DEFINE FRAME D-Dialog
     FILL-IN-Canasta AT ROW 1.38 COL 10 COLON-ALIGNED WIDGET-ID 2 PASSWORD-FIELD 
     COMBO-BOX-Anaquel AT ROW 2.54 COL 10 COLON-ALIGNED WIDGET-ID 4
     Btn_OK AT ROW 4.27 COL 3
     Btn_Cancel AT ROW 4.27 COL 18
     SPACE(9.13) SKIP(0.76)
...
DO:
  ...
  FIND VtamAnaquel WHERE VtamAnaquel.CodCia = s-codcia
      ...
      AND VtamAnaquel.Codigo = COMBO-BOX-Anaquel
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN NO-APPLY ON STOP UNDO, RETURN NO-APPLY:
      ...
      ASSIGN
          VtamAnaquel.FlgEst = "O"
          VtamAnaquel.Canasta = VtamBasket.Codigo
          VtamAnaquel.CodDoc = VtamBasket.CodDoc 
          VtamAnaquel.NroPed = VtamBasket.NroPed.
      ASSIGN
          VtamBasket.FlgEst = "R".
      CREATE LogTabla.
      ASSIGN
          ...
          VtamBasket.CodDoc + '|' + VtamBasket.NroPed.
      RELEASE VtamBasket.
      RELEASE VtamAnaquel.
      RELEASE LogTabla.
  END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Canasta COMBO-BOX-Anaquel 
      WITH FRAME D-Dialog.
  ENABLE FILL-IN-Canasta COMBO-BOX-Anaquel Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
