...
DEF INPUT PARAMETER pCanasta AS CHAR.
DEF INPUT PARAMETER pGabinete AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS F-CodCli RADIO-SET-Libre_C01 f-ApePat ~
f-ApeMat f-Nombre F-DirCli F-RucCli F-DNICli RADIO-SET-Retenedor ~
...
DEFINE FRAME D-Dialog
     ...
     "Agente Retenedor:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 8.88 COL 7 WIDGET-ID 16
     "Agente de Percepción:" VIEW-AS TEXT
          SIZE 16 BY .5 AT ROW 10.04 COL 4 WIDGET-ID 30
     SPACE(66.13) SKIP(5.37)
...
------------------------------------------------------------------------------*/
  DISPLAY F-CodCli RADIO-SET-Libre_C01 f-ApePat f-ApeMat f-Nombre F-NomCli 
      ...
      WITH FRAME D-Dialog.
  ENABLE F-CodCli RADIO-SET-Libre_C01 f-ApePat f-ApeMat f-Nombre F-DirCli 
         F-RucCli F-DNICli RADIO-SET-Retenedor RADIO-SET-Percepcion F-GirCli 
         F-CodDept F-CodProv F-CodDist f-vende F-TlfCli Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      FIND VtamAnaquel WHERE VtamAnaquel.CodCia = s-codcia
          ...
          AND VtamAnaquel.Codigo = pGabinete
          AND VtamAnaquel.Canasta = pCanasta
      ...
      S-CODCLI = "".
      IF AVAILABLE VtamAnaquel AND VtamAnaquel.CodCli <> '' THEN DO:
          ASSIGN
              F-CodCli:SCREEN-VALUE = VtamAnaquel.CodCli 
              f-ApePat:SCREEN-VALUE = VtamAnaquel.ApePat 
              f-ApeMat:SCREEN-VALUE = VtamAnaquel.ApeMat 
              f-Nombre:SCREEN-VALUE = VtamAnaquel.Nombre 
              F-NomCli:SCREEN-VALUE = VtamAnaquel.NomCli 
              F-DirCli:SCREEN-VALUE = VtamAnaquel.DirCli 
              F-RucCli:SCREEN-VALUE = VtamAnaquel.Ruc 
              F-DNICli:SCREEN-VALUE = VtamAnaquel.DNI 
              RADIO-SET-Libre_C01:SCREEN-VALUE = VtamAnaquel.Persona.
          IF gn-divi.Campo-Log[2] = NO THEN     /* NO puede modificar */
              ASSIGN
              F-CodCli:SENSITIVE = NO
              f-ApePat:SENSITIVE = NO
              f-ApeMat:SENSITIVE = NO
          ...
          ELSE APPLY 'VALUE-CHANGED':U TO RADIO-SET-Libre_C01.
