...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaTabla WHERE FacTabla.CodCia = VtaTabla.CodCia and ~
factabla.tabla = vtatabla.tabla and ~
factabla.codigo = vtatabla.llave_c1 ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaTabla WHERE FacTabla.CodCia = VtaTabla.CodCia and ~
factabla.tabla = vtatabla.tabla and ~
factabla.codigo = vtatabla.llave_c1 ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     ...
     _JoinCode[1]      = "FacTabla.CodCia = VtaTabla.CodCia and
factabla.tabla = vtatabla.tabla and
factabla.codigo = vtatabla.llave_c1
"
