...
DEFINE VARIABLE h_vodconsolidada AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vodconsolidada.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vodconsolidada ).
       RUN set-position IN h_vodconsolidada ( 2.73 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.35 , 110.00 ) */
       ...
       /* Links to SmartViewer h_vodconsolidada. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_vodconsolidada ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_vodconsolidada ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_vodconsolidada ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-pedido ,
             h_vodconsolidada , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
