...
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-1 FILL-IN-3 FILL-IN-4 FILL-IN-6 ~
FILL-IN-7 
...
DEFINE VARIABLE FILL-IN-3 AS CHARACTER FORMAT "X(256)":U INITIAL "10.00" 
     VIEW-AS FILL-IN 
     SIZE 8 BY 1 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-6 AS CHARACTER FORMAT "X(256)":U INITIAL "0.00" 
     VIEW-AS FILL-IN 
     SIZE 8 BY 1 NO-UNDO.

DEFINE VARIABLE FILL-IN-7 AS CHARACTER FORMAT "X(256)":U INITIAL "2.50" 
     VIEW-AS FILL-IN 
     SIZE 8 BY 1 NO-UNDO.
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 1.19 COL 53
     Btn_Cancel AT ROW 2.73 COL 53
     FILL-IN-1 AT ROW 3.12 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     FILL-IN-3 AT ROW 3.12 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     FILL-IN-4 AT ROW 4.27 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN-6 AT ROW 4.27 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     FILL-IN-7 AT ROW 4.27 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     "PRE UNI S/." VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.35 COL 36 WIDGET-ID 92
     "4" VIEW-AS TEXT
     ...
     "% DESCUENTO" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.35 COL 19 WIDGET-ID 18
     "C" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 1.38 COL 36 WIDGET-ID 56
          BGCOLOR 8 FGCOLOR 0 
     "A" VIEW-AS TEXT
     ...
     "5" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 0 
     "B" VIEW-AS TEXT
          SIZE 14 BY .62 AT ROW 1.38 COL 20 WIDGET-ID 54
          BGCOLOR 8 FGCOLOR 0 
     "3" VIEW-AS TEXT
     ...
     RECT-9 AT ROW 3.12 COL 35 WIDGET-ID 32
     RECT-10 AT ROW 4.27 COL 35 WIDGET-ID 34
     RECT-11 AT ROW 2.15 COL 18 WIDGET-ID 36
     RECT-12 AT ROW 2.15 COL 35 WIDGET-ID 38
     RECT-15 AT ROW 1.19 COL 6 WIDGET-ID 50
     RECT-16 AT ROW 1.19 COL 18 WIDGET-ID 46
     C AT ROW 1.19 COL 35 WIDGET-ID 48
...
REPEAT:
    ...
    cValue = chWorkSheet:Cells(t-Row, t-Column):VALUE.
    ASSIGN
        Promocion.Libre_d01 = DECIMAL(cValue).

    t-Column = t-Column + 1.
    cValue = chWorkSheet:Cells(t-Row, t-Column):VALUE.
    ASSIGN
        Promocion.Libre_d02 = DECIMAL(cValue).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-1 FILL-IN-3 FILL-IN-4 FILL-IN-6 FILL-IN-7 
      WITH FRAME D-Dialog.
