...
&Scoped-define INTERNAL-TABLES vtacprom

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH vtacprom OF GN-DIVI WHERE ~{&KEY-PHRASE} ~
      AND vtacprom.CodCia = s-codcia ~
 AND vtacprom.CodDoc = s-coddoc ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH vtacprom OF GN-DIVI WHERE ~{&KEY-PHRASE} ~
      AND vtacprom.CodCia = s-codcia ~
 AND vtacprom.CodDoc = s-coddoc ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main vtacprom
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main vtacprom
...
<SORTBY-OPTIONS>
NroDoc|y||INTEGRAL.vtacprom.NroDoc|no
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.vtacprom OF INTEGRAL.GN-DIVI"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.vtacprom.CodCia = s-codcia
 AND INTEGRAL.vtacprom.CodDoc = s-coddoc
"
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'NroDoc':U THEN DO:
      &Scope SORTBY-PHRASE BY vtacprom.NroDoc DESCENDING
