...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ComiConfig WHERE ~{&KEY-PHRASE} ~
      AND ComiConfig.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ComiConfig WHERE ~{&KEY-PHRASE} ~
      AND ComiConfig.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main ComiConfig
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ComiConfig
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "ComiConfig.CodCia = s-codcia"
