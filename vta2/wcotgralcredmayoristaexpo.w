...
DEFINE VARIABLE h_vcotgralcredmayoristav21 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     BTN-Excel AT ROW 2.35 COL 121 WIDGET-ID 16
     btnExcVend AT ROW 2.54 COL 131 WIDGET-ID 40
     BUTTON-PRECOTIZACION AT ROW 2.54 COL 133 WIDGET-ID 58
     B-CLI AT ROW 3.69 COL 121 WIDGET-ID 22
     B-CCTE AT ROW 4.85 COL 121 WIDGET-ID 12
     BUTTON-COT AT ROW 6 COL 121 WIDGET-ID 14
     BUTTON-IMPORTAR-EXCEL AT ROW 7.15 COL 121 WIDGET-ID 50
     BUTTON-Importar-Pedido AT ROW 8.27 COL 121 WIDGET-ID 48
     BUTTON-TRF-SDO-EXPO AT ROW 9.46 COL 121 WIDGET-ID 46
     BUTTON-EDI AT ROW 10.62 COL 120.72 WIDGET-ID 24
     BtnListaExpress AT ROW 10.96 COL 121 WIDGET-ID 54
     BUTTON-IMP-HIST-COT AT ROW 11.77 COL 120.43 WIDGET-ID 36
     BUTTON-SUPERMERCADOS-B2Bv2 AT ROW 11.77 COL 121 WIDGET-ID 52
...
DO:
   RUN Actualiza-datos-cliente IN h_vcotgralcredmayoristav21.
END.
...
/*     END CASE.                                                                    */
    CASE TRUE :
        WHEN INDEX(gn-divi.canalventa, "MIN") > 0
            THEN RUN Excel_Utilex IN h_vcotgralcredmayoristav21 (INPUT lchoice) .
        OTHERWISE RUN Genera-Excel2 IN h_vcotgralcredmayoristav21 (INPUT lchoice) .
    END CASE.
END.
...
/*     END CASE.                                                                    */
    IF lChoice = TRUE THEN DO:
        RUN Genera-Excel-vendedores IN h_vcotgralcredmayoristav21 (INPUT lchoice) .
    END.
END.
...
DO:
    ...
    RUN Importar-listaexpress-2016 IN h_vcotgralcredmayoristav21.
...
DO:
  RUN Importar-entre-companias IN h_vcotgralcredmayoristav21.
  IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
  RUN dispatch IN h_tcotgralcredmayoristav21 ('open-query':U).
END.
...
DO:
  RUN Edi-Comparativo IN h_vcotgralcredmayoristav21.
END.
...
DO:
  RUN Genera-Excel-Trabajo IN h_vcotgralcredmayoristav21.
END.
...
DO:
   RUN Captura-Historico-Cotizaciones IN h_vcotgralcredmayoristav21.
END.
...
DO:
   RUN Importar-Excel-OpenOrange IN h_vcotgralcredmayoristav21.
END.
...
DO:
   RUN Importar-Excel-Provincias IN h_vcotgralcredmayoristav21.
END.
...
DO:
   RUN Importar-Excel-Marco IN h_vcotgralcredmayoristav21.
END.
...
DO:
  ...
  RUN Importar-Excel-2015 IN h_vcotgralcredmayoristav21.
END.
...
DO:
  RUN Asigna-PrePedido IN h_vcotgralcredmayoristav21.
  IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
  RUN dispatch IN h_tcotgralcredmayoristav21 ('open-query':U).
...
DO:
    RUN Importar-Supermercados IN h_vcotgralcredmayoristav21.
    IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
    RUN dispatch IN h_tcotgralcredmayoristav21 ('open-query':U).
END.
...
DO:
    RUN Importar-Supermercados-B2B IN h_vcotgralcredmayoristav21.
    IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
    RUN dispatch IN h_tcotgralcredmayoristav21 ('open-query':U).
END.
...
DO:
    ...
    */
    ...
    RUN Importar-tiendas-B2B IN h_vcotgralcredmayoristav21.
...
DO:
   ...
   RUN Transferencia-de-Saldos IN h_vcotgralcredmayoristav21
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vcotgralcredmayoristav21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vcotgralcredmayoristav21 ).
       RUN set-position IN h_vcotgralcredmayoristav21 ( 2.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.04 , 117.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'q-pedidoexpo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-pedido ).
       ...
       /* Links to SmartViewer h_vcotgralcredmayoristav21. */
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_vcotgralcredmayoristav21 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_vcotgralcredmayoristav21 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico-2 ,
             h_p-updv01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_vcotgralcredmayoristav21 ,
...
CASE L-Handle:
    WHEN "Repinta" THEN DO:
        MESSAGE 'repintado'.
        RUN dispatch IN h_q-pedido ('get-next':U).
        RUN dispatch IN h_vcotgralcredmayoristav21 ('display-fields':U).
