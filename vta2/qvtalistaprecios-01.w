...
DEFINE SHARED VARIABLE s-Rowid AS ROWID.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaListaPrecios WHERE ~{&KEY-PHRASE} ~
      AND ROWID(VtaListaPrecios) = s-Rowid NO-LOCK, ~
      FIRST Almmmatg OF VtaListaPrecios NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaListaPrecios WHERE ~{&KEY-PHRASE} ~
      AND ROWID(VtaListaPrecios) = s-Rowid NO-LOCK, ~
      FIRST Almmmatg OF VtaListaPrecios NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaListaPrecios Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaListaPrecios
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "integral.VtaListaPrecios,integral.Almmmatg OF integral.VtaListaPrecios"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _Where[1]         = "ROWID(VtaListaPrecios) = s-Rowid"
