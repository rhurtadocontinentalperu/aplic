...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/v-pedido-credito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-credito ).
       RUN set-position IN h_v-pedido-credito ( 2.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.69 , 122.57 ) */
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-size IN h_t-pedido-credito ( 12.50 , 141.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-size IN h_t-pedido-cred-2 ( 12.50 , 141.00 ) NO-ERROR.
