...
DEFINE VARIABLE h_bconcotcrev2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CONSULTA GENERAL DE PEDIDOS COMERCIALES"
         HEIGHT             = 26.69
         WIDTH              = 173.14
         MAX-HEIGHT         = 27.69
         MAX-WIDTH          = 178.29
...
ON END-ERROR OF W-Win /* CONSULTA GENERAL DE PEDIDOS COMERCIALES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CONSULTA GENERAL DE PEDIDOS COMERCIALES */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/bconcotcrev2-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = CodDiv':U ,
             OUTPUT h_bconcotcrev2 ).
       RUN set-position IN h_bconcotcrev2 ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bconcotcrev2 ( 11.92 , 170.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'LABEL-FONT = 4,
                     ...
                     LABELS = Detalle|Pedidos Logísticos':U ,
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 12.92 , 1.00 ) NO-ERROR.
       RUN set-size IN h_tab95 ( 15.00 , 171.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_tab95 ,
             h_bconcotcrev2 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/bconcotcrev2-1d.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotizacion-cred ).
       RUN set-position IN h_b-cotizacion-cred ( 13.88 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-cotizacion-cred ( 12.65 , 152.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cotizacion-cred. */
       RUN add-link IN adm-broker-hdl ( h_bconcotcrev2 , 'Record':U , h_b-cotizacion-cred ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_bconcotcre-1 ( 13.88 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_bconpedcre-1 ( 13.88 , 84.00 ) NO-ERROR.
       ...
       RUN set-position IN h_bconpedcre-2a ( 20.23 , 2.00 ) NO-ERROR.
...
CASE pParameter:
    WHEN 'Open-Query' THEN DO:
        RUN dispatch IN h_bconcotcrev2 ('row-changed').
    END.
