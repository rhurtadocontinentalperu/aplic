...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-prov.NomPro FORMAT "x(60)":U WIDTH 58.86
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 86 BY 4.04
         FONT 4
         TITLE "PROVEEDORES".
...
"gn-prov.NomPro" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "58.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaDTabla.Libre_d01
"VtaDTabla.Libre_d01" "Mínimo en Soles" ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
