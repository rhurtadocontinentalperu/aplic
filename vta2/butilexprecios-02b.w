...
T-MATG.TpoCmb T-MATG.DesMar T-MATG.CtoTot T-MATG.MrgAlt[1] T-MATG.PreAlt[1] ~
T-MATG.UndAlt[1] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table T-MATG.MrgAlt[1] ~
T-MATG.PreAlt[1] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.MrgAlt[1] COLUMN-LABEL "UTILEX!% Uti" FORMAT "->>,>>9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      T-MATG.PreAlt[1] COLUMN-LABEL "UTILEX!Precio S/." FORMAT "->>,>>9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 135 BY 16.35
         FONT 4
         TITLE "LISTA MINORISTA - UTILEX" FIT-LAST-COLUMN.
...
"T-MATG.CtoTot" "Costo Total!S/." ">>>,>>9.9999" "decimal" 14 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.MrgAlt[1]
"T-MATG.MrgAlt[1]" "UTILEX!% Uti" ? "decimal" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATG.PreAlt[1]
"T-MATG.PreAlt[1]" "UTILEX!Precio S/." ? "decimal" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.UndAlt[1]
"T-MATG.UndAlt[1]" "UTILEX!UM" "x(6)" "character" 14 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* LISTA MINORISTA - UTILEX */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* LISTA MINORISTA - UTILEX */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* LISTA MINORISTA - UTILEX */
DO:
