...
FOR EACH Vtactickets NO-LOCK WHERE Vtactickets.codcia = s-codcia
    AND VtaCTickets.CodPro = s-CodPro 
    ...
    IF VtaCTickets.Pos_YearVcto = '9999' THEN x-Ano = STRING(TODAY, '9999').
    ...
    IF TODAY > x-FchVto THEN DO:
        MESSAGE 'El Ticket venció el' x-FchVto VIEW-AS ALERT-BOX ERROR.
        RETURN 'ADM-ERROR'.
    END.
    /* Digito verificador */
