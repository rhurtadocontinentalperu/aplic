...
FacCPedi.Atencion FacCPedi.Cmpbnte FacCPedi.LugEnt FacCPedi.CodMon ~
...
FacCPedi.fchven FacCPedi.RucCli FacCPedi.Atencion FacCPedi.Cmpbnte ~
FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.Glosa FacCPedi.FlgIgv ~
FacCPedi.CodVen FacCPedi.FmaPgo FacCPedi.NroCard 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 26 COLON-ALIGNED WIDGET-ID 2
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 3.42 COL 94 COLON-ALIGNED WIDGET-ID 6
          LABEL "Comprobante"
     ...
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 4.23 COL 96 NO-LABEL
...
"US$", 2
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Glosa AT ROW 5.04 COL 6.28 FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgIgv AT ROW 5.04 COL 96 NO-LABEL WIDGET-ID 22
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
     ...
     FacCPedi.NroCard AT ROW 7.46 COL 9 COLON-ALIGNED
          ...
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 7.46 COL 21 COLON-ALIGNED NO-LABEL
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.04 COL 89 WIDGET-ID 26
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 4.5 COL 89
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  IF FacCPedi.FlgEst <> "A" THEN DO:
      RUN vta2/R-CotMin (ROWID(FacCPedi)).
  END.
...
IF NOT AVAILABLE FacCPedi THEN RETURN "ADM-ERROR".
IF LOOKUP(FacCPedi.FlgEst,"C,A,X") > 0 THEN DO:
