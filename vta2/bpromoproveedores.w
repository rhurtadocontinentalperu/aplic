...
&Scoped-define INTERNAL-TABLES VtaDTabla gn-prov
...
gn-prov.NomPro VtaDTabla.Libre_d01 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaDTabla OF VtaCTabla WHERE ~{&KEY-PHRASE} ~
      ...
      AND gn-prov.CodCia = pv-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaDTabla gn-prov
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDTabla.LlaveDetalle COLUMN-LABEL "Proveedor" FORMAT "x(11)":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      gn-prov.NomPro FORMAT "x(60)":U WIDTH 65.86
      VtaDTabla.Libre_d01 COLUMN-LABEL "Mínimo en Soles" FORMAT ">>>,>>9.99":U
            WIDTH 10.72 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
      VtaDTabla.LlaveDetalle
      VtaDTabla.Libre_d01
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 94 BY 4.04
         FONT 4
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaDTabla OF INTEGRAL.VtaCTabla,INTEGRAL.gn-prov WHERE INTEGRAL.VtaDTabla ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "VtaDTabla.Tipo = ""P"""
     _JoinCode[2]      = "gn-prov.CodPro = VtaDTabla.LlaveDetalle"
     _Where[2]         = "gn-prov.CodCia = pv-codcia"
     _FldNameList[1]   > INTEGRAL.VtaDTabla.LlaveDetalle
"VtaDTabla.LlaveDetalle" "Proveedor" "x(11)" "character" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-prov.NomPro
"gn-prov.NomPro" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "65.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaDTabla.Libre_d01
"VtaDTabla.Libre_d01" "Mínimo en Soles" ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF RETURN-VALUE = 'YES' THEN DO:
    IF CAN-FIND(FIRST Vtadtabla OF Vtactabla WHERE VtaDTabla.Tipo = 'P'
