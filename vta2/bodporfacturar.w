...
/*         RETURN.                                                              */
/*     END.                                                                     */
/*     RUN vta2/d-fraccionar-od ( ROWID(Faccpedi), OUTPUT rpta ).               */
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN vta2/dgenerafacturacredito ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    RUN vta2/d-distribucion-factura-cred ( ROWID(Faccpedi), OUTPUT rpta ).
    IF rpta = 'ADM-ERROR' THEN RETURN 'ADM-ERROR'.
    RUN vta2/dgenerafacturacredito ( ROWID(FacCPedi), 'M' ).       /* MANUAL */
