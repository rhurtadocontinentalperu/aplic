...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vpedidocreditomay.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vpedidocreditomay ).
       RUN set-position IN h_vpedidocreditomay ( 2.58 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.65 , 119.00 ) */
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-pedido-cred ( 12.35 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedido-cred ( 12.35 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 23.92 , 2.00 ) NO-ERROR.
