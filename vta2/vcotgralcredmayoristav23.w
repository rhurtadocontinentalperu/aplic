...
FacCPedi.fchven FacCPedi.Libre_c04 FacCPedi.RucCli FacCPedi.Atencion ~
FacCPedi.FchEnt FacCPedi.NomCli FacCPedi.DirCli FacCPedi.ordcmp ~
FacCPedi.Sede FacCPedi.Cmpbnte FacCPedi.LugEnt FacCPedi.CodMon ~
FacCPedi.Glosa FacCPedi.TpoCmb FacCPedi.CodPos FacCPedi.FlgIgv ~
FacCPedi.CodVen FacCPedi.Libre_d01 FacCPedi.FmaPgo FacCPedi.CodRef ~
FacCPedi.NroRef FacCPedi.NroCard FacCPedi.LugEnt2 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.Libre_c01 ~
FacCPedi.FchPed FacCPedi.CodCli FacCPedi.FaxCli FacCPedi.fchven ~
FacCPedi.Libre_c04 FacCPedi.RucCli FacCPedi.Atencion FacCPedi.FchEnt ~
...
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-1 FILL-IN-marco ~
FILL-IN-sede FILL-IN-cmpbnte FILL-IN-moneda FILL-IN-Postal f-NomVen ~
FILL-IN-redondeo F-CndVta F-Nomtar txtStkLetras FILL-IN-stkletras ~
PuntodeSalida 
...
DEFINE VARIABLE FILL-IN-moneda AS CHARACTER FORMAT "X(15)":U INITIAL "Moneda" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE FILL-IN-redondeo AS CHARACTER FORMAT "X(30)":U INITIAL "Redondeo del P.U." 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE FILL-IN-stkletras AS CHARACTER FORMAT "X(30)":U INITIAL "Stock de Letras" 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .81
...
DEFINE FRAME F-Main
     FacCPedi.NroPed AT ROW 1 COL 15 COLON-ALIGNED WIDGET-ID 58
          LABEL "Número" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     F-Estado AT ROW 1 COL 33 COLON-ALIGNED WIDGET-ID 114
     FacCPedi.Libre_c01 AT ROW 1 COL 64 COLON-ALIGNED WIDGET-ID 126
     ...
     FacCPedi.FchPed AT ROW 1 COL 98 COLON-ALIGNED WIDGET-ID 46
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.CodCli AT ROW 1.77 COL 15 COLON-ALIGNED WIDGET-ID 38
          LABEL "Cliente"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FaxCli AT ROW 1.77 COL 28 COLON-ALIGNED NO-LABEL WIDGET-ID 124 FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
          FONT 6
     BUTTON-Turno-Retrocede AT ROW 1.77 COL 46 WIDGET-ID 34
     BUTTON-Turno-Avanza AT ROW 1.77 COL 51 WIDGET-ID 32
     FILL-IN-1 AT ROW 1.77 COL 54 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     FacCPedi.fchven AT ROW 1.77 COL 98 COLON-ALIGNED WIDGET-ID 48 FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Libre_c04 AT ROW 1.81 COL 76 NO-LABEL WIDGET-ID 144
...
"No", ""
     ...
     FILL-IN-marco AT ROW 1.85 COL 62.57 COLON-ALIGNED NO-LABEL WIDGET-ID 154
     FacCPedi.RucCli AT ROW 2.54 COL 15 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.Atencion AT ROW 2.54 COL 33 COLON-ALIGNED WIDGET-ID 88
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FchEnt AT ROW 2.54 COL 98 COLON-ALIGNED WIDGET-ID 130
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.NomCli AT ROW 3.31 COL 15 COLON-ALIGNED WIDGET-ID 54 FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 69 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.usuario AT ROW 3.31 COL 98 COLON-ALIGNED WIDGET-ID 66
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.DirCli AT ROW 4.08 COL 15 COLON-ALIGNED WIDGET-ID 44
          LABEL "Dirección" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 69 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.ordcmp AT ROW 4.08 COL 98 COLON-ALIGNED WIDGET-ID 118 FORMAT "X(25)"
          VIEW-AS FILL-IN 
          SIZE 20 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Sede AT ROW 4.85 COL 15 COLON-ALIGNED WIDGET-ID 62
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-sede AT ROW 4.85 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     FacCPedi.Cmpbnte AT ROW 4.85 COL 100 NO-LABEL WIDGET-ID 102
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "FAC", "FAC":U,
"BOL", "BOL":U
          SIZE 15 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-cmpbnte AT ROW 4.88 COL 87.57 COLON-ALIGNED NO-LABEL WIDGET-ID 156
...
DEFINE FRAME F-Main
     FacCPedi.LugEnt AT ROW 5.62 COL 15 COLON-ALIGNED WIDGET-ID 112
          LABEL "Entregar en" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 5.62 COL 100 NO-LABEL WIDGET-ID 78
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dólares", 2
          SIZE 15 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-moneda AT ROW 5.69 COL 90.72 COLON-ALIGNED NO-LABEL WIDGET-ID 158
     FacCPedi.Glosa AT ROW 6.38 COL 15 COLON-ALIGNED WIDGET-ID 110
          LABEL "Glosa" FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.TpoCmb AT ROW 6.38 COL 98 COLON-ALIGNED WIDGET-ID 64
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     FacCPedi.CodPos AT ROW 7.15 COL 15 COLON-ALIGNED WIDGET-ID 136
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FILL-IN-Postal AT ROW 7.15 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FacCPedi.FlgIgv AT ROW 7.15 COL 100 WIDGET-ID 116
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY .77
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodVen AT ROW 7.92 COL 15 COLON-ALIGNED WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 11 FGCOLOR 0 
     f-NomVen AT ROW 7.92 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     FILL-IN-redondeo AT ROW 7.92 COL 83.86 COLON-ALIGNED NO-LABEL WIDGET-ID 160
     FacCPedi.Libre_d01 AT ROW 7.92 COL 100 NO-LABEL WIDGET-ID 96
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "2", 2,
"3", 3,
...
"5", 5
          SIZE 15 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FmaPgo AT ROW 8.69 COL 15 COLON-ALIGNED WIDGET-ID 50
          LABEL "Condición de Venta"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 11 FGCOLOR 0 
     F-CndVta AT ROW 8.69 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     FacCPedi.CodRef AT ROW 8.69 COL 98 COLON-ALIGNED WIDGET-ID 120
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 8.69 COL 103 COLON-ALIGNED NO-LABEL WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NroCard AT ROW 9.46 COL 15 COLON-ALIGNED WIDGET-ID 56
          LABEL "Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     F-Nomtar AT ROW 9.46 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 92
     txtStkLetras AT ROW 9.62 COL 98 COLON-ALIGNED NO-LABEL WIDGET-ID 152
     FILL-IN-stkletras AT ROW 9.65 COL 84 COLON-ALIGNED NO-LABEL WIDGET-ID 162
     FacCPedi.LugEnt2 AT ROW 10.23 COL 15 COLON-ALIGNED WIDGET-ID 132
          LABEL "Punto de Distribucion" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     PuntodeSalida AT ROW 10.23 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 140
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4 WIDGET-ID 100.
...
/* SETTINGS FOR FILL-IN FILL-IN-Postal IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-redondeo IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-sede IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-stkletras IN FRAME F-Main
   NO-ENABLE                                                            */
...
FOR EACH Facdpedi OF Faccpedi NO-LOCK WHERE Facdpedi.Libre_c05 <> "OF" :
    ...
    /* ************************* */
    /* RHC 02/12/2019 Ampliación */
    /* ************************* */
    IF Facdpedi.Libre_c04 = 'DVXDSF'    THEN ASSIGN ITEM.Por_Dsctos[3] = 0.
    IF Facdpedi.Libre_c04 = 'DVXSALDOC' THEN ASSIGN ITEM.Por_Dsctos[1] = 0 ITEM.Por_Dsctos[3] = 0.
    /* ************************* */
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE cotizacion-tablet V-table-Win 
PROCEDURE cotizacion-tablet :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  IF s-tpoped = 'TBLT' THEN DO:
      DO WITH FRAME {&FRAME-NAME}:
          ...
          FRAME f-main:HEIGHT = 5.58.

          RUN ocultar-campos(INPUT faccpedi.libre_d01:HANDLE).
          RUN ocultar-campos(INPUT fill-in-redondeo:HANDLE).
          
          RUN ocultar-campos(INPUT faccpedi.dircli:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.sede:HANDLE).
          RUN ocultar-campos(INPUT fill-in-sede:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.codpos:HANDLE).
          RUN ocultar-campos(INPUT fill-in-postal:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.NroCard:HANDLE).
          RUN ocultar-campos(INPUT f-nomtar:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.lugent2:HANDLE).
          RUN ocultar-campos(INPUT puntodesalida:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.codref:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.nroref:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.nroped:HANDLE).
          RUN ocultar-campos(INPUT f-estado:HANDLE).
          RUN ocultar-campos(INPUT fill-in-1:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.fchven:HANDLE).
          RUN ocultar-campos(INPUT button-turno-avanza:HANDLE).
          RUN ocultar-campos(INPUT button-turno-retrocede:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.tpocmb:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.usuario:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.libre_c04:HANDLE).
          RUN ocultar-campos(INPUT fill-in-marco:HANDLE).
          
          RUN ocultar-campos(INPUT faccpedi.ordcmp:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.flgigv:HANDLE).
          RUN ocultar-campos(INPUT faccpedi.codmon:HANDLE).
          RUN ocultar-campos(INPUT fill-in-moneda:HANDLE).
          
          RUN ocultar-campos(INPUT txtStkLetras:HANDLE).
          RUN ocultar-campos(INPUT fill-in-Stkletras:HANDLE).
          
          
          /**/
          RUN reposicionar-campos(INPUT faccpedi.codcli:HANDLE, 98, 3).
          RUN reposicionar-campos(INPUT faccpedi.faxcli:HANDLE, 189, 3).
          RUN reposicionar-campos(INPUT faccpedi.ruccli:HANDLE, 284, 3).
          RUN reposicionar-campos(INPUT faccpedi.atencion:HANDLE, 399, 3).
          RUN reposicionar-campos(INPUT faccpedi.fchped:HANDLE, 679, 3).

          RUN reposicionar-campos(INPUT faccpedi.nomcli:HANDLE, 98, 26).
          RUN reposicionar-campos(INPUT faccpedi.fchent:HANDLE, 679, 26).
          RUN reposicionar-campos(INPUT faccpedi.lugent:HANDLE, 98, 47).
          RUN reposicionar-campos(INPUT faccpedi.cmpbnte:HANDLE, 658, 47).
          RUN reposicionar-campos(INPUT fill-in-cmpbnte:HANDLE, 567, 47).          

          RUN reposicionar-campos(INPUT faccpedi.glosa:HANDLE, 98, 68).
          RUN reposicionar-campos(INPUT faccpedi.libre_c01:HANDLE, 672, 68).

          RUN reposicionar-campos(INPUT faccpedi.codven:HANDLE, 97, 90).
          RUN reposicionar-campos(INPUT f-nomven:HANDLE, 143, 90).
          RUN reposicionar-campos(INPUT faccpedi.fmapgo:HANDLE, 97, 110).
          RUN reposicionar-campos(INPUT f-cndvta:HANDLE, 143, 110).
...
END PROCEDURE.
/*
      fill-in-marco:SCREEN-VALUE = "Lista MARCO?".
      fill-in-cmpbnte:SCREEN-VALUE = "Comprobante".
      fill-in-moneda:SCREEN-VALUE = "Moneda".
      fill-in-redondeo:SCREEN-VALUE = "Redondeo del P.U.:".
      fill-in-Stkletras:SCREEN-VALUE = "Stock de Letras".
...
DEFINE VAR x-factor-igv AS DEC.
...
FOR EACH facdpedi OF faccpedi NO-LOCK,
    ...
    */
    ...
    END.
    ELSE DO:
        x-factor-igv = FacCPedi.PorIgv.

        IF Facdpedi.aftigv = NO THEN x-factor-igv = 0.
        ...
        IF Facdpedi.Por_Dsctos[1] = 0
            ...
            F-ImpLin = ROUND(FacDPedi.ImpLin / (1 + FacCPedi.PorIgv / 100), 2).
            */
            F-PreUni = ROUND(FacDPedi.PreUni / (1 + x-factor-igv / 100), 4).
            F-ImpLin = ROUND(FacDPedi.ImpLin / (1 + x-factor-igv / 100), 2).
        END.
        ELSE DO:
            /*
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Importar-Supermercados-porrevisar V-table-Win 
PROCEDURE Importar-Supermercados-porrevisar :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       Cambio de lógica
------------------------------------------------------------------------------*/
...
DEFINE VAR x-TaxMoa AS LOG NO-UNDO.
...
REPEAT:
    ...
    /* DATOS DEL CLIENTE */
    /* ************************************************************************************** */
        WHEN x-Linea BEGINS 'ENC' THEN DO:
            ASSIGN
                x-Encabezado = YES
                x-Detalle    = NO
                x-CodMat = ''
        ...
        END.
        /* Sede y Lugar de Entrega */
        WHEN x-Linea BEGINS 'DPGR' AND NUM-ENTRIES(x-Linea) > 1 THEN DO:
            cSede = TRIM(ENTRY(2,x-Linea)).
        END.
        /* Cliente */
        WHEN x-Linea BEGINS 'IVAD' AND NUM-ENTRIES(x-Linea) > 1 THEN DO:
            cCodCli = TRIM(ENTRY(2,x-Linea)).
            /* PINTAMOS INFORMACION */
            FIND FIRST gn-clie WHERE gn-clie.codcia = cl-codcia
                AND gn-clie.codibc = cCodCli
    ...
    /* DATOS DEL DETALLE */
    /* ************************************************************************************** */
        WHEN x-Linea BEGINS 'LIN' THEN DO:
            CREATE ITEM.    /* Registro Nuevo */
            x-Item = ENTRY(2,x-Linea).
            IF NUM-ENTRIES(x-Linea) = 6
            THEN ASSIGN x-CodMat = STRING(INTEGER(ENTRY(6,x-Linea)), '999999') NO-ERROR.
            ELSE ASSIGN x-CodMat = ENTRY(3,x-Linea) NO-ERROR.
            ...
            ASSIGN 
                ...
                ITEM.NroItm = x-NroItm.
        END.
        WHEN x-Linea BEGINS 'QTY' THEN DO:
            x-CanPed = DECIMAL(ENTRY(2,x-Linea)).
            IF AVAILABLE ITEM THEN ASSIGN ITEM.CanPed = x-CanPed.
        END.
        WHEN x-Linea BEGINS 'MOA' THEN DO:
            x-ImpLin = DECIMAL(ENTRY(2,x-Linea)).
            IF AVAILABLE ITEM THEN ASSIGN ITEM.ImpLin = x-ImpLin.
        END.
        WHEN x-Linea BEGINS 'TAX' THEN DO:
            IF NUM-ENTRIES(x-Linea) > 1 THEN ASSIGN  x-ImpIgv = DECIMAL(ENTRY(2,x-Linea)).
            IF NUM-ENTRIES(x-Linea) > 2 THEN ASSIGN  x-ImpIgv = DECIMAL(ENTRY(3,x-Linea)).
            /* consistencia de duplicidad */
            IF AVAILABLE ITEM THEN DO:
                ASSIGN ITEM.AftIgv = (IF x-ImpIgv > 0 THEN YES ELSE NO).
                x-TaxMoa = YES.
            END.
        END.
    END CASE.
  ...
  INPUT CLOSE.
  /* Si no hay TAX */
  IF x-TaxMoa = NO THEN DO:
      FOR EACH ITEM:
          FIND Almmmatg WHERE Almmmatg.codcia = s-codcia AND
              Almmmatg.codmat = ITEM.codmat NO-LOCK NO-ERROR.
          ASSIGN
              ITEM.aftigv = Almmmatg.aftigv.
          IF ITEM.AftIgv = YES THEN DO:
              ASSIGN
                  x-ImpLin = ROUND(ITEM.ImpLin * (1 + (s-PorIgv / 100)), 2).
              ASSIGN
                  ITEM.ImpIgv = x-ImpLin - ITEM.ImpLin.
/*               ASSIGN                                                                                */
/*                   x-PreUni = ROUND(x-ImpLin / ITEM.CanPed, 5).                                      */
/*               ASSIGN                                                                                */
/*                   ITEM.ImpIgv = ROUND( ITEM.ImpLin / (1 + (s-PorIgv / 100)) * (s-PorIgv / 100), 2). */
          END.
      END.
  END.
  /* BARRIDO FINAL */
  FOR EACH ITEM:
      ...
      IF LOOKUP(TRIM(s-CodCli), '20100070970,20109072177,20100106915,20504912851') > 0
      THEN ASSIGN
              ITEM.PreUni = ROUND(ITEM.ImpLin / ITEM.CanPed, 5).
      ELSE ASSIGN
              ITEM.ImpLin = ITEM.ImpLin + ITEM.ImpIgv
              ITEM.PreUni = ROUND(ITEM.ImpLin / ITEM.CanPed, 5).
  END.
  /* BLOQUEAMOS CAMPOS */
  ASSIGN
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    */
    ASSIGN FacCPedi.NroPed:SCREEN-VALUE = STRING(FacCorre.NroSer, '999') + STRING(FacCorre.Correlativo, '999999')
            FacCPedi.FchPed:SCREEN-VALUE = STRING(TODAY,"99/99/9999")
            FacCPedi.TpoCmb:SCREEN-VALUE = STRING(S-TPOCMB,">9.9999")
            FacCPedi.FchVen:SCREEN-VALUE = STRING(TODAY + s-DiasVtoCot,"99/99/9999")
...
------------------------------------------------------------------------------*/
  ...
  ELSE DO:
      /* **************************************************************************** */
      /* RHC 07/03/2020 EN CASO DE QUE HAYA SUFRIDO UNA MODIFICACION POR OTRO USUARIO
        O SE HALLA GENERADO UN PEDIDO */
      /* **************************************************************************** */
      FIND B-CPEDI WHERE ROWID(B-CPEDI) = ROWID(Faccpedi) NO-LOCK NO-ERROR.
      IF AVAILABLE B-CPEDI THEN DO:
          IF LOOKUP(B-CPEDI.FlgEst,"E,P,T,I") = 0 THEN DO:
              pMensaje = 'La Cotización ha sido actualizada por otro usuario'.
