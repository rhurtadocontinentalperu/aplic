...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.Orden COLUMN-LABEL "Config. de Desctos." FORMAT "9":U
            WIDTH 14.29 COLUMN-FONT 4 VIEW-AS COMBO-BOX INNER-LINES 5
...
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "46" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.UndStk
"Almmmatg.UndStk" "Unidad" "X(6)" "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.Dec__01" "% Uti Ofi" "->>>,>>9.9999" "decimal" 12 15 ? ? ? ? yes ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.PreOfi
"T-MATG.PreOfi" "Precio Oficina!S/." ">>>,>>9.9999" "decimal" 12 15 ? ? ? ? yes ? no no "11.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-MATG.Orden
"T-MATG.Orden" "Config. de Desctos." "9" "integer" ? ? 4 ? ? ? yes ? no no "14.29" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Normal,0,Sin Descuentos,1" 5 no 0 no no
