...
FacCPedi.Atencion FacCPedi.fchven FacCPedi.NomCli FacCPedi.DirCli ~
...
FacCPedi.NomCli FacCPedi.usuario FacCPedi.DirCli FacCPedi.Cmpbnte ~
FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.NroCard FacCPedi.TpoCmb ~
FacCPedi.Sede FacCPedi.FlgIgv FacCPedi.CodVen FacCPedi.NroRef ~
FacCPedi.FmaPgo FacCPedi.ordcmp FacCPedi.CodAlm FacCPedi.Glosa ~
FacCPedi.TpoLic 
...
------------------------------------------------------------------------------*/
    ...
    IF LOOKUP(FacCPedi.FlgEst,"A,C,E,R,P") > 0 THEN DO:
