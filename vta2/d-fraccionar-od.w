...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 12.31 COL 74
     Btn_Cancel AT ROW 12.31 COL 89
     SPACE(2.71) SKIP(0.10)
...
DO:
    ...
    IF x-item > FacCfgGn.Items_Guias THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    MESSAGE 'Se va aprodecer a fraccionar la Orden de Despacho' SKIP(1)
        'Procedemos?'
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  't-distribucion-factura-cred.w':U ,
