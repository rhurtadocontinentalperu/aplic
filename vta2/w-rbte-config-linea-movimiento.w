...
DEFINE VARIABLE FILL-IN-titulo AS CHARACTER FORMAT "X(50)":U INITIAL "  Lineas/sub-lineas para la meta" 
     VIEW-AS FILL-IN 
     SIZE 62.72 BY 1.23
     BGCOLOR 10 FGCOLOR 0 FONT 11 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     FILL-IN-titulo AT ROW 1 COL 1.14 NO-LABEL WIDGET-ID 16
     BUTTON-cargar AT ROW 2.31 COL 96.86 WIDGET-ID 20
     ...
     BUTTON-cancelar AT ROW 17.62 COL 61.57 WIDGET-ID 22
...
ON CHOOSE OF BUTTON-cancelar IN FRAME F-Main /* Seleccionar Proceso! */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-rbte-config-linea-movimiento.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rbte-config-linea-movimiento ).
       RUN set-position IN h_b-rbte-config-linea-movimiento ( 3.73 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-rbte-config-linea-movimiento ( 13.46 , 121.00 ) NO-ERROR.
