...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ITEM.codmat FORMAT "X(14)":U
      Almmmatg.DesMat FORMAT "X(60)":U WIDTH 59.14
  ENABLE
      ITEM.codmat
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 78 BY 8.85
         FONT 4
         TITLE "INGRESE LOS PRODUCTOS A RASTREAR" FIT-LAST-COLUMN.
...
"ITEM.codmat" ? "X(14)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "59.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* INGRESE LOS PRODUCTOS A RASTREAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* INGRESE LOS PRODUCTOS A RASTREAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* INGRESE LOS PRODUCTOS A RASTREAR */
DO:
...
ON LEAVE OF ITEM.codmat IN BROWSE br_table /* Codigo Articulo */
DO:
