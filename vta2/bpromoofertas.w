...
"VtaDTabla.Libre_d02" "Máximo" ">>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaDTabla.Libre_d04
"VtaDTabla.Libre_d04" "Mínimo!S/." ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
