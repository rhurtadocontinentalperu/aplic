...
&Scoped-Define ENABLED-FIELDS FacCPedi.FchPed FacCPedi.LugEnt ~
FacCPedi.CodRef FacCPedi.NroRef FacCPedi.Sede FacCPedi.Glosa 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.FchPed ~
FacCPedi.CodCli FacCPedi.RucCli FacCPedi.Atencion FacCPedi.FchEnt ~
...
FacCPedi.FmaPgo FacCPedi.CodOrigen FacCPedi.CodAlm FacCPedi.NroOrigen ~
FacCPedi.Glosa 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-Situac F-Nomtar FILL-IN-sede ~
F-nOMvEN F-CndVta f-NomAlm FILL-IN-Libre_c16 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 137.43 COLON-ALIGNED
          LABEL "Emision"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.Atencion AT ROW 1.81 COL 54 COLON-ALIGNED WIDGET-ID 4
          ...
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     FacCPedi.FchEnt AT ROW 1.81 COL 137.43 COLON-ALIGNED WIDGET-ID 116
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     FacCPedi.NomCli AT ROW 2.62 COL 16 COLON-ALIGNED
          LABEL "Nombre" FORMAT "x(100)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.usuario AT ROW 2.62 COL 137.43 COLON-ALIGNED WIDGET-ID 56
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     FacCPedi.DirCli AT ROW 3.42 COL 16 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.ordcmp AT ROW 3.42 COL 137.43 COLON-ALIGNED
     ...
     FacCPedi.LugEnt AT ROW 4.23 COL 16 COLON-ALIGNED WIDGET-ID 20
          ...
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.CodRef AT ROW 4.23 COL 137.43 COLON-ALIGNED WIDGET-ID 114
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 15 FGCOLOR 12 
     FacCPedi.NroRef AT ROW 4.23 COL 142.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 11.86 BY .81
          BGCOLOR 15 FGCOLOR 12 
     ...
     FacCPedi.CodMon AT ROW 5.04 COL 139 NO-LABEL WIDGET-ID 46
...
"US$", 2
     ...
     FacCPedi.FlgIgv AT ROW 5.85 COL 139 WIDGET-ID 58
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 11.29 BY .77
...
DEFINE FRAME F-Main
     FacCPedi.CodOrigen AT ROW 7.46 COL 139 COLON-ALIGNED NO-LABEL WIDGET-ID 172
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     ...
     FacCPedi.NroOrigen AT ROW 8.27 COL 139 COLON-ALIGNED NO-LABEL WIDGET-ID 174
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
     FacCPedi.Glosa AT ROW 9.08 COL 13.28 FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 70 BY .81
     FILL-IN-Libre_c16 AT ROW 9.88 COL 16 COLON-ALIGNED WIDGET-ID 170
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.31 COL 101.57 WIDGET-ID 54
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
FOR EACH FacDPedi OF FacCPedi NO-LOCK,
    ...
    ASSIGN 
        ...
        Reporte.CodUbi = "G-0"
        Reporte.CodZona = "G-0".
    IF Facdpedi.Libre_c05 <> '' AND Facdpedi.Libre_c05 <> 'OF'  
        THEN Reporte.DesMat = Facdpedi.Libre_c05 + ' - ' + Almmmatg.desmat.
...
FOR EACH FacDPedi OF FacCPedi NO-LOCK,
    ...
    ASSIGN 
        ...
        Reporte.CodZona = "G-0".
    IF Facdpedi.Libre_c05 <> '' AND Facdpedi.Libre_c05 <> 'OF'  
        THEN Reporte.DesMat = Facdpedi.Libre_c05.
    FIND FIRST Almmmate WHERE Almmmate.CodCia = FacCPedi.CodCia
        AND Almmmate.CodAlm = FacDPedi.AlmDes
...
------------------------------------------------------------------------------*/
    ...
    IF FacCPedi.FlgEst = "P" AND FacCPedi.FlgSit = "O" THEN DO:
        MESSAGE 'Tiene una Orden de Transferencia (OTR) en proceso' VIEW-AS ALERT-BOX WARNING.
        RETURN "ADM-ERROR".
    END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE FacCPedi THEN DO WITH FRAME {&FRAME-NAME}:
      ...
      CASE Faccpedi.FlgSit:
          WHEN 'P' THEN F-Situac = "PRE-PICKEADO OK  ".
          WHEN 'C' THEN F-Situac = "PICKEADO OK      ".
          WHEN 'T' THEN F-Situac = "FALTA PRE-PICKEAR".
          WHEN 'O' THEN F-Situac  = "CON OTR EN TRAMITE".
          OTHERWISE F-Situac = "".
      END CASE.
      RUN logis/p-logtrkdocs (Faccpedi.CodDoc, 
                              Faccpedi.NroPed, 
                              Faccpedi.DivDes, 
                              OUTPUT F-Situac).
...
------------------------------------------------------------------------------*/
  ...
  CASE cMode:
      WHEN '1' THEN RUN vta/R-ImpOD-sunat (ROWID(FacCPedi)).
      WHEN '2' THEN RUN Imprimir1.
      WHEN '3' THEN DO: 
            RUN vta/R-ImpOD-sunat (ROWID(FacCPedi)).
            RUN Imprimir1.
      END.
  END CASE.
