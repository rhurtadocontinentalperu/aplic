...
VtaCDocu.CodPos VtaCDocu.CodVen VtaCDocu.NroRef VtaCDocu.FmaPgo ~
VtaCDocu.NroCard 
...
VtaCDocu.Cmpbnte VtaCDocu.Sede VtaCDocu.LugEnt VtaCDocu.CodMon ~
VtaCDocu.Glosa VtaCDocu.FlgIgv VtaCDocu.CodPos VtaCDocu.CodRef ~
VtaCDocu.CodVen VtaCDocu.NroRef VtaCDocu.FmaPgo VtaCDocu.NroCard 
...
DEFINE FRAME F-Main
     ...
     VtaCDocu.DniCli AT ROW 3.58 COL 28.29 COLON-ALIGNED WIDGET-ID 42
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.Cmpbnte AT ROW 4.31 COL 98 COLON-ALIGNED
     ...
     VtaCDocu.LugEnt AT ROW 5.19 COL 9 COLON-ALIGNED WIDGET-ID 30
          ...
          SIZE 44.29 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.CodMon AT ROW 5.19 COL 100 NO-LABEL
...
"US$", 2
     ...
     VtaCDocu.Glosa AT ROW 6 COL 6.28
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.FlgIgv AT ROW 6 COL 100 NO-LABEL WIDGET-ID 38
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
          SIZE 11 BY .58
     VtaCDocu.CodPos AT ROW 6.81 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-Postal AT ROW 6.81 COL 14.43 COLON-ALIGNED NO-LABEL
     VtaCDocu.CodRef AT ROW 6.81 COL 98 COLON-ALIGNED WIDGET-ID 44
          LABEL "Referencia"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     VtaCDocu.CodVen AT ROW 7.62 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
...
DEFINE FRAME F-Main
     F-nOMvEN AT ROW 7.62 COL 14.43 COLON-ALIGNED NO-LABEL
     VtaCDocu.NroRef AT ROW 7.62 COL 98 COLON-ALIGNED WIDGET-ID 46
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
     VtaCDocu.FmaPgo AT ROW 8.42 COL 9 COLON-ALIGNED
          LABEL "Cond.Vta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-CndVta AT ROW 8.42 COL 14.43 COLON-ALIGNED NO-LABEL
     VtaCDocu.NroCard AT ROW 9.23 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 9.23 COL 21.14 COLON-ALIGNED NO-LABEL
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.92 COL 93 WIDGET-ID 26
     "Moneda:" VIEW-AS TEXT
          SIZE 6.86 BY .5 AT ROW 5.27 COL 93
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
------------------------------------------------------------------------------*/
    ...
    IF lchoice THEN DO:
        ...
        END.
        ELSE DO: 
            RUN Vta2\genera-cotizacion-expo (ROWID(VtaCDocu),OUTPUT CNroPed).    
            IF cNroPed <> '' THEN
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH PEDI2 NO-LOCK WHERE PEDI2.ImpLin > 0
      BY PEDI2.NroItm:
      /*BY DECIMAL(PEDI2.Libre_c01) BY DECIMAL(PEDI2.Libre_c02):*/
      I-NITEM = I-NITEM + 1.
      CREATE VtaDDocu.
