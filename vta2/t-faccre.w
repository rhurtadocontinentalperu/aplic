...
Almmmatg.DesMat Almmmatg.DesMar DETA.UndVta DETA.CanDes DETA.PorDto ~
DETA.PreUni DETA.Por_Dsctos[1] DETA.Por_Dsctos[2] DETA.Por_Dsctos[3] ~
DETA.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)":U WIDTH 12.29
      DETA.UndVta COLUMN-LABEL "Unidad" FORMAT "x(10)":U WIDTH 5.43
      DETA.CanDes FORMAT ">>>,>>9.99":U
      DETA.PorDto COLUMN-LABEL "% Dscto.!Incluido" FORMAT "->>9.99":U
      DETA.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999":U
      DETA.Por_Dsctos[1] COLUMN-LABEL "% Dscto.!Manual" FORMAT "->>9.99":U
      DETA.Por_Dsctos[2] COLUMN-LABEL "% Dscto.!Evento" FORMAT "->>9.99":U
      DETA.Por_Dsctos[3] COLUMN-LABEL "% Dscto.!Vol. Prom." FORMAT "->>9.99":U
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 11.69 COL 17 COLON-ALIGNED
     F-TotBrt AT ROW 13.04 COL 19 NO-LABEL
     F-ImpExo AT ROW 13.04 COL 31 NO-LABEL
     F-ValVta AT ROW 13.04 COL 53.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 13.04 COL 65.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 13.04 COL 78.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 13.04 COL 91 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 13.08 COL 41 COLON-ALIGNED NO-LABEL
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.5 COL 56.86
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 12.46 COL 93.14
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 12.46 COL 83.14
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.5 COL 43.57
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.46 COL 20.86
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 12.46 COL 71.57
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.46 COL 31.43
...
"Almmmatg.DesMar" "Marca" "X(12)" "character" ? ? ? ? ? ? no ? no no "12.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"DETA.CanDes" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.DETA.PorDto
"DETA.PorDto" "% Dscto.!Incluido" "->>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.DETA.PreUni
"DETA.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.DETA.Por_Dsctos[1]
"DETA.Por_Dsctos[1]" "% Dscto.!Manual" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.DETA.Por_Dsctos[2]
"DETA.Por_Dsctos[2]" "% Dscto.!Evento" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.DETA.Por_Dsctos[3]
"DETA.Por_Dsctos[3]" "% Dscto.!Vol. Prom." ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.DETA.ImpLin
