...
DEFINE VARIABLE h_v-pedido-cont AS HANDLE NO-UNDO.
...
DO:
  RUN Asigna-Cotizacion IN h_v-pedido-cont.
...
DO:
  RUN Genera-Excel IN h_v-pedido-cont.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-pedido-cont.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-cont ).
       RUN set-position IN h_v-pedido-cont ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pedido-cont. */
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_v-pedido-cont ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-pedido-cont ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pedido-cont ,
