...
tt-w-report.Campo-C[6] tt-w-report.Campo-C[7] tt-w-report.Campo-C[5] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tt-w-report.Campo-C[4] COLUMN-LABEL "Descripcion Sub-Linea" FORMAT "X(50)":U
            WIDTH 31.86
      tt-w-report.Campo-C[6] COLUMN-LABEL "Marca" FORMAT "X(4)":U
      tt-w-report.Campo-C[7] COLUMN-LABEL "Descripcion Marca" FORMAT "X(60)":U
            WIDTH 29
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 121 BY 13.46
         FONT 4.
...
ASSIGN 
       ...
       tt-w-report.Campo-C[7]:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
"tt-w-report.Campo-C[2]" "Descripcion de la Linea" "X(50)" "character" ? ? ? ? ? ? yes ? no no "30.43" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
...
"tt-w-report.Campo-C[4]" "Descripcion Sub-Linea" "X(50)" "character" ? ? ? ? ? ? yes ? no no "31.86" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-w-report.Campo-C[6]
"tt-w-report.Campo-C[6]" "Marca" "X(4)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-w-report.Campo-C[7]
"tt-w-report.Campo-C[7]" "Descripcion Marca" "X(60)" "character" ? ? ? ? ? ? yes ? no no "29" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-w-report.Campo-C[1] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF tt-w-report.Campo-C[1] IN BROWSE br_table /* Linea */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-w-report.Campo-C[3] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF tt-w-report.Campo-C[3] IN BROWSE br_table /* Sub-Linea */
DO:
    ASSIGN
      input-var-1 = tt-w-report.campo-c[1]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}
      input-var-2 = ?
      input-var-3 = ?
      output-var-1 = ?
      output-var-2 = ''
    ...
    RUN lkup/c-subfam.r('SUB-LINEAS DE PRODUCTO').
    IF output-var-1 = ? THEN RETURN 'ADM-ERROR'.
...
&Scoped-define SELF-NAME tt-w-report.Campo-C[6]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-w-report.Campo-C[6] br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF tt-w-report.Campo-C[6] IN BROWSE br_table /* Marca */
DO:
    DEFINE VAR x-sublinea AS CHAR.
    DEFINE VAR x-linea AS CHAR.
    ...
    x-marca = SELF:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.
    x-linea = tt-w-report.campo-c[1]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.
    x-sublinea = tt-w-report.campo-c[3]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.

     hColumn = BROWSE br_table:GET-BROWSE-COLUMN(5).    

    IF NOT (TRUE <> (x-marca > "")) THEN DO:
        IF x-marca = '*' THEN DO:

            ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[7]:SCREEN-VALUE IN BROWSE br_table = "Todas las MARCAS".
            ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[5]:SCREEN-VALUE IN BROWSE br_table = "+".
            IF x-todas-lineas = YES THEN ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[5]:SCREEN-VALUE IN BROWSE br_table = "-".
        ...
        ELSE DO:
            FIND FIRST almtabla WHERE almtabla.tabla = 'MK' AND
                                        almtabla.codigo = x-marca NO-LOCK NO-ERROR.
            IF NOT AVAILABLE almtabla THEN DO:
                MESSAGE "Marca no existe" VIEW-AS ALERT-BOX INFORMATION.
                RETURN NO-APPLY.                
            END.

            ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[7]:SCREEN-VALUE IN BROWSE br_table = almtabla.nombre.
            ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[5]:SCREEN-VALUE IN BROWSE br_table = "+".
            IF x-todas-lineas = YES THEN ASSIGN {&FIRST-TABLE-IN-QUERY-br_table}.campo-c[5]:SCREEN-VALUE IN BROWSE br_table = "-".
    ...
    IF x-linea = "*" AND x-sublinea = '*' AND x-marca = '*' THEN DO:
        /*hColumn:read-only = YES.*/
    END.
...
ON 'RETURN':U OF tt-w-report.campo-c[1], tt-w-report.campo-c[2], 
                ...
                tt-w-report.campo-c[5], tt-w-report.campo-c[6],
                tt-w-report.campo-c[7] IN BROWSE {&BROWSE-NAME} DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH rbte_linea_movimiento WHERE rbte_linea_movimiento.codcia = s-codcia AND
                                            ...
                                            rbte_linea_movimiento.codrazon = x-motivo NO-LOCK:
          CREATE tt-w-report.
          ASSIGN    tt-w-report.campo-c[1] = rbte_linea_movimiento.codlinea
                    tt-w-report.campo-c[3] = rbte_linea_movimiento.codsublinea
                    tt-w-report.campo-c[5] = rbte_linea_movimiento.signo
                    tt-w-report.campo-c[6] = rbte_linea_movimiento.campo-c[3]
              .
          /* FAMILIA */
          ...
          IF tt-w-report.campo-c[3] = "*" THEN DO:
             ASSIGN tt-w-report.campo-c[4] = "<Todas las Sub-lineas>".
          END.
          ELSE DO:
              ...
              FIND FIRST almsfam WHERE almsfam.codcia = s-codcia AND
                                            ...
                                            NO-LOCK NO-ERROR.
              IF AVAILABLE almsfam THEN ASSIGN tt-w-report.campo-c[2] = almsfam.dessub.
          END.
          /* Marca */
          IF tt-w-report.campo-c[6] = "*" THEN DO:
             ASSIGN tt-w-report.campo-c[7] = "<Todas las Marcas>".
          END.
          ELSE DO:
              ASSIGN tt-w-report.campo-c[7] = "MARCA ERRADA".
              FIND FIRST almtabla WHERE almtabla.tabla = "MK" AND
                                            almtabla.codigo = tt-w-report.campo-c[6] NO-LOCK NO-ERROR.
              IF AVAILABLE almtabla THEN ASSIGN tt-w-report.campo-c[7] = almtabla.nombre.
          END.
...
------------------------------------------------------------------------------*/
  ...
  */
  ...
  FOR EACH rbte_linea_movimiento WHERE rbte_linea_movimiento.codcia = s-codcia AND
                                        ...
                                        rbte_linea_movimiento.codrazon = x-motivo NO-LOCK:
      CREATE ytt-w-report.
      ASSIGN    ytt-w-report.campo-c[1] = rbte_linea_movimiento.codlinea
                ytt-w-report.campo-c[3] = rbte_linea_movimiento.codsublinea
                ytt-w-report.campo-c[6] = rbte_linea_movimiento.campo-c[3]      /* MARCA */
                ytt-w-report.campo-c[5] = rbte_linea_movimiento.signo
          .
  END.
  ...
  FOR EACH ytt-w-report :
      ...
      FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = ytt-w-report.campo-c[1] AND
                                    xtt-w-report.campo-c[3] = ytt-w-report.campo-c[3] AND 
                                    xtt-w-report.campo-c[6] = ytt-w-report.campo-c[6] NO-LOCK NO-ERROR.
  ...
  DO TRANSACTION ON ERROR UNDO GRABACION, LEAVE GRABACION:  
      DO:
          ...
          FOR EACH ytt-w-report WHERE ytt-w-report.campo-c[10] = "X" :
              FIND FIRST rbte_linea_movimiento WHERE rbte_linea_movimiento.codcia = s-codcia AND
                                                        rbte_linea_movimiento.codproceso = x-proceso AND
                                                        rbte_linea_movimiento.codrazon = x-motivo AND
                                                        rbte_linea_movimiento.codlinea = ytt-w-report.campo-c[1] AND
                                                        rbte_linea_movimiento.codsublinea = ytt-w-report.campo-c[3] AND
                                                        rbte_linea_movimiento.campo-c[3] = ytt-w-report.campo-c[6]      /* MARCA */
                                                        EXCLUSIVE-LOCK NO-ERROR.
              IF AVAILABLE rbte_linea_movimiento THEN DO:
                  DELETE rbte_linea_movimiento NO-ERROR.
              END.
          ...
          FOR EACH xtt-w-report :
              FIND FIRST rbte_linea_movimiento WHERE rbte_linea_movimiento.codcia = s-codcia AND
                                                        rbte_linea_movimiento.codproceso = x-proceso AND
                                                        rbte_linea_movimiento.codrazon = x-motivo AND
                                                        rbte_linea_movimiento.codlinea = xtt-w-report.campo-c[1] AND
                                                        rbte_linea_movimiento.codsublinea = xtt-w-report.campo-c[3] AND
                                                        rbte_linea_movimiento.campo-c[3] = xtt-w-report.campo-c[6]  /* MARCA */
                                                        EXCLUSIVE-LOCK NO-ERROR.
              IF NOT AVAILABLE rbte_linea_movimiento THEN DO:
                  CREATE rbte_linea_movimiento.
                    ASSIGN rbte_linea_movimiento.codcia = s-codcia
                            rbte_linea_movimiento.codproceso = x-proceso
                            rbte_linea_movimiento.codrazon = x-motivo
                            rbte_linea_movimiento.codlinea = xtt-w-report.campo-c[1]
                            rbte_linea_movimiento.codsublinea = xtt-w-report.campo-c[3]
                            rbte_linea_movimiento.campo-c[3] = xtt-w-report.campo-c[6]      /* MARCA */
                            rbte_linea_movimiento.campo-c[1] = USERID("DICTDB") + "|" + STRING(TODAY,"99/99/9999") + "|" + STRING(TIME,"HH:MM:SS")
                            NO-ERROR
                            .
              END.
              ASSIGN rbte_linea_movimiento.signo = xtt-w-report.campo-c[5]
                        rbte_linea_movimiento.campo-c[2] = USERID("DICTDB") + "|" + STRING(TODAY,"99/99/9999") + "|" + STRING(TIME,"HH:MM:SS")
                  NO-ERROR.
...
x-marca = tt-w-report.campo-c[6]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.
...
FIND FIRST almtabla WHERE almtabla.tabla = "MK" AND
                            almtabla.codigo = x-marca NO-LOCK NO-ERROR.
IF x-marca <> "*" AND NOT AVAILABLE almtabla THEN DO:
    MESSAGE "La Marca no existe" VIEW-AS ALERT-BOX INFORMATION.
    RETURN "ADM-ERROR".
END.
FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea AND
                                xtt-w-report.campo-c[3] = x-sublinea AND 
                                xtt-w-report.campo-c[6] = x-Marca NO-LOCK NO-ERROR.
IF AVAILABLE xtt-w-report THEN DO:
    MESSAGE "Ya existe la Linea/Sub-Linea/Marca" VIEW-AS ALERT-BOX INFORMATION.
    RETURN "ADM-ERROR".
END.
IF x-marca = '*' THEN DO:
    IF x-sublinea = '*' THEN DO:
        ...
        ELSE DO:
            FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea /*AND
                                                xtt-w-report.campo-c[5] = "+"*/ NO-LOCK NO-ERROR.
            IF AVAILABLE xtt-w-report THEN DO:
                MESSAGE "Existe conflicto con la linea de registros anteriores" VIEW-AS ALERT-BOX INFORMATION.
                RETURN "ADM-ERROR".
            END.            
        END.
    END.
    ELSE DO:
        ...
        IF AVAILABLE xtt-w-report THEN DO:
            MESSAGE "Existe conflicto con la Linea/Sublinea de registros anteriores" VIEW-AS ALERT-BOX INFORMATION.
            RETURN "ADM-ERROR".
        END.            
...
ELSE DO: 
    IF x-sublinea = '*' THEN DO:
        IF x-linea = "*" THEN DO:
            FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = "*" AND
                                            xtt-w-report.campo-c[3] = "*" AND 
                                            xtt-w-report.campo-c[6] = "*" NO-LOCK NO-ERROR.
            IF AVAILABLE xtt-w-report THEN DO:
                MESSAGE "Existe conflicto con TODAS las Lineas/Sublineas/Marcas" VIEW-AS ALERT-BOX INFORMATION.
                RETURN "ADM-ERROR".
            END.
        END.
        ELSE DO:
            FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = "*" AND
                                            ...
                                            xtt-w-report.campo-c[6] = "*" NO-LOCK NO-ERROR.
            IF AVAILABLE xtt-w-report THEN DO:
                MESSAGE "Existe conflicto con TODAS las Lineas/Sublineas/Marcas (1)" VIEW-AS ALERT-BOX INFORMATION.
                RETURN "ADM-ERROR".
            END.
            ...
            FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea AND
                                            ...
                                            xtt-w-report.campo-c[6] = "*" NO-LOCK NO-ERROR.
            IF AVAILABLE xtt-w-report THEN DO:
                MESSAGE "Existe conflicto con Lineas/Sublineas y todas las Marcas" VIEW-AS ALERT-BOX INFORMATION.
                RETURN "ADM-ERROR".
            END.
            ...
            FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = "*" AND
                                            ...
                                            xtt-w-report.campo-c[6] = x-marca NO-LOCK NO-ERROR.
            IF AVAILABLE xtt-w-report THEN DO:
                MESSAGE "Existe conflicto, MARCA ya esta registrada" VIEW-AS ALERT-BOX INFORMATION.
                RETURN "ADM-ERROR".
            END.
    ...
    ELSE DO:
        FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = "*" AND
                                        ...
                                        xtt-w-report.campo-c[6] = "*" NO-LOCK NO-ERROR.
        IF AVAILABLE xtt-w-report THEN DO:
            MESSAGE "Existe conflicto con TODAS las Lineas/Sublineas/Marcas (2)" VIEW-AS ALERT-BOX INFORMATION.
            RETURN "ADM-ERROR".
        END.
        FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea AND
                                        xtt-w-report.campo-c[3] = x-sublinea AND 
        ...
        FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea AND
                                        ...
                                        xtt-w-report.campo-c[6] = "*" NO-LOCK NO-ERROR.
        IF AVAILABLE xtt-w-report THEN DO:
            MESSAGE "Existe conflicto con la Linea y TODAS Sublineas/Marcas " VIEW-AS ALERT-BOX INFORMATION.
            RETURN "ADM-ERROR".
        END.
        FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = x-linea AND
                                        xtt-w-report.campo-c[3] = "*" AND 
                                        xtt-w-report.campo-c[6] = x-marca NO-LOCK NO-ERROR.
        IF AVAILABLE xtt-w-report THEN DO:
            MESSAGE "Existe conflicto con la Linea todas las Sublineas y la MARCA" VIEW-AS ALERT-BOX INFORMATION.
            RETURN "ADM-ERROR".
        END.
        FIND FIRST xtt-w-report WHERE xtt-w-report.campo-c[1] = "*" AND
                                        xtt-w-report.campo-c[3] = "*" AND 
                                        xtt-w-report.campo-c[6] = x-marca NO-LOCK NO-ERROR.
        IF AVAILABLE xtt-w-report THEN DO:
            MESSAGE "Existe conflicto con TODAS las Lineas/Sublineas y la MARCA" VIEW-AS ALERT-BOX INFORMATION.
            RETURN "ADM-ERROR".
        END.
