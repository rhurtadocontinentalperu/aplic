...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Producto FILL-IN-Limite ~
FILL-IN-Cantidad FILL-IN-PreUni FILL-IN-ImpLin 
...
DEFINE FRAME gDialog
     ...
     FILL-IN-Cantidad AT ROW 4.27 COL 25 COLON-ALIGNED WIDGET-ID 6
     FILL-IN-PreUni AT ROW 5.23 COL 25 COLON-ALIGNED WIDGET-ID 10
     FILL-IN-ImpLin AT ROW 6.19 COL 25 COLON-ALIGNED WIDGET-ID 12
     Btn_OK AT ROW 7.73 COL 11
     Btn_Cancel AT ROW 7.73 COL 61
     "EL CLIENTE PUEDE LLEVAR LA SIGUIENTE PROMOCION" VIEW-AS TEXT
          SIZE 55 BY .62 AT ROW 1.54 COL 4 WIDGET-ID 2
          BGCOLOR 1 FGCOLOR 15 
     SPACE(38.42) SKIP(7.29)
...
/* SETTINGS FOR FILL-IN FILL-IN-ImpLin IN FRAME gDialog
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-Cantidad gDialog
ON LEAVE OF FILL-IN-Cantidad IN FRAME gDialog /* Cantidad */
DO:
    ASSIGN
        FILL-IN-ImpLin = INPUT {&self-name} * x-PreUni.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Producto FILL-IN-Limite FILL-IN-Cantidad FILL-IN-PreUni 
          FILL-IN-ImpLin 
      WITH FRAME gDialog.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      FILL-IN-ImpLin = x-CanPed * x-PreUni.
