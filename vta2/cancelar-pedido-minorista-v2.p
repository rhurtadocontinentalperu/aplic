...
IF NOT AVAILABLE Faccpedi THEN RETURN 'ADM-ERROR'.
    ...
    */
    ...
    RUN vta2/d-cancelar-pedido-minorista-v2 (
...
/*         MESSAGE list_docs SKIP "CONFIRMAR IMPRESION DE DOCUMENTO(S)" VIEW-AS ALERT-BOX INFORMATION. */
    ...
    FOR EACH T-CDOCU NO-LOCK BY T-CDOCU.NroPed:         
        ...
        IF AVAILABLE CcbCDocu THEN DO:
            IF Ccbcdocu.CodDoc = "FAC" THEN RUN vtamin/r-tick500-caja (ROWID(ccbcdocu), "O") NO-ERROR.
            IF Ccbcdocu.CodDoc = "BOL" THEN RUN ccb/r-bole01 (ROWID(ccbcdocu)) NO-ERROR.
