...
DEFINE VAR x-usuario-autoriza AS CHAR.
...
------------------------------------------------------------------------------*/
  ...
  /* ************************************************************************************** */
  /* RHC 23/03/2021 Control de Descuentos */
  /* ************************************************************************************** */
/*   RUN vtagn/p-control-descuentos (INPUT ROWID(Faccpedi)). */
  /* ************************************************************************************** */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE usuario-que-autoriza V-table-Win 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE OUTPUT PARAMETER pUsuarioQueAutoriza AS CHAR.

pUsuarioQueAutoriza = x-usuario-autoriza.
...
RUN vtamay/D-CLAVE-v2.R("D",
                     "DESCUENTOS",
                     OUTPUT NIV,
                     OUTPUT RPTA,
                     OUTPUT x-usuario-autoriza).
IF RPTA = "ERROR" THEN RETURN "ADM-ERROR".
/* **************************************** */
ASSIGN
