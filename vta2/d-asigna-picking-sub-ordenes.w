...
&Scoped-Define ENABLED-OBJECTS FILL-IN-UsrChq Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-NroPed FILL-IN-NroRef ~
FILL-IN-Cliente FILL-IN-UsrChq x-NomChq 
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 7.54 COL 4
     Btn_Cancel AT ROW 7.54 COL 19
     SPACE(66.99) SKIP(0.99)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "ASIGNACION DE PICKING DE SUB-ORDENES"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* ASIGNACION DE PICKING DE SUB-ORDENES */
DO:  
...
DO:
  ASSIGN FILL-IN-UsrChq.
  /*Campo de Chequeador obligatorio*/
  IF FILL-IN-UsrChq = "" THEN DO:
      MESSAGE 'Debe ingresar codigo del responsable'
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      APPLY "ENTRY" TO FILL-IN-UsrChq.
      RETURN NO-APPLY.
  END.
  FIND FIRST Pl-pers WHERE Pl-pers.codper = FILL-IN-UsrChq NO-LOCK NO-ERROR.
  ...
  FIND FIRST piksacadores WHERE piksacadores.codcia = s-codcia 
      ...
      AND piksacadores.codper = FILL-IN-UsrChq 
      AND piksacadores.flgest = 'A'
      NO-LOCK NO-ERROR.
  IF NOT AVAILABLE piksacadores THEN DO:
      MESSAGE 'Pikeador ingresado no esta REGISTRADO en este TURNO'
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      APPLY "ENTRY" TO FILL-IN-UsrChq.
      RETURN NO-APPLY.
  END.
  IF piksacadores.flgtarea <> 'L'  THEN DO:
      MESSAGE 'Pikeador esta OCUPADO'
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      APPLY "ENTRY" TO FILL-IN-UsrChq.
      RETURN NO-APPLY.
  END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-NroPed FILL-IN-NroRef FILL-IN-Cliente FILL-IN-UsrChq x-NomChq 
      WITH FRAME D-Dialog.
  ENABLE FILL-IN-UsrChq Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
