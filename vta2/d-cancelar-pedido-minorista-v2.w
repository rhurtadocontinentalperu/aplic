...
FILL-IN_ImpUsa4 FILL-IN_Voucher5 FILL-IN_Voucher7 FILL-IN_Voucher8 ~
FILL-IN_CodBco8 BUTTON-TpoCmb Btn_OK Btn_Cancel 
...
DEFINE FRAME D-Dialog
     ...
     BUTTON-Tickets AT ROW 11.19 COL 41 WIDGET-ID 2
     ...
     Btn_Cancel AT ROW 14.08 COL 14
     FILL-IN_T_Venta AT ROW 14.08 COL 46 COLON-ALIGNED PASSWORD-FIELD 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-dcaja1-02 ( 16.96 , 4.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 RECT-32 RECT-9 RECT-7 RECT-5 RECT-4 RECT-10 RECT-6 
         ...
         FILL-IN_Voucher5 FILL-IN_Voucher7 FILL-IN_Voucher8 FILL-IN_CodBco8 
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF Contado THEN DO:
            ...
            END.
/*             WHEN "V" OR WHEN "X" OR WHEN "M" THEN DO:               */
/*                 IF CAN-FIND(FIRST VtaVales WHERE                    */
/*                     vtavales.codcia = s-codcia AND                  */
/*                     vtavales.flgest = 'P' NO-LOCK) THEN DO:         */
/*                     ASSIGN                                          */
/*                         FILL-IN_ImpNac10:LABEL = "Vales de Consumo" */
/*                         BUTTON-Vales:VISIBLE = YES                  */
/*                         BUTTON-Vales:SENSITIVE = YES                */
/*                         FILL-IN_ImpNac10:SENSITIVE = YES            */
/*                         FILL-IN_ImpUsa10:SENSITIVE = YES            */
/*                         FILL-IN_ImpNac1 = 0                         */
/*                         FILL-IN_ImpUSA1 = 0.                        */
/*                     DISPLAY                                         */
/*                         FILL-IN_ImpNac1                             */
/*                         FILL-IN_ImpUSA1.                            */
/*                 END.                                                */
/*                 ELSE BUTTON-Vales:SENSITIVE = NO.                   */
/*             END.                                                    */
            WHEN "K" OR WHEN "KC" THEN DO:
                ASSIGN
