...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 11.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"FacCPedi.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF cEsValeUtilex = YES THEN DO:
    ...
    RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'FA', "CREDITO", "" ).       /* AUTOMATICA */
END.
ELSE DO:
    MESSAGE "La O/D NO pertenece a la venta de VALES UTILEX".
END.
