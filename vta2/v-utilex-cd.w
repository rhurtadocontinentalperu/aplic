...
&Scoped-Define ENABLED-FIELDS VtaTabla.Llave_c1 VtaTabla.Rango_fecha[1] ~
VtaTabla.Rango_fecha[2] 
&Scoped-define ENABLED-TABLES VtaTabla
&Scoped-define FIRST-ENABLED-TABLE VtaTabla
&Scoped-Define DISPLAYED-FIELDS VtaTabla.Llave_c1 VtaTabla.Rango_fecha[1] ~
VtaTabla.Rango_fecha[2] 
...
DEFINE FRAME F-Main
     VtaTabla.Llave_c1 AT ROW 1.38 COL 20 COLON-ALIGNED WIDGET-ID 2
          LABEL "Código de Encarte" FORMAT "x(20)"
          VIEW-AS FILL-IN 
          SIZE 12.43 BY 1
     VtaTabla.Rango_fecha[1] AT ROW 2.54 COL 20 COLON-ALIGNED WIDGET-ID 4
          LABEL "Válido desde"
          VIEW-AS FILL-IN 
          SIZE 12.86 BY 1
     VtaTabla.Rango_fecha[2] AT ROW 3.69 COL 20 COLON-ALIGNED WIDGET-ID 6
          LABEL "Hasta"
          VIEW-AS FILL-IN 
          SIZE 12.86 BY 1
...
/* SETTINGS FOR FILL-IN VtaTabla.Llave_c1 IN FRAME F-Main
