...
&Scoped-Define ENABLED-OBJECTS BUTTON-11 BUTTON-12 BUTTON-13 
...
DEFINE VARIABLE h_b-aprped-1ce AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-11 AT ROW 24.69 COL 102 WIDGET-ID 2
     BUTTON-12 AT ROW 24.69 COL 117 WIDGET-ID 4
     BUTTON-13 AT ROW 24.69 COL 132 WIDGET-ID 6
...
DO:
   RUN Rechazar IN h_b-aprped-1ce.
END.
...
DO:
  RUN dispatch IN h_b-aprped-1ce ('open-query':U).
END.
...
/* ***************************  Main Block  *************************** */
CASE s-CodDoc:
    WHEN 'PED' THEN {&WINDOW-NAME}:TITLE = 'PEDIDOS POR APROBAR - CONTRAENTREGA'.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-aprped-1ce.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprped-1ce ).
       RUN set-position IN h_b-aprped-1ce ( 1.00 , 1.86 ) NO-ERROR.
       RUN set-size IN h_b-aprped-1ce ( 8.04 , 146.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-11 BUTTON-12 BUTTON-13 
