...
&Scoped-Define ENABLED-OBJECTS BtnDone RECT-1 BUTTON-14 RADIO-SET-CodDoc ~
BUTTON-13 txtDesde txtHasta BtnExcel RADIO-SET-1 ChkChequeo txtOrdenCompra ~
...
RADIO-SET-1 ChkChequeo txtOrdenCompra chbxImpresos txtcodref txtNroRef ~
txtArtSinPeso 
...
DEFINE FRAME F-Main
     ...
     BUTTON-14 AT ROW 1.08 COL 116 WIDGET-ID 52
     ...
     ChkChequeo AT ROW 2.81 COL 62.72 WIDGET-ID 22
     txtOrdenCompra AT ROW 3.58 COL 28 COLON-ALIGNED WIDGET-ID 48
     chbxImpresos AT ROW 3.69 COL 62.72 WIDGET-ID 50
     ...
     RECT-1 AT ROW 2.5 COL 93 WIDGET-ID 32
...
OCXFile = SEARCH( "w-listado-picking-ordenes-v3.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-listado-picking-ordenes-v3.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-CodDoc txtDesde txtHasta RADIO-SET-1 ChkChequeo 
          txtOrdenCompra chbxImpresos txtcodref txtNroRef txtArtSinPeso 
      WITH FRAME F-Main IN WINDOW sW-Win.
  ENABLE BtnDone RECT-1 BUTTON-14 RADIO-SET-CodDoc BUTTON-13 txtDesde txtHasta 
         BtnExcel RADIO-SET-1 ChkChequeo txtOrdenCompra chbxImpresos BROWSE-5 
