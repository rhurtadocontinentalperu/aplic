...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 103 BY 13.46
         FONT 4.
...
"tt-w-report.Campo-C[2]" "Descripcion de la Linea" "X(50)" "character" ? ? ? ? ? ? yes ? no no "38.86" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
...
"tt-w-report.Campo-C[4]" "Descripcion Sub-Linea" "X(50)" "character" ? ? ? ? ? ? yes ? no no "38" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
      ...
      DO:
          ...
          FOR EACH ytt-w-report WHERE ytt-w-report.campo-c[10] = "X" :
              FIND FIRST rbte_linea_movimiento WHERE rbte_linea_movimiento.codcia = s-codcia AND
                                                        ...
                                                        rbte_linea_movimiento.codsublinea = ytt-w-report.campo-c[3]
