...
CcbDDocu.Por_Dsctos[2] CcbDDocu.Por_Dsctos[3] Ccbddocu.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Ccbddocu.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT "->>,>>>.9999":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 127 BY 10.5
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 11.58 COL 16 COLON-ALIGNED
     F-TotBrt AT ROW 12.92 COL 18 NO-LABEL
     F-ImpExo AT ROW 12.92 COL 30 NO-LABEL
     F-ValVta AT ROW 12.92 COL 52.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 12.92 COL 64.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 12.92 COL 77.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 12.92 COL 90 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 12.96 COL 40 COLON-ALIGNED NO-LABEL
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 12.35 COL 92.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 12.35 COL 70.57
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.35 COL 30.57
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 12.35 COL 82.14
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.35 COL 20
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.38 COL 55.86
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.38 COL 42.72
...
"Ccbddocu.PreUni" "Precio!Unitario" "->>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbDDocu.Por_Dsctos[3]" "% Dscto!Vol. Prom." ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.Ccbddocu.ImpLin
...
------------------------------------------------------------------------------*/
  ...
  THEN ASSIGN
        f-ImpDes = Ccbcdocu.ImpDto
        f-ImpExo = Ccbcdocu.ImpExo
        f-ImpIgv = Ccbcdocu.ImpIgv
        f-ImpIsc = Ccbcdocu.ImpIsc
        f-ImpTot = Ccbcdocu.ImpTot
        f-TotBrt = Ccbcdocu.ImpBrt
        f-ValVta = Ccbcdocu.ImpVta
        f-PorDes = Ccbcdocu.PorDto.
