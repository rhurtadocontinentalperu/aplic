...
DEF INPUT-OUTPUT PARAMETER x-CodProm AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Promocion FILL-IN-Cantidad Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Promocion FILL-IN-Limite ~
FILL-IN-Cantidad FILL-IN-PreUni 
...
DEFINE VARIABLE COMBO-BOX-Promocion AS CHARACTER FORMAT "X(256)":U 
...
DEFINE FRAME gDialog
     COMBO-BOX-Promocion AT ROW 3.12 COL 21 COLON-ALIGNED WIDGET-ID 14
     FILL-IN-Limite AT ROW 4.23 COL 45 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-Cantidad AT ROW 4.27 COL 21 COLON-ALIGNED WIDGET-ID 6
     FILL-IN-PreUni AT ROW 5.31 COL 45 COLON-ALIGNED WIDGET-ID 10
     Btn_OK AT ROW 6.38 COL 11
     Btn_Cancel AT ROW 6.38 COL 61
     "EL CLIENTE PUEDE LLEVAR LAS SIGUIENTES PROMOCIONES" VIEW-AS TEXT
          SIZE 57 BY .62 AT ROW 1.54 COL 4 WIDGET-ID 2
          BGCOLOR 1 FGCOLOR 15 
     SPACE(36.42) SKIP(6.52)
...
DO:
  ...
  END.
  ASSIGN
      x-CodProm = TRIM(ENTRY(1, COMBO-BOX-Promocion, ' - '))
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-Promocion FILL-IN-Limite FILL-IN-Cantidad FILL-IN-PreUni 
      WITH FRAME gDialog.
  ENABLE COMBO-BOX-Promocion FILL-IN-Cantidad Btn_OK Btn_Cancel 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
...
------------------------------------------------------------------------------*/
  ...
  DO k = 1 TO NUM-ENTRIES(x-CodProm):
      FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
          ...
          NO-LOCK.
       COMBO-BOX-Promocion:ADD-LAST(Almmmatg.codmat + ' - ' + Almmmatg.desmat)
           IN FRAME {&FRAME-NAME}.
       COMBO-BOX-Promocion = Almmmatg.codmat + ' - ' + Almmmatg.desmat.
  END.
