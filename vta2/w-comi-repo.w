...
&Scoped-Define ENABLED-OBJECTS RECT-1 BUTTON-2 
...
DEFINE FRAME F-Main
     BUTTON-2 AT ROW 11.23 COL 36 WIDGET-ID 4
     RECT-1 AT ROW 1.27 COL 2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 61.29 BY 12.54 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "COMISIONES POR MARGEN DE UTILIDAD"
         HEIGHT             = 12.54
         WIDTH              = 61.29
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 144.29
...
ON END-ERROR OF W-Win /* COMISIONES POR MARGEN DE UTILIDAD */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* COMISIONES POR MARGEN DE UTILIDAD */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-comiconfig ( 1.27 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-comiconfig ( 1.54 , 54.00 ) NO-ERROR.
