...
&SCOPED-DEFINE l-lookup h_l-listaprecios-conta
...
DEFINE VARIABLE h_l-listaprecios-conta AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-listaprecios-conta.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-listaprecios-conta ).
       RUN set-position IN h_l-listaprecios-conta ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-listaprecios-conta ( 14.23 , 148.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-listaprecios-conta. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listaprecios-conta ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listaprecios-conta , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listaprecios-conta ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-detart ,
             h_l-listaprecios-conta , 'AFTER':U ).
