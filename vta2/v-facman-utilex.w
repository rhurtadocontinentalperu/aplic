...
&Scoped-Define ENABLED-FIELDS CcbCDocu.ImpTot CcbCDocu.FchDoc ~
CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.TpoCmb CcbCDocu.DirCli ~
CcbCDocu.FchVto CcbCDocu.RucCli CcbCDocu.CodAnt CcbCDocu.CodVen ~
CcbCDocu.NroPed CcbCDocu.FmaPgo CcbCDocu.NroOrd CcbCDocu.CodMon ~
CcbCDocu.Glosa 
&Scoped-define ENABLED-TABLES CcbCDocu
&Scoped-define FIRST-ENABLED-TABLE CcbCDocu
&Scoped-Define ENABLED-OBJECTS TOGGLE-DELIVERY 
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.NroDoc CcbCDocu.ImpTot ~
CcbCDocu.FchDoc CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.TpoCmb ~
CcbCDocu.DirCli CcbCDocu.FchVto CcbCDocu.RucCli CcbCDocu.CodAnt ~
CcbCDocu.Lista_de_Precios CcbCDocu.CodVen CcbCDocu.NroPed CcbCDocu.FmaPgo ~
CcbCDocu.NroOrd CcbCDocu.NroRef CcbCDocu.CodMon CcbCDocu.Glosa 
&Scoped-define DISPLAYED-TABLES CcbCDocu
&Scoped-define FIRST-DISPLAYED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado TOGGLE-DELIVERY F-nOMvEN F-CndVta 
...
DEFINE FRAME F-Main
     CcbCDocu.NroDoc AT ROW 1 COL 9 COLON-ALIGNED WIDGET-ID 22 FORMAT "XXX-XXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     F-Estado AT ROW 1 COL 29 COLON-ALIGNED NO-LABEL
     CcbCDocu.ImpTot AT ROW 1 COL 68 COLON-ALIGNED WIDGET-ID 24
          LABEL "IMPORTE DE CONTROL" FORMAT ">>,>>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11.43 BY .81
          BGCOLOR 12 FGCOLOR 15 FONT 6
     CcbCDocu.FchDoc AT ROW 1 COL 91 COLON-ALIGNED
          LABEL "F/ Emision"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.CodCli AT ROW 1.81 COL 9 COLON-ALIGNED FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.NomCli AT ROW 1.81 COL 21 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 58 BY .81
     CcbCDocu.TpoCmb AT ROW 1.81 COL 91 COLON-ALIGNED
          LABEL "T/ Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.DirCli AT ROW 2.62 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 70 BY .81
     CcbCDocu.FchVto AT ROW 2.62 COL 91 COLON-ALIGNED
          LABEL "Vencimiento"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     TOGGLE-DELIVERY AT ROW 3.31 COL 51 WIDGET-ID 130
     ...
     CcbCDocu.CodAnt AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 16
          ...
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     CcbCDocu.Lista_de_Precios AT ROW 3.46 COL 90.86 COLON-ALIGNED WIDGET-ID 132
          LABEL "Delivery" FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 10.43 BY .81
     ...
     CcbCDocu.NroPed AT ROW 4.27 COL 91 COLON-ALIGNED FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ...
     CcbCDocu.NroOrd AT ROW 5.15 COL 91 COLON-ALIGNED
     ...
     CcbCDocu.NroRef AT ROW 5.85 COL 9 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 48.72 BY .81
     CcbCDocu.CodMon AT ROW 6.08 COL 93.14 NO-LABEL
...
"US$", 2
     ...
     "Moneda:" VIEW-AS TEXT
          SIZE 6.43 BY .5 AT ROW 6.19 COL 86
...
/* SETTINGS FOR FILL-IN CcbCDocu.ImpTot IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN CcbCDocu.Lista_de_Precios IN FRAME F-Main
...
DO:
    ...
    DO WITH FRAME {&FRAME-NAME}:        
        ccbcdocu.fmapgo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "000".
        IF SELF:SCREEN-VALUE IN FRAME {&FRAME-NAME} = 'YES' THEN DO:
            ...
            IF AVAILABLE gn-convt THEN DO:
                ccbcdocu.lista_de_precios:SCREEN-VALUE = x-listaprecio-rappi. /* Lista de Precios RAPPI */
                ccbcdocu.fmapgo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = x-cond-vta-rappi.
            END.
            ELSE DO:
        ...
        END.
        ELSE DO:
            ccbcdocu.fmapgo:SCREEN-VALUE = "000".
            ccbcdocu.lista_de_precios:SCREEN-VALUE = "".
        END.
    END.
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN 'ADM-ERROR':
   FOR EACH ITEM WHERE ITEM.CanPed > 0, FIRST Almmmatg OF ITEM NO-LOCK
       BY ITEM.NroItm:
       CREATE CcbDDocu.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Importe-de-control V-table-Win 
PROCEDURE Importe-de-control :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF DECIMAL (CcbCDocu.ImpTot:SCREEN-VALUE IN FRAME {&FRAME-NAME} ) = 0 THEN DO:
    MESSAGE 'Debe ingresar primero el IMPORTE DE CONTROL' VIEW-AS ALERT-BOX WARNING.
    RETURN 'ADM-ERROR'.
END.
RETURN 'OK'.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
      ...
      CcbCDocu.CodAlm = ENTRY(1, s-CodAlm)
      /*CcbCDocu.NroDoc = STRING(I-NroSer,"999") + STRING(I-NroDoc,"999999")*/
      CcbCDocu.NroDoc = STRING(I-NroSer,ENTRY(1,x-Formato,'-')) + 
                        STRING(I-NroDoc,ENTRY(2,x-Formato,'-')).
  ...
  /* Ingreso a caja */
   ...
   IF toggle-delivery = YES THEN DO:
       ASSIGN CcbCDocu.lista_de_precios = x-listaprecio-rappi.
   END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbCDocu THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     toggle-delivery:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "no".
     IF NOT (TRUE <> (ccbcdocu.lista_de_precios > ""))  THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF s-coddoc = 'FAC' THEN CcbCDocu.CodAnt:SENSITIVE = NO.
  END.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH ITEM:
      x-Importe = x-Importe + ITEM.ImpLin.
  END.
  ...
  x-filer = "M".
  IF TOggle-delivery = YES THEN x-filer = x-filer + "|RAPPI".
  ...
  RUN ccb/d-canped-02a.r(
      ...
      x-filer, /* "M",  digitacion manual acepta pago con tarjetas de crédito **/
      OUTPUT s-ok
      ).
...
DO WITH FRAME {&FRAME-NAME} :
   ...
   IF Ccbcdocu.CodVen:SCREEN-VALUE = "" THEN DO:
    ...
    END.
    IF x-ImpLin <> DECIMAL(CcbCDocu.ImpTot:SCREEN-VALUE) THEN DO:
        MESSAGE 'NO coinciden el IMPORTE DE CONTROL y el DETALLE' VIEW-AS ALERT-BOX ERROR.
        RETURN 'ADM-ERROR'.
    END.

    IF x-ImpLin >= 700 AND s-CodDoc = "BOL" AND LENGTH(CcbCDocu.CodAnt:SCREEN-VALUE) <> 8
        THEN DO:
        MESSAGE 'Ingrese el DNI' VIEW-AS ALERT-BOX ERROR.
