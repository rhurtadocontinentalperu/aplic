...
------------------------------------------------------------------------------*/
    ...
    IF lchoice THEN DO:
        ...
        END.
        ELSE DO: 
            RUN Vta2\genera-cotizacion-expo (ROWID(VtaCDocu), pCodDiv, OUTPUT CNroPed).    
            IF cNroPed <> '' THEN
  ...
  FOR EACH PEDI2 NO-LOCK WHERE PEDI2.ImpLin > 0,
      ...
      BUFFER-COPY PEDI2 TO VtaDDocu
          ASSIGN
              ...
              VtaDDocu.PesMat = PEDI2.CanPed * PEDI2.Factor * Almmmatg.PesMat
              VtaDDocu.NroItm = I-NITEM.
      ASSIGN
          VtaCDocu.PesMat = VtaCDocu.PesMat + VtaDDocu.PesMat.
  END.
