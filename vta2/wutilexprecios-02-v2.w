...
DEFINE VARIABLE h_butilexprecios-02c-v2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "IMPORTAR PRECIOS DE VENTA - SOLO EVENTOS"
         HEIGHT             = 25.54
         WIDTH              = 142.43
         MAX-HEIGHT         = 27.23
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF W-Win /* IMPORTAR PRECIOS DE VENTA - SOLO EVENTOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* IMPORTAR PRECIOS DE VENTA - SOLO EVENTOS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/butilexprecios-02c-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_butilexprecios-02c-v2 ).
       RUN set-position IN h_butilexprecios-02c-v2 ( 8.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_butilexprecios-02c-v2 ( 16.35 , 139.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_butilexprecios-02c-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv97 , 'TableIO':U , h_butilexprecios-02c-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_butilexprecios-02c-v2 ,
             FILL-IN-Mensaje:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv97 ,
             h_butilexprecios-02c-v2 , 'AFTER':U ).
    END. /* Page 1 */
...
RUN Recalcular IN h_butilexprecios-02c-v2.
RUN dispatch IN h_butilexprecios-02c-v2 ('open-query':U).
