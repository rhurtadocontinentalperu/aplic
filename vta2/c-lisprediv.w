...
&SCOPED-DEFINE l-lookup h_l-lisprediv
...
DEFINE VARIABLE h_l-lisprediv AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-lisprediv.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-lisprediv ).
       RUN set-position IN h_l-lisprediv ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-lisprediv ( 14.23 , 131.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-lisprediv. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-lisprediv ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-lisprediv ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-lisprediv , 'AFTER':U ).
    END. /* Page 0 */
