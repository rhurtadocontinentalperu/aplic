...
DEFINE BUFFER c-VtaCDocu FOR VtaCDocu.
...
DEFINE TEMP-TABLE Reporte
    FIELD CodDoc    LIKE Vtacdocu.CodPed
    FIELDS NroPed   LIKE Vtacdocu.NroPed
    FIELD  CodRef    LIKE Vtacdocu.CodRef
    FIELDS NroRef   LIKE Vtacdocu.NroRef
    ...
    FIELDS X-TRANS  LIKE Vtacdocu.Libre_c01
    FIELDS X-DIREC  LIKE Vtacdocu.Libre_c02
    FIELDS X-LUGAR  LIKE Vtacdocu.Libre_c03
    FIELDS X-CONTC  LIKE Vtacdocu.Libre_c04
    FIELDS X-HORA   LIKE Vtacdocu.Libre_c05
    FIELDS X-FECHA  LIKE Vtacdocu.Libre_f01
    FIELDS X-OBSER  LIKE Vtacdocu.Observa
    FIELDS X-Glosa  LIKE Vtacdocu.Glosa
    FIELDS X-codcli LIKE Vtacdocu.CodCli
    FIELDS X-NomCli LIKE Vtacdocu.NomCli
    FIELDS X-fchent LIKE Vtacdocu.fchent
...
&Scoped-define INTERNAL-TABLES ORDENES VtaCDocu

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaCDocu.CodPed ORDENES.NroPed ~
ORDENES.FchPed ORDENES.Hora ORDENES.FchEnt ORDENES.NomCli ORDENES.Libre_d01 ~
ORDENES.AcuBon[1] ORDENES.AcuBon[2] ORDENES.AcuBon[3] ORDENES.AcuBon[4] ~
ORDENES.AcuBon[5] Vtacdocu.UsrImpOD Vtacdocu.FchImpOD ORDENES.Libre_d02 ~
Vtacdocu.Glosa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH ORDENES WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST VtaCDocu WHERE VtaCDocu.CodCia = ORDENES.CodCia ~
  AND VtaCDocu.CodPed = ORDENES.CodDoc ~
  AND VtaCDocu.NroPed = ORDENES.NroPed NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH ORDENES WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND VtaCDocu.NroPed = ORDENES.NroPed NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table ORDENES VtaCDocu
...
<SORTBY-OPTIONS>
FchPed|y||INTEGRAL.Vtacdocu.FchPed|no,INTEGRAL.Vtacdocu.Hora|no
Libre_c01|||ORDENES.Libre_c01|yes,ORDENES.FchPed|yes,ORDENES.Hora|yes
NomCli|||INTEGRAL.Vtacdocu.NomCli|yes,INTEGRAL.Vtacdocu.FchPed|yes,INTEGRAL.Vtacdocu.Hora|yes
FchEnt|||INTEGRAL.Vtacdocu.FchEnt|no,INTEGRAL.Vtacdocu.NomCli|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ORDENES.NroPed COLUMN-LABEL "Numero" FORMAT "X(12)":U WIDTH 12.57
      ...
      ORDENES.AcuBon[2] COLUMN-LABEL "Impresos" FORMAT "99":U WIDTH 6.43
      ORDENES.AcuBon[3] COLUMN-LABEL "Asignados" FORMAT "99":U
            WIDTH 7.43
      ORDENES.AcuBon[4] COLUMN-LABEL "Recep." FORMAT "99":U WIDTH 5
      ORDENES.AcuBon[5] COLUMN-LABEL "xAsignar" FORMAT "99":U WIDTH 6.43
      Vtacdocu.UsrImpOD COLUMN-LABEL "Impreso por" FORMAT "x(8)":U
            WIDTH 8.14
      Vtacdocu.FchImpOD COLUMN-LABEL "Fecha y!hora de impresión" FORMAT "99/99/9999 HH:MM":U
            WIDTH 13.43
      ORDENES.Libre_d02 COLUMN-LABEL "Items" FORMAT ">>9":U
      Vtacdocu.Glosa FORMAT "X(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 153 BY 7.5
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: c-VtaCDocu B "?" ? INTEGRAL VtaCDocu
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.ORDENES,INTEGRAL.VtaCDocu WHERE Temp-Tables.ORDENES ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST,,,"
     _JoinCode[2]      = "INTEGRAL.VtaCDocu.CodCia = Temp-Tables.ORDENES.CodCia
  AND INTEGRAL.VtaCDocu.CodPed = Temp-Tables.ORDENES.CodDoc
  AND INTEGRAL.VtaCDocu.NroPed = Temp-Tables.ORDENES.NroPed"
     _FldNameList[1]   = INTEGRAL.VtaCDocu.CodPed
     _FldNameList[2]   > Temp-Tables.ORDENES.NroPed
"ORDENES.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no "12.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ORDENES.NomCli" "Cliente" ? "character" ? ? ? ? ? ? no ? no no "35.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.ORDENES.Libre_d01
"ORDENES.Libre_d01" "Peso KG" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.ORDENES.AcuBon[1]
"ORDENES.AcuBon[1]" "Sectores" "99" "decimal" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.ORDENES.AcuBon[2]
"ORDENES.AcuBon[2]" "Impresos" "99" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.ORDENES.AcuBon[3]
"ORDENES.AcuBon[3]" "Asignados" "99" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.ORDENES.AcuBon[4]
"ORDENES.AcuBon[4]" "Recep." "99" "decimal" ? ? ? ? ? ? no ? no no "5" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.ORDENES.AcuBon[5]
"ORDENES.AcuBon[5]" "xAsignar" "99" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.Vtacdocu.UsrImpOD
"Vtacdocu.UsrImpOD" "Impreso por" ? "character" ? ? ? ? ? ? no ? no no "8.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.Vtacdocu.FchImpOD
"Vtacdocu.FchImpOD" "Fecha y!hora de impresión" "99/99/9999 HH:MM" "datetime" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > Temp-Tables.ORDENES.Libre_d02
"ORDENES.Libre_d02" "Items" ">>9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   = INTEGRAL.Vtacdocu.Glosa
...
------------------------------------------------------------------------------*/
  ...
  IF Vtacdocu.Libre_c02 = '' OR Vtacdocu.Libre_c03 <> '' THEN RETURN.
  ...
  */
  ...
  DEF VAR x-UsrChq LIKE VtaCDocu.UsrSac NO-UNDO.
  ...
  END.
  ASSIGN
      Vtacdocu.Libre_c03 = s-user-id + '|' + STRING(DATETIME(TODAY, MTIME), '99/99/9999 HH:MM:SS') + '|' + x-UsrChq
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'FchPed':U THEN DO:
      &Scope SORTBY-PHRASE BY Vtacdocu.FchPed DESCENDING BY Vtacdocu.Hora DESCENDING
    ...
    WHEN 'NomCli':U THEN DO:
      &Scope SORTBY-PHRASE BY Vtacdocu.NomCli BY Vtacdocu.FchPed BY Vtacdocu.Hora
      {&OPEN-QUERY-{&BROWSE-NAME}}
    END.
    WHEN 'FchEnt':U THEN DO:
      &Scope SORTBY-PHRASE BY Vtacdocu.FchEnt DESCENDING BY Vtacdocu.NomCli
      {&OPEN-QUERY-{&BROWSE-NAME}}
    END.
...
CASE TRUE:
    WHEN lChequeados = YES THEN DO:
        FOR EACH Vtacdocu NO-LOCK WHERE Vtacdocu.codcia = s-codcia 
            ...
            AND Vtacdocu.CodPed = s-CodDoc
            AND Vtacdocu.fchped >= ltxtDesde:

            IF NOT (Vtacdocu.flgsit = 'T') THEN NEXT.
            IF NOT (Vtacdocu.fchped <= ltxtHasta) THEN NEXT.
            IF Vtacdocu.FlgImpOD = YES THEN NEXT.

            /* Rutina General */
            {vta2/i-listado-picking-suborden-cons.i}

        END.
    END.
    WHEN pSoloImpresos = YES THEN DO:
        FOR EACH Vtacdocu NO-LOCK WHERE Vtacdocu.codcia = s-codcia 
            AND Vtacdocu.CodDiv = s-coddiv
            AND Vtacdocu.CodPed = s-CodDoc
            AND Vtacdocu.fchped >= ltxtDesde:
            ...
            IF NOT (Vtacdocu.fchped <= ltxtHasta) THEN NEXT.
            IF Vtacdocu.FlgImpOD = NO THEN NEXT.
...
END CASE.
/*
FOR EACH Vtacdocu WHERE {&Condicion} USE-INDEX Llave09 NO-LOCK,
    FIRST GN-DIVI OF Vtacdocu NO-LOCK:
    CASE TRUE:
        WHEN lChequeados = YES THEN DO:
            IF Vtacdocu.FlgImpOD = YES THEN NEXT.
            IF NOT (Vtacdocu.flgest = 'P' AND Vtacdocu.flgsit = 'T') THEN NEXT.
        END.
        WHEN pSoloImpresos = YES AND Vtacdocu.FlgImpOD = NO THEN NEXT.
    END CASE.
    ...
    RUN ue-sectores(INPUT Vtacdocu.codped, INPUT Vtacdocu.nroped,
...
DO k = 1 TO {&browse-name}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
    ...
    x-Ordenes = x-Ordenes + (IF x-Ordenes = '' THEN '' ELSE ',') + Vtacdocu.NroPed.
    /* NO KITS */
    FOR EACH Vtaddocu OF Vtacdocu NO-LOCK,
        ...
        END.
        /* Cargamos Resumen */
        FIND Resumen WHERE Resumen.codmat = Vtaddocu.codmat NO-ERROR.
        ...
        ASSIGN
            ...
            Resumen.nroped[k] = Vtacdocu.nroped
            Resumen.canped[k] =  Vtaddocu.CanPed * Vtaddocu.Factor.

        /* Cargamos Resumen2 */
        FIND Resumen2 WHERE Resumen2.x-codcli = Vtacdocu.codcli AND 
                        resumen2.coddoc = Vtacdocu.CodPed AND  
                        resumen2.nroped = Vtacdocu.NroPed NO-ERROR.
        IF NOT AVAILABLE Resumen2 THEN DO : 
            CREATE Resumen2.
                ASSIGN
                    Resumen2.x-codcli = Vtacdocu.CodCli
                    Resumen2.X-NomCli = Vtacdocu.NomCli
                    resumen2.CodDoc   = Vtacdocu.CodPed
                    resumen2.NroPed   = Vtacdocu.NroPed
                    resumen2.X-FECHA  = Vtacdocu.fchped
                    resumen2.X-fchent = Vtacdocu.fchent
                    resumen2.x-qtyitm = 0
                    resumen2.x-peso   = 0.
        END.
        ASSIGN resumen2.x-qtyitm = resumen2.x-qtyitm + 1.
               resumen2.x-peso  = resumen2.x-peso + (( Vtaddocu.CanPed * Vtaddocu.Factor ) * almmmatg.pesmat).
    ...
    FOR EACH Vtaddocu OF Vtacdocu NO-LOCK,
        ...
        ASSIGN
            Resumen.codmat = Almmmatg.codmat
            Resumen.desmat = TRIM(Almmmatg.DesMat) + ' (KIT ' + TRIM(Vtaddocu.codmat) + ')'
            Resumen.undbas = Almmmatg.undbas
            Resumen.desmat = Almmmatg.desmat
            Resumen.nroped[k] = Vtacdocu.nroped
            Resumen.canped[k] = ( Vtaddocu.CanPed * Vtaddocu.Factor *  AlmDKits.Cantidad ).
        ...
        IF NOT AVAILABLE Resumen2 THEN DO : 
            CREATE Resumen2.
                ASSIGN
                    ...
                    resumen2.CodDoc   = Vtacdocu.CodPed
                    resumen2.NroPed   = Vtacdocu.NroPed
                    resumen2.X-FECHA  = Vtacdocu.Libre_f01
                    resumen2.X-fchent = Vtacdocu.fchent
                    resumen2.x-qtyitm = 0
                    resumen2.x-peso   = 0.
        END.
        ASSIGN resumen2.x-qtyitm = resumen2.x-qtyitm + 1.
               resumen2.x-peso  = resumen2.x-peso + ((Vtaddocu.CanPed * Vtaddocu.Factor *  AlmDKits.Cantidad ) * almmmatg.pesmat).
...
------------------------------------------------------------------------------*/
  ...
  DO k = 1 TO {&browse-name}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
      ...
      IF AVAILABLE Vtacdocu THEN DO:
          ASSIGN
              Vtacdocu.FlgImpOD = YES
              Vtacdocu.UsrImpOD = s-user-id
              Vtacdocu.FchImpOD = DATETIME(TODAY, MTIME).
              /*Vtacdocu.Libre_c02 = s-user-id + '|' + STRING(DATETIME(TODAY, MTIME), '99/99/9999 HH:MM:SS').*/
      END.
      FIND CURRENT Vtacdocu NO-LOCK NO-ERROR.
  END.
...
SESSION:SET-WAIT-STATE('GENERAL').
    ...
    DO  WHILE AVAILABLE Vtacdocu:
            FIND FIRST gn-div OF Vtacdocu NO-LOCK.
             iColumn = iColumn + 1.
             cColumn = STRING(iColumn).

             chWorkSheet:Range("A" + cColumn):Value = "'" + Vtacdocu.codped.
             chWorkSheet:Range("B" + cColumn):Value = "'" + Vtacdocu.nroped.             
             chWorkSheet:Range("C" + cColumn):Value = Vtacdocu.fchped.             
             chWorkSheet:Range("D" + cColumn):Value = Vtacdocu.hora.
             cRange = "E" + cColumn.
             chWorkSheet:Range(cRange):Value = IF(AVAILABLE gn-divi) THEN gn-divi.desdiv ELSE "".
             cRange = "F" + cColumn.
             chWorkSheet:Range(cRange):Value = Vtacdocu.nomcli.
             cRange = "G" + cColumn.
             chWorkSheet:Range(cRange):Value = Vtacdocu.usrimpod.
             cRange = "H" + cColumn.
             chWorkSheet:Range(cRange):Value = Vtacdocu.fchimpod.

             cRange = "I" + cColumn.
             chWorkSheet:Range(cRange):Value = IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 1) THEN ENTRY(2,Vtacdocu.Libre_c03,'|') ELSE "".
         ...
         lsFechaEmision = STRING(Vtacdocu.fchped, '99-99-9999').
         lsHoraEmision  = Vtacdocu.hora.
         
         ldtFechaEmision      = DATETIME(lsFechaEmision + ' ' + lsHoraEmision).
         ldtFechaDistribucion = DATETIME(IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 1) THEN ENTRY(2,Vtacdocu.Libre_c03,'|') ELSE "").

         RUN lib\_time-passed.p (ldtFechaEmision, Vtacdocu.fchimpod, OUTPUT lsDifTempo_VtaAlm).
         RUN lib\_time-passed.p (Vtacdocu.fchimpod, ldtFechaDistribucion, OUTPUT lsDifTempo_AlmDist).
         ...
         chWorkSheet:Range("O" + cColumn):Value = Vtacdocu.fchent.

         lPeso = fPeso().
         chWorkSheet:Range("P" + cColumn):Value = lpeso.
         cRange = "Q" + cColumn.
         chWorkSheet:Range(cRange):Value = "'" + IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 2) THEN ENTRY(3,Vtacdocu.Libre_c03,'|') ELSE "".

         lCodUser = IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 2) THEN ENTRY(3,Vtacdocu.Libre_c03,'|') ELSE "".
         lNomUser = fPersonal(lCodUser).
         cRange = "R" + cColumn.
         chWorkSheet:Range(cRange):Value = "'" + lNomUser.

         lGuiasHRutas = "".
         RUN um-get-guias-rutas(INPUT Vtacdocu.codped, INPUT Vtacdocu.nroped, OUTPUT lGuiasHrutas).

         cRange = "S" + cColumn.
         chWorkSheet:Range(cRange):Value = "'" + lGuiasHRutas.
        
         lGuiasHRutas = "".
         RUN um-get-rutas(INPUT Vtacdocu.codped, INPUT Vtacdocu.nroped, OUTPUT lGuiasHrutas).
...
DO  WHILE AVAILABLE Vtacdocu:
    ...
    FOR EACH Vtaddocu OF Vtacdocu NO-LOCK :        
        ...
        chWorkSheet:Range("Q" + cColumn):Value = Vtaddocu.codmat.
        ...
        chWorkSheet:Range("U" + cColumn):Value = Vtaddocu.canped.
        chWorkSheet:Range("V" + cColumn):Value = Vtaddocu.undvta.
        chWorkSheet:Range("W" + cColumn):Value = Vtaddocu.almdes.

        FIND FIRST Almmmate WHERE Almmmate.CodCia = Vtaddocu.CodCia
            AND Almmmate.CodAlm = Vtaddocu.AlmDes
            AND Almmmate.codmat = Vtaddocu.codmat NO-LOCK NO-ERROR.
        IF AVAILABLE Almmmate THEN DO:
        ...
        END.
        chWorkSheet:Range("Z" + cColumn):VALUE = (Vtaddocu.CanPed * Almmmatg.Pesmat ).
        chWorkSheet:Range("AA" + cColumn):Value = "'" + IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 2) THEN ENTRY(3,Vtacdocu.Libre_c03,'|') ELSE "".
...
FIND FIRST Ccbcdocu WHERE Ccbcdocu.codcia = s-codcia
    AND Ccbcdocu.codped = Vtacdocu.codref
    AND Ccbcdocu.nroped = Vtacdocu.nroref
...
DEFINE FRAME f-cab
        ...
        {&PRN4} + {&PRN6A} + "    Cliente: " + Vtacdocu.nomcli + {&PRN6B} FORMAT "X(50)"        
        {&PRN3} + {&PRN7A} + {&PRN6B} + "Fec. Despacho : " + STRING(Vtacdocu.fchent,"99/99/9999") + {&PRN6B} + {&PRN7B} + {&PRN3} AT 80 FORMAT "X(40)" SKIP
...
DEFINE FRAME f-cab
        ...
        {&PRN4} + {&PRN6B} + "Observación: " + Vtacdocu.glosa  FORMAT "X(80)" SKIP
...
DEFINE FRAME f-cab
        ...
        /*{&PRN4} + {&PRN6A} + "    Destino: " + Vtacdocu.codcli + ' ' + Vtacdocu.nomcli + {&PRN6B} + {&PRN3} FORMAT "X(50)" SKIP*/       
        {&PRN3} + {&PRN7A} + {&PRN6B} + " F. Entrega: " + STRING(Vtacdocu.fchent,"99/99/9999") + {&PRN6B} + {&PRN7B} + {&PRN3} AT 90 FORMAT "X(40)" SKIP        
        {&PRN4} + {&PRN6A} + "    Destino: " + Vtacdocu.codcli + ' ' + trim(Vtacdocu.nomcli) + {&PRN6B} + {&PRN3} FORMAT "X(60)" SKIP    
        {&PRN4} + {&PRN6B} + "       Hora: " STRING(TIME,"HH:MM") FORMAT "X(12)" SKIP
...
DEFINE FRAME f-cab
        ...
        {&PRN3} + {&PRN7A} + {&PRN6B} + "         Peso : " + STRING(lPeso,">>>,>>9.99") + {&PRN6B} + {&PRN7B} + {&PRN3} AT 80 FORMAT "X(40)" SKIP
        {&PRN4} + {&PRN6A} + "    Cliente: " + Vtacdocu.nomcli + {&PRN6B} + {&PRN3} FORMAT "X(50)" SKIP
...
/*         {&PRN4} + {&PRN6A} + "Cliente: " + Vtacdocu.nomcli + {&PRN6B} + {&PRN3} AT 1 FORMAT "X(50)" SKIP                                                               */
...
FOR EACH Reporte BREAK BY reporte.nroped BY Reporte.codubi:
    ...
    ASSIGN
        ...
        ASSIGN  w-report.campo-c[6] = reporte.Coddoc + " " + reporte.Nroped
                ...
                w-report.campo-c[16] = (IF LOOKUP(vtacdocu.codped,"ODC,OTC") > 0 THEN "CONSOLIDADA" ELSE "")
                w-report.campo-c[23] = TRIM(vtacdocu.nroori)
                    .
...
DO  WHILE AVAILABLE Vtacdocu:
    ...
    FOR EACH Vtaddocu OF Vtacdocu NO-LOCK :        
        ...
        PUT STREAM REPORT
                ...
                Vtacdocu.usrimpod  "|"
                Vtacdocu.fchimpod "|"
                IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 1) THEN ENTRY(2,Vtacdocu.Libre_c03,'|') ELSE ""  "|"
                iCount1 "|"
                Vtacdocu.glosa "|"
                lsDifTempo_VtaAlm "|"
                lsDifTempo_AlmDist "|"
                ...
                lzona "|"
                lUbicacion "|"
                (Vtaddocu.CanPed * Almmmatg.Pesmat ) "|"
                IF(NUM-ENTRIES(Vtacdocu.Libre_c03,'|') > 2) THEN ENTRY(3,Vtacdocu.Libre_c03,'|') ELSE ""  "|"
                lNomUser SKIP.
...
DO  WHILE AVAILABLE Vtacdocu:
    ...
    FOR EACH Vtaddocu OF Vtacdocu NO-LOCK :        
        ...
        chWorkSheet:Range("A" + cColumn):Value = Vtacdocu.coddoc.
        chWorkSheet:Range("B" + cColumn):Value = Vtacdocu.nroped.             
        chWorkSheet:Range("C" + cColumn):Value = Vtacdocu.fchped.             
        chWorkSheet:Range("D" + cColumn):Value = Vtacdocu.hora.
        cRange = "E" + cColumn.
...
/* Actualizo datos */
DEFINE BUFFER b-vtacdocu FOR vtacdocu.
DEFINE BUFFER ic-Vtacdocu FOR Vtacdocu.
...
DEFINE BUFFER i-Vtacdocu FOR Vtacdocu.
DEFINE BUFFER i-ccbcdocu FOR ccbcdocu.

DEFINE VAR lRetVal AS CHAR INIT ''.

/*FIND FIRST i-Vtacdocu WHERE ROWID(i-Vtacdocu) = p-RowId NO-LOCK NO-ERROR.*/
FIND FIRST i-Vtacdocu WHERE i-Vtacdocu.codcia = s-codcia AND 
                            i-Vtacdocu.codped = p-CodDoc AND
                             i-Vtacdocu.nroped = p-NroDoc NO-LOCK NO-ERROR.
IF AVAILABLE i-Vtacdocu THEN DO:
    /* Guias de la orden de despacho */
    IF i-Vtacdocu.codped = 'O/D' THEN DO:
        FOR EACH i-ccbcdocu USE-INDEX llave15 WHERE i-ccbcdocu.codcia = s-codcia AND 
                                i-ccbcdocu.codped = i-Vtacdocu.codref AND 
                                i-ccbcdocu.nroped = i-Vtacdocu.nroref AND 
                                i-ccbcdocu.flgest <> 'A' NO-LOCK :
            IF i-ccbcdocu.coddoc = 'G/R' AND 
                i-ccbcdocu.libre_c01 = i-Vtacdocu.codped AND 
                i-ccbcdocu.libre_c02 = i-Vtacdocu.nroped THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  IF NUM-ENTRIES(Vtacdocu.Libre_c02,'|') > 1 
      THEN RETURN ENTRY(2,Vtacdocu.Libre_c02,'|').
...
/*     DEFINE BUFFER c-Vtacdocu FOR Vtacdocu. */
    ...
    FIND FIRST b-Vtacdocu WHERE b-Vtacdocu.codcia = s-codcia AND 
        b-Vtacdocu.codped = 'PED' AND
        b-Vtacdocu.nroped = pPedido NO-LOCK NO-ERROR.
    IF AVAILABLE b-Vtacdocu THEN DO:
        lCotizacion = b-Vtacdocu.nroref.
        /* Busco la COT */
        FIND FIRST c-Vtacdocu WHERE c-Vtacdocu.codcia = s-codcia AND 
            c-Vtacdocu.codped = 'COT' AND
            c-Vtacdocu.nroped = lCotizacion NO-LOCK NO-ERROR.
        IF AVAILABLE c-Vtacdocu THEN DO:
            IF (c-Vtacdocu.ordcmp BEGINS pFiltroOrdenCompra) THEN DO:
                lOrdenCompra = TRIM(c-Vtacdocu.ordcmp).
            END.
        END.
    END.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH b-Vtaddocu OF Vtacdocu NO-LOCK, FIRST almmmatg OF b-Vtaddocu NO-LOCK :
        IF almmmatg.pesmat <> ? AND almmmatg.pesmat > 0 THEN DO:
            lPeso = lPeso + (b-Vtaddocu.canped * almmmatg.pesmat).
        END.       
        ELSE DO:
