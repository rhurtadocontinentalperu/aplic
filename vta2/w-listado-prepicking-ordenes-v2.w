  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-listado-prepicking-ordenes-todos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = FchPed':U ,
             OUTPUT h_b-prepicking-ordenes-todos ).
       RUN set-position IN h_b-prepicking-ordenes-todos ( 4.27 , 1.00 ) NO-ERROR.
...
OCXFile = SEARCH( "w-listado-prepicking-ordenes-v2.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-listado-prepicking-ordenes-v2.wrx":U SKIP(1)
