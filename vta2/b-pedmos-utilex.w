...
FacDPedi.CanPed FacDPedi.PreUni FacCPedi.PorDto FacDPedi.Por_Dsctos[1] ~
...
&Scoped-Define DISPLAYED-OBJECTS F-ImpDto2 F-ImpPer F-ImpTot F-TotBrt ~
F-ImpExo F-ValVta F-ImpIsc F-ImpIgv F-ImpDes F-ImpTot-S F-ImpTot-D 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999":U
            WIDTH 7.57
      FacCPedi.PorDto COLUMN-LABEL "% Dscto.!Incluido" FORMAT ">>9.99":U
      FacDPedi.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Manual" FORMAT "->,>>9.999999":U
            WIDTH 6.43
      FacDPedi.Por_Dsctos[2] COLUMN-LABEL "% Dscto!Evento" FORMAT "->,>>9.999999":U
            WIDTH 7.29
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->,>>9.999999":U
            WIDTH 7.14
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U
      FacDPedi.Libre_c05 COLUMN-LABEL "" FORMAT "x(60)":U WIDTH 13.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 150 BY 11.15
...
DEFINE FRAME F-Main
     ...
     F-ImpDto2 AT ROW 13.69 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     F-ImpPer AT ROW 13.69 COL 115 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     F-ImpTot AT ROW 13.73 COL 103 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 13.77 COL 18 NO-LABEL
     F-ImpExo AT ROW 13.77 COL 30 NO-LABEL
     F-ValVta AT ROW 13.77 COL 52.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 13.77 COL 64.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 13.77 COL 77.43 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 13.81 COL 40 COLON-ALIGNED NO-LABEL
     ...
     "Percepción" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.12 COL 117 WIDGET-ID 66
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.23 COL 42.72
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.19 COL 20
     "Otros Dctos" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.15 COL 92 WIDGET-ID 62
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.19 COL 82.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.19 COL 70.57
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.15 COL 105.14
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.19 COL 30.57
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.23 COL 55.86
     " S/." VIEW-AS TEXT
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacCPedi.PorDto
"FacCPedi.PorDto" "% Dscto.!Incluido" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.Por_Dsctos[1]
"FacDPedi.Por_Dsctos[1]" "% Dscto!Manual" ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.FacDPedi.Por_Dsctos[2]
"FacDPedi.Por_Dsctos[2]" "% Dscto!Evento" ? "decimal" ? ? ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.FacDPedi.Por_Dsctos[3]
...
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.Libre_c05
"FacDPedi.Libre_c05" "" ? "character" ? ? ? ? ? ? no ? no no "13.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
