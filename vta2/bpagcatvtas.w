...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCatVtaC WHERE AlmCatVtaC.CodCia = s-codcia ~
  AND AlmCatVtaC.CodPro = w-report.Llave-C ~
  AND AlmCatVtaC.CodDiv = pCodDiv NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH AlmCatVtaC WHERE AlmCatVtaC.CodCia = s-codcia ~
  AND AlmCatVtaC.CodPro = w-report.Llave-C ~
  AND AlmCatVtaC.CodDiv = pCodDiv NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE br_table
     ...
     _JoinCode[1]      = "AlmCatVtaC.CodCia = s-codcia
  AND AlmCatVtaC.CodPro = w-report.Llave-C
