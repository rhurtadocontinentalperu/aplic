...
DEFINE VAR x-flgest AS CHAR INIT '*'.
...
AND (x-flgest = '*' OR (FacCPedi.FlgEst = x-flgest)) ~
...
DEFINE VARIABLE COMBO-BOX-Estado AS CHARACTER FORMAT "X(256)":U INITIAL "*" 
     LABEL "Estado" 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PCOs - ASIGNACION ALMACEN DE DISTRIBUCION"
         HEIGHT             = 25.27
         WIDTH              = 148.43
         MAX-HEIGHT         = 31.35
         MAX-WIDTH          = 164.57
...
ON END-ERROR OF W-Win /* PCOs - ASIGNACION ALMACEN DE DISTRIBUCION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PCOs - ASIGNACION ALMACEN DE DISTRIBUCION */
DO:
