...
&Scoped-Define ENABLED-OBJECTS RECT-65 BUTTON-13 BUTTON-15 x-CodDoc ~
x-NroDoc txtTTrans br_table 
&Scoped-Define DISPLAYED-OBJECTS x-CodDoc x-NroDoc x-FchDoc x-CodCli ~
x-NomCli x-NroItem txtTTxx txtTTrans 
    ...
    DO:
        ...
        FOR EACH Almacen NO-LOCK WHERE Almacen.codcia = s-codcia
            ...
            FIND Almcmov WHERE Almcmov.codcia = s-codcia 
                ...
                AND Almcmov.FlgSit = "T"    /* Transferido y NO recepcionado */
                NO-LOCK NO-ERROR.
        ...
        IF Almcmov.Libre_c02 <> 'T' THEN DO:
            MESSAGE 'Guia de Transferencia YA fue Pre-Pickeada' VIEW-AS ALERT-BOX ERROR.
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      IF NOT AVAILABLE Almcmov THEN UNDO, RETURN 'ADM-ERROR'.
      /* Volvemos a chequear las condiciones */
      IF NOT (Almcmov.Libre_c02 = 'T' AND Almcmov.FlgSit = 'T') THEN DO:
          MESSAGE 'ERROR en la Guia de Transferencia' SKIP
      ...
      /* *********************************** */
      ASSIGN 
          Almcmov.Libre_c02 = 'P'                       /* Pre-Pickeado OK */
          Almcmov.Libre_c04 = x-usrchq + '|' + 
          STRING(TODAY, '99/99/9999') + '|' +
          STRING(TIME,'HH:MM:SS') + '|' +
          STRING(x-fchini, '99/99/9999') + '|' +
          x-horini.
      /* RHC 06/07/2015 CONTROL DE BARRAS POR DIVISION */
      FIND gn-divi WHERE gn-divi.codcia = s-codcia
          AND gn-divi.coddiv = s-coddiv
          NO-LOCK NO-ERROR.
      IF AVAILABLE gn-divi AND GN-DIVI.FlgBarras = NO THEN Almcmov.Libre_c02 = "C".
      RELEASE Almcmov.
  END.
...
OCXFile = SEARCH( "b-prepicking-tranfs.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "b-prepicking-tranfs.wrx":U SKIP(1)
