...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDTabla.Libre_d01 COLUMN-LABEL "% Descuento" FORMAT ">>9.99":U
            WIDTH 9.57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaDTabla.Libre_d02 COLUMN-LABEL "P.U. S/." FORMAT ">,>>9.99":U
            WIDTH 5.72 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 9.42
         FONT 4
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 9.08 COL 97 WIDGET-ID 2
...
"VtaDTabla.Libre_d01" "% Descuento" ">>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaDTabla.Libre_d02
"VtaDTabla.Libre_d02" "P.U. S/." ">,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  RUN vta2/dencartearticulos (OUTPUT TABLE Promocion).
...
ON 'RETURN':U OF  VtaDTabla.Libre_d01, VtaDTabla.Libre_d02, VtaDTabla.LlaveDetalle
DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
