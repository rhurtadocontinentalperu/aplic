  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-aprped-1a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprped ).
       RUN set-position IN h_b-aprped ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-aprped ( 8.04 , 147.00 ) NO-ERROR.
       ...
       RUN set-size IN h_b-sdoxcli ( 5.65 , 53.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-pedido. */
       RUN add-link IN adm-broker-hdl ( h_b-aprped , 'Record':U , h_b-pedido ).

       /* Links to SmartBrowser h_b-sdoxcli. */
       RUN add-link IN adm-broker-hdl ( h_b-pedido , 'Record':U , h_b-sdoxcli ).
