...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 123 BY 14.27
...
DEFINE FRAME D-Dialog
     txtOrdenCompra AT ROW 1.81 COL 66.14 COLON-ALIGNED WIDGET-ID 24
     BUTTON-11 AT ROW 1.81 COL 83 WIDGET-ID 28
     FILL-IN-CodCli AT ROW 1.88 COL 26 COLON-ALIGNED WIDGET-ID 20
     FILL-IN-NomCli AT ROW 2.69 COL 26 COLON-ALIGNED WIDGET-ID 22
     BROWSE-4 AT ROW 3.96 COL 2 WIDGET-ID 200
     Btn_OK AT ROW 18.5 COL 2
     Btn_Cancel AT ROW 18.5 COL 17
     "Venta Normal" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 1.27 COL 3 WIDGET-ID 12
          BGCOLOR 9 FGCOLOR 15 
     RECT-56 AT ROW 1.54 COL 2 WIDGET-ID 26
     SPACE(1.13) SKIP(16.34)
