...
f-Chofer f-NroLicencia F-CodTran f-SedeTran F-Lugar F-Contacto F-horario ~
F-Fecha F-Observ Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS f-Placa f-Marca f-CodAge f-NomTra f-RucAge ~
f-Traslado f-Chofer f-NroLicencia F-CodTran F-Nombre f-SedeTran F-Direccion ~
F-ruc F-Lugar F-Contacto F-horario F-Fecha F-Observ 
...
DEFINE FRAME D-Dialog
     ...
     F-CodTran AT ROW 8.54 COL 20 COLON-ALIGNED WIDGET-ID 2
     F-Nombre AT ROW 8.54 COL 32 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     f-SedeTran AT ROW 9.35 COL 20 COLON-ALIGNED WIDGET-ID 70
     F-Direccion AT ROW 9.35 COL 32 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     F-ruc AT ROW 10.15 COL 20 COLON-ALIGNED WIDGET-ID 14
     F-Lugar AT ROW 11.77 COL 20 COLON-ALIGNED WIDGET-ID 6
     F-Contacto AT ROW 12.58 COL 20 COLON-ALIGNED WIDGET-ID 8
     F-horario AT ROW 13.38 COL 20 COLON-ALIGNED WIDGET-ID 10
     F-Fecha AT ROW 13.38 COL 52 COLON-ALIGNED WIDGET-ID 34
     F-Observ AT ROW 14.19 COL 20 COLON-ALIGNED WIDGET-ID 36
     Btn_OK AT ROW 15.81 COL 2 WIDGET-ID 68
     Btn_Cancel AT ROW 15.81 COL 17
     "SEGUNDO TRAMO:" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 11.23 COL 8 WIDGET-ID 24
          BGCOLOR 9 FGCOLOR 15 
     "PRIMER TRAMO:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 8 COL 8 WIDGET-ID 26
          BGCOLOR 9 FGCOLOR 15 
     ...
     RECT-67 AT ROW 8.27 COL 2 WIDGET-ID 64
...
------------------------------------------------------------------------------*/
  DISPLAY f-Placa f-Marca f-CodAge f-NomTra f-RucAge f-Traslado f-Chofer 
          f-NroLicencia F-CodTran F-Nombre f-SedeTran F-Direccion F-ruc F-Lugar 
          F-Contacto F-horario F-Fecha F-Observ 
      WITH FRAME D-Dialog.
  ENABLE RECT-66 RECT-67 RECT-21 f-Placa f-Traslado f-Chofer f-NroLicencia 
         F-CodTran f-SedeTran F-Lugar F-Contacto F-horario F-Fecha F-Observ 
         Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
              ...
              IF CcbADocu.Libre_C[9] > '' THEN DO:  /* AGENCIA DE TRANSPORTE */
                  ...
                  IF AVAILABLE TabDistr THEN DO:
                      ASSIGN
                          ...
                          FacCPedi.LugEnt    = gn-provd.DirPro
                          pFchEnt            = FacCPedi.FchEnt
                          pMensaje           = ''.
