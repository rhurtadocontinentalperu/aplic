...
FacCPedi.TpoCmb FacCPedi.CodPos FacCPedi.FlgIgv FacCPedi.CodVen ~
FacCPedi.Libre_d01 FacCPedi.FmaPgo FacCPedi.NroCard FacCPedi.LugEnt2 
...
FacCPedi.usuario FacCPedi.DirCli FacCPedi.ordcmp FacCPedi.Sede ~
FacCPedi.Cmpbnte FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.Glosa ~
FacCPedi.TpoCmb FacCPedi.CodPos FacCPedi.FlgIgv FacCPedi.CodVen ~
FacCPedi.Libre_d01 FacCPedi.FmaPgo FacCPedi.CodRef FacCPedi.NroRef ~
...
"5", 5
     ...
     BtnPtoSalida AT ROW 10.23 COL 78 WIDGET-ID 138
...
/* SETTINGS FOR BUTTON BtnPtoSalida IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       BtnPtoSalida:HIDDEN IN FRAME F-Main           = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ASSIGN
          ...
          BtnPtoSalida:VISIBLE = NO
          BtnPtoSalida:SENSITIVE = NO.
  END.
    ...
    /* OTRAS VALIDACIONES */
     ...
     IF faccpedi.libre_c01 <> ? THEN DO:
         ...
         IF AVAILABLE b-gn-divi THEN DO:
             ...
             /*
             /* Si es FERIA */
             IF b-gn-divi.canalventa = 'FER' THEN DO:
