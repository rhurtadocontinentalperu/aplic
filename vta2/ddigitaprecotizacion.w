...
DO:
  RUN Graba-Datos IN h_bdigitaprecotizaciondetalle.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/bdigitaprecotizacionprov.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bdigitaprecotizacionprov ).
       RUN set-position IN h_bdigitaprecotizacionprov ( 2.92 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bdigitaprecotizacionprov ( 8.46 , 74.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/bdigitaprecotizaciondetalle.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bdigitaprecotizaciondetalle ).
       RUN set-position IN h_bdigitaprecotizaciondetalle ( 11.58 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bdigitaprecotizaciondetalle ( 13.23 , 137.00 ) NO-ERROR.
