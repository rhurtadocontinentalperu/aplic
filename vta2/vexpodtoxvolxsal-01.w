...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-PreUni-1 FILL-IN-PreUni-2 ~
FILL-IN-PreUni-3 FILL-IN-PreUni-4 FILL-IN-PreUni-5 FILL-IN-PreUni-6 ~
FILL-IN-PreUni-7 FILL-IN-PreUni-8 FILL-IN-PreUni-9 FILL-IN-PreUni-10 
...
DEFINE VARIABLE FILL-IN-PreUni-1 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-10 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-2 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-3 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-4 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-5 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-6 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-7 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-8 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-PreUni-9 AS DECIMAL FORMAT ">>>,>>9.9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     FacTabla.Valor[1] AT ROW 4.23 COL 3 NO-LABEL WIDGET-ID 32 FORMAT "->>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-1 AT ROW 4.23 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     ...
     FacTabla.Valor[2] AT ROW 5.04 COL 3 NO-LABEL WIDGET-ID 36 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-2 AT ROW 5.04 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     ...
     FacTabla.Valor[3] AT ROW 5.85 COL 3 NO-LABEL WIDGET-ID 38 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-3 AT ROW 5.85 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     ...
     FacTabla.Valor[4] AT ROW 6.65 COL 3 NO-LABEL WIDGET-ID 40 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-4 AT ROW 6.65 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     ...
     FacTabla.Valor[5] AT ROW 7.46 COL 3 NO-LABEL WIDGET-ID 42 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-5 AT ROW 7.46 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     ...
     FacTabla.Valor[6] AT ROW 8.27 COL 3 NO-LABEL WIDGET-ID 44 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-6 AT ROW 8.27 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     ...
     FacTabla.Valor[7] AT ROW 9.08 COL 3 NO-LABEL WIDGET-ID 46 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-7 AT ROW 9.08 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 78
     ...
     FacTabla.Valor[8] AT ROW 9.88 COL 3 NO-LABEL WIDGET-ID 48 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-8 AT ROW 9.88 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 80
     ...
     FacTabla.Valor[9] AT ROW 10.69 COL 3 NO-LABEL WIDGET-ID 50 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-9 AT ROW 10.69 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 82
...
DEFINE FRAME F-Main
     FacTabla.Valor[10] AT ROW 11.5 COL 3 NO-LABEL WIDGET-ID 12 FORMAT ">>>,>>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     FILL-IN-PreUni-10 AT ROW 11.5 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 84
     FacTabla.Valor[20] AT ROW 11.5 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     "Precio Unitario" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 3.15 COL 19 WIDGET-ID 86
...
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-1 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-10 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-2 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-3 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-4 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-5 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-6 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-7 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-8 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-PreUni-9 IN FRAME F-Main
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME FILL-IN-PreUni-1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-1 V-table-Win
ON LEAVE OF FILL-IN-PreUni-1 IN FRAME F-Main
DO:
  x-PreUni = DECIMAL(FILL-IN-PreUni-1:SCREEN-VALUE).
  x-PorDto = DECIMAL(FacTabla.Valor[11]:SCREEN-VALUE).
  FacTabla.Valor[11]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
END.
...
&Scoped-define SELF-NAME FILL-IN-PreUni-10
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-10 V-table-Win
ON LEAVE OF FILL-IN-PreUni-10 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-10:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[20]:SCREEN-VALUE).
    FacTabla.Valor[20]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-2 V-table-Win
ON LEAVE OF FILL-IN-PreUni-2 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-2:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[12]:SCREEN-VALUE).
    FacTabla.Valor[12]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
END.
...
&Scoped-define SELF-NAME FILL-IN-PreUni-3
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-3 V-table-Win
ON LEAVE OF FILL-IN-PreUni-3 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-3:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[13]:SCREEN-VALUE).
    FacTabla.Valor[13]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-4
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-4 V-table-Win
ON LEAVE OF FILL-IN-PreUni-4 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-4:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[14]:SCREEN-VALUE).
    FacTabla.Valor[14]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-5
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-5 V-table-Win
ON LEAVE OF FILL-IN-PreUni-5 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-5:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[15]:SCREEN-VALUE).
    FacTabla.Valor[15]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-6
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-6 V-table-Win
ON LEAVE OF FILL-IN-PreUni-6 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-6:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[16]:SCREEN-VALUE).
    FacTabla.Valor[16]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-7
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-7 V-table-Win
ON LEAVE OF FILL-IN-PreUni-7 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-7:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[17]:SCREEN-VALUE).
    FacTabla.Valor[17]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-8
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-8 V-table-Win
ON LEAVE OF FILL-IN-PreUni-8 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-8:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[18]:SCREEN-VALUE).
    FacTabla.Valor[18]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
&Scoped-define SELF-NAME FILL-IN-PreUni-9
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-PreUni-9 V-table-Win
ON LEAVE OF FILL-IN-PreUni-9 IN FRAME F-Main
DO:
    x-PreUni = DECIMAL(FILL-IN-PreUni-9:SCREEN-VALUE).
    x-PorDto = DECIMAL(FacTabla.Valor[19]:SCREEN-VALUE).
    FacTabla.Valor[19]:SCREEN-VALUE = STRING( (1 - (x-PreUni / x-Precio)) * 100 ).
...
DO WITH FRAME {&FRAME-NAME} :
    ...
    FOR EACH B-Tabla WHERE B-Tabla.CodCia = FacTabla.CodCia AND
        ...
        IF NOT AVAILABLE VtaListaMay THEN DO:
            ...
            RETURN 'ADM-ERROR'.
        END.
        IF FacTabla.Campo-C[1]:SCREEN-VALUE <> VtaListaMay.Chr__01 THEN DO:
    ...
    DEF VAR x-PreUni AS DECI EXTENT 10 NO-UNDO.

    ASSIGN
        x-PreUni[01] = DECIMAL(FILL-IN-PreUni-1:SCREEN-VALUE)
        x-PreUni[02] = DECIMAL(FILL-IN-PreUni-2:SCREEN-VALUE)
        x-PreUni[03] = DECIMAL(FILL-IN-PreUni-3:SCREEN-VALUE)
        x-PreUni[04] = DECIMAL(FILL-IN-PreUni-4:SCREEN-VALUE)
        x-PreUni[05] = DECIMAL(FILL-IN-PreUni-5:SCREEN-VALUE)
        x-PreUni[06] = DECIMAL(FILL-IN-PreUni-6:SCREEN-VALUE)
        x-PreUni[07] = DECIMAL(FILL-IN-PreUni-7:SCREEN-VALUE)
        x-PreUni[08] = DECIMAL(FILL-IN-PreUni-8:SCREEN-VALUE)
        x-PreUni[09] = DECIMAL(FILL-IN-PreUni-9:SCREEN-VALUE)
        x-PreUni[10] = DECIMAL(FILL-IN-PreUni-10:SCREEN-VALUE)
        .

    DEFINE VAR hProc AS HANDLE NO-UNDO.
    RUN pri/pri-librerias PERSISTENT SET hProc.
    /* Barremos cada producto relacionado */
    FOR EACH B-FacTabla NO-LOCK WHERE B-FacTabla.codcia = FacTabla.codcia
        ...
        ASSIGN 
            x-CodMat = B-FacTabla.Campo-c[1].
        DO x-Orden = 1 TO 10:
            IF x-PreUni[x-Orden] <= 0 THEN NEXT.
            /* 1ro. Calculamos el margen de utilidad */
            RUN PRI_Margen-Utilidad IN hProc (INPUT x-CodDiv,
                                              INPUT x-CodMat,
                                              INPUT FacTabla.Campo-C[1]:SCREEN-VALUE,
                                              INPUT x-PreUni[x-Orden],
                                              INPUT 1,
                                              OUTPUT x-Margen,
                                              OUTPUT x-Limite,
                                              OUTPUT pError).
            ...
            IF pError > '' THEN DO:
                ...
                RUN PRI_Alerta-de-Margen IN hProc (INPUT x-CodMat,
                                                   OUTPUT pAlerta).
