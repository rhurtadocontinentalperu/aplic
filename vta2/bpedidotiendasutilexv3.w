...
Almmmatg.DesMat Almmmatg.DesMar FacDPedi.AlmDes FacDPedi.UndVta ~
...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Arte F-ImpDto2 F-ImpPer F-ImpTot ~
F-TotBrt F-ImpExo F-ValVta F-ImpIsc F-ImpIgv F-ImpDes F-ImpTot-S F-ImpTot-D 
...
DEFINE VARIABLE F-ImpPer AS DECIMAL FORMAT "Z,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 10 BY .69
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
DEFINE VARIABLE FILL-IN-Arte AS DECIMAL FORMAT "->>>,>>9.99":U INITIAL 0 
     LABEL "TOTAL LINEA DE ARTE" 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)":U WIDTH 8.43
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999":U
            WIDTH 7.57
      FacDPedi.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Manual" FORMAT "->>9.99":U
            WIDTH 6.43
      FacDPedi.Por_Dsctos[2] COLUMN-LABEL "% Dscto!Evento" FORMAT "->>9.99":U
            WIDTH 7.29
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.99":U
            WIDTH 7.14
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U
      FacDPedi.Libre_c05 COLUMN-LABEL "" FORMAT "x(60)":U WIDTH 4.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141 BY 11.15
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Arte AT ROW 12.54 COL 18 COLON-ALIGNED WIDGET-ID 68
     F-ImpDto2 AT ROW 13.69 COL 104 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     F-ImpPer AT ROW 13.69 COL 129 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     F-ImpTot AT ROW 13.73 COL 117 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 13.77 COL 32 NO-LABEL
     F-ImpExo AT ROW 13.77 COL 44 NO-LABEL
     F-ValVta AT ROW 13.77 COL 66.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 13.77 COL 78.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 13.77 COL 91.43 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 13.81 COL 54 COLON-ALIGNED NO-LABEL
     F-ImpTot-S AT ROW 15.38 COL 104.43 RIGHT-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpTot-D AT ROW 15.38 COL 113.43 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.19 COL 34
     "Otros Dctos" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.15 COL 106 WIDGET-ID 62
     ...
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.23 COL 56.72
     " S/." VIEW-AS TEXT
          SIZE 4 BY 1.35 AT ROW 15.23 COL 83 WIDGET-ID 6
          BGCOLOR 0 FGCOLOR 15 FONT 30
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.23 COL 69.86
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.19 COL 44.57
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.15 COL 119.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.19 COL 84.57
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.19 COL 96.14
     "   $" VIEW-AS TEXT
          SIZE 5 BY 1.35 AT ROW 15.23 COL 109 WIDGET-ID 52
          BGCOLOR 0 FGCOLOR 15 FONT 30
     "Percepción" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.12 COL 131 WIDGET-ID 66
     RECT-11 AT ROW 12.35 COL 1
     RECT-3 AT ROW 14.85 COL 1 WIDGET-ID 56
...
/* SETTINGS FOR FILL-IN F-ImpIsc IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-ImpPer IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN F-ValVta IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Arte IN FRAME F-Main
   NO-ENABLE                                                            */
...
"Almmmatg.DesMar" "Marca" "X(12)" "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.FacDPedi.AlmDes
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacDPedi.Por_Dsctos[1]
"FacDPedi.Por_Dsctos[1]" "% Dscto!Manual" ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.Por_Dsctos[2]
"FacDPedi.Por_Dsctos[2]" "% Dscto!Evento" ? "decimal" ? ? ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.FacDPedi.Por_Dsctos[3]
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol/Prom" ? "decimal" ? ? ? ? ? ? no ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.FacDPedi.ImpLin
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.Libre_c05
"FacDPedi.Libre_c05" "" ? "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  THEN DO: 
      ASSIGN
        f-ImpDes = FacCPedi.ImpDto
        f-ImpDto2 = Faccpedi.ImpDto2
        f-ImpExo = FacCPedi.ImpExo
        f-ImpIgv = FacCPedi.ImpIgv
        f-ImpIsc = FacCPedi.ImpIsc
        f-ImpTot = FacCPedi.ImpTot
        f-ImpPer = FacCPedi.AcuBon[5]
        f-ImpTot-S = FacCPedi.ImpTot + FacCPedi.AcuBon[5]
        f-TotBrt = FacCPedi.ImpBrt
        f-ValVta = FacCPedi.ImpVta.
        /*f-PorDes = FacCPedi.PorDto.*/
      FOR EACH Facdpedi OF Faccpedi NO-LOCK, FIRST Almmmatg OF Facdpedi NO-LOCK WHERE Almmmatg.codfam = '014':
          /*FILL-IN-Arte = FILL-IN-Arte + (Facdpedi.implin - FacDPedi.ImpDto2).*/
          FILL-IN-Arte = FILL-IN-Arte + Facdpedi.implin.
      END.
  END.
