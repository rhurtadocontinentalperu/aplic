...
DEF VAR s-Tabla AS CHAR INIT "DTOPROUTILEX" NO-UNDO.
...
IF GN-DIVI.Campo-Log[1] = YES THEN DO:
    MESSAGE 'División INACTIVA' VIEW-AS ALERT-BOX ERROR.
    APPLY 'ENTRY':U TO VtaTabla.Llave_c2.
    RETURN 'ADM-ERROR'.
END.
IF GN-DIVI.CanalVenta <> "MIN" THEN DO:
    MESSAGE 'División NO es UTILEX' VIEW-AS ALERT-BOX ERROR.
    APPLY 'ENTRY':U TO VtaTabla.Llave_c2.
    RETURN 'ADM-ERROR'.
END.
