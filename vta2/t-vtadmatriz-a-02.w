...
DEFINE FRAME F-Main
     ...
     "F8: Cambiar Unidad  de Venta" VIEW-AS TEXT
          SIZE 26 BY .5 AT ROW 16.38 COL 25 WIDGET-ID 36
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[1] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[1] @ T-DMatriz.UndVta[1]
            /*T-DMatriz.PreUni[1] @ T-DMatriz.PreUni[1]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[1],
                                  T-DMatriz.AlmDes[1],
                                  T-DMatriz.UndVta[1],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[1] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[1] @ T-DMatriz.StkAct[1] WITH BROWSE {&browse-name}.
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[2] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[2] @ T-DMatriz.UndVta[2]
            /*T-DMatriz.PreUni[2] @ T-DMatriz.PreUni[2]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[2],
                                  T-DMatriz.AlmDes[2],
                                  T-DMatriz.UndVta[2],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[2] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[2] @ T-DMatriz.StkAct[2] WITH BROWSE {&browse-name}.
        RUN Importe-Total.
    END.
END.
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[3] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[3] @ T-DMatriz.UndVta[3]
            /*T-DMatriz.PreUni[3] @ T-DMatriz.PreUni[3]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[3],
                                  T-DMatriz.AlmDes[3],
                                  T-DMatriz.UndVta[3],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[3] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[3] @ T-DMatriz.StkAct[3] WITH BROWSE {&browse-name}.
        RUN Importe-Total.
    END.
END.
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[4] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[4] @ T-DMatriz.UndVta[4]
            /*T-DMatriz.PreUni[4] @ T-DMatriz.PreUni[4]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[4],
                                  T-DMatriz.AlmDes[4],
                                  T-DMatriz.UndVta[4],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[4] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[4] @ T-DMatriz.StkAct[4] WITH BROWSE {&browse-name}.
        RUN Importe-Total.
    END.
END.
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[5] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[5] @ T-DMatriz.UndVta[5]
            /*T-DMatriz.PreUni[5] @ T-DMatriz.PreUni[5]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[5],
                                  T-DMatriz.AlmDes[5],
                                  T-DMatriz.UndVta[5],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[5] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[5] @ T-DMatriz.StkAct[5] WITH BROWSE {&browse-name}.
        RUN Importe-Total.
    END.
END.
...
DO:
    ...
    IF output-var-1 <> ? THEN DO:
        ASSIGN
            T-DMatriz.UndVta[6] = output-var-2.
        ...
        DISPLAY 
            T-DMatriz.UndVta[6] @ T-DMatriz.UndVta[6]
            /*T-DMatriz.PreUni[6] @ T-DMatriz.PreUni[6]*/ WITH BROWSE {&browse-name}.
        RUN Carga-Stock-Registro (T-DMatriz.CodMat[6],
                                  T-DMatriz.AlmDes[6],
                                  T-DMatriz.UndVta[6],
                                  OUTPUT pStkAct).
        T-DMatriz.StkAct[6] = pStkAct.
        DISPLAY 
            T-DMatriz.StkAct[6] @ T-DMatriz.StkAct[6] WITH BROWSE {&browse-name}.
        RUN Importe-Total.
    END.
END.
