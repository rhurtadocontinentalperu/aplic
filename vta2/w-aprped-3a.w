...
DEFINE VARIABLE h_b-aprped-3a AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-11 AT ROW 19.31 COL 114 WIDGET-ID 2
     BUTTON-12 AT ROW 19.31 COL 129 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 150.86 BY 19.81 WIDGET-ID 100.
...
ON END-ERROR OF W-Win /* PEDIDOS POR APROBAR - MULTIPLE SELECCION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PEDIDOS POR APROBAR - MULTIPLE SELECCION */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-aprped-3a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprped-3a ).
       RUN set-position IN h_b-aprped-3a ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-aprped-3a ( 6.96 , 146.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedido ).
       RUN set-position IN h_b-pedido ( 8.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-pedido ( 10.96 , 146.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-pedido. */
       RUN add-link IN adm-broker-hdl ( h_b-aprped-3a , 'Record':U , h_b-pedido ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-aprped-3a ,
             BUTTON-11:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-pedido ,
             h_b-aprped-3a , 'AFTER':U ).
    END. /* Page 0 */
