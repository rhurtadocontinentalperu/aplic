...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND (TRUE <> (FILL-IN-CodVen > '') OR FacCPedi.CodVen = FILL-IN-CodVen) NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS SELECT-FlgEst BUTTON-Filtrar ~
COMBO-BOX-Filtro FILL-IN-NomCli BUTTON-Limpiar FILL-IN-CodVen ~
FILL-IN-FchPed-1 FILL-IN-FchPed-2 br_table 
&Scoped-Define DISPLAYED-OBJECTS x-CodDiv x-NomDiv SELECT-FlgEst ~
COMBO-BOX-Filtro FILL-IN-NomCli FILL-IN-CodVen FILL-IN-NomVen ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 157 BY 8.35
...
DEFINE FRAME F-Main
     x-CodDiv AT ROW 1 COL 24 COLON-ALIGNED WIDGET-ID 18
     x-NomDiv AT ROW 1 COL 32 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     SELECT-FlgEst AT ROW 1 COL 109 NO-LABEL WIDGET-ID 82
     BUTTON-Filtrar AT ROW 1.27 COL 143 WIDGET-ID 28
     COMBO-BOX-Filtro AT ROW 1.81 COL 24 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-NomCli AT ROW 1.81 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     BUTTON-Limpiar AT ROW 2.35 COL 143 WIDGET-ID 26
     FILL-IN-CodVen AT ROW 2.62 COL 24 COLON-ALIGNED WIDGET-ID 22
     FILL-IN-NomVen AT ROW 2.62 COL 33 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     FILL-IN-FchPed-1 AT ROW 3.42 COL 24 COLON-ALIGNED WIDGET-ID 86
     FILL-IN-FchPed-2 AT ROW 3.42 COL 48 COLON-ALIGNED WIDGET-ID 88
     br_table AT ROW 4.5 COL 1
     "Estado:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 1 COL 103 WIDGET-ID 84
...
/* Query rebuild information for BROWSE br_table
 ...
 AND FacCPedi.CodDoc = ""COT""
 AND FacCPedi.CodDiv = x-coddiv
 AND (TRUE <> (FILL-IN-CodVen > '') OR FacCPedi.CodVen = FILL-IN-CodVen)"
...
"_FlgEst() @ x-Estado" "Estado" "x(20)" ? ? ? ? ? ? ? no ? no no "17.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  ASSIGN
      x-CodDiv COMBO-BOX-FILTRO FILL-IN-CodVen FILL-IN-NomVen FILL-IN-NomCli 
...
ON VALUE-CHANGED OF COMBO-BOX-Filtro IN FRAME F-Main /* Filtro por Nombre de Cliente */
DO:
...
DO:
  ASSIGN {&self-name}.
  FILL-IN-NomVen:SCREEN-VALUE = ''.
  FIND Gn-ven WHERE gn-ven.CodCia = s-CodCia 
      AND gn-ven.CodVen = FILL-IN-CodVen:SCREEN-VALUE
      NO-LOCK NO-ERROR.
  IF AVAILABLE Gn-ven THEN FILL-IN-NomVen:SCREEN-VALUE = gn-ven.NomVen.
  ASSIGN FILL-IN-NomVen.
  RUN dispatch IN THIS-PROCEDURE('open-query-cases':U).
  RUN Procesa-Handle IN lh_handle ('Open-Query':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  x-coddiv = s-coddiv.
  FIND gn-divi WHERE codcia = s-codcia
