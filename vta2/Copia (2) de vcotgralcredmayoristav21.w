  ...
  FOR EACH ITEM WHERE ITEM.ImpLin > 0,
      ...
      IF GN-DIVI.Campo-Log[9] = YES THEN DO:
          ...
          IF AVAILABLE Almmmate THEN DO:
              RUN vta2/Stock-Comprometido-v2 (ITEM.CodMat,
                                           ENTRY(1, s-CodAlm),
...
/* ******************************************************* */
IF s-TpoPed = "S" AND s-Import-B2B = YES THEN RETURN.
/* ******************************************************* */
/* ******************************************************* */
/* ARTIFICIO */
...
------------------------------------------------------------------------------*/
  ...
  /* Recalcula PRECIOS */
  RUN Recalcular-Precios.
  /* RHC 10/02/2016 LISTA EXPRESS: No hay cambio de precios */
/*   IF s-TpoPed <> "LF" THEN DO:         */
...
/* RHC 06/11/2017: Revisar también vta2/wcotcanalmoderno.w */
IF s-TpoPed = "S" AND s-Import-B2B = YES THEN RUN Procesa-Handle IN lh_Handle ('Pagina5').
