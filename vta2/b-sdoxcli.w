...
CcbCDocu.NroDoc CcbCDocu.FchDoc CcbCDocu.FchVto ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.CodDoc COLUMN-LABEL "Docum." FORMAT "x(3)":U
      CcbCDocu.NroDoc FORMAT "X(15)":U WIDTH 14.86
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 65 BY 5.65
         FONT 4
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.CcbCDocu WHERE INTEGRAL.FacCPedi ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.CcbCDocu.CodCia = INTEGRAL.FacCPedi.CodCia
  AND INTEGRAL.CcbCDocu.CodCli = INTEGRAL.FacCPedi.CodCli
"
     _Where[1]         = "INTEGRAL.CcbCDocu.FlgEst = ""P""
 AND INTEGRAL.CcbCDocu.FchVto + 1 < TODAY 
 AND (INTEGRAL.CcbCDocu.CodDoc = ""FAC""
  OR INTEGRAL.CcbCDocu.CodDoc = ""BOL""
  OR INTEGRAL.CcbCDocu.CodDoc = ""LET""
  OR INTEGRAL.CcbCDocu.CodDoc = ""N/D""
  OR INTEGRAL.CcbCDocu.CodDoc = ""CHQ""
  OR INTEGRAL.CcbCDocu.CodDoc = ""TCK""
  OR INTEGRAL.CcbCDocu.CodDoc = ""N/A""
  OR INTEGRAL.CcbCDocu.CodDoc = ""A/R""
  OR INTEGRAL.CcbCDocu.CodDoc = ""A/C""
  OR INTEGRAL.CcbCDocu.CodDoc = ""BD""
  OR INTEGRAL.CcbCDocu.CodDoc = ""DCO"")"
...
"CcbCDocu.CodDoc" "Docum." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.CcbCDocu.NroDoc
"CcbCDocu.NroDoc" ? "X(15)" "character" ? ? ? ? ? ? no ? no no "14.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  {&BROWSE-NAME}:TITLE IN FRAME {&FRAME-NAME} = "DOCUMENTOS VENCIDOS " + Faccpedi.nomcli.
