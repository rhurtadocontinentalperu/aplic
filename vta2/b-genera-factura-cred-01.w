...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
      ...
      AND gn-ConVt.Libre_l01 = FALSE NO-LOCK ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[3]         = "gn-ConVt.Libre_l01 = FALSE"
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    /*RUN vta2/d-genera-factura-cred-01 ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */*/
    RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    /*RUN vta2/d-genera-factura-cred-01 ( ROWID(FacCPedi), 'M' ).       /* MANUAL */*/
    RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'M' ).       /* MANUAL */
