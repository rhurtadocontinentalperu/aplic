  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-listaprecios-cred.w':U ,
       ...
       RUN set-size IN h_l-listaprecios-cred ( 14.23 , 117.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-listaprecios-cred. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listaprecios-cred ).
