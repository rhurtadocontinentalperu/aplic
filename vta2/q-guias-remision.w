...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "{&CONDICION}"
     _Design-Parent    is WINDOW q-tables @ ( 1.23 , 13.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Reposiciona q-tables 
...
DEF INPUT PARAMETER pRowidChar AS CHAR.

DEF VAR output-var-1 AS ROWID NO-UNDO.

output-var-1 = TO-ROWID(pRowidChar).
