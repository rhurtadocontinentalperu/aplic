...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 120.72 BY 12.31
...
DEFINE FRAME F-Main
     ...
     BUTTON-9 AT ROW 4.46 COL 123 WIDGET-ID 40
     btn-elimina AT ROW 8.12 COL 123 WIDGET-ID 6
     F-ValVta AT ROW 13.92 COL 58 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     F-ImpIsc AT ROW 13.92 COL 71 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     F-PorDes AT ROW 13.96 COL 11 COLON-ALIGNED WIDGET-ID 20
     F-TotBrt AT ROW 13.96 COL 24 NO-LABEL WIDGET-ID 22
     F-ImpExo AT ROW 13.96 COL 36 NO-LABEL WIDGET-ID 12
     F-ImpDes AT ROW 13.96 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     F-ImpIgv AT ROW 13.96 COL 83 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-ImpTot AT ROW 13.96 COL 96 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.38 COL 98 WIDGET-ID 38
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.38 COL 61 WIDGET-ID 30
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.38 COL 87 WIDGET-ID 32
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.38 COL 48 WIDGET-ID 34
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.38 COL 35 WIDGET-ID 36
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.38 COL 24 WIDGET-ID 26
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.38 COL 76 WIDGET-ID 28
...
DO:
    IF s-codcli = '' THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    RUN vta2/ddigitaprecot-terceros.
...
DO:
    ...
    IF s-codcli = '' THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    RUN vta2/ddigitaprecotizacionv1.
    RUN Procesa-Handle IN lh_handle ('Recalculo').
    RUN Imp-Total.
    RUN dispatch IN THIS-PROCEDURE ('open-query':U).
END.
