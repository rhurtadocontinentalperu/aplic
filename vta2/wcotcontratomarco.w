...
/* RHC 16/04/2015 OJO >>> SOLO PARA CONTRATO MARCO */
s-TpoPed = ENTRY(1, pParametro).
IF s-TpoPed <> "M" THEN RETURN ERROR.
/* *********************************************** */
...
DEFINE FRAME F-Main
     ...
     BUTTON-IMPORTAR-EXCEL AT ROW 3.69 COL 119 WIDGET-ID 40
     B-CCTE AT ROW 8.69 COL 119 WIDGET-ID 12
     BUTTON-COT AT ROW 9.77 COL 119 WIDGET-ID 14
     B-CLI AT ROW 10.85 COL 119 WIDGET-ID 22
...
DO:
   RUN Importar-Excel-Marco IN h_vcotizacioncreditomay.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-24 COMBO-NroSer BTN-Excel BUTTON-IMPORTAR-EXCEL 
      WITH FRAME F-Main IN WINDOW W-Win.
