  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Cantidades|Precios|Stocks' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/t-vtadmatriz.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-vtadmatriz ).
       RUN set-position IN h_t-vtadmatriz ( 8.88 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-vtadmatriz ( 15.62 , 142.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-size IN h_t-vtadmatriz-02 ( 13.27 , 142.00 ) NO-ERROR.
  ...
  FOR EACH Vtacmatriz WHERE Vtacmatriz.codcia = s-codcia
      ...
      IF T-DMatriz.codmat[2] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[2] = Almmmatg.UndA
              T-DMatriz.PreUni[2] = fPreUni(T-DMatriz.codmat[2], T-DMatriz.UndVta[2], T-DMatriz.AlmDes[2]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[2] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[2] = Almmmatg.UndB
              T-DMatriz.PreUni[2] = fPreUni(T-DMatriz.codmat[2], T-DMatriz.UndVta[2], T-DMatriz.AlmDes[2]).
      END.
      IF T-DMatriz.codmat[3] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[3] = Almmmatg.UndA
              T-DMatriz.PreUni[3] = fPreUni(T-DMatriz.codmat[3], T-DMatriz.UndVta[3], T-DMatriz.AlmDes[3]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[3] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[3] = Almmmatg.UndB
              T-DMatriz.PreUni[3] = fPreUni(T-DMatriz.codmat[3], T-DMatriz.UndVta[3], T-DMatriz.AlmDes[3]).
      END.
      IF T-DMatriz.codmat[4] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[4] = Almmmatg.UndA
              T-DMatriz.PreUni[4] = fPreUni(T-DMatriz.codmat[4], T-DMatriz.UndVta[4], T-DMatriz.AlmDes[4]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[4] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[4] = Almmmatg.UndB
              T-DMatriz.PreUni[4] = fPreUni(T-DMatriz.codmat[4], T-DMatriz.UndVta[4], T-DMatriz.AlmDes[4]).
      END.
      IF T-DMatriz.codmat[5] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[5] = Almmmatg.UndA
              T-DMatriz.PreUni[5] = fPreUni(T-DMatriz.codmat[5], T-DMatriz.UndVta[5], T-DMatriz.AlmDes[5]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[5] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[5] = Almmmatg.UndB
              T-DMatriz.PreUni[5] = fPreUni(T-DMatriz.codmat[5], T-DMatriz.UndVta[5], T-DMatriz.AlmDes[5]).
      END.
      IF T-DMatriz.codmat[6] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[6] = Almmmatg.UndA
              T-DMatriz.PreUni[6] = fPreUni(T-DMatriz.codmat[6], T-DMatriz.UndVta[6], T-DMatriz.AlmDes[6]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[6] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[6] = Almmmatg.UndB
              T-DMatriz.PreUni[6] = fPreUni(T-DMatriz.codmat[6], T-DMatriz.UndVta[6], T-DMatriz.AlmDes[6]).
      END.
      IF T-DMatriz.codmat[7] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[7] = Almmmatg.UndA
              T-DMatriz.PreUni[7] = fPreUni(T-DMatriz.codmat[7], T-DMatriz.UndVta[7], T-DMatriz.AlmDes[7]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[7] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[7] = Almmmatg.UndB
              T-DMatriz.PreUni[7] = fPreUni(T-DMatriz.codmat[7], T-DMatriz.UndVta[7], T-DMatriz.AlmDes[7]).
      END.
      IF T-DMatriz.codmat[8] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[8] = Almmmatg.UndA
              T-DMatriz.PreUni[8] = fPreUni(T-DMatriz.codmat[8], T-DMatriz.UndVta[8], T-DMatriz.AlmDes[8]).
      END.
      ...
      IF T-DMatriz.codmat[10] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[10] = Almmmatg.UndA
              T-DMatriz.PreUni[10] = fPreUni(T-DMatriz.codmat[10], T-DMatriz.UndVta[10], T-DMatriz.AlmDes[10]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[10] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[10] = Almmmatg.UndB
              T-DMatriz.PreUni[10] = fPreUni(T-DMatriz.codmat[10], T-DMatriz.UndVta[10], T-DMatriz.AlmDes[10]).
      END.
      IF T-DMatriz.codmat[11] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[11] = Almmmatg.UndA
              T-DMatriz.PreUni[11] = fPreUni(T-DMatriz.codmat[11], T-DMatriz.UndVta[11], T-DMatriz.AlmDes[11]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[11] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[11] = Almmmatg.UndB
              T-DMatriz.PreUni[11] = fPreUni(T-DMatriz.codmat[11], T-DMatriz.UndVta[11], T-DMatriz.AlmDes[11]).
      END.
      IF T-DMatriz.codmat[12] <> "" THEN DO:
          ...
          IF AVAILABLE Almmmatg THEN
              ...
              T-DMatriz.UndVta[12] = Almmmatg.UndA
              T-DMatriz.PreUni[12] = fPreUni(T-DMatriz.codmat[12], T-DMatriz.UndVta[12], T-DMatriz.AlmDes[12]).
          IF AVAILABLE Almmmatg AND Almmmatg.UndB <> "" THEN
              ASSIGN
              T-DMatriz.AlmDes[12] = ENTRY(1, s-codalm)
              T-DMatriz.UndVta[12] = Almmmatg.UndB
              T-DMatriz.PreUni[12] = fPreUni(T-DMatriz.codmat[12], T-DMatriz.UndVta[12], T-DMatriz.AlmDes[12]).
      END.
  END.
  /* Cargsmos stock actual */
