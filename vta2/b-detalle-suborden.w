...
Almmmatg.DesMar VtaDDocu.CanPed VtaDDocu.UndVta VtaDDocu.AlmDes ~
Almmmate.CodUbi (VtaDDocu.CanPed * Almmmatg.Pesmat) @ lPesoVta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDDocu.CodMat COLUMN-LABEL "Codigo" FORMAT "X(6)":U WIDTH 7.43
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 36.43
      Almmmatg.DesMar FORMAT "X(30)":U WIDTH 19.43
      VtaDDocu.CanPed FORMAT "->>>,>>9.9999":U WIDTH 8.43
      VtaDDocu.UndVta COLUMN-LABEL "Und ! Vta" FORMAT "x(5)":U
            WIDTH 5.43
      VtaDDocu.AlmDes FORMAT "x(3)":U WIDTH 7.43
      Almmmate.CodUbi FORMAT "x(7)":U WIDTH 9.43
      (VtaDDocu.CanPed * Almmmatg.Pesmat) @ lPesoVta COLUMN-LABEL "Peso Kgr" FORMAT "->>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114 BY 11.15
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaDDocu OF INTEGRAL.VtaCDocu,INTEGRAL.Almmmatg OF INTEGRAL.VtaDDocu,INTEGRAL.Almmmate WHERE INTEGRAL.Almmmatg  ...,INTEGRAL.almtubic OF INTEGRAL.Almmmate"
...
"VtaDDocu.CodMat" "Codigo" ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "36.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"Almmmatg.DesMar" ? ? "character" ? ? ? ? ? ? no ? no no "19.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaDDocu.CanPed
"VtaDDocu.CanPed" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaDDocu.UndVta
"VtaDDocu.UndVta" "Und ! Vta" ? "character" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaDDocu.AlmDes
"VtaDDocu.AlmDes" ? ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.Almmmate.CodUbi
"Almmmate.CodUbi" ? ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"(VtaDDocu.CanPed * Almmmatg.Pesmat) @ lPesoVta" "Peso Kgr" "->>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
