...
&Scoped-Define ENABLED-FIELDS FacCPedi.FaxCli FacCPedi.Libre_c04 ~
FacCPedi.fchven FacCPedi.RucCli FacCPedi.Atencion FacCPedi.FchEnt ~
FacCPedi.NomCli FacCPedi.DirCli FacCPedi.ordcmp FacCPedi.Sede ~
FacCPedi.Cmpbnte FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.Glosa ~
FacCPedi.TpoCmb FacCPedi.CodPos FacCPedi.FlgIgv FacCPedi.Libre_d01 ~
FacCPedi.NroCard FacCPedi.LugEnt2 
...
f-NomVen F-CndVta F-Nomtar PuntodeSalida 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FaxCli AT ROW 1.77 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 124 FORMAT "X(10)"
          ...
          SIZE 9 BY .81
          FONT 6
     FacCPedi.Libre_c04 AT ROW 1.77 COL 77 NO-LABEL WIDGET-ID 150
...
"5", 5
     ...
     "Lista MARCO?" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 1.96 COL 66 WIDGET-ID 154
          BGCOLOR 15 FGCOLOR 1 
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
          ...
          */
          IF faccpedi.libre_c01 <> ? THEN DO:
              FIND FIRST gn-divi WHERE gn-divi.codcia = s-codcia
                  AND gn-divi.coddiv = faccpedi.libre_c01 NO-LOCK NO-ERROR.
