...
DEF VAR s-Tabla AS CHAR INIT 'CVUTILEX' NO-UNDO.
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacTabla WHERE ~{&KEY-PHRASE} ~
      ...
      FIRST gn-clie WHERE gn-clie.CodCli =  FacTabla.Codigo ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-clie.NomCli FORMAT "x(250)":U WIDTH 48.72
  ENABLE
      FacTabla.Codigo
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"gn-clie.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "48.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
