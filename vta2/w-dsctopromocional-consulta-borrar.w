...
&Scoped-Define DISPLAYED-OBJECTS txtVigenciaDesde txtVigenciaHasta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      Almtfami.desfam FORMAT "X(30)":U WIDTH 30.86 COLUMN-FONT 4 LABEL-FONT 0
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 41.72 BY 9.65 FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 W-Win _STRUCTURED
  QUERY BROWSE-3 NO-LOCK DISPLAY
      ...
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 35.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 45 BY 9.5 FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-4 W-Win _STRUCTURED
  QUERY BROWSE-4 NO-LOCK DISPLAY
      ...
      tt-w-report.Campo-C[4] COLUMN-LABEL "Descripcion Articulo" FORMAT "X(60)":U
            WIDTH 35.72 COLUMN-FONT 0
      tt-w-report.Campo-C[5] COLUMN-LABEL "Marca" FORMAT "X(30)":U
            WIDTH 17.43 COLUMN-FONT 0 LABEL-FONT 0
      ...
      tt-w-report.Campo-F[1] COLUMN-LABEL "Precio Promo" FORMAT "->>>,>>>,>>9.9999":U
            COLUMN-BGCOLOR 14 COLUMN-FONT 0 LABEL-FGCOLOR 0 LABEL-BGCOLOR 14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 108 BY 11.92 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     BROWSE-3 AT ROW 2.08 COL 64 WIDGET-ID 300
     BROWSE-2 AT ROW 1.88 COL 2.29 WIDGET-ID 200
     BUTTON-16 AT ROW 11.92 COL 97.43 WIDGET-ID 16
     BUTTON-14 AT ROW 4.04 COL 45.72 WIDGET-ID 12
     txtVigenciaDesde AT ROW 12 COL 37.57 COLON-ALIGNED WIDGET-ID 6
     txtVigenciaHasta AT ROW 12 COL 61.29 COLON-ALIGNED WIDGET-ID 8
     BUTTON-13 AT ROW 11.92 COL 80.86 WIDGET-ID 10
     BROWSE-4 AT ROW 13.5 COL 3 WIDGET-ID 400
     BUTTON-15 AT ROW 6.5 COL 45.72 WIDGET-ID 14
     "T I E N D A S" VIEW-AS TEXT
          SIZE 15.86 BY .62 AT ROW 1.38 COL 64.43 WIDGET-ID 4
          FGCOLOR 12 FONT 6
     "F A M I L I A S" VIEW-AS TEXT
          SIZE 13.29 BY .62 AT ROW 1.19 COL 2.72 WIDGET-ID 2
          FGCOLOR 12 FONT 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 110.72 BY 24.73 WIDGET-ID 100.
...
"Almtfami.desfam" ? ? "character" ? ? 4 ? ? 0 no ? no no "30.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
"GN-DIVI.DesDiv" ? ? "character" ? ? ? ? ? ? no ? no no "35.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
...
"Campo-C[1]" "Cod.Tda" "X(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-w-report.Campo-C[2]
"Campo-C[2]" "Tienda" "X(50)" "character" ? ? 0 ? ? 0 no ? no no "24.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-w-report.Campo-C[3]
"Campo-C[3]" "Cod.Art" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-w-report.Campo-C[4]
"Campo-C[4]" "Descripcion Articulo" "X(60)" "character" ? ? 0 ? ? ? no ? no no "35.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-w-report.Campo-C[5]
"Campo-C[5]" "Marca" "X(30)" "character" ? ? 0 ? ? 0 no ? no no "17.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-w-report.Campo-C[6]
"Campo-C[6]" "U.M." "X(5)" "character" ? ? 0 ? ? 0 no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-w-report.Campo-C[7]
"Campo-C[7]" "G-U-M" "X(10)" "character" ? ? ? ? ? ? no ? no no "9.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tt-w-report.Campo-F[1]
"Campo-F[1]" "Precio Promo" "->>>,>>>,>>9.9999" "decimal" 14 ? 0 14 0 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.tt-w-report.Campo-F[2]
"Campo-F[2]" "%Dscto Promo" ">>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.tt-w-report.Campo-D[1]
"Campo-D[1]" "Inicio Promo" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.tt-w-report.Campo-D[2]
"Campo-D[2]" "Fin Promo" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.tt-w-report.Campo-C[8]
"Campo-C[8]" "Familia" "X(40)" "character" ? ? 0 ? ? 0 no ? no no "25.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-4 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  DISPLAY txtVigenciaDesde txtVigenciaHasta 
...
FOR EACH vtatabla WHERE vtatabla.codcia = s-codcia AND 
                        (vtatabla.tabla = 'DTOPROLIMA' OR vtatabla.tabla = 'DTOPROUTILEX') AND
                        (vtatabla.rango_fecha[1] >= txtVigenciaDesde AND 
                         vtatabla.rango_fecha[1] <= txtVigenciaHasta) :

    IF lTiendas = "" OR LOOKUP(vtatabla.llave_c2,lTiendas) > 0 THEN DO:
        FIND FIRST b-gn-divi WHERE b-gn-divi.codcia = s-codcia AND 
                                b-gn-divi.coddiv = vtatabla.llave_c2 NO-LOCK NO-ERROR.
        FIND FIRST factabla WHERE factabla.codcia = s-codcia AND 
                                factabla.tabla = 'RANKVTA' AND
                                factabla.codigo = vtatabla.llave_c1 NO-LOCK NO-ERROR.
        ...
        IF AVAILABLE almmmatg THEN DO:
            IF lFamilias = "" OR LOOKUP(almmmatg.codfam,lFamilias) > 0 THEN DO:
                ...
                ASSIGN  tt-w-report.campo-c[1] = vtatabla.llave_c2
                        ...
                        tt-w-report.campo-c[3] = vtatabla.llave_c1
                        ...
                        tt-w-report.campo-c[8] = IF(AVAILABLE almtfami) THEN almtfami.desfam ELSE vtatabla.llave_c1
                        tt-w-report.campo-f[1] = vtatabla.valor[2] * (IF(almmmatg.monvta = 2) THEN almmmatg.tpocmb ELSE 1)
                        tt-w-report.campo-f[2] = vtatabla.valor[1]
                        tt-w-report.campo-d[1] = vtatabla.rango_fecha[1]
                        tt-w-report.campo-d[2] = vtatabla.rango_fecha[2].
