...
FacDPedi.ImpDto2 Almmmatg.Pesmat 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
            WIDTH 6.43
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 9.43
      FacDPedi.ImpDto2 COLUMN-LABEL "Otros!Descuentos" FORMAT ">>>,>>9.99":U
      Almmmatg.Pesmat FORMAT "->>>,>>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 144 BY 11.04
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpDto AT ROW 12.35 COL 52 COLON-ALIGNED WIDGET-ID 38
     FILL-IN_PorIgv AT ROW 12.35 COL 79 COLON-ALIGNED WIDGET-ID 24
     FILL-IN_ImpDto2 AT ROW 12.35 COL 129 COLON-ALIGNED WIDGET-ID 40
     FILL-IN_Percepcion AT ROW 12.38 COL 102 COLON-ALIGNED WIDGET-ID 30
     FILL-IN_ImpTot AT ROW 13.12 COL 129 COLON-ALIGNED WIDGET-ID 20
     FILL-IN_ImpExo AT ROW 13.15 COL 22 COLON-ALIGNED WIDGET-ID 16
     FILL-IN_ImpVta AT ROW 13.15 COL 52 COLON-ALIGNED WIDGET-ID 22
     FILL-IN_ImpIgv AT ROW 13.15 COL 79 COLON-ALIGNED WIDGET-ID 18
     FILL-IN-Peso AT ROW 13.88 COL 52 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-Volumen AT ROW 13.88 COL 79 COLON-ALIGNED WIDGET-ID 34
     FILL-IN_Import2 AT ROW 13.88 COL 129 COLON-ALIGNED WIDGET-ID 26
...
"FacDPedi.UndVta" "Unidad" "X(10)" "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > integral.FacDPedi.TipVta
...
"FacDPedi.Por_Dsctos[2]" "% Dscto!Evento" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.ImpDto2
"FacDPedi.ImpDto2" "Otros!Descuentos" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > integral.Almmmatg.Pesmat
"Almmmatg.Pesmat" ? "->>>,>>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
