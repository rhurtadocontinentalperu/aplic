...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Número" FORMAT "X(9)":U WIDTH 9.57
            COLUMN-FONT 0
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 8.08
         FONT 4
         TITLE "ORDENES DE DESPACHO PARA FACTURAR VALES UTILEX".
...
ON MOUSE-SELECT-DBLCLICK OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR VALES UTILEX */
DO:
    RUN proc_GeneraGuia.
    RETURN NO-APPLY.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-ENTRY OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR VALES UTILEX */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR VALES UTILEX */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR VALES UTILEX */
DO:
...
------------------------------------------------------------------------------*/
    ...
    IF cEsValeUtilex = YES THEN DO:
        CASE RADIO-SET-TipDoc:
            /*WHEN "FAC" THEN RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */ */
            WHEN "FAI" THEN RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'FA' ).       /* AUTOMATICA */
        END CASE.
    END.
    ELSE DO:
        MESSAGE "O/D NO es de venta de VALES UTILEX".
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'M' ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'FM' ).       /* AUTOMATICA */
    END CASE.
