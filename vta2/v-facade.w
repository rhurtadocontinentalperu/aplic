...
CcbCDocu.DirCli CcbCDocu.RucCli CcbCDocu.CodAnt CcbCDocu.CodMon ~
CcbCDocu.CodVen CcbCDocu.FmaPgo CcbCDocu.Glosa 
...
CcbCDocu.FchVto CcbCDocu.RucCli CcbCDocu.CodAnt CcbCDocu.CodMon ~
CcbCDocu.CodVen CcbCDocu.FmaPgo CcbCDocu.Glosa 
...
DEFINE FRAME F-Main
     CcbCDocu.NroDoc AT ROW 1 COL 9 COLON-ALIGNED FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 15.14 BY .81
          FONT 1
     F-Estado AT ROW 1 COL 28 COLON-ALIGNED NO-LABEL
     ...
     CcbCDocu.RucCli AT ROW 3.42 COL 9 COLON-ALIGNED FORMAT "x(11)"
          ...
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 9 
     CcbCDocu.CodAnt AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 2
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     CcbCDocu.CodMon AT ROW 3.42 COL 93 NO-LABEL
...
"US$", 2
     ...
     CcbCDocu.Glosa AT ROW 5.85 COL 9 COLON-ALIGNED
          LABEL "Glosa"
          VIEW-AS FILL-IN 
          SIZE 70 BY .81
          BGCOLOR 11 FGCOLOR 9 
     "Moneda:" VIEW-AS TEXT
          SIZE 6.43 BY .5 AT ROW 3.42 COL 86
...
DO ON ERROR UNDO, RETURN "ADM-ERROR":
   ...
   B-CDOCU.ImpTot2 = 0.     /* RHC 14.12.2010 así no se pueden aplicar */
   RELEASE B-CDOCU.
END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE FacCorre THEN DO:
      MESSAGE 'Correlativo de la serie no configurado'
          VIEW-AS ALERT-BOX ERROR.
      RETURN "ADM-ERROR".
  END.
  IF FacCorre.FlgEst = NO THEN DO:
      MESSAGE 'Correlativo inactivo'
          VIEW-AS ALERT-BOX ERROR.
      RETURN "ADM-ERROR".
  END.
  ASSIGN 
