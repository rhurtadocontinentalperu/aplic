...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH rbte_linea_generan_nc WHERE rbte_linea_generan_nc.codcia = s-codcia AND
          ...
          CREATE tt-w-report.
          ASSIGN    tt-w-report.campo-c[1] = rbte_linea_generan_nc.codlinea
                    tt-w-report.campo-c[3] = rbte_linea_generan_nc.codsublinea
                    tt-w-report.campo-c[5] = rbte_linea_generan_nc.signo
                    .
...
------------------------------------------------------------------------------*/
  ...
  x-marca = tt-w-report.campo-c[5]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.
