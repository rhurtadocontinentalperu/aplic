...
&SCOPED-DEFINE l-lookup h_l-cotizacion
...
DEFINE VARIABLE h_l-cotizacion AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-cotizacion.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cotizacion ).
       RUN set-position IN h_l-cotizacion ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-cotizacion ( 10.92 , 71.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cotizacion. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cotizacion ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cotizacion ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-cotizacion , 'AFTER':U ).
    END. /* Page 0 */
