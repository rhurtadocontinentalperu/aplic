...
Almmmatg.DesMar FacDPedi.UndVta FacDPedi.CanPed FacDPedi.PreUni ~
FacCPedi.Porcent[2] FacCPedi.Porcent[3] FacDPedi.ImpLin 
...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN_ImpDto2 FILL-IN_ImpTot ~
FILL-IN_Import2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.UndVta COLUMN-LABEL "Unidad" FORMAT "X(10)":U WIDTH 7
      FacDPedi.CanPed FORMAT ">>>,>>9.99":U
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.99999":U
            WIDTH 8.86
      FacCPedi.Porcent[2] COLUMN-LABEL "% Dscto!Evento" FORMAT "->>9.9999":U
      FacCPedi.Porcent[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 5.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 125 BY 9.69
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpBrt AT ROW 10.96 COL 18 COLON-ALIGNED WIDGET-ID 14
     FILL-IN_ImpDto AT ROW 10.96 COL 44 COLON-ALIGNED WIDGET-ID 38
     FILL-IN_PorIgv AT ROW 10.96 COL 71 COLON-ALIGNED WIDGET-ID 24
     FILL-IN_ImpDto2 AT ROW 10.96 COL 110.14 COLON-ALIGNED WIDGET-ID 42
     FILL-IN_Percepcion AT ROW 11 COL 94 COLON-ALIGNED WIDGET-ID 30
     FILL-IN_ImpTot AT ROW 11.73 COL 110.14 COLON-ALIGNED WIDGET-ID 46
     FILL-IN_ImpExo AT ROW 11.77 COL 18 COLON-ALIGNED WIDGET-ID 16
     FILL-IN_ImpVta AT ROW 11.77 COL 44 COLON-ALIGNED WIDGET-ID 22
     FILL-IN_ImpIgv AT ROW 11.77 COL 71 COLON-ALIGNED WIDGET-ID 18
     FILL-IN-Peso AT ROW 12.5 COL 44 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-Volumen AT ROW 12.5 COL 71 COLON-ALIGNED WIDGET-ID 34
     FILL-IN_Import2 AT ROW 12.5 COL 110.14 COLON-ALIGNED WIDGET-ID 44
     RECT-25 AT ROW 10.69 COL 1 WIDGET-ID 36
...
ASSIGN 
       FILL-IN-Peso:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-Volumen IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN-Volumen:HIDDEN IN FRAME F-Main           = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN_ImpDto IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_ImpDto:HIDDEN IN FRAME F-Main           = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN_ImpExo IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_ImpExo:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN_ImpIgv IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_ImpIgv:HIDDEN IN FRAME F-Main           = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN_ImpVta IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_ImpVta:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN_Percepcion IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_Percepcion:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN_PorIgv IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN_PorIgv:HIDDEN IN FRAME F-Main           = TRUE.
...
"(IF FacDPedi.Libre_c05 <> '' AND FacDPedi.Libre_c05 <> 'OF' THEN FacDPedi.Libre_c05 + ' - ' ELSE '') + Almmmatg.DesMat @ Almmmatg.DesMat" "Descripción" "x(60)" ? ? ? ? ? ? ? no ? no no "49.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.UndVta" "Unidad" "X(10)" "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.FacCPedi.Porcent[2]
"FacCPedi.Porcent[2]" "% Dscto!Evento" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacCPedi.Porcent[3]
"FacCPedi.Porcent[3]" "% Dscto!Vol/Prom" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.ImpLin
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "5.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
