...
DEF INPUT PARAMETER cCodDoc AS CHAR.
...
DEFINE FRAME F-Main
     BUTTON-11 AT ROW 2.08 COL 81 WIDGET-ID 2
     BUTTON-12 AT ROW 3.42 COL 81 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 149 BY 24.54 WIDGET-ID 100.
...
ON END-ERROR OF W-Win /* PEDIDOS POR APROBAR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PEDIDOS POR APROBAR */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/b-aprped.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprped ).
       RUN set-position IN h_b-aprped ( 1.54 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-aprped ( 6.69 , 72.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/b-pedido.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedido ).
       RUN set-position IN h_b-pedido ( 8.54 , 3.00 ) NO-ERROR.
