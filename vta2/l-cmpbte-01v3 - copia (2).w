...
DEFINE TEMP-TABLE tt-reg-tempo
...
&Scoped-Define ENABLED-OBJECTS RECT-61 RECT-62 FILL-IN-CodCli CMB-filtro ~
FILL-IN-filtro BUTTON-19 BUTTON-Division xcodmod BUTTON-20 f-desde f-hasta ~
C-CMPBTE c-Serie x-FchVto-1 x-FchVto-2 x-CndCre x-FchCan-desde ~
x-FchCan-hasta COMBO-BOX-5 F-FMAPGO f-codven br_table 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-CodCli CMB-filtro FILL-IN-filtro ~
x-CodDiv xcodmod f-desde f-hasta C-CMPBTE c-Serie x-FchVto-1 x-FchVto-2 ~
x-CndCre x-FchCan-desde x-FchCan-hasta COMBO-BOX-5 F-FMAPGO F-CndVta ~
f-codven F-nomven f-totsol f-totdol f-sdosol f-sdodol FILL-IN-Mensaje 
...
DEFINE BUTTON BUTTON-20 
     ...
     LABEL "" 
     SIZE 10 BY 2.69 TOOLTIP "Exportar a EXCEL".
...
DEFINE FRAME F-Main
     FILL-IN-CodCli AT ROW 1.27 COL 14 COLON-ALIGNED
     CMB-filtro AT ROW 1.27 COL 27 NO-LABEL
     FILL-IN-filtro AT ROW 1.27 COL 49 NO-LABEL
     BUTTON-19 AT ROW 1.27 COL 102 WIDGET-ID 86
     x-CodDiv AT ROW 2.23 COL 16 NO-LABEL WIDGET-ID 90
     BUTTON-Division AT ROW 2.42 COL 79 WIDGET-ID 76
     xcodmod AT ROW 2.42 COL 92 NO-LABEL
     BUTTON-20 AT ROW 3.15 COL 127 WIDGET-ID 98
     f-desde AT ROW 4.85 COL 84 COLON-ALIGNED
     f-hasta AT ROW 4.85 COL 100 COLON-ALIGNED
     C-CMPBTE AT ROW 4.92 COL 16 NO-LABEL WIDGET-ID 6
     c-Serie AT ROW 5.04 COL 52 COLON-ALIGNED
     x-FchVto-1 AT ROW 5.81 COL 84 COLON-ALIGNED
     x-FchVto-2 AT ROW 5.81 COL 100 COLON-ALIGNED
     x-CndCre AT ROW 6 COL 54 NO-LABEL
     x-FchCan-desde AT ROW 6.77 COL 84 COLON-ALIGNED WIDGET-ID 94
     x-FchCan-hasta AT ROW 6.77 COL 100 COLON-ALIGNED WIDGET-ID 96
     COMBO-BOX-5 AT ROW 7.81 COL 84 COLON-ALIGNED
     F-FMAPGO AT ROW 8.77 COL 16 COLON-ALIGNED
     F-CndVta AT ROW 8.77 COL 21.14 COLON-ALIGNED NO-LABEL
     f-codven AT ROW 8.77 COL 84 COLON-ALIGNED
     F-nomven AT ROW 8.77 COL 90 COLON-ALIGNED NO-LABEL
     ...
     "División Origen:" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 2.23 COL 5 WIDGET-ID 92
     "N/C:" VIEW-AS TEXT
          SIZE 4 BY .5 AT ROW 5.92 COL 50 WIDGET-ID 80
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 5.12 COL 6 WIDGET-ID 8
     ...
     "(*)  Click Derecho - Visualiza Pagos" VIEW-AS TEXT
          ...
          FONT 6
     "Moneda:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 2.62 COL 85 WIDGET-ID 78
     RECT-61 AT ROW 1 COL 123 WIDGET-ID 104
...
/* BROWSE-TAB br_table F-nomven F-Main */
ASSIGN 
...
chWorkSheet:Range("E2"):Value = "Pedido Cliente".
chWorkSheet:COLUMNS("E"):NumberFormat = "@".
chWorkSheet:Range("F2"):Value = "Código".
chWorkSheet:COLUMNS("F"):NumberFormat = "@".
chWorkSheet:Range("G2"):Value = "Cliente".
chWorkSheet:COLUMNS("G"):NumberFormat = "@".
chWorkSheet:Range("H2"):Value = "RUC".
chWorkSheet:COLUMNS("H"):NumberFormat = "@".
chWorkSheet:Range("I2"):Value = "Cond. Vta.".
chWorkSheet:COLUMNS("I"):NumberFormat = "@".
chWorkSheet:Range("J2"):Value = "Vendedor".
chWorkSheet:COLUMNS("J"):NumberFormat = "@".
chWorkSheet:Range("K2"):Value = "Nombre del Vendedor".
chWorkSheet:Range("L2"):Value = "Emision".
chWorkSheet:COLUMNS("L"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("M2"):Value = "Vencimiento".
chWorkSheet:COLUMNS("M"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("N2"):Value = "Recepción".
chWorkSheet:COLUMNS("N"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("O2"):Value = "Cancelación".
...
CASE xcodmod:
    WHEN 1 THEN DO:
        chWorkSheet:Range("P2"):Value = "Importe S/.".
        chWorkSheet:Range("Q2"):Value = "Importe S/. SIN Adelanto".
        chWorkSheet:Range("R2"):Value = "Saldo S/.".
        chWorkSheet:Range("S2"):Value = "Estado".
        chWorkSheet:Range("T2"):Value = "Usuario anulación".
        chWorkSheet:Range("U2"):Value = "Fecha".
        chWorkSheet:COLUMNS("U"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("V2"):Value = "Hora".
        chWorkSheet:Range("U2"):Value = "Motivo anulación".
        chWorkSheet:Range("X2"):Value = "División".
        chWorkSheet:COLUMNS("X"):NumberFormat = "@".
        chWorkSheet:Range("Y2"):Value = "Fecha Reporte".
        chWorkSheet:COLUMNS("Y"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("Z2"):Value = "Ubicación".
        chWorkSheet:Range("AA2"):Value = "Banco".
        chWorkSheet:Range("AB2"):Value = "Situación".
        chWorkSheet:Range("AC2"):Value = "F.Entrega(DIST)".
        chWorkSheet:Range("AD2"):Value = "F.Entrega(CRED)".
        chWorkSheet:Range("AE2"):Value = "DIRECC. CLIENTE".
        chWorkSheet:Range("AF2"):Value = "CANJE".
        chWorkSheet:Range("AG2"):Value = "DEPARTAMENTO".
        chWorkSheet:Range("AH2"):Value = "PROVINCIA".
        chWorkSheet:Range("AI2"):Value = "DISTRITO".
        chWorkSheet:Range("AJ2"):Value = "N° UNICO".
        chWorkSheet:Range("AK2"):Value = "Concepto N/C Otras".
        chWorkSheet:COLUMNS("AK"):NumberFormat = "@".
        chWorkSheet:Range("AL2"):Value = "Descripción".
    END.
    WHEN 2 THEN DO:
        chWorkSheet:Range("P2"):Value = "Importe US$".
        chWorkSheet:Range("Q2"):Value = "Importe US$ SIN Adelanto".
        chWorkSheet:Range("R2"):Value = "Saldo US$".
        chWorkSheet:Range("S2"):Value = "Estado".
        chWorkSheet:Range("T2"):Value = "Usuario anulación".
        chWorkSheet:Range("U2"):Value = "Fecha".
        chWorkSheet:COLUMNS("U"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("V2"):Value = "Hora".
        chWorkSheet:Range("W2"):Value = "Motivo anulación".
        chWorkSheet:Range("X2"):Value = "División".
        chWorkSheet:COLUMNS("X"):NumberFormat = "@".
        chWorkSheet:Range("Y2"):Value = "Fecha Reporte".
        chWorkSheet:COLUMNS("Y"):NumberFormat = "dd/mm/yyyy".
    ...
    WHEN 3 THEN DO:
        ...
        chWorkSheet:Range("AC2"):Value = "Ubicación".
        chWorkSheet:Range("AD2"):Value = "Banco".
        chWorkSheet:Range("AE2"):Value = "Situación".
        chWorkSheet:Range("AF2"):Value = "F.Entrega(DIST)".
        chWorkSheet:Range("AG2"):Value = "F.Entrega(CRED)".
        chWorkSheet:Range("AH2"):Value = "DIRECC. CLIENTE".
        chWorkSheet:Range("AI2"):Value = "CANJE".
        chWorkSheet:Range("AJ2"):Value = "DEPARTAMENTO".
        chWorkSheet:Range("AK2"):Value = "PROVINCIA".
        chWorkSheet:Range("AL2"):Value = "DISTRITO".
        chWorkSheet:Range("AM2"):Value = "N° UNICO".
        chWorkSheet:Range("AN2"):Value = "Papel Fotocopia (S/)".
        chWorkSheet:Range("AO2"):Value = "Papel Fotocopia ($)".
        chWorkSheet:Range("AP2"):Value = "Concepto N/C Otras".
        chWorkSheet:COLUMNS("AP"):NumberFormat = "@".
        chWorkSheet:Range("AQ2"):Value = "Descripción".
    END.
END.
