...
BUTTON-16 txtTTrans BUTTON-13 TOGGLE-1 BUTTON-15 
...
DEFINE VARIABLE FILL-IN-NroEtq AS CHARACTER FORMAT "X(25)":U 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Detalle.Libre_c01 COLUMN-LABEL "Número de Etiqueta" FORMAT "x(25)":U
            WIDTH 12.72
  ENABLE
      Detalle.codmat
      Detalle.CanPick
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 134 BY 18.27
...
DEFINE FRAME F-Main
     ...
     BUTTON-16 AT ROW 6.19 COL 46 WIDGET-ID 26
     ...
     TOGGLE-1 AT ROW 6.38 COL 68 WIDGET-ID 28
...
/* SETTINGS FOR FILL-IN FILL-IN-NroEtq IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
...
"Detalle.Libre_c01" "Número de Etiqueta" "x(25)" "character" ? ? ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  ...
  DISPLAY x-CodCli x-FchDoc x-NomCli x-NroDoc FILL-IN-NroEtq WITH FRAME {&FRAME-NAME}.
...
DO:
    ...
    ASSIGN
        ...
        FILL-IN-NroEtq = '' BUTTON-16:SENSITIVE = NO
        x-NroItem = 0.
    DISPLAY 
        x-NroDoc
        x-CodCli
...
ON CHOOSE OF BUTTON-16 IN FRAME F-Main /* INGRESAR ETIQUETA */
DO:
/*   IF FILL-IN-NroEtq:SCREEN-VALUE <> '' THEN DO:                         */
/*       MESSAGE 'Se va a proceder a ingresar una NUEVA etiqueta' SKIP     */
...
DO:
  IF NOT SELF:SCREEN-VALUE BEGINS 'CO' THEN DO:
...
OCXFile = SEARCH( "b-picking-od.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "b-picking-od.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR x-Cantidad AS INT NO-UNDO.
  ...
  IF s-generacion-multiple = YES AND x-Factor > 1 THEN DO:
      ...
      DO k = 1 TO x-Cantidad:
          ...
          ASSIGN
              ...
              Detalle.canpick = 1
              Detalle.Libre_c01 = FILL-IN-NroEtq + STRING(k, '999')
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  BUTTON-16:SENSITIVE IN FRAME {&FRAME-NAME} = YES.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  BUTTON-16:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
