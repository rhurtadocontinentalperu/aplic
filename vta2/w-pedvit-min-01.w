...
DEFINE VARIABLE h_v-pedvit-min-01 AS HANDLE NO-UNDO.
...
DO:
  RUN Imprimira IN h_v-pedvit-min-01.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Vta2/v-pedvit-min-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedvit-min-01 ).
       RUN set-position IN h_v-pedvit-min-01 ( 3.15 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pedvit-min-01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-pedvit-min-01 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido-4 , 'Record':U , h_v-pedvit-min-01 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedmos-min-01 ( 5.85 , 2.00 ) NO-ERROR.
