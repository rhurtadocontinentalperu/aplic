...
DEFINE VAR x-tabla AS CHAR INIT "TIPO_DSCTO_LINEA".
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 87.86 BY 13.46
         FONT 4.
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH vtatabla WHERE vtatabla.codcia = s-codcia AND
          ...
          ASSIGN    tt-w-report.campo-c[1] = vtatabla.llave_c2
                    tt-w-report.campo-c[3] = vtatabla.llave_c3
                    tt-w-report.campo-c[5] = vtatabla.libre_c01
              .
          /* FAMILIA */
...
------------------------------------------------------------------------------*/
    ...
    MESSAGE 'Seguro de GRABAR las Lineas/Sub Lineas ?' VIEW-AS ALERT-BOX QUESTION
  ...
  */
  ...
  FOR EACH vtatabla WHERE vtatabla.codcia = s-codcia AND
      ...
      ASSIGN    ytt-w-report.campo-c[1] = vtatabla.llave_c2
                ytt-w-report.campo-c[3] = vtatabla.llave_c3
                ytt-w-report.campo-c[5] = vtatabla.libre_c01
          .
  END.
      ...
      DO:
          ...
          FOR EACH ytt-w-report WHERE ytt-w-report.campo-c[10] = "X" :
              FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND
                                            ...
                                            vtatabla.llave_c2 = ytt-w-report.campo-c[1] AND
                                            vtatabla.llave_c3 = ytt-w-report.campo-c[3]
          ...
          FOR EACH xtt-w-report :
              ...
              FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND
                                            vtatabla.tabla = x-tabla AND
                                            vtatabla.llave_c1 = x-proceso AND
                                            vtatabla.llave_c2 = xtt-w-report.campo-c[1] AND
                                            vtatabla.llave_c3 = xtt-w-report.campo-c[3]
                                            EXCLUSIVE-LOCK NO-ERROR.
              IF NOT AVAILABLE vtatabla THEN DO:
                  CREATE vtatabla.
                    ASSIGN vtatabla.codcia = s-codcia
                            ...
                            vtatabla.llave_c3 = xtt-w-report.campo-c[3] NO-ERROR
                        .
              END.
              ...
              ASSIGN vtatabla.libre_c01 = xtt-w-report.campo-c[5]
