...
ON CHOOSE OF BUTTON-2 IN FRAME D-Dialog /* MUESTRA PRECIOS */
DO:
  /*RUN Carga-Precios.*/
...
CASE TRUE:
    ...
    WHEN CMB-FILTRO = 'Nombres que inicien con' AND FILL-IN-filtro > '' THEN DO:
        ...
        SELECT Almmmatg.codmat
            ...
            WHERE (Almmmatg.codcia = s-codcia AND 
                   ...
                   Almmmatg.tpoart <> "D" AND
                   (f-Marca = '' OR Almmmatg.desmar BEGINS f-Marca) AND
    ...
    WHEN f-Marca > '' THEN DO:
        ...
        SELECT Almmmatg.codmat
            FROM Almmmatg, Almtfami, Almmmate
            WHERE (Almmmatg.codcia = s-codcia AND 
                   Almmmatg.desmar BEGINS f-Marca AND
                   Almmmatg.tpoart <> "D" AND
                   (f-CodFam = 'Todos' OR Almmmatg.codfam = f-CodFam)) AND
            (Almtfami.codcia = Almmmatg.codcia AND
             Almtfami.codfam = Almmmatg.codfam AND
    ...
    END.
    OTHERWISE DO:
        DECLARE cur-CodMat-05 CURSOR FOR 
        SELECT Almmmatg.codmat
            FROM Almmmatg, Almtfami, Almmmate
            WHERE (Almmmatg.codcia = s-codcia AND 
                   Almmmatg.tpoart <> "D" AND
            ...
            .
        OPEN cur-CodMat-05.
        FETCH cur-CodMat-05 INTO c-CodMat.
        REPEAT:
            CREATE t-Matg.
            ASSIGN t-Matg.CodMat = c-CodMat.
            FETCH cur-CodMat-05 INTO c-CodMat.
