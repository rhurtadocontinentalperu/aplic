...
AND Almmmatg.FchCes = ? ~
AND ( RADIO-SET-Margen = 1 OR ( Almmmatg.MrgUti-A < 0 ~
OR Almmmatg.MrgUti-B < 0 ~
OR Almmmatg.MrgUti-C < 0 ~
...
Almmmatg.DesMar Almmmatg.UndBas Almmmatg.MonVta X-Mon @ X-Mon ~
Almmmatg.TpoCmb Almmmatg.CtoLis Almmmatg.CtoTot Almmmatg.PorMax ~
Almmmatg.Prevta[1] Almmmatg.MrgUti-A Almmmatg.Prevta[2] Almmmatg.UndA ~
Almmmatg.MrgUti-B Almmmatg.Prevta[3] Almmmatg.UndB Almmmatg.MrgUti-C ~
Almmmatg.Prevta[4] Almmmatg.UndC Almmmatg.Dec__01 Almmmatg.PreOfi ~
Almmmatg.Chr__01 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table Almmmatg.MonVta ~
Almmmatg.CtoLis Almmmatg.PorMax Almmmatg.Prevta[1] Almmmatg.MrgUti-A ~
Almmmatg.Prevta[2] Almmmatg.MrgUti-B Almmmatg.Prevta[3] Almmmatg.MrgUti-C ~
Almmmatg.Prevta[4] 
...
&Scoped-Define ENABLED-OBJECTS RECT-24 CB-FchMod F-FchDes F-FchHas ~
Btn-Imprime BUTTON-7 R-Tipo F-CodMat F-Filtro RADIO-SET-Margen F-Provee ~
br_table 
&Scoped-Define DISPLAYED-OBJECTS CB-FchMod F-FchDes F-FchHas R-Tipo ~
F-CodMat F-Filtro RADIO-SET-Margen F-Provee 
...
DEFINE BUTTON Btn-Imprime 
     IMAGE-UP FILE "img/api-va.ico":U
     LABEL "" 
     SIZE 8 BY 1.62.
...
DEFINE VARIABLE RADIO-SET-Margen AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Todos", 1,
"Margen negativo", 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.MonVta COLUMN-LABEL "M" FORMAT "9":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      X-Mon @ X-Mon COLUMN-LABEL "Mon" FORMAT "X(4)":U
      Almmmatg.TpoCmb FORMAT "Z9.9999":U
      Almmmatg.CtoLis COLUMN-LABEL "<Costo sin IGV>" FORMAT ">>>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.CtoTot COLUMN-LABEL "Costo de Lista Total" FORMAT ">>>>,>>9.9999":U
      Almmmatg.PorMax COLUMN-LABEL "%Max!Dscto" FORMAT ">9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.Prevta[1] COLUMN-LABEL "Precio Lista" FORMAT ">>,>>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.MrgUti-A COLUMN-LABEL "%Marg!Utilid A" FORMAT "->>9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.Prevta[2] COLUMN-LABEL "Precio Vta!A" FORMAT ">>>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.UndA COLUMN-LABEL "UM.!A" FORMAT "X(6)":U COLUMN-BGCOLOR 11
      Almmmatg.MrgUti-B COLUMN-LABEL "%Marg!Utilid B" FORMAT "->>9.99":U
            COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 13
      Almmmatg.Prevta[3] COLUMN-LABEL "Precio Vta!B" FORMAT ">>>>,>>9.9999":U
            COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 13
      Almmmatg.UndB COLUMN-LABEL "UM.!B" FORMAT "X(6)":U COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 13
      Almmmatg.MrgUti-C COLUMN-LABEL "%Marg!Utilid C" FORMAT "->>9.99":U
            COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 9
      Almmmatg.Prevta[4] COLUMN-LABEL "Precio Vta!C" FORMAT ">>>>,>>9.9999":U
            COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 9
      Almmmatg.UndC COLUMN-LABEL "UM.!C" FORMAT "X(6)":U COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 9
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141.57 BY 17.58
         FONT 4.
...
DEFINE FRAME F-Main
     CB-FchMod AT ROW 1.15 COL 9 COLON-ALIGNED
     F-FchDes AT ROW 1.15 COL 33.72 COLON-ALIGNED
     F-FchHas AT ROW 1.15 COL 50.14 COLON-ALIGNED
     Btn-Imprime AT ROW 1.27 COL 94 WIDGET-ID 6
     BUTTON-7 AT ROW 1.27 COL 102 WIDGET-ID 8
     R-Tipo AT ROW 1.38 COL 67.57 NO-LABEL
     F-CodMat AT ROW 2.08 COL 9.14 COLON-ALIGNED
     F-Filtro AT ROW 2.08 COL 31 COLON-ALIGNED
     RADIO-SET-Margen AT ROW 2.23 COL 67.57 NO-LABEL WIDGET-ID 2
     F-Provee AT ROW 3 COL 9 COLON-ALIGNED
     br_table AT ROW 4 COL 1.43
     RECT-24 AT ROW 1.19 COL 66.72
...
"Almmmatg.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.Almmmatg.DesMat
"Almmmatg.DesMat" ? "X(65)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.Almmmatg.DesMar
"Almmmatg.DesMar" ? "X(14)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > integral.Almmmatg.UndBas
"Almmmatg.UndBas" "Und!Base" "X(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.Almmmatg.MonVta
"Almmmatg.MonVta" "M" ? "integer" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"X-Mon @ X-Mon" "Mon" "X(4)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = integral.Almmmatg.TpoCmb
     _FldNameList[8]   > integral.Almmmatg.CtoLis
"Almmmatg.CtoLis" "<Costo sin IGV>" ">>>>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.Almmmatg.CtoTot
"Almmmatg.CtoTot" "Costo de Lista Total" ">>>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.Almmmatg.PorMax
"Almmmatg.PorMax" "%Max!Dscto" ">9.99" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.Almmmatg.Prevta[1]
"Almmmatg.Prevta[1]" "Precio Lista" ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.Almmmatg.MrgUti-A
"Almmmatg.MrgUti-A" "%Marg!Utilid A" "->>9.99" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.Almmmatg.Prevta[2]
"Almmmatg.Prevta[2]" "Precio Vta!A" ">>>>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.Almmmatg.UndA
"Almmmatg.UndA" "UM.!A" "X(6)" "character" 11 ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > integral.Almmmatg.MrgUti-B
"Almmmatg.MrgUti-B" "%Marg!Utilid B" "->>9.99" "decimal" 13 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > integral.Almmmatg.Prevta[3]
"Almmmatg.Prevta[3]" "Precio Vta!B" ">>>>,>>9.9999" "decimal" 13 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > integral.Almmmatg.UndB
"Almmmatg.UndB" "UM.!B" "X(6)" "character" 13 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > integral.Almmmatg.MrgUti-C
"Almmmatg.MrgUti-C" "%Marg!Utilid C" "->>9.99" "decimal" 9 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > integral.Almmmatg.Prevta[4]
"Almmmatg.Prevta[4]" "Precio Vta!C" ">>>>,>>9.9999" "decimal" 9 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > integral.Almmmatg.UndC
"Almmmatg.UndC" "UM.!C" "X(6)" "character" 9 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > integral.Almmmatg.Dec__01
"Almmmatg.Dec__01" "%Marg Utilid!Pre.Ofi." "->>9.99" "decimal" 12 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > integral.Almmmatg.PreOfi
"Almmmatg.PreOfi" "Precio de Oficina" ">>>>,>>9.9999" "decimal" 12 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > integral.Almmmatg.Chr__01
"Almmmatg.Chr__01" "UM.!Pre.Ofi." "X(6)" "character" 12 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-Imprime B-table-Win
ON CHOOSE OF Btn-Imprime IN FRAME F-Main
DO:
...
&Scoped-define SELF-NAME RADIO-SET-Margen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RADIO-SET-Margen B-table-Win
ON VALUE-CHANGED OF RADIO-SET-Margen IN FRAME F-Main
DO:
    ASSIGN {&self-name}.
    RUN dispatch IN THIS-PROCEDURE ('open-query':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  IF Almmmatg.MonVta = 0 THEN Almmmatg.MonVta = 1.      /* SOLES */
  ...
  FIND Almtfami WHERE Almtfami.CodCia = S-CODCIA 
      ...
      No-LOCK NO-ERROR.
  IF AVAILABLE Almtfami THEN Almmmatg.TpoCmb = Almtfami.Tpocmb.
  RUN dispatch IN THIS-PROCEDURE ('display-fields':U).
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DO WITH FRAME {&FRAME-NAME}:
      Btn-Imprime:SENSITIVE = YES.
      BUTTON-7:SENSITIVE = YES. 
      CB-FchMod:SENSITIVE = YES. 
      F-CodMat:SENSITIVE = YES. 
      F-FchDes:SENSITIVE = YES. 
      F-FchHas:SENSITIVE = YES. 
      F-Filtro:SENSITIVE = YES. 
      F-Provee:SENSITIVE = YES. 
      RADIO-SET-Margen:SENSITIVE = YES. 
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DO WITH FRAME {&FRAME-NAME}:
      Btn-Imprime:SENSITIVE = NO.
      BUTTON-7:SENSITIVE = NO. 
      CB-FchMod:SENSITIVE = NO. 
      F-CodMat:SENSITIVE = NO. 
      F-FchDes:SENSITIVE = NO. 
      F-FchHas:SENSITIVE = NO. 
      F-Filtro:SENSITIVE = NO. 
      F-Provee:SENSITIVE = NO. 
      RADIO-SET-Margen:SENSITIVE = NO. 
      R-Tipo:SENSITIVE = NO.
  END.
