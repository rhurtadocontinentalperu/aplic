...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 BUTTON-create BUTTON-exit 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "GENERACION DE FACTURAS AL CREDITO - VALES UTILEX"
         HEIGHT             = 22.08
         WIDTH              = 122
         MAX-HEIGHT         = 24.58
         MAX-WIDTH          = 124.43
...
ON END-ERROR OF W-Win /* GENERACION DE FACTURAS AL CREDITO - VALES UTILEX */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* GENERACION DE FACTURAS AL CREDITO - VALES UTILEX */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'bgeneracioncomprobantes-valesutilex.w':U ,
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-1 BUTTON-create BUTTON-exit 
