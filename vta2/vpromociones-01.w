...
DEFINE FRAME F-Main
     VtaCTabla.Libre_c02 AT ROW 1.19 COL 2.86 WIDGET-ID 2
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  RUN Procesa-Handle IN lh_handle ("Enable-Heads").
...
RUN Procesa-Handle IN lh_handle ("Disable-Heads").
RETURN "OK".
