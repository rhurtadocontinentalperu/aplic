...
DEFINE VARIABLE h_butilexprecios-02e AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/butilexprecios-02e.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_butilexprecios-02e ).
       RUN set-position IN h_butilexprecios-02e ( 2.62 , 3.00 ) NO-ERROR.
       RUN set-size IN h_butilexprecios-02e ( 16.35 , 138.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_butilexprecios-02e ,
             BUTTON-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 5 */
...
CASE RADIO-SET-1:
    ...
    WHEN 5 THEN DO: 
        RUN select-page ('5').
        RUN Recalcular IN h_butilexprecios-02e.
        RUN dispatch IN h_butilexprecios-02e ('open-query':U).
    END.
END CASE.
