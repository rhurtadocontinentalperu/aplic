...
DEFINE NEW SHARED VARIABLE s-TpoPed AS CHAR INIT 'P2'.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "COTIZACION MAYORISTA AL CREDITO - NO ASISTENTES"
         HEIGHT             = 24.19
         WIDTH              = 143.14
         MAX-HEIGHT         = 24.62
         MAX-WIDTH          = 150.72
...
ON END-ERROR OF W-Win /* COTIZACION MAYORISTA AL CREDITO - NO ASISTENTES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* COTIZACION MAYORISTA AL CREDITO - NO ASISTENTES */
DO:
