...
&Scoped-define QUERY-STRING-Query-Main FOR EACH gn-locales WHERE ~{&KEY-PHRASE} ~
      AND gn-locales.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-locales WHERE ~{&KEY-PHRASE} ~
      AND gn-locales.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-locales
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-locales
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "gn-locales.CodCia = s-codcia"
