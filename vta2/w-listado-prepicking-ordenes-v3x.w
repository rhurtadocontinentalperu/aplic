...
rbtn-impresos txtDesde txtHasta ChkChequeo rbtn-cliente txtOC-SMP BtnExcel ~
RADIO-SET-1 txtCliente BUTTON-PorZona BUTTON-Alfabeticamente 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-CodDoc rbtn-impresos txtDesde ~
txtHasta ChkChequeo rbtn-cliente txtOC-SMP RADIO-SET-1 txtCliente ~
txtArtSinPeso 
...
DEFINE FRAME F-Main
     ...
     BtnExcel AT ROW 3.69 COL 112 WIDGET-ID 34
     RADIO-SET-1 AT ROW 3.69 COL 127 NO-LABEL WIDGET-ID 28
     txtCliente AT ROW 4.38 COL 54 COLON-ALIGNED WIDGET-ID 46
     BUTTON-PorZona AT ROW 25.85 COL 1.43 WIDGET-ID 6
     BUTTON-Alfabeticamente AT ROW 25.85 COL 24.14 WIDGET-ID 8
     txtArtSinPeso AT ROW 26 COL 51.57 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     "Lista de Articulos que NO tienen PESO en la O/D" VIEW-AS TEXT
          SIZE 43.14 BY .62 AT ROW 25.38 COL 53.72 WIDGET-ID 26
          BGCOLOR 15 FGCOLOR 9 FONT 6
     "Filtrar por:" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 1.38 COL 2 WIDGET-ID 40
     RECT-1 AT ROW 3.5 COL 111 WIDGET-ID 32
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {F0B88A90-F5DA-11CF-B545-0020AF6ED35A} type: PSTimer */
      CtrlFrame:MOVE-AFTER(ChkChequeo:HANDLE IN FRAME F-Main).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-listado-prepicking-ordenes-todos-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = FchPed':U ,
             OUTPUT h_b-prepicking-ordenes-todos ).
       RUN set-position IN h_b-prepicking-ordenes-todos ( 5.69 , 1.14 ) NO-ERROR.
...
OCXFile = SEARCH( "w-listado-prepicking-ordenes-v3x.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-listado-prepicking-ordenes-v3x.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-CodDoc rbtn-impresos txtDesde txtHasta ChkChequeo 
          rbtn-cliente txtOC-SMP RADIO-SET-1 txtCliente txtArtSinPeso 
      WITH FRAME F-Main IN WINDOW sW-Win.
  ENABLE RECT-1 RADIO-SET-CodDoc BtnDone BUTTON-13 rbtn-impresos txtDesde 
         txtHasta ChkChequeo rbtn-cliente txtOC-SMP BtnExcel RADIO-SET-1 
         txtCliente BUTTON-PorZona BUTTON-Alfabeticamente 
      WITH FRAME F-Main IN WINDOW sW-Win.
