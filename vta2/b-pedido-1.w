...
&Scoped-define FIELDS-IN-QUERY-br_table FacDPedi.CodAux FacDPedi.NroItm ~
FacDPedi.codmat Almmmatg.DesMat Almmmatg.DesMar FacDPedi.UndVta ~
FacDPedi.AlmDes FacDPedi.CanPed FacDPedi.PreUni FacDPedi.PorDto ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacDPedi.CodAux COLUMN-LABEL "" FORMAT "X":U
      FacDPedi.NroItm COLUMN-LABEL "No" FORMAT ">>>9":U
      FacDPedi.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)":U WIDTH 5.43
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 51.86
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>>.9999":U
      FacDPedi.PorDto COLUMN-LABEL "% Dscto.!Incluido" FORMAT ">>9.99":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 142 BY 8.62
         BGCOLOR 15 FONT 4
         TITLE BGCOLOR 15 "DETALLE".
...
DEFINE FRAME F-Main
     ...
     F-ValVta AT ROW 10.69 COL 89 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-TotBrt AT ROW 10.73 COL 11 NO-LABEL WIDGET-ID 12
     F-ImpExo AT ROW 10.73 COL 31 NO-LABEL WIDGET-ID 4
     F-ImpDes AT ROW 10.73 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     F-ImpIsc AT ROW 10.73 COL 69 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpIgv AT ROW 10.73 COL 109 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     F-ImpTot AT ROW 10.73 COL 129 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.15 COL 51.57 WIDGET-ID 18
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 10.15 COL 113.72 WIDGET-ID 24
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 10.15 COL 131.14 WIDGET-ID 20
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.15 COL 31.43 WIDGET-ID 22
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 10.15 COL 74.72 WIDGET-ID 26
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.15 COL 12.86 WIDGET-ID 28
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.15 COL 92.72 WIDGET-ID 16
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > integral.FacDPedi.CodAux
"FacDPedi.CodAux" "" "X" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.FacDPedi.NroItm
"FacDPedi.NroItm" "No" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.FacDPedi.codmat
"FacDPedi.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > integral.Almmmatg.DesMat
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "51.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.PorDto
"FacDPedi.PorDto" "% Dscto.!Incluido" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.FacDPedi.Por_Dsctos[1]
"FacDPedi.Por_Dsctos[1]" "% Dscto!Manual" ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.FacDPedi.Por_Dsctos[2]
"FacDPedi.Por_Dsctos[2]" "% Dscto!Evento" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.Por_Dsctos[3]
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol/Prom" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.ImpLin
...
------------------------------------------------------------------------------*/
  ...
  {&BROWSE-NAME}:TITLE IN FRAME {&FRAME-NAME} = "DETALLE PEDIDO " + Faccpedi.nroped.
  ...
  /* Stock Letras */
  RUN show-stk-letras IN lh_Handle (IF AVAILABLE faccpedi THEN facCpedi.codcli ELSE "***123**").
