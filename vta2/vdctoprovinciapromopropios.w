...
Almmmatg.PromMinFchH[1] Almmmatg.PromMinDto[1] 
&Scoped-define DISPLAYED-TABLES Almmmatg
&Scoped-define FIRST-DISPLAYED-TABLE Almmmatg
&Scoped-Define DISPLAYED-OBJECTS F-PRECIO-1 
...
DEFINE FRAME F-Main
     ...
     Almmmatg.PromMinFchH[1] AT ROW 4.08 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     Almmmatg.PromMinDto[1] AT ROW 4.08 COL 31 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     F-PRECIO-1 AT ROW 4.08 COL 40 COLON-ALIGNED NO-LABEL
     "Descuento" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 3.31 COL 33
     "Inicio" VIEW-AS TEXT
     ...
     "Precio en S/." VIEW-AS TEXT
          SIZE 10.14 BY .5 AT ROW 3.31 COL 42
