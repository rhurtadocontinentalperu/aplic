...
DEFINE VARIABLE h_tprecotizacioncreditomay AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vprecotizacioncreditomayv2.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/tprecotizacioncreditomay.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tprecotizacioncreditomay ).
       RUN set-position IN h_tprecotizacioncreditomay ( 11.96 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tprecotizacioncreditomay ( 11.08 , 131.57 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_tprecotizacioncreditomay ,
             BUTTON-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 2 */
...
CASE L-Handle:
    WHEN "browse" THEN DO:
          ...
          IF h_tprecotizacioncreditomay <> ? THEN RUN dispatch IN h_tprecotizacioncreditomay ('open-query':U).
      END.
...
/*         B-CCTE:SENSITIVE = YES.*/
    ...
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
        RUN Recalcular-Precios IN h_tprecotizacioncreditomay.
      END.
