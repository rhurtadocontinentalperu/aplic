...
FacCPedi.CodVen FacCPedi.FmaPgo FacCPedi.Libre_c05 FacCPedi.NroCard ~
FacCPedi.Libre_c03 FacCPedi.NroRef FacCPedi.Libre_c04 
...
FacCPedi.CodMon FacCPedi.Glosa FacCPedi.CodVen FacCPedi.FmaPgo ~
FacCPedi.Libre_c05 FacCPedi.NroCard FacCPedi.Libre_c03 FacCPedi.NroRef ~
FacCPedi.Libre_c04 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-nOMvEN COMBO-BOX-Proveedor ~
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 86 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.fchven AT ROW 1 COL 118 COLON-ALIGNED
     ...
     FacCPedi.TpoCmb AT ROW 1.81 COL 86 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.ordcmp AT ROW 1.81 COL 118 COLON-ALIGNED WIDGET-ID 32
          LABEL "O/Compra"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 9 
     ...
     FacCPedi.Cmpbnte AT ROW 2.62 COL 118 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
          SIZE 8 BY 1
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgSit AT ROW 2.73 COL 88 NO-LABEL
...
"Cupón de Descuento", "CD":U
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgIgv AT ROW 3.42 COL 120 NO-LABEL WIDGET-ID 28
...
"No", no
     ...
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 4.27 COL 120 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
     ...
     COMBO-BOX-Proveedor AT ROW 6 COL 86 COLON-ALIGNED WIDGET-ID 48
...
DEFINE FRAME F-Main
     ...
     FacCPedi.Libre_c05 AT ROW 6.77 COL 86 COLON-ALIGNED WIDGET-ID 50 PASSWORD-FIELD 
     ...
     FacCPedi.Libre_c03 AT ROW 7.58 COL 86 COLON-ALIGNED HELP
          "" WIDGET-ID 6
          LABEL "Banco" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-4 AT ROW 7.58 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     FacCPedi.NroRef AT ROW 8.27 COL 9 COLON-ALIGNED WIDGET-ID 10
          LABEL "Vitrinas" FORMAT "X(254)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 15 FGCOLOR 12 
     FacCPedi.Libre_c04 AT ROW 8.38 COL 86 COLON-ALIGNED WIDGET-ID 38
          LABEL "Tarjeta" FORMAT "x(2)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-5 AT ROW 8.38 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 3.42 COL 113 WIDGET-ID 26
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 4.46 COL 113
...
DO:
  ...
  IF s-FlgSit = "KC" THEN DO:   /* Vales Continental */
      IF LOOKUP(SUBSTRING(SELF:SCREEN-VALUE,1,4), '0001,0002,0003,0004') = 0 THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  RUN vtamin/cancelar-pedido-minorista-04 (ROWID(FacCPedi)).
...
/*   RUN vta2/utilex-promocion-final ("PREMIUM", INPUT-OUTPUT TABLE PEDI).    /* PUEDE COMPRAR PRODUCTOS PROMOCIONALES */       */
/*                                                                                                                              */
/*   IF s-FlgSit = "" THEN                                                                                                      */
/*       RUN vta2/utilex-promocion-final ("MOCHILA", INPUT-OUTPUT TABLE PEDI).    /* PUEDE COMPRAR PRODUCTOS PROMOCIONALES */   */
/*                                                                                                                              */
/*   RUN vta2/utilex-promocion-final ("TILIBRA", INPUT-OUTPUT TABLE PEDI).    /* PUEDE COMPRAR PRODUCTOS PROMOCIONALES */       */
/*                                                                                                                              */
/*   RUN vta2/utilex-descuentos-finales ("PREMIUM", INPUT-OUTPUT TABLE PEDI). /* DESCUENTOS ESPECIALES POR LOTE DE PRODUCTOS */ */
...
------------------------------------------------------------------------------*/
  ...
  RUN vta2/promociones-pedidos-cred ( ROWID(Faccpedi), NO ).
  IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO, RETURN 'ADM-ERROR'.
  
  /* SE DEFINEN TOPES PARA LOS ENCARTES Y SE CALCULA EL TOTAL FINAL */
  RUN Graba-Totales.
  /* ************************************************************** */
...
/*     END.                                                                                                  */
    ...
    IF s-FlgSit = 'T' THEN DO:
        IF faccpedi.libre_c03:SCREEN-VALUE = '' THEN DO:
            MESSAGE 'Debe ingresar Banco'
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            APPLY "ENTRY" TO Faccpedi.Libre_c03.
            RETURN "ADM-ERROR".   
        END.
    END.
    * ****************** */
    ...
    IF Faccpedi.FlgSit:SCREEN-VALUE = "CD" THEN DO:
        /*IF LOOKUP(INPUT FacCPedi.Libre_c05, '00755631,4122,075648,2413,45781,45782') = 0 THEN DO:*/
        IF LOOKUP(INPUT FacCPedi.Libre_c05, '00755631,4122,075648,2413,45782,091169') = 0 THEN DO:
            MESSAGE 'Cupón de Descuento NO válido Promoción Vencida' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
            RETURN 'ADM-ERROR'.
        END.
    END.
    ...
    END.
/*     IF Faccpedi.FlgSit:SCREEN-VALUE = "KC" THEN DO:                       */
/*         IF s-CodPro = '10003814' AND NOT s-NroVale BEGINS '0003' THEN DO: */
/*             MESSAGE 'Vale NO válido' VIEW-AS ALERT-BOX ERROR.             */
/*             APPLY 'ENTRY':U TO FacCPedi.Libre_c05.                        */
/*             RETURN 'ADM-ERROR'.                                           */
/*         END.                                                              */
