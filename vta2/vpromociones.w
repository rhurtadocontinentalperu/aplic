...
VtaCTabla.FechaInicial VtaCTabla.FechaFinal VtaCTabla.Libre_c01 ~
VtaCTabla.Libre_d01 
...
VtaCTabla.Descripcion VtaCTabla.UsrCreacion VtaCTabla.FchCreacion ~
VtaCTabla.FechaInicial VtaCTabla.FechaFinal VtaCTabla.Libre_c01 ~
VtaCTabla.Libre_d01 VtaCTabla.UsrModificacion VtaCTabla.FchModificacion 
...
DEFINE FRAME F-Main
     VtaCTabla.Llave AT ROW 1 COL 13 COLON-ALIGNED WIDGET-ID 12
          LABEL "Promoción"
          VIEW-AS FILL-IN 
          SIZE 15.72 BY .81
     VtaCTabla.Estado AT ROW 1 COL 32 NO-LABEL WIDGET-ID 18
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Activa", "A":U,
"Inactiva", "I":U
          SIZE 20 BY .81
     VtaCTabla.Descripcion AT ROW 1 COL 60 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 44.29 BY .81
     VtaCTabla.UsrCreacion AT ROW 1 COL 117 COLON-ALIGNED WIDGET-ID 14
          LABEL "Creado por"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCTabla.FchCreacion AT ROW 1 COL 130 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     VtaCTabla.FechaInicial AT ROW 2.08 COL 13 COLON-ALIGNED WIDGET-ID 10
          LABEL "Válida desde"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCTabla.FechaFinal AT ROW 2.08 COL 31 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCTabla.Libre_c01 AT ROW 2.08 COL 51 COLON-ALIGNED NO-LABEL WIDGET-ID 24
          VIEW-AS COMBO-BOX INNER-LINES 2
          LIST-ITEMS "Unidades","Soles" 
          DROP-DOWN-LIST
          SIZE 10 BY 1
          BGCOLOR 14 FGCOLOR 0 
     VtaCTabla.Libre_d01 AT ROW 2.08 COL 74 COLON-ALIGNED WIDGET-ID 22
          LABEL "Por la compra de" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 14 FGCOLOR 0 
     VtaCTabla.UsrModificacion AT ROW 2.08 COL 117 COLON-ALIGNED WIDGET-ID 16
          LABEL "Modificado por"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCTabla.FchModificacion AT ROW 2.08 COL 130 COLON-ALIGNED NO-LABEL WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     "(obligatorio)" VIEW-AS TEXT
          SIZE 8 BY .81 AT ROW 2.08 COL 87 WIDGET-ID 26
