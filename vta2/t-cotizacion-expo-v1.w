...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 144 BY 12.38
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpTot AT ROW 13.38 COL 70 COLON-ALIGNED WIDGET-ID 6
     FILL-IN-ImpPer AT ROW 13.38 COL 94 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-ImpTot-2 AT ROW 13.38 COL 126 COLON-ALIGNED WIDGET-ID 2
     "F8: Stocks por Almacén" VIEW-AS TEXT
          SIZE 17 BY .5 AT ROW 14.46 COL 52 WIDGET-ID 10
