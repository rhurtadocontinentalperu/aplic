...
FacDPedi.AlmDes FacDPedi.CanPed FacDPedi.PreUni FacDPedi.Por_Dsctos[1] ~
...
FILL-IN_ImpVta FILL-IN_Percepcion FILL-IN_ImpIgv FILL-IN_PorIgv ~
FILL-IN_ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999":U
            WIDTH 7.43
      FacDPedi.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Adminis" FORMAT "->>9.9999":U
            WIDTH 7
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
            WIDTH 7.43
      FacDPedi.ImpDto FORMAT ">>>,>>9.99":U WIDTH 7.86
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 8.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpExo AT ROW 12.31 COL 53 COLON-ALIGNED WIDGET-ID 16
     FILL-IN_ImpVta AT ROW 12.31 COL 83 COLON-ALIGNED WIDGET-ID 22
     FILL-IN_Percepcion AT ROW 12.35 COL 126 COLON-ALIGNED WIDGET-ID 26
     FILL-IN_ImpIgv AT ROW 13.12 COL 83 COLON-ALIGNED WIDGET-ID 18
     FILL-IN_PorIgv AT ROW 13.12 COL 103 COLON-ALIGNED WIDGET-ID 24
     FILL-IN_ImpTot AT ROW 13.12 COL 126 COLON-ALIGNED WIDGET-ID 20
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.Por_Dsctos[1]
"FacDPedi.Por_Dsctos[1]" "% Dscto!Adminis" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol/Prom" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.ImpDto
"FacDPedi.ImpDto" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.ImpLin
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
