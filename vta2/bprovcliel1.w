...
DEF VAR s-Tabla AS CHAR INIT 'PL1' NO-UNDO.
...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
 ...
 AND VtaTabla.Tabla = s-tabla NO-LOCK, ~
      FIRST gn-clie WHERE gn-clie.CodCli = VtaTabla.Llave_c1 ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Codigo" FORMAT "x(11)":U
            WIDTH 11.43
      gn-clie.NomCli FORMAT "x(60)":U WIDTH 48.72
  ENABLE
      VtaTabla.Llave_c1
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 15.19
...
/* Query rebuild information for BROWSE br_table
 ...
 AND INTEGRAL.VtaTabla.Tabla = s-tabla"
     _JoinCode[2]      = "INTEGRAL.gn-clie.CodCli = INTEGRAL.VtaTabla.Llave_c1"
     _Where[2]         = "INTEGRAL.gn-clie.CodCia = cl-codcia"
     _FldNameList[1]   > INTEGRAL.VtaTabla.Llave_c1
"VtaTabla.Llave_c1" "Codigo" "x(11)" "character" ? ? ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-clie.NomCli
"gn-clie.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "48.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  END.
  IF CAN-FIND(FIRST B-Tabla WHERE B-Tabla.codcia = s-codcia
