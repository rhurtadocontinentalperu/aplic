...
FacCPedi.FchEnt FacCPedi.DirCli FacCPedi.Libre_f02 FacCPedi.CodPos ~
FacCPedi.TipVta FacCPedi.Cmpbnte FacCPedi.LugEnt FacCPedi.CodMon ~
FacCPedi.TpoCmb FacCPedi.NroCard FacCPedi.FlgIgv FacCPedi.Sede ~
FacCPedi.NroRef FacCPedi.FmaPgo FacCPedi.CodVen FacCPedi.ordcmp ~
FacCPedi.CodAlm FacCPedi.Glosa FacCPedi.Libre_c03 
...
FacCPedi.Libre_f02 FacCPedi.CodPos FacCPedi.TipVta FacCPedi.Cmpbnte ~
FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.TpoCmb FacCPedi.NroCard ~
FacCPedi.FlgIgv FacCPedi.Sede FacCPedi.NroRef FacCPedi.NroOrigen ~
FacCPedi.FmaPgo FacCPedi.CodVen FacCPedi.ordcmp FacCPedi.CodAlm ~
FacCPedi.usuario FacCPedi.Glosa FacCPedi.Libre_c03 FacCPedi.CrossDocking ~
FacCPedi.AlmacenXD FacCPedi.TpoLic 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-Lista FILL-IN-CodPos ~
F-Nomtar FILL-IN-sede F-CndVta f-NomVen f-NomAlm FILL-IN-AlmacenXD 
...
DEFINE FRAME F-Main
     FacCPedi.NroPed AT ROW 1 COL 13 COLON-ALIGNED
          LABEL "Numero" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 15 FGCOLOR 1 FONT 0
     F-Estado AT ROW 1 COL 31.14 COLON-ALIGNED NO-LABEL
     FacCPedi.FaxCli AT ROW 1 COL 69 COLON-ALIGNED NO-LABEL WIDGET-ID 120 FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     FacCPedi.FchPed AT ROW 1 COL 97 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.CodCli AT ROW 1.81 COL 13 COLON-ALIGNED HELP
          ""
          LABEL "Cliente" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.RucCli AT ROW 1.81 COL 30 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.Atencion AT ROW 1.81 COL 47 COLON-ALIGNED WIDGET-ID 4
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-Lista AT ROW 1.81 COL 75 COLON-ALIGNED WIDGET-ID 124
     FacCPedi.fchven AT ROW 1.81 COL 97 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NomCli AT ROW 2.62 COL 13 COLON-ALIGNED FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 71 BY .81
     FacCPedi.FchEnt AT ROW 2.62 COL 97 COLON-ALIGNED WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.DirCli AT ROW 3.42 COL 13 COLON-ALIGNED
          LABEL "Dirección" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 71 BY .81
     FacCPedi.Libre_f02 AT ROW 3.46 COL 97 COLON-ALIGNED WIDGET-ID 150
          LABEL "Fecha entrega" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 14 
     FacCPedi.CodPos AT ROW 4.23 COL 13 COLON-ALIGNED WIDGET-ID 126
          LABEL "Distrito de Entrega"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FILL-IN-CodPos AT ROW 4.23 COL 18 COLON-ALIGNED NO-LABEL WIDGET-ID 128
     FacCPedi.TipVta AT ROW 4.23 COL 77 NO-LABEL WIDGET-ID 134
...
"Si", "Si":U
          SIZE 12 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.Cmpbnte AT ROW 4.27 COL 99 NO-LABEL WIDGET-ID 36
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "FAC", "FAC":U,
"BOL", "BOL":U
          SIZE 13 BY .81
     FacCPedi.LugEnt AT ROW 5.04 COL 13 COLON-ALIGNED WIDGET-ID 20
          LABEL "Lug. de entrega" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 74 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 5.04 COL 99 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dolares", 2
          SIZE 15 BY .81
     FacCPedi.TpoCmb AT ROW 5.81 COL 97 COLON-ALIGNED
          LABEL "T.C."
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NroCard AT ROW 5.85 COL 13 COLON-ALIGNED WIDGET-ID 14
          LABEL "Nro. Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     F-Nomtar AT ROW 5.85 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 12
...
DEFINE FRAME F-Main
     FacCPedi.FlgIgv AT ROW 5.85 COL 73.72 WIDGET-ID 108
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 11.29 BY .77
     FacCPedi.Sede AT ROW 6.65 COL 13 COLON-ALIGNED WIDGET-ID 24
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     FILL-IN-sede AT ROW 6.65 COL 19 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     FacCPedi.NroRef AT ROW 6.65 COL 97 COLON-ALIGNED WIDGET-ID 10
          LABEL "Cotizacion"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 4 
     FacCPedi.NroOrigen AT ROW 6.65 COL 108 COLON-ALIGNED NO-LABEL WIDGET-ID 146
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
     FacCPedi.FmaPgo AT ROW 7.46 COL 13 COLON-ALIGNED
          LABEL "Cond. de Venta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-CndVta AT ROW 7.46 COL 19 COLON-ALIGNED NO-LABEL
     FacCPedi.CodVen AT ROW 7.46 COL 56 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
     f-NomVen AT ROW 7.46 COL 61 COLON-ALIGNED NO-LABEL
     FacCPedi.ordcmp AT ROW 7.46 COL 97 COLON-ALIGNED
          LABEL "O/Compra" FORMAT "X(25)"
          VIEW-AS FILL-IN 
          SIZE 22 BY .81
     FacCPedi.CodAlm AT ROW 8.27 COL 13 COLON-ALIGNED WIDGET-ID 110
          LABEL "Alm. Despacho" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 14 BY .81
          BGCOLOR 8 FGCOLOR 0 
     f-NomAlm AT ROW 8.27 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 112
     FacCPedi.usuario AT ROW 8.27 COL 97 COLON-ALIGNED WIDGET-ID 34
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Glosa AT ROW 9.08 COL 10.28 FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 74 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Libre_c03 AT ROW 9.08 COL 97 COLON-ALIGNED WIDGET-ID 130
          LABEL "Bol. Depósito" FORMAT "x(12)"
          VIEW-AS FILL-IN 
          SIZE 16 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.CrossDocking AT ROW 9.88 COL 15 WIDGET-ID 140
          LABEL "Cross Docking"
          VIEW-AS TOGGLE-BOX
          SIZE 14 BY .77
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.AlmacenXD AT ROW 9.88 COL 38 COLON-ALIGNED WIDGET-ID 142
          LABEL "Alm.Tránsito"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FILL-IN-AlmacenXD AT ROW 9.88 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 144
     FacCPedi.TpoLic AT ROW 9.88 COL 99 WIDGET-ID 118
          LABEL "APLICAR ADELANTOS"
          VIEW-AS TOGGLE-BOX
          SIZE 19 BY .77
          BGCOLOR 14 FGCOLOR 0 
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.27 COL 92
     "Pactado con cliente" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 3.58 COL 109.57 WIDGET-ID 154
     "Calendario logistico" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 2.73 COL 109.57 WIDGET-ID 148
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 4.46 COL 89 WIDGET-ID 106
     "Cliente Recoge?" VIEW-AS TEXT
          SIZE 12 BY .5 AT ROW 4.5 COL 65 WIDGET-ID 138
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/*         RUN vta/w-agtrans-02v2 (Faccpedi.codcia,  */
/*                                 Faccpedi.coddiv,  */
/*                                 Faccpedi.coddoc,  */
/*                                 Faccpedi.nroped). */
        RUN vta2/d-agencia-trans-tempo (Faccpedi.codcia, 
                                        Faccpedi.coddiv, 
                                        Faccpedi.coddoc, 
                                        Faccpedi.nroped).
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    /* ********************************************************************************************** */
    RUN {&Promocion} (COTIZACION.Libre_c01,   /* División Lista Precio */
                      Faccpedi.CodCli,
...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    ...
    /* ******************************************************************************* */
    /* RHC 12/09/2019 CASO DE VENTA 002 */
    /* ******************************************************************************* */
    ...
    IF Faccpedi.FmaPgo = '002' THEN DO:
        ...
        IF AVAILABLE Ccbcdocu THEN DO:
            ...
            IF FacCPedi.CodMon = Ccbcdocu.CodMon THEN DO:
                IF Ccbcdocu.sdoact < x-ImpLin THEN DO:
                    ASSIGN 
                        FacCPedi.Flgest = 'X'
                        FacCPedi.Glosa  = TRIM (FacCPedi.Glosa) + '//Linea Credito'
                        FacCPedi.Libre_c05 = 'LA BD NO CUBRE EL PEDIDO'
                        FacCPedi.Libre_c04 = ' - LA BD NO CUBRE EL PEDIDO'.
                END.
            END.
            ELSE DO:
                IF Ccbcdocu.codmon = 1 THEN DO:
                    IF Ccbcdocu.sdoact < (x-ImpLin * FaccPedi.Tpocmb) THEN DO:
                        ASSIGN 
                            FacCPedi.Flgest = 'X'
                            FacCPedi.Glosa  = TRIM (FacCPedi.Glosa) + '//Linea Credito'
                            FacCPedi.Libre_c05 = 'LA BD NO CUBRE EL PEDIDO'
                ...
                END.
            END.
        END.    /* AVAILABLE Ccbcdocu */
    END.    /* FmaPgo = '002' */

    /* 27Set2019 - direccion de cliente MOROSO */
    DEFINE VAR xProc AS HANDLE NO-UNDO.
    DEFINE VAR y-moroso AS CHAR.

    RUN ccb\libreria-ccb PERSISTENT SET xProc.
        
    y-moroso = "".

    DO WITH FRAME {&FRAME-NAME} :
        RUN direccion-de-moroso IN xProc (INPUT faccpedi.codcli:SCREEN-VALUE, 
                                    INPUT faccpedi.lugent:SCREEN-VALUE,
    ...
    IF y-moroso <> "" THEN DO:
        ASSIGN 
            FacCPedi.Flgest = 'X'
            FacCPedi.Glosa  = TRIM (FacCPedi.Glosa) + '//Linea Credito'
            FacCPedi.Libre_c05 = 'LA DIRECCION DE ENTREGA PERTENECE'
            FacCPedi.Libre_c04 = ' - A UN CLIENTE MOROSO ('  + y-moroso + ')'.
    END.

    DELETE PROCEDURE xProc.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      APPLY 'LEAVE':U TO FacCPedi.NroCard.
      APPLY 'LEAVE':U TO FacCPedi.Sede.
      APPLY 'LEAVE':U TO FacCPedi.CodVen.
...
/*     END.                                                                       */
    ...
    IF s-FmaPgo = '002' /*AND LOOKUP(s-CodDiv, '00018,00024,00030') > 0 */ THEN DO:
        ...
        IF INPUT FacCPedi.CodMon = Ccbcdocu.CodMon THEN DO:
            IF Ccbcdocu.sdoact < x-ImpLin THEN DO:
                MESSAGE 'El saldo de la Boleta de Depósito NO cubre el Pedido' SKIP
                    'Continuamos con el proceso? (flujo temporal)'
                    VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO UPDATE rpta AS LOG.
                IF rpta = NO THEN DO:
                    APPLY 'ENTRY':U TO FacCPedi.Libre_c03.
                    RETURN 'ADM-ERROR'.
        ...
        ELSE DO:
            IF Ccbcdocu.codmon = 1 THEN DO:
                IF Ccbcdocu.sdoact < (x-ImpLin * DECI(FaccPedi.Tpocmb:SCREEN-VALUE)) THEN DO:
                    MESSAGE 'El saldo de la Boleta de Depósito NO cubre el Pedido' SKIP
                        'Continuamos con el proceso? (flujo temporal)'
...
/*         END.                                                                                  */
    ...
    ***************************************************************************** */
    ...
    /* Ic 27Set2019 - CONTRA-ENTREGA no es aplicable a CLIENTES-NUEVOS */
