...
&SCOPED-DEFINE l-lookup h_l-docdevutilex
...
DEFINE VARIABLE h_l-docdevutilex AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/l-docdevutilex.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-docdevutilex ).
       RUN set-position IN h_l-docdevutilex ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-docdevutilex ( 10.69 , 84.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-docdevutilex. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-docdevutilex ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-docdevutilex ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-docdevutilex , 'AFTER':U ).
    END. /* Page 0 */
