...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.CanPed FORMAT ">>>,>>9.99":U WIDTH 7.43
      ...
      (integral.FacDPedi.CanPed * integral.Almmmatg.Pesmat ) @ lPesoVenta COLUMN-LABEL "Peso Tot"
            WIDTH 8.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 111 BY 10.58
         BGCOLOR 15 FONT 4
...
"FacDPedi.CanPed" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(integral.FacDPedi.CanPed * integral.Almmmatg.Pesmat ) @ lPesoVenta" "Peso Tot" ? ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
