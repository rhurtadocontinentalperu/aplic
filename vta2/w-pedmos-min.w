...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_q-pedido-4 , 'Record':U , h_v-pedmos-min ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-pedmos-min.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedmos-min ).
       RUN set-position IN h_b-pedmos-min ( 11.50 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-pedmos-min ( 15.88 , 130.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-pedmos-min. */
       RUN add-link IN adm-broker-hdl ( h_q-pedido-4 , 'Record':U , h_b-pedmos-min ).
