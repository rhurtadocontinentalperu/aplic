            ...
            IF radio-set-calculo = 1 OR X-TIPDTO BEGINS "PRO" THEN DO:
                ...
                IF x-flete-unitario > 0 THEN DO:
                    ...
                    ASSIGN
                        ...
                        ttListaPreciosEventosPromocional.tPrecFinal = x-PreVta + (x-flete-unitario / (1 - y-dsctos / 100))
                        x-PreVtaFin = ttListaPreciosEventosPromocional.tPrecFinal.     /* Nuevo valor afectado conel flete */
                END.
