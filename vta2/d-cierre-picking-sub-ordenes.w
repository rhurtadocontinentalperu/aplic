...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-ZonaPick COMBO-BOX-Situacion ~
Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-NroPed FILL-IN-NroRef ~
FILL-IN-Cliente FILL-IN-UsrChq x-NomChq COMBO-BOX-ZonaPick ~
COMBO-BOX-Situacion 
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-NroPed FILL-IN-NroRef FILL-IN-Cliente FILL-IN-UsrChq x-NomChq 
          COMBO-BOX-ZonaPick COMBO-BOX-Situacion 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX-ZonaPick COMBO-BOX-Situacion Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      END.
      IF Vtacdocu.CodPed = "ODC" THEN DO:
          COMBO-BOX-ZonaPick:DELETE(COMBO-BOX-ZonaPick:LIST-ITEMS).
          COMBO-BOX-ZonaPick:ADD-LAST("X00").
      END.
  END.
