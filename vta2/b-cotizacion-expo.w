...
FILL-IN_ImpVta FILL-IN_ImpTot FILL-IN_ImpDto FILL-IN_ImpIgv FILL-IN_PorIgv ~
FILL-IN_Import2 FILL-IN-ColorEntero FILL-IN-Cuadernos FILL-IN-Propios ~
FILL-IN-Practiforros FILL-IN-Variacion FILL-IN-TERCEROS 
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpDto AT ROW 13.12 COL 53 COLON-ALIGNED WIDGET-ID 28
     ...
     FILL-IN-ColorEntero AT ROW 14.08 COL 83 COLON-ALIGNED WIDGET-ID 30
     FILL-IN-Cuadernos AT ROW 14.08 COL 107 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-Propios AT ROW 14.19 COL 53 COLON-ALIGNED WIDGET-ID 32
     ...
     FILL-IN-TERCEROS AT ROW 15 COL 53 COLON-ALIGNED WIDGET-ID 34
...
IF AVAILABLE FacCPedi THEN DO:
    FOR EACH FacDPedi OF Faccpedi NO-LOCK, FIRST Almmmatg OF FacDPedi NO-LOCK:
        ...
        CASE Almmmatg.CodFam:
            ...
            END.
        END CASE.
/*         IF Almmmatg.CodFam = '010' AND Almmmatg.SubFam = '012'                */
