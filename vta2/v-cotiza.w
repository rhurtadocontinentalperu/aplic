...
FacCPedi.CodVen FacCPedi.FlgIgv FacCPedi.FmaPgo FacCPedi.CodRef ~
...
FacCPedi.FmaPgo FacCPedi.CodRef FacCPedi.NroCard FacCPedi.NroRef 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.NroRef AT ROW 8.27 COL 94 COLON-ALIGNED WIDGET-ID 34 FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      /* SUPERMERCADOS */
      IF s-import-ibc = YES AND s-pendiente-ibc = YES THEN Faccpedi.flgest = 'X'.   /* POR APROBAR */
