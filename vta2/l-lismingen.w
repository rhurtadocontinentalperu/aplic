...
&SCOPED-DEFINE CONDICION ( VtaListaMinGn.Codfam BEGINS F-Codfam ~
AND VtaListaMinGn.Subfam BEGINS F-Subfam ~
AND VtaListaMinGn.DesMar BEGINS F-marca )

&SCOPED-DEFINE CODIGO VtaListaMinGn.codmat

/* Preprocesadores para cada campo filtro */ 
&SCOPED-DEFINE FILTRO1 VtaListaMinGn.DesMat BEGINS FILL-IN-filtro
&SCOPED-DEFINE FILTRO2 INDEX ( VtaListaMinGn.DesMat , FILL-IN-filtro ) <> 0 
...
&Scoped-define INTERNAL-TABLES VtaListaMinGn Almmmatg Almmmate

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaListaMinGn.codfam ~
VtaListaMinGn.subfam VtaListaMinGn.codmat VtaListaMinGn.DesMat ~
VtaListaMinGn.DesMar F-PRESOLA @ VtaListaMinGn.PreOfi VtaListaMinGn.Chr__01 ~
Almmmatg.UndBas _StkAct() @ F-STKACT ~
...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      ...
      EACH Almmmatg OF VtaListaMinGn NO-LOCK, ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
 ...
 AND (RADIO-SET-Stock = 'T' OR Almmmate.StkAct > 0) NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table VtaListaMinGn Almmmatg Almmmate
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaListaMinGn.DesMat
Nombres que contengan|y||INTEGRAL.VtaListaMinGn.DesMat
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Codigo|||INTEGRAL.VtaListaMinGn.CodCia|yes,INTEGRAL.VtaListaMinGn.codmat|yes
Familia|||INTEGRAL.VtaListaMinGn.codfam|yes
Descripcion|y||INTEGRAL.VtaListaMinGn.DesMat|yes
Marca|||INTEGRAL.VtaListaMinGn.DesMar|yes
Sub-Familia|||INTEGRAL.VtaListaMinGn.codfam|yes,INTEGRAL.VtaListaMinGn.subfam|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaListaMinGn.codfam COLUMN-LABEL "Cód!Fam" FORMAT "X(3)":U
      VtaListaMinGn.subfam COLUMN-LABEL "Sub!Fam" FORMAT "X(3)":U
      VtaListaMinGn.codmat COLUMN-LABEL "Codigo!Articulo" FORMAT "X(6)":U
      VtaListaMinGn.DesMat FORMAT "X(80)":U WIDTH 50.14
      VtaListaMinGn.DesMar COLUMN-LABEL "Marca" FORMAT "X(30)":U
            WIDTH 19.86
      F-PRESOLA @ VtaListaMinGn.PreOfi COLUMN-LABEL "Precio Venta S/." FORMAT ">>>,>>9.9999":U
      VtaListaMinGn.Chr__01 COLUMN-LABEL "Unidad!Venta" FORMAT "X(8)":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaListaMinGn,INTEGRAL.Almmmatg OF INTEGRAL.VtaListaMinGn,INTEGRAL.Almmmate OF INTEGRAL.Almmmatg"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",, FIRST, FIRST"
     _Where[1]         = "{&CONDICION}"
     _Where[3]         = "Almmmate.CodAlm = x-codalm
 AND (RADIO-SET-Stock = 'T' OR Almmmate.StkAct > 0)"
     _FldNameList[1]   > INTEGRAL.VtaListaMinGn.codfam
"VtaListaMinGn.codfam" "Cód!Fam" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaListaMinGn.subfam
"VtaListaMinGn.subfam" "Sub!Fam" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaListaMinGn.codmat
"VtaListaMinGn.codmat" "Codigo!Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaListaMinGn.DesMat
"VtaListaMinGn.DesMat" ? "X(80)" "character" ? ? ? ? ? ? no ? no no "50.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaListaMinGn.DesMar
"VtaListaMinGn.DesMar" "Marca" ? "character" ? ? ? ? ? ? no ? no no "19.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"F-PRESOLA @ VtaListaMinGn.PreOfi" "Precio Venta S/." ">>>,>>9.9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.VtaListaMinGn.Chr__01
"VtaListaMinGn.Chr__01" "Unidad!Venta" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  IF Almmmatg.MonVta = 1 THEN DO:
    F-PRESOLA = VtaListaMinGn.PreOfi.
    F-PREUSSA = VtaListaMinGn.PreOfi / VtaListaMinGn.TpoCmb.
  END.
  ELSE DO:
    F-PREUSSA = VtaListaMinGn.PreOfi.
    F-PRESOLA = VtaListaMinGn.PreOfi * VtaListaMinGn.TpoCmb.
  END.
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaListaMinGn.CodCia BY VtaListaMinGn.codmat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Familia':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaListaMinGn.codfam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripcion':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaListaMinGn.DesMat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Marca':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaListaMinGn.DesMar
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Sub-Familia':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaListaMinGn.codfam BY VtaListaMinGn.subfam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
