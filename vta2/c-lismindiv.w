...
&SCOPED-DEFINE l-lookup h_l-lismindiv
...
DEFINE VARIABLE h_l-lismindiv AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-lismindiv.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-lismindiv ).
       RUN set-position IN h_l-lismindiv ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-lismindiv ( 14.23 , 131.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-lismindiv. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-lismindiv ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-lismindiv ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-lismindiv , 'AFTER':U ).
    END. /* Page 0 */
