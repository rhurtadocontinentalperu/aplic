...
&ANALYZE-RESUME
    WITH SEPARATORS NO-VALIDATE SIZE 70.72 BY 11.85
         FONT 4
         TITLE "Divisiones ASOCIADAS al GRUPO".
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Divisiones ASOCIADAS al GRUPO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Divisiones ASOCIADAS al GRUPO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Divisiones ASOCIADAS al GRUPO */
DO:
...
FOR EACH gn-divi WHERE gn-divi.codcia = s-codcia NO-LOCK BY gn-divi.coddiv:
    ...
    FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND
                                ...
                                vtatabla.llave_c2 = gn-divi.coddiv NO-LOCK NO-ERROR.

    IF NOT AVAILABLE vtatabla OR vtatabla.llave_c1 = factabla.codigo THEN DO:
        CREATE t-w-report.
            ASSIGN t-w-report.task-no = 999
                t-w-report.llave-c = factabla.tabla
...
FOR EACH t-w-report WHERE t-w-report.campo-l[2] = YES AND t-w-report.campo-l[1] = NO:
    FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND
                                vtatabla.tabla = factabla.tabla AND
                                vtatabla.llave_c1 = factabla.codigo AND
                                vtatabla.llave_c2 = t-w-report.campo-c[1] EXCLUSIVE-LOCK NO-ERROR.
    IF AVAILABLE vtatabla THEN DO:
       DELETE vtatabla.
    END.
...
FOR EACH t-w-report WHERE t-w-report.campo-l[1] = YES AND t-w-report.campo-l[2] = NO:
    FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND
                                vtatabla.tabla = factabla.tabla AND
                                vtatabla.llave_c1 = factabla.codigo AND
                                vtatabla.llave_c2 = t-w-report.campo-c[1] EXCLUSIVE NO-ERROR.
