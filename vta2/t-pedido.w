...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 147 BY 9.96
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-ValVta AT ROW 12.04 COL 69 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-TotBrt AT ROW 12.08 COL 11 NO-LABEL WIDGET-ID 12
     F-ImpExo AT ROW 12.08 COL 31 NO-LABEL WIDGET-ID 4
     F-ImpDes AT ROW 12.08 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     F-ImpIsc AT ROW 12.08 COL 89 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpIgv AT ROW 12.08 COL 109 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     F-ImpTot AT ROW 12.08 COL 129 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.5 COL 51.57 WIDGET-ID 18
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 11.5 COL 94.72 WIDGET-ID 26
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 11.5 COL 113.72 WIDGET-ID 24
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 11.5 COL 131.14 WIDGET-ID 20
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.5 COL 31.43 WIDGET-ID 22
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.5 COL 72.72 WIDGET-ID 16
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.5 COL 12.86 WIDGET-ID 28
...
"PEDI.AlmDes" "Alm.!Desp." ? "character" ? ? ? ? ? ? yes ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  END.
  f-CanPed = f-CanPed - PEDI.CanPed + DECIMAL(PEDI.CanPed:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).
