...
RECT-10 RECT-6 FILL-IN_ImpNac1 FILL-IN_ImpUsa1 FILL-IN_ImpNac2 ~
...
FILL-IN_CodBco8 BUTTON-TpoCmb RADIO-SET_Codmon Btn_OK Btn_Cancel 
...
DO:
    ...
    RUN vta2/d-ttickets (INPUT pCodPro, 
...
DO:
    /*RUN vtamin/D-TVVALE(OUTPUT FILL-IN_ImpNac10, OUTPUT FILL-IN_ImpUSA10).*/
    RUN vta2/d-tvales (INPUT pDNIClie, INPUT PgoTarjCr, OUTPUT FILL-IN_ImpNac10, OUTPUT FILL-IN_ImpUSA10).
    DISPLAY FILL-IN_ImpNac10  FILL-IN_ImpUSA10 WITH FRAME {&FRAME-NAME}.
    RUN Calculo.
END.
