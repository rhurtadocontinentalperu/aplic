...
&Scoped-Define ENABLED-OBJECTS BUTTON-12 RECT-69 C-NroSer B-AGTRANS 
...
DEFINE FRAME F-Main
     ...
     B-AGTRANS AT ROW 1.27 COL 97 WIDGET-ID 2
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/v-guias-manuales-valesutilex.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-guias-manuales ).
       RUN set-position IN h_v-guias-manuales ( 2.58 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-guias-remision ( 1.00 , 88.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-12 RECT-69 C-NroSer B-AGTRANS 
      WITH FRAME F-Main IN WINDOW W-Win.
