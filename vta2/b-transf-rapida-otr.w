...
TOGGLE-1 txtTTrans BUTTON-13 BUTTON-15 
&Scoped-Define DISPLAYED-OBJECTS txtTTxx x-CodDoc FILL-IN-AlmDes x-NroDoc ~
FILL-IN-NomAlmDes TOGGLE-1 x-FchDoc txtTTrans x-NroItem FILL-IN-Bultos 
...
DEFINE VARIABLE FILL-IN-NomAlmDes AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(60)":U WIDTH 72.57
      Detalle.UndVta COLUMN-LABEL "Unidad" FORMAT "x(8)":U
...
DEFINE FRAME F-Main
     ...
     txtTTxx AT ROW 5.69 COL 55.29 RIGHT-ALIGNED NO-LABEL WIDGET-ID 20
     x-CodDoc AT ROW 1.54 COL 12 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-AlmDes AT ROW 3.31 COL 14 COLON-ALIGNED WIDGET-ID 34
     x-NroDoc AT ROW 1.54 COL 19 COLON-ALIGNED NO-LABEL
     FILL-IN-NomAlmDes AT ROW 3.31 COL 19 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     TOGGLE-1 AT ROW 4.46 COL 21 WIDGET-ID 38
     x-FchDoc AT ROW 1.54 COL 56 COLON-ALIGNED
     txtTTrans AT ROW 5.69 COL 54 COLON-ALIGNED WIDGET-ID 14
     ...
     FILL-IN-Bultos AT ROW 5.81 COL 95 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     "BULTOS:" VIEW-AS TEXT
          SIZE 15 BY 1.15 AT ROW 5.81 COL 82 WIDGET-ID 32
          BGCOLOR 0 FGCOLOR 14 FONT 8
     RECT-65 AT ROW 1 COL 1
     RECT-66 AT ROW 5.42 COL 1 WIDGET-ID 22
     SPACE(18.29) SKIP(0.00)
...
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "72.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Detalle.CanPed" "Cantidad!Calculada" ? "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  MESSAGE 'Cerramos la Orden?' SKIP(2)
      'Se va a generar la salida y el ingreso x transferencia en forma automática'
  ...
  DISPLAY FILL-IN-AlmDes x-FchDoc FILL-IN-NomAlmDes x-NroDoc FILL-IN-Bultos WITH FRAME {&FRAME-NAME}.
...
OR RETURN OF {&SELF-NAME}
    DO:
        ...
        IF NOT AVAILABLE Faccpedi THEN DO:
            MESSAGE 'Orden de Transferencia NO registrada para este almacén' 
                VIEW-AS ALERT-BOX ERROR.
            SELF:SCREEN-VALUE = ''.
            RETURN NO-APPLY.
        END.
        ...
        FIND Almtdocm WHERE Almtdocm.CodCia = s-codcia
            AND Almtdocm.CodAlm = Faccpedi.codcli
            AND Almtdocm.TipMov = "I"
            AND Almtdocm.CodMov = 03
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE Almtdocm THEN DO:
            MESSAGE 'NO se ha configurado el movimiento I-03 para el almacén' Faccpedi.codcli
                VIEW-AS ALERT-BOX ERROR.
            RETURN NO-APPLY.
        END.
        IF x-NroDoc <> SELF:SCREEN-VALUE THEN DO:
            ...
            ASSIGN
                ...
                FILL-IN-AlmDes = Faccpedi.codcli
                FILL-IN-NomAlmDes = Faccpedi.nomcli.
            DISPLAY
                x-fchdoc
                FILL-IN-AlmDes
                FILL-IN-NomAlmDes
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      END.
      ASSIGN 
          Faccpedi.flgest = "C"         /* Nace CERRADA (18/04/18) */
      ...
      END.
      /* ************************************************************************* */
      RUN dist/p-transfxppv (ROWID(Faccpedi), Faccpedi.CodAlm, Faccpedi.CodCli).
...
OCXFile = SEARCH( "b-transf-rapida-otr.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "b-transf-rapida-otr.wrx":U SKIP(1)
