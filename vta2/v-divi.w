...
&Scoped-Define ENABLED-FIELDS GN-DIVI.CodDiv GN-DIVI.DesDiv 
&Scoped-define ENABLED-TABLES GN-DIVI
&Scoped-define FIRST-ENABLED-TABLE GN-DIVI
&Scoped-Define ENABLED-OBJECTS RECT-52 
&Scoped-Define DISPLAYED-FIELDS GN-DIVI.CodDiv GN-DIVI.DesDiv 
...
DEFINE FRAME F-Main
     GN-DIVI.CodDiv AT ROW 1.27 COL 2 NO-LABEL WIDGET-ID 6 FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5.72 BY .81
     GN-DIVI.DesDiv AT ROW 1.27 COL 6 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 41 BY .81
     RECT-52 AT ROW 1 COL 1 WIDGET-ID 10
