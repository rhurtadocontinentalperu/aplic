...
"Detalle.CanPed" "Cantidad!Calculada" ? "decimal" ? ? ? ? ? ? no ? no no "37.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      /* ********************************************* */
      /* RHC 25.08.2011 */
      IF FacCPedi.CodDoc = 'O/M' AND Faccpedi.FlgEst = "C" THEN FacCPedi.FlgEst = "C".
      /* TRACKING */
...
OCXFile = SEARCH( "b-pickordenv2.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "b-pickordenv2.wrx":U SKIP(1)
