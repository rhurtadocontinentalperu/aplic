...
ITEM.PreUni ITEM.Por_Dsctos[2] ITEM.Por_Dsctos[3] ITEM.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 5.29
  ENABLE
      ITEM.codmat
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 125 BY 10.5
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpTot AT ROW 11.5 COL 56 COLON-ALIGNED WIDGET-ID 6
     FILL-IN-ImpPer AT ROW 11.5 COL 80 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-ImpTot-2 AT ROW 11.5 COL 112 COLON-ALIGNED WIDGET-ID 2
...
"ITEM.PreUni" "Precio!Unitario" ">>,>>9.99999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.ITEM.Por_Dsctos[2]
...
"ITEM.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "5.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* RHC 02/07/2019 Información que falta */
  ASSIGN
