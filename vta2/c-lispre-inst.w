...
&SCOPED-DEFINE l-lookup h_l-lispre-inst
...
DEFINE VARIABLE h_l-lispre-inst AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-lispre-inst.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-lispre-inst ).
       RUN set-position IN h_l-lispre-inst ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-lispre-inst ( 14.23 , 131.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-lispre-inst. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-lispre-inst ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-lispre-inst ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-lispre-inst , 'AFTER':U ).
    END. /* Page 0 */
