...
DEFINE VARIABLE h_bcanjeadelxnc-v2 AS HANDLE NO-UNDO.
...
DO:
  ...
  RUN Genera-NC IN h_bcanjeadelxnc-v2
   ( INPUT cCodDoc,
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/bcanjeadelxnc-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bcanjeadelxnc-v2 ).
       RUN set-position IN h_bcanjeadelxnc-v2 ( 7.15 , 5.00 ) NO-ERROR.
       RUN set-size IN h_bcanjeadelxnc-v2 ( 9.42 , 80.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-updv97 ( 1.54 , 39.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bcanjeadelxnc-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv97 , 'TableIO':U , h_bcanjeadelxnc-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bcanjeadelxnc-v2 ,
             COMBO-BOX-Concepto:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv97 ,
             h_bcanjeadelxnc-v2 , 'AFTER':U ).
    END. /* Page 0 */
...
END.
RUN dispatch IN h_bcanjeadelxnc-v2 ('open-query':U).
