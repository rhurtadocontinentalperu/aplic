...
&Scoped-Define ENABLED-FIELDS VtaCTabla.Libre_c04 VtaCTabla.Libre_l05 
&Scoped-define ENABLED-TABLES VtaCTabla
&Scoped-define FIRST-ENABLED-TABLE VtaCTabla
&Scoped-Define ENABLED-OBJECTS RECT-2 
&Scoped-Define DISPLAYED-FIELDS VtaCTabla.Libre_c04 VtaCTabla.Libre_l05 
...
DEFINE FRAME F-Main
     VtaCTabla.Libre_c04 AT ROW 1.19 COL 2.86 WIDGET-ID 2
          LABEL "Operador" FORMAT "x(8)"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "AND","OR" 
          DROP-DOWN-LIST
          SIZE 8 BY 1
     VtaCTabla.Libre_l05 AT ROW 2.35 COL 6 HELP
          "" WIDGET-ID 6
          LABEL "ALEATORIO"
          VIEW-AS TOGGLE-BOX
          SIZE 14 BY .77
...
/* SETTINGS FOR COMBO-BOX VtaCTabla.Libre_c04 IN FRAME F-Main
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL VtaCTabla.Libre_c04 V-table-Win
ON VALUE-CHANGED OF VtaCTabla.Libre_c04 IN FRAME F-Main /* Operador */
DO:
  IF SELF:SCREEN-VALUE = "AND" THEN VtaCTabla.Libre_l05:SCREEN-VALUE = "NO".
END.
...
------------------------------------------------------------------------------*/
  ...
  IF VtaCTabla.Libre_c04 = "AND" THEN VtaCTabla.Libre_l05 = NO.
  RUN lib/logtabla ('vtactabla',
                    VtaCTabla.Tabla + ',' + VtaCTabla.Llave + ',' + 
                    'PROMOCION' + ',' + VtaCTabla.Libre_c04,
                    'WRITE').
