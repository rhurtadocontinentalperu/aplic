...
T-MATG.TpoCmb T-MATG.DesMar T-MATG.CtoTot T-MATG.Prevta[1] T-MATG.Prevta[2] ~
T-MATG.Prevta[3] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.DesMat FORMAT "X(60)":U WIDTH 57.43
      T-MATG.UndBas COLUMN-LABEL "Unidad" FORMAT "X(6)":U WIDTH 3.86
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon COLUMN-LABEL "Moneda" FORMAT "x(3)":U
      T-MATG.TpoCmb COLUMN-LABEL "TC" FORMAT "Z9.9999":U
      T-MATG.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U WIDTH 15.29
      T-MATG.CtoTot COLUMN-LABEL "Costo Total!S/." FORMAT ">>>>,>>9.9999":U
            WIDTH 10.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      T-MATG.Prevta[1] COLUMN-LABEL "Precio Lista! #1 S/." FORMAT ">>,>>>,>>9.9999":U
            WIDTH 9.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      T-MATG.Prevta[2] COLUMN-LABEL "Precio Lista! #2 S/." FORMAT ">>>,>>9.9999":U
            WIDTH 9.14 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      T-MATG.Prevta[3] COLUMN-LABEL "Precio Lista! #3 S/." FORMAT ">>>,>>9.9999":U
            WIDTH 7 COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 13
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 140 BY 16.35
         FONT 4
         TITLE "LISTA DE PRECIOS DE TERCEROS" FIT-LAST-COLUMN.
...
"T-MATG.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "57.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-MATG.UndBas
"T-MATG.UndBas" "Unidad" "X(6)" "character" ? ? ? ? ? ? no ? no no "3.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no "15.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-MATG.CtoTot
"T-MATG.CtoTot" "Costo Total!S/." ">>>>,>>9.9999" "decimal" 14 0 ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.Prevta[1]
"T-MATG.Prevta[1]" "Precio Lista! #1 S/." ? "decimal" 14 0 ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATG.Prevta[2]
"T-MATG.Prevta[2]" "Precio Lista! #2 S/." ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.Prevta[3]
"T-MATG.Prevta[3]" "Precio Lista! #3 S/." ">>>,>>9.9999" "decimal" 13 15 ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* LISTA DE PRECIOS DE TERCEROS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* LISTA DE PRECIOS DE TERCEROS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* LISTA DE PRECIOS DE TERCEROS */
DO:
