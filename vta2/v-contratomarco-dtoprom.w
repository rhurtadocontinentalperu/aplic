...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Almmmatp Almmmatg
&Scoped-define FIRST-EXTERNAL-TABLE Almmmatp


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Almmmatp, Almmmatg.
...
almmmatp.PromDivi[9] almmmatp.PromFchD[9] almmmatp.PromFchH[9] ~
almmmatp.PromDto[9] almmmatp.PromDivi[10] almmmatp.PromFchD[10] ~
almmmatp.PromFchH[10] almmmatp.PromDto[10] almmmatp.codmat Almmmatg.UndBas ~
Almmmatg.DesMat 
&Scoped-define DISPLAYED-TABLES almmmatp Almmmatg
...
DEFINE FRAME F-Main
     ...
     Almmmatg.UndBas AT ROW 1.46 COL 19 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 7 BY .69
     Almmmatg.DesMat AT ROW 2.35 COL 3 NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 51.14 BY .69
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: integral.Almmmatp,INTEGRAL.Almmmatg
...
/*                ? @ Almmmatp.PromFchH[10]. */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-10 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[10]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-10.
 ...
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-1 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[1]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-1.
...
/*                ? @ Almmmatp.PromFchH[2].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-2 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[2]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-2.
...
/*                ? @ Almmmatp.PromFchH[3].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-3 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[3]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-3.
...
/*                ? @ Almmmatp.PromFchH[4].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-4 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[4]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-4.
...
/*                                          */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-5 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[5]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-5.
...
/*                ? @ Almmmatp.PromFchH[6].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-6 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[6]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-6.
...
/*                ? @ Almmmatp.PromFchH[7].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-7 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[7]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-7.
...
/*        RETURN.                           */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-8 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[8]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-8.
...
/*                ? @ Almmmatp.PromFchH[9].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-9 = ROUND(F-PRECIO * ( 1 - ( DECI(Almmmatp.PromDto[9]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-9.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Almmmatp THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     F-PRECIO-1 = IF Almmmatp.PromDivi[1] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[1] / 100 ) ),4) ELSE 0.     
     F-PRECIO-2 = IF Almmmatp.PromDivi[2] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[2] / 100 ) ),4) ELSE 0.
     F-PRECIO-3 = IF Almmmatp.PromDivi[3] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[3] / 100 ) ),4) ELSE 0.
     F-PRECIO-4 = IF Almmmatp.PromDivi[4] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[4] / 100 ) ),4) ELSE 0.
     F-PRECIO-5 = IF Almmmatp.PromDivi[5] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[5] / 100 ) ),4) ELSE 0.
     F-PRECIO-6 = IF Almmmatp.PromDivi[6] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[6] / 100 ) ),4) ELSE 0.
     F-PRECIO-7 = IF Almmmatp.PromDivi[7] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[7] / 100 ) ),4) ELSE 0.
     F-PRECIO-8 = IF Almmmatp.PromDivi[8] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[8] / 100 ) ),4) ELSE 0.
     F-PRECIO-9 = IF Almmmatp.PromDivi[9] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[9] / 100 ) ),4) ELSE 0.
     F-PRECIO-10 = IF Almmmatp.PromDivi[10] <> "" THEN ROUND(F-PRECIO * ( 1 - ( Almmmatp.PromDto[10] / 100 ) ),4) ELSE 0.
