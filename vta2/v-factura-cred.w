...
CcbCDocu.CodPed CcbCDocu.CodRef CcbCDocu.NroRef CcbCDocu.Glosa ~
CcbCDocu.Libre_c01 CcbCDocu.Libre_c02 
&Scoped-define ENABLED-TABLES CcbCDocu
&Scoped-define FIRST-ENABLED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.FchDoc CcbCDocu.NroDoc ~
CcbCDocu.FchVto CcbCDocu.CodCli CcbCDocu.RucCli CcbCDocu.CodAnt ~
CcbCDocu.usuario CcbCDocu.NomCli CcbCDocu.NroOrd CcbCDocu.DirCli ~
CcbCDocu.CodMon CcbCDocu.NroCard CcbCDocu.TpoCmb CcbCDocu.CodVen ~
CcbCDocu.CodPed CcbCDocu.NroPed CcbCDocu.FmaPgo CcbCDocu.CodRef ~
CcbCDocu.NroRef CcbCDocu.Glosa CcbCDocu.Libre_c01 CcbCDocu.Libre_c02 ~
CcbCDocu.DivOri 
...
FILL-IN-DivOri FILL-IN-estado-doc 
...
DEFINE VARIABLE FILL-IN-estado-doc AS CHARACTER FORMAT "X(25)":U 
      VIEW-AS TEXT 
     SIZE 27 BY .62
...
DEFINE FRAME F-Main
     CcbCDocu.FchDoc AT ROW 1 COL 99 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.NroDoc AT ROW 1.04 COL 15.86 COLON-ALIGNED FORMAT "XXX-XXXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          FONT 1
     F-Estado AT ROW 1.04 COL 36.14 COLON-ALIGNED
     CcbCDocu.FchVto AT ROW 1.81 COL 99 COLON-ALIGNED
          LABEL "Fecha Vencimiento"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.CodCli AT ROW 1.88 COL 15.86 COLON-ALIGNED FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.RucCli AT ROW 1.88 COL 38 COLON-ALIGNED FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     CcbCDocu.CodAnt AT ROW 1.88 COL 59.43 COLON-ALIGNED WIDGET-ID 16
     ...
     CcbCDocu.usuario AT ROW 2.62 COL 99 COLON-ALIGNED WIDGET-ID 18
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.NomCli AT ROW 2.69 COL 15.86 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
     CcbCDocu.NroOrd AT ROW 3.42 COL 99 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 17 BY .81
     CcbCDocu.DirCli AT ROW 3.5 COL 15.86 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
...
"US$", 2
          SIZE 10.72 BY .81
     CcbCDocu.NroCard AT ROW 4.31 COL 15.86 COLON-ALIGNED WIDGET-ID 28
          LABEL "Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     F-Nomtar AT ROW 4.31 COL 25.86 COLON-ALIGNED NO-LABEL WIDGET-ID 92
     CcbCDocu.TpoCmb AT ROW 5.04 COL 99 COLON-ALIGNED
          LABEL "T/ Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.CodVen AT ROW 5.12 COL 15.86 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-nOMvEN AT ROW 5.12 COL 21.86 COLON-ALIGNED NO-LABEL
     CcbCDocu.CodPed AT ROW 5.85 COL 99 COLON-ALIGNED WIDGET-ID 20
          LABEL "Pedido"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     CcbCDocu.NroPed AT ROW 5.85 COL 104 COLON-ALIGNED NO-LABEL FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.FmaPgo AT ROW 5.92 COL 15.86 COLON-ALIGNED
          LABEL "Condición de Venta"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-CndVta AT ROW 5.92 COL 21.86 COLON-ALIGNED NO-LABEL
     CcbCDocu.CodRef AT ROW 6.65 COL 99 COLON-ALIGNED WIDGET-ID 22
          LABEL "Guia de Remisión"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     CcbCDocu.NroRef AT ROW 6.65 COL 104 COLON-ALIGNED NO-LABEL WIDGET-ID 24 FORMAT "XXX-XXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.Glosa AT ROW 6.73 COL 15.86 COLON-ALIGNED
          LABEL "Glosa"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
     CcbCDocu.Libre_c01 AT ROW 7.46 COL 99 COLON-ALIGNED WIDGET-ID 98
...
DEFINE FRAME F-Main
     CcbCDocu.Libre_c02 AT ROW 7.46 COL 104 COLON-ALIGNED NO-LABEL WIDGET-ID 100 FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.DivOri AT ROW 7.54 COL 15.86 COLON-ALIGNED WIDGET-ID 94
          LABEL "División Origen"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 8 FGCOLOR 0 
     FILL-IN-DivOri AT ROW 7.54 COL 25.86 COLON-ALIGNED NO-LABEL WIDGET-ID 96
     FILL-IN-estado-doc AT ROW 1.12 COL 57.72 COLON-ALIGNED NO-LABEL WIDGET-ID 102
     "Moneda:" VIEW-AS TEXT
...
/* SETTINGS FOR FILL-IN FILL-IN-DivOri IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-estado-doc IN FRAME F-Main
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE delete-record-old V-table-Win 
PROCEDURE delete-record-old :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  DEFINE VAR x-cod-estado-doc AS CHAR.
  ...
  IF s-Sunat-Activo = YES THEN DO:
      ...
      RUN gn/p-estado-documento-electronico.r(INPUT CcbCDocu.CodDoc,
                          INPUT CcbCDocu.NroDoc,
                          INPUT CcbCDocu.CodDiv,
                          OUTPUT x-estado-bizlinks,
                          OUTPUT x-estado-sunat,
                          OUTPUT x-estado-doc).
      IF NUM-ENTRIES(x-estado-sunat,"|") > 0  THEN DO:
        x-cod-estado-doc = CAPS(ENTRY(1,x-estado-sunat,"|")).
      END.
        /*
      ...
      */
      ...
      IF NOT CAN-FIND(FeLogComprobantes WHERE FELogComprobantes.CodCia = Ccbcdocu.codcia
          ...
          THEN DO:
      */
      IF x-cod-estado-doc <> "RC_05" THEN DO:
          IF x-es-masivo = NO THEN DO:
  ...
  /* En caso de SERVICIOS no pasa por ahi */
  ...
  IF x-cod-estado-doc <> "RC_05" THEN DO:
      /* Para documentos rechazados por SUNAT - procede la anulacion */
      ...
      IF LOOKUP(Ccbcdocu.FmaPgo, "899,900") = 0 THEN DO:          /* NO TRANSFERENCIA GRATUITA */
          ...
          IF Ccbcdocu.coddoc = "FAC" AND CCbcdocu.nrodoc = "26800042089" THEN DO:
              /* Daniel Llican pidio 04Feb2022, lo ejecuto Luis Urbano desde mi PC via AnyDesk */
          END.
          ELSE DO:
  ...
  CASE TRUE:
      WHEN Ccbcdocu.CodRef = "FAI" AND Ccbcdocu.NroRef > '' THEN DO:
          ...
          END.
      END.
      WHEN Ccbcdocu.CodRef = "FAI" AND (TRUE <> (Ccbcdocu.NroRef > '')) THEN DO:
          x-FAIs = ''.
          x-Lista = Ccbcdocu.coddoc + ' ' + Ccbcdocu.nrodoc.    /* Valor por defecto */
          FOR EACH B-CDOCU NO-LOCK WHERE B-CDOCU.CodCia = s-CodCia AND
              B-CDOCU.CodDoc = "FAI" AND
              B-CDOCU.CodCli = Ccbcdocu.CodCli AND
              B-CDOCU.FlgEst = "C" AND
              B-CDOCU.Libre_c03 = Ccbcdocu.CodDoc AND
              B-CDOCU.Libre_c04 = Ccbcdocu.NroDoc:
              x-FAIs = x-FAIs + (IF TRUE <> (x-FAIs > '') THEN '' ELSE '|') + B-CDOCU.NroDoc.
          END.
          MESSAGE 'Continuamos con la anulación?' SKIP
              x-FAIs 
              VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO 
              TITLE 'Se van a anular los siguientes FAIs'
              UPDATE rptafai AS LOG.
          IF rptafai = NO THEN RETURN 'ADM-ERROR'.
      END.
      OTHERWISE DO:
          x-FAIs = "".
          x-Lista = Ccbcdocu.coddoc + ' ' + Ccbcdocu.nrodoc.    /* Valor por defecto */
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN 'ADM-ERROR':
     ...
     RUN ML_Extorna-FAC-Control IN hMaster (INPUT ROWID(B-CDOCU),     /* FAC */
                                            OUTPUT pMensaje).
     IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO, RETURN 'ADM-ERROR'.
     /* *********************************************************************** */
     /* RHC 14/10/2020 CONTROL MR: Control de kardex FIFO */
     /* *********************************************************************** */
     RUN ML_Extorna-Fifo-Control IN hMaster (INPUT ROWID(B-CDOCU),     /* FAC */
                                            OUTPUT pMensaje).
     IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO, RETURN 'ADM-ERROR'.
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'ADM-ERROR' THEN MESSAGE pMensaje VIEW-AS ALERT-BOX ERROR.
    ELSE MESSAGE 'La ANULACION se culminó con éxito' VIEW-AS ALERT-BOX INFORMATION.
  RUN dispatch IN THIS-PROCEDURE ('display-fields':U).
  RUN Procesa-Handle IN lh_Handle ('Browse').
  RETURN 'OK'.
  /* ******************************************************************** */
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbCDocu THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     IF AVAILABLE gn-convt THEN F-CndVta:SCREEN-VALUE = gn-convt.Nombr.
      ...
      fill-in-estado-doc:SCREEN-VALUE IN FRAME {&FRAME-NAME} =  x-estado-doc.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  /* Solicitamos formato de impresión */
