...
FIND faccpedi WHERE ROWID(faccpedi) = s-Rowid NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI.UndVta COLUMN-LABEL "Unidad" FORMAT "XXXX":U WIDTH 5.43
      PEDI.CanPed COLUMN-LABEL "Saldo Pendiente" FORMAT ">,>>>,>>9.9999":U
            WIDTH 12.43
      PEDI.canate COLUMN-LABEL "Saldo por Facturar" FORMAT ">,>>>,>>9.9999":U
            WIDTH 10.72
  ENABLE
      PEDI.canate
/* _UIB-CODE-BLOCK-END */
...
"PEDI.CanPed" "Saldo Pendiente" ? "decimal" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.PEDI.canate
"PEDI.canate" "Saldo por Facturar" ? "decimal" ? ? ? ? ? ? yes ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH PEDI-1 WHERE PEDI-1.CanPed - PEDI-1.CanAte > 0:
      CREATE PEDI.
      BUFFER-COPY PEDI-1 TO PEDI
          ASSIGN 
            PEDI.canped = PEDI-1.canped - PEDI-1.canate
            PEDI.canate = PEDI-1.canped - PEDI-1.canate.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF DECIMAL (PEDI.canate:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
