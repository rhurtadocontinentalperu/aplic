...
txtTTrans TOGGLE-1 FILL-IN-Embalado x-NroItem FILL-IN-Bultos 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Embalado AT ROW 6.12 COL 74 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     BUTTON-15 AT ROW 1 COL 84 WIDGET-ID 8
     x-NroItem AT ROW 2.35 COL 90 COLON-ALIGNED WIDGET-ID 10
     ...
     RECT-66 AT ROW 3.96 COL 1 WIDGET-ID 22
     SPACE(20.29) SKIP(0.00)
...
/*         RETURN 'ADM-ERROR'.                                      */
  ...
  IF l-Error = YES THEN DO:
      MESSAGE 'NO se han registrado los siguientes artículos:' SKIP l-Mensaje
          VIEW-AS ALERT-BOX ERROR.
      RETURN 'ADM-ERROR'.
  END.
  /* Usuario de Chequeo */
  ...
  IF AVAILABLE x-Faccpedi AND x-faccpedi.empaqesp = YES THEN DO:
      RUN logis/d-rollos-film.r (OUTPUT pMetros, OUTPUT pOk).
