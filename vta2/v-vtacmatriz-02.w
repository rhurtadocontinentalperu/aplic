...
DEFINE FRAME F-Main
     VtaCMatriz.LabelColumna[1] AT ROW 1.38 COL 78 NO-LABEL WIDGET-ID 18
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     VtaCMatriz.LabelColumna[2] AT ROW 1.38 COL 84 COLON-ALIGNED NO-LABEL WIDGET-ID 20
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     VtaCMatriz.LabelColumna[3] AT ROW 1.38 COL 92 COLON-ALIGNED NO-LABEL WIDGET-ID 22
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     VtaCMatriz.LabelColumna[4] AT ROW 1.38 COL 99 COLON-ALIGNED NO-LABEL WIDGET-ID 24
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     VtaCMatriz.LabelColumna[5] AT ROW 1.38 COL 107 COLON-ALIGNED NO-LABEL WIDGET-ID 26
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     VtaCMatriz.LabelColumna[6] AT ROW 1.38 COL 114 COLON-ALIGNED NO-LABEL WIDGET-ID 28
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 12 FGCOLOR 15 
     "ETIQUETAS DE COLUMNAS =>" VIEW-AS TEXT
          SIZE 23 BY .5 AT ROW 1.58 COL 54 WIDGET-ID 40
