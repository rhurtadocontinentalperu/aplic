...
&Scoped-define FIELDS-IN-QUERY-br_table PEDI-1.codmat Almmmatg.DesMat ~
Almmmatg.DesMar PEDI-1.UndVta PEDI-1.CanPed PEDI-1.canate 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI-1.UndVta COLUMN-LABEL "Unidad" FORMAT "XXXX":U
      PEDI-1.CanPed COLUMN-LABEL "Cantidad!Pedida" FORMAT ">,>>>,>>9.99":U
      PEDI-1.canate COLUMN-LABEL "Cantidad!Atendida" FORMAT ">,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > Temp-Tables.PEDI-1.codmat
...
"PEDI-1.UndVta" "Unidad" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.PEDI-1.CanPed
"PEDI-1.CanPed" "Cantidad!Pedida" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.PEDI-1.canate
"PEDI-1.canate" "Cantidad!Atendida" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
