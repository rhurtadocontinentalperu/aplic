...
DEF INPUT-OUTPUT PARAMETER x-divisiones AS CHAR.
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH GN-DIVI NO-LOCK ~
    BY GN-DIVI.CodDiv INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH GN-DIVI NO-LOCK ~
    BY GN-DIVI.CodDiv INDEXED-REPOSITION.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 D-Dialog _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      GN-DIVI.CodDiv FORMAT "x(5)":U WIDTH 8.43
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 39.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS MULTIPLE SIZE 52 BY 18.08
...
DEFINE FRAME D-Dialog
     BROWSE-1 AT ROW 2.15 COL 5
     Btn_OK AT ROW 2.54 COL 62
     Btn_Cancel AT ROW 3.73 COL 62
     BUTTON-1 AT ROW 9.54 COL 57 WIDGET-ID 2
     BUTTON-2 AT ROW 10.69 COL 57 WIDGET-ID 4
     SPACE(2.00) SKIP(8.72)
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _OrdList          = "INTEGRAL.GN-DIVI.CodDiv|yes"
     _FldNameList[1]   > INTEGRAL.GN-DIVI.CodDiv
"CodDiv" ? "x(5)" "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.GN-DIVI.DesDiv
"DesDiv" ? ? "character" ? ? ? ? ? ? no ? no no "39.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
