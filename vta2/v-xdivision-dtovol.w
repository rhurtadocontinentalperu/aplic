...
F-PRECIO-18 F-PRECIO-9 F-PRECIO-19 F-PRECIO-20 F-PRECIO-10 
...
DEFINE FRAME F-Main
     ...
     F-PRECIO-11 AT ROW 4.23 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     ...
     F-PRECIO-12 AT ROW 5.04 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     ...
     F-PRECIO-13 AT ROW 5.85 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     ...
     F-PRECIO-14 AT ROW 6.65 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     ...
     F-PRECIO-15 AT ROW 7.46 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     ...
     F-PRECIO-16 AT ROW 8.27 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     ...
     F-PRECIO-17 AT ROW 9.08 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 22
...
DEFINE FRAME F-Main
     ...
     F-PRECIO-18 AT ROW 9.88 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     ...
     F-PRECIO-19 AT ROW 10.69 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     F-PRECIO-20 AT ROW 11.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 28
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-10.
    F-PRECIO-20 = fPreVta(F-PRECIO-10,2).
    DISPLAY F-PRECIO-20.
 END.
END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-1  .
    F-PRECIO-11 = fPreVta(F-PRECIO-1,2).
    DISPLAY F-PRECIO-11.
 END.
END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-2  .
    F-PRECIO-12 = fPreVta(F-PRECIO-2,2).
    DISPLAY F-PRECIO-12.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-3  .
    F-PRECIO-13 = fPreVta(F-PRECIO-3,2).
    DISPLAY F-PRECIO-13.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-4  .
    F-PRECIO-14 = fPreVta(F-PRECIO-4,2).
    DISPLAY F-PRECIO-14.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-5  .
    F-PRECIO-15 = fPreVta(F-PRECIO-5,2).
    DISPLAY F-PRECIO-15.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-6  .
    F-PRECIO-16 = fPreVta(F-PRECIO-6,2).
    DISPLAY F-PRECIO-16.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-7  .
    F-PRECIO-17 = fPreVta(F-PRECIO-7,2).
    DISPLAY F-PRECIO-17.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-8  .
    F-PRECIO-18 = fPreVta(F-PRECIO-8,2).
    DISPLAY F-PRECIO-18.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    DISPLAY F-PRECIO-9  .
    F-PRECIO-19 = fPreVta(F-PRECIO-9,2).
    DISPLAY F-PRECIO-19.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[10]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[3]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[4]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[5]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[6]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[7]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[8]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(VtaListaMay.DtoVolR[9]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    VtaListaMay.DtoVolD[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE VtaListaMay THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     F-PRECIO-1 = IF VtaListaMay.DtoVolR[1] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[1] / 100 ) ),4) ELSE 0.     
     F-PRECIO-2 = IF VtaListaMay.DtoVolR[2] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[2] / 100 ) ),4) ELSE 0.
     F-PRECIO-3 = IF VtaListaMay.DtoVolR[3] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[3] / 100 ) ),4) ELSE 0.
     F-PRECIO-4 = IF VtaListaMay.DtoVolR[4] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[4] / 100 ) ),4) ELSE 0.
     F-PRECIO-5 = IF VtaListaMay.DtoVolR[5] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[5] / 100 ) ),4) ELSE 0.
     F-PRECIO-6 = IF VtaListaMay.DtoVolR[6] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[6] / 100 ) ),4) ELSE 0.
     F-PRECIO-7 = IF VtaListaMay.DtoVolR[7] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[7] / 100 ) ),4) ELSE 0.
     F-PRECIO-8 = IF VtaListaMay.DtoVolR[8] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[8] / 100 ) ),4) ELSE 0.
     F-PRECIO-9 = IF VtaListaMay.DtoVolR[9] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[9] / 100 ) ),4) ELSE 0.
     F-PRECIO-10 = IF VtaListaMay.DtoVolR[10] <> 0 THEN ROUND(F-PRECIO * ( 1 - ( VtaListaMay.DtoVolD[10] / 100 ) ),4) ELSE 0.
...
DO WITH FRAME {&FRAME-NAME} :
    ASSIGN
        x-DtoVolP[01] = DECIMAL (f-Precio-1:SCREEN-VALUE)
        x-DtoVolP[02] = DECIMAL (f-Precio-2:SCREEN-VALUE)
        x-DtoVolP[03] = DECIMAL (f-Precio-3:SCREEN-VALUE)
        x-DtoVolP[04] = DECIMAL (f-Precio-4:SCREEN-VALUE)
        x-DtoVolP[05] = DECIMAL (f-Precio-5:SCREEN-VALUE)
        x-DtoVolP[06] = DECIMAL (f-Precio-6:SCREEN-VALUE)
        x-DtoVolP[07] = DECIMAL (f-Precio-7:SCREEN-VALUE)
        x-DtoVolP[08] = DECIMAL (f-Precio-8:SCREEN-VALUE)
        x-DtoVolP[09] = DECIMAL (f-Precio-9:SCREEN-VALUE)
        x-DtoVolP[10] = DECIMAL (f-Precio-10:SCREEN-VALUE)
        .
    DO x-Orden = 1 TO 10:
        IF INPUT VtaListaMay.DtoVolR[x-Orden] <= 0 THEN NEXT.
        IF x-ValorAnterior = 0 THEN x-ValorAnterior = VtaListaMay.DtoVolR[x-Orden].
