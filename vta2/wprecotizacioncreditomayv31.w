...
/*------------------------------------------------------------------------
  ...
  History: Nueva version para Setiembre del 2016
...
DEFINE VARIABLE h_tprecotizacioncreditomayv3 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vprecotizacioncreditomay AS HANDLE NO-UNDO.
...
DO:
    RUN Asigna-Cotizacion IN h_vprecotizacioncreditomay.  
...
DO:
  /*RUN Asigna-PrePedido IN h_vprecotizacioncreditomay.*/

  RUN tomar-pedido-tablet IN h_vprecotizacioncreditomay.
  IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
  RUN dispatch IN h_tprecotizacioncreditomayv3 ('open-query':U).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vprecotizacioncreditomayv31.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vprecotizacioncreditomay ).
       RUN set-position IN h_vprecotizacioncreditomay ( 2.92 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_vprecotizacioncreditomay. */
       RUN add-link IN adm-broker-hdl ( h_p-updv06 , 'TableIO':U , h_vprecotizacioncreditomay ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido2x , 'Record':U , h_vprecotizacioncreditomay ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv06 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_vprecotizacioncreditomay ,
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/tprecotizacioncreditomayv3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tprecotizacioncreditomayv3 ).
       RUN set-position IN h_tprecotizacioncreditomayv3 ( 11.96 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tprecotizacioncreditomayv3 ( 11.08 , 131.43 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_tprecotizacioncreditomayv3 ,
             BUTTON-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 2 */
...
CASE L-Handle:
    WHEN "browse" THEN DO:
          IF h_b-cotexp-2-1 <> ? THEN RUN dispatch IN h_b-cotexp-2-1 ('open-query':U).
          IF h_tprecotizacioncreditomayv3 <> ? THEN RUN dispatch IN h_tprecotizacioncreditomayv3 ('open-query':U).
      END.
    ...
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
        RUN Recalcular-Precios IN h_vprecotizacioncreditomay.
      END.
