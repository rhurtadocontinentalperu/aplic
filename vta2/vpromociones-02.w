...
DEFINE FRAME F-Main
     VtaCTabla.Libre_c03 AT ROW 1.19 COL 3.86 WIDGET-ID 2
...
/* SETTINGS FOR COMBO-BOX VtaCTabla.Libre_c03 IN FRAME F-Main
...
------------------------------------------------------------------------------*/
  ...
  RUN lib/logtabla ('vtactabla',
                    ...
                    'PROVEEDORES' + ',' + VtaCTabla.Libre_c03,
                    'WRITE').
