...
DEFINE VARIABLE h_v-factura-cred-ade AS HANDLE NO-UNDO.
...
CASE s-TpoFac:
    ...
    WHEN "V" THEN W-Win:TITLE = W-Win:TITLE + "- VENTA ANYICIPADA".
END CASE.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-factura-cred-ade ).
       RUN set-position IN h_v-factura-cred-ade ( 2.85 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-factura-cred-ade. */
       RUN add-link IN adm-broker-hdl ( h_p-updv13 , 'TableIO':U , h_v-factura-cred-ade ).
       RUN add-link IN adm-broker-hdl ( h_q-docmto , 'Record':U , h_v-factura-cred-ade ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-factura-cred-ade ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-docmto ,
             h_v-factura-cred-ade , 'AFTER':U ).
    END. /* Page 0 */
