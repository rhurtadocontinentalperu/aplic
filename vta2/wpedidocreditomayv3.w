...
DEFINE VARIABLE h_vpedidocreditomayv3 AS HANDLE NO-UNDO.
...
DO:
   RUN Asigna-datos IN h_vpedidocreditomayv3.
END.
...
DO:
  ...
  RUN Excel IN h_vpedidocreditomayv3.
...
DO:
  RUN Margen IN h_vpedidocreditomayv3.
END.
...
DO:
  RUN Despachar-Pedido IN h_vpedidocreditomayv3.
END.
...
DO:
  ...
  RETURN NO-APPLY.
  RUN Redondeo IN h_vpedidocreditomayv3.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vpedidocreditomayv3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vpedidocreditomayv3 ).
       RUN set-position IN h_vpedidocreditomayv3 ( 2.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.69 , 122.00 ) */
       ...
       /* Links to SmartViewer h_vpedidocreditomayv3. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_vpedidocreditomayv3 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_vpedidocreditomayv3 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_vpedidocreditomayv3 ,
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_t-pedido-cred-2 ( 12.58 , 2.00 ) NO-ERROR.
...
CASE L-Handle:
 ...
 WHEN "Disable-Head" THEN DO:
     ...
     RUN dispatch IN h_vpedidocreditomayv3 ('disable-fields').
   END.
 WHEN "Enable-Head" THEN DO:
     RUN dispatch IN h_p-updv04 ('enable':U).
     RUN dispatch IN h_vpedidocreditomayv3 ('enable-fields').
   END.
END CASE.
