...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tt-w-report.Campo-C[1] COLUMN-LABEL "Campaña" FORMAT "X(6)":U
            WIDTH 7.29
...
"tt-w-report.Campo-C[1]" "Campaña" "X(6)" "character" ? ? ? ? ? ? yes ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF tt-w-report.Campo-C[1] IN BROWSE br_table /* Campaña */
DO:
    ...
    FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia AND 
                                vtatabla.tabla = "CAMPAÑAS" AND
                                vtatabla.llave_c1 = x-campana NO-LOCK NO-ERROR.
    IF NOT AVAILABLE vtatabla THEN DO:
        MESSAGE "Codigo de campaña no existe" VIEW-AS ALERT-BOX INFORMATION.
        RETURN "ADM-ERROR".    
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-w-report.Campo-C[1] br_table _BROWSE-COLUMN B-table-Win
ON LEFT-MOUSE-DBLCLICK OF tt-w-report.Campo-C[1] IN BROWSE br_table /* Campaña */
DO:
 /*
  ASSIGN
    input-var-1 = ?
...
------------------------------------------------------------------------------*/
    ...
    MESSAGE 'Seguro de GRABAR las CAMPAÑAS ?' VIEW-AS ALERT-BOX QUESTION
...
IF TRUE <> (x-campana > "")  THEN DO:
    MESSAGE "Ingrese la Campaña" VIEW-AS ALERT-BOX INFORMATION.
    RETURN "ADM-ERROR".    
END.
...
IF AVAILABLE xtt-w-report THEN DO:
    MESSAGE "Codigo de campaña ya esta registrado" VIEW-AS ALERT-BOX INFORMATION.
    RETURN "ADM-ERROR".    
END.
