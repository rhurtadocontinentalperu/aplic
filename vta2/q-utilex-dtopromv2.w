...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almmmatg WHERE ~{&KEY-PHRASE} ~
      AND Almmmatg.CodCia = S-CODCIA ~
 AND Almmmatg.codmat = S-CODMAT NO-LOCK, ~
      FIRST VtaListaMinGn OF Almmmatg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almmmatg WHERE ~{&KEY-PHRASE} ~
      AND Almmmatg.CodCia = S-CODCIA ~
 AND Almmmatg.codmat = S-CODMAT NO-LOCK, ~
      FIRST VtaListaMinGn OF Almmmatg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Almmmatg VtaListaMinGn
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Almmmatg
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main VtaListaMinGn
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND integral.Almmmatg.codmat = S-CODMAT"
