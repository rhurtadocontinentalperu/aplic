...
&Scoped-Define ENABLED-FIELDS FacCPedi.fchven FacCPedi.ordcmp ~
FacCPedi.CodCli FacCPedi.NomCli FacCPedi.FlgSit FacCPedi.Cmpbnte ~
FacCPedi.DirCli FacCPedi.FlgIgv FacCPedi.RucCli FacCPedi.Atencion ~
FacCPedi.CodMon FacCPedi.LugEnt FacCPedi.TpoCmb FacCPedi.Glosa ~
FacCPedi.CodVen FacCPedi.Libre_c05 FacCPedi.Ubigeo[3] FacCPedi.FmaPgo ~
FacCPedi.Libre_c03 FacCPedi.NroCard FacCPedi.NroRef FacCPedi.Libre_c04 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.FchPed ~
FacCPedi.fchven FacCPedi.ordcmp FacCPedi.CodCli FacCPedi.NomCli ~
FacCPedi.FlgSit FacCPedi.Cmpbnte FacCPedi.DirCli FacCPedi.FlgIgv ~
FacCPedi.RucCli FacCPedi.Atencion FacCPedi.CodMon FacCPedi.LugEnt ~
FacCPedi.TpoCmb FacCPedi.Glosa FacCPedi.CodVen FacCPedi.Libre_c05 ~
FacCPedi.Ubigeo[3] FacCPedi.FmaPgo FacCPedi.Libre_c03 FacCPedi.NroCard ~
FacCPedi.NroRef FacCPedi.Libre_c04 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado COMBO-BOX-Proveedor F-nOMvEN ~
F-CndVta F-Nomtar FILL-IN-4 FILL-IN-5 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 71 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.fchven AT ROW 1 COL 91 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.ordcmp AT ROW 1 COL 118 COLON-ALIGNED WIDGET-ID 32
          LABEL "O/Compra"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.NomCli AT ROW 1.81 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 48 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgSit AT ROW 1.81 COL 88 NO-LABEL
...
"Cupón de Descuento", "CD":U
          SIZE 19 BY 3.27
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 1.81 COL 118 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
     ...
     FacCPedi.FlgIgv AT ROW 2.62 COL 120 NO-LABEL WIDGET-ID 28
...
"No", no
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 3.46 COL 120 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
     ...
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 4.23 COL 118 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Glosa AT ROW 5.04 COL 6.28
          ...
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     COMBO-BOX-Proveedor AT ROW 5.04 COL 86 COLON-ALIGNED WIDGET-ID 48
     FacCPedi.CodVen AT ROW 5.85 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-nOMvEN AT ROW 5.85 COL 15 COLON-ALIGNED NO-LABEL
     FacCPedi.Libre_c05 AT ROW 5.85 COL 86 COLON-ALIGNED WIDGET-ID 50 PASSWORD-FIELD 
...
DEFINE FRAME F-Main
     FacCPedi.Ubigeo[3] AT ROW 6.58 COL 86 COLON-ALIGNED WIDGET-ID 52
          LABEL "Cliente Asociado" FORMAT "x(60)"
          VIEW-AS COMBO-BOX INNER-LINES 20
          LIST-ITEM-PAIRS "Seleccione Cliente Asociado","Seleccione Cliente Asociado"
          DROP-DOWN-LIST
          SIZE 44 BY 1
     ...
     F-Nomtar AT ROW 7.35 COL 22 COLON-ALIGNED NO-LABEL
     FacCPedi.Libre_c03 AT ROW 7.35 COL 86 COLON-ALIGNED HELP
          "" WIDGET-ID 6
          LABEL "Banco" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-4 AT ROW 7.35 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     FacCPedi.NroCard AT ROW 7.46 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.NroRef AT ROW 8.15 COL 9 COLON-ALIGNED WIDGET-ID 10
          LABEL "Vitrinas" FORMAT "X(254)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 15 FGCOLOR 12 
     FacCPedi.Libre_c04 AT ROW 8.15 COL 86 COLON-ALIGNED WIDGET-ID 38
          LABEL "Tarjeta" FORMAT "x(2)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-5 AT ROW 8.15 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 2.62 COL 113 WIDGET-ID 26
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 3.65 COL 113
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 1.96 COL 78
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* SETTINGS FOR FILL-IN FacCPedi.TpoCmb IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX FacCPedi.Ubigeo[3] IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
...
/*             ENABLE  faccpedi.libre_c03 WITH FRAME {&FRAME-NAME}.  */
/*             ENABLE  faccpedi.libre_c04 WITH FRAME {&FRAME-NAME}.  */
/*             DISABLE faccpedi.libre_c05 WITH FRAME {&FRAME-NAME}.  */
/*         END.                                                      */
/*         WHEN "C" THEN DO:                                         */
/*             DISABLE COMBO-BOX-Proveedor WITH FRAME {&FRAME-NAME}. */
...
/*             DISABLE faccpedi.libre_c04 WITH FRAME {&FRAME-NAME}.                                                  */
/*             ENABLE faccpedi.libre_c05 WITH FRAME {&FRAME-NAME}.                                                   */
/*             faccpedi.libre_c05:LABEL IN FRAME {&FRAME-NAME} = "CUPON DE MUESTRA".                                 */
/*             FIND gn-prov WHERE gn-prov.codcia = pv-codcia AND gn-prov.codpro = '10003814'                         */
/*                 NO-LOCK NO-ERROR.                                                                                 */
/*             IF AVAILABLE gn-prov THEN COMBO-BOX-Proveedor:SCREEN-VALUE = gn-prov.codpro + ' - ' + gn-prov.nompro. */
/*             APPLY 'VALUE-CHANGED':U TO COMBO-BOX-Proveedor.                                                       */
...
&Scoped-define SELF-NAME FacCPedi.Libre_c03
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FacCPedi.Libre_c03 V-table-Win
ON LEAVE OF FacCPedi.Libre_c03 IN FRAME F-Main /* Banco */
DO:
    FIND cb-tabl WHERE
    ...
    ASSIGN s-codbko = SELF:SCREEN-VALUE .    
    RUN Procesa-Handle IN lh_Handle ('Recalculo').
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FacCPedi.Libre_c03 V-table-Win
ON LEFT-MOUSE-DBLCLICK OF FacCPedi.Libre_c03 IN FRAME F-Main /* Banco */
OR F8 OF Faccpedi.libre_c03 DO:
    ASSIGN
        input-var-1 = "04"
        input-var-2 = ""
        input-var-3 = ""
...
ON LEAVE OF FacCPedi.Libre_c04 IN FRAME F-Main /* Tarjeta */
DO:
    FIND FacTabla WHERE
        FacTabla.CodCia = s-codcia AND 
        FacTabla.Tabla = "TC" AND
        FacTabla.codigo = SELF:SCREEN-VALUE
        NO-LOCK NO-ERROR.
    IF AVAILABLE FacTabla 
    THEN FILL-IN-5:SCREEN-VALUE = FacTabla.Nombre.
    ELSE FILL-IN-5:SCREEN-VALUE = "".
    ASSIGN 
        s-Tarjeta = SELF:SCREEN-VALUE .    
    RUN Procesa-Handle IN lh_Handle ('Recalculo').
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FacCPedi.Libre_c04 V-table-Win
ON LEFT-MOUSE-DBLCLICK OF FacCPedi.Libre_c04 IN FRAME F-Main /* Tarjeta */
OR f8 OF FacCPedi.Libre_c04
DO:
    ASSIGN
        input-var-1 = "TC"
        input-var-2 = "2"
        input-var-3 = ""
        output-var-1 = ?.
    RUN lkup/c-vtatab ("Tarjetas").
    IF output-var-1 <> ? THEN DO:
        FIND Factabla WHERE ROWID(FacTabla) = output-var-1 NO-LOCK NO-ERROR.
        IF AVAILABLE Factabla THEN SELF:SCREEN-VALUE = FacTabla.Codigo.
    END.
...
DO:
  ...
  CASE TRUE:
      WHEN s-FlgSit = "KC" THEN DO:
          IF LOOKUP(SUBSTRING(SELF:SCREEN-VALUE,1,4), '0001,0002,0003,0004,0005') = 0 THEN DO:
      ...
      WHEN s-FlgSit = "CD" THEN DO:
          ...
          IF AVAILABLE Vtadtabla THEN DO:
               FacCPedi.Ubigeo[3]:DELETE(FacCPedi.Ubigeo[3]:LIST-ITEM-PAIRS).
               FacCPedi.Ubigeo[3]:ADD-LAST('Seleccione Cliente Asociado','Seleccione Cliente Asociado').
               FOR EACH  Vtadtabla NO-LOCK WHERE Vtadtabla.codcia = s-codcia
                   AND Vtadtabla.tabla = "UTILEX-ENCARTE"
                   AND Vtadtabla.llave = SELF:SCREEN-VALUE
                   AND Vtadtabla.tipo  = "CA":
                   FacCPedi.Ubigeo[3]:ADD-LAST(VtaDTabla.Libre_c01, VtaDTabla.LlaveDetalle).
               END.
               FacCPedi.Ubigeo[3]:SCREEN-VALUE = 'Seleccione Cliente Asociado'.
               FacCPedi.Ubigeo[3]:SENSITIVE = YES.
...
------------------------------------------------------------------------------*/
  ...
  RUN vta2/cancelar-pedido-minorista-v2 (ROWID(FacCPedi)).
...
/*       RUN vta2/utilex-promocion-final ("MOCHILA-NEW", INPUT-OUTPUT TABLE PEDI).    /* PUEDE COMPRAR PRODUCTOS PROMOCIONALES */ */
  ...
  RUN vta2/promocion-generalv2 (s-coddiv, INPUT-OUTPUT TABLE PEDI, OUTPUT pMensaje).
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ASSIGN
        ...
        FacCPedi.Ubigeo[3]:SENSITIVE = NO.

    RUN GET-ATTRIBUTE("ADM-NEW-RECORD").
    IF RETURN-VALUE = "NO" AND Faccpedi.FlgSit = "T" 
        THEN ASSIGN
    ...
    /* RHC 19/02/2015 CASO ESPECIAL: FERIA PLAZA NORTE UTILEX */
    IF s-CodDiv = '00509' THEN Faccpedi.FlgSit:SENSITIVE = NO.
  END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME} :
    ...
    IF LOOKUP (FacCPedi.FlgSit:SCREEN-VALUE, 'V,X,M,CD') > 0 AND FacCPedi.Atencion:SCREEN-VALUE = '' THEN DO:
        ...
        RETURN 'ADM-ERROR'.
    END.
    IF FacCPedi.FlgSit:SCREEN-VALUE = "T" THEN DO:
        IF Faccpedi.Libre_c03:SCREEN-VALUE = ''
            OR Faccpedi.Libre_c04:SCREEN-VALUE = '' THEN DO:
            MESSAGE "Debe ingresar la información del banco y la tarjeta"
                VIEW-AS ALERT-BOX ERROR.
        ...
        FIND cb-tabl WHERE
            cb-tabl.Tabla = "04" AND
            cb-tabl.codigo = Faccpedi.Libre_c03:SCREEN-VALUE
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE cb-tabl THEN DO:
            MESSAGE 'Código de banco no registrado' VIEW-AS ALERT-BOX ERROR.
            APPLY 'entry':u TO Faccpedi.Libre_c03.
            RETURN 'ADM-ERROR'.
        END.
        FIND FacTabla WHERE
            FacTabla.CodCia = s-codcia AND 
            FacTabla.Tabla = "TC" AND
            FacTabla.codigo = Faccpedi.Libre_c04:SCREEN-VALUE
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE Factabla THEN DO:
            MESSAGE 'Código de tarjeta no registrado' VIEW-AS ALERT-BOX ERROR.
    ...
    END.
    /* Tickets de compra */
    IF Faccpedi.FlgSit:SCREEN-VALUE = "K" THEN DO:
        IF COMBO-BOX-Proveedor:SCREEN-VALUE = '' THEN DO:
            MESSAGE 'Debe ingresar el proveedor de los tickets' VIEW-AS ALERT-BOX ERROR.
            APPLY 'entry' TO COMBO-BOX-Proveedor.
            RETURN 'ADM-ERROR'.
        END.
        FIND gn-prov WHERE gn-prov.codcia = pv-codcia
            AND gn-prov.codpro = ENTRY (1, COMBO-BOX-Proveedor:SCREEN-VALUE, ' - ')
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE gn-prov THEN DO:
            MESSAGE 'Proveedor de tickets no registrado' VIEW-AS ALERT-BOX ERROR.
            APPLY 'entry':u TO COMBO-BOX-Proveedor.
            RETURN 'ADM-ERROR'.
        END.
        FIND FIRST Vtactickets WHERE Vtactickets.codcia = s-codcia
            AND Vtactickets.codpro = gn-prov.codpro
            AND TODAY >= Vtactickets.fchini
            AND TODAY <= Vtactickets.fchfin
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE Vtactickets THEN DO:
            MESSAGE 'Tickets para este proveedor NO autorizados' VIEW-AS ALERT-BOX ERROR.
            APPLY 'entry':u TO COMBO-BOX-Proveedor.
            RETURN 'ADM-ERROR'.
        END.
    END.
    /* Cupón de Descuento */
    IF Faccpedi.FlgSit:SCREEN-VALUE = "C" THEN DO:
        IF INPUT FacCPedi.Libre_c05 <> '7750822004' THEN DO:
            MESSAGE 'Cupón de Descuento NO válido' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
            RETURN 'ADM-ERROR'.
        END.
    END.
    /* ENCARTE */
    IF Faccpedi.FlgSit:SCREEN-VALUE = "CD" THEN DO:
        ...
        END.
        /* RHC 20/01/2016 */
        IF FacCPedi.Ubigeo[3]:SENSITIVE = YES AND FacCPedi.Ubigeo[3]:SCREEN-VALUE BEGINS 'Seleccione Cliente' 
            THEN DO:
        ...
        END.
    END.
    IF Faccpedi.FlgSit:SCREEN-VALUE = "KC" THEN DO:
        IF s-CodPro = '10003814' AND 
            NOT (s-Nrovale BEGINS '0001' OR s-NroVale BEGINS '0002' OR 
                 s-NroVale BEGINS '0003' OR s-NroVale BEGINS '0004')
            THEN DO:
            MESSAGE 'Vale NO válido' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
            RETURN 'ADM-ERROR'.
        END.
    END.
