...
DEFINE FRAME F-Main2
     gn-clie.CodCli AT ROW 1.54 COL 12 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 13.86 BY .81
          FONT 4
     gn-clie.Libre_C01 AT ROW 1.54 COL 29 NO-LABEL WIDGET-ID 38
...
"Extranjera", "E":U
     ...
     gn-clie.Flgsit AT ROW 1.54 COL 58 NO-LABEL WIDGET-ID 54
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Activo", "A":U,
"Cesado", "C":U
...
"No", no
          SIZE 9.72 BY .77
     gn-clie.Ruc AT ROW 2.35 COL 12 COLON-ALIGNED WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 13.86 BY .81
     ...
     gn-clie.DNI AT ROW 3.15 COL 12 COLON-ALIGNED WIDGET-ID 52 FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 14 BY .81
          BGCOLOR 11 
     ...
     gn-clie.CodIBC AT ROW 3.15 COL 110 COLON-ALIGNED WIDGET-ID 170
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     gn-clie.ApePat AT ROW 3.96 COL 12 COLON-ALIGNED WIDGET-ID 8
          LABEL "Ap. Paterno"
          VIEW-AS FILL-IN 
          SIZE 27 BY .81
          BGCOLOR 11 FGCOLOR 7 
     gn-clie.ApeMat AT ROW 3.96 COL 50 COLON-ALIGNED WIDGET-ID 58
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
          BGCOLOR 11 FGCOLOR 7 
     gn-clie.Libre_F01 AT ROW 3.96 COL 110 COLON-ALIGNED WIDGET-ID 164
          ...
          SIZE 11 BY .81
          BGCOLOR 14 FGCOLOR 0 
     gn-clie.Nombre AT ROW 4.77 COL 12 COLON-ALIGNED WIDGET-ID 10
...
DEFINE FRAME F-Main2
     ...
     "Agente Retenedor:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 1.65 COL 77 WIDGET-ID 68
...
DO:
  ...
  SELF:SCREEN-VALUE = CAPS(TRIM(SELF:SCREEN-VALUE)).
    ...
    IF SUBSTRING(SELF:SCREEN-VALUE,1,2) = "10" OR SUBSTRING(SELF:SCREEN-VALUE,1,2) = "20" THEN DO:
