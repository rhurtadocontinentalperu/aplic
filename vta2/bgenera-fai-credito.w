...
&Scoped-define INTERNAL-TABLES FacCPedi FacDPedi GN-DIVI gn-ConVt
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
      ...
      WHERE GN-DIVI.flgrep = TRUE NO-LOCK, ~
      FIRST gn-ConVt WHERE gn-ConVt.Codig = FacCPedi.FmaPgo ~
      AND gn-ConVt.Libre_l01 = TRUE NO-LOCK ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
    ...
    BY FacCPedi.FchPed DESCENDING ~
       BY FacCPedi.NroPed DESCENDING.
&Scoped-define TABLES-IN-QUERY-br_table FacCPedi FacDPedi GN-DIVI gn-ConVt
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacCPedi,INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.GN-DIVI OF INTEGRAL.FacCPedi,INTEGRAL.gn-ConVt WHERE INTEGRAL.FacCPedi ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST, FIRST"
     _OrdList          = "INTEGRAL.FacCPedi.FchPed|no,INTEGRAL.FacCPedi.NroPed|no"
     _Where[1]         = "{&CONDICION}"
     _Where[3]         = "GN-DIVI.flgrep = TRUE"
     _JoinCode[4]      = "INTEGRAL.gn-ConVt.Codig = FacCPedi.FmaPgo"
     _Where[4]         = "gn-ConVt.Libre_l01 = TRUE"
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'FA' ).       /* AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    RUN vta2/d-genera-factura-cred-01v2 ( ROWID(FacCPedi), 'FM' ).       /* MANUAL */
