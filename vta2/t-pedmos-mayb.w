...
PEDI.Libre_d01 PEDI.PorDto PEDI.Por_Dsctos[1] PEDI.Por_Dsctos[2] ~
PEDI.Por_Dsctos[3] PEDI.PreUni PEDI.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 44.14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 147 BY 13.19
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 15.73 COL 19 NO-LABEL
     F-ImpExo AT ROW 15.73 COL 31 NO-LABEL
     F-ValVta AT ROW 15.73 COL 53.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 15.73 COL 65.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 15.73 COL 78.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 15.73 COL 91 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 15.77 COL 41 COLON-ALIGNED NO-LABEL
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 15.19 COL 56.86
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 15.15 COL 93.14
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 15.15 COL 31.43
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 15.15 COL 20.86
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 15.15 COL 83.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 15.15 COL 71.57
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 15.19 COL 43.57
     RECT-11 AT ROW 14.19 COL 1
...
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "44.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PEDI.AlmDes" "Alm.!Desp." ? "character" ? ? ? ? ? ? yes ? no no "5.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PEDI.Por_Dsctos[3]" "% Dscto!Vol Prom" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.PEDI.PreUni
...
------------------------------------------------------------------------------*/
  ...
  IF DECIMAL(PEDI.CanPed:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
       ...
       RETURN "ADM-ERROR".
  END.
  IF AVAILABLE PEDI AND PEDI.Libre_d01 > 0 AND
      DECIMAL(PEDI.CanPed:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) > PEDI.Libre_d01 THEN DO:
