...
DEFINE VARIABLE h_b-prepicking-tranfs AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW sW-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PRE-PICKING SALIDAS POR TRANSFERENCIAS"
         HEIGHT             = 17.04
         WIDTH              = 115
         MAX-HEIGHT         = 32.31
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF sW-Win /* PRE-PICKING SALIDAS POR TRANSFERENCIAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sW-Win sW-Win
ON WINDOW-CLOSE OF sW-Win /* PRE-PICKING SALIDAS POR TRANSFERENCIAS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_Done sW-Win
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-prepicking-tranfs.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prepicking-tranfs ).
       RUN set-position IN h_b-prepicking-tranfs ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-prepicking-tranfs ( 15.88 , 95.29 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 6.12 , 98.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 7.27 , 13.14 ) NO-ERROR.

       /* Links to SmartBrowser h_b-prepicking-tranfs. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-prepicking-tranfs ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-prepicking-tranfs ,
             Btn_Done:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_b-prepicking-tranfs , 'AFTER':U ).
    END. /* Page 0 */
