...
&Scoped-define INTERNAL-TABLES Almdmov Almmmatg Almmmate almtubic
...
Almmmatg.DesMar Almdmov.CanDes Almdmov.CodUnd Almdmov.CodAlm ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almdmov OF Almcmov WHERE ~{&KEY-PHRASE} NO-LOCK, ~
    ...
    BY Almmmate.CodUbi ~
       BY almtubic.CodZona ~
        BY Almdmov.codmat.
&Scoped-define TABLES-IN-QUERY-br_table Almdmov Almmmatg Almmmate almtubic
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmate.CodUbi FORMAT "x(8)":U WIDTH 7.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123 BY 11.35
         BGCOLOR 15 FONT 4
         TITLE BGCOLOR 15 "DETALLE DE LA TRANSFERENCIA" FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Almdmov OF INTEGRAL.Almcmov,INTEGRAL.Almmmatg OF INTEGRAL.Almdmov,INTEGRAL.Almmmate OF INTEGRAL.Almdmov,INTEGRAL.almtubic OF INTEGRAL.Almmmate"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST, FIRST OUTER"
     _OrdList          = "integral.Almmmate.CodUbi|yes,integral.almtubic.CodZona|yes,INTEGRAL.Almdmov.codmat|yes"
...
"Almmmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[6]   = INTEGRAL.Almdmov.CodAlm
...
"Almmmate.CodUbi" ? "x(8)" "character" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* DETALLE DE LA TRANSFERENCIA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* DETALLE DE LA TRANSFERENCIA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* DETALLE DE LA TRANSFERENCIA */
DO:
