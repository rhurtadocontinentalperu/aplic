...
T-MATG.Chr__01 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table T-MATG.CtoTot ~
T-MATG.Dec__01 T-MATG.PreOfi 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1 COLUMN-LABEL "Moneda" FORMAT "x(3)":U
...
"IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1" "Moneda" "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.CtoTot" "Costo MARCO!S/." ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.Dec__01
"T-MATG.Dec__01" "% Uti Oficina" "->>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATG.PreOfi
"T-MATG.PreOfi" "Precio Oficina!S/." "->>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF T-MATG.CtoTot IN BROWSE br_table /* Costo MARCO!S/. */
DO:
    ASSIGN
