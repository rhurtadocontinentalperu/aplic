...
btn-margen Btn-Excel BTN-CCTE B-AGTRANS BUTTON-REDONDEO 
...
DEFINE VARIABLE h_v-pedido-cred-01 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     btn-margen AT ROW 7.46 COL 121 WIDGET-ID 2
     Btn-Excel AT ROW 7.46 COL 136 WIDGET-ID 20
     BTN-CCTE AT ROW 8.54 COL 121 WIDGET-ID 22
     B-AGTRANS AT ROW 9.62 COL 121 WIDGET-ID 24
     BUTTON-REDONDEO AT ROW 10.69 COL 121 WIDGET-ID 26
...
DO:
   RUN Asigna-datos IN h_v-pedido-cred-01.
END.
...
DO:
  ...
  RUN Excel IN h_v-pedido-cred-01.
...
DO:
  RUN Margen IN h_v-pedido-cred-01.
END.
...
DO:
  RUN Despachar-Pedido IN h_v-pedido-cred-01.
END.
...
DO:
  RUN Redondeo IN h_v-pedido-cred-01.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-pedido-cred-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-cred-01 ).
       RUN set-position IN h_v-pedido-cred-01 ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pedido-cred-01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_v-pedido-cred-01 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-pedido-cred-01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pedido-cred-01 ,
             h_p-navico , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-size IN h_b-pedido-cred ( 12.92 , 141.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedido-cred ( 11.77 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-25 BUTTON-Despachar COMBO-NroSer btn-margen Btn-Excel BTN-CCTE 
...
CASE L-Handle:
 ...
 WHEN "Disable-Head" THEN DO:
     ...
     RUN dispatch IN h_v-pedido-cred-01 ('disable-fields').
   END.
 WHEN "Enable-Head" THEN DO:
     RUN dispatch IN h_p-updv04 ('enable':U).
     RUN dispatch IN h_v-pedido-cred-01 ('enable-fields').
   END.
END CASE.
