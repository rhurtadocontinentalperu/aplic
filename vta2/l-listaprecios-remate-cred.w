...
&Scoped-define INTERNAL-TABLES VtaTabla Almmmatg Almmmate Almtfami
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
 ...
 AND VtaTabla.Tabla = "REMATES" NO-LOCK, ~
  ...
  AND Almmmatg.codmat = VtaTabla.Llave_c1 ~
      ...
      EACH Almtfami OF Almmmatg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table VtaTabla Almmmatg Almmmate Almtfami
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaTabla,INTEGRAL.Almmmatg WHERE INTEGRAL.VtaTabla ...,INTEGRAL.Almmmate OF INTEGRAL.Almmmatg,INTEGRAL.Almtfami OF INTEGRAL.Almmmatg"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST, FIRST,"
     _Where[1]         = "INTEGRAL.VtaTabla.CodCia = s-codcia
 AND INTEGRAL.VtaTabla.Tabla = ""REMATES"""
...
"_Comprometido(Almmmatg.codmat, x-codalm) @ f-StockComprometido" "Stock!Comprometido" "->>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ".43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
