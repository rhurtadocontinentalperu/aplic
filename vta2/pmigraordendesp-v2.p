...
IF LOOKUP(B-CPEDI.CodRef, "R/A,PED") = 0 THEN DO:
    ...
    RETURN 'ADM-ERROR'.
END.
/* Buscamos R/A ORIGINAL */
/* FIND Almcrepo WHERE almcrepo.CodCia = B-CPEDI.CodCia             */
/*     AND almcrepo.CodAlm = B-CPEDI.CodAlm                         */
/*     /*AND almcrepo.TipMov = B-CPEDI.TipMov*/                     */
...
pMensaje = "SE GENERO LA ORDEN: " + x-Comprobante.   /* devuelvo la OTR */
