...
&SCOPED-DEFINE l-lookup h_l-lisprecios-marco
...
DEFINE VARIABLE h_l-lisprecios-marco AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 15.54 COL 20
     Btn_Cancel AT ROW 15.54 COL 31
     SPACE(90.70) SKIP(0.38)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/l-lisprecios-marco.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-lisprecios-marco ).
       RUN set-position IN h_l-lisprecios-marco ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-lisprecios-marco ( 14.23 , 131.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 15.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 2.00 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-lisprecios-marco. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-lisprecios-marco ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-lisprecios-marco ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-lisprecios-marco , 'AFTER':U ).
    END. /* Page 0 */
