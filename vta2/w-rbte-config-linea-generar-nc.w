...
DEFINE VARIABLE COMBO-BOX-motivo AS CHARACTER FORMAT "X(25)":U INITIAL "LGNC" 
     LABEL "Motivo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Lineas/SubLineas para las N/C","LGNC"
     DROP-DOWN-LIST
     SIZE 30.29 BY 1
...
DEFINE VARIABLE FILL-IN-titulo AS CHARACTER FORMAT "X(50)":U INITIAL "  Lineas consideradas para generar la N/C" 
     VIEW-AS FILL-IN 
     SIZE 70.86 BY 1.23
...
DEFINE FRAME F-Main
     FILL-IN-titulo AT ROW 1.04 COL 1.86 NO-LABEL WIDGET-ID 16
     BUTTON-cargar AT ROW 1.12 COL 76 WIDGET-ID 20
     COMBO-BOX-procesos AT ROW 2.46 COL 9 COLON-ALIGNED WIDGET-ID 2
     COMBO-BOX-motivo AT ROW 2.46 COL 62.57 COLON-ALIGNED WIDGET-ID 18
     BUTTON-cancelar AT ROW 17.62 COL 58.29 WIDGET-ID 22
     BUTTON-grabar AT ROW 17.62 COL 80.14 WIDGET-ID 10
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-rbte-config-linea-generar-nc.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rbte-config-linea-movimiento ).
       RUN set-position IN h_b-rbte-config-linea-movimiento ( 3.73 , 4.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 17.42 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-cargar COMBO-BOX-procesos COMBO-BOX-motivo BUTTON-cancelar 
         BUTTON-grabar 
      WITH FRAME F-Main IN WINDOW W-Win.
