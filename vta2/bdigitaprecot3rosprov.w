...
w-report.Campo-C[1] w-report.Campo-C[2] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      w-report.Campo-C[1] COLUMN-LABEL "Proveedor" FORMAT "X(40)":U
            WIDTH 37.43
      w-report.Campo-C[2] COLUMN-LABEL "Promotor" FORMAT "X(30)":U
            WIDTH 19.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"w-report.Campo-C[1]" "Proveedor" "X(40)" "character" ? ? ? ? ? ? no ? no no "37.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.w-report.Campo-C[2]
"w-report.Campo-C[2]" "Promotor" "X(30)" "character" ? ? ? ? ? ? no ? no no "19.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
