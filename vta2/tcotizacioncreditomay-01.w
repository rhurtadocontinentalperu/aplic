...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.ImpLin COLUMN-LABEL "Importe!SIN Percep." FORMAT ">,>>>,>>9.99":U
            WIDTH 8.72
  ENABLE
      ITEM.codmat
      ITEM.CanPed
...
"ITEM.ImpLin" "Importe!SIN Percep." ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*       END.                                                                             */
  ...
  IF AVAILABLE Almmmate THEN DO:
      RUN vta2/Stock-Comprometido-Expo (ITEM.CodMat:SCREEN-VALUE IN BROWSE {&BROWSE-NAME},
                                   ENTRY(1, s-CodAlm),
...
/*           IF rpta = NO THEN RETURN "ADM-ERROR".                                      */
  ...
  IF s-TpoPed = "E" THEN RETURN "OK".       /* NO MARGEN DE UTILIDAD PARA EXPOLIBRERIA */
