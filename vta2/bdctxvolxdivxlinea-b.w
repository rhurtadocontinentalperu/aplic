...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmSFami.dessub FORMAT "X(40)":U WIDTH 43.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 52 BY 11.35
         BGCOLOR 15 FONT 4
...
"AlmSFami.dessub" ? "X(40)" "character" ? ? ? ? ? ? no ? no no "43.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  ...
  s-codfam = almsfami.codfam.
  s-subfam = almsfami.subfam.
