...
BUTTON-cargar BUTTON-cancelar BUTTON-grabar 
...
DEFINE BUTTON BUTTON-cancelar 
     LABEL "Seleccionar otro proceso!!!" 
     SIZE 19.57 BY 1.12.
...
DEFINE VARIABLE FILL-IN-titulo AS CHARACTER FORMAT "X(50)":U INITIAL "  Lista de precio(Evento) para la meta" 
     VIEW-AS FILL-IN 
     SIZE 64.29 BY 1.23
     BGCOLOR 11 FGCOLOR 0 FONT 11 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     FILL-IN-titulo AT ROW 1 COL 2.43 NO-LABEL WIDGET-ID 16
     COMBO-BOX-procesos AT ROW 2.54 COL 9 COLON-ALIGNED WIDGET-ID 2
     COMBO-BOX-motivo AT ROW 3.69 COL 9 COLON-ALIGNED WIDGET-ID 18
     BUTTON-cargar AT ROW 3.69 COL 45 WIDGET-ID 20
     BUTTON-cancelar AT ROW 19.08 COL 46.14 WIDGET-ID 22
     BUTTON-grabar AT ROW 20.42 COL 48.43 WIDGET-ID 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Configuracion - Lista de precios (Eventos)"
         HEIGHT             = 21.08
         WIDTH              = 67.57
         MAX-HEIGHT         = 21.5
         MAX-WIDTH          = 121
...
ON END-ERROR OF W-Win /* Configuracion - Lista de precios (Eventos) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Configuracion - Lista de precios (Eventos) */
DO:
...
ON CHOOSE OF BUTTON-cancelar IN FRAME F-Main /* Seleccionar otro proceso!!! */
DO:
...
ON CHOOSE OF BUTTON-grabar IN FRAME F-Main /* Confirmar y grabar */
DO:
...
ON ENTRY OF COMBO-BOX-motivo IN FRAME F-Main /* Motivo */
DO:
  RUN browse-off.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-rbte-config-evento-movimiento.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rbte-config-linea-movimiento ).
       RUN set-position IN h_b-rbte-config-linea-movimiento ( 5.15 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-rbte-config-linea-movimiento ( 13.46 , 59.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 19.58 , 2.72 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE COMBO-BOX-procesos COMBO-BOX-motivo BUTTON-cargar BUTTON-cancelar 
         BUTTON-grabar 
      WITH FRAME F-Main IN WINDOW W-Win.
