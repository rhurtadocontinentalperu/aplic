...
&Scoped-Define ENABLED-OBJECTS BTN-Excel RECT-24 COMBO-NroSer 
...
DO:
  RUN Asigna-Cotizacion IN h_vpedidocontadomay.
...
DO:
  RUN Genera-Excel IN h_vpedidocontadomay.
END.
...
DO:
    ...
    RUN dispatch IN h_t-pedido-cont ('open-query').
END.
...
DO:
  RUN Asigna-PrePedido IN h_vpedidocontadomay.
  IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
  RUN dispatch IN h_t-pedido-cont ('open-query':U).
  {&self-name}:SENSITIVE = NO.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/vpedidocontadomay.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/t-pedido-cont.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedido-cont ).
       RUN set-position IN h_t-pedido-cont ( 11.23 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BTN-Excel RECT-24 COMBO-NroSer 
      WITH FRAME F-Main IN WINDOW W-Win.
