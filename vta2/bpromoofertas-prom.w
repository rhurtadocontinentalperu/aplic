...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDTabla.Libre_d02 COLUMN-LABEL "Máximo" FORMAT ">>>9.99":U
            WIDTH 6.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaDTabla.Libre_d04 COLUMN-LABEL "Mínimo!S/." FORMAT ">>>,>>9.99":U
            WIDTH 9.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaDTabla.Libre_d03 COLUMN-LABEL "Unitario!S/." FORMAT ">>9.99":U
            WIDTH 5.72 COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 12
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 100 BY 20.19
...
"VtaDTabla.LlaveDetalle" "Articulo" "x(6)" "character" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDTabla.Libre_d01" "Cantidad" ">>>9.99" "decimal" 11 0 ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaDTabla.Libre_d02
"VtaDTabla.Libre_d02" "Máximo" ">>>9.99" "decimal" 11 0 ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaDTabla.Libre_d04
"VtaDTabla.Libre_d04" "Mínimo!S/." ">>>,>>9.99" "decimal" 11 0 ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.VtaDTabla.Libre_d03
"VtaDTabla.Libre_d03" "Unitario!S/." ">>9.99" "decimal" 12 15 ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
