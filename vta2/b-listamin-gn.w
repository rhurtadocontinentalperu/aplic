...
DEFINE BUFFER MATG FOR INTEGRAL.Almmmatg.
...
&Scoped-define INTERNAL-TABLES INTEGRAL.VtaListaMinGn INTEGRAL.Almmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table INTEGRAL.VtaListaMinGn.codmat ~
INTEGRAL.VtaListaMinGn.DesMat INTEGRAL.VtaListaMinGn.DesMar ~
INTEGRAL.Almmmatg.codfam fMonVta() @ x-MonVta INTEGRAL.Almmmatg.CtoTot ~
INTEGRAL.VtaListaMinGn.MonVta INTEGRAL.VtaListaMinGn.TpoCmb ~
INTEGRAL.VtaListaMinGn.Chr__01 INTEGRAL.VtaListaMinGn.PreOfi ~
INTEGRAL.VtaListaMinGn.Dec__01 INTEGRAL.VtaListaMinGn.CanEmp ~
INTEGRAL.Almmmatg.UndBas 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table ~
INTEGRAL.VtaListaMinGn.codmat INTEGRAL.VtaListaMinGn.MonVta ~
INTEGRAL.VtaListaMinGn.TpoCmb INTEGRAL.VtaListaMinGn.Chr__01 ~
INTEGRAL.VtaListaMinGn.PreOfi INTEGRAL.VtaListaMinGn.CanEmp 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table INTEGRAL.VtaListaMinGn
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table INTEGRAL.VtaListaMinGn
&Scoped-define QUERY-STRING-br_table FOR EACH INTEGRAL.VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      AND INTEGRAL.VtaListaMinGn.CodCia = s-codcia ~
 NO-LOCK, ~
      EACH INTEGRAL.Almmmatg OF INTEGRAL.VtaListaMinGn ~
      WHERE INTEGRAL.Almmmatg.codfam BEGINS x-CodFam ~
 AND INTEGRAL.Almmmatg.subfam BEGINS x-SubFam ~
 AND Almmmatg.CodPr1 BEGINS x-codpro NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH INTEGRAL.VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      AND INTEGRAL.VtaListaMinGn.CodCia = s-codcia ~
 NO-LOCK, ~
      EACH INTEGRAL.Almmmatg OF INTEGRAL.VtaListaMinGn ~
      WHERE INTEGRAL.Almmmatg.codfam BEGINS x-CodFam ~
 ...
 AND Almmmatg.CodPr1 BEGINS x-codpro NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table INTEGRAL.VtaListaMinGn ~
INTEGRAL.Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-br_table INTEGRAL.VtaListaMinGn
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      INTEGRAL.VtaListaMinGn.codmat COLUMN-LABEL "Codigo!Articulo" FORMAT "X(6)":U
            WIDTH 7.43
      INTEGRAL.VtaListaMinGn.DesMat FORMAT "X(60)":U WIDTH 42
      INTEGRAL.VtaListaMinGn.DesMar COLUMN-LABEL "Marca" FORMAT "X(30)":U
            WIDTH 14.86
      INTEGRAL.Almmmatg.codfam FORMAT "X(3)":U
      fMonVta() @ x-MonVta COLUMN-LABEL "Mon!Costo" FORMAT "x(3)":U
      INTEGRAL.Almmmatg.CtoTot COLUMN-LABEL "Costo Total" FORMAT ">>>>9.9999":U
      INTEGRAL.VtaListaMinGn.MonVta FORMAT "9":U WIDTH 8.86 COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
            VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEM-PAIRS "Soles",1,
                                      "Dolares",2
                      DROP-DOWN-LIST 
      INTEGRAL.VtaListaMinGn.TpoCmb FORMAT "Z9.9999":U COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.VtaListaMinGn.Chr__01 COLUMN-LABEL "Unidad" FORMAT "X(6)":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.VtaListaMinGn.PreOfi COLUMN-LABEL "Precio Venta" FORMAT ">,>>>,>>9.9999":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.VtaListaMinGn.Dec__01 COLUMN-LABEL "Margen" FORMAT "(ZZZ,ZZ9.9999)":U
      INTEGRAL.VtaListaMinGn.CanEmp COLUMN-LABEL "Empaque" FORMAT "->>,>>9.99":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.Almmmatg.UndBas FORMAT "X(6)":U
  ENABLE
      INTEGRAL.VtaListaMinGn.codmat
      INTEGRAL.VtaListaMinGn.MonVta
      INTEGRAL.VtaListaMinGn.TpoCmb
      INTEGRAL.VtaListaMinGn.Chr__01
      INTEGRAL.VtaListaMinGn.PreOfi
      INTEGRAL.VtaListaMinGn.CanEmp
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VtaListaMinGn.codmat" "Codigo!Articulo" ? "character" ? ? ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaListaMinGn.DesMar" "Marca" ? "character" ? ? ? ? ? ? no ? no no "14.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.CtoTot" "Costo Total" ">>>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.VtaListaMinGn.MonVta
"VtaListaMinGn.MonVta" ? ? "integer" 11 9 ? ? ? ? yes ? no no "8.86" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Soles,1,Dolares,2" 5 no 0 no no
     _FldNameList[8]   > INTEGRAL.VtaListaMinGn.TpoCmb
"VtaListaMinGn.TpoCmb" ? ? "decimal" 11 9 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.VtaListaMinGn.Chr__01
"VtaListaMinGn.Chr__01" "Unidad" "X(6)" "character" 11 9 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.VtaListaMinGn.PreOfi
"VtaListaMinGn.PreOfi" "Precio Venta" ? "decimal" 11 9 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.VtaListaMinGn.Dec__01
"VtaListaMinGn.Dec__01" "Margen" "(ZZZ,ZZ9.9999)" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.VtaListaMinGn.CanEmp
"VtaListaMinGn.CanEmp" "Empaque" ? "decimal" 11 9 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define SELF-NAME INTEGRAL.VtaListaMinGn.codmat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL INTEGRAL.VtaListaMinGn.codmat br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF INTEGRAL.VtaListaMinGn.codmat IN BROWSE br_table /* Codigo!Articulo */
DO:
    ...
    IF VtaListaMinGn.Chr__01:SCREEN-VALUE IN BROWSE {&browse-name} = '' THEN DO:
        DISPLAY
    ...
    IF RETURN-VALUE = 'YES' THEN DO:
        IF Almmmatg.monvta = 1 THEN VtaListaMinGn.MonVta:SCREEN-VALUE IN BROWSE {&browse-name} = '1'.
        IF Almmmatg.monvta = 2 THEN VtaListaMinGn.MonVta:SCREEN-VALUE IN BROWSE {&browse-name} = '2'.
        VtaListaMinGn.TpoCmb:SCREEN-VALUE IN BROWSE {&browse-name} = STRING(Almmmatg.tpocmb).
    END.
END.
...
&Scoped-define SELF-NAME INTEGRAL.VtaListaMinGn.Chr__01
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL INTEGRAL.VtaListaMinGn.Chr__01 br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF INTEGRAL.VtaListaMinGn.Chr__01 IN BROWSE br_table /* Unidad */
DO:
...
ON 'RETURN':U OF VtaListaMinGn.codmat, VtaListaMinGn.Chr__01,
    VtaListaMinGn.MonVta, VtaListaMinGn.PreOfi, VtaListaMinGn.TpoCmb,
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "INTEGRAL.VtaListaMinGn"}
...
IF VtaListaMinGn.MonVta:SCREEN-VALUE IN BROWSE {&Browse-name} = '' THEN DO:
    MESSAGE 'Debe seleccionar la moneda de venta'
        VIEW-AS ALERT-BOX ERROR.
    APPLY 'entry' TO VtaListaMinGn.MonVta IN BROWSE {&browse-name}.
    RETURN "ADM-ERROR".
END.
IF DECIMAL (VtaListaMinGn.TpoCmb:SCREEN-VALUE IN BROWSE {&Browse-name}) = 0 THEN DO:
    MESSAGE 'Debe ingresar el tipo de cambio'
        VIEW-AS ALERT-BOX ERROR.
    APPLY 'entry' TO VtaListaMinGn.TpoCmb IN BROWSE {&browse-name}.
    RETURN "ADM-ERROR".
END.
FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
