...
IF s-coddiv = '00506' THEN DO:
    MESSAGE 'Restringido para la división' s-coddiv VIEW-AS ALERT-BOX WARNING.
    RETURN ERROR.
END.
...
cCodDoc = "FAI".        /* <<< OJO <<< FORZAMOS DOCUMENTO */
...
&Scoped-Define ENABLED-OBJECTS BROWSE-2 COMBO-BOX-Guias COMBO-NroSer-Guia ~
...
DEFINE FRAME gDialog
     ...
     COMBO-NroSer AT ROW 3.69 COL 13 WIDGET-ID 2
...
ON RETURN OF COMBO-NroSer IN FRAME gDialog /* Serie FAI */
DO:
    APPLY 'Tab':U TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-NroSer gDialog
ON VALUE-CHANGED OF COMBO-NroSer IN FRAME gDialog /* Serie FAI */
DO:
    /* Correlativo */
    FIND FacCorre WHERE
        FacCorre.CodCia = s-CodCia AND
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Aplicacion-de-Adelantos gDialog 
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-Guias COMBO-NroSer-Guia FILL-IN-NroPed FILL-IN-Cliente 
      ...
      WITH FRAME gDialog.
  ENABLE BROWSE-2 COMBO-BOX-Guias COMBO-NroSer-Guia COMBO-NroSer Btn_OK 
         Btn_Cancel FILL-IN-Glosa FILL-IN-LugEnt RECT-1 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
