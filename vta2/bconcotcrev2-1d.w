...
&Scoped-define INTERNAL-TABLES FacDPedi Almmmatg t-FacDPedi
...
t-FacDPedi.CanSol t-FacDPedi.canate FacDPedi.PreUni FacDPedi.Por_Dsctos[1] ~
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacDPedi OF FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      FIRST t-FacDPedi WHERE t-FacDPedi.CodCia = FacDPedi.CodCia ~
  AND t-FacDPedi.CodDiv = FacDPedi.CodDiv ~
  AND t-FacDPedi.CodDoc = FacDPedi.CodDoc ~
  AND t-FacDPedi.NroPed = FacDPedi.NroPed ~
  AND t-FacDPedi.codmat = FacDPedi.codmat NO-LOCK ~
    BY FacDPedi.NroItm
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacDPedi OF FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND t-FacDPedi.codmat = FacDPedi.codmat NO-LOCK ~
    BY FacDPedi.NroItm.
&Scoped-define TABLES-IN-QUERY-br_table FacDPedi Almmmatg t-FacDPedi
&Scoped-define FIRST-TABLE-IN-QUERY-br_table FacDPedi
&Scoped-define SECOND-TABLE-IN-QUERY-br_table Almmmatg
&Scoped-define THIRD-TABLE-IN-QUERY-br_table t-FacDPedi
...
FILL-IN_ImpVta FILL-IN_ImpDto2 FILL-IN_ImpExo FILL-IN_PorIgv ~
FILL-IN_Import2 FILL-IN_ImpDto FILL-IN_ImpIgv FILL-IN-Peso FILL-IN-Volumen ~
FILL-IN_Percepcion 
...
DEFINE QUERY br_table FOR 
      ...
      Almmmatg, 
      t-FacDPedi
    FIELDS(t-FacDPedi.CanSol
      t-FacDPedi.canate) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      t-FacDPedi.CanSol COLUMN-LABEL "Cantidad!Atendida!Pre-Ped.Logistico" FORMAT "(>>>,>>9.99)":U
            WIDTH 13.29
      t-FacDPedi.canate COLUMN-LABEL "Cantidad!Atendida!Ped.Logistico" FORMAT "(>>>,>>9.99)":U
            WIDTH 11.43
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.99999":U
            WIDTH 7.86
      FacDPedi.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Admins" FORMAT "->>9.9999":U
            WIDTH 6.43
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
            WIDTH 6.43
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 10.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 152 BY 9.96
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpBrt AT ROW 11.12 COL 19 COLON-ALIGNED WIDGET-ID 14
     FILL-IN_ImpTot AT ROW 11.12 COL 126 COLON-ALIGNED WIDGET-ID 20
     FILL-IN_ImpVta AT ROW 11.15 COL 49 COLON-ALIGNED WIDGET-ID 22
     FILL-IN_ImpDto2 AT ROW 11.15 COL 100 COLON-ALIGNED WIDGET-ID 38
     FILL-IN_ImpExo AT ROW 11.92 COL 19 COLON-ALIGNED WIDGET-ID 16
     FILL-IN_PorIgv AT ROW 11.92 COL 49 COLON-ALIGNED WIDGET-ID 24
     FILL-IN_Import2 AT ROW 11.92 COL 126 COLON-ALIGNED WIDGET-ID 26
     FILL-IN_ImpDto AT ROW 12.69 COL 19 COLON-ALIGNED WIDGET-ID 28
     FILL-IN_ImpIgv AT ROW 12.69 COL 49 COLON-ALIGNED WIDGET-ID 18
     FILL-IN-Peso AT ROW 12.69 COL 74 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-Volumen AT ROW 12.69 COL 100 COLON-ALIGNED WIDGET-ID 34
     FILL-IN_Percepcion AT ROW 12.69 COL 126 COLON-ALIGNED WIDGET-ID 30
     RECT-25 AT ROW 10.96 COL 1 WIDGET-ID 36
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.Almmmatg OF INTEGRAL.FacDPedi,Temp-Tables.t-FacDPedi WHERE INTEGRAL.FacDPedi ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST USED"
     _OrdList          = "INTEGRAL.FacDPedi.NroItm|yes"
     _JoinCode[3]      = "Temp-Tables.t-FacDPedi.CodCia = FacDPedi.CodCia
  AND Temp-Tables.t-FacDPedi.CodDiv = FacDPedi.CodDiv
  AND Temp-Tables.t-FacDPedi.CodDoc = FacDPedi.CodDoc
  AND Temp-Tables.t-FacDPedi.NroPed = FacDPedi.NroPed
  AND Temp-Tables.t-FacDPedi.codmat = FacDPedi.codmat"
...
"(IF Facdpedi.Libre_c05 <> '' AND Facdpedi.Libre_c05 <> 'OF' THEN Facdpedi.Libre_c05 + ' - ' ELSE '') + Almmmatg.desmat @ Almmmatg.desmat" "Descripción" "x(60)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.CanPed" "Cantidad!Aprobada" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.t-FacDPedi.CanSol
"t-FacDPedi.CanSol" "Cantidad!Atendida!Pre-Ped.Logistico" "(>>>,>>9.99)" "decimal" ? ? ? ? ? ? no ? no no "13.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.t-FacDPedi.canate
"t-FacDPedi.canate" "Cantidad!Atendida!Ped.Logistico" "(>>>,>>9.99)" "decimal" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.FacDPedi.PreUni
...
"FacDPedi.Por_Dsctos[1]" "% Dscto!Admins" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.Por_Dsctos[2]
"FacDPedi.Por_Dsctos[2]" "% Dscto!Evento" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.Por_Dsctos[3]
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol/Prom" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > integral.FacDPedi.ImpLin
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH Facdpedi OF Faccpedi NO-LOCK:
    CREATE t-Facdpedi.
    BUFFER-COPY Facdpedi EXCEPT Facdpedi.CanSol TO t-Facdpedi.
    /* Calculamos PCO */
    FOR EACH PCO NO-LOCK WHERE PCO.codcia = Faccpedi.codcia AND
        ...
        PCO.coddoc = 'PCO' AND
        PCO.flgest = "P",
        EACH DETALLE OF PCO NO-LOCK WHERE DETALLE.codmat = Facdpedi.codmat:
        ASSIGN
            t-Facdpedi.CanSol = t-Facdpedi.CanSol + DETALLE.CanPed
            t-Facdpedi.CanAte = t-Facdpedi.CanAte - DETALLE.CanPed
            .
    END.
END.
...
IF AVAILABLE FacCPedi THEN DO:
    ASSIGN
        ...
        FILL-IN_ImpDto2 = FacCPedi.ImpDto2
