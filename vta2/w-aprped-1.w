...
DEFINE VARIABLE h_b-aprped-1 AS HANDLE NO-UNDO.
...
DO:
  RUN dispatch IN h_b-aprped-1 ('open-query':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-aprped-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprped-1 ).
       RUN set-position IN h_b-aprped-1 ( 1.00 , 1.86 ) NO-ERROR.
       RUN set-size IN h_b-aprped-1 ( 8.04 , 142.00 ) NO-ERROR.
