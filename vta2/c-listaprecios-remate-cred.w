...
&SCOPED-DEFINE l-lookup h_l-listaprecios-remate-cred
...
DEFINE VARIABLE h_l-listaprecios-remate-cred AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 15.62 COL 61.14
     Btn_Cancel AT ROW 15.62 COL 72.14
     SPACE(37.13) SKIP(2.53)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'l-listaprecios-remate-cred.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-listaprecios-remate-cred ).
       RUN set-position IN h_l-listaprecios-remate-cred ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-listaprecios-remate-cred ( 14.23 , 117.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-detart ).
       RUN set-position IN h_v-detart ( 15.54 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 15.96 , 39.29 ) NO-ERROR.
       RUN set-size IN h_p-option ( 2.00 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-listaprecios-remate-cred. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listaprecios-remate-cred ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listaprecios-remate-cred , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listaprecios-remate-cred ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-detart ,
             h_l-listaprecios-remate-cred , 'AFTER':U ).
