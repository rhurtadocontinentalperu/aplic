...
DEFINE TEMP-TABLE ITEM NO-UNDO LIKE VtaDDocu
       FIELD TipVta AS CHAR
       FIELD PreVta AS DEC DECIMALS 4 EXTENT 3
       FIELD CanSol AS DEC DECIMALS 4
       FIELD CanApr AS DEC DECIMALS 4.
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    /* RHC 06/07/17 Descuentos especiales por volumen por saldo Expolibreria */
...
&IF DEFINED(EXCLUDE-Descuentos-Finales-04) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Descuentos-Finales-04 Procedure 
