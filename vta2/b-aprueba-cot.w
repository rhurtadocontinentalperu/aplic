...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacCPedi.CodDoc COLUMN-LABEL "Cod" FORMAT "x(3)":U WIDTH 4.43
      FacCPedi.NroPed COLUMN-LABEL "Número" FORMAT "X(9)":U WIDTH 10.29
      ...
      FacCPedi.NomCli COLUMN-LABEL "Nombre del Cliente" FORMAT "x(50)":U
            WIDTH 50.43
      FacCPedi.CodMon COLUMN-LABEL "Moneda" FORMAT "9":U VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEM-PAIRS "SOLES",1,
                                      "DOLARES",2
                      DROP-DOWN-LIST 
      FacCPedi.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 8.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"FacCPedi.CodDoc" "Cod" ? "character" ? ? ? ? ? ? no ? no no "4.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacCPedi.NroPed
"FacCPedi.NroPed" "Número" ? "character" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacCPedi.FchPed
"FacCPedi.FchPed" "Emisión" ? "date" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.NomCli" "Nombre del Cliente" ? "character" ? ? ? ? ? ? no ? no no "50.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacCPedi.CodMon
"FacCPedi.CodMon" "Moneda" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SOLES,1,DOLARES,2" 5 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacCPedi.ImpTot
"FacCPedi.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
MESSAGE 'Confirme la APROBACION de la Cotización' 
...
IF NOT AVAILABLE Faccpedi THEN RETURN.
MESSAGE 'Confirme el RECHAZO de la Cotización' 
    VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO
    UPDATE rpta AS LOG.
IF rpta = NO THEN RETURN.
FIND CURRENT Faccpedi EXCLUSIVE-LOCK NO-ERROR NO-WAIT.
