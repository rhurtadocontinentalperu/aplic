...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[3]         = "INTEGRAL.VtaListaMay.CodDiv = s-coddiv"
...
"T-MATG.Dec__01" "% Uti Ofi" "->>,>>9.9999" "decimal" 12 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.PreOfi
"T-MATG.PreOfi" "Precio Oficina!S/." ">>>,>>9.9999" "decimal" 12 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
