...
&Scoped-define FIELDS-IN-QUERY-br_table Almmmatg.DesMat Almmmatg.codmat ~
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-CodAlm TOGGLE-Stock FILL-IN-1 ~
FILL-IN-Marca COMBO-BOX-Linea COMBO-BOX-SubLinea br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-CodAlm TOGGLE-Stock FILL-IN-1 ~
FILL-IN-Marca COMBO-BOX-Linea COMBO-BOX-SubLinea 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almmmatg.DesMat FORMAT "X(60)":U WIDTH 49
...
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "49" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.Libre_d01" "Cantidad" ">>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"(IF Almmmatg.MonVta = 2 THEN Almmmatg.TpoCmb ELSE 1) * Almmmatg.PreOfi @ Almmmatg.PreOfi" "Precio en S/." ">>,>>9.9999" ? ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
