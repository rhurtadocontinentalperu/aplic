...
DEFINE VARIABLE h_b-captura-mostrador AS HANDLE NO-UNDO.
...
DO:
  RUN Aceptar IN h_b-captura-mostrador.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-captura-mostrador.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = DesMat':U ,
             OUTPUT h_b-captura-mostrador ).
       RUN set-position IN h_b-captura-mostrador ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-captura-mostrador ( 19.15 , 126.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-captura-mostrador ,
