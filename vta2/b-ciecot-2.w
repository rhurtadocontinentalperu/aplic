...
Almmmatg.DesMat FacDPedi.AlmDes FacDPedi.CanPed FacDPedi.canate ~
FacDPedi.UndVta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.AlmDes COLUMN-LABEL "Alm." FORMAT "x(3)":U
      ...
      FacDPedi.UndVta COLUMN-LABEL "Unidad" FORMAT "XXXXXXX":U
            WIDTH 8.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"FacDPedi.codmat" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[4]   > INTEGRAL.FacDPedi.AlmDes
"FacDPedi.AlmDes" "Alm." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.FacDPedi.CanPed
"FacDPedi.CanPed" "Cantidad Pedida" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacDPedi.canate
"FacDPedi.canate" "Cantidad Atendida" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacDPedi.UndVta
"FacDPedi.UndVta" "Unidad" "XXXXXXX" "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
