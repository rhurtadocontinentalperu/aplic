...
DEFINE VARIABLE h_v-pedido-cred-01a AS HANDLE NO-UNDO.
...
DO:
   RUN Asigna-datos IN h_v-pedido-cred-01a.
END.
...
DO:
  ...
  RUN Excel IN h_v-pedido-cred-01a.
...
DO:
  RUN Margen IN h_v-pedido-cred-01a.
END.
...
DO:
  RUN Despachar-Pedido IN h_v-pedido-cred-01a.
END.
...
DO:
  RUN Redondeo IN h_v-pedido-cred-01a.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/v-pedido-cred-01a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-cred-01a ).
       RUN set-position IN h_v-pedido-cred-01a ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pedido-cred-01a. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_v-pedido-cred-01a ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-pedido-cred-01a ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pedido-cred-01a ,
             h_p-navico , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-pedido-cred ( 10.92 , 2.00 ) NO-ERROR.
...
CASE L-Handle:
 ...
 WHEN "Disable-Head" THEN DO:
     ...
     RUN dispatch IN h_v-pedido-cred-01a ('disable-fields').
   END.
 WHEN "Enable-Head" THEN DO:
     RUN dispatch IN h_p-updv04 ('enable':U).
     RUN dispatch IN h_v-pedido-cred-01a ('enable-fields').
   END.
END CASE.
