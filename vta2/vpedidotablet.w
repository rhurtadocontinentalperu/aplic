...
&Scoped-Define ENABLED-FIELDS FacCPedi.NroRef FacCPedi.CodOrigen ~
FacCPedi.NroOrigen FacCPedi.fchven FacCPedi.CodCli FacCPedi.FaxCli ~
FacCPedi.RucCli FacCPedi.Atencion FacCPedi.FchEnt FacCPedi.Libre_f02 ~
FacCPedi.NomCli FacCPedi.Sede FacCPedi.CodAlm FacCPedi.TipVta ~
FacCPedi.Libre_c03 FacCPedi.CodMon FacCPedi.Glosa FacCPedi.FmaPgo ~
FacCPedi.Cmpbnte 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.NroRef ~
FacCPedi.CodOrigen FacCPedi.NroOrigen FacCPedi.fchven FacCPedi.CodCli ~
FacCPedi.FaxCli FacCPedi.RucCli FacCPedi.Atencion FacCPedi.FchEnt ~
FacCPedi.Libre_f02 FacCPedi.NomCli FacCPedi.Sede FacCPedi.CodAlm ~
FacCPedi.TipVta FacCPedi.Libre_c03 FacCPedi.TpoLic FacCPedi.CodMon ~
FacCPedi.Glosa FacCPedi.FmaPgo FacCPedi.Cmpbnte 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-Lista FILL-IN-sede 
...
DEFINE FRAME F-Main
     FacCPedi.NroPed AT ROW 1 COL 7 COLON-ALIGNED
          LABEL "Numero" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 15 FGCOLOR 1 FONT 0
     FacCPedi.NroRef AT ROW 1 COL 28 COLON-ALIGNED WIDGET-ID 10
          LABEL "Cotizacion"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.CodOrigen AT ROW 1 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.NroOrigen AT ROW 1 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 146
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 14 FGCOLOR 0 
     F-Estado AT ROW 1 COL 57 COLON-ALIGNED NO-LABEL
     FacCPedi.fchven AT ROW 1 COL 97 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.CodCli AT ROW 1.81 COL 7 COLON-ALIGNED HELP
          ""
          LABEL "Cliente" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.FaxCli AT ROW 1.81 COL 22 NO-LABEL WIDGET-ID 120 FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     FacCPedi.RucCli AT ROW 1.81 COL 31 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     FacCPedi.Atencion AT ROW 1.81 COL 48 COLON-ALIGNED WIDGET-ID 4
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-Lista AT ROW 1.81 COL 69 COLON-ALIGNED WIDGET-ID 124
     FacCPedi.FchEnt AT ROW 1.81 COL 97 COLON-ALIGNED WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.Libre_f02 AT ROW 2.58 COL 97 COLON-ALIGNED WIDGET-ID 154
          LABEL "Fecha Entrega" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NomCli AT ROW 2.62 COL 7 COLON-ALIGNED FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 75 BY .81
     FacCPedi.Sede AT ROW 3.42 COL 7 COLON-ALIGNED WIDGET-ID 24
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN-sede AT ROW 3.42 COL 14 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     FacCPedi.CodAlm AT ROW 3.42 COL 97 COLON-ALIGNED WIDGET-ID 110
          LABEL "Almacén Despacho" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 14 BY .81
          BGCOLOR 8 FGCOLOR 0 
     FacCPedi.TipVta AT ROW 4.23 COL 9 NO-LABEL WIDGET-ID 134
...
"Si", "Si":U
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Libre_c03 AT ROW 4.23 COL 33 COLON-ALIGNED WIDGET-ID 130
          LABEL "Bol. Depósito" FORMAT "x(12)"
          VIEW-AS FILL-IN 
          SIZE 16 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.TpoLic AT ROW 4.23 COL 57 WIDGET-ID 118
          LABEL "APLICAR ADELANTOS"
          VIEW-AS TOGGLE-BOX
          SIZE 19 BY .77
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 4.23 COL 99 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dolares", 2
...
DEFINE FRAME F-Main
     FacCPedi.Glosa AT ROW 5.04 COL 4.28 FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 75 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FmaPgo AT ROW 5.04 COL 97 COLON-ALIGNED
          LABEL "Condición de Venta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     FacCPedi.Cmpbnte AT ROW 5.04 COL 108 NO-LABEL WIDGET-ID 160
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "FAC", "FAC":U,
"BOL", "BOL":U
     ...
     "Calendario logistico" VIEW-AS TEXT
          SIZE 14.43 BY .5 AT ROW 1.88 COL 109.57 WIDGET-ID 156
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 4.35 COL 92
     "Recoge?" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 4.5 COL 2 WIDGET-ID 138
     "Pactado con cliente" VIEW-AS TEXT
          SIZE 14.43 BY .5 AT ROW 2.69 COL 109.57 WIDGET-ID 158
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
ON LEAVE OF FacCPedi.CodAlm IN FRAME F-Main /* Almacén Despacho */
DO:
...
------------------------------------------------------------------------------*/
  ...
  */      
  ...
  EMPTY TEMP-TABLE PEDI.    /* Limpiamos el detalle del pedido */
  
  FIND TabGener WHERE TabGener.CodCia = s-codcia AND TabGener.Clave = "CFGCOT" AND 
  ...
  ASSIGN
      ...
      pFchEnt = TODAY.
  CASE TRUE:
      WHEN AVAILABLE TabGener AND TabGener.Libre_c01 = "PCO" THEN DO:
      ...
      END.
      OTHERWISE DO:
          /* 1ro. capturamos la COTIZACION */
          RUN vta2/dcotpendientetablet (OUTPUT s-NroCot).
          IF TRUE <> (s-NroCot > "") THEN RETURN "ADM-ERROR".
          /* 2do. capturamos el ALMACEN DESPACHO */
  ...
  RUN vta2/d-ped-tope-despacho NO-ERROR.
  /* ******************************************************************** */
  /* ******************************************************************** */
  /* *********************************************** */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    CASE TRUE:
        WHEN s-Tipo-Abastecimiento = "PCO" THEN DO:
            ...
            FOR EACH B-DPEDI NO-LOCK WHERE B-DPEDI.CodCia = s-CodCia AND
                ...
                EACH Facdpedi EXCLUSIVE-LOCK WHERE Facdpedi.CodCia = COTIZACION.CodCia AND
                    Facdpedi.CodDoc = COTIZACION.CodDoc AND
                    Facdpedi.NroPed = COTIZACION.NroPed AND
                    Facdpedi.CodMat = B-DPEDI.CodMat ON ERROR UNDO, THROW:
    ...
    ASSIGN
        ...
        FacCPedi.CrossDocking = COTIZACION.CrossDocking
        FacCPedi.AlmacenXD = COTIZACION.AlmacenXD
        FacCPedi.FchPed = TODAY
        FacCPedi.TpoCmb = COTIZACION.TpoCmb
...
/*     IF INPUT FacCPedi.fchent > DATE(FacCPedi.FchPed:SCREEN-VALUE) + 25 THEN DO: */
    IF INPUT FacCPedi.fchent > TODAY + 25 THEN DO: 
...
/*                     IF Ccbcdocu.sdoact < (f-Tot * DECI(FaccPedi.Tpocmb:SCREEN-VALUE)) THEN DO: */
                    IF Ccbcdocu.sdoact < (f-Tot * s-Tpocmb) THEN DO:
                        MESSAGE 'El saldo de la Boleta de Depósito NO cubre el Pedido' 
                            VIEW-AS ALERT-BOX INFORMATION.
                        APPLY 'ENTRY':U TO FacCPedi.Libre_c03.
                        RETURN 'ADM-ERROR'.
