...
rbtn-impresos txtDesde txtHasta ChkChequeo BtnExcel RADIO-SET-1 ~
rbtn-cliente txtOC-SMP txtCliente BUTTON-15 BUTTON-PorZona ~
BUTTON-Alfabeticamente 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-CodDoc rbtn-impresos txtDesde ~
txtHasta ChkChequeo RADIO-SET-1 rbtn-cliente txtOC-SMP txtCliente ~
txtArtSinPeso 
...
DEFINE FRAME F-Main
     ...
     BUTTON-13 AT ROW 1.31 COL 120 WIDGET-ID 4
     ...
     ChkChequeo AT ROW 2.54 COL 49 WIDGET-ID 22
     ...
     RECT-1 AT ROW 3.31 COL 111 WIDGET-ID 32
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {F0B88A90-F5DA-11CF-B545-0020AF6ED35A} type: PSTimer */
      CtrlFrame:MOVE-AFTER(BUTTON-15:HANDLE IN FRAME F-Main).
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-CodDoc rbtn-impresos txtDesde txtHasta ChkChequeo 
          RADIO-SET-1 rbtn-cliente txtOC-SMP txtCliente txtArtSinPeso 
      WITH FRAME F-Main IN WINDOW ssW-Win.
  ENABLE RECT-1 RADIO-SET-CodDoc BtnDone BUTTON-13 rbtn-impresos txtDesde 
         txtHasta ChkChequeo BtnExcel RADIO-SET-1 rbtn-cliente txtOC-SMP 
         txtCliente BUTTON-15 BUTTON-PorZona BUTTON-Alfabeticamente 
      WITH FRAME F-Main IN WINDOW ssW-Win.
