...
DEFINE BUFFER B-Precios FOR VtaListaPrecios.
...
&Scoped-define INTERNAL-TABLES VtaListaPrecios Almmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaListaPrecios.codmat ~
Almmmatg.DesMat Almmmatg.DesMar Almmmatg.UndBas Almmmatg.codfam ~
Almmmatg.TpoCmb ~
IF (Almmmatg.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Moneda ~
Almmmatg.CtoTot VtaListaPrecios.CtoTot VtaListaPrecios.Chr__01 ~
VtaListaPrecios.PreOfi VtaListaPrecios.Dec__01 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table VtaListaPrecios.codmat ~
VtaListaPrecios.CtoTot VtaListaPrecios.Chr__01 VtaListaPrecios.PreOfi 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table VtaListaPrecios
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table VtaListaPrecios
&Scoped-define QUERY-STRING-br_table FOR EACH VtaListaPrecios WHERE VtaListaPrecios.CodCia = VtaTabla.CodCia ~
  AND VtaListaPrecios.TpoPed = VtaTabla.Libre_c01 ~
  AND VtaListaPrecios.NroLista = INTEGER(INTEGRAL.VtaTabla.Valor[1]) NO-LOCK, ~
      EACH Almmmatg OF VtaListaPrecios ~
      WHERE Almmmatg.codfam BEGINS x-CodFam ~
 AND Almmmatg.subfam BEGINS x-SubFam ~
 AND Almmmatg.CodPr1 BEGINS x-CodPro NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaListaPrecios WHERE VtaListaPrecios.CodCia = VtaTabla.CodCia ~
  AND VtaListaPrecios.TpoPed = VtaTabla.Libre_c01 ~
  AND VtaListaPrecios.NroLista = INTEGER(INTEGRAL.VtaTabla.Valor[1]) NO-LOCK, ~
      EACH Almmmatg OF VtaListaPrecios ~
      WHERE Almmmatg.codfam BEGINS x-CodFam ~
 ...
 AND Almmmatg.CodPr1 BEGINS x-CodPro NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaListaPrecios Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaListaPrecios
...
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Linea FILL-IN-CodMat ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaListaPrecios.codmat COLUMN-LABEL "Articulo" FORMAT "X(13)":U
            WIDTH 6.57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      Almmmatg.DesMat FORMAT "X(60)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U
      Almmmatg.UndBas COLUMN-LABEL "Unidad!Base" FORMAT "X(4)":U
      Almmmatg.codfam COLUMN-LABEL "Línea" FORMAT "X(3)":U
      Almmmatg.TpoCmb FORMAT "Z9.9999":U
      IF (Almmmatg.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Moneda COLUMN-LABEL "Mon"
      Almmmatg.CtoTot COLUMN-LABEL "Costo Lista Total" FORMAT ">>>,>>9.9999":U
      VtaListaPrecios.CtoTot COLUMN-LABEL "Costo Marco" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaListaPrecios.Chr__01 COLUMN-LABEL "Und" FORMAT "x(3)":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaListaPrecios.PreOfi COLUMN-LABEL "Precio Venta" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaListaPrecios.Dec__01 COLUMN-LABEL "Margen" FORMAT "(ZZZ,ZZ9.9999)":U
            WIDTH 5.14
  ENABLE
      VtaListaPrecios.codmat
      VtaListaPrecios.CtoTot
      VtaListaPrecios.Chr__01
      VtaListaPrecios.PreOfi
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 133 BY 14.42
...
DEFINE FRAME F-Main
     BUTTON-5 AT ROW 1 COL 30 WIDGET-ID 24
     COMBO-BOX-Linea AT ROW 1 COL 55 COLON-ALIGNED WIDGET-ID 28
     BUTTON-7 AT ROW 1 COL 109 WIDGET-ID 26
     FILL-IN-CodMat AT ROW 1.19 COL 13 COLON-ALIGNED WIDGET-ID 32
     COMBO-BOX-Sublinea AT ROW 1.96 COL 55 COLON-ALIGNED WIDGET-ID 30
     txt-codprov AT ROW 2.92 COL 55 COLON-ALIGNED WIDGET-ID 34
     txt-desprov AT ROW 2.92 COL 70 COLON-ALIGNED NO-LABEL WIDGET-ID 36
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: B-Precios B "?" ? INTEGRAL VtaListaPrecios
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaListaPrecios Where INTEGRAL.VtaTabla ...,INTEGRAL.Almmmatg OF INTEGRAL.VtaListaPrecios"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.VtaListaPrecios.CodCia = INTEGRAL.VtaTabla.CodCia
  AND INTEGRAL.VtaListaPrecios.TpoPed = INTEGRAL.VtaTabla.Libre_c01
  AND INTEGRAL.VtaListaPrecios.NroLista = INTEGER(INTEGRAL.VtaTabla.Valor[1])"
 ...
 AND INTEGRAL.Almmmatg.CodPr1 BEGINS x-CodPro"
     _FldNameList[1]   > INTEGRAL.VtaListaPrecios.codmat
"VtaListaPrecios.codmat" "Articulo" "X(13)" "character" 11 0 ? ? ? ? yes ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.UndBas" "Unidad!Base" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.Almmmatg.codfam
"Almmmatg.codfam" "Línea" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = INTEGRAL.Almmmatg.TpoCmb
     _FldNameList[7]   > "_<CALC>"
"IF (Almmmatg.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Moneda" "Mon" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.Almmmatg.CtoTot
"Almmmatg.CtoTot" "Costo Lista Total" ">>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.VtaListaPrecios.CtoTot
"VtaListaPrecios.CtoTot" "Costo Marco" ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.VtaListaPrecios.Chr__01
"VtaListaPrecios.Chr__01" "Und" "x(3)" "character" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.VtaListaPrecios.PreOfi
"VtaListaPrecios.PreOfi" "Precio Venta" ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.VtaListaPrecios.Dec__01
"VtaListaPrecios.Dec__01" "Margen" "(ZZZ,ZZ9.9999)" "decimal" ? ? ? ? ? ? no ? no no "5.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define SELF-NAME VtaListaPrecios.codmat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL VtaListaPrecios.codmat br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF VtaListaPrecios.codmat IN BROWSE br_table /* Articulo */
DO:
...
&Scoped-define SELF-NAME VtaListaPrecios.Chr__01
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL VtaListaPrecios.Chr__01 br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF VtaListaPrecios.Chr__01 IN BROWSE br_table /* Und */
DO:
...
DO:
    DEF VAR pCodMat AS CHAR NO-UNDO.
    pCodMat = SELF:SCREEN-VALUE.
    IF SELF:SCREEN-VALUE <> '' THEN RUN vta2/p-codigo-producto (INPUT-OUTPUT pCodMat, NO).
    SELF:SCREEN-VALUE = pCodMat.
    SELF:SENSITIVE = NO.
    IF pCodMat = '' THEN RETURN NO-APPLY.
    RUN local-busca.
...
DO:
   RUN vta2/ddctoxvolumen (ROWID(VtaListaPrecios)).
END.
...
DO:
  RUN vta2/ddctopromocional (ROWID(VtaListaPrecios)).
END.
...
ON 'RETURN':U OF VtaListaPrecios.Chr__01, VtaListaPrecios.codmat, 
    VtaListaPrecios.CtoTot, VtaListaPrecios.Dec__01, VtaListaPrecios.PreOfi
DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  APPLY 'ENTRY':U TO VtaListaPrecios.CodMat IN BROWSE {&BROWSE-NAME}.
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN
      ASSIGN
      VtaListaPrecios.CodCia = VtaTabla.CodCia
      VtaListaPrecios.TpoPed = VtaTabla.Libre_c01
      VtaListaPrecios.NroLista = INTEGER(VtaTabla.Valor[1])
  ...
  x-CtoTot = VtaListaPrecios.CtoTot.
...
------------------------------------------------------------------------------*/
  ...
  END.
  RUN GET-ATTRIBUTE('ADM-NEW-RECORD').
  IF RETURN-VALUE = "NO" THEN APPLY 'ENTRY':U TO VtaListaPrecios.CtoTot IN BROWSE {&BROWSE-NAME}.
...
FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
    AND Almmmatg.codmat = VtaListaPrecios.codmat:SCREEN-VALUE IN BROWSE {&browse-name} 
    NO-LOCK NO-ERROR.
IF NOT AVAILABLE Almmmatg THEN DO:
    MESSAGE 'Código del producto NO registrado'
        VIEW-AS ALERT-BOX ERROR.
    APPLY 'entry' TO VtaListaPrecios.codmat IN BROWSE {&browse-name}.
    RETURN "ADM-ERROR".
END.
  
FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
    AND Almtconv.Codalter = VtaListaPrecios.Chr__01:SCREEN-VALUE IN BROWSE {&browse-name}
    NO-LOCK NO-ERROR.
IF NOT AVAILABLE Almtconv THEN DO:
    MESSAGE "Equivalencia NO definida" SKIP
        "Unidad base :" Almmmatg.undbas SKIP
        "Unidad venta:" VtaListaPrecios.Chr__01:SCREEN-VALUE IN BROWSE {&browse-name}
        VIEW-AS ALERT-BOX ERROR.
    APPLY 'entry' TO VtaListaPrecios.Chr__01 IN BROWSE {&browse-name}.
    RETURN "ADM-ERROR".
END.
IF DECIMAL (VtaListaPrecios.PreOfi:SCREEN-VALUE IN BROWSE {&Browse-name}) = 0 THEN DO:
    MESSAGE 'Debe ingresar el precio de venta'
        VIEW-AS ALERT-BOX ERROR.
    APPLY 'entry' TO VtaListaPrecios.PreOfi IN BROWSE {&browse-name}.
    RETURN "ADM-ERROR".
END.
RETURN "OK".
