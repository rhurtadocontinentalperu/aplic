...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[1]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
   DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[2]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
   DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / VtaListaMinGn.PreOfi  ) * 100, 4 ) ).
 END.
...
/*                ? @ VtaListaMinGn.PromFchH[10]. */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-10 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[10]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-10.
 ...
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-1 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[1]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-1.
...
/*                ? @ VtaListaMinGn.PromFchH[2].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-2 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[2]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-2.
...
/*                ? @ VtaListaMinGn.PromFchH[3].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-3 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[3]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-3.
...
/*                ? @ VtaListaMinGn.PromFchH[4].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-4 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[4]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-4.
...
/*                                          */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-5 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[5]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-5.
...
/*                ? @ VtaListaMinGn.PromFchH[6].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-6 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[6]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-6.
...
/*                ? @ VtaListaMinGn.PromFchH[7].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-7 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[7]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-7.
...
/*        RETURN.                           */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-8 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[8]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-8.
...
/*                ? @ VtaListaMinGn.PromFchH[9].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-9 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(VtaListaMinGn.PromDto[9]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-9.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[10]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-10 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-10  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[1]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-1 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-1  .
 END.
END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[2]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-2 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-2  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[3]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-3 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-3  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[4]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-4 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-4  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[5]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-5 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-5  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[6]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-6 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-6  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[7]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-7 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-7  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[8]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-8 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-8  .
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF VtaListaMinGn.PromDivi[9]:SCREEN-VALUE = "" AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    F-PRECIO-9 = ROUND(VtaListaMinGn.PreOfi * ( 1 - ( DECI(SELF:SCREEN-VALUE) / 100 ) ),4).
    DISPLAY F-PRECIO-9 .
...
------------------------------------------------------------------------------*/
  ...
  RUN lib/logtabla ('VtaListaMinGn', VtaListaMinGn.codmat, 'WRITE').   /* Log de cambios */
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE VtaListaMinGn THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     F-PRECIO-1 = IF PromDivi[1] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[1] / 100 ) ),4) ELSE 0.     
     F-PRECIO-2 = IF PromDivi[2] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[2] / 100 ) ),4) ELSE 0.
     F-PRECIO-3 = IF PromDivi[3] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[3] / 100 ) ),4) ELSE 0.
     F-PRECIO-4 = IF PromDivi[4] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[4] / 100 ) ),4) ELSE 0.
     F-PRECIO-5 = IF PromDivi[5] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[5] / 100 ) ),4) ELSE 0.
     F-PRECIO-6 = IF PromDivi[6] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[6] / 100 ) ),4) ELSE 0.
     F-PRECIO-7 = IF PromDivi[7] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[7] / 100 ) ),4) ELSE 0.
     F-PRECIO-8 = IF PromDivi[8] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[8] / 100 ) ),4) ELSE 0.
     F-PRECIO-9 = IF PromDivi[9] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[9] / 100 ) ),4) ELSE 0.
     F-PRECIO-10 = IF PromDivi[10] <> "" THEN ROUND(VtaListaMinGn.PreOfi * ( 1 - ( PromDto[10] / 100 ) ),4) ELSE 0.
