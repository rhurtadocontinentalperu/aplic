...
DEFINE NEW SHARED VARIABLE s-DtoMax-Terceros     AS DECIMAL.
DEFINE NEW SHARED VARIABLE s-DtoMax-propios     AS DECIMAL.
...
&Scoped-Define ENABLED-OBJECTS RECT-25 BUTTON-1 COMBO-NroSer B-MARGEN 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/v-cotizacion-cred-dcto-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cotizacion-cred-dcto ).
       RUN set-position IN h_v-cotizacion-cred-dcto ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.15 , 112.00 ) */
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/t-cotizacion-cred-dcto-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-25 BUTTON-1 COMBO-NroSer B-MARGEN 
      WITH FRAME F-Main IN WINDOW W-Win.
