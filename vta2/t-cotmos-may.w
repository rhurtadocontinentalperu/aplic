...
PEDI.Por_Dsctos[1] PEDI.Por_Dsctos[2] PEDI.Por_Dsctos[3] PEDI.PreUni ~
PEDI.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 52.14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 139 BY 13.19
         BGCOLOR 15 FONT 4.
...
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "52.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PEDI.Por_Dsctos[3]" "% Dscto!Vol Prom" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.PEDI.PreUni
...
------------------------------------------------------------------------------*/
  ...
  /* RHC 13.09.2011 Margen de Utilidad */
  ...
  RUN vtagn/p-margen-utilidad (
      ...
      ENTRY(1, s-codalm),   /* Almacén de despacho */
