...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      COMPROBANTES.Libre_c04 FORMAT 'x(12)' COLUMN-LABEL 'G/R Entrega!Final'
...
FOR EACH COMPROBANTES EXCLUSIVE-LOCK:
...
chWorkSheet:Range("M2"):Value = "Deposito".
chWorkSheet:COLUMNS("M"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("N2"):Value = "Vencimiento".
chWorkSheet:COLUMNS("N"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("O2"):Value = "Recepción".
chWorkSheet:COLUMNS("O"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("P2"):Value = "Cancelación".
...
CASE xcodmod:
    WHEN 1 THEN DO:
        chWorkSheet:Range("Q2"):Value = "Importe S/.".
        chWorkSheet:Range("R2"):Value = "Importe S/. SIN Adelanto".
        chWorkSheet:Range("S2"):Value = "Saldo S/.".
        chWorkSheet:Range("T2"):Value = "Estado".
        chWorkSheet:Range("U2"):Value = "Usuario anulación".
        chWorkSheet:Range("V2"):Value = "Fecha".
        chWorkSheet:COLUMNS("V"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("W2"):Value = "Hora".
        chWorkSheet:Range("X2"):Value = "Motivo anulación".
        chWorkSheet:Range("Y2"):Value = "División".
        chWorkSheet:COLUMNS("Y"):NumberFormat = "@".
        chWorkSheet:Range("Z2"):Value = "Fecha Reporte".
        chWorkSheet:COLUMNS("Z"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("AA2"):Value = "Ubicación".
        chWorkSheet:Range("AB2"):Value = "Banco".
        chWorkSheet:Range("AC2"):Value = "Situación".
        chWorkSheet:Range("AD2"):Value = "F.Entrega(DIST)".
        chWorkSheet:Range("AE2"):Value = "F.Entrega(CRED)".
        chWorkSheet:Range("AF2"):Value = "DIRECC. CLIENTE".
        chWorkSheet:Range("AG2"):Value = "CANJE".
        chWorkSheet:Range("AH2"):Value = "DEPARTAMENTO".
        chWorkSheet:Range("AI2"):Value = "PROVINCIA".
        chWorkSheet:Range("AJ2"):Value = "DISTRITO".
        chWorkSheet:Range("AK2"):Value = "N° UNICO".
        chWorkSheet:Range("AL2"):Value = "Concepto N/C Otras".
        chWorkSheet:COLUMNS("AL"):NumberFormat = "@".
        chWorkSheet:Range("AM2"):Value = "Descripción".
/*         chWorkSheet:Range("AO2"):Value = "Papel Fotocopia (S/)". */
/*         chWorkSheet:Range("AP2"):Value = "Papel Fotocopia ($)".  */
    END.
    WHEN 2 THEN DO:
        chWorkSheet:Range("Q2"):Value = "Importe US$".
        chWorkSheet:Range("R2"):Value = "Importe US$ SIN Adelanto".
        chWorkSheet:Range("S2"):Value = "Saldo US$".
        chWorkSheet:Range("T2"):Value = "Estado".
        chWorkSheet:Range("U2"):Value = "Usuario anulación".
        chWorkSheet:Range("V2"):Value = "Fecha".
        chWorkSheet:COLUMNS("V"):NumberFormat = "dd/mm/yyyy".
...
/*         chWorkSheet:Range("AP2"):Value = "Papel Fotocopia ($)".  */
    ...
    WHEN 3 THEN DO:
        ...
        chWorkSheet:Range("R2"):Value = "Importe S/. SIN Adelanto".
        chWorkSheet:Range("S2"):Value = "Saldo S/.".
        chWorkSheet:Range("T2"):Value = "Importe US$".
        chWorkSheet:Range("U2"):Value = "Importe US$ SIN Adelanto".
        chWorkSheet:Range("V2"):Value = "Saldo US$".
        chWorkSheet:Range("W2"):Value = "Estado".
        chWorkSheet:Range("X2"):Value = "Usuario anulación".
        chWorkSheet:Range("Y2"):Value = "Fecha".
        chWorkSheet:COLUMNS("Y"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("Z2"):Value = "Hora".
        chWorkSheet:Range("AA2"):Value = "Motivo anulación".
        chWorkSheet:Range("AB2"):Value = "División".
        chWorkSheet:COLUMNS("AB"):NumberFormat = "@".
        chWorkSheet:Range("AC2"):Value = "Fecha Reporte".
        chWorkSheet:COLUMNS("AC"):NumberFormat = "dd/mm/yyyy".
        chWorkSheet:Range("AD2"):Value = "Ubicación".
        chWorkSheet:Range("AE2"):Value = "Banco".
        chWorkSheet:Range("AF2"):Value = "Situación".
        chWorkSheet:Range("AG2"):Value = "F.Entrega(DIST)".
        chWorkSheet:Range("AH2"):Value = "F.Entrega(CRED)".
        chWorkSheet:Range("AI2"):Value = "DIRECC. CLIENTE".
        chWorkSheet:Range("AJ2"):Value = "CANJE".
        chWorkSheet:Range("AK2"):Value = "DEPARTAMENTO".
        chWorkSheet:Range("AL2"):Value = "PROVINCIA".
        chWorkSheet:Range("AM2"):Value = "DISTRITO".
        chWorkSheet:Range("AN2"):Value = "N° UNICO".
        chWorkSheet:Range("AO2"):Value = "Papel Fotocopia (S/)".
        chWorkSheet:Range("AP2"):Value = "Papel Fotocopia ($)".
        chWorkSheet:Range("AQ2"):Value = "Concepto N/C Otras".
        chWorkSheet:COLUMNS("AQ"):NumberFormat = "@".
        chWorkSheet:Range("AR2"):Value = "Descripción".
    END.
END.
