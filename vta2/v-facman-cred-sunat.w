...
DEFINE FRAME F-Main
     ...
     CcbCDocu.FchDoc AT ROW 1 COL 121 COLON-ALIGNED
          LABEL "F/ Emision"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     CcbCDocu.NomCli AT ROW 1.81 COL 21 COLON-ALIGNED NO-LABEL FORMAT "x(100)"
          VIEW-AS FILL-IN 
          SIZE 88 BY .81
     CcbCDocu.TpoCmb AT ROW 1.81 COL 121 COLON-ALIGNED
          LABEL "T/ Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.DirCli AT ROW 2.62 COL 9 COLON-ALIGNED FORMAT "x(100)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     CcbCDocu.FchVto AT ROW 2.62 COL 121 COLON-ALIGNED
          LABEL "Vencimiento"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     CcbCDocu.NroPed AT ROW 3.42 COL 121 COLON-ALIGNED FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ...
     CcbCDocu.NroOrd AT ROW 4.23 COL 121 COLON-ALIGNED
     ...
     CcbCDocu.CodMon AT ROW 5.04 COL 123.14 NO-LABEL
...
"US$", 2
     ...
     "Moneda:" VIEW-AS TEXT
          SIZE 6.43 BY .5 AT ROW 5.04 COL 116
