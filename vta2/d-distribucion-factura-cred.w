...
DEFINE FRAME D-Dialog
     FILL-IN_Bultos-1 AT ROW 13.27 COL 86 COLON-ALIGNED WIDGET-ID 2
     FILL-IN_Bultos-2 AT ROW 14.35 COL 86 COLON-ALIGNED WIDGET-ID 4
     Btn_OK AT ROW 14.65 COL 3.57
     Btn_Cancel AT ROW 14.65 COL 18.57
     SPACE(85.42) SKIP(0.22)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_t-distribucion-factura-cred ( 1.27 , 1.00 ) NO-ERROR.
       RUN set-size IN h_t-distribucion-factura-cred ( 11.73 , 117.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv96 ).
       RUN set-position IN h_p-updv96 ( 13.04 , 3.57 ) NO-ERROR.
