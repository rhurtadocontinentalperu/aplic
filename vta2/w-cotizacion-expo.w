...
&Scoped-Define ENABLED-OBJECTS BTN-Excel BUTTON-2 RECT-24 COMBO-NroSer 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  't-cotizacion-expo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-cotizacion-cred ).
       RUN set-position IN h_t-cotizacion-cred ( 11.96 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-cotizacion-cred ( 13.50 , 141.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 23.00 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BTN-Excel BUTTON-2 RECT-24 COMBO-NroSer 
      WITH FRAME F-Main IN WINDOW W-Win.
