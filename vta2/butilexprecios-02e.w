...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.CtoTot COLUMN-LABEL "Costo!S/." FORMAT ">>>,>>9.9999":U
...
"T-MATG.CtoTot" "Costo!S/." ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.PreOfi" "Precio Oficina!S/." "->>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF T-MATG.CtoTot IN BROWSE br_table /* Costo!S/. */
DO:
    ASSIGN
