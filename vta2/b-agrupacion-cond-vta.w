...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Nombre COLUMN-LABEL "Nombre del GRUPO" FORMAT "x(80)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 49.86 BY 7.12
         FONT 4
         TITLE "GRUPOS DE APLICACIONES DE CONDICIONES DE VENTA".
...
"FacTabla.Nombre" "Nombre del GRUPO" "x(80)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* GRUPOS DE APLICACIONES DE CONDICIONES DE VENTA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* GRUPOS DE APLICACIONES DE CONDICIONES DE VENTA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* GRUPOS DE APLICACIONES DE CONDICIONES DE VENTA */
DO:
