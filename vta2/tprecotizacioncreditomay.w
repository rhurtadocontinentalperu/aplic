...
FOR EACH B-PEDI, FIRST Almmmatg OF B-PEDI NO-LOCK:
    ASSIGN
        ...
        s-UndVta = B-PEDI.UndVta
        f-PreVta = B-PEDI.PreUni
        f-PreBas = B-PEDI.PreBas
        f-Dsctos = B-PEDI.PorDto
        z-Dsctos = B-PEDI.Por_Dsctos[2]
        y-Dsctos = B-PEDI.Por_Dsctos[3].
...
/*             ).                         */
    ...
    ASSIGN 
        ...
        /*B-PEDI.PreVta[1] = F-PreVta   /* CONTROL DE PRECIO DE LISTA */*/
