...
DEFINE FRAME F-Main
     ...
     CcbCDocu.FchDoc AT ROW 1.27 COL 74 COLON-ALIGNED
          LABEL "Emisión"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     CcbCDocu.NomCli AT ROW 2.08 COL 24 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 39 BY .81
     CcbCDocu.HorCie AT ROW 2.08 COL 74 COLON-ALIGNED HELP
          ""
     ...
     CcbCDocu.DirCli AT ROW 2.88 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 52 BY .81
     CcbCDocu.FchVto AT ROW 2.88 COL 74 COLON-ALIGNED
          LABEL "Vencmento"
          VIEW-AS FILL-IN 
          SIZE 10.43 BY .81
     CcbCDocu.RucCli AT ROW 3.69 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.TpoCmb AT ROW 3.69 COL 74 COLON-ALIGNED
     ...
     CcbCDocu.NroPed AT ROW 4.5 COL 74 COLON-ALIGNED
     ...
     CcbCDocu.Libre_c02 AT ROW 5.31 COL 74 COLON-ALIGNED WIDGET-ID 6
     ...
     CcbCDocu.Glosa AT ROW 6.12 COL 11 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 52 BY .81
     CcbCDocu.NroOrd AT ROW 6.12 COL 74 COLON-ALIGNED
...
/*             FIND Facdpedi OF Faccpedi WHERE /*Facdpedi.almdes = almdmov.codalm */
