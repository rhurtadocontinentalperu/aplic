  ...
  DO WITH FRAME {&FRAME-NAME} :
    ...
    IF Faccpedi.FlgSit:SCREEN-VALUE = "CD" THEN DO:
        ...
        IF NOT AVAILABLE VtaCTabla THEN DO:
            MESSAGE "Cupón de descuento NO válido"
                VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
            RETURN 'ADM-ERROR'.
        END.
        /* CLIENTE ESPECIAL NO VERIFICA VENCIMIENTOS */
        IF FacCPedi.CodCli:SCREEN-VALUE <> 'SYS00000001' THEN DO:
            IF NOT (TODAY >= VtaCTabla.FechaInicial AND TODAY <= VtaCTabla.FechaFinal)
                THEN DO:
                MESSAGE "Cupón de descuento ya venció o está fuera de fecha"
                    VIEW-AS ALERT-BOX ERROR.
                APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
                RETURN 'ADM-ERROR'.
            END.
