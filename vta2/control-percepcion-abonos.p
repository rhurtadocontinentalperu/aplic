...
/* GENERAMOS CONTROL DE PERCEPCIONES POR NOTAS DE CREDITO (PRA) */
DEF INPUT PARAMETER pRowid AS ROWID.

DEF VAR x-Tipo LIKE Ccbcdocu.Tipo NO-UNDO.      /* CREDITO o MOSTRADOR */

FIND Ccbcdocu WHERE ROWID(Ccbcdocu) = pRowid NO-LOCK NO-ERROR.
IF NOT AVAILABLE Ccbcdocu THEN RETURN.
IF LOOKUP(Ccbcdocu.coddoc, 'N/C') = 0 THEN RETURN.
...
/*IF CDOCU.tipo = 'MOSTRADOR' THEN NEXT.*/
...
DEF VAR s-coddoc AS CHAR INIT "PRA" NO-UNDO.
...
IF NOT AVAILABLE Faccorre THEN DO:
    MESSAGE 'NO existe el control de correlativos para el documento' s-coddoc
...
DO TRANSACTION ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    ASSIGN
        ...
        CDOCU.tipo   = x-Tipo       /* CREDITO o MOSTRADOR */
