...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 81 BY 8.08
         FONT 4
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN vta2/d-genera-factura-cred ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    RUN vta2/d-genera-factura-cred ( ROWID(FacCPedi), 'M' ).       /* MANUAL */
