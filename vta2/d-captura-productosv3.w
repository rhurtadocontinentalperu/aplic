...
DEFINE VARIABLE h_b-captura-productosv2 AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     BtnOK AT ROW 20.42 COL 91 WIDGET-ID 22
     BtnCancel AT ROW 20.42 COL 106 WIDGET-ID 24
     SPACE(8.42) SKIP(0.38)
...
DO:
  RUN Aceptar IN h_b-captura-productosv2.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/b-captura-productosv3.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-captura-productosv2 ).
       RUN set-position IN h_b-captura-productosv2 ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-captura-productosv2 ( 19.15 , 126.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-captura-productosv2 ,
