...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Número" FORMAT "X(12)":U
...
"FacCPedi.NroPed" "Número" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*         MESSAGE 'No hay programación de despachos para el día' pFchProg VIEW-AS ALERT-BOX ERROR. */
/*         APPLY 'ENTRY':U TO FacCPedi.FchEnt.                                                      */
/*         RETURN 'ADM-ERROR'.                                                                      */
/*     END.                                                                                         */
