...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.FlgEst <> "A" NO-LOCK, ~
      ...
      WHERE FacDPedi.codmat BEGINS x-codmat NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed FORMAT "X(9)":U WIDTH 10
...
/* Query rebuild information for BROWSE br_table
 ...
 AND FacCPedi.FlgEst <> ""A"""
     _Where[2]         = "FacDPedi.codmat BEGINS x-codmat"
     _FldNameList[1]   = INTEGRAL.FacCPedi.FchPed
     _FldNameList[2]   > INTEGRAL.FacCPedi.NroPed
"FacCPedi.NroPed" ? ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
