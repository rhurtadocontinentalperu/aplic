...
DEFINE FRAME F-Main
     ...
     x-monlc AT ROW 1.38 COL 113.72 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     x-importe AT ROW 1.38 COL 118.72 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     "L.C Disponible:" VIEW-AS TEXT
          SIZE 13 BY .62 AT ROW 1.54 COL 102 WIDGET-ID 24
          BGCOLOR 8 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_bcatventa ).
       RUN set-position IN h_bcatventa ( 3.50 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bcatventa ( 6.69 , 68.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/bcatvtac.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bcatvtac ).
       RUN set-position IN h_bcatvtac ( 3.50 , 71.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-detcatvta_prov-1 ( 11.96 , 2.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_bcatvtac , 'Record':U , h_b-detcatvta_prov-1 ).
