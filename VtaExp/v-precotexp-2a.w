...
DEFINE VARIABLE x-tarea           AS ROWID. 
...
VtaCDocu.TpoCmb VtaCDocu.FchVen VtaCDocu.DirCli VtaCDocu.FchEnt ~
VtaCDocu.RucCli VtaCDocu.DniCli VtaCDocu.Cmpbnte VtaCDocu.Sede ~
VtaCDocu.CodMon VtaCDocu.LugEnt VtaCDocu.Glosa VtaCDocu.FlgIgv ~
VtaCDocu.CodPos VtaCDocu.NroRef VtaCDocu.CodVen VtaCDocu.FmaPgo ~
VtaCDocu.NroCard 
...
VtaCDocu.Glosa VtaCDocu.FlgIgv VtaCDocu.CodPos VtaCDocu.NroRef ~
VtaCDocu.CodVen VtaCDocu.Usuario VtaCDocu.FmaPgo VtaCDocu.NroCard 
&Scoped-define DISPLAYED-TABLES VtaCDocu
&Scoped-define FIRST-DISPLAYED-TABLE VtaCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-sede FILL-IN-Postal ~
...
DEFINE FRAME F-Main
     VtaCDocu.NroPed AT ROW 1 COL 9 COLON-ALIGNED
          LABEL "Numero" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 13.14 BY .81
          BGCOLOR 15 FGCOLOR 9 FONT 0
     F-Estado AT ROW 1 COL 29 COLON-ALIGNED NO-LABEL
     VtaCDocu.FchPed AT ROW 1 COL 98 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.CodCli AT ROW 1.81 COL 9 COLON-ALIGNED HELP
          "" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.NomCli AT ROW 1.81 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 49 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.TpoCmb AT ROW 1.81 COL 98 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.FchVen AT ROW 2.62 COL 98 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.DirCli AT ROW 2.65 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.FchEnt AT ROW 3.42 COL 98 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.RucCli AT ROW 3.5 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCDocu.DniCli AT ROW 3.5 COL 28.29 COLON-ALIGNED WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.Cmpbnte AT ROW 4.23 COL 98 COLON-ALIGNED
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","BOL" 
          DROP-DOWN-LIST
          SIZE 10 BY 1
     VtaCDocu.Sede AT ROW 4.31 COL 9 COLON-ALIGNED NO-LABEL WIDGET-ID 32
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-sede AT ROW 4.31 COL 14.43 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     BUTTON-10 AT ROW 4.38 COL 5.72 WIDGET-ID 10
     VtaCDocu.CodMon AT ROW 5.04 COL 100 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.57 BY .81
     VtaCDocu.LugEnt AT ROW 5.08 COL 9 COLON-ALIGNED WIDGET-ID 30
          VIEW-AS FILL-IN 
          SIZE 44.29 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.Glosa AT ROW 5.92 COL 6.28
          LABEL "Glosa"
          VIEW-AS FILL-IN 
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     VtaCDocu.FlgIgv AT ROW 5.92 COL 100 NO-LABEL WIDGET-ID 38
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
          SIZE 11 BY .58
     VtaCDocu.CodPos AT ROW 6.65 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-Postal AT ROW 6.65 COL 14.43 COLON-ALIGNED NO-LABEL
     VtaCDocu.NroRef AT ROW 6.65 COL 98 COLON-ALIGNED WIDGET-ID 44
          LABEL "Cotización"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          FGCOLOR 12 
     VtaCDocu.CodVen AT ROW 7.46 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-nOMvEN AT ROW 7.46 COL 14.43 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME F-Main
     VtaCDocu.Usuario AT ROW 7.46 COL 98 COLON-ALIGNED WIDGET-ID 46
          LABEL "Digitador"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 8 
     VtaCDocu.FmaPgo AT ROW 8.27 COL 9 COLON-ALIGNED
          LABEL "Cond.Vta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-CndVta AT ROW 8.27 COL 14.43 COLON-ALIGNED NO-LABEL
     VtaCDocu.NroCard AT ROW 9.08 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 9.08 COL 21.14 COLON-ALIGNED NO-LABEL
     "Moneda:" VIEW-AS TEXT
          SIZE 6.86 BY .5 AT ROW 5.15 COL 93
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.85 COL 93 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
DO:
    ...
    IF NOT (INPUT {&SELF-NAME} >= 01/12/2011) THEN DO:
        MESSAGE 'Los despachos deben programarse a partir del 12 de Enero'
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Actualiza-NroCotizacion V-table-Win 
PROCEDURE Actualiza-NroCotizacion :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER cNroPed AS CHAR.
...
------------------------------------------------------------------------------*/
    ...
    MESSAGE 'Esta Seguro de Generar Cotización?'
    ...
    IF VtaCDocu.FlgSit = 'T' THEN DO: 
        MESSAGE 'Pre-Pedido ya registra La Cotización: ' + VtaCDocu.NroRef
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        RETURN 'ADM-ERROR'.
    END.
    DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
        /* CERRAMOS TAREAS Y TURNOS */
        FIND FIRST b-cpedi WHERE ROWID(b-cpedi) = ROWID(VtaCDocu) EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE B-CPEDI THEN UNDO, RETURN 'ADM-ERROR'.
        FIND ExpTarea WHERE ROWID(ExpTarea) = TO-ROWID(VtaCDocu.Libre_C01) 
            EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE ExpTarea THEN UNDO, RETURN 'ADM-ERROR'.
        ASSIGN
            ExpTarea.Estado = 'C'
            ...
            ExpTarea.Libre_c03 = STRING ( DATETIME(TODAY, MTIME), '99/99/9999 HH:MM:SS').
        /* Contador de items digitados */
        ExpTarea.Libre_d01 = 0.
        FOR EACH VtaDDocu OF VtaCDocu NO-LOCK:
            Exptarea.Libre_d01 = ExpTarea.Libre_d01 + 1.
        END.
        /* *************************** */
        FIND ExpDigit OF ExpTarea EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE ExpTarea THEN UNDO, RETURN 'ADM-ERROR'.
        ASSIGN
            ExpDigit.Libre_c01 = STRING( DATETIME(TODAY, MTIME), "99/99/9999 HH:MM:SS" ) 
            ExpDigit.FlgEst = "L".      /* LIBRE */
        FIND ExpTurno WHERE ROWID(ExpTurno) = TO-ROWID(ExpTarea.Libre_c01)
            EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE ExpTurno THEN UNDO, RETURN 'ADM-ERROR'.
        ASSIGN
            ExpTurno.Libre_c03 = STRING ( DATETIME(TODAY, MTIME), '99/99/9999 HH:MM:SS')
            ExpTurno.Estado = "P".      /* Pasa a Vendedor */
        /* GENERAMOS LA COTIZACION */
        /* RHC 05.01.2012 SE VAN A GENERAR 2 COTIZACIONES: FAMS. 001 002 005 y el resto */
        /*RUN Vtaexp\genera-cotizacion-2 (ROWID(VtaCDocu),OUTPUT CNroPed, "VTA-15").    */
        RUN Vtaexp\genera-cotizacion-2a (ROWID(VtaCDocu),OUTPUT CNroPed, "VTA-15").    
    ...
    MESSAGE '!!Cotización(es) Nº ' + cNroPed + ' acaba(n) de generarse!!.'.            
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH PEDI2 NO-LOCK BY PEDI2.NroItm TRANSACTION ON STOP UNDO, RETURN 'ADM-ERROR'
      ...
      MESSAGE vtaddocu.codmat SKIP
          vtaddocu.preuni SKIP
          vtaddocu.canped SKIP
          vtaddocu.impdto SKIP
          vtaddocu.implin.
      RELEASE VtaDDocu.
  END.
...
------------------------------------------------------------------------------*/
  ...
  /*Captura Primera Atencion Pendiente*/
  FIND FIRST ExpTarea USE-INDEX Llave02 WHERE ExpTarea.CodCia = s-codcia
      AND ExpTarea.CodDiv = s-coddiv
      AND ExpTarea.Estado = "P"
      AND ExpTarea.CodDig = s-user-id
      NO-LOCK NO-ERROR.
  IF NOT AVAIL ExpTarea THEN DO:
      MESSAGE "No hay pendientes, Sorry!"
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      RETURN "ADM-ERROR".
  END.
  /* Buscamos si ya se está trabajando */
/*   FIND B-CPEDI WHERE B-CPEDI.codcia = s-codcia                   */
/*       AND B-CPEDI.coddiv = s-coddiv                              */
/*       AND B-CPEDI.codped = s-coddoc                              */
/*       AND B-CPEDI.flgest <> 'A'                                  */
/*       AND B-CPEDI.flgsit <> 'T'                                  */
/*       AND B-CPEDI.Libre_c01 = STRING(x-tarea)                    */
/*       NO-LOCK NO-ERROR.                                          */
/*   IF AVAILABLE B-CPEDI THEN DO:                                  */
/*       MESSAGE "   Tiene un Pre-Pedido Pendiente   " SKIP         */
/*               "Usted debe Cotizarlo para Continuar" SKIP         */
/*               " Número de Pre-Pedido: " + STRING(B-CPedi.NroPed) */
/*           VIEW-AS ALERT-BOX WARNING BUTTONS OK.                  */
/*       RETURN "ADM-ERROR".                                        */
/*   END.                                                           */
  /*Busca Si Existe Pre-Cotizacion pendiente*/
  FIND LAST B-CPedi WHERE B-Cpedi.CodCia = s-codcia
      AND B-CPedi.CodDiv = s-coddiv
      AND B-CPedi.CodPed = s-coddoc
      AND B-CPedi.Usuario = s-user-id
      AND B-CPedi.FlgEst <> 'A'  NO-LOCK NO-ERROR.
  IF AVAIL B-CPedi AND B-CPedi.FlgSit <> 'T' THEN DO:
      MESSAGE "   Tiene un Pre-Pedido Pendiente   " SKIP
              "Usted debe Cotizarlo para Continuar" SKIP
              " Número de Pre-Pedido: " + STRING(B-CPedi.NroPed)
          VIEW-AS ALERT-BOX WARNING BUTTONS OK.
      RETURN "adm-error".
  END.
  /* GUARDAMOS ROWID DE LA TAREA */
  x-Tarea = ROWID(ExpTarea).
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      DISPLAY 
          ...
          11/15/2011 @ VtaCDocu.FchEnt
          S-TPOCMB   @ VtaCDocu.TpoCmb
          04/30/2012 @ VtaCDocu.FchVen
          '001' @ VtaCDocu.FmaPgo.

      FIND FIRST gn-clie WHERE gn-clie.codcia = cl-codcia
          AND gn-clie.codcli = ExpTarea.CodCli NO-LOCK NO-ERROR.
      
      DISPLAY
          gn-clie.codcli     @ VtaCDocu.CodCli 
          gn-clie.nomcli     @ VtaCDocu.NomCli 
          gn-clie.codpos     @ VtaCDocu.CodPos 
          ExpTarea.CodVen    @ VtaCDocu.CodVen 
          gn-clie.dircli     @ VtaCDocu.DirCli 
          gn-clie.DNI        @ VtaCDocu.DniCli 
          TODAY              @ VtaCDocu.FchEnt 
          TODAY              @ VtaCDocu.FchPed 
          gn-clie.dirent     @ VtaCDocu.LugEnt 
          gn-clie.NroCard    @ VtaCDocu.NroCard
          gn-clie.Ruc        @ VtaCDocu.RucCli .
      ...
      ASSIGN
          ...
          S-CODMON  = INTEGER(VtaCDocu.CodMon:SCREEN-VALUE)
          /*s-user-id = s-codter*/
          /*S-CODCLI  = VtaCDocu.CodCli:SCREEN-VALUE*/  /* Se actualiza al hacer LEAVE al CodCli */
          S-CNDVTA  = VtaCDocu.FmaPgo:SCREEN-VALUE
          s-codven  = VtaCDocu.CodVen:SCREEN-VALUE.
      ...
      APPLY 'LEAVE':U TO VtaCDocu.CodCli.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      FIND ExpTarea WHERE ROWID(ExpTarea) = x-Tarea NO-LOCK.
      FIND FacCorre WHERE FacCorre.CodCia = S-CODCIA 
          AND FacCorre.CodDoc = S-CODDOC 
          AND FacCorre.CodDiv = S-CODDIV 
          AND Faccorre.Codalm = S-CodAlm
      ...
      ASSIGN 
          ...
          VtaCDocu.Libre_c01 = STRING(x-tarea)      /*Puntero de Numero de Tarea*/
          VtaCDocu.Libre_d01 = ExpTarea.NroDig.     /* Correlativo unico */
      ASSIGN
