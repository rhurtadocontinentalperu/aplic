...
&SCOPED-DEFINE l-lookup h_l-cotexp
...
DEFINE VARIABLE h_l-cotexp AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/l-cotexp.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cotexp ).
       RUN set-position IN h_l-cotexp ( 1.19 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cotexp. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cotexp ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cotexp ,
