...
VtaDDocu.UndVta VtaDDocu.CanPed VtaDDocu.PorDto VtaDDocu.PorDto2 ~
VtaDDocu.Por_Dsctos[1] VtaDDocu.PreUni VtaDDocu.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDDocu.Libre_c01 COLUMN-LABEL "Pag" FORMAT "x(4)":U WIDTH 4.29
      VtaDDocu.Libre_c02 COLUMN-LABEL "Sec" FORMAT "x(6)":U
      VtaDDocu.CodMat COLUMN-LABEL "Codigo" FORMAT "X(6)":U WIDTH 7
      Almmmatg.DesMat FORMAT "X(30)":U WIDTH 35
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U WIDTH 12
      VtaDDocu.UndVta FORMAT "x(5)":U
      VtaDDocu.CanPed FORMAT "->>>,>>9.9999":U
      VtaDDocu.PorDto COLUMN-LABEL "% Dscto 1" FORMAT ">>9.9999":U
      VtaDDocu.PorDto2 COLUMN-LABEL "% Dscto 2" FORMAT ">>9.9999":U
      VtaDDocu.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Manual" FORMAT "->>9.99":U
      VtaDDocu.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">,>>>,>>9.9999":U
      VtaDDocu.ImpLin FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 132 BY 11.73
...
DEFINE FRAME F-Main
     br_table AT ROW 1.12 COL 2
     F-TotBrt AT ROW 13.65 COL 22 NO-LABEL WIDGET-ID 12
     F-ImpExo AT ROW 13.65 COL 34 NO-LABEL WIDGET-ID 4
     F-ImpDes AT ROW 13.65 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     F-ValVta AT ROW 13.65 COL 56.14 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-ImpIsc AT ROW 13.65 COL 68.86 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpIgv AT ROW 13.65 COL 81.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     F-ImpTot AT ROW 13.65 COL 94 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.12 COL 23 WIDGET-ID 26
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.12 COL 46 WIDGET-ID 24
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.12 COL 96 WIDGET-ID 22
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.12 COL 59 WIDGET-ID 20
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.12 COL 86 WIDGET-ID 18
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.12 COL 73 WIDGET-ID 16
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.12 COL 34 WIDGET-ID 28
...
"VtaDDocu.Libre_c01" "Pag" "x(4)" "character" ? ? ? ? ? ? no ? no no "4.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDDocu.CodMat" "Codigo" ? "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = INTEGRAL.VtaDDocu.UndVta
     _FldNameList[8]   = INTEGRAL.VtaDDocu.CanPed
     _FldNameList[9]   > INTEGRAL.VtaDDocu.PorDto
"VtaDDocu.PorDto" "% Dscto 1" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.VtaDDocu.PorDto2
"VtaDDocu.PorDto2" "% Dscto 2" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.VtaDDocu.Por_Dsctos[1]
"VtaDDocu.Por_Dsctos[1]" "% Dscto!Manual" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.VtaDDocu.PreUni
"VtaDDocu.PreUni" "Precio!Unitario" ">,>>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
