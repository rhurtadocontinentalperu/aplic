...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCatVtaC WHERE AlmCatVtaC.CodCia = s-codcia ~
  AND AlmCatVtaC.CodPro = gn-prov.CodPro ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmCatVtaC.DesPag FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 7
         FONT 4
...
/* Query rebuild information for BROWSE br_table
  ...
  AND AlmCatVtaC.CodPro = gn-prov.CodPro"
     _Where[1]         = "AlmCatVtaC.CodDiv = s-coddiv"
     _FldNameList[1]   = INTEGRAL.AlmCatVtaC.NroPag
     _FldNameList[2]   > INTEGRAL.AlmCatVtaC.DesPag
"AlmCatVtaC.DesPag" ? "x(40)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    */
    FOR EACH ALMCATVTAC:
        ...
        FOR EACH AlmCatVtaD WHERE AlmCatVtaD.CodCia = ALMCATVTAC.CodCia
            ...
            iCont = iCont + 1.            
        END.                   
        ASSIGN AlmCatVtaC.Libre_d01 = iCont.
    END.
END.
