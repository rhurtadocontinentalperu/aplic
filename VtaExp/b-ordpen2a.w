...
FacCPedi.NroPed FacCPedi.NomCli FacCPedi.FchPed ~
fGetCurr(FacCPedi.CodMon) @ cCurrency 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 80 BY 7.81
         FONT 4.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN vtaexp\gGenGuia2a (ROWID(FacCPedi), 'A', 'GRI').       /* GUIA AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    RUN vtaexp\gGenGuia2a (ROWID(FacCPedi), 'M', 'GRI').       /* GUIA MANUAL */
    RUN dispatch IN THIS-PROCEDURE ('open-query').
