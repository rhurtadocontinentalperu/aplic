...
PEDI2.codmat Almmmatg.DesMat Almmmatg.DesMar Almmmatg.UndBas ~
PEDI2.Libre_d02 PEDI2.Libre_d01 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH PEDI2 WHERE ~{&KEY-PHRASE} ~
      AND PEDI2.Libre_d02 <> 0 NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI2.Libre_d02 COLUMN-LABEL "Cantidad" FORMAT "->>>,>>9.9999":U
      PEDI2.Libre_d01 COLUMN-LABEL "Cantidad 1" FORMAT "->>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     BUTTON-7 AT ROW 2.08 COL 93 WIDGET-ID 2
     btn-elimina AT ROW 5.31 COL 93 WIDGET-ID 6
     "Agregar" VIEW-AS TEXT
          SIZE 7 BY .81 AT ROW 4.23 COL 94.86 WIDGET-ID 8
          FONT 6
...
ASSIGN 
       PEDI2.Libre_d01:VISIBLE IN BROWSE br_table = FALSE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "Temp-Tables.PEDI2.Libre_d02 <> 0"
     _FldNameList[1]   > Temp-Tables.PEDI2.Libre_c01
"PEDI2.Libre_c01" "Pag" "x(4)" "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.UndBas" "Und Bas" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.PEDI2.Libre_d02
"PEDI2.Libre_d02" "Cantidad" "->>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.PEDI2.Libre_d01
"PEDI2.Libre_d01" "Cantidad 1" "->>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? no no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    IF AVAIL b-pedi THEN ASSIGN b-pedi.libre_d01 = 0.
    RUN adm-open-query.
...
ON RETURN OF PEDI2.Libre_d01 DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  IF PEDI2.CodMat:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = ''
    OR INTEGER(PEDI2.CodMat:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
       ...
       RETURN "ADM-ERROR".
  END.
  IF DECIMAL(PEDI2.Libre_d01:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
       MESSAGE "Cantidad debe ser mayor a cero" VIEW-AS ALERT-BOX ERROR.
       APPLY 'ENTRY':U TO PEDI2.Libre_d01.
       RETURN "ADM-ERROR".
  END.
  /*
