...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 69.86 BY 5.35
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     br_table AT ROW 2.65 COL 3.14
     "** Dar doble chic a registro antes de ingresar los datos" VIEW-AS TEXT
          SIZE 56.57 BY .62 AT ROW 8.27 COL 3 WIDGET-ID 4
          FONT 5
  ...
  FOR EACH PEDI2 WHERE PEDI2.codcia = s-codcia
      ...
      IF AVAIL datos THEN DO:
          ASSIGN
              ...
              Datos.Por_Dsctos[1] = Pedi2.Por_Dsctos[1].
