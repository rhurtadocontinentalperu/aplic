...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDDocu.Libre_c01 COLUMN-LABEL "Pag" FORMAT "x(4)":U WIDTH 6
      VtaDDocu.Libre_c02 COLUMN-LABEL "Sec" FORMAT "x(6)":U
      VtaDDocu.CodMat COLUMN-LABEL "Codigo" FORMAT "X(6)":U WIDTH 8
      Almmmatg.DesMat FORMAT "X(30)":U WIDTH 35
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U WIDTH 25
      VtaDDocu.UndVta FORMAT "x(5)":U
      VtaDDocu.CanPed FORMAT "->>>,>>9.9999":U
      VtaDDocu.PorDto FORMAT ">>9.9999":U
      VtaDDocu.PorDto2 FORMAT ">>9.9999":U
      VtaDDocu.Por_Dsctos[1] FORMAT "->>9.99":U
      VtaDDocu.PreUni FORMAT ">,>>>,>>9.999999":U
      VtaDDocu.ImpLin FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 106 BY 10.5
...
"VtaDDocu.Libre_c01" "Pag" "x(4)" "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDDocu.CodMat" "Codigo" ? "character" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no "25" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
