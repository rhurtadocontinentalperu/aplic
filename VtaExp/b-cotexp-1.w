...
FacDPedi.CanPed FacDPedi.PorDto FacDPedi.Por_Dsctos[1] FacDPedi.PreUni ~
FacDPedi.ImpLin 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 8
         BGCOLOR 15 FONT 4.
...
"FacDPedi.CanPed" ? ">>,>>>.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.Por_Dsctos[1]" "% Dscto!2" ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
