...
&Scoped-Define ENABLED-OBJECTS RECT-21 RECT-22 RECT-65 f-CodAge f-RucAge ~
f-Marca f-Placa f-Traslado F-CodTran F-Direccion F-Lugar F-Contacto ~
F-horario F-Fecha F-Observ Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS f-CodAge f-NomTra f-RucAge f-Marca f-Placa ~
...
DEFINE FRAME F-Main
     f-CodAge AT ROW 2.08 COL 15 COLON-ALIGNED WIDGET-ID 40
     f-NomTra AT ROW 2.08 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     f-RucAge AT ROW 2.88 COL 15 COLON-ALIGNED WIDGET-ID 42
     f-Marca AT ROW 3.69 COL 15 COLON-ALIGNED WIDGET-ID 48
     f-Placa AT ROW 4.5 COL 15 COLON-ALIGNED WIDGET-ID 46
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtaexp/b-vehic.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-vehic ).
       RUN set-position IN h_b-vehic ( 1.54 , 81.00 ) NO-ERROR.
       RUN set-size IN h_b-vehic ( 5.77 , 35.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-vehic ,
             f-CodAge:HANDLE IN FRAME F-Main , 'BEFORE':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY f-CodAge f-NomTra f-RucAge f-Marca f-Placa f-Traslado F-CodTran 
          F-Nombre F-ruc F-Direccion F-Lugar F-Contacto F-horario F-Fecha 
          F-Observ 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-21 RECT-22 RECT-65 f-CodAge f-RucAge f-Marca f-Placa f-Traslado 
