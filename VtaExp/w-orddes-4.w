...
DEFINE FRAME F-Main
     B-AGTRANS AT ROW 8.81 COL 93 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 108.86 BY 17.88
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv13 ).
       RUN set-position IN h_p-updv13 ( 8.81 , 30.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-orddes-4 ).
       RUN set-position IN h_b-orddes-4 ( 10.15 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-orddes-4 ( 8.08 , 96.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpdes-4 ).
       RUN set-position IN h_b-tmpdes-4 ( 10.15 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-tmpdes-4 ( 8.35 , 100.00 ) NO-ERROR.
