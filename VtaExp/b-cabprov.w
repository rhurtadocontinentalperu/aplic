...
Nombres que contenga|y||INTEGRAL.w-report.Campo-C[1]
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "Nombres que inicien con,Nombres que contenga",
     Keys-Supplied = ':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      w-report.Llave-C COLUMN-LABEL "Código" FORMAT "x(11)":U
...
"Llave-C" "Código" "x(11)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.w-report.Campo-C[1]
"Campo-C[1]" "Proveedores" "X(50)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    ...
    WHEN 'Nombres que contenga':U THEN DO:
       &Scope KEY-PHRASE ( {&Filtro2} )
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* Nombres que contenga */
    OTHERWISE DO:
