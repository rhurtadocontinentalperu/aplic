...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE B-CDOCU THEN DO:
        ...
        /*IF AVAILABLE FacCPedi THEN RUN vtaexp\w-agtrans(ROWID(FacCPedi)).*/
        IF AVAILABLE FacCPedi THEN RUN vtaexp\w-agtrans-01(ROWID(FacCPedi), ROWID(Ccbcdocu)).
        /*IF AVAILABLE FacCPedi THEN RUN vtaexp\w-agtrans-02(ROWID(FacCPedi), ROWID(Ccbcdocu)). /*PRUEBA*/*/
    END.
...
/*                                                                                                     */
  ...
  /*IF CcbCDocu.FlgEst <> "A" THEN RUN vtaexp/R-ImpGMA.R(ROWID(CcbCDocu)).*/
  IF CcbCDocu.FlgEst <> "A" THEN RUN vtaexp/r-impgma-01 (ROWID(CcbCDocu)).
