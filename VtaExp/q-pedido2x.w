...
&SCOPED-DEFINE CONDICION ( VtaCDocu.CodCia = S-CODCIA AND ~
                           ...
                           VtaCDocu.NroPed BEGINS STRING(S-NROSER,"999") )
*/
/*
&SCOPED-DEFINE CONDICION ( VtaCDocu.CodCia = S-CODCIA AND ~ 
                            VtaCDocu.CodDiv = S-CODDIV AND ~ 
                            VtaCDocu.CodPed = S-CODDOC AND ~ 
                            VtaCDocu.Usuario = S-USER-ID AND ~ 
                            VtaCDocu.NroPed BEGINS STRING(S-NROSER,"999")) 
*/
&SCOPED-DEFINE CONDICION ( VtaCDocu.CodCia = S-CODCIA AND ~
                           VtaCDocu.CodDiv = S-CODDIV AND ~
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    IF s-coddoc = 'PET' THEN RUN vta2/c-precotizacion (s-Titulo).
    ELSE RUN vta2/c-cotizacion (s-Titulo).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND VtaCDocu WHERE {&CONDICION} AND
     VtaCDocu.NroPed = STRING(S-NROSER,"999") + STRING(F-Numero,"999999") 
     NO-LOCK NO-ERROR.
