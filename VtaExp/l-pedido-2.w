...
<FOREIGN-KEYS>
Nombre de Cliente|y|y|INTEGRAL.FacCPedi.NomCli
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "Nombre de Cliente",
     Keys-Supplied = "Nombre de Cliente"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "Nombre de Cliente" "FacCPedi" "NomCli"}
