...
DEF VAR c-TipVta AS CHAR NO-UNDO.
c-TipVta = IF input-var-2 = 'FAC' THEN '1' ELSE '2'.
&SCOPED-DEFINE CONDICION ( FacCPedi.CodCia = S-CODCIA AND ~
                           FacCPedi.CodDoc = input-var-1 AND ~
                           FacCPedi.TipVta = c-TipVta AND ~
                           FacCPedi.FlgEst = "P" AND ~
                           FacCPedi.FlgSit = "P" AND ~
...
/*                            FacCPedi.TipVta = c-TipVta AND ~                */
/*                            FacCPedi.NroPed BEGINS C-NROSER AND ~           */
/*                            FacCPedi.FlgEst = "P" AND ~                     */
/*                            FacCPedi.FlgSit = "P" AND ~                     */
/*                            FacCPedi.CodDiv = S-CODDIV  AND ~               */
