...
/* Connected Databases 
*/
&Scoped-define WINDOW-NAME fieW-Win
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS fieW-Win 
/*********************************************************************
...
DEFINE VAR x-clasificacion-clientes AS  CHAR    INIT "" EXTENT 15.
...
DEFINE TEMP-TABLE ttListaPreciosEventosPromocional
    ...
    FIELDS  tPrecCatg   AS  DEC     FORMAT '->>,>>9.9999'   COLUMN-LABEL "Precio Categoria"     EXTENT 15 INIT 0
    FIELDS  tPFinal   AS  DEC     FORMAT '->>,>>9.9999'   COLUMN-LABEL "% Dscto Categoria"     EXTENT 15 INIT 0
    FIELDS  tPFinCatg   AS  DEC     FORMAT '->>,>>9.9999'   COLUMN-LABEL "Precio Categoria"     EXTENT 15 INIT 0
    INDEX idx01 tDesmat 
    .
...
DEFINE VAR x-total-clasif AS INT    INIT 0.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 ttListaPreciosEventosPromocional.tItem ttListaPreciosEventosPromocional.tCodmat ttListaPreciosEventosPromocional.tDesMat ttListaPreciosEventosPromocional.tUndVta ttListaPreciosEventosPromocional.tMarca ttListaPreciosEventosPromocional.tInner ttListaPreciosEventosPromocional.tMaster ttListaPreciosEventosPromocional.tPrecLista /*ttListaPreciosEventosPromocional.tPrecCateg */ ttListaPreciosEventosPromocional.tDsctoProm /*ttListaPreciosEventosPromocional.tPrecioUni */ ttListaPreciosEventosPromocional.tFlete /*ttListaPreciosEventosPromocional.tPrecFinal */ ttListaPreciosEventosPromocional.tTipoDscto ttListaPreciosEventosPromocional.tPrecCatg[1] ttListaPreciosEventosPromocional.tPFinCatg[1] ttListaPreciosEventosPromocional.tPFinal[1] ttListaPreciosEventosPromocional.tPrecCatg[2] ttListaPreciosEventosPromocional.tPFinCatg[2] ttListaPreciosEventosPromocional.tPFinal[2] ttListaPreciosEventosPromocional.tPrecCatg[3] ttListaPreciosEventosPromocional.tPFinCatg[3] ttListaPreciosEventosPromocional.tPFinal[3] ttListaPreciosEventosPromocional.tPrecCatg[4] ttListaPreciosEventosPromocional.tPFinCatg[4] ttListaPreciosEventosPromocional.tPFinal[4] ttListaPreciosEventosPromocional.tPrecCatg[5] ttListaPreciosEventosPromocional.tPFinCatg[5] ttListaPreciosEventosPromocional.tPFinal[5] ttListaPreciosEventosPromocional.tPrecCatg[6] ttListaPreciosEventosPromocional.tPFinCatg[6] ttListaPreciosEventosPromocional.tPFinal[6] ttListaPreciosEventosPromocional.tPrecCatg[7] ttListaPreciosEventosPromocional.tPFinCatg[7] ttListaPreciosEventosPromocional.tPFinal[7] ttListaPreciosEventosPromocional.tPrecCatg[8] ttListaPreciosEventosPromocional.tPFinCatg[8] ttListaPreciosEventosPromocional.tPFinal[8] ttListaPreciosEventosPromocional.tPrecCatg[9] ttListaPreciosEventosPromocional.tPFinCatg[9] ttListaPreciosEventosPromocional.tPFinal[9] ttListaPreciosEventosPromocional.tPrecCatg[10] ttListaPreciosEventosPromocional.tPFinCatg[10] ttListaPreciosEventosPromocional.tPFinal[10] ttListaPreciosEventosPromocional.tPrecCatg[11] ttListaPreciosEventosPromocional.tPFinCatg[11] ttListaPreciosEventosPromocional.tPFinal[11] ttListaPreciosEventosPromocional.tPrecCatg[12] ttListaPreciosEventosPromocional.tPFinCatg[12] ttListaPreciosEventosPromocional.tPFinal[12] ttListaPreciosEventosPromocional.tcodprov ttListaPreciosEventosPromocional.tnomprov   
...
COMBO-BOX-ClasificacionCliente RADIO-SET-tipocliente BUTTON-3 ~
...
DEFINE VAR fieW-Win AS WIDGET-HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 fieW-Win _FREEFORM
  QUERY BROWSE-2 DISPLAY
    ...
    ttListaPreciosEventosPromocional.tPrecCatg[1]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!PrecCatg"    
    ttListaPreciosEventosPromocional.tPFinCatg[1]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[1]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[2]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "2!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[2]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "2!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[2]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[3]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "3!PrecCatg"    
    ttListaPreciosEventosPromocional.tPFinCatg[3]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "3!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[3]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[4]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "4!PrecCatg"    
    ttListaPreciosEventosPromocional.tPFinCatg[4]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "4!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[4]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[5]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "5!PrecCatg"    
    ttListaPreciosEventosPromocional.tPFinCatg[5]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "5!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[5]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[6]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "6!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[6]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "6!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[6]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[7]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "7!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[7]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "7!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[7]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[8]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "8!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[8]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "8!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[8]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[9]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "9!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[9]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "9!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[9]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[10]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "10!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[10]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "10!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[10]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[11]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "11!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[11]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "11!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[11]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tPrecCatg[12]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "12!PrecCatg"
    ttListaPreciosEventosPromocional.tPFinCatg[12]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "12!PrecFin"
    ttListaPreciosEventosPromocional.tPFinal[12]   FORMAT  '->>,>>9.9999'   COLUMN-LABEL "1!%Dscto"          
    ttListaPreciosEventosPromocional.tcodprov    FORMAT 'x(12)'     COLUMN-LABEL "Cod.Proveedor"
    ttListaPreciosEventosPromocional.tnomprov    FORMAT 'x(80)'     COLUMN-LABEL "Nombre Proveedor"   WIDTH 45
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 131 BY 8.27 ROW-HEIGHT-CHARS .65 FIT-LAST-COLUMN.

DEFINE BROWSE BROWSE-3
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 fieW-Win _FREEFORM
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 131 BY 9.04 FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     BROWSE-2 AT ROW 9.96 COL 2.57 WIDGET-ID 200
     BROWSE-3 AT ROW 20.38 COL 2.43 WIDGET-ID 300
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _INCLUDED-LIB fieW-Win 
/* ************************* Included-Libraries *********************** */
...
/* SETTINGS FOR FILL-IN FILL-IN-ruta IN FRAME F-Main
   NO-ENABLE                                                            */
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(fieW-Win)
THEN fieW-Win:HIDDEN = yes.
...
&Scoped-define SELF-NAME fieW-Win
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fieW-Win fieW-Win
ON END-ERROR OF fieW-Win /* Calculos de Precios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fieW-Win fieW-Win
ON WINDOW-CLOSE OF fieW-Win /* Calculos de Precios */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-1 fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-2 fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-3 fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-BOX-ClasificacionCliente fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-BOX-familia fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-proveedor fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RADIO-SET-calculo fieW-Win
...
DO:
    DO WITH FRAME {&FRAME-NAME} :
        ...
        IF radio-set-calculo:SCREEN-VALUE = '1' THEN DO:
            ...
            BROWSE-2:X = 11.
            BROWSE-2:Y = 235.
            BROWSE-2:height = 14.75.
        END.
        ELSE DO: 
            BROWSE-3:VISIBLE = YES.
            BROWSE-3:X = 11.
            BROWSE-3:Y = 235.
            BROWSE-3:height = 14.75.
        END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RADIO-SET-proveedor fieW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK fieW-Win 
...
DEF VAR t_celda_br_prcctg AS WIDGET-HANDLE EXTENT 80 NO-UNDO. 
DEF VAR t_celda_br_pfinctg AS WIDGET-HANDLE EXTENT 80 NO-UNDO. 
DEF VAR t_celda_br_pdsctoctg AS WIDGET-HANDLE EXTENT 80 NO-UNDO. 
...
DO t_n_cols_browse = 1 TO browse-2:NUM-COLUMNS. 
 ...
 IF CAPS(t_cual_celda:NAME) = "TPRECCATG"  THEN DO:
     x-corre = x-corre + 1.
     t_cual_celda:LABEL-FGCOLOR = 4.
     IF CAPS(t_cual_celda:NAME) = "TPRECCATG" THEN t_celda_br_prcctg[x-corre] = t_celda_br[t_n_cols_browse].      
 END.
 ELSE t_cual_celda:LABEL-FGCOLOR = 9.
END.
...
DO t_n_cols_browse = 1 TO browse-2:NUM-COLUMNS. 
 t_celda_br[t_n_cols_browse] = browse-2:GET-BROWSE-COLUMN(t_n_cols_browse). 
 t_cual_celda = t_celda_br[t_n_cols_browse]. 
 IF CAPS(t_cual_celda:NAME) = "TPFINCATG" THEN DO:
     x-corre = x-corre + 1.
     t_cual_celda:LABEL-FGCOLOR = 4.
     IF CAPS(t_cual_celda:NAME) = "TPFINCATG" THEN t_celda_br_pfinctg[x-corre] = t_celda_br[t_n_cols_browse]. 
 END. 
END.
...
DO t_n_cols_browse = 1 TO browse-2:NUM-COLUMNS. 
 t_celda_br[t_n_cols_browse] = browse-2:GET-BROWSE-COLUMN(t_n_cols_browse). 
 t_cual_celda = t_celda_br[t_n_cols_browse]. 
 IF CAPS(t_cual_celda:NAME) = "TPFINAL" THEN DO:
     x-corre = x-corre + 1.
     t_cual_celda:LABEL-FGCOLOR = 4.
     IF CAPS(t_cual_celda:NAME) = "TPFINAL" THEN t_celda_br_pdsctoctg[x-corre] = t_celda_br[t_n_cols_browse]. 
 END. 
END.

/*
FOR EACH ClfClie NO-LOCK:
    IF clfclie.pordsc <> 0 OR clfclie.pordsc1 <> 0 THEN DO:
        t_cual_celda = t_celda_br_prcctg[t_n_cols_browse]. 
        t_cual_celda:LABEL = "Precio!Categoria!" + ClfClie.categoria.
        /**/
        t_cual_celda = t_celda_br_pfinctg[t_n_cols_browse]. 
        t_cual_celda:LABEL = "Precio!Final!" + ClfClie.categoria.
        /**/
        t_n_cols_browse = t_n_cols_browse + 1.
    END.
END.

DO x-sec = t_n_cols_browse TO 12:
    t_cual_celda = t_celda_br_prcctg[x-sec]. 
    t_cual_celda:LABEL = "".
    t_cual_celda:VISIBLE = NO.
    /**/
    t_cual_celda = t_celda_br_pfinctg[x-sec]. 
    t_cual_celda:LABEL = "".
    t_cual_celda:VISIBLE = NO.
    /**/    
END.
...
DO x-sec = 1 TO 12:
    IF x-clasificacion-clientes[x-sec] <> "" THEN DO:
        t_cual_celda = t_celda_br_prcctg[x-sec]. 
        t_cual_celda:LABEL = "Precio!Categoria!" + x-clasificacion-clientes[x-sec].
        /**/
        t_cual_celda = t_celda_br_pfinctg[x-sec]. 
        t_cual_celda:LABEL = "Precio!Incl.Promo!" + x-clasificacion-clientes[x-sec].
        /**/
        t_cual_celda = t_celda_br_pdsctoctg[x-sec]. 
        t_cual_celda:LABEL = "Final+!Flete!" + x-clasificacion-clientes[x-sec].
        /**/        
        t_n_cols_browse = t_n_cols_browse + 1.
    END.
    ELSE DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE adm-create-objects fieW-Win  _ADM-CREATE-OBJECTS
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE adm-row-available fieW-Win  _ADM-ROW-AVAILABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE cargar-subfamilia fieW-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI fieW-Win  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dscto-x-vol-acumulado fieW-Win 
    ...
    FOR EACH x-factabla WHERE x-factabla.codcia = s-codcia AND 
        ...
        REPEAT x-sec = 1 TO 10:
            IF factabla.Valor[x-sec] > 0 THEN DO:
                ...
                RUN vta2/precio-de-venta-eventos.r(INPUT x-tipo-pedido, INPUT x-lista-de-precio, INPUT x-codclie,
                                                   INPUT x-moneda, INPUT-OUTPUT x-undvta, OUTPUT x-factor, 
                                                   INPUT x-codmat, INPUT x-cond-vta,
                                                   INPUT x-cantidad, INPUT x-nro-dec, OUTPUT x-prebas,
                                                   OUTPUT x-prevta, OUTPUT f-dsctos, OUTPUT x-dsctos,
                                                   OUTPUT x-tipdto, INPUT x-clasificacion-cliente, 
                                                   OUTPUT x-flete-unitario, INPUT NO).

                x-dsctos = factabla.Valor[x-sec + 10].
                ...
                /**/
                RUN _graba_detalle(INPUT x-sec, INPUT x-cantidad, INPUT x-dsctos, INPUT x-prevta).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI fieW-Win  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-listaprecios COMBO-BOX-familia COMBO-BOX-subfamilia 
      ...
      WITH FRAME F-Main IN WINDOW fieW-Win.
  ENABLE RECT-1 COMBO-BOX-listaprecios COMBO-BOX-familia COMBO-BOX-subfamilia 
         BUTTON-1 COMBO-BOX-ClasificacionCliente RADIO-SET-tipocliente BUTTON-3 
         RADIO-SET-calculo RADIO-SET-proveedor FILL-IN-proveedor BUTTON-2 
         BROWSE-2 BROWSE-3 
      WITH FRAME F-Main IN WINDOW fieW-Win.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE encabezados-excel fieW-Win 
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    chWorkSheet:Range("C2"):VALUE = ENTRY(combo-box-familia:LOOKUP(combo-box-familia) * 2 - 1 , combo-box-familia:LIST-ITEM-PAIRS,"|" ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enviar-a-excel fieW-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-exit fieW-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-initialize fieW-Win 
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    COMBO-BOX-clasificacioncliente:DELIMITER = "|".
      ...
      FOR EACH gn-divi WHERE gn-divi.codcia = s-codcia AND
                                (gn-divi.campo-char[1] = 'L' /*OR gn-divi.campo-char[1] = 'L'*/)
                            NO-LOCK:
      ...
      FOR EACH ClfClie NO-LOCK:
          IF clfclie.pordsc <> 0 OR clfclie.pordsc1 <> 0 THEN DO:
              x-total-clasif = x-total-clasif + 1.
              COMBO-BOX-clasificacioncliente:ADD-LAST(ClfClie.descat, ClfClie.categoria).
              IF TRUE <> (COMBO-BOX-clasificacioncliente:SCREEN-VALUE > "") THEN COMBO-BOX-clasificacioncliente:SCREEN-VALUE = ClfClie.categoria.
              x-clasificacion-clientes[x-total-clasif] = ClfClie.categoria.
          END.
      END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE procesa-parametros fieW-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proceso-calculo fieW-Win 
...
DEFINE VAR x-sec AS INT INIT 0.
DEFINE VAR x-sec1 AS INT INIT 0.
DEFINE VAR x-hdr AS LOG.
    ...
    FOR EACH almmmatg WHERE almmmatg.codcia = s-codcia AND 
        ...
        IF AVAILABLE VtaListaMay THEN DO:
            ...
            IF radio-set-calculo <> 1 THEN DO:
                ...
                REPEAT x-sec = 1 TO 10:
                    IF vtalistamay.DtoVolR[x-sec] > 0 THEN DO:
                        ...
                        RUN vta2/precio-de-venta-eventos.r(INPUT x-tipo-pedido, INPUT x-lista-de-precio, INPUT x-codclie,
                                                           INPUT x-moneda, INPUT-OUTPUT x-undvta, OUTPUT x-factor, 
                                                           INPUT vtalistamay.codmat, INPUT x-cond-vta,
                                                           INPUT x-cantidad, INPUT x-nro-dec, OUTPUT x-prebas,
                                                           OUTPUT x-prevta, OUTPUT f-dsctos, OUTPUT x-dsctos,
                                                           OUTPUT x-tipdto, INPUT x-clasificacion-cliente, 
                                                           OUTPUT x-flete-unitario, INPUT NO).
            ...
            ELSE DO:
                x-hdr = YES.
                DO x-sec1 = 1 TO 12:
                    IF x-clasificacion-clientes[x-sec1] <> "" THEN DO:
                        x-cantidad = 1.
                        x-nro-dec = 4.
                        x-prebas = 0.
                        x-prevta = 0.
                        ...
                        x-clasificacion-cliente = x-clasificacion-clientes[x-sec1].
                        ...
                        IF vtalistamay.codmat = '044714'  THEN DO:
                            /*MESSAGE x-flete-unitario.*/
                        END.

                        IF X-TIPDTO <> "VOL" THEN DO:

                            FIND FIRST clfclie WHERE clfclie.categoria = x-clasificacion-cliente NO-LOCK NO-ERROR.
                            ...
                            END.
                            /* */
                            ttListaPreciosEventosPromocional.tPrecCatg[x-sec1]  = x-prevta.                            
                            ttListaPreciosEventosPromocional.tPFinCatg[x-sec1]  = if(x-dsctos <> 0) THEN 
                                Round(x-prevta * ( 1 - x-dsctos / 100), x-nro-dec) ELSE x-prevta.
                            ttListaPreciosEventosPromocional.tPFinal[x-sec1] = ttListaPreciosEventosPromocional.tPFinCatg[x-sec1] + x-flete-unitario.
                        END.
                    END.
                END.
            END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE recoge-parametros fieW-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE send-records fieW-Win  _ADM-SEND-RECORDS
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE state-changed fieW-Win 
