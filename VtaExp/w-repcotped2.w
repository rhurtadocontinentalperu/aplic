...
&Scoped-Define ENABLED-OBJECTS x-FlgEst F-DIVISION BUTTON-5 txt-codcli ~
DesdeF HastaF Btn_OK Btn_Cancel RECT-64 RECT-65 
&Scoped-Define DISPLAYED-OBJECTS x-FlgEst F-DIVISION txt-codcli txt-nomcli ~
DesdeF HastaF txt-msj 
...
DEFINE FRAME F-Main
     x-FlgEst AT ROW 4.77 COL 41 NO-LABEL WIDGET-ID 28
     F-DIVISION AT ROW 2.08 COL 8 COLON-ALIGNED WIDGET-ID 6
     BUTTON-5 AT ROW 2.08 COL 21 WIDGET-ID 2
     txt-codcli AT ROW 3.42 COL 8 COLON-ALIGNED WIDGET-ID 24
     txt-nomcli AT ROW 3.42 COL 19 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     DesdeF AT ROW 4.77 COL 8 COLON-ALIGNED WIDGET-ID 4
     HastaF AT ROW 4.77 COL 24 COLON-ALIGNED WIDGET-ID 8
...
ON END-ERROR OF W-Win /* COTIZACIONES  PENDIENTES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* COTIZACIONES  PENDIENTES */
DO:
...
DO:
    ...
    ASSIGN 
        F-DIVISION DesdeF HastaF txt-codcli x-flgest
        cCodDoc = "COT"
...
------------------------------------------------------------------------------*/
  DISPLAY x-FlgEst F-DIVISION txt-codcli txt-nomcli DesdeF HastaF txt-msj 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE x-FlgEst F-DIVISION BUTTON-5 txt-codcli DesdeF HastaF Btn_OK 
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH faccpedi WHERE faccpedi.codcia = s-codcia
        ...
        AND faccpedi.flgest = x-flgest NO-LOCK,
        ...
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):Value = (facdpedi.canped * facDPedi.PreUni).
        cRange = "M" + cColumn.
        chWorkSheet:Range(cRange):Value = facdpedi.canate.
        cRange = "N" + cColumn.
        chWorkSheet:Range(cRange):Value = (facdpedi.canate * facDPedi.PreUni).
    END.
