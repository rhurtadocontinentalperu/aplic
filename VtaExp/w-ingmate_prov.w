...
&Scoped-Define ENABLED-OBJECTS RECT-70 BUTTON-3 BUTTON-2 BUTTON-4 
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 2.88 COL 134 WIDGET-ID 14
     BUTTON-2 AT ROW 6.08 COL 134 WIDGET-ID 16
     BUTTON-4 AT ROW 9.31 COL 134 WIDGET-ID 30
     "Exportar Listado" VIEW-AS TEXT
          SIZE 11 BY .62 AT ROW 5.27 COL 134 WIDGET-ID 18
          FONT 1
     ...
     "Cliente:" VIEW-AS TEXT
          ...
          BGCOLOR 8 
     "Importar Listado" VIEW-AS TEXT
          SIZE 11 BY .62 AT ROW 8.46 COL 134 WIDGET-ID 20
          FONT 1
...
DO:
    RUN Importar-Excel IN h_b-detcatvta_prov.
END.
...
DO:
    /*RUN Genera-Excel IN h_b-pagcatvtas.*/
    RUN Genera-Listado IN h_b-detcatvta_prov.
...
DO:
  RUN Genera-Excel IN h_b-detcatvta_prov.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-70 BUTTON-3 BUTTON-2 BUTTON-4 
      WITH FRAME F-Main IN WINDOW W-Win.
