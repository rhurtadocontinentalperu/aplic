...
Almmmatg.DesMar Almmmatg.UndBas DATOS.Libre_d01 DATOS.NroSec 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 95 BY 12.65
         FONT 4
...
DEFINE FRAME F-Main
     ...
     btn-save AT ROW 3.15 COL 97.43 WIDGET-ID 6
     "GRABAR" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 5.58 COL 98.14 WIDGET-ID 8
          FONT 6
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH datos WHERE datos.codcia = s-codcia
        ...
        END.
        PEDI2.CanPed    = datos.libre_d01. /*Cantidad ingresada*/
        PEDI2.Libre_d01 = datos.libre_d01. /*Copia de información*/
    END.
