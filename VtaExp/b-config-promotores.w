...
VtaTabla.LLave_c3 VtaTabla.Libre_c01 VtaTabla.Libre_c02 VtaTabla.Llave_c4 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaTabla.Libre_c01 COLUMN-LABEL "Nombre Promotor" FORMAT "x(40)":U
            WIDTH 39.86 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      VtaTabla.Libre_c02 COLUMN-LABEL "Equipo" FORMAT "x(10)":U
            WIDTH 11.72 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11 VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEMS "ROJO","CELESTE","AMARILLO","VERDE","NARANJA","AGUA MARINA","AZUL","BLANCO" 
                      DROP-DOWN-LIST 
      VtaTabla.Llave_c4 COLUMN-LABEL "DNI" FORMAT "x(12)":U WIDTH 15.43
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
      VtaTabla.Llave_c2
      VtaTabla.LLave_c3
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 145 BY 22.88
...
"VtaTabla.LLave_c3" "Promotor" ? "character" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "FILL-IN" "," ? ? 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Libre_c01
"VtaTabla.Libre_c01" "Nombre Promotor" "x(40)" "character" 11 0 ? ? ? ? yes ? no no "39.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaTabla.Libre_c02
"VtaTabla.Libre_c02" "Equipo" "x(10)" "character" 11 0 ? ? ? ? yes ? no no "11.72" yes no no "U" "" "" "DROP-DOWN-LIST" "," "ROJO,CELESTE,AMARILLO,VERDE,NARANJA,AGUA MARINA,AZUL,BLANCO" ? 5 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaTabla.Llave_c4
"VtaTabla.Llave_c4" "DNI" "x(12)" "character" 11 0 ? ? ? ? yes ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF TRUE <> (VtaTabla.Llave_c4:SCREEN-VALUE IN BROWSE {&browse-name} > '')
    THEN DO:
    MESSAGE 'NO ha ingresado el campo DNI' SKIP
...
END.
ELSE DO:
    IF LENGTH(VtaTabla.Llave_c4:SCREEN-VALUE IN BROWSE {&browse-name}) < 8 
        THEN DO:
        MESSAGE 'El DNI debe tener al menos 8 caracteres' VIEW-AS ALERT-BOX WARNING.
        APPLY 'ENTRY':U TO VtaTabla.Llave_c4.
        RETURN 'ADM-ERROR'.
    END.
END.
