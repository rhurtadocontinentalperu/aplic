...
DEFINE FRAME F-Main
     ...
     RECT-69 AT ROW 12.04 COL 3 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 113.72 BY 22.81
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotexp-2 ).
       RUN set-position IN h_b-cotexp-2 ( 12.31 , 4.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-cotexp-2x ( 12.31 , 4.57 ) NO-ERROR.
