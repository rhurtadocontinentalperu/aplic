...
&Scoped-Define ENABLED-OBJECTS txt-codpro FILL-IN-file BUTTON-5 BUTTON-1 ~
BUTTON-4 
&Scoped-Define DISPLAYED-OBJECTS txt-codpro txt-nompro FILL-IN-file ~
txt-Mensaje 
...
DEFINE FRAME F-Main
     txt-codpro AT ROW 2.08 COL 15 COLON-ALIGNED WIDGET-ID 12
     txt-nompro AT ROW 2.08 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     FILL-IN-file AT ROW 3.15 COL 15 COLON-ALIGNED WIDGET-ID 68
     BUTTON-5 AT ROW 3.15 COL 77 WIDGET-ID 66
     BUTTON-1 AT ROW 5.31 COL 64 WIDGET-ID 2
     BUTTON-4 AT ROW 5.31 COL 73 WIDGET-ID 8
     txt-Mensaje AT ROW 6.12 COL 4 NO-LABEL WIDGET-ID 74
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 85.29 BY 7.54 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Imprime Lista de Pedidos por Cliente"
         HEIGHT             = 7.54
         WIDTH              = 85.29
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 91.72
...
ON END-ERROR OF W-Win /* Imprime Lista de Pedidos por Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Imprime Lista de Pedidos por Cliente */
DO:
...
DO:
    ASSIGN txt-codpro fill-in-file .
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH tt-clientes WHERE tt-clientes.codcli <> "" 
        AND tt-clientes.codcli <> ? NO-LOCK:   /*Tabla Clientes*/
        FOR EACH almcatvtac WHERE almcatvtac.codcia = s-codcia
            ...
            IF NOT AVAIL w-report THEN DO:
                ...
                FIND FIRST gn-clie WHERE gn-clie.codcia = cl-codcia
                    AND gn-clie.codcli = tt-clientes.codcli NO-LOCK NO-ERROR.
                ...
                /*Busca Historico*/
                FIND FIRST b-report WHERE b-report.task-no = 9147 
                    AND b-report.llave-c = tt-clientes.codcli
                    AND b-report.Campo-C[1] = almcatvtad.codmat NO-LOCK NO-ERROR.
                IF AVAIL b-report THEN w-report.Campo-F[3] = b-report.Campo-F[1]. 
...
------------------------------------------------------------------------------*/
  DISPLAY txt-codpro txt-nompro FILL-IN-file txt-Mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-codpro FILL-IN-file BUTTON-5 BUTTON-1 BUTTON-4 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    ...
    IF txt-codpro = '51135890' THEN RB-REPORT-NAME = 'Imprime Catalogo Ventas'.
    ELSE RB-REPORT-NAME = 'Imprime Catalogo Ventas Otros'.
