...
&Scoped-define FIELDS-IN-QUERY-BROWSE-9 t-gn-clie.CodCli t-gn-clie.LocCli 
...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-3 RECT-4 BROWSE-9 Btn_OK 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-9 D-Dialog _STRUCTURED
  QUERY BROWSE-9 NO-LOCK DISPLAY
      t-gn-clie.CodCli FORMAT "x(11)":U
      t-gn-clie.LocCli COLUMN-LABEL "Tipo" FORMAT "x(15)":U WIDTH 15.14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 34 BY 7.81 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     BROWSE-9 AT ROW 2.35 COL 6 WIDGET-ID 200
     ...
     "5" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 0 
     "A                       | B" VIEW-AS TEXT
          SIZE 32 BY .62 AT ROW 1.54 COL 7 WIDGET-ID 2
          BGCOLOR 8 FGCOLOR 0 
     "1" VIEW-AS TEXT
...
/* SETTINGS FOR DIALOG-BOX D-Dialog
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-9 RECT-4 D-Dialog */
ASSIGN 
...
/* Query rebuild information for BROWSE BROWSE-9
     ...
     _FldNameList[2]   > Temp-Tables.t-gn-clie.LocCli
"LocCli" "Tipo" "x(15)" "character" ? ? ? ? ? ? no ? no no "19.14" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "OTROS,,VIP,VIP,MESA REDONDA,MR" 5 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-9 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ENABLE RECT-2 RECT-3 RECT-4 BROWSE-9 Btn_OK 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR Glosa AS CHAR INIT "VIP,MR" NO-UNDO.
  ...
  FOR EACH gn-clie NO-LOCK WHERE gn-clie.codcia = cl-codcia
      ...
      CASE k:
          WHEN 1 THEN t-gn-clie.loccli = "VIP".
          WHEN 2 THEN t-gn-clie.loccli = "MR".
          OTHERWISE t-gn-clie.loccli = "".
      END CASE.
      IF k = 5 THEN LEAVE.
  END.
