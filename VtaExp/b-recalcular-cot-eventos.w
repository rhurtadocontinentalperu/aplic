...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi OF GN-DIVI WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.FchPed <= x-FchPed-2 AND FacCPedi.CodDoc = "COT" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 17.23
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "FacCPedi.FchPed >= x-FchPed-1
 AND FacCPedi.FchPed <= x-FchPed-2 AND FacCPedi.CodDoc = ""COT"""
