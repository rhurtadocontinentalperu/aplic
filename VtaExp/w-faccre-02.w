  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv14 ).
       RUN set-position IN h_p-updv14 ( 6.96 , 42.72 ) NO-ERROR.
       RUN set-size IN h_p-updv14 ( 1.31 , 37.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-docmto-2 ).
       RUN set-position IN h_q-docmto-2 ( 6.96 , 16.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.04 , 8.29 ) */

       /* Links to SmartViewer h_v-faccre-02. */
       RUN add-link IN adm-broker-hdl ( h_p-updv14 , 'TableIO':U , h_v-faccre-02 ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-docmto ).
       RUN set-position IN h_b-docmto ( 8.54 , 2.00 ) NO-ERROR.
