...
&Scoped-define FIELDS-IN-QUERY-br_table ExpTurno.Turno ExpTurno.NroDig ~
ExpTurno.Hora ExpTurno.CodCli gn-clie.NomCli ExpTurno.Estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ExpTurno.NroDig COLUMN-LABEL "Digita" FORMAT ">>>>>9":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 76 BY 11.35
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "INTEGRAL.ExpTurno.Tipo = ""V""
...
"ExpTurno.NroDig" "Digita" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.ExpTurno.Hora
     _FldNameList[4]   > INTEGRAL.ExpTurno.CodCli
...
chWorkSheet:Range("B2"):Value = "ESTADISTICA DE VENTAS DEL 1 AL 31 MARZO".

FIND FIRST gn-ven WHERE gn-ven.codcia = s-codcia
    AND gn-ven.codven = INTEGRAL.ExpTurno.CodVen NO-LOCK NO-ERROR.

IF AVAIL gn-ven THEN chWorkSheet:Range("B3"):Value = "VENDEDOR: " + INTEGRAL.gn-ven.NomVen.
...
FOR EACH w-report WHERE w-report.task-no = 9900
    AND w-report.llave-c = expturno.codcli NO-LOCK,
