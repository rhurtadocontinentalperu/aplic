...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      fPorAtender('V') @ x-Pendientes COLUMN-LABEL "Ventas" WIDTH 10
      fPorAtender('I') @ x-Interconsulta COLUMN-LABEL "Interconsultas"
            WIDTH 24.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 92 BY 8.62
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 10.23 COL 61.57 WIDGET-ID 2
     BUTTON-4 AT ROW 10.23 COL 77.57 WIDGET-ID 4
...
"fPorAtender('V') @ x-Pendientes" "Ventas" ? ? ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"fPorAtender('I') @ x-Interconsulta" "Interconsultas" ? ? ? ? ? ? ? ? no ? no no "24.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
