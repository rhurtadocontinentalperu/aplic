...
------------------------------------------------------------------------------*/
  ...
  IF S-CODDOC = "FAC" THEN DO:
    ...
    IF LOOKUP(s-coddiv,'00000,00015') > 0 THEN RUN vtamay/r-fac00002a (ROWID(ccbcdocu)).
    ELSE RUN vtamay/r-fac00002 (ROWID(ccbcdocu)).
...
------------------------------------------------------------------------------*/
  ...
  input-var-3 = ''.
  RUN vtaexp\C-Pedido-1 ("Pedidos Pendientes").
