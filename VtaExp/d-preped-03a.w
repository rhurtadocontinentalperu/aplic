...
DEFINE FRAME gDialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "SALDO DE DEPOSITOS, ADELANTOS Y NOTA DE CREDITO"
...
ON WINDOW-CLOSE OF FRAME gDialog /* SALDO DE DEPOSITOS, ADELANTOS Y NOTA DE CREDITO */
DO:  
...
FOR EACH Ccbcdocu NO-LOCK WHERE Ccbcdocu.codcia = s-codcia
    AND LOOKUP(Ccbcdocu.coddoc, 'BD,A/R,N/C') > 0
