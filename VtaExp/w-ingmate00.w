...
DEFINE VARIABLE h_b-prov02 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 107.14 BY 27.15 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtaexp/b-prov02.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prov02 ).
       RUN set-position IN h_b-prov02 ( 1.00 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-prov02 ( 5.12 , 84.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cabcatvta00 ( 7.46 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-cabcatvta00 ( 7.27 , 67.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-detcatvta ( 15.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-detcatvta ( 12.65 , 105.43 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cabcatvta00. */
       RUN add-link IN adm-broker-hdl ( h_b-prov02 , 'Record':U , h_b-cabcatvta00 ).

       /* Links to SmartBrowser h_b-detcatvta. */
       RUN add-link IN adm-broker-hdl ( h_b-cabcatvta00 , 'Record':U , h_b-detcatvta ).
