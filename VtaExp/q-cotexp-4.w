...
&SCOPED-DEFINE CONDICION ( FacCPedi.CodCia = S-CODCIA AND ~
                           ...
                           ( s-user-id BEGINS 'CAA' OR FacCPedi.Usuario = S-USER-ID ) AND ~
                           NOT (Faccpedi.fchped >= 01/01/2011 AND Faccpedi.UsrSac <> '*') AND ~
...
&Scoped-Define ENABLED-OBJECTS F-Numero RECT-22 
