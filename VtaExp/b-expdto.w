...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "Periodo"
      FacTabla.Nombre COLUMN-LABEL "Descripcion" FORMAT "x(20)"
      FacTabla.Valor[1] COLUMN-LABEL "% Descuento!Linea Propia"
      FacTabla.Valor[2] COLUMN-LABEL "% Descuento!Terceros"
  ENABLE
      FacTabla.Codigo
      FacTabla.Nombre
      FacTabla.Valor[1]
...
/* Query rebuild information for BROWSE br_table
 ...
 AND INTEGRAL.FacTabla.Tabla = ""EL"""
     _FldNameList[1]   > INTEGRAL.FacTabla.Codigo
"FacTabla.Codigo" "Periodo" ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > INTEGRAL.FacTabla.Nombre
"FacTabla.Nombre" "Descripcion" "x(20)" "character" ? ? ? ? ? ? yes ?
     _FldNameList[3]   > INTEGRAL.FacTabla.Valor[1]
"FacTabla.Valor[1]" "% Descuento!Linea Propia" ? "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[4]   > INTEGRAL.FacTabla.Valor[2]
"FacTabla.Valor[2]" "% Descuento!Terceros" ? "decimal" ? ? ? ? ? ? yes ?
