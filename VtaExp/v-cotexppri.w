...
DEFINE FRAME F-Main
     VtaCDocu.NroPed AT ROW 1.19 COL 9 COLON-ALIGNED WIDGET-ID 98
          LABEL "Numero" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 13.14 BY .81
          BGCOLOR 15 FGCOLOR 1 FONT 0
     F-Estado AT ROW 1.19 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     VtaCDocu.FchPed AT ROW 1.19 COL 98 COLON-ALIGNED WIDGET-ID 82
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     BUTTON-Turno-Retrocede AT ROW 1.77 COL 74 WIDGET-ID 56
     BUTTON-Turno-Avanza AT ROW 1.77 COL 79 WIDGET-ID 54
     VtaCDocu.CodCli AT ROW 1.96 COL 9 COLON-ALIGNED HELP
          "" WIDGET-ID 60 FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCDocu.NomCli AT ROW 1.96 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 94
          VIEW-AS FILL-IN 
          SIZE 49 BY .81
     FILL-IN-1 AT ROW 1.96 COL 82 COLON-ALIGNED NO-LABEL WIDGET-ID 86
     VtaCDocu.TpoCmb AT ROW 1.96 COL 98 COLON-ALIGNED WIDGET-ID 104
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.RucCli AT ROW 2.73 COL 9 COLON-ALIGNED WIDGET-ID 100
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaCDocu.FchVen AT ROW 2.73 COL 98 COLON-ALIGNED WIDGET-ID 84
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.NroCard AT ROW 3.5 COL 9 COLON-ALIGNED WIDGET-ID 96
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
     F-Nomtar AT ROW 3.5 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     VtaCDocu.FchEnt AT ROW 3.5 COL 98 COLON-ALIGNED WIDGET-ID 80
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.DirCli AT ROW 4.27 COL 9 COLON-ALIGNED WIDGET-ID 70
          VIEW-AS FILL-IN 
          SIZE 62 BY .81
     C-TpoVta AT ROW 4.27 COL 98 COLON-ALIGNED WIDGET-ID 58
     VtaCDocu.CodPos AT ROW 5.04 COL 9 COLON-ALIGNED WIDGET-ID 66
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-Postal AT ROW 5.04 COL 15 COLON-ALIGNED NO-LABEL WIDGET-ID 88
     VtaCDocu.CodMon AT ROW 5.23 COL 100 NO-LABEL WIDGET-ID 62
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.57 BY .81
     VtaCDocu.CodVen AT ROW 5.81 COL 9 COLON-ALIGNED WIDGET-ID 68 FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
     F-nOMvEN AT ROW 5.81 COL 15 COLON-ALIGNED NO-LABEL WIDGET-ID 78
     VtaCDocu.FmaPgo AT ROW 6.58 COL 9 COLON-ALIGNED WIDGET-ID 90
          LABEL "Cond.Vta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
     F-CndVta AT ROW 6.58 COL 15 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     VtaCDocu.Glosa AT ROW 7.35 COL 6.29 WIDGET-ID 92
          VIEW-AS FILL-IN 
          SIZE 62 BY .81
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.23 COL 93 WIDGET-ID 102
