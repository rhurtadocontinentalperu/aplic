...
AlmCatVtaD.Libre_d02 AlmCatVtaD.Libre_d03 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmCatVtaD.Libre_d02 COLUMN-LABEL "Mín. Venta" FORMAT ">>>,>>9.99":U
            WIDTH 8.43
  ...
  ENABLE
      AlmCatVtaD.codmat
      AlmCatVtaD.Libre_d02
      AlmCatVtaD.Libre_d03
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 99 BY 10.15
         FONT 4
         TITLE "Lista de Artículos" FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 5.81 COL 104.72 WIDGET-ID 12
     "Actualiza" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 3.12 COL 103.72 WIDGET-ID 6
     "Número" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 3.92 COL 104.14 WIDGET-ID 8
     "de Secuencia" VIEW-AS TEXT
          SIZE 12 BY .62 AT ROW 4.73 COL 101.72 WIDGET-ID 10
...
/* BROWSE-TAB br_table TEXT-3 F-Main */
ASSIGN 
...
"AlmCatVtaD.codmat" "Codigo" ? "character" ? ? ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmCatVtaD.Libre_d02" "Mín. Venta" ">>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.AlmCatVtaD.Libre_d03
"AlmCatVtaD.Libre_d03" "Empaque" ">>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmCatVtaD.Libre_c05" "Descripcion Grupo" ? "character" ? ? ? ? ? ? no ? no no "19.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*   RELEASE Almmmatg.                                                    */
  ...
  IF CAN-FIND(FIRST b-almcatvtad WHERE b-almcatvtad.codcia = almcatvtac.codcia
      ...
      UNDO, RETURN 'ADM-ERROR'.
  END.
  /* Actualizamos el Catálogo General */
  FIND Almmmatg OF Almcatvtad EXCLUSIVE-LOCK NO-ERROR.
  IF NOT AVAILABLE Almmmatg THEN DO:
