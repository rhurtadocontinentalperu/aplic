...
FacDPedi.Libre_d01 FacDPedi.Libre_d02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.CanPed FORMAT ">,>>>,>>9.9999":U COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 2
      FacDPedi.Libre_d01 COLUMN-LABEL "Proyectado" FORMAT "->>>,>>>,>>9.99<<<":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      FacDPedi.Libre_d02 COLUMN-LABEL "Negociado" FORMAT "->>>,>>>,>>9.99<<<":U
...
"FacDPedi.CanPed" ? ? "decimal" 2 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacDPedi.Libre_d01
"FacDPedi.Libre_d01" "Proyectado" ? "decimal" 11 9 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.FacDPedi.Libre_d02
"FacDPedi.Libre_d02" "Negociado" ? "decimal" 12 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF DEC (FacDPedi.Libre_d02:SCREEN-VALUE IN BROWSE {&browse-name}) > FacDPedi.Libre_d01 THEN DO:
