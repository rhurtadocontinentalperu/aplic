...
DEFINE VARIABLE h_v-precotexp-1 AS HANDLE NO-UNDO.
...
DO:
    RUN Asigna-Cotizacion IN h_v-precotexp-1.  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/v-precotexp-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-precotexp-1 ).
       RUN set-position IN h_v-precotexp-1 ( 1.27 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-precotexp-1. */
       RUN add-link IN adm-broker-hdl ( h_p-updv06 , 'TableIO':U , h_v-precotexp-1 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido2x , 'Record':U , h_v-precotexp-1 ).

       /* Links to SmartQuery h_q-pedido2x. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_q-pedido2x ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-precotexp-1 ,
             BUTTON-6:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-precotexp-1 , 'AFTER':U ).
