...
Almmmatg.UndBas VtaDDocu.CanPed VtaDDocu.Libre_d02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDDocu.Libre_d02 COLUMN-LABEL "Cantidad" FORMAT "->>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
ASSIGN 
       VtaDDocu.CanPed:VISIBLE IN BROWSE br_table = FALSE.
...
"VtaDDocu.CanPed" ? ? "decimal" ? ? ? ? ? ? no ? no no ? no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.VtaDDocu.Libre_d02
"VtaDDocu.Libre_d02" "Cantidad" "->>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
