...
&SCOPED-DEFINE l-lookup h_l-pages
...
DEFINE VARIABLE h_l-pages AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/l-pages.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pages ).
       RUN set-position IN h_l-pages ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-pages ( 10.92 , 58.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pages. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pages ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pages ,
