...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ExpTurno.CodCli FORMAT "x(11)":U WIDTH 11.43
      gn-clie.NomCli FORMAT "x(250)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 73 BY 6.69
         FONT 4
         TITLE "TURNOS PENDIENTES DE ASIGNAR POR VENDEDOR".
...
"ExpTurno.NroDig" "Secuencia" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ExpTurno.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* TURNOS PENDIENTES DE ASIGNAR POR VENDEDOR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* TURNOS PENDIENTES DE ASIGNAR POR VENDEDOR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* TURNOS PENDIENTES DE ASIGNAR POR VENDEDOR */
DO:
