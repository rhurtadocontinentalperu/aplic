...
DEFINE BUTTON BUTTON-1 
     LABEL "Renumerar Secuencia Artículos" 
     SIZE 29 BY 1.12.
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* Renumerar Secuencia Artículos */
DO:
  RUN Procesa-Handle IN lh_handle ('RenumGrupoDetail').
END.
