...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCatVtaC OF VtaCatVenta  WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH AlmCatVtaC OF VtaCatVenta  WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.AlmCatVtaC OF INTEGRAL.VtaCatVenta "
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Páginas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Páginas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Páginas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  ASSIGN 
      almcatvtac.coddiv = Vtacatventa.coddiv
      almcatvtac.codcia = Vtacatventa.codcia
      almcatvtac.codpro = Vtacatventa.codpro
      NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  IF fMov(almcatvtac.codpro, almcatvtac.nropag) THEN DO: 
      MESSAGE 'Esta página tiene registros asociados' SKIP
...
/*
    DO WITH FRAME {&FRAME-NAME}:        
        IF AlmCatVtaC.DesPag:SCREEN-VALUE IN BROWSE {&BROWSE-name} = '' THEN DO:
            MESSAGE 'Debe asignar un nombre a la página'
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
        ...
        IF RETURN-VALUE = 'YES' THEN DO:
            ...
            IF AVAIL b-almcatvtac THEN DO:
                MESSAGE "Número de Página Repetido"
                    VIEW-AS ALERT-BOX INFO BUTTONS OK.
                APPLY "ENTRY" TO almcatvtac.nropag.
                RETURN "adm-error".
            END.
