...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-4 wWin _STRUCTURED
  QUERY BROWSE-4 NO-LOCK DISPLAY
      ExpTermi.Block COLUMN-LABEL "T" FORMAT "x":U WIDTH 4.43
      gn-ven.NomVen FORMAT "X(40)":U WIDTH 46.43
      fTurno() @ x-Turno COLUMN-LABEL "Turno!Siguiente" WIDTH 12.43
      fAtencionAct() @ x-AtencionAct COLUMN-LABEL "En Vendedor"
            WIDTH 16.43
      fUltAtencion() @ x-UltAtencion COLUMN-LABEL "Utl. Atención"
            WIDTH 17.43
      fPorAtender() @ x-PorAtender COLUMN-LABEL "Por Atender"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 118 BY 19.38
...
"ExpTermi.Block" "T" ? "character" ? ? ? ? ? ? no ? no no "4.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-ven.NomVen
"gn-ven.NomVen" ? ? "character" ? ? ? ? ? ? no ? no no "46.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > "_<CALC>"
"fTurno() @ x-Turno" "Turno!Siguiente" ? ? ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"fAtencionAct() @ x-AtencionAct" "En Vendedor" ? ? ? ? ? ? ? ? no ? no no "16.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fUltAtencion() @ x-UltAtencion" "Utl. Atención" ? ? ? ? ? ? ? ? no ? no no "17.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"fPorAtender() @ x-PorAtender" "Por Atender" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-4 */
&ANALYZE-RESUME
...
OCXFile = SEARCH( "w-exp007big.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-exp007big.wrx":U SKIP(1)
