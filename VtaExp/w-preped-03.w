...
DEFINE VARIABLE h_b-preped-03a AS HANDLE NO-UNDO.
...
OR ENDKEY OF {&WINDOW-NAME} ANYWHERE DO:
  ...
  RUN Eliminar-Todo IN h_b-preped-03a.
...
DO:
    ...
    RUN Carga-Temporal IN h_b-preped-03a ( INPUT FILL-IN_FchEnt).
    RUN dispatch IN h_b-preped-03a ('open-query').
...
DO:
   SESSION:SET-WAIT-STATE('GENERAL').
   RUN Proyeccion IN h_b-preped-03a.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/b-preped-03a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-preped-03a ).
       RUN set-position IN h_b-preped-03a ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-preped-03a ( 13.15 , 145.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-preped-03b. */
       RUN add-link IN adm-broker-hdl ( h_b-preped-03a , 'Record':U , h_b-preped-03b ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-preped-03b ,
             BUTTON-5:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-preped-03a ,
...
/*                              OUTPUT pImpMin).                        */
/*           /* ****************** */                                   */
/*           f-Tot = B-CPEDI.Libre_d02.                                 */
/*           IF B-CPEDI.codmon = 2 THEN f-Tot = f-Tot * B-CPEDI.tpocmb. */
/*           IF pImpMin > 0 AND f-Tot < pImpMin THEN DO:                */
/*               MESSAGE 'Error en la cotizacion' B-CPEDI.NroPed SKIP   */
/*                   'El importe debe superar los S/.' pImpMin          */
