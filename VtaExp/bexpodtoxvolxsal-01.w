...
"FacTabla.Nombre" ? ? "character" ? ? ? ? ? ? no ? no no "40.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacTabla.Campo-D[1]
"FacTabla.Campo-D[1]" "Vigente Desde" "99/99/9999" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacTabla.Campo-D[2]
"FacTabla.Campo-D[2]" "Hasta" "99/99/9999" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FIND VtaListaMay WHERE VtaListaMay.CodCia = s-CodCia AND
    ...
    VtaListaMay.codmat = T-FacTabla.Campo-C[1]
    NO-LOCK NO-ERROR.
