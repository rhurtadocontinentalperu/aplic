...
DEFINE VARIABLE h_v-pedido-2-2 AS HANDLE NO-UNDO.
...
DO:
   RUN Asigna_datos IN h_v-pedido-2-2.
END.
...
DO:
    ...
    RUN Envia_chequeo IN h_v-pedido-2-2.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/v-pedido-2-2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-2-2 ).
       RUN set-position IN h_v-pedido-2-2 ( 1.00 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pedido-2-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-pedido-2-2 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-pedido-2-2 ).

       /* Links to SmartQuery h_q-pedido. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_q-pedido ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pedido-2-2 ,
             B-CCTE:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-pedido-2-2 , 'AFTER':U ).
