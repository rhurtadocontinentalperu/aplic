...
"ImpUnit @ ImpUnit" "Importe" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > "_<CALC>"
"PreUniRef @ PreUniRef" "Precio Unit!Referencial" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "5.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
