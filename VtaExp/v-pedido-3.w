...
DEFINE FRAME F-Main
     FacCPedi.TipVta AT ROW 5.31 COL 91 NO-LABEL WIDGET-ID 4
...
"Boleta", "2":U
     ...
     FacCPedi.Atencion AT ROW 2.88 COL 26 COLON-ALIGNED
     ...
     FacCPedi.CodCli AT ROW 2.08 COL 9 COLON-ALIGNED HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.NroRef AT ROW 6.92 COL 89 COLON-ALIGNED
     ...
     F-Estado AT ROW 1.27 COL 39 COLON-ALIGNED NO-LABEL
     ...
     FacCPedi.NomCli AT ROW 2.08 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 52 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 2.08 COL 89 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.RucCli AT ROW 2.88 COL 9 COLON-ALIGNED
          LABEL "RUC"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.fchven AT ROW 2.88 COL 89 COLON-ALIGNED
          LABEL "Vencimiento" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NroCard AT ROW 3.69 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
     F-Nomtar AT ROW 3.69 COL 21 COLON-ALIGNED NO-LABEL
     FacCPedi.FchEnt AT ROW 3.69 COL 89 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.DirCli AT ROW 4.5 COL 9 COLON-ALIGNED
          LABEL "Dirección"
          VIEW-AS FILL-IN 
          SIZE 65 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodPos AT ROW 5.31 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-Postal AT ROW 5.31 COL 15 COLON-ALIGNED NO-LABEL
     FacCPedi.CodVen AT ROW 6.12 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
     F-nOMvEN AT ROW 6.12 COL 15 COLON-ALIGNED NO-LABEL
     FacCPedi.CodMon AT ROW 6.12 COL 91 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.57 BY .81
     FacCPedi.FmaPgo AT ROW 6.92 COL 9 COLON-ALIGNED
          LABEL "Cond.Vta" FORMAT "X(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
     F-CndVta AT ROW 6.92 COL 15 COLON-ALIGNED NO-LABEL
     FacCPedi.Glosa AT ROW 7.73 COL 6.28
          VIEW-AS FILL-IN 
          SIZE 65 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Situacion AT ROW 1.27 COL 55 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 6.12 COL 84
     "Tipo Venta:" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 5.54 COL 82 WIDGET-ID 8
...
------------------------------------------------------------------------------*/
  ...
  IF FacCPedi.FlgEst = "P" AND FacCPedi.FlgSit = "P"  THEN DO:
       MESSAGE "No puede eliminar un pedido Chequeado" SKIP
           "Pruebe con la opción CIERRE DE PEDIDOS"
           VIEW-AS ALERT-BOX ERROR.
       RETURN "ADM-ERROR".
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF LOOKUP(FacCPedi.FlgEst,"F,C,A") > 0 THEN DO:
      ...
      RETURN "ADM-ERROR".
  END.
  IF FacCPedi.FlgSit <> "" THEN DO:
      MESSAGE 'Ya fue enviado a chequeo' VIEW-AS ALERT-BOX WARNING.
      RETURN "ADM-ERROR".     /* A chequeo */
  END.
  ASSIGN
