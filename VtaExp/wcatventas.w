...
DEFINE FRAME F-Main
     BUTTON-6 AT ROW 1.38 COL 72 WIDGET-ID 2
     "Genera Excel de Catalogo" VIEW-AS TEXT
          SIZE 23 BY 1.15 AT ROW 1.38 COL 84 WIDGET-ID 4
          FGCOLOR 4 
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 115.57 BY 26.58 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 2.92 , 72.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-2 ).
       RUN set-position IN h_p-updv12-2 ( 10.23 , 74.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_bcatvtad ).
       RUN set-position IN h_bcatvtad ( 15.81 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12-3 ).
       RUN set-position IN h_p-updv12-3 ( 26.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12-3 ( 1.35 , 38.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bcatventa. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_bcatventa ).

       /* Links to SmartBrowser h_bcatvtac. */
       RUN add-link IN adm-broker-hdl ( h_bcatventa , 'Record':U , h_bcatvtac ).
       RUN add-link IN adm-broker-hdl ( h_p-updv12-2 , 'TableIO':U , h_bcatvtac ).

       /* Links to SmartBrowser h_bcatvtad. */
       RUN add-link IN adm-broker-hdl ( h_bcatvtac , 'Record':U , h_bcatvtad ).
       RUN add-link IN adm-broker-hdl ( h_p-updv12-3 , 'TableIO':U , h_bcatvtad ).
