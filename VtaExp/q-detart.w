...
DEFINE VARIABLE S-CODMAT AS CHAR NO-UNDO.
...
&Scoped-define INTERNAL-TABLES Expmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Expmmatg WHERE ~{&KEY-PHRASE} ~
      AND Expmmatg.CodCia = S-CODCIA ~
 AND Expmmatg.codmat = S-CODMAT ~
 AND Expmmatg.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Expmmatg WHERE ~{&KEY-PHRASE} ~
      AND Expmmatg.CodCia = S-CODCIA ~
 AND Expmmatg.codmat = S-CODMAT ~
 AND Expmmatg.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Expmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Expmmatg
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Expmmatg"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "Expmmatg.CodCia = S-CODCIA
 AND Expmmatg.codmat = S-CODMAT
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Captura-Codigo q-tables 
PROCEDURE Captura-Codigo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER X-COD AS CHAR.
S-CODMAT = X-COD.
