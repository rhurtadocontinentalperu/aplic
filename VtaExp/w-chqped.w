...
DEFINE VARIABLE h_b-chqped AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* CHEQUEO DE PEDIDOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CHEQUEO DE PEDIDOS */
DO:
...
DO:
  RUN Cierre-de-guia IN h_b-chqped.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtaexp/b-chqped.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chqped ).
       RUN set-position IN h_b-chqped ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-chqped ( 14.00 , 95.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-chqped. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chqped ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chqped ,
