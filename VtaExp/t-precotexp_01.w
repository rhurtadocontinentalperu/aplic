...
PEDI2.codmat Almmmatg.DesMat Almmmatg.DesMar Almmmatg.UndBas PEDI2.CanPed ~
PEDI2.PreUni PEDI2.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PEDI2.Libre_c01 COLUMN-LABEL "Pag" FORMAT "x(4)":U WIDTH 4.29
      PEDI2.Libre_c02 COLUMN-LABEL "Sec" FORMAT "x(6)":U
      PEDI2.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)":U
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 35
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(25)":U WIDTH 13
      Almmmatg.UndBas COLUMN-LABEL "Und" FORMAT "X(4)":U WIDTH 4
      PEDI2.CanPed FORMAT "->>>,>>9.9999":U
      PEDI2.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">,>>>,>>9.999999":U
      PEDI2.ImpLin FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 108 BY 11.04
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     br_table AT ROW 1.12 COL 1.72
     BUTTON-7 AT ROW 2.08 COL 110 WIDGET-ID 2
     btn-elimina AT ROW 5.31 COL 110 WIDGET-ID 6
     F-TotBrt AT ROW 12.85 COL 13 NO-LABEL WIDGET-ID 36
     F-ImpExo AT ROW 12.85 COL 25 NO-LABEL WIDGET-ID 28
     F-ImpDes AT ROW 12.85 COL 35 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     F-ValVta AT ROW 12.85 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     F-ImpIsc AT ROW 12.85 COL 59.86 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     F-ImpIgv AT ROW 12.85 COL 72.43 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     F-ImpTot AT ROW 12.85 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.31 COL 25 WIDGET-ID 52
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 12.31 COL 37 WIDGET-ID 50
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 12.31 COL 77 WIDGET-ID 48
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 12.31 COL 64 WIDGET-ID 44
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.31 COL 14 WIDGET-ID 42
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 12.31 COL 87 WIDGET-ID 40
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.31 COL 50 WIDGET-ID 46
     "Agregar" VIEW-AS TEXT
          SIZE 7 BY .81 AT ROW 4.23 COL 111.14 WIDGET-ID 8
          FONT 6
...
"PEDI2.Libre_c01" "Pag" "x(4)" "character" ? ? ? ? ? ? no ? no no "4.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.PEDI2.Libre_c02
"PEDI2.Libre_c02" "Sec" "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "35" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" "X(25)" "character" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.Almmmatg.UndBas
"Almmmatg.UndBas" "Und" ? "character" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = Temp-Tables.PEDI2.CanPed
     _FldNameList[8]   > Temp-Tables.PEDI2.PreUni
"PEDI2.PreUni" "Precio!Unitario" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   = Temp-Tables.PEDI2.ImpLin
