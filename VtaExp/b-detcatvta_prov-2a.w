...
&Scoped-Define ENABLED-OBJECTS br_table btn-save 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 147 BY 12.12
         FONT 4
...
DEFINE FRAME F-Main
     ...
     btn-save AT ROW 13.12 COL 74 WIDGET-ID 6
     ...
     BUTTON-1 AT ROW 13.38 COL 8 WIDGET-ID 18
     "Totales:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 13.42 COL 87 WIDGET-ID 14
     "GRABAR" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 13.38 COL 66 WIDGET-ID 8
          FONT 6
