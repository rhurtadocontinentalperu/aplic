...
&Scoped-Define ENABLED-OBJECTS RECT-41 RECT-43 RECT-44 Btn_OK f-desde ~
f-hasta FILL-IN-FchPed-1 FILL-IN-FchPed-2 F-entrega1 F-entrega2 Btn_Cancel 
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 1.27 COL 59
     f-desde AT ROW 1.54 COL 25 COLON-ALIGNED
     f-hasta AT ROW 1.54 COL 43 COLON-ALIGNED
     FILL-IN-FchPed-1 AT ROW 2.35 COL 25 COLON-ALIGNED
     FILL-IN-FchPed-2 AT ROW 2.35 COL 43 COLON-ALIGNED
     F-entrega1 AT ROW 3.15 COL 25 COLON-ALIGNED WIDGET-ID 2
     F-entrega2 AT ROW 3.15 COL 43 COLON-ALIGNED WIDGET-ID 4
     Btn_Cancel AT ROW 3.15 COL 59
     RECT-41 AT ROW 1 COL 1
     RECT-43 AT ROW 5.04 COL 1
     RECT-44 AT ROW 1 COL 58 WIDGET-ID 28
     SPACE(0.00) SKIP(7.76)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 5.04 , 59.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cliente ).
       RUN set-position IN h_b-cliente ( 5.31 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY f-desde f-hasta FILL-IN-FchPed-1 FILL-IN-FchPed-2 F-entrega1 
          F-entrega2 
      WITH FRAME D-Dialog.
  ENABLE RECT-41 RECT-43 RECT-44 Btn_OK f-desde f-hasta FILL-IN-FchPed-1 
         FILL-IN-FchPed-2 F-entrega1 F-entrega2 Btn_Cancel 
      WITH FRAME D-Dialog.
