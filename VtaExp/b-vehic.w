...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gn-vehic WHERE ~{&KEY-PHRASE} ~
      AND gn-vehic.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gn-vehic
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 35 BY 5.77
         FONT 2.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "INTEGRAL.gn-vehic.CodCia = s-codcia"
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Vehiculos'.
  RB-INCLUDE-RECORDS = 'O'.
  RB-FILTER = 'gn-vehic.codcia = ' + STRING(s-codcia).
