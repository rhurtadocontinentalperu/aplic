...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL gn-clie THEN DO:
        ...
        IF AVAIL expasist THEN DO:
            ...
            IF AVAILABLE ExpAsist THEN DO:
                MESSAGE 'El Cliente ya ha sido regitrado en el listado' 
                    VIEW-AS ALERT-BOX INFO BUTTONS OK.            
                RETURN 'adm-error'.
            END.
        END.
        ...
        ASSIGN 
            ...
            ExpAsist.CodDiv     = s-CodDiv      /*pCodDiv*/
    ...
    END.
    ELSE DO:
        MESSAGE 'Este Cliente no esta registrado en el Catálogo de Clientes'
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        RETURN 'ADM-ERROR'.
    END.
