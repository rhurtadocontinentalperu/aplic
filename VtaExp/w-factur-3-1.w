...
DEFINE VARIABLE h_b-tmpdoc-1 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     C-CodDoc AT ROW 6.38 COL 2 NO-LABEL
     C-NroSer AT ROW 6.38 COL 9 NO-LABEL
     Btn-Print AT ROW 6.65 COL 80.57
     RECT-20 AT ROW 6.38 COL 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 116.86 BY 16.35
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-docmto ).
       RUN set-position IN h_q-docmto ( 6.38 , 16.72 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-docmto-1 ).
       RUN set-position IN h_b-docmto-1 ( 7.73 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-factur-1 ).
       RUN set-position IN h_v-factur-1 ( 15.54 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_q-docmto , 'Record':U , h_v-factur-1 ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/b-tmpdoc-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpdoc-1 ).
       RUN set-position IN h_b-tmpdoc-1 ( 7.73 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-tmpdoc-1 ( 9.31 , 100.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-tmpdoc-1 ,
             Btn-Print:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 2 */
...
CASE L-Handle:
    WHEN "browse" THEN DO:
          ...
          RUN dispatch IN h_b-tmpdoc-1 ('open-query':U).
      END.
