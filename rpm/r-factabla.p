...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND FIRST factabla WHERE factabla.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) 
        AND factabla.tabla = TRIM(SUBSTRING(pkeyvalue,4,20))
        AND factabla.codigo = TRIM(SUBSTRING(pkeyvalue,24,20))
    ...
    CASE pEvent:
        ...
        WHEN 'WRITE' THEN DO:
            ...
            RAW-TRANSFER pDATARECORD TO factabla.
            L-FLG = YES.
        END.
    END CASE.
