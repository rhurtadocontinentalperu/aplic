...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND almtfami WHERE almtfami.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) 
        AND almtfami.codfam = SUBSTRING(pkeyvalue,4)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE almtfami THEN CREATE almtfami.
            RAW-TRANSFER pDATARECORD TO almtfami.
            L-FLG = YES.
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(almtfami) THEN RELEASE almtfami.
