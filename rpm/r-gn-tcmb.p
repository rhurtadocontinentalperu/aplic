...
DISABLE TRIGGERS FOR LOAD OF gn-tcmb.
...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND gn-tcmb WHERE gn-tcmb.fecha = DATE(pkeyvalue)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE gn-tcmb THEN CREATE gn-tcmb.
            RAW-TRANSFER pDATARECORD TO gn-tcmb.
            L-FLG = YES.
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(gn-tcmb) THEN RELEASE gn-tcmb.
