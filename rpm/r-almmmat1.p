...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND almmmat1 WHERE almmmat1.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) AND
        almmmat1.codmat = SUBSTRING(pkeyvalue,4) 
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE almmmat1 THEN CREATE almmmat1.
            RAW-TRANSFER pDATARECORD TO almmmat1.
            L-FLG = YES.
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(almmmat1) THEN RELEASE almmmat1.
