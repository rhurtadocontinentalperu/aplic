...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND FIRST vtactabla WHERE vtactabla.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) 
        AND vtactabla.tabla = SUBSTRING(pkeyvalue,4,20) 
        AND vtactabla.llave = SUBSTRING(pkeyvalue,24)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE vtactabla THEN CREATE vtactabla.
            RAW-TRANSFER pDATARECORD TO vtactabla.
            L-FLG = YES.
        END.
    END CASE.
