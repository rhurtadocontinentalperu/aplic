...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND gn-ven WHERE gn-ven.codcia = INTEGER (SUBSTRING(pkeyvalue,1,3)) AND
         gn-ven.codven = SUBSTRING(pkeyvalue,4)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE gn-ven THEN CREATE gn-ven.
            RAW-TRANSFER pDATARECORD TO gn-ven.
            L-FLG = YES.
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(gn-ven) THEN RELEASE gn-ven.
