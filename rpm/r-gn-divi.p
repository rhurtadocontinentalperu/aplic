...
DISABLE TRIGGERS FOR LOAD OF gn-divi.
...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND gn-divi WHERE gn-divi.codcia = INTEGER (SUBSTRING(pkeyvalue,1,3)) AND
         gn-divi.coddiv = SUBSTRING(pkeyvalue,4)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE gn-divi THEN CREATE gn-divi.
            RAW-TRANSFER pDATARECORD TO gn-divi.
            L-FLG = YES.
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(gn-divi) THEN RELEASE gn-divi.
