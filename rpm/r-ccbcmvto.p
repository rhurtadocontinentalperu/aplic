...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND ccbcmvto WHERE ccbcmvto.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) AND
         ccbcmvto.coddoc = SUBSTRING(pkeyvalue,4,3) AND
         ccbcmvto.nrodoc = SUBSTRING(pkeyvalue,7)
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE ccbcmvto THEN CREATE ccbcmvto.
            RAW-TRANSFER pDATARECORD TO ccbcmvto.
            L-FLG = YES.
        END.
    END CASE.
