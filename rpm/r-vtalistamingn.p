...
DO TRANSACTION ON STOP UNDO, RETRY:
    ...
    FIND vtalistamingn WHERE vtalistamingn.codcia = INTEGER(SUBSTRING(pkeyvalue,1,3)) AND
        vtalistamingn.codmat = SUBSTRING(pkeyvalue,4) 
    ...
    CASE pEvent:
        ...
        END.
        WHEN 'WRITE' THEN DO:
            IF NOT AVAILABLE vtalistamingn THEN CREATE vtalistamingn.
            RAW-TRANSFER pDATARECORD TO vtalistamingn.
            L-FLG = YES.
        END.
    END CASE.
