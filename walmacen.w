...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'aplic/dalmacen.wDB-AWARE':U ,
             ...
             OUTPUT h_dalmacen ).
       RUN repositionObject IN h_dalmacen ( 1.27 , 61.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */

       RUN constructObject (
             INPUT  'aplic/valmacen.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_valmacen ).
       RUN repositionObject IN h_valmacen ( 4.77 , 3.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_pupdsav ).
       RUN repositionObject IN h_pupdsav ( 2.62 , 2.00 ) NO-ERROR.
