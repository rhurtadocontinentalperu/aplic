...
&SCOPED-DEFINE CONDICION ( Clf_Temp_Calculos.Id_Agrupador = INTEGER(input-var-1) AND ~
Clf_Temp_Calculos.Id_Periodo = INTEGER(input-var-2) )

&SCOPED-DEFINE CODIGO Clf_Temp_Calculos.CodMat

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Clf_Temp_Calculos.Descripcion BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Clf_Temp_Calculos.Descripcion , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table Clf_Temp_Calculos.CodMat ~
Clf_Temp_Calculos.Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Clf_Temp_Calculos WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Clf_Temp_Calculos WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.Clf_Temp_Calculos.Descripcion
Nombres que contengan|y||integral.Clf_Temp_Calculos.Descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.Clf_Temp_Calculos.CodMat|yes
Descripción|||integral.Clf_Temp_Calculos.Descripcion|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.Clf_Temp_Calculos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   = integral.Clf_Temp_Calculos.CodMat
     _FldNameList[2]   = integral.Clf_Temp_Calculos.Descripcion
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY Clf_Temp_Calculos.CodMat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY Clf_Temp_Calculos.Descripcion
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
