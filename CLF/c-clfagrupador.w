...
&SCOPED-DEFINE l-lookup h_l-clfagrupador
...
DEFINE VARIABLE h_l-clfagrupador AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/clf/l-clfagrupador.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-clfagrupador ).
       RUN set-position IN h_l-clfagrupador ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-clfagrupador ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-clfagrupador. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-clfagrupador ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-clfagrupador ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-clfagrupador , 'AFTER':U ).
    END. /* Page 0 */
