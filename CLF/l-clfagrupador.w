...
&SCOPED-DEFINE CODIGO Clf_Agrupador.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Clf_Agrupador.Codigo BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Clf_Agrupador.Codigo , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES Clf_Agrupador

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Clf_Agrupador.Codigo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Clf_Agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Clf_Agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Clf_Agrupador
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Clf_Agrupador
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.Clf_Agrupador.Codigo
Nombres que contengan|y||integral.Clf_Agrupador.Codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.Clf_Agrupador.Codigo|yes
Descripción|||integral.Clf_Agrupador.Codigo|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Clf_Agrupador.Codigo COLUMN-LABEL "Agrupador" FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > integral.Clf_Agrupador.Codigo
"Codigo" "Agrupador" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY Clf_Agrupador.Codigo
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = STRING({&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.id_agrupador)
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codigo.
&ENDIF
