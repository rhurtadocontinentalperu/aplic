...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Clf_Agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Clf_Agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Clf_Agrupador
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Clf_Agrupador
...
DEFINE FRAME FRAME-A
     BUTTON-4 AT ROW 1 COL 1 WIDGET-ID 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-4 q-tables
ON CHOOSE OF BUTTON-4 IN FRAME FRAME-A /* Button 4 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN clf/c-clfagrupador.w ('Seleccione el agrupador').
