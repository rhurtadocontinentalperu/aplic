...
&Scoped-define INTERNAL-TABLES Clf_Cfg_General

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Clf_Cfg_General WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Clf_Cfg_General WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Clf_Cfg_General
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Clf_Cfg_General
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "integral.Clf_Cfg_General"
...
------------------------------------------------------------------------------*/
  ...
  IF NOT CAN-FIND(FIRST Clf_Cfg_General NO-LOCK) THEN DO:
      CREATE Clf_Cfg_General.
      RELEASE Clf_Cfg_General.
  END.
