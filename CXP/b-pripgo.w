...
DEF VAR s-Tabla AS CHAR INIT 'PP' NO-UNDO.      /* Priorodad de Pago */

&SCOPED-DEFINE CONDICION codcia = s-codcia AND tabla = s-tabla
...
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table~
 ...
 ~{&FP1}Valor[2] ~{&FP2}Valor[2] ~{&FP3}~
 ~{&FP1}Valor[3] ~{&FP2}Valor[3] ~{&FP3}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo FORMAT "x(1)"
      FacTabla.Nombre COLUMN-LABEL "Descripcion"
      FacTabla.Valor[1] COLUMN-LABEL "Factura!+ dias" FORMAT ">>9"
      FacTabla.Valor[2] COLUMN-LABEL "Letra!+ Dias" FORMAT ">>9"
      FacTabla.Valor[3] COLUMN-LABEL "Otros!+ Dias" FORMAT ">>9"
  ENABLE
      FacTabla.Codigo
      FacTabla.Nombre
      FacTabla.Valor[1]
