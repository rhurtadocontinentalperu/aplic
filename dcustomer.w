...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "sports2017.Customer"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > sports2017.Customer.Address
"Address" "Address" ? ? "character" ? ? ? ? ? ? yes ? no 35 yes ?
     _FldNameList[2]   > sports2017.Customer.Address2
"Address2" "Address2" ? ? "character" ? ? ? ? ? ? yes ? no 35 yes ?
     _FldNameList[3]   > sports2017.Customer.Balance
"Balance" "Balance" ? ? "decimal" ? ? ? ? ? ? yes ? no 10.86 yes ?
     _FldNameList[4]   > sports2017.Customer.City
"City" "City" ? ? "character" ? ? ? ? ? ? yes ? no 25 yes ?
     _FldNameList[5]   > sports2017.Customer.Comments
"Comments" "Comments" ? ? "character" ? ? ? ? ? ? yes ? no 80 yes ?
     _FldNameList[6]   > sports2017.Customer.Contact
"Contact" "Contact" ? ? "character" ? ? ? ? ? ? yes ? no 30 yes ?
     _FldNameList[7]   > sports2017.Customer.Country
"Country" "Country" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[8]   > sports2017.Customer.CreditLimit
"CreditLimit" "CreditLimit" ? ? "decimal" ? ? ? ? ? ? yes ? no 9.29 yes ?
     _FldNameList[9]   > sports2017.Customer.CustNum
"CustNum" "CustNum" ? ? "integer" ? ? ? ? ? ? yes ? no 8.14 yes ?
     _FldNameList[10]   > sports2017.Customer.Discount
"Discount" "Discount" ? ? "integer" ? ? ? ? ? ? yes ? no 7.43 yes ?
     _FldNameList[11]   > sports2017.Customer.EmailAddress
"EmailAddress" "EmailAddress" ? ? "character" ? ? ? ? ? ? yes ? no 50 yes ?
     _FldNameList[12]   > sports2017.Customer.Fax
"Fax" "Fax" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[13]   > sports2017.Customer.Name
"Name" "Name" ? ? "character" ? ? ? ? ? ? yes ? no 30 yes ?
     _FldNameList[14]   > sports2017.Customer.Phone
"Phone" "Phone" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[15]   > sports2017.Customer.PostalCode
"PostalCode" "PostalCode" ? ? "character" ? ? ? ? ? ? yes ? no 10.57 yes ?
     _FldNameList[16]   > sports2017.Customer.SalesRep
"SalesRep" "SalesRep" ? ? "character" ? ? ? ? ? ? yes ? no 9.14 yes ?
     _FldNameList[17]   > sports2017.Customer.State
"State" "State" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[18]   > sports2017.Customer.Terms
...
If rowobject.creditlimit <= 0 THEN RETURN "Credit limit must be greater than zero".
