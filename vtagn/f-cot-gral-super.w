...
&Scoped-Define ENABLED-OBJECTS BUTTON-EDI BUTTON-SUPERMERCADOS-B2Bv2 
...
DEFINE FRAME F-Main
     BUTTON-EDI AT ROW 1 COL 1 WIDGET-ID 24
     BUTTON-SUPERMERCADOS-B2Bv2 AT ROW 2.08 COL 1 WIDGET-ID 52
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-EDI F-Frame-Win
ON CHOOSE OF BUTTON-EDI IN FRAME F-Main /* EDI COMPARATIVO */
DO:
  RUN Procesa-Botones IN lh_handle ("Edi-Comparativo").
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-SUPERMERCADOS-B2Bv2 F-Frame-Win
ON CHOOSE OF BUTTON-SUPERMERCADOS-B2Bv2 IN FRAME F-Main /* IMPORTAR TIENDAS B2B */
DO:
    RUN Procesa-Botones IN lh_handle ("Importar-tiendas-B2B").
END.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-EDI BUTTON-SUPERMERCADOS-B2Bv2 
      WITH FRAME F-Main.
