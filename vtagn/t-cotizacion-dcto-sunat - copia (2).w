...
DEFINE VAR x-usuario-que-autoriza AS CHAR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(100)":U WIDTH 83.43
      ...
      ITEM.PreUni COLUMN-LABEL "Precio Unitario!con IGV" FORMAT ">>,>>9.99999":U
            WIDTH 11.14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 181 BY 13.69
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpTot AT ROW 15 COL 157 COLON-ALIGNED WIDGET-ID 2
...
"Almmmatg.DesMat" ? "X(100)" "character" ? ? ? ? ? ? no ? no no "83.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.PreUni" "Precio Unitario!con IGV" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "11.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.Por_Dsctos[3]" "% Dscto!Vol/Prom" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"fMargen() @ x-Margen" "Margen!(%)" "->,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.ITEM.ImpLin
"ITEM.ImpLin" "Importe!con IGV" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
      ...
      APPLY 'ENTRY':U TO ITEM.Por_Dsctos[1] IN BROWSE {&browse-name}.
...
------------------------------------------------------------------------------*/
  ...
  /**/
  RUN usuario-que-autoriza IN lh_handle(OUTPUT x-usuario-que-autoriza).
  ...
  /* 06/09/2023. Se desactiva porque NO está implementado */
...
/*       NO-LOCK NO-ERROR.                                      */
  CASE TRUE:
      WHEN Almmmatg.CHR__02 = "T" THEN DO:     /* Productos de Terceros */
          IF AVAILABLE BDctoLin THEN x-DtoMax = MINIMUM(BDctoLin.Valor[1], s-DtoMax).
          ...
          IF DEC(ITEM.Por_DSCTOS[1]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) > x-DtoMax THEN DO:
             MESSAGE "Maximo DSCTO.  permitido TERCEROS" SKIP
                     "para el nivel de Usuario (" + s-Nivel + ")" SKIP
                     "es : " x-DtoMax " %" SKIP
                     "Línea del producto es :" Almmmatg.CodFam SKIP                     
      ...
      WHEN Almmmatg.CHR__02 = "P" THEN DO:     /* Productos Propios */
          ...
          /* **************************************************************************** */
          IF NOT (AVAILABLE BDctoLin) THEN DO:
          ...
          IF AVAILABLE Almtconv THEN DO:
              ...
              END.
          END.
          IF AVAILABLE BDctoLin THEN x-DtoMax = MINIMUM(BDctoLin.Valor[2], s-DtoMax).
