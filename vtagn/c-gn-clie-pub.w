...
&SCOPED-DEFINE l-lookup h_l-gn-clie-pub
...
DEFINE VARIABLE h_l-gn-clie-pub AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.42 COL 64
     Btn_Cancel AT ROW 5.04 COL 64
     SPACE(2.85) SKIP(10.30)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/l-gn-clie-pub.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-gn-clie-pub ).
       RUN set-position IN h_l-gn-clie-pub ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-gn-clie-pub ( 15.50 , 61.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.00 , 63.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 13.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-gn-clie-pub. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-gn-clie-pub ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-gn-clie-pub ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-gn-clie-pub , 'AFTER':U ).
    END. /* Page 0 */
