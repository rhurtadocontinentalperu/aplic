...
&Scoped-define QUERY-STRING-Query-Main FOR EACH gn-ven WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-ven WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-ven
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-ven
