...
------------------------------------------------------------------------------*/
  ...
  END CASE.
  /* ********************************* MARGEN DE UTILIDAD ******************************* */
  /* CONTRATO MARCO, REMATES, EXPOLIBRERIA, LISTA EXPRESS:
        NO TIENE MINIMO NI MARGEN DE UTILIDAD */
  IF LOOKUP(s-TpoPed, "M,R,E,LF") > 0 THEN RETURN "OK".   
  /*IF LOOKUP(s-TpoPed, "M,R,LF") > 0 THEN RETURN "OK".   */
