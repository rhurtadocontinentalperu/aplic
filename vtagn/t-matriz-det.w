...
T-DMatriz.Cantidad[1] T-DMatriz.UndVta[1] T-DMatriz.StkAct[1] ~
T-DMatriz.Cantidad[2] T-DMatriz.UndVta[2] T-DMatriz.StkAct[2] ~
T-DMatriz.Cantidad[3] T-DMatriz.UndVta[3] T-DMatriz.StkAct[3] ~
T-DMatriz.Cantidad[4] T-DMatriz.UndVta[4] T-DMatriz.StkAct[4] ~
T-DMatriz.Cantidad[5] T-DMatriz.UndVta[5] T-DMatriz.StkAct[5] ~
T-DMatriz.Cantidad[6] T-DMatriz.UndVta[6] T-DMatriz.StkAct[6] ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      T-DMatriz.LabelFila FORMAT "x(60)":U WIDTH 25 COLUMN-FONT 4
      ...
      fCantidad() @ x-Cantidad COLUMN-LABEL "Cantid." FORMAT ">>>9":U
            WIDTH 5 COLUMN-FGCOLOR 1 COLUMN-BGCOLOR 11
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 133 BY 14
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpLin-1 AT ROW 16.62 COL 32 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-ImpLin-2 AT ROW 16.62 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN-ImpLin-3 AT ROW 16.62 COL 65 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     FILL-IN-ImpLin-4 AT ROW 16.62 COL 81 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     FILL-IN-ImpLin-5 AT ROW 16.62 COL 97 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     FILL-IN-ImpLin-6 AT ROW 16.62 COL 114 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     FILL-IN-DesMat AT ROW 17.69 COL 4 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN-ImpTot AT ROW 17.69 COL 107 COLON-ALIGNED WIDGET-ID 32
...
"T-DMatriz.LabelFila" ? ? "character" ? ? 4 ? ? ? no ? no no "25" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  IF AVAILABLE VtaCMatriz THEN DO:
      ASSIGN
...
RUN VTA_Valida-Cantidad IN hProc (INPUT pCodMat,
                                  INPUT pUndVta,
