...
DEF SHARED VAR S-NROREF   AS CHAR.
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 109 COLON-ALIGNED WIDGET-ID 46
     ...
     FacCPedi.fchven AT ROW 1.96 COL 109 COLON-ALIGNED WIDGET-ID 48 FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
"Tarjeta de Crédito", "T":U
          SIZE 25 BY .81
          BGCOLOR 8 FGCOLOR 0 
     FacCPedi.usuario AT ROW 2.92 COL 109 COLON-ALIGNED WIDGET-ID 66
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.Atencion AT ROW 3.88 COL 59 COLON-ALIGNED WIDGET-ID 88
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.ordcmp AT ROW 3.88 COL 109 COLON-ALIGNED WIDGET-ID 118
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
          FGCOLOR 0 
     FacCPedi.NomCli AT ROW 4.85 COL 16 COLON-ALIGNED WIDGET-ID 54 FORMAT "x(256)"
          ...
          SIZE 78 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Cmpbnte AT ROW 4.85 COL 111 NO-LABEL WIDGET-ID 102
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Factura", "FAC":U,
"Boleta", "BOL":U
     ...
     FacCPedi.DirCli AT ROW 5.81 COL 16 COLON-ALIGNED WIDGET-ID 44
          ...
          SIZE 78 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 5.81 COL 111 NO-LABEL WIDGET-ID 78
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dólares", 2
     ...
     FacCPedi.LugEnt AT ROW 6.77 COL 16 COLON-ALIGNED WIDGET-ID 112
          ...
          SIZE 78 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.TpoCmb AT ROW 6.77 COL 109 COLON-ALIGNED WIDGET-ID 64
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FlgIgv AT ROW 7.73 COL 111 WIDGET-ID 116
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY .77
     ...
     FacCPedi.Libre_d01 AT ROW 8.69 COL 111 NO-LABEL WIDGET-ID 96
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "2", 2,
"3", 3,
"4", 4
     ...
     FacCPedi.CodRef AT ROW 9.65 COL 109 COLON-ALIGNED WIDGET-ID 126
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 9.65 COL 115 COLON-ALIGNED NO-LABEL WIDGET-ID 128
          VIEW-AS FILL-IN 
     ...
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 5.04 COL 101 WIDGET-ID 106
     "Redondedo del P.U.:" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 8.88 COL 96 WIDGET-ID 100
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 3.12 COL 8 WIDGET-ID 124
     "Moneda:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 6 COL 105 WIDGET-ID 84
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  /* ****************************************************************************************** */
  /* 14/12/2022: Control de margen por Pricing */
  DEF VAR hProc AS HANDLE NO-UNDO.
