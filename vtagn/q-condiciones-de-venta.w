...
&Scoped-define QUERY-STRING-Query-Main FOR EACH gn-ConVt WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-ConVt WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-ConVt
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-ConVt
