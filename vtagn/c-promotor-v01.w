...
&SCOPED-DEFINE l-lookup h_l-promotor-v01
...
DEFINE VARIABLE h_l-promotor-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 16.58 COL 2
     Btn_Cancel AT ROW 16.58 COL 14
     SPACE(52.13) SKIP(0.18)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/l-promotor-v01.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Libre_c01':U ,
             OUTPUT h_l-promotor-v01 ).
       RUN set-position IN h_l-promotor-v01 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-promotor-v01 ( 15.58 , 76.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 16.58 , 64.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 13.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-promotor-v01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-promotor-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-promotor-v01 ,
