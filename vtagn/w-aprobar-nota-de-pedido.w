...
DEF NEW SHARED VAR s-coddoc AS CHAR INIT 'NPC'.     /* NOTA DE PEDIDO - CREDITOS */
...
DEFINE VARIABLE h_b-aprobar-nota-de-pedido AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-cotizacion-general-v2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "APROBAR/RECHAZAR POR ADMINISTRADOR"
         HEIGHT             = 24.88
         WIDTH              = 144.29
         MAX-HEIGHT         = 26.15
         MAX-WIDTH          = 191.29
...
ON END-ERROR OF W-Win /* APROBAR/RECHAZAR POR ADMINISTRADOR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* APROBAR/RECHAZAR POR ADMINISTRADOR */
DO:
...
DO:
  RUN Aprobar IN h_b-aprobar-nota-de-pedido.
END.
...
DO:
  RUN Rechazar IN h_b-aprobar-nota-de-pedido.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-aprobar-nota-de-pedido.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprobar-nota-de-pedido ).
       RUN set-position IN h_b-aprobar-nota-de-pedido ( 2.62 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-aprobar-nota-de-pedido ( 6.69 , 111.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-aprobar-nota-de-pedido , 'Record':U , h_v-cotizacion-unificada ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotizacion-general-v2 ).
       RUN set-position IN h_b-cotizacion-general-v2 ( 10.96 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-cotizacion-general-v2 ( 14.00 , 131.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cotizacion-general-v2. */
       RUN add-link IN adm-broker-hdl ( h_b-aprobar-nota-de-pedido , 'Record':U , h_b-cotizacion-general-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cotizacion-general-v2 ,
             h_tab95 , 'AFTER':U ).
    END. /* Page 2 */
