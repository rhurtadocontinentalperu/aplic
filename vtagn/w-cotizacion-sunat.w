...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* *** SUNAT *** */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_f-cot-gral-exporta-a-excel ( 1.00 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-exporta-a-pdf-2 ( 1.00 , 148.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-expo-pag1 ( 2.62 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-imp-excel-plantilla ( 4.77 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-super ( 5.85 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.19 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-imp-market ( 8.00 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */
       ...
       RUN set-position IN h_f-gen-cot-even ( 9.08 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-expo-import ( 10.42 , 142.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-envio-admin ( 11.77 , 142.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-cotizacion-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotizacion-general ).
       RUN set-position IN h_b-cotizacion-general ( 13.12 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_f-cot-gral-pag2 ( 2.35 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-imp-ped-excel ( 4.50 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-imp-excel-provi ( 5.58 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-super-pag2 ( 6.65 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-cotrecu ( 7.73 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-sede-cliente-2 ( 8.81 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.19 , 26.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-cotizacion-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-cotizacion-unificada ).
       RUN set-position IN h_t-cotizacion-unificada ( 13.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-cotizacion-unificada ( 13.73 , 181.00 ) NO-ERROR.
...
RUN COT_Genera-COT-SUNAT IN hProc (INPUT pCodDiv,
                                   INPUT pCodCli,
                                   INPUT pCodVen,
                                   OUTPUT pNroPed,
                                   OUTPUT pMensaje).
...
CASE L-Handle:
    ...
    WHEN "Pagina2"  THEN DO WITH FRAME {&FRAME-NAME}:
        ...
        RUN dispatch IN h_f-cot-gral-envio-admin ('hide':U).
        /*RUN dispatch IN h_f-precot-gral-cotmovil ('hide':U).*/
        CASE s-TpoPed:
            WHEN "S" THEN DO:       /* Supermercados */
            ...
            WHEN "E" THEN DO:      /* Eventos */
                RUN dispatch IN h_f-cot-gral-imp-ped-excel ('view':U).
                /*RUN dispatch IN h_f-precot-gral-cotmovil ('view':U).*/
            END.
