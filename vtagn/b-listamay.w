...
&Scoped-define INTERNAL-TABLES INTEGRAL.VtaListaMay INTEGRAL.Almmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table INTEGRAL.VtaListaMay.codmat ~
INTEGRAL.VtaListaMay.DesMat INTEGRAL.VtaListaMay.DesMar ~
INTEGRAL.VtaListaMay.codfam INTEGRAL.VtaListaMay.MonVta ~
INTEGRAL.VtaListaMay.TpoCmb INTEGRAL.VtaListaMay.Chr__01 ~
INTEGRAL.VtaListaMay.PreOfi fMargen() @ x-Margen ~
INTEGRAL.VtaListaMay.CanEmp INTEGRAL.Almmmatg.UndBas 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table INTEGRAL.VtaListaMay.codmat ~
INTEGRAL.VtaListaMay.MonVta INTEGRAL.VtaListaMay.TpoCmb ~
INTEGRAL.VtaListaMay.Chr__01 INTEGRAL.VtaListaMay.PreOfi ~
INTEGRAL.VtaListaMay.CanEmp 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table INTEGRAL.VtaListaMay
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table INTEGRAL.VtaListaMay
&Scoped-define QUERY-STRING-br_table FOR EACH INTEGRAL.VtaListaMay WHERE ~{&KEY-PHRASE} ~
      AND INTEGRAL.VtaListaMay.CodCia = s-codcia ~
 AND INTEGRAL.VtaListaMay.CodDiv = s-coddiv NO-LOCK, ~
      EACH INTEGRAL.Almmmatg OF INTEGRAL.VtaListaMay NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH INTEGRAL.VtaListaMay WHERE ~{&KEY-PHRASE} ~
      AND INTEGRAL.VtaListaMay.CodCia = s-codcia ~
 AND INTEGRAL.VtaListaMay.CodDiv = s-coddiv NO-LOCK, ~
      EACH INTEGRAL.Almmmatg OF INTEGRAL.VtaListaMay NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table INTEGRAL.VtaListaMay ~
INTEGRAL.Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-br_table INTEGRAL.VtaListaMay
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      INTEGRAL.VtaListaMay.codmat FORMAT "X(6)":U
      INTEGRAL.VtaListaMay.DesMat FORMAT "X(60)":U
      INTEGRAL.VtaListaMay.DesMar COLUMN-LABEL "Marca" FORMAT "X(30)":U
      INTEGRAL.VtaListaMay.codfam FORMAT "X(3)":U
      INTEGRAL.VtaListaMay.MonVta FORMAT "9":U WIDTH 8.86 COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
            VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEM-PAIRS "Soles",1,
                                      "Dolares",2
                      DROP-DOWN-LIST 
      INTEGRAL.VtaListaMay.TpoCmb FORMAT "Z9.9999":U COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.VtaListaMay.Chr__01 COLUMN-LABEL "Unidad" FORMAT "X(6)":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.VtaListaMay.PreOfi COLUMN-LABEL "Precio Venta" FORMAT ">,>>>,>>9.9999":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      fMargen() @ x-Margen COLUMN-LABEL "Margen %" FORMAT "(ZZZ,ZZ9.9999)":U
      INTEGRAL.VtaListaMay.CanEmp COLUMN-LABEL "Empaque" FORMAT "->>,>>9.99":U
            COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      INTEGRAL.Almmmatg.UndBas FORMAT "X(6)":U
  ENABLE
      INTEGRAL.VtaListaMay.codmat
      INTEGRAL.VtaListaMay.MonVta
      INTEGRAL.VtaListaMay.TpoCmb
      INTEGRAL.VtaListaMay.Chr__01
      INTEGRAL.VtaListaMay.PreOfi
      INTEGRAL.VtaListaMay.CanEmp
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME INTEGRAL.VtaListaMay.codmat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL INTEGRAL.VtaListaMay.codmat br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF INTEGRAL.VtaListaMay.codmat IN BROWSE br_table /* Codigo Articulo */
DO:
...
&Scoped-define SELF-NAME INTEGRAL.VtaListaMay.Chr__01
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL INTEGRAL.VtaListaMay.Chr__01 br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF INTEGRAL.VtaListaMay.Chr__01 IN BROWSE br_table /* Unidad */
DO:
...
------------------------------------------------------------------------------*/
	...
	chWorkSheet:Range("D1"):Value = "FAMILIA".
	chWorkSheet:Range("E1"):Value = "MONEDA".
	chWorkSheet:Range("F1"):Value = "T.CAMBIO".
	chWorkSheet:Range("G1"):Value = "UNIDAD".
	chWorkSheet:Range("H1"):Value = "P.VENTA".	
	chWorkSheet:Range("I1"):Value = "EMPAQUE".
	chWorkSheet:Range("J1"):Value = "UNID.BASICA".
...
DO  WHILE AVAILABLE VtaListaMay:
	     ...
	     cRange = "B" + cColumn.
	     chWorkSheet:Range(cRange):Value = vtalistamay.desmat.
	     cRange = "C" + cColumn.
	     chWorkSheet:Range(cRange):Value = vtalistamay.desmar.
	     cRange = "D" + cColumn.
	     chWorkSheet:Range(cRange):Value = vtalistamay.codfam.
	     cRange = "E" + cColumn.
	     ...
	     cRange = "I" + cColumn.
	     chWorkSheet:Range(cRange):Value = vtalistamay.canemp.
	     cRange = "J" + cColumn.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "INTEGRAL.VtaListaMay"}
