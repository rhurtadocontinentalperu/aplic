...
DEFINE FRAME F-Main
     ...
     FacCPedi.FaxCli AT ROW 1.27 COL 74 COLON-ALIGNED NO-LABEL WIDGET-ID 120 FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     FacCPedi.FchPed AT ROW 1.27 COL 132.57 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.fchven AT ROW 2.08 COL 132.57 COLON-ALIGNED
     ...
     FacCPedi.NomCli AT ROW 2.88 COL 12 COLON-ALIGNED FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.FchEnt AT ROW 2.88 COL 132.57 COLON-ALIGNED WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.Libre_f02 AT ROW 3.65 COL 132.57 COLON-ALIGNED WIDGET-ID 154
     ...
     FacCPedi.DirCli AT ROW 3.69 COL 12 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.TpoCmb AT ROW 4.46 COL 109.14 COLON-ALIGNED
          LABEL "T.C."
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Cmpbnte AT ROW 4.46 COL 134.57 NO-LABEL WIDGET-ID 36
...
"BOL", "BOL":U
     ...
     FacCPedi.FlgIgv AT ROW 4.5 COL 92 WIDGET-ID 108
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 11.29 BY .77
     FacCPedi.Libre_c03 AT ROW 5.27 COL 34.14 COLON-ALIGNED WIDGET-ID 130
          ...
          SIZE 16 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 5.27 COL 134.57 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dolares", 2
...
DEFINE FRAME F-Main
     ...
     FacCPedi.NroRef AT ROW 6.12 COL 139.57 COLON-ALIGNED WIDGET-ID 10
     ...
     FacCPedi.ordcmp AT ROW 6.92 COL 132.57 COLON-ALIGNED
     ...
     FacCPedi.CodOrigen AT ROW 8.27 COL 141 COLON-ALIGNED NO-LABEL WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.NroOrigen AT ROW 8.27 COL 146 COLON-ALIGNED NO-LABEL WIDGET-ID 146
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 14 FGCOLOR 0 
     ...
     FacCPedi.Cliente_Recoge AT ROW 9.08 COL 148.57 NO-LABEL WIDGET-ID 164
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
     ...
     FacCPedi.Glosa AT ROW 9.88 COL 11.28 FORMAT "X(256)"
          ...
          SIZE 100 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.TipVta AT ROW 9.88 COL 148.57 NO-LABEL WIDGET-ID 134
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "No", "",
"Si", "Si":U
     ...
     FacCPedi.EmpaqEspec AT ROW 10.69 COL 143.57 WIDGET-ID 176
     ...
     "Calendario logistico" VIEW-AS TEXT
          SIZE 14.43 BY .5 AT ROW 2.96 COL 145.14 WIDGET-ID 156
     "Cliente Recoge:" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 9.35 COL 136.57 WIDGET-ID 168
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 4.65 COL 124.57 WIDGET-ID 106
     "Pactado con cliente" VIEW-AS TEXT
          SIZE 14.43 BY .5 AT ROW 3.77 COL 145.14 WIDGET-ID 158
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.38 COL 127.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
DEFINE FRAME F-Main
     "Trámite Documentario?" VIEW-AS TEXT
          SIZE 18 BY .5 AT ROW 10.15 COL 130.57 WIDGET-ID 138
...
------------------------------------------------------------------------------*/
    ...
    END.
    ELSE DO:
       dImpTot = FacCPedi.TotalValorVenta.
    END.
    ...
    FOR EACH b-facdpedi OF faccpedi NO-LOCK,
        ...
        ELSE DO:
            ...
            dImpLin = ROUND(b-FacDPedi.cImporteTotalConImpuesto / (1 + FacCPedi.PorIgv / 100),2). 
        END.  
        iRow = iRow + 1.
        cColumn = STRING(iRow).
        cRange = "A" + cColumn.
...
------------------------------------------------------------------------------*/
  ...
  RUN vtagn/p-imprime-pedido-sunat (ROWID(Faccpedi)).
