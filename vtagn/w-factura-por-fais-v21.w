...
DEFINE VARIABLE h_b-factura-por-fais-v21 AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN Generacion-de-Factura IN h_b-factura-por-fais-v21 ( INPUT COMBO-NroSer,
                                                           OUTPUT pMensaje,
                                                           OUTPUT iCountGuide).
...
DO:
  RUN Texto IN h_b-factura-por-fais-v21.
END.
...
DO:
    ...
    IF FILL-IN-FchSal-1 = ? OR FILL-IN-FchSal-2 = ? THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    RUN Carga-Temporal IN h_b-factura-por-fais-v21
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-factura-por-fais-v21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-factura-por-fais-v21 ).
       RUN set-position IN h_b-factura-por-fais-v21 ( 6.38 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-factura-por-fais-v21 ( 19.85 , 105.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-factura-por-fais-v21 ,
