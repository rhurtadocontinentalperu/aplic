...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
 ...
 AND VtaTabla.Libre_c01 = "SI" NO-LOCK, ~
      EACH gn-clie WHERE TRUE /* Join to VtaTabla incomplete */ ~
      AND gn-clie.CodCia = cl-codcia ~
 AND gn-clie.Flgsit = "A" ~
 AND gn-clie.Canal = vtatabla.llave_c1 ~
 AND gn-clie.GirCli = vtatabla.llave_c2 NO-LOCK ~
...
/* Query rebuild information for BROWSE br_table
 ...
 AND VtaTabla.Tabla = ""CN-GN""
 AND VtaTabla.Libre_c01 = ""SI"""
     _Where[2]         = "gn-clie.CodCia = cl-codcia
 AND gn-clie.Flgsit = ""A""
 AND gn-clie.Canal = vtatabla.llave_c1
 AND gn-clie.GirCli = vtatabla.llave_c2"
...
DO:
    ...
    &IF "{&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}}" &THEN
        FIND FIRST {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} WHERE
        ...
        IF NOT AVAILABLE {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN DO:
            ...
            RETURN.
        END.
        REPOSITION {&BROWSE-NAME} TO ROWID ROWID( {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} ) NO-ERROR.
...
IF AVAILABLE {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        output-var-1 = ROWID( {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} )
        output-var-2 = {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}}.codcli
