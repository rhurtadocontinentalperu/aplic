...
/* ACTUALIZA LA COTIZACION EN BASE AL PEDIDO AL CREDITO */
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      IF NOT AVAILABLE B-CPEDI THEN DO:
          MESSAGE VtaCDoc.codref VtaCDocu.nroref ' NO registrado'
              VIEW-AS ALERT-BOX ERROR.
          RETURN "ADM-ERROR".
      END.
      /* SOLO SE PUEDE ACTUALIZAR EL PEDIDO MIENTRAS ESTE PENDIENTE O ATENDIDO */
      IF LOOKUP (B-CPEDI.FlgEst, "C,P") = 0 THEN DO:
          MESSAGE "El estado del" VtaCDoc.codref VtaCDocu.nroref "NO permite actualizarlo" SKIP
              "Revise los documentos" VIEW-AS ALERT-BOX ERROR.
          RETURN "ADM-ERROR".
      END.
      FOR EACH VtaDDocu OF VtaCDocu NO-LOCK:
          FIND B-DPedi WHERE B-DPedi.CodCia = VtaCDocu.CodCia 
              ...
              AND B-DPedi.AlmDes = VtaDDocu.AlmDes
