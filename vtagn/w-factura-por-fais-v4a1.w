...
DEF TEMP-TABLE T-FAI-ART
    ...
    FIELD CodFAC LIKE ccbcdocu.coddoc
    FIELD NroFAC LIKE ccbcdocu.Nrodoc
...
&Scoped-Define ENABLED-OBJECTS BROWSE-ORIGEN RADIO-SET-tipo BUTTON-1 ~
COMBO-BOX-Clientes FILL-IN-FchSal-1 FILL-IN-FchSal-2 COMBO-NroSer ~
BUTTON-Filtrar BUTTON-Exportar Btn_OK BtnDone BUTTON-2 COMBO-BOX-grupo ~
BUTTON-12 RADIO-SET-Cliente_Recoge RECT-2 RECT-3 BROWSE-DESTINO RECT-4 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-tipo FILL-IN-Items FILL-IN-Total ~
COMBO-BOX-Clientes FILL-IN-FchSal-1 FILL-IN-FchSal-2 COMBO-NroSer ~
FILL-IN-NroDoc FILL-IN-Division COMBO-BOX-grupo RADIO-SET-Cliente_Recoge 
...
DEFINE VARIABLE RADIO-SET-Cliente_Recoge AS LOGICAL 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "El Cliente Recoge", yes,
"Entregado al Cliente", no
     SIZE 17 BY 1.35 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-DESTINO W-Win _STRUCTURED
  QUERY BROWSE-DESTINO NO-LOCK DISPLAY
      ...
      T-DESTINO.FchDoc COLUMN-LABEL "Fch. FAI" FORMAT "99/99/99":U
      T-DESTINO.FchVto COLUMN-LABEL "Fecha de!Salida" FORMAT "99/99/99":U
      fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo COLUMN-LABEL "Grupo Reparto!Cliente" FORMAT "x(20)":U
            WIDTH 10.43
      COTIZACION.CustomerPurchaseOrder COLUMN-LABEL "Pedido!Compra" FORMAT "x(15)":U
      T-DESTINO.NroRef COLUMN-LABEL "G/R" FORMAT "X(14)":U WIDTH 14.29
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U
      T-DESTINO.Libre_c05 COLUMN-LABEL "Entregado" FORMAT "x(15)":U
            WIDTH 8.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 87.29 BY 18.31
         FONT 4
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-ORIGEN W-Win _STRUCTURED
  QUERY BROWSE-ORIGEN NO-LOCK DISPLAY
      ...
      T-ORIGEN.FchDoc COLUMN-LABEL "Fch. FAI" FORMAT "99/99/99":U
            WIDTH 7.29
      T-ORIGEN.FchVto COLUMN-LABEL "Fecha de!Salida" FORMAT "99/99/99":U
      fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo COLUMN-LABEL "Grupo Reparto!Cliente" FORMAT "x(10)":U
            WIDTH 10.14 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      COTIZACION.CustomerPurchaseOrder COLUMN-LABEL "Pedido!Compra" FORMAT "x(15)":U
      T-ORIGEN.NroRef COLUMN-LABEL "G/R" FORMAT "X(15)":U WIDTH 13.86
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 9
      T-ORIGEN.Libre_c05 COLUMN-LABEL "Entregado" FORMAT "x(15)":U
            WIDTH 8.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 85.29 BY 19.12
         FONT 4
...
DEFINE FRAME F-Main
     BROWSE-ORIGEN AT ROW 6.38 COL 1.72 WIDGET-ID 200
     RADIO-SET-tipo AT ROW 3.15 COL 106 NO-LABEL WIDGET-ID 62
     FILL-IN-Items AT ROW 24.96 COL 119 COLON-ALIGNED WIDGET-ID 56
     BUTTON-1 AT ROW 9.62 COL 88 WIDGET-ID 50
     ...
     BUTTON-Filtrar AT ROW 3.42 COL 132 WIDGET-ID 38
     BUTTON-Exportar AT ROW 4.5 COL 132 WIDGET-ID 48
     Btn_OK AT ROW 3.96 COL 161 WIDGET-ID 32
     BtnDone AT ROW 3.96 COL 173 WIDGET-ID 34
     BUTTON-2 AT ROW 11.77 COL 88 WIDGET-ID 52
     COMBO-BOX-grupo AT ROW 5.27 COL 57.86 COLON-ALIGNED WIDGET-ID 58
     BUTTON-12 AT ROW 4.27 COL 77 WIDGET-ID 60
     RADIO-SET-Cliente_Recoge AT ROW 4.77 COL 106 NO-LABEL WIDGET-ID 68
     BROWSE-DESTINO AT ROW 6.38 COL 98.72 WIDGET-ID 300
     RECT-2 AT ROW 1 COL 2 WIDGET-ID 10
     RECT-3 AT ROW 2.88 COL 2 WIDGET-ID 46
     RECT-4 AT ROW 2.88 COL 159 WIDGET-ID 66
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 188.14 BY 25.04
...
"T-DESTINO.FchDoc" "Fch. FAI" "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-DESTINO.FchVto
"T-DESTINO.FchVto" "Fecha de!Salida" "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo" "Grupo Reparto!Cliente" "x(20)" ? ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.COTIZACION.CustomerPurchaseOrder
"COTIZACION.CustomerPurchaseOrder" "Pedido!Compra" "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-DESTINO.NroRef
"T-DESTINO.NroRef" "G/R" "X(14)" "character" ? ? ? ? ? ? no ? no no "14.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = INTEGRAL.CcbCDocu.ImpTot
     _FldNameList[9]   > Temp-Tables.T-DESTINO.Libre_c05
"T-DESTINO.Libre_c05" "Entregado" "x(15)" "character" ? ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
"T-ORIGEN.FchDoc" "Fch. FAI" "99/99/99" "date" ? ? ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-ORIGEN.FchVto
"T-ORIGEN.FchVto" "Fecha de!Salida" "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo" "Grupo Reparto!Cliente" "x(10)" ? 14 0 ? ? ? ? no ? no no "10.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.COTIZACION.CustomerPurchaseOrder
"COTIZACION.CustomerPurchaseOrder" "Pedido!Compra" "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-ORIGEN.NroRef
"T-ORIGEN.NroRef" "G/R" "X(15)" "character" ? ? ? ? ? ? no ? no no "13.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.CcbCDocu.ImpTot
"CcbCDocu.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-ORIGEN.Libre_c05
"T-ORIGEN.Libre_c05" "Entregado" "x(15)" "character" ? ? ? ? ? ? no ? no no "8.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
DO:
    ASSIGN
         COMBO-NroSer FILL-IN-Division FILL-IN-NroDoc COMBO-BOX-Clientes combo-box-grupo.
    ASSIGN FILL-IN-Items.

    IF radio-set-tipo = 2 AND RADIO-SET-Cliente_Recoge = NO THEN DO:
        IF x-faltan-guias = YES THEN DO:
            MESSAGE "Esta facturando PLANIFICADOS y para el Grupo de reparto (" + combo-box-grupo + ")" SKIP
                    "Existen FAI(s) sin Guias de Remision" SKIP 
                    "Imposible generar FACTURA(s)" VIEW-AS ALERT-BOX ERROR.
            RETURN NO-APPLY.
        END.
    END.

    IF TRUE <> (combo-NroSer > "") THEN DO:
        MESSAGE "Nro de Serie del documento esta ERRADO" SKIP 
                "Imposible generar FACTURA(s)" VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    ...
    IF x-guias-no-entregados = YES AND RADIO-SET-Cliente_Recoge = NO THEN DO:
        MESSAGE "Existen Guia de Remision que aún no esta" SKIP 
                "entregado la mercaderia" SKIP
                /*"Imposible generar FACTURA(s)"*/ VIEW-AS ALERT-BOX WARNING.
        /*RETURN NO-APPLY.*/
    END.
...
DO:
    ASSIGN fill-in-FchSal-1 fill-in-FchSal-2 Radio-set-tipo.
...
DO:
    ASSIGN COMBO-BOX-Clientes COMBO-NroSer
        FILL-IN-FchSal-1 FILL-IN-FchSal-2 combo-box-grupo Radio-set-tipo.
    ASSIGN
        RADIO-SET-Cliente_Recoge.
...
DO:
    ASSIGN COMBO-BOX-Clientes radio-set-tipo.
    ...
    IF radio-set-tipo = 2 THEN DO:
        ...
        FOR EACH T-INVOICE NO-LOCK WHERE T-INVOICE.codcli = COMBO-BOX-Clientes:
            ...
            IF TRUE <> (COMBO-BOX-grupo:SCREEN-VALUE > "")
                THEN COMBO-BOX-grupo:SCREEN-VALUE = TRIM(T-INVOICE.DeliveryGroup).
        END.
    END.
...
&Scoped-define SELF-NAME RADIO-SET-Cliente_Recoge
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RADIO-SET-Cliente_Recoge W-Win
ON VALUE-CHANGED OF RADIO-SET-Cliente_Recoge IN FRAME F-Main
DO:
    EMPTY TEMP-TABLE T-ORIGEN.
    EMPTY TEMP-TABLE T-DESTINO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RADIO-SET-tipo W-Win
ON VALUE-CHANGED OF RADIO-SET-tipo IN FRAME F-Main
DO:
    EMPTY TEMP-TABLE T-ORIGEN.
    EMPTY TEMP-TABLE T-DESTINO.
...
/*             END.                                                                                                                  */
        ...
        FOR EACH T-FAI-ART WHERE T-FAI-ART.codmat = Detalle.codmat :
            ASSIGN T-FAI-ART.codFAC = CcbDDocu.Coddoc        /* FAC */
                    T-FAI-ART.nroFAC = CcbDDocu.Nrodoc.
        END.
...
IF radio-set-tipo = 1 THEN x-agrupador = "".

FOR EACH ccbcdocu NO-LOCK WHERE ccbcdocu.codcia = s-codcia AND
    /*ccbcdocu.codalm <> '11D' AND*/    /* SANTA RAQUEL-CUSTODIA BCP: actualmente está inactivo */
    (ccbcdocu.fchdoc >= fill-in-FchSal-1 AND ccbcdocu.fchdoc <= fill-in-FchSal-2) AND
    ccbcdocu.coddoc = 'FAI' AND
    (ccbcdocu.flgest = 'P' OR ccbcdocu.flgest = 'C'),
    FIRST PEDIDO WHERE PEDIDO.CodCia = CcbCDocu.CodCia
    AND PEDIDO.CodDoc = CcbCDocu.CodPed
    AND PEDIDO.NroPed = CcbCDocu.NroPed NO-LOCK,
    FIRST COTIZACION WHERE COTIZACION.CodCia = PEDIDO.CodCia
    AND COTIZACION.CodDoc = PEDIDO.CodRef
    AND COTIZACION.NroPed = PEDIDO.NroRef 
    AND ((x-agrupador = "") OR (COTIZACION.InvoiceCustomerGroup = x-Agrupador)) NO-LOCK:
    /* *************************************** */
    /* Que las FAI no esten FACTURADAS */
    /* *************************************** */
    IF NOT (TRUE <> (ccbcdocu.libre_c03 > "")) THEN NEXT.
    /* *************************************** */
    /* 13/7/23: Nuevo filtro de cliente recoge */
    /* *************************************** */
    CASE TRUE:
        WHEN RADIO-SET-Cliente_Recoge = YES THEN DO:
            IF PEDIDO.Cliente_Recoge = NO THEN NEXT.
        END.
        WHEN RADIO-SET-Cliente_Recoge = NO THEN DO:
            IF PEDIDO.Cliente_Recoge = YES THEN NEXT.
        END.
    END CASE.
    /* *************************************** */

    x-guia = "".
    /* Si no tiene Grupo, entonces es Pedido Extraordinario */
    IF TRUE <> (COTIZACION.DeliveryGroup > "") THEN DO:
        FIND FIRST x-ccbcdocu WHERE x-ccbcdocu.codcia = s-codcia AND
            x-ccbcdocu.codref = ccbcdocu.coddoc AND /* FAI */
            x-ccbcdocu.nroref = ccbcdocu.nrodoc AND
            x-ccbcdocu.coddoc = 'G/R' AND
            x-ccbcdocu.flgest <> 'A' NO-LOCK NO-ERROR.
        IF AVAILABLE x-ccbcdocu THEN x-guia = x-ccbcdocu.nrodoc.
    END.
    ELSE DO:
        /* Debe ser del mismo grupo de reparto */
        IF COTIZACION.DeliveryGroup <> combo-box-grupo THEN NEXT.
        /* FAI aun sin G/R */
        IF TRUE <> (ccbcdocu.codref > "") THEN x-faltan-guias = YES.
        x-guia = ccbcdocu.nroref.
    END.

    /* Verificamos si la G/R en la H/R esta ENTREGADO */
    x-entregado = "NO".
    x-FchSal = ?.
    ...
    FOR EACH DI-RUTAD WHERE DI-RUTAD.codcia = s-codcia AND
        ...
        DI-RUTAD.codref = 'G/R' AND
        DI-RUTAD.nroref = x-guia AND
        DI-RUTAD.flgest = 'C' NO-LOCK : /* C : Entregado */
        FIND FIRST DI-RUTAC OF DI-RUTAD NO-LOCK NO-ERROR.
        IF AVAILABLE DI-RUTAC AND DI-RutaC.FlgEst = "C" THEN DO:    /* H/R Cerrado */
            x-entregado = "SI".
            x-FchSal = DI-RUTAC.FchSal.
            LEAVE HR_ENTREGADO.
        END.
    END.
    ...
    x-Orden = x-Orden + 1.
    ASSIGN
        T-ORIGEN.FchVto = x-FchSal
        T-ORIGEN.Puntos = x-Orden
        T-ORIGEN.nroref = (IF RADIO-SET-Cliente_Recoge = YES THEN 'CLIENTE RECOGE' ELSE x-guia)
        T-ORIGEN.libre_c05 = x-entregado.
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-tipo FILL-IN-Items FILL-IN-Total COMBO-BOX-Clientes 
          FILL-IN-FchSal-1 FILL-IN-FchSal-2 COMBO-NroSer FILL-IN-NroDoc 
          FILL-IN-Division COMBO-BOX-grupo RADIO-SET-Cliente_Recoge 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE BROWSE-ORIGEN RADIO-SET-tipo BUTTON-1 COMBO-BOX-Clientes 
         FILL-IN-FchSal-1 FILL-IN-FchSal-2 COMBO-NroSer BUTTON-Filtrar 
         BUTTON-Exportar Btn_OK BtnDone BUTTON-2 COMBO-BOX-grupo BUTTON-12 
         RADIO-SET-Cliente_Recoge RECT-2 RECT-3 BROWSE-DESTINO RECT-4 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH T-DESTINO NO-LOCK,
    ...
    /*  */
    IF T-DESTINO.libre_c05 = 'NO' THEN x-guias-no-entregados = YES.
...
FOR EACH T-FAI-ART NO-LOCK:
    CREATE vtatabla.
        ASSIGN vtatabla.codcia = s-codcia 
            vtatabla.tabla = "CRUCE-FAI-FAC"
            vtatabla.llave_c1 = TRIM(T-FAI-ART.codfai) + "-" + TRIM(T-FAI-ART.nrofai)
            vtatabla.llave_c2 = TRIM(T-FAI-ART.codFAC) + "-" + TRIM(T-FAI-ART.nroFAC)
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        FOR EACH ccbcdocu NO-LOCK WHERE ccbcdocu.codcia = s-codcia AND
                                        (ccbcdocu.fchdoc >= fill-in-FchSal-1 AND ccbcdocu.fchdoc <= fill-in-FchSal-2) AND
                                        ccbcdocu.coddoc = 'FAI' AND
                                        (ccbcdocu.flgest = 'C' OR ccbcdocu.flgest = 'P'),
            FIRST PEDIDO WHERE PEDIDO.CodCia = CcbCDocu.CodCia
            AND PEDIDO.CodDoc = CcbCDocu.CodPed
            AND PEDIDO.NroPed = CcbCDocu.NroPed NO-LOCK,
            FIRST COTIZACION WHERE COTIZACION.CodCia = PEDIDO.CodCia
