...
&Scoped-define FIELDS-IN-QUERY-br_table CPEDI.Sede CPEDI.LugEnt ~
CPEDI.ImpTot 
...
DEFINE VARIABLE FILL-IN-ImpTot AS DECIMAL FORMAT "-ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81
     BGCOLOR 1 FGCOLOR 15 FONT 4 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CPEDI.Sede FORMAT "x(5)":U
      CPEDI.LugEnt FORMAT "x(60)":U
      CPEDI.ImpTot FORMAT "->>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 62 BY 6.69
         FONT 4
         TITLE "PACKING LIST POR LOCAL" FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpTot AT ROW 7.73 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = Temp-Tables.CPEDI.Sede
     _FldNameList[2]   = Temp-Tables.CPEDI.LugEnt
     _FldNameList[3]   = Temp-Tables.CPEDI.ImpTot
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* PACKING LIST POR LOCAL */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* PACKING LIST POR LOCAL */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* PACKING LIST POR LOCAL */
DO:
...
DEF INPUT PARAMETER TABLE FOR CPEDI.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      FILL-IN-ImpTot = 0.
      FOR EACH CPEDI NO-LOCK:
          FILL-IN-ImpTot = FILL-IN-ImpTot + CPEDI.ImpTot.
      END.
      DISPLAY FILL-IN-ImpTot.
  END.
