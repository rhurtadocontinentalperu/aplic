...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES VtaCDocu gn-clie
&Scoped-define FIRST-EXTERNAL-TABLE VtaCDocu


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR VtaCDocu, gn-clie.
...
&Scoped-Define DISPLAYED-OBJECTS EDITOR_NomCli FILL-IN_Ruc 
...
DEFINE FRAME F-Main
     VtaCDocu.NroPed AT ROW 1 COL 12 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     VtaCDocu.FchPed AT ROW 1 COL 69 COLON-ALIGNED WIDGET-ID 4 FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     VtaCDocu.CodCli AT ROW 1.81 COL 12 COLON-ALIGNED WIDGET-ID 2
          ...
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     EDITOR_NomCli AT ROW 2.62 COL 14 HELP
          "Nombre del Cliente" NO-LABEL WIDGET-ID 12
     FILL-IN_Ruc AT ROW 4.23 COL 12 COLON-ALIGNED HELP
          "Registro Unico de Contribuyente (Cliente)" WIDGET-ID 10
     "Nombre:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 2.88 COL 8 WIDGET-ID 14
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: INTEGRAL.VtaCDocu,INTEGRAL.gn-clie
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF AVAILABLE gn-clie THEN 
          ASSIGN
          EDITOR_NomCli:SCREEN-VALUE = gn-clie.nomcli
          FILL-IN_Ruc:SCREEN-VALUE = gn-clie.ruc.
      ELSE ASSIGN
          EDITOR_NomCli:SCREEN-VALUE = ""
