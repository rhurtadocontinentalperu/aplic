...
DEFINE FRAME F-Main
     ...
     BUTTON-Canc AT ROW 3.15 COL 141 WIDGET-ID 12
     RECT-24 AT ROW 2.62 COL 2 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 154.86 BY 25.88
         FONT 4.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-ped-utilex-unificado ( 2.88 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-ped-utilex-unificado ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-size IN h_b-pedmos-utilex ( 15.88 , 150.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-ped-utilex-unificado.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ped-utilex-unificado ).
       RUN set-position IN h_t-ped-utilex-unificado ( 10.96 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-ped-utilex-unificado ( 14.23 , 150.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 25.23 , 2.00 ) NO-ERROR.
