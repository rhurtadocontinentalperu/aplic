...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCTickets WHERE ~{&KEY-PHRASE} ~
      AND VtaCTickets.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaCTickets WHERE ~{&KEY-PHRASE} ~
      AND VtaCTickets.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaCTickets
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaCTickets
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "VtaCTickets.CodCia = s-codcia"
