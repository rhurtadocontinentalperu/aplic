...
DEFINE FRAME F-Main
     ...
     FILL-IN-Semaforo AT ROW 13.08 COL 82 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     FILL-IN-Master AT ROW 13.38 COL 64 COLON-ALIGNED WIDGET-ID 14
     "F8: Stocks por Almacén" VIEW-AS TEXT
          SIZE 17 BY .5 AT ROW 12.85 COL 53 WIDGET-ID 10
...
/*               IF CAN-FIND(FIRST B-ITEM WHERE CAN-FIND(FIRST Almmmatg WHERE Almmmatg.codcia = s-codcia */
/*                                                       AND Almmmatg.codmat = B-ITEM.codmat             */
/*                                                       AND Almmmatg.codfam <> '011' NO-LOCK)           */
/*                           NO-LOCK) THEN DO:                                                           */
/*                   MESSAGE 'El Pedido Comercial no puede contener artículos de la línea 011'           */
/*                       VIEW-AS ALERT-BOX ERROR.                                                        */
/*                   APPLY 'ENTRY':U TO ITEM.CodMat.                                                     */
/*                   RETURN "ADM-ERROR".                                                                 */
/*               END.                                                                                    */
