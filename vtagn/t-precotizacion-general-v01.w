...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 120.72 BY 13.65
...
DEFINE FRAME F-Main
     ...
     F-ValVta AT ROW 15.54 COL 58 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     F-ImpIsc AT ROW 15.54 COL 71 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     F-PorDes AT ROW 15.58 COL 11 COLON-ALIGNED WIDGET-ID 20
     F-TotBrt AT ROW 15.58 COL 24 NO-LABEL WIDGET-ID 22
     F-ImpExo AT ROW 15.58 COL 36 NO-LABEL WIDGET-ID 12
     F-ImpDes AT ROW 15.58 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     F-ImpIgv AT ROW 15.58 COL 83 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     F-ImpTot AT ROW 15.58 COL 96 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 15 COL 76 WIDGET-ID 28
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 15 COL 24 WIDGET-ID 26
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 15 COL 35 WIDGET-ID 36
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 15 COL 48 WIDGET-ID 34
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 15 COL 87 WIDGET-ID 32
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 15 COL 61 WIDGET-ID 30
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 15 COL 98 WIDGET-ID 38
...
DO:
    IF s-codcli = '' THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    RUN vtagn/d-precot-terceros-v01.w.
