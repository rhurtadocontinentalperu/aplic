...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-nota-de-pedido-v1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nota-de-pedido ).
       RUN set-position IN h_v-nota-de-pedido ( 2.35 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_f-cot-gral-envio-admin ( 11.77 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-nota-de-pedido-v1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-nota-de-pedido ).
       RUN set-position IN h_b-nota-de-pedido ( 13.08 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-nota-de-pedido ( 13.19 , 156.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-nota-de-pedido-v1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-nota-de-pedido ).
       RUN set-position IN h_t-nota-de-pedido ( 13.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-nota-de-pedido ( 13.19 , 156.00 ) NO-ERROR.
