...
&Scoped-Define ENABLED-OBJECTS RECT-28 br_table BUTTON-3 
...
/* BROWSE-TAB br_table RECT-28 F-Main */
ASSIGN 
...
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:  NO controlamos stock, el control de stock se hace al final
            Solo se va a redondear a empaques (master y/o inner)
------------------------------------------------------------------------------*/
  ...
  /* ******************************************************************** */
  /* Ajuste al Empaque Maste o Inner */
  /* ******************************************************************** */
  ...
  IF s-FlgEmpaque = YES THEN DO:
      ...
      IF f-CanPed <= 0 THEN DO:
          MESSAGE 'Solo puede vender en empaque master de' pMaster 
              'y/o empaque inner de ' pInner Almmmatg.UndBas VIEW-AS ALERT-BOX ERROR.
          APPLY 'ENTRY':U TO PEDI.CanPed.
          RETURN "ADM-ERROR".
      END.
  END.
