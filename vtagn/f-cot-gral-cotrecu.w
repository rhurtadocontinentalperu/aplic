...
&Scoped-Define ENABLED-OBJECTS BUTTON-IMP-HIST-COT 
...
DEFINE FRAME F-Main
     BUTTON-IMP-HIST-COT AT ROW 1 COL 1 WIDGET-ID 36
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-IMP-HIST-COT F-Frame-Win
ON CHOOSE OF BUTTON-IMP-HIST-COT IN FRAME F-Main /* COTIZACIONES RECURRENTES */
DO:
   RUN Procesa-Botones IN lh_handle ("Captura-Historico-Cotizaciones").
END.
