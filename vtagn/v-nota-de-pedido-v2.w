...
FacCPedi.ordcmp FacCPedi.CodVen FacCPedi.Cmpbnte FacCPedi.NroCard ~
FacCPedi.TpoCmb FacCPedi.FlgIgv FacCPedi.Glosa FacCPedi.Libre_d01 ~
...
FacCPedi.CodVen FacCPedi.Cmpbnte FacCPedi.NroCard FacCPedi.FlgIgv ~
...
F-Nomtar FILL-IN-sede txtStkLetras FILL-IN-CodPos FILL-IN-DesAlm 
...
DEFINE FRAME F-Main
     FacCPedi.NroCard AT ROW 6.12 COL 15 COLON-ALIGNED WIDGET-ID 56
          LABEL "Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     F-Nomtar AT ROW 6.12 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 92
     FacCPedi.TpoCmb AT ROW 6.12 COL 94 COLON-ALIGNED WIDGET-ID 64
          LABEL "T.C."
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     FacCPedi.FlgIgv AT ROW 6.12 COL 111 WIDGET-ID 116
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY .77
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Glosa AT ROW 6.92 COL 15 COLON-ALIGNED WIDGET-ID 110
          LABEL "Glosa" FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 69 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Libre_d01 AT ROW 6.92 COL 111 NO-LABEL WIDGET-ID 158
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "2", 2,
"3", 3,
...
"5", 5
          SIZE 15 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Sede AT ROW 8.27 COL 15 COLON-ALIGNED WIDGET-ID 62
          LABEL "Lugar de Entrega"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FILL-IN-sede AT ROW 8.27 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     txtStkLetras AT ROW 8.27 COL 106 COLON-ALIGNED NO-LABEL WIDGET-ID 152
     FacCPedi.CodPos AT ROW 9.08 COL 15 COLON-ALIGNED WIDGET-ID 170
          LABEL "Código Postal"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FILL-IN-CodPos AT ROW 9.08 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 128
     FacCPedi.CodRef AT ROW 9.08 COL 106 COLON-ALIGNED WIDGET-ID 120
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 9.08 COL 111 COLON-ALIGNED NO-LABEL WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     FacCPedi.Cliente_Recoge AT ROW 9.88 COL 17 NO-LABEL WIDGET-ID 164
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Sí", yes,
"No", no
          SIZE 12 BY .81
          FGCOLOR 8 FONT 6
     FacCPedi.CodAlm AT ROW 9.88 COL 36 COLON-ALIGNED WIDGET-ID 176
          LABEL "Tienda" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     FILL-IN-DesAlm AT ROW 9.88 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 178
     "Redondedo del P.U.:" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 7.19 COL 93 WIDGET-ID 100
     "Cliente Recoge?" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 10.15 COL 2 WIDGET-ID 168
          FGCOLOR 8 FONT 6
     "Stock de Letras" VIEW-AS TEXT
          SIZE 15.14 BY .69 AT ROW 8.27 COL 93 WIDGET-ID 150
     ...
     RECT-25 AT ROW 8 COL 1 WIDGET-ID 172
     RECT-26 AT ROW 8 COL 90 WIDGET-ID 174
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4 WIDGET-ID 100.
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    ASSIGN 
        ...
        FacCPedi.FlgEst = (IF FacCPedi.CodCli BEGINS "SYS" THEN "I" ELSE "PV")     /* APROBADO */
...
/* NO debe haber algún producto SIN GRUPO */
DEF BUFFER B-CDOCU FOR Faccpedi.
FIND FIRST B-CDOCU WHERE B-CDOCU.codcia = Faccpedi.codcia
    AND B-CDOCU.coddiv = Faccpedi.coddiv
    AND B-CDOCU.coddoc = Faccpedi.coddoc + "*"
    AND B-CDOCU.nroped = B-CDOCU.nroped + "|SIN GRUPO"
    NO-LOCK NO-ERROR.
IF AVAILABLE B-CDOCU THEN DO:
    MESSAGE 'Se ha detectado que algunos productos no tienen definido un GRUPO POR LINEA' SKIP
        'Avisar al área Comercial' VIEW-AS ALERT-BOX ERROR.
    RETURN.
END.
...
FOR EACH facdpedi OF faccpedi NO-LOCK,
    ...
    /* *************************************************************************** */
    /* *************************************************************************** */
/*     IF Facdpedi.aftIgv = YES THEN DO:                                                         */
/*         IF l-incigv THEN DO:                                                                  */
/*             F-ImpLin = FacDPedi.ImpLin.                                                       */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Genera-Grupos V-table-Win 
PROCEDURE Genera-Grupos :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
/* 1ro. Limpiamos información DETALLE */
...
FOR EACH VtaTabla NO-LOCK WHERE VtaTabla.CodCia = gn-divi.CodCia
    ...
    FIND FIRST B-CDOCU WHERE B-CDOCU.codcia = Faccpedi.codcia
        ...
        AND B-CDOCU.NroPed = Faccpedi.NroPed + "|" + Vtatabla.Libre_c01     /* Ej. 00100101|000,011 */
    ...
    FOR EACH Facdpedi OF Faccpedi NO-LOCK, 
        ...
        CREATE B-DDOCU.
        BUFFER-COPY Facdpedi TO B-DDOCU
            ASSIGN 
    ...
    IF AVAILABLE gn-convt THEN DO:
        CASE gn-ConVt.TipVta:
            ...
            WHEN "2" THEN DO:                 /* Crédito */
                IF VtaTabla.Valor[1] = 1 OR VtaTabla.Valor[2] = 2 THEN B-CDOCU.CodMon = VtaTabla.Valor[2].
            END.
        END CASE.
    END.
    /* Recalculamos la NPC */
...
DEF VAR pOrdCmp AS CHAR NO-UNDO.
DEF VAR pSede AS CHAR NO-UNDO.
DEF VAR pGlosa AS CHAR NO-UNDO.

ASSIGN
    pGlosa = FacCPedi.Glosa:SCREEN-VALUE IN FRAME {&FRAME-NAME}.

DEFINE VAR hProc AS HANDLE NO-UNDO.
RUN vtagn/ventas-library.p PERSISTENT SET hProc.
RUN COT_Importar-Supermercados IN hProc (INPUT s-CodAlm,
                                         OUTPUT s-CodCli,
                                         OUTPUT pOrdCmp,
                                         OUTPUT pSede,
                                         INPUT-OUTPUT pGlosa,
...
ASSIGN
    FacCPedi.CodCli:SCREEN-VALUE IN FRAME {&FRAME-NAME} = s-CodCli
    FacCPedi.Sede:SCREEN-VALUE IN FRAME {&FRAME-NAME}   = pSede
    FacCPedi.Glosa:SCREEN-VALUE IN FRAME {&FRAME-NAME}  = pGlosa
    FacCPedi.ordcmp:SCREEN-VALUE IN FRAME {&FRAME-NAME} = pOrdCmp.
/* BLOQUEAMOS CAMPOS */
ASSIGN
...
APPLY 'LEAVE':U TO FacCPedi.Sede IN FRAME {&FRAME-NAME}.
...
FOR EACH tt-OrdenesPlazVea :
    ...
    FOR EACH OrdenCompra-tienda WHERE lOrden = OrdenCompra-Tienda.nro-oc :
        ...
        END.
        /* ****************************************************************************************** */
        RUN vtagn/p-genera-npc-por-grupos (INPUT FacCPedi.CodDoc,
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
      WHEN "YES" THEN DO:   /* CREAR */
          ...
          /* ************************************************************************ */
          ASSIGN Faccpedi.FlgEst = 'PV'.     /* Por Aprobar */
          /* ************************************************************************ */
      END.
...
------------------------------------------------------------------------------*/
  ...
  CASE TRUE:
      WHEN s-TpoPed = "LF" THEN DO:
          MESSAGE 'Acceso Denegado LF' VIEW-AS ALERT-BOX ERROR.
          RETURN 'ADM-ERROR'.
      END.
...
/*   RUN dispatch IN THIS-PROCEDURE ( INPUT 'delete-record':U ) . */
  ...
  IF LOOKUP(FacCPedi.FlgEst,"PV") = 0 THEN DO:
      MESSAGE 'Acceso denegado' VIEW-AS ALERT-BOX ERROR.
      RETURN "ADM-ERROR".
  END.
