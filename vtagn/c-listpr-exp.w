...
&SCOPED-DEFINE l-lookup h_l-listpr-exp
...
DEFINE VARIABLE h_l-listpr-exp AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/l-listpr-exp.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-listpr-exp ).
       RUN set-position IN h_l-listpr-exp ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-listpr-exp ( 14.23 , 108.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-listpr-exp. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listpr-exp ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listpr-exp , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listpr-exp ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-detart ,
             h_l-listpr-exp , 'AFTER':U ).
