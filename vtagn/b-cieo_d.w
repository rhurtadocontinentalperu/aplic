...
DEF SHARED VAR s-codped AS CHAR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCDocu.NroPed COLUMN-LABEL "Numero" FORMAT "X(9)":U WIDTH 10.43
      VtaCDocu.FchPed COLUMN-LABEL "Emision" FORMAT "99/99/99":U
...
/* Query rebuild information for BROWSE br_table
 ...
 AND VtaCDocu.CodPed = s-codped
 AND (VtaCDocu.FlgEst = ""P""
 OR VtaCDocu.FlgEst = ""X"")"
     _FldNameList[1]   > INTEGRAL.VtaCDocu.NroPed
"VtaCDocu.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaCDocu.FchPed
"VtaCDocu.FchPed" "Emision" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DEF VAR x-CodCot LIKE Vtacdocu.codped NO-UNDO.
DEF VAR x-NroCot LIKE Vtacdocu.nroped NO-UNDO.
  
MESSAGE 'Desea CERRAR la Orden de Despacho?'
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    ASSIGN
        VtaCDocu.FlgEst = 'S'.      /* Ciclo Suspendido */
    /* BUSCAMOS EL PEDIDO */
