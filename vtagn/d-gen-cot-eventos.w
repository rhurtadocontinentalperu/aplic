...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-CodVen Btn_OK Btn_Cancel 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/b-gen-cot-eventos-cab.w':U ,
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-CodVen 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX-CodVen Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
/*       END.                                                                              */
      FOR EACH ExpTermi NO-LOCK WHERE ExpTermi.CodCia = s-codcia
          AND ExpTermi.CodDiv = s-coddiv,
          FIRST gn-ven OF ExpTermi NO-LOCK
          BREAK BY ExpTermi.CodVen:
          IF FIRST-OF(ExpTermi.CodVen) THEN DO:
              COMBO-BOX-CodVen:ADD-LAST(gn-ven.CodVen + " " + gn-ven.NomVen,gn-ven.CodVen).
          END.
      END.
  END.
