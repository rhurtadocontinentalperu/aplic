...
/* ***************************  Definitions  ************************** */
/*&SCOPED-DEFINE precio-venta-general pri/PrecioVentaMayorCredito-v2.r*/
...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Semaforo FILL-IN-Master 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      fDesMat() @ x-DesMat COLUMN-LABEL "Descripción" FORMAT "x(80)":U
            WIDTH 80
      fDesMar() @ x-DesMar COLUMN-LABEL "Marca" FORMAT "x(20)":U
            WIDTH 12.43
      ITEM.UndVta COLUMN-LABEL "Unidad" FORMAT "x(10)":U WIDTH 6.43
      ITEM.CanPed FORMAT ">>>,>>9.99":U WIDTH 9.14 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
      ITEM.codmat
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 131 BY 12.65
...
DEFINE FRAME F-Main
     ...
     BUTTON-2 AT ROW 13.65 COL 36 WIDGET-ID 8
     FILL-IN-Semaforo AT ROW 13.88 COL 82 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     FILL-IN-Master AT ROW 14.19 COL 64 COLON-ALIGNED WIDGET-ID 14
     "F8: Stocks por Almacén" VIEW-AS TEXT
          SIZE 17 BY .5 AT ROW 13.65 COL 53 WIDGET-ID 10
...
"fDesMat() @ x-DesMat" "Descripción" "x(80)" ? ? ? ? ? ? ? no ? no no "80" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.CanPed" ? ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
