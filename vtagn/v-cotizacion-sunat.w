...
DEFINE BUFFER TABLET FOR FacCPedi.
...
FacCPedi.Cliente_Recoge FacCPedi.CodAlm FacCPedi.CodOrigen ~
FacCPedi.NroOrigen 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1.27 COL 127.14 COLON-ALIGNED WIDGET-ID 46
...
"No", ""
     ...
     FacCPedi.usuario AT ROW 2.08 COL 127 COLON-ALIGNED WIDGET-ID 66
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.Atencion AT ROW 2.88 COL 33 COLON-ALIGNED WIDGET-ID 88
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.fchven AT ROW 2.88 COL 127 COLON-ALIGNED WIDGET-ID 48 FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.NomCli AT ROW 3.69 COL 15 COLON-ALIGNED WIDGET-ID 54 FORMAT "x(256)"
          ...
          SIZE 90 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FchEnt AT ROW 3.69 COL 127 COLON-ALIGNED WIDGET-ID 130
     ...
     FacCPedi.DirCli AT ROW 4.5 COL 15 COLON-ALIGNED WIDGET-ID 44
          ...
          SIZE 90 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.ordcmp AT ROW 4.5 COL 127 COLON-ALIGNED WIDGET-ID 118 FORMAT "X(25)"
          VIEW-AS FILL-IN 
          SIZE 20 BY .81
          BGCOLOR 11 FGCOLOR 0 
     ...
     FacCPedi.Cmpbnte AT ROW 5.31 COL 129 NO-LABEL WIDGET-ID 102
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "FAC", "FAC":U,
"BOL", "BOL":U
...
DEFINE FRAME F-Main
     ...
     FacCPedi.TpoCmb AT ROW 6.12 COL 112 COLON-ALIGNED WIDGET-ID 64
          LABEL "T.C."
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     FacCPedi.CodMon AT ROW 6.12 COL 129 NO-LABEL WIDGET-ID 78
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dólares", 2
     ...
     FacCPedi.FlgIgv AT ROW 6.92 COL 129 WIDGET-ID 116
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY .77
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Glosa AT ROW 7.73 COL 15 COLON-ALIGNED WIDGET-ID 110
          ...
          SIZE 69 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Libre_d01 AT ROW 7.73 COL 129 NO-LABEL WIDGET-ID 158
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "2", 2,
"3", 3,
...
"5", 5
     ...
     txtStkLetras AT ROW 9.08 COL 124 COLON-ALIGNED NO-LABEL WIDGET-ID 152
     ...
     FacCPedi.CodRef AT ROW 9.88 COL 124 COLON-ALIGNED WIDGET-ID 120
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 9.88 COL 129 COLON-ALIGNED NO-LABEL WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
...
"No", no
     ...
     FacCPedi.CodOrigen AT ROW 10.69 COL 124 COLON-ALIGNED WIDGET-ID 182
          LABEL "Doc. Tablet"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     FacCPedi.NroOrigen AT ROW 10.69 COL 131 COLON-ALIGNED NO-LABEL WIDGET-ID 184
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DEFINE FRAME F-Main
     "Redondedo del P.U.:" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 8 COL 111 WIDGET-ID 100
     "Moneda:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 6.04 COL 123.14 WIDGET-ID 84
     "Stock de Letras" VIEW-AS TEXT
          SIZE 15.14 BY .69 AT ROW 9.08 COL 111 WIDGET-ID 150
     ...
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 5.31 COL 119.14 WIDGET-ID 106
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: TABLET B "?" ? INTEGRAL FacCPedi
   END-TABLES.
 */
...
DO WITH FRAME {&FRAME-NAME}:
    IF FacCPedi.CodOrigen:SCREEN-VALUE = "PPX" THEN RETURN.    /* Ya fue */
    ...
    FIND FIRST TABLET WHERE TABLET.codcia = s-codcia
        AND TABLET.coddiv = s-coddiv
        AND TABLET.coddoc = "PPX"
        AND TABLET.codcli = FacCPedi.CodCli:SCREEN-VALUE
        AND TABLET.flgest = "P"
        AND TABLET.fchped >= (TODAY - 1)
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE TABLET THEN RETURN.
    DISPLAY
        TABLET.CodDoc @ FacCPedi.CodRef
        TABLET.NroPed @ FacCPedi.NroRef.

    DEF BUFFER PEDI2 FOR ITEM.
    i-nItem = 0.
    FOR EACH PEDI2:
        i-nItem = i-nItem + 1.
    END.
    ...
    FOR EACH Facdpedi OF Faccpedi NO-LOCK BY Facdpedi.NroItm:
        FIND FIRST ITEM WHERE ITEM.CodMat = Facdpedi.CodMat NO-LOCK NO-ERROR.
        ...
        BUFFER-COPY FacDPedi 
            EXCEPT FacDPedi.Libre_d05
            TO PEDI2
            ASSIGN 
                PEDI2.CodCia = s-codcia
                PEDI2.CodDiv = s-coddiv
                PEDI2.CodDoc = s-coddoc
                PEDI2.NroPed = ''
                PEDI2.NroItm = I-NITEM
                PEDI2.CanAte = 0
                PEDI2.CanPed = PEDI2.CanPed.
    END.
...
FOR EACH Facdpedi OF Faccpedi NO-LOCK WHERE Facdpedi.Libre_c05 <> "OF",
    ...
    IF Facdpedi.Libre_c04 = 'EDVXSALDOC' THEN ASSIGN ITEM.Por_Dsctos[1] = 0 ITEM.Por_Dsctos[3] = 0.
    LogRecalcular = NO.
    IF LOOKUP(Facdpedi.Libre_c04, 'DCAMPANA,DVXDSF,DVXSALDOC,EDVXSALDOC') > 0 THEN LogRecalcular = YES.
...
/*IF FacCpedi.FlgIgv THEN DO:*/
IF l-incigv THEN DO:
   F-ImpTot = FacCPedi.TotalPrecioVenta.
END.
ELSE DO:
...
FOR EACH facdpedi OF faccpedi NO-LOCK,
    ...
    /* *************************************************************************** */
    x-ImpLin = FacDPedi.cImporteTotalConImpuesto.
    IF (FacDPedi.Por_Dsctos[1] + FacDPedi.Por_Dsctos[2] + FacDPedi.Por_Dsctos[3] + ~
        FacDPedi.ImpDto2) = 0 THEN DO:
        F-PreUni = FacDPedi.PreUni.
    END.
    ELSE DO:
        IF l-IncIgv = YES THEN F-PreUni = ROUND(x-ImpLin / FacDPedi.CanPed, INTEGER(Faccpedi.Libre_d01)).
        ELSE F-PreUni = ROUND(x-ImpLin / FacDPedi.CanPed, 4).
    END.
    CASE TRUE:
        ...
        WHEN l-IncIgv = NO AND Facdpedi.AftIgv = YES THEN DO:
            ...
            F-ImpLin = ROUND(x-ImpLin / (1 + FacCPedi.PorIgv / 100), 2).
        END.
        OTHERWISE DO:
            F-ImpLin = x-ImpLin. 
        END.
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST Sunat_Fact_Electr_Taxs  WHERE Sunat_Fact_Electr_Taxs.TaxTypeCode = "IGV"
      ...
      NO-LOCK NO-ERROR.
  IF AVAILABLE Sunat_Fact_Electr_Taxs THEN s-PorIgv = Sunat_Fact_Electr_Taxs.Tax.
...
/*   DELETE PROCEDURE hProc.                                                                          */
  ...
  /* 10/11/2020 : No hay nada configurado hasta este momento */
...
/*   IF pError = "ADM-ERROR" THEN UNDO, RETURN 'ADM-ERROR'.                               */
  ...
  END.
  /* ****************************************************************************************** */
  /* Actualizamos Pedidos TABLET */
  /* ****************************************************************************************** */
  IF FacCPedi.CodOrigen = "PPX" THEN DO:
      FIND TABLET WHERE TABLET.CodCia = Faccpedi.codcia
          AND TABLET.CodDiv = Faccpedi.coddiv
          AND TABLET.CodDoc = FacCPedi.CodOrigen
          AND TABLET.NroPed = FacCPedi.NroOrigen
          EXCLUSIVE-LOCK NO-ERROR.
      IF NOT AVAILABLE TABLET THEN DO:
          RUN dispatch IN THIS-PROCEDURE ('show-errors':U).
          UNDO, RETURN 'ADM-ERROR'.
      END.
      ASSIGN
          TABLET.FlgEst = "C"
          TABLET.NCmpbnte = Faccpedi.coddoc  + ',' + Faccpedi.nroped.  /* OJO */
  END.
  IF AVAILABLE(Faccorre) THEN RELEASE FacCorre.
  IF AVAILABLE(Facdpedi) THEN RELEASE Facdpedi.
  IF AVAILABLE(B-DPEDI)  THEN RELEASE B-DPEDI.
  IF AVAILABLE(gn-clie)  THEN RELEASE Gn-Clie.
  IF AVAILABLE(TABLET)  THEN RELEASE TABLET.
...
/*   RUN dispatch IN THIS-PROCEDURE ( INPUT 'delete-record':U ) . */
  ...
  /* RHC 16/10/2020 D.LL. Caso de Eventos */
  IF s-TpoPed = "E" AND Faccpedi.FlgEst = "P" THEN DO:
      MESSAGE 'Acceso Denegado' VIEW-AS ALERT-BOX ERROR.
      RETURN 'ADM-ERROR'.
  END.
  IF LOOKUP(FacCPedi.FlgEst,"PV,P,T,V") = 0 THEN DO:
      MESSAGE 'Acceso denegado' VIEW-AS ALERT-BOX ERROR.
      RETURN "ADM-ERROR".
  END.
...
*/
/* ****************************************************************************** */
IF LOOKUP(FacCPedi.FlgEst,"PV,P,T,I") = 0 THEN DO:
    MESSAGE 'Acceso denegado' VIEW-AS ALERT-BOX ERROR.
    RETURN "ADM-ERROR".
END.
/* ****************************************************************************** */
/* RHC 13/10/2020 Llican: Solo Eventos */
/* ****************************************************************************** */
IF s-TpoPed = "E" AND Faccpedi.FlgEst = "P" THEN DO:
    MESSAGE 'Acceso Denegado' VIEW-AS ALERT-BOX WARNING.
    RETURN 'ADM-ERROR'.
    /* SE dejo sin efecto correo de Mayra Padilla, 19Ene2021
        MESSAGE 'Acceso Denegado' VIEW-AS ALERT-BOX WARNING.
        RETURN 'ADM-ERROR'.
    */
END.
...
IF s-tpoped = 'LF' AND Faccpedi.FlgEst = "P" THEN DO:
    ...
    RETURN "ADM-ERROR".
END.
IF s-tpoped = 'LF' AND Faccpedi.FlgEst = "E" THEN DO:
    MESSAGE 'Cotización de ListaExpress'  SKIP
        'Acceso denegado' VIEW-AS ALERT-BOX ERROR.
    RETURN "ADM-ERROR".
END.
