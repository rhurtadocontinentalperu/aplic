...
DEFINE FRAME F-Main
     BUTTON-PEN AT ROW 1.23 COL 99.14 WIDGET-ID 14
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-pedido-utilex.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-utilex ).
       RUN set-position IN h_v-pedido-utilex ( 2.62 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-pedido-utilex.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedido-utilex ).
       RUN set-position IN h_t-pedido-utilex ( 10.62 , 2.00 ) NO-ERROR.
...
/*       END.                                            */
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
        IF h_v-pedido-utilex <> ? THEN RUN Recalcular-Precios IN h_v-pedido-utilex.
