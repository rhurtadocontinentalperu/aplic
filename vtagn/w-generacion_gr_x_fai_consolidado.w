...
RUN gre/p-control-gre-activa-inactiva.p (INPUT "GRC", OUTPUT pRpta).
IF pRpta = NO THEN DO:
...
DO:
    ...
    IF FILL-IN-Items > 1000 THEN DO:
        MESSAGE 'Ha superado los 1000 POSICIONES' SKIP
            'Continuamos con la Generacion de las G/R?'
    ...
    */
    ...
    MESSAGE "Se va aproceder a generar la G/R con serie : " + COMBO-NroSer-Guia  SKIP "¿Todos los datos son correctos?"
...
DO:
    ASSIGN COMBO-BOX-Clientes COMBO-NroSer-Guia
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    FOR EACH Detalle , FIRST Almmmatg OF Detalle NO-LOCK BREAK BY Detalle.NROGUIA /*Detalle.CodCia*/:
        /* Crea Cabecera */
...
/*             END.                                                                                                                  */
            ...
            ASSIGN
                ...
                /* Ic - 03Set2020, se esta generando G/R en caso de generacion FAC se activara  */
...
/*             RELEASE b-controlOD.                                                             */
        ...
        FOR EACH T-FAI-ART WHERE T-FAI-ART.codmat = Detalle.codmat :
            ASSIGN T-FAI-ART.codGR = CcbCDocu.Coddoc        /* G/R */
        ...
        IF LAST-OF(Detalle.NroGuia) THEN DO:
            ...
            /*  Ic - 03Set2020 se esta generando G/R
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR'
    ...
    DO WHILE NOT QUERY-OFF-END('BROWSE-DESTINO'):
        ...
        IF Ccbcdocu.CodAlm = "11d" THEN ASSIGN Ccbcdocu.FlgEst = "C".
        /* ******************* */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    /*RUN Carga-Cancelacion.  Ic - 30Set2020 - FAI dejarla pendientes */
    /* ************************************************************* */
