...
------------------------------------------------------------------------------*/
    ...
    FOR EACH datos WHERE datos.codcia = s-codcia
        ...
        ASSIGN
            ...
            PEDI2.Libre_c03 = datos.Libre_c03
            .
        /* RHC 03/12/2015 CARGAMOS EL PROMOTOR EN EL CAMPO LIBRE */
        IF TRUE <> (PEDI2.Libre_c03 > '') THEN DO:
        ...
        END.
        /*MESSAGE pedi2.codmat pedi2.canped pedi2.libre_c03.*/
    END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE Almmmatg THEN DO:
      ...
      RETURN "ADM-ERROR".
  END.
    /* 04/01/2024: No es necesario, see controla en la cotizacion */
...
/*       THEN DO:                                                                                */
/*       MESSAGE "Código NO registrado en la lista de precios" pCodDiv                           */
