...
DEF INPUT PARAMETER pCodFai AS CHAR.
DEF INPUT PARAMETER pNroFai AS CHAR.
...
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH CcbCDocu ~
 ...
 AND CcbCDocu.CodRef = pCodFai ~
 AND CcbCDocu.NroRef = pNroFai ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 40 BY 8.62 FIT-LAST-COLUMN.
...
"CcbCDocu.FchDoc" "Fecha Emisión" ? "date" ? ? ? ? ? ? no ? no no "17.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* G/R por FAI */
DO:  
