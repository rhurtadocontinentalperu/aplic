...
&Scoped-Define ENABLED-OBJECTS BUTTON-IMP-PROV 
...
DEFINE FRAME F-Main
     BUTTON-IMP-PROV AT ROW 1 COL 1 WIDGET-ID 52
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-IMP-PROV F-Frame-Win
ON CHOOSE OF BUTTON-IMP-PROV IN FRAME F-Main /* IMPORT. EXCEL PROVINCIAS */
DO:
   RUN Procesa-Botones IN lh_handle ("Importar-Excel-Provincias").
END.
