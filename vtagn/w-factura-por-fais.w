...
&Scoped-Define ENABLED-OBJECTS RECT-2 COMBO-BOX-Clientes COMBO-BOX-Group ~
BUTTON-Filtrar COMBO-NroSer Btn_OK BtnDone 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Division COMBO-BOX-Clientes ~
COMBO-BOX-Group COMBO-NroSer FILL-IN-NroDoc 
...
DEFINE VARIABLE h_b-factura-por-fais AS HANDLE NO-UNDO.
...
DEFINE VARIABLE COMBO-BOX-Group AS CHARACTER FORMAT "X(256)":U INITIAL "Seleccione un agrupador" 
     LABEL "Grupo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "Seleccione un agrupador" 
     DROP-DOWN-LIST
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX-Group AT ROW 3.96 COL 9 COLON-ALIGNED WIDGET-ID 36
     BUTTON-Filtrar AT ROW 3.96 COL 51 WIDGET-ID 38
     COMBO-NroSer AT ROW 5.04 COL 3.43 WIDGET-ID 28
     FILL-IN-NroDoc AT ROW 5.12 COL 16 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     Btn_OK AT ROW 10.69 COL 81 WIDGET-ID 32
     BtnDone AT ROW 12.31 COL 81 WIDGET-ID 34
     RECT-2 AT ROW 1 COL 1 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 100.14 BY 25.38
...
DO:
    ...
    RUN Generacion-de-Factura IN h_b-factura-por-fais ( INPUT COMBO-NroSer,
                                                        OUTPUT pMensaje,
                                                        OUTPUT iCountGuide).
...
DO:
    ASSIGN COMBO-BOX-Clientes COMBO-BOX-Group COMBO-NroSer.
    RUN Carga-Filtros IN h_b-factura-por-fais ( INPUT COMBO-BOX-Clientes,
                                                INPUT COMBO-BOX-Group,
                                                INPUT COMBO-NroSer).
END.
...
DO:
    ...
    COMBO-BOX-Group:DELETE(COMBO-BOX-Group:LIST-ITEMS).
    FOR EACH T-INVOICE NO-LOCK WHERE T-INVOICE.CodCli = COMBO-BOX-Clientes:
        COMBO-BOX-Group:ADD-LAST(T-INVOICE.InvoiceCustomerGroup).
    END.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/b-factura-por-fais.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-factura-por-fais ).
       RUN set-position IN h_b-factura-por-fais ( 6.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-factura-por-fais ( 19.92 , 76.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-factura-por-fais ,
             FILL-IN-NroDoc:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Division COMBO-BOX-Clientes COMBO-BOX-Group COMBO-NroSer 
          FILL-IN-NroDoc 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-2 COMBO-BOX-Clientes COMBO-BOX-Group BUTTON-Filtrar COMBO-NroSer 
         Btn_OK BtnDone 
      WITH FRAME F-Main IN WINDOW W-Win.
