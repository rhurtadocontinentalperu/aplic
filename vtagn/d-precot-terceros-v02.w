...
DEFINE VARIABLE h_b-precot-terc-deta-v02 AS HANDLE NO-UNDO.
...
DO:
  RUN Graba-Datos IN h_b-precot-terc-deta-v02.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-precot-terc-deta-v02.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-precot-terc-deta-v02 ).
       RUN set-position IN h_b-precot-terc-deta-v02 ( 11.77 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-precot-terc-deta-v02 ( 12.12 , 130.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bpagcatvtas-v2. */
       RUN add-link IN adm-broker-hdl ( h_b-precot-terc-prov-v02 , 'Record':U , h_bpagcatvtas-v2 ).

       /* Links to SmartBrowser h_b-precot-terc-deta-v02. */
       RUN add-link IN adm-broker-hdl ( h_bpagcatvtas-v2 , 'Record':U , h_b-precot-terc-deta-v02 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-precot-terc-deta-v02 ,
...
------------------------------------------------------------------------------*/
    ...
    CASE pParameter:
        ...
        WHEN 'Open-Query-3' THEN DO:
            RUN dispatch IN h_b-precot-terc-deta-v02 ('open-query').
        END.
    END CASE.
