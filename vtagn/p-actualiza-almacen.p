...
DEFINE VAR pCodMov AS INTE NO-UNDO.

pCodMov = Ccbcdocu.CodMov.
IF Ccbcdocu.CodMov = 00 OR Ccbcdocu.CodMov = ? THEN pCodMov = 02.   /* Valor por defecto */
...
FIND gn-divi WHERE gn-divi.codcia = ccbcdocu.codcia 
    ...
    NO-LOCK NO-ERROR.                                                                    
/* ************************************************************************** */
/* RHC 17/08/2015 RUTINA GENERAL: SOLO FAC BOL FAI GENERAN MOVIMIENTOS DE ALMACEN */
/* ************************************************************************** */
ASSIGN 
