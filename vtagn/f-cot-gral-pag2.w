...
&Scoped-Define ENABLED-OBJECTS B-CCTE BUTTON-COT 
...
DEFINE FRAME F-Main
     B-CCTE AT ROW 1 COL 1 WIDGET-ID 16
     BUTTON-COT AT ROW 2.08 COL 1 WIDGET-ID 18
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL B-CCTE F-Frame-Win
...
DO:
    ...
    ASSIGN
        ...
        logtabla.ValorLlave = "BOTON-CTACTE".

    RUN Procesa-Botones IN lh_handle ('Cuenta-Corriente').
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-COT F-Frame-Win
