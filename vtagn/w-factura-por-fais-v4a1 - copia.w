...
BUTTON-12 RECT-2 RECT-3 BROWSE-DESTINO 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-DESTINO W-Win _STRUCTURED
  QUERY BROWSE-DESTINO NO-LOCK DISPLAY
      ...
      T-DESTINO.Libre_c05 COLUMN-LABEL "Entregado" FORMAT "x(10)":U
            WIDTH 7.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 82.29 BY 18.31
         FONT 4
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-ORIGEN W-Win _STRUCTURED
  QUERY BROWSE-ORIGEN NO-LOCK DISPLAY
      ...
      T-ORIGEN.Libre_c05 COLUMN-LABEL "Entregado" FORMAT "x(10)":U
            WIDTH 7.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 81 BY 19.12
         FONT 4
...
DEFINE FRAME F-Main
     ...
     RADIO-SET-tipo AT ROW 3.88 COL 93 NO-LABEL WIDGET-ID 62
     ...
     BUTTON-Filtrar AT ROW 3.88 COL 115 WIDGET-ID 38
     BUTTON-Exportar AT ROW 4.96 COL 115 WIDGET-ID 48
     ...
     BROWSE-DESTINO AT ROW 6.38 COL 93.72 WIDGET-ID 300
...
"T-DESTINO.Libre_c05" "Entregado" "x(10)" "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
"T-ORIGEN.Libre_c05" "Entregado" "x(10)" "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
DO:
    ...
    IF x-guias-no-entregados = YES THEN DO:
        MESSAGE "Existen Guia de Remision que aun no esta" SKIP 
...
FOR EACH ccbcdocu NO-LOCK WHERE ccbcdocu.codcia = s-codcia AND
    ...
    IF TRUE <> (COTIZACION.DeliveryGroup > "") THEN DO:
        /* No tiene Grupo, entonces es Pedido Extraordinario */
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-tipo FILL-IN-Items FILL-IN-Total COMBO-BOX-Clientes 
          ...
          FILL-IN-Division COMBO-BOX-grupo 
