...
&SCOPED-DEFINE l-lookup h_l-vtaalmdiv-01
...
DEFINE VARIABLE h_l-vtaalmdiv-01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/l-vtaalmdiv-01.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_l-vtaalmdiv-01 ).
       RUN set-position IN h_l-vtaalmdiv-01 ( 1.04 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-vtaalmdiv-01 ( 10.92 , 47.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-vtaalmdiv-01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-vtaalmdiv-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-vtaalmdiv-01 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-vtaalmdiv-01 , 'AFTER':U ).
    END. /* Page 0 */
