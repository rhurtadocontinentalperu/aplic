...
CASE s-TpoPed:
    ...
    OTHERWISE DO:
        ...
        END.
/*         CASE TRUE:                                                              */
/*             WHEN s-CodDoc = "PPV" AND s-CodDiv = '00065' THEN s-CodAlm = "65S". */
/*             WHEN s-CodDoc = "PPV" AND s-CodDiv = '00072' THEN s-CodAlm = "76S". */
/*         END CASE.                                                               */
    END.
END CASE.
IF s-CodAlm = "" THEN DO:
...
DEFINE VARIABLE h_bpedcontadomarketv2 AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_t-ped-market-unificado-v2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-ped-market-unificado-v2 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     BUTTON-Genera-Orden AT ROW 2.54 COL 128 WIDGET-ID 10
     BUTTON-Verifica-Orden AT ROW 4.65 COL 128 WIDGET-ID 12
     RECT-24 AT ROW 2.35 COL 2 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 142.86 BY 25.73
...
DO:
  RUN Genera-Orden-Despacho IN h_v-ped-market-unificado-v2.
END.
...
DO:
  RUN Verifica-Pedido IN h_v-ped-market-unificado-v2.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-ped-market-unificado-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ped-market-unificado-v2 ).
       RUN set-position IN h_v-ped-market-unificado-v2 ( 2.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.42 , 123.00 ) */
       ...
       /* Links to SmartViewer h_v-ped-market-unificado-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_v-ped-market-unificado-v2 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-ped-market-unificado-v2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-ped-market-unificado-v2 ,
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta2/bpedcontadomarketv21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bpedcontadomarketv2 ).
       RUN set-position IN h_bpedcontadomarketv2 ( 13.50 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bpedcontadomarketv2 ( 12.96 , 141.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bpedcontadomarketv2. */
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_bpedcontadomarketv2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bpedcontadomarketv2 ,
             BUTTON-Verifica-Orden:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-ped-market-unificado-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ped-market-unificado-v2 ).
       RUN set-position IN h_t-ped-market-unificado-v2 ( 13.50 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-ped-market-unificado-v2 ( 12.27 , 140.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_t-ped-market-unificado-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_t-ped-market-unificado-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_t-ped-market-unificado-v2 ,
             BUTTON-Verifica-Orden:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_t-ped-market-unificado-v2 , 'AFTER':U ).
    END. /* Page 2 */
...
CASE L-Handle:
    ...
    WHEN "Pagina2"  THEN DO WITH FRAME {&FRAME-NAME}:
         ...
         RUN dispatch IN h_t-ped-market-unificado-v2 ('open-query':U).
      END.
    ...
    WHEN "Add-Record" THEN DO:
        RUN dispatch IN h_t-ped-market-unificado-v2 ('add-record':U).
      END.
    WHEN "browse" THEN DO:
          IF h_bpedcontadomarketv2 <> ? THEN RUN dispatch IN h_bpedcontadomarketv2 ('open-query':U).
          IF h_t-ped-market-unificado-v2 <> ? THEN RUN dispatch IN h_t-ped-market-unificado-v2 ('open-query':U). 
      END.
    WHEN "browse2" THEN DO:
          RUN dispatch IN h_t-ped-market-unificado-v2 ('open-query':U). 
      END.
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
         RUN Recalcular-Precios IN h_v-ped-market-unificado-v2.
         IF h_t-ped-market-unificado-v2 <> ? THEN RUN dispatch IN h_t-ped-market-unificado-v2 ('open-query':U). 
      END.
END CASE.
