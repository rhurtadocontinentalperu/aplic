...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-ped-market-unificado.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ped-market-unificado ).
       RUN set-position IN h_t-ped-market-unificado ( 13.50 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-ped-market-unificado ( 12.27 , 140.00 ) NO-ERROR.
