...
x-Factor = 1.
FIND FIRST Almtconv WHERE Almtconv.CodUnid = Almmmatg.UndStk AND Almtconv.Codalter = pUndVta NO-LOCK NO-ERROR.
        ...
        OTHERWISE DO:
            ...
            CASE TRUE:
                WHEN GN-DIVI.CanalVenta = "FER" AND GN-DIVI.VentaMayorista = 2 THEN DO:
                    ...
                    /* ******************************************* */
                    FIND AlmCatVtaD USE-INDEX Idx00 WHERE AlmCatVtaD.CodCia = s-CodCia AND
