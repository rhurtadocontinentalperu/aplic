...
FacDPedi.AlmDes FacDPedi.CanPed FacDPedi.PreUni ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio Unitario!sin dscto" FORMAT ">,>>>,>>9.999999":U
      FacDPedi.FactorDescuento * 100 @ FacDPedi.FactorDescuento COLUMN-LABEL "% Descuento" FORMAT ">>9.99999":U
      FacDPedi.ImporteUnitarioConImpuesto COLUMN-LABEL "Precio Unitario!con dscto" FORMAT ">>,>>9.99999":U
...
"FacDPedi.PreUni" "Precio Unitario!sin dscto" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.ImporteUnitarioConImpuesto" "Precio Unitario!con dscto" ">>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
