...
FacCPedi.Atencion FacCPedi.NomCli FacCPedi.ordcmp FacCPedi.DirCli ~
...
FacCPedi.Libre_d01 FacCPedi.Glosa FacCPedi.CodRef FacCPedi.NroRef 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.FchPed ~
FacCPedi.Ubigeo[1] FacCPedi.Ubigeo[2] FacCPedi.FlgSit FacCPedi.fchven ~
FacCPedi.CodCli FacCPedi.RucCli FacCPedi.Atencion FacCPedi.usuario ~
FacCPedi.NomCli FacCPedi.ordcmp FacCPedi.DirCli FacCPedi.Cmpbnte ~
FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.NroCard FacCPedi.TpoCmb ~
FacCPedi.CodVen FacCPedi.FlgIgv FacCPedi.FmaPgo FacCPedi.Libre_d01 ~
FacCPedi.Glosa FacCPedi.CodRef FacCPedi.NroRef 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 137 COLON-ALIGNED WIDGET-ID 46
          LABEL "Fecha de Emisión"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.Ubigeo[1] AT ROW 1.81 COL 16 COLON-ALIGNED WIDGET-ID 130
          LABEL "CANASTA" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 0 FGCOLOR 14 
     FacCPedi.Ubigeo[2] AT ROW 1.81 COL 40 COLON-ALIGNED WIDGET-ID 132
          LABEL "GABINETE" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 0 FGCOLOR 14 FONT 6
     FacCPedi.FlgSit AT ROW 1.81 COL 71 NO-LABEL WIDGET-ID 120
...
"Tarjeta de Crédito", "T":U
          SIZE 25 BY .81
          BGCOLOR 8 FGCOLOR 0 
     FacCPedi.fchven AT ROW 1.81 COL 137 COLON-ALIGNED WIDGET-ID 48 FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.CodCli AT ROW 2.62 COL 16 COLON-ALIGNED WIDGET-ID 38
          LABEL "Cliente"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.RucCli AT ROW 2.62 COL 40 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Atencion AT ROW 2.62 COL 59 COLON-ALIGNED WIDGET-ID 88
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.usuario AT ROW 2.62 COL 137 COLON-ALIGNED WIDGET-ID 66
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.NomCli AT ROW 3.42 COL 16 COLON-ALIGNED WIDGET-ID 54 FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.ordcmp AT ROW 3.42 COL 137 COLON-ALIGNED WIDGET-ID 118
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
          FGCOLOR 0 
     FacCPedi.DirCli AT ROW 4.23 COL 16 COLON-ALIGNED WIDGET-ID 44
          LABEL "Dirección" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Cmpbnte AT ROW 4.23 COL 139 NO-LABEL WIDGET-ID 102
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Factura", "FAC":U,
"Boleta", "BOL":U,
"Ticket", "TCK":U
          SIZE 23 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.LugEnt AT ROW 5.04 COL 16 COLON-ALIGNED WIDGET-ID 112
          LABEL "Lugar de entrega" FORMAT "x(100)"
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodMon AT ROW 5.04 COL 139 NO-LABEL WIDGET-ID 78
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dólares", 2
          SIZE 15 BY .81
     FacCPedi.NroCard AT ROW 5.85 COL 16 COLON-ALIGNED WIDGET-ID 56
          LABEL "Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 0 
     F-Nomtar AT ROW 5.85 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 92
...
DEFINE FRAME F-Main
     FacCPedi.TpoCmb AT ROW 5.85 COL 137 COLON-ALIGNED WIDGET-ID 64
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     FacCPedi.CodVen AT ROW 6.65 COL 16 COLON-ALIGNED WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
          BGCOLOR 11 FGCOLOR 0 
     f-NomVen AT ROW 6.65 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     FacCPedi.FlgIgv AT ROW 6.65 COL 139 WIDGET-ID 116
          LABEL "Afecto a IGV"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY .77
     FacCPedi.FmaPgo AT ROW 7.46 COL 16 COLON-ALIGNED WIDGET-ID 50
          LABEL "Condición de Venta"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-CndVta AT ROW 7.46 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     FacCPedi.Libre_d01 AT ROW 7.46 COL 139 NO-LABEL WIDGET-ID 96
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "2", 2,
"3", 3,
"4", 4
          SIZE 12 BY .81
     FacCPedi.Glosa AT ROW 8.27 COL 16 COLON-ALIGNED WIDGET-ID 110
          LABEL "Glosa" FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.CodRef AT ROW 8.27 COL 137 COLON-ALIGNED WIDGET-ID 126
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 8.27 COL 143 COLON-ALIGNED NO-LABEL WIDGET-ID 128
          VIEW-AS FILL-IN 
          SIZE 11 BY .81 TOOLTIP "XXX-XXXXXX"
     "Moneda:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 5.23 COL 133 WIDGET-ID 84
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 2 COL 61 WIDGET-ID 124
     "Redondedo del P.U.:" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 7.65 COL 124 WIDGET-ID 100
     "Comprobante:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 4.42 COL 129 WIDGET-ID 106
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  IF Faccpedi.FlgEst <> "A" THEN RUN vtagn/r-tck-ped-market-sunat (ROWID(Faccpedi) ).
