...
Vtatabla.tabla = input-var-1 AND ~
Vtatabla.Llave_c1 = input-var-2 AND ~
Vtatabla.Llave_c2 = input-var-3 )        

&SCOPED-DEFINE CODIGO vtatabla.llave_c3
...
&Scoped-define FIELDS-IN-QUERY-br_table VtaTabla.LLave_c3 ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaTabla.Libre_c01 COLUMN-LABEL "Nombre Promotor" FORMAT "x(60)":U
            WIDTH 43.43
      VtaTabla.Libre_c02 COLUMN-LABEL "Equipo" FORMAT "x(25)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VtaTabla.LLave_c3" "Promotor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaTabla.Libre_c02" "Equipo" "x(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c2 + '|' +  /* Proveedor */
                        {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c3 + '|' + /* Promotor */
