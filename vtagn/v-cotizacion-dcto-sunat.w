...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1.27 COL 124 COLON-ALIGNED
     ...
     FacCPedi.FaxCli AT ROW 2.08 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 124 FORMAT "X(10)"
          ...
          SIZE 9 BY .81
          FONT 6
     FacCPedi.usuario AT ROW 2.08 COL 124 COLON-ALIGNED
          LABEL "Digitado por"
          VIEW-AS FILL-IN 
          SIZE 10.86 BY .81
     FacCPedi.NomCli AT ROW 2.88 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 100 BY .81
     FacCPedi.CodMon AT ROW 2.88 COL 126 NO-LABEL
...
"US$", 2
     ...
     FacCPedi.TpoCmb AT ROW 3.69 COL 124.29 COLON-ALIGNED
          LABEL "Tpo.Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.Glosa AT ROW 5.31 COL 12.28
          ...
          VIEW-AS FILL-IN 
          SIZE 61 BY .81
     FacCPedi.PorDto AT ROW 5.31 COL 124 COLON-ALIGNED
          LABEL "% Dscto." FORMAT ">>9.99"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
          BGCOLOR 15 FGCOLOR 12 FONT 6
     "Moneda" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 3.15 COL 119
