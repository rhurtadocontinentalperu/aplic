...
DEFINE VARIABLE h_b-precotizacion-general-v01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_f-precot-gral-cotmovil AS HANDLE NO-UNDO.
DEFINE VARIABLE h_f-precot-gral-expo AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-navico AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updv06 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_q-pedido2x AS HANDLE NO-UNDO.
DEFINE VARIABLE h_t-precotizacion-general AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-precotizacion-general AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-precotizacion-general-v01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-precotizacion-general ).
       RUN set-position IN h_v-precotizacion-general ( 2.92 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.27 , 116.00 ) */
       ...
       /* Links to SmartViewer h_v-precotizacion-general. */
       RUN add-link IN adm-broker-hdl ( h_p-updv06 , 'TableIO':U , h_v-precotizacion-general ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido2x , 'Record':U , h_v-precotizacion-general ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv06 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-precotizacion-general ,
             COMBO-NroSer:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-pedido2x ,
             h_v-precotizacion-general , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/f-precot-gral-expo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_f-precot-gral-expo ).
       RUN set-position IN h_f-precot-gral-expo ( 3.15 , 122.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.77 , 13.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-precotizacion-general-v01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-precotizacion-general-v01 ).
       RUN set-position IN h_b-precotizacion-general-v01 ( 10.69 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-precotizacion-general-v01 ( 15.23 , 130.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-precotizacion-general-v01. */
       RUN add-link IN adm-broker-hdl ( h_q-pedido2x , 'Record':U , h_b-precotizacion-general-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-precot-gral-expo ,
             h_v-precotizacion-general , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-precotizacion-general-v01 ,
             h_f-precot-gral-expo , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       RUN set-position IN h_f-precot-gral-cotmovil ( 6.38 , 122.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 18.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-precotizacion-general-v01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-precotizacion-general ).
       RUN set-position IN h_t-precotizacion-general ( 10.69 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-precotizacion-general ( 15.38 , 132.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-precot-gral-cotmovil ,
             h_v-precotizacion-general , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_t-precotizacion-general ,
             h_f-precot-gral-cotmovil , 'AFTER':U ).
    END. /* Page 2 */
...
CASE pParam:
    WHEN "Asigna-Cotizacion" THEN DO:
        RUN Asigna-Cotizacion IN h_v-precotizacion-general.
    END.
    WHEN "Asigna-PrePedido" THEN DO:
        RUN Asigna-PrePedido IN h_v-precotizacion-general.
...
CASE L-Handle:
    WHEN "browse" THEN DO:
          ...
          IF h_t-precotizacion-general <> ? THEN RUN dispatch IN h_t-precotizacion-general ('open-query':U).
      END.
    ...
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
        RUN Recalcular-Precios IN h_v-precotizacion-general.
      END.
