...
DEFINE VARIABLE h_v-uniofi-01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-uniofi-01.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-uniofi-01 ).
       RUN set-position IN h_v-uniofi-01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.15 , 52.29 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-uniofi-01 ,
