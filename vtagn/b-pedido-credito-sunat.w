...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN_PorcentajeDsctoGlobal ~
FILL-IN_DescuentosGlobales FILL-IN_TotalValorVenta FILL-IN_TotalMontoICBPER ~
FILL-IN_TotalImpuestos FILL-IN_PorIgv FILL-IN_ImpTot FILL-IN-Peso ~
FILL-IN-Volumen 
...
DEFINE VARIABLE FILL-IN_DescuentosGlobales AS DECIMAL FORMAT ">>>>>>>>>>>9.99" INITIAL 0 
     LABEL "Dscto Global" 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81
...
DEFINE VARIABLE FILL-IN_PorcentajeDsctoGlobal AS DECIMAL FORMAT ">>>>>>>>>>>9.99" INITIAL 0 
     LABEL "%Dscto Global" 
     VIEW-AS FILL-IN 
     SIZE 7.86 BY .81
     BGCOLOR 1 FGCOLOR 15  NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     FILL-IN_PorcentajeDsctoGlobal AT ROW 11.23 COL 19.14 COLON-ALIGNED WIDGET-ID 90
     FILL-IN_DescuentosGlobales AT ROW 11.23 COL 43.86 COLON-ALIGNED WIDGET-ID 88
     FILL-IN_TotalValorVenta AT ROW 11.23 COL 72.14 COLON-ALIGNED WIDGET-ID 76
     FILL-IN_TotalMontoICBPER AT ROW 11.23 COL 95.29 COLON-ALIGNED WIDGET-ID 80
     FILL-IN_TotalImpuestos AT ROW 11.23 COL 114.43 COLON-ALIGNED WIDGET-ID 78
...
/* SETTINGS FOR FILL-IN FILL-IN-Volumen IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_DescuentosGlobales IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_ImpTot IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_PorcentajeDsctoGlobal IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN
    ...
    FILL-IN_DescuentosGlobales = 0
    FILL-IN_PorcentajeDsctoGlobal = 0
    .
IF AVAILABLE FacCPedi THEN DO:
    ASSIGN
        ...
        FILL-IN_DescuentosGlobales = faccpedi.porcent[1]
        FILL-IN_PorcentajeDsctoGlobal = faccpedi.porcent[2]
        .
END.
DISPLAY
    FILL-IN_ImpTot
    ...
    FILL-IN_DescuentosGlobales
    FILL-IN_PorcentajeDsctoGlobal
