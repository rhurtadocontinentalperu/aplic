...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-ped-utilex-unificado ( 2.62 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-ped-utilex-unificado ( 10.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-ped-utilex-unificado ( 14.23 , 141.00 ) NO-ERROR.
