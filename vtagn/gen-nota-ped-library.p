...
&IF DEFINED(EXCLUDE-EVEN_Genera-COT) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE EVEN_Genera-COT Procedure 
PROCEDURE EVEN_Genera-COT :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEF INPUT PARAMETER pCodDoc AS CHAR.    /* Ej.NPC */
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    IF AVAILABLE VtaCDocu THEN
        ASSIGN
            ...
            Vtacdocu.FlgSit = "T".
    /* ************************************************************************************** */
    /* NPC por Grupos de Líneas de Productos */
    /* ************************************************************************************** */
    RUN vtagn/p-genera-npc-por-grupos.p (INPUT Faccpedi.CodDoc,
                                         INPUT Faccpedi.NroPed,
                                         INPUT pCodDiv,
                                         OUTPUT pMensaje).
    IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
