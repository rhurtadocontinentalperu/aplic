...
&Scoped-define INTERNAL-TABLES T-Almtfami Almtfami

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 T-Almtfami.codfam T-Almtfami.desfam 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH T-Almtfami NO-LOCK, ~
      FIRST Almtfami OF T-Almtfami OUTER-JOIN NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH T-Almtfami NO-LOCK, ~
      FIRST Almtfami OF T-Almtfami OUTER-JOIN NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 T-Almtfami Almtfami
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      T-Almtfami.codfam FORMAT "X(8)":U
      T-Almtfami.desfam FORMAT "X(30)":U WIDTH 52.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-2
     _TblList          = "Temp-Tables.T-Almtfami,INTEGRAL.Almtfami OF Temp-Tables.T-Almtfami"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST OUTER USED"
     _FldNameList[1]   > Temp-Tables.T-Almtfami.codfam
"Temp-Tables.T-Almtfami.codfam" ? "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-Almtfami.desfam
"Temp-Tables.T-Almtfami.desfam" ? ? "character" ? ? ? ? ? ? no ? no no "52.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* SELECCIONE LA LINEA */
DO:  
...
DO:
  ASSIGN
      output-var-1 = ROWID(T-Almtfami)
      output-var-2 = T-Almtfami.codfam
      output-var-3 = T-Almtfami.desfam.
...
ASSIGN
    ...
    T-Almtfami.codfam = 'OTROS'
    T-Almtfami.desfam = 'OTROS'.
