...
------------------------------------------------------------------------------*/
  ...
  {vtagn/totales-cotizacion-unificada.i &Cabecera="FacCPedi" &Detalle="FacDPedi"}
  /* ****************************************************************************************** */
  /* 02/20/2021 Grupos por Líneas de Productos */
  /* ****************************************************************************************** */
  RUN Genera-Grupos.
  /* ****************************************************************************************** */
  /* ****************************************************************************************** */
...
DO WITH FRAME {&FRAME-NAME} :
    ...
    /* OTRAS VALIDACIONES */
     ...
     FOR EACH ITEM, FIRST Almmmatg OF ITEM NO-LOCK WHERE Almmmatg.codfam = '011':
         ...
         END.
     END.
/*      DEF VAR x-Cuenta-011 AS DEC NO-UNDO.                                            */
/*      DEF VAR x-Cuenta-Otros AS DEC NO-UNDO.                                          */
/*      DEF BUFFER B-ITEM FOR ITEM.                                                     */
/*      FOR EACH ITEM NO-LOCK, FIRST Almmmatg OF ITEM NO-LOCK:                          */
/*          IF Almmmatg.CodFam = '011' THEN x-Cuenta-011 = x-Cuenta-011 + 1.            */
/*          ELSE x-Cuenta-Otros = x-Cuenta-Otros + 1.                                   */
/*      END.                                                                            */
/*      IF x-Cuenta-011 > 0 AND x-Cuenta-Otros > 0 THEN DO:                             */
/*          MESSAGE 'El Pedido Comercial solo puede contener artículos de la línea 011' */
/*              VIEW-AS ALERT-BOX ERROR.                                                */
/*          RETURN "ADM-ERROR".                                                         */
/*      END.                                                                            */
     /* ******************************************************************************* */
