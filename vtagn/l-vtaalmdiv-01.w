...
&SCOPED-DEFINE CONDICION (VtaAlmDiv.CodCia = S-CODCIA ~
AND LOOKUP(VtaAlmDiv.CodAlm, input-var-1) > 0  ~
AND VtaAlmDiv.CodDiv = input-var-2 )

&SCOPED-DEFINE CODIGO VtaAlmDiv.CodAlm
...
&Scoped-define INTERNAL-TABLES VtaAlmDiv Almacen

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaAlmDiv.CodAlm ~
Almacen.Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaAlmDiv WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK, ~
      EACH Almacen OF VtaAlmDiv NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaAlmDiv WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK, ~
      EACH Almacen OF VtaAlmDiv NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaAlmDiv Almacen
...
<SORTBY-OPTIONS>
Codigo|y||integral.VtaAlmDiv.Orden|yes,integral.VtaAlmDiv.CodAlm|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaAlmDiv.CodAlm FORMAT "x(3)":U
      Almacen.Descripcion FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 46.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.VtaAlmDiv,integral.Almacen OF integral.VtaAlmDiv"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = integral.VtaAlmDiv.CodAlm
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaAlmDiv.Orden BY VtaAlmDiv.CodAlm
...
DO I = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
   IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(I) THEN DO:    
    ASSIGN
        ...
        output-var-3 = {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}}.descrip.
   END.     
END.
