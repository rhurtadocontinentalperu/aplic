...
COMBO-BOX-CodAlm RADIO-SET-Stock FILL-IN-codigo 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/t-mostrador-sunat.w':U ,
...
------------------------------------------------------------------------------*/
  DISPLAY F-marca f-CodFam CMB-filtro FILL-IN-filtro COMBO-BOX-CodAlm 
          RADIO-SET-Stock FILL-IN-codigo 
      WITH FRAME D-Dialog.
  ENABLE F-marca f-CodFam CMB-filtro FILL-IN-filtro BUTTON_Filtrar 
         COMBO-BOX-CodAlm FILL-IN-codigo Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
