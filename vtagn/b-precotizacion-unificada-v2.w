...
VtaDDocu.UndVta VtaDDocu.CanPed 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(80)":U WIDTH 78.29
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U WIDTH 13
      VtaDDocu.UndVta FORMAT "x(6)":U WIDTH 5.86
      VtaDDocu.CanPed FORMAT "->>>,>>9.9999":U WIDTH 7.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 132 BY 14
...
"Almmmatg.DesMat" ? "X(80)" "character" ? ? ? ? ? ? no ? no no "78.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDDocu.UndVta" ? "x(6)" "character" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.VtaDDocu.CanPed
"VtaDDocu.CanPed" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
