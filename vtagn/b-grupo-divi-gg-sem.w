...
FacTabla.Valor[1] FacTabla.Valor[2] FacTabla.Valor[3] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacTabla.Valor[1] COLUMN-LABEL "Rojo!Hasta (%)" FORMAT ">>>,>>>,>>9.99":U
            COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 12
      FacTabla.Valor[2] COLUMN-LABEL "Amarillo!Hasta (%)" FORMAT ">>>,>>>,>>9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      FacTabla.Valor[3] COLUMN-LABEL "Verde!Hasta (%)" FORMAT ">>>,>>>,>>9.99":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 80 BY 10.77
         FONT 4
         TITLE "GRUPO DIVISION GG" FIT-LAST-COLUMN.
...
"FacTabla.Nombre" ? ? "character" ? ? ? ? ? ? no ? no no "34.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacTabla.Valor[1]
"FacTabla.Valor[1]" "Rojo!Hasta (%)" ">>>,>>>,>>9.99" "decimal" 12 15 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacTabla.Valor[2]
"FacTabla.Valor[2]" "Amarillo!Hasta (%)" ">>>,>>>,>>9.99" "decimal" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.FacTabla.Valor[3]
"FacTabla.Valor[3]" "Verde!Hasta (%)" ">>>,>>>,>>9.99" "decimal" 10 0 ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* GRUPO DIVISION GG */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* GRUPO DIVISION GG */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* GRUPO DIVISION GG */
DO:
