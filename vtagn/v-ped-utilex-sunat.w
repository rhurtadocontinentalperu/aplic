...
&Scoped-Define DISPLAYED-OBJECTS TOGGLE-DELIVERY F-Estado F-nOMvEN ~
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FchPed AT ROW 1 COL 122 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.fchven AT ROW 1.77 COL 122 COLON-ALIGNED WIDGET-ID 98
     ...
     FacCPedi.NomCli AT ROW 2.54 COL 23 COLON-ALIGNED NO-LABEL
          ...
          SIZE 87 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.FlgSit AT ROW 2.54 COL 124 NO-LABEL WIDGET-ID 104
...
"Cupón de Descuento", "CD":U
     ...
     FacCPedi.FlgIgv AT ROW 1 COL 157 NO-LABEL WIDGET-ID 100
...
"No", no
     ...
     FacCPedi.CodMon AT ROW 1.77 COL 157 NO-LABEL WIDGET-ID 92
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
     ...
     FacCPedi.Atencion AT ROW 4.08 COL 31 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 2.54 COL 155 COLON-ALIGNED WIDGET-ID 120
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     COMBO-BOX-Proveedor AT ROW 5.62 COL 122 COLON-ALIGNED WIDGET-ID 96
     ...
     FacCPedi.Libre_c05 AT ROW 6.38 COL 122 COLON-ALIGNED WIDGET-ID 112 PASSWORD-FIELD 
...
DEFINE FRAME F-Main
     FacCPedi.Libre_c03 AT ROW 7.15 COL 122 COLON-ALIGNED WIDGET-ID 124
          LABEL "Cliente asociado" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 29.86 BY .81
     FacCPedi.Libre_c04 AT ROW 7.92 COL 122 COLON-ALIGNED WIDGET-ID 110
     ...
     txtNombrePersonal AT ROW 7.92 COL 135 COLON-ALIGNED NO-LABEL WIDGET-ID 122
     FacCPedi.Libre_c01 AT ROW 3.88 COL 154 COLON-ALIGNED WIDGET-ID 132
          LABEL "Delivery"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 1.96 COL 150 WIDGET-ID 118
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 2.73 COL 114 WIDGET-ID 114
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 1.08 COL 150 WIDGET-ID 116
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
FOR EACH PEDI WHERE PEDI.Libre_c05 <> "OF", FIRST Almmmatg OF PEDI NO-LOCK:
    ...
    ELSE DO:
        /* Ventas DELIVERY */
        RUN pri/PrecioVentaMayorCredito.r(
            'N',
            x-lista-precio,
            s-CodCli,
            s-CodMon,
