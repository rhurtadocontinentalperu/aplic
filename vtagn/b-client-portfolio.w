...
DEFINE TEMP-TABLE t-clients NO-UNDO LIKE gn-clie.
...
&Scoped-Define ENABLED-OBJECTS RADIO-SET-FlgSit br_table BUTTON-1 BUTTON-2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      t-gn-clie.NomCli FORMAT "x(100)":U WIDTH 63.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 86 BY 15.88
         FONT 4
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 18.23 COL 1 WIDGET-ID 2
     BUTTON-2 AT ROW 18.23 COL 16 WIDGET-ID 4
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: t-clients T "?" NO-UNDO INTEGRAL gn-clie
...
"t-gn-clie.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.t-gn-clie.NomCli
"t-gn-clie.NomCli" ? "x(100)" "character" ? ? ? ? ? ? no ? no no "63.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Disable-Multiple-Selection B-table-Win 
PROCEDURE Disable-Multiple-Selection :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Return-Customers B-table-Win 
PROCEDURE Return-Customers :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEF OUTPUT PARAMETER TABLE FOR t-clients.
...
DO k = 1 TO {&browse-name}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
    IF {&browse-name}:FETCH-SELECTED-ROW(k) THEN DO:
        CREATE t-clients.
        BUFFER-COPY t-gn-clie TO t-clients NO-ERROR.
    END.
END.
