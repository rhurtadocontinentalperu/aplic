...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.PreUni COLUMN-LABEL "Precio Unitario!con IGV" FORMAT ">>,>>9.999999":U
            WIDTH 10.57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      ...
      ITEM.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
            WIDTH 7.43
      ITEM.ImpDto COLUMN-LABEL "Descuento!con IGV" FORMAT ">,>>>,>>9.99":U
            WIDTH 8.43
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 181 BY 11.85
...
DEFINE FRAME F-Main
     ...
     BUTTON-2 AT ROW 13.12 COL 36 WIDGET-ID 8
     FILL-IN-ImpTot AT ROW 13.12 COL 166 COLON-ALIGNED WIDGET-ID 6
     FILL-IN-Semaforo AT ROW 13.35 COL 82 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     FILL-IN-Master AT ROW 13.65 COL 64 COLON-ALIGNED WIDGET-ID 14
     "F8: Stocks por Almacén" VIEW-AS TEXT
          SIZE 17 BY .5 AT ROW 13.12 COL 53 WIDGET-ID 10
          BGCOLOR 9 FGCOLOR 15 
     RECT-28 AT ROW 12.85 COL 1 WIDGET-ID 16
...
"fDesMat() @ x-DesMat" "Descripción" "x(100)" ? ? ? ? ? ? ? no ? no no "69.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fDesMar() @ x-DesMar" "Marca" "x(20)" ? ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.ITEM.UndVta
"ITEM.UndVta" "Unidad" "x(10)" "character" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.PreUni" "Precio Unitario!con IGV" ">>,>>9.999999" "decimal" 11 0 ? ? ? ? yes ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.Por_Dsctos[1]" "% Dscto.!Admins" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.ImpDto" "Descuento!con IGV" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.ITEM.ImpLin
"ITEM.ImpLin" "Importe!con IGV" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF ITEM.PreUni IN BROWSE br_table /* Precio Unitario!con IGV */
DO:
