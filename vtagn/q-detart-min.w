...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaListaMin WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMin.CodCia = S-CODCIA ~
 AND VtaListaMin.codmat = S-CODMAT ~
 AND VtaListaMin.CodDiv = s-coddiv NO-LOCK, ~
      EACH Almmmatg OF VtaListaMin NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaListaMin WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMin.CodCia = S-CODCIA ~
 AND VtaListaMin.codmat = S-CODMAT ~
 AND VtaListaMin.CodDiv = s-coddiv NO-LOCK, ~
      EACH Almmmatg OF VtaListaMin NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaListaMin Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaListaMin
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "VtaListaMin.CodCia = S-CODCIA
 AND VtaListaMin.codmat = S-CODMAT
