...
DO:
    RUN vtagn/D-Dtovol-min ({&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codmat).
...
DO:
    IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
     RUN VtaGn/D-DtoProm-Min ({&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codmat).
...
FOR EACH vtalistamin WHERE vtalistamin.codcia = s-codcia
    AND vtalistamin.coddiv = s-coddiv NO-LOCK,
    FIRST almmmatg WHERE almmmatg.codcia = vtalistamin.codcia
        AND almmmatg.codmat = vtalistamin.codmat NO-LOCK:

    t-column = t-column + 1.
    cColumn = STRING(t-Column).
    cRange = "A" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.CodMat.
    cRange = "B" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.DesMat.
    cRange = "C" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.DesMar.
    cRange = "D" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.CodFam.
    ...
    cRange = "H" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.MonVta.
    cRange = "I" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.TpoCmb.
    cRange = "J" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.CHR__01.
    cRange = "K" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.PreOfi.
    cRange = "L" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.Dec__01.
    cRange = "M" + cColumn.
    chWorkSheet:Range(cRange):Value = VtaListaMin.CanEmp.
    cRange = "N" + cColumn.
...
------------------------------------------------------------------------------*/
  ...
  IF x-Tipo = 1 THEN DO:
      MESSAGE 'ATENCIÓN: se van a cambiar TODOS los precios de la lista por menor' SKIP
