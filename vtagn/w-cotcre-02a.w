...
DEFINE VARIABLE L-NROSER   AS CHAR NO-UNDO.
    ...
    CASE GN-DIVI.TipDto:
        ...
        WHEN 2 THEN DO:             /* PRECIO UNITARIO NO INCLUIDO DESCUENTO */
            MESSAGE ' Esta opción solo es válida para Unidades de Negocio' SKIP
                'en cuyo precio unitario esté incluido los descuentos' SKIP
                VIEW-AS ALERT-BOX WARNING TITLE 'ACCESO DENEGADO'.
            RETURN.
        END.
    END CASE.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "DESCUENTO A COTIZACIONES POR IMPORTES"
         HEIGHT             = 26.96
         WIDTH              = 139.14
         MAX-HEIGHT         = 28.54
         MAX-WIDTH          = 161.43
...
ON END-ERROR OF W-Win /* DESCUENTO A COTIZACIONES POR IMPORTES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* DESCUENTO A COTIZACIONES POR IMPORTES */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_t-cotcre-02a ).
