...
DEFINE VARIABLE h_v-cotexp-01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "COTIZACIONES EXPOLIBRERIA"
         HEIGHT             = 25.46
         WIDTH              = 141.57
         MAX-HEIGHT         = 26.19
         MAX-WIDTH          = 165.57
         VIRTUAL-HEIGHT     = 26.19
         VIRTUAL-WIDTH      = 165.57
         RESIZE             = no
         SCROLL-BARS        = no
         STATUS-AREA        = yes
         BGCOLOR            = ?
...
ON END-ERROR OF W-Win /* COTIZACIONES EXPOLIBRERIA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* COTIZACIONES EXPOLIBRERIA */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-cotexp-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cotexp-01 ).
       RUN set-position IN h_v-cotexp-01 ( 2.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.62 , 134.00 ) */
       ...
       /* Links to SmartViewer h_v-cotexp-01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_v-cotexp-01 ).
       RUN add-link IN adm-broker-hdl ( h_q-vtacdocu-01 , 'Record':U , h_v-cotexp-01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv01 ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-cotexp-01 ,
