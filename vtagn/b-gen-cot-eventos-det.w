...
Almmmatg.DesMar VtaDDocu.CanPed VtaDDocu.UndVta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDDocu.CodMat COLUMN-LABEL "Artículo" FORMAT "X(8)":U
      Almmmatg.DesMat FORMAT "X(60)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U
      VtaDDocu.CanPed FORMAT "->>>,>>9.99":U
      VtaDDocu.UndVta FORMAT "x(8)":U WIDTH 1
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 104 BY 15.88
...
"VtaDDocu.CodMat" "Artículo" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDDocu.CanPed" ? "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaDDocu.UndVta
"VtaDDocu.UndVta" ? "x(8)" "character" ? ? ? ? ? ? no ? no no "1" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
