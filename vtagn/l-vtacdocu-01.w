...
VtaCDocu.NomCli VtaCDocu.ImpTot 
...
Cliente|||INTEGRAL.VtaCDocu.NomCli|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'Fecha,Cliente' + '",
     SortBy-Case = ':U + 'Fecha').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.NroPed FORMAT "X(9)":U WIDTH 8.29
      VtaCDocu.NomCli FORMAT "x(60)":U
      VtaCDocu.ImpTot FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 76.14 BY 13.19
...
"VtaCDocu.NroPed" ? ? "character" ? ? ? ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.VtaCDocu.NomCli
     _FldNameList[4]   = INTEGRAL.VtaCDocu.ImpTot
