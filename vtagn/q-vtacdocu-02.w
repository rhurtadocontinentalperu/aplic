...
&SCOPED-DEFINE condicion codcia = s-codcia ~
AND coddiv = s-coddiv ~
AND codped = s-codped ~
AND nroped BEGINS STRING(s-nroser, '999') ~
AND ( flgest = "X" OR flgest = "P" )
...
<SORTBY-OPTIONS>
NroPed|y||INTEGRAL.VtaCDocu.NroPed|no
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'NroPed':U THEN DO:
      &Scope SORTBY-PHRASE BY VtaCDocu.NroPed DESCENDING
