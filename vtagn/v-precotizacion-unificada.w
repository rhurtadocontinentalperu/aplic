...
VtaCDocu.DirCli VtaCDocu.Glosa VtaCDocu.Cmpbnte VtaCDocu.CodVen ~
VtaCDocu.CodMon VtaCDocu.TpoCmb VtaCDocu.FmaPgo VtaCDocu.FlgIgv ~
VtaCDocu.NroCard VtaCDocu.Libre_d01 VtaCDocu.CodRef VtaCDocu.NroRef 
...
VtaCDocu.Usuario VtaCDocu.Glosa VtaCDocu.Cmpbnte VtaCDocu.CodVen ~
VtaCDocu.CodMon VtaCDocu.TpoCmb VtaCDocu.FmaPgo VtaCDocu.FlgIgv ~
VtaCDocu.NroCard VtaCDocu.Libre_d01 VtaCDocu.CodRef VtaCDocu.NroRef 
...
"4", 4
     ...
     VtaCDocu.CodRef AT ROW 7.46 COL 8 COLON-ALIGNED WIDGET-ID 120
          ...
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     VtaCDocu.NroRef AT ROW 7.46 COL 13 COLON-ALIGNED NO-LABEL WIDGET-ID 122
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
------------------------------------------------------------------------------*/
    ...
    IF lchoice THEN DO:
        ...
        /* RHC 23/12/2019 NO para EXPO-BODEGA */
/*         CASE pCodDiv:                               */
/*             WHEN "30015" THEN x-MontoMinimo = 300.  */
/*             WHEN "10072" THEN x-MontoMinimo = 1500. */
/*         END CASE.                                   */
        ...
        x-fecha-emision = DATE(vtacdocu.fchped:SCREEN-VALUE IN FRAME {&FRAME-NAME}) NO-ERROR.
        ...
        IF f-Tot < x-MontoMinimo THEN DO:
            MESSAGE 'El monto mínimo a cotizar es de S/.' STRING(x-MontoMinimo, '>>,>>9.99') SKIP
        ...
        */
        ...
        END.
        ELSE DO: 
            RUN vtagn/genera-cotizacion-unificada.p (ROWID(VtaCDocu), pCodDiv, OUTPUT CNroPed).    
            IF cNroPed <> '' THEN
...
DO WITH FRAME {&FRAME-NAME}:
    IF VtaCDocu.CodRef:SCREEN-VALUE = "PPX" THEN RETURN.    /* Ya fue */
    ...
    FIND FIRST Faccpedi WHERE Faccpedi.codcia = s-codcia
        ...
        AND Faccpedi.coddoc = "PPX"
        AND Faccpedi.codcli = VtaCDocu.CodCli:SCREEN-VALUE
        AND Faccpedi.flgest = "P"
        AND Faccpedi.fchped >= (TODAY - 1)
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Faccpedi THEN RETURN.
    DISPLAY
        Faccpedi.CodDoc @ VtaCDocu.CodRef
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE ExpTurno THEN DO:
        MESSAGE 'NO tienen una programación definida' SKIP
            'Cerramos de todos modos?' VIEW-AS ALERT-BOX QUESTION
        ...
        IF ERROR-STATUS:ERROR = YES THEN DO:
            MESSAGE 'Registro Faccpedi bloqueado por otro usuario'
                VIEW-AS ALERT-BOX ERROR.
            RETURN.
        END.
        ASSIGN
    ...
    DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
        ...
        IF ERROR-STATUS:ERROR = YES THEN DO:
            MESSAGE 'Registro ExpTurno bloqueado por otro usuario'
                VIEW-AS ALERT-BOX ERROR.
            RETURN 'ADM-ERROR'.
        END.
        FIND B-CPEDI WHERE ROWID(B-CPEDI) = ROWID(VtaCDocu) EXCLUSIVE-LOCK NO-ERROR.
        ...
        IF ERROR-STATUS:ERROR = YES THEN DO:
            MESSAGE 'Registro ExpTarea bloqueado por otro usuario'
                VIEW-AS ALERT-BOX ERROR.
            RETURN 'ADM-ERROR'.
        END.
        FIND ExpDigit WHERE ExpDigit.CodCia = ExpTarea.CodCia
            ...
            EXCLUSIVE-LOCK NO-ERROR.
        IF ERROR-STATUS:ERROR = YES THEN DO:
            MESSAGE 'Registro ExpDigit bloqueado por otro usuario'
                VIEW-AS ALERT-BOX ERROR.
            RETURN 'ADM-ERROR'.
        END.
        ASSIGN
...
/*      IF VtaCDocu.CodPos:SCREEN-VALUE = ''                   */
/*          THEN DO:                                           */
...
/*      END.                                                   */
     ...
     */
     ...
     x-fecha-emision = DATE(vtacdocu.fchped:SCREEN-VALUE) NO-ERROR.
