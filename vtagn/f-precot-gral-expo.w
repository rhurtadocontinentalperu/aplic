...
&Scoped-Define ENABLED-OBJECTS BUTTON-6 BUTTON-2 
...
DEFINE FRAME F-Main
     BUTTON-6 AT ROW 1 COL 1 WIDGET-ID 6
     BUTTON-2 AT ROW 2.35 COL 1 WIDGET-ID 8
...
DO:
    RUN Procesa-Botones IN lh_handle ("Asigna-Cotizacion").
END.
