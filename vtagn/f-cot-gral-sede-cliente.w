...
DEF NEW SHARED VAR s-nivel-acceso AS INT NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS B-CLI BUTTON-1 
...
DEFINE FRAME F-Main
     B-CLI AT ROW 1 COL 1 WIDGET-ID 22
     BUTTON-1 AT ROW 2.08 COL 1 WIDGET-ID 46
...
DO:
   RUN Procesa-Botones IN lh_handle ('Actualiza-datos-cliente').
END.
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* SEDE DEL CLIENTE */
DO:
  RUN Procesa-Botones IN lh_handle ('Sede-Cliente').
END.
