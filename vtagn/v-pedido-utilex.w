...
F-CndVta F-Nomtar txtNombrePersonal 
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE faccpedi THEN DO:          
      ...
      END.
  END.      
  /*RUN sunat\cancelar-pedido-minorista-sunat-v2 (ROWID(FacCPedi)).*/
...
------------------------------------------------------------------------------*/
  ...
  RUN {&Promocion} (Faccpedi.CodDiv, Faccpedi.CodCli, INPUT-OUTPUT TABLE PEDI, OUTPUT pMensaje).
