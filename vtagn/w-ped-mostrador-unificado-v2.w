...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_v-ped-mostrador-unificado ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-ped-mostrador-unificado-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ped-mostrador-unificado ).
       RUN set-position IN h_t-ped-mostrador-unificado ( 11.23 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-ped-mostrador-unificado ( 11.85 , 141.00 ) NO-ERROR.
