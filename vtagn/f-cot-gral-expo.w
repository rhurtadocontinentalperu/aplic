...
&Scoped-Define ENABLED-OBJECTS BUTTON-Importar-Pedido 
...
DEFINE FRAME F-Main
     BUTTON-Importar-Pedido AT ROW 1 COL 1 WIDGET-ID 50
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Importar-Pedido F-Frame-Win
ON CHOOSE OF BUTTON-Importar-Pedido IN FRAME F-Main /* IMPORTAR PEDIDO EXCEL */
DO:
   RUN Procesa-Botones IN lh_handle ('Importar-Excel-2015').
END.
