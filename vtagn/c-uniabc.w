...
&SCOPED-DEFINE l-lookup h_l-uniabc
...
DEFINE VARIABLE h_l-uniabc AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 4.54 COL 54
     Btn_Cancel AT ROW 6.65 COL 54
     "            F8 - Consulta de Stocks por Almacen" VIEW-AS TEXT
          SIZE 62.86 BY .5 AT ROW 12.96 COL 1.29
          FONT 6
     "            F7 - Stocks Comprometidos por Pedidos" VIEW-AS TEXT
          SIZE 62.86 BY .5 AT ROW 12.46 COL 1.29
          FONT 6
     "            F9 - Consulta Descuentos X Volumen" VIEW-AS TEXT
          SIZE 63.29 BY .54 AT ROW 13.65 COL 1 WIDGET-ID 2
          FONT 6
     "            F10 - Consulta Descuentos X Promocion" VIEW-AS TEXT
          SIZE 63.29 BY .54 AT ROW 14.19 COL 1 WIDGET-ID 4
          FONT 6
     RECT-33 AT ROW 12.31 COL 1
     RECT-28 AT ROW 1 COL 53.57
     SPACE(0.85) SKIP(2.91)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/l-uniabc.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = ':U ,
             OUTPUT h_l-uniabc ).
       RUN set-position IN h_l-uniabc ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-uniabc ( 11.27 , 52.29 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-uniabc ,
