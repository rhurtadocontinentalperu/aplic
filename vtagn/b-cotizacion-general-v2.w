...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Propios FILL-IN_ImpBrt ~
FILL-IN_ImpDto FILL-IN_PorIgv FILL-IN_ImpDto2 FILL-IN-TERCEROS ~
FILL-IN_ImpExo FILL-IN_ImpVta FILL-IN_ImpIgv FILL-IN_ImpTot ~
FILL-IN-Cuadernos FILL-IN-Practiforros FILL-IN-Variacion FILL-IN_Import2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(80)":U WIDTH 59.43
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom" FORMAT "->>9.9999":U
            WIDTH 7.43
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 6.86
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpDto2 AT ROW 11.77 COL 140 COLON-ALIGNED WIDGET-ID 40
     ...
     FILL-IN_ImpTot AT ROW 12.58 COL 140 COLON-ALIGNED WIDGET-ID 20
     ...
     FILL-IN-ColorEntero AT ROW 13.38 COL 109 COLON-ALIGNED WIDGET-ID 30
     FILL-IN_Import2 AT ROW 13.38 COL 140 COLON-ALIGNED WIDGET-ID 26
...
ASSIGN 
       FILL-IN-ColorEntero:HIDDEN IN FRAME F-Main           = TRUE.
...
"Almmmatg.DesMat" ? "X(80)" "character" ? ? ? ? ? ? no ? no no "59.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.ImpDto2
"FacDPedi.ImpDto2" "Otros!Descuentos" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*             THEN FILL-IN-ColorEntero = FILL-IN-ColorEntero + FacDPedi.ImpLin.       */
/*         IF LOOKUP(FacDPedi.CodMat, "087372,087373,087366,092487,092488") > 0        */
/*             THEN FILL-IN-ColorEntero = FILL-IN-ColorEntero + FacDPedi.ImpLin.       */
    END.
END.
