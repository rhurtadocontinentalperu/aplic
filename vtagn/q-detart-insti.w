...
&Scoped-define INTERNAL-TABLES Almmmatp

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almmmatp WHERE ~{&KEY-PHRASE} ~
      AND Almmmatp.CodCia = S-CODCIA ~
 AND Almmmatp.codmat = S-CODMAT NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almmmatp WHERE ~{&KEY-PHRASE} ~
      AND Almmmatp.CodCia = S-CODCIA ~
 AND Almmmatp.codmat = S-CODMAT NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Almmmatp
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Almmmatp
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "integral.Almmmatp"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "integral.Almmmatp.CodCia = S-CODCIA
 AND integral.Almmmatp.codmat = S-CODMAT"
