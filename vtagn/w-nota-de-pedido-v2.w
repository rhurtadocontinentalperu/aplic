...
DEF NEW SHARED VAR s-CodDoc AS CHAR INIT "NPC".
...
DEFINE VARIABLE h_b-nota-de-pedido AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_f-gen-npc-even AS HANDLE NO-UNDO.
DEFINE VARIABLE h_f-imp-excel-plantilla AS HANDLE NO-UNDO.
DEFINE VARIABLE h_f-npc-gral-expo-pag1 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_f-review-npc-grupos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_t-nota-de-pedido AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-nota-de-pedido AS HANDLE NO-UNDO.
...
DO:
  RUN Genera-Excel-Trabajo IN h_v-nota-de-pedido.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/v-nota-de-pedido-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nota-de-pedido ).
       RUN set-position IN h_v-nota-de-pedido ( 2.35 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 9.96 , 135.57 ) */
       ...
       /* Links to SmartViewer h_v-nota-de-pedido. */
       RUN add-link IN adm-broker-hdl ( h_p-updv01 , 'TableIO':U , h_v-nota-de-pedido ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_v-nota-de-pedido ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/f-npc-gral-expo-pag1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_f-npc-gral-expo-pag1 ).
       RUN set-position IN h_f-npc-gral-expo-pag1 ( 2.62 , 133.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-imp-excel-plantilla ( 3.69 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-super ( 4.77 , 133.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-cot-gral-imp-market ( 6.92 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/f-gen-npc-even.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_f-gen-npc-even ).
       RUN set-position IN h_f-gen-npc-even ( 8.00 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/f-review-npc-grupos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_f-review-npc-grupos ).
       RUN set-position IN h_f-review-npc-grupos ( 9.08 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 25.00 ) */
       ...
       RUN set-position IN h_f-cot-gral-envio-admin ( 10.15 , 133.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/b-nota-de-pedido-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-nota-de-pedido ).
       RUN set-position IN h_b-nota-de-pedido ( 12.31 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-nota-de-pedido ( 14.00 , 131.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-nota-de-pedido. */
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_b-nota-de-pedido ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-npc-gral-expo-pag1 ,
             h_v-nota-de-pedido , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-imp-excel-plantilla ,
             h_f-npc-gral-expo-pag1 , 'AFTER':U ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-gen-npc-even ,
             h_f-cot-gral-imp-market , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-review-npc-grupos ,
             h_f-gen-npc-even , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-cot-gral-envio-admin ,
             h_f-review-npc-grupos , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-nota-de-pedido ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtagn/t-nota-de-pedido-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-nota-de-pedido ).
       RUN set-position IN h_t-nota-de-pedido ( 12.31 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-nota-de-pedido ( 14.00 , 131.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_t-nota-de-pedido. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_t-nota-de-pedido ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_t-nota-de-pedido ,
             h_f-cot-gral-matriz-de-ventas , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_t-nota-de-pedido , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       /* Position in AB:  ( 13.12 , 2.00 ) */
       /* Size in UIB:  ( 12.65 , 156.00 ) */
       ...
       /* Links to  h_t-cotizacion-unif-express. */
...
RUN vtagn/gen-nota-ped-library PERSISTENT SET hProc.

RUN EVEN_Genera-COT IN hProc (INPUT s-CodDoc,
                             INPUT pCodDiv,
                             INPUT pCodCli,
                             INPUT pCodVen,
                             OUTPUT pNroPed,
...
RUN valida-update IN h_v-nota-de-pedido.
IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
...
CASE L-Handle:
    WHEN "Exportar-a-Pdf" THEN DO:
         RUN Exportar-a-Pdf IN h_v-nota-de-pedido.
    END.
    WHEN "Exportar-a-Excel" THEN DO:
        ...
        CASE TRUE :
            WHEN INDEX(gn-divi.canalventa, "MIN") > 0
                THEN RUN Excel_Utilex IN h_v-nota-de-pedido (INPUT lchoice) .
            WHEN s-CodDiv = '00101' THEN 
                RUN Genera-Excel-Delivery IN h_v-nota-de-pedido (INPUT YES).   /* Siempre con IGV */
            OTHERWISE RUN Genera-Excel2 IN h_v-nota-de-pedido (INPUT lchoice) .
        END CASE.
    END.
...
/*         RUN Transferencia-de-Saldos IN h_v-nota-de-pedido ( OUTPUT pRowidS /* ROWID */).  */
/*         IF pRowidS <> ? THEN RUN Posiciona-Registro IN h_q-pedido ( INPUT pRowidS /* ROWID */). */
    END.
    WHEN "Captura-Historico-Cotizaciones" THEN DO:
        RUN Captura-Historico-Cotizaciones IN h_v-nota-de-pedido.
    END.
    WHEN "Importar-Excel-2015" THEN DO:
        RUN Importar-Excel-2015 IN h_v-nota-de-pedido.
    END.
    WHEN "Importar-Excel-Provincias" THEN DO:
        RUN Importar-Excel-Provincias IN h_v-nota-de-pedido.
    END.
    WHEN "Importar-Excel-Marco" THEN DO:
        RUN Importar-Excel-Marco.
    END.
    WHEN "Importar-listaexpress-iversa" THEN DO:
        /*RUN Importar-listaexpress-iversa IN h_v-nota-de-pedido.*/
        RUN Importar-listaexpress IN h_v-nota-de-pedido.
        IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
        MESSAGE 'Proceso Terminado' VIEW-AS ALERT-BOX INFORMATION.
    END.
    WHEN "Importar-tiendas-B2B" THEN DO:
        RUN Importar-tiendas-B2B IN h_v-nota-de-pedido.
    END.
    WHEN "Edi-Comparativo" THEN DO:
        /*RUN Edi-Comparativo IN h_v-nota-de-pedido.*/
        RUN Devuelve-Registro IN h_q-pedido ( OUTPUT pRowid /* ROWID */).
    ...
    WHEN "Importar-Supermercados" THEN DO:
        RUN Importar-Supermercados IN h_v-nota-de-pedido.
        IF RETURN-VALUE = "ADM-ERROR" THEN RETURN NO-APPLY.
        RUN dispatch IN h_t-nota-de-pedido ('open-query':U).
    END.
    WHEN "Importar-PET" THEN DO:
        RUN Importar-PET IN h_v-nota-de-pedido.
    END.
    ...
    WHEN "Actualiza-datos-cliente" THEN DO:
        RUN Actualiza-datos-cliente IN h_v-nota-de-pedido.
    END.
    WHEN "Cuenta-Corriente" THEN DO:
        RUN Cuenta-Corriente IN h_v-nota-de-pedido.
    END.
    WHEN "Enviar-al-Administrador" THEN DO:
        RUN dispatch IN h_v-nota-de-pedido ('Enviar-al-Administrador').
    END.
    ...
    WHEN "Importar-MarketPlace" THEN DO:
        RUN Importar-MarketPlace IN h_v-nota-de-pedido.
        RUN dispatch IN h_q-pedido ('open-query':U).
    END.
    WHEN 'Genera-Cotizacion-Eventos' THEN DO:
        RUN Genera-Cotizacion-Eventos.
    END.
    WHEN 'Revisar-NPC-Grupos' THEN DO:
        RUN Devuelve-Registro IN h_q-pedido ( OUTPUT pRowid /* ROWID */).
        IF pRowid = ? THEN RETURN.
        RUN Revisar-NPC-Grupos (INPUT pRowid).
    END.
    OTHERWISE DO:
...
CASE L-Handle:
    WHEN "Pagina1"  THEN DO WITH FRAME {&FRAME-NAME}:
        ...
        IF h_b-nota-de-pedido <> ? THEN RUN dispatch IN h_b-nota-de-pedido ('open-query':U).
        /* BOTONERAS */
        RUN dispatch IN h_f-npc-gral-expo-pag1 ('hide':U).
        ...
        RUN dispatch IN h_f-gen-npc-even ('hide':U).
        RUN dispatch IN h_f-review-npc-grupos ('view':U).
        CASE s-TpoPed:
            ...
            WHEN "E" THEN DO:      /* Eventos */
                RUN dispatch IN h_f-npc-gral-expo-pag1 ('view':U).
                RUN dispatch IN h_f-gen-npc-even ('view':U).
        ...
        END CASE.
        /* Repintamos pantalla */
        RUN dispatch IN h_v-nota-de-pedido ('display-fields':U).
    END.
    WHEN "Pagina2"  THEN DO WITH FRAME {&FRAME-NAME}:
        ...
        RUN dispatch IN h_f-cot-gral-envio-admin ('hide':U).
        RUN dispatch IN h_f-review-npc-grupos ('hide':U).
        CASE s-TpoPed:
            WHEN "S" THEN DO:       /* Supermercados */
    ...
    WHEN "Disable-Head" THEN DO:
        ...
        RUN dispatch IN h_v-nota-de-pedido ('disable-fields':U).
    ...
    WHEN "Enable-Head" THEN DO:
        ...
        RUN dispatch IN h_v-nota-de-pedido ('enable-fields':U).
    ...
    WHEN "browse" THEN DO:
          IF h_b-nota-de-pedido <> ? THEN RUN dispatch IN h_b-nota-de-pedido ('open-query':U).
          IF h_t-nota-de-pedido <> ? THEN RUN dispatch IN h_t-nota-de-pedido ('open-query':U). 
    END.
    ...
    WHEN "Ultimo-Registro" THEN DO:
        ...
        RUN dispatch IN h_v-nota-de-pedido ('display-fields':U).
        RUN dispatch IN h_b-nota-de-pedido ('open-query':U).
    END.
    OTHERWISE DO:
        MESSAGE 'ERROR, Rutina NO definida:' L-Handle VIEW-AS ALERT-BOX WARNING.
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Revisar-NPC-Grupos W-Win 
PROCEDURE Revisar-NPC-Grupos :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
RUN vtagn/d-npc-grupos (INPUT B-CPEDI.CodDoc + "*",
                        INPUT B-CPEDI.NroPed,
                        INPUT B-CPEDI.CodDiv).
