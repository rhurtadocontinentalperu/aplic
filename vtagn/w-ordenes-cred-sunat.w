...
DEFINE FRAME F-Main
     ...
     B-AGTRANS AT ROW 7.19 COL 167 WIDGET-ID 2
     BUTTON-11 AT ROW 9.08 COL 169 WIDGET-ID 14
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 2.35 , 168.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       /* Position in AB:  ( 12.58 , 2.00 ) */
       /* Size in UIB:  ( 12.12 , 141.00 ) */
