...
DEF VAR s-Tabla AS CHAR INIT 'MMLX' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Producto" FORMAT "x(6)":U
      Almmmatg.DesMat FORMAT "X(60)":U
  ENABLE
      VtaTabla.Llave_c1
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 55 BY 14.54
         FONT 4.
...
"VtaTabla.Llave_c1" "Producto" "x(6)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON 'RETURN':U OF VtaTabla.Llave_c1
DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE Almmmatg THEN DO:
      MESSAGE 'Producto NO registrado en el catálogo'
