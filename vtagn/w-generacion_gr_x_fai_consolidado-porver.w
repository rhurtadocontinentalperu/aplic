...
DEFINE TEMP-TABLE Detalle NO-UNDO LIKE CcbDDocu
       ...
       FIELD NroGuia as int  /* SOLO TEMPORAL */.
...
DEFINE VAR x-nrodoc-generado AS CHAR.
DEFINE VAR x-items-total AS INT.
DEFINE VAR x-items-x-guia AS INT.
DEFINE VAR x-cuantas-guias AS INT.

DEF VAR s-CodDoc AS CHAR INIT 'G/R' NO-UNDO.        /* OLD : FAC */
...
IF NOT AVAILABLE FacCorre THEN DO:
    MESSAGE "Correlativo del Documento " s-coddoc " NO configurado, para la division " + s-CodDiv VIEW-AS ALERT-BOX WARNING.
    RETURN ERROR.
END.
...
DEF TEMP-TABLE T-FAI-ART
    FIELD CodFai LIKE ccbcdocu.coddoc
    FIELD NroFai LIKE ccbcdocu.Nrodoc
    FIELD CodGR LIKE ccbcdocu.coddoc
    FIELD NroGR LIKE ccbcdocu.Nrodoc
...
COTIZACION.CustomerPurchaseOrder CcbCDocu.ImpTot 
...
&Scoped-define QUERY-STRING-BROWSE-DESTINO FOR EACH T-DESTINO NO-LOCK, ~
  ...
  AND COTIZACION.NroPed = PEDIDO.NroRef NO-LOCK ~
    BY COTIZACION.DeliveryGroup ~
       BY T-DESTINO.NroDoc INDEXED-REPOSITION
...
&Scoped-Define ENABLED-OBJECTS BROWSE-ORIGEN BUTTON-12 COMBO-BOX-grupo ~
BUTTON-1 COMBO-BOX-Clientes FILL-IN-FchSal-1 FILL-IN-FchSal-2 ~
BUTTON-Filtrar Btn_OK BtnDone BUTTON-2 COMBO-NroSer-guia RECT-2 RECT-3 ~
BROWSE-DESTINO 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-grupo FILL-IN-Items ~
FILL-IN-Total COMBO-BOX-Clientes FILL-IN-FchSal-1 FILL-IN-FchSal-2 ~
FILL-IN-Division COMBO-NroSer-guia FILL-IN-NroDoc-GR FILL-IN-items-x-guia 
...
DEFINE VARIABLE COMBO-NroSer-guia AS CHARACTER FORMAT "X(3)":U 
     LABEL "Serie G/R" 
...
DEFINE VARIABLE FILL-IN-Division AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 69 BY 1
     BGCOLOR 7 FGCOLOR 15 FONT 10 NO-UNDO.

DEFINE VARIABLE FILL-IN-FchSal-1 AS DATE FORMAT "99/99/9999":U 
     LABEL "Fecha Emision Desde (FAIs emitidas)" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE FILL-IN-items-x-guia AS INTEGER FORMAT ">>>>>9":U INITIAL 0 
     LABEL "Items por Guía" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .81
     BGCOLOR 9 FGCOLOR 15 FONT 10 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-DESTINO W-Win _STRUCTURED
  QUERY BROWSE-DESTINO NO-LOCK DISPLAY
      ...
      fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo COLUMN-LABEL "Grupo de Factura!de Cliente" FORMAT "x(20)":U
      COTIZACION.CustomerPurchaseOrder FORMAT "x(15)":U
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 9.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 71.86 BY 18.31
         FONT 4
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 72 BY 19.12
         FONT 4
...
DEFINE FRAME F-Main
     ...
     BUTTON-12 AT ROW 3.85 COL 64 WIDGET-ID 60
     COMBO-BOX-grupo AT ROW 5.04 COL 45 COLON-ALIGNED WIDGET-ID 58
     FILL-IN-Items AT ROW 25.04 COL 101 COLON-ALIGNED WIDGET-ID 56
     BUTTON-1 AT ROW 9.46 COL 75 WIDGET-ID 50
     FILL-IN-Total AT ROW 25.04 COL 142 COLON-ALIGNED WIDGET-ID 54
     COMBO-BOX-Clientes AT ROW 2.92 COL 7 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-FchSal-1 AT ROW 3.88 COL 28 COLON-ALIGNED WIDGET-ID 42
     FILL-IN-FchSal-2 AT ROW 3.85 COL 47 COLON-ALIGNED WIDGET-ID 44
     FILL-IN-Division AT ROW 1.19 COL 3 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     BUTTON-Filtrar AT ROW 3.85 COL 97 WIDGET-ID 38
     BUTTON-Exportar AT ROW 4.96 COL 97 WIDGET-ID 48
     Btn_OK AT ROW 4.69 COL 140 WIDGET-ID 32
     BtnDone AT ROW 3.04 COL 140 WIDGET-ID 34
     BUTTON-2 AT ROW 11.62 COL 75 WIDGET-ID 52
     COMBO-NroSer-guia AT ROW 5.04 COL 4.28 WIDGET-ID 62
     FILL-IN-NroDoc-GR AT ROW 5.12 COL 17.14 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     FILL-IN-items-x-guia AT ROW 5.04 COL 75 COLON-ALIGNED WIDGET-ID 18
     BROWSE-DESTINO AT ROW 6.38 COL 86.14 WIDGET-ID 300
     RECT-2 AT ROW 1 COL 2 WIDGET-ID 10
     RECT-3 AT ROW 2.54 COL 2 WIDGET-ID 46
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 158.43 BY 25.04
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "GENERACION DE G/R CONSOLIDADES APARTIR DE FAIs x GRUPO DE REPARTO"
         HEIGHT             = 25.04
         WIDTH              = 157.29
         MAX-HEIGHT         = 26.15
         MAX-WIDTH          = 191.29
...
/* SETTINGS FOR BUTTON BUTTON-Exportar IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       BUTTON-Exportar:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR COMBO-BOX COMBO-NroSer-guia IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN FILL-IN-Division IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Items IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-items-x-guia IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* Query rebuild information for BROWSE BROWSE-DESTINO
     ...
     _OrdList          = "INTEGRAL.COTIZACION.DeliveryGroup|yes,Temp-Tables.T-DESTINO.NroDoc|yes"
...
"T-DESTINO.FchDoc" "Fch. FAI" ? "date" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-DESTINO.FchVto
"T-DESTINO.FchVto" "Fecha de!Salida" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fCentrar(COTIZACION.DeliveryGroup)  @ x-Grupo" "Grupo de Factura!de Cliente" "x(20)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbCDocu.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-ORIGEN
     ...
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST, FIRST, FIRST, FIRST"
     _OrdList          = "INTEGRAL.COTIZACION.DeliveryGroup|yes,Temp-Tables.T-ORIGEN.NroDoc|yes"
     _JoinCode[3]      = "PEDIDO.CodCia = INTEGRAL.CcbCDocu.CodCia
  AND PEDIDO.CodDoc = INTEGRAL.CcbCDocu.CodPed
  AND PEDIDO.NroPed  = INTEGRAL.CcbCDocu.NroPed"
     _JoinCode[4]      = "COTIZACION.CodCia = PEDIDO.CodCia
...
"T-ORIGEN.FchDoc" "Fch. FAI" ? "date" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON END-ERROR OF W-Win /* GENERACION DE G/R CONSOLIDADES APARTIR DE FAIs x GRUPO DE REPARTO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* GENERACION DE G/R CONSOLIDADES APARTIR DE FAIs x GRUPO DE REPARTO */
DO:
...
ON CHOOSE OF Btn_OK IN FRAME F-Main /* Generar G/R */
DO:

    ASSIGN
         COMBO-NroSer-Guia FILL-IN-Division FILL-IN-NroDoc-GR COMBO-BOX-Clientes.
    ASSIGN FILL-IN-Items fill-in-items-x-guia combo-box-grupo.

    DEFINE VAR x-fais-grupo AS INT.

    /* Cantidad de Items x G/R */
    RUN VALIDA_FAIS_COMPLETAS (INPUT combo-box-grupo, OUTPUT x-fais-grupo).

    IF FILL-IN-Division BEGINS 'Seleccione' THEN RETURN NO-APPLY.

    MESSAGE "Se va aproceder a generar la G/R con serie : " + COMBO-NroSer-Guia  SKIP 
    ...
    RUN Generacion-de-Factura (INPUT COMBO-NroSer-Guia,
                               OUTPUT pMensaje,
                               OUTPUT iCountGuide).
    SESSION:SET-WAIT-STATE('').
    IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
        MESSAGE "Hubo problemas al generar la G/R" SKIP
                pMensaje VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    ELSE DO:
        MESSAGE "Se ha(n) generado" iCountGuide "Guia(s) : " + x-nrodoc-generado
...
ON CHOOSE OF BUTTON-Exportar IN FRAME F-Main /* ENVIAR A TEXTO */
DO:
  RUN Texto.
END.
...
ON CHOOSE OF BUTTON-Filtrar IN FRAME F-Main /* BUSCAR FAIs */
DO:
    ASSIGN 
        COMBO-BOX-Clientes COMBO-NroSer-Guia
...
DO:
    ...
    FOR EACH T-INVOICE NO-LOCK WHERE T-INVOICE.codcli = COMBO-BOX-Clientes : 
        ...
        IF TRUE <> (COMBO-BOX-grupo:SCREEN-VALUE > "") THEN 
            COMBO-BOX-grupo:SCREEN-VALUE = TRIM(T-INVOICE.InvoiceCustomerGroup).
        */            
        combo-box-grupo:ADD-LAST(TRIM(T-INVOICE.DeliveryGroup)).
        IF TRUE <> (COMBO-BOX-grupo:SCREEN-VALUE > "") THEN 
            COMBO-BOX-grupo:SCREEN-VALUE = TRIM(T-INVOICE.DeliveryGroup).
...
ON RETURN OF COMBO-NroSer-guia IN FRAME F-Main /* Serie G/R */
DO:
    APPLY 'Tab':U TO SELF.
END.
...
/* Para este caso el s-coddoc es G/R */
RUN sunat\p-formato-doc (INPUT s-CodDoc, OUTPUT x-FormatoFAC).
RUN sunat\p-formato-doc (INPUT "G/R", OUTPUT x-FormatoGUIA).
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    FOR EACH Detalle , FIRST Almmmatg OF Detalle NO-LOCK BREAK BY Detalle.NROGUIA:
        /* Crea Cabecera */
        IF FIRST-OF(Detalle.NROGUIA) THEN DO:
            /* Cabecera de Guía */
            ...
            IF ERROR-STATUS:ERROR = YES THEN DO:
                ...
                pMensaje = "PROGRESS :" + ERROR-STATUS:GET-MESSAGE(1).
                UNDO TRLOOP, RETURN 'ADM-ERROR'.
            END.
            ASSIGN
/*                CcbCDocu.TpoFac = "AC"          /* POR FAI - CONSOLIDADA */*/
                CcbCDocu.TpoFac = "A"       /* POR FAI */ 
                Ccbcdocu.CodRef = "FAI"
                Ccbcdocu.NroRef = "".
            /* SOLO UNA GUIA */
            ASSIGN
            ...
            ASSIGN
                ...
                lCreaHeader = FALSE.
                iCountItem = 1.
                x-nrodoc-generado = x-nrodoc-generado + ", " + TRIM(CcbCDocu.NroDoc).
        ...
        /* --------------------------- */
        FOR EACH T-FAI-ART WHERE T-FAI-ART.codmat = Detalle.codmat :
            ASSIGN 
                T-FAI-ART.codGR = CcbCDocu.Coddoc        /* G/R */
                T-FAI-ART.nroGR = CcbCDocu.Nrodoc.
        END.
        IF LAST-OF(Detalle.NroGuia) THEN DO:
            /* Graba Totales */
            ...
            THEN ASSIGN
                    ...
                    Ccbcdocu.flgest = 'C'.      /* OJO nose si en G/R se cancela */
            /* *********************** */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR'
    ...
    DO WHILE NOT QUERY-OFF-END('BROWSE-DESTINO'):
        FIND FIRST B-CDOCU OF T-DESTINO NO-LOCK NO-ERROR.
        /* BLOQUEAMOS REGISTRO */
        {lib/lock-genericov3.i ~
            &Tabla="Ccbcdocu" ~
...
/*         ASSIGN                                                        */
/*             Ccbcdocu.FlgEst = "P"       /* <<<<<<<<< OJO <<<<<<<<< */ */
/*             Ccbcdocu.SdoAct = 0                                       */
/*             CcbCDocu.FchCan = TODAY                                   */
/*             CcbCDocu.UsrCobranza = s-user-id.                         */
        /* ******************* */
        FOR EACH Ccbddocu OF Ccbcdocu NO-LOCK, FIRST Almmmatg OF Ccbddocu NO-LOCK:
            FIND FIRST Detalle WHERE Detalle.codmat = Ccbddocu.codmat NO-ERROR.
            IF NOT AVAILABLE Detalle THEN DO:
                CREATE Detalle.
                x-items-total = x-items-total + 1.
            END.
            ...
            /* Guardar referencias */
            CREATE T-FAI-ART.
                ASSIGN T-FAI-ART.CodFai = Ccbcdocu.coddoc
                        T-FAI-ART.NroFai = Ccbcdocu.nrodoc
                        T-FAI-ART.CodGR = ""
                        T-FAI-ART.NroGR = ""
                        T-FAI-ART.codmat = Ccbddocu.codmat.                        
        END.
        GET NEXT BROWSE-DESTINO.
    END.
END.

/* Cuantas G/R se crearan */
DEFINE VAR x-itm AS INT.
DEFINE VAR x-guia AS INT.

x-items-x-guia = fill-in-items-x-guia.
x-item = 1.
x-guia = 1.
FOR EACH Detalle:
    ASSIGN Detalle.nroguia = x-guia.
   
    IF x-item >= x-items-x-guia THEN DO:
        x-item = 0.
        x-guia = x-guia + 1.
    END.   
    x-item = x-item + 1.
...
/*     /* Que las FAI no tengan G/R */                       */
/*     IF NOT (TRUE <> (ccbcdocu.codref > "")) THEN NEXT.    */
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-grupo FILL-IN-Items FILL-IN-Total COMBO-BOX-Clientes 
          FILL-IN-FchSal-1 FILL-IN-FchSal-2 FILL-IN-Division COMBO-NroSer-guia 
          FILL-IN-NroDoc-GR FILL-IN-items-x-guia 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE BROWSE-ORIGEN BUTTON-12 COMBO-BOX-grupo BUTTON-1 COMBO-BOX-Clientes 
         FILL-IN-FchSal-1 FILL-IN-FchSal-2 BUTTON-Filtrar Btn_OK BtnDone 
         BUTTON-2 COMBO-NroSer-guia RECT-2 RECT-3 BROWSE-DESTINO 
      WITH FRAME F-Main IN WINDOW W-Win.
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    /* ************************************************************* */
    /* *********** 2do. GENERAMOS LA GUIA DE REMISION ***************** */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR'
    ...
    IF NOT CAN-FIND(FIRST T-DESTINO NO-LOCK) THEN DO:
        pMensaje = "No existen FAIs seleccionados para generar G/R".
    ...
    IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
        IF TRUE <> (pMensaje > "") THEN pMensaje = "ERROR: No se pudo generar la GUIA DE REMISION".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Generacion-de-GuiaRemision W-Win 
PROCEDURE Generacion-de-GuiaRemision :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FOR EACH T-DESTINO NO-LOCK,
    ...
    FOR EACH Ccbddocu OF T-DESTINO NO-LOCK:
        ...
        */
        ...
        FIND FIRST T-ITEMS WHERE T-ITEMS.codmat = Ccbddocu.codmat EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE T-ITEMS THEN DO:
            CREATE T-ITEMS.
                ASSIGN T-ITEMS.codmat = Ccbddocu.codmat.
            FILL-IN-Items = FILL-IN-Items + 1.
        END.
    END.
...
------------------------------------------------------------------------------*/
  ...
  APPLY 'VALUE-CHANGED':U TO COMBO-NroSer-Guia IN FRAME {&FRAME-NAME}.
...
/* TODAS LA FAIs INVOLUCRADAS LOS REFERENCIO CON LA GUIA CONSOLIDADA */
TRLOOP:
FOR EACH Cabecera-FAC NO-LOCK:      /* Tantas G/R se hayan generado*/
    FOR EACH Cabecera-FAI NO-LOCK:
        {lib/lock-genericov3.i ~
            ...
            &TipoError="UNDO TRLOOP, RETURN 'ADM-ERROR'"}
         ASSIGN
            CcbCDocu.codref = Cabecera-FAC.CodDoc       /* G/R */
            CcbCDocu.nroref = Cabecera-FAC.NroDoc
            CcbCDocu.Libre_c03 = ""     /* Se reserva para la FAC MASTER */
            CcbCDocu.Libre_c04 = "".
...
/* GRABAR */
FOR EACH T-FAI-ART NO-LOCK:
    CREATE vtatabla.
        ASSIGN vtatabla.codcia = s-codcia 
            vtatabla.tabla = "CRUCE-FAI-GR"
            vtatabla.llave_c1 = TRIM(T-FAI-ART.codfai) + "-" + TRIM(T-FAI-ART.nrofai)
            vtatabla.llave_c2 = TRIM(T-FAI-ART.codgr) + "-" + TRIM(T-FAI-ART.nrogr)
            vtatabla.llave_c3 = TRIM(T-FAI-ART.codmat).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE refrescar-parametros W-Win 
PROCEDURE refrescar-parametros :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        /* RHC 30/03/2021 Las FAI va a tener los siguientes estados:
        P: generada
        A: anulada
        C: con G/R o FAC
        */
        /* SOLO FAIs PLANIFICADAS */
        FOR EACH ccbcdocu NO-LOCK WHERE ccbcdocu.codcia = s-codcia
            AND ccbcdocu.flgest = "P"                       /* OJO */
            AND ccbcdocu.coddoc = "FAI",
            FIRST PEDIDO WHERE PEDIDO.CodCia = CcbCDocu.CodCia
            AND PEDIDO.CodDoc = CcbCDocu.CodPed
            AND PEDIDO.NroPed = CcbCDocu.NroPed NO-LOCK,
            ...
            AND COTIZACION.CodDoc = PEDIDO.CodRef
            AND COTIZACION.NroPed = PEDIDO.NroRef 
            AND COTIZACION.InvoiceCustomerGroup > '' NO-LOCK,   /* OJO */
            FIRST gn-divi WHERE gn-divi.codcia = s-codcia
            AND gn-divi.coddiv = COTIZACION.coddiv
            AND gn-divi.flgrep = YES NO-LOCK                /* OJO : Acepta FAI */
            BREAK BY COTIZACION.codcli BY COTIZACION.InvoiceCustomerGroup:
            IF NOT (ccbcdocu.fchdoc >= fill-in-FchSal-1 
                    AND ccbcdocu.fchdoc <= fill-in-FchSal-2) THEN NEXT.
/*             /*Que las FAI no tengan G/R */                        */
/*             IF NOT (TRUE <> (ccbcdocu.codref > "")) THEN NEXT.    */
/*             /*Que las FAI no esten FACTURADAS */                  */
/*             IF NOT (TRUE <> (ccbcdocu.libre_c03 > "")) THEN NEXT. */
            FIND FIRST T-INVOICE WHERE T-INVOICE.codcli = COTIZACION.codcli 
                AND T-INVOICE.InvoiceCustomerGroup = COTIZACION.InvoiceCustomerGroup 
                EXCLUSIVE-LOCK NO-ERROR.
            IF NOT AVAILABLE T-INVOICE THEN DO:
                CREATE T-INVOICE.
                ASSIGN 
                    T-INVOICE.codcli = ccbcdocu.codcli
        ...
        /* Items x Guia */
        FIND FacCfgGn WHERE FacCfgGn.CodCia = s-CodCia NO-LOCK NO-ERROR.
        FILL-IN-items-x-guia = FacCfgGn.Items_Guias.
        x-cuantas-guias = 0.
        x-items-x-guia = FacCfgGn.Items_Guias.
    END.
    /**/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE VALIDA_FAIS_COMPLETAS W-Win 
PROCEDURE VALIDA_FAIS_COMPLETAS :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE INPUT PARAMETER pGrupoReparto AS CHAR.
DEFINE OUTPUT PARAMETER pTotalFAIs AS INT.
