...
DEF INPUT PARAMETER pCodAlm AS CHAR.        /* 27/04/2026: Debe ser el almacén por defecto, no se puede cambiar */
...
DEF NEW SHARED VAR lh_handle_01 AS HANDLE.
...
BUTTON_Filtrar FILL-IN-codigo Btn_OK Btn_Cancel 
...
/* SETTINGS FOR COMBO-BOX COMBO-BOX-CodAlm IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Disable_Almacenes D-Dialog 
PROCEDURE Disable_Almacenes :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
------------------------------------------------------------------------------*/
  DISPLAY F-marca f-CodFam FILL-IN-filtro COMBO-BOX-CodAlm FILL-IN-codigo 
          TOGGLE-1 
      WITH FRAME D-Dialog.
  ENABLE F-marca f-CodFam FILL-IN-filtro BUTTON_Filtrar FILL-IN-codigo Btn_OK 
         Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      DO i = 1 TO NUM-ENTRIES(s-CodAlm):
          ...
          END.
      END.
      /* 27/04/2026: no se puede modificar */
      IF NOT CAN-FIND(FIRST ITEM NO-LOCK) THEN COMBO-BOX-CodAlm:SENSITIVE = YES.
      COMBO-BOX-CodAlm = pCodAlm.
