...
&Scoped-define INTERNAL-TABLES VtaListaMay

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaListaMay WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMay.CodCia = S-CODCIA ~
 AND VtaListaMay.codmat = S-CODMAT ~
 AND VtaListaMay.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaListaMay WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMay.CodCia = S-CODCIA ~
 AND VtaListaMay.codmat = S-CODMAT ~
 AND VtaListaMay.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaListaMay
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaListaMay
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.VtaListaMay"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "VtaListaMay.CodCia = S-CODCIA
 AND VtaListaMay.codmat = S-CODMAT
