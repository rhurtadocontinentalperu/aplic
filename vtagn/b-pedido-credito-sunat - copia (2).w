...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio!Peldaño Bruto" FORMAT ">,>>>,>>9.99999":U
            WIDTH 10
...
"(IF Facdpedi.Libre_c05 <> '' AND Facdpedi.Libre_c05 <> 'OF' THEN Facdpedi.Libre_c05 + ' - ' ELSE '') + Almmmatg.desmat @ Almmmatg.desmat" "Descripción" "x(100)" ? ? ? ? ? ? ? no ? no no "85" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.PreUni" "Precio!Peldaño Bruto" ">,>>>,>>9.99999" "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"FacDPedi.FactorDescuento * 100 @ FacDPedi.FactorDescuento" "% Descuento" ">>9.99999" ? ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.FacDPedi.ImpDto2
"FacDPedi.ImpDto2" "Otros!Dsctos" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > integral.FacDPedi.ImporteUnitarioConImpuesto
"FacDPedi.ImporteUnitarioConImpuesto" "Precio Unitario!Neto con IGV" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > integral.FacDPedi.cImporteTotalConImpuesto
"FacDPedi.cImporteTotalConImpuesto" "Importe!con IGV" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
