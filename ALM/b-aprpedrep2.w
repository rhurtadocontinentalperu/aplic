...
Almmmatg.DesMar almdrepo.CanReq almdrepo.CanApro almdrepo.CanAten ~
Almmmatg.UndBas 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table almdrepo.CanApro 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      almdrepo.CanApro FORMAT "ZZZ,ZZ9.9999":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      almdrepo.CanAten FORMAT "ZZZ,ZZ9.9999":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      Almmmatg.UndBas COLUMN-LABEL "Unidad" FORMAT "X(7)":U WIDTH 8.43
  ENABLE
      almdrepo.CanApro
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 99 BY 6.69
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     "F8: Consulta de stocks" VIEW-AS TEXT
          SIZE 48 BY .5 AT ROW 8 COL 2 WIDGET-ID 8
...
"Almmmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.almdrepo.CanReq
"almdrepo.CanReq" "Cantidad!Requerida" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.almdrepo.CanApro
"almdrepo.CanApro" ? "ZZZ,ZZ9.9999" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.almdrepo.CanAten
"almdrepo.CanAten" ? ? "decimal" 14 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
