...
DEFINE VARIABLE h_b-aprob-abastec-v21 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-aprob-abastec-v21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprob-abastec-v21 ).
       RUN set-position IN h_b-aprob-abastec-v21 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-aprob-abastec-v21 ( 13.42 , 144.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv96-2 ).
       RUN set-position IN h_p-updv96-2 ( 9.08 , 90.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-aprob-abastec-d , 'Record':U , h_v-aprob-abastec-v2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96-2 , 'TableIO':U , h_v-aprob-abastec-v2 ).

       /* Links to SmartBrowser h_b-aprob-abastec-d. */
       RUN add-link IN adm-broker-hdl ( h_b-aprob-abastec-v21 , 'Record':U , h_b-aprob-abastec-d ).
...
CASE pParametro:
    ...
    WHEN 'disable-header' THEN DO:
         ...
         RUN disable-filtros IN h_b-aprob-abastec-v21.
    END.
    WHEN 'enable-header' THEN DO:
         RUN dispatch IN h_p-updv96-2 ('enable':U).
         RUN Enable-Filtros IN h_b-aprob-abastec-v21.
    END.
    WHEN 'open-queries' THEN DO:
        RUN dispatch IN h_b-aprob-abastec-v21 ('open-query':U).
