...
IF NOT CAN-FIND(Almmmatg WHERE Almmmatg.codcia = s-codcia
                ...
                NO-LOCK)
    THEN DO:
    MESSAGE 'Código de artículo inválido' VIEW-AS ALERT-BOX ERROR.
...
IF NOT CAN-FIND(Almacen WHERE Almacen.codcia = s-codcia
                ...
                NO-LOCK)
    THEN DO:
    MESSAGE 'Almacén despacho inválido' VIEW-AS ALERT-BOX ERROR.
...
IF NOT CAN-FIND(Almacen WHERE Almacen.codcia = s-codcia
                ...
                NO-LOCK)
    THEN DO:
    MESSAGE 'Almacén sugerido inválido' VIEW-AS ALERT-BOX ERROR.
