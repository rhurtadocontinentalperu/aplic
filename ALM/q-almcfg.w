...
&Scoped-define INTERNAL-TABLES INTEGRAL.AlmCfg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH INTEGRAL.AlmCfg WHERE ~{&KEY-PHRASE} ~
      AND INTEGRAL.AlmCfg.CodCia = S-CODCIA NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main INTEGRAL.AlmCfg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main INTEGRAL.AlmCfg
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.AlmCfg"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.AlmCfg.CodCia = S-CODCIA"
