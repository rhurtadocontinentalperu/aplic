...
DEFINE VARIABLE h_b-rutac-01-2 AS HANDLE NO-UNDO.
...
*/
  RUN Cierre-Hoja IN h_b-rutac-01-2.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/b-rutac-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rutac-01-2 ).
       RUN set-position IN h_b-rutac-01-2 ( 1.27 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rutac-01-2 ( 6.69 , 112.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rutac-01-2 ,
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-rut002a-01 ( 10.42 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-rut002a-01 ( 9.35 , 124.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-rut002a-01. */
       RUN add-link IN adm-broker-hdl ( h_b-rutac-01-2 , 'Record':U , h_b-rut002a-01 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac-01-2 , 'Record':U , h_b-rut002d ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac-01-2 , 'Record':U , h_b-rut002e ).
