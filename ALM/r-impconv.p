...
DEF VAR C-RUC    AS CHAR FORMAT "X(11)".
DEF VAR x-Motivo AS CHAR INIT "8 Otros".    /* Motivo de traslado */
...
CASE Almcmov.codmov:
    WHEN 09 THEN x-Motivo = "5 Devolución".     /* Devolución a proveedor */
END CASE.
...
THEN ASSIGN
        C-RUC    = gn-prov.ruc
        C-NomCon = gn-prov.NomPro
        C-DirCon = gn-prov.DirPro.
X-senal  = "X".
...
DEFINE FRAME F-HdrGui
   ...
   'NUEVO R.U.C 20100038146' AT 92  FORMAT "X(20)" SKIP(1)
    ...
    /*"8 Otros " AT 7 FORMAT "X(15)" SKIP*/
    x-Motivo AT 7 FORMAT "X(15)" SKIP
...
DEFINE FRAME F-FtrGui
    ...
    'Glosa   : ' Almcmov.Observ FORMAT 'X(50)' SKIP
