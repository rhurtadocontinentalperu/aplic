...
&Scoped-define QUERY-STRING-Query-Main FOR EACH vtapmatg OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH vtapmatg OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.vtapmatg OF INTEGRAL.Almmmatg"
