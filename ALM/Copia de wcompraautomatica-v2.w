...
&Scoped-Define ENABLED-OBJECTS RECT-9 RECT-1 RECT-11 BUTTON-Grupos BUTTON-4 ~
BUTTON-7 COMBO-BOX-Tipo SELECT-Clasificacion FILL-IN-CodPro FILL-IN-PorRep ~
...
FILL-IN-CodFam FILL-IN-Total COMBO-BOX-Tipo FILL-IN-SubFam FILL-IN-Peso ~
SELECT-Clasificacion FILL-IN-CodPro FILL-IN-NomPro FILL-IN-PorRep ~
FILL-IN-Volumen FILL-IN-Marca FILL-IN-PorStkMax FILL-IN-Stock FILL-IN-Texto ~
FILL-IN-Venta30d FILL-IN-Venta30dy FILL-IN-Mensaje 
...
DO:        
  ...
  FOR EACH Almtabla NO-LOCK WHERE almtabla.Tabla = 'ZG'
      ...
      FOR EACH TabGener WHERE TabGener.Clave = almtabla.Tabla
...
ELSE DO:
    ...
    FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = s-codcia
        ...
        IF NOT AVAILABLE T-MATG THEN CREATE T-MATG.
        BUFFER-COPY Almmmatg TO T-MATG.
        /*IF almmmatg.codmat = '065693' THEN MESSAGE 'dos ok'.*/
        PROCESS EVENTS.
...
FOR EACH TabGener NO-LOCK WHERE TabGener.CodCia = s-codcia
    ...
    AND LOOKUP(TabGener.Codigo, FILL-IN_Grupos) > 0
    AND CAN-FIND(B-GENER WHERE B-GENER.codcia = s-codcia AND 
                 B-GENER.clave = 'ZG' AND
                 B-GENER.libre_c01 = TabGener.Libre_c01 AND
                 LOOKUP(B-GENER.Codigo, FILL-IN_Grupos) = 0 NO-LOCK),
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Temporada FILL-IN_Grupos FILL-IN-CodFam FILL-IN-Total 
          COMBO-BOX-Tipo FILL-IN-SubFam FILL-IN-Peso SELECT-Clasificacion 
          FILL-IN-CodPro FILL-IN-NomPro FILL-IN-PorRep FILL-IN-Volumen 
          FILL-IN-Marca FILL-IN-PorStkMax FILL-IN-Stock FILL-IN-Texto 
          FILL-IN-Venta30d FILL-IN-Venta30dy FILL-IN-Mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-9 RECT-1 RECT-11 BUTTON-Grupos BUTTON-4 BUTTON-7 COMBO-BOX-Tipo 
