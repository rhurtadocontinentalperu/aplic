...
DEFINE FRAME F-Main
     CcbCDocu.CodDoc AT ROW 1.38 COL 9 COLON-ALIGNED
          LABEL "Documento"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     CcbCDocu.NroDoc AT ROW 1.38 COL 15 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCDocu.NomCli AT ROW 1.38 COL 27 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 44 BY .81
