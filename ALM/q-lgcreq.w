...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LG-CRequ WHERE ~{&KEY-PHRASE} ~
      AND LG-CRequ.CodCia = s-codcia ~
 AND LG-CRequ.NroSer = s-nroser NO-LOCK ~
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "INTEGRAL.LG-CRequ.CodCia = s-codcia
 AND INTEGRAL.LG-CRequ.NroSer = s-nroser"
