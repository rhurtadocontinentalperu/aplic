...
DEF TEMP-TABLE T-MATG LIKE ALMMMATG
    FIELD StkAlm AS DEC
    FIELD StkAlm11 AS DEC
    FIELD StkAlm22 AS DEC
    FIELD StkAlm85 AS DEC
    FIELD StkAlm40 AS DEC
    FIELD StkAlm42 AS DEC
    FIELD PesAlm AS DEC
    FIELD PreCto AS DEC
    FIELD ValCto AS DEC
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Existencias por Proveedor ATE"
         HEIGHT             = 11.19
         WIDTH              = 80
         MAX-HEIGHT         = 15.58
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* Existencias por Proveedor ATE */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Existencias por Proveedor ATE */
DO:
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEF VAR F-StkAlm11 AS DEC NO-UNDO.
  DEF VAR F-StkAlm22 AS DEC NO-UNDO.
  DEF VAR F-StkAlm85 AS DEC NO-UNDO.
  DEF VAR F-StkAlm40 AS DEC NO-UNDO.
  DEF VAR F-StkAlm42 AS DEC NO-UNDO.
  FOR EACH T-MATG:
    DELETE T-MATG.
  END.
  ...
  FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = s-codcia
    ...
    ASSIGN
        ...
        F-StkAlm40 = 0
        F-StkAlm42 = 0.
    FOR EACH Almmmate OF Almmmatg NO-LOCK WHERE LOOKUP(TRIM(Almmmate.codalm), '11,22,85,40,42') > 0:
        CASE Almmmate.codalm:
            WHEN '11' THEN F-StkAlm11 = F-StkAlm11 + AlmmMate.stkact.
            WHEN '22' THEN F-StkAlm22 = F-StkAlm22 + AlmmMate.stkact.
            WHEN '85' THEN F-StkAlm85 = F-StkAlm85 + AlmmMate.stkact.
            WHEN '40' THEN F-StkAlm40 = F-StkAlm40 + AlmmMate.stkact.
            WHEN '42' THEN F-StkAlm42 = F-StkAlm42 + AlmmMate.stkact.
        END CASE.
    END.
    F-StkAlm = F-StkAlm11 + F-StkAlm22 + F-StkAlm85 + F-StkAlm40 + F-StkAlm42.
    ...
    BUFFER-COPY ALMMMATG TO T-MATG
        ASSIGN T-MATG.StkAlm = F-STKALM
               T-MATG.StkAlm11 = F-StkAlm11
               T-MATG.StkAlm22 = F-StkAlm22
               T-MATG.StkAlm85 = F-StkAlm85
               T-MATG.StkAlm40 = F-StkAlm40
               T-MATG.StkAlm40 = F-StkAlm42
...
------------------------------------------------------------------------------*/
  DEFINE FRAME F-REPORTE
         ...
         T-MATG.STKALM11 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM22 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM85 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM40 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM42 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM   FORMAT "->>>,>>>,>>9.99"
         T-MATG.Catcon[1] 
         T-MATG.TipArt
         HEADER
         S-NOMCIA FORMAT "X(50)" SKIP
         "EXISTENCIAS POR ALMACENES ATE" AT 20  
         ...
         "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
         "                                                                                                                                                                                " SKIP
         "     Codigo   Descripcion                                        MARCA          Unid   Almacen 11   Almacen 22    Almacen 85    Almacen 40    Almacen 42         Total    CC Tip" SKIP
         "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
/*
                   1         2         3         4         5         6         7         8         9         0         1         2
          12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
           123456789 12345678901234567890123456789012345678901234567890 1234567890123 12345678 ->>>,>>9.999 ->>>,>>9.9999 ->>>,>>9.9999 ->>>,>>9.9999 ->>>,>>9.9999 ->>>,>>>,>>9.99 12 12
*/
...
------------------------------------------------------------------------------*/
  DEFINE FRAME F-REPORTE
         T-MATG.codpr1 FORMAT "X(11)" AT 2
         T-MATG.nompro FORMAT "X(40)"
         T-MATG.DesMar FORMAT "X(13)"
         T-MATG.UndStk FORMAT 'x(7)'
         T-MATG.STKALM11 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM22 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM85 FORMAT "->>>,>>>,>>9.99"
         T-MATG.STKALM40 FORMAT "->>>,>>>,>>9.99"
         ...
         "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
         "                                                                                                                                                                            " SKIP
         "  Proveedor   Nombre/Razon Social                                                Almacen 11      Almacen 22      Almacen 85      Almacen 40      Almacen 42          Total  " SKIP
         "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
/*
           12345678901 1234567890123456789012345678901234567890 1234567890123 12345678 ->>>,>>>,>>9.99 ->>>,>>>,>>9.99 ->>>,>>>,>>9.99 ->>>,>>>,>>9.99 ->>>,>>>,>>9.99 ->>>,>>>,>>9.99
*/
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
    ENABLE ALL EXCEPT T-Resumen D-Corte.
END.
