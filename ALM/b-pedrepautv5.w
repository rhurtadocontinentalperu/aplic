...
fStockComprometido(T-DREPO.CodMat,T-DREPO.CodAlm) @ x-StockComprometido ~
T-DREPO.PorcReposicion @ x-PorcReposicion Almmmatg.CodFam Almtfami.desfam ~
Almmmatg.SubFam AlmSFami.dessub T-DREPO.CodZona @ x-Sector ~
T-DREPO.CodUbi @ x-Ubicacion 
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Codigo COMBO-BOX-Almacen ~
COMBO-BOX-Marcas COMBO-BOX-Lineas COMBO-BOX-SubLineas COMBO-BOX-ClfGral ~
COMBO-BOX-ClfMayo COMBO-BOX-ClfUtil COMBO-BOX-Sector FILL-IN-DesMat ~
br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Codigo COMBO-BOX-Almacen ~
...
DEFINE VARIABLE COMBO-BOX-Codigo AS CHARACTER FORMAT "X(256)":U INITIAL "Codigo" 
     LABEL "Ordenado por" 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DREPO.DesMat @ x-DesMat COLUMN-LABEL "Descripción" FORMAT "x(60)":U
            WIDTH 38.43
      ...
      T-DREPO.DesCmpTra @ x-SolCmpTra COLUMN-LABEL "Compras en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 8.72
      fStkDisponible(T-DREPO.AlmPed,T-DREPO.CodMat) @ x-StkDisponible COLUMN-LABEL "Disponible!Despacho" FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
            WIDTH 8.72 COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 13
      ...
      fStockComprometido(T-DREPO.CodMat,T-DREPO.CodAlm) @ x-StockComprometido COLUMN-LABEL "Stock!Reservado" FORMAT "->>>,>>9.99":U
      ...
      T-DREPO.CodZona @ x-Sector COLUMN-LABEL "Sector" FORMAT "x(5)":U
      T-DREPO.CodUbi @ x-Ubicacion COLUMN-LABEL "Ubicacion" FORMAT "x(10)":U
  ENABLE
      T-DREPO.CodMat
      T-DREPO.AlmPed
      T-DREPO.CanReq
...
DEFINE FRAME F-Main
     COMBO-BOX-Codigo AT ROW 1 COL 10 COLON-ALIGNED WIDGET-ID 6
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ", FIRST, FIRST, FIRST, FIRST, FIRST"
     _Where[1]         = "{&Condicion}"
     _Where[2]         = "{&Condicion2}"
...
"T-DREPO.DesMat @ x-DesMat" "Descripción" "x(60)" ? ? ? ? ? ? ? no ? no no "38.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.DesCmpTra @ x-SolCmpTra" "Compras en!Tránsito" "ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > "_<CALC>"
"fStkDisponible(T-DREPO.AlmPed,T-DREPO.CodMat) @ x-StkDisponible" "Disponible!Despacho" "(ZZZ,ZZZ,ZZ9.99)" ? 13 15 ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.GrpStkDis @ x-DesStkDis" "Disponible!Grupo" "(ZZZ,ZZZ,ZZ9.99)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fStockComprometido(T-DREPO.CodMat,T-DREPO.CodAlm) @ x-StockComprometido" "Stock!Reservado" "->>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.CodZona @ x-Sector" "Sector" "x(5)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   > "_<CALC>"
"T-DREPO.CodUbi @ x-Ubicacion" "Ubicacion" "x(10)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON VALUE-CHANGED OF COMBO-BOX-Codigo IN FRAME F-Main /* Ordenado por */
DO:
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DO WITH FRAME {&FRAME-NAME}:
      COMBO-BOX-Codigo:SENSITIVE = YES.
