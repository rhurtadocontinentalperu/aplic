...
FIND FIRST Almtmovm WHERE Almtmovm.CodCia = S-CODCIA 
                     ...
                     AND  Almtmovm.MovCmp 
                    NO-LOCK NO-ERROR.
IF AVAILABLE Almtmovm THEN /*S-MOVCMP = 99. 
 Almtmovm.Codmov.*/ S-MOVCMP = Almtmovm.Codmov.
...
&Scoped-Define ENABLED-OBJECTS RECT-2 F-Numero BUTTON-1 
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    RUN LKUP\C-CRRALM ("Movimientos de Ingreso").
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST Almtdocm WHERE 
           Almtdocm.CodCia = S-CODCIA AND
           Almtdocm.CodAlm = S-CODALM AND
           Almtdocm.TipMov = S-TPOMOV AND
           Almtdocm.CodMov = 66 /*S-MOVCMP*/ AND
           Almtdocm.CodMov <> S-MOVTRF AND
           Almtdocm.CodMov = F-Numero NO-LOCK NO-ERROR.
