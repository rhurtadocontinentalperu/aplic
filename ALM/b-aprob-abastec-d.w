...
/* BROWSE-TAB adbr_table TEXT-2 F-Main */
ASSIGN 
...
ON F10 OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F11 OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F7 OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F8 OF adbr_table IN FRAME F-Main
DO:
    S-CODMAT = Almmmatg.CodMat.
    /*RUN vta/d-stkalm.*/
    RUN alm/d-stkalm.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F9 OF adbr_table IN FRAME F-Main
DO:
  S-CODMAT = Almmmatg.CodMat.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON LEFT-MOUSE-DBLCLICK OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON ROW-ENTRY OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON ROW-LEAVE OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON START-SEARCH OF adbr_table IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON VALUE-CHANGED OF adbr_table IN FRAME F-Main
DO:
...
FOR EACH almdrepo OF almcrepo NO-LOCK,
    ...
    T-DREPO.StkDisponible = fStockDisponible().
    T-DREPO.StockTransito = fStockTransito() -  almdrepo.CanApro.
    T-DREPO.CompraTransito = fCompraTransito().
    T-DREPO.StkDisponible-Orig = fStockDisponibleOrig().
END.
