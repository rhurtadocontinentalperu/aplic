...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE um-buscar B-table-Win 
PROCEDURE um-buscar :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
DEFINE INPUT PARAMETER p-placa      AS CHARACTER NO-UNDO.
DEFINE VAR lRec AS ROWID.

GET FIRST {&BROWSE-NAME}.
DO  WHILE AVAILABLE gn-vehic:
    IF gn-vehic.placa = p-placa THEN DO:
        
        lRec = ROWID({&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}).
        REPOSITION {&BROWSE-NAME}  TO ROWID lRec.
        /*
        RUN dispatch IN THIS-PROCEDURE ( INPUT 'display-fields':U ) .
        RUN dispatch IN THIS-PROCEDURE ( INPUT 'current-changed':U ) .
        */
        ...
        /*
        lRec = ROWID(gn-vehic).
        FIND gn-vehic WHERE ROWID(gn-vehic) = lRec NO-LOCK NO-ERROR.
        REPOSITION {&BROWSE-NAME}  TO ROWID lRec.
        */
    END.
