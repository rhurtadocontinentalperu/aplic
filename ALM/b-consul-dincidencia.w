...
DEF VAR x-Incidencia AS CHAR NO-UNDO.
...
AlmDIncidencia.CanInc x-Incidencia @ x-Incidencia 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fIncidencia B-table-Win 
FUNCTION fIncidencia RETURNS CHARACTER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(100)":U WIDTH 70.29
      ...
      x-Incidencia @ x-Incidencia COLUMN-LABEL "Incidencia" FORMAT "x(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 140 BY 11.04
         FONT 4
...
"Almmmatg.DesMat" ? "X(100)" "character" ? ? ? ? ? ? no ? no no "70.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"x-Incidencia @ x-Incidencia" "Incidencia" "x(12)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fIncidencia B-table-Win 
FUNCTION fIncidencia RETURNS CHARACTER
...
------------------------------------------------------------------------------*/
  ...
  CASE AlmDIncidencia.Incidencia:
      WHEN "M" THEN RETURN "Mal Estado".
      WHEN "F" THEN RETURN "Faltante".
      WHEN "S" THEN RETURN "Sobrante".
      OTHERWISE RETURN "".
  END CASE.
