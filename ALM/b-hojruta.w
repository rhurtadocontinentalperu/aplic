...
DI-RutaD.FlgEst DI-RutaD.HorAte DI-RutaD.Glosa CcbCDocu.CodMon ~
CcbCDocu.ImpTot DI-RutaD.MonCob DI-RutaD.ImpCob CcbCDocu.FchDoc ~
CcbCDocu.NomCli 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      DI-RutaD.CodRef FORMAT "x(6)"
      DI-RutaD.NroRef FORMAT "X(15)"
      DI-RutaD.FlgEst
      DI-RutaD.HorAte COLUMN-LABEL "Hora!Llegada"
      DI-RutaD.Glosa COLUMN-LABEL "Observaciones"
      CcbCDocu.CodMon
      CcbCDocu.ImpTot
      DI-RutaD.MonCob COLUMN-LABEL "Moneda  !Cobranza"
      DI-RutaD.ImpCob COLUMN-LABEL "Importe    !Cobrado" FORMAT "->>>,>>9.99"
      CcbCDocu.FchDoc COLUMN-LABEL "        Fecha!  Documento"
      CcbCDocu.NomCli FORMAT "x(60)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 87.29 BY 6.69
         FONT 4.
...
"DI-RutaD.CodRef" ? "x(6)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.DI-RutaD.NroRef
"DI-RutaD.NroRef" ? "X(15)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   = INTEGRAL.DI-RutaD.FlgEst
     _FldNameList[4]   > INTEGRAL.DI-RutaD.HorAte
"DI-RutaD.HorAte" "Hora!Llegada" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > INTEGRAL.DI-RutaD.Glosa
"DI-RutaD.Glosa" "Observaciones" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   = INTEGRAL.CcbCDocu.CodMon
     _FldNameList[7]   = INTEGRAL.CcbCDocu.ImpTot
     _FldNameList[8]   > INTEGRAL.DI-RutaD.MonCob
"DI-RutaD.MonCob" "Moneda  !Cobranza" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[9]   > INTEGRAL.DI-RutaD.ImpCob
"DI-RutaD.ImpCob" "Importe    !Cobrado" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[10]   > INTEGRAL.CcbCDocu.FchDoc
"CcbCDocu.FchDoc" "        Fecha!  Documento" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[11]   > INTEGRAL.CcbCDocu.NomCli
"CcbCDocu.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ?
