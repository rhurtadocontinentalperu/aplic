...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "SUSTENTO DIFERENCIA CONSOLIDADA VALORIZADA"
         HEIGHT             = 10.96
         WIDTH              = 67.14
         MAX-HEIGHT         = 11.5
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* SUSTENTO DIFERENCIA CONSOLIDADA VALORIZADA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SUSTENTO DIFERENCIA CONSOLIDADA VALORIZADA */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
    ...
    "SUSTENTO DIFERENCIA CONSOLIDADA VALORIZADA POR ARTICULO" AT 20 
  ...
  FOR EACH DETALLE BREAK BY DETALLE.codcia BY DETALLE.catconta[1] BY DETALLE.desmat:
    ...
    DISPLAY STREAM REPORT 
        ...
        DETALLE.Cto83       
        DETALLE.CtoOtr      
        x-DifPos WHEN x-DifPos <> 0
        x-DifNeg WHEN x-DifNeg <> 0
        /*x-CtoTot*/
