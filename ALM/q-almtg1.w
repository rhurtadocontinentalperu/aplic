...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almmmat1 OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almmmat1 OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Almmmat1
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Almmmat1
...
DO TRANSACTION:
    IF NOT CAN-FIND(FIRST Almmmat1 OF Almmmatg NO-LOCK) THEN DO:
        CREATE Almmmat1.
        ASSIGN
...
END.
DO TRANSACTION:
    IF NOT CAN-FIND(FIRST Almmmatgext OF Almmmatg NO-LOCK) THEN DO:
        CREATE Almmmatgext.
        ASSIGN
