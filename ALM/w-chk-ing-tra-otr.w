...
DEFINE FRAME F-Main
     ...
     FILL-IN-Almacen AT ROW 2.27 COL 12 COLON-ALIGNED WIDGET-ID 28
     FILL-IN_Observ AT ROW 3.23 COL 12 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-chk-ing-tra-otr ( 6.12 , 1.00 ) NO-ERROR.
