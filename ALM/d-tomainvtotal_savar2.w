...
&Scoped-Define ENABLED-OBJECTS RECT-57 txt-date cb-almacen b-busca Btn_OK ~
btn-ok-2 x-almcissac rs-inv 
...
DEFINE VARIABLE x-almcissac AS CHARACTER FORMAT "X(256)":U INITIAL "45s" 
     VIEW-AS FILL-IN 
     SIZE 43 BY .81 NO-UNDO.
...
DEFINE FRAME F-Main
     txt-date AT ROW 1.81 COL 10 COLON-ALIGNED WIDGET-ID 26
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Registro de Inventario Santa Ines"
         HEIGHT             = 6.23
         WIDTH              = 98.72
         MAX-HEIGHT         = 6.23
         MAX-WIDTH          = 98.72
...
ON END-ERROR OF W-Win /* Registro de Inventario Santa Ines */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Registro de Inventario Santa Ines */
DO:
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH integral.almcinv WHERE integral.almcinv.CodCia = s-CodCia 
        AND integral.almcinv.CodAlm = "40x" 
...
------------------------------------------------------------------------------*/
    ...
    FIND integral.InvConfig WHERE integral.InvConfig.CodCia = s-CodCia
        AND integral.InvConfig.CodAlm = "40x"
...
------------------------------------------------------------------------------*/
  DISPLAY txt-date cb-almacen x-almcissac rs-inv x-mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-57 txt-date cb-almacen b-busca Btn_OK btn-ok-2 x-almcissac rs-inv 
      WITH FRAME F-Main IN WINDOW W-Win.
