...
almtmatg.UndAlt[1] almtmatg.Dec__03 almtmatg.RequiereSerialNr ~
almtmatg.RequiereDueDate almtmatg.CodPr1 almtmatg.almacenes ~
almtmatg.usuario 
...
almtmatg.UndAlt[1] almtmatg.UndStk almtmatg.Dec__03 ~
almtmatg.RequiereSerialNr almtmatg.RequiereDueDate almtmatg.CodPr1 ~
...
DEFINE FRAME F-Main
     ...
     almtmatg.RequiereSerialNr AT ROW 13.12 COL 16 COLON-ALIGNED WIDGET-ID 24
          LABEL "Requiere # de Serie"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "Si","No" 
          DROP-DOWN-LIST
          SIZE 6 BY 1
     almtmatg.RequiereDueDate AT ROW 13.12 COL 49 COLON-ALIGNED WIDGET-ID 26
          LABEL "Requiere Fecha de Vencimiento"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "Si","No" 
          DROP-DOWN-LIST
          SIZE 6 BY 1
     almtmatg.CodPr1 AT ROW 14.19 COL 11 COLON-ALIGNED
          LABEL "Proveedor A"
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
          BGCOLOR 15 
     FILL-IN-NomPro1 AT ROW 14.19 COL 22 COLON-ALIGNED NO-LABEL
     almtmatg.CodPr2 AT ROW 14.96 COL 11 COLON-ALIGNED
          LABEL "Proveedor B"
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
          BGCOLOR 15 
     FILL-IN-NomPro2 AT ROW 14.96 COL 22 COLON-ALIGNED NO-LABEL
     almtmatg.almacenes AT ROW 15.81 COL 13 NO-LABEL
          VIEW-AS EDITOR
          SIZE 64.57 BY 2.12
          BGCOLOR 15 
...
DEFINE FRAME F-Main
     ...
     "Almacenes:" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 16.08 COL 5
...
/* SETTINGS FOR FILL-IN almtmatg.PorIsc IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX almtmatg.RequiereDueDate IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX almtmatg.RequiereSerialNr IN FRAME F-Main
   EXP-LABEL                                                            */
