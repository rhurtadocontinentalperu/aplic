...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-Mensaje AT ROW 5.31 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     Btn_OK AT ROW 7.46 COL 3
     Btn_Cancel AT ROW 7.46 COL 19
     "Artículos Registrados:" VIEW-AS TEXT
...
DO:
  ...
  FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.CodCia = s-CodCia
      ...
      RUN ALM_Materiales-por-Almacen (INPUT Almmmatg.CodMat,
                                      OUTPUT pMensaje).
