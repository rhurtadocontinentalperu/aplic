...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almtmovm WHERE Almtmovm.CodCia = Almacen.CodCia ~
      AND Almtmovm.Tipmov = "S" NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almtmovm WHERE Almtmovm.CodCia = Almacen.CodCia ~
      AND Almtmovm.Tipmov = "S" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Almtmovm
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Almtmovm
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Almtmovm WHERE INTEGRAL.Almacen <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "Almtmovm.CodCia = Almacen.CodCia"
     _Where[1]         = "Almtmovm.Tipmov = ""S"""
