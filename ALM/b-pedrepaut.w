...
(Almmmate.StkAct - T-DREPO.CanApro) @ x-StkDisponible Almmmate.StkMin ~
T-DREPO.CanTran ~
(IF T-DREPO.CanReq <> 0 THEN (T-DREPO.CanGen / T-DREPO.CanReq * 100) ELSE 0) @ x-PorcReposicion ~
T-DREPO.StkAct Almmmate.StkMax Almmmatg.CanEmp ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(60)":U WIDTH 38.57
      ...
      (Almmmate.StkAct - T-DREPO.CanApro) @ x-StkDisponible COLUMN-LABEL "Disponible!Destino" FORMAT "(ZZZ,ZZ9.99)":U
            WIDTH 7.43
      Almmmate.StkMin COLUMN-LABEL "Stock Máximo!+ Seguridad" FORMAT "ZZZ,ZZ9.99":U
      T-DREPO.CanTran COLUMN-LABEL "Stock en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 7.86
      (IF T-DREPO.CanReq <> 0 THEN (T-DREPO.CanGen / T-DREPO.CanReq * 100) ELSE 0) @ x-PorcReposicion COLUMN-LABEL "% de!Reposición"
      T-DREPO.StkAct COLUMN-LABEL "Disponible!Despacho" FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
            WIDTH 9.57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
...
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "38.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(Almmmate.StkAct - T-DREPO.CanApro) @ x-StkDisponible" "Disponible!Destino" "(ZZZ,ZZ9.99)" ? ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.StkMin" "Stock Máximo!+ Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-DREPO.CanTran
"T-DREPO.CanTran" "Stock en!Tránsito" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(IF T-DREPO.CanReq <> 0 THEN (T-DREPO.CanGen / T-DREPO.CanReq * 100) ELSE 0) @ x-PorcReposicion" "% de!Reposición" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-DREPO.StkAct
"T-DREPO.StkAct" "Disponible!Despacho" ? "decimal" 14 0 ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.Almmmate.StkMax
"Almmmate.StkMax" "Empaque!Reposición" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > INTEGRAL.Almmmatg.CanEmp
...
"T-DREPO.CanGen * (IF Almmmatg.MonVta = 2 THEN Almmmatg.CtoTot * Almmmatg.TpoCmb ELSE Almmmatg.CToTot) @ Almmmatg.CtoTot" "Costo de!Reposición" ? ? ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   = Temp-Tables.T-DREPO.Origen
...
"(T-DREPO.CanGen * Almmmatg.Libre_d02 / 1000000) @ x-Volumen" "Volumen en m3" ">>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > INTEGRAL.Almmmate.StkAct
...
CASE TRUE:
    WHEN RETURN-VALUE = 'YES' OR T-DREPO.Origen:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = "MAN" 
        ...
        IF NOT AVAILABLE Almacen OR Almacen.Campo-C[6] = "No" THEN DO:
            MESSAGE 'Almacén NO válido (Esta definido como NO COMERCIAL)' VIEW-AS ALERT-BOX ERROR.
            APPLY 'entry':U TO T-DREPO.AlmPed IN BROWSE {&browse-name}.
            RETURN 'ADM-ERROR'.
        END.
        FIND Almmmate WHERE Almmmate.codcia = s-codcia
