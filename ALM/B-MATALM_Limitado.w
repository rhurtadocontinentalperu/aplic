...
Almmmate.desmat Almmmate.CodUbi Almmmate.StkRep 
...
&Scoped-Define ENABLED-OBJECTS RECT-18 F-CodMat F-Filtro R-Tipo br_table 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmate.StkAct COLUMN-LABEL "Stock!Actual" FORMAT "(>>>>>>>>9.9999)":U
            COLUMN-FONT 4
      Almmmate.CodUbi COLUMN-LABEL "Zonas o!Ubicación" FORMAT "x(5)":U
...
"Almmmate.codmat" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.Almmmate.desmat
"Almmmate.desmat" "Descripcion" "x(60)" "character" ? ? ? ? ? ? yes ? no no "41.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.CodUbi" "Zonas o!Ubicación" "x(5)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.StkRep" "Stock de!Reposición" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codmat:READ-ONLY 
