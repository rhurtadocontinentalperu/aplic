...
T-GENER.Codigo Almmmate.CodAlm T-GENER.Libre_c02 Almmmate.StockMax ~
Almmmate.StockSeg Almmmate.StkMin Almmmate.VCtMn1 Almmmate.VCtMn2 ~
Almmmate.StkMax T-GENER.Libre_d01 T-GENER.Libre_d02 T-GENER.Libre_d04 ~
T-GENER.Libre_d03 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmate.CodAlm FORMAT "x(5)":U WIDTH 6
      T-GENER.Libre_c02 COLUMN-LABEL "Descripción" FORMAT "x(40)":U
            WIDTH 35.86
      Almmmate.StockMax COLUMN-LABEL "Máximo" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 6.43
      Almmmate.StockSeg COLUMN-LABEL "Seguridad" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 7.43
      ...
      T-GENER.Libre_d02 COLUMN-LABEL "Stock en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 7
      T-GENER.Libre_d04 COLUMN-LABEL "Tránsito!Compras" FORMAT "ZZ,ZZZ,ZZ9.99":U
            WIDTH 10.86
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141 BY 7.81
...
"T-GENER.Libre_c02" "Descripción" "x(40)" "character" ? ? ? ? ? ? no ? no no "35.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.Almmmate.StockMax
"Almmmate.StockMax" "Máximo" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.Almmmate.StockSeg
"Almmmate.StockSeg" "Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.VCtMn1" "Campaña." "ZZZ,ZZ9.99" "decimal" 11 0 ? ? ? ? yes ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.Almmmate.VCtMn2
"Almmmate.VCtMn2" "No Campaña" "ZZZ,ZZ9.99" "decimal" 11 0 ? ? ? ? yes ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.Almmmate.StkMax
"Almmmate.StkMax" "Empaque" ? "decimal" 11 0 ? ? ? ? yes ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-GENER.Libre_d02" "Stock en!Tránsito" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-GENER.Libre_d04
"T-GENER.Libre_d04" "Tránsito!Compras" "ZZ,ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "10.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-GENER.Libre_d03
"T-GENER.Libre_d03" "Faltante!Sobrante" "-ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  RUN ALM/D-DETMOVv2 (almmmate.codalm, t-gener.libre_c03, "").
END.
...
RUN gn/stock-comprometido-v2 (Almmmate.CodMat, Almmmate.CodAlm, NO, OUTPUT x-StockComprometido).
