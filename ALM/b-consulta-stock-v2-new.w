...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-3 FILL-IN-DesMat BUTTON-3 ~
COMBO-BOX-CodFam BUTTON-4 FILL-IN-CodPro FILL-IN-codigo br_table 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-DesMat COMBO-BOX-CodFam ~
FILL-IN-CodPro FILL-IN-NomPro FILL-IN-codigo 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123 BY 18.58
...
DEFINE FRAME F-Main
     FILL-IN-DesMat AT ROW 1.54 COL 13 COLON-ALIGNED WIDGET-ID 10
     BUTTON-3 AT ROW 1.54 COL 101 WIDGET-ID 14
     COMBO-BOX-CodFam AT ROW 2.35 COL 13 COLON-ALIGNED WIDGET-ID 12
     BUTTON-4 AT ROW 2.62 COL 101 WIDGET-ID 28
     FILL-IN-CodPro AT ROW 3.15 COL 13 COLON-ALIGNED WIDGET-ID 22
     FILL-IN-NomPro AT ROW 3.15 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     FILL-IN-codigo AT ROW 4.77 COL 13 COLON-ALIGNED WIDGET-ID 2
     br_table AT ROW 5.85 COL 1
     "Buscar" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 4.23 COL 2 WIDGET-ID 34
          BGCOLOR 4 FGCOLOR 15 
     "F3: Multiubicación" VIEW-AS TEXT
          SIZE 20 BY .5 AT ROW 24.42 COL 68 WIDGET-ID 30
          FONT 0
     "Filtros" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 1 COL 2 WIDGET-ID 18
          BGCOLOR 1 FGCOLOR 15 
     "F8 : Stocks x Almacenes F7 : Pedidos F9 : Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 63 BY .5 AT ROW 24.42 COL 4 WIDGET-ID 6
          FONT 0
     RECT-2 AT ROW 1.27 COL 1 WIDGET-ID 16
     RECT-3 AT ROW 4.5 COL 1 WIDGET-ID 32
...
DO:
    ASSIGN
        COMBO-BOX-CodFam FILL-IN-codigo FILL-IN-CodPro FILL-IN-DesMat FILL-IN-NomPro.
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      LocalCadena = "".
      DISPLAY FILL-IN-CodPro FILL-IN-DesMat FILL-IN-NomPro.
