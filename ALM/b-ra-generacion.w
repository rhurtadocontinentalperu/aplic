...
------------------------------------------------------------------------------*/
  ...
  /* ************************************************************************************** */
  /* 21/11/2025: Control de stock */
  /* ************************************************************************************** */
  DEF VAR iValidar AS INTE NO-UNDO.       /* 0: no valida     1: sí valida */
  RUN lib/p-validar-stock-negativo (INPUT T-DREPO.AlmPed,
                                   INPUT s-user-id,
                                   OUTPUT iValidar).
  IF iValidar = 0 THEN T-DREPO.DesStkDis = 999999999.99.     /* Artificio */
  /* ************************************************************************************** */
  /* ************************************************************************************** */
...
/* ************************************************************************************** */
DEF VAR iValidar AS INTE NO-UNDO.       /* 0: no valida     1: sí valida */
RUN lib/p-validar-stock-negativo (INPUT B-MATE.codalm,
                                 INPUT s-user-id,
                                 OUTPUT iValidar).
/*MESSAGE B-MATE.codalm s-user-id iValidar.*/
IF iValidar = 1 THEN DO:
    /* Control de stock */
    ASSIGN
        x-StkAct = B-MATE.StkAct.
    /* DESCONTAMOS LO COMPROMETIDO */
