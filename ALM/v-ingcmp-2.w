...
Almcmov.Observ Almcmov.TpoCmb Almcmov.NroRf3 
...
DEFINE FRAME F-Main
     ...
     Almcmov.NroRf1 AT ROW 1.96 COL 13 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     Almcmov.NroRf2 AT ROW 1.96 COL 39 COLON-ALIGNED WIDGET-ID 4
          LABEL "Referencia 2"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
"US$", 2
     ...
     Almcmov.TpoCmb AT ROW 3.5 COL 74 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     Almcmov.NroRf3 AT ROW 4.23 COL 74 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     "Moneda :" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  RUN ALM\R-IMPFMT-1.R(ROWID(almcmov), NO).
