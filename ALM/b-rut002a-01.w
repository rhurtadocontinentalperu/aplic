...
ENTRY(LOOKUP(DI-RutaD.Libre_c02, ',R,A'), ',REPROGRAMADO,NO REPROGRAMADO') @ DI-RutaD.Libre_c02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ENTRY(LOOKUP(DI-RutaD.Libre_c02, ',R,A'), ',REPROGRAMADO,NO REPROGRAMADO') @ DI-RutaD.Libre_c02 COLUMN-LABEL "Tipo" FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"ENTRY(LOOKUP(DI-RutaD.Libre_c02, ',R,A'), ',REPROGRAMADO,NO REPROGRAMADO') @ DI-RutaD.Libre_c02" "Tipo" "x(15)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*   IF NOT AVAILABLE Di-RutaD THEN RETURN.         */
/*   Di-RutaD.Libre_c02 = ''.                       */
  RUN alm/d-rut002 (ROWID(di-rutad)).
  RUN dispatch IN THIS-PROCEDURE ('row-changed':U).
END.
