...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88 BY 6.69
         FONT 4
         TITLE "COTIZACIONES NO CUBIERTAS AL 100%".
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* COTIZACIONES NO CUBIERTAS AL 100% */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* COTIZACIONES NO CUBIERTAS AL 100% */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* COTIZACIONES NO CUBIERTAS AL 100% */
DO:
