...
&SCOPED-DEFINE l-lookup h_l-almtdocm-01
...
DEFINE VARIABLE h_l-almtdocm-01 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.35 COL 59
     Btn_Cancel AT ROW 6.5 COL 59
     Btn_Help AT ROW 9.58 COL 59
     SPACE(2.13) SKIP(0.79)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/l-almtdocm-01.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_l-almtdocm-01 ).
       RUN set-position IN h_l-almtdocm-01 ( 1.12 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-almtdocm-01 ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-almtdocm-01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-almtdocm-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-almtdocm-01 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-almtdocm-01 , 'AFTER':U ).
    END. /* Page 0 */
