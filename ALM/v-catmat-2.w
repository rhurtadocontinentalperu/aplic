...
&Scoped-Define ENABLED-FIELDS Almmmatg.codmat Almmmatg.DesMat ~
Almmmatg.TpoArt Almmmatg.Licencia[1] Almmmatg.CodMar Almmmatg.Chr__02 ~
Almmmatg.codfam Almmmatg.TpoPro Almmmatg.subfam Almmmatg.AftIgv ~
Almmmatg.Detalle Almmmatg.PorIsc Almmmatg.AftIsc Almmmatg.CodBrr ~
Almmmatg.UndBas Almmmatg.UndCmp Almmmatg.UndA Almmmatg.UndB Almmmatg.UndC ~
Almmmatg.CanEmp Almmmatg.Pesmat Almmmatg.UndStk Almmmatg.Chr__01 ~
Almmmatg.CodPr1 Almmmatg.almacenes Almmmatg.usuario Almmmatg.FchAct 
&Scoped-define ENABLED-TABLES Almmmatg
&Scoped-define FIRST-ENABLED-TABLE Almmmatg
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-4 RECT-5 RECT-7 RECT-12 
...
Almmmatg.subfam Almmmatg.AftIgv Almmmatg.Detalle Almmmatg.PorIsc ~
Almmmatg.AftIsc Almmmatg.CodBrr Almmmatg.UndBas Almmmatg.UndCmp ~
Almmmatg.UndA Almmmatg.UndB Almmmatg.UndC Almmmatg.CanEmp Almmmatg.Pesmat ~
Almmmatg.UndStk Almmmatg.Chr__01 Almmmatg.CodPr1 Almmmatg.CodPr2 ~
...
"Tercero", "T":U
     ...
     Almmmatg.Detalle AT ROW 4.81 COL 10.57 NO-LABEL
          ...
          SIZE 34.72 BY 1.92
     Almmmatg.PorIsc AT ROW 4.92 COL 64.14 COLON-ALIGNED
          LABEL "%"
          VIEW-AS FILL-IN 
          SIZE 5.29 BY .69
     ...
     Almmmatg.UndCmp AT ROW 8.62 COL 11 COLON-ALIGNED
          ...
          SIZE 7 BY .65
          BGCOLOR 15 
     Almmmatg.UndA AT ROW 8.62 COL 33.14 COLON-ALIGNED
          LABEL "A" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .65
          BGCOLOR 15 
     Almmmatg.UndB AT ROW 8.62 COL 42.57 COLON-ALIGNED
          LABEL "B" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .65
          BGCOLOR 15 
...
DEFINE FRAME F-Main
     Almmmatg.UndC AT ROW 8.62 COL 51.57 COLON-ALIGNED
          LABEL "C" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .65
          BGCOLOR 15 
     Almmmatg.CanEmp AT ROW 8.62 COL 67 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .65
          BGCOLOR 15 
     Almmmatg.Pesmat AT ROW 9.27 COL 67 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .65
     Almmmatg.UndStk AT ROW 9.31 COL 11 COLON-ALIGNED
          ...
          SIZE 7 BY .65
          BGCOLOR 15 
     Almmmatg.Chr__01 AT ROW 9.35 COL 33.14 COLON-ALIGNED
          LABEL "" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .65
          BGCOLOR 15 
     ...
     "Oficina" VIEW-AS TEXT
          SIZE 10.57 BY .69 AT ROW 9.27 COL 22.57
          FONT 1
     ...
     "Unidades Venta" VIEW-AS TEXT
          SIZE 16.14 BY .69 AT ROW 7.42 COL 22.72
          FONT 1
     "Mostrador" VIEW-AS TEXT
          SIZE 10.57 BY .69 AT ROW 8.38 COL 22.43
          FONT 1
     RECT-6 AT ROW 7.08 COL 21.43
     RECT-4 AT ROW 10.38 COL 1.14
