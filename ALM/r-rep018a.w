...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 82.86 BY 7.5 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "STOCK PROYECTADO RESUMIDO"
         HEIGHT             = 7.5
         WIDTH              = 82.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 82.86
...
ASSIGN 
       FILL-IN-DiasMaximo:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-DiasMinimo IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN-DiasMinimo:HIDDEN IN FRAME F-Main           = TRUE.
...
ON END-ERROR OF W-Win /* STOCK PROYECTADO RESUMIDO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* STOCK PROYECTADO RESUMIDO */
DO:
...
FOR EACH T-MATG:
    ...
    ASSIGN
        ...
        T-MATG.Minimo = T-MATG.Dias * pDiasMinimo
        T-MATG.Maximo = T-MATG.Dias * pDiasMaximo.
    /* Cantidad */
...
------------------------------------------------------------------------------*/
  DISPLAY txt-codalm x-CodFam x-desFam x-CodPro x-NomPro x-mensaje 
...
FOR EACH T-MATG:
    ...
    x-Llave = x-Llave + STRING(T-MATG.cantidad * T-MATG.ctotot) + CHR(9).
