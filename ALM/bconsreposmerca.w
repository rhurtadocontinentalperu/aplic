...
DEFINE TEMP-TABLE T-Detalle NO-UNDO
...
DEFINE TEMP-TABLE T-Detalle-Item NO-UNDO LIKE T-Detalle 
...
REPOSICIONES.TotCosAte @ x-TotCosAte 
...
FILL-IN-TotPesAte FILL-IN-TotCosSol FILL-IN-TotCosAte FILL-IN-TotBultos ~
FILL-IN-TotItm 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-TotVolSol AT ROW 16.88 COL 60 COLON-ALIGNED NO-LABEL WIDGET-ID 190
     FILL-IN-TotVolAte AT ROW 16.88 COL 78 COLON-ALIGNED NO-LABEL WIDGET-ID 192
     ...
     FILL-IN-TotPesAte AT ROW 16.92 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 108
     FILL-IN-TotCosSol AT ROW 16.92 COL 93 COLON-ALIGNED NO-LABEL WIDGET-ID 112
     FILL-IN-TotCosAte AT ROW 16.92 COL 106 COLON-ALIGNED NO-LABEL WIDGET-ID 110
     FILL-IN-TotBultos AT ROW 16.92 COL 119 COLON-ALIGNED NO-LABEL WIDGET-ID 152
     FILL-IN-TotItm AT ROW 16.92 COL 129.57 COLON-ALIGNED NO-LABEL WIDGET-ID 172
     "Peso Aprobado kg" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 16.35 COL 32 WIDGET-ID 120
     ...
     "Soles Aprobado" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 16.35 COL 95 WIDGET-ID 124
          BGCOLOR 9 FGCOLOR 15 
     "Soles Atendido" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 16.35 COL 109 WIDGET-ID 126
          BGCOLOR 9 FGCOLOR 15 
     "Pedidos atrazados" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 16.35 COL 2 WIDGET-ID 144
          BGCOLOR 9 FGCOLOR 15 
     "Peso Atendido kg" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 16.35 COL 47 WIDGET-ID 122
          BGCOLOR 9 FGCOLOR 15 
...
DEFINE FRAME F-Main
     "Items" VIEW-AS TEXT
          SIZE 4 BY .5 AT ROW 16.35 COL 139 WIDGET-ID 174
          BGCOLOR 9 FGCOLOR 15 
     "Volumen Aprobado m3" VIEW-AS TEXT
          SIZE 16 BY .5 AT ROW 16.35 COL 61 WIDGET-ID 194
          BGCOLOR 9 FGCOLOR 15 
     "Volumen Atendido m3" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 16.35 COL 78 WIDGET-ID 196
          BGCOLOR 9 FGCOLOR 15 
     "Bultos" VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 16.35 COL 125.43 WIDGET-ID 154
          BGCOLOR 9 FGCOLOR 15 
...
FOR EACH REPOSICIONES:
    ...
    /* 24/02/2025 Lucy Mesia: volver a activar las columnas de valores */
    ASSIGN
...
DO k = 1 TO 2:
    ...
    FOR EACH almacen NO-LOCK WHERE almacen.codcia = s-codcia
        ...
        FOR EACH almcrepo NO-LOCK WHERE almcrepo.codcia = s-codcia
            ...
            AND almcrepo.FchDoc >= FILL-IN-FchDoc-1:
            IF almcrepo.FchDoc > FILL-IN-FchDoc-2 THEN NEXT.
            IF FILL-IN-AlmPed > '' AND LOOKUP(almcrepo.almped, FILL-IN-AlmPed) = 0 THEN NEXT.
            /* ********************************************************************** */
            /* Filtros */
            /* ********************************************************************** */
...
FOR EACH almacen NO-LOCK WHERE almacen.codcia = s-codcia
    ...
    FOR EACH Faccpedi NO-LOCK WHERE Faccpedi.codcia = s-codcia
        ...
        AND Faccpedi.FchPed >= FILL-IN-FchDoc-1:
        IF Faccpedi.FchPed > FILL-IN-FchDoc-2 THEN NEXT.
        IF Faccpedi.flgest = "A" THEN NEXT.
        IF lnroOtr > '' AND Faccpedi.nroped <> lNroOtr THEN NEXT.
        IF FILL-IN-AlmPed > '' AND LOOKUP(Faccpedi.codalm, FILL-IN-AlmPed) = 0 THEN NEXT.
        /* ********************************************************************** */
        /* Filtros */
        /* ********************************************************************** */
