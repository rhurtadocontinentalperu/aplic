...
&Scoped-Define ENABLED-FIELDS almcrepo.VtaPuntual almcrepo.Fecha ~
almcrepo.MotReposicion almcrepo.Glosa 
&Scoped-define ENABLED-TABLES almcrepo
&Scoped-define FIRST-ENABLED-TABLE almcrepo
&Scoped-Define ENABLED-OBJECTS RECT-2 
&Scoped-Define DISPLAYED-FIELDS almcrepo.VtaPuntual almcrepo.Fecha ~
almcrepo.MotReposicion almcrepo.Glosa 
...
DEFINE FRAME F-Main
     almcrepo.VtaPuntual AT ROW 1.27 COL 14 WIDGET-ID 10
          LABEL "Urgente"
          VIEW-AS TOGGLE-BOX
          SIZE 11.29 BY .77
          BGCOLOR 15 FGCOLOR 0 
     almcrepo.Fecha AT ROW 2.08 COL 12 COLON-ALIGNED WIDGET-ID 8
          LABEL "Fecha Entrega" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 0 
     almcrepo.MotReposicion AT ROW 2.88 COL 12 COLON-ALIGNED WIDGET-ID 12
          LABEL "Mot. Reposición"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
          SIZE 40 BY 1
          BGCOLOR 15 FGCOLOR 0 
     almcrepo.Glosa AT ROW 3.69 COL 12 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 40 BY .81
          BGCOLOR 15 FGCOLOR 0 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      almcrepo.MotReposicion:DELETE(1).
