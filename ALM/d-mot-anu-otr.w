...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Motivo FILL-IN-Glosa Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Motivo FILL-IN-Glosa 
...
DEFINE FRAME D-Dialog
     COMBO-BOX-Motivo AT ROW 2.08 COL 9 COLON-ALIGNED WIDGET-ID 2
     FILL-IN-Glosa AT ROW 3.15 COL 9 COLON-ALIGNED WIDGET-ID 4
     Btn_OK AT ROW 6.38 COL 3
     Btn_Cancel AT ROW 6.38 COL 19
     SPACE(31.13) SKIP(0.53)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "MOTIVO DE ANULACION DE LA OTR"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* MOTIVO DE ANULACION DE LA OTR */
DO:  
...
DO:
  ASSIGN COMBO-BOX-Motivo FILL-IN-Glosa.
  IF COMBO-BOX-Motivo = 'Seleccione un motivo' THEN DO:
      MESSAGE 'Debe seleccionar un motivo' VIEW-AS ALERT-BOX ERROR.
      APPLY 'ENTRY':U TO COMBO-BOX-Motivo.
      RETURN NO-APPLY.
  END.
  ASSIGN
      pMotivo = COMBO-BOX-Motivo
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-Motivo FILL-IN-Glosa 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX-Motivo FILL-IN-Glosa Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
