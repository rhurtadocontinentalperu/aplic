...
DEFINE VAR S-TIPMOV AS CHAR INIT 'S'.
DEFINE VAR S-CODMOV AS INT  INIT 10.
...
&Scoped-Define ENABLED-OBJECTS FILL-IN-Fecha-1 FILL-IN-Fecha-2 Btn_Ok ~
Btn_Done 
...
DEFINE FRAME F-Main
     FILL-IN-Fecha-1 AT ROW 1.77 COL 16 COLON-ALIGNED
     FILL-IN-Fecha-2 AT ROW 2.73 COL 16 COLON-ALIGNED
     Btn_Ok AT ROW 5.23 COL 6
     Btn_Done AT ROW 5.23 COL 23
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REPORTE DE MUESTRAS PENDIENTES DE DEVOLUCION"
         HEIGHT             = 6.62
         WIDTH              = 71.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* REPORTE DE MUESTRAS PENDIENTES DE DEVOLUCION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REPORTE DE MUESTRAS PENDIENTES DE DEVOLUCION */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-Fecha-1 FILL-IN-Fecha-2 Btn_Ok Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME FC-REP
    ...
    x-NomCli        COLUMN-LABEL "Nombre / Razon Social" FORMAT 'x(35)'
    Almdmov.codmat  COLUMN-LABEL "Material"
    Almmmatg.desmat COLUMN-LABEL "Descripcion" FORMAT 'x(35)'
    x-Saldo         COLUMN-LABEL "Pendiente" FORMAT '>>>,>>9.99'
    Almdmov.codund  COLUMN-LABEL "Und" FORMAT 'x(5)' SKIP
    Almcmov.Observ  COLUMN-LABEL "Observaciones"    AT 30
  ...
  DEFINE FRAME H-REP
    ...
    "REPORTE DE MUESTRAS RETORNABLES PENDIENTES DE DEVOLUCION" AT 20
    ...
    "Fecha : " AT 100 STRING(TODAY,"99/99/9999") FORMAT "X(12)" SKIP(1)
  ...
  FOR EACH Almcmov NO-LOCK WHERE Almcmov.CodCia = S-CODCIA 
        ...
        /*AND Almcmov.flgsit <> "R"*/,
        EACH Almdmov OF Almcmov WHERE Almdmov.candes > Almdmov.candev NO-LOCK,
    ...
    x-Saldo = Almdmov.candes - Almdmov.candev.
    DISPLAY STREAM REPORT
        Almcmov.Nroser WHEN x-Quiebre
        Almcmov.Nrodoc WHEN x-Quiebre
        Almcmov.FchDoc WHEN x-Quiebre
        Almcmov.CodCli WHEN x-Quiebre
        x-NomCli       WHEN x-Quiebre 
        Almdmov.codmat  
        Almmmatg.desmat 
        x-Saldo         
        Almdmov.codund
        Almcmov.Observ WHEN x-Quiebre
        WITH FRAME FC-REP.      
  END.  
