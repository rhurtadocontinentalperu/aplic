...
&Scoped-Define ENABLED-OBJECTS desdeF hastaF R-Estado Btn_OK Btn_Excel ~
Btn_Cancel RECT-63 RECT-60 RECT-62 
...
DEFINE FRAME F-Main
     F-Almacen AT ROW 2.08 COL 6.57
     ...
     R-Estado AT ROW 1.54 COL 57 NO-LABEL
     Btn_OK AT ROW 5.58 COL 20
     Btn_Excel AT ROW 5.58 COL 31 WIDGET-ID 2
     Btn_Cancel AT ROW 5.58 COL 42
     RECT-63 AT ROW 1.27 COL 56
     RECT-60 AT ROW 5.31 COL 2
     RECT-62 AT ROW 1.27 COL 2
...
------------------------------------------------------------------------------*/
  DISPLAY F-Almacen desdeF hastaF C-Tipmov I-CodMov N-MOVI R-Estado 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE desdeF hastaF R-Estado Btn_OK Btn_Excel Btn_Cancel RECT-63 RECT-60 
         RECT-62 
      WITH FRAME F-Main IN WINDOW W-Win.
...
chWorkSheet:Range("F2"):VALUE = "Descripción".
chWorkSheet:Range("G2"):VALUE = "Observaciones".
...
FOR EACH B-Almacen WHERE B-Almacen.codcia = s-codcia AND
         B-Almacen.codalm BEGINS f-Almacen NO-LOCK,
         EACH Almcmov NO-LOCK WHERE Almcmov.CodCia = S-CODCIA AND  
              ...
              Almcmov.flgsit = "T",
              FIRST Almacen WHERE Almacen.codcia = Almcmov.codcia AND 
                    Almacen.codalm = Almcmov.almdes NO-LOCK
