...
"Temp-Tables.REPOSICIONES.AlmacenXD" "Almacen!XD" "x(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.REPOSICIONES.CodAlm
"Temp-Tables.REPOSICIONES.CodAlm" "Almacén!Destino" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.REPOSICIONES.FchDoc
"Temp-Tables.REPOSICIONES.FchDoc" "Emisión" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.REPOSICIONES.usuario
"Temp-Tables.REPOSICIONES.usuario" "Usuario" "x(15)" "character" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.REPOSICIONES.NroSer
"Temp-Tables.REPOSICIONES.NroSer" "Serie" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.REPOSICIONES.NroDoc
"Temp-Tables.REPOSICIONES.NroDoc" "Número" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Temp-Tables.REPOSICIONES.Libre_c05" "Estado de la R/A" "x(20)" "character" ? ? ? ? ? ? no ? no no "15.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.REPOSICIONES.Libre_f02
"Temp-Tables.REPOSICIONES.Libre_f02" "Fecha Estado" "99/99/9999" "date" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.REPOSICIONES.FlgCbd
"Temp-Tables.REPOSICIONES.FlgCbd" "Bultos" "x(7)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.REPOSICIONES.TotItm
"Temp-Tables.REPOSICIONES.TotItm" "Total!Items" ? "integer" ? ? ? ? ? ? no ? no no "4.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.REPOSICIONES.Libre_d01
"Temp-Tables.REPOSICIONES.Libre_d01" "Total Peso!Generado Kg" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Temp-Tables.REPOSICIONES.Libre_d02" "Total Peso!Atendido Kg" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"INTEGRAL.almcrepo.Glosa" ? ? "character" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
