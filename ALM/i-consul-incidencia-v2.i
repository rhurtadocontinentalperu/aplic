...
DEF TEMP-TABLE Cabecera
    ...
    FIELD FchReg        AS CHAR FORMAT 'x(10)'  LABEL 'Fecha de Regularizacion de Inc'
    FIELD AlmOri        AS CHAR FORMAT 'x(8)'   LABEL 'Alm. Origen'
    FIELD DesOri        AS CHAR FORMAT 'x(40)'  LABEL 'Nombre División Origen'
    FIELD AlmDes        AS CHAR FORMAT 'x(8)'   LABEL 'Alm. Destino'
    FIELD DesDes        AS CHAR FORMAT 'x(40)'  LABEL 'Nombre División Destino'
    FIELD Usuario       AS CHAR FORMAT 'x(12)'  LABEL 'Usuario Emisor Inc.'
...
DEF TEMP-TABLE Detalle LIKE Cabecera
    ...
    FIELD Familia       AS CHAR FORMAT 'x(100)' LABEL 'Familia'
    FIELD SUbFamilia    AS CHAR FORMAT 'x(100)' LABEL 'SubFamilia'
    FIELD CC            AS CHAR FORMAT 'x(8)'   LABEL 'Cat.Contab.'
    FIELD Campagna      AS CHAR FORMAT 'x(10)'  LABEL 'CAMPAÑA'
    FIELD NoCampagna    AS CHAR FORMAT 'x(10)'  LABEL 'NO CAMPAÑA'
