...
&Scoped-define FIELDS-IN-QUERY-br_table ITEM.codmat Almmmatg.DesMat ITEM.CodUnd Almmmate.StkAct ITEM.PreUni   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table ITEM.PreUni   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.PreUni COLUMN-LABEL "Importe S/."
  ENABLE
      ITEM.PreUni
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 75.14 BY 8.08
         FONT 4.
...
IF DECIMAL(ITEM.PreUni:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
   MESSAGE "Importe debe ser diferente a cero" VIEW-AS ALERT-BOX ERROR.
   RETURN "ADM-ERROR".   
END.
