...
AlmCDocu.CodLlave AlmCDocu.Libre_c02 AlmCDocu.Libre_c01 
&Scoped-define ENABLED-TABLES AlmCDocu
&Scoped-define FIRST-ENABLED-TABLE AlmCDocu
&Scoped-Define DISPLAYED-FIELDS AlmCDocu.NroDoc AlmCDocu.FchDoc ~
AlmCDocu.UsrCreacion AlmCDocu.CodLlave AlmCDocu.Libre_c02 ~
AlmCDocu.Libre_c01 
&Scoped-define DISPLAYED-TABLES AlmCDocu
&Scoped-define FIRST-DISPLAYED-TABLE AlmCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-NomUsr FILL-IN-NomAux ~
FILL-IN-NomAlm 
...
DEFINE FRAME F-Main
     AlmCDocu.NroDoc AT ROW 1.19 COL 13 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     F-Estado AT ROW 1.19 COL 33 COLON-ALIGNED WIDGET-ID 114
     AlmCDocu.FchDoc AT ROW 1.19 COL 66 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     AlmCDocu.UsrCreacion AT ROW 1.96 COL 13 COLON-ALIGNED WIDGET-ID 10
          LABEL "Solicitado por" FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     FILL-IN-NomUsr AT ROW 1.96 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 116
     AlmCDocu.CodLlave AT ROW 2.73 COL 13 COLON-ALIGNED WIDGET-ID 2
          LABEL "Centro de Costo" FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     FILL-IN-NomAux AT ROW 2.73 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 118
     AlmCDocu.Libre_c02 AT ROW 3.5 COL 13 COLON-ALIGNED WIDGET-ID 120
          LABEL "Almacén" FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     FILL-IN-NomAlm AT ROW 3.5 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 122
     AlmCDocu.Libre_c01 AT ROW 4.27 COL 13 COLON-ALIGNED WIDGET-ID 6
...
/* SETTINGS FOR FILL-IN AlmCDocu.CodLlave IN FRAME F-Main
...
/* SETTINGS FOR FILL-IN AlmCDocu.Libre_c02 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN AlmCDocu.NroDoc IN FRAME F-Main
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME AlmCDocu.CodLlave
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL AlmCDocu.CodLlave V-table-Win
ON LEAVE OF AlmCDocu.CodLlave IN FRAME F-Main /* Centro de Costo */
DO:
...
/*   END.                                                                                      */
  ...
  DO WITH FRAME {&FRAME-NAME}:
      DISPLAY 
          /*STRING(FacCorre.NroSer, '999') + STRING(FacCorre.Correlativo, '999999') @ AlmCDocu.NroDoc*/
          "" @ F-Estado
          TODAY @ AlmCDocu.FchDoc
          s-user-id @ INTEGRAL.AlmCDocu.UsrCreacion
          /*VtaTabla.llave_c2 @ AlmCDocu.CodLlave*/
          s-Cco @ AlmCDocu.CodLlave
          VtaTabla.llave_c4 @ AlmCDocu.Libre_c02.
      RUN Borra-Temporal.
      RUN Procesa-Handle IN lh_Handle ('Pagina2').
      APPLY 'LEAVE':U TO AlmCDocu.CodLlave.
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      FIND LAST B-CDOCU USE-INDEX llave01 WHERE B-CDOCU.codcia = s-codcia
          AND B-CDOCU.CodLlave = s-cco
          AND B-CDOCU.coddoc = s-coddoc
          AND B-CDOCU.nrodoc BEGINS s-cco + STRING(YEAR(TODAY), '9999')
          NO-LOCK NO-ERROR.
      IF NOT AVAILABLE B-CDOCU THEN I-NroDoc = 1.
      ELSE I-NroDoc = INTEGER(SUBSTRING(B-CDOCU.nrodoc, LENGTH(s-cco) + 4 + 1)).
      REPEAT:
          C-NroDoc = s-Cco + STRING(YEAR(TODAY), '9999') + STRING(I-NroDoc, '9999').
          IF NOT CAN-FIND(FIRST Almcdocu WHERE Almcdocu.codcia = s-codcia
                          AND AlmCDocu.CodLlave = s-cco
      ...
      ASSIGN 
          ...
          /*AlmCDocu.CodDiv = S-CODDIV*/
          AlmCDocu.CodDoc = s-coddoc 
          AlmCDocu.FchDoc = TODAY 
          /*AlmCDocu.NroDoc = STRING(FacCorre.NroSer,"999") + STRING(FacCorre.Correlativo,"999999")*/
