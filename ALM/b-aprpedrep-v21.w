...
BUTTON-1 COMBO-BOX-Motivo FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 FILL-IN-Usuario ~
FILL-IN-Fecha-1 FILL-IN-Fecha-2 br_table 
...
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       NO es selección múltiple
------------------------------------------------------------------------------*/
