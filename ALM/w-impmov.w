...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 W-Win _STRUCTURED
  QUERY BROWSE-1 DISPLAY
      T-CMOV.CodAlm
      T-CMOV.FchDoc COLUMN-LABEL "Fecha Emisión"
      T-CMOV.TipMov COLUMN-LABEL "Tipo"
      T-CMOV.CodMov COLUMN-LABEL "Código"
      T-CMOV.NroSer COLUMN-LABEL "Seri Nº"
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importar Movimientos de Almacén"
         HEIGHT             = 15.88
         WIDTH              = 86.29
         MAX-HEIGHT         = 18.12
         MAX-WIDTH          = 96.57
...
"T-CMOV.FchDoc" "Fecha Emisión" ? "date" ? ? ? ? ? ? no ?
...
"T-CMOV.NroSer" "Seri Nº" ? "integer" ? ? ? ? ? ? no ?
...
ON END-ERROR OF W-Win /* Importar Movimientos de Almacén */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Importar Movimientos de Almacén */
DO:
...
------------------------------------------------------------------------------*/
  ...
  MESSAGE "Importación de Movimiento de Almacén Completa" VIEW-AS ALERT-BOX WARNING.
  {&OPEN-QUERY-{&BROWSE-NAME}}
