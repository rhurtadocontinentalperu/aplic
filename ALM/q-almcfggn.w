...
&Scoped-define INTERNAL-TABLES AlmCfgGn

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH AlmCfgGn WHERE ~{&KEY-PHRASE} ~
      AND AlmCfgGn.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH AlmCfgGn WHERE ~{&KEY-PHRASE} ~
      AND AlmCfgGn.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main AlmCfgGn
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main AlmCfgGn
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.AlmCfgGn"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "AlmCfgGn.CodCia = s-codcia"
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST Almcfggn WHERE codcia = s-codcia NO-LOCK NO-ERROR.
IF NOT AVAILABLE Almcfggn THEN DO:
    CREATE Almcfggn.
    Almcfggn.codcia = s-codcia.
    RELEASE Almcfggn.
END.
END PROCEDURE.
