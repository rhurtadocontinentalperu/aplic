...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DREPO.CanGen FORMAT "ZZZ,ZZ9.9999":U COLUMN-FGCOLOR 1 COLUMN-BGCOLOR 11
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 110 BY 10.5
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     "F8: Consulta de stocks             Doble Clic: Consulta de Movimientos" VIEW-AS TEXT
          SIZE 48 BY .5 AT ROW 11.77 COL 2 WIDGET-ID 8
...
"T-DREPO.CanGen" ? ? "decimal" 11 1 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = Temp-Tables.T-DREPO.Origen
...
DO:
    RUN ALM/D-DETMOV.R (almmmatg.codmat, almmmatg.desmat).
END.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  RUN GET-ATTRIBUTE('ADM-NEW_RECORD').
...
/*     IF DECIMAL(T-DREPO.CanReq:SCREEN-VALUE IN BROWSE {&browse-name}) > T-DREPO.StkAct */
/*         AND T-DREPO.StkAc > 0                                                         */
/*     THEN DO:                                                                          */
/*         MESSAGE 'La cantidad solicitada supera el stock actual del almacén despacho'  */
