...
DEFINE VARIABLE h_v-invcfg-a AS HANDLE NO-UNDO.
...
DO:
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Carga-Temporal2 IN h_v-invcfg-a (01).
...
DO:
  ...
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Genera-Movimiento IN h_v-invcfg-a.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/v-invcfg-a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-invcfg-a ).
       RUN set-position IN h_v-invcfg-a ( 1.19 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-invcfg-a. */
       RUN add-link IN adm-broker-hdl ( h_q-invcfg , 'Record':U , h_v-invcfg-a ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-invcfg-a ,
