...
/* ***************************  Main Block  *************************** */
    ...
    */
    ...
    /*PUT STREAM REPORTE '^FO280,80'                         SKIP.   /* Coordenadas de origen */*/
    ...
    IF lUnidadVenta_undA <> "" THEN DO:
        ...
        PUT STREAM REPORTE '^FD'.
        PUT STREAM REPORTE lUnidadVenta_undA  FORMAT 'X(40)'             SKIP.   /* Descripcion */
        PUT STREAM REPORTE '^FS'                                SKIP.   /* Fin de Campo1 */
    END.    
    /* Precio B */  
    IF lUnidadVenta_undB <> "" THEN DO:
        ...
        PUT STREAM REPORTE '^A0n,25,20'                         SKIP.   /* Coordenada de impresion */
        PUT STREAM REPORTE '^FD'.
        PUT STREAM REPORTE lUnidadVenta_undB  FORMAT 'X(40)'             SKIP.   /* Descripcion */
        PUT STREAM REPORTE '^FS'                                SKIP.   /* Fin de Campo1 */
    END.
    /* Precio C */
