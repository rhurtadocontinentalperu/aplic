...
DEFINE VARIABLE h_b-artalmv3 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-artalmv3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Familia':U ,
             OUTPUT h_b-artalmv3 ).
       RUN set-position IN h_b-artalmv3 ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-artalmv3 ( 18.08 , 102.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.96 , 76.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.58 , 13.43 ) NO-ERROR.

       /* Links to SmartLookup h_b-artalmv3. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_b-artalmv3 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_b-artalmv3 , 'AFTER':U ).
    END. /* Page 0 */
