...
&Scoped-Define ENABLED-OBJECTS DesdeF HastaF BUTTON-1 BUTTON-2 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE DesdeF HastaF BUTTON-1 BUTTON-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*      IF FIRST-OF(t-CodPro) THEN DO:
 *          FIND Gn-Prov WHERE Gn-prov.Codcia = 0 AND
 *                             Gn-prov.CodPro = T-CodPro
 *                             NO-LOCK NO-ERROR.
 *                       
 *          PUT STREAM REPORT T-CodPro AT 1 .
