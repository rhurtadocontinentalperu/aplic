...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 34.57
      ...
      almdrepo.CanAten FORMAT "ZZZ,ZZ9.9999":U COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
      Almmmatg.UndBas COLUMN-LABEL "Unidad" FORMAT "X(7)":U WIDTH 7.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "34.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"almdrepo.CanAten" ? ? "decimal" 11 9 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.Almmmatg.UndBas
"Almmmatg.UndBas" "Unidad" "X(7)" "character" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
