...
&Scoped-Define ENABLED-OBJECTS r-repo r-sele F-CodFam F-SubFam F-prov1 ~
F-prov2 DesdeC HastaC DesdeF HastaF nCodMon R-Tipo Btn_OK Btn_Cancel ~
Btn_Help RECT-57 
&Scoped-Define DISPLAYED-OBJECTS r-repo r-sele F-CodFam F-SubFam F-prov1 ~
F-prov2 DesdeC HastaC DesdeF HastaF nCodMon R-Tipo F-DesFam F-DesSub 
...
DEFINE FRAME F-Main
     r-repo AT ROW 7.27 COL 50.43 NO-LABEL
     r-sele AT ROW 7.88 COL 20.43 NO-LABEL
     ...
     "Reporte" VIEW-AS TEXT
          SIZE 8 BY .81 AT ROW 8.08 COL 11.86
          FONT 1
     "Tipo" VIEW-AS TEXT
          SIZE 5.72 BY .92 AT ROW 7.96 COL 43.43
          FONT 1
...
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN F-prov1 F-prov2 DesdeC DesdeF F-CodFam F-SubFam F-DesFam HastaC HastaF nCodMon R-Tipo R-Sele R-Repo.
...
/*  DISPLAY ccbddocu.codmat ccbddocu.fchdoc ccbddocu.coddoc ccbddocu.nrodoc.                    */
      ...
      F-FACTOR  = 1 . 
      t-importe = 0.
      F-PORIGV  = ( 1 + (Almmmatg.PorIgv / 100)).
...
------------------------------------------------------------------------------*/
  DISPLAY r-repo r-sele F-CodFam F-SubFam F-prov1 F-prov2 DesdeC HastaC DesdeF 
          HastaF nCodMon R-Tipo F-DesFam F-DesSub 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE r-repo r-sele F-CodFam F-SubFam F-prov1 F-prov2 DesdeC HastaC DesdeF 
         HastaF nCodMon R-Tipo Btn_OK Btn_Cancel Btn_Help RECT-57 
      WITH FRAME F-Main IN WINDOW W-Win.
      ...
      */
      ...
      IF LAST-OF(t-SubFam) THEN DO:
         ...
         IF AVAILABLE Almsfami THEN DO:
             ...
             PUT STREAM REPORT (ACCUM SUB-TOTAL BY t-subfam t-totald) AT 103 SKIP.
     /*      PUT STREAM REPORT '      ------------------------------------------' SKIP.*/
         /*    PUT STREAM REPORT ' ' SKIP.*/
         END.
      END.
  ...
  FOR EACH tmp-tempo BREAK BY t-prove
      ...
      IF LAST-OF(t-CodFam) THEN DO:
         ...
         IF AVAILABLE Almtfami THEN DO:
             ...
             PUT STREAM REPORT (ACCUM SUB-TOTAL BY t-codfam t-totald) AT 103  SKIP.
  ...
  FOR EACH tmp-tempo BREAK BY t-prove:
      ...
      IF LAST-OF(t-prove) THEN DO:
         ...
         IF AVAILABLE GN-PROV THEN DO:
             ...
             PUT STREAM REPORT  (ACCUM SUB-TOTAL BY t-prove t-totald) At 103 SKIP.
.
         END.  
      END.
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN F-prov1 F-prov2 DesdeC DesdeF F-CodFam F-DesFam HastaC HastaF nCodMon R-Tipo R-Sele R-Repo.
