...
DEF VAR x-desmat AS CHAR NO-UNDO FORMAT 'X(40)'.
...
&Scoped-Define ENABLED-OBJECTS txt-desde txt-hasta btn-print BUTTON-8 
...
DEFINE VARIABLE txt-desde AS CHARACTER FORMAT "X(20)":U 
     LABEL "Desde" 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .9 NO-UNDO.

DEFINE VARIABLE txt-hasta AS CHARACTER FORMAT "X(20)":U 
     LABEL "Hasta" 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .9 NO-UNDO.
...
DEFINE FRAME F-Main
     txt-desde AT ROW 3.15 COL 8 COLON-ALIGNED WIDGET-ID 20
     txt-hasta AT ROW 3.15 COL 30 COLON-ALIGNED WIDGET-ID 22
...
------------------------------------------------------------------------------*/
  ...
  ENABLE txt-desde txt-hasta btn-print BUTTON-8 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE iNumero2 AS INTEGER     NO-UNDO.
    ...
    OUTPUT STREAM REPORTE TO PRINTER.
        ...
        DO iInt = INT(txt-desde) TO INT(txt-hasta):
