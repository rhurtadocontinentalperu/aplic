...
DEFINE VARIABLE h_vsalidausointernov21 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/vsalidausointernov21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vsalidausointernov21 ).
       RUN set-position IN h_vsalidausointernov21 ( 4.46 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_vsalidausointernov21. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_vsalidausointernov21 ).
       RUN add-link IN adm-broker-hdl ( h_q-alcmov , 'Record':U , h_vsalidausointernov21 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_vsalidausointernov21 ,
             h_p-updv05 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-salida ,
             h_vsalidausointernov21 , 'AFTER':U ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/tsalidausointerno.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
