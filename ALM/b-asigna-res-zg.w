...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      t-report.Campo-F[6] COLUMN-LABEL "Stock en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 8.43
      t-report.Campo-F[7] COLUMN-LABEL "Tránsito!Compras" FORMAT "ZZ,ZZZ,ZZ9.99":U
            WIDTH 9.43
...
"Temp-Tables.t-report.Llave-C" "Zona!Geográfica" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-report.Campo-C[1]
"Temp-Tables.t-report.Campo-C[1]" "Descripción" "X(40)" "character" ? ? ? ? ? ? no ? no no "29.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.t-report.Campo-F[2]
"Temp-Tables.t-report.Campo-F[2]" "Máximo" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.t-report.Campo-F[3]
"Temp-Tables.t-report.Campo-F[3]" "Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.t-report.Campo-F[4]
"Temp-Tables.t-report.Campo-F[4]" "Máximo +!Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.t-report.Campo-F[10]
"Temp-Tables.t-report.Campo-F[10]" "Empaque!Grupo" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.t-report.Campo-F[5]
"Temp-Tables.t-report.Campo-F[5]" "Stock!Disponible" "-ZZZ,ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.t-report.Campo-F[6]
"Temp-Tables.t-report.Campo-F[6]" "Stock en!Tránsito" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.t-report.Campo-F[7]
"Temp-Tables.t-report.Campo-F[7]" "Tránsito!Compras" "ZZ,ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.t-report.Campo-F[1]
"Temp-Tables.t-report.Campo-F[1]" "Faltante!Sobrante" "-ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
