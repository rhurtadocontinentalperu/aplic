...
FacCPedi.FchPed FacCPedi.CodAlm Almacen.Descripcion FacCPedi.CodCli ~
FacCPedi.NomCli _FlgEst() @ x-Estado 
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.CodDiv = s-coddiv NO-LOCK, ~
      EACH Almacen OF FacCPedi NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.CodAlm COLUMN-LABEL "Almacén!Despacho" FORMAT "x(3)":U
      Almacen.Descripcion FORMAT "X(30)":U
      FacCPedi.CodCli COLUMN-LABEL "Almacén!Destino" FORMAT "x(3)":U
            WIDTH 11
      FacCPedi.NomCli COLUMN-LABEL "Descripción" FORMAT "x(30)":U
...
DEFINE FRAME F-Main
     ...
     "..." VIEW-AS TEXT
          SIZE 3 BY .5 AT ROW 8.12 COL 115 WIDGET-ID 2
...
"FacCPedi.CodAlm" "Almacén!Despacho" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.CodCli" "Almacén!Destino" "x(3)" "character" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacCPedi.NomCli
"FacCPedi.NomCli" "Descripción" "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"_FlgEst() @ x-Estado" "Estado" "x(20)" ? ? ? ? ? ? ? no ? no no "22" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
