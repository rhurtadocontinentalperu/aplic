...
DEF VAR x-CodPed LIKE PikTareas.CodPed NO-UNDO.
DEF VAR x-NroPed LIKE PikTareas.NroPed NO-UNDO.
DEF VAR x-FchIni LIKE PikTareas.FchInicio NO-UNDO.
...
PikSacadores.Sector PikTareas.CodPed PikTareas.NroPed PikTareas.FchInicio ~
PikTareas.FchFin PikTareas.Items 
...
&Scoped-define QUERY-STRING-BROWSE-3 FOR EACH PikSacadores ~
      ...
      LAST PikTareas WHERE PikTareas.CodCia = PikSacadores.CodCia ~
...
&Scoped-define OPEN-QUERY-BROWSE-3 OPEN QUERY BROWSE-3 FOR EACH PikSacadores ~
  ...
  AND PikTareas.CodPer = PikSacadores.CodPer ~
 OUTER-JOIN NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-3 PikSacadores PL-PERS PikTareas
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-3 PikSacadores
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-3 PL-PERS
&Scoped-define THIRD-TABLE-IN-QUERY-BROWSE-3 PikTareas
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 W-Win _STRUCTURED
  QUERY BROWSE-3 NO-LOCK DISPLAY
      ...
      PikTareas.CodPed COLUMN-LABEL "Docum." FORMAT "x(8)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      PikTareas.NroPed COLUMN-LABEL "Número" FORMAT "x(15)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      PikTareas.FchInicio COLUMN-LABEL "Inicio Tarea" FORMAT "99/99/9999 HH:MM:SS":U
            WIDTH 15.86 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      PikTareas.FchFin COLUMN-LABEL "Fin de Tarea" FORMAT "99/99/9999 HH:MM:SS":U
            WIDTH 15.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      PikTareas.Items COLUMN-LABEL "#Items" FORMAT ">>>,>>9":U
            WIDTH 7.29 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-3
     _TblList          = "INTEGRAL.PikSacadores,INTEGRAL.PL-PERS OF INTEGRAL.PikSacadores,INTEGRAL.PikTareas WHERE INTEGRAL.PikSacadores ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST, LAST OUTER"
     _Where[1]         = "{&Condicion}"
     _JoinCode[3]      = "PikTareas.CodCia = PikSacadores.CodCia
  AND PikTareas.CodDiv = PikSacadores.CodDiv
  AND PikTareas.CodPer = PikSacadores.CodPer
"
...
"PikSacadores.Sector" ? "x(20)" "character" ? ? ? ? ? ? no ? no no "14.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.PikTareas.CodPed
"PikTareas.CodPed" "Docum." ? "character" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.PikTareas.NroPed
"PikTareas.NroPed" "Número" ? "character" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.PikTareas.FchInicio
"PikTareas.FchInicio" "Inicio Tarea" "99/99/9999 HH:MM:SS" "datetime" 11 0 ? ? ? ? no ? no no "15.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.PikTareas.FchFin
"PikTareas.FchFin" "Fin de Tarea" "99/99/9999 HH:MM:SS" "datetime" 11 0 ? ? ? ? no ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.PikTareas.Items
"PikTareas.Items" "#Items" ? "integer" 11 0 ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
...
DO k = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
    IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(k) THEN DO:
        FIND CURRENT PikSacadores NO-LOCK NO-ERROR NO-WAIT.
...
DEF VAR k AS INT NO-UNDO.
RLOOP:
FOR EACH PikSacadores WHERE {&Condicion}:
    IF PikSacadores.FlgTarea = "O" THEN NEXT RLOOP.
    ASSIGN
        PikSacadores.FlgEst = "C"
        PikSacadores.FchCierre = DATETIME(TODAY,MTIME)
