...
&Scoped-define DATA-FIELD-DEFS "aplic/alm/dmate-matg-p1.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.codfam rowObject.codmat ~
rowObject.DesMat rowObject.DesMar rowObject.UndStk rowObject.StkAct ~
rowObject.CodUbi rowObject.FchIng rowObject.Pesmat 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.codfam FORMAT "X(3)":U
      rowObject.codmat FORMAT "X(6)":U
      rowObject.DesMat FORMAT "X(60)":U WIDTH 47.72
      rowObject.DesMar COLUMN-LABEL "Marca" FORMAT "X(30)":U WIDTH 15
      rowObject.UndStk COLUMN-LABEL "Unidad" FORMAT "X(8)":U WIDTH 6
      rowObject.StkAct FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
      rowObject.CodUbi COLUMN-LABEL "Zona o!Ubicación" FORMAT "x(7)":U
            WIDTH 8
      rowObject.FchIng FORMAT "99/99/9999":U
      rowObject.Pesmat FORMAT "->>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 123 BY 19.65
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "aplic\alm\dmate-matg-p1.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.codfam
     _FldNameList[2]   = _<SDO>.rowObject.codmat
     _FldNameList[3]   > _<SDO>.rowObject.DesMat
"rowObject.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "47.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.DesMar
"rowObject.DesMar" "Marca" ? "character" ? ? ? ? ? ? no "?" no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.UndStk
"rowObject.UndStk" "Unidad" ? "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.StkAct
     _FldNameList[7]   > _<SDO>.rowObject.CodUbi
"rowObject.CodUbi" "Zona o!Ubicación" ? "character" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = _<SDO>.rowObject.FchIng
     _FldNameList[9]   > _<SDO>.rowObject.Pesmat
"rowObject.Pesmat" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ASSIGN
        ...
        input-var-2 = rowObject.codmat:SCREEN-VALUE IN BROWSE {&browse-name}.
...
DO:
        S-CODMAT = rowObject.codmat:SCREEN-VALUE IN BROWSE {&browse-name}.
...
DO:
      ASSIGN
          input-var-1 = rowObject.codmat:SCREEN-VALUE IN BROWSE {&browse-name}
          input-var-2 = ''
          input-var-3 = ''
          output-var-1 = ?.
