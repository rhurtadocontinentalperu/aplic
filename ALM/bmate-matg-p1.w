...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.CodCia rowObject.CodAlm ~
rowObject.TpoArt rowObject.codfam rowObject.codmat rowObject.DesMat ~
rowObject.DesMar rowObject.UndStk rowObject.StkAct rowObject.CodUbi 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.CodCia FORMAT "999":U
      rowObject.CodAlm FORMAT "x(5)":U
      rowObject.TpoArt FORMAT "X(1)":U
      rowObject.codfam FORMAT "X(3)":U
      rowObject.codmat FORMAT "X(6)":U
      rowObject.DesMat FORMAT "X(45)":U
      rowObject.DesMar FORMAT "X(30)":U
      rowObject.UndStk FORMAT "X(8)":U
      rowObject.StkAct FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
      rowObject.CodUbi FORMAT "x(7)":U WIDTH 8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 124 BY 21.54
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.CodCia
     _FldNameList[2]   = _<SDO>.rowObject.CodAlm
     _FldNameList[3]   = _<SDO>.rowObject.TpoArt
     _FldNameList[4]   = _<SDO>.rowObject.codfam
     _FldNameList[5]   = _<SDO>.rowObject.codmat
     _FldNameList[6]   = _<SDO>.rowObject.DesMat
     _FldNameList[7]   = _<SDO>.rowObject.DesMar
     _FldNameList[8]   = _<SDO>.rowObject.UndStk
     _FldNameList[9]   = _<SDO>.rowObject.StkAct
     _FldNameList[10]   > _<SDO>.rowObject.CodUbi
"rowObject.CodUbi" ? ? "character" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
