...
&Scoped-define FIELDS-IN-QUERY-br_table T-MATE.CodAlm Almacen.Descripcion ~
T-MATE.StkMin T-MATE.StkMax T-MATE.VCtMn1 T-MATE.VCtMn2 
...
&Scoped-define QUERY-STRING-br_table FOR EACH T-MATE WHERE T-MATE.CodCia = Almmmatg.CodCia ~
  AND T-MATE.codmat = Almmmatg.codmat NO-LOCK, ~
      EACH Almacen OF T-MATE NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH T-MATE WHERE T-MATE.CodCia = Almmmatg.CodCia ~
  AND T-MATE.codmat = Almmmatg.codmat NO-LOCK, ~
      EACH Almacen OF T-MATE NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almacen.Descripcion FORMAT "X(60)":U
      T-MATE.StkMin COLUMN-LABEL "Máximo" FORMAT "ZZZ,ZZ9.99":U
      T-MATE.StkMax COLUMN-LABEL "Cant. Reposición" FORMAT "ZZZ,ZZ9.99":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 92 BY 11.35
...
DEFINE FRAME F-Main
     ...
     BUTTON-5 AT ROW 12.5 COL 5 WIDGET-ID 2
     FILL-IN-1 AT ROW 12.54 COL 71 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN-2 AT ROW 12.54 COL 79 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.T-MATE WHERE INTEGRAL.Almmmatg  ...,INTEGRAL.Almacen OF Temp-Tables.T-MATE"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "Temp-Tables.T-MATE.CodCia = INTEGRAL.Almmmatg.CodCia
  AND Temp-Tables.T-MATE.codmat = INTEGRAL.Almmmatg.codmat"
     _FldNameList[1]   = Temp-Tables.T-MATE.CodAlm
     _FldNameList[2]   > INTEGRAL.Almacen.Descripcion
"Almacen.Descripcion" ? "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-MATE.StkMin
"T-MATE.StkMin" "Máximo" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-MATE.StkMax
"T-MATE.StkMax" "Cant. Reposición" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-MATE.VCtMn1
"T-MATE.VCtMn1" "Campaña" "ZZZ,ZZ9.99" "decimal" 10 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-MATE.VCtMn2
"T-MATE.VCtMn2" "No Campaña" "ZZZ,ZZ9.99" "decimal" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON CHOOSE OF BUTTON-5 IN FRAME F-Main /* RECARGAR MAXIMOS */
DO:
   RUN Recarga-Maximos .
...
*/
  ...
  /* Actualizamos el mínimo de acuerdo a si estamos en Campaña o no */
...
RUN alm/d-stkminxcamp (INPUT Almmmatg.codmat, INPUT-OUTPUT TABLE T-MATE).
...
FOR EACH BT-MATE:
    ASSIGN
        FILL-IN-1 = FILL-IN-1 +  BT-MATE.VCtMn1
        FILL-IN-2 = FILL-IN-2 +  BT-MATE.VCtMn2.
END.
