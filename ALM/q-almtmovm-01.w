...
DEFINE TEMP-TABLE Almacen NO-UNDO LIKE Almacen.
...
DEF VAR s-codmov LIKE almtdocm.codmov NO-UNDO.

&SCOPED-DEFINE condicion almtdocm.tipmov = s-tipmov ~
...
&Scoped-Define ENABLED-OBJECTS c-CodMov 
&Scoped-Define DISPLAYED-OBJECTS c-CodMov 
...
DEFINE VARIABLE c-CodMov AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS COMBO-BOX INNER-LINES 5
     DROP-DOWN-LIST
     SIZE 56 BY .92 NO-UNDO.
...
DEFINE FRAME FRAME-B
     c-CodMov AT ROW 1 COL 1 NO-LABEL WIDGET-ID 2
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: Almacen T "?" NO-UNDO INTEGRAL Almacen
   END-TABLES.
 */
...
/* SETTINGS FOR COMBO-BOX c-CodMov IN FRAME FRAME-B
   ALIGN-L                                                              */
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Almtdocm OF INTEGRAL.Almacen"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _Design-Parent    is WINDOW q-tables @ ( 1.23 , 59.57 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME c-CodMov
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-CodMov q-tables
ON VALUE-CHANGED OF c-CodMov IN FRAME FRAME-B /* Combo 2 */
DO:
  s-CodMov = INTEGER ( SUBSTRING (SELF:SCREEN-VALUE,1,2 ) ).
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH almtdocm OF Almacen NO-LOCK WHERE tipmov = s-tipmov,
      FIRST ALmtmovm OF ALmtdocm NO-LOCK
      BREAK BY almtdocm.tipmov BY almtdocm.codmov:
      IF FIRST-OF(almtdocm.tipmov) THEN s-codmov = almtdocm.codmov.
      c-CodMov:ADD-LAST( STRING (almtdocm.Codmov, '99') + " - " + almtmovm.Desmov) IN FRAME {&FRAME-NAME}.
  END.
  ...
  c-CodMov:SCREEN-VALUE IN FRAME {&FRAME-NAME} = c-CodMov:ENTRY(1).
