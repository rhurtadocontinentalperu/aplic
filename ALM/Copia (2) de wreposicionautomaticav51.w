...
RECT-26 BUTTON-4 COMBO-BOX-Tipo SELECT-Clasificacion FILL-IN-PorRep ~
FILL-IN-Marca FILL-IN-PorStkMax FILL-IN-CodPro FILL-IN-ImpMin BUTTON-20 ~
BUTTON-7 COMBO-BOX-Motivo TOGGLE-VtaPuntual FILL-IN-Glosa txtFechaEntrega ~
BUTTON-1 BUTTON-5 BUTTON-IMPORTAR-EXCEL BUTTON-2 BUTTON-RAN BUTTON-998 
...
FILL-IN-Compras COMBO-BOX-Motivo TOGGLE-VtaPuntual FILL-IN-CodRef ~
FILL-IN-Items FILL-IN-Glosa txtFechaEntrega FILL-IN-NroRef FILL-IN-Mensaje 
...
DEFINE FRAME F-Main
     ...
     TOGGLE-VtaPuntual AT ROW 7.19 COL 78 WIDGET-ID 68
     FILL-IN-CodRef AT ROW 7.38 COL 104 COLON-ALIGNED WIDGET-ID 122
     FILL-IN-Items AT ROW 7.73 COL 130 COLON-ALIGNED WIDGET-ID 118
     FILL-IN-Glosa AT ROW 8 COL 11 COLON-ALIGNED WIDGET-ID 32
     txtFechaEntrega AT ROW 8 COL 76 COLON-ALIGNED WIDGET-ID 56
     FILL-IN-NroRef AT ROW 8.19 COL 104 COLON-ALIGNED WIDGET-ID 124
     ...
     BUTTON-RAN AT ROW 9.35 COL 110 WIDGET-ID 120
     ...
     RECT-26 AT ROW 7.19 COL 91 WIDGET-ID 126
...
DO:
  ...
  RUN Eliminar IN h_b-pedrepautv51.
END.
...
DO:
  ...
  IF output-var-1 <> ? THEN DO:
      ...
      FOR EACH RepAutomDetail NO-LOCK WHERE RepAutomDetail.CodCia = s-codcia
          AND RepAutomDetail.NroSer = Almcrepo.nroser
          AND RepAutomDetail.NroDoc = Almcrepo.nrodoc
          AND RepAutomDetail.TipMov = Almcrepo.tipmov:
          CREATE T-DREPO.
          BUFFER-COPY RepAutomDetail TO T-DREPO.
      END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-pedrepautv51 ( 10.69 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-pedrepautv51 ( 14.77 , 141.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv08 ).
       RUN set-position IN h_p-updv08 ( 25.50 , 3.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Tipo FILL-IN-Temporada FILL-IN-Almacen FILL-IN-CodFam 
          ...
          COMBO-BOX-Motivo TOGGLE-VtaPuntual FILL-IN-CodRef FILL-IN-Items 
          FILL-IN-Glosa txtFechaEntrega FILL-IN-NroRef FILL-IN-Mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-9 RECT-1 RECT-12 RECT-13 RECT-14 RECT-26 BUTTON-4 COMBO-BOX-Tipo 
         ...
         BUTTON-IMPORTAR-EXCEL BUTTON-2 BUTTON-RAN BUTTON-998 
      WITH FRAME F-Main IN WINDOW W-Win.
