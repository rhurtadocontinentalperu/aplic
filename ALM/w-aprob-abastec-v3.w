...
DEFINE VARIABLE h_b-aprob-abastec-v3 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 144.29 BY 24.88 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/b-aprob-abastec-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprob-abastec-v3 ).
       RUN set-position IN h_b-aprob-abastec-v3 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-aprob-abastec-v3 ( 24.46 , 144.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-aprob-abastec-v2 ( 6.12 , 90.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv96-2 ).
       RUN set-position IN h_p-updv96-2 ( 10.15 , 90.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96-2 ( 1.54 , 26.14 ) NO-ERROR.

       /* Links to SmartViewer h_v-aprob-abastec-v2. */
       RUN add-link IN adm-broker-hdl ( h_b-aprob-abastec-v3 , 'Record':U , h_v-aprob-abastec-v2 ).
...
/*     END.                                           */
    WHEN 'disable-header' THEN DO:
         ...
         RUN disable-filtros IN h_b-aprob-abastec-v3.
    END.
    WHEN 'enable-header' THEN DO:
         RUN dispatch IN h_p-updv96-2 ('enable':U).
         RUN Enable-Filtros IN h_b-aprob-abastec-v3.
    END.
    WHEN 'open-queries' THEN DO:
        RUN dispatch IN h_b-aprob-abastec-v3 ('open-query':U).
