...
BUTTON-3 BUTTON-6 BtnDone C-Tipo FILL-IN_Fecha 
...
DEFINE VARIABLE FILL-IN_Fecha AS DATE FORMAT "99/99/9999":U 
     LABEL "Al día" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     FILL-IN_Fecha AT ROW 21.73 COL 43 COLON-ALIGNED WIDGET-ID 54
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CONSOLIDADO DE ARTICULOS ZONIFICADOS POR ALMACEN"
         HEIGHT             = 22.58
         WIDTH              = 106.29
         MAX-HEIGHT         = 23.46
         MAX-WIDTH          = 110.86
...
ON END-ERROR OF W-Win /* CONSOLIDADO DE ARTICULOS ZONIFICADOS POR ALMACEN */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CONSOLIDADO DE ARTICULOS ZONIFICADOS POR ALMACEN */
DO:
...
DO:
    ...
    RUN gn/d-almacenes.w (INPUT-OUTPUT pAlmacenes).
    /* Control */
...
FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = s-codcia
    ...
    DO k = 1 TO NUM-ENTRIES(EDITOR_Almacenes):
        ...
        CASE TRUE:
            WHEN FILL-IN_Fecha = TODAY THEN DO:
            ...
            OTHERWISE DO:
                FIND LAST Almstkal USE-INDEX Llave01 WHERE Almstkal.codcia = s-codcia AND
                    ...
                    Almstkal.fecha <= FILL-IN_Fecha
                    NO-LOCK NO-ERROR NO-WAIT.
                IF NOT AVAILABLE Almstkal THEN NEXT.
                IF c-Tipo = "Todos" OR Almstkal.stkact > 0 THEN DO:
                    ...
                    FIND Almacen WHERE Almacen.codcia = s-codcia AND
                        Almacen.codalm = x-CodAlm NO-LOCK NO-ERROR NO-WAIT.
