...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 LT-DREPO.AlmPed LT-DREPO.Item ~
LT-DREPO.CanGen LT-DREPO.CanAten LT-DREPO.CanTran 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 68 BY 9.62 FIT-LAST-COLUMN.
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-Costo AT ROW 10.96 COL 16 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     FILL-IN-Peso AT ROW 10.96 COL 33 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN-Volumen AT ROW 10.96 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     Btn_OK AT ROW 12.58 COL 2
     Btn_Cancel AT ROW 12.58 COL 21 WIDGET-ID 16
     "TOTALES" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 11.23 COL 7 WIDGET-ID 14
          FONT 6
     RECT-10 AT ROW 10.69 COL 2 WIDGET-ID 12
     SPACE(1.85) SKIP(2.30)
