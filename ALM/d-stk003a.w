...
DEF TEMP-TABLE T-MOV-I LIKE ALMDMOV
    ...
    INDEX LLAVE01 AS PRIMARY CodMat /*CanDes*/ FchDoc .
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH DETALLE /*WHERE DETALLE.StkCbd <> DETALLE.StkLog*/:
    FOR EACH ALMDMOV NO-LOCK USE-INDEX ALMD02 WHERE almdmov.codcia = s-codcia
        ...
        THEN ASSIGN
                T-MOV-I.almdes = ALMCMOV.almdes
                T-MOV-I.almdes = ALMDMOV.almori
                T-MOV-I.nrorf1 = ALMCMOV.nrorf1.
    END.
    FOR EACH ALMDMOV NO-LOCK USE-INDEX ALMD02 WHERE almdmov.codcia = s-codcia
            AND almdmov.codmat = DETALLE.codmat
            AND almdmov.fchdoc >= xFecha
        ...
        IF AVAILABLE ALMCMOV 
        THEN ASSIGN
                T-MOV-S.almdes = ALMCMOV.almdes
                T-MOV-S.almdes = ALMDMOV.almori
                T-MOV-S.nrorf2 = ALMCMOV.nrorf2.
    END.
  END.
  ...
  FOR EACH T-MOV-I WHERE T-MOV-I.CodMov = 03:
    FIND FIRST T-MOV-S WHERE T-MOV-S.CODMAT = T-MOV-I.CODMAT
        AND T-MOV-S.CANDES = T-MOV-I.CANDES 
  ...
  FOR EACH T-MOV-S WHERE T-MOV-S.CodMov = 03:
    FIND FIRST T-MOV-I WHERE T-MOV-I.CODMAT = T-MOV-S.CODMAT
        AND T-MOV-I.CANDES = T-MOV-S.CANDES 
  ...
  /* MOVIMIENTOS DE INGRESO */
  FOR EACH T-MOV-I WHERE T-MOV-I.CodMov = 67:
    FIND FIRST T-MOV-S WHERE T-MOV-S.CODMAT = T-MOV-I.CODMAT
        AND T-MOV-S.CANDES = T-MOV-I.CANDES 
        AND T-MOV-S.CODMOV = 03
        AND T-MOV-S.NROSER = T-MOV-I.NROSER
        AND T-MOV-S.NRODOC = T-MOV-I.NRODOC
        AND T-MOV-S.CODALM = T-MOV-I.ALMDES
        NO-ERROR.
    IF AVAILABLE T-MOV-S
    THEN DO:
  ...
  END.
  /* MOVIMIENTOS DE SALIDA */
  FOR EACH T-MOV-S WHERE T-MOV-S.CodMov = 67:
    FIND FIRST T-MOV-I WHERE T-MOV-I.CODMAT = T-MOV-S.CODMAT
        AND T-MOV-I.CANDES = T-MOV-S.CANDES 
        AND T-MOV-I.CODMOV = 03
        AND T-MOV-I.NRODOC = T-MOV-S.NRODOC
        AND T-MOV-I.CODALM = T-MOV-S.CODALM
        NO-ERROR.
    IF AVAILABLE T-MOV-I
    THEN DO:
        DELETE T-MOV-I.
  ...
  /* AHORA LO QUE FALTA */
  FOR EACH T-MOV-I:
    FIND FIRST T-MOV-S WHERE T-MOV-S.ALMDES = T-MOV-I.CODALM
