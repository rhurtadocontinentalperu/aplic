...
/*       END.                                                              */
      ...
      FOR EACH Di-RutaD OF Di-RutaC NO-LOCK WHERE Di-RutaD.FlgEst = 'C'
          ...
          THEN DO:
              /* BUSCAMOS LA FAC O BOL DE REFERENCIA */
              ...
              IF AVAILABLE Ccbcdocu THEN DO:
                  ...
                  RUN gn/pTracking-01 (Di-RutaD.CodCia,
                                    ...
                                    Ccbcdocu.nrodoc).
                  IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO, RETURN 'ADM-ERROR'.
                  /* DE ACUERDO A LA DIVISION */
                  IF DI-RutaC.CodDiv = '00000'  /* ATE */
                  THEN CcbCDocu.FchCbd = Di-RutaC.FchDoc.
                  ELSE CcbCDocu.FchCbd = Di-RutaC.FchDoc + 1.
                  /* ************************ */
                  FIND FIRST gn-convt WHERE gn-convt.codig = ccbcdocu.fmapgo
                      NO-LOCK NO-ERROR.
                  IF AVAILABLE gn-convt 
                  THEN ccbcdocu.fchvto = ccbcdocu.fchcbd + gn-convt.totdias.
                  ELSE ccbcdocu.fchvto = ccbcdocu.fchcbd.
                  RELEASE Ccbcdocu.
              END.
          END.
      END.
