...
DEFINE VARIABLE h_b-chqingotr-v2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CHEQUEO DE INGRESOS POR ORDEN DE TRANSFERENCIAS"
         HEIGHT             = 24.58
         WIDTH              = 129.14
         MAX-HEIGHT         = 32.31
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF W-Win /* CHEQUEO DE INGRESOS POR ORDEN DE TRANSFERENCIAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CHEQUEO DE INGRESOS POR ORDEN DE TRANSFERENCIAS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-chqingotr-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chqingotr-v2 ).
       RUN set-position IN h_b-chqingotr-v2 ( 1.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-chqingotr-v2 ( 23.69 , 113.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 8.00 , 116.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 7.27 , 13.14 ) NO-ERROR.

       /* Links to SmartBrowser h_b-chqingotr-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chqingotr-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chqingotr-v2 ,
             Btn_Done:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_b-chqingotr-v2 , 'AFTER':U ).
    END. /* Page 0 */
