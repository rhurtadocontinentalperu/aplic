...
&Scoped-Define ENABLED-OBJECTS txt-almvirtual Btn_Ok Btn_Done x-pass 
&Scoped-Define DISPLAYED-OBJECTS txt-almvirtual x-pass x-mensaje 
...
DEFINE FRAME F-Main
     txt-almvirtual AT ROW 3.96 COL 16 COLON-ALIGNED WIDGET-ID 52
     Btn_Ok AT ROW 5.12 COL 39 WIDGET-ID 38
     Btn_Done AT ROW 5.12 COL 53 WIDGET-ID 36
     x-pass AT ROW 5.31 COL 16 COLON-ALIGNED NO-LABEL WIDGET-ID 34 PASSWORD-FIELD 
     x-mensaje AT ROW 7.46 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     "Este proceso actualiza la informacion de Reconteo con la" VIEW-AS TEXT
          SIZE 62 BY .62 AT ROW 1.65 COL 7 WIDGET-ID 48
          FONT 10
     "informacion de Conteo previamente ingresada." VIEW-AS TEXT
          SIZE 44 BY .62 AT ROW 2.73 COL 7 WIDGET-ID 50
          FONT 10
     "Reconteo" VIEW-AS TEXT
          SIZE 12 BY .62 AT ROW 5.85 COL 5 WIDGET-ID 42
     "Confirmar" VIEW-AS TEXT
          SIZE 10 BY .62 AT ROW 5.04 COL 5 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 70.43 BY 8.42 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  DISPLAY txt-almvirtual x-pass x-mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-almvirtual Btn_Ok Btn_Done x-pass 
      WITH FRAME F-Main IN WINDOW W-Win.
