...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES T-ALMTDOCM
&Scoped-define FIRST-EXTERNAL-TABLE T-ALMTDOCM


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR T-ALMTDOCM.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almcmov WHERE Almcmov.CodCia = T-ALMTDOCM.CodCia ~
  AND Almcmov.CodAlm = T-ALMTDOCM.CodAlm ~
  AND Almcmov.TipMov = T-ALMTDOCM.TipMov ~
  AND Almcmov.CodMov = T-ALMTDOCM.CodMov NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almcmov WHERE Almcmov.CodCia = T-ALMTDOCM.CodCia ~
  AND Almcmov.CodAlm = T-ALMTDOCM.CodAlm ~
  AND Almcmov.TipMov = T-ALMTDOCM.TipMov ~
  AND Almcmov.CodMov = T-ALMTDOCM.CodMov NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: Temp-Tables.T-ALMTDOCM
   Allow: Basic,Query
   Frames: 1
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Almcmov WHERE Temp-Tables.T-ALMTDOCM ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST OUTER"
     _JoinCode[1]      = "INTEGRAL.Almcmov.CodCia = Temp-Tables.T-ALMTDOCM.CodCia
  AND INTEGRAL.Almcmov.CodAlm = Temp-Tables.T-ALMTDOCM.CodAlm
  AND INTEGRAL.Almcmov.TipMov = Temp-Tables.T-ALMTDOCM.TipMov
  AND INTEGRAL.Almcmov.CodMov = Temp-Tables.T-ALMTDOCM.CodMov"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "T-ALMTDOCM"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "T-ALMTDOCM"}
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN  
      input-var-1 = t-almtdocm.codalm
      input-var-2 = t-almtdocm.tipmov
      input-var-3 = STRING(t-almtdocm.codmov)
      output-var-1 = ?
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
      RUN alm/c-almcmov-01 ("Movimientos").
