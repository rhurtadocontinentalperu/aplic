...
&Scoped-define INTERNAL-TABLES MrdMMatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH MrdMMatg OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH MrdMMatg OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main MrdMMatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main MrdMMatg
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.MrdMMatg OF INTEGRAL.Almmmatg"
...
DEF BUFFER B-MATG FOR Mrdmmatg.

IF AVAILABLE Almmmatg AND NOT CAN-FIND(FIRST Mrdmmatg OF Almmmatg)
    THEN DO:
    CREATE B-MATG.
    ASSIGN
        B-MATG.CodCia = Almmmatg.codcia
        B-MATG.codmat = Almmmatg.codmat.
    RELEASE B-MATG.
END.
