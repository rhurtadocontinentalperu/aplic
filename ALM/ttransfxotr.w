...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 85 BY 11.92
         FONT 4.
...
"Temp-Tables.ITEM.codmat" "<Codigo>" "X(14)" "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"INTEGRAL.Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "42.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"INTEGRAL.Almmmatg.UndBas" "Unidad" "X(7)" "character" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.ITEM.CanDes
"Temp-Tables.ITEM.CanDes" ? "ZZZ,ZZ9.9999" "decimal" ? ? ? ? ? ? no "F8: ver stocks" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
