...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    /* buscamos la orden de despacho del almacén origen */
    ...
    IF NOT AVAILABLE Faccpedi THEN DO:
        ...
        MESSAGE "Se generó la" Faccpedi.coddoc Faccpedi.nroped "automáticamente"
            VIEW-AS ALERT-BOX INFORMATION.
    END.
    ELSE DO:
        IF NOT (Faccpedi.flgest = "P" AND Faccpedi.flgsit = "C") THEN DO:
            MESSAGE "La" Faccpedi.coddoc Faccpedi.nroped "aún no se ha chequeado por barras"
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    IF NOT (Faccpedi.flgest = "P" AND Faccpedi.flgsit = "C") THEN DO:
        MESSAGE "La" Faccpedi.coddoc Faccpedi.nroped "puede que ya esté facturada"
            VIEW-AS ALERT-BOX ERROR.
        UNDO, RETURN "ADM-ERROR".
    END.
