...
DEFINE VARIABLE w-STK AS DECIMAL.
DEFINE VARIABLE w-mone AS CHARACTER.
...
&Scoped-Define ENABLED-OBJECTS RECT-58 RECT-62 RECT-57 F-CodFam F-SubFam ~
DesdeC HastaC Btn_OK Btn_Cancel R-Tipo Btn_Help 
&Scoped-Define DISPLAYED-OBJECTS F-CodFam F-SubFam DesdeC HastaC F-DesFam ~
F-DesSub R-Tipo 
...
DEFINE FRAME F-Main
     F-CodFam AT ROW 1.88 COL 8.29 COLON-ALIGNED
     F-SubFam AT ROW 2.65 COL 8.29 COLON-ALIGNED
     DesdeC AT ROW 4.42 COL 12.86 COLON-ALIGNED
     HastaC AT ROW 5.46 COL 12.86 COLON-ALIGNED
     Btn_OK AT ROW 10.35 COL 14.57
     F-DesFam AT ROW 1.88 COL 14.57 COLON-ALIGNED NO-LABEL
     F-DesSub AT ROW 2.65 COL 14.57 COLON-ALIGNED NO-LABEL
     Btn_Cancel AT ROW 10.35 COL 25.86
     R-Tipo AT ROW 4.42 COL 39.14 NO-LABEL
     Btn_Help AT ROW 10.35 COL 37.29
     RECT-58 AT ROW 3.77 COL 7.29
     RECT-62 AT ROW 3.77 COL 30.43
     RECT-46 AT ROW 10.23 COL 1
     RECT-57 AT ROW 1.62 COL 1.43
     "Criterio de Selección" VIEW-AS TEXT
          SIZE 17.72 BY .5 AT ROW 1 COL 5.43
          FONT 6
     "Estado" VIEW-AS TEXT
          SIZE 6.86 BY .69 AT ROW 4.5 COL 31.43
          FONT 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Reporte de Articulos X Rotacion"
         HEIGHT             = 10.92
         WIDTH              = 57.86
         MAX-HEIGHT         = 10.92
         MAX-WIDTH          = 88.43
...
ON END-ERROR OF W-Win /* Reporte de Articulos X Rotacion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de Articulos X Rotacion */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY F-CodFam F-SubFam DesdeC HastaC F-DesFam F-DesSub R-Tipo 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-58 RECT-62 RECT-57 F-CodFam F-SubFam DesdeC HastaC Btn_OK 
         Btn_Cancel R-Tipo Btn_Help 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
         ...
         "LISTADO X ROTACION" AT 37
         "Pagina :" TO 118 PAGE-NUMBER(REPORT) TO 130 FORMAT "ZZZZZ9" SKIP
         "COSTO SIN IGV"
         "Fecha  :" TO 118 TODAY TO 130 FORMAT "99/99/9999" SKIP
         "Almacen : "s-codalm
         "Hora   :" TO 118 STRING(TIME,"HH:MM") TO 130 SKIP
        "---------------------------------------------------------------------------------------------------------------------" SKIP
        "                                                                          (A)       (B)      (C)     OFIC            " SKIP
        "  Codigo D  E  S  C  R  I  P  C  I  O  N          MARCA          UM.      UM.       UM.      UM.                STOCK" SKIP
        "---------------------------------------------------------------------------------------------------------------------" SKIP
/*
         123456789|123456789|123456789|123456789|123456789|123456789|123456789|123456789|123456789|123456789|123456789|123456789|
         X 123456 1234567890123456789012345678901234567890 1234567890 12345678 12345678 12345678 12345678 12345678 ->>>,>>9.99
*/        
 ...
 FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.Codcia = S-CODCIA  
                           ...
                           BREAK BY Almmmatg.Codfam
                                 ...
                                 BY Almmmatg.tipart:
      w-mone = "D".
      if almmmatg.monvta = 1 then w-mone = "S".
      
      DISPLAY Almmmatg.CodMat @ Fi-Mensaje LABEL "Codigo de Articulo "
              FORMAT "X(11)" WITH FRAME F-Proceso.
      w-stk = 0.
      FIND FIRST almmmate where almmmate.codcia = S-CODCIA and almmmate.codalm = s-codalm AND almmmate.codmat = almmmatg.codmat no-lock no-error.
      IF AVAILABLE almmmate THEN w-STK = almmmate.stkact.
