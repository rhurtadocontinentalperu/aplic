...
&Scoped-Define ENABLED-OBJECTS txt-almvirtual rs-cont Btn_OK Btn_Cancel ~
BUTTON-1 RECT-72 
&Scoped-Define DISPLAYED-OBJECTS txt-almvirtual rs-cont 
...
DEFINE FRAME D-Dialog
     txt-almvirtual AT ROW 2.92 COL 19 COLON-ALIGNED WIDGET-ID 36
     rs-cont AT ROW 4.04 COL 14 NO-LABEL WIDGET-ID 2
     Btn_OK AT ROW 5.31 COL 37
     Btn_Cancel AT ROW 5.31 COL 50
     BUTTON-1 AT ROW 5.31 COL 25 WIDGET-ID 32
     "Paginas sin ingreso de inventario PLANTA" VIEW-AS TEXT
          SIZE 52 BY 1.04 AT ROW 1.62 COL 7 WIDGET-ID 34
          FONT 6
...
ON CHOOSE OF Btn_OK IN FRAME D-Dialog /* EXCEL */
DO:
  ASSIGN rs-cont txt-almvirtual.
  RUN Excel.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY txt-almvirtual rs-cont 
      WITH FRAME D-Dialog.
  ENABLE txt-almvirtual rs-cont Btn_OK Btn_Cancel BUTTON-1 RECT-72 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
