...
DEFINE VARIABLE cVar  AS CHARACTER FORMAT "X(6)"  NO-UNDO.
DEF STREAM REPORTE.
...
&Scoped-Define ENABLED-OBJECTS x-inicio x-fin btn-print BUTTON-8 
&Scoped-Define DISPLAYED-OBJECTS x-inicio x-fin 
...
DEFINE VARIABLE x-fin AS CHARACTER FORMAT "X(8)":U 
     LABEL "Hasta" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .81 NO-UNDO.

DEFINE VARIABLE x-inicio AS CHARACTER FORMAT "X(8)":U 
     LABEL "Desde" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .81 NO-UNDO.
...
DEFINE FRAME F-Main
     x-inicio AT ROW 3.15 COL 13 COLON-ALIGNED WIDGET-ID 20
     x-fin AT ROW 4.5 COL 13 COLON-ALIGNED WIDGET-ID 16
     btn-print AT ROW 4.77 COL 32 WIDGET-ID 4
     BUTTON-8 AT ROW 4.77 COL 41 WIDGET-ID 18
     "Impresión Codigos" VIEW-AS TEXT
...
&Scoped-define SELF-NAME x-fin
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL x-fin W-Win
ON LEAVE OF x-fin IN FRAME F-Main /* Hasta */
DO:
...
&Scoped-define SELF-NAME x-inicio
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL x-inicio W-Win
ON LEAVE OF x-inicio IN FRAME F-Main /* Desde */
DO:
    IF SELF:SCREEN-VALUE = "" THEN RETURN.
    ASSIGN
        SELF:SCREEN-VALUE = STRING(INTEGER(SELF:SCREEN-VALUE),"99999999")
...
------------------------------------------------------------------------------*/
  DISPLAY x-inicio x-fin 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE x-inicio x-fin btn-print BUTTON-8 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
        ...
        IF rpta = NO THEN RETURN.
            ...
            DO iInt = INT(x-inicio) TO INT(x-fin):

                cb-niveles = STRING(iInt,"99999999").
                cVar = cb-niveles.
