...
&Scoped-Define DATA-FIELD-DEFS "alm/dmate-matg-p1.i"
&Scoped-Define DATA-TABLE-NO-UNDO NO-UNDO
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almmmate NO-LOCK, ~
      FIRST Almmmatg OF Almmmate NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almmmate NO-LOCK, ~
      FIRST Almmmatg OF Almmmate NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main Almmmate Almmmatg
