...
&Scoped-Define DISPLAYED-FIELDS Almcmov.NroRef Almcmov.usuario ~
Almcmov.CodRef Almcmov.Observ Almcmov.NroDoc Almcmov.FchDoc 
...
DO WITH FRAME {&FRAME-NAME}:
   input-var-1 = "A,B".
   RUN LKUP\C-OPPEN ("Ordenes de Produccion").
