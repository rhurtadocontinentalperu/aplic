...
DEFINE FRAME F-Main
     ...
     x-FchInv AT ROW 4.62 COL 25 COLON-ALIGNED WIDGET-ID 34
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "STOCK INICIAL VALORIZADO"
         HEIGHT             = 10.96
         WIDTH              = 69.14
         MAX-HEIGHT         = 10.96
         MAX-WIDTH          = 69.14
...
ON END-ERROR OF W-Win /* STOCK INICIAL VALORIZADO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* STOCK INICIAL VALORIZADO */
DO:
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH AlmCInv WHERE AlmCInv.CodCia = s-codcia
      AND LOOKUP(AlmCInv.CodAlm,cAlmc) > 0 
      ...
      FOR EACH AlmDInv OF AlmCInv NO-LOCK,
          ...
          X-Dife = X-StkSub.
          DISPLAY "PROCESANDO: " + Almmmatg.codmat + Almmmatg.DesMat 
              @ x-Mensaje 
          ...
          FIND LAST AlmStkGe WHERE AlmStkGe.codcia = s-codcia
              ...
              AND AlmStkGe.fecha <= AlmDInv.Libre_f01 NO-LOCK NO-ERROR.
...
cRange = "C" + '2'.
chWorkSheet:Range(cRange):Value = "STOCK INICIAL VALORIZADO".
...
/* set the column names for the Worksheet */
 ...
 cRange = "G" + cColumn.
 chWorkSheet:Range(cRange):Value = "Costo Unit S/. " .
 cRange = "H" + cColumn.
...
FOR EACH T-Ajuste, FIRST Almtfami NO-LOCK WHERE Almtfami.codcia = s-codcia
    ...
    IF FIRST-OF(t-Ajuste.CodAlm) THEN x-TotAlm = 0.
    ...
    /*
        MESSAGE T-Ajuste.CodMat SKIP
            x-CtoPos SKIP x-TotAlm.
    */
    /*ACCUMULATE x-CtoPos (SUB-TOTAL BY T-Ajuste.CodCia BY T-Ajuste.CodFam).    */
    ...
    cRange = "G" + cColumn.
    chWorkSheet:Range(cRange):Value = T-Ajuste.CtoUni.
    cRange = "H" + cColumn.
    ...
    IF LAST-OF(T-Ajuste.CodFam) THEN DO:
        ...
        /*
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY T-Ajuste.CodFam x-CtoPos.
        */        
    END.
    IF LAST-OF(T-Ajuste.CodAlm) THEN DO:        
        ...
        cColumn = STRING(t-Column).
        cRange = "H" + cColumn.
        chWorkSheet:Range(cRange):Value = "TOTAL ALM: " + T-Ajuste.CodAlm.
        cRange = "I" + cColumn.
...
*/    
  ...
  DEFINE FRAME F-HEADER
    ...
    "STOCK INICIAL VALORIZADO" AT 20 
