...
&Scoped-Define ENABLED-OBJECTS tg-surq x-zona x-codalm BUTTON-1 txt-page ~
txt-page-2 r-imp tg-incsis btn-Excel Btn_Ok Btn_Done RECT-70 
&Scoped-Define DISPLAYED-OBJECTS tg-surq x-zona x-mensaje x-codalm txt-page ~
...
DEFINE VARIABLE tg-surq AS LOGICAL INITIAL no 
     LABEL "Formato Surquillo" 
     VIEW-AS TOGGLE-BOX
     SIZE 20.86 BY .77 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     tg-surq AT ROW 6.04 COL 38 WIDGET-ID 42
     x-zona AT ROW 2.58 COL 9 COLON-ALIGNED WIDGET-ID 40
     x-mensaje AT ROW 7.46 COL 2 NO-LABEL WIDGET-ID 34
     x-codalm AT ROW 1.65 COL 9 COLON-ALIGNED WIDGET-ID 30
     BUTTON-1 AT ROW 1.69 COL 63.57 WIDGET-ID 32
     txt-page AT ROW 3.85 COL 18 COLON-ALIGNED WIDGET-ID 24
     txt-page-2 AT ROW 3.81 COL 32.57 COLON-ALIGNED WIDGET-ID 26
     r-imp AT ROW 5.04 COL 6 NO-LABEL WIDGET-ID 16
     tg-incsis AT ROW 5.31 COL 38 WIDGET-ID 28
     btn-Excel AT ROW 8.69 COL 34.57 WIDGET-ID 20
     Btn_Ok AT ROW 8.69 COL 46.57
     Btn_Done AT ROW 8.69 COL 58.57
     "Nº Página" VIEW-AS TEXT
          SIZE 7.86 BY .5 AT ROW 4.08 COL 6 WIDGET-ID 8
     RECT-70 AT ROW 8.46 COL 1 WIDGET-ID 22
...
DO:
  ASSIGN x-CodAlm txt-page txt-page-2 r-imp tg-incsis x-zona tg-surq.
  RUN Carga-Temporal.
  RUN Imprime.    
  DISPLAY "" @ x-mensaje WITH FRAME {&FRAME-NAME}.
END.
...
FOR EACH Almacen WHERE Almacen.codcia = s-codcia
    ...
    FOR EACH AlmDInv WHERE AlmDInv.CodCia = Almacen.CodCia
...
------------------------------------------------------------------------------*/
  DISPLAY tg-surq x-zona x-mensaje x-codalm txt-page txt-page-2 r-imp tg-incsis 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE tg-surq x-zona x-codalm BUTTON-1 txt-page txt-page-2 r-imp tg-incsis 
         btn-Excel Btn_Ok Btn_Done RECT-70 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  ELSE DO:
      IF tg-surq THEN DO:
          IF r-imp = 1 THEN RB-REPORT-NAME = 'Listado de Conteo_Surq'.
          ELSE RB-REPORT-NAME = 'Listado de Conteo_Surq Draft'.
      END.
      ELSE DO:
