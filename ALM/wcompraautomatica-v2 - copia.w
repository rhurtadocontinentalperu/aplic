...
BUTTON-5 BUTTON-IMPORTAR-EXCEL TOGGLE-todos 
...
FILL-IN-Peso FILL-IN-SubFam x-CodDiv FILL-IN-PorRep FILL-IN-Volumen ~
...
DEFINE VARIABLE TOGGLE-todos AS LOGICAL INITIAL no 
     LABEL "Mostrar todos los articulos" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     BUTTON-Division AT ROW 3.54 COL 115.72 WIDGET-ID 78
     ...
     x-CodDiv AT ROW 4.23 COL 101.29 NO-LABEL WIDGET-ID 110
     ...
     TOGGLE-todos AT ROW 7.81 COL 72.29 WIDGET-ID 116
     BUTTON-Stop-It AT ROW 25.77 COL 55 WIDGET-ID 68
     FILL-IN-Mensaje AT ROW 25.77 COL 62 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     "al calculo de ventas" VIEW-AS TEXT
          SIZE 14.29 BY .58 AT ROW 3.58 COL 101.43 WIDGET-ID 114
          FGCOLOR 12 
     "Divisiones que no entran" VIEW-AS TEXT
          SIZE 17 BY .58 AT ROW 3 COL 101.29 WIDGET-ID 112
          FGCOLOR 12 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_bcompraautomatica ( 8.77 , 2.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_bcompraautomatica ,
             TOGGLE-todos:HANDLE IN FRAME F-Main , 'AFTER':U ).
...
FOR EACH T-MATG NO-LOCK, 
    FIRST T-MATE OF T-MATG NO-LOCK WHERE T-MATE.Libre_c01 <> "*":   /* OJO: NO todos */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Temporada FILL-IN_Grupos COMBO-BOX-Tipo FILL-IN-Total 
          FILL-IN-CodFam SELECT-Clasificacion FILL-IN-Peso FILL-IN-SubFam 
          x-CodDiv FILL-IN-PorRep FILL-IN-Volumen FILL-IN-CodPro FILL-IN-NomPro 
          FILL-IN-PorStkMax FILL-IN-Marca FILL-IN-Stock FILL-IN-Texto 
          FILL-IN-Venta30d FILL-IN-Venta30dy TOGGLE-todos FILL-IN-Mensaje 
  ...
  ENABLE RECT-9 RECT-1 RECT-11 BUTTON-Grupos COMBO-BOX-Tipo BUTTON-4 
         ...
         BUTTON-IMPORTAR-EXCEL TOGGLE-todos 
      WITH FRAME F-Main IN WINDOW W-Win.
