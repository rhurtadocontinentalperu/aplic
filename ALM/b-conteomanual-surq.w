...
&Scoped-define QUERY-STRING-br_table FOR EACH tmp-AlmDInv WHERE ~{&KEY-PHRASE} ~
 ...
 AND tmp-AlmDInv.CodAlm = "10X" NO-LOCK, ~
...
/* Query rebuild information for BROWSE br_table
 ...
 AND Temp-Tables.tmp-AlmDInv.CodAlm = ""10X"""
...
------------------------------------------------------------------------------*/
    ...
    FIND FIRST almcinv WHERE almcinv.codcia = s-codcia
        ...
        AND AlmCInv.NomCia = "UTILEX" NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  FIND LAST tmp-AlmDInv WHERE tmp-AlmDInv.CodCia = s-codcia
      AND tmp-AlmDInv.NomCia = "UTILEX"
      AND tmp-AlmDInv.CodAlm = "10X" NO-LOCK NO-ERROR.
