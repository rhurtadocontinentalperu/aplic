...
&Scoped-define INTERNAL-TABLES VtaCDocu T-VtaCDocu FacCPedi
...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaCDocu WHERE ~{&KEY-PHRASE} ~
      ...
      EACH FacCPedi WHERE vtacdocu.codcia = faccpedi.codcia and ~
vtacdocu.codped = faccpedi.coddoc and ~
substring(vtacdocu.nroped,1,9) = faccpedi.nroped and ~
faccpedi.flgsit <> 'C' NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
faccpedi.flgsit <> 'C' NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaCDocu T-VtaCDocu FacCPedi
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 91 BY 6.69
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaCDocu,Temp-Tables.T-VtaCDocu OF INTEGRAL.VtaCDocu,INTEGRAL.FacCPedi WHERE INTEGRAL.VtaCDocu ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST,"
     _Where[1]         = "{&Condicion}"
     _JoinCode[2]      = "{&Condicion}"
     _JoinCode[3]      = "vtacdocu.codcia = faccpedi.codcia and
vtacdocu.codped = faccpedi.coddoc and
substring(vtacdocu.nroped,1,9) = faccpedi.nroped and
faccpedi.flgsit <> 'C'"
