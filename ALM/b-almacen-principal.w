...
&Scoped-define QUERY-STRING-br_table FOR EACH Almacen WHERE ~{&KEY-PHRASE} ~
 ...
 AND Almacen.AlmPrincipal = TRUE NO-LOCK, ~
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 6.69
         FONT 4
         TITLE "ALMACENES PRINCIPALES" FIT-LAST-COLUMN.
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* ALMACENES PRINCIPALES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* ALMACENES PRINCIPALES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* ALMACENES PRINCIPALES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Captura-Almacen B-table-Win 
PROCEDURE Captura-Almacen :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
