...
&Scoped-Define ENABLED-OBJECTS x-Copias btn-print BUTTON-8 
...
DEFINE VARIABLE x-desc AS CHARACTER FORMAT "X(20)":U INITIAL "ABR-09" 
     LABEL "Cliente" 
     VIEW-AS FILL-IN 
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME L-To-R                                                    */
/* SETTINGS FOR FILL-IN x-desc IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE x-Copias btn-print BUTTON-8 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    FIND FIRST almmmatg WHERE almmmatg.codcia = 1
        AND almmmatg.codmat = '000067' NO-LOCK NO-ERROR.
    IF AVAIL almmmatg THEN MESSAGE almmmatg.desmat.
    DEF VAR rpta AS LOG.
