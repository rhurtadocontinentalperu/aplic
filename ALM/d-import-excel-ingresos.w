...
&Scoped-Define ENABLED-OBJECTS RECT-69 BUTTON-1 BROWSE-2 Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Excel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      t-report.Campo-C[1] COLUMN-LABEL "ARTICULO" FORMAT "X(14)":U
      t-report.Campo-C[2] COLUMN-LABEL "CANTIDAD" FORMAT "X(15)":U
            WIDTH 24.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 42 BY 6.19
         TITLE "A                 |                    B                           |" FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     BUTTON-1 AT ROW 1 COL 4 WIDGET-ID 4
     FILL-IN-Excel AT ROW 1.27 COL 7 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     ...
     "Formato del archivo Excel" VIEW-AS TEXT
          SIZE 23 BY .62 AT ROW 2.62 COL 5 WIDGET-ID 6
          BGCOLOR 9 FGCOLOR 15 
     "La columna A debe estar en formato TEXTO y la B en formato numérico" VIEW-AS TEXT
          SIZE 49 BY .62 AT ROW 9.62 COL 5 WIDGET-ID 8
          FONT 4
     RECT-69 AT ROW 2.88 COL 2 WIDGET-ID 10
     SPACE(2.28) SKIP(1.61)
...
/* SETTINGS FOR DIALOG-BOX D-Dialog
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-2 FILL-IN-Excel D-Dialog */
ASSIGN 
       FRAME D-Dialog:SCROLLABLE       = FALSE
       FRAME D-Dialog:HIDDEN           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-Excel IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
"Campo-C[1]" "ARTICULO" "X(14)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-report.Campo-C[2]
"Campo-C[2]" "CANTIDAD" "X(15)" "character" ? ? ? ? ? ? no ? no no "24.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
DO:
  pArchivo = FILL-IN-Excel:SCREEN-VALUE.
END.
...
DO:
  ...
  FILL-IN-Excel:SCREEN-VALUE = FILL-IN-Archivo .
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Excel 
      WITH FRAME D-Dialog.
  ENABLE RECT-69 BUTTON-1 BROWSE-2 Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
