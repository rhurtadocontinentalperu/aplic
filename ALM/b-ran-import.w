...
&Scoped-Define ENABLED-OBJECTS RECT-30 RECT-31 COMBO-BOX-Marcas ~
COMBO-BOX-Almacen COMBO-BOX-Lineas FILL-IN-PorcReposicion RADIO-SET_Empaque ~
COMBO-BOX-Sector FILL-IN-DesMat COMBO-BOX-SubLineas BUTTON-Limpiar-Orden ~
br_table BUTTON-998 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Marcas COMBO-BOX-Almacen ~
COMBO-BOX-Lineas FILL-IN-PorcReposicion RADIO-SET_Empaque FILL-IN-Inner ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DREPO.AlmPed COLUMN-LABEL "Alm.!Desp." FORMAT "x(5)":U
            WIDTH 5.14 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 190 BY 15.35
...
DEFINE FRAME F-Main
     COMBO-BOX-Marcas AT ROW 1.27 COL 7 COLON-ALIGNED WIDGET-ID 72
     COMBO-BOX-Almacen AT ROW 1.27 COL 46 COLON-ALIGNED WIDGET-ID 80
     COMBO-BOX-Lineas AT ROW 1.27 COL 89 COLON-ALIGNED WIDGET-ID 74
     FILL-IN-PorcReposicion AT ROW 1.27 COL 119 COLON-ALIGNED WIDGET-ID 136
     RADIO-SET_Empaque AT ROW 1.27 COL 141 NO-LABEL WIDGET-ID 144
     FILL-IN-Inner AT ROW 1.27 COL 170 COLON-ALIGNED WIDGET-ID 70
     COMBO-BOX-Sector AT ROW 2.08 COL 7 COLON-ALIGNED WIDGET-ID 88
     FILL-IN-DesMat AT ROW 2.08 COL 46 COLON-ALIGNED WIDGET-ID 90
     COMBO-BOX-SubLineas AT ROW 2.08 COL 89 COLON-ALIGNED WIDGET-ID 76
     FILL-IN-Master AT ROW 2.08 COL 170 COLON-ALIGNED WIDGET-ID 62
     BUTTON-Limpiar-Orden AT ROW 2.88 COL 9 WIDGET-ID 132
     FILL-IN-Reposicion AT ROW 2.88 COL 170 COLON-ALIGNED WIDGET-ID 64
     br_table AT ROW 3.96 COL 1
     FILL-IN-Total AT ROW 20.12 COL 10 COLON-ALIGNED WIDGET-ID 94
     FILL-IN-Peso AT ROW 20.12 COL 27 COLON-ALIGNED WIDGET-ID 96
     FILL-IN-Volumen AT ROW 20.12 COL 44 COLON-ALIGNED WIDGET-ID 98
     FILL-IN-Stock AT ROW 20.12 COL 65 COLON-ALIGNED WIDGET-ID 100
     FILL-IN-Transferencias AT ROW 20.12 COL 84 COLON-ALIGNED WIDGET-ID 102
     FILL-IN-Compras AT ROW 20.12 COL 104 COLON-ALIGNED WIDGET-ID 104
     FILL-IN-Items AT ROW 20.12 COL 120 COLON-ALIGNED WIDGET-ID 118
     BUTTON-998 AT ROW 21.19 COL 55 WIDGET-ID 134
     "F8 : Stocks x Almacenes F7 : Pedidos F9 : Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 62 BY .5 AT ROW 19.58 COL 2 WIDGET-ID 12
          FONT 0
     "F10: Kardex Almacén Despacho  F11: Faltante/Sobrante" VIEW-AS TEXT
          SIZE 54 BY .5 AT ROW 19.58 COL 66 WIDGET-ID 68
          FONT 0
     RECT-30 AT ROW 1 COL 162 WIDGET-ID 140
     RECT-31 AT ROW 1 COL 1 WIDGET-ID 142
...
"T-DREPO.AlmPed" "Alm.!Desp." "x(5)" "character" 11 0 ? ? ? ? yes ? no no "5.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-DREPO.CanReq
"T-DREPO.CanReq" "Cantidad!Requerida" "-ZZZ,ZZ9.99" "decimal" 11 0 ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-DREPO.CanGen
"T-DREPO.CanGen" "Cantidad!Generada" "ZZZ,ZZ9.99" "decimal" 14 0 ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
RUN ARTICULOS-A-SOLICITAR (INPUT T-DREPO.CodMat, INPUT "MAN").
...
IF TRUE <> (pCodRef > '') THEN RETURN 'ADM-ERROR'.
IF TRUE <> (pNroRef > '') THEN RETURN 'ADM-ERROR'.
IF NOT CAN-FIND(FIRST Almcrepo WHERE almcrepo.CodCia = s-codcia
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    /* OJO: SOLO SI HAY DISPONIBLE DESPACHO (DesStkDis > 0) */
    FOR EACH BT-DREPO WHERE {&CondicionX},
        FIRST Almmmatg OF BT-DREPO NO-LOCK,
        FIRST Almmmate OF Almmmatg WHERE Almmmate.CodAlm = s-CodAlm NO-LOCK,
        FIRST Almtfami OF Almmmatg NO-LOCK,
        FIRST AlmSFami OF Almmmatg NO-LOCK 
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST Almmmate WHERE Almmmate.codcia = s-codcia AND
      Almmmate.codmat = T-DREPO.CodMat AND
