...
&Scoped-define INTERNAL-TABLES T-DREPO almdrepo Almmmatg Almmmate
...
Almmmatg.UndBas T-DREPO.StkDisponible @ x-StkDisponible Almmmate.StkMin ~
T-DREPO.StockTransito @ x-StockTransito ~
T-DREPO.CompraTransito @ x-CompraTransito Almmmate.StkMax Almmmatg.CanEmp ~
T-DREPO.StkDisponible-Orig @ x-StkDisponible-Orig 
...
&Scoped-define QUERY-STRING-adbr_table FOR EACH T-DREPO OF almcrepo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST almdrepo WHERE almdrepo.CodCia = T-DREPO.CodCia ~
  AND almdrepo.CodAlm = T-DREPO.CodAlm ~
  AND almdrepo.TipMov = T-DREPO.TipMov ~
  AND almdrepo.NroSer = T-DREPO.NroSer ~
  AND almdrepo.NroDoc = T-DREPO.NroDoc ~
  AND almdrepo.CodMat = T-DREPO.CodMat NO-LOCK, ~
      FIRST Almmmatg OF almdrepo NO-LOCK, ~
      FIRST Almmmate OF almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-adbr_table OPEN QUERY adbr_table FOR EACH T-DREPO OF almcrepo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST almdrepo WHERE almdrepo.CodCia = T-DREPO.CodCia ~
  AND almdrepo.CodAlm = T-DREPO.CodAlm ~
  AND almdrepo.TipMov = T-DREPO.TipMov ~
  AND almdrepo.NroSer = T-DREPO.NroSer ~
  ...
  AND almdrepo.CodMat = T-DREPO.CodMat NO-LOCK, ~
      ...
      FIRST Almmmate OF almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-adbr_table T-DREPO almdrepo Almmmatg ~
Almmmate
&Scoped-define FIRST-TABLE-IN-QUERY-adbr_table T-DREPO
&Scoped-define SECOND-TABLE-IN-QUERY-adbr_table almdrepo
&Scoped-define THIRD-TABLE-IN-QUERY-adbr_table Almmmatg
&Scoped-define FOURTH-TABLE-IN-QUERY-adbr_table Almmmate
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS adbr_table B-table-Win _STRUCTURED
  QUERY adbr_table NO-LOCK DISPLAY
      ...
      T-DREPO.StkDisponible @ x-StkDisponible COLUMN-LABEL "Stk Destino!Disponible" FORMAT "(ZZZ,ZZ9.99)":U
            WIDTH 8
      Almmmate.StkMin COLUMN-LABEL "Stock Máximo!+ Seguridad" FORMAT "ZZZ,ZZ9.99":U
      T-DREPO.StockTransito @ x-StockTransito COLUMN-LABEL "Stock en!Tránsito" FORMAT "-ZZZ,ZZ9.99":U
            WIDTH 7.43
      T-DREPO.CompraTransito @ x-CompraTransito COLUMN-LABEL "Compra en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 7.72
      ...
      Almmmatg.CanEmp COLUMN-LABEL "Empaque!Master" FORMAT "->>,>>9.99":U
            WIDTH 7.14
      T-DREPO.StkDisponible-Orig @ x-StkDisponible-Orig COLUMN-LABEL "Stk Origen!Disponible" FORMAT "(ZZZ,ZZ9.99)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141 BY 22.35
         FONT 4
...
/* Query rebuild information for BROWSE adbr_table
     _TblList          = "Temp-Tables.T-DREPO OF INTEGRAL.almcrepo,INTEGRAL.almdrepo WHERE Temp-Tables.T-DREPO ...,INTEGRAL.Almmmatg OF INTEGRAL.almdrepo,INTEGRAL.Almmmate OF INTEGRAL.almdrepo"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST, FIRST USED, FIRST"
     _JoinCode[2]      = "INTEGRAL.almdrepo.CodCia = Temp-Tables.T-DREPO.CodCia
  AND INTEGRAL.almdrepo.CodAlm = Temp-Tables.T-DREPO.CodAlm
  AND INTEGRAL.almdrepo.TipMov = Temp-Tables.T-DREPO.TipMov
  AND INTEGRAL.almdrepo.NroSer = Temp-Tables.T-DREPO.NroSer
  AND INTEGRAL.almdrepo.NroDoc = Temp-Tables.T-DREPO.NroDoc
  AND INTEGRAL.almdrepo.CodMat = Temp-Tables.T-DREPO.CodMat"
...
"T-DREPO.StkDisponible @ x-StkDisponible" "Stk Destino!Disponible" "(ZZZ,ZZ9.99)" ? ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.StockTransito @ x-StockTransito" "Stock en!Tránsito" "-ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"T-DREPO.CompraTransito @ x-CompraTransito" "Compra en!Tránsito" "ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.StkDisponible-Orig @ x-StkDisponible-Orig" "Stk Origen!Disponible" "(ZZZ,ZZ9.99)" ? 14 0 ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
