...
DEF VAR x-CodCta LIKE Almmmatg.CodCta NO-UNDO.
...
&Scoped-Define ENABLED-FIELDS Almmmatg.DesMat 
...
DEFINE FRAME F-Main
     Almmmatg.codmat AT ROW 1.19 COL 13 COLON-ALIGNED WIDGET-ID 6
          LABEL "Codigo"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     Almmmatg.DesMat AT ROW 1.96 COL 13 COLON-ALIGNED WIDGET-ID 8 FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 57 BY .81
...
DO WITH FRAME {&FRAME-NAME}:
    FIND Almssfami OF Almmmatg NO-LOCK NO-ERROR.
    IF NOT AVAILABLE Almssfami THEN LEAVE rloop.
    /* Buscamos Plantilla */
    FIND Vtactabla WHERE VtaCTabla.CodCia = Almmmatg.codcia 
...
Almmmatg.DesMat:SCREEN-VALUE IN FRAME {&FRAME-NAME} = CAPS(x-DesMat).
