...
FIND FacCfgGn WHERE FacCfgGn.CodCia = S-CODCIA NO-LOCK NO-ERROR.
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      ASSIGN 
          ...
          t-Almcmov.NomRef  = Faccpedi.NomCli
          t-Almcmov.CodRef = Faccpedi.CodDoc
          t-Almcmov.NroRef = Faccpedi.NroPed
          t-Almcmov.NroRf1 = Faccpedi.NroPed
      ...
      ASSIGN 
          t-Almcmov.CodCli = Faccpedi.CodCli
          t-Almcmov.CodMon = Faccpedi.CodMon.
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
      ...
      FOR EACH OOMoviAlmacen NO-LOCK WHERE OOMoviAlmacen.CodCia = t-Almcmov.CodCia
          ...
          FIND FIRST Facdpedi OF Faccpedi WHERE Facdpedi.CodMat = OOMoviAlmacen.CodMat 
          ...
          END.
          ASSIGN 
              Facdpedi.Libre_d05 = Facdpedi.Libre_d05 + (FACTOR * OOMoviAlmacen.CanDes).
      END.
...
/* OJO: NO acumulamos, lo grabamos al detalle incluido el número de serie */
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      FOR EACH LogisDChequeo NO-LOCK WHERE LogisDChequeo.CodCia = s-CodCia
          ...
          FIRST Facdpedi OF Faccpedi NO-LOCK WHERE Facdpedi.codmat = LogisDChequeo.codmat:
          ...
          ASSIGN 
              ...
              OOMoviAlmacen.LinPreUni = ((Facdpedi.ImpLin - Facdpedi.ImpDto2) / Facdpedi.CanPed )
              OOMoviAlmacen.CodAjt = '' 
              OOMoviAlmacen.LinImpLin = ROUND (OOMoviAlmacen.CanDes * OOMoviAlmacen.LinPreUni, 2)
              OOMoviAlmacen.AftIsc = Facdpedi.AftIsc 
              OOMoviAlmacen.AftIgv = Facdpedi.AftIgv 
              /*OOMoviAlmacen.Flg_factor = Facdpedi.Flg_factor*/
              OOMoviAlmacen.HraDoc     = t-Almcmov.HorRcp
              .
          IF OOMoviAlmacen.AftIgv = YES THEN OOMoviAlmacen.LinImpIgv = ROUND(OOMoviAlmacen.LinImpLin / ( 1 + Faccpedi.PorIgv / 100) * Faccpedi.PorIgv / 100, 2).
          ASSIGN
