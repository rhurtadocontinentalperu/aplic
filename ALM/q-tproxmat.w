...
&Scoped-define INTERNAL-TABLES vtapmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH vtapmatg WHERE vtapmatg.codmat = "T" +  almtmatg.codmat ~
  AND vtapmatg.CodCia =  almtmatg.CodCia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH vtapmatg WHERE vtapmatg.codmat = "T" +  almtmatg.codmat ~
  AND vtapmatg.CodCia =  almtmatg.CodCia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main vtapmatg
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main vtapmatg
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.vtapmatg WHERE INTEGRAL.almtmatg ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "vtapmatg.codmat = ""T"" +  almtmatg.codmat
  AND vtapmatg.CodCia =  almtmatg.CodCia"
