...
&Scoped-Define ENABLED-OBJECTS rs-cuales rs-tipo txt-page txt-page-2 r-imp ~
btn-Excel Btn_Ok Btn_Done x-zona x-zona-2 RECT-70 RECT-71 RECT-72 RECT-73 
&Scoped-Define DISPLAYED-OBJECTS rs-cuales rs-tipo x-codalm x-mensaje ~
txt-desalm txt-page txt-page-2 r-imp x-zona x-zona-2 
...
DEFINE VARIABLE rs-cuales AS INTEGER INITIAL 3 
...
DEFINE FRAME F-Main
     rs-cuales AT ROW 4.77 COL 51 NO-LABEL WIDGET-ID 56
     ...
     RECT-73 AT ROW 4.62 COL 49.72 WIDGET-ID 60
...
------------------------------------------------------------------------------*/
    DO WITH FRAME {&FRAME-NAME}:
        ASSIGN 
            x-CodAlm txt-page txt-page-2 r-imp x-zona x-zona-2 rs-tipo rs-cuales.  
    END.    
...
cCodAlm = x-CodAlm.
/* Ic - 22-03-2012 
IF x-zona   = '' THEN cZonaD = 'A*'. ELSE cZonaD = x-zona.
IF x-zona-2 = '' THEN cZonaH = 'ZZ'. ELSE cZonaH = x-zona-2.
*/
...
FOR EACH AlmDInv WHERE AlmDInv.CodCia = s-codcia
    ...
    IF (rs-cuales = 3) OR (rs-cuales = 1 AND almdinv.QtyFisico <> 0) OR (rs-cuales = 2 AND almdinv.QtyFisico = 0) THEN DO:
        CREATE w-report.
        ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY rs-cuales rs-tipo x-codalm x-mensaje txt-desalm txt-page txt-page-2 
          r-imp x-zona x-zona-2 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE rs-cuales rs-tipo txt-page txt-page-2 r-imp btn-Excel Btn_Ok Btn_Done 
         x-zona x-zona-2 RECT-70 RECT-71 RECT-72 RECT-73 
      WITH FRAME F-Main IN WINDOW W-Win.
