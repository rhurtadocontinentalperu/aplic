...
DEFINE FRAME F-Main
     ...
     "Impresión de Etiquetas Continental" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
    ...
    PUT STREAM REPORTE 'HECHO EN PERÚ por Continental SAC RUC20100038146 Calle René Descartes Mz.C.Lt.1' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */

    PUT STREAM REPORTE '^FO135,30'                      SKIP.   /* Coordenadas de origen campo1 */
    PUT STREAM REPORTE '^A0N,25,15'                    SKIP.
    PUT STREAM REPORTE '^FD'.
    PUT STREAM REPORTE 'Santa Raquel II etapa Ate Lima Perú Teléfono:(511)715-8888 www.standford.com.pe' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */

    PUT STREAM REPORTE '^FO135,55'                      SKIP.   /* Coordenadas de origen campo1 */
    PUT STREAM REPORTE '^A0N,25,15'                    SKIP.
    PUT STREAM REPORTE '^FD'.
    PUT STREAM REPORTE 'Importado por: Lápices y Útiles Mexicanos S.A. de C.V. Av. Paseo de las Palmas' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */
    
    PUT STREAM REPORTE '^FO135,80'                      SKIP.   /* Coordenadas de origen campo1 */
    PUT STREAM REPORTE '^A0N,25,15'                    SKIP.
    PUT STREAM REPORTE '^FD'.
    PUT STREAM REPORTE '755 Piso 4, Col. Lomas de Chapultepec, C.P. 11000, Delegación Miguel Hidalgo,' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */
    
    PUT STREAM REPORTE '^FO135,105'                      SKIP.   /* Coordenadas de origen campo1 */
    PUT STREAM REPORTE '^A0N,25,15'                    SKIP.
    PUT STREAM REPORTE '^FD'.
    PUT STREAM REPORTE 'México, D.F. RFC LUM101018766, Teléfono (52) (55) 52842434' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */

    PUT STREAM REPORTE '^FO135,130'                      SKIP.   /* Coordenadas de origen campo1 */
    PUT STREAM REPORTE '^A0N,25,15'                    SKIP.
    PUT STREAM REPORTE '^FD'.
    PUT STREAM REPORTE 'CUADERNO PROFESIONAL de 21x28 cm. Fabricado con Papel Bond de 70g/m2' SKIP.
    PUT STREAM REPORTE '^FS'                           SKIP.   /* Fin de Campo1 */
