...
Almmmatg.CodFam Almmmatg.SubFam almdrepo.CanGen almdrepo.CanApro ~
fAtendido(Almcrepo.AlmPed,almdrepo.CodMat, 'R/A', STRING(almdrepo.NroSer,'999') + STRING(almdrepo.NroDoc,'999999') ) @ x-CanAte ~
Almmmatg.Pesmat Almmmatg.Libre_d02 / 1000000 @ Almmmatg.Libre_d02 ~
almdrepo.Origen 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      almdrepo.CanGen FORMAT "ZZZ,ZZ9.9999":U
      almdrepo.CanApro FORMAT "-Z,ZZZ,ZZ9.9999":U WIDTH 10.29
      fAtendido(Almcrepo.AlmPed,almdrepo.CodMat, 'R/A', STRING(almdrepo.NroSer,'999') + STRING(almdrepo.NroDoc,'999999') ) @ x-CanAte COLUMN-LABEL "Cantidad!Atendida" FORMAT "-Z,ZZZ,ZZ9.9999":U
            WIDTH 10.43
...
"Almmmatg.SubFam" "Subfamilia" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = INTEGRAL.almdrepo.CanGen
     _FldNameList[11]   > INTEGRAL.almdrepo.CanApro
"almdrepo.CanApro" ? "-Z,ZZZ,ZZ9.9999" "decimal" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > "_<CALC>"
"fAtendido(Almcrepo.AlmPed,almdrepo.CodMat, 'R/A', STRING(almdrepo.NroSer,'999') + STRING(almdrepo.NroDoc,'999999') ) @ x-CanAte" "Cantidad!Atendida" "-Z,ZZZ,ZZ9.9999" ? ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.Libre_d02 / 1000000 @ Almmmatg.Libre_d02" "Vol!cm3" ">>,>>9.9999" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   = INTEGRAL.almdrepo.Origen
