...
btn-consulta txt-almvirtual txt-codalmac br_table btn-ingresa btn-grabar ~
btn-cancelar btn-exit-2 
&Scoped-Define DISPLAYED-OBJECTS txt-page txt-totpag txt-almvirtual ~
txt-codalmac 
...
DEFINE FRAME F-Main
     txt-page AT ROW 1.54 COL 37 COLON-ALIGNED WIDGET-ID 36
     txt-totpag AT ROW 1.54 COL 56.43 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     btn-consulta AT ROW 1.54 COL 99.72 WIDGET-ID 8
     txt-almvirtual AT ROW 1.58 COL 15 COLON-ALIGNED WIDGET-ID 64
     txt-codalmac AT ROW 2.81 COL 13 COLON-ALIGNED WIDGET-ID 24
     ...
     "Total Pág:" VIEW-AS TEXT
          SIZE 8.72 BY .5 AT ROW 1.69 COL 49 WIDGET-ID 60
          FONT 6
     RECT-67 AT ROW 1.27 COL 2 WIDGET-ID 32
     RECT-68 AT ROW 4.35 COL 2 WIDGET-ID 34
...
------------------------------------------------------------------------------*/
    ...
    FIND AlmCInv WHERE AlmCInv.CodCia = s-CodCia
        AND TRIM(AlmCInv.CodAlm) =  txt-almvirtual /*"11x"*/
