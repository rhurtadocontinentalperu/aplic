...
DEFINE VARIABLE h_b-artalmv2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-artalmv2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Familia':U ,
             OUTPUT h_b-artalmv2 ).
       RUN set-position IN h_b-artalmv2 ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-artalmv2 ( 18.08 , 102.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_b-artalmv2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_b-artalmv2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_b-artalmv2 , 'AFTER':U ).
    END. /* Page 0 */
