...
&Scoped-Define DISPLAYED-OBJECTS rbGrabarReg txt-porcentaje txt-valorizado ~
r-queimprimir rs_cant rs_concuales x-codalm txt-desalm x-zona x-zona-2 ~
x-sup x-sup-2 r-pages x-nropages r-imp x-mensaje 
...
DEFINE FRAME F-Main
     rbGrabarReg AT ROW 10.42 COL 29 WIDGET-ID 110
     ...
     r-pages AT ROW 10.42 COL 4 NO-LABEL WIDGET-ID 52
     x-nropages AT ROW 11.58 COL 11 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     r-imp AT ROW 13.96 COL 6 NO-LABEL WIDGET-ID 16
     x-mensaje AT ROW 15.12 COL 3.29 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     btn-Excel AT ROW 16.15 COL 35.43 WIDGET-ID 68
     Btn_Ok AT ROW 16.15 COL 47.43 WIDGET-ID 64
     Btn_Done AT ROW 16.15 COL 59.57
     "Ingrese número de páginas o rango de páginas separadas" VIEW-AS TEXT
          SIZE 41 BY .5 AT ROW 12.38 COL 13 WIDGET-ID 60
     "por coma. Por ejemplo:1,2,5-10." VIEW-AS TEXT
          SIZE 41 BY .5 AT ROW 13 COL 13 WIDGET-ID 48
     "Rango Páginas" VIEW-AS TEXT
          SIZE 11.72 BY .5 AT ROW 9.77 COL 3.57 WIDGET-ID 58
          FGCOLOR 1 
     ...
     RECT-71 AT ROW 16.04 COL 2.86 WIDGET-ID 24
     RECT-75 AT ROW 13.88 COL 2 WIDGET-ID 46
     RECT-72 AT ROW 9.96 COL 2 WIDGET-ID 50
...
------------------------------------------------------------------------------*/
  DISPLAY rbGrabarReg txt-porcentaje txt-valorizado r-queimprimir rs_cant 
          rs_concuales x-codalm txt-desalm x-zona x-zona-2 x-sup x-sup-2 r-pages 
          x-nropages r-imp x-mensaje 
