...
Almmmatg.DesMat Almmmatg.UndStk ITEM.CanDes 
...
"Temp-Tables.ITEM.codmat" "Codigo Salida" "X(14)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMat
"INTEGRAL.Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "61.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
