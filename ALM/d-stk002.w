...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "DIFERENCIAS ENTRE SALDO CONTABLE Y LOGISTICO"
         HEIGHT             = 10.92
         WIDTH              = 80
         MAX-HEIGHT         = 26
         MAX-WIDTH          = 137.14
...
ON END-ERROR OF W-Win /* DIFERENCIAS ENTRE SALDO CONTABLE Y LOGISTICO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* DIFERENCIAS ENTRE SALDO CONTABLE Y LOGISTICO */
DO:
...
------------------------------------------------------------------------------*/
  DEFINE FRAME F-REPORTE
    DETALLE.codmat LABEL "Codigo"
    DETALLE.desmat LABEL "Descripcion"
    DETALLE.StkCbd LABEL "Stock Contable"   FORMAT '->>>,>>>,>>9.99'
    DETALLE.StkLog LABEL "Stock Logistico"  FORMAT '->>>,>>>,>>9.99'
  WITH WIDTH 110 NO-BOX STREAM-IO DOWN. 

  DEFINE FRAME F-HEADER
         HEADER
         {&Prn2} + {&Prn7A} + {&Prn6A} + S-NOMCIA + {&Prn7B} + {&Prn6A} + {&Prn3} FORMAT "X(50)" AT 1 SKIP
         "DIFERENCIAS ENTRE SALDO CONTABLE Y LOGISTICO" AT 30 
