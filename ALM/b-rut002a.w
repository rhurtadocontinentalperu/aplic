...
DI-RutaD.HorPar fEstado() @ x-Estado 
...
DEFINE MENU POPUP-MENU-br_table 
       ...
       MENU-ITEM m_Devolucion_Total LABEL "Devolucion Total"
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 8.08
...
&Scoped-define SELF-NAME m_Devolucion_Total
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Devolucion_Total B-table-Win
ON CHOOSE OF MENU-ITEM m_Devolucion_Total /* Devolucion Total */
DO:
  FIND CURRENT Di-RutaD EXCLUSIVE-LOCK NO-ERROR.
  IF NOT AVAILABLE Di-RutaD THEN RETURN.
  ASSIGN
