...
/* *************************************************** */
/* IF x-Empaque > 0 AND (pReposicion MODULO x-Empaque) > 0 THEN DO: */
/*     dFactor = pReposicion / x-Empaque.                               */
...
FOR EACH Almrepos NO-LOCK WHERE Almrepos.CodCia = s-codcia
    ...
    x-StockDisponible = T-MATE-2.StkAct - T-MATE-2.StkMin + T-MATE-2.StkRep.
