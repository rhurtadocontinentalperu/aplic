...
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-1 FILL-IN-Mensaje 
...
"Desde ayer", 1,
"Hace una semana", 7,
"Mas de una semana", 365
     SIZE 23 BY 3.77 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     RADIO-SET-1 AT ROW 1.54 COL 25 NO-LABEL WIDGET-ID 2
     FILL-IN-Mensaje AT ROW 5.85 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     Btn_OK AT ROW 7.46 COL 3
     Btn_Cancel AT ROW 7.46 COL 19
     "Artículos Creados:" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1.81 COL 3 WIDGET-ID 6
     SPACE(42.13) SKIP(8.02)
...
DO:
  ...
  FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.CodCia = s-CodCia
      AND Almmmatg.FchIng >= (TODAY - RADIO-SET-1):
      FILL-IN-Mensaje:SCREEN-VALUE IN FRAME {&FRAME-NAME} = 'PROCESANDO: ' + Almmmatg.codmat.
      RUN ALM_Materiales-por-Almacen IN hProc (INPUT Almmmatg.CodMat,
                                               OUTPUT pMensaje).
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-1 FILL-IN-Mensaje 
      WITH FRAME D-Dialog.
