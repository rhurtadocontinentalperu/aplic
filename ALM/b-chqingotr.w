...
------------------------------------------------------------------------------*/
  ...
  DEFINE VAR lRowIdAlmcmov AS ROWID.
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR'
      ...
      /* Barremos todas la G/R x Sal Transf de la OTR */
      FIND Almtdocm WHERE Almtdocm.CodCia = Faccpedi.CodCia 
          AND Almtdocm.CodAlm = Faccpedi.CodCli 
          AND Almtdocm.TipMov = "I" 
          AND Almtdocm.CodMov = 03
          EXCLUSIVE-LOCK NO-ERROR.
      IF ERROR-STATUS:ERROR THEN DO:
          MESSAGE 'NO se pudo bloquera el correlativo I-03 del almacén' Faccpedi.codcli
              VIEW-AS ALERT-BOX ERROR.
          UNDO CICLO, RETURN 'ADM-ERROR'.
      END.
      FOR EACH B-CMOV WHERE B-CMOV.codcia = s-codcia
          ...
          ASSIGN 
              ...
              Almcmov.AlmDes  = B-CMOV.CodAlm     /* OJO */
              ...
              Almcmov.NomRef  = Almacen.Descripcion.
                ...
                lRowIdAlmcmov = ROWID(almcmov).
          ASSIGN 
              B-CMOV.FlgSit  = "R"      /* OTR Recepcionado */
...
OCXFile = SEARCH( "b-chqingotr.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "b-chqingotr.wrx":U SKIP(1)
