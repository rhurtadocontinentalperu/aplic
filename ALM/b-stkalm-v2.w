...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      t-StkTransito FORMAT "->>,>>>,>>9.99<<<" COLUMN-LABEL 'Tránsito'
      t-StkMaximo   FORMAT "->>,>>>,>>9.99<<<" COLUMN-LABEL 'Máximo' COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH Almmmate NO-LOCK WHERE Almmmate.codcia = s-codcia
      ...
      FIRST Almacen OF Almmmate NO-LOCK WHERE Almacen.Campo-C[9] <> "I"     /* Solo Activos */
          AND Almacen.Campo-C[6] = "Si"     /* Almacén Comercial */
          AND Almacen.FlgRep = YES:         /* Almacén Propio */
      CREATE t-Almacen.
      ASSIGN
