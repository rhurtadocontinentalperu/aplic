...
&Scoped-Define ENABLED-FIELDS vtapmatg.Periodo 
...
FILL-IN_DesMat-2 FILL-IN-UndBas-1 FILL-IN-CodMat-1 FILL-IN_PMaxMn2 ~
FILL-IN-UndBas-2 FILL-IN-CodMat-2 
...
DEFINE FRAME F-Main
     vtapmatg.Periodo AT ROW 1 COL 17 COLON-ALIGNED WIDGET-ID 14
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     vtapmatg.codmat AT ROW 2.08 COL 17 COLON-ALIGNED WIDGET-ID 72 FORMAT "X(7)"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
...
"por Proyeccion", "P":U
     ...
     FILL-IN-UndBas-1 AT ROW 5.85 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 78
     FILL-IN-CodMat-1 AT ROW 5.85 COL 13 COLON-ALIGNED NO-LABEL WIDGET-ID 96
     ...
     FILL-IN-CodMat-2 AT ROW 5.85 COL 54 COLON-ALIGNED NO-LABEL WIDGET-ID 98
...
DEFINE FRAME F-Main
     ...
     "de" VIEW-AS TEXT
          SIZE 3 BY .81 AT ROW 5.85 COL 12 WIDGET-ID 94
     "de" VIEW-AS TEXT
          SIZE 3 BY .81 AT ROW 5.85 COL 53 WIDGET-ID 100
     "Tipo:" VIEW-AS TEXT
          SIZE 4 BY .5 AT ROW 3.15 COL 14 WIDGET-ID 68
     "1" VIEW-AS TEXT
          SIZE 2 BY .81 AT ROW 5.85 COL 5 WIDGET-ID 80
...
/* SETTINGS FOR FILL-IN vtapmatg.PorProy[10] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[10]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[11] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[11]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[12] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[12]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[1] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[1]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[2] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[2]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[3] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[3]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[4] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[4]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[5] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[5]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[6] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[6]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[7] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[7]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[8] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[8]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR FILL-IN vtapmatg.PorProy[9] IN FRAME F-Main
   NO-DISPLAY NO-ENABLE EXP-LABEL                                       */
ASSIGN 
       vtapmatg.PorProy[9]:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR RADIO-SET vtapmatg.Tipo IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  FIND Almtmatg WHERE Almtmatg.codcia = VTapmatg.codcia
      AND Almtmatg.codmat = SUBSTRING(Vtapmatg.codmat,2,6) 
      EXCLUSIVE-LOCK NO-ERROR.
  IF NOT AVAILABLE Almtmatg THEN DO:
      UNDO, RETURN 'ADM-ERROR'.
  END.
  ASSIGN
      Almtmatg.codant = FILL-IN_CodAnt:SCREEN-VALUE IN FRAME {&FRAME-NAME}
      Almtmatg.pmaxmn2 = DECIMAL(FILL-IN_PMaxMn2:SCREEN-VALUE IN FRAME {&FRAME-NAME})
      vtapmatg.CodEqu = FILL-IN_CodAnt:SCREEN-VALUE IN FRAME {&FRAME-NAME}
      vtapmatg.Factor = DECIMAL(FILL-IN_PMaxMn2:SCREEN-VALUE IN FRAME {&FRAME-NAME}).
  RELEASE Almtmatg.
  ...
  IF AVAILABLE Vtapmatg THEN DO WITH FRAME {&FRAME-NAME}:
      ...
      IF AVAILABLE ALmtmatg THEN DO:
          DISPLAY
              ...
              Almtmatg.codant @ FILL-IN_codant
              Almtmatg.pmaxmn2 @ FILL-IN_pmaxmn2
