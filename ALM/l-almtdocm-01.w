...
AND Almtdocm.CodAlm = input-var-1 ~
AND Almtdocm.Tipmov = input-var-2

&SCOPED-DEFINE CODIGO Almtdocm.Codmov 
...
&Scoped-define FIELDS-IN-QUERY-br_table Almtdocm.CodMov Almtmovm.Desmov 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Almtdocm WHERE ~{&KEY-PHRASE} ~
      AND {&condicion} NO-LOCK, ~
      EACH Almtmovm OF Almtdocm NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almtdocm WHERE ~{&KEY-PHRASE} ~
      AND {&condicion} NO-LOCK, ~
      EACH Almtmovm OF Almtdocm NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Almtdocm Almtmovm
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Almtdocm
...
<SORTBY-OPTIONS>
Codigo|y||INTEGRAL.Almtdocm.CodMov|yes
Descripcion|||INTEGRAL.Almtmovm.Desmov|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Almtdocm,INTEGRAL.Almtmovm OF INTEGRAL.Almtdocm"
  ...
  AND Almtdocm.CodAlm = S-CODALM"
     _FldNameList[1]   = INTEGRAL.Almtdocm.CodMov
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtdocm.CodMov
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripcion':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmovm.Desmov
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}}.desmov.
