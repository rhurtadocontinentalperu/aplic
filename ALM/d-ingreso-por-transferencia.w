...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX_Zona FILL-IN-Bultos Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX_Zona FILL-IN-Bultos ~
FILL-IN_CodDoc FILL-IN_NroPed FILL-IN_FchPed FILL-IN_CodCli FILL-IN_NomCli ~
FILL-IN_Items 
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN_CodDoc AT ROW 4.5 COL 51 COLON-ALIGNED WIDGET-ID 10
     FILL-IN_NroPed AT ROW 6.12 COL 51 COLON-ALIGNED WIDGET-ID 18
     FILL-IN_FchPed AT ROW 7.73 COL 51 COLON-ALIGNED WIDGET-ID 12
     FILL-IN_CodCli AT ROW 9.35 COL 51 COLON-ALIGNED HELP
          "C¢digo del Cliente" WIDGET-ID 8
     FILL-IN_NomCli AT ROW 10.96 COL 51 COLON-ALIGNED HELP
          "Nombre del Cliente" WIDGET-ID 16
     FILL-IN_Items AT ROW 12.58 COL 51 COLON-ALIGNED WIDGET-ID 14
     Btn_OK AT ROW 15 COL 3 WIDGET-ID 36
     Btn_Cancel AT ROW 15 COL 22 WIDGET-ID 34
     SPACE(103.42) SKIP(0.69)
...
/* SETTINGS FOR FILL-IN FILL-IN_CodCli IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_CodDoc IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN_NomCli IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_NroPed IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX_Zona FILL-IN-Bultos FILL-IN_CodDoc FILL-IN_NroPed 
          FILL-IN_FchPed FILL-IN_CodCli FILL-IN_NomCli FILL-IN_Items 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX_Zona FILL-IN-Bultos Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FIND Faccpedi WHERE Faccpedi.codcia = s-codcia
          ...
          NO-LOCK NO-ERROR.
      FILL-IN_CodDoc = Almcmov.codref.
      FILL-IN_NroPed = Almcmov.nroref.
      FILL-IN_FchPed = Faccpedi.fchped.
      FILL-IN_Items = Faccpedi.items.
      FILL-IN_CodCli = Almcmov.AlmacenXD.
