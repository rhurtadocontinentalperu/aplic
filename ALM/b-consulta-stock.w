...
DEFINE FRAME F-Main
     ...
     "F8 : Stocks x Almacenes F7 : Pedidos F9 : Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 67 BY .5 AT ROW 24.42 COL 4 WIDGET-ID 6
          FONT 0
...
/*     FIND FIRST {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} WHERE {&Condicion2} AND */
...
/*         RETURN.                                                               */
/*     END.                                                                      */
    FIND FIRST {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} WHERE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodCia = s-CodCia AND
        {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodMat = pCodMat
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} OR
        NOT ({&Condicion2}) THEN DO:
        MESSAGE "Registro no encontrado" VIEW-AS ALERT-BOX ERROR.
        SELF:SCREEN-VALUE = "".
        RETURN.
    END.
    FIND FIRST {&SECOND-TABLE-IN-QUERY-{&BROWSE-NAME}} OF
        {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} WHERE {&Condicion}
        NO-LOCK NO-ERROR.
