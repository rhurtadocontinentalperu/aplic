...
&Scoped-Define DISPLAYED-OBJECTS DesdeC desdeF hastaF C-Tipmov I-CodMov ~
F-DESMAT F-NomDes N-MOVI F-AlmDes 
...
DEFINE FRAME F-Main
     DesdeC AT ROW 1.58 COL 8 COLON-ALIGNED
     desdeF AT ROW 2.35 COL 8 COLON-ALIGNED
     hastaF AT ROW 2.35 COL 26.72 COLON-ALIGNED
     C-Tipmov AT ROW 3.15 COL 8 COLON-ALIGNED
     I-CodMov AT ROW 3.19 COL 17.86 COLON-ALIGNED NO-LABEL
     Btn_OK AT ROW 5.46 COL 15.57
     Btn_Cancel AT ROW 5.46 COL 37.43
     F-DESMAT AT ROW 1.58 COL 16.43 COLON-ALIGNED NO-LABEL
     F-NomDes AT ROW 4.08 COL 14.72 COLON-ALIGNED NO-LABEL
     N-MOVI AT ROW 3.19 COL 22 COLON-ALIGNED NO-LABEL
     F-AlmDes AT ROW 4.08 COL 8 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Analisis de Movimiento-Articulo General Valorizado"
         HEIGHT             = 6.27
         WIDTH              = 54.43
         MAX-HEIGHT         = 10.92
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* Analisis de Movimiento-Articulo General Valorizado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Analisis de Movimiento-Articulo General Valorizado */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY DesdeC desdeF hastaF C-Tipmov I-CodMov F-DESMAT F-NomDes N-MOVI 
          F-AlmDes 
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-REP
         ...
         Almdmov.Nrodoc                         COLUMN-LABEL 'NroDoc'
         Almdmov.AlmOri  FORMAT "X(5)"          COLUMN-LABEL 'Proc!Dest'
         Almdmov.FchDoc  FORMAT "99/99/9999"    COLUMN-LABEL 'Fecha'
         Almcmov.NomRef  FORMAT 'X(35)'         COLUMN-LABEL 'R e f e r e n c i a s'
         Almcmov.Nrorf1                         COLUMN-LABEL ''
         x-NroRf1                               COLUMN-LABEL ''
         Almcmov.Usuario                        COLUMN-LABEL 'Usuario'
         Almdmov.CodUnd                         COLUMN-LABEL 'Unid'
         Almdmov.CanDes  FORMAT "(>,>>>,>>9.99)"    COLUMN-LABEL 'Cantidad'
         Almdmov.PreUni  FORMAT "(>,>>>,>>9.9999)"  COLUMN-LABEL 'Precio Unitario'
         x-Importe       FORMAT "(>,>>>,>>9.99)"    COLUMN-LABEL 'Valorizacion'
  ...
  DEFINE FRAME H-REP
      ...
      /*
         "--------------------------------------------------------------------------------------------------------------------------------------------" SKIP
         "Alm NroDoc Proc/Dest Fecha       R e f e r e n c i a s                      Usuario  Unid        Cantidad         Precio Uni    Valorizacion" SKIP
         "--------------------------------------------------------------------------------------------------------------------------------------------" SKIP
      */
/*
...
*/
  ...
  FOR EACH Almacen WHERE Almacen.codcia = s-codcia NO-LOCK:
    FOR EACH Almdmov NO-LOCK WHERE Almdmov.CodCia = S-CODCIA AND  
          ...
          /* rhc 17.04.09 */
          x-nrorf1 = ''.
          IF almcmov.nrorf1 BEGINS 'G' THEN DO:
              FIND FIRST ccbcdocu WHERE ccbcdocu.codcia = s-codcia
                  AND ccbcdocu.codref = 'G/R'
                  AND ccbcdocu.nroref = SUBSTRING(almcmov.nrorf1,2)
                  NO-LOCK NO-ERROR.
              IF AVAILABLE ccbcdocu THEN x-nrorf1 = SUBSTRING(ccbcdocu.coddoc,1,1) +
                  ccbcdocu.nrodoc.
          END.
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
   ENABLE ALL EXCEPT N-MOVI F-Desmat F-Nomdes.
