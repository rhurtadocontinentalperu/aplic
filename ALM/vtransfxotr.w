...
DEFINE FRAME F-Main
     ...
     Almcmov.CodRef AT ROW 2.73 COL 13 COLON-ALIGNED WIDGET-ID 40
          ...
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     Almcmov.NroRef AT ROW 2.73 COL 18 COLON-ALIGNED NO-LABEL WIDGET-ID 42 FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     ...
     FILL-IN-Urgente AT ROW 4.27 COL 78 COLON-ALIGNED NO-LABEL WIDGET-ID 46
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH Facdpedi OF Faccpedi NO-LOCK WHERE ( Facdpedi.CanPed - Facdpedi.CanAte > 0 ):
          ...
          IF NOT AVAILABLE Almmmate THEN DO:
              MESSAGE 'Material' Facdpedi.codmat 'NO asignado al almacén' s-codalm SKIP
                  'Proceso Abortado'
...
/*                                          (Facdpedi.CanPed - Facdpedi.CanAte) ). */
          ...
          ASSIGN 
              ...
              ITEM.StkAct = (Facdpedi.CanPed - Facdpedi.CanAte).  /* OJO: TOPE */
      END.
      DISPLAY
