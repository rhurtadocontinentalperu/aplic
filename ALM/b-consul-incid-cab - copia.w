...
&Scoped-define INTERNAL-TABLES AlmCIncidencia Almacen B-Almacen PL-PERS
...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCIncidencia WHERE ~{&KEY-PHRASE} ~
  ...
  AND Almacen.CodAlm = AlmCIncidencia.AlmOri OUTER-JOIN NO-LOCK, ~
      FIRST B-Almacen WHERE B-Almacen.CodCia = AlmCIncidencia.CodCia ~
  AND B-Almacen.CodAlm = AlmCIncidencia.AlmDes OUTER-JOIN NO-LOCK, ~
      FIRST PL-PERS WHERE PL-PERS.CodCia = AlmCIncidencia.CodCia ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH AlmCIncidencia WHERE ~{&KEY-PHRASE} ~
  ...
  AND PL-PERS.codper = AlmCIncidencia.ChkAlmOri OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table AlmCIncidencia Almacen B-Almacen ~
PL-PERS
...
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table PL-PERS
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.AlmCIncidencia,INTEGRAL.Almacen WHERE INTEGRAL.AlmCIncidencia ...,B-Almacen WHERE INTEGRAL.AlmCIncidencia ...,INTEGRAL.PL-PERS WHERE INTEGRAL.AlmCIncidencia ..."
  ...
  AND Almacen.CodAlm = AlmCIncidencia.AlmOri"
     _JoinCode[3]      = "B-Almacen.CodCia = AlmCIncidencia.CodCia
  AND B-Almacen.CodAlm = AlmCIncidencia.AlmDes"
     _JoinCode[4]      = "INTEGRAL.PL-PERS.CodCia = AlmCIncidencia.CodCia
