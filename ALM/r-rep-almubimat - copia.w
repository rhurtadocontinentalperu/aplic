...
COMBO-BOX_CodUbi FILL-IN_Pasaje FILL-IN_Piso BUTTON-2 BtnDone 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX_CodAlm FILL-IN_CodMat ~
FILL-IN_DesMat COMBO-BOX_CodUbi FILL-IN_Pasaje FILL-IN_Piso 
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX_CodUbi AT ROW 2.88 COL 9 COLON-ALIGNED WIDGET-ID 8
     FILL-IN_Pasaje AT ROW 3.69 COL 9 COLON-ALIGNED WIDGET-ID 10
     FILL-IN_Piso AT ROW 4.5 COL 9 COLON-ALIGNED WIDGET-ID 12
...
DO:
    COMBO-BOX_CodUbi:DELETE(COMBO-BOX_CodUbi:LIST-ITEM-PAIRS).
    COMBO-BOX_CodUbi:ADD-LAST('Todas','Todas').
    FOR EACH Almtubic NO-LOCK WHERE Almtubic.codcia = s-codcia
        AND Almtubic.codalm = COMBO-BOX_CodAlm:SCREEN-VALUE:
        COMBO-BOX_CodUbi:ADD-LAST(almtubic.CodUbi + ' - ' + almtubic.DesUbi, Almtubic.codubi).
    END.
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX_CodAlm FILL-IN_CodMat FILL-IN_DesMat COMBO-BOX_CodUbi 
          FILL-IN_Pasaje FILL-IN_Piso 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE COMBO-BOX_CodAlm FILL-IN_CodMat COMBO-BOX_CodUbi FILL-IN_Pasaje 
         FILL-IN_Piso BUTTON-2 BtnDone 
      WITH FRAME F-Main IN WINDOW W-Win.
