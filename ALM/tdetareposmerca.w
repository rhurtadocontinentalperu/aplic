...
DEFINE TEMP-TABLE t-almdrepo NO-UNDO LIKE almdrepo.
...
&Scoped-define INTERNAL-TABLES t-almdrepo Almmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table t-almdrepo.CodMat Almmmatg.DesMat ~
Almmmatg.DesMar Almmmatg.UndBas fClfGral('GENERAL') @ x-ClfGral ~
fClfGral('UTILEX') @ x-ClfUtilex fClfGral('MAYORISTA') @ x-ClfMay ~
Almmmatg.codfam Almmmatg.subfam t-almdrepo.CanGen t-almdrepo.CanApro ~
t-almdrepo.CanAten Almmmatg.Pesmat ~
Almmmatg.Libre_d02 / 1000000 @ Almmmatg.Libre_d02 t-almdrepo.Origen 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH t-almdrepo WHERE TRUE NO-LOCK, ~
      FIRST Almmmatg OF t-almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH t-almdrepo WHERE TRUE NO-LOCK, ~
      FIRST Almmmatg OF t-almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table t-almdrepo Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-br_table t-almdrepo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      t-almdrepo.CodMat COLUMN-LABEL "<Codigo>" FORMAT "X(6)":U
      ...
      t-almdrepo.CanGen FORMAT "ZZZ,ZZ9.9999":U
      t-almdrepo.CanApro FORMAT "Z,ZZZ,ZZ9.9999":U
      t-almdrepo.CanAten FORMAT "ZZZ,ZZ9.9999":U
      Almmmatg.Pesmat FORMAT "->>,>>9.9999":U
      Almmmatg.Libre_d02 / 1000000 @ Almmmatg.Libre_d02 COLUMN-LABEL "Vol!cm3" FORMAT ">>,>>9.9999":U
      t-almdrepo.Origen FORMAT "x(3)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 142 BY 8.08
         FONT 4.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: t-almdrepo T "?" NO-UNDO INTEGRAL almdrepo
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.t-almdrepo WHERE INTEGRAL.almcrepo ...,INTEGRAL.Almmmatg OF Temp-Tables.t-almdrepo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _JoinCode[1]      = "TRUE"
     _FldNameList[1]   > Temp-Tables.t-almdrepo.CodMat
"t-almdrepo.CodMat" "<Codigo>" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.subfam" "Subfamilia" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = Temp-Tables.t-almdrepo.CanGen
     _FldNameList[11]   = Temp-Tables.t-almdrepo.CanApro
     _FldNameList[12]   = Temp-Tables.t-almdrepo.CanAten
     _FldNameList[13]   = INTEGRAL.Almmmatg.Pesmat
     _FldNameList[14]   > "_<CALC>"
"Almmmatg.Libre_d02 / 1000000 @ Almmmatg.Libre_d02" "Vol!cm3" ">>,>>9.9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   = Temp-Tables.t-almdrepo.Origen
    ...
    WHEN "OTR" THEN DO:
        ...
        IF AVAILABLE Faccpedi THEN DO:
            FOR EACH Facdpedi OF Faccpedi NO-LOCK.
                CREATE t-almdrepo.
                ASSIGN
                    t-almdrepo.CodCia = Facdpedi.codcia
                    t-almdrepo.CodMat = Facdpedi.codmat
                    t-almdrepo.cangen = Facdpedi.canped
                    t-almdrepo.canapro = Facdpedi.canped
                    t-almdrepo.canaten = t-almdrepo.canate.
            END.
        END.
    END.
    OTHERWISE DO:
        ...
        IF AVAILABLE Almcrepo THEN DO:
            FOR EACH Almdrepo OF Almcrepo NO-LOCK:
                ...
                t-almdrepo.canaten = fAtendido(Almcrepo.AlmPed,almdrepo.CodMat, 'R/A', STRING(almdrepo.NroSer,'999') + STRING(almdrepo.NroDoc,'999999') ).
            END.
        END.
    END.
END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "t-almdrepo"}
