...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almtdocm WHERE ~{&KEY-PHRASE} ~
 ...
 AND Almtdocm.TipMov = s-tipmov NO-LOCK, ~
      EACH Almtmovm OF Almtdocm ~
      WHERE Almtmovm.MovTrf = TRUE NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "Almtdocm.CodAlm = s-codalm
 AND Almtdocm.CodCia = s-codcia
 AND Almtdocm.TipMov = s-tipmov"
     _Where[2]         = "Almtmovm.MovTrf = TRUE"
