...
AlmRCDoc.usuario AlmRCDoc.CodDoc AlmRCDoc.NroDoc ~
(IF NUM-ENTRIES(AlmDCdoc.CodCli,'|') > 1 THEN ENTRY(2,AlmDCdoc.CodCli,'|') ELSE AlmDCdoc.CodCli )  @ x-NomCli ~
...
DEFINE QUERY br_table FOR 
      AlmRCDoc, 
      AlmDCdoc
    FIELDS(AlmDCdoc.CodCli
      AlmDCdoc.CodCli
      AlmDCdoc.CodCli) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmRCDoc.NroDoc COLUMN-LABEL "<<Numero>>" FORMAT "X(12)":U
            WIDTH 10
      (IF NUM-ENTRIES(AlmDCdoc.CodCli,'|') > 1 THEN ENTRY(2,AlmDCdoc.CodCli,'|') ELSE AlmDCdoc.CodCli )  @ x-NomCli COLUMN-LABEL "Nombre" FORMAT "x(50)":U
            WIDTH 32
      AlmRCDoc.CodAlm COLUMN-LABEL "Alm." FORMAT "x(3)":U
      AlmRCDoc.Bultos FORMAT "->,>>9":U
      AlmRCDoc.Observ FORMAT "x(40)":U WIDTH 28.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"AlmRCDoc.usuario" "<Usuario>" ? "character" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmRCDoc.NroDoc" "<<Numero>>" "X(12)" "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"(IF NUM-ENTRIES(AlmDCdoc.CodCli,'|') > 1 THEN ENTRY(2,AlmDCdoc.CodCli,'|') ELSE AlmDCdoc.CodCli )  @ x-NomCli" "Nombre" "x(50)" ? ? ? ? ? ? ? no ? no no "32" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmRCDoc.Observ" ? ? "character" ? ? ? ? ? ? no ? no no "28.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
