...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 110.57 BY 21 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "SALIDA POR AJUSTES DE VALORES"
         HEIGHT             = 21
         WIDTH              = 110.57
         MAX-HEIGHT         = 26.15
         MAX-WIDTH          = 191.29
...
ON END-ERROR OF W-Win /* SALIDA POR AJUSTES DE VALORES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SALIDA POR AJUSTES DE VALORES */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/v-salida-solo-valor.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-salida ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-navico-2 ).
       RUN set-position IN h_p-navico-2 ( 8.54 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv05 ).
       RUN set-position IN h_p-updv05 ( 8.54 , 41.00 ) NO-ERROR.
       RUN set-size IN h_p-updv05 ( 1.42 , 57.86 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/q-salida.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-salida ).
       RUN set-position IN h_q-salida ( 1.00 , 61.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-alcmov ).
       RUN set-position IN h_q-alcmov ( 8.54 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ingres ).
       RUN set-position IN h_b-ingres ( 10.15 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-ing-solovalor ( 10.15 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-imp-excel-plantilla ( 10.15 , 92.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 11.23 , 92.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 5.92 , 12.00 ) NO-ERROR.
...
CASE L-Handle:
    WHEN "browse"   THEN DO:
       ...
       END.
    WHEN "Inactiva" THEN RUN dispatch IN h_b-ingres ('hide':U).
    WHEN "Activa"   THEN RUN dispatch IN h_b-ingres ('view':U).
    ...
    WHEN "RefrescarItems" THEN RUN dispatch IN h_t-ing-solovalor ('open-query':U).
END CASE.
