...
&Scoped-Define ENABLED-FIELDS Almcmov.AlmDes Almcmov.Observ 
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH Almdrepo OF Almcrepo NO-LOCK WHERE ( almdrepo.CanApro - almdrepo.CanAten > 0 ):
          ...
          IF NOT AVAILABLE Almmmate THEN DO:
              ...
              NEXT.
          END.
          RUN gn/stock-comprometido (Almdrepo.codmat, s-CodAlm, OUTPUT pComprometido).
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH Almdrequ OF Almcrequ NO-LOCK WHERE Almdrequ.canreq > Almdrequ.candes:
          ...
          IF NOT AVAILABLE Almmmate THEN DO:
              ...
              NEXT.
          END.
          RUN gn/stock-comprometido (Almdrequ.codmat, s-CodAlm, OUTPUT pComprometido).
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    FOR EACH ITEM BY ITEM.NroItm:
        IF x-Item >= FacCfgGn.Items_Guias THEN LEAVE.
        ...
        IF s-Reposicion = YES THEN DO:
            ...
            END CASE.
        END.
        IF s-CodAlm <> "11T" THEN DO:       /* 18.08.10 a pedido de Victor Escalante */
            IF ( ITEM.CanDes > (Almmmate.stkact - pComprometido) )
            THEN DO:
                CREATE T-ITEM.
