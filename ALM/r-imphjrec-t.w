...
&Scoped-Define ENABLED-OBJECTS txt-almvirtual txt-page txt-page-2 r-imp ~
tg-todos btn-Excel Btn_Ok Btn_Done x-zona RECT-71 
&Scoped-Define DISPLAYED-OBJECTS txt-almvirtual x-mensaje txt-page ~
txt-page-2 r-imp tg-todos x-zona 
...
DEFINE FRAME F-Main
     txt-almvirtual AT ROW 1.38 COL 24 COLON-ALIGNED WIDGET-ID 44
     x-mensaje AT ROW 7.73 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     txt-page AT ROW 2.5 COL 23 COLON-ALIGNED WIDGET-ID 20
     txt-page-2 AT ROW 2.5 COL 36.14 COLON-ALIGNED WIDGET-ID 22
     r-imp AT ROW 4.77 COL 6 NO-LABEL WIDGET-ID 16
     tg-todos AT ROW 4.77 COL 39 WIDGET-ID 34
     btn-Excel AT ROW 8.96 COL 34.57 WIDGET-ID 26
     Btn_Ok AT ROW 8.96 COL 46.57
     Btn_Done AT ROW 8.96 COL 58.57
     x-zona AT ROW 3.85 COL 19 COLON-ALIGNED WIDGET-ID 42
     "Nº Página" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 2.69 COL 11 WIDGET-ID 8
     RECT-71 AT ROW 8.81 COL 1.57 WIDGET-ID 24
...
DO:
    ASSIGN txt-page txt-page-2 r-imp x-zona txt-almvirtual.
    RUN Carga-Temporal.
    RUN Excel.
END.
...
DO:
  ASSIGN txt-page txt-page-2 r-imp tg-todos x-zona txt-almvirtual.
  RUN Carga-Temporal.
  RUN Imprime.  
END.
...
/*Campo referencia*/ w-report.Campo-I[3] = i + 1
        ...
        END.
        DISPLAY "Cargando para el almacen  " + AlmDInv.CodMat @ x-mensaje
...
------------------------------------------------------------------------------*/
  DISPLAY txt-almvirtual x-mensaje txt-page txt-page-2 r-imp tg-todos x-zona 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-almvirtual txt-page txt-page-2 r-imp tg-todos btn-Excel Btn_Ok 
         Btn_Done x-zona RECT-71 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH w-report WHERE w-report.task-no = s-task-no
        ...
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):Value = (w-report.Campo-F[2] - w-report.Campo-F[1]).
