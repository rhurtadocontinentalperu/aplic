...
/*     EACH ORDEN NO-LOCK WHERE ORDEN.CodCia = s-CodCia AND                                      */
/*         ORDEN.CodDoc = 'OTR' AND                                                              */
/*         ORDEN.CodRef = 'R/A' AND                                                              */
/*         ORDEN.NroRef = STRING(Almcrepo.NroSer, '999') + STRING(Almcrepo.NroDoc, '999999') AND */
/*         ORDEN.FlgEst <> 'A':                                                                  */
