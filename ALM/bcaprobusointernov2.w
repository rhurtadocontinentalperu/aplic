...
&Scoped-define FIELDS-IN-QUERY-br_table AlmCDocu.FchDoc AlmCDocu.NroDoc ~
AlmCDocu.UsrCreacion fSolicitadoPor(AlmCDocu.UsrCreacion) @ x-SolicitadoPor ~
AlmCDocu.CodLlave cb-auxi.Nomaux AlmCDocu.Libre_c01 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmCDocu.NroDoc FORMAT "X(10)":U WIDTH 8.72
...
/* Query rebuild information for BROWSE br_table
 ...
 AND cb-auxi.Clfaux = ""CCO"""
     ...
     _FldNameList[2]   > INTEGRAL.AlmCDocu.NroDoc
"AlmCDocu.NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    /* Primero solicitamos si es un movimiento 04 Uso Interno ó 05 Publicidad */
    ...
    DO k = 1 TO {&browse-name}:NUM-SELECTED-ROWS:
        ...
        ASSIGN
            ...
            B-CDOCU.FlgEst = "WL"      /* Necesita aprobación por Logistica */
