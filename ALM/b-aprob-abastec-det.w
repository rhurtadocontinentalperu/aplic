...
DEFINE TEMP-TABLE T-DREPO NO-UNDO LIKE almdrepo
       FIELD StkDisponible AS DEC
       FIELD StockTransito AS DEC
       FIELD CompraTransito AS DEC
       FIELD StkDisponible-Orig AS DEC.
...
DEF VAR cStkDisponible AS LOG NO-UNDO.
DEF VAR cStkTransito AS LOG NO-UNDO.
DEF VAR cCompraTransito AS LOG NO-UNDO.
DEF VAR cStkDisponibleOri AS LOG NO-UNDO.
...
&Scoped-define BROWSE-NAME adbr_table
...
/* Definitions for BROWSE adbr_table                                    */
&Scoped-define FIELDS-IN-QUERY-adbr_table almdrepo.Item almdrepo.CodMat ~
Almmmatg.DesMat Almmmatg.DesMar almdrepo.CanReq almdrepo.CanApro ~
Almmmatg.UndBas ~
fStockDisponible(almdrepo.CodMat, almdrepo.CodAlm) @  x-StkDisponible ~
Almmmate.StkMin ~
(fStockTransito(almdrepo.CodMat, almdrepo.CodAlm) - Almdrepo.CanApro) @ x-StockTransito ~
fCompraTransito(almdrepo.CodMat, almdrepo.CodAlm) @ x-CompraTransito ~
Almmmate.StkMax Almmmatg.CanEmp ~
fStockDisponibleOrig(almdrepo.CodMat, almcrepo.AlmPed) @ x-StkDisponible-Orig 
&Scoped-define ENABLED-FIELDS-IN-QUERY-adbr_table almdrepo.CodMat ~
almdrepo.CanApro 
&Scoped-define ENABLED-TABLES-IN-QUERY-adbr_table almdrepo
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-adbr_table almdrepo
&Scoped-define QUERY-STRING-adbr_table FOR EACH almdrepo OF almcrepo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST Almmmatg OF almdrepo NO-LOCK, ~
      FIRST Almmmate OF almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-adbr_table OPEN QUERY adbr_table FOR EACH almdrepo OF almcrepo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST Almmmatg OF almdrepo NO-LOCK, ~
      FIRST Almmmate OF almdrepo NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-adbr_table almdrepo Almmmatg Almmmate
&Scoped-define FIRST-TABLE-IN-QUERY-adbr_table almdrepo
&Scoped-define SECOND-TABLE-IN-QUERY-adbr_table Almmmatg
&Scoped-define THIRD-TABLE-IN-QUERY-adbr_table Almmmate


/* Definitions for FRAME F-Main                                         */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS adbr_table 
...
/* Browse definitions                                                   */
DEFINE BROWSE adbr_table
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS adbr_table B-table-Win _STRUCTURED
  QUERY adbr_table NO-LOCK DISPLAY
      ...
      fStockDisponible(almdrepo.CodMat, almdrepo.CodAlm) @  x-StkDisponible COLUMN-LABEL "Stk Destino!Disponible" FORMAT "(ZZZ,ZZ9.99)":U
      Almmmate.StkMin COLUMN-LABEL "Stock Máximo!+ Seguridad" FORMAT "ZZZ,ZZ9.99":U
      (fStockTransito(almdrepo.CodMat, almdrepo.CodAlm) - Almdrepo.CanApro) @ x-StockTransito COLUMN-LABEL "Stock en!Tránsito" FORMAT "-ZZZ,ZZ9.99":U
      fCompraTransito(almdrepo.CodMat, almdrepo.CodAlm) @ x-CompraTransito COLUMN-LABEL "Compra en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
      ...
      Almmmatg.CanEmp COLUMN-LABEL "Empaque!Master" FORMAT "->>,>>9.99":U
            WIDTH 7.14
      fStockDisponibleOrig(almdrepo.CodMat, almcrepo.AlmPed) @ x-StkDisponible-Orig COLUMN-LABEL "Stk Origen!Disponible" FORMAT "(ZZZ,ZZ9.99)":U
  ENABLE
      almdrepo.CodMat
      almdrepo.CanApro
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 144 BY 22.35
         FONT 4
         TITLE "ITEMS" ROW-HEIGHT-CHARS .5.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     adbr_table AT ROW 1 COL 1
     "F8: Consulta de stocks  F7: Pedidos F9: Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 41 BY .5 AT ROW 23.62 COL 74 WIDGET-ID 10
     "F10: Kardex Almacén Despacho" VIEW-AS TEXT
          SIZE 23 BY .5 AT ROW 23.62 COL 116 WIDGET-ID 12
...
/* BROWSE-TAB adbr_table 1 F-Main */
ASSIGN 
       FRAME F-Main:SCROLLABLE       = FALSE
       FRAME F-Main:HIDDEN           = TRUE.

ASSIGN 
       adbr_table:NUM-LOCKED-COLUMNS IN FRAME F-Main     = 2
       adbr_table:ALLOW-COLUMN-SEARCHING IN FRAME F-Main = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE adbr_table
/* Query rebuild information for BROWSE adbr_table
...
"fStockDisponible(almdrepo.CodMat, almdrepo.CodAlm) @  x-StkDisponible" "Stk Destino!Disponible" "(ZZZ,ZZ9.99)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(fStockTransito(almdrepo.CodMat, almdrepo.CodAlm) - Almdrepo.CanApro) @ x-StockTransito" "Stock en!Tránsito" "-ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"fCompraTransito(almdrepo.CodMat, almdrepo.CodAlm) @ x-CompraTransito" "Compra en!Tránsito" "ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fStockDisponibleOrig(almdrepo.CodMat, almcrepo.AlmPed) @ x-StkDisponible-Orig" "Stk Origen!Disponible" "(ZZZ,ZZ9.99)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define BROWSE-NAME adbr_table
&Scoped-define SELF-NAME adbr_table
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F10 OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F11 OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F7 OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F8 OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
    S-CODMAT = Almmmatg.CodMat.
    /*RUN vta/d-stkalm.*/
    RUN alm/d-stkalm.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON F9 OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
  S-CODMAT = Almmmatg.CodMat.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON LEFT-MOUSE-DBLCLICK OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON ROW-ENTRY OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON ROW-LEAVE OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON START-SEARCH OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL adbr_table B-table-Win
ON VALUE-CHANGED OF adbr_table IN FRAME F-Main /* ITEMS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL almdrepo.CodMat adbr_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF almdrepo.CodMat IN BROWSE adbr_table /* <Codigo> */
DO:
  IF SELF:SCREEN-VALUE = '' THEN RETURN.
  ASSIGN
      SELF:SCREEN-VALUE = CAPS(SELF:SCREEN-VALUE) NO-ERROR.
  ASSIGN
...
DEF INPUT PARAMETER pStkDisponible AS LOG NO-UNDO.
DEF INPUT PARAMETER pStkTransito AS LOG NO-UNDO.
DEF INPUT PARAMETER pCompraTransito AS LOG NO-UNDO.
DEF INPUT PARAMETER pStkDisponibleOri AS LOG NO-UNDO.
                         
cStkDisponible    = pStkDisponible.
cStkTransito      = pStkTransito.
cCompraTransito   = pCompraTransito.
cStkDisponibleOri = pStkDisponibleOri.
...
FOR EACH almdrepo OF almcrepo NO-LOCK,
    FIRST Almmmatg OF INTEGRAL.almdrepo NO-LOCK,
    FIRST Almmmate OF INTEGRAL.almdrepo NO-LOCK:
    CREATE T-DREPO.
    BUFFER-COPY almdrepo TO T-DREPO.

    /* Disponible */
    RUN gn/stock-comprometido-v2.p (almdrepo.CodMat, almdrepo.CodAlm, NO, OUTPUT pComprometido).
    T-DREPO.StkDisponible = (Almmmate.StkAct - pComprometido).

    /* Tránsito: lo pasamos al momento de pintar el detalle */
    RUN alm\p-articulo-en-transito (Almdrepo.codcia,
                                    Almdrepo.codalm,
                                    Almdrepo.codmat,
                                    INPUT-OUTPUT TABLE tmp-tabla,
                                    OUTPUT x-Total).
    T-DREPO.StockTransito = x-Total -  almdrepo.CanApro.

    /* Compra Tránsito */
    FIND OOComPend WHERE OOComPend.CodMat = Almdrepo.codmat
        AND OOComPend.CodAlm = Almdrepo.codalm
        NO-LOCK NO-ERROR.
    IF AVAILABLE OOComPend THEN T-DREPO.CompraTransito =  (OOComPend.CanPed - OOComPend.CanAte).
    ELSE T-DREPO.CompraTransito = 0.
    /* Disponible Origen */
    ...
    FIND B-MATE WHERE B-MATE.codcia = s-codcia
        ...
        NO-LOCK NO-ERROR.
    IF AVAILABLE B-MATE THEN T-DREPO.StkDisponible-Orig =  (B-MATE.StkAct - pComprometido).
    ELSE T-DREPO.StkDisponible-Orig =  0.00.
END.
...
------------------------------------------------------------------------------*/
  ...
  IF cCompraTransito = NO THEN RETURN 0.00.
  IF NOT AVAILABLE Almcrepo THEN RETURN 0.00.
  
  FIND OOComPend WHERE OOComPend.CodMat = pCodMat
      AND OOComPend.CodAlm = pCodAlm
      NO-LOCK NO-ERROR.
  IF AVAILABLE OOComPend THEN RETURN (OOComPend.CanPed - OOComPend.CanAte).
  ELSE RETURN 0.00.
...
------------------------------------------------------------------------------*/
  ...
  IF cStkDisponible = NO THEN RETURN 0.00.
  DEF VAR pComprometido AS DEC NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  IF cStkDisponibleOri = NO THEN RETURN 0.00.
  DEF VAR pComprometido AS DEC NO-UNDO.
  ...
  /* Comprometido */
  RUN gn/stock-comprometido-v2 (pCodMat, pCodAlm, NO, OUTPUT pComprometido).
...
------------------------------------------------------------------------------*/
  ...
  IF cStkTransito = NO THEN RETURN 0.00.
  ...
  RUN alm\p-articulo-en-transito (INPUT s-codcia,
                                  INPUT pCodAlm,
                                  INPUT pCodMat,
                                  INPUT-OUTPUT TABLE tmp-tabla,
                                  OUTPUT x-Total).
