...
LOOKUP(TRIM(S-CODALM), Almmmatg.almacenes) > 0 AND ~
(R-Tipo = '' OR Almmmatg.TpoArt = R-Tipo) AND ~
(RADIO-SET_TipArt = '' OR Almmmatg.TipArt = RADIO-SET_TipArt) )
...
FOR EACH MATG NO-LOCK WHERE matg.CodCia = S-CODCIA  
    ...
    AND matg.TipArt BEGINS RADIO-SET_TipArt,
