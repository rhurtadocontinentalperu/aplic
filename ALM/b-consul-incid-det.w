...
AlmDIncidencia.Incidencia AlmDIncidencia.CanInc 
...
"AlmDIncidencia.CodMat" ? "x(6)" "character" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[6]   = INTEGRAL.AlmDIncidencia.Incidencia
     _FldNameList[7]   = INTEGRAL.AlmDIncidencia.CanInc
