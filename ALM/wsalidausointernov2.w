...
DEFINE VARIABLE h_vsalidausointernov2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/vsalidausointernov2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vsalidausointernov2 ).
       RUN set-position IN h_vsalidausointernov2 ( 4.46 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_vsalidausointernov2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_vsalidausointernov2 ).
       RUN add-link IN adm-broker-hdl ( h_q-alcmov , 'Record':U , h_vsalidausointernov2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_vsalidausointernov2 ,
             h_p-updv05 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-salida ,
             h_vsalidausointernov2 , 'AFTER':U ).
