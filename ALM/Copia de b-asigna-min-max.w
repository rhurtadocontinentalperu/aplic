...
&Scoped-define INTERNAL-TABLES T-MATE Almacen TabGener
...
(IF T-MATE.Libre_d01 = 1 THEN '*' ELSE '') @ T-MATE.Libre_c01 ~
TabGener.Codigo T-MATE.CodAlm Almacen.Descripcion T-MATE.VInMn1 ~
T-MATE.VInMn2 T-MATE.StkMin T-MATE.VCtMn1 T-MATE.VCtMn2 
...
&Scoped-define QUERY-STRING-br_table FOR EACH T-MATE OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      FIRST TabGener WHERE TabGener.CodCia = Almacen.CodCia ~
  AND TabGener.Libre_c01 = Almacen.CodAlm ~
      AND TabGener.Clave = "ZG" OUTER-JOIN NO-LOCK ~
    BY T-MATE.CodUbi ~
       BY T-MATE.CodAlm
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH T-MATE OF Almmmatg WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND TabGener.Libre_c01 = Almacen.CodAlm ~
    ...
    BY T-MATE.CodUbi ~
       BY T-MATE.CodAlm.
&Scoped-define TABLES-IN-QUERY-br_table T-MATE Almacen TabGener
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.T-MATE OF INTEGRAL.Almmmatg,INTEGRAL.Almacen OF Temp-Tables.T-MATE,INTEGRAL.TabGener WHERE INTEGRAL.Almacen ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST OUTER"
     _OrdList          = "Temp-Tables.T-MATE.CodUbi|yes,Temp-Tables.T-MATE.CodAlm|yes"
     _JoinCode[3]      = "INTEGRAL.TabGener.CodCia = INTEGRAL.Almacen.CodCia
  AND INTEGRAL.TabGener.Libre_c01 = INTEGRAL.Almacen.CodAlm"
     _Where[3]         = "INTEGRAL.TabGener.Clave = ""ZG"""
...
"TabGener.Codigo" "Zona Geografica" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATE.VInMn1" "Máximo" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-MATE.VInMn2
"T-MATE.VInMn2" "Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-MATE.StkMin
"T-MATE.StkMin" "Máximo + Seguridad" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATE.VCtMn1
"T-MATE.VCtMn1" "Campaña" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATE.VCtMn2
"T-MATE.VCtMn2" "No Campaña" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    /* Verificamos Zona Geográfica */
    GET FIRST {&browse-name}.
    REPEAT WHILE AVAILABLE T-MATE:
        /* Verificamos que todos tengan zona geografica registrada */
        FIND TabGener WHERE TabGener.CodCia = Almacen.CodCia
            AND TabGener.Clave = "ZG"
            AND TabGener.Libre_c01 = Almacen.CodAlm
            NO-LOCK NO-ERROR.
        IF NOT AVAILABLE TabGener THEN DO:
            MESSAGE 'Almacén' T-MATE.codalm 'NO tiene Zona Geográfica definida'
