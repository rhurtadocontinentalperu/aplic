...
tt-AlmDInv.QtyReconteo DifQty @ DifQty 
...
&Scoped-Define ENABLED-OBJECTS txt-codmat tg-dif btn-consulta btn-Excel ~
btn-print btn-exit-2 br_table txt-page-1 txt-page-2 RECT-67 RECT-68 
&Scoped-Define DISPLAYED-OBJECTS txt-codmat tg-dif txt-page-1 txt-page-2 
...
DEFINE FRAME F-Main
     txt-codmat AT ROW 2.62 COL 9 COLON-ALIGNED WIDGET-ID 54
     tg-dif AT ROW 2.62 COL 27 WIDGET-ID 56
     ...
     txt-page-1 AT ROW 1.54 COL 9 COLON-ALIGNED WIDGET-ID 58
     txt-page-2 AT ROW 1.54 COL 25 COLON-ALIGNED WIDGET-ID 60
...
"DifQty @ DifQty" "Diferencia" "-ZZZ,ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ASSIGN txt-codmat tg-dif txt-page-1 txt-page-2.   
...
cRange = "H" + cColumn.
chWorkSheet:Range(cRange):Value = "Costo Sin IGV".
cRange = "I" + cColumn.
...
FOR EACH tt-AlmDInv NO-LOCK
    ...
    cRange = "L" + cColumn.
    chWorkSheet:Range(cRange):Value = DifQty.
    cRange = "M" + cColumn.
