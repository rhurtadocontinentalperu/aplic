...
DEFINE TEMP-TABLE t-Almcmov NO-UNDO LIKE OOMoviAlmacen.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: t-Almcmov T "?" NO-UNDO INTEGRAL OOMoviAlmacen
   END-TABLES.
 */
...
*/
/*
MESSAGE "s-codcia " s-codcia SKIP
        "s-codalm " s-codalm SKIP
...
*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      FOR EACH B-CMOV EXCLUSIVE-LOCK WHERE B-CMOV.codcia = s-codcia
          AND B-CMOV.CodRef = Faccpedi.coddoc
          AND B-CMOV.NroRef = Faccpedi.nroped
          AND B-CMOV.AlmDes = s-CodAlm      /* OJO: nuevo filtro */
          AND B-CMOV.TipMov = "S"
          AND B-CMOV.CodMov = s-CodMov
          AND B-CMOV.FlgEst <> 'A'
          AND B-CMOV.FlgSit = "T" ON ERROR UNDO, THROW:

          EMPTY TEMP-TABLE t-Almcmov.   /* Limpiamos temporal */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    DEFINE VAR pComprobante AS CHAR NO-UNDO.
