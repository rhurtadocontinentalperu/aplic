...
&Scoped-Define ENABLED-OBJECTS BUTTON-3 BUTTON-1 BUTTON-2 
...
DEFINE VARIABLE h_v-invcfg AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 4.08 COL 23
     BUTTON-2 AT ROW 4.08 COL 46
...
DO:
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Carga-Temporal IN h_v-invcfg (01).
...
DO:
  ...
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Genera-Movimiento IN h_v-invcfg.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/v-invcfg.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-invcfg ).
       RUN set-position IN h_v-invcfg ( 1.19 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Entrada|Salida' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 4.69 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-invcfg. */
       RUN add-link IN adm-broker-hdl ( h_q-invcfg , 'Record':U , h_v-invcfg ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-invcfg ,
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ajting ).
       RUN set-position IN h_b-ajting ( 6.58 , 4.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ajtsal ).
       RUN set-position IN h_b-ajtsal ( 6.58 , 4.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-3 BUTTON-1 BUTTON-2 
