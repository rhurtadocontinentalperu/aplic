...
FOR EACH T-MATG NO-LOCK,
    ...
    x-Item = x-Item + 1.
    /*IF x-Item MODULO 1000 = 0 THEN FILL-IN-Mensaje:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "*** CALCULANDO Código: " + T-MATG.codmat.*/
    /*FILL-IN-Mensaje:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "*** CALCULANDO Código: " + T-MATG.codmat.*/
    DISPLAY
