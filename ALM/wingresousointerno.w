...
DEFINE VARIABLE h_vingresousointerno AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vingresousointerno.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vingresousointerno ).
       RUN set-position IN h_vingresousointerno ( 2.35 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_vingresousointerno. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_vingresousointerno ).
       RUN add-link IN adm-broker-hdl ( h_q-alcmov , 'Record':U , h_vingresousointerno ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-movmto , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_vingresousointerno ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico-2 ,
             h_vingresousointerno , 'AFTER':U ).
