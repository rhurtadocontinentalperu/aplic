...
FOR EACH AlmCieAl WHERE 
    ...
    IF DAY(AlmCieAl.FchCie) = 01 AND AlmCieAl.FlgCie THEN DIA-1 = YES.
    IF DAY(AlmCieAl.FchCie) = 02 AND AlmCieAl.FlgCie THEN DIA-2 = YES.
    IF DAY(AlmCieAl.FchCie) = 03 AND AlmCieAl.FlgCie THEN DIA-3 = YES.
    IF DAY(AlmCieAl.FchCie) = 04 AND AlmCieAl.FlgCie THEN DIA-4 = YES.
    IF DAY(AlmCieAl.FchCie) = 05 AND AlmCieAl.FlgCie THEN DIA-5 = YES.
    IF DAY(AlmCieAl.FchCie) = 06 AND AlmCieAl.FlgCie THEN DIA-6 = YES.
    IF DAY(AlmCieAl.FchCie) = 07 AND AlmCieAl.FlgCie THEN DIA-7 = YES.
    IF DAY(AlmCieAl.FchCie) = 08 AND AlmCieAl.FlgCie THEN DIA-8 = YES.
    IF DAY(AlmCieAl.FchCie) = 09 AND AlmCieAl.FlgCie THEN DIA-9 = YES.
    IF DAY(AlmCieAl.FchCie) = 10 AND AlmCieAl.FlgCie THEN DIA-10 = YES.
    IF DAY(AlmCieAl.FchCie) = 11 AND AlmCieAl.FlgCie THEN DIA-11 = YES.
    IF DAY(AlmCieAl.FchCie) = 12 AND AlmCieAl.FlgCie THEN DIA-12 = YES.
    IF DAY(AlmCieAl.FchCie) = 13 AND AlmCieAl.FlgCie THEN DIA-13 = YES.
    IF DAY(AlmCieAl.FchCie) = 14 AND AlmCieAl.FlgCie THEN DIA-14 = YES.
    IF DAY(AlmCieAl.FchCie) = 15 AND AlmCieAl.FlgCie THEN DIA-15 = YES.
    IF DAY(AlmCieAl.FchCie) = 16 AND AlmCieAl.FlgCie THEN DIA-16 = YES.
    IF DAY(AlmCieAl.FchCie) = 17 AND AlmCieAl.FlgCie THEN DIA-17 = YES.
    IF DAY(AlmCieAl.FchCie) = 18 AND AlmCieAl.FlgCie THEN DIA-18 = YES.
    IF DAY(AlmCieAl.FchCie) = 19 AND AlmCieAl.FlgCie THEN DIA-19 = YES.
    IF DAY(AlmCieAl.FchCie) = 20 AND AlmCieAl.FlgCie THEN DIA-20 = YES.
    IF DAY(AlmCieAl.FchCie) = 21 AND AlmCieAl.FlgCie THEN DIA-21 = YES.
    IF DAY(AlmCieAl.FchCie) = 22 AND AlmCieAl.FlgCie THEN DIA-22 = YES.
    IF DAY(AlmCieAl.FchCie) = 23 AND AlmCieAl.FlgCie THEN DIA-23 = YES.
    IF DAY(AlmCieAl.FchCie) = 24 AND AlmCieAl.FlgCie THEN DIA-24 = YES.
    IF DAY(AlmCieAl.FchCie) = 25 AND AlmCieAl.FlgCie THEN DIA-25 = YES.
    IF DAY(AlmCieAl.FchCie) = 26 AND AlmCieAl.FlgCie THEN DIA-26 = YES.
    IF DAY(AlmCieAl.FchCie) = 27 AND AlmCieAl.FlgCie THEN DIA-27 = YES.
    IF DAY(AlmCieAl.FchCie) = 28 AND AlmCieAl.FlgCie THEN DIA-28 = YES.
    IF DAY(AlmCieAl.FchCie) = 29 AND AlmCieAl.FlgCie THEN DIA-29 = YES.
    IF DAY(AlmCieAl.FchCie) = 30 AND AlmCieAl.FlgCie THEN DIA-30 = YES.
    IF DAY(AlmCieAl.FchCie) = 31 AND AlmCieAl.FlgCie THEN DIA-31 = YES.
...
FIND AlmCieAl WHERE 
     AlmCieAl.CodCia = S-CODCIA   AND
     AlmCieAl.CodAlm = S-CODALM   AND
     AlmCieAl.FchCie = D-FchCie - 1 NO-LOCK NO-ERROR.
IF NOT AVAILABLE AlmCieAl AND D-FchCie <> D-FchApe THEN DO:
   MESSAGE "Debe cerrar el dia anterior" VIEW-AS ALERT-BOX ERROR.
   RETURN "ADM-ERROR".
END.
IF AVAILABLE AlmCieAl AND NOT AlmCieAl.FlgCie THEN DO:
   MESSAGE "Debe cerrar el dia anterior" VIEW-AS ALERT-BOX ERROR.
   RETURN "ADM-ERROR".
END.
FIND AlmCieAl WHERE 
     AlmCieAl.CodCia = S-CODCIA   AND
     AlmCieAl.CodAlm = S-CODALM   AND
     AlmCieAl.FchCie = D-FchCie EXCLUSIVE-LOCK NO-ERROR.
IF NOT AVAILABLE AlmCieAl
THEN DO:
    CREATE AlmCieAl.
    ASSIGN
...
ELSE DO:
    ASSIGN
        AlmCieAl.flgcie = NOT AlmCieAl.flgcie   /* Si está cerrado lo abrimos y viceversa */
        AlmCieAl.usucierr = s-user-id.
END.
RELEASE AlmCieAl.
