...
DEFINE BUFFER B-MATG FOR INTEGRAL.Almmmatg.
...
&Scoped-Define ENABLED-FIELDS INTEGRAL.Almmmatg.UndBas 
&Scoped-define ENABLED-TABLES INTEGRAL.Almmmatg
&Scoped-define FIRST-ENABLED-TABLE INTEGRAL.Almmmatg
&Scoped-Define ENABLED-OBJECTS RECT-14 
&Scoped-Define DISPLAYED-FIELDS INTEGRAL.Almmmatg.codmat ~
INTEGRAL.Almmmatg.DesMat INTEGRAL.Almmmatg.UndBas ~
INTEGRAL.Almmmatg.Libre_d01 
...
FILL-IN-CodMat-1 FILL-IN-Factor FILL-IN-UndBas-2 FILL-IN-CodMat-2 
...
DEFINE FRAME F-Main
     INTEGRAL.Almmmatg.codmat AT ROW 1.27 COL 19 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     INTEGRAL.Almmmatg.DesMat AT ROW 1.27 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 8 FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 57 BY .81
     ...
     INTEGRAL.Almmmatg.UndBas AT ROW 3.15 COL 29 COLON-ALIGNED WIDGET-ID 106
          LABEL "1" FORMAT "X(4)"
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
          BGCOLOR 1 FGCOLOR 15 
     FILL-IN-CodMat-1 AT ROW 3.15 COL 37 COLON-ALIGNED WIDGET-ID 96
     FILL-IN-Factor AT ROW 4.23 COL 19 COLON-ALIGNED WIDGET-ID 104
     ...
     INTEGRAL.Almmmatg.Libre_d01 AT ROW 6.77 COL 43 RIGHT-ALIGNED WIDGET-ID 112
          LABEL "Equivalencia"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
