...
/*                                                                                                */
  ...
  PUT STREAM REPORTE '^FO115,20'                   SKIP.   /* Coordenadas de origen */
  PUT STREAM REPORTE '^A0R,40,40'                  SKIP.   /* Coordenada de impresion */
  PUT STREAM REPORTE '^FD'.
  PUT STREAM REPORTE SUBSTRING("EA-4000D",1,40) FORMAT 'x(40)' SKIP.   /* Descripcion */
  PUT STREAM REPORTE '^FS'                         SKIP.   /* Fin de Campo1 */
  /**
  PUT STREAM REPORTE '^FO90,00'                   SKIP.   /* Coordenadas de origen campo2 */
  PUT STREAM REPORTE '^A0R,25,15'                  SKIP.
  PUT STREAM REPORTE '^FD'.
  PUT STREAM REPORTE SUBSTRING(Desmar,1,26) FORMAT 'x(26)' SKIP.
  PUT STREAM REPORTE '^FS'                         SKIP.   /* Fin de Campo2 */
  */
  PUT STREAM REPORTE '^FO20,30'                    SKIP.   /* Coordenadas de origen barras */
  IF x-Tipo = 1 THEN DO:
