...
Almcmov.NroRf1 Almcmov.AlmDes Almcmov.NroRf2 Almcmov.NroRf3 Almcmov.Observ ~
Almcmov.CodTra Almcmov.cco 
...
Almcmov.NroRf3 Almcmov.Observ Almcmov.CodTra Almcmov.cco Almcmov.usuario 
...
FILL-IN-NomCli FILL-IN-NomPro F-AlmRef 
...
"US$", 2
     ...
     Almcmov.CodPro AT ROW 2.58 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
     FILL-IN-NomPro AT ROW 2.58 COL 23.14 COLON-ALIGNED NO-LABEL
     ...
     Almcmov.NroRf2 AT ROW 3.31 COL 72 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     Almcmov.NroRf3 AT ROW 4.04 COL 71.86 COLON-ALIGNED
          LABEL "O/T" FORMAT "xxx-xxxxxx"
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     Almcmov.Observ AT ROW 4.08 COL 12 COLON-ALIGNED FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 49.72 BY .69
     Almcmov.CodTra AT ROW 4.77 COL 12 COLON-ALIGNED
          LABEL "Transportista" FORMAT "X(11)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
     Almcmov.cco AT ROW 4.77 COL 72 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .69
     Almcmov.usuario AT ROW 4.85 COL 47 COLON-ALIGNED
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     "Moneda :" VIEW-AS TEXT
