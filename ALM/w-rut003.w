...
DEFINE FRAME F-Main
     b-imprimir AT ROW 7.73 COL 81 WIDGET-ID 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rut001 ).
       RUN set-position IN h_v-rut001 ( 7.73 , 2.00 ) NO-ERROR.
       ...
       RUN set-size IN h_folder ( 8.88 , 90.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rut001a ).
       RUN set-position IN h_b-rut001a ( 18.08 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rut001b ).
       RUN set-position IN h_b-rut001b ( 18.23 , 3.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rut001c ).
       RUN set-position IN h_b-rut001c ( 18.23 , 4.00 ) NO-ERROR.
