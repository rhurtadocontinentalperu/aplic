...
&Scoped-Define ENABLED-OBJECTS BUTTON-11 FILL-IN-CodMat BUTTON-10 BUTTON-6 ~
br_table RECT-1 
&Scoped-Define DISPLAYED-OBJECTS EDITOR-1 FILL-IN-Temporada FILL-IN-CodMat ~
FILL-IN-Mensaje 
...
DEFINE FRAME F-Main
     BUTTON-11 AT ROW 3.5 COL 52 WIDGET-ID 40
     EDITOR-1 AT ROW 3.5 COL 16 NO-LABEL WIDGET-ID 42
     FILL-IN-Temporada AT ROW 1 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     FILL-IN-CodMat AT ROW 2.54 COL 14 COLON-ALIGNED WIDGET-ID 34
     FILL-IN-Mensaje AT ROW 5.23 COL 12 NO-LABEL WIDGET-ID 28
     BUTTON-10 AT ROW 1 COL 2 WIDGET-ID 32
     BUTTON-6 AT ROW 1 COL 17 WIDGET-ID 24
     br_table AT ROW 6.19 COL 1
     "Desde Texto:" VIEW-AS TEXT
          SIZE 9 BY .5 AT ROW 3.69 COL 6 WIDGET-ID 46
     RECT-1 AT ROW 2.35 COL 2 WIDGET-ID 44
...
DO:
  ASSIGN FILL-IN-CodMat EDITOR-1.
  ASSIGN FILL-IN-CodMat:SENSITIVE = NO.
  RUN Carga-Temporal.
  RUN dispatch IN THIS-PROCEDURE ('open-query':U).
END.
