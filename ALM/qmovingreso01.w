...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almcmov OF Almtdocm WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Almcmov.FchDoc DESCENDING ~
       BY Almcmov.NroSer ~
        BY Almcmov.NroDoc DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almcmov OF Almtdocm WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Almcmov.FchDoc DESCENDING ~
       BY Almcmov.NroSer ~
        BY Almcmov.NroDoc DESCENDING.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-2 q-tables
ON CHOOSE OF BUTTON-2 IN FRAME FRAME-D /* Button 2 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
      RUN alm/c-almcmov-01 ('MOVIMIENTOS DE ALMACEN').
    /*
