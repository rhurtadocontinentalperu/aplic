...
DEFINE VARIABLE h_b-chqingotr AS HANDLE NO-UNDO.
...
ON END-ERROR OF ssW-Win /* CHEQUEO DE INGRESOS POR ORDEN DE TRANSFERENCIAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ssW-Win ssW-Win
ON WINDOW-CLOSE OF ssW-Win /* CHEQUEO DE INGRESOS POR ORDEN DE TRANSFERENCIAS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-chqingotr.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chqingotr ).
       RUN set-position IN h_b-chqingotr ( 1.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-chqingotr ( 16.92 , 95.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 8.27 , 98.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 7.27 , 13.14 ) NO-ERROR.

       /* Links to SmartBrowser h_b-chqingotr. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chqingotr ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chqingotr ,
             Btn_Done:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_b-chqingotr , 'AFTER':U ).
    END. /* Page 0 */
