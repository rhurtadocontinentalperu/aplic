...
&Scoped-Define ENABLED-OBJECTS BUTTON-Filtrar BUTTON-Procesar ~
...
DEFINE FRAME F-Main
     ...
     BUTTON-Procesar AT ROW 1.27 COL 68 WIDGET-ID 10
...
ON END-ERROR OF sW-Win /* RECLASIFICACION AUTOMATICA DE KITS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sW-Win sW-Win
ON WINDOW-CLOSE OF sW-Win /* RECLASIFICACION AUTOMATICA DE KITS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Filtrar sW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Procesar sW-Win
ON CHOOSE OF BUTTON-Procesar IN FRAME F-Main /* PROCESAR */
DO:
  MESSAGE 'Procedemos a generar los movimientos de reclasificación?'
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/b-reclasificacion-autom-kits-ing.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-reclasif-kits-ingr ).
       RUN set-position IN h_b-reclasif-kits-ingr ( 2.88 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-reclasif-kits-ingr ( 6.69 , 83.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv98 ).
       RUN set-position IN h_p-updv98 ( 3.96 , 87.00 ) NO-ERROR.
       RUN set-size IN h_p-updv98 ( 5.12 , 11.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/b-reclasificacion-autom-kits-det.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-reclasif-kits-deta ).
       RUN set-position IN h_b-reclasif-kits-deta ( 9.88 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-reclasif-kits-deta ( 6.69 , 84.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/b-reclasificacion-autom-kits-recl.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-reclasif-kits-reclasf ).
       RUN set-position IN h_b-reclasif-kits-reclasf ( 16.88 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-reclasif-kits-reclasf ( 8.62 , 84.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-reclasif-kits-ingr. */
       RUN add-link IN adm-broker-hdl ( h_p-updv98 , 'TableIO':U , h_b-reclasif-kits-ingr ).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-Filtrar BUTTON-Procesar FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 
      WITH FRAME F-Main IN WINDOW sW-Win.
