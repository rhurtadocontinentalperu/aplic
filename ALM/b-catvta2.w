...
&Scoped-define FIELDS-IN-QUERY-br_table AlmCatVtaD.codmat Almmmatg.DesMat ~
Almmmatg.DesMar 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 74 BY 8.62
...
/* Query rebuild information for BROWSE br_table
  ...
  AND AlmCatVtaD.NroPag = AlmCatVtaC.NroPag"
     _FldNameList[1]   > INTEGRAL.AlmCatVtaD.codmat
