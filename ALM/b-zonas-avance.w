...
tt-AlmDInv.NroPagina tt-AlmDInv.CodUbi tt-AlmDInv.Libre_c01 ~
tt-AlmDInv.Libre_c02 tt-AlmDInv.Libre_c03 tt-AlmDInv.Libre_d01 
...
&Scoped-Define ENABLED-OBJECTS txt-page-1 txt-page-2 btn-consulta btn-Excel ~
btn-exit-2 br_table txt-codalm BUTTON-1 RECT-67 RECT-68 
&Scoped-Define DISPLAYED-OBJECTS txt-page-1 txt-page-2 txt-codalm 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tt-AlmDInv.NroPagina COLUMN-LABEL "Pag." FORMAT ">>>9":U
            WIDTH 5.72
      tt-AlmDInv.CodUbi COLUMN-LABEL "Zona" FORMAT "x(6)":U WIDTH 6.43
      ...
      tt-AlmDInv.Libre_c03 COLUMN-LABEL "3erConteo" FORMAT "x(60)":U
            WIDTH 11.43
      tt-AlmDInv.Libre_d01 COLUMN-LABEL "Articulos" FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75.86 BY 14
         FONT 4
...
DEFINE FRAME F-Main
     ...
     btn-consulta AT ROW 2.54 COL 45 WIDGET-ID 8
     btn-Excel AT ROW 2.54 COL 58 WIDGET-ID 20
     btn-exit-2 AT ROW 2.54 COL 72 WIDGET-ID 52
...
"CodAlm" "Alm" ? "character" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-AlmDInv.NroPagina
"NroPagina" "Pag." ">>>9" "integer" ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-AlmDInv.CodUbi
"CodUbi" "Zona" ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-AlmDInv.Libre_c01
"Libre_c01" "Conteo" ? "character" ? ? ? ? ? ? no ? no no "12.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-AlmDInv.Libre_c02
"Libre_c02" "Reconteo" ? "character" ? ? ? ? ? ? no ? no no "14.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-AlmDInv.Libre_c03
"Libre_c03" "3erConteo" ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-AlmDInv.Libre_d01
"Libre_d01" "Articulos" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH AlmCInv WHERE AlmCInv.CodCia = s-codcia
        ...
        FOR EACH AlmDInv OF AlmCInv NO-LOCK:
            ...
            FIND FIRST tt-AlmDInv WHERE tt-almdinv.codalm = lAlmx AND tt-almdinv.nropagina = lPag AND almdinv.codubi = lZona EXCLUSIVE NO-ERROR.
            IF NOT AVAILABLE tt-almDInv THEN DO:
                CREATE tt-AlmDInv.
                ASSIGN tt-AlmDInv.codalm = lAlmx
                        tt-AlmDInv.nropagina = lPag
                        tt-AlmDInv.codubi = lZona
                        tt-AlmDInv.libre_d01 = 0
                        tt-AlmDInv.libre_c01 = ""
                        tt-AlmDInv.libre_c02 = ""
                        tt-AlmDInv.libre_c03 = "" .
                IF almCinv.swConteo = YES THEN tt-AlmDInv.libre_c01 = "Si".
                IF almCinv.swReConteo = YES THEN tt-AlmDInv.libre_c02 = "Si".
                IF almCinv.sw3Conteo = YES THEN tt-AlmDInv.libre_c03 = "Si".
...
cRange = "G" + cColumn.
chWorkSheet:Range(cRange):Value = "Cant.Articulos".
...
FOR EACH tt-AlmDInv NO-LOCK :
    ...
    cRange = "E" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.libre_c02.
    cRange = "F" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.libre_c03.
    cRange = "G" + cColumn.
