...
DEFINE VARIABLE h_b-matalm01 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     Btn-Asigna AT ROW 4.23 COL 105.29 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 118.29 BY 18.96
...
DO:
   RUN Asigna-por-Articulos IN h_b-matalm01.
END.
...
DO:
  RUN Asigna-por-Familia IN h_b-matalm01.
END.
...
DO:
  RUN Asigna-por-Marca IN h_b-matalm01.
END.
...
DO:
  RUN Asigna-por-Proveedor IN h_b-matalm01.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/b-matalm01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_b-matalm01 ).
       RUN set-position IN h_b-matalm01 ( 1.12 , 1.86 ) NO-ERROR.
       RUN set-size IN h_b-matalm01 ( 14.88 , 102.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv05 ).
       RUN set-position IN h_p-updv05 ( 5.42 , 104.72 ) NO-ERROR.
       RUN set-size IN h_p-updv05 ( 6.73 , 13.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/v-matalm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-matalm ).
       RUN set-position IN h_v-matalm ( 16.12 , 2.29 ) NO-ERROR.
       /* Size in UIB:  ( 3.23 , 96.00 ) */

       /* Links to SmartBrowser h_b-matalm01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_b-matalm01 ).

       /* Links to SmartViewer h_v-matalm. */
       RUN add-link IN adm-broker-hdl ( h_b-matalm01 , 'Record':U , h_v-matalm ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-matalm01 ,
