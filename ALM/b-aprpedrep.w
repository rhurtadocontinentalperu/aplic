...
almcrepo.FchDoc almcrepo.FchVto almcrepo.NroSer almcrepo.NroDoc ~
almcrepo.Glosa almcrepo.FchApr almcrepo.HorApr 
...
&Scoped-Define ENABLED-OBJECTS x-FlgEst x-FlgSit br_table 
...
/* BROWSE-TAB br_table x-FlgSit F-Main */
ASSIGN 
...
"almcrepo.FchDoc" "Emision" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[5]   = INTEGRAL.almcrepo.NroSer
     _FldNameList[6]   = INTEGRAL.almcrepo.NroDoc
     _FldNameList[7]   = INTEGRAL.almcrepo.Glosa
     _FldNameList[8]   > INTEGRAL.almcrepo.FchApr
"almcrepo.FchApr" "Fecha!Aprob." ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.almcrepo.HorApr
"almcrepo.HorApr" "Hor!Aprob." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
