...
&SCOPED-DEFINE Condiciontareas ( VtaCDocu.CodCia = s-codcia ~
    AND VtaCDocu.DivDes = s-coddiv ~
    AND VtaCDocu.UsrSac = piksacadores.codper ~
    AND (rsTareas = 3 OR (rsTareas = 1 AND LOOKUP(VtaCDocu.FlgSit,'T,P') > 0 ) ~
         OR (rsTareas = 2 AND VtaCDocu.FlgSit = 'C') ~
         ) ~
    )
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-8 VtaCDocu.CodPed VtaCDocu.NroPed ~
VtaCDocu.FchInicio VtaCDocu.UsuarioInicio VtaCDocu.FchFin ~
VtaCDocu.UsuarioFin fTiempo() @ x-Tiempo VtaCDocu.Items VtaCDocu.ImpTot ~
VtaCDocu.Peso VtaCDocu.Volumen 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-8 
&Scoped-define QUERY-STRING-BROWSE-8 FOR EACH VtaCDocu ~
      WHERE {&Condiciontareas} NO-LOCK ~
    BY VtaCDocu.FchInicio DESCENDING INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-8 OPEN QUERY BROWSE-8 FOR EACH VtaCDocu ~
      WHERE {&Condiciontareas} NO-LOCK ~
    BY VtaCDocu.FchInicio DESCENDING INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-8 VtaCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-8 VtaCDocu
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-8 W-Win _STRUCTURED
  QUERY BROWSE-8 NO-LOCK DISPLAY
      ...
      VtaCDocu.FchInicio COLUMN-LABEL "Fecha!Inicio" FORMAT "99/99/9999 HH:MM:SS":U
      VtaCDocu.UsuarioInicio COLUMN-LABEL "Usuario!Inicio" FORMAT "x(10)":U
      VtaCDocu.FchFin COLUMN-LABEL "Fecha!Devol." FORMAT "99/99/9999 HH:MM:SS":U
      VtaCDocu.UsuarioFin COLUMN-LABEL "Usuario!Devol" FORMAT "x(10)":U
      fTiempo() @ x-Tiempo COLUMN-LABEL "Tiempo usado" FORMAT "x(20)":U
      VtaCDocu.Items FORMAT ">>>,>>9":U
      VtaCDocu.ImpTot COLUMN-LABEL "Importe" FORMAT "->>>,>>>,>>9.99":U
      VtaCDocu.Peso COLUMN-LABEL "Peso!Kgrs" FORMAT "->>>,>>9.99":U
      VtaCDocu.Volumen COLUMN-LABEL "Volumen!cm3" FORMAT "->>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-8
     ...
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _OrdList          = "INTEGRAL.VtaCDocu.FchInicio|no"
...
"VtaCDocu.NroPed" "Numero" "X(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCDocu.FchInicio
"VtaCDocu.FchInicio" "Fecha!Inicio" "99/99/9999 HH:MM:SS" "datetime" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaCDocu.UsuarioInicio
"VtaCDocu.UsuarioInicio" "Usuario!Inicio" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaCDocu.FchFin
"VtaCDocu.FchFin" "Fecha!Devol." "99/99/9999 HH:MM:SS" "datetime" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaCDocu.UsuarioFin
"VtaCDocu.UsuarioFin" "Usuario!Devol" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaCDocu.ImpTot" "Importe" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.VtaCDocu.Peso
"VtaCDocu.Peso" "Peso!Kgrs" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.VtaCDocu.Volumen
"VtaCDocu.Volumen" "Volumen!cm3" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-8 */
&ANALYZE-RESUME
...
OCXFile = SEARCH( "w-control-picking-v2.wrx":U ).
IF OCXFile = ? THEN
...
IF OCXFile = ? THEN DO:
    ...
    PROPATH = PROPATH + "," + OCXFile + "aplic/alm".
END.
...
END.
ELSE MESSAGE "w-control-picking-v2.wrx":U SKIP(1)
