...
&Scoped-Define ENABLED-FIELDS Almmmatg.CtoPrm[1] Almmmatg.CtoPrm[2] 
...
Almmmatg.UndStk Almmmatg.CtoPrm[1] Almmmatg.CtoPrm[2] 
...
DEFINE FRAME F-Main
     Almmmatg.codmat AT ROW 1.38 COL 16 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10.43 BY 1
     Almmmatg.DesMat AT ROW 2.35 COL 16 COLON-ALIGNED WIDGET-ID 8 FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 74 BY 1
     Almmmatg.UndStk AT ROW 3.31 COL 16 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 8.43 BY 1
     Almmmatg.CtoPrm[1] AT ROW 4.27 COL 50 COLON-ALIGNED WIDGET-ID 4
          LABEL "Cantidad a Reponer Mayorista" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
          BGCOLOR 11 FGCOLOR 0 
     Almmmatg.CtoPrm[2] AT ROW 5.23 COL 50 COLON-ALIGNED WIDGET-ID 6
          LABEL "Cantidad a Reponer Minorista" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
          BGCOLOR 11 FGCOLOR 0 
...
/* SETTINGS FOR FILL-IN Almmmatg.codmat IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN Almmmatg.CtoPrm[1] IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN Almmmatg.CtoPrm[2] IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
...
------------------------------------------------------------------------------*/
  ...
  /* Actualizamos los almacenes (el filtro es similar al alm/t-stkminxcamp) */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  RUN Procesa-Handle IN lh_handle ('Repinta-Reposicion').
