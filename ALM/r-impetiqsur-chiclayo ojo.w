...
/*             ELSE f-PrePromocional = X-PREVTA2. */
            f-PrePromocional = ROUND(X-PREVTA1, 4).
        END.
    END.
    ...
    IF almmmatg.undA <> ? AND almmmatg.undA <> "" THEN DO:
        ...
        dPreuni = ROUND( (dPreUni + f-FleteUnitario) * (1 - f-DtoPromocional / 100), 2 ).
        lPrecioVenta_undA = dPreuni.
        /* Venta Unidad A  */
        FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
            AND Almtconv.Codalter = almmmatg.undA
        ...
        IF AVAILABLE almtconv THEN DO:
            ...
            lPrecio_undA = lPrecioVenta_undA / almtconv.equival. 
        END.
/*         MESSAGE 'Unidad A' SKIP                                          */
/*             'f-PrePromocional' f-PrePromocional 'f-Factor' f-Factor SKIP */
/*             'f-DtoPromocional' f-DtoPromocional SKIP                     */
/*             'dPreuni' dPreuni SKIP                                       */
/*             'lUnidadVenta_undA' lUnidadVenta_undA SKIP                   */
/*             'lQty_undA' lQty_undA 'lPrecio_undA' lPrecio_undA.           */
