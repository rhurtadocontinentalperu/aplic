...
DEF NEW SHARED VAR s-CodAlm AS CHAR INIT '65'.      /* FIJO: Almacén 1er. Piso */
DEF            VAR pCodAlm  AS CHAR INIT '65s'.     /* FIJO: Almacén 2do. Piso */
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    ASSIGN 
        ...
        FacCPedi.CodAlm = pCodAlm       /* 65s */
        Faccpedi.CodCli = s-CodAlm      /* 65 */
...
FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = s-codcia
    ...
    IF x-StockMaximo <= 0 THEN x-StockMaximo = 1.   /* Valor por defecto */
