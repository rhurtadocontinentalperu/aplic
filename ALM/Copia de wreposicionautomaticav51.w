...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fFSDespacho W-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fStkDisponible W-Win 
...
RUN Limpiar-Filtros IN h_b-pedrepautv51.
RUN adm-open-query IN h_b-pedrepautv51.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fFSDespacho W-Win 
FUNCTION fFSDespacho RETURNS DECIMAL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fStkDisponible W-Win 
FUNCTION fStkDisponible RETURNS DECIMAL
  ( INPUT pCodAlm AS CHAR,
    INPUT pCodMat AS CHAR ):
/*------------------------------------------------------------------------------
