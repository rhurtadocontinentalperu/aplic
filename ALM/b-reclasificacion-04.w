...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(55)":U WIDTH 53.86
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(15)":U WIDTH 15.43
      Almdmov.CodUnd COLUMN-LABEL "Unidad" FORMAT "X(10)":U WIDTH 5.86
      Almdmov.CanDes FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 101 BY 6.73
         FONT 4
         TITLE "COMPONENTES".
...
"Almmmatg.DesMat" ? "X(55)" "character" ? ? ? ? ? ? no ? no no "53.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" "X(15)" "character" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > integral.Almdmov.CodUnd
"Almdmov.CodUnd" "Unidad" ? "character" ? ? ? ? ? ? no ? no no "5.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
