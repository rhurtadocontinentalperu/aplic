...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCFamMat WHERE ~{&KEY-PHRASE} ~
      AND VtaCFamMat.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaCFamMat WHERE ~{&KEY-PHRASE} ~
      AND VtaCFamMat.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaCFamMat
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaCFamMat
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "VtaCFamMat.CodCia = s-codcia"
