...
&SCOPED-DEFINE CODIGO Almmmate.codmat
...
DO:
  RUN ALM/D-DETMOVv2 (almmmatg.codmat, almmmatg.desmat).
END.
...
DO:
    ...
    &IF "{&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}" &THEN
        ...
        IF NOT AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN DO:
            ...
            RETURN.
        END.
        REPOSITION {&BROWSE-NAME} TO ROWID ROWID( almmmate ) NO-ERROR.
