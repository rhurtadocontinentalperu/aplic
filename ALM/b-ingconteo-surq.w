...
&Scoped-Define ENABLED-OBJECTS RECT-67 RECT-68 txt-page btn-consulta ~
txt-codalmac txt-codinv br_table btn_ingresa btn-lista btn-grabar ~
btn-cancelar btn-exit 
&Scoped-Define DISPLAYED-OBJECTS txt-page txt-codalmac txt-nombre1 ~
txt-totpag txt-codinv 
...
DEFINE FRAME F-Main
     txt-page AT ROW 1.5 COL 79 COLON-ALIGNED WIDGET-ID 36
     btn-consulta AT ROW 1.54 COL 95 WIDGET-ID 8
     txt-codalmac AT ROW 1.73 COL 14 COLON-ALIGNED WIDGET-ID 24
     txt-nombre1 AT ROW 1.73 COL 23.72 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     txt-totpag AT ROW 2.35 COL 79 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     txt-codinv AT ROW 2.69 COL 14 COLON-ALIGNED WIDGET-ID 28
     br_table AT ROW 4.23 COL 4
     btn_ingresa AT ROW 5.58 COL 87 WIDGET-ID 12
     btn-dif AT ROW 7.04 COL 87 WIDGET-ID 42
     btn-lista AT ROW 8.54 COL 87.14 WIDGET-ID 46
     btn-grabar AT ROW 10.08 COL 87.14 WIDGET-ID 44
     btn-cancelar AT ROW 11.62 COL 87.14 WIDGET-ID 40
     btn-exit AT ROW 13.27 COL 90 WIDGET-ID 38
     "Total Pág:" VIEW-AS TEXT
          SIZE 8.86 BY .5 AT ROW 2.42 COL 72.14 WIDGET-ID 48
          FONT 6
     RECT-67 AT ROW 1.27 COL 2 WIDGET-ID 32
     RECT-68 AT ROW 3.96 COL 2 WIDGET-ID 34
...
/* SETTINGS FOR BUTTON btn-dif IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       btn-dif:HIDDEN IN FRAME F-Main           = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FIND LAST invconfig WHERE invconfig.codcia = s-codcia
          AND invconfig.codalm = "10x"  NO-LOCK NO-ERROR.
