...
DEFINE VARIABLE h_b-aprob-abastec-v2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-aprob-abastec-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aprob-abastec-v2 ).
       RUN set-position IN h_b-aprob-abastec-v2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-aprob-abastec-v2 ( 13.42 , 144.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-aprob-abastec-v2 , 'Record':U , h_b-aprob-abastec-d ).
...
CASE pParametro:
    ...
    WHEN 'disable-header' THEN DO:
         ...
         RUN disable-filtros IN h_b-aprob-abastec-v2.
    END.
    WHEN 'enable-header' THEN DO:
         RUN dispatch IN h_p-updv96-2 ('enable':U).
         RUN Enable-Filtros IN h_b-aprob-abastec-v2.
    END.
    WHEN 'open-queries' THEN DO:
        RUN dispatch IN h_b-aprob-abastec-v2 ('open-query':U).
