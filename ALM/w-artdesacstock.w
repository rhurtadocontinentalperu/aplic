...
&Scoped-Define ENABLED-OBJECTS txt-codalm BUTTON-1 BUTTON-6 BUTTON-7 
&Scoped-Define DISPLAYED-OBJECTS txt-codalm x-mensaje 
...
DEFINE FRAME F-Main
     txt-codalm AT ROW 2.08 COL 12 COLON-ALIGNED WIDGET-ID 30
     BUTTON-1 AT ROW 2.08 COL 62 WIDGET-ID 62
     BUTTON-6 AT ROW 3.96 COL 55 WIDGET-ID 64
     BUTTON-7 AT ROW 3.96 COL 62 WIDGET-ID 66
     x-mensaje AT ROW 4.5 COL 4 COLON-ALIGNED NO-LABEL WIDGET-ID 68
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 75.86 BY 6.19 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Articulos Desactivados con Stock"
         HEIGHT             = 6.19
         WIDTH              = 75.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 93
...
ON END-ERROR OF W-Win /* Articulos Desactivados con Stock */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Articulos Desactivados con Stock */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY txt-codalm x-mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-codalm BUTTON-1 BUTTON-6 BUTTON-7 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*Header del Excel */
cRange = "E" + '2'.
chWorkSheet:Range(cRange):Value = "ARTICULOS DESACTIVADOS CON STOCK".
cRange = "K" + '2'.
...
cRange = "B" + cColumn.
chWorkSheet:Range(cRange):Value = "Cod Ubi.".
cRange = "C" + cColumn.
...
FOR EACH almmmate WHERE almmmate.codcia = s-codcia
    AND LOOKUP(TRIM(almmmate.codalm),txt-codalm) > 0
    AND almmmate.stkact <> 0  NO-LOCK,
    FIRST almmmatg OF almmmate
        WHERE almmmatg.tpoart = "D" NO-LOCK:
    
    DISPLAY "PROCESANDO: ALMACEN " + almmmate.codalm @ x-mensaje
