...
DEF VAR s-tabla AS CHAR INIT 'KITREMATE'.
...
<SORTBY-OPTIONS>
Valor[2]|y||INTEGRAL.VtaTabla.Valor[2]|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'Valor[2]' + '",
     SortBy-Case = ':U + 'Valor[2]').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Producto" FORMAT "x(14)":U
      Almmmatg.DesMat FORMAT "X(60)":U
      VtaTabla.Valor[1] COLUMN-LABEL "Importe S/. mayor a" FORMAT ">>>,>>>,>>9.99":U
      VtaTabla.Valor[2] COLUMN-LABEL "Importe S/. menor o igual a" FORMAT ">>>,>>>,>>9.99":U
  ENABLE
      VtaTabla.Llave_c1
      VtaTabla.Valor[1]
      VtaTabla.Valor[2]
...
"VtaTabla.Llave_c1" "Producto" "x(14)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Valor[1]
"VtaTabla.Valor[1]" "Importe S/. mayor a" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Valor[2]
"VtaTabla.Valor[2]" "Importe S/. menor o igual a" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF VtaTabla.Llave_c1 IN BROWSE br_table /* Producto */
DO:
    DEF VAR pCodMat AS CHAR NO-UNDO.
    pCodMat = SELF:SCREEN-VALUE.
    IF pCodMat = ? OR pCodMat = '' THEN RETURN.
...
ON 'RETURN':U OF VtaTabla.Llave_c1, VtaTabla.Valor[1], VtaTabla.Valor[2]
DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Valor[2]':U THEN DO:
      &Scope SORTBY-PHRASE BY VtaTabla.Valor[2]
...
FIND Almmmatg WHERE Almmmatg.codcia = s-codcia
    AND Almmmatg.codmat = Llave_c1:SCREEN-VALUE IN BROWSE {&browse-name}
    NO-LOCK NO-ERROR.
IF NOT AVAILABLE Almmmatg THEN DO:
    MESSAGE 'Código del producto no registrado' VIEW-AS ALERT-BOX ERROR.
    APPLY 'ENTRY':U TO Llave_c1 IN BROWSE {&browse-name}.
    RETURN 'ADM-ERROR'.
END.
RETURN "OK".
