...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Imprime_Old V-table-Win 
PROCEDURE Imprime_Old :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
------------------------------------------------------------------------------*/
    ...
    /*Impresión Transferencias*/
    FIND FIRST DI-RutaG OF DI-RutaC NO-LOCK NO-ERROR.
    IF AVAILABLE DI-RutaG THEN DO:
        MESSAGE "Imprimirá Hoja de Ruta para Transferencias.".
        GET-KEY-VALUE SECTION 'Startup' KEY 'BASE' VALUE RB-REPORT-LIBRARY.
        RB-REPORT-LIBRARY = RB-REPORT-LIBRARY + 'alm/rbalm.prl'.
        RB-REPORT-NAME = 'Hoja Ruta3'.
        RB-INCLUDE-RECORDS = "O".
    ...
    /*Impresión Guia Itinerante*/
    FIND FIRST DI-RutaDG OF DI-RutaC NO-LOCK NO-ERROR.
    IF AVAILABLE DI-RutaDG THEN DO:
        MESSAGE "Imprimirá Hoja de Ruta para las Guias Itinerantes.".
        GET-KEY-VALUE SECTION 'Startup' KEY 'BASE' VALUE RB-REPORT-LIBRARY.
        RB-REPORT-LIBRARY = RB-REPORT-LIBRARY + 'alm/rbalm.prl'.
        RB-REPORT-NAME = 'Hoja Ruta4'.
        RB-INCLUDE-RECORDS = "O".
