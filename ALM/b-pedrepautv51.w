...
(COMBO-BOX-ClfGral = 'Todas' OR T-DREPO.ClfGral = COMBO-BOX-ClfGral) AND ~
...
(COMBO-BOX-FaltanteGrupo = 'Todos' OR T-DREPO.FaltanteGrupo = COMBO-BOX-FaltanteGrupo) ~
)
...
(COMBO-BOX-FaltanteGrupo = 'Todos' OR BT-DREPO.FaltanteGrupo = COMBO-BOX-FaltanteGrupo) ~
)
...
T-DREPO.DesSaldo T-DREPO.GrpStkDis T-DREPO.FSGrupo T-DREPO.DesStkMax ~
...
T-DREPO.CodUbi T-DREPO.FaltanteGrupo 
...
COMBO-BOX-ClfGral COMBO-BOX-Sector FILL-IN-DesMat COMBO-BOX-ClfMayo ~
BUTTON-Limpiar-Orden COMBO-BOX-Lineas COMBO-BOX-SubLineas ~
COMBO-BOX-FaltanteGrupo COMBO-BOX-ClfUtil br_table BUTTON-998 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Marcas COMBO-BOX-Almacen ~
COMBO-BOX-ClfGral FILL-IN-Inner FILL-IN-Estado COMBO-BOX-Sector ~
FILL-IN-DesMat COMBO-BOX-ClfMayo FILL-IN-Master COMBO-BOX-Lineas ~
COMBO-BOX-SubLineas COMBO-BOX-FaltanteGrupo COMBO-BOX-ClfUtil ~
...
DEFINE VARIABLE COMBO-BOX-FaltanteGrupo AS CHARACTER FORMAT "X(256)":U INITIAL "Todos" 
     LABEL "Faltante Grupo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DREPO.DesMat FORMAT "X(60)":U WIDTH 36.86
      ...
      T-DREPO.FaltanteGrupo FORMAT "x(8)":U
  ENABLE
      T-DREPO.CodMat
      T-DREPO.AlmPed
      T-DREPO.CanReq
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141 BY 17.5
...
DEFINE FRAME F-Main
     COMBO-BOX-Marcas AT ROW 1 COL 7 COLON-ALIGNED WIDGET-ID 72
     COMBO-BOX-Almacen AT ROW 1 COL 46 COLON-ALIGNED WIDGET-ID 80
     COMBO-BOX-ClfGral AT ROW 1 COL 88 COLON-ALIGNED WIDGET-ID 84
     FILL-IN-Inner AT ROW 1 COL 113 COLON-ALIGNED WIDGET-ID 70
     FILL-IN-Estado AT ROW 1 COL 131 COLON-ALIGNED WIDGET-ID 66
     COMBO-BOX-Sector AT ROW 1.81 COL 7 COLON-ALIGNED WIDGET-ID 88
     FILL-IN-DesMat AT ROW 1.81 COL 46 COLON-ALIGNED WIDGET-ID 90
     COMBO-BOX-ClfMayo AT ROW 1.81 COL 88 COLON-ALIGNED WIDGET-ID 86
     FILL-IN-Master AT ROW 1.81 COL 113 COLON-ALIGNED WIDGET-ID 62
     BUTTON-Limpiar-Orden AT ROW 2.08 COL 130 WIDGET-ID 132
     COMBO-BOX-Lineas AT ROW 2.62 COL 7 COLON-ALIGNED WIDGET-ID 74
     COMBO-BOX-SubLineas AT ROW 2.62 COL 25 COLON-ALIGNED WIDGET-ID 76
     COMBO-BOX-FaltanteGrupo AT ROW 2.62 COL 46 COLON-ALIGNED WIDGET-ID 136
     COMBO-BOX-ClfUtil AT ROW 2.62 COL 88 COLON-ALIGNED WIDGET-ID 82
     FILL-IN-Reposicion AT ROW 2.62 COL 113 COLON-ALIGNED WIDGET-ID 64
     br_table AT ROW 3.42 COL 1
     FILL-IN-Total AT ROW 21.46 COL 9 COLON-ALIGNED WIDGET-ID 94
     FILL-IN-Peso AT ROW 21.46 COL 26 COLON-ALIGNED WIDGET-ID 96
     FILL-IN-Volumen AT ROW 21.46 COL 43 COLON-ALIGNED WIDGET-ID 98
     FILL-IN-Stock AT ROW 21.46 COL 64 COLON-ALIGNED WIDGET-ID 100
     FILL-IN-Transferencias AT ROW 21.46 COL 83 COLON-ALIGNED WIDGET-ID 102
     FILL-IN-Compras AT ROW 21.46 COL 103 COLON-ALIGNED WIDGET-ID 104
     FILL-IN-Items AT ROW 21.46 COL 119 COLON-ALIGNED WIDGET-ID 118
     BUTTON-998 AT ROW 22.81 COL 53 WIDGET-ID 134
     "F8 : Stocks x Almacenes F7 : Pedidos F9 : Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 62 BY .5 AT ROW 20.92 COL 1 WIDGET-ID 12
          FONT 0
     "F10: Kardex Almacén Despacho  F11: Faltante/Sobrante" VIEW-AS TEXT
          SIZE 54 BY .5 AT ROW 20.92 COL 65 WIDGET-ID 68
          FONT 0
...
"T-DREPO.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "36.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.SolStkCom" "Stock!Reservado" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.T-DREPO.DesSaldo
"T-DREPO.DesSaldo" "Faltante/Sobrante!Despacho" "(ZZZ,ZZZ,ZZ9.99)" "decimal" 14 0 ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > Temp-Tables.T-DREPO.GrpStkDis
"T-DREPO.GrpStkDis" "Disponible!Grupo" "(ZZZ,ZZZ,ZZ9.99)" "decimal" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > Temp-Tables.T-DREPO.FSGrupo
"T-DREPO.FSGrupo" "Faltante/Sobrante!Grupo" "(ZZZ,ZZZ,ZZ9.99)" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > Temp-Tables.T-DREPO.DesStkMax
"T-DREPO.DesStkMax" "Stock Máximo!Despacho" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > INTEGRAL.Almmmate.StkMax
"Almmmate.StkMax" "Empaque!Reposición" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > INTEGRAL.Almmmatg.CanEmp
...
"T-DREPO.CanGen * (IF Almmmatg.MonVta = 2 THEN Almmmatg.CtoTot * Almmmatg.TpoCmb ELSE Almmmatg.CToTot) @ Almmmatg.CtoTot" "Costo de!Reposición" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > Temp-Tables.T-DREPO.Origen
"T-DREPO.Origen" ? ? "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[24]   > Temp-Tables.T-DREPO.ClfGral
"T-DREPO.ClfGral" "Clasf!Gral" "x" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[25]   = Temp-Tables.T-DREPO.ClfMayo
     _FldNameList[26]   = Temp-Tables.T-DREPO.ClfUtil
...
"(T-DREPO.CanGen * Almmmatg.Libre_d02 / 1000000) @ x-Volumen" "Volumen en m3" ">>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[29]   = Temp-Tables.T-DREPO.CodFam
     _FldNameList[30]   = INTEGRAL.Almtfami.desfam
     _FldNameList[31]   = Temp-Tables.T-DREPO.SubFam
     _FldNameList[32]   = INTEGRAL.AlmSFami.dessub
     _FldNameList[33]   > Temp-Tables.T-DREPO.CodZona
"T-DREPO.CodZona" "Sector" "x(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > Temp-Tables.T-DREPO.CodUbi
"T-DREPO.CodUbi" "Ubicacion" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   = Temp-Tables.T-DREPO.FaltanteGrupo
...
/*     &SCOPED-DEFINE MYWHERE (IF INDEX(lQueryPrepare,' WHERE ') = 0 THEN ' WHERE ' ELSE '')                                  */
/*     &SCOPED-DEFINE MYAND (IF INDEX(lQueryPrepare,' WHERE ') > 0 AND INDEX(lQueryPrepare,' AND ') > 0 THEN ' AND ' ELSE '') */
    
    lQueryPrepare = "FOR EACH T-DREPO NO-LOCK WHERE TRUE".
    CASE COMBO-BOX-ClfGral:
        WHEN 'Todas' THEN .
        OTHERWISE lQueryPrepare = lQueryPrepare + {&MYAND} + "T-DREPO.ClfGral = '" + COMBO-BOX-ClfGral + "'".
    END CASE.
    CASE COMBO-BOX-ClfMayo:
        WHEN 'Todas' THEN .
        OTHERWISE lQueryPrepare = lQueryPrepare + {&MYAND}  + "T-DREPO.ClfMayo = '" + COMBO-BOX-ClfMayo + "'".
    END CASE.
    CASE COMBO-BOX-ClfUtil:
        WHEN 'Todas' THEN .
        OTHERWISE lQueryPrepare = lQueryPrepare + {&MYAND}  + "T-DREPO.ClfUtil = '" + COMBO-BOX-ClfUtil + "'".
    END CASE.
    ...
    END CASE.
    CASE COMBO-BOX-FaltanteGrupo:
        WHEN 'Todos' THEN .
        OTHERWISE lQueryPrepare = lQueryPrepare + {&MYAND}  + "T-DREPO.FaltanteGrupo = '" + COMBO-BOX-FaltanteGrupo + "'".
    END CASE.
    /*MESSAGE lqueryprepare.*/
...
&Scoped-define SELF-NAME COMBO-BOX-FaltanteGrupo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-BOX-FaltanteGrupo B-table-Win
ON VALUE-CHANGED OF COMBO-BOX-FaltanteGrupo IN FRAME F-Main /* Faltante Grupo */
DO:
    ASSIGN {&SELF-NAME}.
    RUN dispatch IN THIS-PROCEDURE ('open-query':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      COMBO-BOX-FaltanteGrupo:SENSITIVE = YES.
  END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      COMBO-BOX-FaltanteGrupo:SENSITIVE = NO.
  END.
