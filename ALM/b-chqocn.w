...
DO:
  ...
  IF NOT AVAILABLE Lg-docmp THEN DO:
    MESSAGE 'Artículo NO registrado en la Orden de Compra'
...
DO:
    ...
    IF NOT AVAILABLE Lg-cocmp THEN DO:
        MESSAGE "Orden de Compra NO válida" VIEW-AS ALERT-BOX WARNING.
        RETURN NO-APPLY.
    END.
    IF Lg-cocmp.fchvto < TODAY THEN DO:
        MESSAGE 'La orden de compra ya venció el' Lg-cocmp.fchvto 
...
/*   END.                                                                      */
  ...
  FOR EACH C-Detalle:
      FIND Lg-docmp WHERE Lg-docmp.codcia = s-codcia
          ...
          NO-LOCK NO-ERROR.
      IF NOT AVAILABLE Lg-docmp THEN DO:
          MESSAGE 'Producto' C-Detalle.codmat 'NO está registrado en la orden de compra'
              VIEW-AS ALERT-BOX ERROR.
          RETURN 'ADM-ERROR'.
      END.
      IF C-Detalle.CanDes > (Lg-docmp.CanPed - LG-DOCmp.CanAten) THEN DO:
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR'
    ...
    IF ERROR-STATUS:ERROR THEN DO:
        MESSAGE 'NO pudo bloquear el almacén' Almtdocm.CodAlm VIEW-AS ALERT-BOX ERROR.
        UNDO, RETURN 'ADM-ERROR'.        
    END.
