...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH TabGener ~
      WHERE TabGener.CodCia = s-codcia ~
 AND TabGener.Clave = "ZG" ~
 AND TabGener.Libre_l01 = TRUE NO-LOCK, ~
      FIRST Almacen WHERE Almacen.CodCia = TabGener.CodCia ~
  AND Almacen.CodAlm = TabGener.Libre_c01 NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH TabGener ~
      WHERE TabGener.CodCia = s-codcia ~
 AND TabGener.Clave = "ZG" ~
 AND TabGener.Libre_l01 = TRUE NO-LOCK, ~
      FIRST Almacen WHERE Almacen.CodCia = TabGener.CodCia ~
  AND Almacen.CodAlm = TabGener.Libre_c01 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 TabGener Almacen
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 TabGener
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "INTEGRAL.TabGener,INTEGRAL.Almacen WHERE INTEGRAL.TabGener ..."
     _Options          = "NO-LOCK"
