...
DEFINE VARIABLE h_b-consulincidcabv2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-consulincidcabv2.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consulincidcabv2 ).
       RUN set-position IN h_b-consulincidcabv2 ( 1.15 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-consulincidcabv2 ( 14.00 , 140.43 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-consulincidcabv2 , 'Record':U , h_b-consul-dincidencia ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-consulincidcabv2 ,
...
CASE pParam:
    WHEN "Header" THEN DO:
        RUN Carga-Cabecera IN h_b-consulincidcabv2 ( INPUT-OUTPUT TABLE Cabecera).
    ...
    END.
    WHEN "Detail" THEN DO:
        RUN Carga-Detalle IN h_b-consulincidcabv2 ( INPUT-OUTPUT TABLE Detalle).
        /* Programas que generan el Excel */
...
DEF INPUT PARAMETER pParam AS CHAR.
    ...
    CASE pParam:
        WHEN "Header" THEN DO:
            RUN Carga-Cabecera IN h_b-consulincidcabv2 ( INPUT-OUTPUT TABLE Cabecera).
            IF NOT CAN-FIND (FIRST Cabecera NO-LOCK) THEN DO:
                MESSAGE 'Ho hay datos que exportar' VIEW-AS ALERT-BOX WARNING.
                RETURN.
            END.
            cArchivo = LC(pArchivo).
            SESSION:SET-WAIT-STATE('GENERAL').
            RUN lib/tt-filev2 (TEMP-TABLE Cabecera:HANDLE, cArchivo, pOptions).
            SESSION:SET-WAIT-STATE('').
        END.
        WHEN "Detail" THEN DO:
            RUN Carga-Detalle IN h_b-consulincidcabv2 ( INPUT-OUTPUT TABLE Detalle).
