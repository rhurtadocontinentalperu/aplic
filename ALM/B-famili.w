...
DEFINE SHARED VAR S-CODFAM AS CHARACTER.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 33 BY 10.12
         FONT 4
         TITLE "Familias".
...
ON ANY-PRINTABLE OF br_table IN FRAME F-Main /* Familias */
DO:
  RETURN NO-APPLY.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON MOUSE-SELECT-DBLCLICK OF br_table IN FRAME F-Main /* Familias */
DO:
  RUN Proc-Aceptar IN lh_Handle.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON RETURN OF br_table IN FRAME F-Main /* Familias */
DO:
  RUN Proc-Aceptar IN lh_Handle.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Selecciona-Familia B-table-Win 
PROCEDURE Selecciona-Familia :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
   ASSIGN
        S-CODFAM = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codfam.
END PROCEDURE.
