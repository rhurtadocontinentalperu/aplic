...
AlmDCdoc.NroDoc x-NomCli @ x-NomCli AlmDCdoc.CodAlm AlmDCdoc.Bultos ~
AlmDCdoc.Observ 
...
****/ ~
 ...
 AND AlmDCdoc.CodCli BEGINS FILL-IN-CodCli ~
...
FILL-IN-NroDoc FILL-IN-Fecha FILL-IN-Fecha-2 FILL-IN-CodCli br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-CodAlm COMBO-BOX-CodDoc ~
FILL-IN-NroDoc FILL-IN-Fecha FILL-IN-Fecha-2 FILL-IN-NomCli FILL-IN-CodCli 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmDCdoc.Observ FORMAT "x(40)":U WIDTH 27.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     FILL-IN-NomCli AT ROW 4.04 COL 23 COLON-ALIGNED NO-LABEL
...
****/
 ...
 AND INTEGRAL.AlmDCdoc.CodCli BEGINS FILL-IN-CodCli
 /*AND (AlmDCdoc.FlgEst = ""S""
...
"AlmDCdoc.NroDoc" "<<Numero>>" "X(12)" "character" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"x-NomCli @ x-NomCli" "Nombre" "x(50)" ? ? ? ? ? ? ? no ? no no "40" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.AlmDCdoc.CodAlm
...
"AlmDCdoc.Observ" ? ? "character" ? ? ? ? ? ? no ? no no "27.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH tt-almdcdoc NO-LOCK ,
    FIRST gn-clie WHERE gn-clie.codcia = cl-codcia
        AND gn-clie.codcli = ENTRY(1,tt-almdcdoc.codcli,'|') NO-LOCK
