...
&Scoped-Define ENABLED-OBJECTS RECT-63 RECT-60 RECT-62 F-Almacen desdeF ~
hastaF R-Estado Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS F-Almacen desdeF hastaF C-Tipmov I-CodMov ~
N-MOVI R-Estado F-AlmDes F-NomDes 
...
DEFINE FRAME F-Main
     F-Almacen AT ROW 1.85 COL 5.71
     desdeF AT ROW 2.65 COL 10.43 COLON-ALIGNED
     hastaF AT ROW 2.65 COL 29.14 COLON-ALIGNED
     C-Tipmov AT ROW 3.46 COL 10.43 COLON-ALIGNED
     I-CodMov AT ROW 3.5 COL 20.29 COLON-ALIGNED NO-LABEL
     N-MOVI AT ROW 3.5 COL 24.43 COLON-ALIGNED NO-LABEL
     R-Estado AT ROW 4.46 COL 58.86 NO-LABEL
     Btn_OK AT ROW 5.23 COL 15.43
     Btn_Cancel AT ROW 5.23 COL 37.29
     F-AlmDes AT ROW 8.12 COL 8.43 COLON-ALIGNED NO-LABEL
     F-NomDes AT ROW 8.19 COL 15.29 COLON-ALIGNED NO-LABEL
     RECT-63 AT ROW 1.42 COL 66.14
     RECT-60 AT ROW 5.12 COL 1.14
     RECT-62 AT ROW 1.04 COL 1.29
...
/* SETTINGS FOR FILL-IN F-AlmDes IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       F-AlmDes:HIDDEN IN FRAME F-Main           = TRUE.
...
DO:
  ASSIGN f-Almacen C-TipMov DesdeF HastaF I-CodMov .
  CASE C-tipmov:
  ...
  /*IF I-CODMOV = '' THEN do:
    message "Ingrese un Movimiento" VIEW-AS ALERT-BOX question.
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN DesdeF HastaF C-tipmov I-Codmov R-Estado F-Almacen.
...
------------------------------------------------------------------------------*/
  DISPLAY F-Almacen desdeF hastaF C-Tipmov I-CodMov N-MOVI R-Estado F-AlmDes 
          F-NomDes 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-63 RECT-60 RECT-62 F-Almacen desdeF hastaF R-Estado Btn_OK 
         Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME H-REP
         ...
         "Fecha : " AT 80 STRING(TODAY,"99/99/9999") FORMAT "X(12)" SKIP(1)
    ...
    FOR EACH B-Almacen WHERE B-Almacen.codcia = s-codcia
            AND B-Almacen.codalm BEGINS f-Almacen NO-LOCK,
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
    ENABLE ALL EXCEPT N-MOVI F-ALMACEN i-codmov c-tipmov.
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN DesdeF HastaF C-tipmov I-Codmov R-Estado.
