...
&Scoped-Define ENABLED-OBJECTS RECT-65 BUTTON-Nueva x-NroDoc COMBO-BOX-1 ~
FILL-IN_Observ 
&Scoped-Define DISPLAYED-OBJECTS x-FchDoc x-NroDoc FILL-IN-Almacen ~
COMBO-BOX-1 FILL-IN-tiempo FILL-IN_Observ 
...
DEFINE VARIABLE h_b-chk-ing-dev-otr-v2 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX-1 AT ROW 3.15 COL 12 COLON-ALIGNED WIDGET-ID 2
     FILL-IN-tiempo AT ROW 3.42 COL 83.57 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FILL-IN_Observ AT ROW 3.96 COL 12 COLON-ALIGNED HELP
...
ON END-ERROR OF W-Win /* SLOTING - CHEQUEO DE OTR POR G/R POR TRANSFERENCIAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SLOTING - CHEQUEO DE OTR POR G/R POR TRANSFERENCIAS */
DO:
...
DO:
  ...
  RUN Cerrar-Orden IN h_b-chk-ing-dev-otr-v2(INPUT ENTRY(1,COMBO-BOX-1:SCREEN-VALUE,' - '),
...
OR RETURN OF {&SELF-NAME} DO:
    IF SELF:SCREEN-VALUE = '' THEN DO:
        RUN Captura-Parametros IN h_b-chk-ing-dev-otr-v2 (INPUT pTipo,
                                                       INPUT "" /* CHARACTER */,
                                                       INPUT "" /* CHARACTER */).
        RETURN.
    END.
    ...
    IF x-NroDoc <> SELF:SCREEN-VALUE THEN DO:
        ...
        RUN Captura-Parametros IN h_b-chk-ing-dev-otr-v2
            ( INPUT pTipo,
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/b-chk-ing-dev-otr-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chk-ing-dev-otr-v2 ).
       RUN set-position IN h_b-chk-ing-dev-otr-v2 ( 5.31 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-chk-ing-dev-otr-v2 ( 18.31 , 143.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-chk-ing-dev-otr-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chk-ing-dev-otr-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chk-ing-dev-otr-v2 ,
             FILL-IN_Observ:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_b-chk-ing-dev-otr-v2 , 'AFTER':U ).
    END. /* Page 0 */
...
OCXFile = SEARCH( "w-chk-ingreso-dev-otr-v2.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-chk-ingreso-dev-otr-v2.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY x-FchDoc x-NroDoc FILL-IN-Almacen COMBO-BOX-1 FILL-IN-tiempo 
          FILL-IN_Observ 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-65 BUTTON-Nueva x-NroDoc COMBO-BOX-1 FILL-IN_Observ 
      WITH FRAME F-Main IN WINDOW W-Win.
