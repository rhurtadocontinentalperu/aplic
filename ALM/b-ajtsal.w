...
&Scoped-define QUERY-STRING-br_table FOR EACH ITEM WHERE ~{&KEY-PHRASE} ~
      AND ITEM.TipMov = "S" and ITEM.codcia = s-codcia and ITEM.codalm = xalminv-grpo ~
 NO-LOCK, ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "Temp-Tables.ITEM.TipMov = ""S"" and Temp-Tables.ITEM.codcia = s-codcia and Temp-Tables.ITEM.codalm = xalminv-grpo
"
 ...
 *   END.*/
  ...
  FOR EACH T-Ajuste USE-INDEX Idx02 NO-LOCK WHERE T-Ajuste.TipMov = 'S'
