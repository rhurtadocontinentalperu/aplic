...
&Scoped-Define DATA-FIELDS  codfam codmat DesMat DesMar UndStk StkAct CodUbi FchIng Pesmat
&Scoped-define DATA-FIELDS-IN-Almmmatg codfam DesMat DesMar UndStk FchIng ~
Pesmat 
&Scoped-define DATA-FIELDS-IN-Almmmate codmat StkAct CodUbi 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "alm/dmate-matg.i"
&Scoped-Define DATA-TABLE-NO-UNDO NO-UNDO
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almmmatg NO-LOCK, ~
      FIRST Almmmate OF Almmmatg NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
"codfam" "codfam" "Código!Familia" ? "character" ? ? ? ? ? ? no ? no 6.29 yes "Código!Familia"
     _FldNameList[2]   > INTEGRAL.Almmmate.codmat
"codmat" "codmat" "Codigo!Articulo" ? "character" ? ? ? ? ? ? no ? no 13 yes ?
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNCTION('addQueryWhere',
                   ...
                   "Almmmate.codalm = '" + s-codalm + "'", "Almmmate","").
