...
DEFINE FRAME F-Main
     ...
     INTEGRAL.Almmmatg.DesMat AT ROW 1.27 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 8 FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 57 BY .81
     INTEGRAL.Almmmatg.Libre_c04 AT ROW 2.08 COL 19 COLON-ALIGNED WIDGET-ID 108
...
/* SETTINGS FOR FILL-IN FILL-IN_DesMat-2 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN INTEGRAL.Almmmatg.Libre_c04 IN FRAME F-Main
   NO-ENABLE EXP-LABEL EXP-FORMAT                                       */
...
&Scoped-define SELF-NAME INTEGRAL.Almmmatg.Libre_c04
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL INTEGRAL.Almmmatg.Libre_c04 V-table-Win
ON LEAVE OF INTEGRAL.Almmmatg.Libre_c04 IN FRAME F-Main /* Código Asociado */
DO:
