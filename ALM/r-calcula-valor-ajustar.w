...
DEFINE FRAME F-Main
     ...
     "  Calcular el valor del CONTEO FINALpara ell AJUSTE de inventarios" VIEW-AS TEXT
          SIZE 64 BY .96 AT ROW 1.19 COL 7 WIDGET-ID 106
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VAR lQConteo AS DECIMAL.
    DEFINE VAR lQReConteo AS DECIMAL.
    DEFINE VAR lQ3erConteo AS DECIMAL.

    DEFINE VAR lQMostrar AS DECIMAL.
    DEFINE VAR lFaseInv AS CHAR.
    DEFINE VAR lConteo AS LOGICAL.
    DEFINE VAR lReConteo AS LOGICAL.
    DEFINE VAR l3erConteo AS LOGICAL.

    DEFINE VAR lDifConteo AS DECIMAL.
    DEFINE VAR lDifReConteo AS DECIMAL.
    ...
    FOR EACH AlmDInv USE-INDEX Llave01
        ...
        AND AlmDInv.NomCia =  cNomCia EXCLUSIVE:
        ...
        IF almdinv.libre_c01=? OR almdinv.libre_c01='' THEN DO:
            ...
            ELSE DO:
                /* Si hay RECONTEO */
                lQReconteo = AlmDInv.QtyReConteo.    
                lReConteo = YES.
            END.
        END.
        ELSE DO:
            /* Si existe 3ER CONTEO */
            lQ3erConteo = AlmDInv.libre_d02.
            l3erConteo = YES.
        END.

        IF l3erConteo = YES THEN DO:
            ASSIGN AlmDInv.libre_d01 = lQ3erCOnteo.
        END.
        ELSE DO:
            IF lConteo = YES AND lReconteo = YES THEN DO:
                lDifConteo = ABSOLUTE(almDInv.QtyFisico - lQConteo).
                lDifReConteo = ABSOLUTE(almDInv.QtyFisico - lQReConteo).

                IF lDifConteo < lDifReconteo THEN DO:
                    ASSIGN AlmDInv.libre_d01 = lQCOnteo.
                END.
                ELSE ASSIGN AlmDInv.libre_d01 = lQReCOnteo.
            END.
            ELSE AlmDInv.libre_d01 = lQCOnteo.
        END.
        ...
        END.
        ELSE DO:
            IF lReconteo = YES THEN DO:
                IF almDInv.QtyFisico < 0 THEN DO:
                    /* Si el Fisico es NEGATIVO, se toma el menor del CONTEO y RECONTEO */
                    IF lQReconteo < lQConteo THEN DO:
                        ASSIGN AlmDInv.libre_d01 = lQReCOnteo.
                    END.
                    ELSE ASSIGN AlmDInv.libre_d01 = lQCOnteo.
                END.
                ELSE DO:
                    lDifConteo = 0.
                    lDifReConteo = 0.
                    /* Fisico es POSITIVO  */
                    IF lQConteo <= almDInv.QtyFisico AND lQReConteo <= almDInv.QtyFisico THEN DO:
                        /* Cantidades Inventariadas x DEBAJO del STock Fisico */
                        IF lQConteo > lQReConteo THEN DO:
                            ASSIGN AlmDInv.libre_d01 = lQCOnteo.
                        END.
                        ELSE ASSIGN AlmDInv.libre_d01 = lQReCOnteo.
                    END.
                    ELSE DO: 
                        IF lQConteo >= almDInv.QtyFisico AND lQReConteo >= almDInv.QtyFisico THEN DO:
                            /* Cantidades Inventariadas x ENCIMA del STock Fisico */
                            IF lQConteo < lQReConteo THEN DO:
                                ASSIGN AlmDInv.libre_d01 = lQCOnteo.
                            END.
                            ELSE ASSIGN AlmDInv.libre_d01 = lQReCOnteo.
                        END.
                        ELSE DO:
                            /* Las cantidades Inventariadas estan en los Extremos */
                            lDifConteo = ABSOLUTE(almDInv.QtyFisico - lQConteo).
                            lDifReConteo = ABSOLUTE(almDInv.QtyFisico - lQReConteo).
                            IF lDifConteo < lDifReconteo THEN DO:
                                ASSIGN AlmDInv.libre_d01 = lQCOnteo.
        ...
        */
        ...
        DISPLAY "Calculando Valor para el Ajuste " + AlmDInv.CodMat @ x-mensaje
