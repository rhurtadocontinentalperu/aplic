...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCDocu WHERE ~{&KEY-PHRASE} ~
 ...
 AND LOOKUP(AlmCDocu.CodLlave, s-cco) > 0 NO-LOCK, ~
...
/* Query rebuild information for BROWSE br_table
 ...
 AND AlmCDocu.CodDoc = s-coddoc
 AND AlmCDocu.FlgEst = ""T""
 AND LOOKUP(AlmCDocu.CodLlave, s-cco) > 0"
...
"AlmCDocu.UsrCreacion" "Solicitado por" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.AlmCDocu.CodLlave
...
"cb-auxi.Nomaux" ? "x(40)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.AlmCDocu.Libre_c01
...
ASSIGN
    ...
    AlmCDocu.FlgEst = "WL"      /* Necesita aprobación por Logistica */
