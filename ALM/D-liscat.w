...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Reporte de Articulos X Rotacion Valorizado"
         HEIGHT             = 10.92
         WIDTH              = 57.86
         MAX-HEIGHT         = 10.92
         MAX-WIDTH          = 88.43
...
ON END-ERROR OF W-Win /* Reporte de Articulos X Rotacion Valorizado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de Articulos X Rotacion Valorizado */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
         ...
         "LISTADO X ROTACION VALORIZADO" AT 37
        ...
        "-----------------------------------------------------------------------------------------------------------------------------------" SKIP
        "                                                                                   (A)      (B)       (C)      OFIC                " SKIP
        "  Codigo D  E  S  C  R  I  P  C  I  O  N          MARCA     MON     COSTO U.B.     UM.      UM.       UM.      UM.            STOCK" SKIP
        "-----------------------------------------------------------------------------------------------------------------------------------" SKIP
