...
DEFINE VARIABLE h_q-ingre1 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-ingre1 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/v-ingre1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ingre1 ).
       RUN set-position IN h_v-ingre1 ( 2.35 , 1.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico-2 ).
       RUN set-position IN h_p-navico-2 ( 6.31 , 21.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv05 ).
       RUN set-position IN h_p-updv05 ( 6.31 , 40.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-alcmov ).
       RUN set-position IN h_q-alcmov ( 6.46 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.19 , 20.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/q-ingre1.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-ingre1 ).
       RUN set-position IN h_q-ingre1 ( 1.08 , 60.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 10.00 ) */

       /* Links to SmartViewer h_v-movmto. */
       RUN add-link IN adm-broker-hdl ( h_q-ingre1 , 'Record':U , h_v-movmto ).

       /* Links to SmartViewer h_v-ingre1. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-ingre1 ).
       RUN add-link IN adm-broker-hdl ( h_q-alcmov , 'Record':U , h_v-ingre1 ).

       /* Links to SmartQuery h_q-alcmov. */
       RUN add-link IN adm-broker-hdl ( h_p-navico-2 , 'Navigation':U , h_q-alcmov ).
       RUN add-link IN adm-broker-hdl ( h_q-ingre1 , 'Record':U , h_q-alcmov ).

       /* Links to SmartQuery h_q-ingre1. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_q-ingre1 ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ingres ).
       RUN set-position IN h_b-ingres ( 7.81 , 1.86 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpin1 ).
       RUN set-position IN h_b-tmpin1 ( 7.77 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 7.77 , 76.86 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ingrso ).
       RUN set-position IN h_b-ingrso ( 7.81 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 7.81 , 87.57 ) */
    ...
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpin2 ).
       RUN set-position IN h_b-tmpin2 ( 7.81 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 7.92 , 75.14 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = Multiple-Records':U ,
             OUTPUT h_p-updv12-2 ).
       RUN set-position IN h_p-updv12-2 ( 7.85 , 77.14 ) NO-ERROR.
