...
&Scoped-define QUERY-STRING-Query-Main FOR EACH AlmCatVtaC WHERE ~{&KEY-PHRASE} ~
      AND AlmCatVtaC.CodCia = s-codcia ~
 AND AlmCatVtaC.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH AlmCatVtaC WHERE ~{&KEY-PHRASE} ~
      AND AlmCatVtaC.CodCia = s-codcia ~
 AND AlmCatVtaC.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main AlmCatVtaC
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main AlmCatVtaC
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND AlmCatVtaC.CodDiv = s-coddiv"
     _Design-Parent    is WINDOW q-tables @ ( 1.12 , 2.43 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
