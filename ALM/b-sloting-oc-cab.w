...
/*                               pHoraInicio,                                                                      */
/*                               OUTPUT pLeadTime).                                                                */
        RUN lib/_time-passed (DATETIME(STRING(OOMoviAlmacen.MigFecha,'99/99/9999') + ' ' + OOMoviAlmacen.MigHora), 
                              pHoraInicio, 
                              OUTPUT pLeadTime).
    END.
...
FOR EACH TI-MoviAlmacen NO-LOCK,
    ...
    IF pImprimirDetalle = NO THEN DO:
        ...
        ASSIGN
            ...
            w-report.Campo-D[1] = OOMoviAlmacen.MigFecha 
            w-report.Campo-C[5] = OOMoviAlmacen.MigHora
            w-report.Campo-f[2] = TI-MoviAlmacen.peso
            w-report.Campo-f[3] = TI-MoviAlmacen.volumen
            w-report.Campo-f[4] = TI-MoviAlmacen.items
            .
        RUN lib/_time-passed (DATETIME(STRING(w-report.Campo-D[1],'99/99/9999') + ' ' + w-report.Campo-C[5]), 
                              pHoraInicio, 
                              OUTPUT pLeadTime).
