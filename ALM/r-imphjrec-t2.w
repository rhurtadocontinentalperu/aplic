...
DEFINE VARIABLE txt-almvirtual AS CHARACTER FORMAT "X(3)":U 
...
DEFINE FRAME F-Main
     txt-almvirtual AT ROW 1.38 COL 24 COLON-ALIGNED WIDGET-ID 46
     x-mensaje AT ROW 8.54 COL 3 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     txt-page AT ROW 2.54 COL 24.14 COLON-ALIGNED WIDGET-ID 20
     txt-page-2 AT ROW 2.54 COL 37.29 COLON-ALIGNED WIDGET-ID 22
     ...
     x-zona AT ROW 3.88 COL 20 COLON-ALIGNED WIDGET-ID 44
     "Nº Página" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 2.77 COL 12 WIDGET-ID 8
...
DO:
    ASSIGN txt-page txt-page-2 x-zona txt-almvirtual.
    RUN Carga-Temporal.
    RUN Excel.
END.
