...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-GENER.Libre_d02 COLUMN-LABEL "Stock en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 7
      T-GENER.Libre_d04 COLUMN-LABEL "Tránsito!Compras" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 6.29
...
"T-GENER.Libre_c02" "Descripción" "x(40)" "character" ? ? ? ? ? ? no ? no no "40.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.StkMax" "Empaque" ? "decimal" 11 0 ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-GENER.Libre_d04" "Tránsito!Compras" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "6.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-GENER.Libre_d03
"T-GENER.Libre_d03" "Faltante!Sobrante" "-ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no "3.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
