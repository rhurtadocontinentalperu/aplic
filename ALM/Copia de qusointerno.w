...
&SCOPED-DEFINE CONDICION ( AlmCDocu.CodCia = S-CODCIA AND ~
                           AlmCDocu.CodDiv = S-CODDIV AND ~
                           AlmCDocu.CodDoc = S-CODDOC AND ~
                           AlmCDocu.Cco    = S-CCO AND ~
                           AlmCDocu.NroDoc BEGINS STRING(S-NROSER,"999") )
...
&Scoped-Define ENABLED-OBJECTS RECT-23 F-Numero 
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-almcdocu ('Solicitud para Uso Interno').
