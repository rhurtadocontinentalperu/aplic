...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almcmov WHERE Almcmov.CodCia = Almtmovm.CodCia ~
      AND Almcmov.CodRef = "OTR" ~
 AND Almcmov.TipMov = Almtmovm.tipmov ~
 AND Almcmov.CodMov = Almtmovm.codmov ~
 AND Almcmov.NroSer = s-nroSer NO-LOCK, ~
      FIRST Almacen WHERE Almacen.CodCia = Almcmov.CodCia ~
  AND Almacen.CodAlm = Almcmov.CodAlm ~
      AND Almacen.CodDiv = s-coddiv NO-LOCK ~
    BY Almcmov.FchDoc ~
       BY Almcmov.NroDoc INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almcmov WHERE Almcmov.CodCia = Almtmovm.CodCia ~
      AND Almcmov.CodRef = "OTR" ~
 AND Almcmov.TipMov = Almtmovm.tipmov ~
 AND Almcmov.CodMov = Almtmovm.codmov ~
 AND Almcmov.NroSer = s-nroSer NO-LOCK, ~
  ...
  AND Almacen.CodAlm = Almcmov.CodAlm ~
    ...
    BY Almcmov.FchDoc ~
       BY Almcmov.NroDoc INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Almcmov Almacen
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Almcmov
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main Almacen
...
/* SETTINGS FOR COMBO-BOX C-NroSer IN FRAME FRAME-C
   ALIGN-L                                                              */
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Almcmov WHERE INTEGRAL.Almtmovm ...,INTEGRAL.Almacen WHERE INTEGRAL.Almcmov ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _TblOptList       = ", FIRST USED"
     _OrdList          = "INTEGRAL.Almcmov.FchDoc|yes,INTEGRAL.Almcmov.NroDoc|yes"
     _JoinCode[1]      = "Almcmov.CodCia = Almtmovm.CodCia"
     _Where[1]         = "Almcmov.CodRef = ""OTR""
 AND Almcmov.TipMov = Almtmovm.tipmov
 AND Almcmov.CodMov = Almtmovm.codmov
 AND Almcmov.NroSer = s-nroSer"
  ...
  AND Almacen.CodAlm = Almcmov.CodAlm"
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.19 , 10.43 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
ON VALUE-CHANGED OF C-NroSer IN FRAME FRAME-C
DO:
  ASSIGN C-NroSer.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN  input-var-1 = Almtmovm.TipMov
          input-var-2 = STRING(Almtmovm.CodMov)
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-saltrfrep-v3 ("Movimientos").
