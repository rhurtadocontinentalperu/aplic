...
&Scoped-define QUERY-STRING-Query-Main FOR EACH DI-RutaC WHERE ~{&KEY-PHRASE} ~
      AND DI-RutaC.CodCia = s-codcia ~
 AND (INTEGRAL.DI-RutaC.CodDiv = s-coddiv ~
 OR (s-coddiv = '00035' and DI-RutaC.CodDiv = '00008')) ~
 AND DI-RutaC.CodDoc = s-coddoc ~
 /*AND DI-RutaC.usuario = s-user-id*/ NO-LOCK ~
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND (INTEGRAL.DI-RutaC.CodDiv = s-coddiv
 OR (s-coddiv = '00035' and INTEGRAL.DI-RutaC.CodDiv = '00008'))
 AND INTEGRAL.DI-RutaC.CodDoc = s-coddoc
 /*AND DI-RutaC.usuario = s-user-id*/"
