...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      t-report.Campo-C[1] COLUMN-LABEL "Grupo" FORMAT "X(20)":U
            WIDTH 20.43
      t-report.Campo-F[1] COLUMN-LABEL "Sobrante/Faltante" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 9.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-ASSIGN SEPARATORS SIZE 34 BY 5.58
         FONT 4
         TITLE "RESUMEN POR GRUPO DE REPOSICION" FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Total AT ROW 6.77 COL 20 COLON-ALIGNED WIDGET-ID 4
...
"t-report.Campo-C[1]" "Grupo" "X(20)" "character" ? ? ? ? ? ? no ? no no "20.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-report.Campo-F[1]
"t-report.Campo-F[1]" "Sobrante/Faltante" ? "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* RESUMEN POR GRUPO DE REPOSICION */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* RESUMEN POR GRUPO DE REPOSICION */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* RESUMEN POR GRUPO DE REPOSICION */
DO:
...
FILL-IN-Total = 0.
FOR EACH t-report:
    FILL-IN-Total = FILL-IN-Total + t-report.Campo-F[1].
END.
