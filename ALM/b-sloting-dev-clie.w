...
T-MoviAlmacen.NroRf1 T-MoviAlmacen.CodCli T-MoviAlmacen.Observ ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MoviAlmacen.NroRf1 COLUMN-LABEL "OC/Comprobante" FORMAT "x(12)":U
            WIDTH 12.43
      T-MoviAlmacen.CodCli COLUMN-LABEL "Cliente" FORMAT "x(11)":U
      T-MoviAlmacen.Observ FORMAT "X(30)":U WIDTH 29.43
      T-MoviAlmacen.Items @ x-Items COLUMN-LABEL "Items" FORMAT ">>9":U
      T-MoviAlmacen.Volumen @ x-Volumen COLUMN-LABEL "Vol. m3" FORMAT ">>>,>>9.99999":U
            WIDTH 7.72
...
"T-MoviAlmacen.NroRf1" "OC/Comprobante" "x(12)" "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-MoviAlmacen.CodCli
"T-MoviAlmacen.CodCli" "Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-MoviAlmacen.Observ
...
"T-MoviAlmacen.Volumen @ x-Volumen" "Vol. m3" ">>>,>>9.99999" ? ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH T-MoviAlmacen NO-LOCK,
    ...
    IF pImprimirDetalle = NO THEN DO:
        ...
        ASSIGN
            ...
            w-report.Campo-C[3] = ooMoviAlmacen.Codcli
        ...
        RUN lib/_time-passed (DATETIME(STRING(w-report.Campo-D[1],'99/99/9999') + ' ' + w-report.Campo-C[5]), 
                              pHoraInicio, 
                              OUTPUT pLeadTime).
        ASSIGN w-report.Campo-C[6] = pLeadTime.
    END.
    ELSE DO:
    ...
    IF FIRST-OF(OOMoviAlmacen.CodAlm) 
        ...
        */
        FOR EACH b-ooMoviAlmacen NO-LOCK WHERE b-ooMoviAlmacen.CodCia = ooMoviAlmacen.CodCia AND
            ...
            ASSIGN T-MoviAlmacen.Items = T-MoviAlmacen.Items + 1.
        ...
        END.
        ASSIGN T-MoviAlmacen.Volumen = T-MoviAlmacen.Volumen / 1000000.
    END.
END.
...
FOR EACH OOMoviAlmacen WHERE OOMoviAlmacen.codcia = s-codcia
                            ...
                            AND OOMoviAlmacen.TipMov = "I" 
                            AND OOMoviAlmacen.CodMov = 09
                            AND OOMoviAlmacen.UseInDropShipment = "no" NO-LOCK
    BREAK BY OOMoviAlmacen.CodAlm 
    BY OOMoviAlmacen.TipMov
    BY OOMoviAlmacen.CodMov
    BY OOMoviAlmacen.NroSer 
    ...
    IF FIRST-OF(OOMoviAlmacen.CodAlm) 
        ...
        */
        FOR EACH b-ooMoviAlmacen NO-LOCK WHERE b-ooMoviAlmacen.CodCia = ooMoviAlmacen.CodCia AND
            ...
            FIRST Almmmatg OF b-ooMoviAlmacen NO-LOCK:
            ASSIGN TI-MoviAlmacen.Items = TI-MoviAlmacen.Items + 1.
