...
almmmatg.UndBas almmmatg.CodBrr 
...
"almmmatg.codmat" "Codigo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"almmmatg.CodBrr" "EAN 13" "X(13)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
