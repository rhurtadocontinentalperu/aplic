...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 103.29 BY 21.92 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'alm/v-salida-transfer.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-salida-transfer ).
       RUN set-position IN h_v-salida-transfer ( 4.77 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.65 , 90.00 ) */
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-trfsal-01 ( 10.69 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-salida-transfer ( 10.69 , 2.00 ) NO-ERROR.
