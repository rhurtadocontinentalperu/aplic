...
DEFINE FRAME F-Main
     ...
     "F8: Consulta de stocks  F7: Pedidos F9: Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 41 BY .5 AT ROW 11.5 COL 77 WIDGET-ID 10
     "F10: Kardex Almacén Despacho" VIEW-AS TEXT
          SIZE 23 BY .5 AT ROW 11.5 COL 119 WIDGET-ID 12
...
"almdrepo.CanApro" ? "ZZZ,ZZ9.99" "decimal" 11 0 ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON F10 OF br_table IN FRAME F-Main /* ITEMS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  RUN gn/stock-comprometido-v2 (almdrepo.CodMat, almdrepo.CodAlm, NO, OUTPUT pComprometido).
