...
&Scoped-Define ENABLED-OBJECTS RECT-1 COMBO-BOX_CodAlm BUTTON_Filtrar ~
COMBO-BOX_CodFam BUTTON_Limpiar FILL-IN_CodMat 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX_CodAlm COMBO-BOX_CodFam ~
...
DEFINE FRAME F-Main
     COMBO-BOX_CodAlm AT ROW 1.27 COL 19 COLON-ALIGNED WIDGET-ID 4
     BUTTON_Filtrar AT ROW 1.54 COL 82 WIDGET-ID 8
     COMBO-BOX_CodFam AT ROW 2.08 COL 19 COLON-ALIGNED WIDGET-ID 6
     BUTTON_Limpiar AT ROW 2.62 COL 82 WIDGET-ID 14
     FILL-IN_CodMat AT ROW 2.88 COL 19 COLON-ALIGNED WIDGET-ID 10
     FILL-IN_DesMat AT ROW 2.88 COL 31 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     RECT-1 AT ROW 1 COL 2 WIDGET-ID 16
...
DO:
  ASSIGN
      ...
      COMBO-BOX_CodFam 
      FILL-IN_CodMat.
  RUN Captura-Parametros IN h_b-multi-ubicacion
    ( INPUT COMBO-BOX_CodAlm /* CHARACTER */,
      INPUT COMBO-BOX_CodFam /* CHARACTER */,
...
DO:
    ASSIGN
        ...
        FILL-IN_CodMat = ''
        FILL-IN_DesMat = ''.
    DISPLAY  COMBO-BOX_CodAlm COMBO-BOX_CodFam FILL-IN_CodMat FILL-IN_DesMat
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-multi-ubicacion ( 4.23 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-multi-ubicacion ( 19.12 , 103.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-multi-ubicacion ,
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 COMBO-BOX_CodAlm BUTTON_Filtrar COMBO-BOX_CodFam BUTTON_Limpiar 
         FILL-IN_CodMat 
      WITH FRAME F-Main IN WINDOW W-Win.
