...
&Scoped-Define ENABLED-OBJECTS RECT-58 RECT-57 F-AlmDes R-Tipo Btn_Genera ~
Btn_OK F-Dias Btn_Cancel F-Items 
&Scoped-Define DISPLAYED-OBJECTS F-CodAlm F-AlmDes R-Tipo F-Dias F-Items 
...
DEFINE FRAME F-Main
     ...
     Btn_Genera AT ROW 7.85 COL 22.57
     Btn_OK AT ROW 7.88 COL 35
     F-Dias AT ROW 3.5 COL 48.86 COLON-ALIGNED
...
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN F-Codalm F-AlmDes R-Tipo F-Dias F-Items.
...
------------------------------------------------------------------------------*/
  DISPLAY F-CodAlm F-AlmDes R-Tipo F-Dias F-Items 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-58 RECT-57 F-AlmDes R-Tipo Btn_Genera Btn_OK F-Dias Btn_Cancel 
         F-Items 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
         ...
         S-SUBTIT4 AT 1       SKIP
         "-------------------------------------------------------------------------------------------------------------------------------" SKIP
         "Cod                                                                                                  Stock   Stock   Stock     " SKIP
         "Alm       Articulo                                    Marca          UM  Cat.    Cantidad            Minimo  Actual  Alm.Despa." SKIP
         "-------------------------------------------------------------------------------------------------------------------------------" SKIP
...
------------------------------------------------------------------------------*/
 ...
 X-Items = F-Items.
    ...
    FOR EACH Repo WHERE Repo.canate > 0 :
       IF X-Items = F-Items THEN DO:
          ...
          IF AVAILABLE FacCorre THEN DO:
             ...
             IF x-nrodoc = "" THEN STRING(Almcrequ.NroDoc,"999999").
    ...
    MESSAGE "Requerimiento(s) Generado(s)" SKIP
            X-NRODOC VIEW-AS ALERT-BOX ERROR.
