...
&Scoped-define FIELDS-IN-QUERY-br_table tt-AlmDInv.CodAlm ~
tt-AlmDInv.NroPagina tt-AlmDInv.NroSecuencia tt-AlmDInv.CodUbi ~
tt-AlmDInv.codmat Almmmatg.DesMat Almmmatg.DesMar Almmmatg.UndBas ~
tt-AlmDInv.QtyFisico tt-AlmDInv.QtyConteo tt-AlmDInv.QtyReconteo ~
tt-AlmDInv.Libre_d02 tt-AlmDInv.Libre_d01 DifQty @ DifQty 
...
&Scoped-Define ENABLED-OBJECTS txt-page-1 txt-page-2 txt-codmat tg-dif ~
btn-consulta btn-Excel btn-print btn-exit-2 br_table txt-codalm BUTTON-1 ~
RECT-67 RECT-68 
&Scoped-Define DISPLAYED-OBJECTS txt-page-1 txt-page-2 txt-codmat tg-dif ~
txt-codalm 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tt-AlmDInv.CodAlm COLUMN-LABEL "Alm" FORMAT "x(3)":U WIDTH 4
      tt-AlmDInv.NroPagina COLUMN-LABEL "Pag." FORMAT ">>>9":U
            WIDTH 3.72
      tt-AlmDInv.NroSecuencia COLUMN-LABEL "Nro." FORMAT ">>>9":U
            WIDTH 3
      tt-AlmDInv.CodUbi COLUMN-LABEL "Ubic." FORMAT "x(6)":U WIDTH 5.57
      ...
      tt-AlmDInv.QtyConteo FORMAT "->>>,>>>,>>9.99":U WIDTH 10
      tt-AlmDInv.QtyReconteo FORMAT "->>>,>>>,>>9.99":U WIDTH 9.14
      tt-AlmDInv.Libre_d02 COLUMN-LABEL "3er Conteo" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 9.43
      tt-AlmDInv.Libre_d01 COLUMN-LABEL "Conteo Final" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 10
      DifQty @ DifQty COLUMN-LABEL "Diferencia" FORMAT "-ZZZ,ZZZ,ZZ9.99":U
            WIDTH 9.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 120.57 BY 14
         FONT 4
...
DEFINE FRAME F-Main
     ...
     txt-codmat AT ROW 3.69 COL 12 COLON-ALIGNED WIDGET-ID 54
     tg-dif AT ROW 3.69 COL 28 WIDGET-ID 56
     btn-consulta AT ROW 1.81 COL 84 WIDGET-ID 8
     btn-Excel AT ROW 1.81 COL 94.14 WIDGET-ID 20
     btn-print AT ROW 1.81 COL 104.14 WIDGET-ID 42
     btn-exit-2 AT ROW 1.81 COL 114.14 WIDGET-ID 52
...
"tt-AlmDInv.CodAlm" "Alm" ? "character" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-AlmDInv.NroPagina
"tt-AlmDInv.NroPagina" "Pag." ">>>9" "integer" ? ? ? ? ? ? no ? no no "3.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-AlmDInv.NroSecuencia
"tt-AlmDInv.NroSecuencia" "Nro." ">>>9" "integer" ? ? ? ? ? ? no ? no no "3" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-AlmDInv.CodUbi
"tt-AlmDInv.CodUbi" "Ubic." ? "character" ? ? ? ? ? ? no ? no no "5.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-AlmDInv.codmat
...
"Almmmatg.UndBas" "Unidad" ? "character" ? ? ? ? ? ? no ? no no "3.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.tt-AlmDInv.QtyFisico
"tt-AlmDInv.QtyFisico" "Sistema" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.tt-AlmDInv.QtyConteo
"tt-AlmDInv.QtyConteo" ? ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.tt-AlmDInv.QtyReconteo
"tt-AlmDInv.QtyReconteo" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.tt-AlmDInv.Libre_d02
"tt-AlmDInv.Libre_d02" "3er Conteo" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.tt-AlmDInv.Libre_d01
"tt-AlmDInv.Libre_d01" "Conteo Final" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > "_<CALC>"
"DifQty @ DifQty" "Diferencia" "-ZZZ,ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
cRange = "Q" + cColumn.
chWorkSheet:Range(cRange):Value = "USER Conteo".
cRange = "R" + cColumn.
chWorkSheet:Range(cRange):Value = "USER ReConteo".
cRange = "S" + cColumn.
chWorkSheet:Range(cRange):Value = "USER 3erConteo".


FOR EACH tt-AlmDInv NO-LOCK
    BREAK BY tt-AlmDInv.CodAlm 
        BY tt-AlmDInv.NroPagina 
        BY tt-AlmDInv.NroSecuencia:
    ...
    IF AVAIL Almmmatg THEN DO:
        ...
        IF tt-AlmDInv.CodAlm = '10' THEN x-DesMat = Almmmatg.CodBrr + "-" + Almmmatg.DesMat.
    END.
    ...
    cColumn = STRING(t-Column).
    cRange = "A" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.CodAlm.
    cRange = "B" + cColumn.
    ...
    cRange = "M" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.libre_d02.
    cRange = "N" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.libre_d01.
    cRange = "O" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.DifQty.
    cRange = "P" + cColumn.
    chWorkSheet:Range(cRange):Value = (tt-AlmDInv.DifQty * x-ctopro).
    cRange = "Q" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.CodUserCon.
    cRange = "R" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.CodUserReC.
    cRange = "S" + cColumn.
    chWorkSheet:Range(cRange):Value = tt-AlmDInv.libre_c01.

    IF tt-AlmDInv.CodAlm = '10' THEN DO:
        /*
        cRange = "P" + cColumn.
        chWorkSheet:Range(cRange):Value = tt-AlmDInv.Libre_c01.
        */
