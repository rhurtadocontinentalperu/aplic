...
T-CPEDI.FchPed T-CPEDI.NomCli T-CPEDI.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-CPEDI.FchPed COLUMN-LABEL "Emisión" FORMAT "99/99/9999":U
      T-CPEDI.NomCli FORMAT "x(50)":U WIDTH 51
      T-CPEDI.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 9.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88 BY 6.69
         FONT 4
         TITLE "COTIZACIONES CUBIERTAS AL 100%".
...
"T-CPEDI.FchPed" "Emisión" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-CPEDI.NomCli
"T-CPEDI.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "51" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-CPEDI.ImpTot
"T-CPEDI.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* COTIZACIONES CUBIERTAS AL 100% */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* COTIZACIONES CUBIERTAS AL 100% */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* COTIZACIONES CUBIERTAS AL 100% */
DO:
...
DEF INPUT PARAMETER TABLE FOR T-CPEDI.
