...
&Scoped-Define ENABLED-OBJECTS RECT-9 BUTTON-4 BUTTON-1 BUTTON-3 BUTTON-2 ~
FILL-IN-CodPro FILL-IN-Marca FILL-IN-Glosa 
...
DEFINE VARIABLE h_b-pedrepaut-01 AS HANDLE NO-UNDO.
...
DO:        
  ...
  /*SESSION:SET-WAIT-STATE('').*/
   ...
   RUN Carga-Temporal IN h_b-pedrepaut-01 (FILL-IN-CodPro, 
                                        FILL-IN-Marca, 
                                        FILL-IN-CodFam, 
                                        FILL-IN-CodAlm).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-pedrepaut-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_b-pedrepaut-01 ).
       RUN set-position IN h_b-pedrepaut-01 ( 7.73 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-pedrepaut-01 ( 15.04 , 122.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-pedrepaut-01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv08 , 'TableIO':U , h_b-pedrepaut-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-pedrepaut-01 ,
             FILL-IN-Glosa:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv08 ,
             h_b-pedrepaut-01 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
        ...
        ASSIGN
            ...
            T-DREPO.CanGen = 100
            T-DREPO.StkAct = 100.
        RUN adm-open-query-cases IN h_b-pedrepaut-01.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-9 BUTTON-4 BUTTON-1 BUTTON-3 BUTTON-2 FILL-IN-CodPro 
         FILL-IN-Marca FILL-IN-Glosa 
      WITH FRAME F-Main IN WINDOW W-Win.
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    RELEASE Faccorre.
END.
RUN adm-open-query IN h_b-pedrepaut-01.
