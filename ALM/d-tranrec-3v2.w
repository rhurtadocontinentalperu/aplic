...
chWorkSheet:Range("Q2"):VALUE = "Nro Hoja Ruta".
chWorkSheet:Range("R2"):VALUE = "Descripcion Hoja Ruta".
chWorkSheet:Range("S2"):VALUE = "Fecha Emision".
chWorkSheet:Range("T2"):VALUE = "Fecha Salida".
chWorkSheet:Range("U2"):VALUE = "Hora Salida".
chWorkSheet:Range("V2"):VALUE = "Fecha Retorno".
chWorkSheet:Range("W2"):VALUE = "Hora Retorno".

chWorkSheet:Range("X2"):VALUE = "Orden de Transferencia".

chWorkSheet:Range("Y2"):VALUE = "Almacen Inicio".
chWorkSheet:Range("Z2"):VALUE = "Almacen Intermedio".
chWorkSheet:Range("AA2"):VALUE = "Almacen Final".
