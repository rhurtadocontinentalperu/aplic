...
Almmmatg.DesMar Almmmate.CodUbi 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almmmate.codmat COLUMN-LABEL "Articulo" FORMAT "X(6)":U WIDTH 6.43
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 89 BY 14.62
...
/* Query rebuild information for BROWSE br_table
 ...
 AND INTEGRAL.Almmmate.CodAlm = s-codalm"
     _FldNameList[1]   > INTEGRAL.Almmmate.codmat
"Almmmate.codmat" "Articulo" ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.DesMar" "Marca" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.Almmmate.CodUbi
"Almmmate.CodUbi" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
