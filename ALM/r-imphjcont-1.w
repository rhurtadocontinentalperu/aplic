...
&Scoped-Define ENABLED-OBJECTS txt-page txt-page-2 r-imp btn-Excel Btn_Ok ~
Btn_Done x-zona x-zona-2 RECT-70 RECT-71 
&Scoped-Define DISPLAYED-OBJECTS x-codalm x-mensaje txt-desalm txt-page ~
txt-page-2 r-imp x-zona x-zona-2 
...
DEFINE FRAME F-Main
     ...
     x-mensaje AT ROW 7.5 COL 2 NO-LABEL WIDGET-ID 28
     ...
     r-imp AT ROW 5.58 COL 7 NO-LABEL WIDGET-ID 16
     btn-Excel AT ROW 8.73 COL 36.57 WIDGET-ID 20
     Btn_Ok AT ROW 8.73 COL 48
     Btn_Done AT ROW 8.73 COL 59.43
     ...
     RECT-70 AT ROW 8.62 COL 1.29 WIDGET-ID 22
...
DO:
    ASSIGN x-CodAlm txt-page txt-page-2 r-imp x-zona.
    RUN Carga-Temporal.
    RUN Excel.
END.
...
DO:
  ASSIGN x-CodAlm txt-page txt-page-2 r-imp x-zona x-zona-2.
  RUN Carga-Temporal.
  RUN Imprime.    
END.
...
------------------------------------------------------------------------------*/
  DISPLAY x-codalm x-mensaje txt-desalm txt-page txt-page-2 r-imp x-zona 
          x-zona-2 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-page txt-page-2 r-imp btn-Excel Btn_Ok Btn_Done x-zona x-zona-2 
         RECT-70 RECT-71 
      WITH FRAME F-Main IN WINDOW W-Win.
