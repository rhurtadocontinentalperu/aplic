...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      SUBSTRING(AlmCDocu.NroDoc,LENGTH(AlmCDocu.CodLlave) + 1) @ AlmCDocu.NroDoc COLUMN-LABEL "Número" FORMAT "x(10)":U
...
"SUBSTRING(AlmCDocu.NroDoc,LENGTH(AlmCDocu.CodLlave) + 1) @ AlmCDocu.NroDoc" "Número" "x(10)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
