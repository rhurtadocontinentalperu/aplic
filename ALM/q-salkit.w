...
DEFINE SHARED BUFFER buff-ingkit FOR Almcmov.
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES buff-ingkit
&Scoped-define FIRST-EXTERNAL-TABLE buff-ingkit
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: buff-ingkit
   Allow: Basic,Query
   Frames: 1
   Add Fields to: NEITHER
   Other Settings: PERSISTENT-ONLY COMPILE
   Temp-Tables and Buffers:
      TABLE: buff-ingkit B "SHARED" ? INTEGRAL Almcmov
   END-TABLES.
 */
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Almcmov WHERE buff-ingkit ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.Almcmov.CodCia = s-codcia
  AND INTEGRAL.Almcmov.CodAlm = s-codalm
  AND INTEGRAL.Almcmov.TipMov = 'S'
  AND INTEGRAL.Almcmov.CodMov = s-movsal
  AND INTEGRAL.Almcmov.NroRf1 = STRING(buff-ingkit.NroDoc, '999999')"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "buff-ingkit"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "buff-ingkit"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "buff-ingkit"}
