...
IF s-codalm = '11T' THEN RETURN "OK".   /* RHC 17.08.10 pedido por Victor Escalante */
IF s-Reposicion = NO THEN DO:
    /* CONSISTENCIA NORMAL */
    /* RHC 19.03.10 TEMPORAL */
    IF LOOKUP(s-codalm, "35,35a,35b,40,40a,40d,42,18") > 0
        AND ( TODAY >= DATE(03,19,2010) AND TODAY <= DATE(03,22,2010) ) THEN DO:
    END.
    ELSE DO:
