...
&Scoped-define INTERNAL-TABLES InvConfig

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH InvConfig WHERE ~{&KEY-PHRASE} ~
      AND InvConfig.CodCia = s-codcia ~
 AND InvConfig.CodAlm = s-codalm NO-LOCK ~
    BY InvConfig.FchInv DESCENDING INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main InvConfig
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main InvConfig
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.InvConfig"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _OrdList          = "INTEGRAL.InvConfig.FchInv|no"
     _Where[1]         = "INTEGRAL.InvConfig.CodCia = s-codcia
 AND INTEGRAL.InvConfig.CodAlm = s-codalm"
