...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      TabGener.Codigo COLUMN-LABEL "Zona!Geografica" FORMAT "x(8)":U
            WIDTH 7.57
      Almmmate.CodAlm FORMAT "x(3)":U WIDTH 6.43
      Almacen.Descripcion FORMAT "X(40)":U WIDTH 41.43
      ...
      fStockDisponible() @ x-StockDisponible COLUMN-LABEL "Stock!Disponible" FORMAT "-ZZZ,ZZZ,ZZ9.99":U
            WIDTH 8.57
      x-StockTransito @ x-StockTransito COLUMN-LABEL "Stock en!Tránsito" FORMAT "ZZZ,ZZ9.99":U
            WIDTH 8.72
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "INTEGRAL.TabGener.Codigo|yes,INTEGRAL.TabGener.Libre_c01|yes"
...
"TabGener.Codigo" "Zona!Geografica" ? "character" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmate.CodAlm
"Almmmate.CodAlm" ? ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.Almacen.Descripcion
"Almacen.Descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "41.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmate.VCtMn2" "No Campaña" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? yes ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.Almmmate.StkMax
"Almmmate.StkMax" "Empaque" ? "decimal" ? ? ? ? ? ? yes ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"fStockDisponible() @ x-StockDisponible" "Stock!Disponible" "-ZZZ,ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > "_<CALC>"
"x-StockTransito @ x-StockTransito" "Stock en!Tránsito" "ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > "_<CALC>"
"fSaldo() @ x-Saldo" "Faltante!Sobrante" "-ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
