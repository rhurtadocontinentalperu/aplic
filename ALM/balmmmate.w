...
&Scoped-define DATA-FIELD-DEFS "aplic/alm/dalmmmate.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table codmat StkAct 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table codmat StkAct 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      codmat FORMAT "X(6)":U
      StkAct FORMAT "(ZZZ,ZZZ,ZZ9.99)":U
  ENABLE
      codmat
      StkAct
/* _UIB-CODE-BLOCK-END */
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "aplic\alm\dalmmmate.w"
   Allow: Basic,Browse
   Frames: 1
...
"codmat" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.StkAct
"StkAct" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
