...
DO:
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Carga-Temporal2 IN h_v-invcfg-a (03).
...
DO:
  ...
  MESSAGE 'Este proceso genera los movimientos de entrada y salida' SKIP
        ...
        UPDATE rpta AS LOG.
  IF rpta = YES THEN DO:
    RUN Genera-Movimiento-Transferencia IN h_v-invcfg-a.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_b-ajting ).
       /* Position in AB:  ( 8.27 , 6.00 ) */
       /* Size in UIB:  ( 6.69 , 68.00 ) */
