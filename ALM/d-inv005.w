...
&Scoped-Define ENABLED-OBJECTS DFecha HFecha DesdeC HastaC Btn_OK ~
Btn_Cancel 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "SUSTENTO DIFERENCIA CONSOLIDADA"
         HEIGHT             = 10.96
         WIDTH              = 67.14
         MAX-HEIGHT         = 11.5
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* SUSTENTO DIFERENCIA CONSOLIDADA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SUSTENTO DIFERENCIA CONSOLIDADA */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE DFecha HFecha DesdeC HastaC Btn_OK Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
 ...
 *     x-CtoTot            COLUMN-LABEL "Total"            FORMAT '->,>>>,>>9.99'*/
  ...
  DEFINE FRAME F-HEADER
    ...
    "SUSTENTO DIFERENCIA CONSOLIDADA POR ARTICULO" AT 20 
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
    ENABLE ALL EXCEPT RADIO-SET-Costo.
    IF R-Tipo = 2 then
          ASSIGN
                 DesdeC:VISIBLE = NO
                 HastaC:VISIBLE = NO
