...
DEFINE VARIABLE h_b-rut002a AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_b-rutac AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 8.31 COL 93
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 113.14 BY 19.54
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/b-rutac.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rutac ).
       RUN set-position IN h_b-rutac ( 1.38 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.69 , 112.00 ) */
       ...
       RUN set-size IN h_folder ( 11.35 , 109.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/alm/b-rut002a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rut002a ).
       RUN set-position IN h_b-rut002a ( 10.42 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.35 , 105.00 ) */

       /* Links to SmartBrowser h_b-rut002a. */
       RUN add-link IN adm-broker-hdl ( h_b-rutac , 'Record':U , h_b-rut002a ).
    ...
    WHEN 2 THEN DO:
       ...
       /* Size in UIB:  ( 7.81 , 78.00 ) */

       /* Links to SmartBrowser h_b-rut002d. */
       RUN add-link IN adm-broker-hdl ( h_b-rutac , 'Record':U , h_b-rut002d ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rut002a , 'Record':U , h_v-rut002 ).

       /* Links to SmartBrowser h_b-rut002c. */
       RUN add-link IN adm-broker-hdl ( h_b-rut002a , 'Record':U , h_b-rut002c ).
    ...
    WHEN 4 THEN DO:
       ...
       /* Size in UIB:  ( 9.35 , 102.00 ) */

       /* Links to SmartBrowser h_b-rut002e. */
       RUN add-link IN adm-broker-hdl ( h_b-rutac , 'Record':U , h_b-rut002e ).
