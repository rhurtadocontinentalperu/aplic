...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CmpAutomParam.CodAlm COLUMN-LABEL "Almacén!Solicitante" FORMAT "x(8)":U
            WIDTH 7.43
      CmpAutomParam.AlmPed COLUMN-LABEL "Almacén!Despacho" FORMAT "x(8)":U
            WIDTH 7.43
      ...
      CmpAutomParam.PorRep COLUMN-LABEL "% de!Rep." FORMAT "->>,>>9.99":U
            WIDTH 6.43
      CmpAutomParam.PorStkMax COLUMN-LABEL "% de Stck!Máx." FORMAT "->>,>>9.99":U
            WIDTH 6.43
      ...
      CmpAutomParam.FechaFin COLUMN-LABEL "Término" FORMAT "99/99/9999":U
...
"CmpAutomParam.CodAlm" "Almacén!Solicitante" ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.CmpAutomParam.AlmPed
"CmpAutomParam.AlmPed" "Almacén!Despacho" ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CmpAutomParam.PorStkMax" "% de Stck!Máx." ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CmpAutomParam.FechaFin" "Término" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
