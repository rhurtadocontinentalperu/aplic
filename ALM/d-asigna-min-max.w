...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 1.58 COL 44
     RADIO-SET-1 AT ROW 1.77 COL 11 NO-LABEL WIDGET-ID 2
     Btn_Cancel AT ROW 3.12 COL 44
     SPACE(6.13) SKIP(1.56)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "SELECCIONE EL TIPO DE REPOSICION"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* SELECCIONE EL TIPO DE REPOSICION */
DO:  
