...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almcmov WHERE Almcmov.CodCia = Almtdocm.CodCia ~
  ...
  AND Almcmov.CodMov = Almtdocm.CodMov USE-INDEX ALMC04 NO-LOCK ~
    BY Almcmov.CodCia ~
       BY Almcmov.CodAlm ~
        BY Almcmov.TipMov ~
         BY Almcmov.CodMov ~
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "INTEGRAL.Almcmov.CodCia|yes,INTEGRAL.Almcmov.CodAlm|yes,INTEGRAL.Almcmov.TipMov|yes,INTEGRAL.Almcmov.CodMov|yes,INTEGRAL.Almcmov.FchDoc|no"
     _JoinCode[1]      = "Almcmov.CodCia = Almtdocm.CodCia
  AND Almcmov.CodAlm = Almtdocm.CodAlm
  AND Almcmov.TipMov = Almtdocm.TipMov
  AND Almcmov.CodMov = Almtdocm.CodMov USE-INDEX ALMC04"
