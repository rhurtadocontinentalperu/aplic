...
/* Filtrso */
DEF VAR x-Marcas AS CHAR INIT '' NO-UNDO.
DEF VAR x-Lineas AS CHAR INIT '' NO-UNDO.

&SCOPED-DEFINE Condicion2 (x-Marcas = '' OR LOOKUP(Almmmatg.DesMar,x-Marcas,'|') > 0)
...
(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.DesStkMax / T-DREPO.VtaGrp30y) * 100 @ x-FacMaxGrp30 ~
(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.SolStkDis / T-DREPO.VtaGrp30y)  @ x-FacDisGrp30 ~
(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE (T-DREPO.SolStkDis + T-DREPO.CanGen) / T-DREPO.VtaGrp30y) @ x-FacDisGrp30 ~
fClfGral(T-DREPO.CodMat,s-Reposicion) @ x-ClfGral ~
fClfMayo(T-DREPO.CodMat,s-Reposicion) @ x-ClfMayo ~
fClfUtil(T-DREPO.CodMat,s-Reposicion) @ x-ClfUtil ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DREPO.VtaGrp90y @ x-VtaGrp90y COLUMN-LABEL "Vta Grp!90d adel!Año pasado" FORMAT "-Z,ZZZ,ZZ9.99":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 10
      (IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.DesStkMax / T-DREPO.VtaGrp30y) * 100 @ x-FacMaxGrp30 COLUMN-LABEL "Stk. Max. Grupo!/ Vta 30d adel" FORMAT "-Z,ZZZ,ZZ9.99":U
            WIDTH 12.14
      (IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.SolStkDis / T-DREPO.VtaGrp30y)  @ x-FacDisGrp30 COLUMN-LABEL "Stock Actual!/ Vta 30d adel"
      (IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE (T-DREPO.SolStkDis + T-DREPO.CanGen) / T-DREPO.VtaGrp30y) @ x-FacDisGrp30 COLUMN-LABEL "Stock Actual +!Can. Gen.!/ Vta 30d adel"
            WIDTH 12
      fClfGral(T-DREPO.CodMat,s-Reposicion) @ x-ClfGral COLUMN-LABEL "Clasf!Gral" FORMAT "x":U
      fClfMayo(T-DREPO.CodMat,s-Reposicion) @ x-ClfMayo COLUMN-LABEL "Clasf.!Mayorista" FORMAT "x":U
      fClfUtil(T-DREPO.CodMat,s-Reposicion) @ x-ClfUtil COLUMN-LABEL "Clasf.!Utilex" FORMAT "x":U
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Mensaje AT ROW 16.62 COL 95 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     "F10: Kardex Almacén Despacho" VIEW-AS TEXT
          SIZE 29 BY .5 AT ROW 16.62 COL 67 WIDGET-ID 68
          FONT 0
     "F8 : Stocks x Almacenes F7 : Pedidos F9 : Ingresos en Tránsito" VIEW-AS TEXT
          SIZE 62 BY .5 AT ROW 16.62 COL 3 WIDGET-ID 12
          FONT 0
...
"Temp-Tables.T-DREPO.CodMat" "<Codigo>" "X(14)" "character" ? ? ? ? ? ? yes ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"INTEGRAL.Almmmatg.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "38.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"INTEGRAL.Almmmatg.DesMar" "Marca" "X(15)" "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.Almmmatg.UndBas
"INTEGRAL.Almmmatg.UndBas" "Unidad" "X(7)" "character" ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-DREPO.CanReq
"Temp-Tables.T-DREPO.CanReq" "Cantidad!Requerida" "-ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-DREPO.CanGen
"Temp-Tables.T-DREPO.CanGen" ? "ZZZ,ZZ9.99" "decimal" 11 9 ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.DesStkMax / T-DREPO.VtaGrp30y) * 100 @ x-FacMaxGrp30" "Stk. Max. Grupo!/ Vta 30d adel" "-Z,ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "12.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > "_<CALC>"
"(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE T-DREPO.SolStkDis / T-DREPO.VtaGrp30y)  @ x-FacDisGrp30" "Stock Actual!/ Vta 30d adel" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > "_<CALC>"
"(IF T-DREPO.VtaGrp30y = 0 THEN 0 ELSE (T-DREPO.SolStkDis + T-DREPO.CanGen) / T-DREPO.VtaGrp30y) @ x-FacDisGrp30" "Stock Actual +!Can. Gen.!/ Vta 30d adel" ? ? ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > "_<CALC>"
"fClfGral(T-DREPO.CodMat,s-Reposicion) @ x-ClfGral" "Clasf!Gral" "x" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > "_<CALC>"
"fClfMayo(T-DREPO.CodMat,s-Reposicion) @ x-ClfMayo" "Clasf.!Mayorista" "x" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > "_<CALC>"
"fClfUtil(T-DREPO.CodMat,s-Reposicion) @ x-ClfUtil" "Clasf.!Utilex" "x" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-DREPO.DesStkTra @ x-DesStkTra" "Tránsito Transf.!Principal" "ZZZ,ZZ9.99" ? ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[27]   > INTEGRAL.Almmmate.StkMax
"INTEGRAL.Almmmate.StkMax" "Empaque!Reposición" "ZZZ,ZZ9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[28]   > INTEGRAL.Almmmatg.CanEmp
"INTEGRAL.Almmmatg.CanEmp" "Empaque!Master" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[29]   > INTEGRAL.Almmmatg.StkRep
"INTEGRAL.Almmmatg.StkRep" "Empaque!Inner" "->>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"(T-DREPO.CanGen * Almmmatg.Libre_d02 / 1000000) @ x-Volumen" "Volumen en m3" ">>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > Temp-Tables.T-DREPO.AlmPed
"Temp-Tables.T-DREPO.AlmPed" "Almacén!Despacho" "x(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > INTEGRAL.Almtfami.codfam
"INTEGRAL.Almtfami.codfam" "Linea" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   = INTEGRAL.Almtfami.desfam
     _FldNameList[36]   > INTEGRAL.AlmSFami.subfam
"INTEGRAL.AlmSFami.subfam" "SubLinea" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[37]   = INTEGRAL.AlmSFami.dessub
...
DO:
  ...
  IF Almmmatg.CanEmp = 0 AND Almmmatg.StkRep = 0 THEN
      ASSIGN
        T-DREPO.AlmPed:BGCOLOR IN BROWSE {&BROWSE-NAME} = 12 
        T-DREPO.CanGen:BGCOLOR IN BROWSE {&BROWSE-NAME} = 12
        T-DREPO.CanReq:BGCOLOR IN BROWSE {&BROWSE-NAME} = 12 
        T-DREPO.CodMat:BGCOLOR IN BROWSE {&BROWSE-NAME} = 12 
        T-DREPO.AlmPed:FGCOLOR IN BROWSE {&BROWSE-NAME} = 12
        T-DREPO.CanGen:FGCOLOR IN BROWSE {&BROWSE-NAME} = 12
        T-DREPO.CanReq:FGCOLOR IN BROWSE {&BROWSE-NAME} = 12 
        T-DREPO.CodMat:FGCOLOR IN BROWSE {&BROWSE-NAME} = 12 
        .
  IF Almmmatg.CanEmp = 0 OR Almmmatg.StkRep = 0 THEN
      ASSIGN
        T-DREPO.AlmPed:BGCOLOR IN BROWSE {&BROWSE-NAME} = 13
        T-DREPO.CanGen:BGCOLOR IN BROWSE {&BROWSE-NAME} = 13
        T-DREPO.CanReq:BGCOLOR IN BROWSE {&BROWSE-NAME} = 13 
        T-DREPO.CodMat:BGCOLOR IN BROWSE {&BROWSE-NAME} = 13 
        T-DREPO.AlmPed:FGCOLOR IN BROWSE {&BROWSE-NAME} = 13
        T-DREPO.CanGen:FGCOLOR IN BROWSE {&BROWSE-NAME} = 13
        T-DREPO.CanReq:FGCOLOR IN BROWSE {&BROWSE-NAME} = 13 
        T-DREPO.CodMat:FGCOLOR IN BROWSE {&BROWSE-NAME} = 13 
        .
END.
