  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/t-ped-may-mostr-codigos.w':U ,
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR lControl AS LOG INIT NO NO-UNDO.
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      /* En caso de que ya venta la tabla ITEM cargada con info */
      FOR EACH ITEM NO-LOCK:
          COMBO-BOX-CodAlm = ITEM.AlmDes.
          lControl = YES.
          LEAVE.
      END.
  END.
  ...
  IF lControl THEN COMBO-BOX-CodAlm:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
