...
DEF NEW SHARED VAR f-CodDoc  AS CHAR INITIAL "N/C".
...
DEFINE VARIABLE FILL-IN-desc AS CHARACTER FORMAT "X(256)":U INITIAL "Nota de Credito" 
     VIEW-AS FILL-IN 
     SIZE 19 BY .81
