...
##################################################### CLIENTES ####################################################################
# Nombre del Shell 	: clientes2satelite.sh
# cron			: */5 * * * * /ruta/del/script/clientes2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/cliente' -H 'accept: application/json'
##################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/clientes2satelite.lock"
LOGFILE="/var/log/clientes2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/cliente"
