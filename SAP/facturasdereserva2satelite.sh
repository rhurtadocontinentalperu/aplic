...
####################################################### FACTURAS DE RESERVA ##############################################################
# Nombre del Shell 	: facturasdereserva2satelite.sh
# cron			: */5 * * * * /ruta/del/script/facturasdereserva2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/facturareserva' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/facturasdereserva2satelite.lock"
LOGFILE="/var/log/facturasdereserva2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/facturareserva"
