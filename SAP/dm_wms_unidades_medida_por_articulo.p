...
DO TRANSACTION:
    ...
    DELETE FROM INTEGRAL.ooItemAlternativeCode.
END.
...
FOR EACH INTEGRAL.oItems NO-LOCK,
    ...
    AND pro.Almmmatg.codbrr > '':
    CREATE ooItemAlternativeCode.
    ASSIGN
        ooItemAlternativeCode.ItemNro = pro.Almmmatg.codmat
        ooItemAlternativeCode.ItemCode = pro.Almmmatg.codbrr
        ooItemAlternativeCode.FreeText = "EAN13"
        ooItemAlternativeCode.Factor = 1
        .
    FIND pro.Almmmat1 OF pro.Almmmatg NO-LOCK NO-ERROR.
    IF AVAILABLE pro.Almmmat1 THEN DO:
        DO i = 1 TO 5:
            IF pro.Almmmat1.Barras[i] > '' THEN DO:
                CREATE ooItemAlternativeCode.
                ASSIGN
                    ooItemAlternativeCode.ItemNro = pro.Almmmatg.codmat
                    ooItemAlternativeCode.ItemCode = pro.Almmmat1.Barras[i]
                    ooItemAlternativeCode.FreeText = "EAN 14-" + STRING(i,'9')
                    ooItemAlternativeCode.Factor = pro.Almmmat1.Equival[i]
                    .
            END.
        END.
    END.
