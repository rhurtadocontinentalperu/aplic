...
####################################################### SEDES DE CLIENTES ################################################################
# Nombre del Shell 	: sedesdecliente2satelite.sh
# cron			: */5 * * * * /ruta/del/script/sedesdecliente2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/sedes' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/sedesdecliente2satelite.lock"
LOGFILE="/var/log/sedesdecliente2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/sedes"
