...
# Nombre del Shell 	: solicitudtraslado2satelite.sh
# cron			: */5 * * * * /ruta/del/script/solicitudtraslado2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/inventarios/ventascredito/solicitudtraslado' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/solicitudtraslado2satelite.lock"
LOGFILE="/var/log/solicitudtraslado2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/inventarios/ventascredito/solicitudtraslado"
