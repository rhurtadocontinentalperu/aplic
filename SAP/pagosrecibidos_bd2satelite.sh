...
####################################################### PAGOS RECIBIDOS BD ##############################################################
# Nombre del Shell 	: pagosrecibidos_bd2satelite.sh
# cron			: */5 * * * * /ruta/del/script/pagosrecibidos_bd2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/finanzas/pagorecibido/boletadeposito' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosrecibidos_bd2satelite.lock"
LOGFILE="/var/log/pagosrecibidos_bd2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/finanzas/pagorecibido/boletadeposito"
