...
####################################################### PAGOS RECIBIDOS VENTA MOSTRADOR ##################################################
# Nombre del Shell 	: pagosrecibido_ventasmostrador2sap.sh
# cron			: */5 * * * * /ruta/del/script/pagosrecibido_ventasmostrador2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/finanzas/pagosrecibidos/ventasmostrador/cobranza' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosrecibido_ventasmostrador2sap.lock"
LOGFILE="/var/log/pagosrecibido_ventasmostrador2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/finanzas/pagosrecibidos/ventasmostrador/cobranza"
