...
####################################################### PAGOS RECIBIDOS A/R ##############################################################
# Nombre del Shell 	: pagosrecibidos_ar2sap.sh
# cron			: */5 * * * * /ruta/del/script/pagosrecibidos_arsap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/finanzas/pagosrecibidos/anticiporecibido' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosrecibidos_ar2sap.lock"
LOGFILE="/var/log/pagosrecibidos_ar2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/finanzas/pagosrecibidos/anticiporecibido"
