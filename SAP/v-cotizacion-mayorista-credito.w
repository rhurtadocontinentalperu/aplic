...
&SCOPED-DEFINE precio-venta-general sap/unit-price-credit-sale.p

&SCOPED-DEFINE Promocion SAP/promocion-general.p
...
RUN SAP/d-cotizacion-cant-vs-saldo.w (INPUT ROWID(Faccpedi), INPUT s-CodAlm).
    ...
    */    
    ...
    IF Faccpedi.coddoc <> "PLE" THEN DO:          
        ...
        IF AVAILABLE FacTabla THEN DO:
            ...
            FIND Inventory_SAP WHERE Inventory_SAP.ItemCode = ITEM.CodMat AND
                Inventory_SAP.WarehouseCode = ENTRY(1, s-CodAlm)
                NO-LOCK NO-ERROR.
            IF AVAILABLE Inventory_SAP THEN x-StkActual = Inventory_SAP.Quantity.
            ELSE x-StkActual = 0.
            RUN SAP/Stock-Comprometido (ITEM.CodMat,
                                        ENTRY(1, s-CodAlm),
                                        YES,
