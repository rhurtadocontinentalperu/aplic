...
####################################################### PAGO EFECTUADO ################################################################
# Nombre del Shell 	: pagoefectuado2satelite.sh
# cron			: */5 * * * * /ruta/del/script/pagoefectuadosatelite.sh
# curl			: curl -X 'GET' 'http://localhost:5500/continental/interfaces/pagoefectuado' -H 'accept: application/json'
# 	 (NUEVO)
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagoefectuado2satelite.lock"
LOGFILE="/var/log/pagoefectuado2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/pagoefectuado"
