...
####################################################### CLIENTES ##############################################################
# Nombre del Shell 	: clientes2sap.sh
# cron			: */5 * * * * /ruta/del/script/clientes2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/ventas/socionegocio' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/clientes2sap.lock"
LOGFILE="/var/log/clientes2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/ventas/socionegocio"
