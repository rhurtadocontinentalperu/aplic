...
####################################################### ENTREGAS DE VENTAS MOSTRADOR #####################################################
# Nombre del Shell 	: entregasventamostrador2satelite.sh
# cron			: */5 * * * * /ruta/del/script/entregasventamostrador2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/entregaventa' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/entregasventamostrador2satelite.lock"
LOGFILE="/var/log/entregasventamostrador2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/entregaventa"
