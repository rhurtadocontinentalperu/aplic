...
####################################################### PEDIDOS LOGISTICOS / MOSTRADOR ###################################################
# Nombre del Shell 	: pedidoslogisticos_mostrador2sap.sh
# cron			: */5 * * * * /ruta/del/script/pedidoslogisticos_mostrador2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/ventas/ordr' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pedidoslogisticos_mostrador2sap.lock"
LOGFILE="/var/log/pedidoslogisticos_mostrador2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/ventas/ordr"
