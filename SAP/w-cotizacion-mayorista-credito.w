...
DEF NEW SHARED VAR sh_hProcPricing AS HANDLE NO-UNDO.
IF NOT VALID-HANDLE(sh_hProcPricing) THEN RUN web/web-library PERSISTENT SET sh_hProcPricing.
...
DEFINE FRAME F-Main
     COMBO-NroSer AT ROW 1.23 COL 76.71 WIDGET-ID 4
     "Buscar:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 1.42 COL 88 WIDGET-ID 6
...
DO:
  ...
  IF VALID-HANDLE(sh_hProcPricing) THEN DELETE PROCEDURE sh_hProcPricing.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/v-cotizacion-mayorista-credito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/t-cotizacion-mayorista-credito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
