...
####################################################### PEDIDO LOGISTICO/MOSTRADOR #######################################################
# Nombre del Shell 	: pedidologisticomostrador2satelite.sh
# cron			: */5 * * * * /ruta/del/script/pedidologisticomostrador2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/pedidodlogistico' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pedidologisticomostrador2satelite.lock"
LOGFILE="/var/log/pedidologisticomostrador2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/pedidodlogistico"
