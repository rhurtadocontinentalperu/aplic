...
DEF NEW SHARED VAR sh_hProcSapLibrary AS HANDLE NO-UNDO.

RUN sap/sap-library.p PERSISTENT SET sh_hProcSapLibrary.
...
&Scoped-Define ENABLED-OBJECTS chbx-como-dni BUTTON-11 BUTTON-12 BUTTON-13 ~
BUTTON-15 
&Scoped-Define DISPLAYED-OBJECTS chbx-como-dni FILL-IN-param 
...
DEFINE FRAME F-Main
     chbx-como-dni AT ROW 20.38 COL 81 WIDGET-ID 10
     ...
     BUTTON-15 AT ROW 24.69 COL 79 WIDGET-ID 12
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PEDIDOS POR APROBAR POR CREDITOS & COBRANZAS"
         HEIGHT             = 25.27
         WIDTH              = 143.72
         MAX-HEIGHT         = 26.92
         MAX-WIDTH          = 187.57
...
ON END-ERROR OF W-Win /* PEDIDOS POR APROBAR POR CREDITOS  COBRANZAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PEDIDOS POR APROBAR POR CREDITOS  COBRANZAS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/b-pedido-aprobacion.w':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/b-sdoxcli.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-sdoxcli ).
       RUN set-position IN h_b-sdoxcli ( 20.38 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-sdoxcli ( 5.65 , 71.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_bcaprobaciongeneral ,
             chbx-como-dni:HANDLE IN FRAME F-Main , 'BEFORE':U ).
...
------------------------------------------------------------------------------*/
  DISPLAY chbx-como-dni FILL-IN-param 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE chbx-como-dni BUTTON-11 BUTTON-12 BUTTON-13 BUTTON-15 
      WITH FRAME F-Main IN WINDOW W-Win.
