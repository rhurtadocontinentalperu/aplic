...
# Nombre del Shell 	: facturasdeanticipo2sap.sh
# cron			: */5 * * * * /ruta/del/script/facturasdeanticipo2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/ventas/facturaanticipo' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/facturasdeanticipo2sap.lock"
LOGFILE="/var/log/facturasdeanticipo2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/ventas/facturaanticipo"
