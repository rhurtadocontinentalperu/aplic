...
DEFINE VAR pAviso AS CHAR NO-UNDO.

RUN SAP/genera-od-otr-hpk-phr PERSISTENT SET hProc.

RUN CCB_Aprobar_Pedido IN hProc (INPUT rRowid,
                                 INPUT s-FlgEst,
                                 OUTPUT pNroOD,
                                 OUTPUT pMensaje,
                                 OUTPUT pAviso).
...
IF AVAILABLE b-t-cpedi THEN DO:
    ...
    RUN sap/d-eecc-por-cliente (INPUT faccpedi.codcli).
