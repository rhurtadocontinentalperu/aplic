...
DEF INPUT PARAMETER titulo AS CHAR NO-UNDO.
DEF INPUT PARAMETER TABLE FOR tw-report.
DEF OUTPUT PARAMETER pcNroDoc AS CHAR NO-UNDO.
...
tw-report.Campo-C[5] tw-report.Campo-F[2] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      tw-report.Campo-C[1] COLUMN-LABEL "Doc" FORMAT "X(8)":U
      tw-report.Campo-C[2] COLUMN-LABEL "Numero" FORMAT "X(15)":U
            WIDTH 11.72
      tw-report.Campo-C[3] COLUMN-LABEL "Cliente" FORMAT "X(80)":U
            WIDTH 40.43
      tw-report.Campo-C[4] COLUMN-LABEL "Fecha Emisión" FORMAT "X(10)":U
      tw-report.Campo-C[5] COLUMN-LABEL "Mon" FORMAT "X(5)":U
      tw-report.Campo-F[2] COLUMN-LABEL "Saldo Actual" FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 88 BY 8.62
...
"Campo-C[1]" "Doc" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tw-report.Campo-C[2]
"Campo-C[2]" "Numero" "X(15)" "character" ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tw-report.Campo-C[3]
"Campo-C[3]" "Cliente" "X(80)" "character" ? ? ? ? ? ? no ? no no "40.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tw-report.Campo-C[4]
"Campo-C[4]" "Fecha Emisión" "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tw-report.Campo-C[5]
"Campo-C[5]" "Mon" "X(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tw-report.Campo-F[2]
"Campo-F[2]" "Saldo Actual" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
DO:
  IF AVAILABLE tw-report THEN pcNroDoc = tw-report.Campo-C[2].
END.
