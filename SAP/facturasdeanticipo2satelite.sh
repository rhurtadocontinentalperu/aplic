...
# Nombre del Shell 	: facturasdeanticipo2satelite.sh
# cron			: */5 * * * * /ruta/del/script/facturasdeanticipo2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/facturaanticipo' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/facturasdeanticipo2satelite.lock"
LOGFILE="/var/log/facturasdeanticipo2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/facturaanticipo"
