...
CcbCCaja.Glosa CcbCCaja.TpoCmb 
...
------------------------------------------------------------------------------*/
  ...
  IF s-user-id <> 'ADMIN' THEN IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO, RETURN 'ADM-ERROR'.
...
MESSAGE 'NO se permite ANULACIÓN' VIEW-AS ALERT-BOX WARNING.
RETURN 'ADM-ERROR'.
...
------------------------------------------------------------------------------*/
  ...
  BUTTON-TpoCmb:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
  CcbCcaja.ImpNac[1]:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
  CcbCcaja.ImpUsa[1]:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
