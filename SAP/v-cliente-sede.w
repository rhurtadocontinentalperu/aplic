...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  IF AVAILABLE gn-clied AND (gn-clied.sede = '@@@' OR gn-clied.sede = 'ALM') THEN DO:
      MESSAGE 'NO puede eliminar la dirección fiscal ni la dirección del almacén' SKIP 'Proceso abortado'
