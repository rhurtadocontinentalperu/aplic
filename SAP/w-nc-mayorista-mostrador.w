...
DEFINE VARIABLE h_vnotcredutilex AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/v-nc-mayorista-mostrador.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vnotcredutilex ).
       RUN set-position IN h_vnotcredutilex ( 2.92 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-notcre-4 ).
       RUN set-position IN h_q-notcre-4 ( 1.19 , 78.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 10.00 ) */

       /* Links to SmartViewer h_vnotcredutilex. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_vnotcredutilex ).
       RUN add-link IN adm-broker-hdl ( h_q-notcre-4 , 'Record':U , h_vnotcredutilex ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_vnotcredutilex ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-notcre-4 ,
             h_vnotcredutilex , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       RUN add-link IN adm-broker-hdl ( h_q-notcre-4 , 'Record':U , h_bnotcredutilex ).

       /* Links to SmartViewer h_vnotcredutilexa. */
       RUN add-link IN adm-broker-hdl ( h_q-notcre-4 , 'Record':U , h_vnotcredutilexa ).
