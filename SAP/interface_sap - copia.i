...
&IF DEFINED(input_table) &THEN
        ...
        IF AVAILABLE(faccpedi) THEN DO:
            ...
            CASE faccpedi.coddoc:
                ...
                WHEN "PED" THEN DO:
                    ...
                    LocalActualiza = YES.
                    /* Si generó un O/D => flgest = "C" y no debe volver a pasarse */
                    IF faccpedi.flgest = "C" THEN LocalActualiza = NO.
                END.
    ...
    &IF "{&input_table}" = "ccbcdocu" &THEN
        ...
        IF AVAILABLE(ccbcdocu) THEN DO:
            CASE ccbcdocu.coddoc:
                WHEN "FAC" OR WHEN "BOL" OR WHEN "N/C" OR WHEN "BD" THEN DO:
                    LocalActualiza = YES.
                END.
            END CASE.
            LocalAccion = "UPDATE".
            IF NEW ccbcdocu THEN LocalAccion = "CREATE".
            IF Ccbcdocu.FlgEst = "A" THEN LocalAccion = "DELETE".
            IF LocalActualiza THEN DO:
    ...
    &IF "{&input_table}" = "ccbccaja" &THEN
        IF AVAILABLE(ccbccaja) THEN DO:
            ...
            END CASE.
            LocalAccion = "UPDATE".
            IF NEW ccbccaja THEN LocalAccion = "CREATE".
            IF Ccbccaja.FlgEst = "A" THEN LocalAccion = "DELETE".
            IF LocalActualiza THEN DO:
