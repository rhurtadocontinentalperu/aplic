...
####################################################### PAGOS RECIBIDOS BD ##############################################################
# Nombre del Shell 	: pagosrecibido_bd2sap.sh
# cron			: */5 * * * * /ruta/del/script/pagosrecibido_bd2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/finanzas/pagosrecibidos/boletasdeposito' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosrecibido_bd2sap.lock"
LOGFILE="/var/log/pagosrecibido_bd2sap.txt"
URL="http://192.168.100.222:5500/http://localhost:9500/interfacesatelite2sap/finanzas/pagosrecibidos/boletasdeposito"
