...
####################################################### CODIGO DE BARRAS DE SAP2SATELITE #############################################
# Nombre del Shell 	: codigobarra_sap2stelite.sh
# cron			: */5 * * * * /ruta/del/script/codigobarra_sap2stelite.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesap2satelite/master/codigobarra' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/codigobarra_sap2stelite.lock"
LOGFILE="/var/log/codigobarra_sap2stelite.txt"
URL="http://192.168.100.222:9500/interfacesap2satelite/master/codigobarra"
