...
&Scoped-Define ENABLED-OBJECTS RECT-2 Btn-Print 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 8.27 , 14.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 8.27 , 31.14 ) NO-ERROR.
       ...
       RUN set-position IN h_q-remesa-01 ( 8.27 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/v-remesa-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-remesa-01 ).
       RUN set-position IN h_v-remesa-01 ( 1.27 , 3.00 ) NO-ERROR.
