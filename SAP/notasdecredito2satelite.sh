...
####################################################### NOTAS DE CREDITO ##############################################################
# Nombre del Shell 	: notasdecredito2satelite.sh
# cron			: */5 * * * * /ruta/del/script/notasdecredito2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/notacredito' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/notasdecredito2satelite.lock"
LOGFILE="/var/log/notasdecredito2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/notacredito"
