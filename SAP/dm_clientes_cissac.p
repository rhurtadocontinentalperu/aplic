...
DEF VAR c-xls-file AS CHAR INIT 'oStdBusineesPartners' NO-UNDO.
DEF VAR rpta AS LOG INIT NO NO-UNDO.

SYSTEM-DIALOG GET-FILE c-xls-file
    FILTERS 'Libro de Excel' '*.cvs'
    INITIAL-FILTER 1
    ASK-OVERWRITE
    CREATE-TEST-FILE
...
RUN pi-crea-archivo-csv IN hProc (INPUT BUFFER oStdBusineesPartners:HANDLE,
                                  INPUT c-xls-file,
                                  OUTPUT c-csv-file) .
