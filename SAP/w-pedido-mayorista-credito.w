...
DO:
    RUN sap/d-eecc-por-cliente (INPUT s-codcli).
    /* Declaración de la función externa de Windows */
    /* Ejecución: Pausa de 3 segundos (3000 milisegundos) */
    RUN Sleep(3000).
END.
...
{src/adm/template/windowmn.i}
    ...
    PROCEDURE Sleep EXTERNAL "kernel32.dll":
        DEFINE INPUT PARAMETER deMilisegundos AS LONG NO-UNDO.
    END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'SAP/v-pedido-mayorista-credito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedido-credito-v2 ( 14.19 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 25.23 , 3.00 ) NO-ERROR.
