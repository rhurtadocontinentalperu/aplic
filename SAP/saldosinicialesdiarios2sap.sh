...
####################################################### SALDOS INICIALES DIARIOS ##########################################################
# Nombre del Shell 	: saldosinicialesdiarios2sap.sh
# cron			: */5 * * * * /ruta/del/script/saldosinicialesdiarios2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesap2satelite/items/saldosinicialesdiarios' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/saldosinicialesdiarios2sap.lock"
LOGFILE="/var/log/saldosinicialesdiarios2sap.txt"
URL="http://192.168.100.222:9500/interfacesap2satelite/items/saldosinicialesdiarios"
