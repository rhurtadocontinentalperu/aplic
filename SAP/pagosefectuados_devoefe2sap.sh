...
######################################### PAGOS EFECTUADOS DEVOLUCION EFECTIVO ###########################################################
# Nombre del Shell 	: pagosefectuados_devoefe2sap.sh
# cron			: */5 * * * * /ruta/del/script/pagosefectuados_devoefe2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/ventas/pagoefectuado/devonc' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosefectuados_devoefe2sap.lock"
LOGFILE="/var/log/pagosefectuados_devoefe2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/ventas/pagoefectuado/devonc"
