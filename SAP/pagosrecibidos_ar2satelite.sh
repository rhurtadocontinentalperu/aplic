...
####################################################### PAGOS RECIBIDOS A/R ##############################################################
# Nombre del Shell 	: pagosrecibidos_ar2satelite.sh
# cron			: */5 * * * * /ruta/del/script/pagosrecibidos_ar2satelite.sh
# curl			: curl -X 'GET' 'http://192.168.100.222:5500/continental/interfaces/finanzas/pagorecibido/anticiporecibido' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/pagosrecibidos_ar2satelite.lock"
LOGFILE="/var/log/pagosrecibidos_ar2satelite.txt"
URL="http://192.168.100.222:5500/continental/interfaces/finanzas/pagorecibido/anticiporecibido"
