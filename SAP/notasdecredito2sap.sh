...
####################################################### NOTAS DE CREDITO ##################################################################
# Nombre del Shell 	: notasdecredito2sap.sh
# cron			: */5 * * * * /ruta/del/script/notasdecredito2sap.sh
# curl			: curl -X 'GET' 'http://localhost:9500/interfacesatelite2sap/ventas/notacredito' -H 'accept: application/json'
##########################################################################################################################################

# 1. Definición de rutas y variables
LOCKFILE="/tmp/notasdecredito2sap.lock"
LOGFILE="/var/log/notasdecredito2sap.txt"
URL="http://192.168.100.222:9500/interfacesatelite2sap/ventas/notacredito"
