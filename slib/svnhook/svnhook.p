...
procedure commitWc private:
    ...
    &if "{&opsys}" begins "win" &then
        ...
        cCmd = 'svn commit "' + pcFullPath + '" -m "' + escapeProp( pcDesc ) + '"'.
...
procedure copyWc private:
    ...
    &if "{&opsys}" begins "win" &then
        ...
        cCmd = 'svn copy "' + pcSource + '" "' + pcTarget + '"'.
...
procedure mergeUrlWc private:
    ...
    &if "{&opsys}" begins "win" &then
        ...
        cCmd = 'svn merge --reintegrate "' + pcUrl + '" "' + pcFullPath + '"'.
...
procedure deleteWc private:
    ...
    &if "{&opsys}" begins "win" &then
        ...
        cCmd = 'svn delete "' + pcFullPath + '" --force'.
...
procedure setWcProp private:
    ...
    &if "{&opsys}" begins "win" &then
        ...
        cCmd = 'svn propset "' + pcPropName + '" "' + escapeProp( pcPropVal ) + '" "' + pcFullPath + '"'.
