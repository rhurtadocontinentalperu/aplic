...
&Scoped-define INTERNAL-TABLES t_pago_efectivo T-CPEDI T-INTERFASE
...
&Scoped-define QUERY-STRING-BROWSE-3 FOR EACH T-CPEDI ~
      WHERE {&CONDICION} NO-LOCK, ~
...
&Scoped-define OPEN-QUERY-BROWSE-3 OPEN QUERY BROWSE-3 FOR EACH T-CPEDI ~
      WHERE {&CONDICION} NO-LOCK, ~
      FIRST T-INTERFASE WHERE T-INTERFASE.CodCia = T-CPEDI.CodCia ~
  AND T-INTERFASE.Pedido_Cliente = T-CPEDI.ordcmp OUTER-JOIN NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-3 T-CPEDI T-INTERFASE
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-3 T-CPEDI
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-3 T-INTERFASE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 189 BY 4.77
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 189 BY 10.38
         FONT 4 FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     BROWSE-3 AT ROW 9.15 COL 1.86 WIDGET-ID 300
