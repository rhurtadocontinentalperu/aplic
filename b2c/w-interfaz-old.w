...
T-INTERFASE.Moneda T-INTERFASE.Importe T-INTERFASE.Comision ~
T-INTERFASE.Neto_Abonar T-INTERFASE.Estado T-INTERFASE.Fecha_Abono ~
T-INTERFASE.Autorizacion T-INTERFASE.Id_Unico T-INTERFASE.Pedido_Cliente ~
T-INTERFASE.Cuenta T-INTERFASE.Banco 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      T-INTERFASE.Comision FORMAT "->>>,>>>,>>9.99":U
      ...
      T-INTERFASE.Pedido_Cliente COLUMN-LABEL "Pedido Cliente" FORMAT "x(20)":U
            WIDTH 16.14
      T-INTERFASE.Cuenta FORMAT "x(30)":U WIDTH 18.43
      T-INTERFASE.Banco FORMAT "x(40)":U WIDTH 21.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 179 BY 21
...
"T-INTERFASE.Fecha_de_Proceso" "Fecha de!Proceso" ? "date" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-INTERFASE.Tipo_Operacion
"T-INTERFASE.Tipo_Operacion" "Tipo de!Operacion" ? "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = Temp-Tables.T-INTERFASE.Tarjeta
     _FldNameList[4]   > Temp-Tables.T-INTERFASE.Tipo_Tarjeta
"T-INTERFASE.Tipo_Tarjeta" "Tipo Tarjeta" ? "character" ? ? ? ? ? ? no ? no no "10.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = Temp-Tables.T-INTERFASE.Moneda
     _FldNameList[6]   = Temp-Tables.T-INTERFASE.Importe
     _FldNameList[7]   = Temp-Tables.T-INTERFASE.Comision
     _FldNameList[8]   > Temp-Tables.T-INTERFASE.Neto_Abonar
"T-INTERFASE.Neto_Abonar" "Neto Abonar" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   = Temp-Tables.T-INTERFASE.Estado
     _FldNameList[10]   > Temp-Tables.T-INTERFASE.Fecha_Abono
"T-INTERFASE.Fecha_Abono" "Fecha Abono" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   = Temp-Tables.T-INTERFASE.Autorizacion
     _FldNameList[12]   > Temp-Tables.T-INTERFASE.Id_Unico
"T-INTERFASE.Id_Unico" "Id Unico" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-INTERFASE.Pedido_Cliente
"T-INTERFASE.Pedido_Cliente" "Pedido Cliente" ? "character" ? ? ? ? ? ? no ? no no "16.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-INTERFASE.Cuenta
"T-INTERFASE.Cuenta" ? ? "character" ? ? ? ? ? ? no ? no no "18.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > Temp-Tables.T-INTERFASE.Banco
"T-INTERFASE.Banco" ? ? "character" ? ? ? ? ? ? no ? no no "21.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
