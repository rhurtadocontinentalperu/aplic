...
&Scoped-define QUERY-STRING-BROWSE-2 FOR FIRST t_pago_efectivo WHERE  ~
 OUTER-JOIN NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR FIRST t_pago_efectivo WHERE  ~
 OUTER-JOIN NO-LOCK INDEXED-REPOSITION.
...
FILL-IN-FchDoc BUTTON-Procesar BUTTON-Aprobar BUTTON-buscar ~
...
DEFINE VARIABLE FILL-IN-1 AS CHARACTER FORMAT "X(256)":U INITIAL "   LIQUIDACION DE PAGO EFECTIVO MENSUAL" 
     VIEW-AS FILL-IN 
     SIZE 65.57 BY 1.04
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      t_pago_efectivo.concepto_pago COLUMN-LABEL "Concepto!Pago" FORMAT "x(50)":U
            WIDTH 20.72
      t_pago_efectivo.monto COLUMN-LABEL "Importe" FORMAT "->>,>>>,>>9.99":U
...
DEFINE FRAME F-Main
     FILL-IN-1 AT ROW 1.04 COL 125 NO-LABEL WIDGET-ID 24
     BUTTON-filtrar AT ROW 2.23 COL 129 WIDGET-ID 16
     FILL-IN-FchDoc AT ROW 2.35 COL 19 COLON-ALIGNED WIDGET-ID 2
     FILL-IN-FchDoc-2 AT ROW 2.35 COL 37 COLON-ALIGNED WIDGET-ID 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "LIQUIDACION DE PAGO EFECTIVO MENSUAL"
         HEIGHT             = 24.73
         WIDTH              = 190.86
         MAX-HEIGHT         = 26.15
         MAX-WIDTH          = 191.29
...
/* SETTINGS FOR FILL-IN FILL-IN-1 IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN FILL-IN-FchDoc-2 IN FRAME F-Main
   NO-ENABLE                                                            */
...
"t_pago_efectivo.fecha_emision" "Fecha!Emision" ? "date" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.t_pago_efectivo.fecha_cancelacion
"t_pago_efectivo.fecha_cancelacion" "Fecha!Cancelacion" ? "date" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"t_pago_efectivo.monto" "Importe" "->>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON END-ERROR OF W-Win /* LIQUIDACION DE PAGO EFECTIVO MENSUAL */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* LIQUIDACION DE PAGO EFECTIVO MENSUAL */
DO:
...
FOR EACH pago_efectivo WHERE pago_efectivo.codcia = s-codcia AND
                                ...
                                (TRUE <> (pago_efectivo.usrliquidacion > "")) NO-LOCK :
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-34 RECT-35 BUTTON-filtrar FILL-IN-FchDoc BUTTON-Procesar 
         BUTTON-Aprobar BUTTON-buscar RADIO-SET-cuales FILL-IN-pedido BROWSE-2 
      WITH FRAME F-Main IN WINDOW W-Win.
