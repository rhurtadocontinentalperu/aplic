TRIGGER PROCEDURE FOR REPLICATION-DELETE OF piksacadores.

    {rpl/reptrig.i
    &Table  = piksacadores
    &Key    = "string(piksacadores.codcia,'999') + string(piksacadores.coddiv,'x(5)') + ~
        string(piksacadores.codper,'x(6)') + STRING(piksacadores.fecha)"
    &Prg    = r-piksacadores
    &Event  = DELETE
    &FlgDB0 = NO
