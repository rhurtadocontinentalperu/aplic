TRIGGER PROCEDURE FOR REPLICATION-DELETE OF vtadtrkped.
/*
    {rpl/reptrig.i
    &Table  = vtadtrkped
    &Key    = "string(vtadtrkped.codcia,'999') + string(vtadtrkped.coddiv,'x(5)') + ~
        string(vtadtrkped.coddoc,'x(3)') + string(vtadtrkped.nroped,'x(12)') + ~
        string(vtadtrkped.fechai)"
    &Prg    = r-vtadtrkped
    &Event  = DELETE
    &FlgDB0 = NO
