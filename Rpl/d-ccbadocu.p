TRIGGER PROCEDURE FOR REPLICATION-DELETE OF ccbadocu.
/*
    {rpl/reptrig.i
    &Table  = ccbadocu
    &Key    = "string(ccbadocu.codcia,'999') + string(ccbadocu.coddiv,'x(5)') + ~
    string(ccbadocu.coddoc,'x(3)') + ccbadocu.nrodoc"
    &Prg    = r-ccbadocu
    &Event  = DELETE
    &FlgDB0 = NO
