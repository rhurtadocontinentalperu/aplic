TRIGGER PROCEDURE FOR REPLICATION-DELETE OF FacTabla.

    {rpl/reptrig.i
    &Table  = FacTabla
    &Key    =  "string(FacTabla.codcia,'999') + ~
                string(FacTabla.tabla,'x(20)') + ~
                string(FacTabla.codigo,'x(20)')"
    &Prg    = r-FacTabla
    &Event  = DELETE
    &FlgDB0 = TRUE  /* NO Replicar de la sede remota a la base principal */
