TRIGGER PROCEDURE FOR REPLICATION-WRITE OF ccbccaja.
/*
    ...
    {rpl/reptrig.i
    &Table  = ccbccaja
    &Key    =  "string(ccbccaja.codcia,'999') + string(ccbccaja.coddoc,'x(3)') + string(ccbccaja.nrodoc,'x(15)')"
    &Prg    = r-ccbccaja
    &Event  = WRITE
    &FlgDB0 = NO
    &FlgDB1 = TRUE      /* Replicar a la División 00501 (Plaza Norte) */
    &FlgDB2 = TRUE
    &FlgDB3 = TRUE
    &FlgDB4 = TRUE
    &FlgDB5 = TRUE
