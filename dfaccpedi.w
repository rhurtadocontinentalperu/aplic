...
&Scoped-Define ENABLED-FIELDS  CodCia CodDiv CodDoc FchPed NroPed
&Scoped-define ENABLED-FIELDS-IN-FacCPedi CodCia CodDiv CodDoc FchPed ~
NroPed 
&Scoped-Define DATA-FIELDS  CodCia CodDiv CodDoc FchPed NroPed
&Scoped-define DATA-FIELDS-IN-FacCPedi CodCia CodDiv CodDoc FchPed NroPed 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "dfaccpedi.i"
...
------------------------------------------------------------------------------*/
  ...
  /* Añadir el filtro dinámicamente usando funciones de ADM2   */
  
  DYNAMIC-FUNCTION('addQueryWhere':U, 
                   INPUT "faccpedi.codcia = " + STRING(s-codcia) + " and faccpedi.coddoc = 'PED'", 
                   INPUT "", /* Buffer */
                   INPUT ""). /* Operador AND implícito */
...
------------------------------------------------------------------------------*/
  ...
  /* Asignamos el valor de la variable global en lugar del '1' fijo */
  ASSIGN RowObject.codcia = s-codcia RowObject.coddoc = 'PED'.

  /* Lógica para registros nuevos en cabecera (ejemplo pedido) */
  IF RowObject.RowMod = "A" THEN ASSIGN RowObject.fchped = TODAY.
