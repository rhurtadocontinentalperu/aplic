...
DEFINE OUTPUT PARAMETER pCMotivo AS CHAR NO-UNDO.
DEFINE OUTPUT PARAMETER pCMotivoGlosa AS CHAR NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-motivo EDITOR-detalle Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-motivo EDITOR-detalle 
...
DEFINE VARIABLE EDITOR-detalle AS CHARACTER 
     ...
     SIZE 57.86 BY 4 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     COMBO-BOX-motivo AT ROW 1.54 COL 8 COLON-ALIGNED WIDGET-ID 2
     EDITOR-detalle AT ROW 2.69 COL 10.14 NO-LABEL WIDGET-ID 4
     Btn_Help AT ROW 6.92 COL 55
     Btn_OK AT ROW 7.19 COL 7
     Btn_Cancel AT ROW 7.19 COL 22
     "Glosa" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 2.73 COL 4 WIDGET-ID 6
     SPACE(60.71) SKIP(5.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 3
         TITLE "Motivos de Baja en Sunat"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Motivos de Baja en Sunat */
DO:  
...
DO:
    ...
    IF TRUE <> (combo-box-motivo > "") OR TRUE <> (editor-detalle > "") THEN DO:
        MESSAGE "Ingrese el motivo y la glosa" VIEW-AS ALERT-BOX INFORMATION.
    END.
    ELSE DO:
    ...
    FIND FIRST ttFacdpedi WHERE ttFacdpedi.libre_c04 = "SELECCIONAR FALTANTE" NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-motivo EDITOR-detalle 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX-motivo EDITOR-detalle Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
