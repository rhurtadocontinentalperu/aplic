...
&SCOPED-DEFINE l-lookup h_l-crralm-01
...
DEFINE VARIABLE h_l-crralm-01 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.35 COL 73.72
     Btn_Cancel AT ROW 6.5 COL 73.72
     Btn_Help AT ROW 9.58 COL 73.72
     SPACE(2.27) SKIP(1.26)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'gre/l-gre-crralm-01-consulta.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-crralm-01 ).
       RUN set-position IN h_l-crralm-01 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-crralm-01 ( 11.58 , 70.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.35 , 71.43 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-crralm-01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-crralm-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-crralm-01 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-crralm-01 , 'AFTER':U ).
    END. /* Page 0 */
