...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'gre/b-hoja-de-ruta-dg-gre.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-hoja-de-ruta-dg ).
       RUN set-position IN h_b-hoja-de-ruta-dg ( 16.08 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-hoja-de-ruta-dg ( 6.92 , 136.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-3 ).
       RUN set-position IN h_p-updv12-3 ( 23.08 , 4.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12-3 ( 1.35 , 32.00 ) NO-ERROR.
