...
FOR EACH gre_header_disponibles NO-LOCK:
    ...
    /*  Temporal para propositos de QA 
...
/* Solo para propositos de QA */ 
pcTextoQR = 'http://ec2-52-26-118-179.us-west-2.compute.amazonaws.com/files/x%276B793753686B6F4B4E79376F6B714A4B4A43676C732F634D763550704F766131567441587134316C4C644273524A476843677A64454F3872447348724556656A497A58634C3247446256413D%27'.
...
&IF DEFINED(EXCLUDE-simular-respuesta-sunat) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE simular-respuesta-sunat Procedure 
PROCEDURE simular-respuesta-sunat :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'typeDocument'
        cValue = '06'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'idDocument'
            cValue = 'F251-00143277'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'status'
            cValue = 'SIGNED'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'statusSunat'
            cValue = 'AC_03'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'signTime'
            cValue = '2024-07-24'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'signatureValue'
            cValue = 'xUJHW02KIZiULFcOlhaTrHv1jMpWp51IwlY64yqkvcE4rxdMFgRYRmzSvht4RR3ZVAEDtZy5Gzoo7YFdaE5khpEvgf46Wnzv3xLJ/r4jqHf45kJtuIT6oRZ30FyFycsVJzBNTmF+g=='.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'emisionTime'
            cValue = '2024-07-24'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'messageSunat'
            cValue = "codigo:0,mensaje:El comprobante numero F276-00023016, ha sido aceptada".
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'hashCode'
            cValue = 'Xh6gKqPG30wfoxRTF7AKC1/m7Gc='.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'pdfFileUrl'
            cValue = 'http://ec2-52-26-118-179.us-west-2.compute.amazonaws.com/files/x%275A556573616D42526B64706E647A472B365639476844546136326134384A6F6F784166744A36524979646D79366C4973524A6D4378334E2B45647775394D314D%27'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'xmlFileSignUrl'
            cValue = 'http://ec2-52-26-118-179.us-west-2.compute.amazonaws.com/files/x%274F7372717353565334492F6D4A446565706A56382B577231736F41387363623536335A464F55394B50517879736F577259726A376B6E35625050464765496C61%27'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'xmlFileSunatUrl'
            cValue = 'http://ec2-52-26-118-179.us-west-2.compute.amazonaws.com/files/x%276B793753686B6F4B4E79376F6B714A4B4A43676C732F634D763550704F766131567441587134316C4C644273524A476843677A64454F3872447348724556656A497A58634C3247446256413D%27'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'numeroDocumentoEmisor'
            cValue = '20100038146'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'tipoDocumentoAdquiriente'
            cValue = '6'.
CREATE tTagsEstadoDoc.
    ASSIGN cTag = 'numeroDocumentoAdquiriente'
            cValue = '20600557875'.
