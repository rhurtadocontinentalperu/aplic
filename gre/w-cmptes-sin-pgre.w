...
DEFINE NEW SHARED VAR s-acceso-total  AS LOG.   /* Control GRE */
...
&Scoped-Define ENABLED-OBJECTS BUTTON-generar-pre-gre 
...
DEFINE FRAME F-Main
     BUTTON-generar-pre-gre AT ROW 21.27 COL 2.43 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 121.14 BY 21.81 WIDGET-ID 100.
...
ON CHOOSE OF BUTTON-generar-pre-gre IN FRAME F-Main /* Exportar a Excel */
DO:
    DEFINE VAR lSoloSeleccionados AS LOG.

    lSoloSeleccionados = NO.

  RUN exportar-excel IN h_b-genera-gre-desde-cmpte (lSoloSeleccionados).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'gre/b-cmptes-sin-pgre.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-genera-gre-desde-cmpte ).
       RUN set-position IN h_b-genera-gre-desde-cmpte ( 1.00 , 2.29 ) NO-ERROR.
       RUN set-size IN h_b-genera-gre-desde-cmpte ( 19.92 , 118.14 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-genera-gre-desde-cmpte ,
             BUTTON-generar-pre-gre:HANDLE IN FRAME F-Main , 'BEFORE':U ).
    END. /* Page 0 */
