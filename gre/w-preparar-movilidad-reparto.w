...
&Scoped-Define ENABLED-OBJECTS RECT-10 RECT-11 RECT-12 RECT-14 BUTTON-1 ~
BUTTON-3 BUTTON-Invalidar FILL-IN-phr COMBO-BOX-tipoorden FILL-IN-orden ~
BROWSE-2 BUTTON-filtrar BUTTON-reset-filtros FILL-IN-placa FILL-IN-placa-2 ~
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1.08 COL 2.57 WIDGET-ID 4
     BUTTON-3 AT ROW 1.08 COL 29.29 WIDGET-ID 144
     BUTTON-Invalidar AT ROW 1.08 COL 57 WIDGET-ID 216
     FILL-IN-phr AT ROW 1.81 COL 137 RIGHT-ALIGNED WIDGET-ID 196
     COMBO-BOX-tipoorden AT ROW 1.81 COL 150.72 COLON-ALIGNED WIDGET-ID 200
     FILL-IN-orden AT ROW 1.81 COL 185 RIGHT-ALIGNED WIDGET-ID 198
     BROWSE-2 AT ROW 2.31 COL 1.72 WIDGET-ID 200
     BUTTON-filtrar AT ROW 2.85 COL 146 WIDGET-ID 206
     BUTTON-reset-filtros AT ROW 2.85 COL 163.72 WIDGET-ID 208
     ...
     BROWSE-9 AT ROW 15 COL 1.57 WIDGET-ID 300
...
DEFINE FRAME F-Main
     ...
     " [ filtros ]" VIEW-AS TEXT
          SIZE 13 BY .54 AT ROW 1 COL 174 WIDGET-ID 204
     ...
     RECT-14 AT ROW 1.19 COL 115.43 WIDGET-ID 202
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 187.86 BY 25
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-2 FILL-IN-orden F-Main */
/* BROWSE-TAB BROWSE-9 FILL-IN_NomPro F-Main */
ASSIGN 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-10 RECT-11 RECT-12 RECT-14 BUTTON-1 BUTTON-3 BUTTON-Invalidar 
         FILL-IN-phr COMBO-BOX-tipoorden FILL-IN-orden BROWSE-2 BUTTON-filtrar 
         BUTTON-reset-filtros FILL-IN-placa FILL-IN-placa-2 BROWSE-9 
...
DEFINE VAR lActivarPGRE AS LOG.

/*

20Jun2025, en coodino con Contraloria y Martin chirinos y solo se pondran filtros

MESSAGE 'Antes de continuar con el proceso de INVALIDACION' SKIP
        '---------------------------------------------------------' SKIP
        'Desea ACTIVAR el comprobante invalidado, para volver' SKIP
        'generar una nueva PRE-GUIA DE REMISION?' SKIP
        'SOLO VALIDO PARA COMPROBANTES DE VENTAS!!!'
        '---------------------------------------------------------' SKIP
        'POR FAVOR LEA Y ELIJA CON RESPONSABILIDAD'
         VIEW-AS ALERT-BOX QUESTION
                BUTTONS YES-NO UPDATE rptaActivarPGRE AS LOG.

lActivarPGRE = rptaActivarPGRE.
*/
        ...
        IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(iRow) THEN DO:
            CASE gre_header_disponibles.correoRemitente:
                WHEN "O/D" THEN DO:
                    ...
                    END.
                    ELSE DO:
                        /* Veamos si está anulada la factura - es porque se va facturar de nuevo */
