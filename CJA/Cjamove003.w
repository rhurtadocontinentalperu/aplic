...
DEFINE FRAME F-maestro
     C-CodOpe AT ROW 1.38 COL 9 COLON-ALIGNED
     FILL-IN-CodOpe AT ROW 1.38 COL 18 COLON-ALIGNED NO-LABEL
     cb-cmov.NroAst AT ROW 2.35 COL 9 COLON-ALIGNED
          LABEL "Voucher"
          VIEW-AS FILL-IN 
          SIZE 8 BY .69
     cb-cmov.CodDiv AT ROW 3.12 COL 9 COLON-ALIGNED
          LABEL "División" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 8 BY .69
     X-NOMDIV AT ROW 3.12 COL 17 COLON-ALIGNED NO-LABEL
     cb-cmov.CtaCja AT ROW 3.88 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY .69
     x-NomCta AT ROW 3.88 COL 17 COLON-ALIGNED NO-LABEL
     cb-cmov.CodAux AT ROW 4.65 COL 9 COLON-ALIGNED
          LABEL "Auxiliar"
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     ...
     cb-cmov.FchMod AT ROW 2.35 COL 60 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 8 BY .69
     cb-cmov.CodDoc AT ROW 4.65 COL 26 COLON-ALIGNED
          LABEL "Doc"
          VIEW-AS FILL-IN 
          SIZE 6 BY .69
     cb-cmov.NroChq AT ROW 4.65 COL 38 COLON-ALIGNED
          LABEL "Nro"
          VIEW-AS FILL-IN 
          SIZE 15 BY .69
     cb-cmov.TpoCmb AT ROW 2.35 COL 77 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 9 BY .69
     Moneda AT ROW 3.12 COL 77 COLON-ALIGNED
     F-SdoCta AT ROW 4.08 COL 77 COLON-ALIGNED
     cb-cmov.C-FCaja AT ROW 4.85 COL 77 COLON-ALIGNED
          LABEL "Con. Flj. Caja"
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .69
...
DO:
   DEF VAR X-ERROR AS LOGICAL INIT NO.
    IF b-d-add:SENSITIVE = NO THEN DO:
        MESSAGE "Modifica".
        RETURN NO-APPLY.
    END.
    /*THEN RETURN NO-APPLY.*/
