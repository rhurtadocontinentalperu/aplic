...
cb-cmov.CtaCja cb-cmov.CodAux cb-cmov.NroVou cb-cmov.NotAst cb-cmov.GloAst ~
cb-cmov.CodDoc cb-cmov.Usuario cb-cmov.FchAst cb-cmov.NroChq cb-cmov.ImpChq ~
cb-cmov.Girado cb-cmov.TpoCmb cb-cmov.C-FCaja 
...
/* Menu Definitions                                                     */
DEFINE MENU POPUP-MENU-B-imprimir-2 
       MENU-ITEM m_Todas_las_Cuentas-2 LABEL "Todas las Cuentas"
       MENU-ITEM m_Todas_las_Cuentas_Ordenado_2 LABEL "Todas las Cuentas Ordenado por Cuenta".
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 76 BY 5.81
...
DEFINE FRAME F-maestro
     ...
     cb-cmov.CodAux AT ROW 4.85 COL 10.86 COLON-ALIGNED
          ...
          SIZE 10 BY .69
          BGCOLOR 8 
     cb-cmov.NroVou AT ROW 11.65 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .69
          BGCOLOR 8 
     cb-cmov.NotAst AT ROW 12.46 COL 11 COLON-ALIGNED
          LABEL "Concepto" FORMAT "x(80)"
          VIEW-AS FILL-IN 
          SIZE 42.14 BY .69
          BGCOLOR 8 
     cb-cmov.GloAst AT ROW 13.38 COL 13 NO-LABEL
     ...
     cb-cmov.CodDoc AT ROW 4.85 COL 33.14 COLON-ALIGNED
          ...
          SIZE 6 BY .69
          BGCOLOR 8 
     cb-cmov.Usuario AT ROW 11.65 COL 33 COLON-ALIGNED
          LABEL "Autor"
          VIEW-AS FILL-IN 
          SIZE 11.72 BY .69
     ...
     cb-cmov.NroChq AT ROW 4.85 COL 44.14 COLON-ALIGNED
          ...
          SIZE 14.29 BY .69
          BGCOLOR 8 
     cb-cmov.ImpChq AT ROW 11.65 COL 55 COLON-ALIGNED
          LABEL "Total"
          VIEW-AS FILL-IN 
          SIZE 17 BY .69
          BGCOLOR 7 FGCOLOR 15 
     cb-cmov.Girado AT ROW 12.46 COL 64.14 COLON-ALIGNED
          LABEL "Recibido de"
          VIEW-AS FILL-IN 
          SIZE 25 BY .69
          BGCOLOR 8 
...
/* SETTINGS FOR BUTTON B-first IN FRAME F-ctrl-frame
   NO-DISPLAY                                                           */
ASSIGN 
       B-imprimir:POPUP-MENU IN FRAME F-ctrl-frame       = MENU POPUP-MENU-B-imprimir-2:HANDLE.
...
&Scoped-define SELF-NAME m_Todas_las_Cuentas-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Todas_las_Cuentas-2 W-Maestro
ON CHOOSE OF MENU-ITEM m_Todas_las_Cuentas-2 /* Todas las Cuentas */
DO:
   RUN IMPRIME2(1).
END.
...
ON CHOOSE OF MENU-ITEM m_Todas_las_Cuentas_Ordenado_2 /* Todas las Cuentas Ordenado por Cuenta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE cb-cmov THEN 
    DISPLAY cb-cmov.NroAst cb-cmov.CodDiv cb-cmov.CtaCja cb-cmov.CodAux 
          cb-cmov.NroVou cb-cmov.NotAst cb-cmov.GloAst cb-cmov.CodDoc 
          cb-cmov.Usuario cb-cmov.FchAst cb-cmov.NroChq cb-cmov.ImpChq 
          cb-cmov.Girado cb-cmov.TpoCmb cb-cmov.C-FCaja 
      WITH FRAME F-maestro IN WINDOW W-Maestro.
  ENABLE RECT-2 BRW-DETALLE C-CodOpe B-impresoras 
      WITH FRAME F-maestro IN WINDOW W-Maestro.
  {&OPEN-BROWSERS-IN-QUERY-F-maestro}
  ENABLE R-exit R-consulta-2 B-query B-add B-update B-delete BUTTON-2 
         B-imprimir B-first B-prev B-next B-last B-browse B-exit 
  ...
  ENABLE R-consulta R-navigaate-3 B-ok-2 B-Cancel-2 
