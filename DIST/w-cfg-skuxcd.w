...
DEF NEW SHARED VAR s-Tabla AS CHAR INIT 'CDSKU'.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 103.72 BY 17 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CAPACIDAD DISPONIBLE POR CD"
         HEIGHT             = 17
         WIDTH              = 103.72
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 103.72
...
ON END-ERROR OF W-Win /* CAPACIDAD DISPONIBLE POR CD */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CAPACIDAD DISPONIBLE POR CD */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-cfg-skuxcd ( 2.62 , 2.00 ) NO-ERROR.
