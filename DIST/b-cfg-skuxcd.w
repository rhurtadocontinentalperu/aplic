...
VtaTabla.Valor[1] VtaTabla.Valor[2] VtaTabla.Valor[3] VtaTabla.Valor[4] ~
VtaTabla.Valor[5] 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 112 BY 14.27
         FONT 4.
