...
DEFINE VARIABLE h_b-cierre-hr-cab AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-cierre-hr-det-d AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* CIERRE DE HOJAS DE RUTA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CIERRE DE HOJAS DE RUTA */
DO:
...
*/
  RUN Cierre-Hoja IN h_b-cierre-hr-cab.
END.
...
DO:
  RUN dispatch IN h_b-cierre-hr-cab ('open-query':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'DIST/b-cierre-hr-cab.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cierre-hr-cab ).
       RUN set-position IN h_b-cierre-hr-cab ( 1.19 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-cierre-hr-cab ( 6.92 , 106.00 ) NO-ERROR.
       ...
       RUN set-size IN h_folder ( 17.77 , 141.00 ) NO-ERROR.

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cierre-hr-cab ,
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'DIST/b-cierre-hr-det-d.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cierre-hr-det-d ).
       RUN set-position IN h_b-cierre-hr-det-d ( 9.88 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-cierre-hr-det-d ( 15.88 , 139.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cierre-hr-det-d. */
       RUN add-link IN adm-broker-hdl ( h_b-cierre-hr-cab , 'Record':U , h_b-cierre-hr-det-d ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cierre-hr-det-d ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       RUN add-link IN adm-broker-hdl ( h_b-cierre-hr-cab , 'Record':U , h_b-cierre-hr-det-g ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-cierre-hr-det-d , 'Record':U , h_v-rut002 ).

       /* Links to SmartBrowser h_b-cierre-hr-det-dv. */
       RUN add-link IN adm-broker-hdl ( h_b-cierre-hr-det-d , 'Record':U , h_b-cierre-hr-det-dv ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-cierre-hr-cab , 'Record':U , h_b-cierre-hr-det-dg ).
...
CASE pParam:
    WHEN 'Open-Browses' THEN DO:
        IF h_b-cierre-hr-det-d <> ? THEN RUN dispatch IN h_b-cierre-hr-det-d ('open-query':U).
