...
DI-RutaC.CodVeh DI-RutaC.CtoRut DI-RutaC.CodRut DI-RutaC.DesRut 
&Scoped-define ENABLED-FIELDS-IN-QUERY-D-Dialog DI-RutaC.HorRet ~
DI-RutaC.KmtFin DI-RutaC.CodRut 
...
DEFINE FRAME D-Dialog
     ...
     DI-RutaC.CtoRut AT ROW 8.31 COL 18 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     DI-RutaC.CodRut AT ROW 9.27 COL 18 COLON-ALIGNED WIDGET-ID 2
          LABEL "Guia del Transportista" FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     DI-RutaC.DesRut AT ROW 10.23 COL 18 COLON-ALIGNED
          LABEL "Detalle de la ruta"
          VIEW-AS FILL-IN 
          SIZE 37.14 BY .81
     SPACE(7.99) SKIP(0.60)
...
/* SETTINGS FOR FILL-IN DI-RutaC.CodRut IN FRAME D-Dialog
...
DO:
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      FOR EACH Di-RutaD OF Di-RutaC NO-LOCK WHERE Di-RutaD.FlgEst = "C",    /* SOLO ENTREGADOS */
          ...
          FIRST Ccbcbult WHERE CcbCBult.CodCia = Ccbcdocu.codcia
      ...
      FOR EACH Di-RutaG OF Di-RutaC NO-LOCK WHERE Di-RutaG.FlgEst = "C",    /* SOLO ENTREGADOS */
          FIRST Ccbcbult WHERE CcbCBult.CodCia = Di-RutaC.codcia
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE DI-RutaC THEN 
    DISPLAY DI-RutaC.NroDoc DI-RutaC.FchDoc DI-RutaC.HorSal DI-RutaC.HorRet 
          ...
          DI-RutaC.CodRut DI-RutaC.DesRut 
      WITH FRAME D-Dialog.
  ENABLE Btn_OK Btn_Cancel DI-RutaC.HorRet DI-RutaC.KmtFin DI-RutaC.CodRut 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
