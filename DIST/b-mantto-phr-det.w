...
FacCPedi.NomCli T-RUTAD.LugEnt @ x-Distrito T-RUTAD.Estado @ x-Estado ~
T-RUTAD.Docs @ x-Docs T-RUTAD.SKU @ x-SKU T-RUTAD.Libre_c01 T-RUTAD.ImpCob ~
T-RUTAD.Libre_d01 T-RUTAD.Libre_d02 FacCPedi.FchEnt T-RUTAD.FlgEst 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-RUTAD.FlgEst FORMAT "x(15)":U VIEW-AS COMBO-BOX INNER-LINES 5
...
"T-RUTAD.Reprogramado @ x-Reprogramado" "Rep." ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacCPedi.CrossDocking
...
"FacCPedi.FchEnt" ? ? "date" ? ? ? ? ? ? no ? no no "11.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.T-RUTAD.FlgEst
"T-RUTAD.FlgEst" ? "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Por Entregar,P,Cerrado,C,Anulado,A,Reprogramado,R" 5 no 0 no no
