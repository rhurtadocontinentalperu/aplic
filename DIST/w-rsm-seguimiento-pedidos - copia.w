...
DEFINE TEMP-TABLE tt-seguimiento NO-UNDO
        ...
        FIELDS tt-nroped    AS CHAR     COLUMN-LABEL "Nro.Pedido" FORMAT 'x(20)'
        ...
        FIELDS tt-divped    AS CHAR    COLUMN-LABEL "Div.Pedido Pedido" FORMAT 'x(10)'
        ...
        FIELD tt-horingcre          AS CHAR                 COLUMN-LABEL "Hora Ing. a Créditos" FORMAT 'x(20)'
        FIELDS tt-fecha-apro-cyc     AS  DATE                COLUMN-LABEL "Fecha aprobacion a CyC"
        FIELDS tt-hora-apro-cyc      AS  CHAR                COLUMN-LABEL "Hora aprobacion a CyC"  FORMAT 'x(20)'
        /* Orden */
        FIELDS tt-codord    LIKE faccpedi.coddoc    COLUMN-LABEL "Cod.Orden"
        FIELDS tt-nroord    AS CHAR    COLUMN-LABEL "Nro.Orden" FORMAT 'x(20)'
        ...
        FIELDS tt-imptot    AS DEC    COLUMN-LABEL "S/. Importe Venta Con IGV (O/D)" FORMAT "->>,>>>,>>9.9999"
        FIELDS tt-imprepo   AS DEC    COLUMN-LABEL "S/. Importe Reposicion con IGV (O/D)" FORMAT "->>,>>>,>>9.9999"
        FIELDS tt-impkard   AS DEC    COLUMN-LABEL "S/. Costo Promedio Kardex (O/D)" FORMAT "->>,>>>,>>9.9999"
        ...
        FIELDS tt-bultos    AS INT    COLUMN-LABEL "Bultos" FORMAT '>,>>>,>>9'
        FIELDS tt-frotula   AS DATE                 COLUMN-LABEL "Fecha Rotulado"
        FIELDS tt-finiemba  LIKE ccbcbult.dte_01    COLUMN-LABEL "Dia inicio Embalado"
        FIELDS tt-hiniemba  LIKE ccbcbult.CHR_03    COLUMN-LABEL "Hora inicio Embalado"
        FIELDS tt-ffinemba  LIKE ccbcbult.dte_01    COLUMN-LABEL "Dia Fin Embalado"
        FIELDS tt-hfinemba  LIKE ccbcbult.CHR_03    COLUMN-LABEL "Hora fin Embalado"
        FIELDS tt-fini_pi  LIKE ccbcbult.dte_01    COLUMN-LABEL "Dia inicio Parte de ingreso"
        FIELDS tt-hini_pi  LIKE ccbcbult.CHR_03    COLUMN-LABEL "Hora inicio Parte de ingreso"

        /* Generacion del Comprobante */
        FIELDS tt-cdoc      LIKE faccpedi.coddoc    COLUMN-LABEL "Doc"
        FIELDS tt-ndoc      AS CHAR                 COLUMN-LABEL "Nro Dcto"                FORMAT 'x(20)'
        ...
        FIELDS tt-origen    AS CHAR      COLUMN-LABEL "Division Emision"        FORMAT 'x(10)'
        FIELDS tt-codcli    AS CHAR    COLUMN-LABEL "CodCliente" FORMAT 'x(20)'
        ...
        FIELDS tt-nroremi   AS CHAR    COLUMN-LABEL "Nro Remision" FORMAT 'x(20)'
        /* Ruta */
        FIELDS tt-hruta         AS CHAR    COLUMN-LABEL "Numero H/R"        FORMAT 'x(20)'
        ...
        FIELDS tt-gtranspo  AS CHAR COLUMN-LABEL "Guia Transp." FORMAT 'x(20)'
...
DEFINE FRAME fMain
     txtCoddivi AT ROW 1.31 COL 19.72 COLON-ALIGNED WIDGET-ID 2
     txtDesDivi AT ROW 1.31 COL 28.57 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     txtFile AT ROW 3.19 COL 11.14 COLON-ALIGNED WIDGET-ID 28
     BUTTON-1 AT ROW 3.19 COL 74.86 WIDGET-ID 30
     BUTTON-2 AT ROW 4.27 COL 30 WIDGET-ID 32
     txtDesde AT ROW 6.35 COL 21 COLON-ALIGNED WIDGET-ID 4
     txtHasta AT ROW 6.35 COL 43.14 COLON-ALIGNED WIDGET-ID 6
     txtProcesar AT ROW 7.31 COL 67 WIDGET-ID 8
     ...
     "PED, R/A  y TRA que esten emitidos en este rango de fechas" VIEW-AS TEXT
          SIZE 43.86 BY .62 AT ROW 5.58 COL 23.43 WIDGET-ID 20
     "(valido solo para PEDIDOS de ventas)" VIEW-AS TEXT
          SIZE 27 BY .62 AT ROW 2.35 COL 36.43 WIDGET-ID 24
...
DO:
  ...
  END.
    ...
    ELSE DO:
        ...
        RUN lib/tt-file (TEMP-TABLE tt-seguimiento:HANDLE, cArchivo, pOptions).
