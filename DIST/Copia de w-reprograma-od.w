...
DEFINE FRAME F-Main
     BUTTON-Actualizar AT ROW 1 COL 3 WIDGET-ID 2
     BUTTON-Reprogramar AT ROW 1 COL 23 WIDGET-ID 4
     BUTTON-Elimicar AT ROW 1 COL 43 WIDGET-ID 6
...
DO:
  RUN MASTER-TRANSACTION IN h_b-reprograma-od-cab.
  RUN dispatch IN h_b-reprograma-od-cab ('open-query':U).
END.
