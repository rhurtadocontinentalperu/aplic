...
DEF VAR x-Moneda AS CHAR INIT 'S/' NO-UNDO.
...
x-Moneda @ x-Moneda fImporte() @ x-Importe Di-RutaG.HorLle Di-RutaG.HorPar ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Di-RutaG.serref COLUMN-LABEL "Serie" FORMAT "999":U WIDTH 5.43
      Di-RutaG.nroref COLUMN-LABEL "Correlativo" FORMAT "9999999":U
            WIDTH 13
      x-Moneda @ x-Moneda COLUMN-LABEL "Mon." FORMAT "x(3)":U
      fImporte() @ x-Importe COLUMN-LABEL "Importe Total" FORMAT "->>>,>>9.99":U
            WIDTH 13.14
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ", FIRST"
     _JoinCode[2]      = "Almcmov.CodCia = Di-RutaG.CodCia
  AND Almcmov.CodAlm = Di-RutaG.CodAlm
  AND Almcmov.TipMov = Di-RutaG.Tipmov
  AND Almcmov.CodMov = Di-RutaG.Codmov
  AND Almcmov.NroSer = Di-RutaG.serref
...
"Di-RutaG.serref" "Serie" ? "integer" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Di-RutaG.nroref
"Di-RutaG.nroref" "Correlativo" "9999999" "integer" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > "_<CALC>"
"x-Moneda @ x-Moneda" "Mon." "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"fImporte() @ x-Importe" "Importe Total" "->>>,>>9.99" ? ? ? ? ? ? ? no ? no no "13.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.Di-RutaG.HorLle
"Di-RutaG.HorLle" "Hora!Llegada" "XX:XX" "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.Di-RutaG.HorPar
"Di-RutaG.HorPar" "Hora!Partida" "XX:XX" "character" ? ? ? ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"fEstado() @ x-Estado" "Situacion" "x(15)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"fEstadoDet() @ x-Motivo" "Motivo" "x(20)" ? ? ? ? ? ? ? no ? no no "17.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
