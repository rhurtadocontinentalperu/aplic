...
&Scoped-Define ENABLED-OBJECTS RECT-2 BUTTON-9 
...
DEFINE FRAME F-Main
     BUTTON-9 AT ROW 1.19 COL 102 WIDGET-ID 4
     RECT-2 AT ROW 2.54 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 127.86 BY 23.08
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rut001 ).
       RUN set-position IN h_v-rut001 ( 2.73 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-dirutac ).
       RUN set-position IN h_q-dirutac ( 1.27 , 93.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.65 , 8.29 ) */

       /* Links to SmartViewer h_v-rut001. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_v-rut001 ).
       RUN add-link IN adm-broker-hdl ( h_q-dirutac , 'Record':U , h_v-rut001 ).
...
CASE p-State:
    ...
    WHEN 'pinta-viewer' THEN DO:
        RUN dispatch IN h_v-rut001 ('display-fields':U).
    END.
END CASE.              
