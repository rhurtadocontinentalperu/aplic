...
&Scoped-define INTERNAL-TABLES T-RutaD VtaCTabla

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table T-RutaD.Libre_c03 ~
VtaCTabla.Descripcion T-RutaD.CodRef T-RutaD.NroRef T-RutaD.Libre_c05 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH T-RutaD WHERE ~{&KEY-PHRASE} NO-LOCK, ~
 ...
 AND VtaCTabla.Tabla = s-tabla NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table T-RutaD VtaCTabla
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCTabla.Descripcion FORMAT "x(15)":U WIDTH 11.43
      T-RutaD.CodRef FORMAT "x(3)":U
      T-RutaD.NroRef FORMAT "X(12)":U WIDTH 12.57
      T-RutaD.Libre_c05 COLUMN-LABEL "Cliente" FORMAT "x(40)":U
            WIDTH 25.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 16.54
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Peso AT ROW 17.73 COL 9 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-Volumen AT ROW 17.73 COL 31 COLON-ALIGNED WIDGET-ID 6
...
"VtaCTabla.Descripcion" ? "x(15)" "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = Temp-Tables.T-RutaD.CodRef
     _FldNameList[4]   > Temp-Tables.T-RutaD.NroRef
"T-RutaD.NroRef" ? "X(12)" "character" ? ? ? ? ? ? no ? no no "12.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-RutaD.Libre_c05
"T-RutaD.Libre_c05" "Cliente" "x(40)" "character" ? ? ? ? ? ? no ? no no "25.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Pr-Baja B-table-Win 
PROCEDURE Pr-Baja :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
