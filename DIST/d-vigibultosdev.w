...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 58 BY 7.27 FIT-LAST-COLUMN.
...
DEFINE FRAME gDialog
     ...
     Btn_OK AT ROW 2.08 COL 61
     Btn_Cancel AT ROW 3.31 COL 61
     SPACE(1.28) SKIP(4.45)
