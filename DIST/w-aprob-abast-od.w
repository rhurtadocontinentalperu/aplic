...
&SCOPED-DEFINE Condicion FacCPedi.CodCia = s-cdocia ~
...
FacCPedi.FchPed FacCPedi.FlgEnv FacCPedi.CodCli FacCPedi.NomCli ~
FacCPedi.ImpTot 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.FlgEnv FORMAT "Si/No":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = INTEGRAL.FacCPedi.FlgEnv
