...
TORDENES.Campo-C[2] TORDENES.Campo-D[1] TORDENES.Campo-C[29] ~
TORDENES.Campo-D[2] TORDENES.Campo-C[10] TORDENES.Campo-C[5] ~
TORDENES.Campo-C[9] TORDENES.Campo-C[4] TORDENES.Campo-C[7] ~
TORDENES.Campo-C[8] 
...
DEFINE FRAME F-Main
     ...
     BROWSE-3 AT ROW 9.58 COL 96.57 WIDGET-ID 300
...
"NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = INTEGRAL.DI-RutaC.FchDoc
     _FldNameList[5]   > INTEGRAL.DI-RutaC.Libre_c01
"Libre_c01" "Hora" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.DI-RutaC.usuario
"usuario" "Usuario" ? "character" ? ? ? ? ? ? no ? no no "13.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-7 */
&ANALYZE-RESUME
...
FOR EACH PTOSDESPACHO WHERE PTOSDESPACHO.campo-l[1] = YES NO-LOCK:
    ...
    FOR EACH faccpedi WHERE faccpedi.codcia = s-codcia AND
            ...
            CREATE TORDENES.
                ...
                .
                RUN vta2/p-faccpedi-flgestv(INPUT faccpedi.flgest,
