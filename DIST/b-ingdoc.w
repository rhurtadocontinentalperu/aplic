...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      FIND LAST B-Docum USE-INDEX Llave02 WHERE B-Docum.codcia = s-codcia
          ...
          NO-LOCK NO-ERROR.
      IF AVAILABLE B-Docum AND B-Docum.TipMov = "I" THEN DO:
          MESSAGE 'El documento YA ha sido registrado el día' B-Docum.FchDoc
              VIEW-AS ALERT-BOX ERROR.
          UNDO, RETURN 'ADM-ERROR'.
      END.
      /* RHC 23.05.2011 debe estar registrado en una salida anterior */
      IF NOT AVAILABLE B-Docum OR B-Docum.TipMov <> "S" THEN DO:
          MESSAGE 'NO hay control de que el documento ha salido de alguna sede'
              VIEW-AS ALERT-BOX ERROR.
          UNDO, RETURN 'ADM-ERROR'.
      END.
      IF B-Docum.NroBul <> CntDocum.NroBul THEN DO:
          MESSAGE 'NO coinciden los bultos' VIEW-AS ALERT-BOX ERROR.
          UNDO, RETURN 'ADM-ERROR'.
      END.
      /* FIN DE FILTROS */
      ...
      ASSIGN
          cntdocum.codcli = B-Docum.codcli
          cntdocum.nomcli = B-Docum.nomcli
          cntdocum.oridoc = B-Docum.oridoc.
  END.
