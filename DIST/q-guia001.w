...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES CntDocum
&Scoped-define FIRST-EXTERNAL-TABLE CntDocum


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR CntDocum.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH DI-RutaC WHERE DI-RutaC.CodCia = CntDocum.CodCia ~
  AND DI-RutaC.CodDoc = ENTRY(1, CntDocum.OriDoc, '|') ~
  AND DI-RutaC.NroDoc = ENTRY(2, CntDocum.OriDoc, '|') NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH DI-RutaC WHERE DI-RutaC.CodCia = CntDocum.CodCia ~
  AND DI-RutaC.CodDoc = ENTRY(1, CntDocum.OriDoc, '|') ~
  AND DI-RutaC.NroDoc = ENTRY(2, CntDocum.OriDoc, '|') NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main DI-RutaC
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main DI-RutaC
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: INTEGRAL.CntDocum
   Allow: Basic,Query
   Frames: 1
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.DI-RutaC WHERE INTEGRAL.CntDocum ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "DI-RutaC.CodCia = CntDocum.CodCia
  AND DI-RutaC.CodDoc = ENTRY(1, CntDocum.OriDoc, '|')
  AND DI-RutaC.NroDoc = ENTRY(2, CntDocum.OriDoc, '|')"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "CntDocum"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "CntDocum"}
