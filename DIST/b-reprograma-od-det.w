...
FacDPedi.CanPed - FacDPedi.canate @ FacDPedi.Libre_d01 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.canate COLUMN-LABEL "Cantidad!Atendida" FORMAT ">,>>>,>>9.9999":U
            WIDTH 9.43
      FacDPedi.CanPed - FacDPedi.canate @ FacDPedi.Libre_d01 COLUMN-LABEL "Saldo"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 108 BY 9.96
         FONT 4
...
"FacDPedi.CanPed" "Cantidad!Pedida" ? "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacDPedi.canate
"FacDPedi.canate" "Cantidad!Atendida" ? "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"FacDPedi.CanPed - FacDPedi.canate @ FacDPedi.Libre_d01" "Saldo" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
