...
&Scoped-define QUERY-STRING-BROWSE-4 FOR EACH INTEGRAL.VtaCTabla ~
    ...
    BY INTEGRAL.VtaCTabla.Libre_f01 DESCENDING ~
       BY INTEGRAL.VtaCTabla.Libre_c03 DESCENDING INDEXED-REPOSITION
...
INTEGRAL.CcbCBult.NomCli INTEGRAL.VtaDTabla.Libre_c05 
...
BROWSE-4 BROWSE-6 btnGrabar BtnRefrescarRacks 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-6 wWin _STRUCTURED
  QUERY BROWSE-6 NO-LOCK DISPLAY
      ...
      INTEGRAL.CcbCBult.NomCli FORMAT "x(50)":U WIDTH 29.86
      INTEGRAL.VtaDTabla.Libre_c05 COLUMN-LABEL "H/R" FORMAT "x(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 100.29 BY 9.73 FIT-LAST-COLUMN.
...
DEFINE FRAME fMain
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 144.43 BY 26.38 WIDGET-ID 100.
...
ON END-ERROR OF wWin /* Despachando los RACKS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Despachando los RACKS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE txtCD btnAceptar txtCodRack BROWSE-2 BROWSE-4 BROWSE-6 btnGrabar 
         BtnRefrescarRacks 
      WITH FRAME fMain IN WINDOW wWin.
