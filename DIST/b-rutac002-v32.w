...
&Scoped-define QUERY-STRING-br_table FOR EACH DI-RutaC WHERE ~{&KEY-PHRASE} ~
 ...
 AND DI-RutaC.FlgEst = "PR"   /* CAMION RETORNO */ ~
 AND DI-RutaC.Libre_l01 = TRUE NO-LOCK ~
    BY DI-RutaC.Nomtra ~
...
/* Query rebuild information for BROWSE br_table
 ...
 AND INTEGRAL.DI-RutaC.FlgEst = ""PR""   /* CAMION RETORNO */
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    END.
END.
RUN dist/d-cierre-hr-v32 (x-HojasdeRuta).
