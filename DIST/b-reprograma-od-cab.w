...
ON ROW-DISPLAY OF br_table IN FRAME F-Main /* GRE - INACTIVA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-ENTRY OF br_table IN FRAME F-Main /* GRE - INACTIVA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* GRE - INACTIVA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON START-SEARCH OF br_table IN FRAME F-Main /* GRE - INACTIVA */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* GRE - INACTIVA */
DO:
...
END.
MESSAGE 'Guias Generadas:' SKIP pMensaje VIEW-AS ALERT-BOX INFORMATION.
/*MESSAGE 'Proceso Terminado' VIEW-AS ALERT-BOX INFORMATION.*/
