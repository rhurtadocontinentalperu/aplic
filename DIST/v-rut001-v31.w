...
DEF VAR s-Copia-Registro AS LOG INIT NO NO-UNDO.
...
&Scoped-Define ENABLED-FIELDS DI-RutaC.Libre_l01 DI-RutaC.FchSal ~
...
DI-RutaC.FchDoc DI-RutaC.FchSal DI-RutaC.KmtIni DI-RutaC.CodVeh ~
DI-RutaC.responsable DI-RutaC.ayudante-1 DI-RutaC.ayudante-2 ~
DI-RutaC.DesRut DI-RutaC.usuario DI-RutaC.TpoTra DI-RutaC.Libre_c01 ~
DI-RutaC.Libre_c05 DI-RutaC.Libre_f05 
&Scoped-define DISPLAYED-TABLES DI-RutaC
&Scoped-define FIRST-DISPLAYED-TABLE DI-RutaC
&Scoped-Define DISPLAYED-OBJECTS txtHora txtMinuto txtCodPro txtClieDol ~
txtNroClientes txtPtosAlmacen txtCargaMaxima FILL-IN-Marca FILL-IN-Estado ~
txtDTrans FILL-IN-Ayudante-1 FILL-IN-Ayudante-2 txtSerie txtNro txtTransp1 ~
txtTransp-2 txtTransp-3 txtTransp-4 txtTransp-5 txtClieSol txtTranDol ~
txtTranSol txtVolumen txtPeso txtVol txtConductor FILL-IN-Responsable 
...
DEFINE FRAME F-Main
     ...
     DI-RutaC.FchDoc AT ROW 1 COL 70 COLON-ALIGNED
          LABEL "Fecha Emision"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     txtHora AT ROW 1.81 COL 19.43 COLON-ALIGNED WIDGET-ID 2
     txtMinuto AT ROW 1.81 COL 26.29 COLON-ALIGNED WIDGET-ID 4
     DI-RutaC.FchSal AT ROW 1.81 COL 70 COLON-ALIGNED
          LABEL "Fecha Salida del Vehiculo"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     DI-RutaC.KmtIni AT ROW 2.62 COL 16 COLON-ALIGNED
          LABEL "Kilometraje de salida" FORMAT ">>>,>>9"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     DI-RutaC.CodVeh AT ROW 3.42 COL 16 COLON-ALIGNED
     ...
     DI-RutaC.usuario AT ROW 1.81 COL 90 COLON-ALIGNED
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 15 FGCOLOR 12 
     FILL-IN-Marca AT ROW 3.42 COL 25 COLON-ALIGNED NO-LABEL
     FILL-IN-Estado AT ROW 1 COL 90 COLON-ALIGNED
     DI-RutaC.TpoTra AT ROW 3.42 COL 51 NO-LABEL
...
"Externo", "02":U
     ...
     txtNro AT ROW 9.35 COL 107 COLON-ALIGNED WIDGET-ID 18
...
DEFINE FRAME F-Main
     ...
     DI-RutaC.Libre_c05 AT ROW 2.62 COL 90 COLON-ALIGNED WIDGET-ID 70
          LABEL "Modificado por" FORMAT "x(10)"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     DI-RutaC.Libre_f05 AT ROW 3.42 COL 90 COLON-ALIGNED WIDGET-ID 72
          LABEL "Día"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     "Empresas de Tranporte a la que Pertenece el Vehiculo" VIEW-AS TEXT
          ...
          FGCOLOR 1 
     "Salida :" VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 2 COL 13 WIDGET-ID 6
     "Detalle de la ruta:" VIEW-AS TEXT
          SIZE 12 BY .5 AT ROW 7.65 COL 6
     "Estado:" VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 3.62 COL 46
     "(formato de 24 horas)" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 1.92 COL 32.29
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Copia-Registro V-table-Win 
PROCEDURE Copia-Registro :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  /* Bloqueamos la cabecera y copiamos el detalle */
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      {lib/lock-genericov21.i &Tabla="B-DI-RutaC" ~
          &Condicion="B-DI-RutaC.CodCia = s-codcia ~
          AND B-DI-RutaC.CodDiv = s-coddiv ~
          AND B-DI-RutaC.CodDoc = s-coddoc ~
          AND B-DI-RutaC.NroDoc = cNroRef" ~
      ...
      ASSIGN
          B-DI-RutaC.flgest = 'A'
          B-DI-RutaC.Libre_f05 = TODAY
          B-DI-RutaC.Libre_c05 = s-user-id
          B-DI-RutaC.Libre_c04 = pGlosa.

      /* Copiamos el detalle */
      FOR EACH di-rutad OF B-DI-RutaC EXCLUSIVE-LOCK:
          CREATE B-DI-RutaD.
          ASSIGN
              B-DI-RutaD.CodCia = DI-RutaC.CodCia
              B-DI-RutaD.CodDiv = DI-RutaC.CodDiv
              B-DI-RutaD.CodDoc = DI-RutaC.CodDoc
              B-DI-RutaD.NroDoc = DI-RutaC.NroDoc
              B-DI-RutaD.CodRef = DI-RutaD.CodRef
              B-DI-RutaD.NroRef = DI-RutaD.NroRef
              B-DI-RutaD.Libre_c01 = DI-RutaD.Libre_c01
              B-DI-RutaD.Libre_d01 = DI-RutaD.Libre_d01
              B-DI-RutaD.libre_c05 = DI-RutaD.libre_c05.
          DELETE di-rutad.
      END.
      RELEASE B-DI-RutaD.

      FOR EACH di-rutag OF B-DI-RutaC EXCLUSIVE-LOCK:
          CREATE B-DI-RutaG.
          ASSIGN
              B-DI-RutaG.CodCia = DI-RutaC.CodCia
              B-DI-RutaG.CodDiv = DI-RutaC.CodDiv
              B-DI-RutaG.CodDoc = DI-RutaC.CodDoc
              B-DI-RutaG.NroDoc = DI-RutaC.NroDoc
              B-DI-RutaG.SerRef = DI-RutaG.SerRef
              B-DI-RutaG.NroRef = DI-RutaG.NroRef
              B-DI-RutaG.TipMov = DI-RutaG.TipMov
              B-DI-RutaG.CodMov = DI-RutaG.CodMov
              B-DI-RutaG.CodAlm = DI-RutaG.CodAlm
              B-DI-RutaG.Libre_d01 = DI-RutaG.Libre_d01
              B-DI-RutaG.Libre_d02 = DI-RutaG.Libre_d02
              B-DI-RutaG.Libre_d03 = DI-RutaG.Libre_d03.
          DELETE di-rutag.
      END.
      RELEASE B-DI-RutaG.

      FOR EACH di-rutadg OF B-DI-RutaC EXCLUSIVE-LOCK:
          CREATE B-DI-RutaDG.
          ASSIGN
              B-Di-RutaDG.CodCia = DI-RutaC.CodCia
              B-Di-RutaDG.CodDiv = DI-RutaC.CodDiv
              B-Di-RutaDG.CodDoc = DI-RutaC.CodDoc
              B-Di-RutaDG.NroDoc = DI-RutaC.NroDoc
              B-Di-RutaDG.CodRef = DI-RutaDG.CodRef
              B-Di-RutaDG.NroRef = DI-RutaDG.NroRef
              B-Di-RutaDG.CodAlm = DI-RutaDG.CodAlm
              B-Di-RutaDG.CodDes = DI-RutaDG.CodDes
              B-Di-RutaDG.Tipo   = DI-RutaDG.Tipo
              B-Di-RutaDG.TipDes = DI-RutaDG.TipDes
              B-Di-RutaDG.Glosa  = DI-RutaDG.Glosa.
          DELETE di-rutadg.
      END.
      RELEASE B-DI-RutaC.
  END.
...
/*
      {lib/lock-genericov21.i ~
          &Tabla='B-DI-RutaC' ~
          &Condicion='B-DI-RutaC.CodCia = s-codcia AND ~
          B-DI-RutaC.CodDiv = s-coddiv AND ~
          B-DI-RutaC.CodDoc = s-coddoc AND ~
          B-DI-RutaC.NroDoc = cNroRef' ~
          &Bloqueo='EXCLUSIVE-LOCK' ~
          &Mensaje='YES' ~
          &Accion='RETRY' ~
          &TipoError='UNDO, RETURN "ADM-ERROR"' ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Extorna-PreHoja V-table-Win 
...
------------------------------------------------------------------------------*/
  ...
  FIND LAST x-di-rutaC WHERE x-di-rutaC.codcia = s-codcia AND
                                x-di-rutaC.coddiv = s-coddiv AND 
                                x-di-rutaC.coddoc = 'H/R' AND 
                                x-di-rutaC.flgest = 'P' AND 
                                x-di-rutaC.libre_l01 = YES AND 
                                x-di-rutaC.fchdoc <= (TODAY - 3) NO-LOCK NO-ERROR.
  IF AVAILABLE x-di-rutaC THEN DO:
      MESSAGE 'Existen H/R pendientes de hace 3 dias por CERRAR'
...
------------------------------------------------------------------------------*/
  ...
  IF LOOKUP(DI-RutaC.FlgEst, 'C,A,L') > 0 THEN DO:
    ...
    RETURN 'ADM-ERROR'.
  END.
  MESSAGE 'Se va a ANULAR la Hoja de Ruta actual' SKIP
      'Continuamos con la COPIA?' VIEW-AS ALERT-BOX WARNING
  ...
  FIND FIRST FacCorre WHERE FacCorre.CodCia = S-CODCIA 
    ...
    NO-LOCK NO-ERROR.
  IF NOT AVAILABLE FacCorre THEN DO:
      MESSAGE 'No hay un correlativo para la division' s-coddiv VIEW-AS ALERT-BOX ERROR.
      RETURN 'ADM-ERROR'.
  END.
  x-NroDoc = STRING(FacCorre.NroSer, '999') + STRING(FacCorre.Correlativo, '999999').

  s-Copia-Registro = YES.
  cNroRef = DI-RutaC.NroDoc.
  ...
  DISPLAY 
      ...
      x-NroDoc @ DI-RutaC.NroDoc
      WITH FRAME {&FRAME-NAME}.
  DI-RutaC.Libre_l01:SCREEN-VALUE = 'NO'.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH DI-RutaD OF DI-RutaC NO-LOCK,
      ...
      IF NOT AVAILABLE ttTotales THEN DO:
          ...
          CASE GN-DIVI.CanalVenta:
              WHEN "INS" THEN DO:
                  ASSIGN x-INSDocs = x-INSDocs + 1 
                      x-INSImporte = x-INSImporte + FACTURA.ImpTot.
              END.
              WHEN "TDA" THEN DO:
                  ASSIGN x-TDADocs = x-TDADocs + 1 
                      x-TDAImporte = x-TDAImporte + FACTURA.ImpTot.
              END.
              WHEN "FER" THEN DO :
                  ASSIGN x-FERDocs = x-FERDocs + 1 
                      x-FERImporte = x-FERImporte + FACTURA.ImpTot.
              END.
              WHEN "MOD" THEN DO:
                  ASSIGN x-MODDocs = x-MODDocs + 1 
                      x-MODImporte = x-MODImporte + FACTURA.ImpTot.
              END.
              WHEN "PRO" THEN DO:  
                  ASSIGN x-PRODocs = x-PRODocs + 1 
                      x-PROImporte = x-PROImporte + FACTURA.ImpTot.
              END.
              WHEN "MIN" THEN DO: 
                  ASSIGN x-MINDocs = x-MINDocs + 1 
                      x-MINImporte = x-MINImporte + FACTURA.ImpTot.
              END.
              OTHERWISE DO:
                    ASSIGN x-OTROSDocs = x-OTROSDocs + 1 
                        x-OTROSImporte = x-OTROSImporte + FACTURA.ImpTot.
              END.
  ...
  /* Impresion de las G/R remision x transferencias */
...
/* Para sacar las referencias de CrossDocking de max ramos */
REPEAT:
...
DEFINE VAR x-crossdocking AS LOG.

FOR EACH x-di-rutaG OF di-rutaC NO-LOCK:
    FIND FIRST x-almcmov WHERE x-almcmov.codcia = x-di-rutaG.codcia AND 
                                x-almcmov.codalm = x-di-rutaG.codalm AND 
                                x-almcmov.tipmov = x-di-rutaG.tipmov AND
                                x-almcmov.codmov = x-di-rutaG.codmov AND
                                x-almcmov.nroser = x-di-rutaG.serref AND 
                                x-almcmov.nrodoc = x-di-rutaG.nroref NO-LOCK NO-ERROR.
    IF NOT AVAILABLE x-almcmov THEN NEXT.
    /**/
    FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = x-di-rutaG.codcia AND 
                                x-faccpedi.coddoc = x-almcmov.codref AND
                                x-faccpedi.nroped = x-almcmov.nroref NO-LOCK NO-ERROR.
    ...
    END.
    ELSE DO:
        IF x-faccpedi.crossdocking = NO AND x-faccpedi.tpoped = 'XD' THEN DO:
            x-crossdocking = YES.
        END.
    END.
    IF x-crossdocking = YES THEN DO:
        FIND FIRST w-report WHERE w-report.task-no = 99999999 AND 
                w-report.llave-c = x-almcmov.nroref EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE w-report THEN DO:
            CREATE w-report.
            ASSIGN  w-report.task-no = 99999999
                    w-report.llave-c = x-almcmov.nroref
                    w-report.llave-i = s-task-no
                    w-report.campo-c[1] = x-faccpedi.codref + " " + x-faccpedi.nroref
                .
        END.
    END.
END.
...
FOR EACH w-report WHERE w-report.task-no = 99999999 AND w-report.llave-i = s-task-no NO-LOCK:
