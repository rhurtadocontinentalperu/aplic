...
&Scoped-Define ENABLED-OBJECTS txtHora txtMinuto 
...
&Scoped-Define DISPLAYED-OBJECTS txtHora txtMinuto FILL-IN-Marca ~
FILL-IN-Estado FILL-IN-Responsable FILL-IN-Ayudante-1 FILL-IN-Ayudante-2 
...
DEFINE FRAME F-Main
     ...
     DI-RutaC.FchDoc AT ROW 1 COL 67 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     txtHora AT ROW 1.73 COL 26 COLON-ALIGNED WIDGET-ID 2
     txtMinuto AT ROW 1.73 COL 32.43 COLON-ALIGNED WIDGET-ID 4
     DI-RutaC.HorSal AT ROW 1.77 COL 16 COLON-ALIGNED
          LABEL "Hora de salida" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     ...
     FILL-IN-Estado AT ROW 3.42 COL 67 COLON-ALIGNED
...
"Externo", "02":U
     ...
     "(formato de 24 horas)" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 6.77 COL 79
     "Estado:" VIEW-AS TEXT
...
/*     IF AVAILABLE GN-COB THEN FILL-IN-Ayudante-2:SCREEN-VALUE = gn-cob.nomcob. */
    ...
    txtHora:SCREEN-VALUE = SUBSTRING(DI-RutaC.HorSal:SCREEN-VALUE, 1, 2).
    txtMinuto:SCREEN-VALUE = SUBSTRING(DI-RutaC.HorSal:SCREEN-VALUE, 3, 2).
