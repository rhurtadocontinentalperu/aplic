...
DEFINE VARIABLE h_q-cfg-cal-log-base AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'LABEL-FONT = 4,
                     ...
                     LABELS = Zona Geográfica PRE-HOJA RUTA|Capacidad|Programación Despachos|Canales de Venta|Programación por Canal|Estados válidos':U ,
             OUTPUT h_tab95 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_v-cfg-cal-log-base ( 2.62 , 5.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97-3 ).
       RUN set-position IN h_p-updv97-3 ( 5.85 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cfg-skuxcd-v3 ( 8.81 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 23.08 , 3.00 ) NO-ERROR.
       RUN set-size IN h_p-updv10 ( 1.42 , 41.72 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/dist/q-cfg-cal-log-base.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-cfg-cal-log-base ).
       RUN set-position IN h_q-cfg-cal-log-base ( 2.62 , 67.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cfg-cal-log-base , 'Record':U , h_v-cfg-cal-log-base ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'dist/b-subzonahrxdia-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-subzonahrxdia-v3 ).
       RUN set-position IN h_b-subzonahrxdia-v3 ( 10.96 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-subzonahrxdia-v3 ( 13.46 , 96.00 ) NO-ERROR.
