...
DEFINE VARIABLE h_b-rutac002-v4 AS HANDLE NO-UNDO.
...
*/
  RUN Cierre-Hoja IN h_b-rutac002-v4.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'DIST/b-rutac002-v4.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rutac002-v4 ).
       RUN set-position IN h_b-rutac002-v4 ( 1.19 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rutac002-v4 ( 6.92 , 106.00 ) NO-ERROR.
       ...
       RUN set-size IN h_folder ( 11.85 , 129.00 ) NO-ERROR.

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rutac002-v4 ,
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v4 , 'Record':U , h_b-rut002a-01 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v4 , 'Record':U , h_b-rut002d ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v4 , 'Record':U , h_b-rut002e ).
