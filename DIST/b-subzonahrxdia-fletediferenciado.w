...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-FacTabla.Campo-L[1] COLUMN-LABEL "Domingo" FORMAT "yes/no":U
            WIDTH 8.29 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14 VIEW-AS TOGGLE-BOX
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 13.46
...
"Temp-Tables.T-FacTabla.Campo-L[1]" "Domingo" ? "logical" 14 0 ? ? ? ? yes ? no no "8.29" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-FacTabla.Campo-L[2]
"Temp-Tables.T-FacTabla.Campo-L[2]" "Lunes" ? "logical" ? ? ? ? ? ? yes ? no no "8.29" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
...
"Temp-Tables.T-FacTabla.Campo-L[4]" "Miércoles" ? "logical" ? ? ? ? ? ? yes ? no no "9.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
...
"Temp-Tables.T-FacTabla.Campo-L[7]" "Sábado" ? "logical" 14 0 ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
