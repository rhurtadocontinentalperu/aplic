...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-FacTabla.Campo-L[7] COLUMN-LABEL "Sábado" FORMAT "yes/no":U
            WIDTH .57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14 VIEW-AS TOGGLE-BOX
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 97 BY 15.08
...
"T-FacTabla.Campo-L[2]" "Lunes" ? "logical" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
...
"T-FacTabla.Campo-L[4]" "Miércoles" ? "logical" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
...
"T-FacTabla.Campo-L[7]" "Sábado" ? "logical" 14 0 ? ? ? ? yes ? no no ".57" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
