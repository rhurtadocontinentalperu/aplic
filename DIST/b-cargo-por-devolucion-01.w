...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DI-RutaD.NroRef FORMAT "X(9)":U WIDTH 8.86
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 143.72 BY 9.42
...
"DI-RutaD.NroRef" ? ? "character" ? ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fEstado() @ x-Estado" "Situacion" "x(50)" ? ? ? ? ? ? ? no ? no no "44.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"fEstadoDet() @ x-Motivo" "Motivo" "x(40)" ? ? ? ? ? ? ? no ? no no "37.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
