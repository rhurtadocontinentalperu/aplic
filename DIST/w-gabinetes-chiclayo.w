...
&Scoped-Define ENABLED-OBJECTS txtGabinete btn 
&Scoped-Define DISPLAYED-OBJECTS txtGabinete 
...
DEFINE VARIABLE txtGabinete AS CHARACTER FORMAT "X(25)":U 
     LABEL "Codigo de gabinete" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fMain
     txtGabinete AT ROW 2.62 COL 21 COLON-ALIGNED WIDGET-ID 8
     btn AT ROW 4.81 COL 26 WIDGET-ID 4
...
PUT STREAM REPORTE '^FO60,30^BY3'                      SKIP.   /* Coordenadas de origen barras */
/*PUT STREAM REPORTE '^BY2^BCR,80,Y,N,N'         SKIP.   /* Codigo 128 */*/
/*PUT STREAM REPORTE '^BY3^BCN,100,Y,N,N'        SKIP.   /* Codigo 128 */*/
PUT STREAM REPORTE '^B3N,N,100,Y,N'        SKIP.   /* Codigo 128 */
PUT STREAM REPORTE '^FD'.
PUT STREAM REPORTE p-codbarra  SKIP.
/*
IF x-Tipo = 1 THEN DO:
    PUT STREAM REPORTE '^FD'.
