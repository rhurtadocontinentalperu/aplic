...
&Scoped-Define ENABLED-FIELDS DI-RutaC.Observ 
...
DI-RutaC.Observ DI-RutaC.usuario DI-RutaC.Libre_c05 DI-RutaC.Libre_f05 
...
DEFINE FRAME F-Main
     DI-RutaC.NroDoc AT ROW 1.27 COL 14 COLON-ALIGNED WIDGET-ID 20
          LABEL "N° Pre-Hoja"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     DI-RutaC.FchDoc AT ROW 1.27 COL 69 COLON-ALIGNED WIDGET-ID 18
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     DI-RutaC.Observ AT ROW 2.08 COL 14 COLON-ALIGNED WIDGET-ID 22
          VIEW-AS FILL-IN 
          SIZE 44.29 BY .81
     DI-RutaC.usuario AT ROW 2.08 COL 69 COLON-ALIGNED WIDGET-ID 24
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FILL-IN-Estado AT ROW 2.88 COL 14 COLON-ALIGNED WIDGET-ID 74
     DI-RutaC.Libre_c05 AT ROW 2.88 COL 69 COLON-ALIGNED WIDGET-ID 70
          LABEL "Modificado por" FORMAT "x(10)"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     DI-RutaC.Libre_f05 AT ROW 3.69 COL 69 COLON-ALIGNED WIDGET-ID 72
          LABEL "Día"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
