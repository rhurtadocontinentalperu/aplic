...
DEFINE VARIABLE h_b-rutac002-v32 AS HANDLE NO-UNDO.
...
*/
  RUN Cierre-Hoja IN h_b-rutac002-v32.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'DIST/b-rutac002-v32.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rutac002-v32 ).
       RUN set-position IN h_b-rutac002-v32 ( 1.19 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rutac002-v32 ( 6.92 , 106.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rutac002-v32 ,
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v32 , 'Record':U , h_b-rut002a-01 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v32 , 'Record':U , h_b-rut002d ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rutac002-v32 , 'Record':U , h_b-rut002e ).
