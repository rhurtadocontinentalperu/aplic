...
DEF VAR X-CodDoc   AS CHAR INIT "O/D".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacCPedi.NroPed COLUMN-LABEL "N° Orden" FORMAT "X(9)":U WIDTH 11.43
      FacCPedi.NomCli COLUMN-LABEL "Cliente" FORMAT "x(60)":U
...
"NroPed" "N° Orden" ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacCPedi.NomCli
"NomCli" "Cliente" "x(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
