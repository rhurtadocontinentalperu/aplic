...
FacCPedi.ImpTot FacCPedi.Glosa 
...
"FacCPedi.FchEnt" "Fch.Entrega" ? "date" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.NomCli" "Nombre o Razón Social" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = INTEGRAL.FacCPedi.ImpTot
     _FldNameList[8]   = INTEGRAL.FacCPedi.Glosa
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      {lib\lock-genericov21.i &Tabla="B-CPedi" ~
        ...
        END.
        IF x-Tipo = -1 THEN B-CPedi.FlgEst = "G".     /* Generado */
...
------------------------------------------------------------------------------*/
    ...
    IF NOT ( {&Condicion} ) THEN DO:
        MESSAGE 'La Orden YA NO se encuentra pendiente de aprobación'
    ...
    RUN vtagn/pTracking-04 (Faccpedi.CodCia,
                            ...
                            Faccpedi.NroRef,
                            s-User-Id,
                            'AOTWL',    /* Aprobación OTR x Logistica */
                            'P',
