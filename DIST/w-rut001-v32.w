...
DEFINE VARIABLE h_v-rut001-v32 AS HANDLE NO-UNDO.
...
DO:
  RUN dispatch IN h_v-rut001-v32 ('um-imprimir-hoja-de-atencion':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'dist/v-rut001-v32.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rut001-v32 ).
       RUN set-position IN h_v-rut001-v32 ( 2.73 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-rut001-v32. */
       RUN add-link IN adm-broker-hdl ( h_p-updv04 , 'TableIO':U , h_v-rut001-v32 ).
       RUN add-link IN adm-broker-hdl ( h_q-dirutac , 'Record':U , h_v-rut001-v32 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv04 ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rut001-v32 ,
             h_p-updv04 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_v-rut001-v32 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
...
/*         .                                          */
    ...
    IF Di-RutaC.FlgEst <> "P" THEN DO:
        ...
        UNDO, LEAVE.
    END.
    /* Control de Origen de la H/R */
    s-HR-Manual = NO.        /* Ingreso POR PRE-HR */
END.
...
CASE p-State:
    ...
    WHEN 'pinta-viewer' THEN DO:
        RUN dispatch IN h_v-rut001-v32 ('display-fields':U).
    END.
