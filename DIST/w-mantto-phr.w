...
&Scoped-Define ENABLED-OBJECTS BUTTON-Print 
...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 144.29 BY 24.92 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/dist/b-mantto-phr-cab.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = NroDoc':U ,
             OUTPUT h_b-mantto-phr-cab ).
       RUN set-position IN h_b-mantto-phr-cab ( 1.27 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-mantto-phr-cab ( 9.65 , 140.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/dist/b-mantto-phr-det.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-mantto-phr-det ).
       RUN set-position IN h_b-mantto-phr-det ( 11.23 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-mantto-phr-det ( 14.00 , 140.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-mantto-phr-det ).
