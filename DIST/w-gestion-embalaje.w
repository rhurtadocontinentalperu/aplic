...
&Scoped-define INTERNAL-TABLES ChkTareas FacCPedi FacDPedi Almmmatg
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-15 FacDPedi.NroItm FacDPedi.codmat ~
Almmmatg.DesMat Almmmatg.DesMar 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-15 
&Scoped-define QUERY-STRING-BROWSE-15 FOR EACH FacDPedi ~
      WHERE {&CONDICION} NO-LOCK, ~
      EACH Almmmatg OF FacDPedi NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-15 OPEN QUERY BROWSE-15 FOR EACH FacDPedi ~
      WHERE {&CONDICION} NO-LOCK, ~
      EACH Almmmatg OF FacDPedi NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-15 FacDPedi Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-15 FacDPedi
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-15 W-Win _STRUCTURED
  QUERY BROWSE-15 NO-LOCK DISPLAY
      FacDPedi.NroItm FORMAT ">>9":U COLUMN-FONT 0
      FacDPedi.codmat COLUMN-LABEL "Codigo" FORMAT "X(6)":U WIDTH 8.29
            COLUMN-FONT 0
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 37.72 COLUMN-FONT 0
...
DEFINE FRAME F-Main
     ...
     "DoubleClick en Orden - Cerrar EMBALADO" VIEW-AS TEXT
          SIZE 40.43 BY .96 AT ROW 13.04 COL 89.57 WIDGET-ID 4
          FGCOLOR 9 FONT 11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 131.14 BY 22.62 WIDGET-ID 100.
...
"tiempo-observado(chktareas.fechainicio, chktareas.horainicio) @ x-tiempo-observado-col" "Hora Terminado" "x(25)" ? ? ? 0 ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-14 */
&ANALYZE-RESUME
...
"FacDPedi.NroItm" ? ? "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacDPedi.codmat
"FacDPedi.codmat" "Codigo" ? "character" ? ? 0 ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMat
"Almmmatg.DesMat" ? ? "character" ? ? 0 ? ? ? no ? no no "37.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" ? "character" ? ? 0 ? ? ? no ? no no "25.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-15 */
&ANALYZE-RESUME
...
DO TRANSACTION ON ERROR UNDO, LEAVE:
  DO:
    x-procesoOk = "Actualizar la orden como observada (PC)". 
