    ...
    CASE TRUE:
        WHEN faccpedi.codref = 'PED' OR faccpedi.codref = 'P/M' THEN DO:
            ...
            FOR EACH ccbcdocu NO-LOCK WHERE ccbcdocu.codcia = s-codcia AND 
                ccbcdocu.codped = x-codpedido AND ccbcdocu.nroped = x-nropedido:
                IF ccbcdocu.coddoc = 'G/R' AND 
                    ccbcdocu.libre_c01 = pCodDoc AND 
                    ccbcdocu.libre_c02 = pNroDoc AND 
                    Ccbcdocu.flgest = "F" THEN DO:
        ...
        WHEN faccpedi.codref = 'R/A' OR (faccpedi.coddoc = 'OTR' AND faccpedi.codref = 'OPEN') THEN DO:
            ...
            FOR EACH almcmov NO-LOCK WHERE almcmov.codcia = s-codcia
                AND almcmov.codref = pCodDoc
                AND almcmov.nroref = pNroDoc:
                IF NOT (almcmov.tipmov = s-tipmov AND almcmov.codmov = s-codmov AND Almcmov.flgest <> "A") THEN NEXT.
