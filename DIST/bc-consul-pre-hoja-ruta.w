...
DI-RutaC.usuario DI-RutaC.Observ 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DI-RutaC.usuario FORMAT "x(10)":U WIDTH 10.72
      DI-RutaC.Observ COLUMN-LABEL "Glosa" FORMAT "x(60)":U WIDTH 29.43
  ENABLE
      DI-RutaC.Observ
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"usuario" ? ? "character" ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.DI-RutaC.Observ
"Observ" "Glosa" ? "character" ? ? ? ? ? ? yes ? no no "29.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
