...
&Scoped-define FIELDS-IN-QUERY-br_table T-FacTabla.Codigo T-FacTabla.Nombre ~
...
T-FacTabla.Campo-L[6] T-FacTabla.Campo-L[7] T-FacTabla.Campo-L[1] 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH T-FacTabla WHERE TRUE /* Join to GN-DIVI incomplete */ NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table T-FacTabla
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      T-FacTabla.Codigo FORMAT "x(8)":U WIDTH 8.43
      T-FacTabla.Nombre FORMAT "x(30)":U WIDTH 30.43
      ...
      T-FacTabla.Campo-L[7] COLUMN-LABEL "Sábado" FORMAT "yes/no":U
            WIDTH 6.86 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14 VIEW-AS TOGGLE-BOX
      T-FacTabla.Campo-L[1] COLUMN-LABEL "Domingo" FORMAT "yes/no":U
            WIDTH 7.29 COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 12 VIEW-AS TOGGLE-BOX
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 23.08
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.T-FacTabla Where INTEGRAL.GN-DIVI ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > Temp-Tables.T-FacTabla.Codigo
"Codigo" ? ? "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-FacTabla.Nombre
"Nombre" ? "x(30)" "character" ? ? ? ? ? ? no ? no no "30.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-FacTabla.Campo-L[2]
"Campo-L[2]" "Lunes" ? "logical" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-FacTabla.Campo-L[3]
"Campo-L[3]" "Martes" ? "logical" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-FacTabla.Campo-L[4]
"Campo-L[4]" "Miércoles" ? "logical" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-FacTabla.Campo-L[5]
"Campo-L[5]" "Jueves" ? "logical" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-FacTabla.Campo-L[6]
"Campo-L[6]" "Viernes" ? "logical" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-FacTabla.Campo-L[7]
"Campo-L[7]" "Sábado" ? "logical" 14 0 ? ? ? ? yes ? no no "6.86" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-FacTabla.Campo-L[1]
"Campo-L[1]" "Domingo" ? "logical" 12 15 ? ? ? ? yes ? no no "7.29" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
...
FOR EACH Almtabla NO-LOCK WHERE almtabla.Tabla = "CP":
    ...
    ASSIGN
        ...
        T-FacTabla.Codigo = Almtabla.Codigo
        T-FacTabla.Nombre = Almtabla.Nombre.
END.
FOR EACH T-FacTabla:
