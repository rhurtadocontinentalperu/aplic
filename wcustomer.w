...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'aplic/dcustomer.wDB-AWARE':U ,
             ...
             OUTPUT h_dcustomer ).
       RUN repositionObject IN h_dcustomer ( 1.54 , 71.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */

       RUN constructObject (
             INPUT  'aplic/vcustomer.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vcustomer ).
       RUN repositionObject IN h_vcustomer ( 5.58 , 5.00 ) NO-ERROR.
       /* Size in AB:  ( 6.00 , 64.43 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_pnavico ).
       RUN repositionObject IN h_pnavico ( 1.00 , 2.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_pupdsav ).
       RUN repositionObject IN h_pupdsav ( 2.88 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_pupdsav ( 1.77 , 65.57 ) NO-ERROR.

       /* Links to SmartDataObject h_dcustomer. */
       RUN addLink ( h_pnavico , 'Navigation':U , h_dcustomer ).
       ...
       RUN addLink ( h_pupdsav , 'TableIO':U , h_vcustomer ).
