...
DEFINE FRAME F-Main
     ...
     Almmmatg.DtoVolR[1] AT ROW 4.19 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[1] AT ROW 4.19 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[2] AT ROW 5.04 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[2] AT ROW 5.04 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[3] AT ROW 5.85 COL 3.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[3] AT ROW 5.85 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[4] AT ROW 6.65 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[4] AT ROW 6.65 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[5] AT ROW 7.46 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[5] AT ROW 7.46 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[6] AT ROW 8.27 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[6] AT ROW 8.27 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[7] AT ROW 9.08 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[7] AT ROW 9.08 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[8] AT ROW 9.88 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[8] AT ROW 9.88 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     Almmmatg.DtoVolR[9] AT ROW 10.69 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[9] AT ROW 10.69 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
...
DEFINE FRAME F-Main
     ...
     Almmmatg.DtoVolR[10] AT ROW 11.58 COL 3.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[10] AT ROW 11.58 COL 17.72 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
...
DO WITH FRAME {&FRAME-NAME} :
    ASSIGN
        x-Precio[01] = DECIMAL(f-Precio-1:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[02] = DECIMAL(f-Precio-2:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[03] = DECIMAL(f-Precio-3:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[04] = DECIMAL(f-Precio-4:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[05] = DECIMAL(f-Precio-5:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[06] = DECIMAL(f-Precio-6:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[07] = DECIMAL(f-Precio-7:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[08] = DECIMAL(f-Precio-8:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[09] = DECIMAL(f-Precio-9:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        x-Precio[10] = DECIMAL(f-Precio-10:SCREEN-VALUE IN FRAME {&FRAME-NAME}).
    DO x-Orden = 1 TO 10:
        IF INPUT Almmmatg.DtoVolR[x-Orden] <= 0 THEN NEXT.
        IF x-ValorAnterior = 0 THEN x-ValorAnterior = Almmmatg.DtoVolR[x-Orden].
