...
DEFINE FRAME F-Main
     ...
     Almmmatg.codmat AT ROW 2.35 COL 1.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 8.29 BY .69
          BGCOLOR 15 FGCOLOR 1 
     Almmmatg.UndBas AT ROW 2.35 COL 18.43 COLON-ALIGNED NO-LABEL FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .69
          BGCOLOR 15 FGCOLOR 1 
     Almmmatg.DesMat AT ROW 3.19 COL 1.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 40.57 BY .69
          BGCOLOR 15 FGCOLOR 1 
     Almmmatg.DtoVolR[1] AT ROW 5.08 COL 3.57 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[1] AT ROW 5.08 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-1 AT ROW 5.08 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[2] AT ROW 5.92 COL 3.57 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[2] AT ROW 5.92 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-2 AT ROW 5.92 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[3] AT ROW 6.73 COL 3.57 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[3] AT ROW 6.73 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-3 AT ROW 6.73 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[4] AT ROW 7.54 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[4] AT ROW 7.54 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-4 AT ROW 7.54 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[5] AT ROW 8.35 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[5] AT ROW 8.35 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-5 AT ROW 8.35 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[6] AT ROW 9.15 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[6] AT ROW 9.15 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-6 AT ROW 9.15 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[7] AT ROW 9.96 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[7] AT ROW 9.96 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-7 AT ROW 9.96 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[8] AT ROW 10.77 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[8] AT ROW 10.77 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-8 AT ROW 10.77 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[9] AT ROW 11.58 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[9] AT ROW 11.58 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
...
DEFINE FRAME F-Main
     F-PRECIO-9 AT ROW 11.58 COL 28.29 COLON-ALIGNED NO-LABEL
     Almmmatg.DtoVolR[10] AT ROW 12.46 COL 3.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     Almmmatg.DtoVolD[10] AT ROW 12.46 COL 18 COLON-ALIGNED NO-LABEL FORMAT "->>9.9999"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     F-PRECIO-10 AT ROW 12.46 COL 28.29 COLON-ALIGNED NO-LABEL
     "Visualizar en:" VIEW-AS TEXT
          SIZE 10 BY .62 AT ROW 1.27 COL 4 WIDGET-ID 6
     "Cantidad Minima" VIEW-AS TEXT
          SIZE 11.14 BY .5 AT ROW 4.15 COL 5.43
     "Precio" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 4.15 COL 31.57
     "Descuento %" VIEW-AS TEXT
          SIZE 10.86 BY .5 AT ROW 4.15 COL 18.86
     RECT-10 AT ROW 4 COL 3
     RECT-13 AT ROW 4.04 COL 3.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* SETTINGS FOR FILL-IN Almmmatg.DesMat IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[10] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[1] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[2] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[3] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[4] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[5] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[6] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[7] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[8] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Almmmatg.DtoVolD[9] IN FRAME F-Main
   EXP-FORMAT                                                           */
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[1]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[1]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[1]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[1]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[10]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[10]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[10]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[2]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[2]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[2]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[2]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[3]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[3]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[3]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[4]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[4]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[4]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[5]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[5]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[5]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[6]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[6]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[6]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[7]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[7]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[7]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[8]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[8]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[8]:SCREEN-VALUE = '0'.
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[9]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / F-PRECIO ) * 100, 4 ) ).
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN ASSIGN Almmmatg.DtoVolR[9]:SCREEN-VALUE = '0' Almmmatg.DtoVolD[9]:SCREEN-VALUE = '0'.
 END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Almmmatg THEN DO WITH FRAME {&FRAME-NAME}:
      /* TODO EN SOLES */
      F-PRECIO = fPreVta(Almmmatg.Prevta[1], RADIO-SET_Moneda).
