...
"VtaDctoProm.Descuento" "Descuento (%)" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/* RUN Margen-de-Utilidad (INPUT VtaDctoProm.CodDiv:SCREEN-VALUE IN BROWSE {&browse-name},          */
/*                         INPUT FILL-IN-CodMat,                                                    */
/*                         INPUT DECIMAL(VtaDctoProm.Precio:SCREEN-VALUE IN BROWSE {&browse-name}), */
/*                         INPUT FILL-IN-UndBas:SCREEN-VALUE IN FRAME {&FRAME-NAME},                */
/*                         INPUT 1,                                                                 */
