...
DEFINE VARIABLE h_v-listas-import-dctovol AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-listas-import-dctovol ( 2.92 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-listas-import-dctovol ( 19.04 , 108.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'PRI/v-listas-import-dctovol.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-listas-import-dctovol ).
       RUN set-position IN h_v-listas-import-dctovol ( 3.15 , 110.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-listas-import-dctovol. */
       RUN add-link IN adm-broker-hdl ( h_b-listas-import-dctovol , 'Record':U , h_v-listas-import-dctovol ).
       RUN add-link IN adm-broker-hdl ( h_p-updv97 , 'TableIO':U , h_v-listas-import-dctovol ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-listas-import-dctovol ,
             BUTTON-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-listas-import-dctovol ,
             h_b-listas-import-dctovol , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv97 ,
             h_v-listas-import-dctovol , 'AFTER':U ).
    END. /* Page 0 */
