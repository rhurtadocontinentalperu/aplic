...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Moneda COLUMN-LABEL "Mon" FORMAT "x(3)":U
            WIDTH 3.57
      T-MATG.CtoTot COLUMN-LABEL "Costo Tota" FORMAT ">>>,>>9.9999":U
      T-MATG.Prevta[1] COLUMN-LABEL "Precio Lista" FORMAT ">>>,>>9.9999":U
            WIDTH 7.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 87 BY 19.04
...
"T-MATG.CtoTot" "Costo Tota" ">>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-MATG.Prevta[1]
"T-MATG.Prevta[1]" "Precio Lista" ">>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
