...
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}:
    ...
    /* ******************************************************************************************** */
    IF RADIO-SET-Vigente = YES THEN DO:
        EMPTY TEMP-TABLE T-DPROM2.
        FOR EACH T-DPROM EXCLUSIVE-LOCK:
            IF TODAY >= T-DPROM.FchIni AND TODAY <= T-DPROM.FchFin THEN DO:
                CREATE T-DPROM2.
                BUFFER-COPY T-DPROM TO T-DPROM2.
            END.
            DELETE T-DPROM.
        END.
        EMPTY TEMP-TABLE T-DPROM.
