...
DEF VAR s-Tipo AS CHAR INIT "SKU" NO-UNDO.
...
Almmmatg.DesMat VtaDTabla.Libre_d01 fLog() @ x-Log 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDTabla.LlaveDetalle COLUMN-LABEL "Artículo" FORMAT "x(15)":U
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 111 BY 6.69
         FONT 4
         TITLE "EXCLUSIONES POR ARTICULO".
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaDTabla WHERE INTEGRAL.FacTabla <external> ...,INTEGRAL.Almmmatg WHERE INTEGRAL.VtaDTabla ..."
...
"VtaDTabla.LlaveDetalle" "Artículo" "x(15)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* EXCLUSIONES POR ARTICULO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* EXCLUSIONES POR ARTICULO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* EXCLUSIONES POR ARTICULO */
DO:
...
IF RETURN-VALUE = "YES" THEN DO:
    ...
    IF CAN-FIND(FIRST b-vtadtabla WHERE b-vtadtabla.codcia = s-codcia AND
                ...
                b-vtadtabla.llavedetalle = VtaDTabla.LlaveDetalle:SCREEN-VALUE IN BROWSE {&browse-name} 
                NO-LOCK)
        THEN DO:
