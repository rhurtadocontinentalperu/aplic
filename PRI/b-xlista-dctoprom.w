...
VtaDctoProm.FchFin VtaDctoProm.Descuento VtaDctoProm.Precio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDctoProm.Descuento FORMAT ">>>,>>9.999999":U
      VtaDctoProm.Precio COLUMN-LABEL "Precio S/." FORMAT ">>>,>>9.9999":U
      fPreVta(VtaDctoProm.Precio,2)  @ x-Precio COLUMN-LABEL "Precio US$" FORMAT ">>>,>>9.9999":U
  ENABLE
      VtaDctoProm.FchIni
      VtaDctoProm.FchFin
...
"VtaDctoProm.Descuento" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaDctoProm.Precio
"VtaDctoProm.Precio" "Precio S/." ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"fPreVta(VtaDctoProm.Precio,2)  @ x-Precio" "Precio US$" ">>>,>>9.9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF VtaDctoProm.Precio IN BROWSE br_table /* Precio S/. */
DO:
