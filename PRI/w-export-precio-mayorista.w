...
ASSIGN
    ...
    chWorkSheet:Range("E2"):Value = "MONEDA LP"
    chWorkSheet:Range("F2"):Value = "TC"
    chWorkSheet:Range("G2"):Value = "COSTO"
    chWorkSheet:Range("H2"):Value = "PRECIO LISTA"
    chWorkSheet:Range("I2"):Value = "MARGEN A"
    chWorkSheet:Range("J2"):Value = "PRECIO A"
    chWorkSheet:Range("K2"):Value = "UNIDAD A"
    chWorkSheet:Range("L2"):Value = "MARGEN B"
    chWorkSheet:Range("M2"):Value = "PRECIO B"
    chWorkSheet:Range("N2"):Value = "UNIDAD B"
    chWorkSheet:Range("O2"):Value = "MARGEN C"
    chWorkSheet:Range("P2"):Value = "PRECIO C"
    chWorkSheet:Range("Q2"):Value = "UNIDAD C"
    chWorkSheet:Range("R2"):Value = "MARGEN OFICINA"
    chWorkSheet:Range("S2"):Value = "PRECIO OFICINA"
    chWorkSheet:Range("T2"):Value = "UNIDAD OFICINA"
    chWorkSheet:Range("U2"):Value = "MONEDA LP"
    chWorkSheet:Range("V2"):Value = "LISTA"
    chWorkSheet:Range("W2"):Value = "A"
    chWorkSheet:Range("X2"):Value = "B"
    chWorkSheet:Range("Y2"):Value = "C"
    chWorkSheet:Range("Z2"):Value = "MARCA"
    chWorkSheet:Range("AA2"):Value = "CLASIFICACION"
    chWorkSheet:Range("AB2"):Value = "PROVEEDOR"
    chWorkSheet:Range("AC2"):VALUE = "FLETE".
chWorkSheet:Columns("U:Y"):Interior:ColorIndex = 6.
...
ASSIGN
    ...
    chWorkSheet:Range("F2"):Value = "TC"
    chWorkSheet:Range("G2"):Value = "COSTO"
    chWorkSheet:Range("H2"):Value = "PRECIO UTILEX"
...
ASSIGN
    ...
    chWorkSheet:Range("F2"):Value = "TC"
    chWorkSheet:Range("G2"):Value = "COSTO"
    chWorkSheet:Range("H2"):Value = "PRECIO OFICINA"
    chWorkSheet:Range("I2"):Value = "UNIDAD".
    chWorkSheet:Range("J2"):Value = "MEJOR PRECIO".
...
ASSIGN
    ...
    chWorkSheet:Columns("D"):NumberFormat = "@"
    chWorkSheet:Range("E2"):Value = "MONEDA LP"
    chWorkSheet:Range("F2"):Value = "UNIDAD VENTA"
    chWorkSheet:Range("G2"):Value = "PRECIO VENTA"
    chWorkSheet:Range("H2"):Value = "MONEDA COSTO"
    chWorkSheet:Range("I2"):Value = "TC VENTA"
    chWorkSheet:Range("J2"):Value = "COSTO MARCO".
ASSIGN
    t-Row = 2.
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}, FIRST Almtfami OF Almmmatg NO-LOCK, Almsfami OF Almmmatg NO-LOCK:
    ASSIGN
        ...
        x-MonVta = (IF Almmmatg.MonVta = 1 THEN "S/." ELSE "US$").
    /* PRECIO UNITARIO */
    ...
    END.
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas
        AND Almtconv.Codalter = x-UndVta
        NO-LOCK NO-ERROR.
    IF AVAILABLE Almtconv THEN F-FACTOR = Almtconv.Equival.
    x-CtoTot = x-Ctotot * f-Factor.
    ASSIGN
...
ASSIGN
    chWorkSheet:Range("A1"):Value = "REMATE - PRECIOS"
    chWorkSheet:Range("A2"):Value = "CODIGO"
    chWorkSheet:Columns("A"):NumberFormat = "@"
    chWorkSheet:Range("B2"):Value = "DESCRIPCION"
    chWorkSheet:Range("C2"):Value = "LINEA"
    ...
    chWorkSheet:Range("J2"):Value = "COSTO".
ASSIGN
    t-Row = 2.
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}, FIRST Almtfami OF Almmmatg NO-LOCK, Almsfami OF Almmmatg NO-LOCK:
    ...
    /* PRECIO UNITARIO */
    x-PreOfi = (IF AVAILABLE VtaTabla THEN VtaTabla.Valor[1] ELSE 0).   /* A la MonVta */
    x-CtoTot = Almmmatg.CtoTot.
    x-UndVta = Almmmatg.CHR__01.
    x-MonVta = (IF Almmmatg.MonVta = 1 THEN 'S/.' ELSE 'US$').
    FIND Almtconv WHERE Almtconv.CodUnid  = Almmmatg.UndBas 
