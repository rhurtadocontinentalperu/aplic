...
DEFINE VAR x-tabla AS CHAR INIT "AR-FRACCION-ACTIVA".
DEFINE VAR x-tabla-VTAS AS CHAR INIT "AR-VTA-FRACCION".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "Cod!Articulo" FORMAT "x(8)":U
            WIDTH 6.86 LABEL-FGCOLOR 4 LABEL-BGCOLOR 6 LABEL-FONT 6
      ...
      FacTabla.Campo-D[1] COLUMN-LABEL "Vigencia!Desde" FORMAT "99/99/9999":U
            WIDTH 8.43 COLUMN-BGCOLOR 14 LABEL-FGCOLOR 4 LABEL-FONT 6
      FacTabla.Campo-D[2] COLUMN-LABEL "Vigencia!Hasta" FORMAT "99/99/9999":U
            WIDTH 8.43 COLUMN-BGCOLOR 14 LABEL-FGCOLOR 4 LABEL-BGCOLOR 6 LABEL-FONT 6
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "INTEGRAL.FacTabla.Codigo|yes"
...
"FacTabla.Codigo" "Cod!Articulo" ? "character" ? ? ? 6 4 6 yes ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacTabla.Campo-D[1]" "Vigencia!Desde" "99/99/9999" "date" 14 ? ? ? 4 6 yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacTabla.Campo-D[2]
"FacTabla.Campo-D[2]" "Vigencia!Hasta" "99/99/9999" "date" 14 ? ? 6 4 6 yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH factabla WHERE factabla.codcia = s-codcia AND
                        factabla.tabla = 'AR-VALORES-VTAS' NO-LOCK:
    x-posicion-array = factabla.valor[2].
    ar-fracciones[x-posicion-array] = TRIM(factabla.codigo).
END.
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST b-factabla WHERE b-factabla.codcia = s-codcia AND
                                b-factabla.tabla = x-tabla-VTAS AND
                                b-factabla.codigo = factabla.codigo EXCLUSIVE-LOCK NO-ERROR.
  
  IF AVAILABLE b-factabla THEN DO:
        REPEAT x-sec = 1 TO 20:
            IF b-factabla.campo-l[x-sec] = YES AND factabla.campo-l[x-sec] = NO THEN DO:
                ASSIGN b-factabla.campo-l[x-sec] = factabla.campo-l[x-sec].
            END.
        END.
  END.
