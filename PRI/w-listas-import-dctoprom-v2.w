...
DO:
    ASSIGN RADIO-SET-Reemplazar.
    RUN pri/d-listas-import-dctoprom-v2.w (INPUT RADIO-SET-1,
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_t-listas-import-dctoprom-det ( 2.88 , 92.00 ) NO-ERROR.
...
IF RADIO-SET-2 <> 2 THEN DO:
    pMensaje = "Solo se aceptan Descuentos Promocionales en IMPORTES".
    RETURN 'ADM-ERROR'.
END.
