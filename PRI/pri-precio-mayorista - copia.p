...
/*DEF VAR iMonVta AS INTE NO-UNDO.*/
    ...
    CASE TRUE:
        ...
        WHEN ENTRY(7,ENTRY(iRegistro,pcReturn),':') = "Y" THEN DO:
            ...
            IF piCodMon = 1 THEN DO:
                ...
                ELSE ASSIGN f-PreVta = f-PreVta * fTPOCMB /** F-FACTOR*/.
            END.
...
/*DO iRegistro = 1 TO NUM-ENTRIES(pcReturn):*/
    ...
    s-TpoCmb = DECIMAL(ENTRY(4,ENTRY(iRegistro,pcReturn),':')).
    /*
    MESSAGE "cCodMat " cCodMat SKIP
        "fPreUni " fPreUni SKIP
        "x-MonVta " x-MonVta SKIP
        "s-TpoCmb " s-TpoCmb.
    */
    x-FlgDtoVol = gFlgDtoVol.
    x-FlgDtoProm = gFlgDtoProm.
    ...
    CASE TRUE:
        ...
        WHEN ENTRY(7,ENTRY(iRegistro,pcReturn),':') = "Y" THEN DO:
            ...
            IF piCodMon = 2 THEN DO:
                ...
                ELSE ASSIGN f-PreVta = (f-PreVta / fTPOCMB) /** F-FACTOR*/.
            END.
            /*IF cCodMat = "044714" THEN MESSAGE fPreUni f-PreVta f-Factor.*/
            ASSIGN
                f-PreBas = f-PreVta.
            /************************************************/
            RUN lib/RedondearMas (F-PREVTA, s-NRODEC, OUTPUT f-PREVTA).
...
/*MESSAGE pccodcli SKIP pccoddiv SKIP STRING(pccodmat) SKIP STRING(pcclfcli) SKIP STRING(pcfmapgo).*/
...
/*MESSAGE 'Retorno api:' STRING(pcreturn) SKIP 'Mensaje:' pmensaje SKIP RETURN-VALUE.*/
IF RETURN-VALUE = 'ADM-ERROR' THEN RETURN 'ADM-ERROR'.
