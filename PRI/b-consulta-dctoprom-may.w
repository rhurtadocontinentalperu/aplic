...
fPreVta(VtaDctoProm.Precio,RADIO-SET_Moneda) @ x-Precio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      fPreVta(VtaDctoProm.Precio,RADIO-SET_Moneda) @ x-Precio COLUMN-LABEL "Precio" FORMAT ">>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     FILL-IN-CodMat AT ROW 2.08 COL 3.72 NO-LABEL WIDGET-ID 12
     FILL-IN-UndBas AT ROW 2.08 COL 14.72 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     FILL-IN-PrecioBase AT ROW 2.08 COL 61.72 COLON-ALIGNED WIDGET-ID 16
     FILL-IN-DesMat AT ROW 2.85 COL 1.72 COLON-ALIGNED NO-LABEL WIDGET-ID 14
...
"VtaDctoProm.Descuento" "Descuento (%)" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"fPreVta(VtaDctoProm.Precio,RADIO-SET_Moneda) @ x-Precio" "Precio" ">>>,>>9.9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
