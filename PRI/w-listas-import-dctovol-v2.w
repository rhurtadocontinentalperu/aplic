...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'PRI/b-listas-import-dctovol-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-listas-import-dctovol-v2 ,
             h_v-listas-import-dctovol-v2 , 'AFTER':U ).
    END. /* Page 0 */
...
IF NOT (cValue BEGINS "CONTINENTAL - DESCUENTOS POR VOLUMEN"
        ...
        OR cValue BEGINS "CONTRATO MARCO - DESCUENTOS POR VOLUMEN")
    THEN DO:
    pMensaje = 'Formato del archivo Excel errado'.
    RETURN.
END.
...
CASE RADIO-SET-1:
    WHEN 1 THEN DO:
        {pri/i-listas-import-dctovol-v2.i &Tabla=Almmmatg}
    END.
    WHEN 2 THEN DO:
        {pri/i-listas-import-dctovol-v2.i &Tabla=Vtalistamingn}
    END.
    WHEN 3 THEN DO:
        /* ERRORES */
            ...
            DO k = 1 TO 10:
                IF T-MATG.DtoVolD[k] <> 0 THEN DO:
                    RUN PRI_Margen-Utilidad IN hProc (INPUT s-CodDiv,
                                                      ...
                                                      INPUT T-MATG.PreVta[1] * ( 1 - (T-MATG.DtoVolD[k] / 100) ),
    ...
    END.
    WHEN 4 THEN DO:
        {pri/i-listas-import-dctovol-v2.i &Tabla=Almmmatp}
    END.
END CASE.
DELETE PROCEDURE hProc.
