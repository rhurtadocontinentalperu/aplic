...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PREPARAR PLANTILLA DE PRECIOS - SOLO EVENTOS"
         HEIGHT             = 25.62
         WIDTH              = 107.43
         MAX-HEIGHT         = 25.62
         MAX-WIDTH          = 111.14
...
ON END-ERROR OF W-Win /* PREPARAR PLANTILLA DE PRECIOS - SOLO EVENTOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PREPARAR PLANTILLA DE PRECIOS - SOLO EVENTOS */
DO:
