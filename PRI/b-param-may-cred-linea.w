...
Almtfami.desfam VtaDTabla.Libre_c01 VtaDTabla.Libre_c02 ~
fSubLinea() @ x-SubLinea VtaDTabla.Libre_l05 VtaDTabla.Libre_l01 ~
...
VtaDTabla.Libre_c01 VtaDTabla.Libre_c02 VtaDTabla.Libre_l05 ~
VtaDTabla.Libre_l01 VtaDTabla.Libre_l02 VtaDTabla.Libre_l03 ~
VtaDTabla.Libre_l04 VtaDTabla.Libre_c05 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almtfami.desfam FORMAT "X(40)":U WIDTH 33.14
      VtaDTabla.Libre_c01 COLUMN-LABEL "Sub-Línea!+" FORMAT "x(3)":U
      VtaDTabla.Libre_c02 COLUMN-LABEL "Sub-Línea!-" FORMAT "x(3)":U
      ...
      VtaDTabla.Libre_l05 COLUMN-LABEL "Precio!Mostrador" FORMAT "yes/no":U
            WIDTH 10.29 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 10 VIEW-AS COMBO-BOX INNER-LINES 5
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 159 BY 14.81
...
"VtaDTabla.LlaveDetalle" "Línea" "x(3)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almtfami.desfam
"Almtfami.desfam" ? "X(40)" "character" ? ? ? ? ? ? no ? no no "33.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDTabla.Libre_c02" "Sub-Línea!-" "x(3)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"fSubLinea() @ x-SubLinea" "Descripción" "x(30)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaDTabla.Libre_l05
"VtaDTabla.Libre_l05" "Precio!Mostrador" ? "logical" 10 0 ? ? ? ? yes ? no no "10.29" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SI,yes ,NO,no" 5 no 0 no no
     _FldNameList[7]   > INTEGRAL.VtaDTabla.Libre_l01
"VtaDTabla.Libre_l01" "AFECTA LISTA DE!xCondic. de Venta" ? "logical" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SI,yes ,NO,no" 5 no 0 no no
     _FldNameList[8]   > INTEGRAL.VtaDTabla.Libre_l02
"VtaDTabla.Libre_l02" "PRECIOS!xClasific. Cliente" ? "logical" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SI,yes ,NO,no" 5 no 0 no no
     _FldNameList[9]   > INTEGRAL.VtaDTabla.Libre_l03
"VtaDTabla.Libre_l03" "DESCUENTOS POR!Dcto. x Volumen" ? "logical" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SI,yes ,NO,no" 5 no 0 no no
     _FldNameList[10]   > INTEGRAL.VtaDTabla.Libre_l04
"VtaDTabla.Libre_l04" "PRODUCTO!Dcto. Promocional" ? "logical" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "SI,yes ,NO,no" 5 no 0 no no
     _FldNameList[11]   > INTEGRAL.VtaDTabla.Libre_c05
"VtaDTabla.Libre_c05" "Tipo" "x(15)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "NO DEFINIDO,,EXCLUYENTES,E,ACUMULADOS,A" 5 no 0 no no
...
ON LEAVE OF VtaDTabla.LlaveDetalle IN BROWSE br_table /* Línea */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      VtaDTabla.Tipo   = "L".     /* Líneas y SubLíneas */
...
IF NOT CAN-FIND(FIRST VtaTabla WHERE VtaTabla.CodCia = s-codcia AND 
                ...
                VtaTabla.Llave_c2 = VtaDTabla.LlaveDetalle:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} NO-LOCK)
    THEN DO:
...
IF VtaDTabla.Libre_c02:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} > '' THEN DO:
    ...
    END.
END.
IF VtaDTabla.Libre_c01:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} > '' AND
