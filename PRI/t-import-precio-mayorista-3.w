...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.DesMat FORMAT "X(60)":U WIDTH 58.43
      T-MATG.UndBas COLUMN-LABEL "Unidad" FORMAT "X(6)":U WIDTH 8.43
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1 COLUMN-LABEL "Mon!LP" FORMAT "x(3)":U
...
"T-MATG.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "58.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-MATG.UndBas
"T-MATG.UndBas" "Unidad" "X(6)" "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1" "Mon!LP" "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
