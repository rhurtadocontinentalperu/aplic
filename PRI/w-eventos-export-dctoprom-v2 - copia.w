...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - SOLO EVENTOS"
         HEIGHT             = 25.54
         WIDTH              = 108.57
         MAX-HEIGHT         = 25.54
         MAX-WIDTH          = 143.57
...
ON END-ERROR OF W-Win /* PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - SOLO EVENTOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - SOLO EVENTOS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'PRI/b-listas-validas.w':U ,
