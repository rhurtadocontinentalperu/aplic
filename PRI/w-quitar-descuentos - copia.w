...
FILL-IN-ruta-errores FILL-IN-2 
...
IF AVAILABLE b-almmmatg THEN DO:
    REPEAT x-sec = 1 TO 10:
        ASSIGN b-almmmatg.DtoVOLR[x-sec] = 0
...
IF AVAILABLE b-VtaListaMinGn THEN DO:
    REPEAT x-sec = 1 TO 10:
        ASSIGN b-VtaListaMinGn.DtoVOLR[x-sec] = 0
...
------------------------------------------------------------------------------*/
  DISPLAY TOGGLE-clear FILL-IN-txt EDITOR-msg TOGGLE-prom-may TOGGLE-vol-may 
          TOGGLE-vol-utilex TOGGLE-prom-utilex FILL-IN-ruta-errores FILL-IN-2 
...
DEFINE VAR x-procesados AS INT.
...
FOR EACH tt-w-report:
    ...
    IF AVAILABLE almmmatg THEN DO:
        ...
        RELEASE b-almmmatg NO-ERROR.
        RELEASE b-VtaDctoProm NO-ERROR.
        RELEASE b-VtaDctoPromMin NO-ERROR.
        RELEASE b-VtaListaMinGn NO-ERROR.
