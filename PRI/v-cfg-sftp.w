...
DEFINE FRAME F-Main
     FacTabla.Valor[1] AT ROW 2 COL 22 COLON-ALIGNED WIDGET-ID 4
          LABEL "% de Stock a declarar" FORMAT ">>9"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81 TOOLTIP "De 0 a 100%"
     FacTabla.Valor[2] AT ROW 3.15 COL 22 COLON-ALIGNED WIDGET-ID 6
          LABEL "Mínimo de Unidades" FORMAT ">>>,>>9"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
