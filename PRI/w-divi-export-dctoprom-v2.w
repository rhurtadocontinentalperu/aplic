...
/* Sedes */
DEF VAR RADIO-SET-1 AS INTE NO-UNDO.
...
DEFINE FRAME F-Main
     COMBO-BOX-CodFam AT ROW 9.27 COL 13 COLON-ALIGNED WIDGET-ID 8
     COMBO-BOX-SubFam AT ROW 10.23 COL 13 COLON-ALIGNED WIDGET-ID 10
     x-CodPro AT ROW 11.19 COL 13 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-NomPro AT ROW 11.19 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     x-DesMar AT ROW 12.15 COL 13 COLON-ALIGNED WIDGET-ID 16
     BUTTON-1 AT ROW 12.15 COL 28 WIDGET-ID 18
     RADIO-SET-2 AT ROW 12.54 COL 79 NO-LABEL WIDGET-ID 32
     BROWSE-2 AT ROW 13.5 COL 2 WIDGET-ID 200
     "Valores en:" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 12.73 COL 70 WIDGET-ID 36
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 107.43 BY 25.54
...
chWorkSheet:Range("A1"):Value = "POR DIVISION - DESCUENTOS PROMOCIONALES".
...
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}:
    FIND FIRST VtaListaMay OF Almmmatg WHERE LOOKUP(VtaListaMay.CodDiv, f-Divisiones) > 0 NO-LOCK NO-ERROR.
        ...
        DO k = 1 TO NUM-ENTRIES(f-Divisiones):
            ...
            IF AVAILABLE VtaDctoProm THEN DO:
                ASSIGN
                    ...
                    chWorkSheet:Cells(t-Row, t-Column):VALUE = (IF RADIO-SET-2 = 1 THEN VtaDctoProm.Descuento 
