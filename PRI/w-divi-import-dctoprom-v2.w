...
&Scoped-Define ENABLED-OBJECTS TOGGLE-Reemplazar BtnDone BUTTON-1 
&Scoped-Define DISPLAYED-OBJECTS TOGGLE-Reemplazar 
...
DEFINE FRAME F-Main
     TOGGLE-Reemplazar AT ROW 1.27 COL 71 WIDGET-ID 36
     BtnDone AT ROW 1.27 COL 137 WIDGET-ID 6
     BUTTON-1 AT ROW 2.35 COL 71 WIDGET-ID 2
     BUTTON-2 AT ROW 2.35 COL 96 WIDGET-ID 4
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-listas-validas ,
             TOGGLE-Reemplazar:HANDLE IN FRAME F-Main , 'BEFORE':U ).
...
------------------------------------------------------------------------------*/
  DISPLAY TOGGLE-Reemplazar 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE TOGGLE-Reemplazar BtnDone BUTTON-1 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH T-MATG EXCLUSIVE-LOCK,
    ...
    RUN PRI_Graba-Dscto-Prom-Divi IN hProc (INPUT TOGGLE-Reemplazar,
