...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.CtoTot COLUMN-LABEL "Costo" FORMAT ">>>,>>9.9999":U
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 16.35
         FONT 4
         TITLE "LISTA REMATES" FIT-LAST-COLUMN.
...
"T-MATG.CtoTot" "Costo" ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* LISTA REMATES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* LISTA REMATES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* LISTA REMATES */
DO:
...
ON LEAVE OF T-MATG.CtoTot IN BROWSE br_table /* Costo */
DO:
    ASSIGN
