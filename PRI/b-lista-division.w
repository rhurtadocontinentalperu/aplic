...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      GN-DIVI.FlgDtoProm COLUMN-LABEL "Descuento!Prom." FORMAT "yes/no":U
            WIDTH 7.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14 VIEW-AS TOGGLE-BOX
      GN-DIVI.Libre_c01 COLUMN-LABEL "Tipo Cálculo" FORMAT "x(20)":U
...
"GN-DIVI.Libre_c01" "Tipo Cálculo" "x(20)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "EXCLUYENTES,,ACUMULADOS,A" 5 no 0 no no
