...
t-VtaDctoProm.FchFin t-VtaDctoProm.Descuento t-VtaDctoProm.Precio ~
t-VtaDctoProm.Tipo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      t-VtaDctoProm.Precio FORMAT ">>>,>>9.9999":U WIDTH 7.86
      t-VtaDctoProm.Tipo FORMAT "x(15)":U WIDTH 13
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 153 BY 16.42
...
"t-VtaDctoProm.Descuento" "Descuento (%)" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.t-VtaDctoProm.Precio
"t-VtaDctoProm.Precio" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.t-VtaDctoProm.Tipo
"t-VtaDctoProm.Tipo" ? ? "character" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
