...
DEFINE VARIABLE h_b-utilex-dctoprom-v2 AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 1 COL 86
     BUTTON-2 AT ROW 1.27 COL 37 WIDGET-ID 2
     SPACE(42.71) SKIP(17.25)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "UTILEX - DESCUENTO PROMOCIONAL" WIDGET-ID 100.
...
DO:
    ...
    RUN Replica-Plantilla IN h_b-utilex-dctoprom-v2 ( INPUT pDivisiones /* CHARACTER */).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pri/b-utilex-dctoprom-v2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-utilex-dctoprom-v2 ).
       RUN set-position IN h_b-utilex-dctoprom-v2 ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-utilex-dctoprom-v2 ( 16.96 , 91.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/q-utilex-dtopromv2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-utilex-dtopromv2 ).
       RUN set-position IN h_q-utilex-dtopromv2 ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-utilex-dctoprom-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-utilex-dctoprom-v2 ).
       RUN add-link IN adm-broker-hdl ( h_q-utilex-dtopromv2 , 'Record':U , h_b-utilex-dctoprom-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-utilex-dctoprom-v2 ,
