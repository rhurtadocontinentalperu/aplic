...
&Scoped-define INTERNAL-TABLES PriCDctoxImport

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH PriCDctoxImport WHERE ~{&KEY-PHRASE} ~
      AND PriCDctoxImport.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PriCDctoxImport WHERE ~{&KEY-PHRASE} ~
      AND PriCDctoxImport.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main PriCDctoxImport
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PriCDctoxImport
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.PriCDctoxImport"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "PriCDctoxImport.CodCia = s-codcia"
