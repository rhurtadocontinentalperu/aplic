...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon COLUMN-LABEL "Moneda!de LP" FORMAT "x(3)":U
...
"IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon" "Moneda!de LP" "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.CtoTot" "Costo Total" ">>>>,>>9.9999" "decimal" 14 0 ? ? ? ? no ? no no "13.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.Prevta[1]
"T-MATG.Prevta[1]" "Precio Lista" ? "decimal" 14 0 ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATG.MrgUti-A
"T-MATG.MrgUti-A" "% Uti A" ? "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.Prevta[2]
"T-MATG.Prevta[2]" "Precio A" ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.MrgUti-B" "% Uti B" ? "decimal" 13 15 ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-MATG.Prevta[3]
"T-MATG.Prevta[3]" "Precio B" ">>>,>>9.9999" "decimal" 13 15 ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.MrgUti-C" "% Uti C" ? "decimal" 1 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.T-MATG.Prevta[4]
"T-MATG.Prevta[4]" "Precio C" ">>>,>>9.9999" "decimal" 1 15 ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
