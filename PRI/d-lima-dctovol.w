...
DO:
    ...
    RUN Replica-Plantilla IN h_b-lima-dctovol ( INPUT pDivisiones /* CHARACTER */).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pri/v-lima-dctovol.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-lima-dctovol ).
       RUN set-position IN h_v-lima-dctovol ( 2.62 , 76.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.31 , 52.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pri/b-lima-dctovol.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lima-dctovol ).
       RUN set-position IN h_b-lima-dctovol ( 2.88 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-lima-dctovol ( 12.12 , 71.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-lima-dctovol. */
       RUN add-link IN adm-broker-hdl ( h_b-lima-dctovol , 'Record':U , h_v-lima-dctovol ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_v-lima-dctovol ).

       /* Links to SmartBrowser h_b-lima-dctovol. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-lima-dctovol ).
       RUN add-link IN adm-broker-hdl ( h_q-lima-dtopromv2 , 'Record':U , h_b-lima-dctovol ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_OK:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-lima-dctovol ,
             BUTTON-2:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-lima-dctovol ,
             h_v-lima-dctovol , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv96 ,
             h_b-lima-dctovol , 'AFTER':U ).
    END. /* Page 0 */
