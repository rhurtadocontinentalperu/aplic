...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaListaMinGn WHERE ~{&KEY-PHRASE} ~
      AND VtaListaMinGn.CodCia = s-codcia NO-LOCK, ~
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Linea FILL-IN-CodPro BUTTON-8 ~
COMBO-BOX-Sublinea FILL-IN-DesMat FILL-IN-CodMat br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Linea FILL-IN-CodPro ~
FILL-IN-NomPro COMBO-BOX-Sublinea FILL-IN-DesMat FILL-IN-CodMat 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaListaMinGn.PreOfi FORMAT ">,>>>,>>9.9999":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
...
DEFINE FRAME F-Main
     ...
     BUTTON-8 AT ROW 1 COL 153 WIDGET-ID 10
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "VtaListaMinGn.CodCia = s-codcia"
     _Where[2]         = "{&Condicion}"
...
"Almmmatg.Prevta[1]" "Precio Lista" ">>>,>>9.9999" "decimal" 14 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaListaMinGn.PreOfi" ? ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF VtaListaMinGn.PreOfi IN BROWSE br_table /* Precio Oficina */
DO:
    ASSIGN
        X-CTOUND = Almmmatg.CtoTot
        F-FACTOR = 1.
