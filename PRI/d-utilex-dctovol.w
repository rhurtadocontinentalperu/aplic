...
DEFINE VARIABLE h_b-utilex-dctovol AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updv12 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updv96 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_q-detart-min-gn AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-utilex-dctovol AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "UTILEX - DESCUENTO POR VOLUMEN" WIDGET-ID 100.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* UTILEX - DESCUENTO POR VOLUMEN */
DO:  
...
DO:
    ...
    RUN Replica-Plantilla IN h_b-utilex-dctovol ( INPUT pDivisiones /* CHARACTER */).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pri/v-utilex-dctovol.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-utilex-dctovol ).
       RUN set-position IN h_v-utilex-dctovol ( 2.62 , 76.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.31 , 52.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pri/b-utilex-dctovol.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-utilex-dctovol ).
       RUN set-position IN h_b-utilex-dctovol ( 2.88 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-utilex-dctovol ( 12.12 , 71.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/q-detart-min-gn.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-detart-min-gn ).
       RUN set-position IN h_q-detart-min-gn ( 1.27 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartViewer h_v-utilex-dctovol. */
       RUN add-link IN adm-broker-hdl ( h_b-utilex-dctovol , 'Record':U , h_v-utilex-dctovol ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_v-utilex-dctovol ).

       /* Links to SmartBrowser h_b-utilex-dctovol. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-utilex-dctovol ).
       RUN add-link IN adm-broker-hdl ( h_q-detart-min-gn , 'Record':U , h_b-utilex-dctovol ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_OK:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-utilex-dctovol ,
             BUTTON-2:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-utilex-dctovol ,
             h_v-utilex-dctovol , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv96 ,
             h_b-utilex-dctovol , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  RUN Captura-Codigo IN h_q-detart-min-gn (INPUT X-ART).
