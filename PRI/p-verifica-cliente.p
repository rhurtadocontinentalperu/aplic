...
DEF INPUT PARAMETER pCodCliFiler AS CHAR.
...
DEFINE VAR cValidaciones AS CHAR INIT "".
DEFINE VAR pCodCli AS CHAR INIT "".

pCodCli = pCodCliFiler.

IF NUM-ENTRIES(pCodCliFiler,"|") > 1 THEN DO:
    cValidaciones = ENTRY(2,pCodCliFiler,"|").
    pCodCli = ENTRY(1,pCodCliFiler,"|").
END.

/*
cValidaciones :
    1 : Solo valida que el cliente exista
    2 o vacio : Todas las validaciones
*/
...
IF cValidaciones = "1" THEN RETURN "OK".
