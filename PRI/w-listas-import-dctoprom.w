...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "IMPORTAR DESCUENTOS PROMOCIONALES - MAYORISTA"
         HEIGHT             = 21.08
         WIDTH              = 141.14
         MAX-HEIGHT         = 21.54
         MAX-WIDTH          = 142.29
...
ON END-ERROR OF W-Win /* IMPORTAR DESCUENTOS PROMOCIONALES - MAYORISTA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* IMPORTAR DESCUENTOS PROMOCIONALES - MAYORISTA */
DO:
    ...
    FOR EACH T-MATG NO-LOCK:
        ...
        CASE RADIO-SET-1:
            WHEN 2 THEN DO:     /* Solo UTILEX */
                FOR EACH T-DPROM NO-LOCK WHERE T-DPROM.CodCia = T-MATG.CodCia AND T-DPROM.CodMat = T-MATG.CodMat:
                    ...
                    IF AVAILABLE VtaDctoPromMin THEN DO:
                        ...
                        BUFFER-COPY T-DPROM
                            TO VtaDctoPromMin
                            ASSIGN
                            VtaDctoPromMin.codcia = s-codcia
                            VtaDctoPromMin.FchModificacion = TODAY
                            VtaDctoPromMin.HoraModificacion = STRING(TIME, 'HH:MM:SS')
                            VtaDctoPromMin.Precio = ROUND(T-MATG.PreVta[1] * (1 - (T-DPROM.Descuento / 100)), 4)
