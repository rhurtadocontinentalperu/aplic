...
Almtfami.TpoCmb Almtfami.Libre_c05 Almtfami.Libre_f02 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table Almtfami.TpoCmb 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 81 BY 15.88
...
"desfam" ? ? "character" ? ? ? ? ? ? no ? no no "35.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almtfami.TpoCmb
"TpoCmb" ? ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.Almtfami.Libre_c05
"Libre_c05" "Actualizó TC?" "x(2)" "character" 14 0 ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.Almtfami.Libre_f02
"Libre_f02" "Fecha Ultima!Actualización" "99/99/9999" "date" ? ? ? ? ? ? no ? no no "14.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
