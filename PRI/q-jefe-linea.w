...
&Scoped-define QUERY-STRING-Query-Main FOR EACH PF-G004 WHERE ~{&KEY-PHRASE} ~
      AND PF-G004.Aplic-Id = s-aplic-id ~
 AND PF-G004.User-Id = s-user-id NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PF-G004 WHERE ~{&KEY-PHRASE} ~
      AND PF-G004.Aplic-Id = s-aplic-id ~
 AND PF-G004.User-Id = s-user-id NO-LOCK ~
    ~{&SORTBY-PHRASE}.
