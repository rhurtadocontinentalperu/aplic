...
TOGGLE-Vigente x-DesMar BUTTON-1 RADIO-SET-2 BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-CodFam COMBO-BOX-SubFam x-CodPro ~
FILL-IN-NomPro TOGGLE-Vigente x-DesMar RADIO-SET-2 
...
DEFINE VARIABLE TOGGLE-Vigente AS LOGICAL INITIAL no 
...
DO:
    ASSIGN RADIO-SET-2 TOGGLE-Vigente .
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-CodFam COMBO-BOX-SubFam x-CodPro FILL-IN-NomPro 
          TOGGLE-Vigente x-DesMar RADIO-SET-2 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE COMBO-BOX-CodFam COMBO-BOX-SubFam x-CodPro TOGGLE-Vigente x-DesMar 
...
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}:
    ...
    FOR EACH T-DPROM EXCLUSIVE-LOCK BREAK BY T-DPROM.FChIni BY T-DPROM.FchFin:
        /* ******************************************************************************************** */
        /* RHC 20(08/2021: Solo vigente a la fecha */
        /* ******************************************************************************************** */
        IF TOGGLE-Vigente = YES AND NOT (T-DPROM.FchIni >= TODAY AND TODAY <= T-DPROM.FchFin) THEN DO:
            DELETE T-DPROM.
            NEXT.
        END.
        /* ******************************************************************************************** */
