...
T-MATG.TpoCmb T-MATG.DesMar T-MATG.CtoTot T-MATG.Dec__01 T-MATG.PreOfi ~
T-MATG.Chr__01 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.DesMat FORMAT "X(60)":U WIDTH 59.43
      T-MATG.UndBas FORMAT "X(7)":U
      IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1 COLUMN-LABEL "Moneda!LP" FORMAT "x(3)":U
      T-MATG.TpoCmb FORMAT "Z9.9999":U
      T-MATG.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U
      T-MATG.CtoTot COLUMN-LABEL "Costo MARCO" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      T-MATG.Dec__01 COLUMN-LABEL "% Uti Oficina" FORMAT "->>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      T-MATG.PreOfi FORMAT "->>,>>9.9999":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      T-MATG.Chr__01 COLUMN-LABEL "UM" FORMAT "x(7)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 16.35
         FONT 4
         TITLE "LISTA CONTRATO MARCO" FIT-LAST-COLUMN.
...
"T-MATG.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "59.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-MATG.UndBas
"T-MATG.UndBas" ? "X(7)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"IF (T-MATG.MonVta = 1) THEN ('S/.') ELSE ('US$') @ x-Mon1" "Moneda!LP" "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-MATG.CtoTot" "Costo MARCO" ">>>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-MATG.Dec__01
"T-MATG.Dec__01" "% Uti Oficina" "->>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-MATG.PreOfi
"T-MATG.PreOfi" ? "->>,>>9.9999" "decimal" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-MATG.Chr__01
"T-MATG.Chr__01" "UM" "x(7)" "character" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* LISTA CONTRATO MARCO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* LISTA CONTRATO MARCO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* LISTA CONTRATO MARCO */
DO:
...
&Scoped-define SELF-NAME T-MATG.CtoTot
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL T-MATG.CtoTot br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF T-MATG.CtoTot IN BROWSE br_table /* Costo MARCO */
DO:
    ASSIGN
        X-CTOUND   = DECIMAL(T-MATG.CtoTot:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).
     F-FACTOR = 1.
     /****   Busca el Factor de conversion   ****/
       IF T-MATG.CHR__01:SCREEN-VALUE IN BROWSE {&browse-name} <> "" THEN DO:
         ...
         DISPLAY
             ROUND(( X-CTOUND * (1 + DECIMAL(T-MATG.Dec__01:SCREEN-VALUE) / 100) ), 6) * F-FACTOR @ 
              T-MATG.PreOfi WITH BROWSE {&browse-name}.
     END.
...
ON LEAVE OF T-MATG.Dec__01 IN BROWSE br_table /* % Uti Oficina */
DO:
    ASSIGN
        X-CTOUND   = DECIMAL(T-MATG.CtoTot:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).
     F-FACTOR = 1.
...
ON LEAVE OF T-MATG.PreOfi IN BROWSE br_table /* Precio Oficina */
DO:
    ASSIGN
        X-CTOUND = DECIMAL(T-MATG.CtoTot:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).
    F-FACTOR = 1.
    /****   Busca el Factor de conversion   ****/
      IF T-MATG.CHR__01:SCREEN-VALUE IN BROWSE {&browse-name} <> "" THEN DO:
        ...
        DISPLAY
            ...
            T-MATG.DEC__01 WITH BROWSE {&BROWSE-NAME}.
    END.
...
------------------------------------------------------------------------------*/
  ...
  END.  
  ASSIGN
      T-MATG.MrgAlt[1] = ( (T-MATG.PreAlt[1] / (T-MATG.CtoTot * f-Factor) ) - 1 ) * 100. 
