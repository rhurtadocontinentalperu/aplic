...
COMBO-BOX-SubFam x-CodPro TOGGLE-Vigente x-DesMar BUTTON-1 RADIO-SET-2 ~
BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-1 COMBO-BOX-CodFam ~
COMBO-BOX-SubFam x-CodPro FILL-IN-NomPro TOGGLE-Vigente x-DesMar ~
RADIO-SET-2 
...
DO:
    ASSIGN
        RADIO-SET-1 RADIO-SET-2 TOGGLE-Vigente.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RADIO-SET-1 COMBO-BOX-CodFam COMBO-BOX-SubFam x-CodPro TOGGLE-Vigente 
        ...
        CASE RADIO-SET-1:
            WHEN 2 THEN DO:     /* UTILEX MINORISTA */
                DO k = 1 TO NUM-ENTRIES(f-Divisiones):
                    ASSIGN
                        t-Column = t-Column + 1.
                    FIND FIRST VtaDctoPromMin WHERE VtaDctoPromMin.CodCia = s-CodCia AND
                        VtaDctoPromMin.CodDiv = ENTRY(k, f-Divisiones) AND
                        VtaDctoPromMin.CodMat = Almmmatg.codmat AND
                        VtaDctoPromMin.FchIni = T-DPROM.FchIni AND
                        VtaDctoPromMin.FChFin = T-DPROM.FchFin AND
                        VtaDctoPromMin.FlgEst = "A"
                        NO-LOCK NO-ERROR.
                    IF AVAILABLE VtaDctoPromMin THEN DO:
                        ASSIGN
                            ...
                            chWorkSheet:Cells(t-Row, t-Column):VALUE = (IF RADIO-SET-2 = 1 THEN VtaDctoPromMin.Descuento 
