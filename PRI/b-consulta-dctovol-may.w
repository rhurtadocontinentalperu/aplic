...
/*   DO x-Orden = 1 TO 10:                                                          */
/*       IF Almmmatg.DtoVolD[x-Orden] <> 0 THEN DO:                                 */
/*           RUN vtagn/p-margen-utilidad (                                          */
/*               Almmmatg.CodMat,                                                   */
/*               Almmmatg.PreVta[1] * ( 1 - (Almmmatg.DtoVolD[x-Orden] / 100) ),    */
/*               Almmmatg.CHR__01,                                                  */
...
FOR EACH Almmmatg NO-LOCK:
    ...
    iCuentaRangos = 0.
    DO k = 1 TO 10:
        IF iCuentaRangos > 0 AND Almmmatg.DtoVolR[k] > 0
            AND Almmmatg.DtoVolR[k] < iCuentaRangos 
            THEN DO:
            CREATE E-MATG.
            ...
            NEXT trloop.
        END.
        iCuentaRangos = Almmmatg.DtoVolR[k].
    END.
END.
*/
