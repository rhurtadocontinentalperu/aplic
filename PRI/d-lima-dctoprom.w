...
DO:
    ...
    RUN Replica-Plantilla IN h_b-lima-dctoprom ( INPUT pDivisiones /* CHARACTER */).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-lima-dctoprom ( 2.62 , 2.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-lima-dctoprom ).
       RUN add-link IN adm-broker-hdl ( h_q-lima-dtopromv2 , 'Record':U , h_b-lima-dctoprom ).
