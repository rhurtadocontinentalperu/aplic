...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "IMPORTAR DESCUENTOS PROMOCIONALES - SOLO EVENTOS"
         HEIGHT             = 25.69
         WIDTH              = 144.14
         MAX-HEIGHT         = 25.69
         MAX-WIDTH          = 144.14
...
ON END-ERROR OF W-Win /* IMPORTAR DESCUENTOS PROMOCIONALES - SOLO EVENTOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* IMPORTAR DESCUENTOS PROMOCIONALES - SOLO EVENTOS */
DO:
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    FOR EACH T-MATG NO-LOCK,
        ...
        IF T-MATG.Libre_d03 > 0 THEN DO:
            ...
            END.
        END.
/*         IF T-MATG.Libre_d01 > 0 THEN DO:    /* VIP */                                                                        */
/*             RUN vtagn/p-margen-utilidad-v11 (                                                                                */
/*                 VtaListaMay.CodDiv,                                                                                          */
/*                 T-MATG.CodMat,                                                                                               */
/*                 ROUND(x-PreUni * (1 - (T-MATG.Libre_d01 / 100)), 4),                                                         */
/*                 T-MATG.CHR__01,                                                                                              */
/*                 1,                      /* Moneda */                                                                         */
/*                 T-MATG.TpoCmb,                                                                                               */
/*                 NO,                     /* Muestra error? */                                                                 */
...
/*                     TO E-MATG                                                                                                */
/*                     ASSIGN                                                                                                   */
/*                     E-MATG.Libre_c01 = "Margen de utilidad VIP NO debe ser menor a " + TRIM(STRING(x-Limite, ">>>,>>9.99")). */
/*                 DELETE T-MATG.                                                                                               */
/*                 NEXT trloop.                                                                                                 */
/*             END.                                                                                                             */
/*         END.                                                                                                                 */
/*         IF T-MATG.Libre_d02 > 0 THEN DO:    /* MR */                                                                         */
/*             RUN vtagn/p-margen-utilidad-v11 (                                                                                */
/*                 VtaListaMay.CodDiv,                                                                                          */
/*                 T-MATG.CodMat,                                                                                               */
/*                 ROUND(x-PreUni * (1 - (T-MATG.Libre_d02 / 100)), 4),                                                         */
/*                 T-MATG.CHR__01,                                                                                              */
/*                 1,                      /* Moneda */                                                                         */
/*                 T-MATG.TpoCmb,                                                                                               */
/*                 NO,                     /* Muestra error? */                                                                 */
...
/*                     TO E-MATG                                                                                                */
/*                     ASSIGN                                                                                                   */
/*                     E-MATG.Libre_c01 = "Margen de utilidad MR NO debe ser menor a " + TRIM(STRING(x-Limite, ">>>,>>9.99")).  */
/*                 DELETE T-MATG.                                                                                               */
/*                 NEXT trloop.                                                                                                 */
/*             END.                                                                                                             */
/*         END.                                                                                                                 */
/*         IF T-MATG.Libre_d03 > 0 THEN DO:    /* Normal */                                                                     */
/*             RUN vtagn/p-margen-utilidad-v11 (                                                                                */
/*                 VtaListaMay.CodDiv,                                                                                          */
/*                 T-MATG.CodMat,                                                                                               */
/*                 ROUND(x-PreUni * (1 - (T-MATG.Libre_d03 / 100)), 4),                                                         */
/*                 T-MATG.CHR__01,                                                                                              */
/*                 1,                      /* Moneda */                                                                         */
/*                 T-MATG.TpoCmb,                                                                                               */
/*                 NO,                     /* Muestra error? */                                                                 */
