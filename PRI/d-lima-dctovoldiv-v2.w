...
DEFINE VARIABLE h_v-lima-dctovoldiv-v2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pri/v-lima-dctovoldiv-v2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-lima-dctovoldiv-v2 ).
       RUN set-position IN h_v-lima-dctovoldiv-v2 ( 2.62 , 76.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-lima-dctovoldiv-v2. */
       RUN add-link IN adm-broker-hdl ( h_b-lima-dctovol-v2 , 'Record':U , h_v-lima-dctovoldiv-v2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_v-lima-dctovoldiv-v2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-lima-dctovoldiv-v2 ,
             BUTTON-2:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-lima-dctovol-v2 ,
             h_v-lima-dctovoldiv-v2 , 'AFTER':U ).
