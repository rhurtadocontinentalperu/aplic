...
DEF TEMP-TABLE T-Precios
    FIELD Fila   AS INTE
    FIELD CodMat LIKE prilistaprecios.CodMat 
    FIELD Canal LIKE prilistaprecios.Canal 
    FIELD Grupo LIKE prilistaprecios.Grupo 
    FIELD PreUni LIKE prilistaprecios.PreUni 
    FIELD PreGrupo LIKE prilistaprecios.PreGrupo
    FIELD FactorGrupo LIKE prilistaprecios.FactorGrupo.
...
&Scoped-define INTERNAL-TABLES prilistaprecios Almmmatg pricanal prigrupo
...
Almmmatg.DesMat Almmmatg.DesMar prilistaprecios.UndBas Almmmatg.codfam ~
Almmmatg.subfam prilistaprecios.CtoTot prilistaprecios.PreBas ~
x-Margen @ x-Margen pricanal.Descripcion prilistaprecios.FactorCanal ~
prilistaprecios.PreCanal prigrupo.Descripcion prilistaprecios.FactorGrupo ~
prilistaprecios.PreGrupo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH prilistaprecios WHERE ~{&KEY-PHRASE} ~
      AND prilistaprecios.CodCia = s-codcia ~
 AND prilistaprecios.User-Id = s-user-id NO-LOCK, ~
      FIRST Almmmatg OF prilistaprecios OUTER-JOIN NO-LOCK, ~
      FIRST pricanal OF prilistaprecios OUTER-JOIN NO-LOCK, ~
      FIRST prigrupo OF prilistaprecios OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH prilistaprecios WHERE ~{&KEY-PHRASE} ~
 ...
 AND prilistaprecios.User-Id = s-user-id NO-LOCK, ~
      ...
      FIRST prigrupo OF prilistaprecios OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table prilistaprecios Almmmatg pricanal ~
prigrupo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      prilistaprecios.CodMat COLUMN-LABEL "Articulo" FORMAT "X(6)":U
      ...
      prilistaprecios.CtoTot COLUMN-LABEL "Costo!con IGV" FORMAT ">>>,>>>,>>9.9999":U
            WIDTH 8.43
      prilistaprecios.PreBas COLUMN-LABEL "Precio Base!con IGV" FORMAT ">>>,>>>,>>9.9999":U
            WIDTH 9.29
      x-Margen @ x-Margen COLUMN-LABEL "Margen!(%)" FORMAT "->>>,>>9.99":U
            WIDTH 7
      pricanal.Descripcion COLUMN-LABEL "Canal de Negociación" FORMAT "x(30)":U
            WIDTH 17.72
      prilistaprecios.FactorCanal COLUMN-LABEL "% I-II" FORMAT ">>>,>>9.999999":U
            WIDTH 9
      prilistaprecios.PreCanal COLUMN-LABEL "Precio Canal" FORMAT ">>>,>>>,>>9.9999":U
            WIDTH 9.29
      prigrupo.Descripcion COLUMN-LABEL "Grupo de División" FORMAT "x(30)":U
            WIDTH 15.72
      prilistaprecios.FactorGrupo COLUMN-LABEL "% II-III" FORMAT ">>>,>>9.999999":U
            WIDTH 9.29
      prilistaprecios.PreGrupo COLUMN-LABEL "Precio Grupo" FORMAT ">>>,>>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.prilistaprecios,INTEGRAL.Almmmatg OF INTEGRAL.prilistaprecios,INTEGRAL.pricanal OF INTEGRAL.prilistaprecios,INTEGRAL.prigrupo OF INTEGRAL.prilistaprecios"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST OUTER USED, FIRST OUTER USED, FIRST OUTER USED"
     _Where[1]         = "prilistaprecios.CodCia = s-codcia
 AND prilistaprecios.User-Id = s-user-id"
     _FldNameList[1]   > INTEGRAL.prilistaprecios.CodMat
"prilistaprecios.CodMat" "Articulo" "X(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"prilistaprecios.UndBas" "Unidad" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almmmatg.subfam" "SubLínea" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.prilistaprecios.CtoTot
"prilistaprecios.CtoTot" "Costo!con IGV" ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.prilistaprecios.PreBas
"prilistaprecios.PreBas" "Precio Base!con IGV" ? "decimal" ? ? ? ? ? ? no ? no no "9.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"x-Margen @ x-Margen" "Margen!(%)" "->>>,>>9.99" ? ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.pricanal.Descripcion
"pricanal.Descripcion" "Canal de Negociación" ? "character" ? ? ? ? ? ? no ? no no "17.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.prilistaprecios.FactorCanal
"prilistaprecios.FactorCanal" "% I-II" ? "decimal" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.prilistaprecios.PreCanal
"prilistaprecios.PreCanal" "Precio Canal" ? "decimal" ? ? ? ? ? ? no ? no no "9.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.prigrupo.Descripcion
"prigrupo.Descripcion" "Grupo de División" ? "character" ? ? ? ? ? ? no ? no no "15.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.prilistaprecios.FactorGrupo
"prilistaprecios.FactorGrupo" "% II-III" ? "decimal" ? ? ? ? ? ? no ? no no "9.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > INTEGRAL.prilistaprecios.PreGrupo
"prilistaprecios.PreGrupo" "Precio Grupo" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define SELF-NAME prilistaprecios.PreBas
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prilistaprecios.PreBas br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF prilistaprecios.PreBas IN BROWSE br_table /* Precio Base!con IGV */
DO:
    x-Margen = 0.
    IF prilistaprecios.CtoTot > 0 
        THEN x-Margen = ROUND((DECIMAL(SELF:SCREEN-VALUE) - prilistaprecios.CtoTot) / prilistaprecios.CtoTot * 100, 2).
    DISPLAY x-Margen WITH BROWSE {&browse-name}.
    APPLY 'LEAVE':U TO prilistaprecios.FactorCanal.
    APPLY 'LEAVE':U TO prilistaprecios.FactorGrupo.
END.
...
&Scoped-define SELF-NAME prilistaprecios.FactorCanal
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prilistaprecios.FactorCanal br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF prilistaprecios.FactorCanal IN BROWSE br_table /* % I-II */
DO:
    ASSIGN
        prilistaprecios.PreCanal:SCREEN-VALUE IN BROWSE {&browse-name} = STRING(
            ROUND(DECIMAL(SELF:SCREEN-VALUE) * 
                  DECIMAL(prilistaprecios.PreBas:SCREEN-VALUE IN BROWSE {&browse-name})
                  / 100, 4)
            ).
    APPLY 'LEAVE':U TO prilistaprecios.FactorGrupo.
END.
...
&Scoped-define SELF-NAME prilistaprecios.FactorGrupo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prilistaprecios.FactorGrupo br_table _BROWSE-COLUMN B-table-Win
ON LEAVE OF prilistaprecios.FactorGrupo IN BROWSE br_table /* % II-III */
DO:
    ASSIGN
        prilistaprecios.PreGrupo:SCREEN-VALUE IN BROWSE {&browse-name} =  STRING(
            ROUND(DECIMAL(prilistaprecios.PreCanal:SCREEN-VALUE IN BROWSE {&browse-name}) * 
...
ON FIND OF prilistaprecios DO:
    x-Margen = 0.
    IF prilistaprecios.CtoTot > 0 
        THEN x-Margen = ROUND((prilistaprecios.PreBas - prilistaprecios.CtoTot) / prilistaprecios.CtoTot * 100, 2).
END.
...
REPEAT WHILE AVAILABLE prilistaprecios:
    ...
    ASSIGN
        Detalle.CHR__01 = prilistaprecios.UndBas
    ...
    ASSIGN
        Detalle.Factor-1 = prilistaprecios.FactorCanal
        Detalle.Precio-1 = prilistaprecios.PreCanal
        Detalle.Factor-2 = prilistaprecios.FactorGrupo
        Detalle.Precio-2 = prilistaprecios.PreGrupo.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      prilistaprecios.PreCanal = ROUND(prilistaprecios.FactorCanal * prilistaprecios.PreBas / 100, 4).
  ASSIGN
      prilistaprecios.PreGrupo = ROUND(prilistaprecios.PreCanal * prilistaprecios.FactorGrupo / 100, 4).
  ASSIGN
      prilistaprecios.PreUni = prilistaprecios.PreGrupo.
  RUN dispatch IN THIS-PROCEDURE ('display-fields':U).

  /* Validaciones */
  IF prilistaprecios.PreUni < prilistaprecios.CtoTot THEN DO:
      MESSAGE 'El Precio Final es menor al Costo' VIEW-AS ALERT-BOX ERROR.
      APPLY 'ENTRY':U TO prilistaprecios.PreBas IN BROWSE {&browse-name}.
  ...
  ELSE 
      ASSIGN
          prilistaprecios.HoraModificacion = STRING(TIME, 'HH:MM:SS')
          prilistaprecios.FchModificacion = TODAY
          prilistaprecios.UsrModificacion = s-user-id.
...
REPEAT WHILE AVAILABLE prilistaprecios:
    ...
    FIND T-Resumen WHERE T-Resumen.codmat = prilistaprecios.CodMat NO-ERROR.
    IF NOT AVAILABLE T-Resumen THEN CREATE T-Resumen.
    T-Resumen.CodMat = prilistaprecios.CodMat.
    FIND PriCanal WHERE pricanal.CodCia = s-CodCia AND
        pricanal.Canal = prilistaprecios.Canal 
        NO-LOCK.
    FIND PriCanalGrupo WHERE pricanalgrupo.CodCia = s-CodCia AND
        pricanalgrupo.Canal = prilistaprecios.Canal AND
        pricanalgrupo.Grupo = prilistaprecios.Grupo
        NO-LOCK.
    CREATE T-Precios.
    ASSIGN
        T-Precios.Fila = LocalFila
        T-Precios.CodMat = prilistaprecios.CodMat 
        T-Precios.Canal = prilistaprecios.Canal 
        T-Precios.Grupo = prilistaprecios.Grupo 
        T-Precios.PreUni = prilistaprecios.PreUni 
        T-Precios.PreGrupo = prilistaprecios.PreGrupo
        T-Precios.FactorGrupo = (pricanal.Factor / 100) * (pricanalgrupo.Factor / 100).
    GET NEXT {&browse-name}.
END.
/* Validamos */
DEF VAR x-PreGrupo LIKE prilistaprecios.PreGrupo NO-UNDO.
RLOOP:
...
END.
ELSE DO:
    MESSAGE 'NO hay incosistencia entre de los precios de los canales de negociación'
