...
DEFINE VARIABLE RADIO-SET-2 AS INTE INIT 2 NO-UNDO.     /* Solo en Importes */
...
DEFINE BUTTON BUTTON-1 
     LABEL "GENERAR PLANTILLA EN EXCEL EN IMPORTES" 
     SIZE 44 BY 1.12
     FONT 6.
...
DEFINE FRAME F-Main
     ...
     RADIO-SET-Vigente AT ROW 11.77 COL 76 NO-LABEL WIDGET-ID 40
     x-DesMar AT ROW 12.23 COL 13 COLON-ALIGNED WIDGET-ID 16
     BUTTON-1 AT ROW 12.31 COL 30 WIDGET-ID 18
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - POR DIVISION"
         HEIGHT             = 25.54
         WIDTH              = 108.57
         MAX-HEIGHT         = 25.54
         MAX-WIDTH          = 143.57
...
ON END-ERROR OF W-Win /* PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - POR DIVISION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PREPARAR PLANTILLA DESCUENTOS PROMOCIONALES - POR DIVISION */
DO:
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* GENERAR PLANTILLA EN EXCEL EN IMPORTES */
DO:
