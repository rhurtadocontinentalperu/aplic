...
/* Todos los artículos relacionados deben tener la misma línea, sublínea y unidades base */
...
IF AVAILABLE B-VtaaDctoVolTime THEN DO:
    ...
    IF AVAILABLE B-Almmmatg THEN DO:
        IF B-Almmmatg.codfam <> Almmmatg.codfam OR
            ...
            THEN DO:
            MESSAGE 'Todos los artículos deben tener pertenecer a la misma línea' SKIP
                 'y sublínea y además tener las mismas unidades' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO VtaaDctoVolTime.CodMat.
            RETURN 'ADM-ERROR'.
        END.
    END.
