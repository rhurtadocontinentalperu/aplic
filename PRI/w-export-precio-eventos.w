...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 12.23 COL 45 WIDGET-ID 18
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PREPARAR PLANTILLA DE PRECIOS POR DIVISION"
         HEIGHT             = 25.62
         WIDTH              = 107.43
         MAX-HEIGHT         = 25.62
         MAX-WIDTH          = 111.14
...
ON END-ERROR OF W-Win /* PREPARAR PLANTILLA DE PRECIOS POR DIVISION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PREPARAR PLANTILLA DE PRECIOS POR DIVISION */
DO:
...
ASSIGN
    ...
    chWorkSheet:Range("L2"):Value = "CONFIG. DESCTOS.".
ASSIGN
    t-Row = 2.
FOR EACH Almmmatg NO-LOCK WHERE {&Condicion}, FIRST Almtfami OF Almmmatg NO-LOCK,
    FIRST Almsfami OF Almmmatg NO-LOCK
    ...
    IF AVAILABLE VtaListaMay THEN DO:
        CASE VtaListaMay.FlagDesctos:
            WHEN 1 THEN chWorkSheet:Cells(t-Row, t-Column):VALUE = "SIN DESCUENTOS".
            WHEN 0 THEN chWorkSheet:Cells(t-Row, t-Column):VALUE = "NORMAL".
        END CASE.
    END.
    ELSE chWorkSheet:Cells(t-Row, t-Column):VALUE = "NORMAL".
END.
chExcelApplication:VISIBLE = TRUE.
/* release com-handles */
RELEASE OBJECT chExcelApplication.      
