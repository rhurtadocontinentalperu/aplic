...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtadScaleGift.CodMat COLUMN-LABEL "Artículo" FORMAT "x(13)":U
...
"VtadScaleGift.CodMat" "Artículo" "x(13)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF VtadScaleGift.CodMat IN BROWSE br_table /* Artículo */
DO:
