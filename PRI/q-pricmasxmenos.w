...
&Scoped-define INTERNAL-TABLES PriCMasxMenos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH PriCMasxMenos WHERE ~{&KEY-PHRASE} ~
      AND PriCMasxMenos.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PriCMasxMenos WHERE ~{&KEY-PHRASE} ~
      AND PriCMasxMenos.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main PriCMasxMenos
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PriCMasxMenos
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.PriCMasxMenos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "PriCMasxMenos.CodCia = s-codcia"
