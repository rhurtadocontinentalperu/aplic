...
DEFINE VARIABLE h_b-lima-dctoprom-v2 AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN Replica-Plantilla IN h_b-lima-dctoprom-v2 ( INPUT pDivisiones /* CHARACTER */).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pri/b-lima-dctoprom-v2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lima-dctoprom-v2 ).
       RUN set-position IN h_b-lima-dctoprom-v2 ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-lima-dctoprom-v2 ( 16.96 , 90.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-lima-dtopromv2 ( 1.00 , 74.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-lima-dctoprom-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-lima-dctoprom-v2 ).
       RUN add-link IN adm-broker-hdl ( h_q-lima-dtopromv2 , 'Record':U , h_b-lima-dctoprom-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-lima-dctoprom-v2 ,
