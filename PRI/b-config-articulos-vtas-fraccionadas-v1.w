...
Almmmatg.DesMar Almmmatg.UndBas VtaListaMinGn.Chr__01 FacTabla.Valor[1] ~
FacTabla.Campo-D[1] FacTabla.Campo-D[2] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table FacTabla.Codigo ~
FacTabla.Valor[1] FacTabla.Campo-D[1] FacTabla.Campo-D[2] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 38.29
      Almmmatg.DesMar FORMAT "X(30)":U WIDTH 24.43
      Almmmatg.UndBas COLUMN-LABEL "Unidad!Base" FORMAT "X(8)":U
            WIDTH 5.43
      VtaListaMinGn.Chr__01 COLUMN-LABEL "Uni.Vta!Minorista" FORMAT "X(8)":U
            WIDTH 6.86
      FacTabla.Valor[1] COLUMN-LABEL "Multiplos!Venta" FORMAT ">>,>>9.99":U
            WIDTH 7.14 COLUMN-BGCOLOR 14 LABEL-FGCOLOR 9 LABEL-BGCOLOR 7 LABEL-FONT 6
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114.86 BY 14.54
         FONT 4.
...
"Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "38.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"Almmmatg.DesMar" ? ? "character" ? ? ? ? ? ? no ? no no "24.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaListaMinGn.Chr__01" "Uni.Vta!Minorista" ? "character" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacTabla.Valor[1]
"FacTabla.Valor[1]" "Multiplos!Venta" ">>,>>9.99" "decimal" 14 ? ? 7 9 6 yes ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacTabla.Campo-D[1]
"FacTabla.Campo-D[1]" "Vigencia!Desde" "99/99/9999" "date" 14 ? ? ? 9 6 yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.FacTabla.Campo-D[2]
...
ON 'RETURN':U OF factabla.codigo, factabla.campo-d[1], factabla.campo-d[2], factabla.valor[1] IN BROWSE {&BROWSE-NAME} DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
