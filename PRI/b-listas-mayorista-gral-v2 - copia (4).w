  ...
  IF INTEGER(T-MATG.MonVta:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) <> Almmmatg.MonVta THEN DO:
      ...
      IF INTEGER(T-MATG.MonVta:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 1 THEN DO:
          ...
          IF AVAILABLE VtaListaMinGn THEN
              DISPLAY VtaListaMinGn.PreOfi * Almmmatg.TpoCmb @ T-MATG.PreAlt[1] WITH BROWSE {&BROWSE-NAME}.
      END.
      ELSE DO:
          /* DOLARES */
          DISPLAY 
          ...
          IF AVAILABLE VtaListaMinGn THEN
              DISPLAY VtaListaMinGn.PreOfi / Almmmatg.TpoCmb @ T-MATG.PreAlt[1] WITH BROWSE {&BROWSE-NAME}.
      END.
      APPLY 'LEAVE':U TO T-MATG.PreAlt[1].
...
------------------------------------------------------------------------------*/
  ...
  IF Almmmatg.MonVta = Almmmatg.DsctoPro[1] THEN    /* MOneda LP vs Moneda Compra */
      ASSIGN
            Almmmatg.CtoTot = Almmmatg.DsctoPro[2].
  ELSE IF Almmmatg.MonVta = 1 THEN
      ASSIGN
            Almmmatg.CtoTot = Almmmatg.DsctoPro[2] * Almmmatg.TpoCmb.
  ELSE ASSIGN
            Almmmatg.CtoTot = Almmmatg.DsctoPro[2] / Almmmatg.TpoCmb.
  ASSIGN
