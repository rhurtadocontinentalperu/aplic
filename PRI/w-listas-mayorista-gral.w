...
DO:
   RUN Excel IN h_b-listas-mayorista-gral.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'PRI/b-listas-mayorista-gral.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listas-mayorista-gral ).
       RUN set-position IN h_b-listas-mayorista-gral ( 2.92 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-listas-mayorista-gral ( 24.23 , 189.00 ) NO-ERROR.
