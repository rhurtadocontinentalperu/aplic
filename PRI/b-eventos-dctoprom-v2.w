...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDctoProm.PrecioVIP COLUMN-LABEL "Precio VIP" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 10
      ...
      VtaDctoProm.PrecioMR COLUMN-LABEL "Precio Mesa!Redonda" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
      ...
      VtaDctoProm.Precio COLUMN-LABEL "Precio Otros" FORMAT ">>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      fPreVta(VtaDctoProm.Precio,2)  @ x-Precio COLUMN-LABEL "Precio Otros!US$" FORMAT ">>>,>>9.9999":U
      VtaDctoProm.Tipo FORMAT "x(15)":U WIDTH 13.43
  ENABLE
      VtaDctoProm.FchIni
      VtaDctoProm.FchFin
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 165 BY 7.81
         FONT 4
...
"VtaDctoProm.PrecioVIP" "Precio VIP" ? "decimal" 10 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDctoProm.PrecioMR" "Precio Mesa!Redonda" ? "decimal" 14 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaDctoProm.Precio" "Precio Otros" ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > "_<CALC>"
"fPreVta(VtaDctoProm.Precio,2)  @ x-Precio" "Precio Otros!US$" ">>>,>>9.9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.VtaDctoProm.Tipo
"VtaDctoProm.Tipo" ? ? "character" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF VtaDctoProm.PrecioVIP IN BROWSE br_table /* Precio VIP */
DO:
...
ON LEAVE OF VtaDctoProm.PrecioMR IN BROWSE br_table /* Precio Mesa!Redonda */
DO:
...
ON LEAVE OF VtaDctoProm.Precio IN BROWSE br_table /* Precio Otros */
DO:
