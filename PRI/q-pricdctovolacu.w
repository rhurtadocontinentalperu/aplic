...
&Scoped-define INTERNAL-TABLES PriCDtoVolAcu

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH PriCDtoVolAcu WHERE ~{&KEY-PHRASE} ~
      AND PriCDtoVolAcu.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PriCDtoVolAcu WHERE ~{&KEY-PHRASE} ~
      AND PriCDtoVolAcu.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main PriCDtoVolAcu
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PriCDtoVolAcu
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.PriCDtoVolAcu"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "PriCDtoVolAcu.CodCia = s-codcia"
