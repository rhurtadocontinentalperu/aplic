...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 7.73 COL 70 HELP
          "Salida"
...
ON END-ERROR OF W-Win /* INGRESO A CAJA - Otros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* INGRESO A CAJA - Otros */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 7.73 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-remesa ).
       RUN set-position IN h_q-remesa ( 7.92 , 3.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_q-remesa , 'Record':U , h_v-remesa-01 ).
