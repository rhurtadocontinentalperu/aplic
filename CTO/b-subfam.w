...
&Scoped-Define ENABLED-OBJECTS RECT-9 br_table 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      AlmSFami.subfam
      AlmSFami.dessub FORMAT "X(40)"
      AlmSFami.Orden FORMAT ">>>9"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 42.29 BY 7.46
         BGCOLOR 15 FONT 4
         TITLE BGCOLOR 15 "Sub-Familias".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     br_table AT ROW 1.23 COL 1.72
...
/* BROWSE-TAB br_table RECT-9 F-Main */
ASSIGN 
...
"AlmSFami.dessub" ? "X(40)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > integral.AlmSFami.Orden
"AlmSFami.Orden" ? ">>>9" "integer" ? ? ? ? ? ? no ?
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN AlmSFami.CodCia = AlmTFami.CodCia 
