...
&Scoped-define QUERY-STRING-br_table FOR EACH PR-ODPC WHERE ~{&KEY-PHRASE} ~
    ...
    BY PR-ODPC.FchOrd DESCENDING INDEXED-REPOSITION
...
FILL-IN-filtro F-PROVEE br_table BUTTON-1 
...
DEFINE FRAME F-Main
     ...
     br_table AT ROW 3.35 COL 86.72 RIGHT-ALIGNED
     BUTTON-1 AT ROW 14.46 COL 76 HELP
          "Salida"
     RECT-1 AT ROW 14.38 COL 1.14
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "INTEGRAL.PR-ODPC.FchOrd|no"
     _Where[1]         = "{&Condicion}"
