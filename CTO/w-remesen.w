...
DEF NEW SHARED VAR s-tipo   AS CHAR INITIAL "SENCILLO".
...
ON END-ERROR OF W-Win /* Remesa de Sencillo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Remesa de Sencillo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_q-remesa-01 ( 8.12 , 3.00 ) NO-ERROR.
