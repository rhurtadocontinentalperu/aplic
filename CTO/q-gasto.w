...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PR-GASTOS WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY PR-GASTOS.Fchcre DESCENDING INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main PR-GASTOS
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PR-GASTOS


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-27 BUTTON-3 
...
DEFINE FRAME FRAME-C
     BUTTON-3 AT ROW 1.23 COL 2.14
     RECT-27 AT ROW 1.08 COL 1.29
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "INTEGRAL.PR-GASTOS.Fchcre|no"
     _Design-Parent    is WINDOW q-tables @ ( 1.23 , 4.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-3 q-tables
ON CHOOSE OF BUTTON-3 IN FRAME FRAME-C /* Button 3 */
DO:
