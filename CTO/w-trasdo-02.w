...
DEFINE TEMP-TABLE DEPO-1 NO-UNDO LIKE INTEGRAL.Ccbcdocu.
DEFINE TEMP-TABLE DEPO-2 NO-UNDO LIKE INTEGRAL.Ccbcdocu.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: DEPO-1 T "?" NO-UNDO INTEGRAL Ccbcdocu
      TABLE: DEPO-2 T "?" NO-UNDO INTEGRAL Ccbcdocu
   END-TABLES.
 */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-1 BUTTON-1 BUTTON-2 COMBO-BOX-1 BROWSE-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    END.
    FOR EACH DEPO-2:
      FIND Ccbcdocu OF DEPO-2 EXCLUSIVE-LOCK NO-ERROR.
      IF AVAILABLE DEPO-2 THEN DO:
        Ccbcdocu.coddiv = SUBSTRING(COMBO-BOX-1:SCREEN-VALUE, 1, 5).
      END.
      DELETE DEPO-2.
    END.
    RUN Carga-Temporal.
