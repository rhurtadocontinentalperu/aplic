...
DEFINE BUFFER TALMA FOR Almacen.
...
DEF VAR RB-REPORT-NAME AS CHAR INITIAL "Almacenes".
...
Almacen.AutMov Almacen.TdoArt Almacen.CorrIng Almacen.CorrSal Almacen.Clave ~
Almacen.flgrep 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almacen WHERE ~{&KEY-PHRASE} ~
      AND Almacen.CodCia = S-CODCIA SHARE-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table SHARE-LOCK NO-WAIT DISPLAY
      ...
      Almacen.AutMov COLUMN-LABEL "Autoriza!Despacho"
      Almacen.TdoArt
      Almacen.CorrIng COLUMN-LABEL "Correlativo!Ingreso"
      Almacen.CorrSal
      Almacen.Clave FORMAT "X(10)"
      Almacen.flgrep COLUMN-LABEL "Propio" FORMAT "Si/No"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DO:
  ...
  IF RETURN-VALUE = 'NO':U THEN DO:  
     Almacen.CodAlm:READ-ONLY IN BROWSE {&BROWSE-NAME} = YES.
     APPLY "ENTRY":U TO Almacen.Descripcion.
  END.
  ELSE DO:
       Almacen.CodAlm:READ-ONLY IN BROWSE {&BROWSE-NAME} = NO.
       APPLY "ENTRY":U TO Almacen.CodAlm. 
       RETURN NO-APPLY.
  END.
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN Almacen.CodCia = S-CODCIA.
...
------------------------------------------------------------------------------*/
FIND TALMA WHERE TALMA.CodCia = S-CODCIA AND
     TALMA.CodAlm = INPUT BROWSE {&BROWSE-NAME} Almacen.CodAlm NO-LOCK NO-ERROR.
IF AVAILABLE TALMA AND ROWID(TALMA) <> ROWID(Almacen) THEN DO:
