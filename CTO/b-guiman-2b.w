...
DEFINE SHARED TEMP-TABLE T-RDOC LIKE INTEGRAL.CcbRdocu.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      T-RDOC.codmat COLUMN-LABEL "Articulo"
      T-RDOC.DesMat FORMAT "X(40)"
      T-RDOC.DesMar COLUMN-LABEL "Marca" FORMAT "X(15)"
      T-RDOC.CanDes FORMAT ">>>,>>>,>>9.9999"
      T-RDOC.UndVta FORMAT "X(6)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"INTEGRAL.T-RDOC.codmat" "Articulo" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > Temp-Tables.T-RDOC.DesMat
"INTEGRAL.T-RDOC.DesMat" ? "X(40)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > Temp-Tables.T-RDOC.DesMar
"INTEGRAL.T-RDOC.DesMar" "Marca" "X(15)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > Temp-Tables.T-RDOC.CanDes
"INTEGRAL.T-RDOC.CanDes" ? ">>>,>>>,>>9.9999" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[5]   > Temp-Tables.T-RDOC.UndVta
"INTEGRAL.T-RDOC.UndVta" ? "X(6)" "character" ? ? ? ? ? ? no ?
