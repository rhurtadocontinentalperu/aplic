...
CcbTabla.Afecto CcbTabla.Codcta s-nomcta @ s-nomcta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbTabla.Codigo COLUMN-LABEL " Codigo" FORMAT "x(5)":U
      CcbTabla.Nombre FORMAT "x(50)":U
      CcbTabla.Afecto FORMAT "Si/No":U
      CcbTabla.Codcta FORMAT "x(10)":U
      s-nomcta @ s-nomcta COLUMN-LABEL "Descripcion" FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 81 BY 9.42
         FONT 4.
...
"CcbTabla.Codigo" " Codigo" ? "character" ? ? ? ? ? ? no "Codigo de auxiliar" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.CcbTabla.Nombre
"CcbTabla.Nombre" ? "x(50)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.CcbTabla.Afecto
...
"s-nomcta @ s-nomcta" "Descripcion" "x(30)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON FIND OF CcbTabla 
DO:
   FIND CB-Ctas WHERE CB-Ctas.Codcia = cb-codcia AND CB-Ctas.CodCta = ccbtabla.Codcta 
        NO-LOCK NO-ERROR.
