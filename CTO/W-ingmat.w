...
&Scoped-Define ENABLED-OBJECTS Btn-GenPed BUTTON-1 
...
DEFINE FRAME F-Main
     Btn-GenPed AT ROW 9.46 COL 70
     BUTTON-1 AT ROW 6.38 COL 79 HELP
          "Salida"
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-trfsal ).
       RUN set-position IN h_v-trfsal ( 2.73 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico-2 ).
       RUN set-position IN h_p-navico-2 ( 6.38 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-alctrf ).
       RUN set-position IN h_q-alctrf ( 6.58 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-salida ).
       RUN set-position IN h_b-salida ( 8.12 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.92 , 81.43 ) */
