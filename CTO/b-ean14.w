...
&Scoped-define INTERNAL-TABLES Almmmat1 Almmmatg

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Almmmat1.codmat Almmmatg.DesMat ~
Almmmat1.Barras[1] 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almmmat1 WHERE ~{&KEY-PHRASE} ~
      ...
      EACH Almmmatg OF Almmmat1 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Almmmat1 Almmmatg
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almmmat1.codmat
      Almmmatg.DesMat
      Almmmat1.Barras[1] COLUMN-LABEL "EAN 14"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Almmmat1,INTEGRAL.Almmmatg OF INTEGRAL.Almmmat1"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.Almmmat1.CodCia = s-codcia"
     _FldNameList[1]   = INTEGRAL.Almmmat1.codmat
     _FldNameList[2]   = INTEGRAL.Almmmatg.DesMat
     _FldNameList[3]   > INTEGRAL.Almmmat1.Barras[1]
"Almmmat1.Barras[1]" "EAN 14" ? "character" ? ? ? ? ? ? no ?
...
ON LEAVE OF Almmmat1.codmat IN BROWSE br_table /* Codigo Articulo */
DO:
  ASSIGN
  ...
  THEN DISPLAY Almmmatg.desmat WITH BROWSE {&BROWSE-NAME}.
END.
...
ON RETURN OF Almmmat1.Barras[1], Almmmat1.codmat DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
