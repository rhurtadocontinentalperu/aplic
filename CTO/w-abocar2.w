...
&Scoped-Define ENABLED-OBJECTS C-NroSer BUTTON-1 
...
DEFINE FRAME F-Main
     C-NroSer AT ROW 5.42 COL 2 NO-LABEL
     BUTTON-1 AT ROW 5.42 COL 77 HELP
          "Salida"
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 5.23 , 25.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-abocar2 ).
       RUN set-position IN h_q-abocar2 ( 5.42 , 10.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-abocar2 ).
       RUN set-position IN h_b-abocar2 ( 7.15 , 5.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpnot2 ).
       RUN set-position IN h_b-tmpnot2 ( 6.77 , 3.00 ) NO-ERROR.
