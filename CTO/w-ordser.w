  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-ordser ).
       RUN set-position IN h_q-ordser ( 1.38 , 83.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ordser ).
       RUN set-position IN h_t-ordser ( 12.92 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.04 , 110.29 ) */
