...
"CtoLis" "Costo!S/IGV" "->,>>9.9999" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[11]   > integral.Almmmatg.CtoTot
"CtoTot" "Costo!Lista Total" "->,>>9.9999" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[12]   > integral.Almmmatg.MrgAlt[1]
"MrgAlt[1]" "% Margen!Utilidad" ? "decimal" 14 0 ? ? ? ? no ?
     _FldNameList[13]   > integral.Almmmatg.UndAlt[1]
"UndAlt[1]" "U.M." "x(6)" "character" 14 0 ? ? ? ? no ?
     _FldNameList[14]   > integral.Almmmatg.PreAlt[1]
"PreAlt[1]" "Precio!x Menor" ? "decimal" 14 0 ? ? ? ? no ?
...
"PreOfi" ? ">>>,>>9.9999" "decimal" 12 15 ? ? ? ? no ?
