...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCpedi.FchVen < TODAY NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS br_table COMBO-BOX-3 wclient wcotiza 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacCPedi.NroPed COLUMN-LABEL "Cotización" FORMAT "XXX-XXXXXXXX"
      FacCPedi.NomCli FORMAT "x(40)"
      FacCPedi.CodVen COLUMN-LABEL "Vend." FORMAT "XXXX"
      FacCPedi.FchPed COLUMN-LABEL "    Fecha    !   Emisión" FORMAT "99/99/99"
      FacCPedi.fchven COLUMN-LABEL "    Fecha    !    Vcmto." COLUMN-BGCOLOR 11
      X-VTA @ X-VTA COLUMN-LABEL "Tip. !Vta." FORMAT "xxxx"
