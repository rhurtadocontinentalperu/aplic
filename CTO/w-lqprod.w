...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 7.35 COL 76 HELP
          "Salida"
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 11.50 , 85.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cto/v-lqprod.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-lqprod ).
       RUN set-position IN h_v-lqprod ( 2.31 , 1.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lqprodx ).
       RUN set-position IN h_b-lqprodx ( 8.69 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 3.62 , 83.86 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 7.27 , 11.14 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 1.42 , 18.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cto/q-liqopd.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-liqopd ).
       RUN set-position IN h_q-liqopd ( 7.38 , 1.72 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lqpromt ).
       RUN set-position IN h_b-lqpromt ( 2.27 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 8.85 , 83.86 ) */
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lqprome ).
       RUN set-position IN h_b-lqprome ( 2.35 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 8.85 , 83.86 ) */
    ...
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lqprose ).
       RUN set-position IN h_b-lqprose ( 2.15 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 8.85 , 83.86 ) */
    ...
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-lqprohh ).
       RUN set-position IN h_b-lqprohh ( 2.23 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 8.85 , 83.86 ) */
