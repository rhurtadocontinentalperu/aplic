...
&Scoped-Define ENABLED-OBJECTS BUTTON-9 BUTTON-1 
...
DEFINE FRAME F-Main
     BUTTON-9 AT ROW 5.23 COL 51
     BUTTON-1 AT ROW 5.04 COL 64 HELP
          "Salida"
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_p-navico ( 3.65 , 5.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cto/b-dcaja1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-dcaja1 ).
       RUN set-position IN h_b-dcaja1 ( 6.58 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.50 , 66.00 ) */
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-dcaja1-01 ( 4.92 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.65 , 64.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 7.92 , 66.14 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
   IF Pagina = 1 THEN BUTTON-9:HIDDEN = YES.
   IF Pagina = 2 THEN BUTTON-9:HIDDEN = NO.
  END.
