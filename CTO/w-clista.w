...
&Scoped-Define ENABLED-OBJECTS RECT-11 BUTTON-1 BUTTON-2 BUTTON-4 
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 73
     BUTTON-2 AT ROW 1 COL 82
     BUTTON-4 AT ROW 18.31 COL 82 HELP
          "Salida"
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 1.00 , 51.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_b-dlista , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-clista ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-11 BUTTON-1 BUTTON-2 BUTTON-4 
