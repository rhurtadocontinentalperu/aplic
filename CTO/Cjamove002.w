...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW-DETALLE W-Maestro _STRUCTURED
  QUERY BRW-DETALLE NO-LOCK DISPLAY
      ...
      cb-dmov.Codaux COLUMN-LABEL "Auxiliar" FORMAT "x(13)"
...
DEFINE FRAME F-maestro
     ...
     cb-cmov.CodAux AT ROW 4.85 COL 10.57 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     cb-cmov.NroVou AT ROW 11.96 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .69
     cb-cmov.Girado AT ROW 12.73 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 70 BY .69
     cb-cmov.NotAst AT ROW 13.5 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 70 BY .69
     ...
     cb-cmov.FchAst AT ROW 2.31 COL 32.57 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     cb-cmov.Usuario AT ROW 11.96 COL 33 COLON-ALIGNED
          LABEL "Autor"
          VIEW-AS FILL-IN 
          SIZE 11.72 BY .69
     ...
     cb-cmov.NroChq AT ROW 4.85 COL 48.57 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 15 BY .69
     cb-cmov.ImpChq AT ROW 11.96 COL 55 COLON-ALIGNED
          LABEL "Total"
          VIEW-AS FILL-IN 
          SIZE 17 BY .69
          BGCOLOR 7 FGCOLOR 15 
...
/* SETTINGS FOR BUTTON b-d-Asigna IN FRAME F-maestro
   NO-ENABLE                                                            */
ASSIGN 
       b-d-Asigna:HIDDEN IN FRAME F-maestro           = TRUE.
...
"cb-dmov.Codcta" "Cuenta" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.cb-dmov.Codaux
"cb-dmov.Codaux" "Auxiliar" "x(13)" "character" ? ? ? ? ? ? no ?
...
"cb-dmov.CodDiv" "Division." ? "character" ? ? ? ? ? ? no ?
...
------------------------------------------------------------------------------*/
  ...
  ENABLE R-consulta R-exit B-first B-prev B-next B-last B-browse B-exit 
