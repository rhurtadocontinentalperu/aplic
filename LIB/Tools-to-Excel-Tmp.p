...
/* call: Run browser-to-Excel (browser-handle). */
...
*run pi-crea-archivo-csv(input  buffer tt-data:handle,
*                        input  session:temp-directory + "file",
*                        output c-csv-file).

*run pi-crea-archivo-xls(input  buffer tt-data:handle,
*                        input  c-csv-file,
*                        output c-xls-file).
