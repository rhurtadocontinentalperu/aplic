...
&Scoped-Define ENABLED-OBJECTS Btn-down-3 RECT-6 IMAGE-1 RECT-8 RECT-7 ~
R-salida R-rango FILL-IN-copias Btn_OK Btn-up-3 Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS R-salida CMB-impresora FILL-IN-archivo ~
...
DEFINE FRAME D-Dialog
     Btn-down-1 AT ROW 9.73 COL 23.29
     Btn-down-2 AT ROW 9.73 COL 33.57
     Btn-down-3 AT ROW 9.73 COL 57.57
     R-salida AT ROW 4.08 COL 3 NO-LABEL
     Btn-impresoras AT ROW 5.23 COL 15
     Btn-up-1 AT ROW 9.27 COL 23.29
     CMB-impresora AT ROW 5.42 COL 20 NO-LABEL
     Btn-archivos AT ROW 6.19 COL 15
     FILL-IN-archivo AT ROW 6.38 COL 18 COLON-ALIGNED NO-LABEL
     R-rango AT ROW 8.69 COL 4 NO-LABEL
     FILL-IN-pagini AT ROW 9.35 COL 15 COLON-ALIGNED
     FILL-IN-pagfin AT ROW 9.35 COL 25.29 COLON-ALIGNED
     FILL-IN-copias AT ROW 9.35 COL 51 COLON-ALIGNED
     Btn-up-2 AT ROW 9.27 COL 33.57
     Btn_OK AT ROW 11 COL 36
     Btn-up-3 AT ROW 9.27 COL 57.57
     Btn_Cancel AT ROW 11 COL 50
     " Copias:" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 7.92 COL 41
     " Salida a:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 1.19 COL 4
     " Rango de Impresion:" VIEW-AS TEXT
          SIZE 15.14 BY .5 AT ROW 7.92 COL 4
     RECT-6 AT ROW 8.12 COL 2
     IMAGE-1 AT ROW 1.58 COL 14.86
     RECT-8 AT ROW 1.38 COL 2
     RECT-7 AT ROW 8.12 COL 39
     SPACE(1.56) SKIP(1.91)
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Salida de impresión */
DO:  
...
DO:
    ...
    IF R-Salida = 3 THEN DO:
        IF FILL-IN-archivo = "" THEN DO:
            MESSAGE
                "Ingrese nombre del archivo de impresión"
    ...
    IF R-Salida <> 2 THEN s-nro-copias = 1.
...
------------------------------------------------------------------------------*/
  DISPLAY R-salida CMB-impresora FILL-IN-archivo R-rango FILL-IN-pagini 
          FILL-IN-pagfin FILL-IN-copias 
      WITH FRAME D-Dialog.
  ENABLE Btn-down-3 RECT-6 IMAGE-1 RECT-8 RECT-7 R-salida R-rango 
         FILL-IN-copias Btn_OK Btn-up-3 Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  IF s-nro-copias > 1 THEN FILL-IN-copias = s-nro-copias.
