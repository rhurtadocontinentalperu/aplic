...
DEF INPUT-OUTPUT PARAMETER pArchivo AS CHAR.
...
Btn-archivos Btn_OK Btn_Cancel 
...
ON WINDOW-CLOSE OF FRAME gDialog /* EXPORTAR A FORMATO EXCEL */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-FileType RADIO-SET-Grid RADIO-SET-Labels FILL-IN-archivo 
      WITH FRAME gDialog.
  ENABLE RADIO-SET-FileType FILL-IN-archivo Btn-archivos Btn_OK Btn_Cancel 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
...
------------------------------------------------------------------------------*/
  ...
  FILL-IN-archivo = pArchivo.

  RUN SUPER.

  /* Code placed here will execute AFTER standard behavior.    */
/*   DO WITH FRAME {&FRAME-NAME}:                                     */
/*       IF pArchivo > '' THEN DISABLE  Btn-archivos FILL-IN-archivo. */
/*   END.                                                             */
