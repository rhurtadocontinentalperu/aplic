...
DEF VAR pTiempoLimite AS INT64 INIT 300 NO-UNDO.     /* En milisegundos */
...
DEFINE FRAME D-Dialog
     FILL-IN-1 AT ROW 2.08 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     FILL-IN-2 AT ROW 3.96 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-1 FILL-IN-2 
      WITH FRAME D-Dialog.
  ENABLE FILL-IN-1 FILL-IN-2 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
