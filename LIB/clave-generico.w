...
DEFINE INPUT  PARAMETER Titulo      AS CHAR.
DEFINE INPUT  PARAMETER Etiqueta    AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS x-Password Btn_OK Btn_Cancel 
...
DEFINE FRAME D-Dialog
     x-Password AT ROW 1.77 COL 12 COLON-ALIGNED WIDGET-ID 2 PASSWORD-FIELD 
     Btn_OK AT ROW 3.69 COL 6
     Btn_Cancel AT ROW 3.69 COL 21
     SPACE(29.13) SKIP(0.49)
...
DO:
    x-cont = x-cont + 1.
    s-clave = x-Password:SCREEN-VALUE.
...
x-Password:LABEL IN FRAME {&FRAME-NAME} = Etiqueta.

ON 'RETURN':U OF x-Password
DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY x-Password 
      WITH FRAME D-Dialog.
  ENABLE x-Password Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
