...
RUN lib/gethostname.r(OUTPUT vLocalHostName).
...
PROCEDURE readhandler:
 ...
 /* Used to Build MIME Message Body */
  ...
  IF vlength > 0 THEN DO:
    ...
    ASSIGN str = cExtraResp + GET-STRING(vbuffer,1)
...
PROCEDURE dofiles:
  ...
  IF cFileType = "Binary" THEN DO:
    ...
    */
    RUN lib/base64encodev10.r(cBinaryFile, cLocalFile) NO-ERROR.
...
{lib/smtpmail-socket-timezone.i}
