...
function pro_importStr              returns char    ( pcStr as char, input-output piCursor as int ) {1}.
function pro_importInt              returns int     ( pcStr as char, input-output piCursor as int ) {1}.
function pro_importDec              returns dec     ( pcStr as char, input-output piCursor as int ) {1}.
function pro_importDate             returns date    ( pcStr as char, input-output piCursor as int ) {1}.
