...
function err_catch              returns log     ( output pcError as char, output pcErrorMsg as char, output pcErrorParam as char, output pcStackTrace as char ) {1}.
function err_throw              returns log     ( input pcError as char, input pcErrorParam as char, input pcFileName as char ) {1}.
function err_throwExact         returns log     ( input pcError as char, input pcErrorMsg as char, pcErrorParam as char, pcStackTrace as char ) {1}.
