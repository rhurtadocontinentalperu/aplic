...
AND ( TRUE <> (CMB-Estado > '') OR CcbCDocu.flgest = CMB-Estado ) ~
...
AND (x-CodMon = 3 OR CcbCDocu.codmon = x-codmon) ~
AND ( TRUE <> (FILL-IN-FlgAte > '') OR CcbCDocu.FlgAte = FILL-IN-FlgAte)
...
&Scoped-define INTERNAL-TABLES CcbCDocu gn-ConVt cb-tabl cb-ctas
...
gn-ConVt.Nombr CcbCDocu.NroRef ~
fEstado(CcbCDocu.FlgEst,CcbCDocu.FlgEst) @ x-Estado CcbCDocu.FchAte ~
fMoneda(CcbCDocu.CodMon) @ x-Moneda CcbCDocu.ImpTot CcbCDocu.SdoAct ~
CcbCDocu.FlgAte CcbCDocu.NomCli cb-tabl.Nombre CcbCDocu.CodCta ~
cb-ctas.Nomcta CcbCDocu.usuario CcbCDocu.FlgUbi CcbCDocu.FchUbi ~
CcbCDocu.FchDoc ~
...
&Scoped-define QUERY-STRING-br_table FOR EACH CcbCDocu WHERE ~{&KEY-PHRASE} ~
      ...
      FIRST cb-tabl WHERE cb-tabl.Codigo = CcbCDocu.FlgAte ~
      AND cb-tabl.Tabla = "04" OUTER-JOIN NO-LOCK, ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH CcbCDocu WHERE ~{&KEY-PHRASE} ~
      ...
      AND cb-ctas.CodCia = cb-codcia OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table CcbCDocu gn-ConVt cb-tabl cb-ctas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table CcbCDocu
&Scoped-define SECOND-TABLE-IN-QUERY-br_table gn-ConVt
&Scoped-define THIRD-TABLE-IN-QUERY-br_table cb-tabl
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table cb-ctas
...
FILL-IN-NroDoc Cmb-Division x-CodMon FILL-IN-FlgAte Btn_Excel Cmb-convta ~
...
Cmb-convta x-Totales x-Totales-2 CMB-Estado x-Saldos x-Saldos-2 ~
FILL-IN-Importe x-FchDoc-1 x-FchDoc-2 
...
FUNCTION fEstado RETURNS CHARACTER
  ( INPUT cCodDoc AS CHAR, INPUT cEstado AS CHAR )  FORWARD.
...
DEFINE VARIABLE x-Saldos-2 AS DECIMAL FORMAT "->>,>>>,>>9.99":U INITIAL 0 
     LABEL "T. Saldo US$" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .81
     BGCOLOR 9 FGCOLOR 15 FONT 1 NO-UNDO.
...
DEFINE VARIABLE x-Totales-2 AS DECIMAL FORMAT "->>,>>>,>>9.99":U INITIAL 0 
     LABEL "Total US$" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .81
     BGCOLOR 9 FGCOLOR 15 FONT 1 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.NroRef COLUMN-LABEL "<N° Operación>" FORMAT "X(12)":U
            WIDTH 11
      fEstado(CcbCDocu.FlgEst,CcbCDocu.FlgEst) @ x-Estado COLUMN-LABEL "<<<Estado>>>"
      ...
      IF CcbCDocu.imptot <> CcbCDocu.sdoact THEN fINgCaja(CcbCDocu.NroDoc, CcbCDocu.CodCli) ELSE '' @ x-IngCaja COLUMN-LABEL "<<<Ingreso a Caja>>>" FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     FILL-IN-NroDoc AT ROW 1.19 COL 95 COLON-ALIGNED
     Cmb-Division AT ROW 2.08 COL 14 COLON-ALIGNED
     FILL-IN-Division AT ROW 2.08 COL 29 COLON-ALIGNED NO-LABEL
     x-CodMon AT ROW 2.12 COL 97 NO-LABEL
     FILL-IN-FlgAte AT ROW 2.88 COL 95 COLON-ALIGNED
     Btn_Excel AT ROW 2.88 COL 135 WIDGET-ID 22
     ...
     x-Totales AT ROW 3.69 COL 95 COLON-ALIGNED
     x-Totales-2 AT ROW 3.69 COL 119 COLON-ALIGNED WIDGET-ID 26
     CMB-Estado AT ROW 3.81 COL 16.14 NO-LABEL
     x-Saldos AT ROW 4.5 COL 95 COLON-ALIGNED
     x-Saldos-2 AT ROW 4.54 COL 119 COLON-ALIGNED WIDGET-ID 24
     ...
     "Moneda:" VIEW-AS TEXT
          SIZE 6.86 BY .5 AT ROW 2.27 COL 90.14
     RECT-40 AT ROW 1 COL 85
...
/* SETTINGS FOR FILL-IN x-Saldos IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-Saldos-2 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-Totales IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-Totales-2 IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.CcbCDocu,INTEGRAL.gn-ConVt WHERE INTEGRAL.CcbCDocu ...,INTEGRAL.cb-tabl WHERE INTEGRAL.CcbCDocu ...,INTEGRAL.cb-ctas WHERE INTEGRAL.CcbCDocu ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST OUTER, FIRST OUTER, FIRST OUTER"
     _Where[1]         = "{&CONDICION}"
     _JoinCode[2]      = "INTEGRAL.gn-ConVt.Codig = INTEGRAL.CcbCDocu.FmaPgo"
     _JoinCode[3]      = "cb-tabl.Codigo = CcbCDocu.FlgAte"
     _Where[3]         = "cb-tabl.Tabla = ""04"""
     _JoinCode[4]      = "cb-ctas.Codcta = CcbCDocu.CodCta"
     _Where[4]         = "cb-ctas.CodCia = cb-codcia"
     _FldNameList[1]   > INTEGRAL.CcbCDocu.NroDoc
"CcbCDocu.NroDoc" "<<Numero>>" "X(15)" "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fEstado(CcbCDocu.FlgEst,CcbCDocu.FlgEst) @ x-Estado" "<<<Estado>>>" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbCDocu.SdoAct" "<<<Saldo>>>" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.CcbCDocu.FlgAte
"CcbCDocu.FlgAte" "Banco" "x(5)" "character" ? ? ? ? ? ? no "Código de banco" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.CcbCDocu.NomCli
"CcbCDocu.NomCli" "Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.cb-tabl.Nombre
"cb-tabl.Nombre" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   = INTEGRAL.CcbCDocu.CodCta
     _FldNameList[14]   = INTEGRAL.cb-ctas.Nomcta
     _FldNameList[15]   > INTEGRAL.CcbCDocu.usuario
"CcbCDocu.usuario" "Solicitante" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > INTEGRAL.CcbCDocu.FlgUbi
"CcbCDocu.FlgUbi" "Autorizó" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > INTEGRAL.CcbCDocu.FchUbi
"CcbCDocu.FchUbi" "Fecha!Autorizacion" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > INTEGRAL.CcbCDocu.FchDoc
"CcbCDocu.FchDoc" "<Emision>" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > "_<CALC>"
"IF CcbCDocu.imptot <> CcbCDocu.sdoact THEN fINgCaja(CcbCDocu.NroDoc, CcbCDocu.CodCli) ELSE '' @ x-IngCaja" "<<<Ingreso a Caja>>>" "x(30)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
    ...
    DO WHILE NOT QUERY-OFF-END("{&BROWSE-NAME}"):
        ...
        END.
        ELSE DO:
            x-Totales-2 = x-Totales-2 + ccbcdocu.imptot.
            x-Saldos-2  = x-Saldos-2  + ccbcdocu.sdoact.
        END.
...
------------------------------------------------------------------------------*/
    ...
    chWorkSheet:Range("A1:T3"):FONT:Bold = TRUE.
    ...
    chWorkSheet:Range("Q3"):Value = "Fecha Autorizacion".

    chWorkSheet:Range("R3"):Value = "Cod Cliente".
    chWorkSheet:Range("S3"):Value = "RUC".
    chWorkSheet:Range("T3"):Value = "DNI".
    ...
    REPEAT WHILE AVAILABLE Ccbcdocu:
        ...
        END.
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):VALUE = fEstado(ccbcdocu.coddoc, ccbcdocu.flgest).
        cRange = "M" + cColumn.
        ...
        IF AVAILABLE gn-clie THEN DO:
            ...
            cRange = "T" + cColumn.                                                               
            chWorkSheet:Range(cRange):VALUE = gn-clie.DNI.
        END.
...
FUNCTION fEstado RETURNS CHARACTER
  ( INPUT cCodDoc AS CHAR, INPUT cEstado AS CHAR ) :
/*------------------------------------------------------------------------------
  Purpose:  
    Notes:  
------------------------------------------------------------------------------*/
...
RUN gn/fFlgEstCCBv2 (cCodDoc, cEstado, OUTPUT pEstado).
RETURN pEstado.
