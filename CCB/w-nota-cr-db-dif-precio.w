...
DEFINE INPUT PARAMETER pParam AS CHAR NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/b-nota-cr-db-dif-precio.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listado-pnc-dif-precio-ind ).
       RUN set-position IN h_b-listado-pnc-dif-precio-ind ( 2.08 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-listado-pnc-dif-precio-ind ( 8.15 , 132.57 ) NO-ERROR.
       ...
       RUN set-position IN h_b-listado-pnc-dif-precio-ind-d ( 10.69 , 2.00 ) NO-ERROR.
