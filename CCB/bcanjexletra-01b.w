...
CcbCDocu.FchDoc CcbCDocu.FchVto C-MON[CcbCDocu.CodMon] CcbCDocu.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      C-MON[CcbCDocu.CodMon] COLUMN-LABEL "Mon." WIDTH 8.43
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 15.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 67 BY 5.38
...
/* Query rebuild information for BROWSE br_table
  ...
  AND INTEGRAL.CcbDMvto.NroDoc = INTEGRAL.CcbCMvto.NroDoc"
     _Where[1]         = "INTEGRAL.CcbDMvto.TpoRef = ""L"""
...
"CcbDMvto.NroRef" ? "X(12)" "character" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"C-MON[CcbCDocu.CodMon]" "Mon." ? ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.CcbCDocu.ImpTot
"CcbCDocu.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "15.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  CASE Ccbcdocu.coddoc:
      ...
      WHEN "FAC" THEN RUN VTA\R-IMPFAC2-1 (ROWID(CcbCDocu)).
  END CASE.
