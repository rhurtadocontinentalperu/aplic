...
DEFINE VAR x-estados AS CHAR INIT "P,AP".
...
&SCOPED-DEFINE CONDICION ( ~
        ...
        LOOKUP(ccbcdocu.flgest,x-estados) > 0 ) 
...
DEF SHARED VAR s-Tipo   AS CHAR INIT "CREDITO".
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 132.57 BY 7.08
         FONT 4.
...
DO:
  ...
  IF ccbcdocu.flgest = 'P' OR ccbcdocu.flgest = 'AP' THEN DO:
      ...
      RUN ccb/d-nota-cr-db-dif-precio.r(INPUT ccbcdocu.coddiv, 
