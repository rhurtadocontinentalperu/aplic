...
IF LOOKUP(ENTRY(1,s-Tipo), 'NC,ND') > 0 THEN s-coddoc = SUBSTRING(s-Tipo,1,1) + '/' + SUBSTRING(s-Tipo,2,1).
ELSE s-CodDoc = ENTRY(1,s-Tipo).
s-TpoFac = (IF ENTRY(2,s-Tipo) = "N" THEN "" ELSE ENTRY(2,s-Tipo)).

CASE s-coddoc:
    WHEN 'ND' THEN s-tabla = 'N/D'.
    WHEN 'NC' OR WHEN 'NCI' THEN s-tabla = 'N/C'.
...
DEFINE FRAME F-Main
     C-NroSer AT ROW 1.19 COL 53 NO-LABEL
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 1.19 , 72.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-abocar2 ).
       RUN set-position IN h_v-abocar2 ( 2.73 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-abocar2 ).
       RUN set-position IN h_q-abocar2 ( 1.19 , 61.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-abocar2 ,
             h_p-navico , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-abocar2 ).
       RUN set-position IN h_b-abocar2 ( 7.15 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpnot2 ).
       RUN set-position IN h_b-tmpnot2 ( 7.15 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 7.15 , 75.00 ) NO-ERROR.
