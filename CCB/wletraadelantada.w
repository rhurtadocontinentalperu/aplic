...
&Scoped-Define ENABLED-OBJECTS RECT-25 COMBO-NroSer BUTTON-PRELETRA 
...
DEFINE FRAME F-Main
     ...
     BUTTON-PRELETRA AT ROW 7.46 COL 67 WIDGET-ID 6
     RECT-25 AT ROW 2.54 COL 2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 106.72 BY 20.73
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/vletraadelantada.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vletraadelantada ).
       RUN set-position IN h_vletraadelantada ( 2.73 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv14 , 'TableIO':U , h_vletraadelantada ).
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_vletraadelantada ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-02 ( 7.46 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aderec ).
       RUN set-position IN h_b-aderec ( 15.73 , 2.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_b-aderec ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/tletraadelantada-02.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tletraadelantada-02 ).
       RUN set-position IN h_tletraadelantada-02 ( 7.46 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 8.62 , 82.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_tcanjexletra-03 ( 7.46 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 8.62 , 67.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-25 COMBO-NroSer BUTTON-PRELETRA 
      WITH FRAME F-Main IN WINDOW W-Win.
...
CASE L-Handle:
    WHEN "Pre-Letra" THEN DO:
        IF VALID-HANDLE(h_qcanjexletra) THEN RUN dispatch IN h_qcanjexletra ('open-query':U).
    END.
