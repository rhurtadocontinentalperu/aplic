...
&Scoped-Define ENABLED-OBJECTS br_table COMBO-BOX-NroSer f-NroLet ~
FILL-IN-ImpTot BUTTON-2 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-NroSer f-LetIni f-NroLet ~
FILL-IN-ImpTot f-ImpTot 
...
DEFINE VARIABLE f-ImpTot AS DECIMAL FORMAT "ZZZZ,ZZ9.99":U INITIAL 0 
     LABEL "Importe Total" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX-NroSer AT ROW 1.19 COL 18 COLON-ALIGNED WIDGET-ID 2
     f-LetIni AT ROW 2.15 COL 18 COLON-ALIGNED WIDGET-ID 4
     f-NroLet AT ROW 3.12 COL 18 COLON-ALIGNED WIDGET-ID 18
     FILL-IN-ImpTot AT ROW 4.08 COL 18 COLON-ALIGNED WIDGET-ID 20
     BUTTON-2 AT ROW 5.42 COL 6 WIDGET-ID 16
...
DO:
  ASSIGN
      COMBO-BOX-NroSer f-NroLet f-LetIni FILL-IN-ImpTot.
  IF F-LetIni = 0 THEN DO:
     APPLY "ENTRY" TO F-LetIni.
     RETURN NO-APPLY.
  END.
  IF FILL-IN-ImpTot <= 0 THEN DO:
      APPLY "NETRY" TO FILL-IN-ImpTot.
      RETURN NO-APPLY.
  END.
  RUN Genera-Letras.
