...
&ENDIF
    ...
    ASSIGN
        ...
        Detalle.Aval_1_1 = ENTRY(1,gn-clie.aval1[1],'|')
        Detalle.Aval_1_2 = (IF NUM-ENTRIES(gn-clie.aval1[1],'|') > 1 THEN ENTRY(2,gn-clie.aval1[1],'|') ELSE '')
        Detalle.Aval_2 = gn-clie.aval2[1]
        .
...
/*         END.                                                                                */
        ...
        FOR EACH Gn-ClieL 
            ...
            IF pImpLCred = 0 THEN Detalle.LinCredIni = YEAR(gn-cliel.fchini).
