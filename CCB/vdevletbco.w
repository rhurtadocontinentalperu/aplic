...
CcbCMvto.CodMon CcbCMvto.Glosa CcbCMvto.TpoCmb 
...
CcbCMvto.FchDoc CcbCMvto.CodCta CcbCMvto.CodAge CcbCMvto.CodMon ~
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  MESSAGE 'Acceso Denegado' SKIP(1)
      'Tiene que enviar nuevamente la letra al Banco'
