...
&Scoped-define INTERNAL-TABLES T-ClieL gn-clie Gn-ClieL t-report
...
T-ClieL.LCImpDiv[1] T-ClieL.LCImpDiv[2] 
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-9 t-report.Campo-C[1] ~
t-report.Campo-C[3] t-report.Campo-C[2] t-report.Campo-C[4] ~
t-report.Campo-C[5] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-9 
&Scoped-define QUERY-STRING-BROWSE-9 FOR EACH t-report NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-9 OPEN QUERY BROWSE-9 FOR EACH t-report NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-9 t-report
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-9 t-report
...
RADIO-SET-FlgAut BROWSE-1 BROWSE-9 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 W-Win _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      T-ClieL.LCImpDiv[1] COLUMN-LABEL "Div. 00150!ATLAS" FORMAT ">>>,>>>,>>9.99":U
      T-ClieL.LCImpDiv[2] COLUMN-LABEL "Div. 00070!PERU COMPRAS" FORMAT ">>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 140 BY 11.35
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-9 W-Win _STRUCTURED
  QUERY BROWSE-9 NO-LOCK DISPLAY
      t-report.Campo-C[1] COLUMN-LABEL "Cliente" FORMAT "X(8)":U
      t-report.Campo-C[3] COLUMN-LABEL "Fecha de Termino" FORMAT "X(8)":U
            WIDTH 15.72
      t-report.Campo-C[2] COLUMN-LABEL "Linea de Credito" FORMAT "X(8)":U
            WIDTH 13.43
      t-report.Campo-C[4] COLUMN-LABEL "Div. 00150 ATLAS" FORMAT "X(8)":U
            WIDTH 15.43
      t-report.Campo-C[5] COLUMN-LABEL "Div. 00070 PERU COMPRAS" FORMAT "X(8)":U
            WIDTH 20.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 79 BY 2.15
         FONT 4 FIT-LAST-COLUMN.
...
DEFINE FRAME F-Main
     ...
     BtnDone AT ROW 1.27 COL 136 WIDGET-ID 98
     RADIO-SET-FlgAut AT ROW 1.54 COL 74 NO-LABEL WIDGET-ID 104
     BROWSE-1 AT ROW 2.73 COL 3 WIDGET-ID 200
     BROWSE-9 AT ROW 15.54 COL 8 WIDGET-ID 500
     FILL-IN-Mensaje AT ROW 18.69 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 102
     "1" VIEW-AS TEXT
          SIZE 3 BY .81 AT ROW 15.54 COL 5 WIDGET-ID 116
          BGCOLOR 8 FGCOLOR 0 FONT 6
     "A              |B                          |C" VIEW-AS TEXT
          SIZE 39 BY .5 AT ROW 15 COL 8 WIDGET-ID 112
          BGCOLOR 8 FGCOLOR 0 FONT 6
     "|D                          | E" VIEW-AS TEXT
          SIZE 39 BY .5 AT ROW 15 COL 47 WIDGET-ID 114
          BGCOLOR 8 FGCOLOR 0 FONT 6
     ...
     "<<-- La primera línea debe contener los encabezados de las columnas" VIEW-AS TEXT
          SIZE 48 BY .5 AT ROW 15.54 COL 87 WIDGET-ID 92
     "3" VIEW-AS TEXT
          SIZE 3 BY .81 AT ROW 16.88 COL 5 WIDGET-ID 120
          BGCOLOR 8 FGCOLOR 0 FONT 6
     "2" VIEW-AS TEXT
          SIZE 3 BY .81 AT ROW 16.08 COL 5 WIDGET-ID 118
          BGCOLOR 8 FGCOLOR 0 FONT 6
...
/* BROWSE-TAB BROWSE-9 BROWSE-1 F-Main */
...
"Temp-Tables.T-ClieL.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-clie.NomCli
"INTEGRAL.gn-clie.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "47.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-ClieL.FchIni
"Temp-Tables.T-ClieL.FchIni" "Fecha de Inicio" "99/99/9999" "date" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-ClieL.FchFin
"Temp-Tables.T-ClieL.FchFin" "Fecha de Termino" "99/99/9999" "date" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-ClieL.ImpLC
"Temp-Tables.T-ClieL.ImpLC" "Linea de Credito!Propuesta S/." ? "decimal" 11 0 ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.Gn-ClieL.ImpLC
"INTEGRAL.Gn-ClieL.ImpLC" "Linea de Credito!Actual S/." ? "decimal" 14 0 ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-ClieL.LCImpDiv[1]
"Temp-Tables.T-ClieL.LCImpDiv[1]" "Div. 00150!ATLAS" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-ClieL.LCImpDiv[2]
"Temp-Tables.T-ClieL.LCImpDiv[2]" "Div. 00070!PERU COMPRAS" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
"t-report.Campo-C[1]" "Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-report.Campo-C[3]
"t-report.Campo-C[3]" "Fecha de Termino" ? "character" ? ? ? ? ? ? no ? no no "15.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.t-report.Campo-C[2]
"t-report.Campo-C[2]" "Linea de Credito" ? "character" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.t-report.Campo-C[4]
"t-report.Campo-C[4]" "Div. 00150 ATLAS" ? "character" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.t-report.Campo-C[5]
"t-report.Campo-C[5]" "Div. 00070 PERU COMPRAS" ? "character" ? ? ? ? ? ? no ? no no "20.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-9 */
&ANALYZE-RESUME
...
FOR EACH T-CLIEL, FIRST gn-clie OF T-ClieL EXCLUSIVE-LOCK
    ...
    IF gn-clie.FlagAut = "A" THEN DO:
        ...
        RUN lib/logtabla ("gn-clie",
                          ...
                          "AUTORIZA-LIN-CRED").
    END.
    /* Grabamos valores por defecto */
    ASSIGN
        B-CLIEL.LCImpDiv[1] = T-CLIEL.LCImpDiv[1]
        B-CLIEL.LCImpDiv[2] = T-CLIEL.LCImpDiv[2]
        B-CLIEL.LCCodDiv[1] = '00150'    /* ATLAS */
        B-CLIEL.LCCodDiv[2] = '00070'.   /* PERU COMPRAS */
...
IF AVAILABLE(B-CLIEL)  THEN RELEASE B-CLIEL.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 RECT-34 BUTTON-Excel BUTTON-2 BtnDone RADIO-SET-FlgAut BROWSE-1 
         BROWSE-9 
      WITH FRAME F-Main IN WINDOW W-Win.
...
SYSTEM-DIALOG GET-FILE FILL-IN-file
    FILTERS "Archivos Excel (*.xls,*.xlxs)" "*.xls,*.xlsx", "Todos (*.*)" "*.*"
...
REPEAT:
    ...
    ASSIGN
        ...
        NO-ERROR.
    IF ERROR-STATUS:ERROR THEN DO:
        MESSAGE 'ERROR en el formato de fecha línea' iCountLine
    ...
    cValue = chWorkSheet:Range(cRange):VALUE.
    IF cValue = ? THEN cValue = '0.00'.
    ASSIGN
        T-CLIEL.LCImpDiv[1] = DECIMAL (cValue)
        NO-ERROR.
    IF ERROR-STATUS:ERROR THEN DO:
        MESSAGE 'Valor' cValue 'no reconocido:' cValue SKIP
            'Campo: Div. 00150 ATLAS' VIEW-AS ALERT-BOX ERROR.
        NEXT.
    END.
    /* PERU COMPRAS */
    ...
    IF cValue = ? THEN cValue = '0.00'.
    ASSIGN
        T-CLIEL.LCImpDiv[2] = DECIMAL (cValue)
        NO-ERROR.
    IF ERROR-STATUS:ERROR THEN DO:
        MESSAGE 'Valor' cValue 'no reconocido:' cValue SKIP
            'Campo: Div. 00070 PERU COMPRAS' VIEW-AS ALERT-BOX ERROR.
        NEXT.
    END.
END.
