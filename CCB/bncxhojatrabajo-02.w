...
&Scoped-define INTERNAL-TABLES FacDPedi Almmmatg CcbDDocu
...
CcbDDocu.ImpLin FacDPedi.PreUni FacDPedi.CanApr FacDPedi.ImpLin ~
CcbDDocu.ImpLin - FacDPedi.ImpLin @ x-Diferencia 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH FacDPedi OF FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST Almmmatg OF FacDPedi NO-LOCK, ~
      FIRST CcbDDocu WHERE CcbDDocu.CodCia = FacDPedi.CodCia ~
  AND CcbDDocu.codmat = FacDPedi.codmat ~
      AND CcbDDocu.CodDoc = Faccpedi.codref ~
 AND CcbDDocu.NroDoc = Faccpedi.nroref NO-LOCK ~
    BY FacDPedi.NroItm
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacDPedi OF FacCPedi WHERE ~{&KEY-PHRASE} NO-LOCK, ~
 ...
 AND CcbDDocu.NroDoc = Faccpedi.nroref NO-LOCK ~
    BY FacDPedi.NroItm.
&Scoped-define TABLES-IN-QUERY-br_table FacDPedi Almmmatg CcbDDocu
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbDDocu.ImpLin COLUMN-LABEL "Importe!Comprobante" FORMAT ">,>>>,>>9.99":U
            WIDTH 10.57
      FacDPedi.PreUni COLUMN-LABEL "Unitario!Hoja Cálculo" FORMAT ">>,>>9.9999":U
            WIDTH 9.14
      FacDPedi.CanApr COLUMN-LABEL "Percepción!Hoja Cálculo" FORMAT ">>>,>>9.99":U
            WIDTH 9.43
      FacDPedi.ImpLin COLUMN-LABEL "Importe!Hoja Cálculo" FORMAT ">,>>>,>>9.99":U
            WIDTH 9.43
      CcbDDocu.ImpLin - FacDPedi.ImpLin @ x-Diferencia COLUMN-LABEL "Diferencia" FORMAT "->>>,>>9.99":U
            WIDTH 8.57 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 134 BY 11.04
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.Almmmatg OF INTEGRAL.FacDPedi,INTEGRAL.CcbDDocu WHERE INTEGRAL.FacDPedi ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST"
     _OrdList          = "INTEGRAL.FacDPedi.NroItm|yes"
     _JoinCode[3]      = "CcbDDocu.CodCia = FacDPedi.CodCia
  AND CcbDDocu.codmat = FacDPedi.codmat"
     _Where[3]         = "CcbDDocu.CodDoc = Faccpedi.codref
...
"CcbDDocu.ImpLin" "Importe!Comprobante" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.FacDPedi.PreUni
"FacDPedi.PreUni" "Unitario!Hoja Cálculo" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacDPedi.CanApr
"FacDPedi.CanApr" "Percepción!Hoja Cálculo" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.ImpLin
"FacDPedi.ImpLin" "Importe!Hoja Cálculo" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"CcbDDocu.ImpLin - FacDPedi.ImpLin @ x-Diferencia" "Diferencia" "->>>,>>9.99" ? 14 0 ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
