...
/*AND LOOKUP(Ccbcdocu.coddoc, 'FAC,BOL,TCK,LET,N/D,CHC,CHD,CHQ,N/C,A/R,A/C,BD') > 0 */ ~
...
RECT-8 RECT-61 RECT-58 B-Imprimir BUTTON-2 b-Carta b-Depositos BUTTON-8 ~
F-Estado F-CodDoc BUTTON-1 BUTTON-9 x-FchDoc-1 x-FchDoc-2 r-TpoDoc ~
x-Statbr_table 
&Scoped-Define DISPLAYED-OBJECTS F-LinCre f-MonLC F-CreUsa F-Estado ~
F-CodDoc F-Credis x-FchDoc-1 x-FchDoc-2 r-TpoDoc FILL-IN-ImpTot-1 ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 108 BY 6.58
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     r-TpoDoc AT ROW 3.88 COL 3 NO-LABEL
...
/* BROWSE-TAB x-Statbr_table r-TpoDoc F-Main */
ASSIGN 
