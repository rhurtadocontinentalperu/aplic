...
&SCOPED-DEFINE FILTRO1 ( Vtacdocu.NomCli BEGINS FILL-IN-NomCli )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Vtacdocu.NomCli , FILL-IN-NomCli ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table VtaCDocu.CodCli VtaCDocu.NomCli ~
VtaCDocu.CodOri VtaCDocu.NroOri VtaCDocu.CodDiv 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaCDocu WHERE ~{&KEY-PHRASE} ~
      AND VtaCDocu.CodCia = s-codcia ~
 AND VtaCDocu.CodPed = "PRP" ~
 AND VtaCDocu.Cmpbnte = "CREDITO" ~
 AND VtaCDocu.FlgEst = "P" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-NroSer COMBO-BOX-Filtro ~
FILL-IN-NomCli br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-NroSer COMBO-BOX-Filtro ~
FILL-IN-NomCli 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaCDocu.NomCli
Nombres que contengan|y||INTEGRAL.VtaCDocu.NomCli
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.CodOri COLUMN-LABEL "Doc Caja" FORMAT "x(3)":U
      VtaCDocu.NroOri COLUMN-LABEL "Nro Doc Caja" FORMAT "x(15)":U
      VtaCDocu.CodDiv COLUMN-LABEL "Division Caja" FORMAT "x(5)":U
            WIDTH 16.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 86 BY 6.69
...
DEFINE FRAME F-Main
     COMBO-BOX-NroSer AT ROW 1.19 COL 17 COLON-ALIGNED WIDGET-ID 8
     COMBO-BOX-Filtro AT ROW 2.15 COL 17 COLON-ALIGNED WIDGET-ID 4
     FILL-IN-NomCli AT ROW 2.15 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 6
...
/* Query rebuild information for BROWSE br_table
 ...
 AND VtaCDocu.FlgEst = ""P"""
     _FldNameList[1]   = INTEGRAL.VtaCDocu.CodCli
     _FldNameList[2]   = INTEGRAL.VtaCDocu.NomCli
     _FldNameList[3]   > INTEGRAL.VtaCDocu.CodOri
"CodOri" "Doc Caja" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaCDocu.NroOri
"NroOri" "Nro Doc Caja" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaCDocu.CodDiv
"CodDiv" "Division Caja" ? "character" ? ? ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH Faccorre NO-LOCK WHERE Faccorre.codcia = 1
          ...
          COMBO-BOX-NroSer = Faccorre.nroser.
      END.
  END.
