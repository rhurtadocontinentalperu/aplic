...
DEF SHARED VAR s-NumDoc AS CHARACTER.
...
&Scoped-Define DISPLAYED-FIELDS CcbCCgoC.NroDoc CcbCCgoC.CodCob ~
CcbCCgoC.Fecha CcbCCgoC.Hora 
...
DEFINE FRAME F-Main
     CcbCCgoC.NroDoc AT ROW 1.38 COL 7 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     CcbCCgoC.CodCob AT ROW 2.35 COL 7 COLON-ALIGNED
          LABEL "Cobrador"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     x-nombre AT ROW 2.35 COL 15 COLON-ALIGNED NO-LABEL
     CcbCCgoC.Fecha AT ROW 1.38 COL 69 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     CcbCCgoC.Hora AT ROW 2.35 COL 69 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   FIND FIRST GN-COB WHERE
        gn-cob.Codcia = s-codcia AND
        gn-cob.CodCob = Ccbccgoc.CodCob
        EXCLUSIVE-LOCK NO-ERROR.
        IF AVAILABLE Gn-Cob THEN DO:
           DISPLAY 
            gn-cob.NomCob  @ x-nombre
