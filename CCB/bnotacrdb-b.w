...
&Scoped-define DATA-FIELD-DEFS "aplic/ccb/dccbddocu.i"
...
rowObject.PreUni rowObject.x-FactorDescuento ~
rowObject.cImporteTotalConImpuesto 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.DesMat FORMAT "X(70)":U WIDTH 70.29
      rowObject.DesMar FORMAT "X(12)":U WIDTH 12.43
      rowObject.UndVta FORMAT "x(10)":U WIDTH 6.86
      rowObject.CanDes FORMAT ">>>,>>9.99":U WIDTH 6.43
      rowObject.PreUni FORMAT ">>>,>>9.9999":U WIDTH 10.43
      rowObject.x-FactorDescuento FORMAT ">>9.99999":U WIDTH 9.43
      rowObject.cImporteTotalConImpuesto FORMAT ">,>>>,>>9.99":U
            WIDTH 4.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 140 BY 12.92
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "aplic\ccb\dccbddocu.w"
   Allow: Basic,Browse
   Frames: 1
...
"rowObject.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "70.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.DesMar
"rowObject.DesMar" ? ? "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.UndVta
"rowObject.UndVta" ? ? "character" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > _<SDO>.rowObject.CanDes
"rowObject.CanDes" ? ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > _<SDO>.rowObject.PreUni
"rowObject.PreUni" ? ? "decimal" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > _<SDO>.rowObject.x-FactorDescuento
"rowObject.x-FactorDescuento" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > _<SDO>.rowObject.cImporteTotalConImpuesto
"rowObject.cImporteTotalConImpuesto" ? ? "decimal" ? ? ? ? ? ? no ? no no "4.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
