...
DEFINE VARIABLE h_v-boldep-02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/v-boldep-02.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-boldep-02 ).
       RUN set-position IN h_v-boldep-02 ( 1.12 , 1.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 1.12 , 79.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 12.73 , 18.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-docmto-02 ( 12.73 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.15 , 16.00 ) */

       /* Links to SmartViewer h_v-boldep-02. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_v-boldep-02 ).
       RUN add-link IN adm-broker-hdl ( h_q-docmto-02 , 'Record':U , h_v-boldep-02 ).
