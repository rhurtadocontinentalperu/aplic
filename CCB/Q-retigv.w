...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCDocu WHERE ~{&KEY-PHRASE} ~
 ...
 AND CcbCDocu.CodDoc = S-CODDOC NO-LOCK ~
...
DEFINE VARIABLE F-Numero AS CHARACTER FORMAT "X(12)":U INITIAL "0" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME FRAME-A
     F-Numero AT ROW 1.15 COL 1.72 NO-LABEL
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND integral.CcbCDocu.CodDoc = S-CODDOC"
     _Design-Parent    is WINDOW q-tables @ ( 1 , 12.14 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
