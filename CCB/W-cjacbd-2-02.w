...
DO:
  ...
  /*
    @CJM = CIman 21Jul2014 para validar si el dia ya fue procesado
            tanto por el proceso x dia (@CJ) o el Mensual (@CJM)
*/
    ...
    FIND FIRST cb-control WHERE
        ...
        (cb-control.tipo    = '@CJ' OR cb-control.tipo    = '@CJM') AND
