...
FILL-IN-NroCarta FILL-IN-Atencion FILL-IN-Fijo FILL-IN-Movil FILL-IN-Mail ~
BROWSE-1 BUTTON-1 BUTTON-3 Btn_Done 
&Scoped-Define DISPLAYED-OBJECTS txt-fchcorte r-filtro FILL-IN-CodCli ~
FILL-IN-NomCli FILL-IN-NroCarta FILL-IN-Atencion FILL-IN-Fijo FILL-IN-Movil ~
FILL-IN-Mail 
...
DEFINE VARIABLE FILL-IN-Atencion AS CHARACTER FORMAT "X(50)":U INITIAL "AREA DE FINANZAS" 
     LABEL "ATENCION" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Atencion AT ROW 3.15 COL 50 COLON-ALIGNED WIDGET-ID 20
     ...
     BUTTON-1 AT ROW 16.77 COL 55
     BUTTON-3 AT ROW 16.77 COL 66
     Btn_Done AT ROW 16.77 COL 77
...
DO:
  ASSIGN FILL-IN-NroCarta FILL-IN-Fijo FILL-IN-Mail FILL-IN-Movil FILL-IN-Atencion.
  RUN Imprimir.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY txt-fchcorte r-filtro FILL-IN-CodCli FILL-IN-NomCli FILL-IN-NroCarta 
          FILL-IN-Atencion FILL-IN-Fijo FILL-IN-Movil FILL-IN-Mail 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-fchcorte r-filtro FILL-IN-CodCli FILL-IN-NroCarta FILL-IN-Atencion 
         FILL-IN-Fijo FILL-IN-Movil FILL-IN-Mail BROWSE-1 BUTTON-1 BUTTON-3 
         Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Carta Notarialv2'.   
  ...
  RB-OTHER-PARAMETERS = "~ncImpTotLet = " + x-EnLetras + 
                        ...
                        "~ncMail = " + FILL-IN-Mail +
                        "~ncFijoX = " + FILL-IN-Fijo +
                        "~ncAtencion = " + FILL-IN-Atencion.
