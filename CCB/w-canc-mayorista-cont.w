...
DEFINE VARIABLE h_b-canc-mayorista-cont AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN proc_CanPed IN h_b-canc-mayorista-cont.
...
DO:
    RUN dispatch IN h_b-canc-mayorista-cont ('open-query-cases':U).
    RUN proc_CalTot IN h_b-canc-mayorista-cont.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'CCB/b-canc-mayorista-cont.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-canc-mayorista-cont ).
       RUN set-position IN h_b-canc-mayorista-cont ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-canc-mayorista-cont ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-canc-mayorista-cont ,
