...
DEFINE VARIABLE COMBO-BOX_CodDoc AS CHARACTER FORMAT "x(3)" INITIAL "FAC" 
     ...
     LIST-ITEMS "FAC","BOL","LET","CHQ","N/C","N/D","DCO" 
     DROP-DOWN-LIST
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* DOCUMENTO A CASTIGAR */
DO:  
...
DO:
  ...
  IF NOT AVAILABLE ccbcdocu THEN DO:
    ...
    RETURN NO-APPLY.
  END.
  IF ccbcdocu.flgest <> 'J' THEN DO:
    MESSAGE 'El documento NO está EN COBRANZA DUDOSA' VIEW-AS ALERT-BOX ERROR.
    RETURN NO-APPLY.
  END.
  MESSAGE 'Desea proceder a castigar el documento?' VIEW-AS ALERT-BOX QUESTION
