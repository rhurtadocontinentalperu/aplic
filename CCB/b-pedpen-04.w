...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Faccpedi.ImpTot FORMAT "->>>>,>>9.99":U COLUMN-FONT 1
...
"Faccpedi.ImpTot" ? "->>>>,>>9.99" "decimal" ? ? 1 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*             FIND FIRST Ccbddocu OF Ccbcdocu WHERE Ccbddocu.codmat = Facdpedi.codmat NO-ERROR. */
...
/*             END.                                                                              */
/*             ASSIGN                                                                            */
/*                 Ccbddocu.CanDes = Ccbddocu.CanDes + Facdpedi.CanPed                           */
/*                 Ccbddocu.ImpIgv = Ccbddocu.ImpIgv + Facdpedi.ImpIgv                           */
/*                 Ccbddocu.ImpIsc = Ccbddocu.ImpIsc + Facdpedi.ImpIsc                           */
/*                 Ccbddocu.ImpDto = Ccbddocu.ImpDto + Facdpedi.ImpDto                           */
/*                 Ccbddocu.ImpLin = Ccbddocu.ImpLin + Facdpedi.ImpLin.                          */
            /* Guarda Costos */
...
ASSIGN
    ...
    /*Busca Promocion*/
    /*RUN vtagn/r-promociones-04 (d_rowid,OUTPUT cMess).      */
    ...
    DO TRANSACTION ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN 'ADM-ERROR':
        ...
        /* CREACION DE COMPROBANTES A PARTIR DE LAS ORDENES DE DSPACHO */
        ...
        IF AVAILABLE CcbCDocu THEN DO:
            IF Ccbcdocu.CodDoc = "FAC" THEN DO:
                CASE Ccbcdocu.coddiv:
                    ...
                    WHEN '00026' THEN RUN VTA/R-IMPFAC2-2 (ROWID(CcbCDocu)).
