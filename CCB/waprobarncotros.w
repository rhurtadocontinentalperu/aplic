...
&Scoped-define QUERY-STRING-BROWSE-10 FOR EACH CcbCDocu ~
 ...
 AND CcbCDocu.FlgEst = "X" NO-LOCK, ~
  ...
  AND CcbTabla.Codigo = CcbDDocu.codmat NO-LOCK, ~
      EACH tt-w-report-conceptos WHERE tt-w-report-conceptos.Llave-C = CcbCDocu.CodCta NO-LOCK INDEXED-REPOSITION
...
&Scoped-define FOURTH-TABLE-IN-QUERY-BROWSE-10 tt-w-report-conceptos
...
/* Query rebuild information for BROWSE BROWSE-10
     _TblList          = "INTEGRAL.CcbCDocu,INTEGRAL.CcbDDocu OF INTEGRAL.CcbCDocu,INTEGRAL.CcbTabla WHERE INTEGRAL.CcbDDocu ...,Temp-Tables.tt-w-report-conceptos WHERE INTEGRAL.CcbCDocu ..."
 ...
 AND INTEGRAL.CcbCDocu.FlgEst = ""X"""
  ...
  AND INTEGRAL.CcbTabla.Codigo = INTEGRAL.CcbDDocu.codmat"
     _JoinCode[4]      = "Temp-Tables.tt-w-report-conceptos.Llave-C = CcbCDocu.CodCta"
