...
CcbCDocu.FmaPgo CcbCDocu.FchAte CcbCDocu.FlgAte CcbCDocu.CodMon ~
CcbCDocu.NroRef CcbCDocu.TpoFac CcbCDocu.TpoCmb CcbCDocu.CodCta ~
CcbCDocu.Glosa CcbCDocu.CodAge CcbCDocu.ImpTot CcbCDocu.SdoAct ~
CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.CodDiv CcbCDocu.FlgUbi ~
CcbCDocu.FchUbi CcbCDocu.usuario 
...
DEFINE FRAME F-Main
     ...
     CcbCDocu.FchDoc AT ROW 1.27 COL 25.29 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     F-Estado AT ROW 1.27 COL 55.29 COLON-ALIGNED
...
"US$", 2
     ...
     CcbCDocu.NroRef AT ROW 4.46 COL 14 COLON-ALIGNED
          LABEL "Nro. Deposito" FORMAT "X(6)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81 TOOLTIP "Ingrese los últimos 6 dígitos de la derecha"
...
DEFINE FRAME F-Main
     "Multi" VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 11.38 COL 67 WIDGET-ID 2
     "Moneda" VIEW-AS TEXT
...
IF NOT AVAILABLE gn-divi THEN DO:
    MESSAGE 'La division(' + pCoddiv + ") No existe!!!"
        VIEW-AS ALERT-BOX ERROR.
    RETURN 'ADM-ERROR'.
END.

IF gn-divi.campo-log[1] = YES THEN DO:
    MESSAGE 'La division(' + pCoddiv + ") esta INACTIVA!!!"
        VIEW-AS ALERT-BOX ERROR.
    RETURN 'ADM-ERROR'.
END.
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    ASSIGN
        ...
        Ccbcdocu.CodDiv:SCREEN-VALUE = pCodDiv.
    FIND GN-DIVI WHERE gn-divi.codcia = s-codcia
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      END.
  END.
  ELSE Ccbcdocu.FchDoc = TODAY. /* Modificado */
  ASSIGN
...
/*             AND B-Ccbcdocu.FchAte = INPUT Ccbcdocu.FchAte         */
/*             AND LOOKUP(B-Ccbcdocu.FlgEst, "A,R") = 0              */
