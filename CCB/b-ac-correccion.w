...
AND CcbCDocu.CodDoc = s-coddoc AND CcbCDocu.FlgEst = s-flgest)
...
CcbCDocu.SdoAct CcbCDocu.PorDto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table CcbCDocu.PorDto 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.PorDto COLUMN-LABEL "Tasa %" FORMAT ">>9.99":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
      CcbCDocu.PorDto
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 100 BY 15.35
         FONT 4.
...
"CcbCDocu.SdoAct" "Saldo" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.CcbCDocu.PorDto
"CcbCDocu.PorDto" "Tasa %" ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
