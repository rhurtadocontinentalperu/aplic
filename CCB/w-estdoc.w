...
DEFINE VARIABLE h_b-estdoc AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 110.43 BY 16.69 WIDGET-ID 100.
...
ON END-ERROR OF sW-Win /* Estado de Documentos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sW-Win sW-Win
ON WINDOW-CLOSE OF sW-Win /* Estado de Documentos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/b-estdoc.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-estdoc ).
       RUN set-position IN h_b-estdoc ( 1.04 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-estdoc ( 15.88 , 108.00 ) NO-ERROR.
