...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ASIENTO POR REFINANCIACION DE LETRAS"
         HEIGHT             = 15.58
         WIDTH              = 92.57
         MAX-HEIGHT         = 15.58
         MAX-WIDTH          = 92.57
...
ON END-ERROR OF W-Win /* ASIENTO POR REFINANCIACION DE LETRAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ASIENTO POR REFINANCIACION DE LETRAS */
DO:
