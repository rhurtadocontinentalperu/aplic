...
DEF SHARED VAR s-numdoc AS CHAR init "".
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCCgoC WHERE ~{&KEY-PHRASE} ~
      AND CcbCCgoC.CodCia = s-codcia ~
 AND CcbCCgoC.CodDiv = s-coddiv ~
 AND CcbCCgoC.CodDoc = s-coddoc ~
 NO-LOCK ~
    BY CcbCCgoC.NroDoc DESCENDING INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main CcbCCgoC
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main CcbCCgoC
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.CcbCCgoC"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _OrdList          = "INTEGRAL.CcbCCgoC.NroDoc|no"
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    AQUI SE DEBE LLAMAR AL PROGRAMA DE CONSULTA*/
      RUN LKUP\c-busccgo.w ("Lista de cargos").
