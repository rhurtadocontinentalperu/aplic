...
Customer.Phone Customer.State 
&Scoped-Define DISPLAYED-OBJECTS x-name 
...
DEFINE VARIABLE x-name AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     Customer.Cust-Num AT ROW 4 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     Customer.Name AT ROW 5 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
     Customer.Phone AT ROW 6 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
     Customer.State AT ROW 7.19 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
     x-name AT ROW 7.19 COL 41 COLON-ALIGNED NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sport.Customer
...
/* SETTINGS FOR FILL-IN x-name IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    ...
    do with frame {&frame-name}:
        ...
        if  available state
        then x-name:screen-value = state.state-name.
        else x-name:screen-value = '-'.
    end.
