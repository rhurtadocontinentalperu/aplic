...
"Docu-2.ImpTot" "Importe Rebade" ? "decimal" ? ? ? ? ? ? no ? no no "15.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-7 */
&ANALYZE-RESUME
...
/* LAS NOTAS DE CREDITO SERAN APROBADAS EN UN PROCESO POSTERIOR */
...
REPEAT:
    ...
    cValue = chWorkSheet:Range(cRange):VALUE.
    ASSIGN
        /*DOCU.NroDoc = STRING(DECIMAL(cValue), '99999999999')*/
        DOCU.NroDoc = cValue
        NO-ERROR.
