...
&Scoped-define FIELDS-IN-QUERY-br_table CcbPenDep.CodDiv CcbPenDep.usuario ~
CcbPenDep.FchCie CcbPenDep.HorCie CcbPenDep.ImpNac CcbPenDep.SdoNac ~
CcbPenDep.SdoNac  - CcbPenDep.ImpNac  @ x-DifNac CcbPenDep.ImpUsa ~
CcbPenDep.SdoUsa CcbPenDep.SdoUsa - CcbPenDep.ImpUsa  @ x-DifUsa 
...
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-div 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbPenDep.ImpNac COLUMN-LABEL "Importe S/!Sistemas" FORMAT "->>>,>>9.99":U
      CcbPenDep.SdoNac COLUMN-LABEL "Importe S/!Declarado" FORMAT "->>>,>>9.99":U
      CcbPenDep.SdoNac  - CcbPenDep.ImpNac  @ x-DifNac COLUMN-LABEL "Diferencia S/" FORMAT "->>>,>>9.99":U
      CcbPenDep.ImpUsa COLUMN-LABEL "Import US$!Sistemas" FORMAT "->>>,>>9.99":U
      CcbPenDep.SdoUsa COLUMN-LABEL "Importe US$!Declarado" FORMAT "->>>,>>9.99":U
      CcbPenDep.SdoUsa - CcbPenDep.ImpUsa  @ x-DifUsa COLUMN-LABEL "Diferencia US$" FORMAT "->>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 86 BY 10.58
         FONT 4
         TITLE "POR SUSTENTAR".
...
"CcbPenDep.CodDiv" "División" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.CcbPenDep.usuario
"CcbPenDep.usuario" "Usuario" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.CcbPenDep.FchCie
"CcbPenDep.FchCie" "Fecha de!Cierre" "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.CcbPenDep.HorCie
"CcbPenDep.HorCie" "Hora de!Cierre" "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.CcbPenDep.ImpNac
"CcbPenDep.ImpNac" "Importe S/!Sistemas" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.CcbPenDep.SdoNac
"CcbPenDep.SdoNac" "Importe S/!Declarado" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"CcbPenDep.SdoNac  - CcbPenDep.ImpNac  @ x-DifNac" "Diferencia S/" "->>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.CcbPenDep.ImpUsa
"CcbPenDep.ImpUsa" "Import US$!Sistemas" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.CcbPenDep.SdoUsa
"CcbPenDep.SdoUsa" "Importe US$!Declarado" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > "_<CALC>"
"CcbPenDep.SdoUsa - CcbPenDep.ImpUsa  @ x-DifUsa" "Diferencia US$" "->>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* POR SUSTENTAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* POR SUSTENTAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* POR SUSTENTAR */
DO:
