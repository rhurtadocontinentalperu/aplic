...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REFINANCIACION POR LETRAS"
         HEIGHT             = 20.92
         WIDTH              = 106.72
         MAX-HEIGHT         = 22.65
         MAX-WIDTH          = 112.72
...
ON END-ERROR OF W-Win /* REFINANCIACION POR LETRAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REFINANCIACION POR LETRAS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/vrefinanciacionletras.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vrefinanciacionletras ).
       RUN set-position IN h_vrefinanciacionletras ( 2.73 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_vrefinanciacionletras ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/trefixletra-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_trefixletra-01 ).
       RUN set-position IN h_trefixletra-01 ( 6.38 , 2.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_tcanjexletra-03 ( 12.85 , 14.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-updv97 ( 3.65 , 11.00 ) NO-ERROR.
