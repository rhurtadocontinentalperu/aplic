...
&Scoped-define QUERY-STRING-br_table FOR EACH CcbCDocu WHERE CcbCDocu.CodCia = CcbCMvto.CodCia ~
  ...
  AND CcbCDocu.NroRef = CcbCMvto.NroDoc NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH CcbCDocu WHERE CcbCDocu.CodCia = CcbCMvto.CodCia ~
  AND CcbCDocu.CodDiv = CcbCMvto.CodDiv ~
  /*AND CcbCDocu.CodDoc = "LET"*/ ~
  AND CcbCDocu.CodRef = CcbCMvto.CodDoc ~
  AND CcbCDocu.NroRef = CcbCMvto.NroDoc NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.NroDoc FORMAT "X(12)":U WIDTH 9.57
      ...
      c-Mon[CcbCDocu.CodMon] COLUMN-LABEL "Mon." FORMAT "x(3)":U
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 1.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     F-ImpTot AT ROW 7.92 COL 41 COLON-ALIGNED WIDGET-ID 4
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.CcbCDocu WHERE INTEGRAL.CcbCMvto ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.CcbCDocu.CodCia = INTEGRAL.CcbCMvto.CodCia
  AND INTEGRAL.CcbCDocu.CodDiv = INTEGRAL.CcbCMvto.CodDiv
  /*AND INTEGRAL.CcbCDocu.CodDoc = ""LET""*/
  AND INTEGRAL.CcbCDocu.CodRef = INTEGRAL.CcbCMvto.CodDoc
  AND INTEGRAL.CcbCDocu.NroRef = INTEGRAL.CcbCMvto.NroDoc"
...
"c-Mon[CcbCDocu.CodMon]" "Mon." "x(3)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.CcbCDocu.ImpTot
"CcbCDocu.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "1.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Imp-Tot B-table-Win 
PROCEDURE Imp-Tot :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
ASSIGN 
    F-ImpTot = 0.
FOR EACH B-DOCU WHERE B-DOCU.CodCia = CcbCMvto.CodCia
    AND B-DOCU.CodDiv = CcbCMvto.CodDiv
    /*AND B-DOCU.CodDoc = "LET"*/
    AND B-DOCU.CodRef = CcbCMvto.CodDoc
    AND B-DOCU.NroRef = CcbCMvto.NroDoc NO-LOCK:
    ASSIGN
...
cRange = "B" + cColumn.
chWorkSheet:Range(cRange):Value = "LETRAS".
...
cRange = "D" + cColumn.
chWorkSheet:Range(cRange):Value = "Fecha de Vcto".
cRange = "E" + cColumn.
chWorkSheet:Range(cRange):Value = "Mone.".
cRange = "F" + cColumn.
