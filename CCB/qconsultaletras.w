...
&Scoped-define QUERY-STRING-Query-Main FOR EACH CcbCMvto WHERE CcbCMvto.CodCia = CcbCDocu.CodCia ~
  AND CcbCMvto.CodDoc = CcbCDocu.CodRef ~
  AND CcbCMvto.NroDoc = CcbCDocu.NroRef NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCMvto WHERE CcbCMvto.CodCia = CcbCDocu.CodCia ~
  AND CcbCMvto.CodDoc = CcbCDocu.CodRef ~
  AND CcbCMvto.NroDoc = CcbCDocu.NroRef NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.CcbCMvto WHERE INTEGRAL.CcbCDocu ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "CcbCMvto.CodCia = CcbCDocu.CodCia
  AND CcbCMvto.CodDoc = CcbCDocu.CodRef
