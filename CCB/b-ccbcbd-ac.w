...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 90.72 BY 9.04
         FONT 4.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Abrir-Browse B-table-Win 
PROCEDURE Abrir-Browse :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN
        ...
        FILL-IN-Haber-1 = 0
        FILL-IN-Haber-2 = 0.
    FOR EACH b-prev NO-LOCK:
        IF B-PREV.tpomov = NO THEN
            ASSIGN
