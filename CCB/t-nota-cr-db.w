...
DEFINE FRAME F-Main
     ...
     F-ImpTot AT ROW 14.46 COL 124 COLON-ALIGNED WIDGET-ID 44
     RECT-2 AT ROW 14.19 COL 1 WIDGET-ID 50
...
"DETA.CanDes" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
