...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 RECT-7 RECT-9 RECT-32 RECT-10 ~
RECT-8 RECT-6 FILL-IN_ImpNac1 FILL-IN_ImpUsa1 FILL-IN_ImpNac2 ~
...
DO:
    ...
    FIND ccbboldep WHERE 
        ...
        ccbboldep.CodDiv = s-CodDiv AND
        ccbboldep.CodDoc = "BD" AND  
        ccbboldep.CodCli = s-CodCli AND  
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 18.12 , 72.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
      ...
      WITH FRAME D-Dialog.
  ENABLE RECT-4 RECT-5 RECT-7 RECT-9 RECT-32 RECT-10 RECT-8 RECT-6 
         FILL-IN_ImpNac1 FILL-IN_ImpUsa1 FILL-IN_ImpNac2 FILL-IN_ImpUsa2 
