...
DEF VAR X-ImpNac LIKE ccbccaja.impnac EXTENT 20.
DEF VAR X-ImpUsa LIKE ccbccaja.impusa EXTENT 20.
...
&Scoped-define FIELDS-IN-QUERY-D-Dialog CcbCierr.FchCie CcbCierr.usuario ~
CcbCierr.HorCie CcbDecl.ImpNac[1] CcbDecl.ImpUsa[1] CcbDecl.ImpNac[2] ~
CcbDecl.ImpUsa[2] CcbDecl.ImpNac[3] CcbDecl.ImpUsa[3] CcbDecl.ImpNac[4] ~
CcbDecl.ImpUsa[4] CcbDecl.ImpNac[5] CcbDecl.ImpUsa[5] CcbDecl.ImpNac[6] ~
CcbDecl.ImpUsa[6] CcbDecl.ImpNac[7] CcbDecl.ImpUsa[7] CcbDecl.ImpNac[8] ~
CcbDecl.ImpUsa[8] CcbDecl.ImpNac[9] CcbDecl.ImpUsa[9] CcbDecl.ImpNac[10] ~
CcbDecl.ImpUsa[10] CcbDecl.TarPtoNac CcbDecl.TarPtoUsa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-D-Dialog CcbCierr.FchCie ~
CcbDecl.ImpNac[1] CcbDecl.ImpUsa[1] CcbDecl.ImpNac[10] CcbDecl.ImpUsa[10] 
...
CcbDecl.ImpUsa[1] CcbDecl.ImpNac[10] CcbDecl.ImpUsa[10] 
...
&Scoped-Define ENABLED-OBJECTS RECT-21 RECT-22 RECT-24 RECT-25 Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-FIELDS CcbCierr.FchCie CcbCierr.usuario ~
CcbCierr.HorCie CcbDecl.ImpNac[1] CcbDecl.ImpUsa[1] CcbDecl.ImpNac[2] ~
CcbDecl.ImpUsa[2] CcbDecl.ImpNac[3] CcbDecl.ImpUsa[3] CcbDecl.ImpNac[4] ~
CcbDecl.ImpUsa[4] CcbDecl.ImpNac[5] CcbDecl.ImpUsa[5] CcbDecl.ImpNac[6] ~
CcbDecl.ImpUsa[6] CcbDecl.ImpNac[7] CcbDecl.ImpUsa[7] CcbDecl.ImpNac[8] ~
CcbDecl.ImpUsa[8] CcbDecl.ImpNac[9] CcbDecl.ImpUsa[9] CcbDecl.ImpNac[10] ~
CcbDecl.ImpUsa[10] CcbDecl.TarPtoNac CcbDecl.TarPtoUsa 
&Scoped-define DISPLAYED-TABLES CcbCierr CcbDecl
&Scoped-define FIRST-DISPLAYED-TABLE CcbCierr
&Scoped-define SECOND-DISPLAYED-TABLE CcbDecl
...
DEFINE FRAME D-Dialog
     CcbCierr.FchCie AT ROW 1.19 COL 13 COLON-ALIGNED
          LABEL "Fecha de cierre"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCierr.usuario AT ROW 1.19 COL 31 COLON-ALIGNED
          LABEL "Cajero"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     CcbCierr.HorCie AT ROW 1.19 COL 57 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     CcbDecl.ImpNac[1] AT ROW 3.31 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[1] AT ROW 3.31 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     Btn_OK AT ROW 3.69 COL 54
     CcbDecl.ImpNac[2] AT ROW 4.08 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[2] AT ROW 4.08 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[3] AT ROW 4.85 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[3] AT ROW 4.85 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     Btn_Cancel AT ROW 5.42 COL 54
     CcbDecl.ImpNac[4] AT ROW 5.62 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[4] AT ROW 5.62 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[5] AT ROW 6.38 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[5] AT ROW 6.38 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[6] AT ROW 7.15 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[6] AT ROW 7.15 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[7] AT ROW 7.92 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[7] AT ROW 7.92 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[8] AT ROW 8.73 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[8] AT ROW 8.73 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[9] AT ROW 9.54 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[9] AT ROW 9.54 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpNac[10] AT ROW 10.35 COL 22 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.ImpUsa[10] AT ROW 10.35 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.TarPtoNac AT ROW 11.19 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     CcbDecl.TarPtoUsa AT ROW 11.19 COL 38 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     "Tarjeta Puntos" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 11.19 COL 5 WIDGET-ID 6
     "Tarjeta de Crédito" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 5.81 COL 5
...
DEFINE FRAME D-Dialog
     "Notas de Crédito" VIEW-AS TEXT
          SIZE 12 BY .5 AT ROW 7.35 COL 5
     "Depósitos" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 6.58 COL 5
     "Efectivo" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 3.5 COL 5
     "Comisiones Factoring" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 8.88 COL 5
     "Anticipos" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 8.12 COL 5
     "S/." VIEW-AS TEXT
          SIZE 3 BY .5 AT ROW 2.54 COL 27
     "Cheques del Día" VIEW-AS TEXT
          SIZE 12 BY .5 AT ROW 4.27 COL 5
     "Vales de Consumo" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 10.42 COL 5
     "Cheques Diferidos" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 5.04 COL 5
     "Retenciones" VIEW-AS TEXT
          SIZE 9 BY .5 AT ROW 9.65 COL 5
     "US$" VIEW-AS TEXT
          SIZE 4 BY .5 AT ROW 2.54 COL 43
     RECT-21 AT ROW 2.35 COL 3
     RECT-22 AT ROW 3.12 COL 3
     RECT-24 AT ROW 2.35 COL 20.43
     RECT-25 AT ROW 2.35 COL 52.14
     SPACE(1.42) SKIP(0.49)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
...
/* SETTINGS FOR FILL-IN CcbDecl.ImpUsa[9] IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN CcbDecl.TarPtoNac IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN CcbDecl.TarPtoUsa IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
DO:
    ...
    trloop:
    DO TRANSACTION ON ERROR UNDO trloop, LEAVE trloop:
        RUN Procesa-cierre.
...
DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
    ...
    FOR EACH T-ccbccaja EXCLUSIVE-LOCK:
    ...
    FOR EACH t-ccbccaja NO-LOCK:
        ...
        ASSIGN
            ...
            CcbCierr.TarPtoNac = CcbCierr.TarPtoNac + t-ccbccaja.TarPtoNac
            CcbCierr.TarPtoUsa = CcbCierr.TarPtoUsa + t-ccbccaja.TarPtoUsa.
        ...
        END.
        /* VALES CONTINENTAL */
        IF ccbccaja.CodDoc = "I/C" AND
            (t-CcbCCaja.ImpNac[10] > 0 OR
            t-CcbCCaja.ImpUsa[10] > 0) THEN DO:
            FIND ccbpendep WHERE
                CcbPenDep.CodCia = CcbCCaja.CodCia AND
                CcbPenDep.CodDoc = "VAL" AND
                CcbPenDep.CodDiv = CcbCCaja.CodDiv AND
                CcbPenDep.CodRef = CcbCCaja.CodDoc AND
                CcbPenDep.NroRef = CcbCCaja.NroDoc AND
                CcbPenDep.FchCie = CcbCCaja.FchCie
            ...
            END.
            ASSIGN
                CcbPenDep.ImpNac = CcbPenDep.ImpNac + t-CcbCCaja.ImpNac[10]
                CcbPenDep.SdoNac = CcbPenDep.SdoNac + t-CcbCCaja.ImpNac[10]
                CcbPenDep.ImpUsa = CcbPenDep.ImpUsa + t-CcbCCaja.ImpUsa[10]
                CcbPenDep.SdoUsa = CcbPenDep.SdoUsa + t-CcbCCaja.ImpUsa[10].
        END.
    ...
    RUN aplic/sypsa/rpl-registroventascontado (ROWID(Ccbcierr), "I").
END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbDecl THEN 
    DISPLAY CcbDecl.ImpNac[1] CcbDecl.ImpUsa[1] CcbDecl.ImpNac[2] 
          CcbDecl.ImpUsa[2] CcbDecl.ImpNac[3] CcbDecl.ImpUsa[3] 
          CcbDecl.ImpNac[4] CcbDecl.ImpUsa[4] CcbDecl.ImpNac[5] 
          CcbDecl.ImpUsa[5] CcbDecl.ImpNac[6] CcbDecl.ImpUsa[6] 
          CcbDecl.ImpNac[7] CcbDecl.ImpUsa[7] CcbDecl.ImpNac[8] 
          CcbDecl.ImpUsa[8] CcbDecl.ImpNac[9] CcbDecl.ImpUsa[9] 
          CcbDecl.ImpNac[10] CcbDecl.ImpUsa[10] CcbDecl.TarPtoNac 
          CcbDecl.TarPtoUsa 
      WITH FRAME D-Dialog.
  ENABLE RECT-21 RECT-22 RECT-24 RECT-25 CcbCierr.FchCie CcbDecl.ImpNac[1] 
         CcbDecl.ImpUsa[1] Btn_OK Btn_Cancel CcbDecl.ImpNac[10] 
         CcbDecl.ImpUsa[10] 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
&SCOPED-DEFINE Condicion (ccbccaja.codcia = s-codcia ~
    ...
    AND CcbCCaja.FchDoc >= DATE(ccbcierr.FchCie:SCREEN-VALUE) - 1 ~
    AND CcbCCaja.FchDoc <= DATE(ccbcierr.FchCie:SCREEN-VALUE) ~
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR' WITH FRAME {&FRAME-NAME}:
    ...
    IF INPUT CcbDecl.ImpNac[1] > 0 THEN
        RUN proc_CreateECCJA(1, INPUT INPUT CcbDecl.ImpNac[1]).
    IF INPUT CcbDecl.ImpUsa[1] > 0 THEN
        RUN proc_CreateECCJA(2, INPUT INPUT CcbDecl.ImpUsa[1]).
    ...
    ASSIGN
        ...
        X-VueUsa = 0.
    /* INGRESOS */
    FOR EACH ccbccaja USE-INDEX Llave07 NO-LOCK WHERE {&Condicion}
        AND ccbccaja.coddoc = "I/C":
        /* Cierra Documentos Anulados */
        IF ccbccaja.flgest = "A" THEN DO:
            FIND b_Ccaja WHERE RECID(b_Ccaja) = RECID(CcbCcaja) EXCLUSIVE-LOCK.
            ASSIGN
                b_CCaja.FlgCie = "C"
        ...
        ASSIGN
            ...
            t-CcbCCaja.ImpNac[8] = CcbCCaja.ImpNac[8]
            t-CcbCCaja.ImpNac[9] = CcbCCaja.ImpNac[9]
            t-CcbCCaja.ImpNac[10] = CcbCCaja.ImpNac[10]
            ...
            t-CcbCCaja.ImpUsa[8] = CcbCCaja.ImpUsa[8]
            t-CcbCCaja.ImpUsa[9] = CcbCCaja.ImpUsa[9]
            t-CcbCCaja.ImpUsa[10] = CcbCCaja.ImpUsa[10]
            t-CcbCCaja.TarPtoNac = CcbCCaja.TarPtoNac 
            t-CcbCCaja.TarPtoUsa = CcbCCaja.TarPtoUsa
        ...
        ASSIGN
            ...
            x-ImpNac[11] = x-ImpNac[11] + ccbccaja.TarPtoNac
            x-ImpUsa[11] = x-ImpUsa[11] + ccbccaja.TarPtoUsa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_CreateECCJA D-Dialog 
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF AVAILABLE gn-tccja THEN
        ASSIGN CcbCCaja.TpoCmb = gn-tccja.Compra.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_Genera-Deposito D-Dialog 
...
FIND gn-divi WHERE gn-divi.codcia = s-codcia 
    ...
    NO-LOCK NO-ERROR.
IF AVAILABLE gn-divi AND GN-DIVI.CanalVenta = 'MIN' 
    THEN ASSIGN F-Banco = 'IB' F-Cta = '10416100'.
