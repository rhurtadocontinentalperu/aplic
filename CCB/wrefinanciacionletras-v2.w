...
&Scoped-Define ENABLED-OBJECTS RECT-57 COMBO-NroSer 
...
DEFINE VARIABLE h_trefixletra-01 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     COMBO-NroSer AT ROW 6.77 COL 56.71 WIDGET-ID 4
     RECT-57 AT ROW 8 COL 2 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 109.86 BY 25.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REFINANCIACION DE LETRAS"
         HEIGHT             = 25.85
         WIDTH              = 109.86
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 144.29
...
ON END-ERROR OF W-Win /* REFINANCIACION DE LETRAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REFINANCIACION DE LETRAS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv14 ).
       RUN set-position IN h_p-updv14 ( 6.65 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-updv14 ( 1.42 , 53.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 6.65 , 81.00 ) NO-ERROR.
       ...
       RUN set-position IN h_vrefinanciacionletras ( 8.54 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_qcanjexletra-v2 ( 6.65 , 69.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.35 , 12.00 ) */

       /* Links to SmartViewer h_vrefinanciacionletras. */
       RUN add-link IN adm-broker-hdl ( h_p-updv14 , 'TableIO':U , h_vrefinanciacionletras ).
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra-v2 , 'Record':U , h_vrefinanciacionletras ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-01 ( 12.31 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_bcanjexletra-02 ( 18.77 , 25.00 ) NO-ERROR.
       RUN set-size IN h_bcanjexletra-02 ( 7.92 , 62.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bcanjexletra-01. */
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra-v2 , 'Record':U , h_bcanjexletra-01 ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/trefixletra-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_trefixletra-01 ).
       RUN set-position IN h_trefixletra-01 ( 12.31 , 2.00 ) NO-ERROR.
       RUN set-size IN h_trefixletra-01 ( 6.50 , 91.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 13.12 , 94.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 4.04 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_tcanjexletra-02 ( 18.77 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 20.12 , 94.00 ) NO-ERROR.
       RUN set-size IN h_p-updv95 ( 4.85 , 13.00 ) NO-ERROR.

       /* Links to SmartBrowser h_trefixletra-01. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_trefixletra-01 ).

       /* Links to SmartBrowser h_tcanjexletra-02. */
       RUN add-link IN adm-broker-hdl ( h_p-updv95 , 'TableIO':U , h_tcanjexletra-02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_trefixletra-01 ,
             h_vrefinanciacionletras , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_trefixletra-01 , 'AFTER':U ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-01-2 ( 12.31 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_tcanjexletra-03 ( 18.77 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 19.85 , 88.00 ) NO-ERROR.
       RUN set-size IN h_p-updv97 ( 5.12 , 13.00 ) NO-ERROR.

       /* Links to SmartBrowser h_bcanjexletra-01-2. */
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra-v2 , 'Record':U , h_bcanjexletra-01-2 ).
...
CASE L-Handle:
    ...
    WHEN "Pagina1"  THEN DO WITH FRAME {&FRAME-NAME}:    
        ...
        IF VALID-HANDLE(h_trefixletra-01) THEN RUN dispatch IN h_trefixletra-01 ('open-query':U).
