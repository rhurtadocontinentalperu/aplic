...
&Scoped-Define ENABLED-OBJECTS RECT-26 RECT-25 COMBO-NroSer btnFromExcel 
...
DEFINE FRAME F-Main
     ...
     btnFromExcel AT ROW 7.46 COL 100 WIDGET-ID 6
     BUTTON-Aprobar AT ROW 8.54 COL 100 WIDGET-ID 8
     RECT-26 AT ROW 7.19 COL 99 WIDGET-ID 10
     RECT-25 AT ROW 2.54 COL 2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 127.86 BY 15.31
...
ON CHOOSE OF btnFromExcel IN FRAME F-Main /* IMPORTAR DIETARIO EXCEL */
DO:
    ...
    RUN ccb/d-select-dietario (OUTPUT piFormato).
    ...
    CASE piFormato:
        ...
        END.
        WHEN 2 THEN DO:
            RUN ue-desde-excel-v2 IN h_tnotabancaria-v2 (OUTPUT lSumaInteres).   
        END.
    END CASE.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-size IN h_tnotabancaria-v2 ( 6.69 , 96.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-26 RECT-25 COMBO-NroSer btnFromExcel 
      WITH FRAME F-Main IN WINDOW W-Win.
