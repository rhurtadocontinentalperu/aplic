...
DEF VAR RB-REPORT-NAME AS CHAR INITIAL "Pre-cierre de caja2".
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH TEMPO:
      xnombre = "Otros    ".
      CASE TEMPO.TIPO:
       WHEN "CFAC" THEN xnombre = "Cobranzas      ".
      ...
      ASSIGN
          ...
          w-report.Campo-F[11] = TEMPO.TOTSOL
          w-report.Campo-F[12] = TEMPO.TOTDOL.
          IF TEMPO.TIPO = "REMESAS" THEN ASSIGN
             w-report.Campo-C[4] = TEMPO.CODDOC + " " + TEMPO.NRODOC + " " + TEMPO.GLOSA.
