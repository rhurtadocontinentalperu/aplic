...
&Scoped-Define ENABLED-OBJECTS BUTTON-4 BUTTON-5 BUTTON-6 
...
DEFINE FRAME F-Main
     BUTTON-4 AT ROW 1.19 COL 2
     BUTTON-5 AT ROW 1.19 COL 12
     BUTTON-6 AT ROW 1.19 COL 21
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-4 BUTTON-5 BUTTON-6 
...
DEF VAR x-Condicion AS CHAR FORMAT 'x(30)' NO-UNDO.
...
FOR EACH GN-CLIE WHERE gn-clie.codcia = cl-codcia
    ...
    cRange = "E" + cColumn.
    chWorkSheet:Range(cRange):Value = gn-clie.FchVLC.
    cRange = "F" + cColumn.
    ...
    THEN x-Condicion = gn-ConVt.Nombr.
    ELSE x-Condicion = ''.
    cRange = "H" + cColumn.
    chWorkSheet:Range(cRange):Value = x-Condicion.
END.
