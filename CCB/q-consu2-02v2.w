...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 txtCodCliente 
...
DEFINE FRAME FRAME-A
     ...
     txtCodCliente AT ROW 1.19 COL 10 COLON-ALIGNED WIDGET-ID 14
     FILL-IN_NomCli AT ROW 1.19 COL 24 NO-LABEL WIDGET-ID 26
     FILL-IN-Mensaje AT ROW 2.15 COL 10 COLON-ALIGNED NO-LABEL WIDGET-ID 62
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 2.19 , 7.57 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL txtCodCliente q-tables
ON LEAVE OF txtCodCliente IN FRAME FRAME-A /* Cliente */
DO:
    DEF VAR pOpenOrange AS LOG   NO-UNDO.
    ...
    IF txtCodCliente <> "" THEN DO:
        ...
        IF AVAILABLE gn-clie THEN DO:
            ...
            FIND {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}} WHERE
                ROWID({&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}}) = pRowid
                NO-LOCK NO-ERROR.
