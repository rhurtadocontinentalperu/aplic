...
CcbCDocu.NomCli CcbCDocu.FchVto X-MON @ X-MON CcbCDocu.ImpTot X-EST @ X-EST ~
CcbCDocu.SdoAct 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbCDocu.CodDoc COLUMN-LABEL "Tipo" FORMAT "x(5)"
      CcbCDocu.NroDoc FORMAT "XXX-XXXXXXXX"
      CcbCDocu.NomCli FORMAT "x(55)"
      CcbCDocu.FchVto COLUMN-LABEL "Fecha de     !Presentacion"
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 97.14 BY 10.08
