...
CcbCDocu.ImpTot CcbDMvto.NroDep 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbDMvto.NroDep COLUMN-LABEL "Número Unico" FORMAT "x(25)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"CcbCDocu.ImpTot" "Importe" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.CcbDMvto.NroDep
"CcbDMvto.NroDep" "Número Unico" "x(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH B-MVTO  NO-LOCK WHERE B-MVTO.CodCia = CcbCMvto.CodCia
    AND B-MVTO.CodDiv = CcbCMvto.CodDiv
