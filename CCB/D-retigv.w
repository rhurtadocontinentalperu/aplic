...
DEF VAR RB-REPORT-NAME AS CHAR INITIAL "Certificados Retencion".
...
------------------------------------------------------------------------------*/
    ...
    RB-FILTER = "ccbcdocu.codcia = " + 
                string(s-codcia,"99") + 
                " and ccbcdocu.coddoc = 'RET' and " + 
                "ccbcdocu.fchdoc >= " + 
                STRING(FechaD) + 
                " AND ccbcdocu.fchdoc <= " + STRING(FechaH).
    SESSION:DATE-FORMAT = "DMY".
    IF x-CodDiv <> 'Todas'
    THEN RB-FILTER = RB-FILTER + " AND ccbcdocu.coddiv BEGINS '" + x-coddiv + "'".
