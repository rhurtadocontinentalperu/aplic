...
&Scoped-Define DISPLAYED-OBJECTS tg-linea tg-dudosa FILL-IN-codcli ~
FILL-IN-codcli-1 FILL-IN-fecha FILL-IN-fecha-1 FILL-IN-Division ~
RADIO-SET-codmon 
...
------------------------------------------------------------------------------*/
  DISPLAY tg-linea tg-dudosa FILL-IN-codcli FILL-IN-codcli-1 FILL-IN-fecha 
...
------------------------------------------------------------------------------*/
    ...
    IF tg-linea THEN
        ASSIGN RB-REPORT-NAME = "Documentos por Cobrar-a".
    ELSE ASSIGN RB-REPORT-NAME = "Documentos por Cobrar_2-a".
    ASSIGN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_carga-temp-cissac W-Win 
PROCEDURE proc_carga-temp-cissac :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    RUN Ccb\p-rep021.p (s-task-no, tg-dudosa, tg-linea, cDivi, FILL-IN-codcli, FILL-IN-codcli-1, FILL-IN-fecha, FILL-IN-fecha-1, RADIO-SET-codmon).               
...
/*RDP - Considerar Documentos Cobranza Dudosa*/
    ...
    ASSIGN
        ...
        integral.w-report.Campo-C[8] = "CONTINENTAL"                  /* Nombre Cia       */
