...
DEF NEW SHARED VAR s-coddoc AS CHAR INIT "CVU".
...
DEFINE VARIABLE h_tcanjevalesutilexc AS HANDLE NO-UNDO.
DEFINE VARIABLE h_tcanjevalesutilexd AS HANDLE NO-UNDO.
DEFINE VARIABLE h_tcanjexletra-03 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vcanjevalesutilex AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* CANJE FAI POR DOC */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CANJE FAI POR DOC */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/vcanjevalesutilex.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vcanjevalesutilex ).
       RUN set-position IN h_vcanjevalesutilex ( 2.73 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_vcanjevalesutilex. */
       RUN add-link IN adm-broker-hdl ( h_p-updv14 , 'TableIO':U , h_vcanjevalesutilex ).
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_vcanjevalesutilex ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/tcanjevalesutilexc.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tcanjevalesutilexc ).
       RUN set-position IN h_tcanjevalesutilexc ( 6.38 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tcanjevalesutilexc ( 6.50 , 115.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv101 ).
       RUN set-position IN h_p-updv101 ( 11.77 , 3.00 ) NO-ERROR.
       RUN set-size IN h_p-updv101 ( 1.35 , 19.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'CCB/tcanjevalesutilexd.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tcanjevalesutilexd ).
       RUN set-position IN h_tcanjevalesutilexd ( 13.92 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tcanjevalesutilexd ( 8.12 , 120.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 20.92 , 32.00 ) NO-ERROR.
       RUN set-size IN h_p-updv95 ( 1.35 , 33.00 ) NO-ERROR.

       /* Links to SmartBrowser h_tcanjevalesutilexc. */
       RUN add-link IN adm-broker-hdl ( h_p-updv101 , 'TableIO':U , h_tcanjevalesutilexc ).

       /* Links to SmartBrowser h_tcanjevalesutilexd. */
       RUN add-link IN adm-broker-hdl ( h_p-updv95 , 'TableIO':U , h_tcanjevalesutilexd ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_tcanjevalesutilexc ,
             h_vcanjevalesutilex , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv101 ,
             h_tcanjevalesutilexc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_tcanjevalesutilexd ,
             h_p-updv101 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv95 ,
             h_tcanjevalesutilexd , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/bcanjexletra-01.w':U ,
...
CASE L-Handle:
    WHEN "Pagina1"  THEN DO WITH FRAME {&FRAME-NAME}:    
        ...
        IF VALID-HANDLE(h_tcanjevalesutilexc) THEN RUN dispatch IN h_tcanjevalesutilexc ('open-query':U).
        IF VALID-HANDLE(h_tcanjevalesutilexd) THEN RUN dispatch IN h_tcanjevalesutilexd ('open-query':U).
