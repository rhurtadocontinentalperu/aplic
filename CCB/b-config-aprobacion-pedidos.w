...
DEFINE VAR x-tabla AS CHAR INIT "APR.PED|LT.X.ACEPTAR".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo FORMAT "x(15)":U WIDTH 9.43
      FacTabla.Nombre FORMAT "x(40)":U WIDTH 42.43
...
"Codigo" ? "x(15)" "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacTabla.Nombre
"Nombre" ? ? "character" ? ? ? ? ? ? no ? no no "42.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacTabla.Valor[1]
"Valor[1]" "Dias" "->>,>>9" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
