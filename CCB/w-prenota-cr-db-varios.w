...
DEFINE VARIABLE h_v-prenota-cr-db-varios AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/v-prenota-cr-db-varios.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-prenota-cr-db-varios ).
       RUN set-position IN h_v-prenota-cr-db-varios ( 2.88 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.08 , 120.00 ) */
       ...
       /* Links to SmartViewer h_v-prenota-cr-db-varios. */
       RUN add-link IN adm-broker-hdl ( h_p-updv13 , 'TableIO':U , h_v-prenota-cr-db-varios ).
       RUN add-link IN adm-broker-hdl ( h_qnotacreditodebito , 'Record':U , h_v-prenota-cr-db-varios ).
