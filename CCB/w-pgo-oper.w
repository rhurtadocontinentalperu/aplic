...
DEFINE VARIABLE h_v-pgo-oper AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 80 BY 13.69 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/v-pgo-oper.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pgo-oper ).
       RUN set-position IN h_v-pgo-oper ( 2.62 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.62 , 77.43 ) */
       ...
       /* Links to SmartViewer h_v-pgo-oper. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_v-pgo-oper ).
       RUN add-link IN adm-broker-hdl ( h_q-docmto-02 , 'Record':U , h_v-pgo-oper ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv10 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pgo-oper ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-docmto-02 ,
             h_v-pgo-oper , 'AFTER':U ).
    END. /* Page 0 */
