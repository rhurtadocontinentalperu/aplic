...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Nº de Control"
      FacCPedi.NomCli COLUMN-LABEL "Cliente" FORMAT "x(45)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 74 BY 5.19
         FONT 2
         TITLE "SELECCIONE LA PRE-NOTA DE CREDITO A APROBAR O RECHAZAR".
...
"FacCPedi.NroPed" "Nº de Control" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.FacCPedi.NomCli
"FacCPedi.NomCli" "Cliente" "x(45)" "character" ? ? ? ? ? ? no ?
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* SELECCIONE LA PRE-NOTA DE CREDITO A APROBAR O RECHAZAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* SELECCIONE LA PRE-NOTA DE CREDITO A APROBAR O RECHAZAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* SELECCIONE LA PRE-NOTA DE CREDITO A APROBAR O RECHAZAR */
DO:
