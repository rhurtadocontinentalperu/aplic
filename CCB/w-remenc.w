...
DEF NEW SHARED VAR s-tipo   AS CHAR INITIAL "DEVONC".
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Devolucion de Efectivo X N/C"
         HEIGHT             = 8.5
         WIDTH              = 77.57
         MAX-HEIGHT         = 9.19
         MAX-WIDTH          = 77.57
...
ON END-ERROR OF W-Win /* Devolucion de Efectivo X N/C */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Devolucion de Efectivo X N/C */
DO:
