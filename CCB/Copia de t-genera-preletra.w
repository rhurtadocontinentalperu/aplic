...
&Scoped-define FIELDS-IN-QUERY-br_table fLinea() @ DOCU.Libre_c02 ~
DOCU.CodDoc DOCU.FchVto DOCU.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      fLinea() @ DOCU.Libre_c02 COLUMN-LABEL "Linea" FORMAT "x(8)":U
      DOCU.CodDoc FORMAT "x(3)":U
      DOCU.FchVto COLUMN-LABEL "Fecha de Vencimiento" FORMAT "99/99/9999":U
            WIDTH 18.57
      DOCU.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 12.57
  ENABLE
      DOCU.FchVto
      DOCU.ImpTot
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 48 BY 13.19
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpTot AT ROW 14.19 COL 33 COLON-ALIGNED WIDGET-ID 62
...
"fLinea() @ DOCU.Libre_c02" "Linea" "x(8)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"DOCU.ImpTot" ? ? "decimal" ? ? ? ? ? ? yes ? no no "12.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
