...
DEFINE FRAME F-Main
     ...
     RECT-25 AT ROW 2.35 COL 2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 106.72 BY 19.73
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/vrenovacionletra.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vrenovacionletra ).
       RUN set-position IN h_vrenovacionletra ( 2.54 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_vrenovacionletra ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-02 ( 11.77 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/trenovacionletra.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_trenovacionletra ).
       RUN set-position IN h_trenovacionletra ( 11.77 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 13.12 , 82.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_tcanjexletra-03 ( 11.77 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 12.92 , 67.00 ) NO-ERROR.
       RUN set-size IN h_p-updv97 ( 5.58 , 11.00 ) NO-ERROR.
