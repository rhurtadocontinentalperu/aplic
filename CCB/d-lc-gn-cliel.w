...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      DECIMAL(ENTRY(4,logtabla.ValorLlave,'|')) @ x-ImpLC COLUMN-LABEL "Línea de Crédito" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 13.57
...
DEFINE FRAME D-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "Historial Línea de Crédito"
...
"DECIMAL(ENTRY(4,logtabla.ValorLlave,'|')) @ x-ImpLC" "Línea de Crédito" "->>>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no "13.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Historial Línea de Crédito */
DO:  
