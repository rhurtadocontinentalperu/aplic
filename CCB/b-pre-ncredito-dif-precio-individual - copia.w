...
tt-CcbDDocu.UndVta tt-CcbDDocu.CanDes tt-CcbDDocu.PreUni tt-CcbDDocu.ImpLin ~
tt-CcbDDocu.ImpDto ~
...
tt-CcbDDocu.CanDev tt-CcbDDocu.ImpIsc tt-CcbDDocu.PreBas ~
tt-CcbDDocu.Dcto_Otros_Factor tt-CcbDDocu.Dcto_Otros_PV ~
tt-CcbDDocu.Dcto_Otros_VV 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tt-CcbDDocu.UndVta FORMAT "x(8)":U WIDTH 5.29
      tt-CcbDDocu.CanDes FORMAT ">,>>>,>>9.9999":U WIDTH 9.57 COLUMN-BGCOLOR 8
      tt-CcbDDocu.PreUni COLUMN-LABEL "P. Unitario" FORMAT ">,>>>,>>9.99999":U
            WIDTH 8.43 COLUMN-BGCOLOR 8
      tt-CcbDDocu.ImpLin COLUMN-LABEL "Impte" FORMAT "->>,>>>,>>9.99":U
            WIDTH 9 COLUMN-BGCOLOR 8
      tt-CcbDDocu.ImpDto COLUMN-LABEL "Importe!Dsctos N/C" FORMAT ">,>>>,>>9.9999":U
            WIDTH 8.43 COLUMN-FGCOLOR 12 COLUMN-BGCOLOR 15
      fDsctoAcumulado(tt-CcbDDocu.Pesmat,tt-CcbDDocu.PreUni) @ x-fld-dscto-acumulado COLUMN-LABEL "%Dscto!Acumulado" FORMAT "->,>>9.9999":U
            WIDTH 7.86 COLUMN-FGCOLOR 12
      tt-CcbDDocu.ImpDto2 COLUMN-LABEL "Importe!Final" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 7.43 COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 14
      tt-CcbDDocu.Pesmat COLUMN-LABEL "Precio!Final" FORMAT "->>,>>9.9999":U
      ...
      tt-CcbDDocu.CanDev COLUMN-LABEL "% Dscto" FORMAT ">,>>>,>>9.9999":U
            WIDTH 8.57 COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 15
      tt-CcbDDocu.ImpIsc COLUMN-LABEL "Impte Dscto" FORMAT ">,>>>,>>9.99":U
            WIDTH 8.72 COLUMN-BGCOLOR 10
      tt-CcbDDocu.PreBas COLUMN-LABEL "P.!Unit." FORMAT ">,>>>,>>9.9999":U
      tt-CcbDDocu.Dcto_Otros_Factor COLUMN-LABEL "%Dscto!Manual" FORMAT "->>9.9999":U
      tt-CcbDDocu.Dcto_Otros_PV COLUMN-LABEL "%Dscto!Evento" FORMAT "->>9.9999":U
      tt-CcbDDocu.Dcto_Otros_VV COLUMN-LABEL "%Dscto!Vol/Prom" FORMAT "->>9.9999":U
  ENABLE
      tt-CcbDDocu.Por_Dsctos[1]
      tt-CcbDDocu.CanDev
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 161.72 BY 13.81
         FONT 4.
...
"tt-CcbDDocu.UndVta" ? ? "character" ? ? ? ? ? ? no ? no no "5.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-CcbDDocu.CanDes
"tt-CcbDDocu.CanDes" ? ? "decimal" 8 ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tt-CcbDDocu.PreUni
"tt-CcbDDocu.PreUni" "P. Unitario" ? "decimal" 8 ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.tt-CcbDDocu.ImpLin
"tt-CcbDDocu.ImpLin" "Impte" ? "decimal" 8 ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.tt-CcbDDocu.ImpDto
"tt-CcbDDocu.ImpDto" "Importe!Dsctos N/C" ? "decimal" 15 12 ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"fDsctoAcumulado(tt-CcbDDocu.Pesmat,tt-CcbDDocu.PreUni) @ x-fld-dscto-acumulado" "%Dscto!Acumulado" "->,>>9.9999" ? ? 12 ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.tt-CcbDDocu.ImpDto2
"tt-CcbDDocu.ImpDto2" "Importe!Final" ? "decimal" 14 9 ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.tt-CcbDDocu.Pesmat
"tt-CcbDDocu.Pesmat" "Precio!Final" ? "decimal" 14 ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.tt-CcbDDocu.Por_Dsctos[1]
"tt-CcbDDocu.Por_Dsctos[1]" "Nuevo!Precio" "->>9.9999" "decimal" 15 9 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > Temp-Tables.tt-CcbDDocu.CanDev
"tt-CcbDDocu.CanDev" "% Dscto" ? "decimal" 15 9 ? ? ? ? yes ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.tt-CcbDDocu.ImpIsc
"tt-CcbDDocu.ImpIsc" "Impte Dscto" ">,>>>,>>9.99" "decimal" 10 ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > Temp-Tables.tt-CcbDDocu.PreBas
"tt-CcbDDocu.PreBas" "P.!Unit." ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > Temp-Tables.tt-CcbDDocu.Dcto_Otros_Factor
"tt-CcbDDocu.Dcto_Otros_Factor" "%Dscto!Manual" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > Temp-Tables.tt-CcbDDocu.Dcto_Otros_PV
"tt-CcbDDocu.Dcto_Otros_PV" "%Dscto!Evento" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > Temp-Tables.tt-CcbDDocu.Dcto_Otros_VV
"tt-CcbDDocu.Dcto_Otros_VV" "%Dscto!Vol/Prom" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
