...
DEFINE VARIABLE h_tenvletbco AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ENVIO DE LETRAS AL BANCO - TRANSITO"
         HEIGHT             = 14.69
         WIDTH              = 106.86
         MAX-HEIGHT         = 22.65
         MAX-WIDTH          = 112.72
...
ON END-ERROR OF W-Win /* ENVIO DE LETRAS AL BANCO - TRANSITO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ENVIO DE LETRAS AL BANCO - TRANSITO */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_benvletbco ).
       RUN set-position IN h_benvletbco ( 7.46 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/tenvletbco.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tenvletbco ).
       RUN set-position IN h_tenvletbco ( 7.46 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tenvletbco ( 7.73 , 88.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 8.04 , 91.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 5.38 , 14.00 ) NO-ERROR.

       /* Links to SmartBrowser h_tenvletbco. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_tenvletbco ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_tenvletbco ,
             h_venvletbco , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_tenvletbco , 'AFTER':U ).
    END. /* Page 2 */
