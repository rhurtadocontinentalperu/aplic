...
FOR EACH gn-divi NO-LOCK WHERE gn-divi.codcia = s-codcia AND LOOKUP(gn-divi.coddiv, cDivi) > 0:
    FOR EACH CcbCDocu NO-LOCK WHERE CcbCDocu.codcia = s-codcia 
        ...
        END.
        DISPLAY "   Cargando información para: " + CcbCDocu.codcli
            @ x-mensaje WITH FRAME {&FRAME-NAME}.
        ...
        ASSIGN
            ...
            Detalle.CodDoc = CcbCDocu.coddoc       /* Código Documento */
            Detalle.NroDoc = CcbCDocu.nrodoc       /* Número Documento */        
            Detalle.FchDoc = CcbCDocu.fchdoc       /* Fecha Emisión */
            Detalle.FchVto = CcbCDocu.fchvto       /* Fecha Vencimiento */
            Detalle.FchEnt = CcbCDocu.fchcbd.      /* Fecha Recepción */
        ...
        IF tg-linea THEN ASSIGN Detalle.LinCre = dImpLC.        /* Línea de Crédito */
