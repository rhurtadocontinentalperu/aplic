...
&Scoped-define INTERNAL-TABLES cb-cfgcja

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cb-cfgcja WHERE ~{&KEY-PHRASE} ~
      AND cb-cfgcja.Codcia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main cb-cfgcja
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cb-cfgcja
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.cb-cfgcja"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "cb-cfgcja.Codcia = s-codcia"
