...
&SCOPED-DEFINE Condicion ( Ccbcdocu.flgest = 'E' AND Ccbcdocu.coddoc = pCodDoc )
...
&Scoped-define QUERY-STRING-br_table FOR EACH CcbCDocu OF GN-DIVI  WHERE ~{&KEY-PHRASE} ~
      ...
      FIRST tt-w-report-conceptos WHERE (s-coddoc = 'N/D' OR ccbcdocu.codcta = tt-w-report-conceptos.llave-c) NO-LOCK ~
    ~{&SORTBY-PHRASE}
