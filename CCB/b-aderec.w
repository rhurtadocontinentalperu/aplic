...
CcbCDocu.FchDoc CcbCDocu.FchVto CcbCDocu.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbCDocu.CodDoc FORMAT "x(3)":U WIDTH 7
      CcbCDocu.NroDoc FORMAT "X(12)":U WIDTH 11
      CcbCDocu.FchDoc COLUMN-LABEL "Emision" FORMAT "99/99/9999":U
            WIDTH 10
      CcbCDocu.FchVto COLUMN-LABEL "Vencimiento" FORMAT "99/99/9999":U
      CcbCDocu.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 13
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 59 BY 4.04
         FONT 4
...
/* Query rebuild information for BROWSE br_table
     ...
     _JoinCode[1]      = "CcbCDocu.CodCia = CcbCMvto.CodCia
  AND CcbCDocu.CodCli = CcbCMvto.CodCli
  AND INTEGRAL.CcbCDocu.CodRef = INTEGRAL.CcbCMvto.CodDoc
  AND INTEGRAL.CcbCDocu.NroRef = INTEGRAL.CcbCMvto.NroDoc"
     _Where[1]         = "CcbCDocu.CodDoc = ""A/R""
 /*AND CcbCDocu.FlgEst = 'P'*/"
     _FldNameList[1]   > INTEGRAL.CcbCDocu.CodDoc
"CcbCDocu.CodDoc" ? ? "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.CcbCDocu.NroDoc
"CcbCDocu.NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.CcbCDocu.FchDoc
"CcbCDocu.FchDoc" "Emision" ? "date" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbCDocu.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Anticipos Recibidos */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Anticipos Recibidos */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Anticipos Recibidos */
DO:
...
cRange = "B" + cColumn.
chWorkSheet:Range(cRange):Value = "Anticipos Recibidos".
