...
/* SETTINGS FOR FILL-IN CcbCMvto.NroDoc IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN CcbCMvto.TpoCmb IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST FacCorre WHERE FacCorre.CodCia = S-CODCIA 
      ...
      NO-LOCK NO-ERROR.
  IF NOT AVAILABLE FacCorre THEN DO:
      MESSAGE 'NO hay series activas para los documentos de cobranzas (DCO) en esta división' VIEW-AS ALERT-BOX WARNING.
      RETURN 'ADM-ERROR'.
  END.
