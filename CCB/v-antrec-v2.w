...
CcbCCaja.ImpNac[4] CcbCCaja.ImpUsa[4] CcbCCaja.CodBco[4] 
...
COMBO_TarjCred FILL-IN-4 fSumSol fSumDol FILL-IN_Voucher4 
...
DEFINE FRAME F-Main
     ...
     fSumSol AT ROW 12.04 COL 13 COLON-ALIGNED WIDGET-ID 46
     fSumDol AT ROW 12.04 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     FILL-IN_Voucher4 AT ROW 12.04 COL 64 COLON-ALIGNED WIDGET-ID 44
     "En US$" VIEW-AS TEXT
...
DEFINE FRAME F-Main
     ...
     RECT-39 AT ROW 11.77 COL 2 WIDGET-ID 50
     RECT-40 AT ROW 11.77 COL 27 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
