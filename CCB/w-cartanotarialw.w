...
FILL-IN-NroCarta TOGGLE-1 BROWSE-1 BUTTON-1 BUTTON-3 Btn_Done 
&Scoped-Define DISPLAYED-OBJECTS txt-fchcorte r-filtro FILL-IN-CodCli ~
FILL-IN-NomCli FILL-IN-NroCarta TOGGLE-1 
...
DEFINE FRAME F-Main
     ...
     TOGGLE-1 AT ROW 3.31 COL 38 WIDGET-ID 12
     BROWSE-1 AT ROW 4.27 COL 2
     BUTTON-1 AT ROW 14.65 COL 55
     BUTTON-3 AT ROW 14.65 COL 66
     Btn_Done AT ROW 14.65 COL 77
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB BROWSE-1 TOGGLE-1 F-Main */
...
DO:
    ASSIGN FILL-IN-NroCarta TOGGLE-1.
  RUN Imprimir.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE txt-fchcorte r-filtro FILL-IN-CodCli FILL-IN-NroCarta TOGGLE-1 
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Aviso de Cobranza 3'.   /* Con amenaza */
  RB-INCLUDE-RECORDS = 'O'.
  IF TOGGLE-1 = NO THEN RB-REPORT-NAME = 'Aviso de Cobranza 3 no'.
