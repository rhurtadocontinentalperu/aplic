...
DEFINE VAR x-Tipo   AS CHAR INIT 'DOCCASTIGADO' NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "DOCUMENTOS CASTIGADOS" VIEW-AS TEXT
          SIZE 28 BY .85 AT ROW 1 COL 47
          FONT 12
