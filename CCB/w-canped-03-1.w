...
DEFINE VARIABLE h_b-pedpen-03-1 AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN proc_CanPed IN h_b-pedpen-03-1.
...
DO:
    RUN dispatch IN h_b-pedpen-03-1 ('open-query-cases':U).
    RUN proc_CalTot IN h_b-pedpen-03-1.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/b-pedpen-03-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedpen-03-1 ).
       RUN set-position IN h_b-pedpen-03-1 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-pedpen-03-1 ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-pedpen-03-1 ,
