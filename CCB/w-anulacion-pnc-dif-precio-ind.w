...
/* 
    ...
    CCCC    = Concepto de la nota de credito
...
DEFINE FRAME F-Main
     BUTTON-33 AT ROW 1.12 COL 2.29 WIDGET-ID 4
     "  ANULACION DE PRE-NOTA DE CREDITO - DIFERENCIA DE PRECIO INDIVIDUAL" VIEW-AS TEXT
          SIZE 107.72 BY .96 AT ROW 1.08 COL 14.29 WIDGET-ID 2
          BGCOLOR 15 FGCOLOR 12 FONT 11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 122.72 BY 21.73 WIDGET-ID 100.
...
ON END-ERROR OF W-Win /* Anulacion de PRE-NOTAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Anulacion de PRE-NOTAS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'CCB/b-anulacion-pnc-dif-precio-ind.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listado-pnc-dif-precio-ind ).
       RUN set-position IN h_b-listado-pnc-dif-precio-ind ( 2.08 , 1.14 ) NO-ERROR.
       RUN set-size IN h_b-listado-pnc-dif-precio-ind ( 9.54 , 117.29 ) NO-ERROR.
       ...
       RUN set-position IN h_b-listado-pnc-dif-precio-ind-d ( 11.88 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-listado-pnc-dif-precio-ind-d ( 10.58 , 122.72 ) NO-ERROR.
