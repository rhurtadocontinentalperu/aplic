...
&Scoped-Define ENABLED-OBJECTS Btn_OK FILL-IN-1 Btn_Cancel Btn_Help ~
BUTTON-1 
...
DEFINE FRAME D-Dialog
     ...
     BUTTON-1 AT ROW 6 COL 18
     SPACE(32.13) SKIP(5.14)
...
ON CHOOSE OF BUTTON-1 IN FRAME D-Dialog /* ver */
DO:
  message fill-in-1.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-1 
      WITH FRAME D-Dialog.
  ENABLE Btn_OK FILL-IN-1 Btn_Cancel Btn_Help BUTTON-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
