...
CcbCCaja.ImpUsa[4] CcbCCaja.CodBco[4] 
...
DEFINE FRAME F-Main
     ...
     CcbCCaja.ImpNac[4] AT ROW 11.38 COL 15.43 COLON-ALIGNED WIDGET-ID 2
          LABEL "Pago con POS" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
...
ASSIGN 
       CcbCCaja.ImpNac[3]:HIDDEN IN FRAME F-Main           = TRUE.
...
ON LEAVE OF CcbCCaja.ImpNac[4] IN FRAME F-Main /* Pago con POS */
DO:
    /*
...
------------------------------------------------------------------------------*/
  ...
  cTabla = "CONFIG-VTAS".
  cLlave_c1 = "CAJA".
  cLlave_c2 = "MODALIDAPAGO".
  cLlave_c3 = "BILLETERA/TARJETA".
  ...
  IF AVAILABLE vtatabla THEN DO:
      cDivision = TRIM(vtatabla.llave_c4).
  END.
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      */
      ...
      IF lookup(s-coddiv,cDivision) = 0 THEN DO:
          /*
          MESSAGE "La division " s-coddiv " no esta configurada" SKIP
                "para activar las modalidades de pago Tarjea y/o billetera electronica".
          */
      END.
