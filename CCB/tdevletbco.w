...
------------------------------------------------------------------------------*/
   ...
   IF NOT AVAILABLE CcbCDocu THEN DO:
       ...
       RETURN 'ADM-ERROR'.
   END.
   IF NOT (Ccbcdocu.flgest = 'P' AND Ccbcdocu.flgubi = s-FlgUbi AND Ccbcdocu.flgsit = s-FlgSit) THEN DO:
       MESSAGE 'La Letra NO cumple los requisitos para ser devuelta por el banco' 
