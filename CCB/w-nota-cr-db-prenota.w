...
DEFINE VARIABLE h_v-nota-cr-db-prenota AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "NOTAS DE CREDITO POR PRE-NOTA"
         HEIGHT             = 9.88
         WIDTH              = 142.86
         MAX-HEIGHT         = 26.15
         MAX-WIDTH          = 191.29
...
ON END-ERROR OF W-Win /* NOTAS DE CREDITO POR PRE-NOTA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* NOTAS DE CREDITO POR PRE-NOTA */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/v-nota-cr-db-prenota.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nota-cr-db-prenota ).
       RUN set-position IN h_v-nota-cr-db-prenota ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-nota-cr-db-prenota. */
       RUN add-link IN adm-broker-hdl ( h_p-updv13 , 'TableIO':U , h_v-nota-cr-db-prenota ).
       RUN add-link IN adm-broker-hdl ( h_qnotacreditodebito , 'Record':U , h_v-nota-cr-db-prenota ).
