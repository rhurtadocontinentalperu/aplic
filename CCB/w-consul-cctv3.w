...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 161.14 BY 25.65 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/v-consul-cctv3.w':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Documentos|Retenciones|Fac. Adelanta|Campaña|Observ Crédit|Observ Ventas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 6.92 , 1.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/b-consul-cctv3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consul-cctv3 ).
       RUN set-position IN h_b-consul-cctv3 ( 8.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-consul-cctv3 ( 18.27 , 105.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consu3 ).
       RUN set-position IN h_b-consu3 ( 11.08 , 107.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consu4-2 ).
       RUN set-position IN h_b-consu4-2 ( 17.81 , 107.00 ) NO-ERROR.
    ...
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-obsvta ).
       RUN set-position IN h_v-obsvta ( 8.54 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.35 , 69.00 ) */

       /* Links to SmartViewer h_v-obsvta. */
       RUN add-link IN adm-broker-hdl ( h_q-consul-cctv3 , 'Record':U , h_v-obsvta ).
