...
DEF NEW SHARED VAR x-coddoc AS CHAR INITIAL "A/R".
...
FIND CcbDTerm WHERE 
  ...
  FIND FIRST FacCorre WHERE 
       ...
       NO-LOCK NO-ERROR.
  IF NOT AVAILABLE FacCorre THEN DO:
      MESSAGE "No esta definido Documento Anticipo para la Division"  SKIP
...
DEFINE FRAME F-Main
     CB-CodDoc AT ROW 8.27 COL 1.14 NO-LABEL
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-remesa ).
       RUN set-position IN h_q-remesa ( 8.15 , 7.86 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/v-antrec.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_v-remesa-x ).
       /* Position in UIB:  ( 1.00 , 1.57 ) */
       /* Size in UIB:  ( 6.73 , 76.57 ) */

       /* Links to  h_v-remesa-x. */
