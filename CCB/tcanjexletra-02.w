...
&Scoped-Define ENABLED-OBJECTS br_table COMBO-BOX-NroSer f-NroLet BUTTON-2 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 43 BY 6.73
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX-NroSer AT ROW 1.19 COL 21 COLON-ALIGNED WIDGET-ID 2
     f-LetIni AT ROW 2.15 COL 21 COLON-ALIGNED WIDGET-ID 4
     f-NroLet AT ROW 3.12 COL 21 COLON-ALIGNED WIDGET-ID 18
     BUTTON-2 AT ROW 4.46 COL 6 WIDGET-ID 16
     f-ImpTot AT ROW 7.92 COL 62 COLON-ALIGNED WIDGET-ID 14
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE FacCorre THEN DO:
      MESSAGE "Numero de Serie para el documento : LET " SKIP
            "y division : " + S-CODDIV + " no existe" SKIP
            "Por favor comuniquese con su KEY USER"
  ...
  FIND FIRST Gn-convt WHERE Gn-convt.Codig = S-CONDIC NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  /* Verifica fechas */
/*   IF DOCU.FchVto < DOCU.FchDoc THEN DO:                                                      */
/*       MESSAGE 'La fecha de NO DEBE ser menor a la fecha de emision' VIEW-AS ALERT-BOX ERROR. */
/*       APPLY 'ENTRY':U TO DOCU.FchVto IN BROWSE {&BROWSE-NAME}.                               */
/*       UNDO, RETURN 'ADM-ERROR'.                                                              */
/*   END.                                                                                       */
/*   IF DOCU.FchVto - TODAY > 365 THEN DO:                                                      */
/*       MESSAGE 'La fecha de vencimiento no debe' SKIP                                         */
/*             'no debe superar los 365 dias'                                                   */
/*            VIEW-AS ALERT-BOX ERROR.                                                          */
/*       APPLY 'ENTRY':U TO DOCU.FchVto IN BROWSE {&BROWSE-NAME}.                               */
/*       UNDO, RETURN 'ADM-ERROR'.                                                              */
/*   END.                                                                                       */
