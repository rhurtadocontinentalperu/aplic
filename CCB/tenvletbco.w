...
DEFINE FRAME F-Main
     ...
     FILL-IN-Total AT ROW 7.73 COL 69 COLON-ALIGNED WIDGET-ID 2
...
------------------------------------------------------------------------------*/
   ...
   IF TRUE <> (MVTO.NroRef:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} > '') THEN DO:
   ...
   IF NOT AVAILABLE CcbCDocu THEN DO:
       ...
       RETURN 'ADM-ERROR'.
   END.
   IF NOT (Ccbcdocu.flgest = 'P' AND Ccbcdocu.flgubi = 'C' 
           AND (Ccbcdocu.flgsit = '' OR Ccbcdocu.flgsit = 'C')) THEN DO:
