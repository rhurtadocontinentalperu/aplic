...
&Scoped-define FIELDS-IN-QUERY-br_table T-CDOCU.CodDoc T-CDOCU.NroDoc ~
T-CDOCU.FchDoc T-CDOCU.CodCli T-CDOCU.NomCli T-CDOCU.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-CDOCU.NroDoc FORMAT "X(12)":U WIDTH 12.57
      T-CDOCU.FchDoc FORMAT "99/99/9999":U
      T-CDOCU.CodCli FORMAT "x(11)":U WIDTH 12.72
      T-CDOCU.NomCli FORMAT "x(50)":U WIDTH 50.14
      T-CDOCU.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"T-CDOCU.NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "12.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = Temp-Tables.T-CDOCU.FchDoc
     _FldNameList[4]   > Temp-Tables.T-CDOCU.CodCli
"T-CDOCU.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-CDOCU.NomCli
"T-CDOCU.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "50.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-CDOCU.ImpTot
"T-CDOCU.ImpTot" ? ? "decimal" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  /* Solicitamos T-DDOCU */
    RUN Devuelve-TDDOCU IN lh_handle (OUTPUT TABLE T-DDOCU).
    RUN ccb/d-nc-dcto-por-vol-v2 (INPUT TABLE T-DDOCU, INPUT T-CDOCU.coddoc, INPUT T-CDOCU.nrodoc).
