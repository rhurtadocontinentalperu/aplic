...
DO iItem = 1 TO NUM-ENTRIES(cListaDocCargo):
    FOR EACH Ccbcdocu NO-LOCK WHERE Ccbcdocu.codcia = s-codcia AND
        ...
        /* 11/06/2026: NO venta contado mostrador */
        IF LOOKUP(TRIM(Ccbcdocu.coddoc), 'FAC,BOL') > 0 THEN DO:
            IF Ccbcdocu.Tipo = "MOSTRADOR" OR Ccbcdocu.fmapgo = "000" THEN NEXT.
        END.
        ...
        lOk = FALSE.
        /* Amortización */
        FOR EACH ccbdcaja NO-LOCK WHERE ccbdcaja.codcia = ccbcdocu.codcia AND
