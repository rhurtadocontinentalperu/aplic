...
&Scoped-Define ENABLED-OBJECTS RECT-49 RECT-22 Btn_OK f-imptot Btn_Cancel 
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* REDONDEO DE LA NOTA DE ABONO */
DO:  
...
DO:
  ...
  IF ABSOLUTE(DECIMAL(F-Imptot:SCREEN-VALUE) - CcbcDocu.ImpTot2 ) > Faccfggn.Roundocu  
  THEN DO: 
...
------------------------------------------------------------------------------*/
  DISPLAY f-imptot 
      WITH FRAME D-Dialog.
  ENABLE RECT-49 RECT-22 Btn_OK f-imptot Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
