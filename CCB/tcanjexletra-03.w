...
&Scoped-define FIELDS-IN-QUERY-br_table DOCU.CodDoc DOCU.NroDoc DOCU.FchDoc ~
DOCU.FchVto c-Mon[DOCU.CodMon] DOCU.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      c-Mon[DOCU.CodMon] COLUMN-LABEL "Mon." WIDTH 3.72
      DOCU.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 16.72
  ENABLE
      DOCU.FchDoc
      DOCU.FchVto
      DOCU.ImpTot
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 64 BY 6.73
...
DEFINE FRAME F-Main
     ...
     f-ImpTot AT ROW 7.92 COL 47 COLON-ALIGNED WIDGET-ID 14
...
"DOCU.FchVto" "Fecha de Vencimiento" ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"c-Mon[DOCU.CodMon]" "Mon." ? ? ? ? ? ? ? ? no ? no no "3.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.DOCU.ImpTot
"DOCU.ImpTot" ? ? "decimal" ? ? ? ? ? ? yes ? no no "16.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      DOCU.SdoAct = DOCU.ImpTot.
/*   /* Verifica fechas */                                                   */
/*   IF DOCU.FchVto < DOCU.FchDoc THEN DO:                                   */
/*       MESSAGE 'Error en la fecha de vencimiento' VIEW-AS ALERT-BOX ERROR. */
