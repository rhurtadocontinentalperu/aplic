...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table MVTO.FchEmi ~
MVTO.FchVto ~
MVTO.ImpTot   
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table MVTO
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table MVTO
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH MVTO WHERE       MVTO.TpoRef = "L" NO-LOCK
...
&Scoped-Define ENABLED-OBJECTS RECT-11 br_table F-Plazo F-NroLet G-Letras 
...
IF DECIMAL(MVTO.ImpTot:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) = 0 THEN DO:
   ...
   RETURN "ADM-ERROR".
END.
IF DATE(MVTO.FchVto) <  DATE(MVTO.FchEmi) THEN DO:
    MESSAGE "La fecha de vencimiento debe ser mayor a la de emision" VIEW-AS ALERT-BOX ERROR.
    RETURN "ADM-ERROR".
END.
RETURN "OK".
END PROCEDURE.
