...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 7.08 COL 102
     BUTTON-2 AT ROW 8.62 COL 102
     BtnDone AT ROW 10.15 COL 102 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1.04
         SIZE 117.72 BY 25.19
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'gn/b-divisiones-x-div.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-divisiones ).
       RUN set-position IN h_b-divisiones ( 1.00 , 1.43 ) NO-ERROR.
       ...
       RUN set-position IN h_baprobarncndotrosv2 ( 6.38 , 1.43 ) NO-ERROR.
       ...
       RUN set-position IN h_vnotacreditodebito ( 12.38 , 1.29 ) NO-ERROR.
       ...
       RUN set-position IN h_b-anticipos-detalle ( 21.38 , 1.57 ) NO-ERROR.
