...
&Scoped-Define ENABLED-OBJECTS FILL-IN-CodCli BUTTON-1 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-CodCli FILL-IN_NomCli ~
FILL-IN-Mensaje 
...
DEFINE FRAME FRAME-A
     FILL-IN-CodCli AT ROW 1.19 COL 10 COLON-ALIGNED WIDGET-ID 64
     FILL-IN_NomCli AT ROW 1.19 COL 25 NO-LABEL WIDGET-ID 26
     FILL-IN-Mensaje AT ROW 1.19 COL 84 COLON-ALIGNED NO-LABEL WIDGET-ID 62
...
/* SETTINGS FOR FILL-IN FILL-IN-Mensaje IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
       FILL-IN-Mensaje:HIDDEN IN FRAME FRAME-A           = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN_NomCli IN FRAME FRAME-A
   NO-ENABLE ALIGN-L                                                    */
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.12 , 122.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
ON LEAVE OF FILL-IN-CodCli IN FRAME FRAME-A /* Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE get-codclie q-tables 
...
pCodClie = TRIM(FILL-IN-CodCli:SCREEN-VALUE IN FRAME {&FRAME-NAME}).
...
------------------------------------------------------------------------------*/
  ...
  IF s-codcliente <> "?" THEN DO:
      FILL-IN-codcli:SCREEN-VALUE IN FRAME {&FRAME-NAME} = s-codcliente.
      ASSIGN FILL-IN-codcli.

      DISABLE FILL-IN-codcli WITH FRAME {&FRAME-NAME}.
