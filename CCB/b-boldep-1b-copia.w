...
------------------------------------------------------------------------------*/
    ...
    chWorkSheet:Range("B3"):Value = "Depósito".
    chWorkSheet:Range("C3"):Value = "Cliente".
    chWorkSheet:Range("D3"):Value = "División".
    chWorkSheet:Range("E3"):Value = "Emisión".
    chWorkSheet:Range("F3"):Value = "Estado".
    chWorkSheet:Range("G3"):Value = "Banco".
    chWorkSheet:Range("H3"):Value = "Moneda".
    chWorkSheet:Range("I3"):Value = "Importe".
    chWorkSheet:Range("J3"):Value = "Saldo".
    chWorkSheet:Range("K3"):Value = "Ingreso a Caja".
    chWorkSheet:Range("L3"):Value = "Depósito".
    chWorkSheet:Range("M3"):Value = "Solicitante".
    
    FOR EACH T-BDEPO NO-LOCK BREAK BY T-BDEPO.codcia BY T-BDEPO.codcli:
        t-column = t-column + 1.
        cColumn = STRING(t-Column).
        cRange = "A" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.nrodoc.
        cRange = "B" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.nroref.
        cRange = "C" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.nomcli.
        cRange = "D" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.coddiv.
        cRange = "E" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.fchdoc.
        cRange = "F" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.estado.
        cRange = "G" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.FlgAte.
        cRange = "H" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.moneda.
        cRange = "I" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.imptot.
        cRange = "J" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.sdoact.
        cRange = "K" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.ingcaja.
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.FchAte.
        cRange = "M" + cColumn.
        chWorkSheet:Range(cRange):VALUE = T-BDEPO.Usuario.
        DISPLAY
            "  Número: " +  T-BDEPO.nrodoc @ Fi-Mensaje
