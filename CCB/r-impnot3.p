...
DEFINE FRAME F-HdrN/D
    ...
    X-nomcli AT 12 FORMAT "x(50)" SKIP
    X-dircli AT 12 FORMAT "x(35)" SKIP
...
DEFINE FRAME F-HdrN/C
    HEADER
    SKIP(5)
    X-nomcli AT 12 FORMAT "x(50)" SKIP(1.5)
    X-dircli AT 12 FORMAT "x(50)" SKIP(1.5)
    X-ruccli AT 12 FORMAT "x(11)"  
...
&IF DEFINED(EXCLUDE-Imp-NC-Devoluciones) = 0 &THEN
...
&IF DEFINED(EXCLUDE-Imp-NC-Otros) = 0 &THEN
