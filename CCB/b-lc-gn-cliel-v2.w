...
&Scoped-Define ENABLED-OBJECTS br_table BUTTON-4 BUTTON-3 ChkbComoDNI 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Gn-ClieL.FchAut[1] FORMAT "99/99/9999":U WIDTH 9.43
  ENABLE
      Gn-ClieL.FchIni
      Gn-ClieL.FchFin
      Gn-ClieL.ImpLC
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 67.72 BY 6.08
...
DEFINE FRAME F-Main
     ...
     BUTTON-4 AT ROW 7.46 COL 2 WIDGET-ID 6
     BUTTON-3 AT ROW 7.46 COL 17 WIDGET-ID 2
...
"Gn-ClieL.FchAut[1]" ? ? "date" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON CHOOSE OF BUTTON-4 IN FRAME F-Main /* Historial */
DO:
  RUN ccb/d-lc-gn-cliel (gn-clie.codcli).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE actualizable B-table-Win 
PROCEDURE actualizable :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE INPUT PARAMETER pActualizable AS LOG NO-UNDO.

IF pActualizable = NO THEN DO:
    DISABLE BUTTON-4 WITH FRAME {&FRAME-NAME}.
    DISABLE BUTTON-3 WITH FRAME {&FRAME-NAME}.
    DISABLE ChkbComoDNI WITH FRAME {&FRAME-NAME}.
END.
