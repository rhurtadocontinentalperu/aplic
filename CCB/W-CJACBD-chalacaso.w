...
DEFINE NEW SHARED VARIABLE S-TIPO      AS CHAR INITIAL "@CJMXXX".  /* CAJA MENSUAL */
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH CcbCCaja WHERE CcbCCaja.CodCia = s-codcia AND
        ...
        (CcbCCaja.FchCie = DATE(03,01,2016) OR CcbCCaja.FchCie = DATE(03,29,2016)) AND
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH CcbCCaja NO-LOCK WHERE CcbCCaja.CodCia = s-codcia 
        ...
        AND (CcbCCaja.FchCie = DATE(03,01,2016) OR CcbCCaja.FchCie = DATE(03,29,2016))
