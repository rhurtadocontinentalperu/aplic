...
&Scoped-define FIELDS-IN-QUERY-br_table CcbCCaja.FchDoc CcbCCaja.FchCie ~
CcbCCaja.Tipo CcbCCaja.NroDoc _FlgEst() @ x-Estado CcbCCaja.UsrAnu ~
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Estado x-Divisiones x-FchDoc-1 ~
x-FchDoc-2 CMB-filtro FILL-IN-filtro br_table 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCCaja.NroDoc FORMAT "X(12)":U WIDTH 9.43
...
/* Query rebuild information for BROWSE br_table
 ...
 AND CcbCCaja.FchDoc <= x-FchDoc-2
 AND {&Condicion}"
     _FldNameList[1]   = INTEGRAL.CcbCCaja.FchDoc
     _FldNameList[2]   = INTEGRAL.CcbCCaja.FchCie
     _FldNameList[3]   > INTEGRAL.CcbCCaja.Tipo
"Tipo" "Tipo" "x(12)" "character" ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.CcbCCaja.NroDoc
"NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"_FlgEst() @ x-Estado" "Estado" "x(10)" ? ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.CcbCCaja.UsrAnu
"UsrAnu" "Usr.Anul." "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"NomCli" "Nombre del Cliente" "X(60)" "character" ? ? ? ? ? ? no ? no no "38" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.CcbCCaja.CodCaja
"CodCaja" "Terminal" "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.CcbCCaja.usuario
"usuario" "Cajero" ? "character" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
