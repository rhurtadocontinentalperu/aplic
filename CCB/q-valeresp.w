...
/*&SCOPED-DEFINE Condicion  CcbValeResp.CodCia = s-codcia*/
&SCOPED-DEFINE Condicion  CcbValeResp.CodCia = s-codcia AND CcbValeResp.CodDiv = s-coddiv
...
&Scoped-define INTERNAL-TABLES CcbValeResp

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH CcbValeResp WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    BY CcbValeResp.Correlativo DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbValeResp WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    BY CcbValeResp.Correlativo DESCENDING.
&Scoped-define TABLES-IN-QUERY-Query-Main CcbValeResp
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main CcbValeResp
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.CcbValeResp"
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "INTEGRAL.CcbValeResp.Correlativo|no"
     _Where[1]         = "{&Condicion}"
