...
DEFINE FRAME F-Main
     BUTTON-33 AT ROW 1.12 COL 95 WIDGET-ID 4
     "  APROBACION DE PRE-NOTAS DE CREDITO (PNC)" VIEW-AS TEXT
          SIZE 68 BY .96 AT ROW 1.12 COL 2 WIDGET-ID 2
          BGCOLOR 15 FGCOLOR 9 FONT 11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 140.57 BY 19 WIDGET-ID 100.
...
DO:
  RUN refrescar IN h_b-listado-pnc-dif-precio-ind.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/b-listado-pnc-dif-precio-ind.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listado-pnc-dif-precio-ind ).
       RUN set-position IN h_b-listado-pnc-dif-precio-ind ( 2.08 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-listado-pnc-dif-precio-ind ( 7.12 , 117.29 ) NO-ERROR.
       ...
       RUN set-position IN h_b-listado-pnc-dif-precio-ind-d ( 9.27 , 1.00 ) NO-ERROR.
