...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCCaja.NomCli COLUMN-LABEL "Nombre de Cliente" FORMAT "X(50)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"NroDoc" "Numero I/C" "XXX-XXXXXXXX" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.CcbCCaja.FchDoc
"FchDoc" "Fecha de I/C" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[3]   > integral.CcbCCaja.NomCli
"NomCli" "Nombre de Cliente" "X(50)" "character" ? ? ? ? ? ? no ?
