...
&Scoped-Define ENABLED-OBJECTS FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 Btn_OK ~
Btn_Cancel 
...
DEFINE FRAME F-Main
     FILL-IN-FchDoc-1 AT ROW 2.15 COL 18 COLON-ALIGNED
     FILL-IN-FchDoc-2 AT ROW 3.31 COL 18 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 Btn_OK Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEF VAR s-Moneda AS CHAR FORMAT 'x(3)'.
    
  DEFINE FRAME F-REPORTE
    ccbboldep.nrodoc COLUMN-LABEL "Numero"
    ccbboldep.fchdoc COLUMN-LABEL "Fecha"
    ccbboldep.codcta COLUMN-LABEL "Cuenta"
    ccbboldep.descta COLUMN-LABEL "Descripcion" FORMAT 'x(35)'
    ccbboldep.codcli COLUMN-LABEL "Cliente"     FORMAT 'x(11)'
    ccbboldep.nomcli COLUMN-LABEL "Nombre"      FORMAT 'x(35)'
    s-Moneda        COLUMN-LABEL "Mon"
  ...
  DEFINE FRAME F-HEADER       
    HEADER
        ...
        {&PRN6A} + "BOLETAS DE DEPOSITO"  AT 50 FORMAT "X(35)"
        {&PRN4} + {&PRN6B} + "Pag.  : " AT 109 FORMAT "X(10)" PAGE-NUMBER(REPORT) FORMAT "ZZ9" SKIP
        {&PRN4} + "Fecha : " AT 109 FORMAT "X(10)" STRING(TODAY,"99/99/9999") + {&PRN6B} + {&PRND} FORMAT "X(12)" 
        "Hora  : " AT 109 STRING(TIME,"HH:MM:SS") SKIP
  ...
  FOR EACH ccbboldep WHERE ccbboldep.codcia = s-codcia
        ...
        AND ccbboldep.fchdoc >= FILL-IN-FchDoc-1
        AND ccbboldep.fchdoc <= FILL-IN-FchDoc-2
        NO-LOCK:
    DISPLAY ccbboldep.nrodoc @ Fi-Mensaje LABEL "Numero "
             FORMAT "X(11)" 
             WITH FRAME F-Proceso.
  
    VIEW STREAM REPORT FRAME F-HEADER.
    CASE ccbboldep.codmon:
