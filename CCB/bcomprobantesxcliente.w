...
&Scoped-define INTERNAL-TABLES gn-clie CcbCDocu
...
CcbCDocu.NroDoc CcbCDocu.FmaPgo CcbCDocu.FchDoc CcbCDocu.FchVto ~
CcbCDocu.FchCan ( IF CcbCDocu.CodMon = 1 THEN 'S/.' ELSE 'US$' ) @ x-Mon ~
CcbCDocu.ImpTot - CcbCDocu.AcuBon[5] @ x-ImpSinPer CcbCDocu.AcuBon[5] ~
CcbCDocu.ImpTot CcbCDocu.SdoAct fEstado() @ X-EST 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH gn-clie WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH CcbCDocu OF gn-clie ~
      WHERE (CcbCDocu.CodDoc = "FAC" ~
 ...
 AND CcbCDocu.FlgEst <> "A" NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gn-clie WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH CcbCDocu OF gn-clie ~
      WHERE (CcbCDocu.CodDoc = "FAC" ~
  OR CcbCDocu.CodDoc = "BOL" ~
  OR CcbCDocu.CodDoc = "N/C" ~
 ...
 AND CcbCDocu.FlgEst <> "A" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gn-clie CcbCDocu
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ( IF CcbCDocu.CodMon = 1 THEN 'S/.' ELSE 'US$' ) @ x-Mon
      CcbCDocu.ImpTot - CcbCDocu.AcuBon[5] @ x-ImpSinPer
      CcbCDocu.AcuBon[5] FORMAT "->>>,>>>,>>9.99":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.gn-clie,INTEGRAL.CcbCDocu OF INTEGRAL.gn-clie"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[2]         = "(CcbCDocu.CodDoc = ""FAC""
  OR CcbCDocu.CodDoc = ""BOL""
  OR CcbCDocu.CodDoc = ""N/C""
  OR CcbCDocu.CodDoc = ""N/D""
  OR CcbCDocu.CodDoc = ""LET""
...
"( IF CcbCDocu.CodMon = 1 THEN 'S/.' ELSE 'US$' ) @ x-Mon" ? ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"CcbCDocu.ImpTot - CcbCDocu.AcuBon[5] @ x-ImpSinPer" ? ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = INTEGRAL.CcbCDocu.AcuBon[5]
     _FldNameList[11]   = INTEGRAL.CcbCDocu.ImpTot
     _FldNameList[12]   = INTEGRAL.CcbCDocu.SdoAct
     _FldNameList[13]   > "_<CALC>"
"fEstado() @ X-EST" ? ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
