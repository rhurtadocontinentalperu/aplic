...
FOR EACH y-Ccbdcaja NO-LOCK WHERE y-Ccbdcaja.CodCia = s-codcia
    ...
    IF y-Ccbdcaja.codref = "LET" THEN DO:
        ...
        RUN trazabilidad-mov-del-lpa(INPUT x-CcbDMvto.CodDoc, INPUT x-CcbDMvto.NroDoc,      /* I/C */
...
END PROCEDURE.
        ...
        RUN letra-origen-del-movimiento(INPUT y-Ccbdcaja.codref, INPUT y-Ccbdcaja.nroref, 
                                                  OUTPUT x-codmov, OUTPUT x-nromov).
        
        IF x-codmov = 'CLA' THEN DO:

            x-importe-letra = y-Ccbdcaja.imptot.
            x-coddoc = "".
            x-nrodoc = "".
            ...
            FOR EACH x-ccbccaja WHERE x-ccbccaja.codcia = s-codcia and x-ccbccaja.tipo = 'CANCELACION' and 
                ...
                FOR EACH x-ccbdcaja OF x-ccbccaja WHERE LOOKUP(x-ccbdcaja.codref,"N/C,NCI") = 0 NO-LOCK:
                    ...
                    CREATE x-w-report.
                        ASSIGN x-w-report.task-no = x-conteo
                                x-w-report.campo-c[1] = y-Ccbdcaja.CodDoc   /* I/C de la cancelacion de la letra */
                                x-w-report.campo-c[2] = y-Ccbdcaja.NroDoc
                                x-w-report.campo-c[3] = y-Ccbdcaja.codref   /* LET */
                                x-w-report.campo-c[4] = y-Ccbdcaja.nroref
                ...
                x-conteoX = 1.
                x-suma = 0.
                FOR EACH w-report WHERE x-w-report.campo-c[1] = y-Ccbdcaja.CodDoc   /* I/C de la cancelacion de la letra */
                                        AND x-w-report.campo-c[2] = y-Ccbdcaja.NroDoc
                                        AND x-w-report.campo-c[3] = y-Ccbdcaja.codref   /* LET */
                                        AND x-w-report.campo-c[4] = y-Ccbdcaja.nroref
