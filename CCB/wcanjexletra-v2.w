...
DEFINE FRAME F-Main
     ...
     BtnExcel AT ROW 20.04 COL 8 WIDGET-ID 12
     RECT-25 AT ROW 7.92 COL 2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 107.86 BY 25.92
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/b-division-canje.w':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv14 ).
       RUN set-position IN h_p-updv14 ( 6.58 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 6.58 , 81.00 ) NO-ERROR.
       ...
       RUN set-position IN h_vcanjexletra ( 8.12 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.31 , 102.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/qcanjexletra-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'SortBy-Case = NroDoc':U ,
             OUTPUT h_qcanjexletra-v2 ).
       RUN set-position IN h_qcanjexletra-v2 ( 6.58 , 69.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra-v2 , 'Record':U , h_vcanjexletra ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-01 ( 11.96 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_bcanjexletra-02 ( 18.54 , 25.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_tcanjexletra-01 ( 11.58 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 11.96 , 94.00 ) NO-ERROR.
       ...
       RUN set-position IN h_tcanjexletra-02 ( 18.12 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 19.27 , 94.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_bcanjexletra-01-2 ( 11.58 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_tcanjexletra-03 ( 18.31 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 19.27 , 88.00 ) NO-ERROR.
...
btnExcel:VISIBLE IN FRAME {&FRAME-NAME} = NO.

CASE L-Handle:
    WHEN "Pide-Serie" THEN DO:
         RUN Numero-Serie.
         RUN dispatch IN h_qcanjexletra-v2 ('open-query':U).
         btnExcel:VISIBLE IN FRAME {&FRAME-NAME} = YES.
    END.
    ...
    WHEN "disable-header" THEN DO:
        /*RUN dispatch IN h_vcanjexletra ('disable':U).*/
        RUN dispatch IN h_qcanjexletra-v2 ('disable':U).
        COMBO-NroSer:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
    END.
    WHEN "enable-header" THEN DO:
        /*RUN dispatch IN h_vcanjexletra ('enable':U).*/
        RUN dispatch IN h_qcanjexletra-v2 ('enable':U).
        COMBO-NroSer:SENSITIVE IN FRAME {&FRAME-NAME} = YES.
    END.
