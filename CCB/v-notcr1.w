...
&Scoped-Define ENABLED-OBJECTS RECT-23 Btn-Otros 
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.ImpIsc CcbCDocu.PorDto ~
CcbCDocu.ImpBrt CcbCDocu.ImpExo CcbCDocu.ImpDto CcbCDocu.ImpVta ~
CcbCDocu.AcuBon[5] CcbCDocu.ImpTot CcbCDocu.ImpIgv 
...
DEFINE FRAME F-Main
     CcbCDocu.ImpIsc AT ROW 1.19 COL 55 COLON-ALIGNED NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     Btn-Otros AT ROW 1.19 COL 69
     CcbCDocu.PorDto AT ROW 1.27 COL 27.57 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5.72 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpBrt AT ROW 2.85 COL 5.72 NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpExo AT ROW 2.85 COL 14.43 COLON-ALIGNED NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpDto AT ROW 2.85 COL 24.86 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpVta AT ROW 2.85 COL 35.57 COLON-ALIGNED NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.AcuBon[5] AT ROW 2.85 COL 56 COLON-ALIGNED NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpTot AT ROW 2.85 COL 69 COLON-ALIGNED NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpIgv AT ROW 2.88 COL 45.57 COLON-ALIGNED NO-LABEL FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     "Percepción" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 2.27 COL 58 WIDGET-ID 4
     "I.S.C." VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 1.19 COL 48
     "Valor Venta" VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 37.57
     "Imp.Dcto." VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 26.86
     "Imp.Total" VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 71
     "Imp.Bruto" VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 5.72
     "Exonerado" VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 16.43
     "I.G.V." VIEW-AS TEXT
          SIZE 8.57 BY .5 AT ROW 2.27 COL 48.57
...
/* SETTINGS FOR FILL-IN CcbCDocu.AcuBon[5] IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN CcbCDocu.ImpVta IN FRAME F-Main
   NO-ENABLE EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN CcbCDocu.PorDto IN FRAME F-Main
   NO-ENABLE                                                            */
