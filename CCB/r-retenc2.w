...
FILL-IN-fchcan-1 BTN_Ok BTN_Exit 
...
DEFINE FRAME D-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "Reporte Retenciones Pendientes".
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Reporte Retenciones Pendientes */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-codcli FILL-IN-fchcan FILL-IN-fchcan-1 
      WITH FRAME D-Dialog.
  ENABLE RECT-1 RECT-2 FILL-IN-codcli FILL-IN-fchcan FILL-IN-fchcan-1 BTN_Ok 
         BTN_Exit 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ASSIGN
            s-titulo = "REPORTE DE RETENCIONES PENDIENTES"
            FILL-IN-codcli
            FILL-IN-fchcan
            FILL-IN-fchcan-1.
        ...
        s-subtit =
            "DESDE " + STRING(FILL-IN-fchcan) +
            " HASTA " + STRING(FILL-IN-fchcan-1).
    END.

    GET-KEY-VALUE SECTION 'STARTUP' KEY 'BASE' VALUE RB-REPORT-LIBRARY.
    ASSIGN
        RB-REPORT-LIBRARY = RB-REPORT-LIBRARY + "ccb/rbccb.prl"
        RB-REPORT-NAME = "RETENCIONES PENDIENTES"
