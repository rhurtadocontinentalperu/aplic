...
&Scoped-Define ENABLED-OBJECTS RECT-34 RECT-6 RECT-4 RECT-10 RECT-7 RECT-9 ~
RECT-8 RECT-32 RECT-5 Btn_OK R-Codmon Btn_Cancel FILL-IN_ImpNac1 ~
FILL-IN_ImpNac4 FILL-IN_ImpNac5 FILL-IN_ImpNac6 FILL-IN_ImpUsa1 ~
FILL-IN_ImpUsa4 FILL-IN_ImpUsa5 FILL-IN_ImpUsa6 FILL-IN_Voucher4 ~
FILL-IN_Voucher5 FILL-IN_Voucher6 x-TarjetaCredito BUTTON-3 F-CLIECHE 
...
FILL-IN_ImpNac6 FILL-IN_ImpNac7 FILL-IN_VueNac y-CodMon FILL-IN_ImpUsa1 ~
FILL-IN_ImpUsa2 FILL-IN_ImpUsa4 FILL-IN_ImpUsa5 FILL-IN_ImpUsa6 ~
FILL-IN_ImpUsa7 FILL-IN_VueUsa y-SdoAct FILL-IN_Voucher2 FILL-IN_Voucher4 ~
FILL-IN_Voucher5 FILL-IN_Voucher6 FILL-IN_T_Venta FILL-IN_T_Compra ~
FILL-IN_CodBco2 FILL-IN_CodBco4 FILL-IN_CodBco5 FILL-IN-3 x-TarjetaCredito ~
FILL-IN-5 F-CLIECHE F-NroRec F-Presen FILL-IN_Saldo F-TipCom F-Numfac ~
FILL-IN-4 
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 12.35 COL 2
     R-Codmon AT ROW 11.04 COL 8.72 NO-LABEL
     F-cliente AT ROW 1.38 COL 11 COLON-ALIGNED
     X-CodMon AT ROW 3 COL 11 COLON-ALIGNED
     Btn_Cancel AT ROW 12.35 COL 14.14
     ...
     FILL-IN_ImpNac7 AT ROW 9.85 COL 14 COLON-ALIGNED NO-LABEL
     FILL-IN_VueNac AT ROW 11.12 COL 14 COLON-ALIGNED NO-LABEL
     ...
     FILL-IN_ImpUsa7 AT ROW 9.85 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_VueUsa AT ROW 11.12 COL 26 COLON-ALIGNED NO-LABEL
     y-SdoAct AT ROW 3 COL 32 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher2 AT ROW 6.12 COL 37.57 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher4 AT ROW 6.92 COL 37.72 COLON-ALIGNED NO-LABEL
     ...
     FILL-IN_T_Venta AT ROW 12.42 COL 51.43 COLON-ALIGNED
     FILL-IN_T_Compra AT ROW 13.19 COL 51.29 COLON-ALIGNED
     FILL-IN_CodBco2 AT ROW 6.12 COL 55.29 COLON-ALIGNED NO-LABEL
     FILL-IN_CodBco4 AT ROW 6.92 COL 55.29 COLON-ALIGNED NO-LABEL
     FILL-IN_CodBco5 AT ROW 7.73 COL 55.29 COLON-ALIGNED NO-LABEL
     FILL-IN-3 AT ROW 6.12 COL 61.72 COLON-ALIGNED NO-LABEL
     x-TarjetaCredito AT ROW 6.92 COL 61.72 COLON-ALIGNED NO-LABEL
     FILL-IN-5 AT ROW 7.73 COL 61.72 COLON-ALIGNED NO-LABEL
     BUTTON-3 AT ROW 9.65 COL 66
     F-CLIECHE AT ROW 1.38 COL 76.14 COLON-ALIGNED
     ...
     F-TipCom AT ROW 12.42 COL 74.14 COLON-ALIGNED
     F-Numfac AT ROW 13.19 COL 74.14 COLON-ALIGNED
     FILL-IN-4 AT ROW 6.96 COL 79 COLON-ALIGNED NO-LABEL
     ...
     "Vuelto" VIEW-AS TEXT
          SIZE 6.14 BY .5 AT ROW 11.31 COL 1.86
     ...
     "Vales de Compra" VIEW-AS TEXT
          SIZE 12 BY .5 AT ROW 9.85 COL 2
     "Cheque" VIEW-AS TEXT
...
DEFINE FRAME D-Dialog
     "Tarjeta de Credito" VIEW-AS TEXT
          SIZE 12.72 BY .5 AT ROW 7.12 COL 1.72
     "En S/." VIEW-AS TEXT
...
/* SETTINGS FOR FILL-IN F-Numfac IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Presen IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
ON CHOOSE OF BUTTON-3 IN FRAME D-Dialog /* Ingresar Vales de Compra */
DO:
...
DO WITH FRAME D-Dialog:
 ...
 /*
   IF R-Codmon = 2 THEN
      IF Moneda = 1 THEN FILL-IN_VueUsa = ROUND(fSumDol + ROUND( fSumSol / FILL-IN_T_Compra, 2 ) - X-SdoUsa, 2).
      IF Moneda = 2 THEN FILL-IN_VueUsa = ROUND(fSumDol + ROUND( fSumSol / FILL-IN_T_Venta, 2 ) - X-SdoUsa, 2).
*/
   DISPLAY FILL-IN_VueNac FILL-IN_VueUsa WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  DISPLAY R-Codmon F-cliente X-CodMon X-SdoAct FILL-IN_ImpNac1 FILL-IN_ImpNac2 
          FILL-IN_ImpNac4 FILL-IN_ImpNac5 FILL-IN_ImpNac6 FILL-IN_ImpNac7 
          FILL-IN_VueNac y-CodMon FILL-IN_ImpUsa1 FILL-IN_ImpUsa2 
          FILL-IN_ImpUsa4 FILL-IN_ImpUsa5 FILL-IN_ImpUsa6 FILL-IN_ImpUsa7 
          FILL-IN_VueUsa y-SdoAct FILL-IN_Voucher2 FILL-IN_Voucher4 
          FILL-IN_Voucher5 FILL-IN_Voucher6 FILL-IN_T_Venta FILL-IN_T_Compra 
          FILL-IN_CodBco2 FILL-IN_CodBco4 FILL-IN_CodBco5 FILL-IN-3 
          x-TarjetaCredito FILL-IN-5 F-CLIECHE F-NroRec F-Presen FILL-IN_Saldo 
          F-TipCom F-Numfac FILL-IN-4 
      WITH FRAME D-Dialog.
  ENABLE RECT-34 RECT-6 RECT-4 RECT-10 RECT-7 RECT-9 RECT-8 RECT-32 RECT-5 
         Btn_OK R-Codmon Btn_Cancel FILL-IN_ImpNac1 FILL-IN_ImpNac4 
         FILL-IN_ImpNac5 FILL-IN_ImpNac6 FILL-IN_ImpUsa1 FILL-IN_ImpUsa4 
         FILL-IN_ImpUsa5 FILL-IN_ImpUsa6 FILL-IN_Voucher4 FILL-IN_Voucher5 
         FILL-IN_Voucher6 x-TarjetaCredito BUTTON-3 F-CLIECHE 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
