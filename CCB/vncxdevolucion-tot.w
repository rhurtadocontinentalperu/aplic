...
CcbCDocu.TotalMontoICBPER CcbCDocu.ImpIsc CcbCDocu.AcuBon[5] 
...
DEFINE FRAME F-Main
     CcbCDocu.ImpBrt AT ROW 1.19 COL 4.14 FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpExo AT ROW 1.19 COL 31 COLON-ALIGNED
          LABEL "Exonerado" FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpVta AT ROW 1.19 COL 52 COLON-ALIGNED FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpIgv AT ROW 1.19 COL 73 COLON-ALIGNED FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpTot AT ROW 1.19 COL 93 COLON-ALIGNED FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpDto AT ROW 1.96 COL 31 COLON-ALIGNED
          LABEL "Descuento"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.TotalMontoICBPER AT ROW 1.96 COL 52 COLON-ALIGNED WIDGET-ID 4
          LABEL "ICBPER" FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
          BGCOLOR 15 FGCOLOR 0 
     CcbCDocu.ImpIsc AT ROW 1.96 COL 73 COLON-ALIGNED
          LABEL "Importe ISC" FORMAT "->>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     CcbCDocu.AcuBon[5] AT ROW 1.96 COL 93 COLON-ALIGNED WIDGET-ID 2
          LABEL "Percepción"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 15 
     Btn-Otros AT ROW 2.92 COL 95
