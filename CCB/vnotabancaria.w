...
FOR EACH MVTO ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    IF NOT AVAILABLE Ccbcdocu THEN DO:
        MESSAGE 'NO pudo localizar el documento' MVTO.codref MVTO.nroref
            VIEW-AS ALERT-BOX WARNING.
        UNDO, RETURN 'ADM-ERROR'.
    END.
    ASSIGN
        Ccbcdocu.sdoact = Ccbcdocu.sdoact - MVTO.imptot
        Ccbcdocu.flgest = (IF Ccbcdocu.sdoact <= 0 THEN 'C' ELSE 'P')
    ...
    INSERT INTO CcbDCaja ( CodCia, CodDiv, CodDoc, NroDoc, 
        ...
        VALUES ( Ccbcmvto.CodCia, Ccbcmvto.CodDiv, Ccbcmvto.CodDoc, Ccbcmvto.NroDoc, 
                 Ccbcdocu.coddoc , Ccbcdocu.nrodoc, MVTO.ImpTot, Ccbcmvto.FchCbd, 
...
/*       /* fin de consistencia */                                                           */
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN "ADM-ERROR" ON STOP UNDO, RETURN "ADM-ERROR":
      ...
      FIND FIRST B-CMVTO WHERE B-CMVTO.CodCia = CCbCMvto.CodCia 
          ...
          AND B-CMVTO.NroDoc = CCbCMvto.NroDoc NO-ERROR.
      ASSIGN 
          B-CMVTO.FlgEst = "A"
...
libre_dec[1]:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(pSumaIntereses,">>,>>>,>>9.99").
