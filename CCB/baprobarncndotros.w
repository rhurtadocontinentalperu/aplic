...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.NomCli COLUMN-LABEL "Cliente" FORMAT "x(50)":U WIDTH 69.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"CcbCDocu.NomCli" "Cliente" ? "character" ? ? ? ? ? ? no ? no no "69.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
