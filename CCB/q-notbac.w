...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCDocu WHERE ~{&KEY-PHRASE} ~
 ...
 AND CcbCDocu.NroDoc begins f-numero ~
/* AND CcbCDocu.NroDoc begins "trim(STRING(S-NROSER))" */ ~
 AND CcbCDocu.TpoFac = "" ~
 AND CcbCDocu.CndCre = "C" ~
 NO-LOCK ~
...
DEFINE VARIABLE F-Numero AS CHARACTER FORMAT "X(9)":U INITIAL "0" 
     VIEW-AS FILL-IN 
     SIZE 9.43 BY .69 NO-UNDO.
...
DEFINE FRAME FRAME-A
     F-Numero AT ROW 1.15 COL 3.29 NO-LABEL
     RECT-2 AT ROW 1 COL 2.72
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND integral.CcbCDocu.NroDoc begins f-numero
/* AND integral.CcbCDocu.NroDoc begins ""trim(STRING(S-NROSER))"" */
 AND integral.CcbCDocu.TpoFac = """"
 AND integral.CcbCDocu.CndCre = ""C""
"
...
FIND CcbCDocu WHERE 
     ...
     CcbCDocu.NroDoc = /*STRING(S-NroSer,"999") + */ /*STRING(*/ F-Numero /*,"999999999")*/ 
     NO-LOCK NO-ERROR.
