...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-cob WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY gn-cob.CodCob INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-cob
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-cob


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BUTTON-busca 
...
DEFINE FRAME FRAME-A
     BUTTON-busca AT ROW 1.19 COL 1.72
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "INTEGRAL.gn-cob.CodCob|yes"
     _Design-Parent    is WINDOW q-tables @ ( 1.27 , 4.72 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-busca q-tables
ON CHOOSE OF BUTTON-busca IN FRAME FRAME-A /* Button 1 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    RUN LKUP/C-COBRA ("Lista de Cobradores").
