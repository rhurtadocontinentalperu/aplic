...
DEFINE FRAME F-Main
     FILL-IN_Aval1-1 AT ROW 1.73 COL 10 COLON-ALIGNED
     FILL-IN_Aval1-2 AT ROW 2.42 COL 10 COLON-ALIGNED WIDGET-ID 2
     gn-clie.Aval1[2] AT ROW 3.12 COL 10 COLON-ALIGNED
          LABEL "Dirección" FORMAT "X(90)"
          VIEW-AS FILL-IN 
          SIZE 69 BY .69
     FILL-IN_Aval3-1 AT ROW 3.88 COL 10 COLON-ALIGNED
     FILL-IN_Aval3-2 AT ROW 4.62 COL 10 COLON-ALIGNED WIDGET-ID 4
     gn-clie.Aval1[4] AT ROW 5.35 COL 10 COLON-ALIGNED
          LABEL "Teléfonos"
          VIEW-AS FILL-IN 
          SIZE 22.86 BY .69
     gn-clie.Aval2[1] AT ROW 6.88 COL 9.57 COLON-ALIGNED
          LABEL "Nombre" FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 49.43 BY .69
     gn-clie.Aval2[2] AT ROW 7.58 COL 9.57 COLON-ALIGNED
          LABEL "Dirección" FORMAT "X(90)"
          VIEW-AS FILL-IN 
          SIZE 69.43 BY .69
     gn-clie.Aval2[3] AT ROW 8.31 COL 9.57 COLON-ALIGNED
          LABEL "RUC/DNI" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .69
     gn-clie.Aval2[4] AT ROW 9.04 COL 9.57 COLON-ALIGNED
          LABEL "Teléfonos"
          VIEW-AS FILL-IN 
          SIZE 22.86 BY .69
     ...
     "Datos Aval 2" VIEW-AS TEXT
          SIZE 11.43 BY .5 AT ROW 6.42 COL 2.86
          FONT 6
     RECT-30 AT ROW 6.65 COL 1.57
