...
DEF VAR s-Tabla AS CHAR INIT 'CAMPAÑAS' NO-UNDO.
...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
    ...
    BY VtaTabla.Llave_c1 DESCENDING
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Campaña" FORMAT "9999":U
            WIDTH 9.43
      VtaTabla.Rango_fecha[1] COLUMN-LABEL "Inicio Campaña" FORMAT "99/99/9999":U
            WIDTH 13.43
      VtaTabla.Rango_fecha[2] COLUMN-LABEL "Fin de Campaña" FORMAT "99/99/9999":U
            WIDTH 13.43
  ENABLE
      VtaTabla.Llave_c1
...
"VtaTabla.Llave_c1" "Campaña" "9999" "character" ? ? ? ? ? ? yes ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Rango_fecha[1]
"VtaTabla.Rango_fecha[1]" "Inicio Campaña" ? "date" ? ? ? ? ? ? yes ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Rango_fecha[2]
"VtaTabla.Rango_fecha[2]" "Fin de Campaña" ? "date" ? ? ? ? ? ? yes ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
