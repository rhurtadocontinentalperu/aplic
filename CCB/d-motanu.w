...
DEF OUTPUT PARAMETER cReturnValue AS CHAR.

cReturnValue = 'ADM-ERROR'.
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-1 Btn_OK Btn_Cancel 
...
DEFINE FRAME D-Dialog
     COMBO-BOX-1 AT ROW 2.08 COL 15 COLON-ALIGNED WIDGET-ID 2
     Btn_OK AT ROW 4.23 COL 6
     Btn_Cancel AT ROW 4.23 COL 22
     SPACE(52.42) SKIP(0.22)
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* MOTIVO DE ANULACION */
DO:  
...
DO:
  ...
  ASSIGN
      ...
      CcbAudit.CodDoc = s-coddoc
      CcbAudit.CodMon = ccbcdocu.codmon
      CcbAudit.CodRef = SUBSTRING(combo-box-1, 1, INDEX(combo-box-1, " ") - 1 )
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-1 
      WITH FRAME D-Dialog.
  ENABLE COMBO-BOX-1 Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
