...
&Scoped-Define ENABLED-OBJECTS x-CodDiv x-FchDoc-1 x-FchDoc-2 Btn_OK ~
Btn_Cancel 
...
DEFINE FRAME D-Dialog
     x-CodDiv AT ROW 1.77 COL 11 COLON-ALIGNED
     x-FchDoc-1 AT ROW 2.92 COL 11 COLON-ALIGNED
     x-FchDoc-2 AT ROW 3.88 COL 11 COLON-ALIGNED
     Btn_OK AT ROW 5.42 COL 6
     Btn_Cancel AT ROW 5.42 COL 24
     SPACE(29.13) SKIP(0.91)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "REPORTE DE CONTRAFACTURAS"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* REPORTE DE CONTRAFACTURAS */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY x-CodDiv x-FchDoc-1 x-FchDoc-2 
      WITH FRAME D-Dialog.
  ENABLE x-CodDiv x-FchDoc-1 x-FchDoc-2 Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR sDateFormat AS CHAR.
  
  sDateFormat = SESSION:DATE-FORMAT.
  ...
  RB-REPORT-NAME = 'Ingresos por Contrafactura'.
  ...
  RB-FILTER = "ccbccaja.codcia = " + STRING(s-codcia) +
                 ...
                 " AND ccbccaja.fchcie >= " + STRING(x-FchDoc-1) +
                 " AND ccbccaja.fchcie <= " + STRING(x-FchDoc-2) +
                 " AND ( ccbccaja.impnac[4] <> 0 OR ccbccaja.impusa[4] <> 0 )".
  SESSION:DATE-FORMAT = sDateFormat.
