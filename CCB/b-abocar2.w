...
DEFINE SHARED VARIABLE s-Tabla AS CHAR.
...
&Scoped-define INTERNAL-TABLES CcbDDocu

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table CcbDDocu.codmat s-descri @ s-descri ~
CcbDDocu.CanDes CcbDDocu.PreUni CcbDDocu.ImpLin 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH CcbDDocu OF CcbCDocu WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table CcbDDocu
...
&Scoped-Define DISPLAYED-OBJECTS F-ImpBrt F-ImpExo F-ImpDto F-ValVta ~
F-ImpIgv F-ImpIsc F-ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbDDocu.codmat COLUMN-LABEL "Codigo" FORMAT "X(8)":U
      s-descri @ s-descri COLUMN-LABEL "Descripcion" FORMAT "x(40)":U
      CcbDDocu.CanDes FORMAT ">,>>>,>>9.9999":U
      CcbDDocu.PreUni FORMAT ">,>>>,>>9.99999":U
      CcbDDocu.ImpLin FORMAT "->>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 73 BY 7.46
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-ImpBrt AT ROW 9.23 COL 2 NO-LABEL
     F-ImpExo AT ROW 9.23 COL 9.72 COLON-ALIGNED NO-LABEL
     F-ImpDto AT ROW 9.23 COL 19.57 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 9.23 COL 29.43 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 9.23 COL 39.86 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 9.23 COL 49.72 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 9.23 COL 60.29 COLON-ALIGNED NO-LABEL
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 8.73 COL 54.57
     "Imp.Total" VIEW-AS TEXT
          SIZE 7.43 BY .5 AT ROW 8.69 COL 62.43
     "Imp.Dcto." VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.73 COL 23.57
     "Exonerado" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.73 COL 12.29
     "Imp.Bruto" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 8.73 COL 2.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.65 COL 32.14
     "I.G.V." VIEW-AS TEXT
          SIZE 4.14 BY .5 AT ROW 8.69 COL 45.14
     RECT-22 AT ROW 8.5 COL 1
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.CcbDDocu OF integral.CcbCDocu"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > integral.CcbDDocu.codmat
"CcbDDocu.codmat" "Codigo" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"s-descri @ s-descri" "Descripcion" "x(40)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = integral.CcbDDocu.CanDes
     _FldNameList[4]   = integral.CcbDDocu.PreUni
...
ON FIND OF CcbDDocu DO:
   ...
   IF AVAILABLE CcbCDocu THEN DO:
       IF CcbCDocu.CndCre = 'N' THEN DO:
          ...
          END.
       ELSE DO:
          FIND Almmmatg WHERE Almmmatg.codmat = CcbDDocu.codmat NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbcDocu THEN DO WITH FRAME {&FRAME-NAME}:
     DISPLAY CcbcDocu.ImpBrt @ F-ImpBrt
             CcbcDocu.ImpExo @ F-ImpExo
             CcbcDocu.ImpDto @ F-ImpDto
             CcbcDocu.ImpVta @ F-ValVta
