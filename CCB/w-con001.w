...
&Scoped-Define ENABLED-OBJECTS Btn_Done x-Division BROWSE-1 BROWSE-2 
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH FacDocum NO-LOCK WHERE codcia = s-codcia
        AND TpoDoc <> ?
        AND LOOKUP(FacDocum.CodDoc, 'FAC,BOL,N/D,N/C,CHQ,LET,A/R,BD') > 0:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE Btn_Done x-Division BROWSE-1 BROWSE-2 
      WITH FRAME F-Main IN WINDOW W-Win.
