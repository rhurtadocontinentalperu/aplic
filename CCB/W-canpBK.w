...
&Scoped-Define ENABLED-OBJECTS Btn-Compbte Btn-Salir 
...
DEFINE VARIABLE h_b-pedpbk AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     Btn-Compbte AT ROW 15.42 COL 54.43
     Btn-Salir AT ROW 15.42 COL 71.29
...
DO:
  RUN Cancelar-Pedido IN h_b-pedpBK.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/b-pedpbk.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedpbk ).
       RUN set-position IN h_b-pedpbk ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.31 , 82.43 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-pedpbk ,
             Btn-Compbte:HANDLE IN FRAME F-Main , 'BEFORE':U ).
    END. /* Page 0 */
