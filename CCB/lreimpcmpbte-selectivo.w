...
DEFINE VARIABLE C-CMPBTE AS CHARACTER FORMAT "X(256)":U INITIAL "Tck" 
     LABEL "Tipo Cmpbte." 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "Tck","Bol","Fac" 
     DROP-DOWN-LIST
     SIZE 7.43 BY 1
     BGCOLOR 15  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.NroDoc FORMAT "XXX-XXXXXXXX":U COLUMN-BGCOLOR 11 LABEL-BGCOLOR 8
...
"CcbCDocu.NroDoc" ? "XXX-XXXXXXXX" "character" 11 ? ? 8 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  IF AVAILABLE CcbCDocu THEN  DO:
      RUN vtamay/r-odesp-001a (ROWID(Ccbcdocu), ENTRY(1, Ccbcdocu.codalm), 'DUPLICADO').
...
------------------------------------------------------------------------------*/
  IF AVAILABLE CcbCDocu THEN  DO:
     CASE Ccbcdocu.CodDoc:
            WHEN "TCK" THEN 
                /*  RUN ccb/r-tick01 (ROWID(ccbcdocu)).*/
            ...
            WHEN "BOL" THEN DO: 
                CASE Ccbcdocu.coddiv:
                    /*WHEN '00001' THEN  RUN ccb/R-BOLE01-2 (ROWID(CcbCDocu)).   */
