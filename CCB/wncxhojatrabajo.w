...
DEFINE VARIABLE h_bncxhojatrabajo AS HANDLE NO-UNDO.
...
DEFINE VARIABLE FILL-IN-2 AS CHARACTER FORMAT "XXX-XXXXXXXX":U 
     VIEW-AS FILL-IN 
     SIZE 16 BY .81 NO-UNDO.
...
/*   FILL-IN-1:SCREEN-VALUE = STRING(Faccorre.nroser,'999') + STRING(Faccorre.correlativo, '999999'). */
  FILL-IN-1:SCREEN-VALUE = STRING(Faccorre.nroser,ENTRY(1, FILL-IN-1:FORMAT,'-')) + 
      STRING(Faccorre.correlativo, ENTRY(2,FILL-IN-1:FORMAT,'-')).
END.
...
/*   FILL-IN-2:SCREEN-VALUE = STRING(Faccorre.nroser,'999') + STRING(Faccorre.correlativo, '999999'). */
  FILL-IN-2:SCREEN-VALUE = STRING(Faccorre.nroser, ENTRY(1, FILL-IN-2:FORMAT,'-')) + 
      STRING(Faccorre.correlativo, ENTRY(2,FILL-IN-2:FORMAT,'-')).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/bncxhojatrabajo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bncxhojatrabajo ).
       RUN set-position IN h_bncxhojatrabajo ( 5.81 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bncxhojatrabajo ( 6.69 , 127.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_bncxhojatrabajo , 'Record':U , h_bncxhojatrabajo-02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bncxhojatrabajo ,
             x-NomCon-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_bncxhojatrabajo-02 ,
             h_bncxhojatrabajo , 'AFTER':U ).
    END. /* Page 0 */
...
RUN Genera-NC IN h_bncxhojatrabajo
