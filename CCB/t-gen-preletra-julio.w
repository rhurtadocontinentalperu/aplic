...
&Scoped-define FIELDS-IN-QUERY-br_table DOCU.CodDoc DOCU.FchVto DOCU.ImpTot ~
DOCU.Libre_c01 DOCU.Libre_c02 
...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN_ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fLinea B-table-Win 
FUNCTION fLinea RETURNS CHARACTER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DOCU.FchVto COLUMN-LABEL "Fecha de Vencimiento" FORMAT "99/99/9999":U
            WIDTH 18.57
      DOCU.ImpTot FORMAT "->>,>>>,>>9.99":U WIDTH 12.86
      DOCU.Libre_c01 COLUMN-LABEL "Linea" FORMAT "x(3)":U
      DOCU.Libre_c02 COLUMN-LABEL "Sub-Lines" FORMAT "x(3)":U
  ENABLE
      DOCU.FchVto
      DOCU.ImpTot
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 42 BY 13.19
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpTot AT ROW 14.19 COL 27 COLON-ALIGNED WIDGET-ID 62
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "Temp-Tables.DOCU.NroDoc|yes"
     _FldNameList[1]   = Temp-Tables.DOCU.CodDoc
     _FldNameList[2]   > Temp-Tables.DOCU.FchVto
"DOCU.FchVto" "Fecha de Vencimiento" ? "date" ? ? ? ? ? ? yes ? no no "18.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.DOCU.ImpTot
"DOCU.ImpTot" ? ? "decimal" ? ? ? ? ? ? yes ? no no "12.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.DOCU.Libre_c01
"DOCU.Libre_c01" "Linea" "x(3)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.DOCU.Libre_c02
"DOCU.Libre_c02" "Sub-Lines" "x(3)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  RUN Procesa-handle IN lh_handle ('enable-button').
  /* Dispatch standard ADM method.                             */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Nuevas-Letras B-table-Win 
...
------------------------------------------------------------------------------*/
  ...
  RUN ccb/d-preletraadelantada.w.
...
FOR EACH B-DOCU NO-LOCK:
    FILL-IN_ImpTot = FILL-IN_ImpTot + B-DOCU.ImpTot.
END.
...
RUN Procesa-handle IN lh_handle ('disable-button').
RETURN "OK".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fLinea B-table-Win 
FUNCTION fLinea RETURNS CHARACTER
...
------------------------------------------------------------------------------*/
  ...
  IF DOCU.Libre_c02 > '' THEN RETURN DOCU.Libre_c02.
  ELSE RETURN 'OTROS'.
