...
CcbCDocu.NroOrd CcbCDocu.NroPed CcbCDocu.FchVto CcbCDocu.CodCli ~
...
CcbCDocu.usuario CcbCDocu.NroOrd CcbCDocu.NroPed CcbCDocu.FchVto ~
...
DEFINE FRAME F-Main
     ...
     CcbCDocu.usuario AT ROW 1 COL 107 COLON-ALIGNED NO-LABEL WIDGET-ID 24 FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.NroOrd AT ROW 1.81 COL 19 COLON-ALIGNED WIDGET-ID 30
          LABEL "Nro. Ingreso" FORMAT "x(15)"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
     CcbCDocu.NroPed AT ROW 1.81 COL 39 COLON-ALIGNED WIDGET-ID 32
          LABEL "PI" FORMAT "X(15)"
          VIEW-AS FILL-IN 
          SIZE 15 BY .81
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      DISPLAY
          ...
          STRING(Almcmov.nroser,'999') + STRING(Almcmov.nrodoc) @ CcbCDocu.nroped
...
------------------------------------------------------------------------------*/
  ...
  */
   ...
   IF cRetVal <> "" THEN DO:
       pMensaje = "Hubo problemas en la grabacion " + CHR(10) + cRetval.
       UNDO, RETURN 'ADM-ERROR'.
   END.
...
------------------------------------------------------------------------------*/
  ...
  RUN lkup\C-DevoPendientes ("Devoluciones Pendientes").
