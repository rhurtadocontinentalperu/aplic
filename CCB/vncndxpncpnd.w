...
DEFINE VARIABLE FILL-IN-Correlativo AS CHARACTER FORMAT "X(25)":U 
     VIEW-AS FILL-IN 
     SIZE 12 BY .81
     FONT 6 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-EStado AT ROW 1.19 COL 41 COLON-ALIGNED WIDGET-ID 114
     ...
     CcbCDocu.CodCli AT ROW 1.96 COL 18 COLON-ALIGNED WIDGET-ID 48
          VIEW-AS FILL-IN 
          SIZE 15.43 BY .81
     CcbCDocu.RucCli AT ROW 1.96 COL 41 COLON-ALIGNED WIDGET-ID 88
          VIEW-AS FILL-IN 
          SIZE 16 BY .81
     CcbCDocu.CodAnt AT ROW 1.96 COL 62.86 COLON-ALIGNED WIDGET-ID 110
...
DEFINE FRAME F-Main
     ...
     CcbCDocu.ImpTot AT ROW 8.69 COL 94 COLON-ALIGNED WIDGET-ID 76
          ...
          BGCOLOR 15 FGCOLOR 0 
     "..." VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 6.54 COL 96 WIDGET-ID 124
     "Moneda:" VIEW-AS TEXT
