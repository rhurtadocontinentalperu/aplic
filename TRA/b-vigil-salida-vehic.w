...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmDCdoc WHERE ~{&KEY-PHRASE} ~
 ...
 AND AlmDCdoc.usuario = s-user-id ~
 AND AlmDCdoc.CodAlm = s-codalm ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmDCdoc.Fecha FORMAT "99/99/9999":U
      AlmDCdoc.Hora FORMAT "X(5)":U WIDTH 32.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 131 BY 23.15
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "AlmDCdoc.CodCia = s-codcia
 AND AlmDCdoc.usuario = s-user-id
 AND AlmDCdoc.CodAlm = s-codalm
 AND (AlmDCdoc.FlgEst = ""S""
...
"AlmDCdoc.NroDoc" ? "X(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmDCdoc.Observ" "Observaciones" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.AlmDCdoc.Fecha
"AlmDCdoc.Fecha" ? "99/99/9999" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.AlmDCdoc.Hora
"AlmDCdoc.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "32.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
