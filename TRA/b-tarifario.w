...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE gn-divi THEN DO:
      MESSAGE 'División inválida' VIEW-AS ALERT-BOX ERROR.
  ...
  IF NOT AVAILABLE TabDepto THEN DO:
      MESSAGE 'Departamento inválido' VIEW-AS ALERT-BOX ERROR.
  ...
  IF NOT AVAILABLE TabProvi THEN DO:
      MESSAGE 'Provincia inválido' VIEW-AS ALERT-BOX ERROR.
