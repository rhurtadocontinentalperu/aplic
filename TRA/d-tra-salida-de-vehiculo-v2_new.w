...
&Scoped-Define ENABLED-OBJECTS RECT-25 RECT-26 Btn_OK Btn_Cancel 
...
FILL-IN-hora-internamiento FILL-IN-Responsable FILL-IN-NomResp ~
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-hora-internamiento AT ROW 8.54 COL 99 COLON-ALIGNED WIDGET-ID 50
...
/* SETTINGS FOR FILL-IN FILL-IN-Ayudante-1 IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN-Placa IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Responsable IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
DO:
  ...
  IF FILL-in-correlativo <= 0 THEN DO:
      MESSAGE 'Numero de guía esta errado' VIEW-AS ALERT-BOX ERROR.      
      RETURN NO-APPLY.
  END.
...
OCXFile = SEARCH( "d-tra-salida-de-vehiculo-v2_new.wrx":U ).
IF OCXFile = ? THEN
  OCXFile = SEARCH(SUBSTRING(THIS-PROCEDURE:FILE-NAME, 1,
                     R-INDEX(THIS-PROCEDURE:FILE-NAME, ".":U), "CHARACTER":U) + "wrx":U).
...
END.
ELSE MESSAGE "d-tra-salida-de-vehiculo-v2_new.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Placa FILL-IN_Marca FILL-IN_CodPro FILL-IN-NomPro 
      ...
      WITH FRAME D-Dialog.
  ENABLE RECT-25 RECT-26 Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
DO WITH FRAME {&FRAME-NAME}:
   ...
   /* Proveedor */
    ...
    /* 11/04/2025 Martin Chirinos: El vigilante solo verifica lo que viene por la HR, no debe modificar */
/*     CASE TRUE:                            */
