...
FILL-IN-Serie FILL-IN-fecha-internamiento FILL-IN-hora-internamiento ~
FILL-IN-fecha-salida FILL-IN-hora-salida FILL-IN-hoy 
...
DEFINE VARIABLE FILL-IN-fecha-salida AS DATE FORMAT "99/99/9999":U 
     LABEL "SALIDA" 
     VIEW-AS FILL-IN 
     SIZE 15 BY 1.38 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-hora-salida AS CHARACTER FORMAT "X(12)":U 
     LABEL "Hora" 
     VIEW-AS FILL-IN 
     SIZE 15 BY 1.38 NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-fecha-internamiento AT ROW 9.46 COL 34 COLON-ALIGNED WIDGET-ID 48
     FILL-IN-hora-internamiento AT ROW 9.46 COL 58 COLON-ALIGNED WIDGET-ID 50
     FILL-IN-fecha-salida AT ROW 11.08 COL 34 COLON-ALIGNED WIDGET-ID 58
     FILL-IN-hora-salida AT ROW 11.12 COL 58 COLON-ALIGNED WIDGET-ID 60
     FILL-IN-hoy AT ROW 13.31 COL 61 COLON-ALIGNED WIDGET-ID 56
     Btn_OK AT ROW 13.65 COL 3
     Btn_Cancel AT ROW 13.65 COL 19
     "   RETORNO  DEL VEHICULO" VIEW-AS TEXT
          SIZE 51 BY .88 AT ROW 1.19 COL 23 WIDGET-ID 46
          BGCOLOR 15 FGCOLOR 12 FONT 8
     SPACE(40.28) SKIP(14.07)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 9
         TITLE "Retorno del Vehiculo"
...
/* SETTINGS FOR FILL-IN FILL-IN-Chofer IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Correlativo IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-fecha-internamiento IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-fecha-salida IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-hora-internamiento IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-hora-salida IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN-Placa IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Serie IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_Brevete IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Retorno del Vehiculo */
DO:  
...
DO:
  ...
  FIND VtaTabla WHERE VtaTabla.CodCia = s-CodCia AND
    ...
    NO-LOCK NO-ERROR.
  IF NOT AVAILABLE VtaTabla OR VtaTabla.Llave_c8 = "NO" THEN DO:
  ...
  MESSAGE "Seguro de grabar el RETORNO del vehiculo ?" VIEW-AS ALERT-BOX QUESTION
...
OCXFile = SEARCH( "d-tra-retorno-de-vehiculo.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "d-tra-retorno-de-vehiculo.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Placa FILL-IN_Marca FILL-IN_CodPro FILL-IN-NomPro 
          ...
          FILL-IN-fecha-internamiento FILL-IN-hora-internamiento 
          FILL-IN-fecha-salida FILL-IN-hora-salida FILL-IN-hoy 
      WITH FRAME D-Dialog.
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    IF NOT (b-traingsal.flgest = 'S') THEN DO:
        pMensaje = "Error al ubicar el vehículo".
        RELEASE b-TraIngSal.
        RETURN "ADM-ERROR".
    END.
    ASSIGN
        b-TraIngSal.FlgEst = "R"
        b-TraIngSal.FchModificacion = TODAY
        b-TraIngSal.FechaRetorno = TODAY
        b-TraIngSal.HoraRetorno = STRING(TIME, 'HH:MM:SS')
    ...
    IF AVAILABLE DI-RutaC THEN
        ASSIGN
            DI-RutaC.FchRet = b-TraIngSal.FechaRetorno
            DI-RutaC.HorRet = REPLACE(b-TraIngSal.HoraRetorno,":","")
            DI-RutaC.FlgEst = "PR".     /* Ruta Terminada */
END.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    FILL-IN-fecha-salida:SCREEN-VALUE = STRING(b-traingsal.fechasalida,"99/99/9999").
    FILL-IN-hora-salida:SCREEN-VALUE = b-traingsal.horasalida.
