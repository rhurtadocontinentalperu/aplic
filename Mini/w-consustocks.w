...
DEFINE FRAME F-Main
     ...
     BtnDone AT ROW 8.5 COL 15 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 33.14 BY 9.31 WIDGET-ID 100.
...
/* SETTINGS FOR EDITOR EDITOR-DesMat IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-Disponible IN FRAME F-Main
   NO-ENABLE                                                            */
...
ON LEAVE OF FILL-IN-CodMat IN FRAME F-Main
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      FIND Almacen WHERE Almacen.codcia = s-codcia
          ...
          NO-LOCK NO-ERROR.
       {&WINDOW-NAME}:TITLE = Almacen.codalm + ' ' + INTEGRAL.Almacen.Descripcion.
