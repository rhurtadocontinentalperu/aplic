...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.ImpLin COLUMN-LABEL "Imp." FORMAT ">>>>9.99":U WIDTH 10.72
  ENABLE
      ITEM.codmat
      ITEM.UndVta
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 63 BY 11.15
...
DEFINE FRAME F-Main
     ...
     FILL-IN-ImpTot AT ROW 12.35 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
"ITEM.ImpLin" "Imp." ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
