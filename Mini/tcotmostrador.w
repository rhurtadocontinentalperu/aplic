...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-DesMat FILL-IN-ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ITEM.codmat COLUMN-LABEL "Articulo" FORMAT "X(13)":U
      ITEM.UndVta FORMAT "x(6)":U
      ITEM.CanPed FORMAT ">>>,>>9.99":U
      ITEM.PreUni COLUMN-LABEL "Unitario" FORMAT ">>,>>9.9999":U
            WIDTH 8.43
      ITEM.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 11.86
  ENABLE
      ITEM.codmat
      ITEM.UndVta
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 53 BY 15.77
...
DEFINE FRAME F-Main
     ...
     FILL-IN-DesMat AT ROW 16.77 COL 1 NO-LABEL WIDGET-ID 4
     FILL-IN-ImpTot AT ROW 16.77 COL 38 COLON-ALIGNED WIDGET-ID 2
...
"ITEM.codmat" "Articulo" "X(13)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.ITEM.UndVta
"ITEM.UndVta" ? "x(6)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.PreUni" "Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.ITEM.ImpLin
"ITEM.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "11.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  ...
  IF AVAILABLE Almmmatg 
      THEN DISPLAY Almmmatg.desmat @ FILL-IN-DesMat WITH FRAME {&FRAME-NAME}.
END.
