...
DEFINE INPUT PARAMETER p-CodInventariador AS CHAR NO-UNDO.
...
pCodInventariador = p-CodInventariador.
...
------------------------------------------------------------------------------*/
  ...
  */
  ...
  IF p-Conteo = 2 THEN txtTitulo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ' RECONTEO SELECTIVO (' + pCodInventariador + ")" .
  IF p-Conteo = 3 THEN txtTitulo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ' 3er CONTEO SELECTIVO (' + pCodInventariador + ")" .
