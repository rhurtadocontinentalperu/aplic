...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.ImpLin COLUMN-LABEL "Imp." FORMAT ">>>>9.99":U WIDTH 11.72
  ENABLE
      ITEM.codmat
      ITEM.UndVta
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 65 BY 11.15
...
DEFINE FRAME F-Main
     ...
     EDITOR-DesMat AT ROW 12.15 COL 1 NO-LABEL WIDGET-ID 6
     FILL-IN-ImpTot AT ROW 12.35 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
"Temp-Tables.ITEM.codmat" "Articulo" "X(13)" "character" ? ? ? ? ? ? yes ? no no "13.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.ITEM.UndVta
"Temp-Tables.ITEM.UndVta" ? "x(6)" "character" ? ? ? ? ? ? yes ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.ITEM.CanPed
"Temp-Tables.ITEM.CanPed" "Cant." ">>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.ITEM.PreUni
"Temp-Tables.ITEM.PreUni" "Unit." ">>>9.9999" "decimal" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.ITEM.ImpLin
"Temp-Tables.ITEM.ImpLin" "Imp." ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
