...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.CanPed COLUMN-LABEL "Cant." FORMAT ">>>9.99":U WIDTH 8.43
      ITEM.PreUni COLUMN-LABEL "Unit." FORMAT ">>>9.9999":U WIDTH 13.43
      ITEM.ImpLin COLUMN-LABEL "Imp." FORMAT ">>>>9.99":U WIDTH 17.72
  ENABLE
      ITEM.codmat
      ITEM.UndVta
      ITEM.CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SIZE 70 BY 14.42
...
DEFINE FRAME F-Main
     ...
     EDITOR-DesMat AT ROW 15.62 COL 1 NO-LABEL WIDGET-ID 6
     FILL-IN-ImpTot AT ROW 15.81 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
"ITEM.CanPed" "Cant." ">>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.ImpLin" "Imp." ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "17.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH PEDI:
    ...
    FIND ITEM WHERE ITEM.codmat = PEDI.codmatweb AND ITEM.libre_c05 = PEDI.libre_c05 NO-ERROR.
