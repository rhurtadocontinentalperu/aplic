...
ON LEAVE OF x-numord IN FRAME D-Dialog /* Orden de Producción */
DO:
 IF SELF:SCREEN-VALUE = "" THEN RETURN.
    ...
    IF NOT AVAILABLE PR-ODPC THEN DO:
        MESSAGE "Orden inválida" VIEW-AS ALERT-BOX ERROR.
        SELF:SCREEN-VALUE = "".
        RETURN.
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL x-numord D-Dialog
ON RETURN OF x-numord IN FRAME D-Dialog /* Orden de Producción */
DO:
  IF SELF:SCREEN-VALUE = "" THEN RETURN.
     FIND FIRST PR-ODPC WHERE
