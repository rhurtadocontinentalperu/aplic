...
&SCOPED-DEFINE l-lookup h_l-matord
...
DEFINE VARIABLE h_l-matord AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.12 COL 58
     Btn_Cancel AT ROW 4.85 COL 58
     Btn_Help AT ROW 6.58 COL 58
     SPACE(1.71) SKIP(4.14)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pro/l-matord.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-matord ).
       RUN set-position IN h_l-matord ( 1.19 , 2.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-option ( 1.15 , 11.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-matord. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-matord ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-matord ,
