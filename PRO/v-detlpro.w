...
LPRCLPRO.NroDoc LPRCLPRO.FchDoc LPRCLPRO.Usuario 
...
LPRCLPRO.NroDoc LPRCLPRO.FchDoc LPRCLPRO.Usuario 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-1 x-maquina 
...
DEFINE FRAME F-Main
     LPRCLPRO.CodMaq AT ROW 1.58 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     LPRCLPRO.NumOrd AT ROW 2.54 COL 15 COLON-ALIGNED
          LABEL "Nº O/P"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     FILL-IN-1 AT ROW 3.5 COL 15 COLON-ALIGNED
     LPRCLPRO.NroDoc AT ROW 1.58 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     x-maquina AT ROW 1.58 COL 31 COLON-ALIGNED NO-LABEL
     LPRCLPRO.FchDoc AT ROW 1.58 COL 81 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     LPRCLPRO.Usuario AT ROW 2.54 COL 81 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     "-" VIEW-AS TEXT
          SIZE 1 BY .5 AT ROW 1.77 COL 24
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    IF AVAILABLE LPRCLPRO THEN DO:
       FIND LPRMAQUI WHERE LPRMAQUI.CodMaq = LPRCLPRO.CodMaq NO-LOCK NO-ERROR.
