...
&GLOBAL-DEFINE CONDICION PL-FLG-MES.CodCia = s-CodCia AND PL-FLG-MES.Periodo = s-Periodo AND PL-FLG-MES.NroMes = s-NroMes AND PL-FLG-MES.CodPln = x-CodPln AND PL-FLG-MES.SitAct <> 'Inactivo'
...
&Scoped-define INTERNAL-TABLES PL-FLG-MES

/* Definitions for BROWSE BROWSE-1                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 PL-FLG-MES.codper x-Nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH PL-FLG-MES ~
...
&Scoped-define TABLES-IN-QUERY-BROWSE-1 PL-FLG-MES
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 PL-FLG-MES
...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-6 BROWSE-1 Btn_OK FILL-IN-CODIGO ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 H-Dialog _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      PL-FLG-MES.codper FORMAT "X(8)"
      x-Nombre COLUMN-LABEL "Apellidos y nombres" FORMAT "x(60)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* SETTINGS FOR DIALOG-BOX H-Dialog
                                                                        */
/* BROWSE-TAB BROWSE-1 RECT-6 H-Dialog */
ASSIGN 
...
"PL-FLG-MES.codper" ? "X(8)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > "_<CALC>"
"x-Nombre" "Apellidos y nombres" "x(60)" ? ? ? ? ? ? ? no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-CODIGO FILL-IN-NOMBRE 
      WITH FRAME H-Dialog.
  ENABLE RECT-4 RECT-6 BROWSE-1 Btn_OK FILL-IN-CODIGO FILL-IN-NOMBRE Btn_Cancel 
         Btn_Help 
      WITH FRAME H-Dialog.
  VIEW FRAME H-Dialog.
