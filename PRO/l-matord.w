...
&SCOPED-DEFINE CONDICION ( PR-ODPD.CodCia = s-CodCia AND PR-ODPD.NumOrd = input-var-3)
&SCOPED-DEFINE CODIGO PR-ODPD.CodMat

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( PR-ODPD.CodMat BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( PR-ODPD.CodMat , FILL-IN-filtro ) <> 0 )
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PR-ODPD WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK, ~
      EACH Almmmatg OF PR-ODPD NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.PR-ODPD.codmat
Nombres que contengan|y||INTEGRAL.PR-ODPD.codmat
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.PR-ODPD.codmat|yes
Descripción|||INTEGRAL.PR-ODPD.codmat|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PR-ODPD.codmat COLUMN-LABEL "Codigo! Articulo"
      Almmmatg.DesMat FORMAT "X(60)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 53.14 BY 9.35
...
DEFINE FRAME F-Main
     ...
     FILL-IN-filtro AT ROW 1.19 COL 37 NO-LABEL
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.PR-ODPD,INTEGRAL.Almmmatg OF INTEGRAL.PR-ODPD"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > INTEGRAL.PR-ODPD.codmat
"PR-ODPD.codmat" "Codigo! Articulo" ? "character" ? ? ? ? ? ? no ?
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY PR-ODPD.codmat
