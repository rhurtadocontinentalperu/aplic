...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table PR-ODPD.codmat ~
PR-ODPD.CanPed 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table PR-ODPD
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table PR-ODPD
&Scoped-define QUERY-STRING-br_table FOR EACH PR-ODPD OF PR-ODPC WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PR-ODPD.codmat COLUMN-LABEL "Articulo" FORMAT "X(6)":U
      ...
      PR-ODPD.CodUnd FORMAT "X(5)":U
      PR-ODPD.CanPed COLUMN-LABEL "Cantidad a! Procesar" FORMAT ">,>>>,>>9.9999":U
            COLUMN-FGCOLOR 1
      PR-ODPD.CanAte COLUMN-LABEL "Cantidad ! Procesada" FORMAT "->>>,>>9.9999":U
            COLUMN-FGCOLOR 4
      PR-ODPD.CanDes COLUMN-LABEL "Cantidad ! Despachada" FORMAT ">,>>>,>>9.9999":U
      PR-ODPD.CtoPro COLUMN-LABEL "Costo ! Unitario" FORMAT "->>>,>>9.9999":U
      PR-ODPD.CtoTot COLUMN-LABEL "Costo ! Total" FORMAT "->>>,>>9.9999":U
  ENABLE
      PR-ODPD.codmat
      PR-ODPD.CanPed HELP "Cantidad"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 122 BY 8.62
         FONT 4
...
"PR-ODPD.codmat" "Articulo" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PR-ODPD.CodUnd" ? "X(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.PR-ODPD.CanPed
"PR-ODPD.CanPed" "Cantidad a! Procesar" ? "decimal" ? 1 ? ? ? ? yes "Cantidad" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.PR-ODPD.CanAte
"PR-ODPD.CanAte" "Cantidad ! Procesada" "->>>,>>9.9999" "decimal" ? 4 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.PR-ODPD.CanDes
"PR-ODPD.CanDes" "Cantidad ! Despachada" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.PR-ODPD.CtoPro
"PR-ODPD.CtoPro" "Costo ! Unitario" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.PR-ODPD.CtoTot
"PR-ODPD.CtoTot" "Costo ! Total" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
