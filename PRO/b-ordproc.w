...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table PR-ODPCX.codart ~
PR-ODPCX.CodFor PR-ODPCX.CanPed 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table PR-ODPCX
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table PR-ODPCX
&Scoped-define QUERY-STRING-br_table FOR EACH PR-ODPCX OF PR-ODPC  WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PR-ODPCX.codart COLUMN-LABEL "Codigo !Articulo" FORMAT "X(6)":U
      Almmmatg.DesMat FORMAT "X(45)":U
      PR-ODPCX.CodFor COLUMN-LABEL "Formula" FORMAT "X(2)":U
      PR-ODPCX.CodUnd FORMAT "X(10)":U
      PR-ODPCX.CanPed FORMAT ">,>>>,>>9.9999":U
...
"PR-ODPCX.codart" "Codigo !Articulo" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.Almmmatg.DesMat
     _FldNameList[3]   > INTEGRAL.PR-ODPCX.CodFor
"PR-ODPCX.CodFor" "Formula" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = INTEGRAL.PR-ODPCX.CodUnd
     _FldNameList[5]   > INTEGRAL.PR-ODPCX.CanPed
"PR-ODPCX.CanPed" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
