...
&SCOPED-DEFINE CODIGO LPRMAQUI.CodMaq

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( LPRMAQUI.DesPro BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( LPRMAQUI.DesPro , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES LPRMAQUI

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table LPRMAQUI.CodMaq LPRMAQUI.DesPro ~
LPRMAQUI.CapOpe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LPRMAQUI WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table LPRMAQUI
&Scoped-define FIRST-TABLE-IN-QUERY-br_table LPRMAQUI
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.LPRMAQUI.DesPro
Nombres que contengan|y||INTEGRAL.LPRMAQUI.DesPro
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LPRMAQUI.CodMaq
      LPRMAQUI.DesPro COLUMN-LABEL "Descripción" FORMAT "X(39)"
      LPRMAQUI.CapOpe
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.LPRMAQUI"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = INTEGRAL.LPRMAQUI.CodMaq
     _FldNameList[2]   > INTEGRAL.LPRMAQUI.DesPro
"DesPro" "Descripción" "X(39)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   = INTEGRAL.LPRMAQUI.CapOpe
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodMaq
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.DesPro.
