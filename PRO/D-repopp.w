...
&Scoped-Define ENABLED-OBJECTS RECT-62 RECT-60 F-Orden desdeF hastaF Btn_OK ~
Btn_Cancel 
...
DEFINE FRAME F-Main
     F-Orden AT ROW 2.08 COL 9 COLON-ALIGNED
     desdeF AT ROW 3.15 COL 9 COLON-ALIGNED
     hastaF AT ROW 3.15 COL 29 COLON-ALIGNED
     x-mensaje AT ROW 5.31 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     Btn_OK AT ROW 6.77 COL 38.72
     Btn_Cancel AT ROW 6.77 COL 50.14
     RECT-62 AT ROW 1.15 COL 1.72
     RECT-60 AT ROW 6.65 COL 1.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Producto Terminado X Orden de Produccion"
         HEIGHT             = 7.73
         WIDTH              = 61.57
         MAX-HEIGHT         = 7.73
         MAX-WIDTH          = 61.57
...
ON END-ERROR OF W-Win /* Producto Terminado X Orden de Produccion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Producto Terminado X Orden de Produccion */
DO:
...
ON LEAVE OF F-Orden IN FRAME F-Main /* Nro Orden */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-62 RECT-60 F-Orden desdeF hastaF Btn_OK Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME H-REP
       ...
       FOR EACH PR-ODPC NO-LOCK WHERE PR-ODPC.CodCia = S-CODCIA AND  
          ...
          */
          DISPLAY 'Cargando Información: ' + PR-ODPC.NumOrd @ x-Mensaje 
