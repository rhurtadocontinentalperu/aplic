...
&Scoped-define INTERNAL-TABLES PR-PRESER

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PR-PRESER WHERE ~{&KEY-PHRASE} ~
      AND PR-PRESER.Codcia = S-CODCIA NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main PR-PRESER
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PR-PRESER
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    */
    RUN lkup\C-preser ("Tarifa de Servicios").
