...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LPRMAQUI WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main LPRMAQUI
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main LPRMAQUI
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.08 , 4.86 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
ON CHOOSE OF BUTTON-3 IN FRAME FRAME-D /* Button 3 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    RUN PRO/C-MAEMAQ ("Lista de maquinarias").
