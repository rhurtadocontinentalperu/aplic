...
&Scoped-define INTERNAL-TABLES LPRDOPRO PR-ODPC PR-ODPCX Almmmatg
...
PR-ODPCX.CodFor PR-ODPCX.CodUnd Almmmatg.DesMar LPRDOPRO.CanPed 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH LPRDOPRO OF LPRCLPRO WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST PR-ODPC OF LPRCLPRO NO-LOCK, ~
      FIRST PR-ODPCX OF PR-ODPC NO-LOCK, ~
      FIRST Almmmatg WHERE Almmmatg.CodCia = PR-ODPCX.Codcia ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LPRDOPRO OF LPRCLPRO WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND Almmmatg.codmat = PR-ODPCX.codart NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table LPRDOPRO PR-ODPC PR-ODPCX Almmmatg
&Scoped-define FIRST-TABLE-IN-QUERY-br_table LPRDOPRO
&Scoped-define SECOND-TABLE-IN-QUERY-br_table PR-ODPC
&Scoped-define THIRD-TABLE-IN-QUERY-br_table PR-ODPCX
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LPRDOPRO.codart FORMAT "X(6)":U
      Almmmatg.DesMat FORMAT "X(60)":U
      PR-ODPCX.CodFor COLUMN-LABEL "Fórmula" FORMAT "X(2)":U
      PR-ODPCX.CodUnd COLUMN-LABEL "Unidad!Básica" FORMAT "X(10)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(30)":U
      LPRDOPRO.CanPed FORMAT ">,>>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 104 BY 9.81
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.LPRDOPRO OF INTEGRAL.LPRCLPRO,INTEGRAL.PR-ODPC OF INTEGRAL.LPRCLPRO,INTEGRAL.PR-ODPCX OF INTEGRAL.PR-ODPC,INTEGRAL.Almmmatg WHERE INTEGRAL.PR-ODPCX ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST, FIRST, FIRST"
     _JoinCode[4]      = "Almmmatg.CodCia = PR-ODPCX.Codcia
...
"PR-ODPCX.CodFor" "Fórmula" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.PR-ODPCX.CodUnd
"PR-ODPCX.CodUnd" "Unidad!Básica" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = INTEGRAL.LPRDOPRO.CanPed
