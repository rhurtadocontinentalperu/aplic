...
&SCOPED-DEFINE l-lookup h_l-maemaq
...
DEFINE VARIABLE h_l-maemaq AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 2.92 COL 58
     Btn_Cancel AT ROW 4.85 COL 58
     SPACE(1.85) SKIP(5.98)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pro/l-maemaq.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-maemaq ).
       RUN set-position IN h_l-maemaq ( 1.19 , 2.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-option ( 1.15 , 10.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-maemaq. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-maemaq ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-maemaq ,
