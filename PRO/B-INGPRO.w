...
Almmmatg.DesMar Almdmov.CodUnd Almdmov.CanDes Almdmov.PreUni 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almdmov.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)"
      Almmmatg.DesMat FORMAT "X(50)"
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(10)"
      Almdmov.CodUnd COLUMN-LABEL "Unidad" FORMAT "X(8)"
      Almdmov.CanDes
      Almdmov.PreUni COLUMN-LABEL "Precio!Unitario"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 85.29 BY 7.88
         FONT 4.
...
"Almdmov.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ?
...
"Almdmov.CodUnd" "Unidad" "X(8)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   = integral.Almdmov.CanDes
     _FldNameList[6]   > integral.Almdmov.PreUni
"Almdmov.PreUni" "Precio!Unitario" ? "decimal" ? ? ? ? ? ? no ?
