...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.LPRCLPRO.CodMaq|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LPRCLPRO.CodMaq
      LPRCLPRO.NroDoc COLUMN-LABEL "Número!Documento"
      LPRCLPRO.NumOrd COLUMN-LABEL "Número!O/P"
...
"NroDoc" "Número!Documento" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.LPRCLPRO.NumOrd
"NumOrd" "Número!O/P" ? "character" ? ? ? ? ? ? no ?
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* Cod.Máquina */
DO:
