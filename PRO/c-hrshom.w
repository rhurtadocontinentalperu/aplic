...
&SCOPED-DEFINE l-lookup h_l-hrshom
...
DEFINE VARIABLE h_l-hrshom AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 5.23 COL 70
     Btn_Cancel AT ROW 7.15 COL 70
     Btn_Help AT ROW 9.08 COL 70
     SPACE(1.56) SKIP(5.02)
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* Empleados */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pro/l-hrshom.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-hrshom ).
       RUN set-position IN h_l-hrshom ( 1.19 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.23 , 66.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.58 , 69.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.15 , 13.00 ) NO-ERROR.

       /* Links to SmartLookup h_l-hrshom. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-hrshom ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-hrshom ,
