...
&Scoped-Define ENABLED-OBJECTS RECT-62 RECT-60 F-Provee F-Gasto Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS F-Provee F-Gasto 
...
ON END-ERROR OF W-Win /* Tarifa de Servicios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tarifa de Servicios */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY F-Provee F-Gasto 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-62 RECT-60 F-Provee F-Gasto Btn_OK Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  DEFINE FRAME FC-REP
         PR-PRESER.Codpro FORMAT "X(11)"
         Gn-Prov.Nompro   FORMAT "X(40)"
         PR-PRESER.CodGas FORMAT "X(6)"
         PR-Gastos.DesGas FORMAT "X(15)"        
         PR-PRESER.codmat FORMAT "X(6)"
         Almmmatg.DesMat  FORMAT "X(30)"
         PR-PRESER.UndA   FORMAT "X(5)"  
         PR-PRESER.CanDes[1] FORMAT ">>,>>>,>>9.99"
         PR-PRESER.PreLis[1] FORMAT "->>,>>>,>>9.9999"
         S-CodMon    
  ...
  DEFINE FRAME H-REP
         ...
         "--------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
         "                                                                                                                                                                     " SKIP
         " Prove.        Nombre o Razon Social                  Concepto     Descripcion    Articulo                        UM        Cantidad      Precio    Moneda" SKIP
         "----------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
        WITH PAGE-TOP WIDTH 250 NO-BOX NO-LABELS NO-UNDERLINE STREAM-IO CENTERED DOWN. 

       FOR EACH PR-PRESER NO-LOCK WHERE PR-PRESER.CodCia = S-CODCIA AND  
                                      PR-PRESER.Codpro BEGINS F-Provee  AND  
                                      PR-PRESER.CodGas BEGINS F-Gasto :
       
          
          S-CODMON = IF PR-PRESER.Codmon = 1 THEN "S/." ELSE "US$.".


          DISPLAY PR-PRESER.CodPro @ Fi-Mensaje LABEL "Proveedor         "
                  FORMAT "X(11)" 
          ...
          FIND Almmmatg WHERE Almmmatg.Codcia = S-CODCIA AND
                              Almmmatg.CodMat = PR-PRESER.Codmat
                              NO-LOCK NO-ERROR.
                              
          FIND Gn-Prov WHERE 
               Gn-Prov.Codcia = pv-codcia AND  
               Gn-Prov.CodPro = PR-PRESER.Codpro         
               NO-LOCK NO-ERROR.
       
          FIND PR-Gastos WHERE 
               PR-Gastos.Codcia = S-CODCIA AND  
               PR-Gastos.CodGas = PR-PRESER.CodGas       
               NO-LOCK NO-ERROR.
          ...
          DISPLAY STREAM REPORT
                ...
                Gn-Prov.Nompro
                PR-PRESER.CodGas 
                PR-Gastos.DesGas WHEN AVAILABLE PR-Gastos
                PR-PRESER.codmat  
                Almmmatg.DesMat   
                PR-PRESER.UndA    
                PR-PRESER.CanDes[1] 
