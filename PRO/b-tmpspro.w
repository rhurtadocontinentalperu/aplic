...
&Scoped-define FIELDS-IN-QUERY-br_table ITEM.codmat Almmmatg.DesMat Almmmatg.DesMar ITEM.CodUnd Almmmate.StkAct stkdes ITEM.CanDes   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(47)" COLUMN-LABEL "D E S C R I P C I O N"
      Almmmatg.DesMar FORMAT "X(15)" COLUMN-LABEL "MARCA"
      ITEM.CodUnd COLUMN-LABEL "Unidad"
      Almmmate.StkAct 
      stkdes            COLUMN-LABEL "Stock!Pedido" FORMAT "(Z,ZZZ,ZZ9.9999)"
      ITEM.CanDes
ENABLE 
      ITEM.CanDes
/* _UIB-CODE-BLOCK-END */
...
/*
  IF Almtconv.Multiplos <> 0 THEN DO:
       IF DEC(ITEM.CanDes:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) / Almtconv.Multiplos <> 
          INT(DEC(ITEM.CanDes:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) / Almtconv.Multiplos) THEN DO:
