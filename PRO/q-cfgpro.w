...
&Scoped-define INTERNAL-TABLES PR-CFGPRO

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PR-CFGPRO WHERE ~{&KEY-PHRASE} ~
      AND PR-CFGPRO.CodCia = S-CODCIA NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main PR-CFGPRO
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PR-CFGPRO
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.PR-CFGPRO"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.PR-CFGPRO.CodCia = S-CODCIA"
