...
&Scoped-Define ENABLED-OBJECTS RECT-62 RECT-60 desdeF F-AlmDes Btn_OK ~
hastaF Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS desdeF F-AlmDes F-NomDes hastaF 
...
DEFINE FRAME F-Main
     ...
     F-AlmDes AT ROW 3.35 COL 7.86 COLON-ALIGNED
     Btn_OK AT ROW 5.23 COL 15.43
     F-NomDes AT ROW 3.38 COL 14.29 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Materiales X Orden de Produccion"
         HEIGHT             = 5.88
         WIDTH              = 53.72
         MAX-HEIGHT         = 10.92
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* Materiales X Orden de Produccion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Materiales X Orden de Produccion */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  x-titulo1 = 'MATERIALES POR ORDEN DE PRODUCCION'.
...
------------------------------------------------------------------------------*/
  DISPLAY desdeF F-AlmDes F-NomDes hastaF 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-62 RECT-60 desdeF F-AlmDes Btn_OK hastaF Btn_Cancel 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME H-REP
         ...
         "-------------------------------------------------------------------------------------------------------------------------------------" SKIP
         " Orden Alm.  Fecha  Articulo  Descripcion                        UM           Cantidad                                               " SKIP
         "                                              Material  Descripcion                                    UM        Cantidad            " SKIP
         "-------------------------------------------------------------------------------------------------------------------------------------" SKIP
       ...
       FOR EACH PR-ODPC NO-LOCK WHERE PR-ODPC.CodCia = S-CODCIA AND  
          ...
          x-flgest = IF PR-ODPC.flgest = 'A' THEN "ANULADO" ELSE "ACTIVO".          
