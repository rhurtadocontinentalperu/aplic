...
&SCOPED-DEFINE CONDICION ( LPRDMUES.CodCia = s-CodCia AND ~
                           LPRDMUES.CodMaq = input-var-1 AND ~
                           LPRDMUES.NroDoc = input-var-2 )
&SCOPED-DEFINE CODIGO LPRDMUES.Codigo
...
&Scoped-define INTERNAL-TABLES almtabla LPRDMUES
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH almtabla WHERE ~{&KEY-PHRASE} ~
      ...
      EACH LPRDMUES WHERE LPRDMUES.Codigo = almtabla.Codigo ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table almtabla LPRDMUES
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.LPRDMUES.Codigo|yes
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.almtabla,INTEGRAL.LPRDMUES WHERE INTEGRAL.almtabla ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ","
     _Where[1]         = "almtabla.Tabla = ""MP"""
     _JoinCode[2]      = "LPRDMUES.Codigo = almtabla.Codigo"
     _Where[2]         = "{&CONDICION}"
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY LPRDMUES.Codigo
