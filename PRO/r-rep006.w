...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Liquidación de servicios a terceros"
         HEIGHT             = 6.08
         WIDTH              = 53.57
         MAX-HEIGHT         = 6.12
         MAX-WIDTH          = 53.72
...
ON END-ERROR OF W-Win /* Liquidación de servicios a terceros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Liquidación de servicios a terceros */
DO:
...
------------------------------------------------------------------------------*/
    DEFINE FRAME F-REPORTE
          Reporte.CodPro COLUMN-LABEL "Código!Proveedor"
          ...
          Reporte.DesArt COLUMN-LABEL "Descripción Articulo" FORMAT "x(60)"
