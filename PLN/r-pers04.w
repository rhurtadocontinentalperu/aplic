...
DEFINE VARIABLE cTipDoc                 AS CHARACTER   NO-UNDO.
DEFINE VARIABLE cNacio                  AS CHARACTER   NO-UNDO.
DEFINE VARIABLE cDistri                 AS CHARACTER   NO-UNDO.
DEFINE VARIABLE cProvi                  AS CHARACTER   NO-UNDO.
DEFINE VARIABLE cDepto                  AS CHARACTER   NO-UNDO.
DEFINE VARIABLE cSexo                   AS CHARACTER   NO-UNDO.
...
chWorkSheet:Range("A2"):Value = "NroDocumento".
chWorkSheet:Range("B2"):Value = "Tipo Doc".
chWorkSheet:Range("C2"):Value = "Ap. Paterno".
chWorkSheet:Range("D2"):Value = "Ap. Materno".
chWorkSheet:Range("E2"):Value = "Nombres".
chWorkSheet:Range("F2"):Value = "Fecha Nac.".
chWorkSheet:Range("G2"):Value = "Estado Civil".
chWorkSheet:Range("H2"):Value = "Sexo".
chWorkSheet:Range("I2"):Value = "Nacionalidad".
chWorkSheet:Range("J2"):Value = "Direccion".
chWorkSheet:Range("K2"):Value = "Distrito".
chWorkSheet:Range("L2"):Value = "Provincia".
chWorkSheet:Range("M2"):Value = "Departamento".
chWorkSheet:Range("N2"):Value = "Telefono".
chWorkSheet:Range("O2"):Value = "Celular".
