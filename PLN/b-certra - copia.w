...
ASSIGN
    ...
    cPlantilla = SEARCH("\\192.168.100.251\contratos\" + cNomPlantilla).
IF cPlantilla = ? THEN DO:
    MESSAGE 'No se encontró la plantilla' cNomPlantilla 'en la carpeta \\192.l68.100.251\contratos'
...
x_archivo = "CertificadoCONTI" + pl-pers.codper.
/*Word:ChangeFileOpenDirectory("\\192.168.100.251\rrhh").*/
Word:ChangeFileOpenDirectory("d:\rrhh").
/*x_archivo = "\\192.168.100.251\rrhh\CertificadoCONTI" + pl-pers.codper.*/
