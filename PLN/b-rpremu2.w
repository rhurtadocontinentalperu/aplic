...
FOR EACH PL-MOV-MES WHERE
    ...
    CASE PL-MOV-MES.CodMov :
        ...
        WHEN 107 THEN Tempo.ValCal[19] =  Tempo.ValCal[19] + PL-MOV-MES.ValCal-Mes.
        WHEN 218 THEN Tempo.ValCal[20] =  Tempo.ValCal[20] + PL-MOV-MES.ValCal-Mes.
        WHEN 801 THEN Tempo.ValCal[21] =  Tempo.ValCal[21] + PL-MOV-MES.ValCal-Mes.
        WHEN 113 THEN Tempo.ValCal[22] =  Tempo.ValCal[22] + PL-MOV-MES.ValCal-Mes.
        WHEN 112 THEN Tempo.ValCal[23] =  Tempo.ValCal[23] + PL-MOV-MES.ValCal-Mes.
        WHEN 118 THEN Tempo.ValCal[24] =  Tempo.ValCal[24] + PL-MOV-MES.ValCal-Mes.
        /* EGRESOS */
        WHEN 508 THEN Tempo.ValCal[40] =  Tempo.ValCal[40] + PL-MOV-MES.ValCal-Mes.
        WHEN 509 THEN Tempo.ValCal[41] =  Tempo.ValCal[41] + PL-MOV-MES.ValCal-Mes.
        WHEN 215 THEN Tempo.ValCal[42] =  Tempo.ValCal[42] + PL-MOV-MES.ValCal-Mes.
        WHEN 510 THEN Tempo.ValCal[43] =  Tempo.ValCal[43] + PL-MOV-MES.ValCal-Mes.
    END.
END.
x-con-reg = 0.
...
chWorkSheet:Range("T4"):Value = 'Vacaciones'.
chWorkSheet:Range("T5"):Value = 'Trabajadas'.
chWorkSheet:Range("U4"):Value = 'Canasta'.
chWorkSheet:Range("U5"):Value = 'Navideña'.
chWorkSheet:Range("V4"):Value = 'Bonificación x'.
chWorkSheet:Range("V5"):Value = 'Producción'.
chWorkSheet:Range("W5"):Value = 'Refrigerio'.
chWorkSheet:Range("X5"):Value = 'Transporte'.
chWorkSheet:Range("Y4"):Value = 'Subsidio x'.
chWorkSheet:Range("Y5"):Value = 'Incapacidad Temp.'.
chWorkSheet:Range("Z5"):Value = 'Otros'.
chWorkSheet:Range("AA5"):Value = 'Total Sueldos'.
/*Descuentos*/
chWorkSheet:Range("AB4"):Value = 'Tardanzas'.
chWorkSheet:Range("AB5"):Value = 'Permisos'.
chWorkSheet:Range("AC5"):Value = 'Inasistencias'.
chWorkSheet:Range("AD5"):Value = '5ta Categoria'.
chWorkSheet:Range("AE4"):Value = 'Licencia sin'.
chWorkSheet:Range("AE5"):Value = 'Goce de Haber'.
...
FOR EACH tempo BREAK BY tempo.codcia BY tempo.ccosto BY tempo.Codper:
    ...
    ACCUM tempo.ValCal[19] ( SUB-TOTAL BY tempo.ccosto).
    ACCUM tempo.ValCal[20] ( SUB-TOTAL BY tempo.ccosto).
    ...
    /* Descuentos */
    ACCUM tempo.ValCal[40] ( SUB-TOTAL BY tempo.ccosto).
    ACCUM tempo.ValCal[41] ( SUB-TOTAL BY tempo.ccosto).
    ACCUM tempo.ValCal[42] ( SUB-TOTAL BY tempo.ccosto).
    ACCUM tempo.ValCal[43] ( SUB-TOTAL BY tempo.ccosto).
    ...
    ACCUM tempo.ValCal[19] ( TOTAL BY tempo.codcia).
    ACCUM tempo.ValCal[20] ( TOTAL BY tempo.codcia).
    ...
    /* Descuentos */
    ACCUM tempo.ValCal[40] ( TOTAL BY tempo.codcia).
    ACCUM tempo.ValCal[41] ( TOTAL BY tempo.codcia).
    ACCUM tempo.ValCal[42] ( TOTAL BY tempo.codcia).
    ACCUM tempo.ValCal[43] ( TOTAL BY tempo.codcia).
    ...
    IF LAST-OF(tempo.ccosto) THEN DO:
        ...
        cRange = "T" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[19].
        cRange = "U" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[20].
        cRange = "V" + cColumn.
        ...
        /*Liquidaciones*/
        cRange = "AB" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[40].
        cRange = "AC" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[41].
        cRange = "AD" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[42].
        cRange = "AE" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Tempo.ccosto tempo.ValCal[43].
        t-column = t-column + 1.
    END.
    IF LAST-OF(tempo.codcia) THEN DO:            
        ...
        cRange = "T" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[19].
        cRange = "U" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[20].
        cRange = "V" + cColumn.
        ...
        /* Egresos */
        cRange = "AB" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[40].
        cRange = "AC" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[41].
        cRange = "AD" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[42].
        cRange = "AE" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM TOTAL BY Tempo.codcia tempo.ValCal[43].
        t-column = t-column + 1.
    END.
END.
/* release com-handles */
