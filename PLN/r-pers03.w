...
DEF VAR dMonto AS DECIMAL NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Mes BUTTON-3 RADIO-SET-Orden ~
BUTTON-2 
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 2.08 COL 46
     RADIO-SET-Orden AT ROW 2.92 COL 21 NO-LABEL
     BUTTON-2 AT ROW 3.69 COL 46
...
DO:
  ...
  iMes = LOOKUP(COMBO-BOX-Mes, COMBO-BOX-Mes:LIST-ITEMS IN FRAME {&FRAME-NAME}).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE COMBO-BOX-Mes BUTTON-3 RADIO-SET-Orden BUTTON-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
chWorkSheet:Range("A2"):Value = "Nº".
chWorkSheet:Range("B2"):Value = "Código".
chWorkSheet:Range("C2"):Value = "CUSSP".
chWorkSheet:Range("D2"):Value = "DNI".
chWorkSheet:Range("E2"):Value = "Ap. Paterno".
chWorkSheet:Range("F2"):Value = "Ap. Materno".
chWorkSheet:Range("G2"):Value = "Nombres".
chWorkSheet:Range("H2"):Value = "Mov Pers".
chWorkSheet:Range("I2"):Value = "Fcha Ingreso o Cese".
chWorkSheet:Range("J2"):Value = "Remuneracion Afecta AFP - Sueldos".
chWorkSheet:Range("K2"):Value = "Remuneracion Afecta AFP - Liquidacion de Eventuales".
chWorkSheet:Range("L2"):Value = "Remuneracion Afecta AFP - Liquidaciones".
chWorkSheet:Range("M2"):Value = "Apor. Vol con fin previsional".
chWorkSheet:Range("N2"):Value = "Apor. Vol sin fin previsional".
chWorkSheet:Range("O2"):Value = "Apor. del empleador".
chWorkSheet:Range("P2"):Value = "AFP".
...
WHEN 1 THEN DO:
    FOR EACH pl-flg-mes WHERE
        ...
        pl-flg-mes.sitact <> 'Inactivo' AND
        pl-flg-mes.nroafp <> '' NO-LOCK,
