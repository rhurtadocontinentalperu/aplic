...
/* 20/08/2025: Juan Hermoza Obligado CCosto */
IF TRUE <> (PL-FLG-MES.ccosto:SCREEN-VALUE IN FRAME {&FRAME-NAME} > "") THEN DO:
    MESSAGE "Es obligatorio registrar el Centro de Costo" VIEW-AS ALERT-BOX WARNING.
    APPLY "ENTRY":U TO PL-FLG-MES.ccosto.
    RETURN 'ADM-ERROR'.
END.
/* **************************************** */
