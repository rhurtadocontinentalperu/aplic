...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generacion de Convenio de prestamo (Empleados)"
         HEIGHT             = 12.88
         WIDTH              = 70.72
         MAX-HEIGHT         = 12.88
         MAX-WIDTH          = 70.72
...
ON END-ERROR OF W-Win /* Generacion de Convenio de prestamo (Empleados) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Generacion de Convenio de prestamo (Empleados) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/pln/b-prestamo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-p-bolm ).
