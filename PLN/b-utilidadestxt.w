...
&Scoped-define QUERY-STRING-br_pl-flg-m FOR EACH INTEGRAL.PL-FLG-MES ~
 ...
 AND PL-FLG-MES.vcontr = ? NO-LOCK, ~
      FIRST INTEGRAL.PL-PERS OF INTEGRAL.PL-FLG-MES NO-LOCK ~
...
FOR EACH PL-MOV-MES WHERE
        ...
        NO-LOCK :     /* Participación de utilidades */
...
CASE COMBO-canal:
    ...
    WHEN "INTERBANK" THEN RUN procesa_interbank.
END CASE.
