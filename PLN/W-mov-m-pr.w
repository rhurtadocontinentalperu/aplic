...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pln/b-mov-m-pr.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-mov-m ).
       RUN set-position IN h_b-mov-m ( 4.15 , 1.72 ) NO-ERROR.
       RUN set-size IN h_b-mov-m ( 8.77 , 61.57 ) NO-ERROR.
       ...
       RUN set-size IN h_p-updva2 ( 8.65 , 9.57 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico-2 ,
             h_v-plan , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-flg-m ,
             h_p-navico-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-flg-m , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-mov-m ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updva2 ,
             h_b-mov-m , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-flg-m ,
             h_p-updva2 , 'AFTER':U ).
    END. /* Page 1 */
