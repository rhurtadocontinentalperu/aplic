...
DEFINE VARIABLE h_b-p-bolm-v02 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Emisión de Boletas (Empleados)"
         HEIGHT             = 14.92
         WIDTH              = 72.14
         MAX-HEIGHT         = 15.58
         MAX-WIDTH          = 72.14
...
ON END-ERROR OF W-Win /* Emisión de Boletas (Empleados) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Emisión de Boletas (Empleados) */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-plan ).
       RUN set-position IN h_v-plan ( 1.19 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-calc ).
       RUN set-position IN h_v-calc ( 2.54 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.35 , 52.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-navico-2 ).
       RUN set-position IN h_p-navico-2 ( 2.54 , 54.00 ) NO-ERROR.
       RUN set-size IN h_p-navico-2 ( 1.35 , 17.29 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pln/b-p-bolm-v02.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-p-bolm-v02 ).
       RUN set-position IN h_b-p-bolm-v02 ( 3.88 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-p-bolm-v02 ( 11.73 , 69.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-calc ).
       RUN set-position IN h_q-calc ( 2.54 , 40.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-p-bolm-v02. */
       RUN add-link IN adm-broker-hdl ( h_q-calc , 'Record':U , h_b-p-bolm-v02 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico-2 ,
             h_v-calc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-p-bolm-v02 ,
