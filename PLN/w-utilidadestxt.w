...
DEFINE VARIABLE h_b-utilidadestxt AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Archivo Transferencia de Participación de Utilidades (Empleados)"
         HEIGHT             = 12.88
         WIDTH              = 70.72
         MAX-HEIGHT         = 12.88
         MAX-WIDTH          = 70.72
...
ON END-ERROR OF W-Win /* Archivo Transferencia de Participación de Utilidades (Empleados) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Archivo Transferencia de Participación de Utilidades (Empleados) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pln/b-utilidadestxt.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-utilidadestxt ).
       RUN set-position IN h_b-utilidadestxt ( 4.15 , 1.43 ) NO-ERROR.
       RUN set-size IN h_b-utilidadestxt ( 9.50 , 69.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-calc1 ).
       RUN set-position IN h_q-calc1 ( 2.65 , 40.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.31 , 5.43 ) */
       ...
       /* Links to SmartBrowser h_b-utilidadestxt. */
       RUN add-link IN adm-broker-hdl ( h_q-calc1 , 'Record':U , h_b-utilidadestxt ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico-2 ,
             h_v-calc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-utilidadestxt ,
