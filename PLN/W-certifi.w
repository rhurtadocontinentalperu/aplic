...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Certificado de Trabajo(Empleados)"
         HEIGHT             = 12.88
         WIDTH              = 70.72
         MAX-HEIGHT         = 12.88
         MAX-WIDTH          = 70.72
...
ON END-ERROR OF W-Win /* Certificado de Trabajo(Empleados) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Certificado de Trabajo(Empleados) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_q-calc1 , 'Record':U , h_b-p-bolm ).
