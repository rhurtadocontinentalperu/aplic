...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES PL-PERS
&Scoped-define FIRST-EXTERNAL-TABLE PL-PERS


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR PL-PERS.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS PL-PERS.CodCia PL-PERS.patper PL-PERS.matper ~
PL-PERS.nomper PL-PERS.fecnac PL-PERS.sexper PL-PERS.NroDocId ~
PL-PERS.CodNac PL-PERS.E-Mail PL-PERS.telefo PL-PERS.lmilit PL-PERS.Essalud ~
PL-PERS.Domici PL-PERS.dirper PL-PERS.DirNumero PL-PERS.DirInterior ~
PL-PERS.NomZona PL-PERS.DirReferen PL-PERS.Ubigeo PL-PERS.titulo ~
PL-PERS.distri PL-PERS.profesion PL-PERS.ctipss 
&Scoped-define ENABLED-TABLES PL-PERS
&Scoped-define FIRST-ENABLED-TABLE PL-PERS
&Scoped-Define ENABLED-OBJECTS IMAGE-1 RECT-1 RECT-2 
&Scoped-Define DISPLAYED-FIELDS PL-PERS.codper PL-PERS.CodCia ~
PL-PERS.patper PL-PERS.matper PL-PERS.nomper PL-PERS.fecnac PL-PERS.sexper ~
PL-PERS.NroDocId PL-PERS.CodNac PL-PERS.E-Mail PL-PERS.telefo ~
PL-PERS.lmilit PL-PERS.Essalud PL-PERS.Domici PL-PERS.dirper ~
PL-PERS.DirNumero PL-PERS.DirInterior PL-PERS.NomZona PL-PERS.DirReferen ~
PL-PERS.Ubigeo PL-PERS.titulo PL-PERS.distri PL-PERS.profesion ~
PL-PERS.ctipss 
&Scoped-define DISPLAYED-TABLES PL-PERS
&Scoped-define FIRST-DISPLAYED-TABLE PL-PERS
...
DEFINE FRAME F-Main
     ...
     PL-PERS.codper AT ROW 1.77 COL 11 COLON-ALIGNED FORMAT "X(6)"
          VIEW-AS FILL-IN 
          SIZE 7.43 BY .81
          BGCOLOR 15 FGCOLOR 0 
     PL-PERS.CodCia AT ROW 1.77 COL 27 COLON-ALIGNED
          LABEL "Compañia"
          VIEW-AS FILL-IN 
          SIZE 4 BY .81
     FILL-IN-NomCia AT ROW 1.77 COL 32 COLON-ALIGNED NO-LABEL
     PL-PERS.patper AT ROW 2.73 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.matper AT ROW 3.54 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.nomper AT ROW 4.35 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.fecnac AT ROW 2.73 COL 51 COLON-ALIGNED
          LABEL "Fecha Nac"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     PL-PERS.sexper AT ROW 3.69 COL 53.29 NO-LABEL
...
"Femenino", "2":U
     ...
     PL-PERS.NroDocId AT ROW 5.15 COL 49 COLON-ALIGNED
          LABEL "Número"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     PL-PERS.CodNac AT ROW 5.96 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-nacion AT ROW 5.96 COL 16 COLON-ALIGNED NO-LABEL
     PL-PERS.E-Mail AT ROW 6.77 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 37.14 BY .81
     PL-PERS.telefo AT ROW 5.96 COL 52 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     PL-PERS.lmilit AT ROW 6.77 COL 52 COLON-ALIGNED
          LABEL "Cel"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     PL-PERS.Essalud AT ROW 7.58 COL 38 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Sí", "1":U,
"No", "0":U
          SIZE 10 BY .77
     PL-PERS.Domici AT ROW 8.88 COL 13 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Sí", "1":U,
"No", "2":U
     ...
     PL-PERS.dirper AT ROW 9.65 COL 29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.DirNumero AT ROW 9.65 COL 67 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
     PL-PERS.DirInterior AT ROW 9.65 COL 79 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
     COMBO-BOX_TipoZona AT ROW 10.46 COL 10.57 COLON-ALIGNED
     PL-PERS.NomZona AT ROW 10.46 COL 29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 15.72 BY .81
     PL-PERS.DirReferen AT ROW 10.46 COL 54 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.Ubigeo AT ROW 11.27 COL 38 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.72 BY .81
     ...
     PL-PERS.titulo AT ROW 14.08 COL 12 COLON-ALIGNED
...
DEFINE FRAME F-Main
     PL-PERS.distri AT ROW 14.08 COL 54 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     PL-PERS.profesion AT ROW 15.04 COL 12 COLON-ALIGNED
          VIEW-AS COMBO-BOX SORT INNER-LINES 5
          DROP-DOWN-LIST
          SIZE 27.72 BY 1
     PL-PERS.ctipss AT ROW 15.04 COL 54 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16.43 BY .81
...
/* SETTINGS FOR BUTTON BUTTON-loadimg IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN PL-PERS.CodCia IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN PL-PERS.codper IN FRAME F-Main
...
/* SETTINGS FOR COMBO-BOX COMBO-BOX_TpoDocId IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN PL-PERS.fecnac IN FRAME F-Main
   EXP-LABEL                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN-region IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN PL-PERS.lmilit IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN PL-PERS.NroDocId IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX PL-PERS.titulo IN FRAME F-Main
...
&Scoped-define SELF-NAME PL-PERS.CodCia
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.CodCia V-table-Win
ON LEAVE OF PL-PERS.CodCia IN FRAME F-Main /* Compañia */
DO:
...
&Scoped-define SELF-NAME PL-PERS.CodNac
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.CodNac V-table-Win
ON MOUSE-SELECT-DBLCLICK OF PL-PERS.CodNac IN FRAME F-Main /* Nacionalidad */
...
&Scoped-define SELF-NAME PL-PERS.codper
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.codper V-table-Win
ON LEAVE OF PL-PERS.codper IN FRAME F-Main /* Código */
DO:
...
&Scoped-define SELF-NAME PL-PERS.profesion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.profesion V-table-Win
ON ENTRY OF PL-PERS.profesion IN FRAME F-Main /* Profesión */
DO:
...
&Scoped-define SELF-NAME PL-PERS.titulo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.titulo V-table-Win
ON ENTRY OF PL-PERS.titulo IN FRAME F-Main /* Título */
DO:
    ASSIGN CMB-Titulo = "".
...
&Scoped-define SELF-NAME PL-PERS.Ubigeo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL PL-PERS.Ubigeo V-table-Win
ON MOUSE-SELECT-DBLCLICK OF PL-PERS.Ubigeo IN FRAME F-Main /* Ubigeo */
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "PL-PERS"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "PL-PERS"}
...
------------------------------------------------------------------------------*/
  ...
  FIND LAST B-Pers WHERE integer(B-Pers.CodPer) < 999998 NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  IF AVAILABLE PL-PERS THEN DO WITH FRAME {&FRAME-NAME}:
