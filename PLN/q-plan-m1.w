...
&Scoped-define INTERNAL-TABLES PL-PLAN

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PL-PLAN ~
      WHERE PL-PLAN.tippln = TRUE NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main PL-PLAN
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PL-PLAN
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "integral.PL-PLAN"
     _Options          = "NO-LOCK"
     _Where[1]         = "integral.PL-PLAN.tippln = TRUE"
     _Design-Parent    is WINDOW q-tables @ ( 1.08 , 1.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
