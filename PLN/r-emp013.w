...
------------------------------------------------------------------------------*/
    ...
    cRange = "P" + cColumn.
    chWorkSheet:Range(cRange):VALUE = "PROMEDIO ASIGNAC. EXTRAORDINARIA".
    ...
    FOR EACH PL-FLG-MES NO-LOCK WHERE
        ...
        cRange = "P" + cColumn.
        chWorkSheet:Range(cRange):VALUE = dVal[19].

        cRange = "Q" + cColumn.
        dIngDiario = dVal[5] + dVal[12] + dVal[6] + dVal[8] + dVal[10] + dVal[9] + dVal[17] +
                    dVal[13] + dVal[15] + dVal[14] + dVal[16] + dVal[19].
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH PL-FLG-MES NO-LOCK WHERE
        ...
        chWorkSheet:Range(cRange):VALUE = dVal[17].
        cRange = "Q" + cColumn.
        chWorkSheet:Range(cRange):VALUE = dVal[18].
