...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 124.29 BY 22.81 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Datos I|Datos II|Persona|CTS|Secciones|Clases|Proyectos|Cargos|Canal Pago' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 22.62 , 123.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-pers-m-02 ( 3.69 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-pers-m-01 ( 11.77 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.58 , 106.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 12.04 , 110.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-plan-m ).
       RUN set-position IN h_q-plan-m ( 2.35 , 107.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-3 ).
       RUN set-position IN h_p-updv12-3 ( 2.88 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-secc ).
       RUN set-position IN h_b-secc ( 4.23 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-secc ( 17.77 , 120.00 ) NO-ERROR.
    ...
    WHEN 8 THEN DO:
       ...
       RUN set-size IN h_b-carg ( 18.58 , 77.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-6 ).
       RUN set-position IN h_p-updv12-6 ( 2.62 , 80.00 ) NO-ERROR.
    ...
    WHEN 9 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-7 ).
       RUN set-position IN h_p-updv12-7 ( 2.54 , 5.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12-7 ( 1.42 , 34.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pago ).
       RUN set-position IN h_b-pago ( 4.08 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-pago ( 6.69 , 84.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-pago. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12-7 , 'TableIO':U , h_b-pago ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12-7 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-pago ,
             h_p-updv12-7 , 'AFTER':U ).
    END. /* Page 9 */
