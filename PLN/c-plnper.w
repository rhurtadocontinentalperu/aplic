...
&Scoped-define FIELDS-IN-QUERY-BROWSE-3 PL-PERS.codper PL-PERS.lmilit ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 gDialog _STRUCTURED
  QUERY BROWSE-3 NO-LOCK DISPLAY
      PL-PERS.codper COLUMN-LABEL "Código!Progres" FORMAT "X(8)":U
      PL-PERS.lmilit COLUMN-LABEL "Código!Alvisoft" FORMAT "X(10)":U
      PL-PERS.patper FORMAT "X(20)":U WIDTH 23.29
      PL-PERS.matper FORMAT "X(20)":U WIDTH 25.43
      PL-PERS.nomper FORMAT "X(20)":U WIDTH 29.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 102 BY 14.54
...
"codper" "Código!Progres" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.PL-PERS.lmilit
"lmilit" "Código!Alvisoft" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.PL-PERS.patper
"patper" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "23.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.PL-PERS.matper
"matper" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "25.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.PL-PERS.nomper
"nomper" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "29.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
