...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Liquidación Anual de Aportes Obreros"
         HEIGHT             = 4.85
         WIDTH              = 60.72
         MAX-HEIGHT         = 27.73
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF W-Win /* Liquidación Anual de Aportes Obreros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Liquidación Anual de Aportes Obreros */
DO:
