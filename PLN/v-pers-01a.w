...
DEFINE FRAME F-Main
     FILL-IN-FchCes AT ROW 14.69 COL 73 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-FchIng AT ROW 13.92 COL 73 COLON-ALIGNED WIDGET-ID 6
...
"No", "0":U
          SIZE 10 BY .77
     INTEGRAL.PL-PERS.Domici AT ROW 9.08 COL 13 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Sí", "1":U,
"No", "2":U
          SIZE 10 BY .77
     COMBO-BOX_TipoVia AT ROW 9.88 COL 11 COLON-ALIGNED
     INTEGRAL.PL-PERS.dirper AT ROW 10.69 COL 11 COLON-ALIGNED FORMAT "X(253)"
          VIEW-AS FILL-IN 
          SIZE 74 BY .81
     INTEGRAL.PL-PERS.DirNumero AT ROW 11.5 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
     INTEGRAL.PL-PERS.DirInterior AT ROW 11.5 COL 29 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
     COMBO-BOX_TipoZona AT ROW 13.12 COL 11 COLON-ALIGNED
     INTEGRAL.PL-PERS.NomZona AT ROW 13.12 COL 29.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 15.72 BY .81
     INTEGRAL.PL-PERS.DirReferen AT ROW 12.31 COL 11 COLON-ALIGNED FORMAT "x(253)"
          VIEW-AS FILL-IN 
          SIZE 74 BY .81
     INTEGRAL.PL-PERS.Ubigeo AT ROW 13.92 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.72 BY .81
...
DEFINE FRAME F-Main
     FILL-IN-region AT ROW 13.92 COL 29 COLON-ALIGNED
     FILL-IN-provincia AT ROW 14.73 COL 29 COLON-ALIGNED
     FILL-IN-distrito AT ROW 15.54 COL 29 COLON-ALIGNED
     INTEGRAL.PL-PERS.titulo AT ROW 16.88 COL 11 COLON-ALIGNED
          LABEL "Título" FORMAT "X(20)"
          VIEW-AS COMBO-BOX SORT INNER-LINES 5
          DROP-DOWN-LIST
          SIZE 29.57 BY 1
     INTEGRAL.PL-PERS.distri AT ROW 16.88 COL 54 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     INTEGRAL.PL-PERS.profesion AT ROW 17.69 COL 11 COLON-ALIGNED
          VIEW-AS COMBO-BOX SORT INNER-LINES 5
          DROP-DOWN-LIST
          SIZE 27.72 BY 1
     INTEGRAL.PL-PERS.ctipss AT ROW 17.69 COL 54 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16.43 BY .81
     ...
     RECT-3 AT ROW 16.62 COL 2 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* SETTINGS FOR COMBO-BOX COMBO-BOX_TpoDocId IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN INTEGRAL.PL-PERS.dirper IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN INTEGRAL.PL-PERS.DirReferen IN FRAME F-Main
   EXP-FORMAT                                                           */
...
ON LEAVE OF INTEGRAL.PL-PERS.Ubigeo IN FRAME F-Main /* Ubigeo */
DO:
    FIND TabDistr WHERE
    ...
    IF AVAILABLE TabDistr THEN DO:
        FIND TabDepto WHERE TabDepto.CodDepto = SUBSTRING(PL-PERS.ubigeo:SCREEN-VALUE,1,2) NO-LOCK NO-ERROR.
        IF AVAILABLE TabDepto THEN FILL-IN-Region = TabDepto.NomDepto.
        FIND TabProvi WHERE TabProvi.CodDepto = SUBSTRING(PL-PERS.ubigeo:SCREEN-VALUE,1,2) AND
            TabProvi.CodProvi = SUBSTRING(PL-PERS.ubigeo:SCREEN-VALUE,3,2)
            NO-LOCK NO-ERROR.
        IF AVAILABLE TabProvi THEN FILL-IN-provincia = TabProvi.NomProvi.
        FILL-IN-distrito = TabDistr.NomDistr.
        DISPLAY
            FILL-IN-region
            FILL-IN-provincia
            FILL-IN-distrito
            FILL-IN-distrito @ PL-PERS.distri
            WITH FRAME {&FRAME-NAME}.
        PL-PERS.distri:SCREEN-VALUE = TabDistr.NomDistr.
    END.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF RETURN-VALUE = 'YES' THEN DO:
        ...
        IF AVAILABLE B-PERS THEN DO:
            MESSAGE 'YA existe una persona registrada con el mismo nombre' SKIP
                ...
                '# Doc. Identidad:' B-PERS.NroDocId SKIP(1)
                'Proceso Abortado'
                VIEW-AS ALERT-BOX WARNING.
            RETURN 'ADM-ERROR'.
        END.
        IF PL-PERS.NroDocId:SCREEN-VALUE <> '' THEN DO:
            ...
            x-Documento = ENTRY(LOOKUP(COMBO-BOX_TpoDocId:SCREEN-VALUE, COMBO-BOX_TpoDocId:LIST-ITEMS), x-TpoDocId).
            FIND FIRST B-PERS WHERE B-PERS.TpoDocId = x-Documento AND
                B-PERS.nrodocid = PL-PERS.NroDocId:SCREEN-VALUE
                NO-LOCK NO-ERROR.
            IF AVAILABLE B-PERS THEN DO:
    ...
    IF NOT AVAILABLE TabDistr THEN DO:
        MESSAGE 'Ubigeo mal registrado' VIEW-AS ALERT-BOX WARNING.
        APPLY 'ENTRY':U TO PL-PERS.Ubigeo.
        RETURN 'ADM-ERROR'.
    END.
