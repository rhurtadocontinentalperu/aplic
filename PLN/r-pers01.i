...
/* ***************************  Main Block  *************************** */
        ...
        cRange = "X" + cColumn.
        ASSIGN chWorkSheet:Range(cRange):Value = PL-FLG-MES.FchIniCont NO-ERROR. 
        cRange = "Y" + cColumn.
        ASSIGN chWorkSheet:Range(cRange):Value = PL-FLG-MES.FchFinCont NO-ERROR.
        cRange = "Z" + cColumn.
        ...
        cRange = "AG" + cColumn.
        ASSIGN chWorkSheet:Range(cRange):Value = PL-PERS.fecnac NO-ERROR.
        ...
        /* Regimen Pensionario */
        cRange = "AQ" + cColumn.
        chWorkSheet:Range(cRange):Value = PL-FLG-MES.RegPensio.
        FIND pl-tabla WHERE pl-tabla.codcia = cb-codcia AND
            pl-tabla.tabla = '11' AND
            pl-tabla.codigo = PL-FLG-MES.RegPensio NO-LOCK NO-ERROR.
        IF AVAILABLE pl-tabla THEN chWorkSheet:Range(cRange):Value = PL-FLG-MES.RegPensio + " " + pl-tabla.nombre.
        /* Proyecto */
        cRange = "AR" + cColumn.
        chWorkSheet:Range(cRange):Value = PL-FLG-MES.Proyecto.
        /* e-mail */
        cRange = "AS" + cColumn.
        chWorkSheet:Range(cRange):Value = PL-PERS.e-mail.
        /* Nacionalidad */
        cRange = "AT" + cColumn.
        FIND pl-tabla WHERE pl-tabla.codcia = 0 AND
            pl-tabla.tabla = '04' AND
            pl-tabla.codigo = pl-pers.CodNac NO-LOCK NO-ERROR.
        IF AVAILABLE pl-tabla THEN chWorkSheet:Range(cRange):Value = pl-tabla.nombre.
        /* Medidas */
        iColUniforme = 85.
