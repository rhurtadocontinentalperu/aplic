...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-Mes RADIO-SET-Orden BUTTON-2 ~
BUTTON-3 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE COMBO-BOX-Mes RADIO-SET-Orden BUTTON-2 BUTTON-3 
      WITH FRAME F-Main IN WINDOW W-Win.
...
chWorkSheet:Range("I2"):Value = "Dirección".
chWorkSheet:Range("J2"):Value = "Grado Instrucción".
chWorkSheet:Range("K2"):Value = "Fecha de Ingreso".
chWorkSheet:Range("L2"):Value = "Sueldo Básico".
...
DEFINE VARIABLE cRange                  AS CHARACTER.
DEFINE VARIABLE t-Column                AS INTEGER INIT 2.
DEFINE VARIABLE iColUniforme AS INT NO-UNDO.
...
chWorkSheet:Range("K2"):Value = "Sueldo Básico".
chWorkSheet:Range("L2"):Value = "Asignación Familiar".
chWorkSheet:Range("M2"):Value = "Alimentación".
chWorkSheet:Range("N2"):Value = "Condición de Trabajo".
chWorkSheet:Range("O2"):Value = "Bonificación Especial".
chWorkSheet:Range("P2"):Value = "Riesgo de Caja".
chWorkSheet:Range("Q2"):Value = "Prestaciones Alimentarias".
chWorkSheet:Range("R2"):Value = "Transporte".
chWorkSheet:Range("S2"):Value = "Reemb. Refrigerio y Movilidad".
chWorkSheet:Range("T2"):Value = "Otros Ingresos".
chWorkSheet:Range("U2"):Value = "Condición de trabajo - Movilidad".
chWorkSheet:Range("V2"):Value = "CUSSP".
chWorkSheet:Columns("V"):NumberFormat = "@".
chWorkSheet:Range("W2"):Value = "DNI".
chWorkSheet:Columns("W"):NumberFormat = "@".
chWorkSheet:Range("X2"):Value = "Inicio Contrato".
chWorkSheet:Columns("X"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("Y2"):Value = "Fin Contrato".
chWorkSheet:Columns("Y"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("Z2"):Value = "Reg. MINTRA".
chWorkSheet:Range("AA2"):Value = "Telefono".
chWorkSheet:Columns("AA"):NumberFormat = "@".
chWorkSheet:Range("AB2"):Value = "Celular".
chWorkSheet:Columns("AB"):NumberFormat = "@".
chWorkSheet:Range("AC2"):Value = "Canal de Pago".
chWorkSheet:Range("AD2"):Value = "Nro.Cuenta".
chWorkSheet:Columns("AD"):NumberFormat = "@".
chWorkSheet:Range("AE2"):Value = "Profesión".
chWorkSheet:Range("AF2"):Value = "Sexo".
chWorkSheet:Range("AG2"):Value = "Fecha de Nacimiento".
chWorkSheet:Columns("AG"):NumberFormat = "dd/mm/yyyy".
chWorkSheet:Range("AH2"):Value = "Direccion".
chWorkSheet:Range("AI2"):Value = "Distrito".
chWorkSheet:Range("AJ2"):Value = "Nro".
chWorkSheet:Range("AK2"):Value = "Interior".
chWorkSheet:Range("AL2"):VALUE = "EPS".
chWorkSheet:Range("AM2"):VALUE = "División".
chWorkSheet:Columns("AM"):NumberFormat = "@".
chWorkSheet:Range("AN2"):VALUE = "Clase".
chWorkSheet:Range("AO2"):VALUE = "CTS".
chWorkSheet:Range("AP2"):VALUE = "No CTS".
chWorkSheet:Columns("AP"):NumberFormat = "@".
chWorkSheet:Range("AQ2"):VALUE = "Régimen Pensionario".
chWorkSheet:Range("AR2"):VALUE = "Proyecto".
chWorkSheet:Range("AS2"):VALUE = "E-Mail".
chWorkSheet:Range("AT2"):VALUE = "Nacionalidad".
/* Medidas */
iColUniforme = 85.
FOR EACH pl-tabla NO-LOCK WHERE pl-tabla.codcia = 0 AND pl-tabla.tabla = "UNIF":
    cRange = "A" + CHR(iColUniforme) + '2'.
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Maestro de Personal'.
  CASE RADIO-SET-Orden:
    WHEN 2 THEN RB-REPORT-NAME = 'Maestro de Personal x Nombre'.
    WHEN 3 THEN RB-REPORT-NAME = 'Maestro de Personal x Seccion'.
  END CASE.
  RB-INCLUDE-RECORDS = 'O'.
  RB-FILTER = 'pl-flg-mes.codcia = ' + STRING(s-codcia) +
                ' and pl-flg-mes.codpln = 01' +
                ' and pl-flg-mes.periodo = ' + STRING(s-periodo) +
                ' and pl-flg-mes.nromes = ' + STRING(LOOKUP(COMBO-BOX-Mes, COMBO-BOX-Mes:LIST-ITEMS IN FRAME {&FRAME-NAME})) +
