...
DEFINE STREAM strm7.
DEFINE STREAM strm9.
DEFINE STREAM strm10.
DEFINE STREAM strm11.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 PL-FLG-MES.codper PL-FLG-MES.fecing ~
PL-FLG-MES.vcontr PL-FLG-MES.seccion PL-PERS.patper PL-PERS.matper ~
PL-PERS.nomper 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH PL-FLG-MES ~
      WHERE PL-FLG-MES.NroMes = iNroMes ~
 AND PL-FLG-MES.Periodo = COMBO-BOX-Periodo ~
 AND PL-FLG-MES.CodCia = s-codcia ~
 AND (FILL-IN-CodPer-1 = "" OR ~
INTEGRAL.PL-FLG-MES.codper >= FILL-IN-CodPer-1) ~
AND (FILL-IN-CodPer-2 = "" OR ~
INTEGRAL.PL-FLG-MES.codper <= FILL-IN-CodPer-2) NO-LOCK, ~
      EACH PL-PERS OF PL-FLG-MES NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH PL-FLG-MES ~
      WHERE PL-FLG-MES.NroMes = iNroMes ~
 AND PL-FLG-MES.Periodo = COMBO-BOX-Periodo ~
 AND PL-FLG-MES.CodCia = s-codcia ~
 AND (FILL-IN-CodPer-1 = "" OR ~
...
INTEGRAL.PL-FLG-MES.codper <= FILL-IN-CodPer-2) NO-LOCK, ~
      EACH PL-PERS OF PL-FLG-MES NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 PL-FLG-MES PL-PERS
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 PL-FLG-MES
...
FILL-IN-CodPer-1 FILL-IN-CodPer-2 BROWSE-2 BUTTON-8 TOGGLE-1 BUTTON-1 ~
TOGGLE-2 TOGGLE-3 BUTTON-2 TOGGLE-4 TOGGLE-5 TOGGLE-6 TOGGLE-7 TOGGLE-8 ~
TOGGLE-10 TOGGLE-11 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-Periodo COMBO-BOX-mes ~
FILL-IN-CodPer-1 FILL-IN-CodPer-2 FILL-IN-Directorio TOGGLE-1 FILL-IN-1 ~
TOGGLE-2 FILL-IN-2 TOGGLE-3 FILL-IN-3 TOGGLE-4 FILL-IN-4 TOGGLE-5 FILL-IN-5 ~
TOGGLE-6 FILL-IN-6 TOGGLE-7 FILL-IN-7 TOGGLE-8 FILL-IN-8 FILL-IN-9 ~
TOGGLE-10 FILL-IN-10 TOGGLE-11 FILL-IN-11 
...
DEFINE VARIABLE TOGGLE-10 AS LOGICAL INITIAL yes 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 2 BY .77 NO-UNDO.

DEFINE VARIABLE TOGGLE-11 AS LOGICAL INITIAL yes 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 2 BY .77 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      PL-FLG-MES.fecing FORMAT "99/99/9999":U
      PL-FLG-MES.vcontr FORMAT "99/99/9999":U
      PL-FLG-MES.seccion FORMAT "X(25)":U WIDTH 30
      PL-PERS.patper FORMAT "X(20)":U
      PL-PERS.matper FORMAT "X(20)":U
      PL-PERS.nomper FORMAT "X(20)":U WIDTH 9.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 112 BY 8.65
...
DEFINE FRAME F-Main
     ...
     COMBO-BOX-mes AT ROW 1.58 COL 24 COLON-ALIGNED
     FILL-IN-CodPer-1 AT ROW 2.54 COL 24 COLON-ALIGNED WIDGET-ID 20
     FILL-IN-CodPer-2 AT ROW 2.54 COL 49 COLON-ALIGNED WIDGET-ID 22
     BROWSE-2 AT ROW 3.5 COL 7 WIDGET-ID 100
     FILL-IN-Directorio AT ROW 12.54 COL 36 COLON-ALIGNED WIDGET-ID 12
     BUTTON-8 AT ROW 12.54 COL 56 WIDGET-ID 14
     TOGGLE-1 AT ROW 13.5 COL 34.57
     FILL-IN-1 AT ROW 13.5 COL 36 COLON-ALIGNED NO-LABEL
     BUTTON-1 AT ROW 13.69 COL 87
     TOGGLE-2 AT ROW 14.31 COL 34.57
     FILL-IN-2 AT ROW 14.31 COL 36 COLON-ALIGNED NO-LABEL
     TOGGLE-3 AT ROW 15.12 COL 34.57
     FILL-IN-3 AT ROW 15.12 COL 36 COLON-ALIGNED NO-LABEL
     BUTTON-2 AT ROW 15.23 COL 87
     TOGGLE-4 AT ROW 15.92 COL 34.57
     FILL-IN-4 AT ROW 15.92 COL 36 COLON-ALIGNED NO-LABEL
     TOGGLE-5 AT ROW 16.73 COL 34.57
     FILL-IN-5 AT ROW 16.73 COL 36 COLON-ALIGNED NO-LABEL
     TOGGLE-6 AT ROW 17.54 COL 34.57
     FILL-IN-6 AT ROW 17.54 COL 36 COLON-ALIGNED NO-LABEL
     TOGGLE-7 AT ROW 18.35 COL 34.57
     FILL-IN-7 AT ROW 18.35 COL 36 COLON-ALIGNED NO-LABEL
     TOGGLE-8 AT ROW 19.15 COL 34.57
     FILL-IN-8 AT ROW 19.15 COL 36 COLON-ALIGNED NO-LABEL
     FILL-IN-9 AT ROW 19.96 COL 36 COLON-ALIGNED
     TOGGLE-9 AT ROW 21 COL 34.57
     TOGGLE-10 AT ROW 21.77 COL 35 WIDGET-ID 32
     FILL-IN-10 AT ROW 21.77 COL 36 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     TOGGLE-11 AT ROW 22.54 COL 35 WIDGET-ID 34
     FILL-IN-11 AT ROW 22.54 COL 36 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     "Datos de períodos con deuda pendiente:" VIEW-AS TEXT
          SIZE 29 BY .5 AT ROW 22.73 COL 33 RIGHT-ALIGNED WIDGET-ID 28
     "Personal en formación:" VIEW-AS TEXT
          SIZE 16.29 BY .5 AT ROW 17.65 COL 32.86 RIGHT-ALIGNED
     "Datos principales del trabajador:" VIEW-AS TEXT
          SIZE 21.57 BY .5 AT ROW 13.62 COL 32.57 RIGHT-ALIGNED
     "Establecimientos del trabajador:" VIEW-AS TEXT
          SIZE 21.29 BY .5 AT ROW 18.46 COL 12.14
     "Datos del trabajador:" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 14.42 COL 32.57 RIGHT-ALIGNED
     "Datos de períodos:" VIEW-AS TEXT
          SIZE 13.29 BY .5 AT ROW 15.23 COL 32.58 RIGHT-ALIGNED
     "Derechohabientes ALTAS:" VIEW-AS TEXT
          SIZE 18.29 BY .5 AT ROW 16.04 COL 32.86 RIGHT-ALIGNED
     "Comprobantes prestadores servicios:" VIEW-AS TEXT
          SIZE 25.29 BY .5 AT ROW 19.27 COL 33.29 RIGHT-ALIGNED
     "Derechohabientes BAJAS:" VIEW-AS TEXT
          SIZE 18.29 BY .5 AT ROW 16.77 COL 32.86 RIGHT-ALIGNED WIDGET-ID 2
     "Datos del trabajador con deuda pendiente:" VIEW-AS TEXT
          SIZE 29 BY .5 AT ROW 21.96 COL 33 RIGHT-ALIGNED WIDGET-ID 30
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-2 FILL-IN-CodPer-2 F-Main */
...
/* SETTINGS FOR TEXT-LITERAL "Derechohabientes BAJAS:"
          SIZE 18.29 BY .5 AT ROW 16.77 COL 32.86 RIGHT-ALIGNED         */
...
/* SETTINGS FOR TEXT-LITERAL "Datos del trabajador con deuda pendiente:"
          SIZE 29 BY .5 AT ROW 21.96 COL 33 RIGHT-ALIGNED               */

/* SETTINGS FOR TEXT-LITERAL "Datos de períodos con deuda pendiente:"
          SIZE 29 BY .5 AT ROW 22.73 COL 33 RIGHT-ALIGNED               */
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _Where[1]         = "INTEGRAL.PL-FLG-MES.NroMes = iNroMes
 AND INTEGRAL.PL-FLG-MES.Periodo = COMBO-BOX-Periodo
 AND INTEGRAL.PL-FLG-MES.CodCia = s-codcia
 AND (FILL-IN-CodPer-1 = """" OR
INTEGRAL.PL-FLG-MES.codper >= FILL-IN-CodPer-1)
AND (FILL-IN-CodPer-2 = """" OR
INTEGRAL.PL-FLG-MES.codper <= FILL-IN-CodPer-2)"
     _FldNameList[1]   > INTEGRAL.PL-FLG-MES.codper
"PL-FLG-MES.codper" ? ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.PL-FLG-MES.fecing
     _FldNameList[3]   = INTEGRAL.PL-FLG-MES.vcontr
     _FldNameList[4]   > INTEGRAL.PL-FLG-MES.seccion
"PL-FLG-MES.seccion" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PL-PERS.nomper" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
DO:
    ...
    IF {&BROWSE-NAME}:NUM-SELECTED-ROWS = 0 THEN DO:
        MESSAGE 'Debe seleccionar al menos una persona' VIEW-AS ALERT-BOX WARNING.
        RETURN NO-APPLY.
    END.
    IF TOGGLE-1 OR TOGGLE-2 OR TOGGLE-3 OR TOGGLE-4 OR
        TOGGLE-5 OR TOGGLE-6 OR TOGGLE-7 OR TOGGLE-8 
        OR TOGGLE-10 OR TOGGLE-11
        THEN DO:
...
DO:
    ...
    ASSIGN
        ...
        FILL-IN-4 = TRIM(FILL-IN-Directorio) + "\" + "RD_" + x-RUCCia + "_" +
        STRING(DAY(TODAY),'99') + STRING(MONTH(TODAY),'99') + STRING(YEAR(TODAY),'9999') +
        "_ALTA" + ".txt"
        FILL-IN-5 = TRIM(FILL-IN-Directorio) + "\" + "RD_" + x-RUCCia + "_" +
        STRING(DAY(TODAY),'99') + STRING(MONTH(TODAY),'99') + STRING(YEAR(TODAY),'9999') +
        "_BAJA" + ".txt"
        ...
        FILL-IN-10 = TRIM(FILL-IN-Directorio) + "\" + "RP_" + x-RUCCia + ".tradeuda"
        FILL-IN-11 = TRIM(FILL-IN-Directorio) + "\" + "RP_" + x-RUCCia + ".perdeuda".
    DISPLAY 
        FILL-IN-Directorio 
        FILL-IN-1 
        FILL-IN-2 
...
DO:
    ASSIGN 
        COMBO-BOX-mes COMBO-BOX-Periodo.
...
&Scoped-define SELF-NAME FILL-IN-CodPer-1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-CodPer-1 W-Win
ON LEAVE OF FILL-IN-CodPer-1 IN FRAME F-Main /* Desde el código */
DO:
  ASSIGN {&self-name}.
  {&OPEN-QUERY-{&BROWSE-NAME}}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-CodPer-2 W-Win
ON LEAVE OF FILL-IN-CodPer-2 IN FRAME F-Main /* Hasta el código */
DO:
    ASSIGN {&self-name}.
    {&OPEN-QUERY-{&BROWSE-NAME}}
END.
...
&Scoped-define SELF-NAME TOGGLE-10
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL TOGGLE-10 W-Win
ON VALUE-CHANGED OF TOGGLE-10 IN FRAME F-Main
DO:
...
&Scoped-define SELF-NAME TOGGLE-11
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL TOGGLE-11 W-Win
ON VALUE-CHANGED OF TOGGLE-11 IN FRAME F-Main
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-Periodo COMBO-BOX-mes FILL-IN-CodPer-1 FILL-IN-CodPer-2 
          FILL-IN-Directorio TOGGLE-1 FILL-IN-1 TOGGLE-2 FILL-IN-2 TOGGLE-3 
          FILL-IN-3 TOGGLE-4 FILL-IN-4 TOGGLE-5 FILL-IN-5 TOGGLE-6 FILL-IN-6 
          TOGGLE-7 FILL-IN-7 TOGGLE-8 FILL-IN-8 FILL-IN-9 TOGGLE-10 FILL-IN-10 
          TOGGLE-11 FILL-IN-11 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE COMBO-BOX-Periodo COMBO-BOX-mes FILL-IN-CodPer-1 FILL-IN-CodPer-2 
         BROWSE-2 BUTTON-8 TOGGLE-1 BUTTON-1 TOGGLE-2 TOGGLE-3 BUTTON-2 
         TOGGLE-4 TOGGLE-5 TOGGLE-6 TOGGLE-7 TOGGLE-8 TOGGLE-10 TOGGLE-11 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/* 11/11/2024: Sheyla Ortiz */
DEF VAR C10 AS CHAR FORMAT 'x(3)' NO-UNDO.  /* Teléfono (Opcional) */
DEF VAR C11 AS CHAR FORMAT 'x(9)' NO-UNDO.  /* Teléfono (obligatorio) solo si C10 se registró */
...
IF LENGTH(cTelefono) = 7 THEN ASSIGN C10 = "1" C11 = cTelefono. /* Fijo */
IF PL-PERS.LMilit > '' AND 
    PL-PERS.LMilit BEGINS '9' AND 
    LENGTH(TRIM(PL-PERS.LMilit)) = 9 
    THEN ASSIGN C10 = "" C11 = TRIM(PL-PERS.LMilit).    /* Celular */
...
PUT STREAM strm1 UNFORMATTED
    ...
    TRIM(STRING(PL-PERS.NroDocId, 'x(15)')) "|".
...
/*PUT STREAM strm1 UNFORMATTED TRIM(STRING(PL-PERS.e-mail,'x(50)'))  "|".*/
PUT STREAM strm1 "|".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Formato-10 W-Win 
PROCEDURE Formato-10 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
/* buscamos monto de remuneracion */
FIND pl-mov-mes OF pl-flg-mes WHERE PL-MOV-MES.CodMov = 101
    AND PL-MOV-MES.codcal = 000
    NO-LOCK NO-ERROR.
    PUT STREAM strm10 UNFORMATTED
        PL-PERS.TpoDocId "|"
...
FIND pl-mov-mes OF pl-flg-mes WHERE PL-MOV-MES.CodMov = 101
    ...
    /* 11/11/2024: Sheyla Ortiz, (8) CUSPP y (9) SCTR son opcionales */
    PUT STREAM strm2 UNFORMATTED
        /*PL-FLG-MES.nroafp "|"     Dato opcional */
        "|"
        "|"                     /* Dato opcional */
        .
    ...
    PUT STREAM strm2 UNFORMATTED
        ...
        /* 11/11/2024: Sheyla Ortiz, (11), (12) y (13) son opcionales */
...
/*         PL-FLG-MES.Jornada[3] "|" */
    ...
    PUT STREAM strm2 UNFORMATTED
        ...
        (IF AVAILABLE pl-mov-mes THEN TRIM(STRING(PL-MOV-MES.valcal-mes,'>>>>9.99')) ELSE '')
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
    DO WITH FRAME {&FRAME-NAME}:
        ...
        FILL-IN-4 = "RD_" + x-RUCCia + "_" +
            STRING(DAY(TODAY),'99') + STRING(MONTH(TODAY),'99') + STRING(YEAR(TODAY),'9999') +
            "_ALTA.txt".
        FILL-IN-5 = "RD_" + x-RUCCia + "_" +
            STRING(DAY(TODAY),'99') + STRING(MONTH(TODAY),'99') + STRING(YEAR(TODAY),'9999') +
            "_BAJA.txt".
...
IF TOGGLE-10 THEN OUTPUT STREAM strm10 TO VALUE(FILL-IN-10).
IF TOGGLE-11 THEN OUTPUT STREAM strm11 TO VALUE(FILL-IN-11).
...
DO k = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
    IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(k) THEN DO:
        ...
        IF TOGGLE-7 THEN DO:
            RUN Formato-7.
        END.
        IF TOGGLE-10 THEN DO:
            RUN Formato-10.
        END.
        IF TOGGLE-11 THEN DO:
            RUN Formato-11.
        END.
    END.
END.
...
IF TOGGLE-4 THEN OUTPUT STREAM strm4 CLOSE.
IF TOGGLE-7 THEN OUTPUT STREAM strm7 CLOSE.
IF TOGGLE-10 THEN OUTPUT STREAM strm10 CLOSE.
IF TOGGLE-11 THEN OUTPUT STREAM strm11 CLOSE.
