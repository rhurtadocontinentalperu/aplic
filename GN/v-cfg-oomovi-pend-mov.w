...
DEFINE FRAME F-Main
     TabGener.Libre_c01 AT ROW 1.27 COL 19 COLON-ALIGNED WIDGET-ID 14
          LABEL "Seleccione" FORMAT "x(8)"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Ingreso","I",
                     "Salida","S"
          DROP-DOWN-LIST
          SIZE 16 BY 1
     TabGener.Libre_c02 AT ROW 2.35 COL 19 COLON-ALIGNED HELP
          "Movimientos separados por comas (09,90,03)" WIDGET-ID 16
          LABEL "Movimiento" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 60 BY 1
     BUTTON-1 AT ROW 2.35 COL 81 WIDGET-ID 18
     TabGener.Libre_c03 AT ROW 3.69 COL 19 COLON-ALIGNED HELP
          "Almacenes separados por comas (11,03)" WIDGET-ID 4
          LABEL "Almacenes" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 60 BY 1
     TabGener.Libre_c04 AT ROW 5.04 COL 19 COLON-ALIGNED WIDGET-ID 20
...
/* SETTINGS FOR COMBO-BOX TabGener.Libre_c01 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN TabGener.Libre_c02 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT EXP-HELP                                        */
/* SETTINGS FOR FILL-IN TabGener.Libre_c03 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT EXP-HELP                                        */
...
DO:
    ...
    RUN gn\d-filtro-codmov (TabGener.Libre_c01:SCREEN-VALUE,
                            INPUT-OUTPUT x-CodMov,
                            "").
    TabGener.Libre_c02:SCREEN-VALUE = x-CodMov.
END.
