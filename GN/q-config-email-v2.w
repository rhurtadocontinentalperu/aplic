...
&Scoped-define QUERY-STRING-Query-Main FOR EACH emailconfig WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH emailconfig WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main emailconfig
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main emailconfig
