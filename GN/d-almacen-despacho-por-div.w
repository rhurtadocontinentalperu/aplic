...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 VtaAlmDiv.CodAlm ~
Almacen.Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH VtaAlmDiv ~
      WHERE VtaAlmDiv.CodCia = s-codcia ~
 AND VtaAlmDiv.CodDiv = pCodDiv NO-LOCK, ~
      FIRST Almacen OF VtaAlmDiv NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH VtaAlmDiv ~
      WHERE VtaAlmDiv.CodCia = s-codcia ~
 AND VtaAlmDiv.CodDiv = pCodDiv NO-LOCK, ~
      FIRST Almacen OF VtaAlmDiv NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 VtaAlmDiv Almacen
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 VtaAlmDiv
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "VtaAlmDiv.CodCia = s-codcia
...
DO:
  ...
  DO i = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
    IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(i) THEN DO:
        IF i = 1 
        THEN x-Almacenes = TRIM(VtaAlmDiv.CodAlm).
        ELSE x-Almacenes = x-Almacenes + ',' + TRIM(VtaAlmDiv.CodAlm).
    END.
  END.
