...
FacTabla.Nombre FacTabla.Valor[1] FacTabla.Valor[2] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacTabla.Nombre FORMAT "x(40)":U WIDTH 40.86
      FacTabla.Valor[1] COLUMN-LABEL "%" FORMAT ">>9.9999":U
      FacTabla.Valor[2] COLUMN-LABEL "MInAmount" FORMAT ">>>,>>9.99":U
  ENABLE
      FacTabla.Codigo
      FacTabla.Nombre
      FacTabla.Valor[1]
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 69 BY 14
...
"FacTabla.Nombre" ? ? "character" ? ? ? ? ? ? yes ? no no "40.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacTabla.Valor[1]
"FacTabla.Valor[1]" "%" ">>9.9999" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacTabla.Valor[2]
"FacTabla.Valor[2]" "MInAmount" ">>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
