...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "División" FORMAT "x(8)":U
      ...
      VtaTabla.LLave_c3 COLUMN-LABEL "Tipo de Documento" FORMAT "x(8)":U
            WIDTH 26.43 VIEW-AS COMBO-BOX INNER-LINES 10
                      LIST-ITEM-PAIRS "FACTURA","FAC",
                                      ...
                                      "NOTA DE DEBITO","N/D"
                      DROP-DOWN-LIST 
      VtaTabla.Llave_c4 COLUMN-LABEL "Formato de Impresión" FORMAT "x(8)":U
            WIDTH 22.43 VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEM-PAIRS "TICKETERA","TCK",
                                      "A4 MEMBRETADO","A4m",
                                      "A4 EN BLANCO","A4b"
                      DROP-DOWN-LIST 
      VtaTabla.Libre_c01 COLUMN-LABEL "Impresión Directa" FORMAT "x(8)":U
...
"VtaTabla.Llave_c1" "División" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaTabla.Llave_c4" "Formato de Impresión" ? "character" ? ? ? ? ? ? yes ? no no "22.43" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "TICKETERA,TCK,A4 MEMBRETADO,A4m,A4 EN BLANCO,A4b" 5 no 0 no no
     _FldNameList[6]   > INTEGRAL.VtaTabla.Libre_c01
"VtaTabla.Libre_c01" "Impresión Directa" ? "character" ? ? ? ? ? ? yes ? no no ".72" yes no no "U" "" "" "DROP-DOWN-LIST" "," "SI,NO" ? 5 no 0 no no
...
IF TRUE <> (VtaTabla.Llave_c4:SCREEN-VALUE IN BROWSE {&browse-name} > '') THEN DO:
    MESSAGE 'Debe seleccionar un Formato de Impresión' VIEW-AS ALERT-BOX ERROR.
    APPLY 'ENTRY':U TO VtaTabla.Llave_c4.
    RETURN 'ADM-ERROR'.
END.
IF LOOKUP(VtaTabla.Libre_c01:SCREEN-VALUE IN BROWSE {&browse-name}, "SI,NO") = 0 THEN DO:
    MESSAGE 'Debe seleccionar SI o NO el la Impresión Directa' VIEW-AS ALERT-BOX ERROR.
