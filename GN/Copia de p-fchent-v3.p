...
IF WEEKDAY(fFechaBase) = 1 THEN x-Minimo = x-Minimo + 1.
...
/* ************************************** */
MESSAGE 'uno' s-centrodistribucion.
...
REPEAT:
    ...
    MESSAGE 'tres' s-codcia s-llave-canaldia ccoddiv pdivori ffchprog WEEKDAY(fFchProg).
    /* ************************************************************** */
    ...
    END.
    MESSAGE 'cuatro' s-codcia s-llave-zona ccoddiv czonaghr cSubZonaGHR ffchprog WEEKDAY(fFchProg).
