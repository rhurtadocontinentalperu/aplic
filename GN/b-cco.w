...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-ccos.Estado COLUMN-LABEL "Activo" FORMAT "yes/no":U VIEW-AS TOGGLE-BOX
  ENABLE
      gn-ccos.Cco
      gn-ccos.DesCco
      gn-ccos.Estado
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 51 BY 15.35
         FONT 4.
...
"gn-ccos.Estado" "Activo" ? "logical" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "?" ? ? 5 no 0 no no
