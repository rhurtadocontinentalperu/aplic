...
&Scoped-Define ENABLED-FIELDS VtaTabla.Valor[1] 
&Scoped-define ENABLED-TABLES VtaTabla
&Scoped-define FIRST-ENABLED-TABLE VtaTabla
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS VtaTabla.Valor[1] 
...
DEFINE FRAME F-Main
     VtaTabla.Valor[1] AT ROW 1.54 COL 24 COLON-ALIGNED WIDGET-ID 2
          LABEL "Tope de Reimpresiones" FORMAT ">>9"
          VIEW-AS FILL-IN 
          SIZE 23.14 BY 1
