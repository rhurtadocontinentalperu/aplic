...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH Almacen ~
 ...
 AND Almacen.Campo-C[9] <> "I" NO-LOCK ~
    BY Almacen.CodAlm INDEXED-REPOSITION
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 D-Dialog _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      Almacen.Descripcion FORMAT "X(40)":U WIDTH 40.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS MULTIPLE SIZE 52 BY 18.08
         FONT 2 ROW-HEIGHT-CHARS .42 FIT-LAST-COLUMN.
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 2.08 COL 56
     Btn_Cancel AT ROW 3.15 COL 56
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _OrdList          = "INTEGRAL.Almacen.CodAlm|yes"
...
"Almacen.Descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "40.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
