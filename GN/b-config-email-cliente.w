...
&SCOPED-DEFINE FILTRO1 ( FILL-IN-filtro = '' OR gn-clie.nomcli BEGINS FILL-IN-filtro )
...
gn-clie.E-Mail 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table gn-clie.E-Mail 
...
&Scoped-define QUERY-STRING-br_table FOR EACH gn-clie WHERE ~{&KEY-PHRASE} ~
 ...
 AND gn-clie.Flgsit = "A" NO-LOCK INDEXED-REPOSITION
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-clie.E-Mail FORMAT "X(50)":U WIDTH 30.86
  ENABLE
      gn-clie.E-Mail
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 91 BY 14
...
DEFINE FRAME F-Main
     CMB-filtro AT ROW 1.27 COL 6.14 WIDGET-ID 6
     FILL-IN-filtro AT ROW 1.27 COL 36 NO-LABEL WIDGET-ID 8
...
"gn-clie.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.gn-clie.E-Mail
"gn-clie.E-Mail" ? "X(50)" "character" ? ? ? ? ? ? yes ? no no "30.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      CMB-filtro:SENSITIVE = YES.
      FILL-IN-filtro:SENSITIVE = YES.
  END.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DO WITH FRAME {&FRAME-NAME}:
      CMB-filtro:SENSITIVE = NO.
      FILL-IN-filtro:SENSITIVE = NO.
  END.
...
------------------------------------------------------------------------------*/
    ...
    IF gn-clie.E-Mail:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} > '' THEN DO:
        x-Correo = gn-clie.E-Mail:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}.
