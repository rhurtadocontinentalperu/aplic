...
&Scoped-define QUERY-STRING-BROWSE-3 FOR EACH GN-DIVI ~
 ...
 AND GN-DIVI.CanalVenta = "MIN" NO-LOCK INDEXED-REPOSITION
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 D-Dialog _STRUCTURED
  QUERY BROWSE-3 NO-LOCK DISPLAY
      ...
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 52.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME D-Dialog
     BROWSE-3 AT ROW 1.19 COL 2 WIDGET-ID 200
     Btn_OK AT ROW 1.19 COL 66
     Btn_Cancel AT ROW 2.73 COL 66
     SPACE(0.56) SKIP(8.03)
...
"GN-DIVI.DesDiv" ? ? "character" ? ? ? ? ? ? no ? no no "52.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
