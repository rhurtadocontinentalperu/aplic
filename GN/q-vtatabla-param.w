...
DEF VAR x-Tabla LIKE Vtatabla.Tabla NO-UNDO.
DEF VAR x-Llave_c1 LIKE Vtatabla.Llave_c1 NO-UNDO.
DEF VAR x-Llave_c2 LIKE Vtatabla.Llave_c2 NO-UNDO.
DEF VAR x-Llave_c3 LIKE Vtatabla.Llave_c3 NO-UNDO.
DEF VAR x-Llave_c4 LIKE Vtatabla.Llave_c4 NO-UNDO.
...
Vtatabla.llave_c3 = x-Llave_c3 AND ~
Vtatabla.llave_c4 = x-Llave_c4 )
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaTabla
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaTabla
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Registro q-tables 
PROCEDURE Carga-Registro :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF NOT CAN-FIND(FIRST Vtatabla WHERE {&Condicion} NO-LOCK)
    THEN DO:
    CREATE Vtatabla.
    ASSIGN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Input-Parameters q-tables 
...
DEF INPUT PARAMETER pTabla LIKE Vtatabla.tabla.
DEF INPUT PARAMETER pLlave_c1 LIKE Vtatabla.llave_c1.
DEF INPUT PARAMETER pLlave_c2 LIKE Vtatabla.llave_c2.
DEF INPUT PARAMETER pLlave_c3 LIKE Vtatabla.llave_c3.
DEF INPUT PARAMETER pLlave_c4 LIKE Vtatabla.llave_c4.

ASSIGN
    x-Tabla    = pTabla
    x-Llave_c1 = pLlave_c1
    x-Llave_c2 = pLlave_c2
    x-Llave_c3 = pLlave_c3
    x-Llave_c4 = pLlave_c4.
