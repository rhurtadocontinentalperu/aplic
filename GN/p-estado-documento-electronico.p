...
*/
pEstadoBizLinks = "NO ENVIADO A SUNAT".
...
IF AVAILABLE x-felogcomprobantes THEN DO:
    pEstadoBizLinks = "FIRMADO|".
    pEstadoSUNAT = x-felogcomprobantes.libre_C12.
    pEstadoDocumento = x-felogcomprobantes.libre_C13.
    IF LOOKUP(x-felogcomprobantes.libre_C12,'RC_05,ERROR') > 0 THEN pEstadoBizLinks = pEstadoBizLinks + x-felogcomprobantes.libre_C14.
    IF TRUE <> (x-felogcomprobantes.libre_C12 > '') THEN pEstadoBizLinks = pEstadoBizLinks + "Estado del documento aun no actualizado".
END.
