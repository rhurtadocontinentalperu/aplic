...
AND TabGener.Clave = s-clave AND TabGener.Codigo = s-codigo
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH TabGener WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH TabGener WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main TabGener
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main TabGener
...
FIND FIRST TabGener WHERE {&Condicion} NO-LOCK NO-ERROR.
IF AVAILABLE TabGener THEN RETURN.
CREATE TabGener.
ASSIGN
