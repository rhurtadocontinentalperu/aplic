...
&Scoped-define QUERY-STRING-Query-Main FOR EACH almtblas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH almtblas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Reposiciona-Registro q-tables 
PROCEDURE Reposiciona-Registro :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FIND {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}} WHERE {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}}.Tabla = pTabla NO-LOCK NO-ERROR.
IF NOT AVAILABLE {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}} THEN DO:
    CREATE {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}}.
    ASSIGN
        {&FIRST-TABLE-IN-QUERY-{&QUERY-NAME}}.Tabla = pTabla
        NO-ERROR.
