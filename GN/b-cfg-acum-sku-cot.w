...
DEF VAR s-Tabla AS CHAR INIT 'CFG_ACUM_SKU_COT' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "Division" FORMAT "x(8)":U
      GN-DIVI.DesDiv FORMAT "X(40)":U
      FacTabla.Campo-D[1] COLUMN-LABEL "Inicio" FORMAT "99/99/9999":U
      FacTabla.Campo-D[2] COLUMN-LABEL "Fin" FORMAT "99/99/9999":U
  ENABLE
      FacTabla.Codigo
      FacTabla.Campo-D[1]
      FacTabla.Campo-D[2]
...
"FacTabla.Codigo" "Division" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.GN-DIVI.DesDiv
     _FldNameList[3]   > INTEGRAL.FacTabla.Campo-D[1]
"FacTabla.Campo-D[1]" "Inicio" "99/99/9999" "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacTabla.Campo-D[2]
"FacTabla.Campo-D[2]" "Fin" "99/99/9999" "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
