...
DEFINE FRAME C-Dialog
     ...
     "            F8 - Consulta de Stocks por Almacen" VIEW-AS TEXT
          SIZE 63.29 BY .5 AT ROW 12.69 COL 1.29
          FONT 6
     "            F9 - Consulta Descuentos X Volumen" VIEW-AS TEXT
          SIZE 63.29 BY .54 AT ROW 13.19 COL 1.14
          FONT 6
     "            F7 - Stocks Comprometidos por Pedidos" VIEW-AS TEXT
          SIZE 62.86 BY .5 AT ROW 12.19 COL 1.29
          FONT 6
     "            F10 - Consulta Descuentos X Promocion" VIEW-AS TEXT
          SIZE 63.29 BY .54 AT ROW 13.73 COL 1.14
          FONT 6
     RECT-33 AT ROW 12.04 COL 1
     RECT-28 AT ROW 1 COL 53.57
     SPACE(0.14) SKIP(3.58)
