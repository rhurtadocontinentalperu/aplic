...
DEF VAR s-Tabla AS CHAR INIT 'CFG_FMT_GR' NO-UNDO.
...
FacTabla.Campo-C[1] FacTabla.Campo-C[2] 
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacTabla WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacTabla.Tabla = s-tabla NO-LOCK, ~
  ...
  AND GN-DIVI.CodDiv = FacTabla.Codigo OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "División!Emisor" FORMAT "x(8)":U
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 40.86
      FacTabla.Campo-C[1] COLUMN-LABEL "Formato GR!VENTAS" FORMAT "x(20)":U
            WIDTH 14.72 VIEW-AS COMBO-BOX INNER-LINES 5
                      LIST-ITEM-PAIRS "Sin Formato","",
                                      "Formato 13 líneas","13",
                                      "Formato 36 línea","36"
                      DROP-DOWN-LIST 
      FacTabla.Campo-C[2] COLUMN-LABEL "Formato GR!TRANSFERENCIAS" FORMAT "x(20)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 85 BY 15.08
...
"FacTabla.Codigo" "División!Emisor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacTabla.Campo-C[1]" "Formato GR!VENTAS" "x(20)" "character" ? ? ? ? ? ? yes ? no no "14.72" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Sin Formato,,Formato 13 líneas,13,Formato 36 línea,36" 5 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacTabla.Campo-C[2]
"FacTabla.Campo-C[2]" "Formato GR!TRANSFERENCIAS" "x(20)" "character" ? ? ? ? ? ? yes ? no no "14.43" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Sin Formato,,Formato 13 líneas,13,Formato 36 línea,36" 5 no 0 no no
...
FOR EACH gn-divi NO-LOCK WHERE gn-divi.codcia = s-codcia:
    ...
    IF NOT AVAILABLE FacTabla THEN DO:
        ...
        ASSIGN
            ...
            FacTabla.Codigo = gn-divi.coddiv
            FacTabla.Campo-C[1] = '13'
            FacTabla.Campo-C[2] = '13'
            NO-ERROR.
