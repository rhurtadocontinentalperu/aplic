...
DEF VAR pCodCia LIKE ccbcdocu.codcia.
DEF VAR pCodDiv LIKE ccbcdocu.coddiv.
DEF VAR pCodDoc LIKE ccbcdocu.coddoc.
DEF VAR pNroDoc LIKE ccbcdocu.nrodoc.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH CcbCMvto WHERE ~{&KEY-PHRASE} ~
      AND CcbCMvto.CodCia = pCodCia ~
 AND CcbCMvto.CodDiv = pCodDiv ~
 AND CcbCMvto.CodDoc = pCodDoc ~
 AND CcbCMvto.NroDoc = pNroDoc NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "CcbCMvto.CodCia = pCodCia
 AND CcbCMvto.CodDiv = pCodDiv
 AND CcbCMvto.CodDoc = pCodDoc
 AND CcbCMvto.NroDoc = pNroDoc"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Parametros q-tables 
...
DEF INPUT PARAMETER xCodCia LIKE ccbcdocu.codcia.
DEF INPUT PARAMETER xCodDiv LIKE ccbcdocu.coddiv.
DEF INPUT PARAMETER xCodDoc LIKE ccbcdocu.coddoc.
DEF INPUT PARAMETER xNroDoc LIKE ccbcdocu.nrodoc.
