...
&Scoped-define QUERY-STRING-Query-Main FOR EACH FacDocum WHERE ~{&KEY-PHRASE} ~
      AND FacDocum.CodCia = s-codcia ~
 AND FacDocum.CodDoc = s-coddoc NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH FacDocum WHERE ~{&KEY-PHRASE} ~
      AND FacDocum.CodCia = s-codcia ~
 AND FacDocum.CodDoc = s-coddoc NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main FacDocum
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main FacDocum
