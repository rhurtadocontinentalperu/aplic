...
&Scoped-Define ENABLED-FIELDS TabGener.Libre_f01 
&Scoped-define ENABLED-TABLES TabGener
&Scoped-define FIRST-ENABLED-TABLE TabGener
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS TabGener.Libre_f01 
...
DEFINE FRAME F-Main
     TabGener.Libre_f01 AT ROW 3.15 COL 24 COLON-ALIGNED WIDGET-ID 4
          LABEL "FECHA DE CIERRE"
          VIEW-AS FILL-IN 
          SIZE 12.86 BY 1
     BUTTON-1 AT ROW 2.88 COL 41 WIDGET-ID 8
...
DO:
  RUN bin/_calenda.
  IF RETURN-VALUE <> ? THEN TabGener.Libre_f01:SCREEN-VALUE = RETURN-VALUE.
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      TabGener.Libre_c05 = s-user-id + '|' + STRING(NOW).
