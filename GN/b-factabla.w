...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo FORMAT "x(20)":U WIDTH 18.43
      FacTabla.Nombre FORMAT "x(40)":U WIDTH 41.72
      FacTabla.Campo-C[1] COLUMN-LABEL "Tipo" FORMAT "x(15)":U
            WIDTH 23.43 VIEW-AS COMBO-BOX INNER-LINES 5
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 90 BY 14.54
...
"FacTabla.Codigo" ? "x(20)" "character" ? ? ? ? ? ? yes ? no no "18.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacTabla.Nombre
"FacTabla.Nombre" ? ? "character" ? ? ? ? ? ? yes ? no no "41.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacTabla.Campo-C[1]
"FacTabla.Campo-C[1]" "Tipo" "x(15)" "character" ? ? ? ? ? ? yes ? no no "23.43" yes no no "U" "" "" "DROP-DOWN-LIST" "," "ACUMULATIVO,UNICO" ? 5 no 0 no no
