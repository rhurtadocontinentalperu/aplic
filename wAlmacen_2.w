...
DEFINE VARIABLE h_balmacen_2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dalmacen_2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'aplic/dalmacen_2.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedalmacen_2OpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dalmacen_2 ).
       RUN repositionObject IN h_dalmacen_2 ( 1.27 , 69.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */

       RUN constructObject (
             INPUT  'aplic/balmacen_2.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_balmacen_2 ).
       RUN repositionObject IN h_balmacen_2 ( 3.15 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_balmacen_2 ( 6.65 , 66.00 ) NO-ERROR.
       ...
       /* Links to SmartDataBrowser h_balmacen_2. */
       RUN addLink ( h_dalmacen_2 , 'Data':U , h_balmacen_2 ).
       RUN addLink ( h_balmacen_2 , 'Update':U , h_dalmacen_2 ).
       RUN addLink ( h_pupdsav , 'TableIO':U , h_balmacen_2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_balmacen_2 ,
             h_pupdsav , 'AFTER':U ).
    END. /* Page 0 */
