...
AlmCDocu.FchDoc AlmCDocu.UsrCreacion fSolicitante() @ x-Solicitante ~
AlmCDocu.Libre_c05 cb-auxi.Nomaux AlmCDocu.Libre_c01 ~
fAprobadopor() @ x-Aprobadopor 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH AlmCDocu WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK, ~
      FIRST cb-auxi WHERE cb-auxi.Codaux = AlmCDocu.Libre_c05 ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      SUBSTRING(AlmCDocu.NroDoc,LENGTH(AlmCDocu.CodLlave) + 1) @ AlmCDocu.NroDoc COLUMN-LABEL "Número" FORMAT "x(20)":U
      ...
      fSolicitante() @ x-Solicitante COLUMN-LABEL "Nombre" FORMAT "x(30)":U
            WIDTH 21.57
      AlmCDocu.Libre_c05 COLUMN-LABEL "Cco" FORMAT "x(8)":U
...
/* SETTINGS FOR FILL-IN FILL-IN-codigo IN FRAME F-Main
   NO-ENABLE                                                            */
...
"SUBSTRING(AlmCDocu.NroDoc,LENGTH(AlmCDocu.CodLlave) + 1) @ AlmCDocu.NroDoc" "Número" "x(20)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmCDocu.Libre_c05" "Cco" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
