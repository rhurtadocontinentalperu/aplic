...
&SCOPED-DEFINE l-lookup h_l-pack-ec
...
DEFINE VARIABLE h_l-pack-ec AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-pack-ec.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-pack-ec ).
       RUN set-position IN h_l-pack-ec ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-pack-ec ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pack-ec. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pack-ec ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pack-ec ,
