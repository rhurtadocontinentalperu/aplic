...
&SCOPED-DEFINE CONDICION ( vtatabla.CodCia = s-CODCIA AND vtatabla.Tabla = 'BREVETE' AND ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 72.14 BY 13.19
...
"VtaTabla.Llave_c1" "Licencia" ? "character" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Libre_c01
"VtaTabla.Libre_c01" "Ap.Paterno" "x(30)" "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Libre_c02
"VtaTabla.Libre_c02" "Ap. Materno" "x(30)" "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Libre_c03
"VtaTabla.Libre_c03" "Nombres" "x(25)" "character" ? ? ? ? ? ? no ? no no "15.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaTabla.Llave_c2
"VtaTabla.Llave_c2" "D.N.I." "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
