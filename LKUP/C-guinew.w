...
&SCOPED-DEFINE l-lookup h_l-guias
...
DEFINE VARIABLE h_l-guias AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-guinew.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-guias ).
       RUN set-position IN h_l-guias ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 86.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-guias ,
