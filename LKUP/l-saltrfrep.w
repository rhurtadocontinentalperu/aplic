...
Almcmov.TipMov = ENTRY(1, input-var-2) AND ~
Almcmov.CodMov = INTEGER(ENTRY(2, input-var-2)) AND ~
Almcmov.NroSer = INTEGER(input-var-3) AND ~
Almcmov.CodRef = "OTR" )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almcmov.NroDoc COLUMN-LABEL "Documento" FORMAT "999999":U
...
"Almcmov.NroDoc" "Documento" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Almcmov.NomRef" "Descripcion" "x(43)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
