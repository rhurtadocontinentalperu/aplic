...
&SCOPED-DEFINE l-lookup h_l-pedcre
...
DEFINE VARIABLE h_l-pedcre AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-pedcre.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pedcre ).
       RUN set-position IN h_l-pedcre ( 1.19 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 75.00 ) */
       ...
       /* Links to SmartLookup h_l-pedcre. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pedcre ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pedcre ,
