...
&SCOPED-DEFINE CONDICION ( lg-cincid-chk.CodCia = s-codcia AND lg-cincid-chk.CodDiv = input-var-1 )
&SCOPED-DEFINE CODIGO lg-cincid-chk.NroDoc

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( lg-cincid-chk.CodAlm BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( lg-cincid-chk.CodAlm , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES lg-cincid-chk

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table lg-cincid-chk.Fecha ~
lg-cincid-chk.Hora lg-cincid-chk.NroDoc lg-cincid-chk.CodAlm ~
lg-cincid-chk.Usuario lg-cincid-chk.Cerrado 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH lg-cincid-chk WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lg-cincid-chk WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lg-cincid-chk
&Scoped-define FIRST-TABLE-IN-QUERY-br_table lg-cincid-chk
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.lg-cincid-chk.CodAlm
Nombres que contengan|y||INTEGRAL.lg-cincid-chk.CodAlm
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.lg-cincid-chk.NroDoc|no
Descripción|||INTEGRAL.lg-cincid-chk.CodAlm|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
DEFINE VARIABLE FILL-IN-codigo AS INT64 FORMAT ">>>>>9":U INITIAL 0 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lg-cincid-chk.Fecha FORMAT "99/99/9999":U
      lg-cincid-chk.Hora FORMAT "x(8)":U
      lg-cincid-chk.NroDoc FORMAT ">>>>>>>>9":U
      lg-cincid-chk.CodAlm FORMAT "x(8)":U
      lg-cincid-chk.Usuario FORMAT "x(15)":U
      lg-cincid-chk.Cerrado FORMAT "yes/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.lg-cincid-chk"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = INTEGRAL.lg-cincid-chk.Fecha
     _FldNameList[2]   = INTEGRAL.lg-cincid-chk.Hora
     _FldNameList[3]   = INTEGRAL.lg-cincid-chk.NroDoc
     _FldNameList[4]   = INTEGRAL.lg-cincid-chk.CodAlm
     _FldNameList[5]   = INTEGRAL.lg-cincid-chk.Usuario
     _FldNameList[6]   = INTEGRAL.lg-cincid-chk.Cerrado
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY lg-cincid-chk.NroDoc DESCENDING
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY lg-cincid-chk.CodAlm
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
