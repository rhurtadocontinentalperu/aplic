...
&SCOPED-DEFINE l-lookup h_l-almcen
...
DEFINE VARIABLE h_l-almcen AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-almvta.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-almcen ).
       RUN set-position IN h_l-almcen ( 1.04 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 47.72 ) */
       ...
       /* Links to SmartLookup h_l-almcen. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-almcen ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-almcen ,
