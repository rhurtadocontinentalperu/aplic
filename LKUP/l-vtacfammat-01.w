...
&SCOPED-DEFINE CONDICION ( Vtacfammat.CodCia = S-CODCIA )
&SCOPED-DEFINE CODIGO Vtacfammat.grupo 

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Vtacfammat.Descripcion BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VTacfammat.Descripcion , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES VtaCFamMat

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaCFamMat.grupo ~
VtaCFamMat.Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaCFamMat WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaCFamMat WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaCFamMat
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaCFamMat
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaCFamMat.Descripcion
Nombres que contengan|y||INTEGRAL.VtaCFamMat.Descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Codigo|y||INTEGRAL.VtaCFamMat.grupo|yes
Descripcion|||INTEGRAL.VtaCFamMat.Descripcion|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCFamMat.grupo COLUMN-LABEL "Grupo" FORMAT "x(6)":U WIDTH 8.57
      VtaCFamMat.Descripcion FORMAT "X(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaCFamMat"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > INTEGRAL.VtaCFamMat.grupo
"VtaCFamMat.grupo" "Grupo" ? "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.VtaCFamMat.Descripcion
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCFamMat.grupo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripcion':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCFamMat.Descripcion
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
DO I = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
   IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(I) THEN DO:    
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.grupo.
