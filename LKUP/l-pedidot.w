...
FIND FacCorre WHERE FacCorre.CodCia = S-CODCIA AND
     FacCorre.CodDoc = input-var-1 AND
     FacCorre.CodDiv = S-CODDIV NO-LOCK NO-ERROR.
IF AVAILABLE FacCorre THEN  ASSIGN C-NroSer = STRING(FacCorre.NroSer,"999").
/*
message S-CODCIA input-var-1 input-var-2 C-NROSER input-var-3 S-CODDIV.
*/
/* Preprocesadores para condiciones */
&SCOPED-DEFINE CONDICION ( FacCPedi.CodCia = S-CODCIA AND ~
                           LOOKUP(FacCPedi.CodDoc, input-var-1) > 0  AND ~
                           FacCPedi.CodCli BEGINS input-var-2 AND ~
                           FacCPedi.FlgEst = 'P' AND ~
                           FacCPedi.CodDiv = S-CODDIV  AND ~
                           FacCPedi.TpoPed BEGINS input-var-3)
...
&SCOPED-DEFINE FILTRO1 ( FacCPedi.CodCli BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( FacCPedi.CodCli , FILL-IN-filtro ) <> 0 )
...
FacCPedi.NomCli FacCPedi.FchPed FacCPedi.ImpTot C-MON @ C-MON 
...
<FOREIGN-KEYS>
Codigo de Cliente|y|y|integral.FacCPedi.CodCli
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "Codigo de Cliente",
     Keys-Supplied = "Codigo de Cliente"':U).
...
<SORTBY-OPTIONS>
Código|y||integral.FacCPedi.CodCia|yes,integral.FacCPedi.CodDoc|yes,integral.FacCPedi.NroPed|no
Cliente|||integral.FacCPedi.CodCia|yes,integral.FacCPedi.CodCli|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacCPedi.CodDoc COLUMN-LABEL "Cod." FORMAT "x(3)":U
      FacCPedi.NroPed COLUMN-LABEL "Documento No." FORMAT "XXX-XXXXXX":U
            COLUMN-FONT 0
      FacCPedi.NomCli FORMAT "x(35)":U
      FacCPedi.FchPed COLUMN-LABEL "Fecha Emision" FORMAT "99/99/9999":U
...
"FacCPedi.CodDoc" "Cod." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.FacCPedi.NroPed
"FacCPedi.NroPed" "Documento No." "XXX-XXXXXX" "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacCPedi.FchPed" "Fecha Emision" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Codigo de Cliente':U THEN DO:
       &Scope KEY-PHRASE ( {&Filtro1} )
       RUN get-attribute ('SortBy-Case':U).
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY FacCPedi.CodCia BY FacCPedi.CodDoc BY FacCPedi.NroPed DESCENDING
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Cliente':U THEN DO:
           &Scope SORTBY-PHRASE BY FacCPedi.CodCia BY FacCPedi.CodCli
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Coddoc + {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.NroPed
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "Codigo de Cliente" "FacCPedi" "CodCli"}
