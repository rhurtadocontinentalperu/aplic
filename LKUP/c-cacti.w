...
&SCOPED-DEFINE l-lookup h_l-cacti
...
DEFINE VARIABLE h_l-cacti AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.38 COL 67.43
     Btn_Cancel AT ROW 8.58 COL 67.43
     Btn_Help AT ROW 10.38 COL 67.43
     SPACE(2.56) SKIP(0.91)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-cacti.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cacti ).
       RUN set-position IN h_l-cacti ( 1.00 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cacti. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cacti ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cacti ,
