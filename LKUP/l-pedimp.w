...
&SCOPED-DEFINE CONDICION ImCOCmp.codcia = s-codcia
&SCOPED-DEFINE CODIGO ImCOCmp.NroImp

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( ImCOCmp.NomPro BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( ImCOCmp.NomPro , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table ImCOCmp.NroImp ImCOCmp.NroPed ~
ImCOCmp.Fchdoc ImCOCmp.CodPro ImCOCmp.NomPro 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH ImCOCmp WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table ImCOCmp
&Scoped-define FIRST-TABLE-IN-QUERY-br_table ImCOCmp


/* Definitions for FRAME F-Main                                         */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-27 br_table FILL-IN-codigo CMB-filtro ~
FILL-IN-filtro 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.ImCOCmp.NomPro
Nombres que contengan|y||INTEGRAL.ImCOCmp.NomPro
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.ImCOCmp.CodCia|yes,INTEGRAL.ImCOCmp.NroImp|yes
Descripción|||INTEGRAL.ImCOCmp.CodCia|yes,INTEGRAL.ImCOCmp.NomPro|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ImCOCmp.NroImp COLUMN-LABEL "Nro Imp"
      ImCOCmp.NroPed COLUMN-LABEL "<         Nro. Pedido         >"
      ImCOCmp.Fchdoc COLUMN-LABEL "<    Fecha    > !<   Emision   >"
      ImCOCmp.CodPro COLUMN-LABEL "< C¢digo >"
      ImCOCmp.NomPro
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 84 BY 12.88
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > INTEGRAL.ImCOCmp.NroImp
"ImCOCmp.NroImp" "Nro Imp" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.ImCOCmp.NroPed
"ImCOCmp.NroPed" "<         Nro. Pedido         >" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.ImCOCmp.Fchdoc
"ImCOCmp.Fchdoc" "<    Fecha    > !<   Emision   >" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[4]   > INTEGRAL.ImCOCmp.CodPro
"ImCOCmp.CodPro" "< C¢digo >" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   = INTEGRAL.ImCOCmp.NomPro
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY ImCOCmp.CodCia BY ImCOCmp.NroImp
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY ImCOCmp.CodCia BY ImCOCmp.NomPro
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = STRING( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nroimp, "999999" )
