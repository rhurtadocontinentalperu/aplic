...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.19 COL 115.43
     Btn_Cancel AT ROW 8.38 COL 115.43
     SPACE(2.28) SKIP(8.57)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_l-pl-pers-v2 ( 16.42 , 110.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.00 , 113.00 ) NO-ERROR.
