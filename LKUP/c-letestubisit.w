...
&SCOPED-DEFINE l-lookup h_l-letestubisit
...
DEFINE VARIABLE h_l-letestubisit AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 11.96 COL 62
     Btn_Cancel AT ROW 11.96 COL 77.14
     SPACE(3.99) SKIP(0.34)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-letestubisit.r':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-letestubisit ).
       RUN set-position IN h_l-letestubisit ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-letestubisit ( 10.81 , 92.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 12.04 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.65 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-letestubisit. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-letestubisit ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-letestubisit ,
