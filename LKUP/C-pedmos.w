...
&SCOPED-DEFINE l-lookup h_l-pedmos
...
DEFINE VARIABLE h_l-pedmos AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-pedmos.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-pedmos ).
       RUN set-position IN h_l-pedmos ( 1.00 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pedmos. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pedmos ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pedmos ,
