...
&SCOPED-DEFINE CONDICION ( VtaCActi.codcia = s-codcia )
&SCOPED-DEFINE CODIGO VtaCActi.CodActi

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaCActi.DesActi BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VTaCActi.DesActi , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES VtaCActi

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaCActi.CodActi VtaCActi.DesActi 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaCActi WHERE ~{&KEY-PHRASE} ~
      AND VtaCActi.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaCActi
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaCActi
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaCActi.DesActi
Nombres que contengan|y||INTEGRAL.VtaCActi.DesActi
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaCActi.CodActi|yes
Descripción|||INTEGRAL.VtaCActi.DesActi|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCActi.CodActi
      VtaCActi.DesActi COLUMN-LABEL "Descripcion"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 61.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaCActi"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.VtaCActi.CodCia = s-codcia"
     _FldNameList[1]   = INTEGRAL.VtaCActi.CodActi
     _FldNameList[2]   > INTEGRAL.VtaCActi.DesActi
"DesActi" "Descripcion" ? "character" ? ? ? ? ? ? no ?
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCActi.CodActi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCActi.DesActi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codacti
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.desacti.
