...
&SCOPED-DEFINE CONDICION ( GN-VEN.codcia = S-CODCIA )
&SCOPED-DEFINE CODIGO GN-VEN.codven

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( GN-VEN.nomven BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( GN-VEN.nomven , FILL-IN-filtro ) <> 0 )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-ven.NomVen FORMAT "X(45)":U
      gn-ven.PtoVta COLUMN-LABEL "Punto!Venta" FORMAT "X(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"gn-ven.NomVen" ? "X(45)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.gn-ven.PtoVta
"gn-ven.PtoVta" "Punto!Venta" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codven.
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nomven.
