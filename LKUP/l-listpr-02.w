...
&Scoped-define QUERY-STRING-br_table FOR EACH Almmmatg WHERE ~{&KEY-PHRASE} ~
      ...
      WHERE Almmmate.CodAlm = s-codalm ~
...
&Scoped-Define ENABLED-OBJECTS FILL-IN-codigo F-marca RADIO-SET-Stock ~
F-Codfam F-SubFam CMB-filtro FILL-IN-filtro br_table 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-codigo F-marca RADIO-SET-Stock ~
F-Codfam F-SubFam CMB-filtro FILL-IN-filtro 
...
DEFINE FRAME F-Main
     ...
     RADIO-SET-Stock AT ROW 1 COL 52 NO-LABEL WIDGET-ID 4
...
DO:
    IF CMB-filtro = CMB-filtro:SCREEN-VALUE AND
        ...
        RADIO-SET-Stock = RADIO-SET-Stock:SCREEN-VALUE
        THEN RETURN.
    ASSIGN
        FILL-IN-filtro
        CMB-filtro
