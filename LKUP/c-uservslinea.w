...
&SCOPED-DEFINE l-lookup h_l-uservslinea
...
DEFINE VARIABLE h_l-uservslinea AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-uservslinea.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-uservslinea ).
       RUN set-position IN h_l-uservslinea ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-uservslinea ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-uservslinea. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-uservslinea ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-uservslinea ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-uservslinea , 'AFTER':U ).
    END. /* Page 0 */
