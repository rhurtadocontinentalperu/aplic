...
&SCOPED-DEFINE l-lookup h_l-pf-g004
...
DEFINE VARIABLE h_l-pf-g004 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-pf-g004.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pf-g004 ).
       RUN set-position IN h_l-pf-g004 ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-pf-g004 ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pf-g004. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pf-g004 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pf-g004 ,
