...
&SCOPED-DEFINE l-lookup h_l-tabla
...
DEFINE VARIABLE h_l-tabla AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "O/C Supermercados Peruanos"
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* O/C Supermercados Peruanos */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-ordencompra-vea.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-tabla ).
       RUN set-position IN h_l-tabla ( 1.19 , 2.14 ) NO-ERROR.
       RUN set-size IN h_l-tabla ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-tabla. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-tabla ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-tabla ,
