...
&SCOPED-DEFINE CONDICION ( AlmtZona.CodCia = s-CodCia AND AlmtZona.CodAlm = input-var-1)
&SCOPED-DEFINE CODIGO AlmtZona.CodZona

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( AlmtZona.DesZona BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( AlmtZona.DesZona , FILL-IN-filtro ) <> 0 )
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.AlmtZona.DesZona
Nombres que contengan|y||INTEGRAL.AlmtZona.DesZona
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.AlmtZona.CodZona|yes
Descripción|||INTEGRAL.AlmtZona.DesZona|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmtZona.CodZona
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmtZona.DesZona
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codzona
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.deszona.
