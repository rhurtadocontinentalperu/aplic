...
&SCOPED-DEFINE l-lookup h_l-listpr4
...
DEFINE VARIABLE h_l-listpr4 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 14.42 COL 56.29
     Btn_Cancel AT ROW 14.42 COL 67
     Btn_Help AT ROW 14.42 COL 77.43
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-listpr4.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Familia':U ,
             OUTPUT h_l-listpr4 ).
       RUN set-position IN h_l-listpr4 ( 1.08 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-listpr4 ( 12.65 , 88.86 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-listpr4. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listpr4 ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listpr4 , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listpr4 ,
