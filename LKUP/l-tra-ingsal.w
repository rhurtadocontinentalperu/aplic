...
&SCOPED-DEFINE CONDICION ( TraIngSal.CodCia = s-CodCia AND ~
TraIngSal.CodDiv = input-var-1 AND ~
TraIngSal.FlgEst = input-var-2 AND ~
TraIngSal.FlgSit = input-var-3 ) 

&SCOPED-DEFINE CODIGO TraIngSal.Placa
...
&Scoped-define INTERNAL-TABLES TraIngSal gn-prov

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table TraIngSal.Placa gn-prov.NomPro 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH TraIngSal WHERE ~{&KEY-PHRASE} ~
      ...
      AND gn-prov.CodCia = pv-codcia OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table TraIngSal gn-prov
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.TraIngSal,INTEGRAL.gn-prov WHERE INTEGRAL.TraIngSal ..."
