...
&SCOPED-DEFINE CONDICION SunatTablaD.codcia = s-codcia ~
AND SunatTablaD.tabla = "CBD" ~
    AND SunatTablaD.llave1 = 'ESTCOM' ~
    AND SunatTablaD.llave2 BEGINS input-var-1

&SCOPED-DEFINE CODIGO SunatTablaD.llave2

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( SunatTablaD.Descripcion BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( SunatTablaD.Descripcion , FILL-IN-filtro ) <> 0 )
...
&Scoped-define QUERY-STRING-br_table FOR EACH SunatTablaD WHERE ~{&KEY-PHRASE} ~
      AND SunatTablaD.codcia = s-codcia and ~
SunatTablaD.tabla = 'CBD' and  ~
SunatTablaD.llave1 = 'ESTCOM' NO-LOCK ~
    BY SunatTablaD.Llave2
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH SunatTablaD WHERE ~{&KEY-PHRASE} ~
      AND SunatTablaD.codcia = s-codcia and ~
SunatTablaD.tabla = 'CBD' and  ~
SunatTablaD.llave1 = 'ESTCOM' NO-LOCK ~
    BY SunatTablaD.Llave2.
...
<SORTBY-OPTIONS>
Llave2|y||INTEGRAL.SunatTablaD.Llave2|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'Llave2' + '",
     SortBy-Case = ':U + 'Llave2').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      SunatTablaD.Llave2 COLUMN-LABEL "Codigo" FORMAT "x(8)":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.SunatTablaD"
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "INTEGRAL.SunatTablaD.Llave2|yes"
     _Where[1]         = "SunatTablaD.codcia = s-codcia and
SunatTablaD.tabla = 'CBD' and 
SunatTablaD.llave1 = 'ESTCOM'"
     _FldNameList[1]   > INTEGRAL.SunatTablaD.Llave2
"SunatTablaD.Llave2" "Codigo" "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Llave2':U THEN DO:
      &Scope SORTBY-PHRASE BY SunatTablaD.Llave2
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave2
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.descripcion.
