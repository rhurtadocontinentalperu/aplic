...
CcbCDocu.CodCta CcbCDocu.ImpTot CcbCDocu.FchDoc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbCDocu.NroDoc COLUMN-LABEL "<<Numero>>" FORMAT "X(12)"
      CcbCDocu.NomCli COLUMN-LABEL "Cliente" FORMAT "x(40)"
      CcbCDocu.CodCta COLUMN-LABEL "<Cuenta>"
      CcbCDocu.ImpTot
      CcbCDocu.FchDoc COLUMN-LABEL "Fecha Emis" FORMAT "99/99/99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 70.14 BY 8.62
