...
&SCOPED-DEFINE CONDICION ( TODAY >= VtaCTickets.FchIni ~
AND TODAY <= VtaCTickets.FchFin ~
AND VtaCTickets.CodCia = s-codcia )

&SCOPED-DEFINE CODIGO Vtactickets.codpro
...
&Scoped-define INTERNAL-TABLES VtaCTickets gn-prov

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaCTickets.CodPro gn-prov.NomPro ~
VtaCTickets.Producto VtaCTickets.FchIni VtaCTickets.FchFin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaCTickets WHERE ~{&KEY-PHRASE} ~
      AND {&condicion} NO-LOCK, ~
      EACH gn-prov WHERE gn-prov.CodPro = VtaCTickets.CodPro ~
      AND gn-prov.CodCia = pv-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaCTickets WHERE ~{&KEY-PHRASE} ~
      AND {&condicion} NO-LOCK, ~
      EACH gn-prov WHERE gn-prov.CodPro = VtaCTickets.CodPro ~
      AND gn-prov.CodCia = pv-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaCTickets gn-prov
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaCTickets
...
<SORTBY-OPTIONS>
Codigo|y||INTEGRAL.VtaCTickets.CodPro|yes
Descripcion|||INTEGRAL.gn-prov.NomPro|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCTickets.Producto FORMAT "x(8)":U
      VtaCTickets.FchIni FORMAT "99/99/9999":U
      VtaCTickets.FchFin FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 73.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaCTickets,INTEGRAL.gn-prov WHERE INTEGRAL.VtaCTickets ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&condicion}"
     _JoinCode[2]      = "INTEGRAL.gn-prov.CodPro = INTEGRAL.VtaCTickets.CodPro"
     ...
     _FldNameList[3]   = INTEGRAL.VtaCTickets.Producto
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Codigo':U THEN DO:
      &Scope SORTBY-PHRASE BY VtaCTickets.CodPro
...
DO I = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
   IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(I) THEN DO:    
       ASSIGN
           ...
           output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.producto.
   END.     
END.
