...
&Scoped-define INTERNAL-TABLES Almtmovm Almtdocm
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.Almtmovm,integral.Almtdocm WHERE integral.Almtmovm ..."
...
"Almtmovm.Desmov" ? "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
