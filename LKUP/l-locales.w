...
&SCOPED-DEFINE CONDICION ( gn-locales.codcia = S-CODCIA )
&SCOPED-DEFINE CODIGO gn-locales.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( gn-locales.Descripcion BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( gn-locales.Descripcion , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES gn-locales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table gn-locales.Codigo ~
gn-locales.Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH gn-locales WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gn-locales WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gn-locales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gn-locales
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.gn-locales.Descripcion
Nombres que contengan|y||INTEGRAL.gn-locales.Descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.gn-locales.Codigo|yes
Descripción|||INTEGRAL.gn-locales.Descripcion|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
DEFINE VARIABLE FILL-IN-codigo AS CHARACTER FORMAT "XX-XXX":U 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gn-locales.Codigo FORMAT "x(5)":U
      gn-locales.Descripcion FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.gn-locales"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = INTEGRAL.gn-locales.Codigo
     _FldNameList[2]   > INTEGRAL.gn-locales.Descripcion
"Descripcion" ? "x(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-locales.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-locales.Descripcion
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
