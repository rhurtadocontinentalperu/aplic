...
&SCOPED-DEFINE l-lookup h_l-gncard
...
DEFINE VARIABLE h_l-gncard AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-gncard.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-gncard ).
       RUN set-position IN h_l-gncard ( 1.19 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-gncard. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-gncard ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-gncard ,
