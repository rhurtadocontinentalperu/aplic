...
&SCOPED-DEFINE CONDICION ( GN-DIVI.codcia = S-CODCIA AND GN-DIVI.Campo-Log[5] = YES)
&SCOPED-DEFINE CODIGO GN-DIVI.CodDiv

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( GN-DIVI.DesDiv BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( GN-DIVI.DesDiv , FILL-IN-filtro ) <> 0 )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      GN-DIVI.CodDiv COLUMN-LABEL " Codigo" FORMAT "XX-XXX":U
...
"GN-DIVI.CodDiv" " Codigo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodDiv
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.DesDiv.
