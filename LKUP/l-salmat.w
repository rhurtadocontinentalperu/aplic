...
Almcmov.TipMov = "S" AND Almcmov.CodMov = S-CODMOV AND Almcmov.FlgEst <> "A" AND Almcmov.FlgSit = "T" AND Almcmov.AlmDes = S-CODALM)
...
&Scoped-Define ENABLED-OBJECTS RECT-1 F-Serie F-CodAlm FILL-IN-codigo ~
br_table 
...
<SORTBY-OPTIONS>
Código|y||integral.Almcmov.CodCia|yes,integral.Almcmov.CodAlm|yes,integral.Almcmov.TipMov|yes,integral.Almcmov.CodMov|yes,integral.Almcmov.NroDoc|yes
Descripción|||integral.Almcmov.CodCia|yes,integral.Almcmov.CodAlm|yes,integral.Almcmov.TipMov|yes,integral.Almcmov.CodMov|yes,integral.Almcmov.NroDoc|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almcmov.FchDoc COLUMN-LABEL "Fecha!Transferencia"
      Almcmov.HorSal COLUMN-LABEL "Hora de!Transferencia"
      Almcmov.Observ
      Almcmov.usuario
      Almcmov.NroRf2
/* _UIB-CODE-BLOCK-END */
...
"Almcmov.NroSer" " Serie" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   > integral.Almcmov.NroDoc
"Almcmov.NroDoc" "Numero" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[4]   > integral.Almcmov.FchDoc
"Almcmov.FchDoc" "Fecha!Transferencia" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[5]   > integral.Almcmov.HorSal
"Almcmov.HorSal" "Hora de!Transferencia" ? "character" ? ? ? ? ? ? no ?
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Código':U THEN DO:
      &Scope SORTBY-PHRASE BY Almcmov.CodCia BY Almcmov.CodAlm BY Almcmov.TipMov BY Almcmov.CodMov BY Almcmov.NroDoc
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = STRING( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nroser, "999" ) +
                       STRING( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nrodoc, "999999" )
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodAlm.
