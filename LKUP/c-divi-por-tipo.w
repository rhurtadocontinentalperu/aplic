...
&SCOPED-DEFINE l-lookup h_l-divi-por-tipo
...
DEFINE VARIABLE h_l-divi-por-tipo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-divi-por-tipo.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-divi-por-tipo ).
       RUN set-position IN h_l-divi-por-tipo ( 1.19 , 1.57 ) NO-ERROR.
       RUN set-size IN h_l-divi-por-tipo ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-divi-por-tipo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-divi-por-tipo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-divi-por-tipo ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-divi-por-tipo , 'AFTER':U ).
    END. /* Page 0 */
