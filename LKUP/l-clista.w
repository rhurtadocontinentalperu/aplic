...
&SCOPED-DEFINE CONDICION ( VtaCList.CodCia = s-codcia )
&SCOPED-DEFINE CODIGO VtaCList.CodActi

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaCList.DesActi BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VtaCList.DesActi , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES VtaCList

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaCList.CodActi VtaCList.DesActi 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaCList WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table VtaCList
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaCList
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaCList.DesActi
Nombres que contengan|y||INTEGRAL.VtaCList.DesActi
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaCList.CodActi|yes
Descripción|||INTEGRAL.VtaCList.DesActi|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaCList"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = INTEGRAL.VtaCList.CodActi
     _FldNameList[2]   = INTEGRAL.VtaCList.DesActi
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCList.CodActi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCList.DesActi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
