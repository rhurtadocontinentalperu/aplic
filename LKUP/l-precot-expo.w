...
&SCOPED-DEFINE CONDICION ( VtaCDocu.CodCia = s-CodCia AND ~
    ...
    VtaCDocu.CodPed = input-var-1  AND ~
    VtaCDocu.FchPed >= ( TODAY - 3 ) AND ~
    VtaCDocu.Libre_c01 = input-var-2 AND ~
    VtaCDocu.Libre_c05 = '*' AND ~
    VtaCDocu.CodVen = input-var-3 )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaCDocu.NroPed|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCDocu.NroPed COLUMN-LABEL "Numero" FORMAT "X(12)":U
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* Buscar el Número */
DO:
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCDocu.NroPed
