...
&SCOPED-DEFINE CONDICION ( CcbCDocu.CodCia = S-CODCIA  AND CcbCDocu.CodDoc = "G/R" AND CcbCDocu.NroDoc BEGINS C-NROSER AND CcbCDocu.FlgEst = "P" AND CcbCDocu.CodCli BEGINS input-var-1 )
