...
&SCOPED-DEFINE l-lookup h_l-clie-expo
...
DEFINE VARIABLE h_l-clie-expo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-clie-expo.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_l-clie-expo ).
       RUN set-position IN h_l-clie-expo ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-clie-expo ( 15.50 , 61.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-clie-expo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-clie-expo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-clie-expo ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-clie-expo , 'AFTER':U ).
    END. /* Page 0 */
