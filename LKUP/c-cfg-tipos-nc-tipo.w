...
&SCOPED-DEFINE l-lookup h_l-cfg-tipos-nc-tipo
...
DEFINE VARIABLE h_l-cfg-tipos-nc-tipo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-cfg-tipos-nc-tipo.r':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cfg-tipos-nc-tipo ).
       RUN set-position IN h_l-cfg-tipos-nc-tipo ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-cfg-tipos-nc-tipo ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cfg-tipos-nc-tipo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cfg-tipos-nc-tipo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cfg-tipos-nc-tipo ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-cfg-tipos-nc-tipo , 'AFTER':U ).
    END. /* Page 0 */
