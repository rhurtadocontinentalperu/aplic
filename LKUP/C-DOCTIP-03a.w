...
&SCOPED-DEFINE l-lookup h_l-doctip
...
&Scoped-Define ENABLED-OBJECTS RECT-55 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-doctip AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 12.77 COL 38.29
     Btn_Cancel AT ROW 12.77 COL 53.14
     Btn_Help AT ROW 12.77 COL 67.57
     RECT-55 AT ROW 12.5 COL 1.43
     SPACE(34.13) SKIP(0.18)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-doctip-03a.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-doctip ).
       RUN set-position IN h_l-doctip ( 1.08 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-doctip ( 11.15 , 118.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 12.62 , 3.57 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.77 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-doctip. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-doctip ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-doctip ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-55 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
