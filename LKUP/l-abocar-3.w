...
&SCOPED-DEFINE CONDICION ( CcbTabla.Tabla = input-var-1 ~
AND CcbTabla.CodCia = s-codcia ~
AND CcbTabla.Reservado = NO /* NO RESERVADOS */ ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbTabla.Codigo FORMAT "x(5)":U
      CcbTabla.Nombre FORMAT "x(40)":U
...
"CcbTabla.Codcta" ? "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
