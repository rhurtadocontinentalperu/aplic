...
&SCOPED-DEFINE l-lookup h_l-cmvto
...
DEFINE VARIABLE h_l-cmvto AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-cmvto.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cmvto ).
       RUN set-position IN h_l-cmvto ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-cmvto ( 10.92 , 74.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cmvto. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cmvto ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cmvto ,
