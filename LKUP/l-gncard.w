...
&SCOPED-DEFINE CODIGO gn-card.NroCard

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( gn-card.nomclie[1] BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( gn-card.nomcli[1] , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table gn-card.NroCard gn-card.NomClie[1] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gn-card WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gn-card
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gn-card
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.gn-card.NomClie[1]
Nombres que contengan|y||INTEGRAL.gn-card.NomClie[1]
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.gn-card.NroCard|yes
Descripción|||INTEGRAL.gn-card.NomClie[1]|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gn-card.NroCard COLUMN-LABEL "Nº Tarjeta"
      gn-card.NomClie[1] COLUMN-LABEL "Apellidos y Nombres" FORMAT "x(50)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"gn-card.NroCard" "Nº Tarjeta" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.gn-card.NomClie[1]
"gn-card.NomClie[1]" "Apellidos y Nombres" "x(50)" "character" ? ? ? ? ? ? no ?
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-card.NroCard
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-card.NomClie[1]
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nrocard
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nomcli[1].
