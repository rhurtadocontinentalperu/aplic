...
&SCOPED-DEFINE l-lookup h_l-pedi-2
...
DEFINE VARIABLE h_l-pedi-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-pedi-2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pedi-2 ).
       RUN set-position IN h_l-pedi-2 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 63.00 ) */
       ...
       /* Links to SmartLookup h_l-pedi-2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pedi-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pedi-2 ,
