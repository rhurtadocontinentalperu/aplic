...
&SCOPED-DEFINE CONDICION ( gn-vehic.codcia = s-codcia )
&SCOPED-DEFINE CODIGO gn-vehic.placa

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( gn-vehic.marca BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( gn-vehic.marca , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES VtaTabla gn-vehic gn-prov
...
vtatabla.tabla = 'VEHICULO' NO-LOCK, ~
      FIRST gn-vehic WHERE gn-vehic.placa = VtaTabla.Llave_c2 ~
      AND gn-vehic.codcia = s-codcia NO-LOCK, ~
      FIRST gn-prov WHERE gn-prov.CodPro = VtaTabla.Llave_c1 ~
...
vtatabla.tabla = 'VEHICULO' NO-LOCK, ~
      ...
      AND gn-prov.codcia = pv-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table VtaTabla gn-vehic gn-prov
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.gn-vehic.Marca
Nombres que contengan|y||INTEGRAL.gn-vehic.Marca
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Placa|y||INTEGRAL.gn-vehic.placa|yes
Marca|||INTEGRAL.gn-vehic.Marca|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "Placa,Marca",
     SortBy-Case = Placa':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-prov.NomPro COLUMN-LABEL "Proveedor" FORMAT "x(50)":U
            WIDTH 37.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 65.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaTabla,INTEGRAL.gn-vehic WHERE INTEGRAL.VtaTabla ...,INTEGRAL.gn-prov WHERE INTEGRAL.VtaTabla ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST USED, FIRST USED"
     _Where[1]         = "vtatabla.codcia = s-codcia and
vtatabla.tabla = 'VEHICULO'"
     _JoinCode[2]      = "gn-vehic.placa = VtaTabla.Llave_c2"
     _Where[2]         = "gn-vehic.codcia = s-codcia"
     _JoinCode[3]      = "gn-prov.CodPro = VtaTabla.Llave_c1"
     _Where[3]         = "gn-prov.codcia = pv-codcia"
     _FldNameList[1]   = INTEGRAL.gn-vehic.placa
     _FldNameList[2]   = INTEGRAL.gn-vehic.Marca
     _FldNameList[3]   > INTEGRAL.gn-prov.NomPro
"gn-prov.NomPro" "Proveedor" ? "character" ? ? ? ? ? ? no ? no no "37.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* Placa */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Placa':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-vehic.placa
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Marca':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-vehic.Marca
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = gn-vehic.placa
        output-var-3 = gn-vehic.marca.

    /*
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.placa
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.marca.
    */        
