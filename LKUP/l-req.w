...
&SCOPED-DEFINE CONDICION LG-CREQU.codcia = s-codcia
&SCOPED-DEFINE CODIGO LG-CREQU.NroReq

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( LG-CREQU.Solicita BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( LG-CREQU.Solicita , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES LG-CRequ

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table LG-CRequ.NroReq LG-CRequ.FchReq ~
LG-CRequ.Userid-Sol LG-CRequ.Solicita LG-CRequ.FlgSit 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH LG-CRequ WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    BY LG-CRequ.FchReq DESCENDING ~
       BY LG-CRequ.FlgSit DESCENDING
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LG-CRequ WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    BY LG-CRequ.FchReq DESCENDING ~
       BY LG-CRequ.FlgSit DESCENDING.
&Scoped-define TABLES-IN-QUERY-br_table LG-CRequ
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.LG-CRequ.Solicita
Nombres que contengan|y||INTEGRAL.LG-CRequ.Solicita
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.LG-CRequ.CodCia|yes,INTEGRAL.LG-CRequ.NroReq|yes
Descripción|||INTEGRAL.LG-CRequ.CodCia|yes,INTEGRAL.LG-CRequ.Solicita|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LG-CRequ.NroReq COLUMN-LABEL "Nro.  Req." FORMAT "999999":U
      LG-CRequ.FchReq COLUMN-LABEL "Fecha  Req." FORMAT "99/99/9999":U
      LG-CRequ.Userid-Sol FORMAT "x(12)":U
      LG-CRequ.Solicita FORMAT "X(45)":U
      LG-CRequ.FlgSit FORMAT "X(1)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 68 BY 12.88
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.LG-CRequ"
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "INTEGRAL.LG-CRequ.FchReq|no,INTEGRAL.LG-CRequ.FlgSit|no"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > INTEGRAL.LG-CRequ.NroReq
"LG-CRequ.NroReq" "Nro.  Req." ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.LG-CRequ.FchReq
"LG-CRequ.FchReq" "Fecha  Req." ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.LG-CRequ.Userid-Sol
     _FldNameList[4]   = INTEGRAL.LG-CRequ.Solicita
     _FldNameList[5]   = INTEGRAL.LG-CRequ.FlgSit
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY LG-CRequ.CodCia BY LG-CRequ.NroReq
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY LG-CRequ.CodCia BY LG-CRequ.Solicita
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = STRING( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.NroReq, "999999")
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Solicita.
&ENDIF
