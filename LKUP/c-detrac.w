...
&SCOPED-DEFINE l-lookup h_l-detrac
...
DEFINE VARIABLE h_l-detrac AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-detrac.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-detrac ).
       RUN set-position IN h_l-detrac ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-detrac. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-detrac ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-detrac ,
