...
&SCOPED-DEFINE l-lookup h_l-provee02
...
&Scoped-Define ENABLED-OBJECTS RECT-26 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-provee02 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 5.73 COL 52.57
     Btn_Cancel AT ROW 9.19 COL 52.57
     Btn_Help AT ROW 12.81 COL 52.57
     RECT-26 AT ROW 3.81 COL 50.72
     SPACE(1.41) SKIP(0.18)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-provee02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-provee02 ).
       RUN set-position IN h_l-provee02 ( 1.19 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 16.04 , 49.43 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.54 , 50.29 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-provee02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-provee02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-provee02 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-provee02 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-26 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
