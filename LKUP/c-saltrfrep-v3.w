...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.54 COL 70.57
     Btn_Cancel AT ROW 6.42 COL 70.29
     SPACE(3.56) SKIP(3.95)
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.27 , 68.00 ) NO-ERROR.
