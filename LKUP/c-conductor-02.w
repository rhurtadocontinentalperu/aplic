...
&SCOPED-DEFINE l-lookup h_l-conductor-02
...
&Scoped-Define ENABLED-OBJECTS RECT-24 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-conductor-02 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 5.73 COL 77.29
     Btn_Cancel AT ROW 9.23 COL 77.29
     Btn_Help AT ROW 12.73 COL 77.29
     RECT-24 AT ROW 3.42 COL 76
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* Conductores */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-conductor-02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Libre_c01':U ,
             OUTPUT h_l-conductor-02 ).
       RUN set-position IN h_l-conductor-02 ( 1.23 , 1.43 ) NO-ERROR.
       RUN set-size IN h_l-conductor-02 ( 15.50 , 74.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.27 , 76.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 13.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-conductor-02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-conductor-02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-conductor-02 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-conductor-02 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-24 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
