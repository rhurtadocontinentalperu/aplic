...
&SCOPED-DEFINE CONDICION ( YES )
&SCOPED-DEFINE CODIGO PR-PRESER.CodGas

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( PR-Preser.CodMat BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Pr-preser.CodMat , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES PR-PRESER PR-GASTOS Almmmatg gn-prov

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table PR-PRESER.CodGas PR-GASTOS.Desgas ~
PR-PRESER.CodPro gn-prov.NomPro PR-PRESER.codmat Almmmatg.DesMat ~
PR-PRESER.UndA PR-PRESER.CanDes[1] PR-PRESER.CodMon PR-PRESER.PreLis[1] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH PR-PRESER WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST PR-GASTOS WHERE PR-GASTOS.CodCia = PR-PRESER.Codcia ~
  AND PR-GASTOS.CodGas = PR-PRESER.CodGas NO-LOCK, ~
      FIRST Almmmatg WHERE Almmmatg.CodCia = PR-PRESER.Codcia ~
  ...
  AND gn-prov.CodPro = PR-PRESER.CodPro NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PR-PRESER WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST PR-GASTOS WHERE PR-GASTOS.CodCia = PR-PRESER.Codcia ~
  AND PR-GASTOS.CodGas = PR-PRESER.CodGas NO-LOCK, ~
      FIRST Almmmatg WHERE Almmmatg.CodCia = PR-PRESER.Codcia ~
  AND Almmmatg.codmat = PR-PRESER.codmat NO-LOCK, ~
  ...
  AND gn-prov.CodPro = PR-PRESER.CodPro NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table PR-PRESER PR-GASTOS Almmmatg ~
gn-prov
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.AdmRutas.NomTra
Nombres que contengan|y||integral.AdmRutas.NomTra
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.AdmRutas.CodPro|yes
Descripción|||integral.AdmRutas.NomTra|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PR-PRESER.CodGas FORMAT "X(6)":U
      PR-GASTOS.Desgas FORMAT "X(25)":U
      PR-PRESER.CodPro FORMAT "x(11)":U
      gn-prov.NomPro FORMAT "x(35)":U
      PR-PRESER.codmat COLUMN-LABEL "Codigo !Articulo" FORMAT "X(6)":U
      Almmmatg.DesMat FORMAT "X(35)":U
      PR-PRESER.UndA COLUMN-LABEL "Unidad" FORMAT "X(4)":U
      PR-PRESER.CanDes[1] COLUMN-LABEL "Cantidad" FORMAT "->>,>>9.99":U
      PR-PRESER.CodMon FORMAT "9":U
      PR-PRESER.PreLis[1] FORMAT ">>,>>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 90.29 BY 13.19
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.PR-PRESER,INTEGRAL.PR-GASTOS WHERE INTEGRAL.PR-PRESER ...,INTEGRAL.Almmmatg WHERE INTEGRAL.PR-PRESER ...,INTEGRAL.gn-prov WHERE INTEGRAL.PR-PRESER ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST, FIRST, FIRST"
     _JoinCode[2]      = "integral.PR-GASTOS.CodCia = integral.PR-PRESER.Codcia
  AND integral.PR-GASTOS.CodGas = integral.PR-PRESER.CodGas"
     _JoinCode[3]      = "integral.Almmmatg.CodCia = integral.PR-PRESER.Codcia
  AND integral.Almmmatg.codmat = integral.PR-PRESER.codmat"
     _JoinCode[4]      = "integral.gn-prov.CodCia = pv-codcia
  AND integral.gn-prov.CodPro = integral.PR-PRESER.CodPro"
     _FldNameList[1]   = integral.PR-PRESER.CodGas
     _FldNameList[2]   > integral.PR-GASTOS.Desgas
"PR-GASTOS.Desgas" ? "X(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = integral.PR-PRESER.CodPro
     _FldNameList[4]   > integral.gn-prov.NomPro
"gn-prov.NomPro" ? "x(35)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.PR-PRESER.codmat
"PR-PRESER.codmat" "Codigo !Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PR-PRESER.UndA" "Unidad" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.PR-PRESER.CanDes[1]
"PR-PRESER.CanDes[1]" "Cantidad" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   = integral.PR-PRESER.CodMon
     _FldNameList[10]   = integral.PR-PRESER.PreLis[1]
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY AdmRutas.CodPro
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY AdmRutas.NomTra
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codgas
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codmat.
