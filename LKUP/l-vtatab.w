...
&SCOPED-DEFINE CONDICION ( FacTabla.codcia = s-codcia ~
AND FacTabla.tabla = input-var-1 ~
AND FacTabla.Codigo <> '00' ~
AND (input-var-2 = '' OR LENGTH(FacTabla.Codigo) <= INTEGER(input-var-2) ) )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.FacTabla.CodCia|yes,INTEGRAL.FacTabla.Codigo|yes
Descripción|||INTEGRAL.FacTabla.CodCia|yes,INTEGRAL.FacTabla.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY FacTabla.CodCia BY FacTabla.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY FacTabla.CodCia BY FacTabla.Nombre
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
