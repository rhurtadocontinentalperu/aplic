...
&SCOPED-DEFINE l-lookup h_l-tabtrkdocs
...
DEFINE VARIABLE h_l-tabtrkdocs AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-tabtrkdocs.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-tabtrkdocs ).
       RUN set-position IN h_l-tabtrkdocs ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-tabtrkdocs ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-tabtrkdocs. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-tabtrkdocs ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-tabtrkdocs ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-tabtrkdocs , 'AFTER':U ).
    END. /* Page 0 */
