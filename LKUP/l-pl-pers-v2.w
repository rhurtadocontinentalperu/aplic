...
&Scoped-define FIELDS-IN-QUERY-br_table PL-PERS.codper PL-PERS.lmilit ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PL-PERS.codper COLUMN-LABEL "Código!Progress" FORMAT "X(8)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 107.14 BY 14.08
...
"codper" "Código!Progress" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
