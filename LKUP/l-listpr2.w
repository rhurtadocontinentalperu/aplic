...
&SCOPED-DEFINE FILTRO1 ( (Almmmatg.DesMat BEGINS FILL-IN-filtro) AND (Almmmatg.Codfam BEGINS F-Codfam) AND (Almmmatg.Subfam BEGINS F-Subfam) AND (Almmmatg.TpoArt BEGINS R-Tipo) AND (Almmmatg.DesMar BEGINS F-marca) )
&SCOPED-DEFINE FILTRO2 ( (INDEX ( Almmmatg.DesMat , FILL-IN-filtro ) <> 0) AND (Almmmatg.Codfam BEGINS F-Codfam) AND (Almmmatg.Subfam BEGINS F-Subfam) AND (Almmmatg.TpoArt BEGINS R-Tipo) AND (Almmmatg.DesMar BEGINS F-marca) )
...
&Scoped-Define ENABLED-OBJECTS br_table FILL-IN-codigo F-marca R-Tipo ~
CMB-filtro F-Codfam F-SubFam FILL-IN-filtro RECT-24 RECT-1 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-codigo F-marca R-Tipo CMB-filtro ~
F-Codfam F-SubFam FILL-IN-filtro F-Catcli F-Tipo F-Codmon 
...
DEFINE FRAME F-Main
     ...
     R-Tipo AT ROW 1.38 COL 61.86 NO-LABEL
     ...
     "Estado" VIEW-AS TEXT
          SIZE 6.57 BY .5 AT ROW 1.38 COL 53.57
          FONT 6
     RECT-24 AT ROW 1.19 COL 61
