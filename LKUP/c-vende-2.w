...
&SCOPED-DEFINE l-lookup h_l-vende-2
...
DEFINE VARIABLE h_l-vende-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-vende-2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-vende-2 ).
       RUN set-position IN h_l-vende-2 ( 1.04 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-vende-2 ( 15.35 , 50.86 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-vende-2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-vende-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-vende-2 ,
