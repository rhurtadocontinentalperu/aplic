...
&SCOPED-DEFINE l-lookup h_l-listpr
...
DEFINE VARIABLE h_l-listpr AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-listpr2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Orden-Lista':U ,
             OUTPUT h_l-listpr ).
       RUN set-position IN h_l-listpr ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.65 , 87.86 ) */
       ...
       /* Links to SmartLookup h_l-listpr. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listpr ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listpr , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listpr ,
