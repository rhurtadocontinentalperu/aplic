...
AlmCDocu.UsrCreacion AlmCDocu.CodLlave cb-auxi.Nomaux AlmCDocu.Libre_c01 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      AlmCDocu.NroDoc FORMAT "X(10)":U WIDTH 8.57
...
"AlmCDocu.NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmCDocu.Libre_c01" "Observaciones" "x(60)" "character" ? ? ? ? ? ? no ? no no "32.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
