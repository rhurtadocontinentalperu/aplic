...
&SCOPED-DEFINE l-lookup h_l-gn-provd
...
DEFINE VARIABLE h_l-gn-provd AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-gn-provd.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-gn-provd ).
       RUN set-position IN h_l-gn-provd ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-gn-provd ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-gn-provd. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-gn-provd ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-gn-provd ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-gn-provd , 'AFTER':U ).
    END. /* Page 0 */
