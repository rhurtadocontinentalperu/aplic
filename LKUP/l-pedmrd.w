...
FacCPedi.NomCli FacCPedi.Cmpbnte FacCPedi.NroRef 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacCPedi.NroPed COLUMN-LABEL "<<Numero>>"
      FacCPedi.FchPed COLUMN-LABEL "<<<Fecha>>>"
      FacCPedi.NomCli COLUMN-LABEL "Cliente"
      FacCPedi.Cmpbnte COLUMN-LABEL "Referencia"
      FacCPedi.NroRef COLUMN-LABEL "<<Numero>>"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 78 BY 8.62
...
"FacCPedi.NroPed" "<<Numero>>" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.FacCPedi.FchPed
"FacCPedi.FchPed" "<<<Fecha>>>" ? "date" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.FacCPedi.NomCli
"FacCPedi.NomCli" "Cliente" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > INTEGRAL.FacCPedi.Cmpbnte
"FacCPedi.Cmpbnte" "Referencia" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > INTEGRAL.FacCPedi.NroRef
"FacCPedi.NroRef" "<<Numero>>" ? "character" ? ? ? ? ? ? no ?
