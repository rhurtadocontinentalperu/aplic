...
&SCOPED-DEFINE l-lookup h_l-prepedido-terceros
...
DEFINE VARIABLE h_l-prepedido-terceros AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-prepedido-terceros.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-prepedido-terceros ).
       RUN set-position IN h_l-prepedido-terceros ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-prepedido-terceros ( 10.92 , 90.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-prepedido-terceros. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-prepedido-terceros ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-prepedido-terceros ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-prepedido-terceros , 'AFTER':U ).
    END. /* Page 0 */
