...
&SCOPED-DEFINE CONDICION ( almtabla.Tabla = input-var-1 AND ~
    (input-var-2 = "" OR almtabla.nomant = input-var-2) AND ~
    almtabla.codcta1 <> "I" )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      almtabla.Nombre FORMAT "x(50)":U WIDTH 42.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 52.14 BY 8.62
...
"almtabla.Nombre" ? "x(50)" "character" ? ? ? ? ? ? no ? no no "42.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
