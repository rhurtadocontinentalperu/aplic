...
&SCOPED-DEFINE CONDICION ( Almacen.CodCia = S-CODCIA AND Almacen.CodDiv = S-CODDIV AND Almacen.AutMov)
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almacen.CodAlm FORMAT "x(4)"
      Almacen.Descripcion FORMAT "X(51)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Almacen.CodAlm" ? "x(4)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.Almacen.Descripcion
"Almacen.Descripcion" ? "X(51)" "character" ? ? ? ? ? ? no ?
