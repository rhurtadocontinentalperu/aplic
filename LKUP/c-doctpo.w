...
&SCOPED-DEFINE l-lookup h_l-doctpo
...
DEFINE VARIABLE h_l-doctpo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-doctpo.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-doctpo ).
       RUN set-position IN h_l-doctpo ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-doctpo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-doctpo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-doctpo ,
