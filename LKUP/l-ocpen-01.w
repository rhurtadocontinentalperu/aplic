...
/* RHC 23.04.2014 agregar C en tpodoc para incluir compras entre empresas */
&SCOPED-DEFINE CONDICION ( LG-COCmp.CodCia = S-CODCIA ~
AND LOOKUP(LG-COCmp.TpoDoc, "N,C") > 0 ~
AND LG-COCmp.CodDiv BEGINS input-var-2 ~
AND LOOKUP(LG-COCmp.FlgSit,input-var-1) > 0 ~
AND LG-COCmp.ModAdq <> "CR")
...
&Scoped-define FIELDS-IN-QUERY-br_table LG-COCmp.NroDoc LG-COCmp.NroReq ~
LG-COCmp.NomPro LG-COCmp.CodAlm LG-COCmp.FchEnt LG-COCmp.FchVto ~
X-MON @ X-MON LG-COCmp.ImpTot 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH LG-COCmp WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    BY LG-COCmp.Fchdoc DESCENDING
...
<SORTBY-OPTIONS>
No.O/C|y||integral.LG-COCmp.CodCia|yes,integral.LG-COCmp.TpoDoc|yes,integral.LG-COCmp.NroDoc|yes
Proveedor|||integral.LG-COCmp.NomPro|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "No.O/C,Proveedor",
     Sort-Case = No.O/C':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LG-COCmp.NroReq COLUMN-LABEL "No.Requ." FORMAT "999999":U
      LG-COCmp.NomPro FORMAT "X(40)":U
      LG-COCmp.CodAlm COLUMN-LABEL "Solicitante" FORMAT "x(3)":U
      LG-COCmp.FchEnt COLUMN-LABEL "     Fecha    !    Entrega" FORMAT "99/99/9999":U
      LG-COCmp.FchVto COLUMN-LABEL "       Fecha    !     Máxima" FORMAT "99/99/9999":U
      X-MON @ X-MON COLUMN-LABEL "Mon" FORMAT "XXXX":U
      LG-COCmp.ImpTot FORMAT "ZZ,ZZZ,ZZ9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 86.57 BY 9.23
...
DEFINE FRAME F-Main
     FILL-IN-codigo AT ROW 1.35 COL 16.57 COLON-ALIGNED
     CMB-filtro AT ROW 1.35 COL 28.29 NO-LABEL
     FILL-IN-filtro AT ROW 1.35 COL 50.29 NO-LABEL
     br_table AT ROW 2.46 COL 1.57
     "Buscar x" VIEW-AS TEXT
          SIZE 7.86 BY .54 AT ROW 1.5 COL 2.57
          FONT 6
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "integral.LG-COCmp.Fchdoc|no"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > integral.LG-COCmp.NroDoc
"LG-COCmp.NroDoc" "Numero!O/C" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.LG-COCmp.NroReq
"LG-COCmp.NroReq" "No.Requ." ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = integral.LG-COCmp.NomPro
     _FldNameList[4]   > integral.LG-COCmp.CodAlm
"LG-COCmp.CodAlm" "Solicitante" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.LG-COCmp.FchEnt
"LG-COCmp.FchEnt" "     Fecha    !    Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > integral.LG-COCmp.FchVto
"LG-COCmp.FchVto" "       Fecha    !     Máxima" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"X-MON @ X-MON" "Mon" "XXXX" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = integral.LG-COCmp.ImpTot
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* No. O/C */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'No.O/C':U THEN DO:
           &Scope SORTBY-PHRASE BY LG-COCmp.CodCia BY LG-COCmp.TpoDoc BY LG-COCmp.NroDoc
