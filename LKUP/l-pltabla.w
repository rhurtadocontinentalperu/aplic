...
&SCOPED-DEFINE CONDICION ( pl-tabla.codcia = 0 AND pl-tabl.Tabla = input-var-1 )
&SCOPED-DEFINE CODIGO pl-tabl.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( pl-tabla.Nombre BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( pl-tabla.Nombre , FILL-IN-filtro ) <> 0 )
