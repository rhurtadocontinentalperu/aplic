...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      t-CodAlm COLUMN-LABEL "Almacen" 
      t-CodDoc COLUMN-LABEL "Codigo!Documento"  FORMAT "XXX"
      t-NroPed COLUMN-LABEL "Numero!O/D" FORMAT "XXX-XXXXXXXX"
      t-FchPed COLUMN-LABEL "  Fecha       !  Pedido       "  FORMAT "99/99/9999"
      t-NomCli COLUMN-LABEL "Cliente" FORMAT "x(35)"
      t-CanPed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 74.29 BY 8.62
         BGCOLOR 15 FGCOLOR 0 FONT 4
         TITLE BGCOLOR 15 FGCOLOR 0 "STOCK COMPROMETIDO EN O/D".
...
ON ANY-PRINTABLE OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
  RETURN NO-APPLY.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table L-table-Win
ON MOUSE-SELECT-DBLCLICK OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table L-table-Win
ON ROW-ENTRY OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
    RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table L-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table L-table-Win
ON START-SEARCH OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table L-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO EN O/D */
DO:
...
FOR EACH FacDPedi WHERE FacDPedi.CodCia = s-codcia 
    ...
    FIND FIRST FacCPedi OF FacDPedi WHERE FacCPedi.codcia = FacDPedi.CodCia
                                     AND  FacCPedi.CodAlm = s-codalm                                     AND  Faccpedi.FlgEst = "P"
