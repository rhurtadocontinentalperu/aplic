...
&SCOPED-DEFINE l-lookup h_l-boldep-03
...
DEFINE VARIABLE h_l-boldep-03 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-boldep-03.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-boldep-03 ).
       RUN set-position IN h_l-boldep-03 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-boldep-03 ( 10.88 , 87.29 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-boldep-03. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-boldep-03 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-boldep-03 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-boldep-03 , 'AFTER':U ).
    END. /* Page 0 */
