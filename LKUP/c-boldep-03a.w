...
&SCOPED-DEFINE l-lookup h_l-boldep-03a
...
&Scoped-Define ENABLED-OBJECTS RECT-22 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-boldep-03a AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 12.27 COL 31.14
     Btn_Cancel AT ROW 12.31 COL 48.57
     Btn_Help AT ROW 12.31 COL 65.72
     RECT-22 AT ROW 11.96 COL 1
     SPACE(2.13) SKIP(0.00)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-boldep-03a.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-boldep-03a ).
       RUN set-position IN h_l-boldep-03a ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-boldep-03a ( 10.88 , 87.29 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 12.04 , 3.57 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-boldep-03a. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-boldep-03a ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-boldep-03a ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-boldep-03a , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-22 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
