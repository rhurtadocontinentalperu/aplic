...
&SCOPED-DEFINE l-lookup h_l-precot-expo
...
DEFINE VARIABLE h_l-precot-expo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-precot-expo.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-precot-expo ).
       RUN set-position IN h_l-precot-expo ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-precot-expo ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-precot-expo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-precot-expo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-precot-expo ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-precot-expo , 'AFTER':U ).
    END. /* Page 0 */
