...
<SORTBY-OPTIONS>
Codigo|y||integral.AlmSFami.CodCia|yes,integral.AlmSFami.codfam|yes,integral.AlmSFami.subfam|yes
Descripcion|||integral.AlmSFami.CodCia|yes,integral.AlmSFami.codfam|yes,integral.AlmSFami.dessub|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 44.43 BY 8.62
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSFami.CodCia BY AlmSFami.codfam BY AlmSFami.subfam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripcion':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSFami.CodCia BY AlmSFami.codfam BY AlmSFami.dessub
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
DO I = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
   IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(I) THEN DO:
      output-var-1 = ROWID( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} ).
         ...
         ELSE output-var-2 = output-var-2 + "," + {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.SubFam.
         output-var-3 = "".
   END.
