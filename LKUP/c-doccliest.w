...
&SCOPED-DEFINE l-lookup h_l-doccliest
...
DEFINE VARIABLE h_l-doccliest AS HANDLE NO-UNDO.
...
DO:
    RUN dispatch IN h_l-doccliest ('Deselect-All':U).
END.
...
DO:
    RUN dispatch IN h_l-doccliest ('Select-All':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-doccliest.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-doccliest ).
       RUN set-position IN h_l-doccliest ( 1.00 , 1.57 ) NO-ERROR.
       RUN set-size IN h_l-doccliest ( 10.92 , 83.57 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-doccliest. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-doccliest ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-doccliest ,
             B-Select1:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-doccliest , 'AFTER':U ).
    END. /* Page 0 */
