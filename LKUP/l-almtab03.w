...
&SCOPED-DEFINE CONDICION ( almtabla.Tabla = "CN" )
...
<SORTBY-OPTIONS>
Codigo|y||integral.almtabla.Tabla|yes,integral.almtabla.Codigo|yes
Descripcion|||integral.almtabla.Tabla|yes,integral.almtabla.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS MULTIPLE SIZE 44.29 BY 8.62
...
"almtabla.Codigo" ? "x(4)" "character" ? ? ? ? ? ? no ?
...
DO I = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
   IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(I) THEN DO:
      output-var-1 = ROWID( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} ).
         ...
         ELSE output-var-2 = output-var-2 + "," + {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Codigo.
         output-var-3 = "".
   END.
