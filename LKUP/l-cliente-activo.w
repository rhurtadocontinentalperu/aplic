...
&SCOPED-DEFINE FILTRO2 ( gn-clie.nomcli CONTAINS LocalCadena )
...
&Scoped-define FIELDS-IN-QUERY-br_table gn-clie.CodCli gn-clie.Ruc ~
gn-clie.NomCli 
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.gn-clie.CodCli|yes
Descripción|||INTEGRAL.gn-clie.NomCli|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gn-clie.CodCli FORMAT "x(11)":U WIDTH 10.57
      gn-clie.Ruc FORMAT "x(11)":U WIDTH 10.43
      gn-clie.NomCli FORMAT "x(250)":U WIDTH 51.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"gn-clie.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-clie.Ruc
"gn-clie.Ruc" ? ? "character" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.gn-clie.NomCli
"gn-clie.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "51.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
