...
&SCOPED-DEFINE CONDICION ( vtatabla.CodCia = s-codcia ~
AND Vtatabla.tabla = input-var-1 ~
AND Vtatabla.Llave_c1 = input-var-2 )

&SCOPED-DEFINE CODIGO vtatabla.llave_c2
...
VtaTabla.Libre_c01 VtaTabla.Libre_c03 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c2 COLUMN-LABEL "Promotor" FORMAT "x(8)":U
      VtaTabla.Libre_c01 COLUMN-LABEL "Nombre Promotor" FORMAT "x(60)":U
            WIDTH 43.43
      VtaTabla.Libre_c03 COLUMN-LABEL "Equipo" FORMAT "x(25)":U
            WIDTH 15.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75.14 BY 13.54
         BGCOLOR 15 FGCOLOR 0 FONT 9 FIT-LAST-COLUMN.
...
"VtaTabla.Llave_c2" "Promotor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Libre_c01
"VtaTabla.Libre_c01" "Nombre Promotor" "x(60)" "character" ? ? ? ? ? ? no ? no no "43.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Libre_c03
"VtaTabla.Libre_c03" "Equipo" "x(25)" "character" ? ? ? ? ? ? no ? no no "21.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.libre_c01
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c1 + '|' +
                        {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c2 + '|' +
                        {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.libre_c02.
