...
&SCOPED-DEFINE CONDICION ( FacCpedm.CodCia = S-CODCIA ~
AND FacCpedm.CodDoc = input-var-1 ~
AND FacCpedm.CodCli BEGINS input-var-2 ~
AND FacCpedm.FlgEst = "P" ~
AND FacCpedm.CodDiv = S-CODDIV ~
AND Faccpedm.fchven >= TODAY )

&SCOPED-DEFINE CODIGO FacCpedm.NroPed

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( FacCpedm.CodCli BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( FacCpedm.CodCli , FILL-IN-filtro ) <> 0 )
...
Faccpedm.FchPed C-MON @ C-MON Faccpedm.ImpTot 
...
<FOREIGN-KEYS>
Codigo de Cliente|y|y|integral.FacCpedm.CodCli
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.FacCpedm.CodCia|yes,integral.FacCpedm.CodDoc|yes,integral.FacCpedm.NroPed|yes
Cliente|||integral.FacCpedm.CodCia|yes,integral.FacCpedm.CodCli|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Faccpedm.NomCli FORMAT "x(45)"
      Faccpedm.FchPed COLUMN-LABEL "          Fecha"
      C-MON @ C-MON COLUMN-LABEL "Mon" FORMAT "X(4)"
      Faccpedm.ImpTot
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 69.72 BY 9.88
...
"Faccpedm.NomCli" ? "x(45)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > integral.Faccpedm.FchPed
"Faccpedm.FchPed" "          Fecha" ? "date" ? ? ? ? ? ? no ?
    ...
    WHEN 'Codigo de Cliente':U THEN DO:
       ...
       CASE RETURN-VALUE:
         ...
         WHEN 'Cliente':U THEN DO:
           &Scope SORTBY-PHRASE BY FacCpedm.CodCia BY FacCpedm.CodCli
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "Codigo de Cliente" "FacCpedm" "CodCli"}
