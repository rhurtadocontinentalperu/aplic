...
&SCOPED-DEFINE l-lookup h_l-cbulto
...
DEFINE VARIABLE h_l-cbulto AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 4.73 COL 70.57
     Btn_Cancel AT ROW 7.19 COL 70.57
     RECT-2 AT ROW 4 COL 68.14
     SPACE(3.14) SKIP(2.56)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-cbulto.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-cbulto ).
       RUN set-position IN h_l-cbulto ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-cbulto ( 10.92 , 65.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.54 , 68.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-cbulto. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cbulto ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cbulto ,
