...
&SCOPED-DEFINE l-lookup h_l-FACP
...
DEFINE VARIABLE h_l-facp AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-facp.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-facp ).
       RUN set-position IN h_l-facp ( 1.19 , 2.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-option ( 1.92 , 12.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-facp. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-facp ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-facp ,
