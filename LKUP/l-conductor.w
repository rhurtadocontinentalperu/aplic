...
&SCOPED-DEFINE CONDICION ( vtatabla.CodCia = cl-CODCIA )
&SCOPED-DEFINE CODIGO vtatabla.llave_c1

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( vtatabla.libre_c01 BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( vtatabla.libre_c01 , FILL-IN-filtro ) <> 0 )
...
VtaTabla.Libre_c01 VtaTabla.Libre_c02 VtaTabla.Libre_c03 VtaTabla.Llave_c2 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
      AND codcia = s-codcia and tabla = 'BREVETE' NO-LOCK ~
...
<SORTBY-OPTIONS>
Ap.Paterno|y||INTEGRAL.VtaTabla.Libre_c01|yes
Ap.Materno|||INTEGRAL.VtaTabla.Libre_c02|yes
Nombres|||INTEGRAL.VtaTabla.Libre_c03|yes
Nro. Licencia|||INTEGRAL.VtaTabla.Llave_c1|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'Ap.Paterno,Ap.Materno,Nombres,Nro. Licencia' + '",
     SortBy-Case = ':U + 'Ap.Paterno').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Licencia" FORMAT "x(8)":U
            WIDTH 10.57
      VtaTabla.Libre_c01 COLUMN-LABEL "Ap.Paterno" FORMAT "x(30)":U
            WIDTH 15
      VtaTabla.Libre_c02 COLUMN-LABEL "Ap. Materno" FORMAT "x(30)":U
            WIDTH 15
      VtaTabla.Libre_c03 COLUMN-LABEL "Nombres" FORMAT "x(25)":U
            WIDTH 15.86
      VtaTabla.Llave_c2 COLUMN-LABEL "D.N.I." FORMAT "x(10)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 46.86 BY 13.19
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "codcia = s-codcia and tabla = 'BREVETE'"
     _FldNameList[1]   > INTEGRAL.VtaTabla.Llave_c1
"Llave_c1" "Licencia" ? "character" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Libre_c01
"Libre_c01" "Ap.Paterno" "x(30)" "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Libre_c02
"Libre_c02" "Ap. Materno" "x(30)" "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Libre_c03
"Libre_c03" "Nombres" "x(25)" "character" ? ? ? ? ? ? no ? no no "15.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaTabla.Llave_c2
"Llave_c2" "D.N.I." "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Ap.Paterno':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaTabla.Libre_c01
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Ap.Materno':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaTabla.Libre_c02
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Nombres':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaTabla.Libre_c03
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Nro. Licencia':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaTabla.Llave_c1
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c1
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.libre_c01 + " " + libre_c02 + " " + libre_c03.
