...
&SCOPED-DEFINE l-lookup h_l-docflg-div
...
&Scoped-Define ENABLED-OBJECTS RECT-55 Btn_OK Btn_Cancel 
...
DEFINE VARIABLE h_l-docflg-div AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-docflg-div.r':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Documento':U ,
             OUTPUT h_l-docflg-div ).
       RUN set-position IN h_l-docflg-div ( 1.00 , 1.57 ) NO-ERROR.
       RUN set-size IN h_l-docflg-div ( 10.92 , 83.57 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-docflg-div. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-docflg-div ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-docflg-div ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-docflg-div , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-55 Btn_OK Btn_Cancel 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
