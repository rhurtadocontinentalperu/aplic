...
&SCOPED-DEFINE l-lookup h_l-locales
...
DEFINE VARIABLE h_l-locales AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-locales.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-locales ).
       RUN set-position IN h_l-locales ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-locales ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-locales. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-locales ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-locales ,
