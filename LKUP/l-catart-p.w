...
&SCOPED-DEFINE CONDICION ( Almtmatg.CodCia = S-CODCIA AND Almtmatg.FchCes = ?)
&SCOPED-DEFINE CODIGO Almtmatg.codmat
 
/* Preprocesadores para cada campo filtro */ 
&SCOPED-DEFINE FILTRO1 ( (Almtmatg.DesMat BEGINS FILL-IN-filtro) AND (Almtmatg.CodFam BEGINS F-CodFam) AND (Almtmatg.subfam BEGINS F-SubFam) AND (Almtmatg.TpoArt BEGINS R-Tipo) AND (Almtmatg.DesMar BEGINS F-marca) )
&SCOPED-DEFINE FILTRO2 ( (INDEX ( Almtmatg.DesMat , FILL-IN-filtro ) <> 0) AND ( Almtmatg.CodFam BEGINS F-CodFam) AND ( Almtmatg.SubFam BEGINS F-SubFam) AND ( Almtmatg.TpoArt BEGINS R-Tipo) AND (Almtmatg.DesMar BEGINS F-marca) )
...
&Scoped-define INTERNAL-TABLES Almtmatg
...
Almtmatg.DesMar Almtmatg.codfam Almtmatg.subfam Almtmatg.TpoPro ~
Almtmatg.TpoArt 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Almtmatg WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} ~
 AND Almtmatg.codfam BEGINS F-Codfam ~
 AND Almtmatg.TpoArt BEGINS R-Tipo NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Almtmatg
...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-24 br_table CMB-filtro ~
FILL-IN-codigo F-marca F-CodFam FILL-IN-filtro F-SubFam R-Tipo 
&Scoped-Define DISPLAYED-OBJECTS CMB-filtro FILL-IN-codigo F-marca F-CodFam ~
FILL-IN-filtro F-SubFam R-Tipo 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.Almtmatg.DesMat
Nombres que contengan|y||integral.Almtmatg.DesMat
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Codigo|y||integral.Almtmatg.CodCia|yes,integral.Almtmatg.codmat|yes
Descripcion|||integral.Almtmatg.CodCia|yes,integral.Almtmatg.DesMat|yes
Familia|||integral.Almtmatg.CodCia|yes,integral.Almtmatg.codfam|yes,integral.Almtmatg.OrdLis|yes
Sub-Familia|||integral.Almtmatg.CodCia|yes,integral.Almtmatg.codfam|yes,integral.Almtmatg.subfam|yes
Marca|||integral.Almtmatg.CodCia|yes,integral.Almtmatg.DesMar|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Almtmatg.codmat COLUMN-LABEL "Codigo de!Articulo"
      Almtmatg.DesMat FORMAT "X(65)"
      Almtmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)"
      Almtmatg.codfam
      Almtmatg.subfam
      Almtmatg.TpoPro
      Almtmatg.TpoArt
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66.43 BY 8.58
...
DEFINE FRAME F-Main
     br_table AT ROW 3.96 COL 1.72
     CMB-filtro AT ROW 3.04 COL 2.57 NO-LABEL
     FILL-IN-codigo AT ROW 1.23 COL 5.43 COLON-ALIGNED
     F-marca AT ROW 2.12 COL 5.43 COLON-ALIGNED
     F-CodFam AT ROW 1.23 COL 19.29 COLON-ALIGNED
     FILL-IN-filtro AT ROW 3.04 COL 23.72 NO-LABEL
     F-SubFam AT ROW 1.23 COL 32.29 COLON-ALIGNED
     R-Tipo AT ROW 1.42 COL 44.14 NO-LABEL
     RECT-1 AT ROW 1 COL 1
     RECT-24 AT ROW 1.23 COL 43.14
     "Tipo" VIEW-AS TEXT
          SIZE 3.57 BY .5 AT ROW 1.46 COL 39
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.Almtmatg"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}
 AND integral.Almtmatg.codfam BEGINS F-Codfam
 AND integral.Almtmatg.TpoArt BEGINS R-Tipo"
     _FldNameList[1]   > integral.Almtmatg.codmat
"Almtmatg.codmat" "Codigo de!Articulo" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.Almtmatg.DesMat
"Almtmatg.DesMat" ? "X(65)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > integral.Almtmatg.DesMar
"Almtmatg.DesMar" "Marca" "X(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   = integral.Almtmatg.codfam
     _FldNameList[5]   = integral.Almtmatg.subfam
     _FldNameList[6]   = integral.Almtmatg.TpoPro
     _FldNameList[7]   = integral.Almtmatg.TpoArt
...
DO:
    ...
    CASE CMB-filtro:
         WHEN 'Todos':U THEN DO:
              IF F-CodFam <> "" OR F-SubFam <> "" OR F-marca <> "" THEN RUN set-attribute-list('Key-Name=Nombres que inicien con').
         ...
         WHEN 'Nombres que contengan':U THEN DO:
              ...
              ELSE DO:
                 IF F-CodFam <> "" OR F-SubFam <> "" OR F-marca <> "" THEN 
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmatg.CodCia BY Almtmatg.codmat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripcion':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmatg.CodCia BY Almtmatg.DesMat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Familia':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmatg.CodCia BY Almtmatg.codfam BY Almtmatg.OrdLis
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Sub-Familia':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmatg.CodCia BY Almtmatg.codfam BY Almtmatg.subfam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Marca':U THEN DO:
           &Scope SORTBY-PHRASE BY Almtmatg.CodCia BY Almtmatg.DesMar
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
