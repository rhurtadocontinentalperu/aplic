...
AND vtactabla.tabla = input-var-1 ~
    AND vtactabla.llave BEGINS input-var-2

&SCOPED-DEFINE CODIGO vtactabla.llave

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaCTabla.Descripcion BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VtaCTabla.Descripcion , FILL-IN-filtro ) <> 0 )
...
VtaCTabla.Descripcion VtaCTabla.Libre_c01 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaCTabla.Descripcion
Nombres que contengan|y||INTEGRAL.VtaCTabla.Descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaCTabla.Llave|yes
Descripción|||INTEGRAL.VtaCTabla.Descripcion|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCTabla.Descripcion FORMAT "x(60)":U WIDTH 29.86
      VtaCTabla.Libre_c01 FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VtaCTabla.Llave" "Código" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaCTabla.Descripcion
"VtaCTabla.Descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "29.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCTabla.Libre_c01
"VtaCTabla.Libre_c01" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCTabla.Llave
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCTabla.Descripcion
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave
