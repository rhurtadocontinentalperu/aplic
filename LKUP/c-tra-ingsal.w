...
&SCOPED-DEFINE l-lookup h_l-tra-ingsal
...
DEFINE VARIABLE h_l-tra-ingsal AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-tra-ingsal.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-tra-ingsal ).
       RUN set-position IN h_l-tra-ingsal ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-tra-ingsal ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-tra-ingsal. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-tra-ingsal ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-tra-ingsal ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-tra-ingsal , 'AFTER':U ).
    END. /* Page 0 */
