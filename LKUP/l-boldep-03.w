...
AND CcbCDocu.CodCli = input-var-1 ~
AND CcbCDocu.flgest = input-var-2 ~
AND CcbCDocu.coddoc = 'BD' ~
AND CcbCDocu.flgsit = input-var-3 )

/* &SCOPED-DEFINE CONDICION ( CcbCDocu.CodCia = S-CODCIA */
/* AND CcbCDocu.CodCli BEGINS input-var-1 ~              */
/* AND CcbCDocu.flgest BEGINS input-var-2                */
/* AND CcbCDocu.flgsit BEGINS input-var-3)               */
