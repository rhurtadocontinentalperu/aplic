...
AND AlmCDocu.Libre_c02 = input-var-3
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      AlmCDocu.NroDoc FORMAT "X(20)":U WIDTH 11.57
...
"AlmCDocu.NroDoc" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "11.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AlmCDocu.Libre_c01" "Observaciones" "x(60)" "character" ? ? ? ? ? ? no ? no no "29.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
