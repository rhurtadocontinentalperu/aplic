...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.42 COL 115
     Btn_Cancel AT ROW 4.5 COL 115
     SPACE(5.85) SKIP(12.45)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_l-pl-pers ( 16.42 , 112.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.27 , 115.00 ) NO-ERROR.
