...
AND Almcrepo.CodAlm = input-var-1 ~
AND (input-var-2 = '' OR Almcrepo.TipMov = input-var-2) ~
AND Almcrepo.NroSer = INTEGER(input-var-3)

&SCOPED-DEFINE CODIGO Almcrepo.nrodoc
...
&Scoped-define FIELDS-IN-QUERY-br_table almcrepo.NroSer almcrepo.NroDoc ~
almcrepo.FchDoc almcrepo.FchVto almcrepo.Hora almcrepo.CodAlm ~
Almacen.Descripcion 
...
<SORTBY-OPTIONS>
Almacen|y||INTEGRAL.almcrepo.NroSer|yes,INTEGRAL.almcrepo.NroDoc|yes
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.almcrepo.NroSer
     _FldNameList[2]   = INTEGRAL.almcrepo.NroDoc
     _FldNameList[3]   = INTEGRAL.almcrepo.FchDoc
     _FldNameList[4]   = INTEGRAL.almcrepo.FchVto
     _FldNameList[5]   = INTEGRAL.almcrepo.Hora
     _FldNameList[6]   = INTEGRAL.almcrepo.CodAlm
