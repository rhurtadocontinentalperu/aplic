...
&SCOPED-DEFINE CONDICION ( Di-RutaC.CodCia = s-codcia ~
    AND Di-RutaC.CodDiv = input-var-1 ~
    AND Di-RutaC.CodDoc = input-var-2 ~
    AND Di-RutaC.FlgEst = input-var-3 )

&SCOPED-DEFINE CODIGO Di-RutaC.NroDoc

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Di-RutaC.observ BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Di-RutaC.Observ , FILL-IN-filtro ) <> 0 )
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.DI-RutaC.Observ
Nombres que contengan|y||INTEGRAL.DI-RutaC.Observ
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Numero|y||INTEGRAL.DI-RutaC.CodCia|yes,INTEGRAL.DI-RutaC.CodDoc|yes,INTEGRAL.DI-RutaC.NroDoc|yes
Fecha|||INTEGRAL.DI-RutaC.CodCia|yes,INTEGRAL.DI-RutaC.CodDoc|yes,INTEGRAL.DI-RutaC.FchDoc|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "Numero,Fecha",
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      DI-RutaC.NroDoc COLUMN-LABEL "<<Numero>>" FORMAT "X(9)":U
      DI-RutaC.FchDoc COLUMN-LABEL "<<<Fecha>>>" FORMAT "99/99/9999":U
      DI-RutaC.Observ COLUMN-LABEL "Observaciones" FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 64 BY 8.62
...
"DI-RutaC.NroDoc" "<<Numero>>" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.DI-RutaC.FchDoc
"DI-RutaC.FchDoc" "<<<Fecha>>>" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Numero':U THEN DO:
           &Scope SORTBY-PHRASE BY DI-RutaC.CodCia BY DI-RutaC.CodDoc BY DI-RutaC.NroDoc
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Fecha':U THEN DO:
           &Scope SORTBY-PHRASE BY DI-RutaC.CodCia BY DI-RutaC.CodDoc BY DI-RutaC.FchDoc
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nrodoc.
