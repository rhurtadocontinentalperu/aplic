...
&SCOPED-DEFINE l-lookup h_l-almcdocu-v2
...
DEFINE VARIABLE h_l-almcdocu-v2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-almcdocu-v2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Almacen':U ,
             OUTPUT h_l-almcdocu-v2 ).
       RUN set-position IN h_l-almcdocu-v2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-almcdocu-v2 ( 10.96 , 101.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-almcdocu-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-almcdocu-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-almcdocu-v2 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-almcdocu-v2 , 'AFTER':U ).
    END. /* Page 0 */
