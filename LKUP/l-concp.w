...
&SCOPED-DEFINE CONDICION ( YES ) AND gn-ConCp.TipVta BEGINS TRIM(input-var-1)
&SCOPED-DEFINE CODIGO gn-concp.Codig

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( gn-concp.Nombr BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( gn-concp.Nombr , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES Gn-ConCp

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Gn-ConCp.Codig Gn-ConCp.Nombr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Gn-ConCp WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Gn-ConCp
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Gn-ConCp
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.Gn-ConCp.Nombr
Nombres que contengan|y||INTEGRAL.AC-CMOV.CCosto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.Gn-ConCp.Codig|yes
Descripción|||INTEGRAL.Gn-ConCp.Nombr|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Gn-ConCp"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = INTEGRAL.Gn-ConCp.Codig
     _FldNameList[2]   = INTEGRAL.Gn-ConCp.Nombr
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY Gn-ConCp.Codig
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY Gn-ConCp.Nombr
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
