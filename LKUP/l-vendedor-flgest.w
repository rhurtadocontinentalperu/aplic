...
&SCOPED-DEFINE CONDICION ( gn-ven.CodCia = s-codcia AND LOOKUP(gn-ven.flgest, input-var-1, ':')  > 0 )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.gn-ven.CodVen|yes
Descripción|||INTEGRAL.gn-ven.NomVen|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-ven.CodVen
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-ven.NomVen
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
