...
&SCOPED-DEFINE CONDICION ( almmmatg.codcia = INTEGER(input-var-1) ~
AND almmmatg.catconta[1] = input-var-2 ~
AND almmmatg.tpoart BEGINS input-var-3 )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.Almmmatg.codmat|yes
