...
&SCOPED-DEFINE l-lookup h_l-pedidot
...
DEFINE VARIABLE h_l-pedidot AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* Cotizaciones Vigentes */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-pedidot.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-pedidot ).
       RUN set-position IN h_l-pedidot ( 1.12 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.96 , 70.72 ) */
       ...
       /* Links to SmartLookup h_l-pedidot. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pedidot ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pedidot ,
