...
&SCOPED-DEFINE l-lookup h_l-almmtg
...
DEFINE VARIABLE h_l-almmtg AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-almmtg.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-almmtg ).
       RUN set-position IN h_l-almmtg ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-almmtg. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-almmtg ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-almmtg ,
