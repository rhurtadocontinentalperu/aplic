...
&Scoped-define QUERY-STRING-br_table FOR EACH VtaTabla WHERE ~{&KEY-PHRASE} ~
      ...
      AND almtabla.Tabla = input-var-3 OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaTabla.Llave_c2|yes
Descripción|||INTEGRAL.almtabla.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaTabla,INTEGRAL.almtabla WHERE INTEGRAL.VtaTabla ... ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST OUTER USED"
     _Where[1]         = "{&Condicion}"
     _JoinCode[2]      = "almtabla.Codigo = VtaTabla.Llave_c2"
     _Where[2]         = "almtabla.Tabla = input-var-3"
     _FldNameList[1]   > INTEGRAL.VtaTabla.Llave_c2
"VtaTabla.Llave_c2" "Giro" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaTabla.Llave_c2
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY almtabla.Nombre
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c2
