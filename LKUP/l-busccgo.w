...
DEF SHARED VAR s-CodDoc AS CHARACTER INIT "C/C".
...
&SCOPED-DEFINE CODIGO ccbccgoc.NroDoc
...
&Scoped-define INTERNAL-TABLES CcbCCgoC gn-cob

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table CcbCCgoC.NroDoc CcbCCgoC.CodCob ~
gn-cob.NomCob CcbCCgoC.Fecha CcbCCgoC.FlgEst 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH CcbCCgoC WHERE ~{&KEY-PHRASE} ~
      AND CcbCCgoC.CodCia = s-codcia ~
 AND CcbCCgoC.CodDiv = s-coddiv ~
 AND CcbCCgoC.CodDoc = s-coddoc NO-LOCK, ~
      EACH gn-cob OF CcbCCgoC NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table CcbCCgoC gn-cob
&Scoped-define FIRST-TABLE-IN-QUERY-br_table CcbCCgoC
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.CcbCCgoC.NroDoc
Nombres que contengan|y||INTEGRAL.CcbCCgoC.NroDoc
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbCCgoC.NroDoc COLUMN-LABEL "<<Numero>>"
      CcbCCgoC.CodCob
      gn-cob.NomCob
      CcbCCgoC.Fecha
      CcbCCgoC.FlgEst
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 65.14 BY 8.5
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.CcbCCgoC,INTEGRAL.gn-cob OF INTEGRAL.CcbCCgoC"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "CcbCCgoC.CodCia = s-codcia
 AND CcbCCgoC.CodDiv = s-coddiv
 AND CcbCCgoC.CodDoc = s-coddoc"
     _FldNameList[1]   > INTEGRAL.CcbCCgoC.NroDoc
"CcbCCgoC.NroDoc" "<<Numero>>" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   = INTEGRAL.CcbCCgoC.CodCob
     _FldNameList[3]   = INTEGRAL.gn-cob.NomCob
     _FldNameList[4]   = INTEGRAL.CcbCCgoC.Fecha
     _FldNameList[5]   = INTEGRAL.CcbCCgoC.FlgEst
