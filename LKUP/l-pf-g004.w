...
&SCOPED-DEFINE CONDICION ( PF-G004.Aplic-Id = input-var-1 )
&SCOPED-DEFINE CODIGO PF-G004.User-Id

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( PF-G004.User-Id BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( PF-G004.User-Id , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table PF-G004.User-Id ~
x-User-Name @ x-User-Name 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH PF-G004 WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PF-G004 WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table PF-G004
&Scoped-define FIRST-TABLE-IN-QUERY-br_table PF-G004
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.PF-G004.User-Id
Nombres que contengan|y||INTEGRAL.PF-G004.User-Id
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.PF-G004.User-Id|yes
Descripción|||INTEGRAL.PF-G004.User-Id|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   = INTEGRAL.PF-G004.User-Id
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY PF-G004.User-Id
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.USER-ID
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.USER-ID.
