...
&SCOPED-DEFINE CONDICION ( Lg-Serv.CodDoc = input-var-1 )
&SCOPED-DEFINE CODIGO LG-SERV.codser

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( LG-SERV.desser BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( LG-SERV.desser , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES LG-SERV

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table LG-SERV.codser LG-SERV.desser 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LG-SERV WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table LG-SERV
&Scoped-define FIRST-TABLE-IN-QUERY-br_table LG-SERV
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.LG-SERV.desser
Nombres que contengan|y||INTEGRAL.LG-SERV.desser
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.LG-SERV.codser|yes
Descripción|||INTEGRAL.LG-SERV.desser|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY LG-SERV.codser
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY LG-SERV.desser
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codser
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.desser.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "LG-SERV"}
