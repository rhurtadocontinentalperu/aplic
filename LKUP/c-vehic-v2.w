...
&SCOPED-DEFINE l-lookup h_l-vehic
...
DEFINE VARIABLE h_l-vehic AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-vehic-v2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Placa':U ,
             OUTPUT h_l-vehic ).
       RUN set-position IN h_l-vehic ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-vehic ( 10.92 , 67.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-vehic. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-vehic ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-vehic ,
