...
&SCOPED-DEFINE CONDICION ( Gn-ClieD.CodCia = cl-codcia AND Gn-ClieD.CodCli = input-var-1)
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Gn-ClieD.Sede FORMAT "x(5)":U WIDTH 5.57
...
"Gn-ClieD.Sede" ? ? "character" ? ? ? ? ? ? no ? no no "5.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
