...
&SCOPED-DEFINE l-lookup h_l-boldep-01
...
&Scoped-Define ENABLED-OBJECTS RECT-22 Btn_OK Btn_Cancel 
...
DEFINE VARIABLE h_l-boldep-01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-boldep-01.r':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-boldep-01 ).
       RUN set-position IN h_l-boldep-01 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-boldep-01 ( 10.88 , 100.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-boldep-01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-boldep-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-boldep-01 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-boldep-01 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-22 Btn_OK Btn_Cancel 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
