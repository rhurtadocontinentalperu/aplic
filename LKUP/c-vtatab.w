...
&SCOPED-DEFINE l-lookup h_l-vtatab
...
DEFINE VARIABLE h_l-vtatab AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-vtatab.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-vtatab ).
       RUN set-position IN h_l-vtatab ( 1.00 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-vtatab. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-vtatab ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-vtatab ,
