...
&SCOPED-DEFINE CONDICION AlmSSFami.CodCia = s-codcia ~
AND AlmSSFami.CodFam = input-var-1 ~
    AND AlmSSFami.SubFam = input-var-2

&SCOPED-DEFINE CODIGO AlmSSFami.CodSSFam

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( AlmSSFami.DscSSFam BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( AlmSSFami.DscSSFam , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES AlmSSFami
...
&Scoped-define QUERY-STRING-br_table FOR EACH AlmSSFami WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH AlmSSFami WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table AlmSSFami
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.AlmSSFami.DscSSFam
Nombres que contengan|y||INTEGRAL.AlmSSFami.DscSSFam
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.AlmSSFami.CodSSFam|yes
Descripción|||INTEGRAL.AlmSSFami.DscSSFam|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmSSFami.DscSSFam FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.AlmSSFami"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   > INTEGRAL.AlmSSFami.CodSSFam
"AlmSSFami.CodSSFam" "Código" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSSFami.CodSSFam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSSFami.DscSSFam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codssfam
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.dscssfam.
