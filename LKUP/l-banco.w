...
&SCOPED-DEFINE CONDICION ( AlmTabla.Tabla = "BN" )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almtabla.Tabla|yes,INTEGRAL.almtabla.Nombre|yes
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 39.14 BY 13.96
