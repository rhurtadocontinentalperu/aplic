...
&SCOPED-DEFINE CONDICION ( VtaCTabla.CodCia = s-CodCia AND VtaCTabla.Tabla = "PACKS-ECOMERCE" )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCTabla.Llave COLUMN-LABEL "Articulo" FORMAT "x(8)":U
...
"Llave" "Articulo" "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
