...
&SCOPED-DEFINE l-lookup h_l-cmvto-02
...
DEFINE VARIABLE h_l-cmvto-02 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.38 COL 79.43
     Btn_Cancel AT ROW 8.58 COL 79.43
     SPACE(3.42) SKIP(2.71)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-cmvto-02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cmvto-02 ).
       RUN set-position IN h_l-cmvto-02 ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-cmvto-02 ( 10.92 , 74.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.19 , 77.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-cmvto-02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cmvto-02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cmvto-02 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-cmvto-02 , 'AFTER':U ).
    END. /* Page 0 */
