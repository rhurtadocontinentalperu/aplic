...
&Scoped-define FIELDS-IN-QUERY-br_table LIQU.codmat Almmmatg.DesMat LIQU.UndVta LIQU.CanDes LIQU.PreUni LIQU.ImpLin LIQU.CodRef LIQU.NroRef   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      LIQU.codmat  COLUMN-LABEL "Codigo" FORMAT "X(8)"
      Almmmatg.DesMat                    FORMAT "X(38)"
      LIQU.UndVta  COLUMN-LABEL "Unidad" FORMAT "X(5)"
      LIQU.CanDes                        FORMAT ">>>,>>9.99"
      LIQU.PreUni  COLUMN-LABEL "Precio Unit" FORMAT ">>>,>>9.9999" COLUMN-BGCOLOR 11
      LIQU.ImpLin                        FORMAT ">>>>,>>9.99"
      LIQU.CodRef  COLUMN-LABEL "Ref"    FORMAT "XXXXX"
...
------------------------------------------------------------------------------*/
  ...
  FIND B-LIQU WHERE ROWID(B-LIQU) = ROWID(LIQU) EXCLUSIVE-LOCK NO-ERROR.
  IF AVAILABLE B-LIQU THEN DELETE B-LIQU.
  RELEASE B-LIQU.    
