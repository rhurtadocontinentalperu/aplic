...
&SCOPED-DEFINE CONDICION ( CcbTabla.Tabla = input-var-1 AND CcbTabla.CodCia = s-codcia )
...
CcbTabla.Codcta CcbTabla.Afecto 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbTabla.Codigo
      CcbTabla.Nombre
      CcbTabla.Codcta FORMAT "x(10)"
      CcbTabla.Afecto FORMAT "Si/No"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 50.72 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   > integral.CcbTabla.Codcta
"CcbTabla.Codcta" ? "x(10)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > integral.CcbTabla.Afecto
"CcbTabla.Afecto" ? "Si/No" "logical" ? ? ? ? ? ? no ?
