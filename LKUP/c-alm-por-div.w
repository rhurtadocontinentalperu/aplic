...
&SCOPED-DEFINE l-lookup h_l-alm-por-div
...
DEFINE VARIABLE h_l-alm-por-div AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-alm-por-div.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-alm-por-div ).
       RUN set-position IN h_l-alm-por-div ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-alm-por-div ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-alm-por-div. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-alm-por-div ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-alm-por-div ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-alm-por-div , 'AFTER':U ).
    END. /* Page 0 */
