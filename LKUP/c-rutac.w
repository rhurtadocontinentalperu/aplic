...
&SCOPED-DEFINE l-lookup h_l-rutac
...
DEFINE VARIABLE h_l-rutac AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-rutac.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Numero':U ,
             OUTPUT h_l-rutac ).
       RUN set-position IN h_l-rutac ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 66.00 ) */
       ...
       /* Links to SmartLookup h_l-rutac. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-rutac ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-rutac ,
