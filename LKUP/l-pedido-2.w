...
&SCOPED-DEFINE CONDICION ( FacCPedi.CodCia = 1 AND ~
                           FacCPedi.CodDoc = "PED"  AND ~
                           FacCPedi.FlgEst = "P" AND ~
                           FacCPedi.FlgSit = "X" AND ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 54.14 BY 8.65
...
DEFINE FRAME F-Main
     FILL-IN-codigo AT ROW 1.27 COL 23 COLON-ALIGNED
