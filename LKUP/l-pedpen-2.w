...
FacCPedi.FlgEst = input-var-3 )

&SCOPED-DEFINE CODIGO FacCPedi.NroPed 

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( FacCPedi.Glosa BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( FacCPedi.Glosa , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table FacCPedi.NroPed gn-clie.NomCli ~
FacCPedi.FchPed C-MON @ C-MON FacCPedi.ImpTot FacCPedi.Hora 
