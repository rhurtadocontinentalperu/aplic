...
&SCOPED-DEFINE l-lookup h_l-trfsal
...
DEFINE VARIABLE h_l-trfsal AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-salmat.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-trfsal ).
       RUN set-position IN h_l-trfsal ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 76.57 ) */
       ...
       /* Links to SmartLookup h_l-trfsal. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-trfsal ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-trfsal ,
