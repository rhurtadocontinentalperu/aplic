...
&SCOPED-DEFINE l-lookup h_l-unidad
...
DEFINE VARIABLE h_l-unidad AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-unidad-activa.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-unidad ).
       RUN set-position IN h_l-unidad ( 1.15 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-unidad ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-unidad. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-unidad ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-unidad ,
