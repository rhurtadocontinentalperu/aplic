...
&SCOPED-DEFINE CONDICION ( Ccbcdocu.CodCia = S-CODCIA AND ~
                           Ccbcdocu.CodDoc = input-var-1 AND ~
                           Ccbcdocu.CodDiv = S-CODDIV  AND ~
                           Ccbcdocu.TpoFac = input-var-2 AND ~
                           Ccbcdocu.NroDoc BEGINS input-var-3 )
...
CcbCDocu.FchDoc CcbCDocu.NomCli CcbCDocu.ImpTot 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 71.14 BY 8.65
