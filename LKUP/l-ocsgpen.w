...
&SCOPED-DEFINE CONDICION ( LG-COCmp.CodCia = S-CODCIA AND LG-COCmp.TpoDoc = "N" ~
AND LG-COCmp.CodDiv = S-CODDIV ~
AND LG-COCmp.CodAlm = S-CODALM AND LOOKUP(LG-COCmp.FlgSit,input-var-1) = 0 AND LG-COCMP.ModAdq = "CR")
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LG-COCmp.NroDoc COLUMN-LABEL "Numero!O/C"
      LG-COCmp.NroReq COLUMN-LABEL "No.Requ."
      LG-COCmp.NomPro
      LG-COCmp.CodAlm COLUMN-LABEL "Solicitante"
      LG-COCmp.FchEnt COLUMN-LABEL "     Fecha    !    Entrega"
      LG-COCmp.FchVto COLUMN-LABEL "       Fecha    !     Máxima"
