...
&SCOPED-DEFINE l-lookup h_l-clista
...
DEFINE VARIABLE h_l-clista AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-clista.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-clista ).
       RUN set-position IN h_l-clista ( 1.19 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-clista. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-clista ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-clista ,
