...
&SCOPED-DEFINE CONDICION ( CcbCDocu.CodCia = S-CODCIA  AND CcbCDocu.CodDoc = "FAC" AND CcbCDocu.FlgEst <> "A" and CcbCDocu.CodCli BEGINS input-var-1)
...
DEFINE FRAME F-Main
     ...
     "Buscar x" VIEW-AS TEXT
          SIZE 8.43 BY .54 AT ROW 1.42 COL 8.43
          FONT 6
...
DO:
    ...
    C-NROGUI = STRING(INPUT FILL-IN-codigo,"999999999").
