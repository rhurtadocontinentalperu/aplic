...
&SCOPED-DEFINE CONDICION ( Vtamcanal.Codcia = s-codcia )
&SCOPED-DEFINE CODIGO Vtamcanal.CanalVenta

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Vtamcanal.Descrip BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Vtamcanal.Descrip , FILL-IN-filtro ) <> 0 )
...
&Scoped-define QUERY-STRING-br_table FOR EACH Vtamcanal WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Vtamcanal WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.cb-tabl.Nombre
Nombres que contengan|y||integral.cb-tabl.Nombre
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.cb-tabl.Tabla|yes,integral.cb-tabl.Codigo|yes
Descripción|||integral.cb-tabl.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY cb-tabl.Tabla BY cb-tabl.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY cb-tabl.Nombre
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CanalVenta
