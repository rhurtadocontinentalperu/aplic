...
&SCOPED-DEFINE l-lookup h_l-ssfami
...
DEFINE VARIABLE h_l-ssfami AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-ssfami.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-ssfami ).
       RUN set-position IN h_l-ssfami ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-ssfami ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-ssfami. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-ssfami ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-ssfami ,
