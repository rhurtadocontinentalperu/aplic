...
&SCOPED-DEFINE l-lookup h_l-otr
...
DEFINE VARIABLE h_l-otr AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-otr.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-otr ).
       RUN set-position IN h_l-otr ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-otr ( 10.92 , 76.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-otr. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-otr ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-otr ,
