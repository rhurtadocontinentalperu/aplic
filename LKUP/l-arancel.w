...
&SCOPED-DEFINE CONDICION ( ImArancel.CodCia = S-CODCIA OR ImArancel.CodCia = 0 )
&SCOPED-DEFINE CODIGO ImArancel.PartAran

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( ImArancel.Descrip BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( ImArancel.Descrip , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table ImArancel.PartAran ~
ImArancel.Descrip ImArancel.Pais ImArancel.Advalorem 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH ImArancel WHERE ~{&KEY-PHRASE} NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS RECT-1 br_table FILL-IN-codigo CMB-filtro ~
FILL-IN-filtro 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.ImArancel.Descrip
Nombres que contengan|y||INTEGRAL.ImArancel.Descrip
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.ImArancel.CodCia|yes,INTEGRAL.ImArancel.PartAran|yes
Descripción|||INTEGRAL.ImArancel.Descrip|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
DEFINE VARIABLE FILL-IN-codigo AS CHARACTER FORMAT "X(16)":U 
     LABEL "Código" 
     VIEW-AS FILL-IN 
     SIZE 17.14 BY .81
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ImArancel.PartAran FORMAT "X(17)"
      ImArancel.Descrip FORMAT "X(40)"
      ImArancel.Pais FORMAT "x(24)"
      ImArancel.Advalorem
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 74.14 BY 13.96
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.ImArancel"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > INTEGRAL.ImArancel.PartAran
"ImArancel.PartAran" ? "X(17)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > INTEGRAL.ImArancel.Descrip
"ImArancel.Descrip" ? "X(40)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.ImArancel.Pais
"ImArancel.Pais" ? "x(24)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   = INTEGRAL.ImArancel.Advalorem
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY ImArancel.CodCia BY ImArancel.PartAran
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY ImArancel.Descrip
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.PartAran
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Descrip.
