...
&Scoped-define FIELDS-IN-QUERY-br_table almcrepo.FchDoc almcrepo.FchVto ~
almcrepo.Hora almcrepo.CodAlm Almacen.Descripcion almcrepo.NroSer ~
almcrepo.NroDoc 
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.almcrepo.FchDoc
     _FldNameList[2]   = INTEGRAL.almcrepo.FchVto
     _FldNameList[3]   = INTEGRAL.almcrepo.Hora
