...
&SCOPED-DEFINE l-lookup h_l-vales
...
DEFINE VARIABLE h_l-vales AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-vales.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-vales ).
       RUN set-position IN h_l-vales ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-vales ( 10.92 , 59.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-vales. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-vales ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-vales ,
