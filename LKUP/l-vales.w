...
/* &SCOPED-DEFINE CONDICION (VtaVales.CodCia = S-CODCIA AND ~ */
/* VtaVales.CodDiv = input-var-1 )                            */

&SCOPED-DEFINE CONDICION (VtaVales.CodCia = S-CODCIA )


&SCOPED-DEFINE CODIGO VtaVales.NroDoc

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaVales.Benef01 BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX (  VtaVales.Benef01 , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES VtaVales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table VtaVales.NroDoc VtaVales.DNIBnf01 ~
VtaVales.Benef01 VtaVales.DNIBnf02 VtaVales.Benef02 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH VtaVales WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH VtaVales WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table VtaVales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table VtaVales
...
<SORTBY-OPTIONS>
Código|y||integral.Almcmov.NroDoc|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaVales.NroDoc FORMAT "X(15)":U
      VtaVales.DNIBnf01 FORMAT "x(8)":U
      VtaVales.Benef01 FORMAT "x(50)":U
      VtaVales.DNIBnf02 FORMAT "x(8)":U
      VtaVales.Benef02 FORMAT "x(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 57.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.VtaVales"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.VtaVales.NroDoc
     _FldNameList[2]   = INTEGRAL.VtaVales.DNIBnf01
     _FldNameList[3]   = INTEGRAL.VtaVales.Benef01
     _FldNameList[4]   = INTEGRAL.VtaVales.DNIBnf02
     _FldNameList[5]   = INTEGRAL.VtaVales.Benef02
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY Almcmov.NroDoc
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Benef01.
