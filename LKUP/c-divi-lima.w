...
&SCOPED-DEFINE l-lookup h_l-divi-lima
...
DEFINE VARIABLE h_l-divi-lima AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-divi-lima.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-divi-lima ).
       RUN set-position IN h_l-divi-lima ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-divi-lima ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-divi-lima. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-divi-lima ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-divi-lima ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-divi-lima , 'AFTER':U ).
    END. /* Page 0 */
