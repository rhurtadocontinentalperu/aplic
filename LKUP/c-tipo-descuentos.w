...
&SCOPED-DEFINE l-lookup h_l-eventos
...
DEFINE VARIABLE h_l-eventos AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-tipo-descuentos.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-eventos ).
       RUN set-position IN h_l-eventos ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-eventos ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-eventos. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-eventos ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-eventos ,
