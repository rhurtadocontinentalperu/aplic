...
&SCOPED-DEFINE l-lookup h_l-famili02
...
&Scoped-Define ENABLED-OBJECTS RECT-16 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-famili02 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 4.5 COL 48
     Btn_Cancel AT ROW 7 COL 48
     Btn_Help AT ROW 9.46 COL 48
     RECT-16 AT ROW 3.31 COL 45.72
     SPACE(0.55) SKIP(0.21)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-famili02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-famili02 ).
       RUN set-position IN h_l-famili02 ( 1.15 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 43.57 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.19 , 45.43 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-famili02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-famili02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-famili02 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-famili02 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-16 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
