...
&SCOPED-DEFINE l-lookup h_l-condlt
...
DEFINE VARIABLE h_l-condlt AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.85 COL 49.72
     Btn_Cancel AT ROW 6.46 COL 49.72
     RECT-26 AT ROW 3.15 COL 47.72
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-condlt.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-condlt ).
       RUN set-position IN h_l-condlt ( 1.04 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.31 , 46.43 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.08 , 47.57 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-condlt. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-condlt ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-condlt ,
