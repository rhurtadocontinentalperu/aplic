...
&SCOPED-DEFINE l-lookup h_l-trfsal-v2
...
DEFINE VARIABLE h_l-trfsal-v2 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 12.27 COL 26.57
     Btn_Cancel AT ROW 12.27 COL 44.57
     Btn_Help AT ROW 12.27 COL 61.86
     SPACE(4.56) SKIP(0.30)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-trfsal-v2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-trfsal-v2 ).
       RUN set-position IN h_l-trfsal-v2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-trfsal-v2 ( 10.92 , 76.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 12.00 , 3.14 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 15.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-trfsal-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-trfsal-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-trfsal-v2 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-trfsal-v2 , 'AFTER':U ).
    END. /* Page 0 */
