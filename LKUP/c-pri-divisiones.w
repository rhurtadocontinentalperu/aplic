...
&SCOPED-DEFINE l-lookup h_l-pri-divisiones
...
DEFINE VARIABLE h_l-pri-divisiones AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-pri-divisiones.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-pri-divisiones ).
       RUN set-position IN h_l-pri-divisiones ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-pri-divisiones ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pri-divisiones. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pri-divisiones ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pri-divisiones ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-pri-divisiones , 'AFTER':U ).
    END. /* Page 0 */
