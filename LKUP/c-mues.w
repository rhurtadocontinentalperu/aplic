...
&SCOPED-DEFINE l-lookup h_l-mues
...
DEFINE VARIABLE h_l-mues AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.69 COL 58
     Btn_Cancel AT ROW 5.81 COL 58
     SPACE(0.85) SKIP(5.26)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-mues.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-mues ).
       RUN set-position IN h_l-mues ( 1.38 , 1.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-option ( 1.77 , 11.29 ) NO-ERROR.

       /* Links to SmartLookup h_l-mues. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-mues ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-mues ,
