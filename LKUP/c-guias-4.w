...
&SCOPED-DEFINE l-lookup h_l-guias-4
...
DEFINE VARIABLE h_l-guias-4 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 12.35 COL 31.29
     Btn_Cancel AT ROW 12.35 COL 49.43
     Btn_Help AT ROW 12.35 COL 67
     SPACE(8.56) SKIP(0.45)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-guias-4.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = No.Pedido':U ,
             OUTPUT h_l-guias-4 ).
       RUN set-position IN h_l-guias-4 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-guias-4 ( 10.92 , 86.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-option ( 2.15 , 14.00 ) NO-ERROR.

       /* Links to SmartLookup h_l-guias-4. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-guias-4 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-guias-4 ,
