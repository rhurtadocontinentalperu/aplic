...
&SCOPED-DEFINE l-lookup h_l-lettra
...
DEFINE VARIABLE h_l-lettra AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-lettra.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-lettra ).
       RUN set-position IN h_l-lettra ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-lettra. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-lettra ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-lettra ,
