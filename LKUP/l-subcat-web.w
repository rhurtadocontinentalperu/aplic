...
&SCOPED-DEFINE CONDICION ( almtabla.Tabla = "WCLF" AND almtabla.NomAnt = "2" )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almtabla.Codigo|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      almtabla.Codigo FORMAT "x(10)":U WIDTH 8.57
...
"almtabla.Codigo" ? "x(10)" "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY almtabla.Codigo
