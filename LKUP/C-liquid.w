...
&SCOPED-DEFINE l-lookup h_l-liquid
...
DEFINE VARIABLE h_l-liquid AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-liquid.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Liquidacion':U ,
             OUTPUT h_l-liquid ).
       RUN set-position IN h_l-liquid ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 86.00 ) */
       ...
       /* Links to SmartLookup h_l-liquid. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-liquid ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-liquid ,
