...
&SCOPED-DEFINE l-lookup h_l-promotor
...
DEFINE VARIABLE h_l-promotor AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-promotor.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Libre_c01':U ,
             OUTPUT h_l-promotor ).
       RUN set-position IN h_l-promotor ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-promotor ( 15.58 , 76.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-promotor. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-promotor ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-promotor ,
