...
&SCOPED-DEFINE CONDICION ( Almacen.codcia = s-codcia AND Almacen.coddiv = input-var-1 )
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.Almacen.CodAlm|yes
Descripción|||INTEGRAL.Almacen.Descripcion|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
