...
&SCOPED-DEFINE l-lookup h_l-movalm-02
...
DEFINE VARIABLE h_l-movalm-02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-movalm-02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-movalm-02 ).
       RUN set-position IN h_l-movalm-02 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-movalm-02 ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-movalm-02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-movalm-02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-movalm-02 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-movalm-02 , 'AFTER':U ).
    END. /* Page 0 */
