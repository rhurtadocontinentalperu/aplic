...
AND VtaCDocu.CodPed = input-var-1 ~
AND VtaCDocu.NroPed BEGINS input-var-2 ~
AND VtaCDocu.FchPed >= (TODAY - INTEGER(input-var-3)) )

&SCOPED-DEFINE CODIGO CodCli

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaCDocu.NomCli BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VtaCDocu.NomCli , FILL-IN-filtro ) <> 0 )
...
VtaCDocu.NroPed VtaCDocu.FchPed 
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaCDocu.CodCli|yes
Descripción|||INTEGRAL.VtaCDocu.NomCli|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.NomCli FORMAT "x(60)":U WIDTH 48
      VtaCDocu.NroPed COLUMN-LABEL "Numero" FORMAT "X(12)":U WIDTH 12.43
      VtaCDocu.FchPed COLUMN-LABEL "Fecha" FORMAT "99/99/9999":U
            WIDTH 7.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88.14 BY 8.62
...
"VtaCDocu.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "48" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCDocu.NroPed
"VtaCDocu.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaCDocu.FchPed
"VtaCDocu.FchPed" "Fecha" "99/99/9999" "date" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* Buscar el Cliente */
DO:
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCDocu.CodCli
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY VtaCDocu.NomCli
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
