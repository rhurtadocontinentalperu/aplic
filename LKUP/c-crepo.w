...
&SCOPED-DEFINE l-lookup h_l-crepo
...
DEFINE VARIABLE h_l-crepo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-crepo.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Almacen':U ,
             OUTPUT h_l-crepo ).
       RUN set-position IN h_l-crepo ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-crepo ( 10.96 , 77.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-crepo. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-crepo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-crepo ,
