...
&SCOPED-DEFINE l-lookup h_l-listpr3
...
&Scoped-Define ENABLED-OBJECTS RECT-23 Btn_OK Btn_Cancel Btn_Help 
...
DEFINE VARIABLE h_l-listpr3 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 14.19 COL 59
     Btn_Cancel AT ROW 14.19 COL 69.72
     Btn_Help AT ROW 14.19 COL 80.14
     "F8 : Consulta de Stocksde Otros Almacenes" VIEW-AS TEXT
          SIZE 39 BY .65 AT ROW 16.62 COL 41 WIDGET-ID 2
          FONT 6
     RECT-23 AT ROW 13.69 COL 1
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-listpr3.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Familia':U ,
             OUTPUT h_l-listpr3 ).
       RUN set-position IN h_l-listpr3 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-listpr3 ( 12.65 , 91.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-detart ).
       RUN set-position IN h_v-detart ( 13.85 , 1.86 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 14.27 , 39.14 ) NO-ERROR.
       RUN set-size IN h_p-option ( 2.00 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-listpr3. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-listpr3 ).

       /* Links to SmartViewer h_v-detart. */
       RUN add-link IN adm-broker-hdl ( h_l-listpr3 , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-listpr3 ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-23 Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME C-Dialog.
  VIEW FRAME C-Dialog.
