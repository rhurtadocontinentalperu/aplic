...
&SCOPED-DEFINE CONDICION ( INDEX ( gn-convt.Nombr , "LETRA" ) <> 0  )
&SCOPED-DEFINE CODIGO gn-convt.Codig

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( gn-convt.Nombr BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( gn-convt.Nombr , FILL-IN-filtro ) <> 0 )
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.gn-ConVt.Nombr
Nombres que contengan|y||integral.gn-ConVt.Nombr
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.gn-ConVt.Codig|yes
Descripción|||integral.gn-ConVt.Nombr|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 45 BY 9
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-ConVt.Codig
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-ConVt.Nombr
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codig
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nombr.
