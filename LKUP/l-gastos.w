...
&SCOPED-DEFINE CODIGO PR-GASTOS.CodGas

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( PR-GASTOS.Desgas BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( PR-GASTOS.Desgas , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES PR-GASTOS

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table PR-GASTOS.CodGas PR-GASTOS.Desgas 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PR-GASTOS WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table PR-GASTOS
&Scoped-define FIRST-TABLE-IN-QUERY-br_table PR-GASTOS
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PR-GASTOS.CodGas COLUMN-LABEL "Codigo" FORMAT "X(8)"
      PR-GASTOS.Desgas COLUMN-LABEL "Descripcion"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 47.14 BY 13.19
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "integral.PR-GASTOS"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _FldNameList[1]   > integral.PR-GASTOS.CodGas
"CodGas" "Codigo" "X(8)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.PR-GASTOS.Desgas
"Desgas" "Descripcion" ? "character" ? ? ? ? ? ? no ?
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.desgas.
