...
&SCOPED-DEFINE CONDICION ( TabTrkDocs.CodCia = s-codcia AND ~
TabTrkDocs.Clave = input-var-1 )

&SCOPED-DEFINE CODIGO TabTrkDocs.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( TabTrkDocs.NomCorto BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( TabTrkDocs.NomCorto , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table TabTrkDocs.Codigo ~
TabTrkDocs.NomCorto 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.TabTrkDocs.Codigo
Nombres que contengan|y||INTEGRAL.TabTrkDocs.Codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.TabTrkDocs.Codigo|yes
Descripción|||INTEGRAL.TabTrkDocs.NomCorto|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      TabTrkDocs.Codigo FORMAT "x(15)":U WIDTH 8.57
      TabTrkDocs.NomCorto COLUMN-LABEL "Nombre" FORMAT "x(30)":U
            WIDTH 35.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   > INTEGRAL.TabTrkDocs.Codigo
"TabTrkDocs.Codigo" ? "x(15)" "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.TabTrkDocs.NomCorto
"TabTrkDocs.NomCorto" "Nombre" "x(30)" "character" ? ? ? ? ? ? no ? no no "35.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY TabTrkDocs.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY TabTrkDocs.NomCorto
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nomcorto.
