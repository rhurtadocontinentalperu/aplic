...
&SCOPED-DEFINE l-lookup h_l-sacadores
...
DEFINE VARIABLE h_l-sacadores AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 4.77 COL 81.57
     Btn_Cancel AT ROW 7.23 COL 81.57
     Btn_Help AT ROW 9.62 COL 81.57
     RECT-2 AT ROW 4.04 COL 79.14
     SPACE(1.56) SKIP(0.29)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-sacadores.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-sacadores ).
       RUN set-position IN h_l-sacadores ( 1.04 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-sacadores ( 10.92 , 77.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.58 , 79.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-sacadores. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-sacadores ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-sacadores ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-sacadores , 'AFTER':U ).
    END. /* Page 0 */
