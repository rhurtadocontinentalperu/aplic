...
&SCOPED-DEFINE l-lookup h_l-matcbd
...
DEFINE VARIABLE h_l-matcbd AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-matcbd.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-matcbd ).
       RUN set-position IN h_l-matcbd ( 1.19 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-matcbd. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-matcbd ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-matcbd ,
