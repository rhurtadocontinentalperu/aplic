...
&SCOPED-DEFINE CONDICION VtaTabla.CodCia = s-codcia AND VtaTabla.Tabla = input-var-1
&SCOPED-DEFINE CODIGO VtaTabla.Llave_c1

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( VtaTabla.Llave_c2 BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( VtaTabla.Llave_c2 , FILL-IN-filtro ) <> 0 )
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.VtaTabla.Llave_c2
Nombres que contengan|y||INTEGRAL.VtaTabla.Llave_c2
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.VtaTabla.Llave_c1|yes
Descripción|||INTEGRAL.VtaTabla.Llave_c2|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "RUC" FORMAT "x(11)":U WIDTH 10.57
      VtaTabla.Llave_c2 COLUMN-LABEL "Razón Social" FORMAT "x(30)":U
            WIDTH 38.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VtaTabla.Llave_c1" "RUC" "x(11)" "character" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Llave_c2
"VtaTabla.Llave_c2" "Razón Social" "x(30)" "character" ? ? ? ? ? ? no ? no no "38.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.llave_c2.
