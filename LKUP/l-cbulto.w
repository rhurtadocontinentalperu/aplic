...
AND Ccbcbult.coddoc = input-var-1 ~
AND Ccbcbult.coddiv = input-var-2

&SCOPED-DEFINE CODIGO Ccbcbult.nrodoc 

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( ccbcbult.nomcli BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( ccbcbult.nomcli , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES CcbCBult
...
CcbCBult.NomCli CcbCBult.Bultos 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table CcbCBult.NomCli 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table CcbCBult
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table CcbCBult
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH CcbCBult WHERE ~{&KEY-PHRASE} ~
      AND {&condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table CcbCBult
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCBult.NroDoc FORMAT "X(9)":U
      CcbCBult.NomCli FORMAT "x(35)":U
      CcbCBult.Bultos FORMAT ">>9":U
  ENABLE
      CcbCBult.NomCli
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 63.14 BY 8.62
...
"CcbCBult.NomCli" ? "x(35)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = INTEGRAL.CcbCBult.Bultos
