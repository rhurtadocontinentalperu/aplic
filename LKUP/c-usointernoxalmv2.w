...
&SCOPED-DEFINE l-lookup h_l-usointernoxalmv2
...
DEFINE VARIABLE h_l-usointernoxalmv2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'LKUP/l-usointernoxalmv2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Almacen':U ,
             OUTPUT h_l-usointernoxalmv2 ).
       RUN set-position IN h_l-usointernoxalmv2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-usointernoxalmv2 ( 11.15 , 137.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-usointernoxalmv2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-usointernoxalmv2 ).

       /* Links to SmartBrowser h_busointerno. */
       RUN add-link IN adm-broker-hdl ( h_l-usointernoxalmv2 , 'Record':U , h_busointerno ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-usointernoxalmv2 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-usointernoxalmv2 , 'AFTER':U ).
