...
&SCOPED-DEFINE CONDICION ( Gn-ClieD.CodCia = cl-codcia AND Gn-ClieD.CodCli = input-var-1 AND Gn-ClieD.Sede <> '@@@')
&SCOPED-DEFINE CODIGO Gn-ClieD.Sede

/* Preprocesadores para cada campo filtro */
DEF VAR LocalCadena AS CHAR.
DEF VAR LocalOrden AS INTE.

&SCOPED-DEFINE FILTRO1 ( Gn-ClieD.DirCli BEGINS FILL-IN-filtro )
/*&SCOPED-DEFINE FILTRO2 ( INDEX ( Gn-ClieD.DirCli , FILL-IN-filtro ) <> 0 )*/
&SCOPED-DEFINE FILTRO2 ( Gn-ClieD.DirCli CONTAINS LocalCadena )
...
&Scoped-define FIELDS-IN-QUERY-br_table Gn-ClieD.Sede Gn-ClieD.DirCli 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Gn-ClieD WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Gn-ClieD WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Gn-ClieD"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   = INTEGRAL.Gn-ClieD.Sede
     _FldNameList[2]   = INTEGRAL.Gn-ClieD.DirCli
...
DO:
    ...
    CASE CMB-filtro:
        WHEN "Nombres que contengan" THEN DO:
            /* Limpia cadena de caracteres */
            DEF VAR xLocalCadena AS CHAR NO-UNDO.
            RUN lib/limpiar-texto-contains (FILL-IN-filtro, " ", OUTPUT xLocalCadena).
            LocalCadena = "".
            DO LocalOrden = 1 TO NUM-ENTRIES(xLocalCadena, " "):
                LocalCadena = LocalCadena + (IF TRUE <> (LocalCadena > '') THEN "" ELSE " ") + 
                    TRIM(ENTRY(LocalOrden,xLocalCadena, " ")) + "*".
            END.
        END.
    END CASE.
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.sede
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.dircli.
