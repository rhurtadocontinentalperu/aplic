...
&SCOPED-DEFINE CONDICION ( LogisConsolidaHpk.CodCia = s-CodCia )
&SCOPED-DEFINE CODIGO LogisConsolidaHpk.Caso

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( LogisConsolidaHpk.Sectores BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( LogisConsolidaHpk.Sectores , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES LogisConsolidaHpk

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table LogisConsolidaHpk.Caso ~
LogisConsolidaHpk.CodAlm LogisConsolidaHpk.Sectores 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH LogisConsolidaHpk WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LogisConsolidaHpk WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table LogisConsolidaHpk
&Scoped-define FIRST-TABLE-IN-QUERY-br_table LogisConsolidaHpk
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.LogisConsolidaHpk.Sectores
Nombres que contengan|y||INTEGRAL.LogisConsolidaHpk.Sectores
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.LogisConsolidaHpk.Caso|yes
Descripción|||INTEGRAL.LogisConsolidaHpk.Sectores|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LogisConsolidaHpk.Caso FORMAT "->,>>>,>>9":U
      LogisConsolidaHpk.CodAlm FORMAT "x(8)":U
      LogisConsolidaHpk.Sectores FORMAT "x(256)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 72.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.LogisConsolidaHpk"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&Condicion}"
     _FldNameList[1]   = INTEGRAL.LogisConsolidaHpk.Caso
     _FldNameList[2]   = INTEGRAL.LogisConsolidaHpk.CodAlm
     _FldNameList[3]   = INTEGRAL.LogisConsolidaHpk.Sectores
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY LogisConsolidaHpk.Caso
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY LogisConsolidaHpk.Sectores
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = STRING( {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.caso )
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.sectores.
