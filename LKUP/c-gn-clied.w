...
&SCOPED-DEFINE l-lookup h_l-gn-clied
...
DEFINE VARIABLE h_l-gn-clied AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-gn-clied.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-gn-clied ).
       RUN set-position IN h_l-gn-clied ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-gn-clied ( 10.92 , 54.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-gn-clied. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-gn-clied ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-gn-clied ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-gn-clied , 'AFTER':U ).
    END. /* Page 0 */
