...
&SCOPED-DEFINE CONDICION ( vtatabla.codcia = S-CODCIA ~
                            ...
                            AND (input-var-2 = "" OR input-var-2 = "*" OR vtatabla.libre_c02 = "AMBOS" OR vtatabla.libre_c02 = input-var-2))
...
<FOREIGN-KEYS>
Nombres que inicien con|y||integral.GN-DIVI.DesDiv
Nombres que contengan|y||integral.GN-DIVI.DesDiv
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||integral.GN-DIVI.CodCia|yes,integral.GN-DIVI.CodDiv|yes
Descripción|||integral.GN-DIVI.CodCia|yes,integral.GN-DIVI.DesDiv|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "Codigo!Tipo descuento" FORMAT "x(20)":U
            WIDTH 17.57
      VtaTabla.Libre_c01 COLUMN-LABEL "Descripcion" FORMAT "x(80)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VtaTabla.Llave_c1" "Codigo!Tipo descuento" "x(20)" "character" ? ? ? ? ? ? no ? no no "17.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Libre_c01
"VtaTabla.Libre_c01" "Descripcion" "x(80)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY GN-DIVI.CodCia BY GN-DIVI.CodDiv
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY GN-DIVI.CodCia BY GN-DIVI.DesDiv
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.libre_c01.
