...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.CodAlm COLUMN-LABEL "Despacha" FORMAT "x(8)":U
      FacCPedi.CodCli COLUMN-LABEL "Solicitante" FORMAT "x(8)":U
      FacCPedi.NomCli FORMAT "x(100)":U WIDTH 44.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"FacCPedi.CodAlm" "Despacha" "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
