...
&SCOPED-DEFINE l-lookup h_l-precom
...
DEFINE VARIABLE h_l-precom AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 12.5 COL 23.72
     Btn_Cancel AT ROW 12.5 COL 38.57
     Btn_Help AT ROW 12.5 COL 51.57
     SPACE(5.56) SKIP(0.45)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-precom.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Familia':U ,
             OUTPUT h_l-precom ).
       RUN set-position IN h_l-precom ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 67.72 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 12.31 , 1.72 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-precom. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-precom ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-precom ,
