...
&SCOPED-DEFINE l-lookup h_l-divis02
...
DEFINE VARIABLE h_l-divis02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-divis02.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-divis02 ).
       RUN set-position IN h_l-divis02 ( 1.19 , 1.57 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-divis02. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-divis02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-divis02 ,
