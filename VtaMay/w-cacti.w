...
&Scoped-Define ENABLED-OBJECTS RECT-11 RECT-49 BUTTON-2 BUTTON-1 BUTTON-6 ~
BUTTON-3 
...
DEFINE BUTTON BUTTON-6 
     IMAGE-UP FILE "img/envelope.bmp":U
     LABEL "Button 6" 
     SIZE 5 BY 1.35 TOOLTIP "Imprimir sobres de invitaciones".
...
DEFINE FRAME F-Main
     ...
     BUTTON-6 AT ROW 1 COL 93 WIDGET-ID 2
     BUTTON-3 AT ROW 23.88 COL 38
     "Observaciones de ventas" VIEW-AS TEXT
          SIZE 18 BY .5 AT ROW 19.08 COL 3
          BGCOLOR 1 FGCOLOR 15 
     RECT-11 AT ROW 2.54 COL 2
     RECT-49 AT ROW 19.27 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 102.14 BY 24.27
         FONT 4.
...
DO:
  RUN Imprimir-Sobres IN h_v-cacti.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/v-cacti.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cacti ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/b-dacti.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-dacti ).
       RUN set-position IN h_b-dacti ( 6.19 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-obsvta ).
       RUN set-position IN h_v-obsvta ( 19.65 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.65 , 69.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/q-cacti.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-cacti ).
       RUN set-position IN h_q-cacti ( 23.50 , 81.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-dacti , 'Record':U , h_v-obsvta ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 23.69 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-11 RECT-49 BUTTON-2 BUTTON-1 BUTTON-6 BUTTON-3 
...
------------------------------------------------------------------------------*/
  ...
  IF  s-user-id BEGINS 'PSL' OR s-user-id BEGINS 'CAA'
  THEN BUTTON-2:VISIBLE IN FRAME {&FRAME-NAME} = YES.
  ELSE BUTTON-2:VISIBLE IN FRAME {&FRAME-NAME} = NO.
