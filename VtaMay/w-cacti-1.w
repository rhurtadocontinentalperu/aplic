...
&Scoped-Define ENABLED-OBJECTS RECT-11 BUTTON-1 BUTTON-6 
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 21
     BUTTON-6 AT ROW 1 COL 26 WIDGET-ID 2
     RECT-11 AT ROW 2.54 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 111.29 BY 24.27
         FONT 4.
...
ON END-ERROR OF W-Win /* IMPRESION DE SOBRES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* IMPRESION DE SOBRES */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/b-dacti-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-dacti-1 ).
       RUN set-position IN h_b-dacti-1 ( 6.19 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-cacti ).
       RUN set-position IN h_q-cacti ( 2.62 , 91.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cacti , 'Record':U , h_b-dacti-1 ).
...
------------------------------------------------------------------------------*/
  ENABLE RECT-11 BUTTON-1 BUTTON-6 
