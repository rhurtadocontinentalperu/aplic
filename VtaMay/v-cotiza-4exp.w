...
chWorkSheet:Range("A10:I10"):Font:Bold = TRUE.
...
chWorkSheet:Range("F10"):Value = "% Dscto".
chWorkSheet:Range("G10"):Value = "Precio".
chWorkSheet:Range("H10"):Value = "Cantidad".
...
FOR EACH FacDPedi OF FacCPedi BY FacDPedi.NroItm :
    ...
    cRange = "F" + cColumn.
    chWorkSheet:Range(cRange):Value = FacDPedi.Por_Dsctos[1].
    cRange = "G" + cColumn.
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      ASSIGN 
          FacCPedi.UsrSac = "*"     /* COntrol Oct 2010 */
...
------------------------------------------------------------------------------*/
  ...
  IF FacCorre.FlgEst = NO THEN DO:
      ...
      RETURN 'ADM-ERROR'.
  END.
  /* RHC 10.01.2011 control expo oct 2010 */
  IF Faccpedi.fchped >= 01/01/2011 AND Faccpedi.UsrSac <> '*' THEN DO:
      MESSAGE 'Acceso denegado' SKIP 'No pertenece al evento de oct del 2010'
          VIEW-AS ALERT-BOX WARNING.
      RETURN "ADM-ERROR".
  END.
  /* ************************************ */
