...
Faccpedm.NomCli Faccpedm.TpoCmb Faccpedm.RucCli Faccpedm.fchven ~
Faccpedm.NroCard Faccpedm.ordcmp Faccpedm.DirCli Faccpedm.Cmpbnte ~
Faccpedm.CodVen Faccpedm.CodMon Faccpedm.FmaPgo Faccpedm.Glosa ~
Faccpedm.Atencion 
&Scoped-define ENABLED-TABLES Faccpedm
&Scoped-define FIRST-ENABLED-TABLE Faccpedm
&Scoped-Define ENABLED-OBJECTS RECT-21 
&Scoped-Define DISPLAYED-FIELDS Faccpedm.FlgSit Faccpedm.CodCli ~
Faccpedm.NroPed Faccpedm.FchPed Faccpedm.NomCli Faccpedm.TpoCmb ~
Faccpedm.RucCli Faccpedm.fchven Faccpedm.NroCard Faccpedm.ordcmp ~
Faccpedm.DirCli Faccpedm.Cmpbnte Faccpedm.CodVen Faccpedm.CodMon ~
Faccpedm.FmaPgo Faccpedm.Glosa Faccpedm.Atencion 
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR':
    ...
    FIND B-CPedm WHERE B-CPedm.CodCia = FacCPedm.CodCia 
        ...
        AND  B-CPedm.NroPed = FacCPedm.OrdCmp
        EXCLUSIVE-LOCK NO-ERROR.
    IF AVAILABLE B-CPedm THEN B-CPedm.FlgEst = "P".
    RELEASE B-CPedm.
    /* VENTAS FRUSTRADAS */
    FIND B-CPEDM WHERE B-CPedm.codcia = FacCPedm.codcia
        AND B-CPedm.coddiv = FacCPedm.coddiv
        AND B-CPedm.coddoc = 'V/F'
        AND B-CPedm.nroped = Faccpedm.nroped
        EXCLUSIVE-LOCK NO-ERROR.
    IF AVAILABLE B-CPedm
    THEN DO:
 ...
 *       RUN VTA\R-CotExpLib (ROWID(FacCPedm)).
 *   END.*/
