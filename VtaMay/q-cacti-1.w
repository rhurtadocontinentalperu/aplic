...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCActi WHERE ~{&KEY-PHRASE} ~
      AND ROWID(VtaCActi) = s-Rowid NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaCActi WHERE ~{&KEY-PHRASE} ~
      AND ROWID(VtaCActi) = s-Rowid NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaCActi
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaCActi
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "ROWID(VtaCActi) = s-Rowid"
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-cacti ("Maestro de Actividades").
