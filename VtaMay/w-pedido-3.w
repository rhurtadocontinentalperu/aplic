...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/t-pedido-3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedido-3 ).
       RUN set-position IN h_t-pedido-3 ( 10.42 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-pedido-3 ( 8.88 , 110.00 ) NO-ERROR.
