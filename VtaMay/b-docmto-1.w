...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(38)":U WIDTH 29.14
      ...
      CcbDDocu.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT "->,>>9.9999":U
      ...
      CcbDDocu.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol. o Prom." FORMAT ">>9.99":U
      CcbDDocu.ImpLin FORMAT "->>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 103 BY 7.65
         FONT 4.
...
"Almmmatg.DesMat" ? "X(38)" "character" ? ? ? ? ? ? no ? no no "29.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbDDocu.PreUni" "Precio!Unitario" "->,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbDDocu.Por_Dsctos[3]" "% Dscto!Vol. o Prom." ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
