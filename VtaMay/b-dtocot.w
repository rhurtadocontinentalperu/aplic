...
FacDPedi.PorDto FacDPedi.Por_Dsctos[1] FacDPedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.Por_Dsctos[1] COLUMN-LABEL "% Dscto.!2" FORMAT "->>9.9999":U
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 106 BY 7.31
         FONT 4.
...
"FacDPedi.Por_Dsctos[1]" "% Dscto.!2" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
