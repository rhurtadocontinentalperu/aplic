...
&Scoped-Define ENABLED-OBJECTS RECT-5 RECT-41 RECT-43 RADIO-SET-Orden ~
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Resumen Cotizaciones Mostrador */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-3 RADIO-SET-Orden TOGGLE-Vendedor f-desde f-hasta RADIO-SET-1 
          RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME D-Dialog.
  ENABLE RECT-5 RECT-41 RECT-43 RADIO-SET-Orden f-desde f-hasta Btn_OK 
...
------------------------------------------------------------------------------*/
 ...
 FOR EACH FacCPedm NO-LOCK WHERE
          ...
          AND FacCPedm.CodDoc = "PED"    
          AND FacCPedm.FchPed >= F-desde 
          AND FacCPedm.FchPed <= F-hasta 
          /*AND FacCPedm.Codcli BEGINS f-clien */
     BY FacCPedm.NroPed:
 ...
 *           AND FacCPedm.FchPed <= F-hasta 
 *           /*AND FacCPedm.Codcli BEGINS f-clien*/
 *         BREAK BY FacCPedm.CodPos:
 *     {&new-page}.
 *     DISPLAY STREAM REPORT WITH FRAME F-CAB.
 *     IF FIRST-OF(FacCPedm.CodPos)
 *     THEN DO:
 *         PUT STREAM REPORT SKIP "Postal: " FacCPedm.CodPos " ".
 *         FIND almtabla WHERE almtabla.tabla = 'CP'
 *             AND almtabla.codigo = FacCPedm.codpos NO-LOCK NO-ERROR.
