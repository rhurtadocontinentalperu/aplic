...
DEFINE VARIABLE x-FlgEst AS CHAR NO-UNDO.
...
PEDI.PorDto PEDI.PreUni PEDI.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PEDI.NroItm COLUMN-LABEL "No" FORMAT ">>>9"
      PEDI.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)"
      Almmmatg.DesMat
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)"
      PEDI.UndVta COLUMN-LABEL "Undidad" FORMAT "x(10)"
      PEDI.AlmDes
      PEDI.CanPed FORMAT ">>>,>>9.99"
      PEDI.PorDto
      PEDI.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999"
      PEDI.ImpLin FORMAT ">,>>>,>>9.99"
  ENABLE
      PEDI.codmat
      PEDI.AlmDes
      PEDI.CanPed
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 6.54
         BGCOLOR 15 FONT 4.
...
DO:
    ...
    ASSIGN 
        ...
        F-FACTOR = 1
        X-CANPED = 1
        x-FlgEst = (IF AVAILABLE PEDI THEN PEDI.FlgEst ELSE '').
    RUN prov/PrecioVenta (s-CodCia,
                        s-CodDiv,
                        s-CodCli,
                        s-CodMon,
                        s-TpoCmb,
...
------------------------------------------------------------------------------*/
  FOR EACH B-PEDI:
    ...
    IF AVAILABLE Almmmatg THEN DO:
        ...
        x-FlgEst = (IF AVAILABLE B-PEDI THEN B-PEDI.FlgEst ELSE '').
        RUN prov/PrecioVenta (s-CodCia,
                            s-CodDiv,
                            s-CodCli,
                            s-CodMon,
