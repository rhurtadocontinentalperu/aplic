...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCRecl WHERE ~{&KEY-PHRASE} ~
      AND VtaCRecl.codcia = s-codcia ~
 AND VtaCRecl.CodDoc = s-coddoc NO-LOCK ~
    BY VtaCRecl.NroDoc DESCENDING INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaCRecl WHERE ~{&KEY-PHRASE} ~
      AND VtaCRecl.codcia = s-codcia ~
 AND VtaCRecl.CodDoc = s-coddoc NO-LOCK ~
    BY VtaCRecl.NroDoc DESCENDING INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaCRecl
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaCRecl
