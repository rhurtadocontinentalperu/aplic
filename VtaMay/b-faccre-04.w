...
Ccbddocu.PorDto Ccbddocu.Por_Dsctos[1] Ccbddocu.PreUni Ccbddocu.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Ccbddocu.PorDto COLUMN-LABEL "% Dscto!Automatico" FORMAT ">>9.99":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 107 BY 10.5
         BGCOLOR 15 FONT 4.
...
"Ccbddocu.PorDto" "% Dscto!Automatico" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Ccbddocu.Por_Dsctos[1]" "% Dscto!Manual" ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.Ccbddocu.PreUni
"Ccbddocu.PreUni" "Precio!Unitario" "->>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.Ccbddocu.ImpLin
