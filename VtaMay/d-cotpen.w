...
DEFINE FRAME D-Dialog
     FILL-IN-3 AT ROW 1.54 COL 4.86
     f-clien AT ROW 2.62 COL 9 COLON-ALIGNED
     f-nomcli AT ROW 2.62 COL 21.57 COLON-ALIGNED NO-LABEL
     R-Tipo AT ROW 3.69 COL 11 NO-LABEL
     FILL-IN-Marca AT ROW 4.77 COL 19 COLON-ALIGNED
     f-desde AT ROW 6.38 COL 24 COLON-ALIGNED
     f-hasta AT ROW 6.38 COL 43 COLON-ALIGNED
     FILL-IN-FchPed-1 AT ROW 7.62 COL 24 COLON-ALIGNED
     FILL-IN-FchPed-2 AT ROW 7.62 COL 43 COLON-ALIGNED
     txt-msj AT ROW 9.62 COL 2.86 NO-LABEL WIDGET-ID 2
     Btn_OK AT ROW 10.96 COL 33
     Btn_Cancel AT ROW 10.96 COL 45
     Btn_Help AT ROW 10.96 COL 57
     RECT-41 AT ROW 1.12 COL 1.72
     RECT-43 AT ROW 10.69 COL 1.86
     SPACE(0.42) SKIP(0.19)
...
/* SETTINGS FOR FILL-IN FILL-IN-3 IN FRAME D-Dialog
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN txt-msj IN FRAME D-Dialog
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       txt-msj:HIDDEN IN FRAME D-Dialog           = TRUE
       txt-msj:READ-ONLY IN FRAME D-Dialog        = TRUE.
...
------------------------------------------------------------------------------*/
 ...
 DEFINE FRAME f-cab
        ...
        "----------------------------------------------------------------------------------------------------------------------------------------------" SKIP
         ...
         WITH WIDTH 265 NO-BOX NO-LABELS NO-UNDERLINE STREAM-IO DOWN.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    txt-msj:VISIBLE IN FRAME {&FRAME-NAME} = NO.
...
/*Rd01 - Cambio de formato de impresion***
 CASE s-salida-impresion:
      WHEN 1 OR WHEN 3 THEN RUN LIB/d-README.R(s-print-file). 
 END CASE.                                             
 OUTPUT STREAM REPORT CLOSE.
