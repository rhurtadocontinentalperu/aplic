...
&Scoped-define FIELDS-IN-QUERY-br_table T-CodAlm T-Desc t-StkAct   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH T-Almacen WHERE T-CodCia = S-CODCIA  NO-LOCK
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH T-Almacen WHERE T-CodCia = S-CODCIA  NO-LOCK.
...
DEFINE VARIABLE FILL-IN-1 AS DECIMAL FORMAT "-zzz,zz9.99":U INITIAL 0 
     LABEL "Total General" 
     VIEW-AS FILL-IN 
     SIZE 11.14 BY .81
...
DEFINE FRAME F-Main
     ...
     FILL-IN-1 AT ROW 7.81 COL 35.57 COLON-ALIGNED
...
x-AlmValido = '03,03A,04,04A,05,05A,19,83B'.
CASE s-coddiv:
...
FOR EACH almacen NO-LOCK WHERE almacen.codcia = S-CODCIA AND
    LOOKUP(Almacen.codalm, x-AlmValido) > 0 AND almacen.autmov:
    CREATE t-Almacen.
    ASSIGN
...
stock-tot = 0.
x-AlmValido = '03,03A,03C,04,04A,04C,05,05A,05C,30,83B,35,35a'.
...
FOR EACH almacen NO-LOCK WHERE almacen.codcia = S-CODCIA
    ...
    /* ALMACEN DE CONSIGN. NO TIENE MOVIMIENTO CONTABLE  */
