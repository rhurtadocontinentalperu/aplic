...
&Scoped-Define ENABLED-OBJECTS B-CCTE 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/v-pedido-2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-2 ).
       RUN set-position IN h_v-pedido-2 ( 1.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.69 , 103.00 ) */
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/t-pedido-2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedido-2 ).
       RUN set-position IN h_t-pedido-2 ( 10.42 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.88 , 111.00 ) */
...
/*         RUN Recalcular-Precios IN h_t-pedido-2.*/
      END.
END CASE.
