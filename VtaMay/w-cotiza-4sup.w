...
&Scoped-Define ENABLED-OBJECTS B-CCTE COMBO-NroSer BUTTON-COT BTN-Excel ~
Btn-Super 
...
DEFINE FRAME F-Main
     B-CCTE AT ROW 1 COL 123
     COMBO-NroSer AT ROW 1.27 COL 2 NO-LABEL WIDGET-ID 4
     BUTTON-COT AT ROW 2.08 COL 123 WIDGET-ID 6
     BTN-Excel AT ROW 3.15 COL 123
     Btn-Super AT ROW 23.62 COL 2 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 138.29 BY 24.04
         FONT 4.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-pedido-4 ,
             Btn-Super:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotiza-4 ).
       RUN set-position IN h_b-cotiza-4 ( 11.23 , 1.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_t-cotiza-4 ).
       RUN set-position IN h_t-cotiza-4 ( 11.23 , 1.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE B-CCTE COMBO-NroSer BUTTON-COT BTN-Excel Btn-Super 
      WITH FRAME F-Main IN WINDOW W-Win.
