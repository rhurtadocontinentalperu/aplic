...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Gn-Card WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.12 , 1.43 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    /*RUN lkup\c-tarcre.r("Clientes con Tarjeta").*/
    RUN lkup/c-gncard ("Clientes con Tarjeta").
