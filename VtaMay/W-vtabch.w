...
DO:
 RUN Asignar-Articulos IN h_b-tmpvtm.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/b-tmpvtm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpvtm ).
       RUN set-position IN h_b-tmpvtm ( 7.96 , 1.14 ) NO-ERROR.
       RUN set-size IN h_b-tmpvtm ( 9.27 , 89.00 ) NO-ERROR.
       ...
       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-tmpvtm ,
             h_p-updv02 , 'AFTER':U ).
