...
Almmmatg.DesMar DETA.AlmDes DETA.UndVta DETA.CanDes DETA.Por_Dsctos[1] ~
DETA.PreUni DETA.ImpLin 
...
"Temp-Tables.DETA.codmat" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"INTEGRAL.Almmmatg.DesMat" ? "X(35)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"INTEGRAL.Almmmatg.DesMar" ? "X(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.DETA.AlmDes
"Temp-Tables.DETA.AlmDes" ? ? "character" 11 9 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.DETA.UndVta
"Temp-Tables.DETA.UndVta" "Unidad" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.DETA.CanDes
"Temp-Tables.DETA.CanDes" ? ">>>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.DETA.Por_Dsctos[1]
"Temp-Tables.DETA.Por_Dsctos[1]" ? ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.DETA.PreUni
"Temp-Tables.DETA.PreUni" "Precio!Unitario" "->>>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.DETA.ImpLin
"Temp-Tables.DETA.ImpLin" ? "->>,>>>.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
THEN DO:
    ...
    THEN DO:
        ...
        F-ImpIgv = IF F-ImpExo = 0 THEN (F-ImpTot - F-ValVta) ELSE ROUND(F-ValVta * FacCfgGn.PorIgv / 100, 2).
        F-TotBrt = F-ImpTot - F-ImpIgv - F-ImpIsc + F-ImpDes - F-ImpExo.
    END.
END.
