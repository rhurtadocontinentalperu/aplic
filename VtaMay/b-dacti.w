...
VtaDActi.ImpVtaMe VtaDActi.Observaciones gn-clie.CodVen gn-clie.DirCli ~
gn-clie.Telfnos[1] gn-clie.Telfnos[2] gn-clie.Telfnos[3] gn-clie.E-Mail 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaDActi.Observaciones FORMAT "X(50)":U WIDTH 38
      gn-clie.CodVen COLUMN-LABEL "Vend" FORMAT "X(3)":U WIDTH 5
      gn-clie.DirCli COLUMN-LABEL "Direccion" FORMAT "x(60)":U
      gn-clie.Telfnos[1] COLUMN-LABEL "Telefono 1" FORMAT "X(13)":U
      gn-clie.Telfnos[2] COLUMN-LABEL "Telefono 2" FORMAT "X(13)":U
      gn-clie.Telfnos[3] COLUMN-LABEL "Telefono 3" FORMAT "X(13)":U
      gn-clie.E-Mail FORMAT "X(20)":U
  ENABLE
      VtaDActi.CodCli
      VtaDActi.Observaciones
/* _UIB-CODE-BLOCK-END */
...
"VtaDActi.Observaciones" ? "X(50)" "character" ? ? ? ? ? ? yes ? no no "38" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.gn-clie.CodVen
"gn-clie.CodVen" "Vend" ? "character" ? ? ? ? ? ? no ? no no "5" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.gn-clie.DirCli
"gn-clie.DirCli" "Direccion" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.gn-clie.Telfnos[1]
"gn-clie.Telfnos[1]" "Telefono 1" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.gn-clie.Telfnos[2]
"gn-clie.Telfnos[2]" "Telefono 2" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.gn-clie.Telfnos[3]
"gn-clie.Telfnos[3]" "Telefono 3" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = INTEGRAL.gn-clie.E-Mail
