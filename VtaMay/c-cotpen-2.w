...
&SCOPED-DEFINE l-lookup h_l-cotpen-2
...
DEFINE VARIABLE h_l-cotpen-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/l-cotpen-2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-cotpen-2 ).
       RUN set-position IN h_l-cotpen-2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-cotpen-2 ( 10.92 , 71.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cotpen-2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cotpen-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cotpen-2 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-cotpen-2 , 'AFTER':U ).
    END. /* Page 0 */
