...
------------------------------------------------------------------------------*/
  ...
  EMPTY TEMP-TABLE T-CPEDM.
  EMPTY TEMP-TABLE T-DPEDM.
  ...
  FOR EACH b-FacDPedm WHERE b-FacDPedm.CODCIA = FacCPedm.CODCIA 
      ...
      IF FIRST-OF(b-FacDPedm.AlmDes) OR L-NewPed THEN DO:
          ...
          CREATE T-CPEDM.
          ASSIGN 
              T-CPEDM.NroPed   = SUBSTRING(FacCPedm.NroPed,1,3) + STRING(I-NPED,"999999")
...
DO WITH FRAME {&FRAME-NAME} :
   ...
   /*Busca Documento ya registrado*/
   FIND b-cdocu WHERE b-cdocu.codcia = s-codcia
       AND b-cdocu.coddiv = s-coddiv
       AND b-cdocu.coddoc = FacCpedm.Cmpbnte:screen-value
       AND b-cdocu.nrodoc = STRING(v-NroSer:screen-value,"999") + STRING(v-NumDoc:screen-value,"999999")
       NO-LOCK NO-ERROR.
