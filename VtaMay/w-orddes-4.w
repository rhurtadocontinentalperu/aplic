...
&Scoped-Define ENABLED-OBJECTS RECT-68 COMBO-NroSer B-AGTRANS 
...
DEFINE FRAME F-Main
     ...
     B-AGTRANS AT ROW 3.15 COL 123 WIDGET-ID 2
     RECT-68 AT ROW 2.62 COL 2 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 139.14 BY 23.81
         FONT 4.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_p-updv05 ( 1.54 , 53.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-orddes-4 ).
       RUN set-position IN h_v-orddes-4 ( 2.88 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-orddes-4 ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_t-orddes-4 ).
       RUN set-position IN h_t-orddes-4 ( 11.23 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-68 COMBO-NroSer B-AGTRANS 
      WITH FRAME F-Main IN WINDOW W-Win.
