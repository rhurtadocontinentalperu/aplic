...
&Scoped-define FIELDS-IN-QUERY-br_table DETA.codmat Almmmatg.DesMat Almmmatg.DesMar DETA.UndVta DETA.CanDes DETA.PreUni DETA.Por_Dsctos[1] DETA.Por_Dsctos[2] DETA.Por_Dsctos[3] DETA.ImpLin   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      DETA.Por_Dsctos[1] COLUMN-LABEL "% Dscto!Incluido"
      DETA.Por_Dsctos[2] COLUMN-LABEL "% Dscto!Evento"
      DETA.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol/Prom"
