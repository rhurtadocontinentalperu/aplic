...
&Scoped-define INTERNAL-TABLES ExpCProm

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ExpCProm WHERE ~{&KEY-PHRASE} ~
      AND ExpCProm.CodCia = s-codcia ~
 AND ExpCProm.CodDoc = s-coddoc NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ExpCProm
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ExpCProm
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.ExpCProm"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.ExpCProm.CodCia = s-codcia
 AND INTEGRAL.ExpCProm.CodDoc = s-coddoc"
