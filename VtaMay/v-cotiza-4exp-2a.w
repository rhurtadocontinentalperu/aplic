...
FacCPedi.CodPos FacCPedi.FlgIgv FacCPedi.CodVen FacCPedi.FmaPgo ~
FacCPedi.usuario FacCPedi.NroCard 
...
FacCPedi.Glosa FacCPedi.CodMon FacCPedi.CodPos FacCPedi.FlgIgv ~
FacCPedi.CodVen FacCPedi.FmaPgo FacCPedi.usuario FacCPedi.NroCard 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-1 AT ROW 1 COL 59 COLON-ALIGNED WIDGET-ID 44
     ...
     FacCPedi.NomCli AT ROW 1.81 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 49 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 1.81 COL 99 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     FacCPedi.DirCli AT ROW 2.62 COL 9 COLON-ALIGNED
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.fchven AT ROW 2.62 COL 99 COLON-ALIGNED
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 26 COLON-ALIGNED WIDGET-ID 2
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FchEnt AT ROW 3.42 COL 99 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 9 
     ...
     FacCPedi.ordcmp AT ROW 4.23 COL 99 COLON-ALIGNED WIDGET-ID 30
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.LugEnt AT ROW 5.04 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 5.04 COL 99 COLON-ALIGNED WIDGET-ID 6
          LABEL "Comprobante"
     ...
     FacCPedi.Glosa AT ROW 5.85 COL 6.28 FORMAT "X(60)"
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 5.85 COL 101 NO-LABEL
...
"US$", 2
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodPos AT ROW 6.65 COL 9 COLON-ALIGNED WIDGET-ID 38
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-Postal AT ROW 6.65 COL 15 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FacCPedi.FlgIgv AT ROW 6.65 COL 101 NO-LABEL WIDGET-ID 22
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
...
DEFINE FRAME F-Main
     ...
     FacCPedi.usuario AT ROW 8.27 COL 99 COLON-ALIGNED WIDGET-ID 42
          LABEL "USUARIO"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
          BGCOLOR 12 FGCOLOR 15 
     FacCPedi.NroCard AT ROW 9.08 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 9.08 COL 21 COLON-ALIGNED NO-LABEL
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 6.12 COL 94
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 6.65 COL 94 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
DO:
  ...
  IF LOOKUP('001', s-cndvta-validos) = 0 THEN s-cndvta-validos = '001,' + s-cndvta-validos.

  DISPLAY 
    gn-clie.NomCli @ Faccpedi.NomCli
    gn-clie.Ruc    @ Faccpedi.RucCli
    gn-clie.DirCli @ Faccpedi.DirCli
    ENTRY(1, s-cndvta-validos) @ FacCPedi.FmaPgo
...
------------------------------------------------------------------------------*/
    ...
    FIND ExpTurno WHERE ROWID(ExpTurno) = TO-ROWID(FacCPedi.Libre_c02) EXCLUSIVE-LOCK NO-ERROR NO-WAIT.
    IF AVAILABLE ExpTurno 
        THEN ASSIGN
                ExpTurno.Libre_c04 = STRING( DATETIME(TODAY, MTIME), '99/99/9999 HH:MM:SS').
                Expturno.Estado = 'C'.
    ...
    MESSAGE 'Cotización cerrada' SKIP 'Regresamos a la primera cotización por cerrar'
        VIEW-AS ALERT-BOX INFORMATION.
    RUN Procesa-handle IN lh_handle ("primer-registro").
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      ASSIGN 
          ...
          FacCPedi.TpoPed = ""
          FacCPedi.CodAlm = ENTRY(1, s-CodAlm).     /* Por compatibilidad */
      ASSIGN
  ...
  IF NOT s-user-id BEGINS 'CAA' THEN FacCPedi.Usuario = S-USER-ID.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
   MESSAGE "!!No se permite Copiar Las Cotizaciones!!"
  ...
  IF Faccpedi.fchped < 01/01/2011 THEN DO:
      MESSAGE 'Cotización de la expo oct 2010' VIEW-AS ALERT-BOX WARNING.
      RETURN "ADM-ERROR".
  END.
  IF Faccpedi.UsrSac = "*"  THEN DO:
      MESSAGE 'Cotización de la expo oct 2010' VIEW-AS ALERT-BOX WARNING.
      RETURN "ADM-ERROR".
  END.
...
/*         AND vtacdocu.nroref = faccpedi.nroped NO-ERROR.         */
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE FacCPedi THEN DO WITH FRAME {&FRAME-NAME}:
      ...
      IF AVAILABLE ExpTurno THEN FILL-IN-1:SCREEN-VALUE = ExpTurno.BLOCK + ' - '  + STRING(ExpTurno.Turno).
  END.
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF RETURN-VALUE = 'NO' THEN DO:
        ...
        THEN ASSIGN
            FacCPedi.DirCli:SENSITIVE = YES
            FacCPedi.NomCli:SENSITIVE = YES.
        IF FacCPedi.FchPed < 01/06/2012 THEN FacCPedi.FmaPgo:SENSITIVE = NO.
        ELSE FacCPedi.FmaPgo:SENSITIVE = YES.
    END.
    IF s-user-id BEGINS 'CAA' THEN DO:
        ASSIGN
            FacCPedi.FmaPgo:SENSITIVE = YES
            FacCPedi.Usuario:SENSITIVE = YES.
    END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME} :
   ...
   END.
    ...
    IF INTEGER(FacCPedi.CodMon:SCREEN-VALUE) = 2 THEN f-Tot = f-Tot * DECIMAL(FacCPedi.TpoCmb:SCREEN-VALUE).
