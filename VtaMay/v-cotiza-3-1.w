...
DEFINE SHARED VARIABLE S-TPOPED LIKE faccpedi.tpoped.
...
FacCPedi.Atencion FacCPedi.CodRef FacCPedi.NroRef 
...
FacCPedi.FmaPgo FacCPedi.Glosa FacCPedi.Atencion FacCPedi.CodRef ~
FacCPedi.NroRef 
...
"US$", 2
     ...
     FacCPedi.Atencion AT ROW 2.73 COL 26 COLON-ALIGNED WIDGET-ID 2
          ...
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodRef AT ROW 5.85 COL 90 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FacCPedi.NroRef AT ROW 6.65 COL 90 COLON-ALIGNED WIDGET-ID 10 FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
DO:
  ...
  IF Gn-Clie.Canal = '006'     /*Gn-Clie.Canal = '00001'*/
  THEN DO:
