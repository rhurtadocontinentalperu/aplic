...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75 BY 16.42
         FONT 4
...
DEFINE FRAME F-Main
     ...
     x-Total AT ROW 17.42 COL 61 COLON-ALIGNED WIDGET-ID 2
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* STOCK COMPROMETIDO */
DO:
