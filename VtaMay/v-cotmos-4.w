...
FacCPedi.Atencion FacCPedi.FchEnt FacCPedi.LugEnt FacCPedi.Cmpbnte ~
...
&Scoped-Define DISPLAYED-OBJECTS F-nOMvEN F-CndVta F-Estado F-Nomtar 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 4.23 COL 94 COLON-ALIGNED WIDGET-ID 6
          LABEL "Comprobante"
     ...
     FacCPedi.Glosa AT ROW 5.04 COL 6.28 FORMAT "X(60)"
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 5.04 COL 96 NO-LABEL
...
"US$", 2
     ...
     FacCPedi.FlgIgv AT ROW 5.85 COL 96 NO-LABEL WIDGET-ID 22
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
     ...
     F-Estado AT ROW 6.65 COL 94 COLON-ALIGNED
...
DEFINE FRAME F-Main
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.31 COL 89
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.85 COL 89 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
DO:
  ...
  IF Gn-Clie.Canal = '00001' THEN DO:
