...
FacDPedi.CanPed FacDPedi.PreUni FacDPedi.PorDto FacDPedi.Por_Dsctos[1] ~
...
&Scoped-Define DISPLAYED-OBJECTS F-ImpDto2 F-ImpTot F-TotBrt F-ImpExo ~
F-ValVta F-ImpIsc F-ImpIgv F-ImpDes F-ImpTot-S F-ImpTot-D 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)":U WIDTH 5.43
...
DEFINE FRAME F-Main
     ...
     F-ImpDto2 AT ROW 12.31 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     F-ImpTot AT ROW 12.35 COL 103 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 12.38 COL 18 NO-LABEL
     F-ImpExo AT ROW 12.38 COL 30 NO-LABEL
     F-ValVta AT ROW 12.38 COL 52.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 12.38 COL 64.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 12.38 COL 77.43 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 12.42 COL 40 COLON-ALIGNED NO-LABEL
     F-ImpTot-S AT ROW 13.81 COL 104.43 RIGHT-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpTot-D AT ROW 15.23 COL 86.43 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 11.81 COL 82.14
     "   $" VIEW-AS TEXT
          SIZE 5 BY 1.35 AT ROW 15 COL 82 WIDGET-ID 52
     ...
     " S/." VIEW-AS TEXT
          SIZE 4 BY 1.35 AT ROW 13.65 COL 83 WIDGET-ID 6
          BGCOLOR 0 FGCOLOR 15 FONT 30
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.85 COL 42.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.85 COL 55.86
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.81 COL 30.57
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 11.77 COL 105.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 11.81 COL 70.57
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.81 COL 20
     "Otros Dctos" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 11.77 COL 92 WIDGET-ID 62
...
"Almmmatg.DesMar" "Marca" "X(12)" "character" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.Por_Dsctos[1]" "% Dscto!Manual" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
