...
FacDPedi.PorDto FacDPedi.Por_Dsctos[1] FacDPedi.Por_Dsctos[3] ~
FacDPedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PreUni COLUMN-LABEL "Precio !Unitario" FORMAT ">>,>>9.999999":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 112 BY 7.31
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 9.04 COL 6 NO-LABEL
     F-ImpExo AT ROW 9.04 COL 21 NO-LABEL
     F-ImpDes AT ROW 9.04 COL 32 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 9.04 COL 46 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 9.04 COL 61 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 9.04 COL 76 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 9.04 COL 91 COLON-ALIGNED NO-LABEL
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.54 COL 34.43
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.54 COL 21.29
     "Total Importe" VIEW-AS TEXT
          SIZE 9.29 BY .46 AT ROW 8.54 COL 93.72
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 8.54 COL 66.29
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.54 COL 7.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.54 COL 49.72
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 8.54 COL 81.43
     RECT-11 AT ROW 8.31 COL 1
...
"FacDPedi.PreUni" "Precio !Unitario" ">>,>>9.999999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.Por_Dsctos[1]" "% Dscto.!Manual" "->>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacDPedi.Por_Dsctos[3]
...
------------------------------------------------------------------------------*/
  ...
  IF AVAIL FacCPedi THEN output-var-1 = ROWID(FacCPedi).
