...
&Scoped-Define DISPLAYED-OBJECTS F-nOMvEN F-CndVta F-Nomtar F-Estado 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FlgSit AT ROW 1 COL 45 NO-LABEL
...
DEFINE FRAME F-Main
     ...
     F-Estado AT ROW 7.46 COL 92 COLON-ALIGNED
     "Moneda:" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  IF Faccpedi.FlgEst <> "A" THEN RUN vtamay/r-impvm (ROWID(Faccpedi)).
