...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.FlgEst = f-estado ~
 USE-INDEX Llave04 NO-LOCK, ~
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-3 wcotiza wclient br_table 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-3 wcotiza wclient 
...
/* BROWSE-TAB br_table wclient F-Main */
ASSIGN 
...
/* Query rebuild information for BROWSE br_table
 ...
 AND integral.FacCPedi.FlgEst = f-estado
 USE-INDEX Llave04"
  ...
  AND integral.gn-clie.CodCli = integral.FacCPedi.CodCli"
     ...
     _Where[3]         = "(integral.FacCPedi.FmaPgo = ""001""
