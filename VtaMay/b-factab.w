...
DEF VAR s-Tabla AS CHAR INIT 'MG' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo
      FacTabla.Nombre COLUMN-LABEL "Descripcion" FORMAT "x(30)"
      FacTabla.Valor[1] COLUMN-LABEL ">="
      FacTabla.Valor[2] COLUMN-LABEL "<"
  ENABLE
      FacTabla.Codigo
      FacTabla.Nombre
      FacTabla.Valor[1]
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 7.88
         FONT 2.
...
"FacTabla.Nombre" "Descripcion" "x(30)" "character" ? ? ? ? ? ? yes ?
     _FldNameList[3]   > INTEGRAL.FacTabla.Valor[1]
"FacTabla.Valor[1]" ">=" ? "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[4]   > INTEGRAL.FacTabla.Valor[2]
"FacTabla.Valor[2]" "<" ? "decimal" ? ? ? ? ? ? yes ?
