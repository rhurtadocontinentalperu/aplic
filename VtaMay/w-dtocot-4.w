...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/v-dtocot-4.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-dtocot-4 ).
       RUN set-position IN h_v-dtocot-4 ( 2.35 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cotiza-4 ).
       RUN set-position IN h_b-cotiza-4 ( 6.12 , 1.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/t-dtocot-4.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-dtocot-4 ).
       RUN set-position IN h_t-dtocot-4 ( 6.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-dtocot-4 ( 11.50 , 139.00 ) NO-ERROR.
