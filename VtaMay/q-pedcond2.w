...
&Scoped-define QUERY-STRING-Query-Main FOR EACH FacCPedm WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedm.CodDoc = C-CODDOC ~
 AND FacCPedm.CodDiv = S-CODDIV ~
 AND FacCPedm.NroPed = C-NRODOC NO-LOCK ~
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND integral.FacCPedm.CodDoc = C-CODDOC
 AND integral.FacCPedm.CodDiv = S-CODDIV
 AND integral.FacCPedm.NroPed = C-NRODOC"
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER C-NRO AS CHAR.
DEFINE INPUT PARAMETER C-COD AS CHAR.
