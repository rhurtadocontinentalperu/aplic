...
DEFINE INPUT PARAMETER S-NROTAR AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS RECT-19 F-NomCli F-DirCli F-RucCli F-TlfCli ~
F-DNICli Btn_OK Btn_Cancel 
...
/* SETTINGS FOR FILL-IN F-NroCar IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
DO:
  ...
  IF F-NomCli = "" THEN DO:
      ...
      RETURN NO-APPLY.
  END.
  FIND Gn-Card WHERE Gn-Card.NroCard = F-NroCar 
               NO-LOCK NO-ERROR.
  IF AVAILABLE Gn-Card THEN DO:
     MESSAGE "Codigo de tarjeta ya existe" VIEW-AS ALERT-BOX ERROR.
     RETURN NO-APPLY.
  END.
  RUN Crea-Tarjeta.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY F-NroCar F-NomCli F-DirCli F-RucCli F-TlfCli F-DNICli 
      WITH FRAME D-Dialog.
  ENABLE RECT-19 F-NomCli F-DirCli F-RucCli F-TlfCli F-DNICli Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
