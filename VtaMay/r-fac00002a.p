...
DEFINE FRAME F-HdrFac
    ...
    CcbCDocu.CodCli AT 62 FORMAT "x(11)"
    ccbcdocu.dircli AT 11 FORMAT "x(50)" 
    ccbcdocu.RucCli AT 62 format "x(11)" SKIP
    x-DirRef        AT 15 FORMAT 'x(40)'
...
DEFINE FRAME F-Ftrfac
    ...
    "<<BASE DE CAJA CON CINTA DE SEGURIDAD>>" AT 3
    ccbcdocu.PorIgv AT 72 FORMAT ">>9.99" "%" FORMAT "X(1)" SKIP    
    "ADELANTO" AT 105 WHEN Ccbcdocu.ImpTot2 > 0 SKIP
    ccbcdocu.nrosal at 15 
    "Tarjeta :" AT 31 Ccbcdocu.NroCard  
    ccbcdocu.impigv AT 64 FORMAT ">>>,>>>,>>9.99"
    imptotfac AT 84 FORMAT ">>>,>>>,>>9.99"
    Ccbcdocu.ImpTot2 AT 102 FORMAT ">>>,>>9.99" WHEN Ccbcdocu.ImpTot2 > 0
    IF ccbcdocu.codmon = 1 THEN "S/."  ELSE "US$." AT 115 FORMAT "XXXX"
    ( ccbcdocu.imptot -  ccbcdocu.imptot2 ) AT 119 FORMAT ">>,>>>,>>9.99" SKIP
...
/*     X-IMPDTO        AT 88 FORMAT ">>>,>>9.99"                                                                                                             */
/*     ccbcdocu.impvta AT 122 FORMAT ">>>,>>9.99" SKIP                                                                                                       */
/*     ccbcdocu.PorIgv AT 72 FORMAT ">>9.99" "%" FORMAT "X(1)" SKIP(1)                                                                                       */
/*     ccbcdocu.nrosal at 15                                                                                                                                 */
/*     "Tarjeta :" AT 31 Ccbcdocu.NroCard                                                                                                                    */
