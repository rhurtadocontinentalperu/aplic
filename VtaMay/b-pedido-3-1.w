...
FacDPedi.CanPed FacDPedi.CanPick FacDPedi.PorDto FacDPedi.PreUni ~
FacDPedi.Por_Dsctos[1] FacDPedi.Por_Dsctos[3] FacDPedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.AlmDes COLUMN-LABEL "Alm!Des" FORMAT "x(3)":U
      FacDPedi.CanPed FORMAT ">>>,>>9.99":U
      FacDPedi.CanPick COLUMN-LABEL "Pickeado" FORMAT ">>>,>>9.99":U
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Vol. o Prom." FORMAT ">>9.99":U
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123 BY 8
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 9.08 COL 12 COLON-ALIGNED
     F-TotBrt AT ROW 10.42 COL 14 NO-LABEL
     F-ImpExo AT ROW 10.42 COL 26 NO-LABEL
     F-ValVta AT ROW 10.42 COL 48.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 10.42 COL 60.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 10.42 COL 73.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 10.42 COL 86 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 10.46 COL 36 COLON-ALIGNED NO-LABEL
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 9.85 COL 78.14
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 9.85 COL 88.14
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.85 COL 16
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 9.85 COL 66.57
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.88 COL 38.72
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.85 COL 26.57
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.88 COL 51.86
...
"FacDPedi.AlmDes" "Alm!Des" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > integral.FacDPedi.CanPed
"FacDPedi.CanPed" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.FacDPedi.CanPick
"FacDPedi.CanPick" "Pickeado" ">>>,>>9.99" "decimal" 11 9 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.FacDPedi.PorDto
"FacDPedi.PorDto" "% Dscto!Incluido" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.PreUni
...
"FacDPedi.Por_Dsctos[3]" "% Dscto!Vol. o Prom." ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    IF AVAILABLE Facdpedi AND LOOKUP(Faccpedi.flgest, 'X,P') > 0 THEN RUN vtamay/gAlmDesPED (ROWID(Facdpedi)).
