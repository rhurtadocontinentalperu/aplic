...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.CanPed COLUMN-LABEL "Cantidad!Pedido" FORMAT ">,>>>,>>9.9999":U
      ...
      x-canpen @ x-canpen COLUMN-LABEL "Cantidad!por Despachar" FORMAT ">,>>>,>>9.99":U
            COLUMN-BGCOLOR 10
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>>.99":U
...
"FacDPedi.CanPed" "Cantidad!Pedido" ? "decimal" 12 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > integral.FacDPedi.canate
"FacDPedi.canate" "Cantidad!Atendida" ? "decimal" 14 ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>>.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
