...
&Scoped-Define ENABLED-OBJECTS RECT-69 COMBO-NroSer B-CCTE BUTTON-COT ~
BTN-Excel Btn-Grupos B-CLI 
...
DEFINE FRAME F-Main
     ...
     B-CLI AT ROW 23.62 COL 58 WIDGET-ID 8
     RECT-69 AT ROW 2.62 COL 2 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 139.72 BY 24.12
         FONT 4.
...
DO:
   RUN Actualiza-datos-cliente IN h_v-cotiza-4.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-69 COMBO-NroSer B-CCTE BUTTON-COT BTN-Excel Btn-Grupos B-CLI 
      WITH FRAME F-Main IN WINDOW W-Win.
