...
/*    IF LOOKUP(TRIM(ITEM.AlmDes:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}), "03A,04,04A,05A,19") = 0 
 *     THEN DO:
 *        IF S-CODALM <> ITEM.AlmDes:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} THEN DO:
...
DO:
    ...
    RUN vtamay/PrecioConta-2 (s-CodCia,
                        s-CodDiv,
                        s-CodCli,
                        s-CodMon,
                        s-TpoCmb,
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
    ...
    ITEM.Por_DSCTOS[2] = Almmmatg.PorMax
...
/*
    ...
    RUN vtagn/p-margen-utilidad (
        ...
        DECIMAL(ITEM.PreUni:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}),  /* Precio de venta unitario */
        ITEM.UndVta:SCREEN-VALUE IN BROWSE {&BROWSE-NAME},
