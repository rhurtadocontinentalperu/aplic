...
VtaCDocu.CodPos VtaCDocu.CodVen VtaCDocu.FmaPgo VtaCDocu.NroCard 
...
VtaCDocu.Glosa VtaCDocu.FlgIgv VtaCDocu.CodPos VtaCDocu.CodVen ~
...
DEFINE FRAME F-Main
     ...
     VtaCDocu.CodMon AT ROW 5.15 COL 100 NO-LABEL
...
/*       THEN s-cndvta-validos = s-cndvta-validos + ',401'.     */
  ...
  /* Cargamos las condiciones de venta válidas */
  FIND gn-clie WHERE gn-clie.CodCia = CL-CODCIA
    AND  gn-clie.CodCli = s-codcli  /*s-codcli*/
    NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    IF lchoice THEN DO:
        ...
        END.
        ELSE DO: 
            RUN VtaMay\genera-cotizacion (ROWID(VtaCDocu),OUTPUT CNroPed).    
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      DISPLAY 
          ...
          01/12/2011 @ VtaCDocu.FchEnt
          S-TPOCMB @ VtaCDocu.TpoCmb
          03/31/2011 @ VtaCDocu.FchVen
          '001' @ VtaCDocu.FmaPgo.
      ASSIGN
