...
f-ApePat f-ApeMat f-Nombre F-DirCli F-TlfCli f-EMail RADIO-SET-Retenedor ~
RADIO-SET-Percepcion F-GirCli F-CodDept F-CodProv F-CodDist f-vende Btn_OK ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-Libre_C01 F-DNICli F-RucCli ~
F-CodCli f-ApePat f-ApeMat f-Nombre F-NomCli F-DirCli F-TlfCli f-EMail ~
RADIO-SET-Retenedor RADIO-SET-Percepcion F-GirCli F-CodDept F-CodProv ~
F-CodDist f-vende f-condvta F-giro FILL-IN-DEP FILL-IN-PROV FILL-IN-DIS ~
f-nomven f-descond f-DateInscription 
...
DEFINE VARIABLE f-EMail AS CHARACTER FORMAT "X(150)":U 
...
DEFINE FRAME D-Dialog
     ...
     F-TlfCli AT ROW 8.54 COL 18 COLON-ALIGNED
     f-EMail AT ROW 9.35 COL 18 COLON-ALIGNED WIDGET-ID 40
     ...
     F-giro AT ROW 12.04 COL 24.43 COLON-ALIGNED NO-LABEL
     FILL-IN-DEP AT ROW 12.85 COL 24.43 COLON-ALIGNED NO-LABEL
     FILL-IN-PROV AT ROW 13.65 COL 24.43 COLON-ALIGNED NO-LABEL
     FILL-IN-DIS AT ROW 14.46 COL 24.43 COLON-ALIGNED NO-LABEL
     f-nomven AT ROW 15.27 COL 24.43 COLON-ALIGNED NO-LABEL
     f-descond AT ROW 16.12 COL 24.43 COLON-ALIGNED NO-LABEL
...
/*             END.                                                                                                        */
    ...
    IF f-EMail > '' THEN DO:
        ...
        x-Nro-EMails = NUM-ENTRIES(f-EMail,';').
        DO x-Item = 1 TO x-Nro-EMails:
            RUN gn/valida-email (ENTRY(x-Item,f-EMail,';'), 
                                 OUTPUT pError).
            IF pError > '' THEN DO:
...
/*                                                                                     */
/*     ASSIGN x-valor = INT(TRIM(SELF:SCREEN-VALUE IN FRAME {&FRAME-NAME})) NO-ERROR.  */
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-Libre_C01 F-DNICli F-RucCli F-CodCli f-ApePat f-ApeMat 
          f-Nombre F-NomCli F-DirCli F-TlfCli f-EMail RADIO-SET-Retenedor 
  ...
  ENABLE RADIO-SET-Libre_C01 F-DNICli F-RucCli f-ApePat f-ApeMat f-Nombre 
         F-DirCli F-TlfCli f-EMail RADIO-SET-Retenedor RADIO-SET-Percepcion 
         F-GirCli F-CodDept F-CodProv F-CodDist f-vende Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
