...
DEFINE VARIABLE h_b-rcl003 AS HANDLE NO-UNDO.
...
ON END-ERROR OF nW-Win /* Cierre de Reclamos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL nW-Win nW-Win
ON WINDOW-CLOSE OF nW-Win /* Cierre de Reclamos */
DO:
...
ON CHOOSE OF BUTTON-3 IN FRAME F-Main /* CIERRE */
DO:
  MESSAGE '¿Cerramos el Reclamo?' VIEW-AS ALERT-BOX QUESTION
    BUTTONS YES-NO UPDATE rpta AS LOG.
  IF rpta = YES THEN RUN Cierre IN h_b-rcl003.  
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamay/b-rcl003.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rcl003 ).
       RUN set-position IN h_b-rcl003 ( 1.19 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.92 , 91.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rcl003 ,
