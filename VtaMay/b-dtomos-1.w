...
&Scoped-define FIELDS-IN-QUERY-br_table facdpedm.codmat Almmmatg.DesMat ~
Almmmatg.DesMar facdpedm.UndVta facdpedm.CanPed facdpedm.PreUni ~
Facdpedm.PorDto Facdpedm.Por_Dsctos[1] Facdpedm.Por_Dsctos[3] ~
facdpedm.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      facdpedm.codmat COLUMN-LABEL "Articulo" FORMAT "X(6)":U
      Almmmatg.DesMat FORMAT "X(36)":U
      ...
      facdpedm.PreUni COLUMN-LABEL "Precio !Unitario" FORMAT ">>,>>9.9999":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 99 BY 7.31
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 8.92 COL 12.14 NO-LABEL
     F-ImpExo AT ROW 8.92 COL 23.43 NO-LABEL
     F-ImpDes AT ROW 8.92 COL 32.86 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 8.92 COL 43.86 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 8.92 COL 54.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 8.92 COL 66.14 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 8.92 COL 77.14 COLON-ALIGNED NO-LABEL
     "Total Importe" VIEW-AS TEXT
          SIZE 9.29 BY .46 AT ROW 8.42 COL 79.86
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 8.42 COL 60.14
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.42 COL 23.72
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.42 COL 35.29
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.42 COL 47.57
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.42 COL 13.86
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 8.42 COL 71.57
...
"facdpedm.codmat" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.Almmmatg.DesMat
"Almmmatg.DesMat" ? "X(36)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"facdpedm.UndVta" "Unidad" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > integral.facdpedm.CanPed
"facdpedm.CanPed" ? ">>>,>>>.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > integral.facdpedm.PreUni
"facdpedm.PreUni" "Precio !Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > integral.Facdpedm.PorDto
"Facdpedm.PorDto" "% Dscto.!Incluido" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.Facdpedm.Por_Dsctos[1]
"Facdpedm.Por_Dsctos[1]" "% Dscto.!Manual" ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.Facdpedm.Por_Dsctos[3]
"Facdpedm.Por_Dsctos[3]" "% Dscto!Vol. o Prom." ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.facdpedm.ImpLin
...
IF NOT AVAILABLE Faccpedm THEN DO:
   FIND FACCPEDM WHERE ROWID(FACCPEDM) = OUTPUT-VAR-1 NO-LOCK NO-ERROR.
END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAIL Faccpedm THEN output-var-1 = ROWID(faccpedm).
