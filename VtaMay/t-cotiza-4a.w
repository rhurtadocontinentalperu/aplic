...
PEDI-1.Libre_d01 PEDI-1.CanPed PEDI-1.PorDto PEDI-1.PreUni PEDI-1.ImpLin 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 124 BY 9.96
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 12.77 COL 12 COLON-ALIGNED WIDGET-ID 12
...
"Temp-Tables.PEDI-1.CanPed" "Cantidad!Aprobada" ">>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.PEDI-1.PorDto
"Temp-Tables.PEDI-1.PorDto" ? "->>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.PEDI-1.PreUni
