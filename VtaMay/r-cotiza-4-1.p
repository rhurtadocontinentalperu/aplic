...
DEFINE FRAME F-FtrCot
    ...
    "  DTO.GLOBAL :" WHEN FacCPedi.ImpDto <> 0 AT 70 FORMAT 'x(20)'
    STRING(FacCPedi.ImpDto,'->,>>>,>>9.99') WHEN FacCPedi.ImpDto <> 0 FORMAT 'x(20)' SKIP
    ...
    /* FacCPedi.Observa VIEW-AS TEXT FORMAT "X(160)"  SKIP  */
    "--------------------------------------------------                            ------------------- " SKIP
