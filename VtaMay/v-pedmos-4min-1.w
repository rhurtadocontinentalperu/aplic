...
DEFINE SHARED TEMP-TABLE PEDI-2 NO-UNDO LIKE Facdpedi.
...
&Scoped-Define ENABLED-FIELDS FacCPedi.FlgSit FacCPedi.CodCli ~
FacCPedi.NomCli FacCPedi.TpoCmb FacCPedi.DirCli FacCPedi.fchven ~
FacCPedi.RucCli FacCPedi.Atencion FacCPedi.ordcmp FacCPedi.LugEnt ~
FacCPedi.Cmpbnte FacCPedi.Glosa FacCPedi.CodMon FacCPedi.CodVen ~
FacCPedi.Libre_c05 FacCPedi.FlgIgv FacCPedi.FmaPgo FacCPedi.Libre_c03 ~
FacCPedi.NroCard FacCPedi.Libre_c04 FacCPedi.NroRef 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define DISPLAYED-FIELDS FacCPedi.NroPed FacCPedi.FlgSit ~
FacCPedi.FchPed FacCPedi.CodCli FacCPedi.NomCli FacCPedi.TpoCmb ~
FacCPedi.DirCli FacCPedi.fchven FacCPedi.RucCli FacCPedi.Atencion ~
FacCPedi.ordcmp FacCPedi.LugEnt FacCPedi.Cmpbnte FacCPedi.Glosa ~
FacCPedi.CodMon FacCPedi.CodVen FacCPedi.Libre_c05 FacCPedi.FlgIgv ~
FacCPedi.FmaPgo FacCPedi.Libre_c03 FacCPedi.NroCard FacCPedi.Libre_c04 ~
FacCPedi.NroRef 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-nOMvEN F-CndVta FILL-IN-4 ~
F-Nomtar FILL-IN-5 COMBO-BOX-Proveedor 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FlgSit AT ROW 1 COL 88 NO-LABEL
...
"Tickets Personal Continental", "KC":U
          SIZE 22 BY 4.58
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FchPed AT ROW 1 COL 118 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.NomCli AT ROW 1.81 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 48 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 1.81 COL 118 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.fchven AT ROW 2.62 COL 118 COLON-ALIGNED
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.ordcmp AT ROW 3.42 COL 118 COLON-ALIGNED WIDGET-ID 32
          LABEL "O/Compra"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 4.23 COL 118 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
     ...
     FacCPedi.Glosa AT ROW 5.04 COL 6.28
          ...
          SIZE 61 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 5.04 COL 120 NO-LABEL
...
"US$", 2
     ...
     FacCPedi.Libre_c05 AT ROW 5.85 COL 86 COLON-ALIGNED WIDGET-ID 50 PASSWORD-FIELD 
          ...
          SIZE 21 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FlgIgv AT ROW 5.85 COL 120 NO-LABEL WIDGET-ID 28
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
...
DEFINE FRAME F-Main
     ...
     FacCPedi.Libre_c03 AT ROW 6.65 COL 86 COLON-ALIGNED HELP
          "" WIDGET-ID 6
          LABEL "Banco" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-4 AT ROW 6.65 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     ...
     FacCPedi.Libre_c04 AT ROW 7.46 COL 86 COLON-ALIGNED WIDGET-ID 38
          LABEL "Tarjeta" FORMAT "x(2)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-5 AT ROW 7.46 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FacCPedi.NroRef AT ROW 8.27 COL 9 COLON-ALIGNED WIDGET-ID 10
          LABEL "Vitrinas" FORMAT "X(254)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 15 FGCOLOR 12 
     COMBO-BOX-Proveedor AT ROW 8.27 COL 86 COLON-ALIGNED WIDGET-ID 48
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.04 COL 113
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.85 COL 113 WIDGET-ID 26
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 1.27 COL 75
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: PEDI-2 T "SHARED" NO-UNDO INTEGRAL Facdpedi
...
ON VALUE-CHANGED OF COMBO-BOX-Proveedor IN FRAME F-Main /* Proveedor */
DO:
...
DO:
    ...
    CASE s-FlgSit:
        ...
        END.
        WHEN "K" THEN DO:
            ENABLE  COMBO-BOX-Proveedor WITH FRAME {&FRAME-NAME}.                
            DISABLE faccpedi.libre_c03 WITH FRAME {&FRAME-NAME}.                
            DISABLE faccpedi.libre_c04 WITH FRAME {&FRAME-NAME}.                
            DISABLE faccpedi.libre_c05 WITH FRAME {&FRAME-NAME}.                
        END.
...
DO:
  IF s-FlgSit = "C" THEN DO:
      /*IF SELF:SCREEN-VALUE <> "7750822004" THEN DO:*/
      IF INTEGER(SELF:SCREEN-VALUE) <> 755629 THEN DO:
          MESSAGE 'Cupón NO válido' VIEW-AS ALERT-BOX ERROR.
          RETURN NO-APPLY.
      END.
  END.
END.
...
------------------------------------------------------------------------------*/
  ...
  RUN vta2/utilex-promocion-final (INPUT-OUTPUT TABLE PEDI).

  RUN vta2/utilex-descuentos-finales (INPUT-OUTPUT TABLE PEDI).
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF RETURN-VALUE = "NO" AND FAccpedi.FlgSit = "K" 
        THEN ASSIGN
...
/*     END.                                                                                                  */
    ...
    * ****************** */
    ...
    IF Faccpedi.FlgSit:SCREEN-VALUE = "CD" THEN DO:
        IF INPUT FacCPedi.Libre_c05 <> '20916106386' THEN DO:
            MESSAGE 'Cupón de Descuento NO válido' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO FacCPedi.Libre_c05.
            RETURN 'ADM-ERROR'.
        END.
