...
&Scoped-Define ENABLED-OBJECTS RECT-12 COMBO-NroSer BUTTON-1 
...
DEFINE VARIABLE h_v-cotiza-4exp-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 1.27 COL 101 WIDGET-ID 32
...
DO:
  RUN Genera-Excel IN h_v-cotiza-4exp-2.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamay/v-cotiza-4exp-2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cotiza-4exp-2 ).
       RUN set-position IN h_v-cotiza-4exp-2 ( 2.88 , 4.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-cotiza-4exp-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv02 , 'TableIO':U , h_v-cotiza-4exp-2 ).
       RUN add-link IN adm-broker-hdl ( h_q-cotexp-4-2 , 'Record':U , h_v-cotiza-4exp-2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv02 ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-cotiza-4exp-2 ,
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cotexp-4-2 , 'Record':U , h_b-cotiza-4-1 ).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-12 COMBO-NroSer BUTTON-1 
      WITH FRAME F-Main IN WINDOW W-Win.
