...
"PEDI.PorDto2" "% Dscto. 2" "->>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
      ...
      IF s-VentaMayorista = 2 THEN DO:  /* LISTA POR DIVISION */
          ...
          IF AVAILABLE VtaListaMay AND Vtalistamay.CanEmp > 0 THEN DO:
              ...
              IF f-CanPed <> DECIMAL(PEDI.CanPed:SCREEN-VALUE IN BROWSE {&browse-name}) THEN DO:
                  MESSAGE 'Solo puede vender en empaques de' Vtalistamay.CanEmp
                      VIEW-AS ALERT-BOX ERROR.
                  APPLY 'ENTRY':U TO PEDI.CanPed.
                  RETURN "ADM-ERROR".
              END.
  ...
  END.
    ...
    RUN vtagn/p-margen-utilidad (
        ...
        DECIMAL(PEDI.PreUni:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}),  /* Precio de venta unitario */
