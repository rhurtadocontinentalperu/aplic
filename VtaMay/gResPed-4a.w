...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 gDialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      T-CPEDI.ImpTot COLUMN-LABEL "Importe Total S/." FORMAT "->>,>>>,>>9.99":U
            WIDTH 12
      T-CPEDI.Glosa COLUMN-LABEL "Observaciones" FORMAT "X(40)":U
            WIDTH 40
      T-CPEDI.FlgIgv COLUMN-LABEL "Marcar solo los que se van a grabar" FORMAT "Si/no":U
            VIEW-AS TOGGLE-BOX
  ENABLE
      T-CPEDI.FlgIgv
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME gDialog
     ...
     Btn_Cancel AT ROW 7.19 COL 2
     Btn_OK AT ROW 7.19 COL 19
     "NOTA: sin hay error en el importe NUNCA se va a grabar" VIEW-AS TEXT
          SIZE 49 BY .81 AT ROW 6.12 COL 2 WIDGET-ID 2
          BGCOLOR 7 FGCOLOR 15 FONT 5
     SPACE(71.28) SKIP(1.79)
...
"T-CPEDI.CodDiv" "Division Destino" ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-CPEDI.ImpTot" "Importe Total S/." ? "decimal" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-CPEDI.Glosa
"T-CPEDI.Glosa" "Observaciones" "X(40)" "character" ? ? ? ? ? ? no ? no no "40" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-CPEDI.FlgIgv
"T-CPEDI.FlgIgv" "Marcar solo los que se van a grabar" ? "logical" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
