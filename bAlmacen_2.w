...
&Scoped-define DATA-FIELD-DEFS "aplic/dalmacen_2.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table CodAlm Descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table CodAlm Descripcion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CodAlm FORMAT "x(10)":U
      Descripcion FORMAT "X(100)":U
  ENABLE
      CodAlm
      Descripcion
/* _UIB-CODE-BLOCK-END */
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "aplic\dalmacen_2.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.CodAlm
"CodAlm" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Descripcion
