...
UTTON-NC x-Concepto x-FchDoc BROWSE-5 BROWSE-7 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-5 W-Win _STRUCTURED
  QUERY BROWSE-5 NO-LOCK DISPLAY
      ...
      Docu.ImpTot COLUMN-LABEL "Importe" FORMAT "->>,>>>,>>9.99":U
            WIDTH 12.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     UTTON-NC AT ROW 2.35 COL 101 WIDGET-ID 100
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "GENERACION DE NOTAS DE CREDITO VIA EXCEL"
         HEIGHT             = 18.65
         WIDTH              = 126.14
         MAX-HEIGHT         = 19
         MAX-WIDTH          = 128.86
...
"Docu.ImpTot" "Importe" ? "decimal" ? ? ? ? ? ? no ? no no "12.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-5 */
&ANALYZE-RESUME
...
ON END-ERROR OF W-Win /* GENERACION DE NOTAS DE CREDITO VIA EXCEL */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* GENERACION DE NOTAS DE CREDITO VIA EXCEL */
DO:
...
&Scoped-define SELF-NAME UTTON-NC
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL UTTON-NC W-Win
ON CHOOSE OF UTTON-NC IN FRAME F-Main /* GENERAR NOTAS DE CREDITO */
DO:
  ASSIGN
...
/*     FIND CURRENT Faccorre EXCLUSIVE-LOCK. */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 c-NroSer BUTTON-Excel x-CodMon UTTON-NC x-Concepto x-FchDoc 
         BROWSE-5 BROWSE-7 
      WITH FRAME F-Main IN WINDOW W-Win.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Graba-Comprobantes W-Win 
...
REPEAT:
    ...
    cValue = chWorkSheet:Range(cRange):VALUE.
    ASSIGN
        /*DOCU.NroDoc = (IF DOCU.CodDoc <> 'LET' THEN STRING(INTEGER(cValue), '999999999') ELSE cValue)*/
        DOCU.NroDoc = cValue
        NO-ERROR.
