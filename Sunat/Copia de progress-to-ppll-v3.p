...
/* pCaso: 
            ERROR forzar grabar agregando un "X" al final del número  YA NO SE USA
...
IF ERROR-STATUS:ERROR THEN DO:
    ...
    /* *************** LOG DE ERRORES **************** */
    pCodError = "Error: duplicado comprobante en FELogComprobantes: " + B-CDOCU.coddoc + ' ' + B-CDOCU.nrodoc.
    RUN Log-Error.
    /* *********************************************** */
END.
RETURN 'OK'.
...
ASSIGN
    ...
    NO-ERROR.
IF ERROR-STATUS:ERROR THEN DO:
    pCodError = "Error grabación comprobante en FELogComprobantes: " + B-CDOCU.coddoc + ' ' + B-CDOCU.nrodoc.
    DELETE FELogComprobantes NO-ERROR.
    RETURN 'ADM-ERROR'.
END.
RETURN 'OK'.
