...
DEFINE VARIABLE h_bgeneracionfactcredito AS HANDLE NO-UNDO.
...
DO:
  RUN dispatch IN h_bgeneracionfactcredito('open-query':U).
END.
...
DO:
    RUN Fraccionar-Orden IN h_bgeneracionfactcredito.
    RUN dispatch IN h_bgeneracionfactcredito ('open-query':U).
END.
...
DO:
    RUN proc_GeneraGuia IN h_bgeneracionfactcredito.
    RUN dispatch IN h_bgeneracionfactcredito ('open-query':U).
END.
...
DO:
    RUN proc_GeneraGuiaManual IN h_bgeneracionfactcredito.
    RUN dispatch IN h_bgeneracionfactcredito ('open-query':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'sunat/bgeneracionfactcredito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bgeneracionfactcredito ).
       RUN set-position IN h_bgeneracionfactcredito ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bgeneracionfactcredito ( 9.04 , 96.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_bgeneracionfactcredito , 'Record':U , h_b-genera-factura-credb ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bgeneracionfactcredito ,
