...
FOR EACH T-CDOCU NO-LOCK BY T-CDOCU.NroDoc:
    ...
    IF AVAILABLE CcbCDocu THEN DO:
        ...
        */
        /* Solo FACTURA y BOLETA(en formato pre-impreso NO ticketera)  */
        IF Ccbcdocu.CodDoc = "FAC" OR Ccbcdocu.CodDoc = "BOL" THEN
                RUN sunat/r-fact02-1-sunat (ROWID(ccbcdocu)) NO-ERROR.
