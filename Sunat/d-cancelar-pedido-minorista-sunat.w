...
FILL-IN_ImpUsa4 FILL-IN_Voucher7 BUTTON-TpoCmb Btn_OK Btn_Cancel 
...
FILL-IN-4 FILL-IN_ImpNac6 FILL-IN_ImpUsa6 FILL-IN_ImpNac7 FILL-IN_ImpUsa7 ~
FILL-IN_Voucher7 FILL-IN_SaldoAR FILL-IN_ImpNac9 FILL-IN_ImpUsa9 ~
FILL-IN_Voucher4 FILL-IN_ImpNac10 FILL-IN_ImpUsa10 RADIO-SET_Codmon ~
FILL-IN_VueNac FILL-IN_VueUsa FILL-IN_T_Venta FILL-IN-coddoc FILL-IN-nrodoc ~
FILL-IN_T_Compra 
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN_ImpNac4 AT ROW 6.19 COL 14 COLON-ALIGNED
     FILL-IN_ImpUsa4 AT ROW 6.19 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher4a AT ROW 6.19 COL 38 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     FILL-IN_Voucher4b AT ROW 6.19 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN_Voucher4c AT ROW 6.19 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     FILL-IN_CodBco4 AT ROW 6.19 COL 55.29 COLON-ALIGNED NO-LABEL
     COMBO_TarjCred AT ROW 6.19 COL 61.72 COLON-ALIGNED NO-LABEL
     FILL-IN-4 AT ROW 6.19 COL 79 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac6 AT ROW 6.96 COL 14 COLON-ALIGNED
     FILL-IN_ImpUsa6 AT ROW 6.96 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac7 AT ROW 7.73 COL 14 COLON-ALIGNED
     FILL-IN_ImpUsa7 AT ROW 7.73 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher7 AT ROW 7.73 COL 38 COLON-ALIGNED NO-LABEL
     FILL-IN_SaldoAR AT ROW 7.73 COL 61.72 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac9 AT ROW 8.5 COL 14 COLON-ALIGNED
     FILL-IN_ImpUsa9 AT ROW 8.5 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher4 AT ROW 8.62 COL 72 COLON-ALIGNED
     BUTTON-Vales AT ROW 9.08 COL 40
     BUTTON-Tickets AT ROW 9.08 COL 41 WIDGET-ID 2
     FILL-IN_ImpNac10 AT ROW 9.31 COL 14 COLON-ALIGNED
     FILL-IN_ImpUsa10 AT ROW 9.31 COL 26 COLON-ALIGNED NO-LABEL
     BUTTON-TpoCmb AT ROW 10.62 COL 39
     RADIO-SET_Codmon AT ROW 10.65 COL 8.72 NO-LABEL
     FILL-IN_VueNac AT ROW 10.73 COL 14 COLON-ALIGNED NO-LABEL
     FILL-IN_VueUsa AT ROW 10.73 COL 26 COLON-ALIGNED NO-LABEL
     Btn_OK AT ROW 11.96 COL 2
     Btn_Cancel AT ROW 11.96 COL 14
     FILL-IN_T_Venta AT ROW 11.96 COL 46 COLON-ALIGNED PASSWORD-FIELD 
     FILL-IN-coddoc AT ROW 12.15 COL 67 COLON-ALIGNED
     FILL-IN-nrodoc AT ROW 12.15 COL 71.14 COLON-ALIGNED NO-LABEL
     FILL-IN_T_Compra AT ROW 12.73 COL 46 COLON-ALIGNED
     "En S/." VIEW-AS TEXT
     ...
     "Vuelto" VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 10.81 COL 3
...
DO:
    ...
    /* Verifica Vuelto */
    /*
    MESSAGE RADIO-SET_codmon SKIP FILL-IN_vuenac FILL-IN_vueusa SKIP FILL-IN_t_compra
        SKIP FILL-IN_ImpNac1 FILL-IN_ImpUsa1.
    */
    ...
    IF CAN-FIND(FIRST wrk_ret) THEN DO:
        IF h_r-dcaja1-02 <> ? THEN DO:
            RUN proc_return_data IN h_r-dcaja1-02 (OUTPUT Ffchret, OUTPUT Cnroret).
            FOR EACH wrk_ret:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 13.69 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_r-dcaja1-02 ( 14.85 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 15.04 , 68.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-canc-ped-min-sunat ( 14.85 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 15.81 , 70.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_t-canc-ped-min-sunat , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
          ...
          FILL-IN_CodBco4 COMBO_TarjCred FILL-IN-4 FILL-IN_ImpNac6 
          FILL-IN_ImpUsa6 FILL-IN_ImpNac7 FILL-IN_ImpUsa7 FILL-IN_Voucher7 
          FILL-IN_SaldoAR FILL-IN_ImpNac9 FILL-IN_ImpUsa9 FILL-IN_Voucher4 
          FILL-IN_ImpNac10 FILL-IN_ImpUsa10 RADIO-SET_Codmon FILL-IN_VueNac 
