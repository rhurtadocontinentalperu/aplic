...
IF TRUE <> (cListItems > '') THEN DO:
    MESSAGE 'NO definido el documento' s-coddoc 'para la división' s-coddiv SKIP
...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 116 BY 10.58 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ANULACION DE PRE NOTAS DE CREDITO - APROBADAS"
         HEIGHT             = 10.58
         WIDTH              = 116
         MAX-HEIGHT         = 27.38
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF W-Win /* ANULACION DE PRE NOTAS DE CREDITO - APROBADAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ANULACION DE PRE NOTAS DE CREDITO - APROBADAS */
DO:
...
CASE s-CodDoc:
    WHEN "N/C" THEN {&WINDOW-NAME}:TITLE = "ANULACION DE PRE NOTAS DE CREDITO - APROBADAS".
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'CCB/vncndxpncpnd-anular.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/qnotacreditodebito-anular.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
