...
&Scoped-define INTERNAL-TABLES FacCPedi FacDPedi gn-ConVt
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
    ...
    BY FacCPedi.FchPed DESCENDING ~
       BY FacCPedi.NroPed DESCENDING.
&Scoped-define TABLES-IN-QUERY-br_table FacCPedi FacDPedi gn-ConVt
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 9.04
         FONT 4
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacCPedi,INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.gn-ConVt WHERE INTEGRAL.FacCPedi ..."
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    CASE gn-ConVt.Libre_l01:
        WHEN NO  THEN RUN sunat/d-genera-factura-sunat ( ROWID(FacCPedi), 'A' ).       /* AUTOMATICA */
        WHEN YES THEN RUN sunat/d-genera-factura-sunat ( ROWID(FacCPedi), 'FA' ).       /* AUTOMATICA */
    END CASE.
...
------------------------------------------------------------------------------*/
    ...
    CASE gn-ConVt.Libre_l01:
        WHEN NO  THEN RUN sunat/d-genera-factura-sunat ( ROWID(FacCPedi), 'M' ).       /* AUTOMATICA */
        WHEN YES THEN RUN sunat/d-genera-factura-sunat ( ROWID(FacCPedi), 'FM' ).       /* AUTOMATICA */
    END CASE.
