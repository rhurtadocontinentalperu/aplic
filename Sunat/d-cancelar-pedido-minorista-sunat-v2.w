...
IF PgoTarjCr = "PPO" THEN DO:
    IF NUM-ENTRIES(pxCodPro,"|") > 1 AND ENTRY(1,pxCodPro,'|') = "PPO" THEN DO:
        /* Si viene por Calidda => Forzamos el pago con PPO */
    END.
END.
ELSE DO:
    pCodPro = pxCodPro.
...
COMBO_TarPtoTpo FILL-IN_Voucher-Pto COMBO-BOX_CodBco5 FILL-IN_ImpNac5 ~
...
FILL-IN_Voucher7 FILL-IN_SaldoAR FILL-IN_ImpNac9 FILL-IN_ImpUsa9 ~
FILL-IN_ImpNac10 FILL-IN_ImpUsa10 FILL-IN_ImpNac8 FILL-IN_ImpUsa8 ~
RADIO-SET_Codmon FILL-IN_VueNac FILL-IN_VueUsa FILL-IN_T_Venta ~
FILL-IN-coddoc FILL-IN-nrodoc FILL-IN_T_Compra FILL-IN-delivery 
...
DEFINE VARIABLE FILL-IN_Voucher5 AS CHARACTER FORMAT "x(15)" 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .81.
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN_ImpNac1 AT ROW 5.31 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa1 AT ROW 5.31 COL 27 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac4 AT ROW 6.12 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa4 AT ROW 6.12 COL 27 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher4a AT ROW 6.12 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     FILL-IN_Voucher4b AT ROW 6.12 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN_Voucher4c AT ROW 6.12 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     FILL-IN_CodBco4 AT ROW 6.12 COL 58 COLON-ALIGNED NO-LABEL
     COMBO_TarjCred AT ROW 6.12 COL 65 COLON-ALIGNED NO-LABEL
     FILL-IN-4 AT ROW 6.12 COL 82 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher4 AT ROW 6.12 COL 94 COLON-ALIGNED NO-LABEL
     FILL-IN_TarPtoNac AT ROW 6.92 COL 15 COLON-ALIGNED WIDGET-ID 12
     FILL-IN_TarPtoUsa AT ROW 6.92 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     FILL-IN_Voucher5a AT ROW 6.92 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     FILL-IN_Voucher5b AT ROW 6.92 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     FILL-IN_Voucher5c AT ROW 6.92 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     FILL-IN_TarPtoBco AT ROW 6.92 COL 58 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     COMBO_TarPtoTpo AT ROW 6.92 COL 65 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     FILL-IN_Voucher-Pto AT ROW 6.92 COL 94 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     COMBO-BOX_CodBco5 AT ROW 7.65 COL 3 HELP
          "C¢digo de auxiliar" NO-LABEL WIDGET-ID 38
     FILL-IN_ImpNac5 AT ROW 7.69 COL 15 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FILL-IN_ImpUsa5 AT ROW 7.73 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     FILL-IN_Voucher5 AT ROW 7.73 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     FILL-IN_CodBco5 AT ROW 7.73 COL 65 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     FILL-IN-5 AT ROW 7.73 COL 71.43 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     FILL-IN_SaldoBD AT ROW 7.73 COL 94 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     FILL-IN_ImpNac6 AT ROW 8.54 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa6 AT ROW 8.54 COL 27 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac7 AT ROW 9.35 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa7 AT ROW 9.35 COL 27 COLON-ALIGNED NO-LABEL
     FILL-IN_Voucher7 AT ROW 9.35 COL 39 COLON-ALIGNED NO-LABEL
     FILL-IN_SaldoAR AT ROW 9.35 COL 65 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac9 AT ROW 10.15 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa9 AT ROW 10.15 COL 27 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac10 AT ROW 10.96 COL 15 COLON-ALIGNED
     FILL-IN_ImpUsa10 AT ROW 10.96 COL 27 COLON-ALIGNED NO-LABEL
     BUTTON-Vales AT ROW 10.96 COL 41
     BUTTON-Tickets AT ROW 10.96 COL 42 WIDGET-ID 2
     FILL-IN_ImpNac8 AT ROW 11.77 COL 15 COLON-ALIGNED WIDGET-ID 34
     FILL-IN_ImpUsa8 AT ROW 11.77 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     BUTTON-TpoCmb AT ROW 13.04 COL 40
     RADIO-SET_Codmon AT ROW 13.08 COL 9.72 NO-LABEL
     FILL-IN_VueNac AT ROW 13.15 COL 15 COLON-ALIGNED NO-LABEL
     FILL-IN_VueUsa AT ROW 13.15 COL 27 COLON-ALIGNED NO-LABEL
     Btn_OK AT ROW 14.38 COL 3
...
DEFINE FRAME D-Dialog
     Btn_Cancel AT ROW 14.38 COL 15
     FILL-IN_T_Venta AT ROW 14.38 COL 47 COLON-ALIGNED PASSWORD-FIELD 
     FILL-IN-coddoc AT ROW 14.58 COL 68 COLON-ALIGNED
     FILL-IN-nrodoc AT ROW 14.58 COL 72.14 COLON-ALIGNED NO-LABEL
     FILL-IN_T_Compra AT ROW 15.15 COL 47 COLON-ALIGNED
     ...
     "Vuelto" VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.23 COL 4
     ...
     RECT-4 AT ROW 12.85 COL 2
     RECT-10 AT ROW 4.27 COL 40
     RECT-6 AT ROW 4.27 COL 2
     RECT-33 AT ROW 4.27 COL 66 WIDGET-ID 30
     SPACE(2.85) SKIP(11.45)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE BGCOLOR 10 FGCOLOR 0 "Forma de Cancelación".
    ...
    CASE PgoTarjCr:
        WHEN 'T' THEN DO:
            IF FILL-IN_ImpNac4 + FILL-IN_ImpUsa4 + FILL-IN_TarPtoNac + FILL-IN_TarPtoUsa <= 0 
                THEN DO:
                MESSAGE 'NO se ha registrado pagos con tarjeta de crédito/debito'
                    VIEW-AS ALERT-BOX ERROR.
                RETURN NO-APPLY.
            END.
            IF pBanco <> '' AND FILL-IN_CodBco4 <> pBanco THEN DO:
                MESSAGE 'NO coincide el banco' SKIP 
                    'Debería ser el' pBanco
                    VIEW-AS ALERT-BOX ERROR.
                ASSIGN
...
DO:
    ASSIGN
        ...
        input-var-2 = COMBO-BOX_CodBco5
        input-var-3 = "P".  
    RUN lkup/c-boldep-03a ("BOLETAS DE DEPOSITO").
...
/*     END.                                                                          */
    IF LENGTH(SELF:SCREEN-VALUE) <> 2 THEN DO:
        MESSAGE 'Debe ingresar los 2 primeros dígitos' VIEW-AS ALERT-BOX WARNING.
        RETURN NO-APPLY.
    END.
...
DO:
    ...
    IF FILL-IN_Voucher7 <> '' THEN DO:
        ...
        IF Ccbcdocu.FchDoc < (TODAY - 3) THEN DO:
            MESSAGE 'Solo se permiten anticipos dentro de los 3 días'
                VIEW-AS ALERT-BOX ERROR.
            RETURN NO-APPLY.
        END.
        /* ********************************************* */
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 16.12 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_r-dcaja1-02 ( 17.19 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 17.46 , 67.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 17.15 , 71.00 ) NO-ERROR.
       ...
       RUN set-position IN h_t-canc-ped-min-sunat ( 17.19 , 3.00 ) NO-ERROR.
...
DO WITH FRAME D-Dialog:
    ...
    ASSIGN
        ...
        FILL-IN_TarPtoUsa
        .
    ASSIGN FILL-IN_ImpNac8 FILL-IN_ImpUsa8.
    fSumSol = FILL-IN_ImpNac1 + FILL-IN_ImpNac4 + FILL-IN_ImpNac5 +
        FILL-IN_ImpNac6 + FILL-IN_ImpNac7 + FILL-IN_ImpNac8 +
        FILL-IN_ImpNac9 + FILL-IN_ImpNac10 +
        FILL-IN_TarPtoNac.
    fSumDol = FILL-IN_ImpUsa1 + FILL-IN_ImpUsa4 + FILL-IN_ImpUsa5 +
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
          ...
          FILL-IN_Voucher-Pto COMBO-BOX_CodBco5 FILL-IN_ImpNac5 FILL-IN_ImpUsa5 
        ...
        IF Contado THEN DO:
            ...
            WHEN "PPO" THEN DO:
                FIND FIRST FacDocum WHERE FacDocum.CodCia = s-CodCia AND
                    FacDocum.CodDoc = PgoTarjCr
                    NO-LOCK NO-ERROR.
                IF AVAILABLE FacDocum THEN DO:
                    COMBO-BOX_CodBco5:DELETE(1).
                    COMBO-BOX_CodBco5:ADD-LAST(FacDocum.CodDoc, FacDocum.CodDoc).
                    COMBO-BOX_CodBco5:SENSITIVE = NO.
                    COMBO-BOX_CodBco5 = PgoTarjCr.
                    COMBO-BOX_CodBco5:SCREEN-VALUE = PgoTarjCr.
                    FILL-IN_Voucher5:SENSITIVE = YES.
                    FIND Ccbcdocu WHERE Ccbcdocu.codcia = s-codcia
                        AND Ccbcdocu.coddoc = ENTRY(1,pxCodPro,'|')
                        AND Ccbcdocu.nrodoc = ENTRY(2,pxCodPro,'|')
                        AND Ccbcdocu.flgest = "P"
                        NO-LOCK NO-ERROR.
                    IF AVAILABLE Ccbcdocu THEN DO:
                        FILL-IN_Voucher5:SENSITIVE = NO.
                        FILL-IN_Voucher5:SCREEN-VALUE = ENTRY(2,pxCodPro,'|').
                        FILL-IN_SaldoBD = Ccbcdocu.sdoact.
                        IF Ccbcdocu.codmon = 1 THEN FILL-IN_ImpNac5 = Ccbcdocu.sdoact.
                        ELSE FILL-IN_ImpUsa5 = Ccbcdocu.sdoact.
                        FILL-IN_ImpNac1 = FILL-IN_ImpNac1 - FILL-IN_ImpNac5.
                        FILL-IN_ImpUsa1 = FILL-IN_ImpUsa1 - FILL-IN_ImpUsa5.
                        DISPLAY FILL-IN_ImpNac1 FILL-IN_ImpNac5 FILL-IN_ImpUsa1 FILL-IN_ImpUsa5 FILL-IN_SaldoBD.
                    END.
                END.
            END.
            OTHERWISE DO:
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    END.
    /* RHC 22/06/2016 Tarjeta Créditos Puntos */
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    END.
        ...
        FIND FIRST CcbCDocu WHERE 
            CcbCDocu.CodCia = S-CodCia AND  
            CcbCDocu.CodDoc = COMBO-BOX_CodBco5 AND  
