...
FILL-IN_Voucher5 FILL-IN_Voucher7 BUTTON-TpoCmb Btn_OK Btn_Cancel 
    ...
    CASE PgoTarjCr:
        WHEN 'T' THEN DO:
            IF FILL-IN_ImpNac4 + FILL-IN_ImpUsa4 + FILL-IN_TarPtoNac + FILL-IN_TarPtoUsa <= 0 
                THEN DO:
                MESSAGE 'NO se ha registrado pagos con tarjeta de crédito'
                    VIEW-AS ALERT-BOX ERROR.
                RETURN NO-APPLY.
            END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 RECT-32 RECT-9 RECT-7 RECT-5 RECT-4 RECT-10 RECT-6 RECT-33 
         ...
         FILL-IN_TarPtoNac FILL-IN_TarPtoUsa FILL-IN_TarPtoBco FILL-IN_Voucher5 
        ...
        IF Contado THEN DO:
            ...
            WHEN "PPO" THEN DO:
                ...
                IF AVAILABLE FacDocum THEN DO:
                    ...
                    COMBO-BOX_CodBco5:ADD-LAST(FacDocum.NomDoc, FacDocum.CodDoc).
