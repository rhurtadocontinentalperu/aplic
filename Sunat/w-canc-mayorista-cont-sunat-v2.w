...
DEFINE VARIABLE h_b-canc-mayorista-cont-sunat-v2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF ssW-Win /* Cancelación de Pedidos Pendientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ssW-Win ssW-Win
ON WINDOW-CLOSE OF ssW-Win /* Cancelación de Pedidos Pendientes */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-Compbte ssW-Win
...
DO:
    ...
    RUN proc_CanPed IN h_b-canc-mayorista-cont-sunat-v2.
    /*
    RUN Cancelar-Pedido IN h_b-canc-mayorista-cont-sunat-v2.
    */
    RUN dispatch IN h_b-canc-mayorista-cont-sunat-v2 ('open-query':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-Refresh ssW-Win
ON CHOOSE OF Btn-Refresh IN FRAME F-Main /* Refrescar */
DO:
    RUN dispatch IN h_b-canc-mayorista-cont-sunat-v2 ('open-query-cases':U).
    RUN proc_CalTot IN h_b-canc-mayorista-cont-sunat-v2.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-Salir ssW-Win
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/b-canc-mayorista-cont-sunat-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Hora':U ,
             OUTPUT h_b-canc-mayorista-cont-sunat-v2 ).
       RUN set-position IN h_b-canc-mayorista-cont-sunat-v2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-canc-mayorista-cont-sunat-v2 ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-canc-mayorista-cont-sunat-v2 ,
