...
DEFINE VARIABLE h_bgeneracionfactcredito-v2 AS HANDLE NO-UNDO.
...
DO:
  RUN dispatch IN h_bgeneracionfactcredito-v2('open-query':U).
END.
...
DO:
    RUN Fraccionar-Orden IN h_bgeneracionfactcredito-v2.
    RUN dispatch IN h_bgeneracionfactcredito-v2 ('open-query':U).
END.
...
DO:
    RUN proc_GeneraGuia IN h_bgeneracionfactcredito-v2.
    RUN dispatch IN h_bgeneracionfactcredito-v2 ('open-query':U).
END.
...
DO:
    RUN proc_GeneraGuiaManual IN h_bgeneracionfactcredito-v2.
    RUN dispatch IN h_bgeneracionfactcredito-v2 ('open-query':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'sunat/bgeneracionfactcredito-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bgeneracionfactcredito-v2 ).
       RUN set-position IN h_bgeneracionfactcredito-v2 ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bgeneracionfactcredito-v2 ( 9.04 , 96.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_bgeneracionfactcredito-v2 , 'Record':U , h_b-genera-factura-credb ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bgeneracionfactcredito-v2 ,
