...
DEFINE FRAME F-Main
     ...
     F-Estado AT ROW 1 COL 30 COLON-ALIGNED
...
"Cupón de Descuento", "CD":U
     ...
     FacCPedi.FlgIgv AT ROW 2.54 COL 120 NO-LABEL WIDGET-ID 100
...
"No", no
     ...
     FacCPedi.CodMon AT ROW 3.31 COL 120 NO-LABEL WIDGET-ID 92
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
     ...
     FacCPedi.Atencion AT ROW 4.08 COL 31 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 4.08 COL 118 COLON-ALIGNED WIDGET-ID 120
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
DEFINE FRAME F-Main
     ...
     FacCPedi.Libre_c03 AT ROW 7.15 COL 86 COLON-ALIGNED WIDGET-ID 108
     ...
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 2.62 COL 113 WIDGET-ID 116
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 3.5 COL 113 WIDGET-ID 118
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE faccpedi THEN DO:          
      ...
      END.
  END.      
  RUN sunat\p-canc-minorista-cont-sunat-v2 (ROWID(FacCPedi)).
  ...
  DO WITH FRAME {&FRAME-NAME} :
    ...
    IF F-Tot > ImpMinDNI THEN DO:
       IF Faccpedi.Cmpbnte:SCREEN-VALUE = 'BOL' 
           AND LENGTH(Faccpedi.Atencion:SCREEN-VALUE, "CHARACTER") <> 8
           THEN DO:
