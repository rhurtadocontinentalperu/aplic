...
DEFINE SHARED VARIABLE s-genera-gr AS LOG.  /* Genera o no G/R */
...
/*           END.                                                  */
      ...
      ASSIGN
          ...
          FILL-IN-items = (IF cCodDoc = "TCK" THEN 9999 ELSE FacCfgGn.Items_Guias)
