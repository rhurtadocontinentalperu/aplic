...
&IF DEFINED(EXCLUDE-tabla-ccbcdocu-pruebas) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE tabla-ccbcdocu-pruebas Procedure 
PROCEDURE tabla-ccbcdocu-pruebas :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
RUN sunat/sunat-calculo-importes-ccbcdocu-pruebas.r (INPUT pCodDiv,
                                           INPUT pCoddoc,
                                           INPUT pNroDoc,
                                           OUTPUT pRetVal).
IF pRetVal <> "OK" THEN DO:
