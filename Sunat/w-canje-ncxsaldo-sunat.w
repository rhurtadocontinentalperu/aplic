...
DEFINE VARIABLE h_v-canje-ncxsaldo-sunat AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 101.72 BY 20.04 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'sunat/v-canje-ncxsaldo-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-canje-ncxsaldo-sunat ).
       RUN set-position IN h_v-canje-ncxsaldo-sunat ( 3.12 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-canje-ncxsaldo-sunat. */
       RUN add-link IN adm-broker-hdl ( h_p-updv06 , 'TableIO':U , h_v-canje-ncxsaldo-sunat ).
       RUN add-link IN adm-broker-hdl ( h_qcanjexletra , 'Record':U , h_v-canje-ncxsaldo-sunat ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv06 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-canje-ncxsaldo-sunat ,
    ...
    WHEN 1 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_bcanjexletra-01 ,
             h_v-canje-ncxsaldo-sunat , 'AFTER':U ).
