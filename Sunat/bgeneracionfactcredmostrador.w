...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN sunat\dgeneracionfactcredito-v3 ( ROWID(FacCPedi), 'A', "MOSTRADOR", s-CodTer ).       /*AUTOMATICA*/
/*     IF s-user-id = 'ADMIN' THEN                                                                                      */
/*         RUN sunat\dgeneracionfactcredito-v3 ( ROWID(FacCPedi), 'A', "MOSTRADOR", s-CodTer ).       /*AUTOMATICA*/    */
/*     ELSE RUN sunat\dgeneracionfactcredito-v2 ( ROWID(FacCPedi), 'A', "MOSTRADOR", s-CodTer ).       /* AUTOMATICA */ */
