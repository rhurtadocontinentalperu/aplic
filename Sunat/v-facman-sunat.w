...
DEF SHARED VAR s-tipo   AS CHAR INITIAL "CANCELACION".
...
CcbCDocu.CodVen CcbCDocu.NroOrd CcbCDocu.FmaPgo CcbCDocu.CodMon ~
CcbCDocu.Glosa 
&Scoped-define ENABLED-TABLES CcbCDocu
&Scoped-define FIRST-ENABLED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.ImpTot CcbCDocu.FchDoc ~
CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.TpoCmb CcbCDocu.DirCli ~
CcbCDocu.FchVto CcbCDocu.RucCli CcbCDocu.CodAnt CcbCDocu.NroPed ~
CcbCDocu.CodVen CcbCDocu.NroOrd CcbCDocu.FmaPgo CcbCDocu.CodMon ~
CcbCDocu.NroRef CcbCDocu.Glosa 
...
DEFINE VARIABLE FILL-IN-NroDoc AS CHARACTER FORMAT "X(6)":U 
     VIEW-AS FILL-IN 
     SIZE 8 BY .81 NO-UNDO.

DEFINE VARIABLE FILL-IN-NroSer AS CHARACTER FORMAT "X(3)":U 
     LABEL "Número" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-NroDoc AT ROW 1 COL 13 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     ...
     CcbCDocu.CodAnt AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 16
          ...
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     CcbCDocu.NroPed AT ROW 3.42 COL 91 COLON-ALIGNED FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ...
     CcbCDocu.NroOrd AT ROW 4.23 COL 91 COLON-ALIGNED
     ...
     CcbCDocu.CodMon AT ROW 5.04 COL 93.14 NO-LABEL
...
"US$", 2
     ...
     "Moneda:" VIEW-AS TEXT
          SIZE 6.43 BY .5 AT ROW 5.04 COL 86
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
     DISPLAY 
         ...
         STRING (I-NroSer, '999') @ FILL-IN-NroSer
         STRING (I-NroDoc, '999999')  @ FILL-IN-NroDoc
         '000' @ CcbCDocu.FmaPgo.
     FILL-IN-NroDoc = STRING (I-NroDoc, '999999').
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbCDocu THEN DO WITH FRAME {&FRAME-NAME}:
      DISPLAY
          ...
          SUBSTRING(Ccbcdocu.nrodoc,4) @ FILL-IN-NroDoc.
