...
DEFINE VARIABLE h_vpedidotiendasutilexsunat AS HANDLE NO-UNDO.
...
DO:
  ...
  RUN Cancelar-Pedido IN h_vpedidotiendasutilexsunat.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/vpedidotiendasutilexsunat-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vpedidotiendasutilexsunat ).
       RUN set-position IN h_vpedidotiendasutilexsunat ( 2.73 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.73 , 131.00 ) */
       ...
       /* Links to SmartViewer h_vpedidotiendasutilexsunat. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_vpedidotiendasutilexsunat ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido-4 , 'Record':U , h_vpedidotiendasutilexsunat ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv05 ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_vpedidotiendasutilexsunat ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_tpedidotiendasutilex ( 10.62 , 2.00 ) NO-ERROR.
...
/*       END.                                            */
    WHEN "Recalculo" THEN DO WITH FRAME {&FRAME-NAME}:
        IF h_vpedidotiendasutilexsunat <> ? THEN RUN Recalcular-Precios IN h_vpedidotiendasutilexsunat.
