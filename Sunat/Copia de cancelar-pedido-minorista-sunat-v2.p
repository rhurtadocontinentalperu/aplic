...
IF s-Sunat-Activo = NO THEN s-CodDoc = "TCK".   
/* ***************************************************** */
...
/* ELSE RUN sunat\d-cancelar-pedido-minorista-sunat (                    */
/*         B-CPEDM.codmon,     /* Moneda Documento */                    */
/*         (B-CPEDM.imptot + B-CPEDM.acubon[5]),     /* Importe Total */ */
/*         monto_ret,          /* Retención */                           */
/*         B-CPEDM.NomCli,     /* Nombre Cliente */                      */
...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    ...
    /* GRABA DOCUMENTOS EN LA BASE DE DATOS */
        ...
        FOR EACH FacDPedi OF FacCPedi,
            ...
            BUFFER-COPY Facdpedi 
                ...
                ASSIGN
                    ...
                    T-DDOCU.AlmDes = FacDPedi.AlmDes    /* OJO */
                    T-DDOCU.CanDes = FacDPedi.CanPed.
