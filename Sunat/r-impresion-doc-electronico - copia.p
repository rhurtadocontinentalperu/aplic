...
ELSE DO:
    ...
    /* Ic - 09Oct2019, correo de Max Ramos. Division 00024 no considerar */
    IF LOOKUP(ccbcdocu.divori,"00030,00070") > 0 THEN DO:
...
FOR EACH ccbddocu OF ccbcdocu NO-LOCK BREAK BY Ccbddocu.NroItm:
    ...
    IF Ccbddocu.Por_Dsctos[1] > 0 OR Ccbddocu.Por_Dsctos[2] > 0 OR Ccbddocu.Por_Dsctos[3] > 0 THEN DO:
        ...
        x-dscto1 = ( 1 -  ( 1 - Ccbddocu.Por_Dsctos[1] / 100 ) *
                    ...
                    ( 1 - Ccbddocu.dcto_otros_factor / 100 )
                     ) * 100.
    ...
    ASSIGN  w-report.campo-f[6] = x-operaciones-gravadas    /*ccbcdocu.impvta       */
            ...
            w-report.campo-f[13] = x-total-igv  /*ccbcdocu.impigv*/
            w-report.campo-f[14] = x-total-a-pagar  /*lTotalPagar*/
    ...
    ASSIGN w-report.Campo-f[30] = Ccbcdocu.AcuBon[10].
