...
IF FacUsers.CodDiv = "" OR FacUsers.CodAlm = "" THEN DO:
   MESSAGE "Falta definir parámetros de Usuarios" VIEW-AS ALERT-BOX ERROR.
   RETURN ERROR.
END.
...
/* 15/03/22 Cambiamos al primer almacén de despacho de la sede */
...
END.
IF x-Ok = NO THEN DO:
    /* Buscamos por almacén principal */
