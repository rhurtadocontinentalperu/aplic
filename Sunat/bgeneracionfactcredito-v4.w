...
"STRING(FacCPedi.Libre_c02, 'x(3)') + ' ' + STRING(FacCPedi.Libre_c03, 'x(10)') @ x-NroRef" "Referencia" ? ? ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN logis\d-genera-comprobantes-sunat ( ROWID(FacCPedi), 'A', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN logis\d-genera-comprobantes-sunat ( ROWID(FacCPedi), 'FA', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
    &ELSE
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN logis\d-genera-comprobantes ( ROWID(FacCPedi), 'A', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN logis\d-genera-comprobantes ( ROWID(FacCPedi), 'FA', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
    &ENDIF
...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN sunat\dgeneracionfactcredito-v4 ( ROWID(FacCPedi), 'M', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN sunat\dgeneracionfactcredito-v4 ( ROWID(FacCPedi), 'FM', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
