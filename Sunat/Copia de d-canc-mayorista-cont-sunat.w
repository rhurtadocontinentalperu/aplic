...
FILL-IN-4 FILL-IN_ImpNac6 FILL-IN_ImpUsa6 COMBO-BOX_CodBco7 FILL-IN_ImpNac7 ~
...
DEFINE FRAME D-Dialog
     ...
     COMBO-BOX_CodBco7 AT ROW 7.73 COL 2 HELP
          "C¢digo de auxiliar" NO-LABEL WIDGET-ID 2
     FILL-IN_ImpNac7 AT ROW 7.73 COL 14 COLON-ALIGNED NO-LABEL
     ...
     BUTTON-TpoCmb AT ROW 10.42 COL 39
     RADIO-SET_Codmon AT ROW 10.46 COL 8.72 NO-LABEL
     FILL-IN_VueNac AT ROW 10.54 COL 14 COLON-ALIGNED NO-LABEL
     FILL-IN_VueUsa AT ROW 10.54 COL 26 COLON-ALIGNED NO-LABEL
     Btn_OK AT ROW 11.77 COL 2
     Btn_Cancel AT ROW 11.77 COL 14.14
     FILL-IN_T_Venta AT ROW 11.77 COL 46 COLON-ALIGNED
     FILL-IN-coddoc AT ROW 11.96 COL 67 COLON-ALIGNED
     FILL-IN-nrodoc AT ROW 11.96 COL 71.14 COLON-ALIGNED NO-LABEL
     FILL-IN_T_Compra AT ROW 12.54 COL 46 COLON-ALIGNED
     "Numero Documento" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 4.5 COL 39.86
     "Vuelto" VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 10.62 COL 3
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 13.50 , 2.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_r-dcaja1-02 ( 14.65 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 14.85 , 73.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-dcaja1-02 ( 14.65 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 15.92 , 72.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
          ...
          FILL-IN_ImpUsa6 COMBO-BOX_CodBco7 FILL-IN_ImpNac7 FILL-IN_ImpUsa7 
