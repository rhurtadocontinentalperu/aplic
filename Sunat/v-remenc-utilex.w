...
DO:
    ...
    IF CcbCDocu.CodCli <> FILL-IN-CodCli THEN DO:
        MESSAGE 'Documento no corresponde a este cliente' VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF CcbCDocu.FlgEst = 'C' THEN DO:
        MESSAGE 'Documento Cancelado' VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
    IF CcbCDocu.FlgEst = 'A' THEN DO:
        MESSAGE 'Documento Anulado' VIEW-AS ALERT-BOX ERROR.
