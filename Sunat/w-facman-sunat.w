...
DEFINE VARIABLE h_v-facman-sunat AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/v-facman-sunat.r':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-facman-sunat ).
       RUN set-position IN h_v-facman-sunat ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-facman-sunat. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-facman-sunat ).
       RUN add-link IN adm-broker-hdl ( h_q-docmto , 'Record':U , h_v-facman-sunat ).
...
CASE L-Handle:
    ...
    WHEN "Importe-de-control" THEN DO:
        RUN Importe-de-control IN h_v-facman-sunat.
