...
DEFINE VARIABLE h_v-ncnd-otros-sunat AS HANDLE NO-UNDO.
...
CASE s-CodDoc:
    ...
    WHEN "N/D" THEN {&WINDOW-NAME}:TITLE = "NOTAS DE DEBITO POR OTROS CONCEPTOS".
END CASE.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/v-ncnd-otros-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ncnd-otros-sunat ).
       RUN set-position IN h_v-ncnd-otros-sunat ( 2.54 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_qnotacreditodebito ( 1.00 , 108.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 7.00 ) */

       /* Links to SmartViewer h_v-ncnd-otros-sunat. */
       RUN add-link IN adm-broker-hdl ( h_p-updv13 , 'TableIO':U , h_v-ncnd-otros-sunat ).
       RUN add-link IN adm-broker-hdl ( h_qnotacreditodebito , 'Record':U , h_v-ncnd-otros-sunat ).
