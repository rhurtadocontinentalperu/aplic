...
DEFINE VARIABLE h_b-canc-mayorista-cont-v2 AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN proc_CanPed IN h_b-canc-mayorista-cont-v2.
...
DO:
    RUN dispatch IN h_b-canc-mayorista-cont-v2 ('open-query-cases':U).
    RUN proc_CalTot IN h_b-canc-mayorista-cont-v2.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'sunat/b-canc-mayorista-cont-v2-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Hora':U ,
             OUTPUT h_b-canc-mayorista-cont-v2 ).
       RUN set-position IN h_b-canc-mayorista-cont-v2 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-canc-mayorista-cont-v2 ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-canc-mayorista-cont-v2 ,
