...
x-total-igv = Ccbcdocu.TotalIGV.
x-total-a-pagar = Ccbcdocu.TotalVenta.
lTotalPagar = Ccbcdocu.TotalVenta.
IF lTotalPagar <= 0 AND ccbcdocu.imptot > 0 THEN lTotalPagar = ccbcdocu.imptot.
...
FOR EACH ccbddocu OF ccbcdocu NO-LOCK BREAK BY Ccbddocu.NroItm:
    ...
    IF Ccbddocu.impdto > 0 THEN DO:
        
        x-dscto1 = Ccbddocu.FactorDescuento * 100 .
        ASSIGN            
            w-report.campo-f[4] = Ccbddocu.por_dsctos[3] + Ccbddocu.por_dsctos[1]
    ...
    ASSIGN  
        ...
        /* Total Dsctos */
        w-report.campo-f[10] = ccbcdocu.impdto
        /* ISC */
...
END.
/*
DISPLAY ccbcdocu.coddoc ccbcdocu.nrodoc lTotalPagar lTotItems.
PAUSE 0.
*/
/* Pagina Completas */
lLineasTotales = 16.
...
/*
    ...
    OJOOOOOO : verificar que la IP del servidor sea mismo tanto en el .INI y .PF
    
[RBParametros]
cDatabaseName=INTEGRAL
cHostName=192.168.100.210  ????????????
cNetworkProto=TCP
cPortNumber=65010
cOtherParams=    
...
RUN aderb/_prntrb2 (RB-REPORT-LIBRARY,
    ...
    /* El ultimo parametro es la ruta donde poner el log "C:\sie\tmp\quepaso.txt" */
...
ASSIGN RB-REPORT-NAME = "Docto Venta Electronico NOARIMET".
