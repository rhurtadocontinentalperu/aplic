...
DEF NEW SHARED VAR s-Tipo AS CHAR INIT ''.
...
DEFINE FRAME F-Main
     COMBO-NroSer AT ROW 1.19 COL 78.43 WIDGET-ID 4
     "  x ITEM" VIEW-AS TEXT
          SIZE 11.57 BY .77 AT ROW 1.38 COL 103.43 WIDGET-ID 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Notas de Credito - detallado x Item"
         HEIGHT             = 10.54
         WIDTH              = 115.72
         MAX-HEIGHT         = 27.38
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF W-Win /* Notas de Credito - detallado x Item */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Notas de Credito - detallado x Item */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'CCB/vncndxpncpnd-item.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN set-position IN h_qnotacreditodebito ( 1.19 , 92.14 ) NO-ERROR.
...
/*   END.                                                                    */
  ...
  /*h_p-updv13:btn-save:VISIBLE = NO.  */
  /*RUN dispatch IN h_p-updv13:btn-save('adm-hide':U).*/
  RUN dispatch IN h_p-updv13('hide':U).
