...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    /* **************************************************************************** */
    cRetVal = "".
    RUN sunat/facturacion-electronica-bz.r(INPUT B-CDOCU.CodDoc, 
...
*/
/*MESSAGE b-cdocu.imptot x-imp-total.*/
IF B-CDOCU.imptot <> x-imp-total THEN DO:
    ...
    /* w-ccbcdocu.ImpTot2: Acumula los A/C aplicados */
    IF AVAILABLE w-ccbcdocu /*AND w-ccbcdocu.ImpTot2 = 0*/ THEN DO:
