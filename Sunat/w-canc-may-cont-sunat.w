...
DEFINE VARIABLE h_b-canc-may-cont-sunat AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN proc_CanPed IN h_b-canc-may-cont-sunat.
...
DO:
    RUN dispatch IN h_b-canc-may-cont-sunat ('open-query-cases':U).
    RUN proc_CalTot IN h_b-canc-may-cont-sunat.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/b-canc-may-cont-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Hora':U ,
             OUTPUT h_b-canc-may-cont-sunat ).
       RUN set-position IN h_b-canc-may-cont-sunat ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-canc-may-cont-sunat ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-canc-may-cont-sunat ,
