...
&Scoped-define QUERY-STRING-br_table FOR EACH GN-DIVI WHERE ~{&KEY-PHRASE} ~
 ...
 AND GN-DIVI.Campo-Log[10] = TRUE ~
 AND GN-DIVI.Campo-Char[1] <> "Lista de Precios" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for BROWSE br_table
 ...
 AND GN-DIVI.Campo-Log[1] = FALSE
 AND GN-DIVI.Campo-Log[10] = TRUE
 AND GN-DIVI.Campo-Char[1] <> ""Lista de Precios"""
...
DO:
  ...
  {src/adm/template/brschnge.i}
      RUN Procesa-handle IN lh_handle ('initialize').
...
pCodDiv = ''.
IF AVAILABLE gn-divi THEN pCodDiv = gn-divi.coddiv.
