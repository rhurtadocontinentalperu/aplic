...
CcbCDocu.TpoCmb CcbCDocu.FmaPgo CcbCDocu.Glosa CcbCDocu.DivOri 
&Scoped-define DISPLAYED-TABLES CcbCDocu
&Scoped-define FIRST-DISPLAYED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-Nomtar F-CndVta FILL-IN-DivOri 
...
"US$", 2
     ...
     CcbCDocu.Glosa AT ROW 6.65 COL 16 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
     CcbCDocu.DivOri AT ROW 7.46 COL 16 COLON-ALIGNED WIDGET-ID 94
          LABEL "División Origen"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 8 FGCOLOR 0 
     FILL-IN-DivOri AT ROW 7.46 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 96
     "Moneda:" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  IF Ccbcdocu.FlgSit = "X" THEN DO:
      MESSAGE "El Comprobante tiene un CANJE por LETRA en trámite" VIEW-AS ALERT-BOX ERROR.
      RETURN "ADM-ERROR".
  END.
