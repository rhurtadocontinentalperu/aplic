...
IF AVAILABLE VtaTabla THEN DO:
    ...
    CASE VtaTabla.Llave_c4:
        WHEN "TCK" THEN ASSIGN RB-REPORT-NAME = "ticket venta electronico" pFormatoTCK = YES.
...
CASE TRUE:
    WHEN pImprimeDirecto = YES AND LOOKUP(cImprimeDirecto, 'Si,Yes') > 0 THEN DO:
        ...
        IF lImpresora = ""  THEN DO:
            ...
            x-filer = flog-epos-txt("IMPRIMIR DOCMTO (IMPRESION DIRECTA - NO TERMINAL SERVER - IMPRESORA PREDETERMINADA - CAPTURA IMPRESORA X DEFECTO) : " + ccbcdocu.coddiv + " " + ccbcdocu.coddoc + " " + ccbcdocu.nrodoc).
            ...
            IF success = NO THEN DO:
                ...
                RETURN 'ADM-ERROR'.
            END.
            x-filer = flog-epos-txt("IMPRIMIR DOCMTO (IMPRESION DIRECTA - NO TERMINAL SERVER - IMPRESORA PREDETERMINADA - TRANSFORMA PUERTO) : " + ccbcdocu.coddiv + " " + ccbcdocu.coddoc + " " + ccbcdocu.nrodoc).
...
END.
MESSAGE "s-port-name " s-port-name.
ASSIGN
