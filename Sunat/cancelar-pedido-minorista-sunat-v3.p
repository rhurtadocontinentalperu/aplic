...
x-libre_c02_01 = B-CPEDM.Libre_C02.             /* Proveedor de Vales Utilex */
...
RUN CJC_Canc-Min-Contado IN hProc (INPUT s-CodDoc,            /* BOL o FAC */                                        
...
IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
    ...
    RETURN 'ADM-ERROR'.
END.
IF pMensaje > '' THEN MESSAGE pMensaje VIEW-AS ALERT-BOX INFORMATION.
