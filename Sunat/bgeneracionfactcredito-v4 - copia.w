...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN sunat\dgeneracionfactcredito-v4 ( ROWID(FacCPedi), 'A', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN sunat\dgeneracionfactcredito-v4 ( ROWID(FacCPedi), 'FA', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
