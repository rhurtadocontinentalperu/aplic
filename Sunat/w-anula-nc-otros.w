...
DEFINE NEW SHARED VARIABLE s-CndCre   AS CHAR INIT "N".   /* Por otros conceptos */
...
DEFINE VARIABLE h_v-anula-nc-otros AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     RECT-72 AT ROW 18.77 COL 2 WIDGET-ID 20
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ANULACION DE N/C POR OTROS CONCEPTOS"
         HEIGHT             = 20.46
         WIDTH              = 124.43
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 144.29
...
ON END-ERROR OF W-Win /* ANULACION DE N/C POR OTROS CONCEPTOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ANULACION DE N/C POR OTROS CONCEPTOS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/v-anula-nc-otros.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-anula-nc-otros ).
       RUN set-position IN h_v-anula-nc-otros ( 10.42 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.08 , 117.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-totales ).
       RUN set-position IN h_v-totales ( 19.04 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-ndnc-divi ( 8.54 , 54.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.04 , 11.00 ) */

       /* Links to SmartViewer h_v-anula-nc-otros. */
       RUN add-link IN adm-broker-hdl ( h_p-updv98 , 'TableIO':U , h_v-anula-nc-otros ).
       RUN add-link IN adm-broker-hdl ( h_q-ndnc-divi , 'Record':U , h_v-anula-nc-otros ).

       /* Links to SmartViewer h_v-totales. */
       RUN add-link IN adm-broker-hdl ( h_q-ndnc-divi , 'Record':U , h_v-totales ).
