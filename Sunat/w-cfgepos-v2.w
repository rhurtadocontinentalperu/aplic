...
DEFINE VARIABLE h_b-cfgepos-v2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_p-updv10 ( 1.35 , 46.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/b-cfgepos-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cfgepos-v2 ).
       RUN set-position IN h_b-cfgepos-v2 ( 2.35 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-cfgepos-v2 ( 8.73 , 134.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'LABEL-FONT = 4,
                     ...
                     LABELS = e-Pos por Series|e-Pos Mostrador':U ,
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 11.19 , 1.00 ) NO-ERROR.
       RUN set-size IN h_tab95 ( 8.85 , 128.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cfgeposformatos ( 20.04 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cfgeposnroitems ( 20.23 , 65.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96-3 ).
       RUN set-position IN h_p-updv96-3 ( 20.81 , 52.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96-3 ( 4.62 , 12.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96-4 ).
       RUN set-position IN h_p-updv96-4 ( 21.00 , 117.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96-4 ( 4.62 , 11.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-cfggen ).
       RUN set-position IN h_q-cfggen ( 25.62 , 113.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 14.86 ) */

       /* Links to SmartBrowser h_b-cfgepos-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_b-cfgepos-v2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cfgepos-v2 ,
             h_p-updv10 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_tab95 ,
             h_b-cfgepos-v2 , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-cfgeposcorrel ( 12.35 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-cfgeposcorrel ( 7.31 , 93.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96 ).
       RUN set-position IN h_p-updv96 ( 13.12 , 98.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96 ( 4.62 , 12.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cfgeposcorrel. */
       RUN add-link IN adm-broker-hdl ( h_b-cfgepos-v2 , 'Record':U , h_b-cfgeposcorrel ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_b-cfgeposcorrel ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-cfgeposterm ( 12.54 , 5.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96-2 ).
       RUN set-position IN h_p-updv96-2 ( 13.50 , 82.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96-2 ( 5.00 , 13.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cfgeposterm. */
       RUN add-link IN adm-broker-hdl ( h_b-cfgepos-v2 , 'Record':U , h_b-cfgeposterm ).
       RUN add-link IN adm-broker-hdl ( h_p-updv96-2 , 'TableIO':U , h_b-cfgeposterm ).
