...
CcbCDocu.NomCli CcbCDocu.usuario CcbCDocu.DirCli CcbCDocu.FchAnu ~
CcbCDocu.CodRef CcbCDocu.NroRef CcbCDocu.UsuAnu CcbCDocu.FmaPgo ~
CcbCDocu.CodMon CcbCDocu.CodCta CcbCDocu.Glosa CcbCDocu.ImpBrt ~
...
DEFINE FRAME F-Main
     ...
     CcbCDocu.CodRef AT ROW 4.27 COL 18 COLON-ALIGNED WIDGET-ID 96
          ...
          DROP-DOWN-LIST
          SIZE 15 BY 1
     CcbCDocu.NroRef AT ROW 4.27 COL 41 COLON-ALIGNED WIDGET-ID 84
          LABEL "Número"
          VIEW-AS FILL-IN 
          SIZE 13.43 BY .81
