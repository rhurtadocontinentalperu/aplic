...
Parámetros:
    s-CodDoc:   "ND" Nota de Debito, "NC" Nota de Credito, NCI
...
IF LOOKUP(ENTRY(1,pParametros,'|'), 'ND,NC,PNC,NCI') = 0 THEN RETURN ERROR.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_vncxdevolucion ( 2.54 , 3.00 ) NO-ERROR.
