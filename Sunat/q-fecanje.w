...
&SCOPED-DEFINE Condicion FECanje.codcia = s-codcia ~
AND FECanje.coddiv = s-coddiv ~
AND FECanje.coddoc = s-coddoc ~
AND FECanje.tpodoc = s-tipo ~
AND FECanje.nrodoc BEGINS STRING(s-NroSer, '999')
...
&Scoped-define INTERNAL-TABLES FECanje

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH FECanje WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    BY FECanje.NroDoc DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH FECanje WHERE ~{&KEY-PHRASE} ~
      AND {&Condicion} NO-LOCK ~
    BY FECanje.NroDoc DESCENDING.
&Scoped-define TABLES-IN-QUERY-Query-Main FECanje
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main FECanje
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.FECanje"
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "INTEGRAL.FECanje.NroDoc|no"
     _Where[1]         = "{&Condicion}"
