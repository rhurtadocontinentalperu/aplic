...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 BUTTON-6 RADIO-SET_Cmpbte ~
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 2.35 COL 31 WIDGET-ID 114
     BUTTON-6 AT ROW 2.35 COL 36 WIDGET-ID 124
     RADIO-SET_Cmpbte AT ROW 1.27 COL 15 NO-LABEL WIDGET-ID 108
     FILL-IN_CodCli AT ROW 2.35 COL 13 COLON-ALIGNED WIDGET-ID 102
     FILL-IN_RucCli AT ROW 3.42 COL 13 COLON-ALIGNED WIDGET-ID 106
     FILL-IN_Atencion AT ROW 4.5 COL 13 COLON-ALIGNED WIDGET-ID 104
     EDITOR_NomCli AT ROW 5.58 COL 15 NO-LABEL WIDGET-ID 100
     EDITOR_DirCli AT ROW 8.54 COL 15 NO-LABEL WIDGET-ID 92
     FILL-IN-ImpTot AT ROW 11.77 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     EDITOR_Error AT ROW 13.65 COL 5 NO-LABEL WIDGET-ID 122
     "TOTAL S/" VIEW-AS TEXT
          SIZE 17 BY 1.35 AT ROW 11.77 COL 24 WIDGET-ID 120
          FONT 8
     "Nombre:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 5.85 COL 7 WIDGET-ID 90
     "Direcc:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 8.81 COL 7 WIDGET-ID 94
...
/* SETTINGS FOR EDITOR EDITOR_DirCli IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR EDITOR EDITOR_Error IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET_Cmpbte FILL-IN_CodCli FILL-IN_RucCli FILL-IN_Atencion 
          EDITOR_NomCli EDITOR_DirCli FILL-IN-ImpTot EDITOR_Error 
      WITH FRAME F-Main.
  ENABLE BUTTON-1 BUTTON-6 RADIO-SET_Cmpbte FILL-IN_CodCli FILL-IN_RucCli 
         FILL-IN_Atencion 
      WITH FRAME F-Main.
