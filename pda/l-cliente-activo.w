...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gn-clie.CodCli FORMAT "x(11)":U WIDTH 18.43
      gn-clie.NomCli FORMAT "x(250)":U WIDTH 40.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 63.14 BY 16.69
...
DEFINE FRAME F-Main
     FILL-IN-codigo AT ROW 1 COL 33 COLON-ALIGNED
     CMB-filtro AT ROW 2.12 COL 2 NO-LABEL
     FILL-IN-filtro AT ROW 2.08 COL 35 NO-LABEL
     br_table AT ROW 3.42 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         BGCOLOR 8 FGCOLOR 0 FONT 9 WIDGET-ID 100.
...
"CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "18.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-clie.NomCli
"NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "40.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
