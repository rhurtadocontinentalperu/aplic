...
DEFINE BUTTON BUTTON-4 
     IMAGE-UP FILE "aplic/pda/add_to_shopping_cart.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Button 4" 
     SIZE 15 BY 3.5 TOOLTIP "Agregar nuevo artículo".
...
DO:
  RUN Procesa-Botones IN lh_handle ('Cart-Add').
END.
