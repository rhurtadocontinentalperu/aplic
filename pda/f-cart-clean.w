...
DEFINE BUTTON BUTTON-4 
     IMAGE-UP FILE "aplic/pda/shopping_cart.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Button 4" 
     SIZE 14 BY 3.5 TOOLTIP "Vaciar carrito de compra".
...
DO:
  RUN Procesa-Botones IN lh_handle ('Cart-Clean').
END.
