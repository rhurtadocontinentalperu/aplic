...
DEFINE FRAME C-Dialog
     Btn_Cancel AT ROW 20.38 COL 3
     Btn_OK AT ROW 20.38 COL 50
     SPACE(1.99) SKIP(0.30)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pda/l-cliente-activo.w':U ,
       ...
       RUN set-size IN h_l-cliente-activo ( 19.12 , 64.14 ) NO-ERROR.
