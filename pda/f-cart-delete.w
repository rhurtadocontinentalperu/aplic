...
DEFINE BUTTON BUTTON-4 
     IMAGE-UP FILE "aplic/pda/remove_from_shopping_cart.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Button 4" 
     SIZE 14 BY 3.5 TOOLTIP "Eliminar artículo".
...
DO:
  RUN Procesa-Botones IN lh_handle ('Cart-Delete').
END.
