...
DEFINE VARIABLE x-cfgaux AS CHARACTER INITIAL "01".
DEFINE VARIABLE x-margen AS CHARACTER FORMAT "X(10)" LABEL "".
...
DEFINE FRAME f-cab
        ...
        x-nomaux AT 15
        SKIP(2)
        WITH WIDTH 85 NO-BOX DOWN STREAM-IO.
...
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH cb-tabl ~
      WHERE cb-tabl.Tabla = x-cfgaux AND (NOT cb-tabl.codigo BEGINS "@") NO-LOCK.
...
&Scoped-Define ENABLED-OBJECTS RECT-4 BROWSE-1 RECT-5 RADIO-SET-1 RECT-6 ~
B-impresoras B-imprime RB-NUMBER-COPIES B-cancela RB-BEGIN-PAGE RB-END-PAGE 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 DIALOG-1 _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      cb-tabl.Codigo COLUMN-LABEL "C¾digo"
      cb-tabl.Nombre
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-COLUMN-SCROLLING SEPARATORS SIZE 50 BY 5.46
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME DIALOG-1
     BROWSE-1 AT ROW 1.15 COL 2.72 HELP
          "Seleccione Auxiliar"
     RADIO-SET-1 AT ROW 8 COL 2 NO-LABEL
     B-impresoras AT ROW 9 COL 12.43
     b-archivo AT ROW 10 COL 12.43
     B-imprime AT ROW 11.77 COL 13.57
     RB-OUTPUT-FILE AT ROW 10.12 COL 18.72 NO-LABEL
     RB-NUMBER-COPIES AT ROW 8.15 COL 23.72 COLON-ALIGNED
     B-cancela AT ROW 11.81 COL 31.43
     RB-BEGIN-PAGE AT ROW 8.15 COL 44.57 COLON-ALIGNED
     RB-END-PAGE AT ROW 9.15 COL 44.57 COLON-ALIGNED
     RECT-4 AT ROW 1 COL 1
     " Configuración de Impresión" VIEW-AS TEXT
          SIZE 53.57 BY .62 AT ROW 6.81 COL 1
          BGCOLOR 1 FGCOLOR 15 
     RECT-5 AT ROW 7.42 COL 1.14
     RECT-6 AT ROW 11.5 COL 1
     SPACE(0.13) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         BGCOLOR 8 FGCOLOR 0 FONT 4
         TITLE "Seleccione Auxiliar".
...
/* SETTINGS FOR DIALOG-BOX DIALOG-1
                                                                        */
/* BROWSE-TAB BROWSE-1 RECT-4 DIALOG-1 */
ASSIGN 
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Options          = "NO-LOCK"
     _Where[1]         = "cb-tabl.Tabla = x-cfgaux AND (NOT cb-tabl.codigo BEGINS ""@"")"
     _FldNameList[1]   > integral.cb-tabl.Codigo
"cb-tabl.Codigo" "C¾digo" ? "character" ? ? ? ? ? ? no "C¾digo de auxiliar"
...
ON GO OF FRAME DIALOG-1 /* Seleccione Auxiliar */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-1 RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
  ENABLE RECT-4 BROWSE-1 RECT-5 RADIO-SET-1 RECT-6 B-impresoras B-imprime 
...
-------------------------------------------------------------*/
    ...
    P-Config = P-10cpi.
    x-Raya   = FILL("-", P-Ancho).
    FOR EACH cb-auxi WHERE codcia = cb-codcia  AND
                            clfaux = x-clfaux
                      NO-LOCK:
        {&NEW-PAGE}.
