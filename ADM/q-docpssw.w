...
&Scoped-define INTERNAL-TABLES gn-docpssw

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-docpssw WHERE ~{&KEY-PHRASE} ~
      AND gn-docpssw.Codcia = s-CodCia NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-docpssw
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-docpssw
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.gn-docpssw"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "gn-docpssw.Codcia = s-CodCia"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "gn-docpssw"}
