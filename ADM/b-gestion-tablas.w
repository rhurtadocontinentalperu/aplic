...
tt-w-report.Campo-C[4] tt-w-report.Campo-C[2] tt-w-report.Campo-C[3] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tt-w-report.Campo-C[1] COLUMN-LABEL "Tabla" FORMAT "X(15)":U
            WIDTH 20.43
      tt-w-report.Campo-C[4] COLUMN-LABEL "ID" FORMAT "X(15)":U
            WIDTH 12.43
      tt-w-report.Campo-C[2] COLUMN-LABEL "Descripcion" FORMAT "X(60)":U
            WIDTH 42.43
      tt-w-report.Campo-C[3] COLUMN-LABEL "Referencia" FORMAT "X(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114 BY 10
         FONT 4.
...
"Campo-C[1]" "Tabla" "X(15)" "character" ? ? ? ? ? ? no ? no no "20.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-w-report.Campo-C[4]
"Campo-C[4]" "ID" "X(15)" "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-w-report.Campo-C[2]
"Campo-C[2]" "Descripcion" "X(60)" "character" ? ? ? ? ? ? no ? no no "42.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-w-report.Campo-C[3]
"Campo-C[3]" "Referencia" "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE cargar-temporal B-table-Win 
...
FOR EACH _file WHERE _file._hidden = NO NO-LOCK:
    CREATE tt-w-report.
        ASSIGN tt-w-report.campo-c[1] = _file._file-name
                tt-w-report.campo-c[2] = _file._desc
                tt-w-report.campo-c[3] = _file._file-label
                tt-w-report.campo-c[4] = STRING(RECID(_file))
    .

    IF NOT (TRUE <> (_file._file-label > "")) THEN DO:        
        IF TRUE <> (_file._desc > "") THEN DO:
            ASSIGN tt-w-report.campo-c[2] = _file._file-label.
        END.
    END.
    ELSE ASSIGN tt-w-report.campo-c[3] = "".
