...
GN-DIVI.FlgEmpaque GN-DIVI.Libre_d02 GN-DIVI.FlgMinVenta ~
GN-DIVI.Campo-Log[4] GN-DIVI.Libre_L02 GN-DIVI.Campo-Log[8] ~
GN-DIVI.DiasAmpCot GN-DIVI.flgrep GN-DIVI.Campo-Log[9] ~
...
GN-DIVI.FlgBarras GN-DIVI.DiasVtoO_D GN-DIVI.FlgEmpaque GN-DIVI.Libre_d02 ~
GN-DIVI.FlgMinVenta GN-DIVI.Campo-Log[4] GN-DIVI.Libre_L02 ~
GN-DIVI.Campo-Log[8] GN-DIVI.DiasAmpCot GN-DIVI.flgrep GN-DIVI.Campo-Log[9] ~
GN-DIVI.VentaMayorista GN-DIVI.Libre_c01 GN-DIVI.FlgDtoVol ~
GN-DIVI.Campo-Log[6] GN-DIVI.Libre_L01 GN-DIVI.Campo-Dec[6] ~
GN-DIVI.FlgDtoProm GN-DIVI.Campo-Dec[7] GN-DIVI.Libre_c02 ~
GN-DIVI.FlgDtoClfCli GN-DIVI.PorDtoClfCli GN-DIVI.Libre_d01 ~
...
"Minorista", no
     ...
     GN-DIVI.Libre_d02 AT ROW 10.08 COL 108 COLON-ALIGNED NO-LABEL WIDGET-ID 138 FORMAT ">>9.99"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     GN-DIVI.FlgMinVenta AT ROW 10.27 COL 81 WIDGET-ID 44
     ...
     GN-DIVI.Libre_L02 AT ROW 11.04 COL 81 WIDGET-ID 136
          LABEL "Margen Mínimo x Cotización"
          VIEW-AS TOGGLE-BOX
          SIZE 27 BY .81
...
DEFINE FRAME F-Main
     GN-DIVI.DiasAmpCot AT ROW 11.42 COL 65 COLON-ALIGNED WIDGET-ID 36
          ...
          SIZE 4.86 BY .81
          BGCOLOR 14 FGCOLOR 0 
     GN-DIVI.flgrep AT ROW 11.81 COL 81 WIDGET-ID 142
          LABEL "Acepta Fact. Interna (FAI)"
          VIEW-AS TOGGLE-BOX
          SIZE 26 BY .81
     GN-DIVI.Campo-Log[9] AT ROW 11.81 COL 113 WIDGET-ID 184
...
/* SETTINGS FOR FILL-IN GN-DIVI.Libre_d01 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT EXP-HELP                                        */
/* SETTINGS FOR FILL-IN GN-DIVI.Libre_d02 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN GN-DIVI.Libre_f01 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR TOGGLE-BOX GN-DIVI.Libre_L01 IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX GN-DIVI.Libre_L02 IN FRAME F-Main
   EXP-LABEL                                                            */
...
ON LEAVE OF GN-DIVI.Grupo_Divi_GG IN FRAME F-Main /* Grupo División GG */
DO:
...
&Scoped-define SELF-NAME GN-DIVI.Libre_L02
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL GN-DIVI.Libre_L02 V-table-Win
ON VALUE-CHANGED OF GN-DIVI.Libre_L02 IN FRAME F-Main /* Margen Mínimo x Cotización */
DO:
   GN-DIVI.Libre_d02:SENSITIVE IN FRAME {&FRAME-NAME} = INPUT {&self-name}.
   IF INPUT {&self-name} = YES THEN APPLY 'ENTRY':U TO GN-DIVI.Libre_d02. 
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF RETURN-VALUE = 'NO' THEN DO:
          ...
          GN-DIVI.Campo-Char[1]:SENSITIVE = NO.
      END.
...
DO WITH FRAME {&FRAME-NAME} :
    ...
    IF TRUE <> (GN-DIVI.Grupo_Divi_GG:SCREEN-VALUE > '') THEN DO:
        MESSAGE 'Seguro de grabar SIN GRUPO DIVISION GG?' VIEW-AS ALERT-BOX QUESTION
    ...
    /* RHC 26/12/2019 Bloqueo lógico */
    RUN GET-ATTRIBUTE('ADM-NEW-RECORD').
    IF RETURN-VALUE = 'YES' THEN DO:
        IF GN-DIVI.Campo-Char[1]:SCREEN-VALUE = "A" THEN DO:
            MESSAGE 'Solo se permite crear LISTAS DE PRECIOS' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO GN-DIVI.Campo-Char[1].
            RETURN 'ADM-ERROR'.
        END.
    END.
