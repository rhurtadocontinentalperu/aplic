...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      PROV.Libre_c01 COLUMN-LABEL "Agente de Retención" FORMAT "x(2)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "IMPORTAR PROVEEDORES AGENTES DE RETENCION"
         HEIGHT             = 17
         WIDTH              = 91.86
         MAX-HEIGHT         = 17.08
         MAX-WIDTH          = 123.43
...
"PROV.NomPro" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "48.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.PROV.Libre_c01
"PROV.Libre_c01" "Agente de Retención" "x(2)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON END-ERROR OF W-Win /* IMPORTAR PROVEEDORES AGENTES DE RETENCION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* IMPORTAR PROVEEDORES AGENTES DE RETENCION */
DO:
...
FOR EACH gn-prov WHERE gn-prov.codcia = pv-codcia:
    ...
    IF AVAILABLE PROV THEN gn-prov.Libre_c01 = 'Si'.
...
DEF VAR x-Pedido AS CHAR INIT 'agenret_txt.txt'.
DEF VAR x-Ok AS LOG.
