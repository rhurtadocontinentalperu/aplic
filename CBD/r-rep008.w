...
DEFINE FRAME fMain
     FILL-IN-FchDoc-1 AT ROW 2.73 COL 21 COLON-ALIGNED WIDGET-ID 2
     FILL-IN-FchDoc-2 AT ROW 4.08 COL 21 COLON-ALIGNED WIDGET-ID 4
...
FOR EACH Ccbcdocu NO-LOCK Ccbcdocu.codcia = s-codcia
    AND Ccbcdocu.coddoc = "FAC"
    AND Ccbcdocu.flgest = "C"
    AND Ccbcdocu.fchdoc >= FILL-IN-FchDoc-1
    AND Ccbcdocu.fchdoc <= FILL-IN-FchDoc-2,
    FIRST Ccbdcaja NO-LOCK WHERE Ccbdcaja.codcia = s-codcia AND
    Ccbdcaja.coddoc = "CJE" AND
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 
      WITH FRAME fMain IN WINDOW wWin.
