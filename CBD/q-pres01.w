...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cb-tbal WHERE ~{&KEY-PHRASE} ~
      AND cb-tbal.CodCia = 0 AND cb-tbal.TpoBal = "4" NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main cb-tbal
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cb-tbal
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "integral.cb-tbal.CodCia = 0 AND integral.cb-tbal.TpoBal = ""4"""
     _Design-Parent    is WINDOW q-tables @ ( 1.23 , 9 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
