...
DEFINE VARIABLE x-debe     AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-" 
                           COLUMN-LABEL "S u m!Debe      ". 
DEFINE VARIABLE x-haber    AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-" 
                           COLUMN-LABEL "a s            !Haber     ".
DEFINE VARIABLE x-activo   AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-"
                           COLUMN-LABEL "I n v e n!Activo     ".
DEFINE VARIABLE x-pasivo   AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-"
                           COLUMN-LABEL "t a r i o     !Pasivo     ".
DEFINE VARIABLE x-deudor   AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-"
                           COLUMN-LABEL "S a l!Deudor    ".
DEFINE VARIABLE x-acreedor AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-" 
                           COLUMN-LABEL "d o s         !Acreedor   ".
DEFINE VARIABLE x-perXnat  AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-"
                           COLUMN-LABEL "Resultado por!Pérdidas    ".
DEFINE VARIABLE x-ganXnat  AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-" 
                           COLUMN-LABEL "Naturaleza   !Ganancias   ".
DEFINE VARIABLE x-perXfun  AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-"
                           COLUMN-LABEL "Resultado!Pérdidas    ".
DEFINE VARIABLE x-ganXfun  AS DECIMAL FORMAT "ZZZZZZZZZ,ZZ9.99-" 
...
C-1 x-Div x-balance x-cta-ini O-mayor x-cta-fin x-codmon RADIO-SET-1 ~
RB-NUMBER-COPIES B-impresoras RB-BEGIN-PAGE RB-END-PAGE B-imprime B-cancela ~
BUTTON-EXCEL 
&Scoped-Define DISPLAYED-OBJECTS C-1 x-Div x-balance x-cta-ini O-mayor ~
x-cta-fin x-codmon RADIO-SET-1 RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
...
------------------------------------------------------------------------------*/
  DISPLAY C-1 x-Div x-balance x-cta-ini O-mayor x-cta-fin x-codmon RADIO-SET-1 
          RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
  ENABLE RECT-10 RECT-9 RECT-13 RECT-6 RECT-5 RECT-4 C-1 x-Div x-balance 
...
-------------------------------------------------------------*/
    ...
    DEFINE FRAME f-cab
        ...
        HEADER
        empresas.nomcia
        "B A L A N C E   D E   C O M P R O B A C I O N" TO 116 N-ORIGEN
