...
DEFINE VAR mesi     AS CHAR NO-UNDO.
DEFINE VAR mesf     AS CHAR NO-UNDO.
...
DEFINE TEMP-TABLE Detalle
   FIELD Total1 AS DECI EXTENT 10
   FIELD Total2 AS DECI EXTENT 10
   FIELD Total3 AS DECI EXTENT 10.  
...
&Scoped-Define ENABLED-OBJECTS RECT-21 RECT-12 RECT-20 x-Div x-mesini ~
x-mesfin x-tipDoc s-CodOpe Btn_OK Btn_Cancel b-Excel 
&Scoped-Define DISPLAYED-OBJECTS x-Div C-CodMon x-mesini x-mesfin x-tipDoc ~
s-CodOpe 
...
DEFINE FRAME D-Dialog
     ...
     C-CodMon AT ROW 2.08 COL 53.72 NO-LABEL
     ...
     s-CodOpe AT ROW 4.85 COL 6.57
     Btn_OK AT ROW 6.96 COL 26
     Btn_Cancel AT ROW 6.96 COL 39
     b-Excel AT ROW 6.96 COL 52
     "Moneda" VIEW-AS TEXT
          SIZE 7.14 BY .65 AT ROW 1.27 COL 54.14
     RECT-21 AT ROW 6.77 COL 2
     RECT-12 AT ROW 1.38 COL 2
     RECT-20 AT ROW 1.5 COL 53
     SPACE(0.85) SKIP(5.11)
...
------------------------------------------------------------------------------*/
 DO WITH FRAME {&FRAME-NAME}:
    ASSIGN C-CodMon x-TipDoc s-CodOpe x-Div x-mesfin x-mesini.
...
------------------------------------------------------------------------------*/
  ...
  DO i = 1 TO NUM-ENTRIES(s-CodOpe) :
      ...
      FOR EACH t-cmov NO-LOCK WHERE t-cmov.CodCia  = s-CodCia  AND
                                    t-cmov.CodDiv  BEGINS x-Div AND
                                    t-cmov.Periodo = s-periodo AND
                                    t-cmov.NroMes  >= INTEGER(mesi) AND
                                    t-cmov.NroMes  <= INTEGER(mesf) AND
...
------------------------------------------------------------------------------*/
  ...
  DO i = 1 TO NUM-ENTRIES(s-CodOpe) :
    ...
    FOR EACH cb-dmov NO-LOCK WHERE cb-dmov.codcia = s-codcia
            ...
            AND cb-dmov.nromes >= INTEGER(mesi)
            AND cb-dmov.nromes <= INTEGER(mesf), 
...
------------------------------------------------------------------------------*/
  DISPLAY x-Div C-CodMon x-mesini x-mesfin x-tipDoc s-CodOpe 
      WITH FRAME D-Dialog.
  ENABLE RECT-21 RECT-12 RECT-20 x-Div x-mesini x-mesfin x-tipDoc s-CodOpe 
         Btn_OK Btn_Cancel b-Excel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
chWorkSheet:Range("A3: R3"):Font:Bold = TRUE.

chWorkSheet:Range("A3"):Value = "División".
chWorkSheet:Range("B3"):Value = "Nro.Ast.".
chWorkSheet:Range("C2"):Value = "Fecha de".
chWorkSheet:Range("C3"):Value = "Emisión".
chWorkSheet:Range("D2"):Value = "Cod.".
chWorkSheet:Range("D3"):Value = "Doc.".
chWorkSheet:Range("E2"):Value = "Nro.".
chWorkSheet:Range("E3"):Value = "Documento".
chWorkSheet:Range("F2"):Value = "Nro.".
chWorkSheet:Range("F3"):Value = "Referencia".
chWorkSheet:Range("G2"):Value = "Notas de".
chWorkSheet:Range("G3"):Value = "Débito".
chWorkSheet:Range("H2"):Value = "Notas de".
chWorkSheet:Range("H3"):Value = "Crédito".
chWorkSheet:Range("I2"):Value = "Nro.".
chWorkSheet:Range("I3"):Value = "R.U.C.".
chWorkSheet:Range("J3"):Value = "C l i e n t e".
chWorkSheet:Range("K3"):Value = "Mon".
chWorkSheet:Range("L2"):Value = "Valor".
chWorkSheet:Range("L3"):Value = "Venta".
chWorkSheet:Range("M2"):Value = "Importe".
chWorkSheet:Range("M3"):Value = "Exonerado".
chWorkSheet:Range("N3"):Value = "I.S.C".
chWorkSheet:Range("O2"):Value = "Base".
chWorkSheet:Range("O3"):Value = "Imponible".
chWorkSheet:Range("P2"):Value = "I.G.V.".
chWorkSheet:Range("P3"):Value = "I.P.M.".
chWorkSheet:Range("Q2"):Value = "Importe".
chWorkSheet:Range("Q3"):Value = "Total".
chWorkSheet:Range("R2"):Value = "Importe".
chWorkSheet:Range("R3"):Value = "Total".
...
loopREP:
FOR EACH Registro BREAK BY Registro.CodCia 
  BY Registro.CodDiv 
  BY Registro.CodDoc 
  BY Registro.NroDoc: 
    t-column = t-column + 1.
    ...
    cRange = "A" + cColumn.
    chWorkSheet:Range(cRange):Value = Registro.CodDiv.
    cRange = "B" + cColumn.
    ...
    cRange = "G" + cColumn.
    chWorkSheet:Range(cRange):Value = Registro.NotDeb.
    cRange = "H" + cColumn.
    chWorkSheet:Range(cRange):Value = Registro.NotCre.
    cRange = "I" + cColumn.
    ...
    IF LAST-OF(Registro.CodDoc) THEN DO:
        ...
        cColumn = STRING(t-column).
        cRange = "J" + cColumn.
        chWorkSheet:Range(cRange):Value = "Total Doc:" + Registro.CodDoc.
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[1].
        cRange = "M" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[2].
        cRange = "N" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[3].
        cRange = "O" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[4].
        cRange = "P" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[5].
        cRange = "Q" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDoc Registro.ImpLin[6].
    END.
    ...
    IF LAST-OF(Registro.CodDiv) THEN DO:
        ...
        cColumn = STRING(t-column).
        cRange = "J" + cColumn.
        chWorkSheet:Range(cRange):Value = "Total Div:" + Registro.CodDiv.
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[1].
        cRange = "M" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[2].
        cRange = "N" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[3].
        cRange = "O" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[4].
        cRange = "P" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[5].
        cRange = "Q" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodDiv Registro.ImpLin[6].
    END.
    ...
    IF LAST-OF(Registro.CodCia) THEN DO:
        ...
        cColumn = STRING(t-column).
        cRange = "J" + cColumn.
        chWorkSheet:Range(cRange):Value = "Total Cia: " + Registro.CodCia.
        cRange = "L" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[1].
        cRange = "M" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[2].
        cRange = "N" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[3].
        cRange = "O" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[4].
        cRange = "P" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[5].
        cRange = "Q" + cColumn.
        chWorkSheet:Range(cRange):Value = ACCUM SUB-TOTAL BY Registro.CodCia Registro.ImpLin[6].
    END.    
 ...
 *         cRange = "J" + cColumn.
 *         chWorkSheet:Range(cRange):Value = "Total " + Registro.CodMov.
 *         cRange = "K" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total1.
 *         cRange = "L" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total2.
 *         cRange = "M" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total3.
 *         cRange = "N" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total4.
 *         cRange = "O" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total5.
 *         cRange = "P" + cColumn.
 *         chWorkSheet:Range(cRange):Value = Detalle.Total6.
 *     END.*/
