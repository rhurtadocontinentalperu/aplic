...
T-DDET.Sunat_NroOperacion T-DDET.Sunat_NroConstancia T-DDET.CodDoc ~
T-DDET.NroSer T-DDET.NroDoc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table T-DDET.Sunat_NroOperacion ~
T-DDET.Sunat_NroConstancia T-DDET.CodDoc T-DDET.NroSer T-DDET.NroDoc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DDET.Sunat_NroOperacion FORMAT "x(10)":U WIDTH 10.86
      T-DDET.Sunat_NroConstancia FORMAT "x(10)":U WIDTH 11.43
      T-DDET.CodDoc FORMAT "X(4)":U WIDTH 6.43
      T-DDET.NroSer FORMAT "x(5)":U WIDTH 6.43
      T-DDET.NroDoc FORMAT "X(15)":U WIDTH 10.72
  ENABLE
      T-DDET.Sunat_NroOperacion
      T-DDET.Sunat_NroConstancia
      T-DDET.CodDoc
      T-DDET.NroSer
      T-DDET.NroDoc
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME F-Main
     ...
     "|-------------------- SUNAT ----------------|" VIEW-AS TEXT
          SIZE 23 BY .5 AT ROW 1 COL 86 WIDGET-ID 4
...
"Temp-Tables.T-DDET.CodPro" "Proveedor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.gn-prov.NomPro
     _FldNameList[3]   > Temp-Tables.T-DDET.CtaPro
"Temp-Tables.T-DDET.CtaPro" "<<<Cuenta>>>" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[7]   > Temp-Tables.T-DDET.Sunat_NroOperacion
"Temp-Tables.T-DDET.Sunat_NroOperacion" ? ? "character" ? ? ? ? ? ? yes ? no no "10.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-DDET.Sunat_NroConstancia
"Temp-Tables.T-DDET.Sunat_NroConstancia" ? ? "character" ? ? ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-DDET.CodDoc
"Temp-Tables.T-DDET.CodDoc" ? ? "character" ? ? ? ? ? ? yes ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-DDET.NroSer
"Temp-Tables.T-DDET.NroSer" ? "x(5)" "character" ? ? ? ? ? ? yes ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-DDET.NroDoc
"Temp-Tables.T-DDET.NroDoc" ? "X(15)" "character" ? ? ? ? ? ? yes ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
