...
ELSE DO:
    MESSAGE
        'Configuracion de Cuentas de Redondeo no existe'
        VIEW-AS ALERT-BOX ERROR.
    RETURN.
END.
...
ELSE DO:
    MESSAGE
        'Configuracion de Registro de Ventas no existe'
        VIEW-AS ALERT-BOX ERROR.
    RETURN.
END.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Registro de Ventas SUNAT */
DO:  
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH Registro NO-LOCK BREAK BY
        Registro.CodCia BY
        Registro.CodDiv BY
        Registro.CodDoc BY
        Registro.NroDoc:
        ...
        ASSIGN
            ...
            w-report.Campo-C[12] = Registro.NomCli
