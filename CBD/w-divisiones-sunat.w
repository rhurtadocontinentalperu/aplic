...
DEF TEMP-TABLE tgn-divi NO-UNDO
    FIELD coddiv AS CHAR FORMAT 'x(8)' LABEL 'Division'
    FIELD desdiv AS CHAR FORMAT 'x(80)' LABEL 'Descripcion'
    FIELD libre_c02 AS CHAR FORMAT 'x(20)' LABEL 'SUNAT'
    .
...
&Scoped-Define ENABLED-OBJECTS BUTTON-Texto 
...
DEFINE VARIABLE h_b-divisiones-sunat AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-Texto AT ROW 1.27 COL 37 WIDGET-ID 8
...
ON END-ERROR OF W-Win /* DIVISIONES VS SUNAT */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* DIVISIONES VS SUNAT */
DO:
...
DO:
    ...
    EMPTY TEMP-TABLE tgn-divi.
    FOR EACH gn-divi NO-LOCK:
        CREATE tgn-divi.
        BUFFER-COPY gn-divi TO tgn-divi.
    END.
...
/*     END.                                                               */
    ...
    lOptions = lOptions + "coddiv,desdiv,libre_c02".
    ...
    SESSION:SET-WAIT-STATE('GENERAL').
    RUN lib/tt-filev2 (TEMP-TABLE tgn-divi:HANDLE, cArchivo, pOptions).
    SESSION:SET-WAIT-STATE('').
    /* ******************************************************* */
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/cbd/b-divisiones-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-divisiones-sunat ).
       RUN set-position IN h_b-divisiones-sunat ( 3.15 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-divisiones-sunat ( 22.88 , 87.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-divisiones-sunat. */
       RUN add-link IN adm-broker-hdl ( h_p-updv97 , 'TableIO':U , h_b-divisiones-sunat ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv97 ,
             BUTTON-Texto:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-divisiones-sunat ,
