...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DDET.NroSer FORMAT "x(4)":U
      T-DDET.NroDoc FORMAT "X(8)":U
  ENABLE
...
"Temp-Tables.T-DDET.NroSer" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-DDET.NroDoc
"Temp-Tables.T-DDET.NroDoc" ? "X(8)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
