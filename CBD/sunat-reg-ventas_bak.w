    ...
    FOR EACH Registro 
        ...
        IF LENGTH(Registro.RUC) = 11 THEN DO:
            IF SUBSTRING(Registro.RUC,1,2) = "10" OR 
                SUBSTRING(Registro.RUC,1,2) = "20" THEN cTpoDoc = "6".
            ELSE cTpoDoc = "1".
        END.
        ELSE cTpoDoc = "1".
        /* Referencia */
        ...
        IF LOOKUP(x-coddoc, "BOL,TCK") > 0 THEN DO:
            ...
            FOR EACH Ccbcdocu NO-LOCK WHERE Ccbcdocu.codcia = s-codcia
                ...
                BY Ccbcdocu.nrodoc:
                IF x-NroDoc = "" THEN x-NroDoc = SUBSTRING(Ccbcdocu.nrodoc,4).
        ...
        ASSIGN
            ...
            t-w-report.Campo-C[4] = cTpoDoc
            t-w-report.Campo-C[5] = Registro.NroAst
            t-w-report.Campo-C[6] = x-NroSer
            t-w-report.Campo-C[7] = x-NroDoc
            t-w-report.Campo-C[16] = x-NroFin
            t-w-report.Campo-C[8] = Registro.CodRef
            t-w-report.Campo-C[9] = SUBSTRING(Registro.NroRef,1,3)
            t-w-report.Campo-C[10] = SUBSTRING(Registro.NroRef,4)
            ...
            t-w-report.Campo-C[13] = (IF t-w-report.Campo-F[10] > 0 THEN STRING(t-w-report.Campo-F[10], ">>9.999<") ELSE "")
            t-w-report.Campo-C[14] = IF fFchRef <> ? THEN STRING(fFchRef,"99/99/99") ELSE ""
...
------------------------------------------------------------------------------*/
    ...
    PUT STREAM REPORT UNFORMATTED
        "VMES|VNUMREGOPE|VFECCOM|VFECVENPAG|VTIPDOCCOM|VNUMSER|VNUMDOCCOI|VNUMDOCCOF|"
        ...
        "VFECMOD|VTIPDOCMOD|VNUMSERMOD|VNUMDOCMOD"
        SKIP.
    FOR EACH t-w-report NO-LOCK WHERE t-w-report.task-no = s-task-no 
        ...
        PUT STREAM REPORT
            ...
            t-w-report.Campo-C[7] FORMAT "x(6)" '|'
            t-w-report.Campo-C[16] FORMAT "x(6)" '|'
            ...
            t-w-report.Campo-C[9] FORMAT "x(3)" '|'
            t-w-report.Campo-C[10] FORMAT "x(6)"
            SKIP.
    END.
