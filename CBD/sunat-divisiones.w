...
GN-DIVI.Libre_c02 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 GN-DIVI.Libre_c02 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-2 GN-DIVI
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-2 GN-DIVI
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 wWin _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      GN-DIVI.Libre_c02 COLUMN-LABEL "SUNAT" FORMAT "x(10)":U
  ENABLE
      GN-DIVI.Libre_c02
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 65 BY 16.54 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME fMain
     BROWSE-2 AT ROW 1.19 COL 3 WIDGET-ID 200
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 68.29 BY 17 WIDGET-ID 100.
...
"GN-DIVI.DesDiv" "Descripción" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.GN-DIVI.Libre_c02
"GN-DIVI.Libre_c02" "SUNAT" "x(10)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON END-ERROR OF wWin /* DIVISIONES - SUNAT */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* DIVISIONES - SUNAT */
DO:
