...
&Scoped-Define ENABLED-OBJECTS tg-acum x-CodDiv CB-MES Btn_Excel Btn_Done 
&Scoped-Define DISPLAYED-OBJECTS tg-acum x-mensaje x-CodDiv CB-MES 
...
DEFINE FRAME F-Main
     tg-acum AT ROW 2.88 COL 35 WIDGET-ID 10
     x-mensaje AT ROW 4.77 COL 4 NO-LABEL WIDGET-ID 12
     x-CodDiv AT ROW 1.81 COL 9 COLON-ALIGNED WIDGET-ID 8
     CB-MES AT ROW 2.88 COL 9 COLON-ALIGNED WIDGET-ID 2
     Btn_Excel AT ROW 5.85 COL 40
     Btn_Done AT ROW 5.85 COL 51
...
DO:
    ...
    ASSIGN CB-MES x-coddiv tg-acum.
    RUN bin/_dateif (01, s-Periodo, OUTPUT dFechaF, OUTPUT dHastaF).
...
------------------------------------------------------------------------------*/
  DISPLAY tg-acum x-mensaje x-CodDiv CB-MES 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE tg-acum x-CodDiv CB-MES Btn_Excel Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
