...
DEFINE VARIABLE P-archivo  AS CHARACTER FORMAT "x(50)" NO-UNDO.
...
FIELD imptemn   AS DEC      FORMAT "->>>,>>>,>>9.99"    LABEL 'moneda nacional'
...
INDEX IDX03 codaux codcta Voucher fecha-id coddoc nrodoc codope nroast fchdoc.
    ...
    DEF TEMP-TABLE t-Detalle
        ...
        FIELD saldomn   AS DEC      FORMAT "->>>,>>>,>>9.99"    LABEL 'SALDO ACTUAL MN'.
        .
...
DEFINE FRAME T-cab-4
  ...
  /* SAP */
  DEFINE TEMP-TABLE tsi_let_cxc_soles_hdr
    FIELD   jdt_num     AS  INT     FORMAT  '->>,>>>,>>9'
    FIELD   memo        AS  CHAR    FORMAT  'x(225)'
    FIELD   refdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   taxdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   duedate     AS  CHAR    FORMAT  'x(12)'
    FIELD   coddoc  AS  CHAR    FORMAT  'x(5)'
    FIELD   nrodoc  AS  CHAR    FORMAT  'x(15)'
    FIELD   flgubi  AS  CHAR    FORMAT  'x(15)'
    FIELD   codcli  AS  CHAR    FORMAT  'x(15)'
    FIELD   coddiv  AS  CHAR    FORMAT  'x(8)'
    .

DEFINE TEMP-TABLE tsi_let_cxc_soles_dtl
    FIELD   jdt_num     AS  INT     FORMAT  '->>,>>>,>>9'
    FIELD   linenum     AS  CHAR    FORMAT  'x(25)'
    FIELD   line_id     AS  INT     FORMAT  '->>,>>>,>>9'
    FIELD   account     AS  CHAR    FORMAT  'x(15)'
    FIELD   previo      AS  CHAR    FORMAT  'x(15)'
    FIELD   fccurrency  AS  CHAR    FORMAT  'x(5)'
    FIELD   debit       AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   crebit      AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   fcdebit     AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   fccrebit    AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   refdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   taxdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   duedate     AS  CHAR    FORMAT  'x(12)'
    FIELD   shortname   AS  CHAR    FORMAT  'x(20)'
    FIELD   linememo    AS  CHAR    FORMAT  'x(225)'
    FIELD   ref1        AS  CHAR    FORMAT  'x(150)'
    FIELD   ref2        AS  CHAR    FORMAT  'x(150)'
    FIELD   ref3line    AS  CHAR    FORMAT  'x(150)'
    FIELD   Project     AS  CHAR    FORMAT  'x(50)'
    FIELD   ProfitCode  AS  CHAR    FORMAT  'x(50)'
    FIELD   u_vs_esletra    AS  CHAR    FORMAT  'x(10)'
    FIELD   u_vs_tipocta    AS  CHAR    FORMAT  'x(10)'
    FIELD   u_vs_numeroltr  AS  CHAR    FORMAT  'x(50)'
    .

DEFINE TEMP-TABLE tsi_let_cxc_dolares_dtl
    FIELD   jdt_num     AS  INT     FORMAT  '->>,>>>,>>9'
    FIELD   linenum     AS  CHAR    FORMAT  'x(25)'
    FIELD   line_id     AS  INT     FORMAT  '->>,>>>,>>9'
    FIELD   account     AS  CHAR    FORMAT  'x(15)'    
    ...
    FIELD   fcdebit     AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   fccrebit    AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   debitsys    AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   creditsys   AS  DEC     FORMAT  '->>,>>>,>>9.99'
    FIELD   refdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   taxdate     AS  CHAR    FORMAT  'x(12)'
    FIELD   duedate     AS  CHAR    FORMAT  'x(12)'
    FIELD   shortname   AS  CHAR    FORMAT  'x(20)'
...
DEFINE TEMP-TABLE tsi_let_cxc_soles_err
    FIELD   coddoc  AS  CHAR    FORMAT  'x(5)'
    FIELD   nrodoc  AS  CHAR    FORMAT  'x(15)'
    FIELD   flgest  AS  CHAR    FORMAT  'x(15)'
    FIELD   flgubi  AS  CHAR    FORMAT  'x(15)'
    FIELD   codcli  AS  CHAR    FORMAT  'x(15)'
.

 DEFINE VAR cCtaCtble AS CHAR.
    DEFINE VAR cCtaCtble2 AS CHAR.
    DEFINE VAR cCtaCtble3 AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS TOGGLE-sap TOGGLE-Resumen R-TipRep C-Mes ~
x-CodOpe X-DIV x-codmon x-Clasificacion x-auxiliar x-cuenta x-cuenta-2 ~
T-Fechas RADIO-SET-1 B-impresoras RB-NUMBER-COPIES RB-BEGIN-PAGE ~
RB-END-PAGE B-imprime B-cancela BUTTON-Texto RECT-25 RECT-4 RECT-5 RECT-6 
&Scoped-Define DISPLAYED-OBJECTS TOGGLE-sap TOGGLE-Resumen R-TipRep C-Mes ~
x-CodOpe X-DIV x-codmon x-Clasificacion x-auxiliar x-cuenta x-cuenta-2 ~
T-Fechas F-Fecha1 F-Fecha2 RADIO-SET-1 RB-NUMBER-COPIES RB-BEGIN-PAGE ~
RB-END-PAGE 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD formatofecha DIALOG-1 
FUNCTION formatofecha RETURNS CHARACTER
...
DEFINE VARIABLE TOGGLE-sap AS LOGICAL INITIAL no 
     LABEL "¿Es para SAP?" 
     VIEW-AS TOGGLE-BOX
     SIZE 16 BY .77 NO-UNDO.
...
DEFINE FRAME DIALOG-1
     TOGGLE-sap AT ROW 12.15 COL 5 WIDGET-ID 4
     TOGGLE-Resumen AT ROW 6.12 COL 11 WIDGET-ID 2
     R-TipRep AT ROW 1.31 COL 2.86 NO-LABEL
...
/*       ELSE RUN proc_texto.                                 */
      ...
      ELSE DO:
          ...
          IF r-tiprep = 2 THEN DO:
              IF toggle-sap = YES THEN DO:
                  IF lookup(x-cuenta,'12311100,12311110') > 0 THEN DO:
                      RUN sap-letras.
                  END.
              END.
          END.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH cb-dmov NO-LOCK WHERE
        ...
        ELSE 
         ...
         IF NOT tpomov THEN iSigno = 1.
         IF tpomov THEN iSigno = -1.
        ...
        ASSIGN
            ...
            T-REPORT.imptemn    = cb-dmov.ImpMn1 * iSigno.        
...
------------------------------------------------------------------------------*/
  DISPLAY TOGGLE-sap TOGGLE-Resumen R-TipRep C-Mes x-CodOpe X-DIV x-codmon 
          x-Clasificacion x-auxiliar x-cuenta x-cuenta-2 T-Fechas F-Fecha1 
          F-Fecha2 RADIO-SET-1 RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
  ENABLE TOGGLE-sap TOGGLE-Resumen R-TipRep C-Mes x-CodOpe X-DIV x-codmon 
         x-Clasificacion x-auxiliar x-cuenta x-cuenta-2 T-Fechas RADIO-SET-1 
         B-impresoras RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE B-imprime 
         B-cancela BUTTON-Texto RECT-25 RECT-4 RECT-5 RECT-6 
      WITH FRAME DIALOG-1.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VAR Y-SALDOmn   AS DECIMAL NO-UNDO.
    ...
    FOR EACH T-REPORT NO-LOCK USE-INDEX IDX03
        ...
        ACCUMULATE T-REPORT.imptemn (SUB-TOTAL BY T-REPORT.nrodoc).
        X-CONREG = X-CONREG + 1.
        ...
        IF LAST-OF(T-REPORT.NRODOC) AND X-CONREG > 0 THEN DO:
            ...
            Y-SALDOmn = (ACCUMULATE SUB-TOTAL BY T-REPORT.NroDoc T-REPORT.imptemn ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE sap-addnuevodoc DIALOG-1 
PROCEDURE sap-addnuevodoc :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE INPUT PARAMETER pConteo AS INT NO-UNDO.
DEFINE INPUT PARAMETER pSaldo AS DEC NO-UNDO.
DEFINE INPUT PARAMETER pSaldomn AS DEC NO-UNDO.

    DEFINE VAR iMes AS INT.
    DEFINE VAR iAnio AS INT.
    DEFINE VAR fCorte AS DATE.

    IF NOT T-Fechas THEN DO:
    ...
    FIND FIRST ccbcdocu WHERE ccbcdocu.codcia = 1 AND ccbcdocu.coddoc = 'let' AND
                                ccbcdocu.nrodoc = t-detalle.nrodoc NO-LOCK NO-ERROR.

    IF NOT AVAILABLE ccbcdocu THEN DO:
        CREATE tsi_let_cxc_soles_err.
            ASSIGN tsi_let_cxc_soles_err.coddoc = ""
                    tsi_let_cxc_soles_err.nrodoc = t-detalle.nrodoc
                    tsi_let_cxc_soles_err.codcli = t-detalle.CodAux.

        RETURN.
    END.

    cCtaCtble = t-detalle.codcta.
    IF cCtaCtble = "12311100" THEN DO:
        cCtaCtble = "12331110".      /* Soles */
        cCtaCtble2 = "9905".
    END.
         
    IF cCtaCtble = "12311110" THEN DO:
        cCtaCtble = "12331120".      /* Dolares */
        cCtaCtble2 = "9905".
    END.
        
    /* Header */
    CREATE tsi_let_cxc_soles_hdr.
    ASSIGN tsi_let_cxc_soles_hdr.jdt_num = pConteo
            tsi_let_cxc_soles_hdr.memo = "Saldo inicial - Letra " + t-detalle.nrodoc
            tsi_let_cxc_soles_hdr.refdate = formatofecha(fCorte)
            tsi_let_cxc_soles_hdr.taxdate = formatofecha(ccbcdocu.fchdoc)
            tsi_let_cxc_soles_hdr.duedate = formatofecha(t-detalle.FchVto)
            tsi_let_cxc_soles_hdr.coddoc = ccbcdocu.coddoc
            tsi_let_cxc_soles_hdr.nrodoc = ccbcdocu.nrodoc
            tsi_let_cxc_soles_hdr.flgubi = ccbcdocu.flgubi
            tsi_let_cxc_soles_hdr.codcli = t-detalle.codaux
            tsi_let_cxc_soles_hdr.coddiv = t-detalle.coddiv
        .

    /* Detalle SOLES */
    IF cCtaCtble = "12331110" THEN DO:
        CREATE tsi_let_cxc_soles_dtl.
            ASSIGN  tsi_let_cxc_soles_dtl.jdt_num = pConteo
                    tsi_let_cxc_soles_dtl.linenum = ""
                    tsi_let_cxc_soles_dtl.line_id = 0
                    tsi_let_cxc_soles_dtl.account = cCtaCtble
                    tsi_let_cxc_soles_dtl.previo = cCtaCtble
                    tsi_let_cxc_soles_dtl.fccurrency = ""
                    tsi_let_cxc_soles_dtl.debit = pSaldo
                    tsi_let_cxc_soles_dtl.crebit = 0
                    tsi_let_cxc_soles_dtl.fcdebit = 0
                    tsi_let_cxc_soles_dtl.fccrebit = 0
                    tsi_let_cxc_soles_dtl.refdate = formatofecha(fCorte)
                    tsi_let_cxc_soles_dtl.taxdate = formatofecha(ccbcdocu.fchdoc)
                    tsi_let_cxc_soles_dtl.duedate = formatofecha(t-detalle.FchVto)
                    tsi_let_cxc_soles_dtl.shortname = "CL" + ccbcdocu.codcli
                    tsi_let_cxc_soles_dtl.linememo = "LT DE LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_soles_dtl.ref1 = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_soles_dtl.ref2 = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_soles_dtl.ref3line = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_soles_dtl.Project = ""
                    tsi_let_cxc_soles_dtl.ProfitCode = ""
                    tsi_let_cxc_soles_dtl.u_vs_esletra = "SI"
                    tsi_let_cxc_soles_dtl.u_vs_tipocta = "CXC"
                    tsi_let_cxc_soles_dtl.u_vs_numeroltr = "LC-" + ccbcdocu.nrodoc
                    .

            CREATE tsi_let_cxc_soles_dtl.
                ASSIGN  tsi_let_cxc_soles_dtl.jdt_num = pConteo
                        tsi_let_cxc_soles_dtl.linenum = ""
                        tsi_let_cxc_soles_dtl.line_id = 1
                        tsi_let_cxc_soles_dtl.account = cCtaCtble2
                        tsi_let_cxc_soles_dtl.previo = cCtaCtble2
                        tsi_let_cxc_soles_dtl.fccurrency = ""
                        tsi_let_cxc_soles_dtl.debit = 0
                        tsi_let_cxc_soles_dtl.crebit = pSaldo
                        tsi_let_cxc_soles_dtl.fcdebit = 0
                        tsi_let_cxc_soles_dtl.fccrebit = 0
                        tsi_let_cxc_soles_dtl.refdate = formatofecha(fCorte)
                        tsi_let_cxc_soles_dtl.taxdate = formatofecha(ccbcdocu.fchdoc)
                        tsi_let_cxc_soles_dtl.duedate = formatofecha(t-detalle.FchVto)
                        tsi_let_cxc_soles_dtl.shortname = cCtaCtble2
                        tsi_let_cxc_soles_dtl.linememo = ""
                        tsi_let_cxc_soles_dtl.ref1 = ""
                        tsi_let_cxc_soles_dtl.ref2 = ""
                        tsi_let_cxc_soles_dtl.ref3line = ""
                        tsi_let_cxc_soles_dtl.Project = ""
                        tsi_let_cxc_soles_dtl.ProfitCode = ""
                        tsi_let_cxc_soles_dtl.u_vs_esletra = "NO"
                        tsi_let_cxc_soles_dtl.u_vs_tipocta = "CXC"
                        tsi_let_cxc_soles_dtl.u_vs_numeroltr = ""
                        .

    END.
    /* Detalle DOLARES */
    IF cCtaCtble = "12331120" THEN DO:
        CREATE tsi_let_cxc_dolares_dtl.
            ASSIGN  tsi_let_cxc_dolares_dtl.jdt_num = pConteo
                    tsi_let_cxc_dolares_dtl.linenum = ""
                    tsi_let_cxc_dolares_dtl.line_id = 0
                    tsi_let_cxc_dolares_dtl.account = cCtaCtble
                    tsi_let_cxc_dolares_dtl.fccurrency = "USD"
                    tsi_let_cxc_dolares_dtl.debit = pSaldo
                    tsi_let_cxc_dolares_dtl.crebit = 0
                    tsi_let_cxc_dolares_dtl.fcdebit = IF (pSaldomn > 0) THEN pSaldomn ELSE (pSaldomn * -1)
                    tsi_let_cxc_dolares_dtl.fccrebit = 0
                    tsi_let_cxc_dolares_dtl.debitsys = IF (pSaldomn > 0) THEN pSaldomn ELSE (pSaldomn * -1)
                    tsi_let_cxc_dolares_dtl.creditsys = 0
                    tsi_let_cxc_dolares_dtl.refdate = formatofecha(fCorte)
                    tsi_let_cxc_dolares_dtl.taxdate = formatofecha(ccbcdocu.fchdoc)
                    tsi_let_cxc_dolares_dtl.duedate = formatofecha(t-detalle.fchvto)
                    tsi_let_cxc_dolares_dtl.shortname = "CL" + ccbcdocu.codcli
                    tsi_let_cxc_dolares_dtl.linememo = "LT DE LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_dolares_dtl.ref1 = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_dolares_dtl.ref2 = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_dolares_dtl.ref3line = "LC-" + ccbcdocu.nrodoc
                    tsi_let_cxc_dolares_dtl.Project = ""
                    tsi_let_cxc_dolares_dtl.ProfitCode = ""
                    tsi_let_cxc_dolares_dtl.u_vs_esletra = "SI"
                    tsi_let_cxc_dolares_dtl.u_vs_tipocta = "CXC"
                    tsi_let_cxc_dolares_dtl.u_vs_numeroltr = "LC-" + ccbcdocu.nrodoc
                    .

            CREATE tsi_let_cxc_dolares_dtl.
                ASSIGN  tsi_let_cxc_dolares_dtl.jdt_num = pConteo
                        tsi_let_cxc_dolares_dtl.linenum = ""
                        tsi_let_cxc_dolares_dtl.line_id = 1
                        tsi_let_cxc_dolares_dtl.account = cCtaCtble2
                        tsi_let_cxc_dolares_dtl.fccurrency = "USD"
                        tsi_let_cxc_dolares_dtl.debit = 0
                        tsi_let_cxc_dolares_dtl.crebit = pSaldo
                        tsi_let_cxc_dolares_dtl.fcdebit = 0
                        tsi_let_cxc_dolares_dtl.fccrebit = IF (pSaldomn > 0) THEN pSaldomn ELSE (pSaldomn * -1)
                        tsi_let_cxc_dolares_dtl.debitsys = 0
                        tsi_let_cxc_dolares_dtl.creditsys = IF (pSaldomn > 0) THEN pSaldomn ELSE (pSaldomn * -1)
                        tsi_let_cxc_dolares_dtl.refdate = formatofecha(fCorte)
                        tsi_let_cxc_dolares_dtl.taxdate = formatofecha(ccbcdocu.fchdoc)
                        tsi_let_cxc_dolares_dtl.duedate = formatofecha(t-detalle.fchvto)
                        tsi_let_cxc_dolares_dtl.shortname = cCtaCtble2
                        tsi_let_cxc_dolares_dtl.linememo = ""
                        tsi_let_cxc_dolares_dtl.ref1 = ""
                        tsi_let_cxc_dolares_dtl.ref2 = ""
                        tsi_let_cxc_dolares_dtl.ref3line = ""
                        tsi_let_cxc_dolares_dtl.Project = ""
                        tsi_let_cxc_dolares_dtl.ProfitCode = ""
                        tsi_let_cxc_dolares_dtl.u_vs_esletra = "NO"
                        tsi_let_cxc_dolares_dtl.u_vs_tipocta = "CXC"
                        tsi_let_cxc_dolares_dtl.u_vs_numeroltr = ""
                        .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE sap-letras DIALOG-1 
PROCEDURE sap-letras :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
EMPTY TEMP-TABLE tsi_let_cxc_soles_hdr.
EMPTY TEMP-TABLE tsi_let_cxc_soles_dtl.
EMPTY TEMP-TABLE tsi_let_cxc_soles_err.

FOR EACH t-detalle NO-LOCK:
    IF t-detalle.saldomn = 0 THEN NEXT.
    iConteo = iConteo + 1.
    RUN sap-addnuevodoc(iConteo, t-detalle.saldo, t-detalle.saldomn).
END.

DEFINE VAR cFileXls AS CHAR.

cFileXls = replace(pArchivo,".","").
...
c-xls-file = cFileXls + "_cabecera_soles.xlsx".

IF x-cuenta BEGINS "1231111" THEN DO:       /* Dolares */
    c-xls-file = cFileXls + "_cabecera_dolares.xlsx".
END.

run pi-crea-archivo-csv IN hProc (input  buffer tsi_let_cxc_soles_hdr:handle,
                        /*input  session:temp-directory + "file"*/ c-xls-file,
                        output c-csv-file) .

run pi-crea-archivo-xls  IN hProc (input  buffer tsi_let_cxc_soles_hdr:handle,
                        input  c-csv-file,
                        output c-xls-file) .

/* ------------------------------------------------------------- */

c-xls-file = cFileXls + "_detalle_soles.xlsx".
IF x-cuenta BEGINS "1231111" THEN DO:       /* Dolares */
    c-xls-file = cFileXls + "_detalle_dolares.xlsx".

    run pi-crea-archivo-csv IN hProc (input  buffer tsi_let_cxc_dolares_dtl:handle,
                            /*input  session:temp-directory + "file"*/ c-xls-file,
                            output c-csv-file) .

    run pi-crea-archivo-xls  IN hProc (input  buffer tsi_let_cxc_dolares_dtl:handle,
                            input  c-csv-file,
                            output c-xls-file) .

END.
ELSE DO:
    run pi-crea-archivo-csv IN hProc (input  buffer tsi_let_cxc_soles_dtl:handle,
                            /*input  session:temp-directory + "file"*/ c-xls-file,
                            output c-csv-file) .

    run pi-crea-archivo-xls  IN hProc (input  buffer tsi_let_cxc_soles_dtl:handle,
                            input  c-csv-file,
                            output c-xls-file) .
...
c-xls-file = cFileXls + "_errores_soles.xlsx".
IF x-cuenta BEGINS "1231111" THEN DO:       /* Dolares */
    c-xls-file = cFileXls + "_errores_dolares.xlsx".

END.

run pi-crea-archivo-csv IN hProc (input  buffer tsi_let_cxc_soles_err:handle,
                        /*input  session:temp-directory + "file"*/ c-xls-file,
                        output c-csv-file) .

run pi-crea-archivo-xls  IN hProc (input  buffer tsi_let_cxc_soles_err:handle,
                        input  c-csv-file,
                        output c-xls-file) .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION formatofecha DIALOG-1 
FUNCTION formatofecha RETURNS CHARACTER
  ( INPUT pDate AS DATE ) :
/*------------------------------------------------------------------------------
  Purpose:  
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VAR cRetVal AS CHAR INIT "00000000".
  DEFINE VAR cFiler AS CHAR.

  IF pDate = ? THEN RETURN cretval.

  cFiler = STRING(pDate,"99/99/9999").

  cRetVal = ENTRY(3,cFiler,"/") + ENTRY(2,cFiler,"/") + ENTRY(1,cFiler,"/").
