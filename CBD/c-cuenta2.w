...
&SCOPED-DEFINE l-lookup h_l-cuenta2
...
DEFINE VARIABLE h_l-cuenta2 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 3.5 COL 59
     Btn_Cancel AT ROW 6.77 COL 59
     SPACE(2.13) SKIP(4.37)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/cbd/l-cuenta2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-cuenta2 ).
       RUN set-position IN h_l-cuenta2 ( 1.00 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-cuenta2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-cuenta2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-cuenta2 ,
