...
&Scoped-Define ENABLED-OBJECTS RECT-25 RECT-4 RECT-5 RECT-6 R-TipRep ~
RADIO-SET-1 B-impresoras B-imprime x-Clasificacion C-Mes X-DIV x-cuenta ~
x-auxiliar x-cuenta-2 B-cancela x-codmon T-Fechas RB-NUMBER-COPIES ~
RB-BEGIN-PAGE RB-END-PAGE 
&Scoped-Define DISPLAYED-OBJECTS R-TipRep RADIO-SET-1 x-Clasificacion C-Mes ~
X-DIV x-cuenta x-auxiliar x-cuenta-2 x-codmon T-Fechas F-Fecha1 F-Fecha2 ~
...
DEFINE FRAME DIALOG-1
     ...
     B-imprime AT ROW 12.04 COL 19.86
     ...
     B-cancela AT ROW 12.04 COL 49.86
     ...
     " Configuración de Impresión" VIEW-AS TEXT
          SIZE 78.29 BY .62 AT ROW 6.81 COL 1
...
------------------------------------------------------------------------------*/
  DISPLAY R-TipRep RADIO-SET-1 x-Clasificacion C-Mes X-DIV x-cuenta x-auxiliar 
          x-cuenta-2 x-codmon T-Fechas F-Fecha1 F-Fecha2 RB-NUMBER-COPIES 
          RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
  ENABLE RECT-25 RECT-4 RECT-5 RECT-6 R-TipRep RADIO-SET-1 B-impresoras 
         B-imprime x-Clasificacion C-Mes X-DIV x-cuenta x-auxiliar x-cuenta-2 
         B-cancela x-codmon T-Fechas RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
...
DEF VAR X-MONCTA AS INTEGER.
    ...
    DISPLAY "Seleccionando información requerida" @ x-mensaje with frame f-auxiliar.
    pause 0.
