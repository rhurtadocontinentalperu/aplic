...
DEFINE FRAME D-Dialog
     ...
     SPACE(18.13) SKIP(2.42)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "Impresión de Estados de Gestión  Comparativo".
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Impresión de Estados de Gestión  Comparativo */
DO:  
...
DO ii = C-MesIni TO C-MesFin :
  ...
  RUN CALCULA-SUMAS (x-Rowid, x-Nota, ValAju, x-Rowidn, ii - (C-MesIni - 1)).
