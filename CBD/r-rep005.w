...
DEFINE FRAME F-Main
     ...
     x-mensaje AT ROW 6 COL 4 NO-LABEL WIDGET-ID 12
     x-CodDiv AT ROW 3.15 COL 9 COLON-ALIGNED WIDGET-ID 8
     CB-MES AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 2
     Btn_Excel AT ROW 7.38 COL 40
     Btn_Done AT ROW 7.38 COL 51
     "v2" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 7.73 COL 29 WIDGET-ID 16
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "VENTAS Y COSTOS COMPARATIVOS MENSUAL CON N/C"
         HEIGHT             = 8.65
         WIDTH              = 64.43
         MAX-HEIGHT         = 10.15
         MAX-WIDTH          = 64.43
...
ON END-ERROR OF W-Win /* VENTAS Y COSTOS COMPARATIVOS MENSUAL CON N/C */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* VENTAS Y COSTOS COMPARATIVOS MENSUAL CON N/C */
DO:
...
FIND LAST AlmStkGe USE-INDEX Llave01 WHERE AlmStkge.CodCia = s-codcia
    ...
    AND AlmStkge.Fecha <= Almcmov.fchdoc    /* OJO */
    NO-LOCK NO-ERROR.
...
IF USERID("DICTDB") = "ADMIN" OR USERID("DICTDB") = "MASTER" THEN DO:
    ...
    c-xls-file = session:TEMP-DIRECTORY + 'r-rep005.xlsx'.
