...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-DDET.Provi_Periodo FORMAT "9999":U WIDTH 7.86
      T-DDET.Provi_Nromes FORMAT "99":U WIDTH 4.43
...
"Temp-Tables.T-DDET.CodPro" "Proveedor" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Temp-Tables.T-DDET.ImpDep" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-DDET.CodBien
"Temp-Tables.T-DDET.CodBien" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-DDET.TipOpe
"Temp-Tables.T-DDET.TipOpe" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-DDET.Provi_Periodo
"Temp-Tables.T-DDET.Provi_Periodo" ? ? "integer" ? ? ? ? ? ? yes ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.T-DDET.Provi_Nromes
"Temp-Tables.T-DDET.Provi_Nromes" ? ? "integer" ? ? ? ? ? ? yes ? no no "4.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.T-DDET.CodDoc
"Temp-Tables.T-DDET.CodDoc" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
