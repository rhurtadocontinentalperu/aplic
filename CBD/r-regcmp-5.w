...
ON END-ERROR OF W-Win /* Libro de Compras - 2009 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Libro de Compras - 2009 */
DO:
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME f-cab
        ...
        cTitulo3 SKIP(1)
        "------ -------- -------- ------------- -------- ------------------------------------------ -------------- -------------- -------------- -------------- -------------- -------------- -------------- -------------- -------- ------- --------------------------"
        "Numero                   Comp. de Pago                  Información del Proveedor          BASE IMPONIBLE BASE IMPONIBLE BASE IMPONIBLE                    I.G.V.         I.G.V.         I.G.V.                                        Documento Referencia   "   
        "Asto.                       Serie      Numero                                              DESTINA.A OPE- DESTINA.A OPE- POR OPERACIONE ADQUISICIONES                                                              Numero   Tipo de                           " 
        "Codigo                      Cod.   _    Comp.       Numero                                 RACIONES  GRA- RACIONES GRAB. QUE NO DAN DE-  NO GRAVADAS         A              B              C          T O T A L     Comp.   Cambio                            " 
        "Unico   Fecha    Fecha   Cd Depen Ano  Pgo Doc      Docum.                                 VADAS Y EXPOR- EXPORT, O  NO  RECHO A CREDIT                                                                            Pgo Suj   Usado           Cd               "
        "Oprac. Emision  Vencto.  Dc Aduan Dua    DUA    TD  Proveedor  Nombre/Razon Social         TACION (A)     GRABADAS (B)         (C)                                                                                 No Domic          Fecha   Dc Serie Numero  "
        "------ -------- -------- -- ----- ---- -------- -- ----------- --------------------------- -------------- -------------- -------------- -------------- -------------- -------------- -------------- -------------- -------- ------- -------- -- ----- --------"
    ...
    FOR EACH Registro NO-LOCK
        ...
        IF LAST-OF (Registro.CodOpe) THEN DO:
            ...
            {&NEW-PAGE}.
            DISPLAY STREAM REPORT
                "TOTAL POR OPERACION " + Registro.CodOpe @ Registro.NomPro
