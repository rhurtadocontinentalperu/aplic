...
FILL-IN-CodOpe TOGGLE-summary Btn_Print Btn_Done Btn_Excel Btn_Excel-2 
...
DEFINE BUTTON Btn_Excel-2 
     IMAGE-UP FILE "img/excelch.bmp":U
     LABEL "Excel" 
     SIZE 12 BY 1.5 TOOLTIP "Genera archivo texto"
     BGCOLOR 8 .
...
DEFINE FRAME F-Main
     ...
     Btn_Print AT ROW 5.81 COL 3.43
     Btn_Done AT ROW 5.81 COL 18
     Btn_Excel AT ROW 5.81 COL 31.86
     Btn_Excel-2 AT ROW 5.81 COL 47 WIDGET-ID 2
     "Moneda:" VIEW-AS TEXT
...
ON END-ERROR OF W-Win /* LIBRO VENTAS SUNAT 2011 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* LIBRO VENTAS SUNAT 2011 */
DO:
...
&Scoped-define SELF-NAME Btn_Excel-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_Excel-2 W-Win
ON CHOOSE OF Btn_Excel-2 IN FRAME F-Main /* Excel */
DO:
    ASSIGN FILL-IN-coddiv FILL-IN-CodOpe RADIO-CodMon TOGGLE-summary.
    RUN Excel.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-2 RADIO-CodMon FILL-IN-coddiv FILL-IN-CodOpe TOGGLE-summary 
         Btn_Print Btn_Done Btn_Excel Btn_Excel-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    ...
    cArchivo = 'Ventas' + STRING(s-Periodo, '9999') + STRING(s-NroMes, '99') + '.xls'.
    ...
    cRange = "B" + cColumn.
    chWorkSheet:Range(cRange):Value = "Nro!Asto".
    cRange = "C" + cColumn.
    chWorkSheet:Range(cRange):Value = "Fecha!Emisión".
    cRange = "D" + cColumn.
    chWorkSheet:Range(cRange):Value = "TD".
    cRange = "E" + cColumn.
    chWorkSheet:Range(cRange):Value = "Número!Serie".
    cRange = "F" + cColumn.
    chWorkSheet:Range(cRange):Value = "Número!Cmpbte".
    cRange = "G" + cColumn.
    chWorkSheet:Range(cRange):Value = "TD".
    cRange = "H" + cColumn.
    chWorkSheet:Range(cRange):Value = "Número".
    cRange = "I" + cColumn.
    chWorkSheet:Range(cRange):Value = "Apellidos Nombres/Denominación/Razón Social".
    cRange = "J" + cColumn.
    chWorkSheet:Range(cRange):Value = "Base Imponible".
    cRange = "K" + cColumn.
    chWorkSheet:Range(cRange):Value = "Importe!Exonerado".
    cRange = "L" + cColumn.
    chWorkSheet:Range(cRange):Value = "I.G.V.!I.P.M.".
    cRange = "M" + cColumn.
    chWorkSheet:Range(cRange):Value = "Importe Total".
    cRange = "N" + cColumn.
    chWorkSheet:Range(cRange):Value = "Tipo de!Cambio".
    cRange = "O" + cColumn.
    chWorkSheet:Range(cRange):Value = "Fecha!Refer".
    cRange = "P" + cColumn.
    chWorkSheet:Range(cRange):Value = "TD".
    cRange = "Q" + cColumn.
    chWorkSheet:Range(cRange):Value = "Nro!Ser".
    cRange = "R" + cColumn.
    chWorkSheet:Range(cRange):Value = "Número!Refer".


    FOR EACH w-report NO-LOCK WHERE
        w-report.task-no = s-task-no AND
        w-report.Llave-C = s-user-id
        WITH FRAME b WIDTH 320 NO-BOX :
         ...
         cRange = "O" + cColumn.
         chWorkSheet:Range(cRange):Value = w-report.Campo-C[14].
         cRange = "P" + cColumn.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH Registro BREAK BY
        ...
        ASSIGN
            ...
            w-report.Campo-C[14] = IF fFchRef <> ? THEN STRING(fFchRef,"99/99/99") ELSE ""
...
------------------------------------------------------------------------------*/
    ...
    ELSE RB-REPORT-NAME = "REGISTRO DE VENTAS 2011 DRAFT".
