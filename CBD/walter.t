...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 RADIO-SET-1 RECT-6 C-1 RECT-13 ~
O-mayor B-impresoras B-imprime x-Div x-cta-ini x-cta-fin B-cancela RECT-9 ~
x-balance RECT-10 x-codmon RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-1 C-1 O-mayor x-Div x-cta-ini ~
x-cta-fin x-balance x-codmon RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
...
DEFINE FRAME DIALOG-1
     ...
     x-balance AT ROW 2.12 COL 53 NO-LABEL
...
DO:
    ...
    ELSE DO:
        ...
        ELSE DO:
                MESSAGE "Divisi¢n No Registrada" VIEW-AS ALERT-BOX
                        ERROR.
...
ON LEAVE OF C-1 IN FRAME DIALOG-1 /* D¡gitos */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-1 C-1 O-mayor x-Div x-cta-ini x-cta-fin x-balance x-codmon 
          RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
  ENABLE RECT-4 RECT-5 RADIO-SET-1 RECT-6 C-1 RECT-13 O-mayor B-impresoras 
         B-imprime x-Div x-cta-ini x-cta-fin B-cancela RECT-9 x-balance RECT-10 
         x-codmon RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME DIALOG-1.
