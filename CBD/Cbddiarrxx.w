...
cb-cmov.NroTra cb-cmov.GloAst cb-cmov.FchMod cb-cmov.TotItm cb-cmov.DbeMn1 ~
cb-cmov.DbeMn2 cb-cmov.HbeMn1 cb-cmov.HbeMn2 
...
DEFINE FRAME F-maestro
     ...
     cb-cmov.NotAst AT ROW 2.96 COL 6 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 58 BY .69
     cb-cmov.NroTra AT ROW 3.27 COL 76 COLON-ALIGNED
     ...
     cb-cmov.GloAst AT ROW 3.69 COL 8 NO-LABEL
          ...
          SIZE 58 BY 1.12
     cb-cmov.FchMod AT ROW 4.08 COL 77.72 COLON-ALIGNED
          LABEL "Fecha Detraccion"
          VIEW-AS FILL-IN 
          SIZE 8.57 BY .81
     BRW-DETALLE AT ROW 4.92 COL 1.43
     cb-cmov.TotItm AT ROW 5 COL 80.72 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5.72 BY .69
...
/* SETTINGS FOR FRAME F-maestro
   UNDERLINE L-To-R                                                     */
/* BROWSE-TAB BRW-DETALLE FchMod F-maestro */
...
"cb-dmov.Nroruc" ? "X(13)" "character" ? ? ? ? ? ? no ?
...
DISABLE cb-cmov.fchmod cb-cmov.nrotra cb-cmov.Fchast Moneda Nrovou cb-cmov.Tpocmb cb-cmov.Notast cb-cmov.GloAst
        cb-cmov.C-FCAJA
        b-d-add b-d-update b-d-delete BUTTON-3 b-d-suma WITH FRAME F-maestro.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE cb-cmov THEN 
    DISPLAY cb-cmov.NroAst cb-cmov.NroVou cb-cmov.FchAst cb-cmov.TpoCmb 
          cb-cmov.CodDiv cb-cmov.C-FCaja cb-cmov.NotAst cb-cmov.NroTra 
          cb-cmov.GloAst cb-cmov.FchMod cb-cmov.TotItm cb-cmov.DbeMn1 
          cb-cmov.DbeMn2 cb-cmov.HbeMn1 cb-cmov.HbeMn2 
      WITH FRAME F-maestro IN WINDOW W-maestro.
  ENABLE BRW-DETALLE BUTTON-4 B-impresoras 
      WITH FRAME F-maestro IN WINDOW W-maestro.
