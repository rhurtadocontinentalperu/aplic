...
DEF TEMP-TABLE DETALLE
        ...
        FIELD Codigo1 AS DEC
        FIELD Codigo2 AS DEC
        FIELD Codigo3 AS DEC
        FIELD Codigo4 AS DEC
        FIELD Codigo5 AS DEC
        FIELD Codigo6 AS DEC.
...
------------------------------------------------------------------------------*/
    ...
    SYSTEM-DIALOG GET-FILE x-Cab 
        FILTERS 'Texto (*.txt)' '*.txt', 'Todos (*.*)' '*.*'        INITIAL-FILTER 1
        RETURN-TO-START-DIR 
    ...
    FOR EACH DETALLE WHERE DETALLE.CodPer <> '':
        ...
        IF DETALLE.Codigo1 > 0 THEN RUN Carga-Concepto (125, DETALLE.Codigo1).
        IF DETALLE.Codigo2 > 0 THEN RUN Carga-Concepto (127, DETALLE.Codigo2).
        IF DETALLE.Codigo3 > 0 THEN RUN Carga-Concepto (126, DETALLE.Codigo3).
        IF DETALLE.Codigo4 > 0 THEN RUN Carga-Concepto (118, DETALLE.Codigo4).
        IF DETALLE.Codigo5 > 0 THEN RUN Carga-Concepto (502, DETALLE.Codigo5).
        IF DETALLE.Codigo6 > 0 THEN RUN Carga-Concepto (507, DETALLE.Codigo6).
    END.
