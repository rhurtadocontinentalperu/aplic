...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 58 BY 8.27
         FONT 4.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importar Catalogo de Materiales Nuevos"
         HEIGHT             = 11
         WIDTH              = 64.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* Importar Catalogo de Materiales Nuevos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Importar Catalogo de Materiales Nuevos */
DO:
...
DO:
  IF s-Button-1 = YES
  THEN DO:
    MESSAGE "El archivo a importar debe estar en C:\Tmp\newcat.txt" SKIP
...
------------------------------------------------------------------------------*/
  ...
  END.
  HIDE FRAME F-Mensaje.
  MESSAGE "Importación de Materiales Completa" VIEW-AS ALERT-BOX WARNING.
  {&OPEN-QUERY-{&BROWSE-NAME}}
