...
DEF FRAME F-Mensaje
    ...
    "   Almacen:" lg-cocmp.codalm SKIP
    " Documento:" lg-cocmp.nrodoc
    "       Dia:" lg-cocmp.fchdoc
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación de Movimientos de Almacen"
         HEIGHT             = 18.85
         WIDTH              = 66.29
         MAX-HEIGHT         = 21.31
         MAX-WIDTH          = 110.14
...
ON END-ERROR OF W-Win /* Exportación de Movimientos de Almacen */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación de Movimientos de Almacen */
DO:
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH lg-cocmp WHERE lg-cocmp.codcia = s-codcia
            ...
            AND lg-cocmp.fchdoc >= FILL-IN-FchIni
            AND lg-cocmp.fchdoc <= FILL-IN-FchFin
            AND lg-cocmp.flgsit = 'P'   /* Aprobado */
            NO-LOCK:
        DISPLAY lg-cocmp.codalm lg-cocmp.nrodoc lg-cocmp.fchdoc WITH FRAME F-Mensaje.
        CREATE T-COCMP.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
    x-Cab = "C:\TMP\LG-COCMP." + S-CODDIV
    x-Det = "C:\TMP\LG-DOCMP." + S-CODDIV.

  FIND FIRST T-COCMP NO-ERROR.
  IF NOT AVAILABLE T-COCMP
  THEN DO:
