...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importación de Movimientos de Caja"
         HEIGHT             = 18.85
         WIDTH              = 62.43
         MAX-HEIGHT         = 20.27
         MAX-WIDTH          = 94.29
...
ON END-ERROR OF W-Win /* Importación de Movimientos de Caja */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Importación de Movimientos de Caja */
DO:
...
------------------------------------------------------------------------------*/
  ...
  HIDE FRAME F-Mensaje.
  MESSAGE "Importación de Movimientos de Caja Completa" VIEW-AS ALERT-BOX INFORMATION.
  {&OPEN-QUERY-BROWSE-CMOV}
  {&OPEN-QUERY-BROWSE-DMOV}
