...
&Scoped-define INTERNAL-TABLES T-CMOV T-DMOV INTEGRAL.Almmmatg
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-DMOV T-DMOV.codmat ~
INTEGRAL.Almmmatg.DesMat T-DMOV.Factor T-DMOV.CanDes T-DMOV.PreUni ~
T-DMOV.ImpLin 
...
&Scoped-define OPEN-QUERY-BROWSE-DMOV OPEN QUERY BROWSE-DMOV FOR EACH T-DMOV ~
 ...
 AND T-DMOV.NroDoc = x-nrodoc NO-LOCK, ~
      EACH INTEGRAL.Almmmatg OF T-DMOV NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-DMOV T-DMOV INTEGRAL.Almmmatg
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importación de Movimientos de Almacen"
         HEIGHT             = 17.58
         WIDTH              = 90
         MAX-HEIGHT         = 19.65
         MAX-WIDTH          = 94.72
...
ON END-ERROR OF W-Win /* Importación de Movimientos de Almacen */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Importación de Movimientos de Almacen */
DO:
...
------------------------------------------------------------------------------*/
    ...
    x-Cab = "C:\TMP\ALMCMOV." + COMBO-BOX-CodDiv.
    x-Det = "C:\TMP\ALMDMOV." + COMBO-BOX-CodDiv.
