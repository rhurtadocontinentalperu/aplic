...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 FILL-IN-FchIni FILL-IN-FchFin ~
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-2 RECT-1 FILL-IN-FchIni FILL-IN-FchFin BUTTON-1 BUTTON-3 
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
    x-Cab = "C:\TMP\ALMCMOV." + S-CODDIV
    x-Det = "C:\TMP\ALMDMOV." + S-CODDIV.
