...
&Scoped-define INTERNAL-TABLES ChkTareas tt-ChkTareas VtaCDocu tt-w-report
...
(ChkTareas.FlgEst = 'T' or ChkTareas.FlgEst = 'C') NO-LOCK, ~
      FIRST tt-ChkTareas WHERE TRUE /* Join to ChkTareas incomplete */ NO-LOCK, ~
      FIRST VtaCDocu WHERE tt-ChkTareas.CodCia  =  ChkTareas.CodCia  ~
...
(ChkTareas.FlgEst = 'T' or ChkTareas.FlgEst = 'C') NO-LOCK, ~
  ...
  AND  tt-ChkTareas.CodDoc  = ChkTareas.CodDoc ~
  AND  tt-ChkTareas.NroPed = ChkTareas.NroPed OUTER-JOIN NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-14 ChkTareas tt-ChkTareas VtaCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-14 ChkTareas
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-14 tt-ChkTareas
&Scoped-define THIRD-TABLE-IN-QUERY-BROWSE-14 VtaCDocu
...
/* Query rebuild information for BROWSE BROWSE-14
     _TblList          = "INTEGRAL.ChkTareas,Temp-Tables.tt-ChkTareas WHERE INTEGRAL.ChkTareas ...,INTEGRAL.VtaCDocu WHERE INTEGRAL.ChkTareas ..."
     _Options          = "NO-LOCK"
