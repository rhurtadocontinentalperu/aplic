...
VtaCDocu.FchPed VtaCDocu.Hora VtaCDocu.UsrSac VtaCDocu.FecSac ~
VtaCDocu.HorSac fNombreOrigen(VtaCDocu.UsrSac, 1) @ x-Nombre ~
fNombreOrigen(VtaCDocu.UsrSac, 2) @ x-Origen 
...
(fill-in-dni = "" or VtaCDocu.usrsac = fill-in-dni) ~
 ...
 AND VtaCDocu.FlgSit = "TP" NO-LOCK INDEXED-REPOSITION
...
&Scoped-Define ENABLED-OBJECTS BUTTON-15 BUTTON-Refrescar FILL-IN-dni ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 61 BY 23.15
         FONT 4
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 96 BY 23.15
         FONT 4
         TITLE "SELECCIONA UNA O MAS HPK A RESIGNAR" ROW-HEIGHT-CHARS .54.
...
DEFINE FRAME F-Main
     ...
     BUTTON-Refrescar AT ROW 1.27 COL 146 WIDGET-ID 8
     FILL-IN-dni AT ROW 1.31 COL 8.86 COLON-ALIGNED WIDGET-ID 10
     BROWSE-PHK AT ROW 2.62 COL 2 WIDGET-ID 200
     BROWSE-PERSONAL AT ROW 2.62 COL 101 WIDGET-ID 300
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 162.57 BY 25.08
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-15 BUTTON-Refrescar FILL-IN-dni BROWSE-PHK BROWSE-PERSONAL 
      WITH FRAME F-Main IN WINDOW W-Win.
