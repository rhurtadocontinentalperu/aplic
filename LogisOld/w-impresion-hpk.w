...
&Scoped-Define ENABLED-OBJECTS BUTTON-14 txtDesde txtHasta BUTTON-13 
...
DEFINE FRAME F-Main
     BUTTON-14 AT ROW 1 COL 91 WIDGET-ID 104
     txtDesde AT ROW 1.31 COL 9 COLON-ALIGNED WIDGET-ID 22
     txtHasta AT ROW 1.27 COL 29 COLON-ALIGNED WIDGET-ID 24
     BUTTON-13 AT ROW 1.27 COL 51 WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-impresion-hpk ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-impresion-hpk ( 6.69 , 98.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-impresion-hpk-det ( 9.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-impresion-hpk-det ( 15.88 , 110.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-14 txtDesde txtHasta BUTTON-13 
      WITH FRAME F-Main IN WINDOW W-Win.
