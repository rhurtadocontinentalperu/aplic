...
T-RUTAD.Libre_c01 T-RUTAD.LugEnt @ x-Distrito T-RUTAD.CodRef T-RUTAD.NroRef ~
FacCPedi.NomCli T-RUTAD.SKU @ x-SKU T-RUTAD.ImpCob T-RUTAD.Libre_d01 ~
T-RUTAD.Libre_d02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-RUTAD.Libre_c01 COLUMN-LABEL "Cuadrante" FORMAT "x(10)":U
...
"GN-DIVI.DesDiv" "Canal" "X(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-RUTAD.Libre_c01
"T-RUTAD.Libre_c01" "Cuadrante" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH Di-RutaD OF Di-RutaC NO-LOCK, FIRST Faccpedi NO-LOCK WHERE Faccpedi.codcia = Di-RutaD.codcia
    ...
    RUN logis/p-datos-sede-auxiliar (Faccpedi.Ubigeo[2],    /* @CL o @PV */
