...
FILL-IN-NroHPK BUTTON-Limpiar BUTTON-15 
...
DO:
  ...
  IF TOGGLE-HR = YES THEN pFlgEst = "P".
  ELSE pFlgEst = "P,C".
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-phr-consulta-doc ( 11.23 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-phr-consulta-doc ( 6.69 , 123.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-ped-tracking ( 18.23 , 4.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-Aplicar COMBO-BOX-CodDoc FILL-IN-FchDoc-1 FILL-IN-FchDoc-2 
         FILL-IN-NomCli FILL-IN-NroPed FILL-IN-NroHPK BUTTON-Limpiar BUTTON-15 
      WITH FRAME F-Main IN WINDOW W-Win.
