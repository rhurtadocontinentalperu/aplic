...
&Scoped-Define ENABLED-OBJECTS BUTTON-7 br_table FILL-IN-fecha BUTTON-8 
...
DEFINE BUTTON BUTTON-8 
     LABEL "Cerrar todas las sessiones" 
     SIZE 26 BY 1.12.
...
DEFINE FRAME F-Main
     BUTTON-7 AT ROW 19.38 COL 34 WIDGET-ID 6
     br_table AT ROW 2.65 COL 1.72
     FILL-IN-fecha AT ROW 1.38 COL 13 COLON-ALIGNED WIDGET-ID 2
     BUTTON-8 AT ROW 19.38 COL 54 WIDGET-ID 8
     "DobleClick en DNI para asignar la MESA" VIEW-AS TEXT
          SIZE 53 BY 1 AT ROW 1.38 COL 36 WIDGET-ID 4
...
DO:
    ...
    FIND FIRST x-ChkChequeador WHERE x-ChkChequeador.codcia = s-codcia AND 
                                        ...
                                        x-ChkChequeador.fchasignacion = fill-in-fecha AND
                                        x-ChkChequeador.flgest = 'A' NO-LOCK NO-ERROR.
    IF AVAILABLE x-ChkChequeador THEN DO:
        /*
        MESSAGE "Codigo de trabajador ya tiene la MESA (" + x-ChkChequeador.mesa + ") asignada!!!".
        RETURN.
        */
...
ON CHOOSE OF BUTTON-8 IN FRAME F-Main /* Cerrar todas las sessiones */
DO:
