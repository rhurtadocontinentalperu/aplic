...
"Campo-C[1]" "Cod" "X(5)" "character" ? ? 0 ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.dd-w-report.Campo-C[2]
"Campo-C[2]" "Nro.Doc" "X(12)" "character" ? ? 0 ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.dd-w-report.Campo-C[3]
"Campo-C[3]" "Cliente" "X(50)" "character" ? ? 0 ? ? ? no ? no no "37.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.dd-w-report.Campo-D[1]
"Campo-D[1]" "Entrega" ? "date" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.dd-w-report.Campo-I[1]
"Campo-I[1]" "Items" ">>>,>>9" "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.dd-w-report.Campo-F[1]
"Campo-F[1]" "Peso" "->>>,>>9.99" "decimal" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.dd-w-report.Campo-F[2]
"Campo-F[2]" "Importe" "->,>>>,>>9.99" "decimal" ? ? 0 ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.dd-w-report.Campo-F[3]
"Campo-F[3]" "Volumen" "->>>,>>9.99" "decimal" ? ? 0 ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-6 */
&ANALYZE-RESUME
