...
&Scoped-Define DISPLAYED-OBJECTS F-Giro F-DesCnd 
...
"No", "No":U
     ...
     gn-prov.Telfnos[3] AT ROW 5.85 COL 98 COLON-ALIGNED WIDGET-ID 72
          VIEW-AS FILL-IN 
          SIZE 10.72 BY .81
     gn-prov.Girpro AT ROW 6.12 COL 11 COLON-ALIGNED WIDGET-ID 54
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     F-Giro AT ROW 6.12 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 100
