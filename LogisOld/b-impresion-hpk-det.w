...
&Scoped-define FIELDS-IN-QUERY-br_table VtaDDocu.CodUbi VtaDDocu.CodMat ~
VtaDDocu.CanPed Almmmatg.DesMat Almmmatg.DesMar VtaDDocu.UndVta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDDocu.CodUbi COLUMN-LABEL "Zona" FORMAT "x(10)":U
      VtaDDocu.CodMat COLUMN-LABEL "Artículo" FORMAT "X(6)":U WIDTH 6.86
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > INTEGRAL.VtaDDocu.CodUbi
"VtaDDocu.CodUbi" "Zona" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaDDocu.CodMat
"VtaDDocu.CodMat" "Artículo" ? "character" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
