...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN logis\d-genera-comprobantes ( ROWID(FacCPedi), 'M', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN logis\d-genera-comprobantes ( ROWID(FacCPedi), 'FM', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
