...
dtl-w-report-1.Campo-C[2] dtl-w-report-1.Campo-D[1] ~
dtl-w-report-1.Campo-F[1] dtl-w-report-1.Campo-F[3] ~
dtl-w-report-1.Campo-F[2] dtl-w-report-1.Campo-C[20] ~
...
Btn_Cancel BUTTON-6 BROWSE-14 BROWSE-16 BUTTON-4 BUTTON-5 BUTTON-Eliminar 
...
"dtl-w-report-1.Campo-C[2]" "O/D" "X(15)" "character" ? ? 0 ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.dtl-w-report-1.Campo-D[1]
"dtl-w-report-1.Campo-D[1]" "F.Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.dtl-w-report-1.Campo-F[1]
...
"dtl-w-report-1.Campo-F[3]" "Importe" ">,>>>,>>9.99" "decimal" ? ? 0 ? ? ? no ? no no "14.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.dtl-w-report-1.Campo-F[2]
...
------------------------------------------------------------------------------*/
  ENABLE IMAGE-1 IMAGE-2 BROWSE-11 BROWSE-12 Btn_OK Btn_Cancel BUTTON-6 
         BROWSE-14 BROWSE-16 BUTTON-4 BUTTON-5 BUTTON-Eliminar 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
DO TRANSACTION ON ERROR UNDO CORRELATIVO, LEAVE CORRELATIVO 
        ON STOP UNDO CORRELATIVO, LEAVE CORRELATIVO:
