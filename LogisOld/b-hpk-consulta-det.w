...
VtaCDocu.NroRef T-VtaCDocu.CuentaItems @ x-CuentaItems ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.NroRef COLUMN-LABEL "O/D" FORMAT "X(15)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14
...
"VtaCDocu.CodTer" "Tipo" "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCDocu.NroRef
"VtaCDocu.NroRef" "O/D" ? "character" 14 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
