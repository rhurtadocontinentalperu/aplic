...
x-LLave = x-Llave + "Ap. Paterno" + CHR(9).
x-Llave = x-Llave + "Ap. Materno" + CHR(9).
x-LLave = x-LLave + "Nombres" + CHR(9).
x-Llave = x-Llave + "Cargo" + CHR(9).
x-Llave = x-Llave + "Seccion" + CHR(9).
x-Llave = x-Llave + "Grado Instruccion" + CHR(9).
x-Llave = x-LLave + "Fecha de Ingreso" + CHR(9).
x-Llave = x-Llave + "Centro de Costo" + CHR(9).
x-Llave = x-Llave + "Fecha de Cese" + CHR(9).
x-Llave = x-LLave + "CUSSP" + CHR(9).
x-Llave = x-Llave + "DNI" + CHR(9).
x-Llave = x-Llave + "Sexo" + CHR(9).
x-Llave = x-Llave + "Distrito" + CHR(9).
x-Llave = x-Llave + "Fecha de Nacimiento" + CHR(9).
x-Llave = x-Llave + "Sueldo Basico" + CHR(9).
/**/
x-Llave = x-Llave + "Inicio Contrato" + CHR(9).
x-Llave = x-Llave + "Fin Contrato" + CHR(9).
x-Llave = x-Llave + "Reg. MINTRA" + CHR(9).
/**/
x-Llave = x-Llave + "".
...
FOR EACH pl-flg-mes WHERE pl-flg-mes.codcia = s-codcia 
    ...
    FIRST pl-pers WHERE pl-pers.codper = pl-flg-mes.codper NO-LOCK:
    x-Llave = "".
    x-Llave = x-Llave + "'" + STRING (pl-flg-mes.codper, "999999") + CHR(9).
    x-Llave = x-Llave + pl-pers.patper + CHR(9).
    x-LLave = x-LLave + pl-pers.matper + CHR(9).
    x-Llave = x-LLave + pl-pers.nomper + CHR(9).
    x-LLave = x-Llave + pl-flg-mes.cargo + CHR(9).
    x-Llave = x-LLave + pl-flg-mes.seccion + CHR(9).
    x-Llave = x-Llave + pl-pers.titulo + CHR(9).
    x-Llave = x-Llave + STRING (PL-FLG-MES.fecing, '99/99/9999') + CHR(9).
    x-Llave = x-Llave + PL-FLG-MES.ccosto + CHR(9).
    IF PL-FLG-MES.vcontr <> ? THEN x-Llave = x-LLave + STRING (PL-FLG-MES.vcontr, '99/99/9999') + CHR(9).
    ELSE x-Llave = x-LLave + CHR(9).
    x-Llave = x-Llave + PL-FLG-MES.nroafp + CHR(9).
    x-LLave = x-LLave + PL-PERS.NroDocId + CHR(9).
    x-LLave = x-LLave + PL-PERS.SexPer + CHR(9).
    x-LLave = x-LLave + PL-PERS.Distri + CHR(9).
    x-LLave = x-LLave + STRING (PL-PERS.fecnac, '99/99/9999') + CHR(9).
    FIND PL-MOV-MES OF PL-FLG-MES WHERE
        PL-MOV-MES.codcal = 0 AND
        PL-MOV-MES.CodMov = 101
        NO-LOCK NO-ERROR.
    IF AVAILABLE PL-MOV-MES THEN x-LLave = x-LLave + STRING (PL-MOV-MES.valcal-mes) + CHR(9).
    ELSE x-Llave = ' ' .
    IF pl-flg-mes.fchinicont <> ? THEN x-LLave = x-LLave + STRING (pl-flg-mes.fchinicont, '99/99/9999') + CHR(9).
    ELSE x-Llave = x-LLave + CHR(9).
    IF pl-flg-mes.fchfincont <> ? THEN x-LLave = x-LLave + STRING (pl-flg-mes.fchfincont, '99/99/9999') + CHR(9).    
    ELSE x-Llave = x-LLave + CHR(9).
    IF pl-flg-mes.campo-c[4] <> '' THEN x-LLave = x-LLave + pl-flg-mes.campo-c[4] + CHR(9).
    ELSE x-Llave = x-LLave + CHR(9).
    x-Llave = x-Llave + "".
    PUT STREAM REPORTE x-LLave SKIP.
END.            
...
/* CARGAMOS EL EXCEL */
RUN lib/filetext-to-excel(x-Archivo, 'Personal', YES).
