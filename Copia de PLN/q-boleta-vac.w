...
&Scoped-define INTERNAL-TABLES pl-boleta-vac

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH pl-boleta-vac WHERE ~{&KEY-PHRASE} ~
      AND pl-boleta-vac.CodCia = s-codcia ~
 AND pl-boleta-vac.CodDoc = s-coddoc NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH pl-boleta-vac WHERE ~{&KEY-PHRASE} ~
      AND pl-boleta-vac.CodCia = s-codcia ~
 AND pl-boleta-vac.CodDoc = s-coddoc NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main pl-boleta-vac
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main pl-boleta-vac
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.pl-boleta-vac"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "INTEGRAL.pl-boleta-vac.CodCia = s-codcia
 AND INTEGRAL.pl-boleta-vac.CodDoc = s-coddoc"
