...
FILL-IN-9 TOGGLE-9 BUTTON-2 BUTTON-1 
    ...
    IF TOGGLE-1 THEN DO:
        ...
        ELSE cTelefono = PL-PERS.telefo.
         ...
         PUT STREAM strm1
             ...
             PL-PERS.patper FORMAT 'x(40)' "|"
             PL-PERS.matper FORMAT 'x(40)' "|"
             PL-PERS.nomper FORMAT 'x(40)' "|"
             PL-PERS.fecnac FORMAT "99/99/9999" "|"
             PL-PERS.sexper FORMAT 'x' "|"
             PL-PERS.CodNac FORMAT 'x(4)' "|"
             cTelefono FORMAT 'x(10)' "|".
         IF PL-PERS.E-Mail <> '' THEN PUT STREAM strm1 PL-PERS.E-Mail FORMAT 'x(50)'.
         PUT STREAM strm1 '|'.
         PUT STREAM strm1
             PL-PERS.Essalud FORMAT 'x' "|"
             PL-PERS.Domici FORMAT 'x' "|".
         IF PL-PERS.TpoDocId <> "01" THEN DO:
             PUT STREAM strm1 PL-PERS.TipoVia FORMAT 'x(2)' "|".
             IF PL-PERS.dirper <> '' THEN PUT STREAM strm1 PL-PERS.dirper FORMAT "x(20)".
             PUT STREAM strm1 "|".
             IF PL-PERS.DirNumero <> '' THEN PUT STREAM strm1 PL-PERS.DirNumero FORMAT 'x(4)'.
             PUT STREAM strm1 '|'.
             IF PL-PERS.DirInterior <> '' THEN PUT STREAM strm1 PL-PERS.DirInterior FORMAT 'x(4)'.
             PUT STREAM strm1 '|'.
             IF PL-PERS.TipoZona <> '' THEN PUT STREAM strm1 PL-PERS.TipoZona FORMAT 'x(2)'.
             PUT STREAM strm1 '|'.
             IF PL-PERS.NomZona <> '' THEN PUT STREAM strm1 PL-PERS.NomZona FORMAT 'x(20)'.
             PUT STREAM strm1 '|'.
             IF PL-PERS.DirReferen <> '' THEN PUT STREAM strm1 PL-PERS.DirReferen FORMAT 'x(40)'.
             PUT STREAM strm1 '|'.
             PUT STREAM strm1 PL-PERS.Ubigeo FORMAT 'x(6)' "|" SKIP.
         END.
