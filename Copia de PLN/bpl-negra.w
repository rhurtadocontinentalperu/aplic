...
&Scoped-define DATA-FIELD-DEFS "O:\on_in_co\APLIC\pln\dpl-negra_cl.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table DocIdentidad patper matper nomper 
...
DEFINE TEMP-TABLE RowObject NO-UNDO
    FIELD DocIdentidad LIKE pl-negra.DocIdentidad VALIDATE ~
    FIELD patper LIKE pl-negra.patper VALIDATE ~
    FIELD matper LIKE pl-negra.matper VALIDATE ~
    FIELD nomper LIKE pl-negra.nomper VALIDATE ~
    FIELD NomCompleto LIKE pl-negra.NomCompleto VALIDATE ~
    FIELD usuario LIKE pl-negra.usuario VALIDATE 
    {src/adm2/robjflds.i}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      DocIdentidad FORMAT "x(8)":U
      patper FORMAT "X(40)":U
      matper FORMAT "X(40)":U
      nomper FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 66 BY 6.65 FIT-LAST-COLUMN.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "aplic\pln\dpl-negra_cl.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.DocIdentidad
     _FldNameList[2]   = _<SDO>.rowObject.patper
     _FldNameList[3]   = _<SDO>.rowObject.matper
     _FldNameList[4]   = _<SDO>.rowObject.nomper
