...
PL-PERS.matper PL-PERS.nomper T-FLG-MES.FchIniCont T-FLG-MES.FchFinCont 
...
T-FLG-MES-2.FchIniCont T-FLG-MES-2.FchFinCont 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 wWin _STRUCTURED
  QUERY BROWSE-3 NO-LOCK DISPLAY
      ...
      T-FLG-MES.FchIniCont FORMAT "99/99/9999":U
      T-FLG-MES.FchFinCont FORMAT "99/99/9999":U WIDTH 10.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 101 BY 15
         FONT 4 FIT-LAST-COLUMN.

DEFINE BROWSE BROWSE-7
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-7 wWin _STRUCTURED
  QUERY BROWSE-7 NO-LOCK DISPLAY
      T-FLG-MES-2.codper FORMAT "X(6)":U
      T-FLG-MES-2.FchIniCont FORMAT "99/99/9999":U
      T-FLG-MES-2.FchFinCont FORMAT "99/99/9999":U WIDTH 12.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "CARGA DE VENCIMIENTOS DE CONTRATOS"
         HEIGHT             = 21.77
         WIDTH              = 104.57
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.14
...
"PL-PERS.nomper" ? "X(20)" "character" ? ? ? ? ? ? no ? no no "21.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = Temp-Tables.T-FLG-MES.FchIniCont
     _FldNameList[6]   > Temp-Tables.T-FLG-MES.FchFinCont
"T-FLG-MES.FchFinCont" ? ? "date" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-7
     ...
     _FldNameList[2]   = Temp-Tables.T-FLG-MES-2.FchIniCont
     _FldNameList[3]   > Temp-Tables.T-FLG-MES-2.FchFinCont
"T-FLG-MES-2.FchFinCont" ? ? "date" ? ? ? ? ? ? no ? no no "12.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-7 */
&ANALYZE-RESUME
...
ON END-ERROR OF wWin /* CARGA DE VENCIMIENTOS DE CONTRATOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* CARGA DE VENCIMIENTOS DE CONTRATOS */
DO:
...
ON CHOOSE OF BUTTON-2 IN FRAME fMain /* ACEPTAR VENCIMIENTOS */
DO:
...
FOR EACH T-FLG-MES TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    ASSIGN
        PL-FLG-MES.FchIniCont = T-FLG-MES.FchIniCont
        PL-FLG-MES.FchFinCont = T-FLG-MES.FchFinCont.
    DELETE T-FLG-MES.
END.
...
REPEAT:
    ...
    cValue = chWorkSheet:Range(cRange):VALUE.
    ASSIGN
        T-FLG-MES.FchIniCont = DATE(cValue).

    /* FIN CONTRATO */
    cRange = "C" + TRIM(STRING(iCountLine)).
    cValue = chWorkSheet:Range(cRange):VALUE.
    ASSIGN
        T-FLG-MES.FchFinCont = DATE(cValue).
