...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generacion de Contratos (Empleados)"
         HEIGHT             = 14.96
         WIDTH              = 70.72
         MAX-HEIGHT         = 14.96
         MAX-WIDTH          = 70.72
...
ON END-ERROR OF W-Win /* Generacion de Contratos (Empleados) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Generacion de Contratos (Empleados) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'pln/b-contrato-01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-p-bolm ).
       RUN set-position IN h_b-p-bolm ( 4.08 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-p-bolm ( 11.65 , 69.72 ) NO-ERROR.
