...
/* ***************************  Definitions  ************************** */
    ...
    cRange = "T" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[19].
    cRange = "U" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[20].
    cRange = "V" + cColumn.
    ...
    /* Egresos */
    cRange = "AB" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[40].
    cRange = "AC" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[41].
    cRange = "AD" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[42].
    cRange = "AE" + cColumn.
    chWorkSheet:Range(cRange):Value = tempo.ValCal[43].
