...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REPORTE DE PERSONAL POR CENTRO DE COSTO"
         HEIGHT             = 4.38
         WIDTH              = 71.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 80
...
ON END-ERROR OF W-Win /* REPORTE DE PERSONAL POR CENTRO DE COSTO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REPORTE DE PERSONAL POR CENTRO DE COSTO */
DO:
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Empleados por Centro de Costo'.
  RB-INCLUDE-RECORDS = 'O'.
  RB-FILTER = 'pl-flg-mes.codcia = ' + STRING(s-codcia) +
                ' AND pl-flg-mes.periodo = ' + STRING(s-Periodo) + 
                ' AND pl-flg-mes.nromes = ' + STRING(s-NroMes).
  RB-OTHER-PARAMETERS = 's-nomcia = ' + s-nomcia +
                        '~ns-periodo = ' + STRING(s-Periodo) +
                        '~ns-nromes = ' + STRING(s-nromes).
