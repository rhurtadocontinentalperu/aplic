...
&Scoped-Define ENABLED-OBJECTS RECT-2 FILL-IN-NRO-MES R-seleccion COMBO-S ~
TGL-pantalla Btn-UP Btn-DOWN B-aceptar br_pl-flg-m FILL-IN-msg 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-NRO-MES R-seleccion COMBO-S ~
TGL-pantalla FILL-IN-Copias FILL-IN-msg 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_pl-flg-m B-table-Win _STRUCTURED
  QUERY br_pl-flg-m NO-LOCK DISPLAY
      integral.PL-FLG-MES.codper COLUMN-FONT 4 LABEL-FONT 4
      integral.PL-PERS.patper COLUMN-FONT 4 LABEL-FONT 4
      integral.PL-PERS.matper COLUMN-FONT 4 LABEL-FONT 4
      integral.PL-PERS.nomper COLUMN-FONT 4 LABEL-FONT 4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
FOR EACH PL-BOLE NO-LOCK WHERE
    ...
    IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.valcal-Mes <> 0 THEN DO:
        ...
        valcaltotR = valcaltotR + PL-MOV-MES.valcal-Mes .
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 01 THEN DO:
         valcalR1 = valcalR1 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 02 THEN DO:
         valcalR2 = valcalR2 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 03 THEN DO:
         valcalR3 = valcalR3 + PL-MOV-MES.valcal-Mes.
        END.                        
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 04 THEN DO:
         valcalR4 = valcalR4 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 05 THEN DO:
         valcalR5 = valcalR5 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 06 THEN DO:
         valcalR6 = valcalR6 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 07 THEN DO:
         valcalR7 = valcalR7 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 08 THEN DO:
         valcalR8 = valcalR8 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 09 THEN DO:
         valcalR9 = valcalR9 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 10 THEN DO:
         valcalR10 = valcalR10 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 11 THEN DO:
         valcalR11 = valcalR11 + PL-MOV-MES.valcal-Mes.
        END.                                                                
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 12 THEN DO:
         valcalR12 = valcalR12 + PL-MOV-MES.valcal-Mes.
        END.        
    END.
    END.
...
FOR EACH PL-BOLE NO-LOCK WHERE
    ...
    IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.valcal-Mes <> 0 THEN DO:
        ...
        Tempo.valcal[I] = Tempo.valcal[I] + PL-MOV-MES.valcal-Mes .    
        Tempo.valcal[13] = Tempo.valcal[13] + PL-MOV-MES.valcal-Mes .  
        valcaltotD = valcaltotD + PL-MOV-MES.valcal-Mes .
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 01 THEN DO:
         valcalD1 = valcalD1 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 02 THEN DO:
         valcalD2 = valcalD2 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 03 THEN DO:
         valcalD3 = valcalD3 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 04 THEN DO:
         valcalD4 = valcalD4 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 05 THEN DO:
         valcalD5 = valcalD5 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 06 THEN DO:
         valcalD6 = valcalD6 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 07 THEN DO:
         valcalD7 = valcalD7 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 08 THEN DO:
         valcalD8 = valcalD8 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 09 THEN DO:
         valcalD9 = valcalD9 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 10 THEN DO:
         valcalD10 = valcalD10 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 11 THEN DO:
         valcalD11= valcalD11 + PL-MOV-MES.valcal-Mes.
        END.
        IF AVAILABLE PL-MOV-MES AND PL-MOV-MES.nromes = 12 THEN DO:
         valcalD12 = valcalD12 + PL-MOV-MES.valcal-Mes.
        END.
    END.
    END.
