...
&Scoped-define FIELDS-IN-QUERY-br_table w-report.Llave-I w-report.Campo-C[1] w-report.Campo-F[2] /*WIDTH 11.43*/ w-report.Campo-F[1] w-report.Campo-F[4] w-report.Campo-F[5] w-report.Campo-F[6] w-report.Campo-F[7] w-report.Campo-F[3] w-report.Campo-F[8]   
...
FOR EACH PL-MOV-MES USE-INDEX IDX01 WHERE
