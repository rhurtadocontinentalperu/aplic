...
DEFINE VARIABLE reg-act6  AS ROWID.
...
&Scoped-Define ENABLED-FIELDS PL-PLAN.codpln PL-PLAN.despln PL-PLAN.tippln 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}codpln ~{&FP2}codpln ~{&FP3}~
 ~{&FP1}despln ~{&FP2}despln ~{&FP3}~
 ~{&FP1}tippln ~{&FP2}tippln ~{&FP3}
&Scoped-define ENABLED-TABLES PL-PLAN
&Scoped-define FIRST-ENABLED-TABLE PL-PLAN
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS PL-PLAN.codpln PL-PLAN.despln ~
PL-PLAN.tippln 
...
DEFINE FRAME F-Main
     PL-PLAN.codpln AT ROW 1.31 COL 5.43 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.72 BY .81
     PL-PLAN.despln AT ROW 1.31 COL 9.43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 31.14 BY .81
     PL-PLAN.tippln AT ROW 1.31 COL 41.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .81
