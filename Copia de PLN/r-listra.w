...
&Scoped-Define ENABLED-OBJECTS txt-desde txt-hasta FILL-IN-2 btn-save ~
BUTTON-7 BUTTON-8 
&Scoped-Define DISPLAYED-OBJECTS txt-desde txt-hasta FILL-IN-2 txt-mensaje 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-2 AT ROW 3.42 COL 12 COLON-ALIGNED WIDGET-ID 70
     btn-save AT ROW 3.42 COL 78 WIDGET-ID 72
     BUTTON-7 AT ROW 5.31 COL 68 WIDGET-ID 74
     BUTTON-8 AT ROW 5.31 COL 77 WIDGET-ID 76
     txt-mensaje AT ROW 5.58 COL 5 NO-LABEL WIDGET-ID 78
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 86.29 BY 6.96 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  DISPLAY txt-desde txt-hasta FILL-IN-2 txt-mensaje 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE txt-desde txt-hasta FILL-IN-2 btn-save BUTTON-7 BUTTON-8 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*     IF Rpta-1 = NO THEN RETURN.                           */
    ...
    FOR EACH pl-flg-mes WHERE pl-flg-mes.codcia = s-codcia
        ...
        AND pl-flg-mes.FchIniCont <= txt-hasta NO-LOCK,
        ...
        cLinea = PL-PERS.NroDocId + '|' + '03|' + PL-PERS.patper + '|' + 
                 ...
                 PL-PERS.sexper   + '|' + STRING(PL-PERS.fecnac).
