...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table INTEGRAL.PR-MOV-MES.NumOrd ~
INTEGRAL.PR-MOV-MES.FchReg INTEGRAL.PR-MOV-MES.HoraI ~
INTEGRAL.PR-MOV-MES.HoraF 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table INTEGRAL.PR-MOV-MES
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table INTEGRAL.PR-MOV-MES
&Scoped-define QUERY-STRING-br_table FOR EACH INTEGRAL.PR-MOV-MES OF INTEGRAL.PL-FLG-MES WHERE ~{&KEY-PHRASE} NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      INTEGRAL.PR-MOV-MES.NumOrd COLUMN-LABEL "Orden !Trabajo" FORMAT "X(12)":U
      INTEGRAL.PR-MOV-MES.FchReg COLUMN-LABEL "Fecha              !Registro" FORMAT "99/99/9999":U
      INTEGRAL.PR-MOV-MES.HoraI COLUMN-LABEL "Hora    !Inicial" FORMAT "99.99":U
      INTEGRAL.PR-MOV-MES.HoraF COLUMN-LABEL "Hora    !Final" FORMAT "99.99":U
      INTEGRAL.PR-MOV-MES.Periodo COLUMN-LABEL "Año       !." FORMAT "9999":U
      INTEGRAL.PR-MOV-MES.NroMes COLUMN-LABEL "Mes    !." FORMAT "99":U
      INTEGRAL.PR-MOV-MES.Numliq COLUMN-LABEL "Liquidacion" FORMAT "X(6)":U
      INTEGRAL.PR-MOV-MES.FlgEst COLUMN-LABEL "Estado" FORMAT "X":U
  ENABLE
      INTEGRAL.PR-MOV-MES.NumOrd
      INTEGRAL.PR-MOV-MES.FchReg
      INTEGRAL.PR-MOV-MES.HoraI
      INTEGRAL.PR-MOV-MES.HoraF
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"PR-MOV-MES.NumOrd" "Orden !Trabajo" "X(12)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.PR-MOV-MES.FchReg
"PR-MOV-MES.FchReg" "Fecha              !Registro" ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.PR-MOV-MES.HoraI
"PR-MOV-MES.HoraI" "Hora    !Inicial" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.PR-MOV-MES.HoraF
"PR-MOV-MES.HoraF" "Hora    !Final" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.PR-MOV-MES.Periodo
"PR-MOV-MES.Periodo" "Año       !." ? "integer" ? ? ? ? ? ? no "Año" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.PR-MOV-MES.NroMes
"PR-MOV-MES.NroMes" "Mes    !." ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.PR-MOV-MES.Numliq
"PR-MOV-MES.Numliq" "Liquidacion" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.PR-MOV-MES.FlgEst
"PR-MOV-MES.FlgEst" "Estado" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
