...
DEFINE MENU POPUP-MENU-br_table 
       MENU-ITEM m_Asignacin    LABEL "Asignación Personal"
...
DO:
    ...
    MESSAGE '¿Desea Cancelar Asignación?' 
        VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO
        UPDATE lchoice AS LOG.
    IF lchoice THEN DO:
        ASSIGN
