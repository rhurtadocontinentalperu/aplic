...
DEFINE FRAME F-Main
     BUTTON-Despachar AT ROW 1 COL 108 WIDGET-ID 28
...
ON END-ERROR OF W-Win /* PEDIDO LOGISTICO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PEDIDO LOGISTICO */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 2.35 , 128.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_f-cot-gral-exporta-a-pdf ( 3.96 , 137.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-pedido-cred ( 13.12 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedido-credito-v2 ( 13.12 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-pedido-credito-v2 ( 11.69 , 141.00 ) NO-ERROR.
