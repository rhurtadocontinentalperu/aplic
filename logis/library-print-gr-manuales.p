...
DEF VAR cModalidadTransp AS CHAR FORMAT 'x(30)' NO-UNDO.
DEF VAR cCategoria AS CHAR FORMAT 'x(2)' NO-UNDO.
DEF VAR cObservaciones AS CHAR FORMAT 'x(100)' NO-UNDO.
DEF VAR cDirCli AS CHAR FORMAT 'x(100)' NO-UNDO.
...
ASSIGN
    ...
    .
IF TRUE <> (x-Ruc > '') THEN x-Ruc = Ccbcdocu.codant.   /* DNI */
...
cModalidadTransp = "TRANSPORTE PUBLICO".
cCategoria = "NO".
cObservaciones = "".
cDirCli = Ccbcdocu.DirCli.
...
IF AVAILABLE Ccbadocu THEN DO:
    ...
    /* Datos del vehículo */
    FIND gn-vehic WHERE gn-vehic.CodCia = s-codcia AND gn-vehic.placa = f-Placa NO-LOCK NO-ERROR.
    IF AVAILABLE gn-vehic THEN DO:
        IF gn-vehic.libre_d02 = 0 THEN cCategoria = "NO".
        IF gn-vehic.libre_d02 = 1 THEN cCategoria = "SI".
        f-Certificado = gn-vehic.tipo.
        /* En base al proveedor */
        IF gn-vehic.CodPro = "10003814" THEN cModalidadTransp = "TRANSPORTE PRIVADO".
        FIND FIRST gn-prov WHERE gn-prov.codcia = pv-codcia AND 
            gn-prov.codpro = gn-vehic.codpro NO-LOCK NO-ERROR.
        IF AVAILABLE gn-prov THEN DO:
            IF gn-prov.libre_d01 = 1 THEN cModalidadTransp = "TRANSPORTE PUBLICO".
            IF gn-prov.libre_d01 = 2 THEN cModalidadTransp = "TRANSPORTE PRIVADO".
        END.
    END.
    cObservaciones = Ccbadocu.Libre_C[10].
END.
...
DEFINE FRAME F-HdrGui
    HEADER
    SKIP(7)
    x-OD AT 25 FORMAT 'x(60)' SKIP
    x-OC AT 25 FORMAT 'x(60)' SKIP(2)

    x-FchDoc AT 17 FORMAT '99/99/9999' x-Peso   AT 110 FORMAT '>>>,>>9.99' 'kg' SKIP
    TODAY    AT 17 FORMAT '99/99/9999' x-Bultos AT 110 FORMAT '>>>,>>9' SKIP
    TODAY    AT 17 FORMAT '99/99/9999' cCategoria AT 115 SKIP
    x-Nombre AT 30 FORMAT 'x(75)' ' ' x-NroRef FORMAT "XXX-XXXXXXXX" SKIP(1)
    x-Ruc    AT 10 FORMAT 'x(15)' cDirCli AT 45 FORMAT 'x(100)' SKIP(1)

    x-PuntoPartida  AT 25 FORMAT 'x(100)' SKIP(1)
    x-PuntoLlegada  AT 25 FORMAT "X(100)" SKIP(3)
...
DEFINE FRAME F-FtrGui
    HEADER
    cObservaciones AT 15 FORMAT 'x(100)' SKIP(3)
    f-Placa AT 15 FORMAT 'x(15)' f-Certificado AT 50 FORMAT 'x(50)' SKIP(1)
    f-RucAge AT 5 FORMAT 'x(15)' f-NroLicencia AT 40 FORMAT 'x(20)' SKIP
    f-NomTra AT 18 FORMAT 'x(100)' 
    SKIP(3)
...
DEFINE FRAME F-DetaGui
    ...
    Detalle.codmat FORMAT 'x(8)'
    Detalle.desmat FORMAT 'x(70)'
    Detalle.UndVta FORMAT 'x(8)'
...
/*
PUNTO DE LLEGADA: ftr-Glosa1    NUEVO PUNTO DE PARTIDA: ftr-Glosa9
ftr-Glosa2                      ftr-Glosa10
ftr-Glosa3                      PUNTO DE LLEGADA: ftr-Glosa11
TRANSPORTISTA: ftr-Glosa4       ftr-Glosa12
DOMICILIO: ftr-Glosa5           TRANSPORTISTA: ftr-Glosa13
RUC: ftr-Glosa6                 DOMICILIO: ftr-Glosa14 
MARCA/PLACA: ftr-Glosa7         RUC: ftr-Glosa15
LIC/CONDUCTOR: ftr-Glosa8       MARCA/PLACA: ftr-Glosa16
*/
ASSIGN
    ftr-Glosa1 = ""
    ftr-Glosa2 = ""
...
CASE TRUE:
    WHEN X-TRANS > '' AND X-LUGAR > '' THEN DO:
        ASSIGN
            ...
            ftr-Glosa2 = STRING(X-CONTC,'X(25)') + 'Hora Aten :' + STRING(X-HORA,'X(10)')
            ftr-Glosa3 = STRING(CcbCDocu.Glosa,"X(60)") + " " + x-Grupo-Topaz
            ftr-Glosa5 = ""
            ftr-Glosa6 = ""
            ftr-Glosa7 = ""
            ftr-Glosa8 = ""
            ...
            ftr-Glosa9 = ""
            ftr-Glosa10 = ""
            ftr-Glosa11 = SUBSTRING(X-LUGAR,1,45)
            ftr-Glosa12 = STRING(SUBSTRING(X-LUGAR,46), 'x(50)')
            ftr-Glosa13 = ""
            ftr-Glosa14 = ""
            ftr-Glosa15 = ""
            ftr-Glosa16 = ""
    ...
    WHEN TRUE <> (X-TRANS > '') AND X-LUGAR > '' THEN DO:
        ASSIGN
            ftr-Glosa1 = STRING(X-LUGAR,'X(50)')
            ftr-Glosa2 = STRING(X-CONTC,'X(25)') + 'Hora Aten :' + STRING(X-HORA,'X(10)')
            ftr-Glosa3 = STRING(CcbCDocu.Glosa,"X(60)") + " " + x-Grupo-Topaz
            .
    END.
...
CASE pOrigen:
    WHEN "G/R" THEN DO:
        ...
        RUN GR_Formato_Items IN hProc (INPUT INTEGER(SUBSTRING(Ccbcdocu.nrodoc,1,3)),
                                       OUTPUT x-Formato,
                                       OUTPUT pItemsGuias).
        DELETE PROCEDURE hProc.
