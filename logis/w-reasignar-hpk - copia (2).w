...
&Scoped-define INTERNAL-TABLES tt-rut-pers-turno rut-pers-turno VtaCDocu
...
VtaCDocu.HorSac fNombreOrigen(VtaCDocu.UsrSac, 1) @ x-Nombre ~
...
&Scoped-define QUERY-STRING-BROWSE-PHK FOR EACH VtaCDocu ~
 ...
 AND ( TRUE <> (FILL-IN-NroPed > '') OR VtaCDocu.NroPed = FILL-IN-NroPed) NO-LOCK
...
DEFINE FRAME F-Main
     FILL-IN-NroPed AT ROW 1.27 COL 11 COLON-ALIGNED WIDGET-ID 12
     BUTTON-Refrescar AT ROW 1.27 COL 36 WIDGET-ID 8
...
/* Query rebuild information for BROWSE BROWSE-PHK
 ...
 AND VtaCDocu.FlgSit = ""TI""
 AND VtaCDocu.CodPed = ""HPK""
 AND ( TRUE <> (FILL-IN-NroPed > '') OR VtaCDocu.NroPed = FILL-IN-NroPed)"
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-NroPed BUTTON-Refrescar BUTTON-15 BROWSE-PHK BROWSE-PERSONAL 
      WITH FRAME F-Main IN WINDOW W-Win.
