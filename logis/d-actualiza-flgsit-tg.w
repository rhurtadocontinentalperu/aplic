...
FacCPedi.CodCli FacCPedi.NomCli FacCPedi.FchPed FacCPedi.FchEnt 
...
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH FacCPedi ~
 ...
 AND FacCPedi.FchPed >= (TODAY - 2) NO-LOCK INDEXED-REPOSITION
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      FacCPedi.FchEnt FORMAT "99/99/9999":U WIDTH 11.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 107 BY 13.73
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 15 COL 1
     Btn_Cancel AT ROW 15 COL 17
     SPACE(81.42) SKIP(0.00)
...
"FchEnt" ? ? "date" ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
