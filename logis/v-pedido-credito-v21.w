...
/* Anticipos */
DEFINE VAR x-es-anticipo-campana AS LOG INIT NO.
...
FacCPedi.Libre_c03 FacCPedi.CodAlm FacCPedi.NroRef FacCPedi.CodOrigen ~
FacCPedi.NroOrigen FacCPedi.ordcmp FacCPedi.Sede FacCPedi.Embalaje_Especial ~
FacCPedi.CodPos FacCPedi.TipVta FacCPedi.Glosa FacCPedi.Cliente_Recoge 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define ENABLED-OBJECTS RECT-66 RECT-67 RECT-68 
...
FacCPedi.CodAlm FacCPedi.NroRef FacCPedi.CodOrigen FacCPedi.NroOrigen ~
FacCPedi.DT FacCPedi.AlmacenDT FacCPedi.ordcmp FacCPedi.Sede ~
FacCPedi.Embalaje_Especial FacCPedi.CodPos FacCPedi.TipVta FacCPedi.Glosa ~
FacCPedi.Cliente_Recoge 
&Scoped-define DISPLAYED-TABLES FacCPedi
&Scoped-define FIRST-DISPLAYED-TABLE FacCPedi
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN-Lista F-CndVta ~
FILL-IN-mensaje-AC f-NomAlm FILL-IN-AlmacenDT FILL-IN-sede FILL-IN-CodPos 
...
DEFINE VARIABLE FILL-IN-mensaje-AC AS CHARACTER FORMAT "X(80)":U 
     VIEW-AS FILL-IN 
     SIZE 34 BY .81
...
"BOL", "BOL":U
     ...
     FacCPedi.FlgIgv AT ROW 4.5 COL 55.43 WIDGET-ID 108
          ...
          VIEW-AS TOGGLE-BOX
          SIZE 11.29 BY .77
     FILL-IN-mensaje-AC AT ROW 5.27 COL 53.29 COLON-ALIGNED NO-LABEL WIDGET-ID 172
...
"Dolares", 2
     ...
     FacCPedi.Libre_c03 AT ROW 5.31 COL 12 COLON-ALIGNED WIDGET-ID 130
          ...
          SIZE 16 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.TpoLic AT ROW 5.31 COL 35.57 WIDGET-ID 118
...
DEFINE FRAME F-Main
     ...
     FacCPedi.NroRef AT ROW 6.12 COL 96 COLON-ALIGNED WIDGET-ID 10
          ...
          SIZE 11 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.CodOrigen AT ROW 6.12 COL 107 COLON-ALIGNED NO-LABEL WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.NroOrigen AT ROW 6.12 COL 112 COLON-ALIGNED NO-LABEL WIDGET-ID 146
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 14 FGCOLOR 0 
     ...
     FacCPedi.Embalaje_Especial AT ROW 8.27 COL 101 WIDGET-ID 174
          VIEW-AS TOGGLE-BOX
          SIZE 22 BY .77
     ...
     FacCPedi.TipVta AT ROW 9.08 COL 111 NO-LABEL WIDGET-ID 134
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "No", "",
"Si", "Si":U
     ...
     FacCPedi.Glosa AT ROW 9.88 COL 9.28 FORMAT "X(256)"
          ...
          SIZE 74 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FacCPedi.Cliente_Recoge AT ROW 9.88 COL 111 NO-LABEL WIDGET-ID 164
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Sí", yes,
"No", no
     ...
     "Cliente Recoge?" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 10.15 COL 96 WIDGET-ID 168
          BGCOLOR 13 FGCOLOR 15 FONT 6
     "Moneda:" VIEW-AS TEXT
     ...
     "Trámite Documentario?" VIEW-AS TEXT
          SIZE 20 BY .5 AT ROW 9.35 COL 91 WIDGET-ID 138
          BGCOLOR 10 FGCOLOR 0 FONT 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
...
DEFINE FRAME F-Main
     ...
     RECT-68 AT ROW 8 COL 90 WIDGET-ID 170
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
/* SETTINGS FOR FILL-IN FILL-IN-Lista IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-mensaje-AC IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      FacCPedi.Lista_de_Precios = COTIZACION.Libre_c01.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  IF x-es-anticipo-campana = YES THEN DO:
  ...
  IF x-es-anticipo-campana = YES THEN DO:
      MESSAGE "EL PEDIDO CONSUMIO EL/LOS ANTICIPO(S) DE CAMPAÑA DEL CLIENTE"
...
DEFINE VAR x-anticipos-disponible-mn AS DEC.
DEFINE VAR x-anticipos-disponible-me AS DEC.
DEFINE VAR x-anticipos-disponible AS DEC.

x-es-anticipo-campana = NO.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    /* Sumar el los importes del detalle del Pedido */
    ...
    /* Ic - 27Nov2019, validar con los anticipos de campaña (A/C) */
    
    FIND gn-convt WHERE gn-ConVt.Codig = Faccpedi.FmaPgo:SCREEN-VALUE NO-LOCK NO-ERROR.
    IF AVAILABLE gn-convt AND gn-ConVt.Libre_l03 = YES THEN DO:

        x-codmon = Faccpedi.codmon:SCREEN-VALUE.
        x-es-anticipo-campana = YES.

        RUN vtagn\ventas-library PERSISTENT SET hProc.

        RUN PED_saldo_anticipos_campana IN hProc (INPUT faccpedi.codcli:SCREEN-VALUE, 
                            OUTPUT x-anticipos-disponible-mn,OUTPUT x-anticipos-disponible-me).

        DELETE PROCEDURE hProc.

        IF x-codmon = '2' THEN DO:
            x-anticipos-disponible = x-anticipos-disponible-me.
        END.
        ELSE DO:
            x-anticipos-disponible = x-anticipos-disponible-mn.
        END.

        IF x-anticipos-disponible < f-importe THEN DO:
            MESSAGE 'El monto de los anticipos disponibles no cubre el total del pedido' SKIP
                    'El pedido obligatoriamente requiere aprobacion del area de creditos'
                VIEW-AS ALERT-BOX ERROR.
            /* RETURN "ADM-ERROR".*/
        END.
    END.
    ...
    ***************************************************************************** */
    ...
    IF x-es-anticipo-campana = YES THEN RETURN 'OK'.
