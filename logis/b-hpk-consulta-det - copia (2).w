...
FOR EACH Di-RutaD OF B-RutaC NO-LOCK,
    EACH B-Vtacdocu NO-LOCK WHERE B-Vtacdocu.codcia = B-RutaC.codcia 
    AND B-Vtacdocu.coddiv = B-RutaC.coddiv
    AND B-Vtacdocu.codped = "HPK"
    AND B-Vtacdocu.codref = Di-RutaD.codref
    AND B-Vtacdocu.nroref = Di-RutaD.nroref:
    IF B-Vtacdocu.flgest = "A" THEN NEXT.
    IF B-Vtacdocu.flgsit = "C" THEN NEXT.
...
/*     AND B-Vtacdocu.FlgSit <> "C":                                    */
    ...
    ASSIGN
        ...
        T-Vtacdocu.Bultos = x-Bultos.
    ASSIGN
        T-Vtacdocu.codori = B-RutaC.CodDoc
        T-Vtacdocu.nroori = B-RutaC.NroDoc.
END.
