...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    END.
    RUN Genera-Pedido (INPUT 'CREATE', OUTPUT pMensaje).    /* Detalle del pedido */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    /* ********************************************************************************************** */
    RUN Genera-Pedido (INPUT 'UPDATE', OUTPUT pMensaje).    /* Detalle del pedido */
    IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
        IF TRUE <> (pMensaje > '') THEN pMensaje = 'NO se pudo generar el pedido' + CHR(10) + 'NO hay stock suficiente en los almacenes'.
        UNDO, RETURN 'ADM-ERROR'.
    END.
...
/*                     'Comunicarse con Créditos y Cobranzas'                                        */
/*                     VIEW-AS ALERT-BOX INFORMATION                                                 */
