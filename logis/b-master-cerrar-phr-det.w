...
"T-RUTAD.Estado @ x-Estado" "Situación" "x(20)" ? ? ? ? ? ? ? no ? no no "16.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-RUTAD.Libre_d02" "M3" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
