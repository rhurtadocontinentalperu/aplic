...
DEFINE FRAME D-Dialog
     Btn_Cancel AT ROW 2.08 COL 114
     SPACE(2.42) SKIP(12.41)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_q-hpk-unico ( 3.96 , 115.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-impresion-hpk-det. */
       RUN add-link IN adm-broker-hdl ( h_q-hpk-unico , 'Record':U , h_b-impresion-hpk-det ).
