...
AlmDDocu.Libre_d01 AlmDDocu.Libre_d03 AlmDDocu.Libre_c01 AlmDDocu.Libre_c02 ~
AlmDDocu.CodDoc AlmDDocu.NroDoc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AlmDDocu.Libre_d01 COLUMN-LABEL "Cantidad!Pickeada" FORMAT ">>>,>>9.99":U
...
"AlmDDocu.Codigo" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[3]   > INTEGRAL.AlmDDocu.Libre_d01
"AlmDDocu.Libre_d01" "Cantidad!Pickeada" ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.AlmDDocu.Libre_d03
"AlmDDocu.Libre_d03" "Cantidad!Pedida" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.AlmDDocu.Libre_c01
"AlmDDocu.Libre_c01" "Unidad" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.AlmDDocu.Libre_c02
"AlmDDocu.Libre_c02" "Zona" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = INTEGRAL.AlmDDocu.CodDoc
     _FldNameList[8]   > INTEGRAL.AlmDDocu.NroDoc
