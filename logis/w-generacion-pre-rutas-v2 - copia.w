...
&Scoped-Define ENABLED-OBJECTS RECT-11 RECT-12 FILL-IN-desde FILL-IN-hasta ~
BUTTON-3 FILL-IN-entrega-desde FILL-IN-entrega-hasta 
...
DEFINE FRAME F-Main
     FILL-IN-desde AT ROW 2.19 COL 8.14 COLON-ALIGNED WIDGET-ID 14
     FILL-IN-hasta AT ROW 2.19 COL 31 COLON-ALIGNED WIDGET-ID 16
     COMBO-BOX-corte AT ROW 2.23 COL 58.86 COLON-ALIGNED WIDGET-ID 8
     BUTTON-3 AT ROW 4.04 COL 49 WIDGET-ID 12 NO-TAB-STOP 
     FILL-IN-entrega-desde AT ROW 4.23 COL 8 COLON-ALIGNED WIDGET-ID 22
     FILL-IN-entrega-hasta AT ROW 4.23 COL 30.86 COLON-ALIGNED WIDGET-ID 24
     " Fecha de emision de las Ordenes" VIEW-AS TEXT
          SIZE 33.14 BY .62 AT ROW 1.54 COL 3.86 WIDGET-ID 20
          FGCOLOR 9 FONT 0
     " Fecha de ENTREGA de las Ordenes" VIEW-AS TEXT
          SIZE 33.14 BY .62 AT ROW 3.54 COL 3.86 WIDGET-ID 28
          FGCOLOR 4 FONT 0
     RECT-11 AT ROW 1.88 COL 2 WIDGET-ID 18
     RECT-12 AT ROW 3.88 COL 2 WIDGET-ID 26
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* SETTINGS FOR COMBO-BOX COMBO-BOX-corte IN FRAME F-Main
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       COMBO-BOX-corte:HIDDEN IN FRAME F-Main           = TRUE.
...
DO:
  ASSIGN 
      fill-in-desde fill-in-hasta combo-box-corte
      FILL-IN-entrega-desde fill-in-entrega-hasta.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-desde FILL-IN-hasta FILL-IN-entrega-desde 
          FILL-IN-entrega-hasta 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-11 RECT-12 FILL-IN-desde FILL-IN-hasta BUTTON-3 
         FILL-IN-entrega-desde FILL-IN-entrega-hasta 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH Faccpedi NO-LOCK WHERE Faccpedi.codcia = s-codcia AND
    ...
    /*LOOKUP(Faccpedi.FlgEst, 'P,C') > 0 AND          /* PENDIENTES o CERRADOS */*/
    Faccpedi.FlgEst = 'P' AND          /* PENDIENTES o CERRADOS */
    (FacCPedi.FlgSit = "T" OR FacCPedi.FlgSit = "TG" /*OR FacCPedi.FlgSit = "C"*/) AND
    (Faccpedi.fchped >= fill-in-desde AND Faccpedi.fchped <= fill-in-hasta):
    CASE TRUE:
