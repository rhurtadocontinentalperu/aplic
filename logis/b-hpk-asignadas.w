...
VtaCDocu.FecSac VtaCDocu.HorSac VtaCDocu.UsrSac fNombreOrigen(1) @ x-Nombre ~
fNombreOrigen(2) @ x-Origen 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fNombreOrigen B-table-Win 
FUNCTION fNombreOrigen RETURNS CHARACTER
  ( INPUT pDato AS INT )  FORWARD.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.FecSac FORMAT "99/99/99":U
      VtaCDocu.HorSac FORMAT "x(8)":U
      VtaCDocu.UsrSac FORMAT "x(8)":U
      fNombreOrigen(1) @ x-Nombre COLUMN-LABEL "Nombre" FORMAT "x(30)":U
      fNombreOrigen(2) @ x-Origen COLUMN-LABEL "Origen" FORMAT "x(10)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
 ...
 AND VtaCDocu.FlgSit = ""P"""
     ...
     _FldNameList[3]   = INTEGRAL.VtaCDocu.FecSac
     _FldNameList[4]   = INTEGRAL.VtaCDocu.HorSac
     _FldNameList[5]   = INTEGRAL.VtaCDocu.UsrSac
     _FldNameList[6]   > "_<CALC>"
"fNombreOrigen(1) @ x-Nombre" "Nombre" "x(30)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"fNombreOrigen(2) @ x-Origen" "Origen" "x(10)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fNombreOrigen B-table-Win 
FUNCTION fNombreOrigen RETURNS CHARACTER
  ( INPUT pDato AS INT ) :
/*------------------------------------------------------------------------------
  Purpose:  
