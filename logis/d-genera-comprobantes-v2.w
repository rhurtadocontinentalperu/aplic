...
DEFINE FRAME bgDialog
     ...
     COMBO-BOX-Guias AT ROW 4.23 COL 64 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     COMBO-NroSer-Guia AT ROW 4.23 COL 10 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-NroPed AT ROW 1.54 COL 10 COLON-ALIGNED WIDGET-ID 20
     FILL-IN-Cliente AT ROW 1.54 COL 27 COLON-ALIGNED WIDGET-ID 22
     FILL-IN-DirClie AT ROW 2.35 COL 27 COLON-ALIGNED WIDGET-ID 24
     COMBO-NroSer AT ROW 3.42 COL 4.43 WIDGET-ID 2
     FILL-IN-NroDoc AT ROW 3.42 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     FILL-IN-items AT ROW 3.42 COL 42 COLON-ALIGNED WIDGET-ID 18
     Btn_OK AT ROW 1.81 COL 82
     Btn_Cancel AT ROW 3.42 COL 82
     FILL-IN-Glosa AT ROW 5.85 COL 10 COLON-ALIGNED WIDGET-ID 28
     FILL-IN-LugEnt AT ROW 5.04 COL 10 COLON-ALIGNED WIDGET-ID 30
     FILL-IN-NroDoc-GR AT ROW 4.23 COL 17 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     "<<=== Generamos Guía de Remisión?:" VIEW-AS TEXT
          SIZE 32 BY .77 AT ROW 4.23 COL 33 WIDGET-ID 38
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      /* *********************** */
      CASE cCodDoc:
          WHEN "FAC" THEN ASSIGN FILL-IN-items = FacCfgGn.Items_Factura COMBO-NroSer:LABEL = 'Serie FAC'.
          WHEN "BOL" THEN ASSIGN FILL-IN-items = FacCfgGn.Items_Boleta  COMBO-NroSer:LABEL = 'Serie BOL'.
          WHEN "FAI" THEN ASSIGN FILL-IN-items = FacCfgGn.Items_Boleta  COMBO-NroSer:LABEL = 'Serie FAI'.
      END CASE.
