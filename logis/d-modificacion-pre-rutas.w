...
rsm-w-report-1.Campo-C[11] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-11 rsm-w-report-1.Campo-C[11] 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-11 rsm-w-report-1
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-11 rsm-w-report-1
...
dtl-w-report-1.Campo-C[2] dtl-w-report-1.Campo-C[20] ~
dtl-w-report-1.Campo-D[1] dtl-w-report-1.Campo-F[1] ~
dtl-w-report-1.Campo-F[3] dtl-w-report-1.Campo-F[2] ~
...
Btn_Cancel BUTTON-6 BROWSE-14 BROWSE-16 BUTTON-4 BUTTON-5 BUTTON-7 ~
BUTTON-Eliminar 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-11 D-Dialog _STRUCTURED
  QUERY BROWSE-11 NO-LOCK DISPLAY
      ...
      rsm-w-report-1.Campo-C[10] COLUMN-LABEL "Cuadrante" FORMAT "X(8)":U
            WIDTH 8.29
      rsm-w-report-1.Campo-C[11] COLUMN-LABEL "Glosa" FORMAT "X(40)":U
            WIDTH 21.29
  ENABLE
      rsm-w-report-1.Campo-C[11]
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 72.86 BY 7.35
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-12 D-Dialog _STRUCTURED
  QUERY BROWSE-12 NO-LOCK DISPLAY
      ...
      rsm-w-report-2.Campo-C[10] COLUMN-LABEL "Cuadrante" FORMAT "X(8)":U
            WIDTH 8.72
      rsm-w-report-2.Campo-C[11] COLUMN-LABEL "Glosa" FORMAT "X(40)":U
            WIDTH 18.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 73 BY 7.35
         FONT 4 ROW-HEIGHT-CHARS .5 FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-14 D-Dialog _STRUCTURED
  QUERY BROWSE-14 NO-LOCK DISPLAY
      dtl-w-report-1.Campo-C[1] COLUMN-LABEL "Distrito" FORMAT "X(40)":U
            WIDTH 16.43
      dtl-w-report-1.Campo-C[2] COLUMN-LABEL "Orden" FORMAT "X(15)":U
            WIDTH 13.43
...
DEFINE FRAME D-Dialog
     BROWSE-11 AT ROW 1.27 COL 2 WIDGET-ID 200
     BROWSE-12 AT ROW 1.27 COL 114 WIDGET-ID 300
     Btn_OK AT ROW 2.35 COL 81
     Btn_Cancel AT ROW 3.69 COL 81
     BUTTON-6 AT ROW 5.04 COL 81 WIDGET-ID 14
     BROWSE-14 AT ROW 8.81 COL 2 WIDGET-ID 400
     BROWSE-16 AT ROW 9.08 COL 109 WIDGET-ID 500
     BUTTON-4 AT ROW 13.65 COL 87 WIDGET-ID 4
     BUTTON-5 AT ROW 16.85 COL 87 WIDGET-ID 8
     BUTTON-7 AT ROW 19.31 COL 83 WIDGET-ID 22
     BUTTON-Eliminar AT ROW 24.69 COL 5 WIDGET-ID 20
     "   Unir Ruta" VIEW-AS TEXT
          SIZE 13.29 BY .85 AT ROW 12.85 COL 87 WIDGET-ID 6
          BGCOLOR 2 FGCOLOR 15 FONT 11
     "  Pasar Orden" VIEW-AS TEXT
          SIZE 13.29 BY .85 AT ROW 16.04 COL 87 WIDGET-ID 10
          BGCOLOR 9 FGCOLOR 15 FONT 11
     IMAGE-1 AT ROW 5.04 COL 76 WIDGET-ID 16
     IMAGE-2 AT ROW 5.04 COL 109 WIDGET-ID 18
     SPACE(73.99) SKIP(20.29)
...
"rsm-w-report-1.Campo-C[1]" "Pre-Ruta" "X(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.rsm-w-report-1.Campo-F[1]
"rsm-w-report-1.Campo-F[1]" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.rsm-w-report-1.Campo-F[2]
"rsm-w-report-1.Campo-F[2]" "Volumen" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.rsm-w-report-1.Campo-F[3]
"rsm-w-report-1.Campo-F[3]" "Importe" ">>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "13.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.rsm-w-report-1.Campo-C[10]
"rsm-w-report-1.Campo-C[10]" "Cuadrante" ? "character" ? ? ? ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.rsm-w-report-1.Campo-C[11]
"rsm-w-report-1.Campo-C[11]" "Glosa" "X(40)" "character" ? ? ? ? ? ? yes ? no no "21.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-11 */
&ANALYZE-RESUME
...
"rsm-w-report-2.Campo-C[1]" "Pre-Ruta" "X(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.rsm-w-report-2.Campo-F[1]
"rsm-w-report-2.Campo-F[1]" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "9.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.rsm-w-report-2.Campo-F[2]
"rsm-w-report-2.Campo-F[2]" "Volumen" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.rsm-w-report-2.Campo-F[3]
"rsm-w-report-2.Campo-F[3]" "Importe" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "13.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.rsm-w-report-2.Campo-C[10]
"rsm-w-report-2.Campo-C[10]" "Cuadrante" ? "character" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.rsm-w-report-2.Campo-C[11]
"rsm-w-report-2.Campo-C[11]" "Glosa" "X(40)" "character" ? ? ? ? ? ? no ? no no "18.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-12 */
&ANALYZE-RESUME
...
"dtl-w-report-1.Campo-C[1]" "Distrito" "X(40)" "character" ? ? ? ? ? ? no ? no no "16.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.dtl-w-report-1.Campo-C[2]
"dtl-w-report-1.Campo-C[2]" "Orden" "X(15)" "character" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.dtl-w-report-1.Campo-C[20]
"dtl-w-report-1.Campo-C[20]" "Nombre Cliente" "X(50)" "character" ? ? ? ? ? ? no ? no no "28.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.dtl-w-report-1.Campo-D[1]
"dtl-w-report-1.Campo-D[1]" "F.Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.dtl-w-report-1.Campo-F[1]
"dtl-w-report-1.Campo-F[1]" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.dtl-w-report-1.Campo-F[3]
"dtl-w-report-1.Campo-F[3]" "Importe" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "14.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.dtl-w-report-1.Campo-F[2]
"dtl-w-report-1.Campo-F[2]" "Volumen" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*Temp-Tables.dtl-w-report-1.Campo-C[10] = Temp-Tables.rsm-w-report-2.Campo-C[10]*/"
     _FldNameList[1]   > Temp-Tables.dtl-w-report-1.Campo-C[1]
"dtl-w-report-1.Campo-C[1]" "Distrito" "X(40)" "character" ? ? ? ? ? ? no ? no no "17.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.dtl-w-report-1.Campo-C[2]
"dtl-w-report-1.Campo-C[2]" "Orden" "X(15)" "character" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.dtl-w-report-1.Campo-C[20]
"dtl-w-report-1.Campo-C[20]" "Nombre Cliente" "X(50)" "character" ? ? ? ? ? ? no ? no no "28.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.dtl-w-report-1.Campo-D[1]
"dtl-w-report-1.Campo-D[1]" "F.Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.dtl-w-report-1.Campo-F[1]
"dtl-w-report-1.Campo-F[1]" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.dtl-w-report-1.Campo-F[3]
"dtl-w-report-1.Campo-F[3]" "Importe" ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.dtl-w-report-1.Campo-F[2]
"dtl-w-report-1.Campo-F[2]" "Volumen" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.dtl-w-report-1.Campo-C[21]
"dtl-w-report-1.Campo-C[21]" "Lugar de entrega" "X(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&Scoped-define SELF-NAME rsm-w-report-1.Campo-C[11]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rsm-w-report-1.Campo-C[11] BROWSE-11 _BROWSE-COLUMN D-Dialog
ON LEAVE OF rsm-w-report-1.Campo-C[11] IN BROWSE BROWSE-11 /* Glosa */
DO:
  FIND FIRST p-Di-RutaC WHERE p-Di-RutaC.NroDoc = rsm-w-report-1.Campo-C[1] EXCLUSIVE-LOCK NO-ERROR.
  IF AVAILABLE p-Di-RutaC THEN p-di-rutaC.Observ = SELF:SCREEN-VALUE.
END.
...
ON CHOOSE OF BUTTON-7 IN FRAME D-Dialog /* CONSULTAR PHR's */
DO:
  RUN logis/d-phr-consulta.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Eliminar D-Dialog
ON CHOOSE OF BUTTON-Eliminar IN FRAME D-Dialog /* Eliminar Detalle */
DO:
  RUN Eliminar.
END.
...
ASSIGN
    ...
    b-report2.campo-c[11] = rsm-w-report-1.campo-c[11].
CREATE b-report1.
...
IF AVAILABLE p-Di-RutaC THEN DO:
    ...
    BUFFER-COPY p-Di-RutaC 
        ...
        TO b-RutaC 
        ASSIGN 
        b-RutaC.NroDoc = STRING(x-New-Number, FILL('9', x-Length-Number)).
...
FOR EACH ppDetalle, FIRST ppResumen NO-LOCK WHERE ppResumen.tcuadrante = ppDetalle.tcuadrante:
    ...
    IF AVAILABLE x-faccpedi THEN DO:
        ASSIGN 
            dtl-w-report-1.campo-c[20] = x-faccpedi.nomcli
            dtl-w-report-1.campo-c[21] = x-faccpedi.dircli
            dtl-w-report-1.campo-d[1] = x-faccpedi.fchent
            .
        CASE x-faccpedi.coddoc:
            WHEN "OTR" THEN DO:
                FIND Almacen WHERE Almacen.codcia = s-codcia AND
                    Almacen.codalm = x-faccpedi.codcli
                    NO-LOCK NO-ERROR.
                IF AVAILABLE Almacen THEN dtl-w-report-1.campo-c[21] = Almacen.DirAlm.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Eliminar D-Dialog 
PROCEDURE Eliminar :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
IF NOT AVAILABLE dtl-w-report-1 THEN DO:
    ...
    RETURN "ADM-ERROR".
END.
IF BROWSE-14:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME} = 0 THEN DO:
    MESSAGE "Seleccione al menos una orden por favor" VIEW-AS ALERT-BOX WARNING.
    RETURN "ADM-ERROR".
END.
/* OJO: Valores Base */
...
MESSAGE "Esta seguro de anular los registros de la Pre-Ruta " + x-pre-ruta-1  VIEW-AS ALERT-BOX QUESTION
        BUTTONS YES-NO UPDATE rpta AS LOG.
IF rpta = NO THEN DO:
    RETURN "ADM-ERROR".
END.
...
DO k = 1 TO BROWSE-14:NUM-SELECTED-ROWS WITH FRAME {&FRAME-NAME}:
    IF BROWSE-14:FETCH-SELECTED-ROW(k) THEN DO:
        x-orden = dtl-w-report-1.campo-c[2].
        RUN Rutina-General-Delete.
    END.
END.
...
FIND FIRST rsm-w-report-2 WHERE rsm-w-report-2.campo-c[1] = x-pre-ruta-2 NO-LOCK NO-ERROR.
IF AVAILABLE rsm-w-report-2 THEN DO:
    REPOSITION BROWSE-12 TO ROWID ROWID(rsm-w-report-2) NO-ERROR.
    IF ERROR-STATUS:ERROR = NO THEN APPLY 'VALUE-CHANGED':U TO BROWSE-12.
END.

END PROCEDURE.

PROCEDURE Rutina-General-Delete:
/* ***************************** */
    ...
    IF AVAILABLE rsm-w-report-2 THEN BUFFER-COPY rsm-w-report-1 TO rsm-w-report-2.
...
------------------------------------------------------------------------------*/
  ENABLE IMAGE-1 IMAGE-2 BROWSE-11 BROWSE-12 Btn_OK Btn_Cancel BUTTON-6 
         BROWSE-14 BROWSE-16 BUTTON-4 BUTTON-5 BUTTON-7 BUTTON-Eliminar 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
/* ********************************************************************************** */
FOR EACH p-di-rutaC NO-LOCK:
    /* Por cada O/D con BONIFICACION deben estar las 2 en la misma PHR */
    FOR EACH p-di-rutaD NO-LOCK WHERE p-di-rutaD.coddoc = p-di-rutaC.coddoc AND 
        p-di-rutaD.nrodoc = p-di-rutaC.nrodoc:
        /* Determinamos si es una bonificación o no */
        /* Solo en caso de O/D */
        IF p-di-rutaD.codref = "O/D" THEN DO:
            FIND ORDENES WHERE ORDENES.codcia = s-codcia AND
                ORDENES.coddoc = p-di-rutaD.codref AND
                ORDENES.nroped = p-di-rutaD.nroref NO-LOCK.
            ...
            IF PEDIDOS.CodOrigen = "PED" AND PEDIDOS.FmaPgo = '899' THEN DO:    /* BONIFICACION */
                ...
                IF AVAILABLE ORDENES AND
                    NOT CAN-FIND(FIRST p-di-rutaD WHERE p-di-rutaD.coddoc = p-di-rutaC.coddoc AND 
                                p-di-rutaD.nrodoc = p-di-rutaC.nrodoc AND
                                p-di-rutaD.codref = ORDENES.coddoc AND
                                p-di-rutaD.nroref = ORDENES.nroped 
                                NO-LOCK) THEN DO:
                    pProcesado = "NO ha registrado la Orden Original " + ORDENES.NroPed + 
                        " para la Orden de Bonificación " + p-di-rutaD.nroref.
                ...
                IF AVAILABLE Faccpedi THEN DO:
                    ...
                    IF AVAILABLE ORDENES AND
                        NOT CAN-FIND(FIRST p-di-rutaD WHERE p-di-rutaD.coddoc = p-di-rutaC.coddoc AND 
                                    ...
                                    p-di-rutaD.nroref = ORDENES.nroped 
                                    NO-LOCK) THEN DO:
                        pProcesado = "NO ha registrado la Orden Bonificación " + ORDENES.NroPed + 
                            " para la Orden Original " + p-di-rutaD.nroref.
                        MESSAGE pProcesado VIEW-AS ALERT-BOX ERROR.
                        RETURN.
                    END.
                END.
...
/* Elimino las Vacias */
/* RHC 30/07/2019 a solicitud de M.R. */
/* FOR EACH p-di-rutaC :                                                       */
...
CORRELATIVO:
DO TRANSACTION ON ERROR UNDO CORRELATIVO, LEAVE CORRELATIVO ON STOP UNDO CORRELATIVO, LEAVE CORRELATIVO:
...
IF pProcesado = "OK" THEN DO:
    ...
    DO TRANSACTION ON ERROR UNDO GRABA_PHRUTA, LEAVE GRABA_PHRUTA :
        FOR EACH p-di-rutaC ON ERROR UNDO, THROW:
            /* Cabcera */
            CREATE di-rutaC.
            BUFFER-COPY p-di-rutaC 
                EXCEPT nrodoc 
                TO di-rutaC 
                ASSIGN 
                di-rutaC.nrodoc = p-di-rutaC.nrodoc 
                DI-RutaC.Observ = p-di-rutaC.Observ
                NO-ERROR.
            ...
            /* Detalle */
            FOR EACH p-di-rutaD WHERE p-di-rutaD.coddoc = p-di-rutaC.coddoc AND 
                    p-di-rutaD.nrodoc = p-di-rutaC.nrodoc ON ERROR UNDO, THROW:
                CREATE di-rutaD.
                BUFFER-COPY p-di-rutaD EXCEPT nrodoc TO di-rutaD 
                ...
                END.
            END.
            /* Actualizamos FlgSit de las O/D Relacionadas */
            /* ********************************************************************************* */
            /* REFLEJAMOS TRACKING DE LA OD */
            /* ********************************************************************************* */
            RUN logis/actualiza-flgsit (INPUT ROWID(Di-RutaC)).
            IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
                pProcesado = "Error al actualizar la ORDEN como Cierre de Chequeo".
                UNDO GRABA_PHRUTA, LEAVE GRABA_PHRUTA.
            END.
        END.
        pProcesado = "OK".
...
FIND FIRST dtl-w-report-1 WHERE dtl-w-report-1.llave-c = x-pre-ruta-1  NO-ERROR.
IF NOT AVAILABLE dtl-w-report-1 THEN DO:
    /**/    
    FIND FIRST rsm-w-report-2 WHERE rsm-w-report-2.campo-c[1] = x-pre-ruta-1 NO-ERROR.
    IF AVAILABLE rsm-w-report-2 THEN DO:
...
/* Refresco el browse DESTINO pero la PHR de ORIGEN */
FIND FIRST rsm-w-report-1 WHERE rsm-w-report-1.campo-c[1] = x-pre-ruta-1 NO-ERROR.
IF AVAILABLE rsm-w-report-1 THEN DO:
    
    ASSIGN  rsm-w-report-1.campo-f[1] = 0
            rsm-w-report-1.campo-f[2] = 0
            rsm-w-report-1.campo-f[3] = 0.

    FOR EACH dtl-w-report-1 WHERE dtl-w-report-1.Llave-C = x-pre-ruta-1 NO-LOCK:
        ASSIGN  rsm-w-report-1.campo-f[1] = rsm-w-report-1.campo-f[1] + dtl-w-report-1.campo-f[1]
                rsm-w-report-1.campo-f[2] = rsm-w-report-1.campo-f[2] + dtl-w-report-1.campo-f[2]
                rsm-w-report-1.campo-f[3] = rsm-w-report-1.campo-f[3] + dtl-w-report-1.campo-f[3].
    END.
    ...
    FIND FIRST rsm-w-report-2 WHERE rsm-w-report-2.campo-c[1] = x-pre-ruta-1 NO-ERROR.
    IF AVAILABLE rsm-w-report-2 THEN DO:
        ASSIGN  rsm-w-report-2.campo-f[1] = rsm-w-report-1.campo-f[1]
                rsm-w-report-2.campo-f[2] = rsm-w-report-1.campo-f[2]
                rsm-w-report-2.campo-f[3] = rsm-w-report-1.campo-f[3]
        .
    END.
...
/*
FOR EACH dtl-w-report-1
      WHERE Temp-Tables.dtl-w-report-1.Llave-C = Temp-Tables.rsm-w-report-2.Campo-C[1]
/*Temp-Tables.dtl-w-report-1.Campo-C[10] = Temp-Tables.rsm-w-report-2.Campo-C[10]*/ NO-LOCK INDEXED-REPOSITION:
*/
