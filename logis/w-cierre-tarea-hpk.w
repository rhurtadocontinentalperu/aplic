...
/*         MESSAGE "Documento NO asignado a esta división (" + s-coddiv + ")" */
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
      ...
      IF NOT AVAILABLE PikSacadores THEN DO:
          pError = 'Pickeador no esta disponible o no esta activo, código: ' + Vtacdocu.UsrSac.
          UNDO, LEAVE CICLO.
      END.
      ASSIGN
      ...
      IF NOT (Vtacdocu.flgest = 'P' AND Vtacdocu.flgsit = 'P') THEN DO:
          pError =  'ERROR en la Sub-Orden ya NO está pendiente de Cierre de Pickeo'.
          UNDO, LEAVE CICLO.
      END.
      ASSIGN 
      ...
      /* *********************************************************************************** */
      FINALLY:
        IF NOT AVAILABLE PikSacadores THEN pError = 'Pickeador no esta disponible o no esta activo, código: ' + Vtacdocu.UsrSac.
        IF LOOKUP(VtaCDocu.CodPed, 'OTR,O/D,O/M') > 0 
