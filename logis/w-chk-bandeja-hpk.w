...
FOR EACH ChkTareas NO-LOCK WHERE ChkTareas.codcia = s-codcia AND 
        ChkTareas.coddiv = s-coddiv AND 
        ChkTareas.mesa = x-mesa AND
        ChkTareas.flgest = 'P' AND 
        ChkTareas.coddoc = "HPK",
    FIRST ChkControl NO-LOCK WHERE ChkControl.codcia = s-codcia AND 
