...
COMBO-BOX-Embalaje COMBO-BOX-Mesa BUTTON-1 BtnDone 
...
DEFINE FRAME F-Main
     FILL-IN-Barra AT ROW 1.81 COL 35 COLON-ALIGNED WIDGET-ID 2
     ...
     COMBO-BOX-Prioridad AT ROW 13.92 COL 35 COLON-ALIGNED WIDGET-ID 36
     COMBO-BOX-Embalaje AT ROW 15.54 COL 35 COLON-ALIGNED WIDGET-ID 32
     COMBO-BOX-Mesa AT ROW 17.15 COL 35 COLON-ALIGNED WIDGET-ID 34
     BUTTON-2 AT ROW 19.04 COL 2 WIDGET-ID 26
     BUTTON-1 AT ROW 19.04 COL 64 WIDGET-ID 24
     BtnDone AT ROW 19.04 COL 79 WIDGET-ID 28
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 112.14 BY 20.58
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "RECEPCION DE HOJAS DE PICKING"
         HEIGHT             = 20.58
         WIDTH              = 112.14
         MAX-HEIGHT         = 20.58
         MAX-WIDTH          = 114.57
...
ON END-ERROR OF W-Win /* RECEPCION DE HOJAS DE PICKING */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* RECEPCION DE HOJAS DE PICKING */
DO:
...
/*
  DO WITH FRAME {&FRAME-NAME}:
      ...
      FOR EACH ChkMesas NO-LOCK WHERE ChkMesas.CodCia = s-CodCia AND 
          ChkMesas.CodDiv = s-CodDiv 
          BREAK BY ChkMesas.CodCia BY ChkMesas.Mesa:
          /* Ic - 31Ago2018, verificamos que la mesa tenga asignado chequeador */
          FIND FIRST ChkChequeador WHERE ChkChequeador.codcia = s-codcia AND
              ...
              /*(chkchequeador.fchasignacion >= (TODAY - 1)) AND*/
