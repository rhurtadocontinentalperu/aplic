...
fCuadrante() @ x-Cuadrante fDistrito() @ x-Distrito T-RUTAD.CodRef ~
T-RUTAD.NroRef FacCPedi.NomCli T-RUTAD.Estado @ x-Estado ~
T-RUTAD.SKU @ x-SKU T-RUTAD.Libre_c01 T-RUTAD.ImpCob T-RUTAD.Libre_d01 ~
T-RUTAD.Libre_d02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.CrossDocking COLUMN-LABEL "XD" FORMAT "SI/NO":U
            WIDTH 2
      GN-DIVI.DesDiv COLUMN-LABEL "Canal" FORMAT "X(25)":U
      fCuadrante() @ x-Cuadrante COLUMN-LABEL "Cuadr." WIDTH 4.72
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Importe AT ROW 13.04 COL 84 COLON-ALIGNED WIDGET-ID 16
     FILL-IN-Peso AT ROW 13.04 COL 103 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-Volumen AT ROW 13.04 COL 125 COLON-ALIGNED WIDGET-ID 14
...
"T-RUTAD.Libre_c01" "Bultos" "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-RUTAD.ImpCob
...
"T-RUTAD.Libre_d01" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-RUTAD.Libre_d02
"T-RUTAD.Libre_d02" "M3" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "4.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  IF AVAILABLE di-rutaC THEN DO:
      ...
      IF LOOKUP(di-rutaC.flgest,'P,PK,PC') > 0 THEN DO:
          IF AVAILABLE t-rutaD THEN DO:
              FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = s-codcia AND
                                            ...
                                            x-faccpedi.nroped = t-rutaD.nroref AND
                                            x-faccpedi.flgest = 'C' NO-LOCK NO-ERROR.
