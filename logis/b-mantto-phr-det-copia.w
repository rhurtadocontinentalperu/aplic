...
DEFINE TEMP-TABLE X-DI-RutaC NO-UNDO LIKE DI-RutaC.
...
&Scoped-define FIELDS-IN-QUERY-br_table FacCPedi.Cliente_Recoge ~
fDistrito() @ x-Distrito T-RUTAD.CodRef T-RUTAD.NroRef FacCPedi.FchPed ~
FacCPedi.Hora FacCPedi.FchEnt FacCPedi.NomCli T-RUTAD.Estado @ x-Estado ~
T-RUTAD.SKU @ x-SKU T-RUTAD.Libre_c01 T-RUTAD.Libre_d02 T-RUTAD.Libre_d01 ~
T-RUTAD.ImpCob FacCPedi.Glosa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table T-RUTAD.Libre_d01 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      fDistrito() @ x-Distrito COLUMN-LABEL "Distrito" FORMAT "x(25)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 150 BY 11.54
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Importe AT ROW 12.85 COL 84 COLON-ALIGNED WIDGET-ID 16
     FILL-IN-Peso AT ROW 12.85 COL 103 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-Volumen AT ROW 12.85 COL 125 COLON-ALIGNED WIDGET-ID 14
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      ADDITIONAL-FIELDS:
          ...
          FIELD Reprogramado AS LOG INITIAL NO
      END-FIELDS.
      TABLE: X-DI-RutaC T "?" NO-UNDO INTEGRAL DI-RutaC
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br_table
  ...
  AND INTEGRAL.DI-RutaD.NroDoc = Temp-Tables.T-RUTAD.NroDoc"
     _FldNameList[1]   > INTEGRAL.FacCPedi.Cliente_Recoge
"INTEGRAL.FacCPedi.Cliente_Recoge" "Cliente!Recoge" "SI/NO" "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"fDistrito() @ x-Distrito" "Distrito" "x(25)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-RUTAD.CodRef
"Temp-Tables.T-RUTAD.CodRef" ? ? "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "DROP-DOWN-LIST" "," "O/D,OTR,O/M" ? 5 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-RUTAD.NroRef
"Temp-Tables.T-RUTAD.NroRef" ? ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.FacCPedi.FchPed
"INTEGRAL.FacCPedi.FchPed" "Fecha de!Pedido" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacCPedi.Hora
"INTEGRAL.FacCPedi.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacCPedi.FchEnt
"INTEGRAL.FacCPedi.FchEnt" "Fecha de!Entrega" ? "date" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.FacCPedi.NomCli
"INTEGRAL.FacCPedi.NomCli" "Cliente" "x(30)" "character" ? ? ? ? ? ? no ? no no "28.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-RUTAD.SKU @ x-SKU" "SKU" ">>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-RUTAD.Libre_c01
"Temp-Tables.T-RUTAD.Libre_c01" "Bultos" "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-RUTAD.Libre_d02
"Temp-Tables.T-RUTAD.Libre_d02" "Importe" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-RUTAD.Libre_d01
"Temp-Tables.T-RUTAD.Libre_d01" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.T-RUTAD.ImpCob
"Temp-Tables.T-RUTAD.ImpCob" "M3" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > INTEGRAL.FacCPedi.Glosa
"INTEGRAL.FacCPedi.Glosa" "Glosa O/D" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*   IF AVAILABLE di-rutaC THEN DO:                                                                   */
/*       /* Consistencia */                                                                           */
/*       IF NOT ( (Faccpedi.FlgEst = 'P' AND Faccpedi.FlgSit = 'TG') OR                               */
/*                (Faccpedi.FlgEst = 'C' AND Faccpedi.FlgSit = 'C') )                                 */
/*           THEN DO:                                                                                 */
/*           MESSAGE 'Habilitado solo para Ordenes con HPK o DOCUMENTADAS' VIEW-AS ALERT-BOX WARNING. */
/*           RETURN NO-APPLY.                                                                         */
/*       END.                                                                                         */
/*       /* Chequeo completo, con HPK y Picking completo */                                           */
/*       IF AVAILABLE t-rutaD THEN DO:                                                                */
...
DO:
    ...
    CREATE BUFFER hBuffer FOR TABLE "di-rutaC":U BUFFER-NAME "di-rutaC":U.

    x-sql = "FOR EACH T-RUTAD NO-LOCK OF di-rutac, FIRST FacCPedi WHERE FacCPedi.CodCia = T-RUTAD.CodCia AND FacCPedi.CodDoc = T-RUTAD.CodRef " +
...
/*
x-sql = "EACH Temp-Tables.T-RUTAD OF INTEGRAL.DI-RutaC WHERE " + "~{&" + "KEY-PHRASE" + "} NO-LOCK, " +
      "FIRST INTEGRAL.FacCPedi WHERE INTEGRAL.FacCPedi.CodCia = Temp-Tables.T-RUTAD.CodCia " +
  "AND INTEGRAL.FacCPedi.CodDoc = Temp-Tables.T-RUTAD.CodRef " +
  "AND INTEGRAL.FacCPedi.NroPed = Temp-Tables.T-RUTAD.NroRef NO-LOCK, " + 
      "FIRST INTEGRAL.GN-DIVI OF INTEGRAL.FacCPedi NO-LOCK, " +
      "FIRST INTEGRAL.DI-RutaD WHERE INTEGRAL.DI-RutaD.CodCia = Temp-Tables.T-RUTAD.CodCia " +
  "AND INTEGRAL.DI-RutaD.CodDiv = Temp-Tables.T-RUTAD.CodDiv " + 
  "AND INTEGRAL.DI-RutaD.CodDoc = Temp-Tables.T-RUTAD.CodDoc " + 
  "AND INTEGRAL.DI-RutaD.CodRef = Temp-Tables.T-RUTAD.CodRef " +
  "AND INTEGRAL.DI-RutaD.NroRef = Temp-Tables.T-RUTAD.NroRef " +
  "AND INTEGRAL.DI-RutaD.NroDoc = Temp-Tables.T-RUTAD.NroDoc NO-LOCK " +
    "~{&" + "SORTBY-PHRASE" + "}"
*/
...
ASSIGN T-RutaD.libre_d01:READ-ONLY IN BROWSE br_table = TRUE.
