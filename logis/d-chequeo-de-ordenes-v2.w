...
&Scoped-define QUERY-STRING-BROWSE-12 FOR EACH tt-articulos-pickeados NO-LOCK ~
    BY tt-articulos-pickeados.Campo-I[1]
...
"Campo-I[1]" "No" ">,>>9" "integer" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-articulos-pickeados.Campo-C[1]
"Campo-C[1]" "Codigo" "X(6)" "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-articulos-pickeados.Campo-C[2]
"Campo-C[2]" "Descripcion" "X(50)" "character" ? ? ? ? ? ? no ? no no "37.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-articulos-pickeados.Campo-C[3]
"Campo-C[3]" "Marca" "X(20)" "character" ? ? ? ? ? ? no ? no no "26.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-articulos-pickeados.Campo-C[4]
"Campo-C[4]" "Unidad" "X(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-articulos-pickeados.Campo-F[1]
"Campo-F[1]" "Cantidad" ">>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-articulos-pickeados.Campo-F[2]
"Campo-F[2]" "Factor" ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tt-articulos-pickeados.Campo-F[3]
"Campo-F[3]" "Calculado" ">>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.tt-articulos-pickeados.Campo-C[5]
"Campo-C[5]" "Nro. Bulto" "X(25)" "character" ? ? ? ? ? ? no ? no no "25.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-12 */
&ANALYZE-RESUME
