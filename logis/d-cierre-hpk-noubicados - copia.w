...
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH VtaDDocu ~
  ...
  AND Almmmate.codmat = VtaDDocu.CodMat OUTER-JOIN NO-LOCK, ~
    ...
    BY Almmmatg.DesMat INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH VtaDDocu ~
      WHERE {&Condicion} NO-LOCK, ~
      FIRST Almmmatg OF VtaDDocu NO-LOCK, ~
      FIRST Almmmate WHERE Almmmate.CodCia = VtaDDocu.CodCia ~
  AND Almmmate.CodAlm = VtaDDocu.AlmDes ~
  AND Almmmate.codmat = VtaDDocu.CodMat OUTER-JOIN NO-LOCK, ~
      FIRST almtubic OF Almmmate OUTER-JOIN NO-LOCK ~
    BY Almmmatg.DesMat INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 VtaDDocu Almmmatg Almmmate almtubic
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 VtaDDocu
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-2 Almmmatg
&Scoped-define THIRD-TABLE-IN-QUERY-BROWSE-2 Almmmate
&Scoped-define FOURTH-TABLE-IN-QUERY-BROWSE-2 almtubic
...
/* Query rebuild information for BROWSE BROWSE-2
     _TblList          = "INTEGRAL.VtaDDocu,INTEGRAL.Almmmatg OF INTEGRAL.VtaDDocu,INTEGRAL.Almmmate WHERE INTEGRAL.VtaDDocu ...,INTEGRAL.almtubic OF INTEGRAL.Almmmate"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST USED, FIRST OUTER USED, FIRST OUTER USED"
     _OrdList          = "INTEGRAL.Almmmatg.DesMat|yes"
     _Where[1]         = "{&Condicion}"
     _JoinCode[3]      = "INTEGRAL.Almmmate.CodCia = VtaDDocu.CodCia
  AND INTEGRAL.Almmmate.CodAlm = VtaDDocu.AlmDes
  AND INTEGRAL.Almmmate.codmat = VtaDDocu.CodMat"
