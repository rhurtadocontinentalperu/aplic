...
/*     MESSAGE "Opcion solo de CONSULTA, guia de remision electronica esta ACTIVA" */
...
&Scoped-Define ENABLED-OBJECTS RECT-68 RECT-66 BUTTON-12 BUTTON-8 BUTTON-9 ~
BUTTON-11 BtnDone C-NroSer BUTTON-13 
...
DEFINE VARIABLE h_v-mantto-gr-aut-cred AS HANDLE NO-UNDO.
...
DO:
   RUN Asigna-datos IN h_v-mantto-gr-aut-cred.
END.
...
DO:
  RUN Imprimir-Transportista IN h_v-mantto-gr-aut-cred.
END.
...
DO:
   ...
   RUN Copiar-Guia IN h_v-mantto-gr-aut-cred (OUTPUT pParam).
...
DO:
   RUN dispatch IN h_v-mantto-gr-aut-cred ('delete-record':U).
END.
...
DO:
  RUN dispatch IN h_v-mantto-gr-aut-cred ('imprime':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-mantto-gr-aut-cred ).
       RUN set-position IN h_v-mantto-gr-aut-cred ( 2.62 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-guias-manuales ( 9.27 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-mantto-gr-aut-cred. */
       RUN add-link IN adm-broker-hdl ( h_q-guias-remision , 'Record':U , h_v-mantto-gr-aut-cred ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-mantto-gr-aut-cred ,
             h_p-navico , 'AFTER':U ).
...
/*            (FacCorre.CodMov = 02 OR FacCorre.CodMov = 00)*/:          */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-68 RECT-66 BUTTON-12 BUTTON-8 BUTTON-9 BUTTON-11 BtnDone C-NroSer 
         BUTTON-13 
      WITH FRAME F-Main IN WINDOW W-Win.
