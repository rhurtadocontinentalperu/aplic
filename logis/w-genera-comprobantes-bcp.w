...
DEFINE FRAME F-Main
     ...
     BUTTON-create-2 AT ROW 5.15 COL 109 WIDGET-ID 26
...
ON END-ERROR OF W-Win /* GENERACION DE FAIs - BCP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* GENERACION DE FAIs - BCP */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/b-genera-comprobantes-cab-bcp.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-genera-comprobantes-cab ).
       RUN set-position IN h_b-genera-comprobantes-cab ( 1.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-genera-comprobantes-cab ( 9.04 , 106.00 ) NO-ERROR.
