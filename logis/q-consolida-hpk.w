...
&Scoped-define INTERNAL-TABLES LogisConsolidaHpk Almacen

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH LogisConsolidaHpk WHERE ~{&KEY-PHRASE} ~
      AND LogisConsolidaHpk.CodCia = s-CodCia NO-LOCK, ~
      FIRST Almacen OF LogisConsolidaHpk NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH LogisConsolidaHpk WHERE ~{&KEY-PHRASE} ~
      AND LogisConsolidaHpk.CodCia = s-CodCia NO-LOCK, ~
      FIRST Almacen OF LogisConsolidaHpk NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main LogisConsolidaHpk Almacen
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main LogisConsolidaHpk
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.LogisConsolidaHpk,INTEGRAL.Almacen OF INTEGRAL.LogisConsolidaHpk"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _Where[1]         = "LogisConsolidaHpk.CodCia = s-CodCia"
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
      RUN lkup/c-consolida-hpk ('Casos para Consolidar HPK').
