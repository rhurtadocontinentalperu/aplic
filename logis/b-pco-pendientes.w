...
DEF VAR s-coddoc AS CHAR INIT 'PCO' NO-UNDO.
...
FacCPedi.NomCli FacCPedi.FmaPgo gn-ConVt.Nombr 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.FmaPgo COLUMN-LABEL "Condicion de!Venta" FORMAT "X(8)":U
            WIDTH 9
      gn-ConVt.Nombr FORMAT "X(50)":U WIDTH 29.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 147 BY 19.65
...
"gn-ConVt.Nombr" ? ? "character" ? ? ? ? ? ? no ? no no "29.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*     pCodDoc = ''                                                                       */
/*     pNroPed = ''.                                                                      */
/* IF AVAILABLE Faccpedi THEN ASSIGN pCodDoc = Faccpedi.coddoc pNroPed = Faccpedi.nroped. */

DEFINE VAR timeout AS INT.
DEFINE VAR timenow AS INT.

DEF BUFFER x-factabla FOR Factabla.
...
IF AVAILABLE Faccpedi THEN DO:
    ...
    */
    ...
    IF NOT AVAILABLE x-factabla THEN DO:
        MESSAGE 'Cotización' Faccpedi.nroped ' cuya lista de precio es ' x-Lista_de_Precios SKIP 
            "NO esta configurada como EVENTO" SKIP
    ...
    IF AVAILABLE x-factabla THEN DO:
        ...
        IF TimeOut > 0 THEN DO:
            ...
            END.
            ELSE DO:
                MESSAGE 'Cotización ' Faccpedi.nroped ' , ya vencio su tiempo de espera' SKIP 
                            'por favor comunicarse con el area de ventas' VIEW-AS ALERT-BOX INFORMATION.
