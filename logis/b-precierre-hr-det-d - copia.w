...
&Scoped-define INTERNAL-TABLES DI-RutaD CcbCDocu gn-clie VtaUbiDiv
...
&Scoped-define QUERY-STRING-br_table FOR EACH DI-RutaD OF DI-RutaC WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND CcbCDocu.NroDoc = DI-RutaD.NroRef NO-LOCK, ~
      ...
      FIRST VtaUbiDiv WHERE VtaUbiDiv.CodDept = gn-clie.CodDept ~
  AND VtaUbiDiv.CodProv = gn-clie.CodProv ~
  AND VtaUbiDiv.CodDist = gn-clie.CodDist ~
      AND VtaUbiDiv.CodCia = s-codcia ~
 AND VtaUbiDiv.CodDiv = s-coddiv OUTER-JOIN NO-LOCK ~
 ...
 AND VtaUbiDiv.CodDiv = s-coddiv OUTER-JOIN NO-LOCK ~
    BY VtaUbiDiv.Libre_d01 ~
       BY CcbCDocu.NomCli ~
        BY DI-RutaD.NroRef ~
         BY CcbCDocu.Libre_c02.
&Scoped-define TABLES-IN-QUERY-br_table DI-RutaD CcbCDocu gn-clie VtaUbiDiv
...
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table VtaUbiDiv
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.DI-RutaD OF INTEGRAL.DI-RutaC,INTEGRAL.CcbCDocu WHERE INTEGRAL.DI-RutaD ...,INTEGRAL.gn-clie WHERE INTEGRAL.CcbCDocu ...,INTEGRAL.VtaUbiDiv WHERE INTEGRAL.gn-clie  ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST, FIRST USED, FIRST OUTER USED"
     _OrdList          = "INTEGRAL.VtaUbiDiv.Libre_d01|yes,INTEGRAL.CcbCDocu.NomCli|yes,INTEGRAL.DI-RutaD.NroRef|yes,INTEGRAL.CcbCDocu.Libre_c02|yes"
  ...
  AND INTEGRAL.CcbCDocu.NroDoc = INTEGRAL.DI-RutaD.NroRef"
     ...
     _JoinCode[4]      = "INTEGRAL.VtaUbiDiv.CodDept = gn-clie.CodDept
  AND INTEGRAL.VtaUbiDiv.CodProv = gn-clie.CodProv
  AND INTEGRAL.VtaUbiDiv.CodDist = gn-clie.CodDist"
     _Where[4]         = "VtaUbiDiv.CodCia = s-codcia
