...
&Scoped-Define ENABLED-OBJECTS BUTTON-12 RECT-68 RECT-66 BUTTON-8 BUTTON-9 ~
...
DEFINE VARIABLE h_v-guias-remision AS HANDLE NO-UNDO.
...
DO:
   RUN Asigna-datos IN h_v-guias-remision.
END.
...
DO:
  RUN Imprimir-Transportista IN h_v-guias-remision.
END.
...
DO:
   ...
   RUN Copiar-Guia IN h_v-guias-remision (OUTPUT pParam).
...
DO:
   RUN dispatch IN h_v-guias-remision ('delete-record':U).
END.
...
DO:
  RUN dispatch IN h_v-guias-remision ('imprime':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/v-guias-remision.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-guias-remision ).
       RUN set-position IN h_v-guias-remision ( 2.62 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-guias-remision. */
       RUN add-link IN adm-broker-hdl ( h_q-guias-remision , 'Record':U , h_v-guias-remision ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-guias-remision ,
             h_p-navico , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-12 RECT-68 RECT-66 BUTTON-8 BUTTON-9 BUTTON-11 BtnDone C-NroSer 
         B-AGTRANS 
      WITH FRAME F-Main IN WINDOW W-Win.
