...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 2.88 COL 53 WIDGET-ID 2
     BUTTON-2 AT ROW 4.23 COL 53 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 99.29 BY 24.96 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_tab95 ( 23.96 , 95.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/b-hpk-con-obs-acum.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-hpk-con-obs-acum ).
       RUN set-position IN h_b-hpk-con-obs-acum ( 2.35 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-con-obs-acum ( 6.69 , 49.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/b-hpk-con-obs-det.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-hpk-con-obs-det ).
       RUN set-position IN h_b-hpk-con-obs-det ( 9.35 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-con-obs-det ( 6.69 , 67.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/b-hpk-con-obs-det-od.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-hpk-con-obs-det-od ).
       RUN set-position IN h_b-hpk-con-obs-det-od ( 16.35 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 23.08 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-hpk-con-obs-acum-2 ( 2.35 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-hpk-con-obs-det-2 ( 9.08 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-con-obs-det-2 ( 6.69 , 67.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv97-2 ).
       RUN set-position IN h_p-updv97-2 ( 15.81 , 3.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
      WHEN '1' THEN DO: 
          ...
          RUN Disable-Columns IN h_b-hpk-con-obs-det.
          RUN dispatch IN h_b-hpk-con-obs-acum ('open-query':U).
          RUN dispatch IN h_b-hpk-con-obs-det ('open-query':U).
          RUN dispatch IN h_b-hpk-con-obs-det-od ('open-query':U).
      END.
...
CASE pParam:
    WHEN "Display-Fields" THEN DO:
        RUN GET-ATTRIBUTE('CURRENT-PAGE').
        CASE RETURN-VALUE:
            WHEN '1' THEN DO:
                RUN dispatch IN h_b-hpk-con-obs-det ('display-fields':U).
            END.
            WHEN '2' THEN DO:
                RUN dispatch IN h_b-hpk-con-obs-det-2 ('display-fields':U).
            END.
        END CASE.
    END.
END CASE.
