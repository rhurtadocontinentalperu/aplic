...
"rut-pers-turno.dni" "D.N.I." "x(12)" "character" ? ? 0 ? ? ? yes ? no no "16.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"rut-pers-turno.rol" "ROL" ? "character" ? ? 0 ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," "CHEQUEADOR" ? 5 no 0 no no
     _FldNameList[5]   > INTEGRAL.rut-pers-turno.turno
"rut-pers-turno.turno" "TURNO" ? "character" ? ? 0 ? ? ? yes ? no no ? yes no no "U" "" "" "DROP-DOWN-LIST" "," "MAÑANA,TARDE,NOCHE" ? 5 no 0 no no
...
IF RETURN-VALUE = "YES" THEN DO:
    ...
    IF x-origen-picador = "ERROR" THEN DO:
