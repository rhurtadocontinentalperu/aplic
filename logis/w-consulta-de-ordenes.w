...
DEFINE FRAME F-Main
     BROWSE-5 AT ROW 6.38 COL 127 WIDGET-ID 200
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-consulta-de-ordenes ( 13.00 , 176.43 ) NO-ERROR.
       ...
       RUN set-position IN h_b-consulta-pickings ( 1.23 , 1.43 ) NO-ERROR.
       RUN set-size IN h_b-consulta-pickings ( 12.69 , 125.00 ) NO-ERROR.
