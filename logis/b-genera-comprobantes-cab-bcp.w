...
&GLOBAL-DEFINE CONDICION ( ~
    ...
    FacCPedi.CodCli = "20100047218" AND ~
...
DEFINE VARIABLE RADIO-SET-TipDoc AS CHARACTER INITIAL "FAI" 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 106 BY 8.08
         FONT 4
         TITLE "ORDENES DE DESPACHO PARA FACTURAR - SOLO BCP" FIT-LAST-COLUMN.
...
/* SETTINGS FOR RADIO-SET RADIO-SET-TipDoc IN FRAME F-Main
   NO-ENABLE                                                            */
...
ON MOUSE-SELECT-DBLCLICK OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR - SOLO BCP */
DO:
    RUN proc_GeneraGuia.
    RETURN NO-APPLY.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-ENTRY OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR - SOLO BCP */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR - SOLO BCP */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* ORDENES DE DESPACHO PARA FACTURAR - SOLO BCP */
DO:
...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN logis\d-genera-comprobantes-bcp.r ( ROWID(FacCPedi), 'A', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN logis\d-genera-comprobantes-bcp.r ( ROWID(FacCPedi), 'FA', "CREDITO", "" ).       /* AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    CASE RADIO-SET-TipDoc:
        WHEN "FAC" THEN RUN logis\d-genera-comprobantes-bcp.r ( ROWID(FacCPedi), 'M', "CREDITO", "" ).       /* AUTOMATICA */
        WHEN "FAI" THEN RUN logis\d-genera-comprobantes-bcp.r ( ROWID(FacCPedi), 'FM', "CREDITO", "" ).       /* AUTOMATICA */
    END CASE.
