...
&Scoped-Define ENABLED-OBJECTS RECT-69 RECT-70 RECT-71 
...
CcbCDocu.DirCli CcbCDocu.FmaPgo CcbCDocu.Glosa 
&Scoped-define DISPLAYED-TABLES CcbCDocu
&Scoped-define FIRST-DISPLAYED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-CndVta F-CodTran F-Nombre ~
f-SedeTran F-Direccion F-ruc F-Lugar F-Contacto F-horario F-Fecha F-Observ 
...
DEFINE FRAME F-Main
     CcbCDocu.NroDoc AT ROW 1.27 COL 17 COLON-ALIGNED FORMAT "XXX-XXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          FONT 1
     F-Estado AT ROW 1.27 COL 41 COLON-ALIGNED
     CcbCDocu.FchDoc AT ROW 1.27 COL 87 COLON-ALIGNED
          LABEL "Emisión"
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .81
     CcbCDocu.CodCli AT ROW 2.08 COL 17 COLON-ALIGNED FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.RucCli AT ROW 2.08 COL 41 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     CcbCDocu.CodAnt AT ROW 2.08 COL 62 COLON-ALIGNED WIDGET-ID 2
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     CcbCDocu.CodRef AT ROW 2.08 COL 87 COLON-ALIGNED
          LABEL "Referencia"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     CcbCDocu.NroRef AT ROW 2.08 COL 94 NO-LABEL FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 14 BY .81
     CcbCDocu.NomCli AT ROW 2.88 COL 17 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 59 BY .81
     CcbCDocu.CodPed AT ROW 2.88 COL 87 COLON-ALIGNED
          LABEL "Pedido"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     CcbCDocu.NroPed AT ROW 2.88 COL 92 COLON-ALIGNED NO-LABEL FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 14 BY .81
     CcbCDocu.DirCli AT ROW 3.69 COL 17 COLON-ALIGNED WIDGET-ID 6
          LABEL "Direccion Fiscal" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 91 BY .81
     CcbCDocu.FmaPgo AT ROW 4.5 COL 17 COLON-ALIGNED
          LABEL "Condición de Venta"
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-CndVta AT ROW 4.5 COL 23 COLON-ALIGNED NO-LABEL
     CcbCDocu.Glosa AT ROW 5.31 COL 17 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 59 BY .81
     F-CodTran AT ROW 6.92 COL 19 COLON-ALIGNED WIDGET-ID 72
     F-Nombre AT ROW 6.92 COL 31 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     f-SedeTran AT ROW 7.73 COL 19 COLON-ALIGNED WIDGET-ID 70
     F-Direccion AT ROW 7.73 COL 31 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     F-ruc AT ROW 8.54 COL 19 COLON-ALIGNED WIDGET-ID 14
     F-Lugar AT ROW 10.15 COL 19 COLON-ALIGNED WIDGET-ID 82
     F-Contacto AT ROW 10.96 COL 19 COLON-ALIGNED WIDGET-ID 78
     F-horario AT ROW 11.77 COL 19 COLON-ALIGNED WIDGET-ID 80
     F-Fecha AT ROW 11.77 COL 51 COLON-ALIGNED WIDGET-ID 34
     F-Observ AT ROW 12.58 COL 19 COLON-ALIGNED WIDGET-ID 36
     "SEGUNDO TRAMO:" VIEW-AS TEXT
          SIZE 14 BY .5 AT ROW 9.62 COL 8 WIDGET-ID 24
          BGCOLOR 9 FGCOLOR 15 
     "PRIMER TRAMO:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 6.38 COL 8 WIDGET-ID 26
          BGCOLOR 9 FGCOLOR 15 
     RECT-69 AT ROW 1 COL 1 WIDGET-ID 28
     RECT-70 AT ROW 6.65 COL 1 WIDGET-ID 30
     RECT-71 AT ROW 9.88 COL 1 WIDGET-ID 84
...
/* SETTINGS FOR FILL-IN F-CndVta IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-CodTran IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Contacto IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Direccion IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Estado IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Fecha IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-horario IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Lugar IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Nombre IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-Observ IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN F-ruc IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN f-SedeTran IN FRAME F-Main
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-CodTran V-table-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL f-SedeTran V-table-Win
ON LEAVE OF f-SedeTran IN FRAME F-Main /* Sede */
DO:
...
------------------------------------------------------------------------------*/
    ...
    RUN logis/d-agencia-transporte (Ccbcdocu.codcia, Ccbcdocu.coddiv, Ccbcdocu.coddoc, Ccbcdocu.nrodoc).
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbCDocu THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     FIND FIRST Ccbadocu OF Ccbcdocu NO-LOCK NO-ERROR.
     IF AVAILABLE Ccbadocu THEN DO:
         /* PRIMER Y SEGUNDO TRAMO */
         DISPLAY 
             CcbADocu.Libre_C[20] @ f-SedeTran 
             CcbADocu.Libre_C[9] @ f-CodTran
             CcbADocu.Libre_C[10] @ f-Nombre
             CcbADocu.Libre_C[11] @ f-Ruc
             CcbADocu.Libre_C[12] @ f-Direccion.
         /* SEGUNDO TRAMO: */
         DISPLAY 
             CcbADocu.Libre_C[13] @ f-Lugar 
             CcbADocu.Libre_C[14] @ f-Contacto
             CcbADocu.Libre_C[15] @ f-Horario
             CcbADocu.Libre_C[16] @ f-Observ
             CcbADocu.Libre_F[2] @ f-Fecha.
     END.
  END.
