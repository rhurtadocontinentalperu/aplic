...
( COMBO-BOX_CodDiv = "Todas" OR T-FacCPedi.CodDiv = COMBO-BOX_CodDiv ) ~
AND ( COMBO-BOX_CodDoc = "Todos" OR T-FacCPedi.CodDoc = COMBO-BOX_CodDoc ) ~
AND ( TRUE <> (FILL-IN_NroSer > "") OR T-FacCPedi.NroPed BEGINS FILL-IN_NroSer) ~
                        )
...
T-FacCPedi.Libre_c02 T-FacCPedi.Libre_c01 T-FacCPedi.TipBon[1] ~
...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 COMBO-BOX_CodDiv BUTTON-5 ~
COMBO-BOX_CodDoc BUTTON-6 FILL-IN_NroSer BROWSE-2 BUTTON-2 BUTTON-3 ~
BUTTON-Refrescar BUTTON-Consolidar 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX_CodDiv COMBO-BOX_CodDoc ~
FILL-IN_NroSer FILL-IN-Peso FILL-IN-Volumen FILL-IN-Importe ~
FILL-IN-Clientes FILL-IN-Peso-2 FILL-IN-Volumen-2 FILL-IN-Importe-2 
...
DEFINE VARIABLE COMBO-BOX_CodDiv AS CHARACTER FORMAT "X(256)":U INITIAL "Todas" 
...
DEFINE VARIABLE COMBO-BOX_CodDoc AS CHARACTER FORMAT "X(256)":U INITIAL "Todos" 
     ...
     DROP-DOWN-LIST
     SIZE 9 BY 1 TOOLTIP "O/D: Orden de Despacho    OTR: Orden de Transferencia" NO-UNDO.
...
DEFINE VARIABLE FILL-IN_NroSer AS CHARACTER FORMAT "x(3)":U 
     LABEL "N° de Serie" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .81 TOOLTIP "Los primeros 3 números del documento" NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      T-FacCPedi.Libre_c01 COLUMN-LABEL "Distrito" FORMAT "x(50)":U
            WIDTH 21.43
      T-FacCPedi.TipBon[1] COLUMN-LABEL "#" FORMAT "99":U WIDTH 2.43
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 98 BY 18.85
         FONT 4
...
DEFINE FRAME F-Main
     COMBO-BOX_CodDiv AT ROW 1.27 COL 12 COLON-ALIGNED WIDGET-ID 42
     BUTTON-5 AT ROW 1.27 COL 79 WIDGET-ID 48
     BUTTON-4 AT ROW 1.27 COL 121 WIDGET-ID 22
     COMBO-BOX_CodDoc AT ROW 2.35 COL 12 COLON-ALIGNED WIDGET-ID 44
     BUTTON-6 AT ROW 2.35 COL 79 WIDGET-ID 50
     FILL-IN_NroSer AT ROW 3.42 COL 12 COLON-ALIGNED WIDGET-ID 46
     BROWSE-2 AT ROW 4.77 COL 2 WIDGET-ID 200
     BUTTON-2 AT ROW 19.04 COL 101 WIDGET-ID 4
     BUTTON-3 AT ROW 20.92 COL 101 WIDGET-ID 10
     ...
     BUTTON-Consolidar AT ROW 25.77 COL 24 WIDGET-ID 12
     "(1)" VIEW-AS TEXT
          SIZE 5 BY 1.08 AT ROW 25.77 COL 17 WIDGET-ID 6
          FONT 8
     "(2)" VIEW-AS TEXT
          SIZE 5 BY 1.08 AT ROW 17.96 COL 102 WIDGET-ID 8
          FONT 8
     ...
     "(3)" VIEW-AS TEXT
          ...
          FONT 8
     RECT-2 AT ROW 1 COL 2 WIDGET-ID 40
     RECT-1 AT ROW 1 COL 101 WIDGET-ID 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 191.57 BY 26.12
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-2 FILL-IN_NroSer F-Main */
ASSIGN 
...
"T-FacCPedi.CodOrigen" "Origen" ? "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-FacCPedi.NroOrigen
"T-FacCPedi.NroOrigen" "Detalle" ? "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-FacCPedi.Cliente_Recoge
"T-FacCPedi.Cliente_Recoge" "Cliente!Recoge" "SI/NO" "logical" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-FacCPedi.EmpaqEspec
"T-FacCPedi.EmpaqEspec" "Embalaje!Especial" "SI/NO" "logical" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-FacCPedi.Libre_c02
"T-FacCPedi.Libre_c02" "Departamento" "x(50)" "character" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-FacCPedi.Libre_c01
"T-FacCPedi.Libre_c01" "Distrito" "x(50)" "character" ? ? ? ? ? ? no ? no no "21.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-FacCPedi.TipBon[1]
"T-FacCPedi.TipBon[1]" "#" ? "integer" ? ? ? ? ? ? no ? no no "2.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = Temp-Tables.T-FacCPedi.CodDoc
     _FldNameList[9]   > Temp-Tables.T-FacCPedi.NroPed
"T-FacCPedi.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-FacCPedi.NomCli
"T-FacCPedi.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "31" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-FacCPedi.FchEnt
"T-FacCPedi.FchEnt" "Fch.Entrega" ? "date" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-FacCPedi.Hora
"T-FacCPedi.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-FacCPedi.Libre_d01
"T-FacCPedi.Libre_d01" "Peso kg" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   = Temp-Tables.T-FacCPedi.ImpTot
     _FldNameList[15]   > Temp-Tables.T-FacCPedi.Libre_d02
"T-FacCPedi.Libre_d02" "Volumen m3" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   = Temp-Tables.T-FacCPedi.FchPed
     _FldNameList[17]   > Temp-Tables.T-FacCPedi.Glosa
"T-FacCPedi.Glosa" "Observaciones" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   = Temp-Tables.T-FacCPedi.LugEnt
     _FldNameList[19]   > Temp-Tables.T-FacCPedi.FlgEst
"T-FacCPedi.FlgEst" ? "X(2)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > Temp-Tables.T-FacCPedi.FlgSit
...
DO:
    ...
    END.
    IF T-FacCPedi.TipBon[1] <= 1 THEN DO:
        T-FacCPedi.TipBon[1]:BGCOLOR IN BROWSE {&BROWSE-NAME} = 10.
        T-FacCPedi.TipBon[1]:FGCOLOR IN BROWSE {&BROWSE-NAME} = 0.
    END.
    ELSE DO:
        T-FacCPedi.TipBon[1]:BGCOLOR IN BROWSE {&BROWSE-NAME} = 12.
        T-FacCPedi.TipBon[1]:FGCOLOR IN BROWSE {&BROWSE-NAME} = 15.
    END.
END.
...
ON CHOOSE OF BUTTON-5 IN FRAME F-Main /* APLICAR FILTROS */
DO:
    ASSIGN COMBO-BOX_CodDiv COMBO-BOX_CodDoc FILL-IN_NroSer.
    {&OPEN-QUERY-{&BROWSE-NAME}}
    RUN Totales.
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
      COMBO-BOX_CodDiv = "Todas".
      COMBO-BOX_CodDoc = "Todos".
      FILL-IN_NroSer = "".
      DISPLAY COMBO-BOX_CodDiv COMBO-BOX_CodDoc FILL-IN_NroSer.
  END.
  {&OPEN-QUERY-{&BROWSE-NAME}}
  RUN Totales.
  RUN dispatch IN h_b-add-od-otr-cab ('open-query':U).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-add-od-otr-cab ( 2.88 , 105.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-od-otr-origen-det ( 8.54 , 105.00 ) NO-ERROR.
       RUN set-size IN h_b-od-otr-origen-det ( 7.00 , 83.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/b-consolida-od-otr-phr-add.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-add-od-otr-det ).
       RUN set-position IN h_b-add-od-otr-det ( 16.35 , 108.00 ) NO-ERROR.
       RUN set-size IN h_b-add-od-otr-det ( 10.50 , 83.00 ) NO-ERROR.
...
DEF BUFFER bOrigen FOR Almacen.
DEF BUFFER bDestino FOR Almacen.

/* 11/06/2025: Como los dos flujos (HPK y PHR) confluyen => Solo verificamos FlgEst = "P" */
DO k = 1 TO NUM-ENTRIES(LocalCodDoc):
    RLOOP:
    FOR EACH FacCPedi NO-LOCK USE-INDEX Llave08 WHERE FacCPedi.CodCia = s-codcia 
        AND FacCPedi.DivDes = s-coddiv 
        AND FacCPedi.FlgEst = "P" 
        AND FacCPedi.FchPed >= ADD-INTERVAL(TODAY, -1 , 'month')    /* No más de 1 mes */
        AND FacCPedi.CodDoc = ENTRY(k, LocalCodDoc):        
        /* *************************************************************************** */
        /* 01/10/2025: Martín Chirinos : No presentar si son de la misma división (¿?) */
        /*IF Faccpedi.coddiv = Faccpedi.divdes THEN NEXT.*/
        IF Faccpedi.CodDoc = "OTR" THEN DO:
            FIND bOrigen WHERE bOrigen.codcia = s-codcia AND bOrigen.codalm = Faccpedi.codalm NO-LOCK NO-ERROR.
            FIND bDestino WHERE bDestino.codcia = s-codcia AND bDestino.codalm = Faccpedi.codcli NO-LOCK NO-ERROR.
            IF AVAILABLE bOrigen AND AVAILABLE bDestino AND (bOrigen.coddiv = bDestino.coddiv) THEN NEXT.
        END.
        /* *************************************************************************** */
        CASE TRUE:
...
/* 29/01/2025 Carla Tenazoa: contador de O/Ds */
FOR EACH T-Faccpedi EXCLUSIVE-LOCK:
    T-Faccpedi.tipbon[1] = 0.
    FOR EACH ORDENES NO-LOCK WHERE ORDENES.codcia = s-codcia AND
        ORDENES.coddoc = T-Faccpedi.coddoc AND
        ORDENES.codref = T-Faccpedi.codref AND      /* PED, R/A */
        ORDENES.nroref = T-Faccpedi.nroref AND
        ORDENES.flgest <> "A":
        T-Faccpedi.tipbon[1] = T-Faccpedi.tipbon[1] + 1.
    END.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX_CodDiv COMBO-BOX_CodDoc FILL-IN_NroSer FILL-IN-Peso 
          FILL-IN-Volumen FILL-IN-Importe FILL-IN-Clientes FILL-IN-Peso-2 
          FILL-IN-Volumen-2 FILL-IN-Importe-2 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-2 RECT-1 COMBO-BOX_CodDiv BUTTON-5 COMBO-BOX_CodDoc BUTTON-6 
         FILL-IN_NroSer BROWSE-2 BUTTON-2 BUTTON-3 BUTTON-Refrescar 
         BUTTON-Consolidar 
      WITH FRAME F-Main IN WINDOW W-Win.
...
DO WITH FRAME {&FRAME-NAME} TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    FOR EACH T-RutaC NO-LOCK WHERE CAN-FIND(FIRST BT-RutaD OF T-RutaC NO-LOCK):
        ...
        FOR EACH T-RutaD OF T-RutaC NO-LOCK:
            ...
            IF AVAILABLE FacCPedi AND NOT FacCPedi.FlgEst = "P" THEN NEXT.
            /* ********************************** */
            /* Bloqueamos Orden */
            ...
            END.
            /* OJO: Se marca la O/D */
            IF (FacCPedi.FlgEst = "P" AND FacCPedi.FlgSit = "T") THEN DO:
                FacCPedi.FlgSit = "TG".    /* Con PHR Generada */
            END.
            /* ********************************** */
            CREATE DI-RutaD.
            ASSIGN
