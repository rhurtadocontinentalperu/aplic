...
FILL-IN-ordenes FILL-IN-items FILL-IN-mesa FILL-IN-tiempo 
...
DEFINE FRAME F-Main
     ...
     BUTTON-Refrescar AT ROW 2.35 COL 63 WIDGET-ID 14
     ...
     "Considera ordenes HPK" VIEW-AS TEXT
          SIZE 33.57 BY .62 AT ROW 2.65 COL 91.43 WIDGET-ID 16
          FGCOLOR 4 FONT 11
...
OCXFile = SEARCH( "w-chk-bandeja-hpk.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-chk-bandeja-hpk.wrx":U SKIP(1)
