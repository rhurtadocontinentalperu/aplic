...
&Scoped-define FIELDS-IN-QUERY-br_table VtaTabla.Valor[20] ~
VtaTabla.Llave_c5 VtaTabla.Valor[1] VtaTabla.Valor[2] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table VtaTabla.Valor[20] ~
VtaTabla.Llave_c5 VtaTabla.Valor[1] VtaTabla.Valor[2] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaTabla.Valor[20] COLUMN-LABEL "Sec" FORMAT "->>>,>>>,>>9":U
            WIDTH 8
      VtaTabla.Llave_c5 COLUMN-LABEL "Descripcion" FORMAT "x(80)":U
            WIDTH 48.43
      VtaTabla.Valor[1] COLUMN-LABEL "Por cada!Unidades" FORMAT "->>>,>>>,>>9.99":U
      VtaTabla.Valor[2] COLUMN-LABEL "Usar!Metros" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 11.43
  ENABLE
      VtaTabla.Valor[20]
      VtaTabla.Llave_c5
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88 BY 11.54
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "INTEGRAL.VtaTabla.Valor[20]|yes"
     _Where[1]         = "vtatabla.codcia = s-codcia and
vtatabla.tabla = x-vtatabla and
vtatabla.llave_c1 = x-llave_c1 and
vtatabla.llave_c2 = x-llave_c2 and 
vtatabla.llave_c3 = x-llave_c3"
     _FldNameList[1]   > INTEGRAL.VtaTabla.Valor[20]
"VtaTabla.Valor[20]" "Sec" "->>>,>>>,>>9" "decimal" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Llave_c5
"VtaTabla.Llave_c5" "Descripcion" "x(80)" "character" ? ? ? ? ? ? yes ? no no "48.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaTabla.Valor[1]
"VtaTabla.Valor[1]" "Por cada!Unidades" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Valor[2]
"VtaTabla.Valor[2]" "Usar!Metros" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON 'RETURN':U OF vtatabla.valor[20], vtatabla.llave_c5, vtatabla.valor[1], vtatabla.valor[2] IN BROWSE {&BROWSE-NAME} DO:
    APPLY 'TAB':U.
    RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN vtatabla.codcia = s-codcia
        ...
        vtatabla.llave_c3 = x-llave_c3
        vtatabla.llave_c4 = STRING(INT(valor[20]),"99999999").
