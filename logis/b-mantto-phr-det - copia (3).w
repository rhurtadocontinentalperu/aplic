...
fDistrito() @ x-Distrito T-RUTAD.CodRef T-RUTAD.NroRef FacCPedi.Hora ~
FacCPedi.FchEnt FacCPedi.NomCli T-RUTAD.Estado @ x-Estado ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-RUTAD.Libre_d01 COLUMN-LABEL "Peso" FORMAT ">>>,>>9.99":U
            WIDTH 6.57
      T-RUTAD.ImpCob COLUMN-LABEL "M3" FORMAT ">>>,>>9.99":U WIDTH 6.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 150 BY 11.85
...
"T-RUTAD.SKU @ x-SKU" "SKU" ">>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.T-RUTAD.Libre_c01
...
"T-RUTAD.Libre_d02" "Importe" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-RUTAD.Libre_d01
"T-RUTAD.Libre_d01" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > Temp-Tables.T-RUTAD.ImpCob
"T-RUTAD.ImpCob" "M3" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
