...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-cliente txtTTxx FILL-IN-orden ~
txtTTrans FILL-IN-PHR FILL-IN-chequeador FILL-IN-codplanilla ~
FILL-IN-Embalaje FILL-IN-embalado FILL-IN-crossdocking FILL-IN-prioridad 
...
DEFINE FRAME D-Dialog
     ...
     txtTTxx AT ROW 1.15 COL 145 RIGHT-ALIGNED NO-LABEL WIDGET-ID 20
     FILL-IN-orden AT ROW 1.27 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     Btn_OK AT ROW 1.27 COL 147
     txtTTrans AT ROW 2.23 COL 128 COLON-ALIGNED WIDGET-ID 14
     ...
     Btn_Cancel AT ROW 2.62 COL 147
...
/* SETTINGS FOR FILL-IN FILL-IN-prioridad IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN txtTTrans IN FRAME D-Dialog
   NO-ENABLE                                                            */
ASSIGN 
       txtTTrans:READ-ONLY IN FRAME D-Dialog        = TRUE.

/* SETTINGS FOR FILL-IN txtTTxx IN FRAME D-Dialog
   NO-ENABLE ALIGN-R                                                    */
ASSIGN 
       txtTTxx:READ-ONLY IN FRAME D-Dialog        = TRUE.
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {F0B88A90-F5DA-11CF-B545-0020AF6ED35A} type: PSTimer */
      CtrlFrame:MOVE-AFTER(Btn_OK:HANDLE IN FRAME D-Dialog).
...
DO:  
  ...
  /* MARCAMOS LA PAUSA DEL CHEQUEO */
  RUN gn/p-log-status-pedidos (pCodDoc,
                               pNroDoc,
                               'TRCKHPK',
                               'CK_PAUSA',
                               '',
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-chk-bandeja-hpk-v2 ( 5.31 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-chk-bandeja-hpk-v2 ( 19.42 , 174.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-cliente txtTTxx FILL-IN-orden txtTTrans FILL-IN-PHR 
          FILL-IN-chequeador FILL-IN-codplanilla FILL-IN-Embalaje 
          FILL-IN-embalado FILL-IN-crossdocking FILL-IN-prioridad 
      WITH FRAME D-Dialog.
