...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/v-pedido-credito-v2a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedido-credito-v2 ).
       RUN set-position IN h_v-pedido-credito-v2 ( 2.35 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.96 , 125.00 ) */
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-pedido-cred ( 12.38 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-pedido-credito-v2 ( 12.58 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-pedido-credito-v2 ( 12.50 , 141.00 ) NO-ERROR.
