...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 95 BY 20.19
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 1.81 COL 97 WIDGET-ID 4
...
"t-VtaCDocu.Libre_d01" "Pedidos" "->>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
