...
gn-clie.RepLeg[2] gn-clie.RepLeg[5] gn-clie.Rucold gn-clie.Libre_L01 ~
gn-clie.Telfnos[1] gn-clie.Telfnos[2] gn-clie.Telfnos[3] gn-clie.FaxCli ~
gn-clie.Libre_L02 gn-clie.SwBajaSunat gn-clie.Libre_F01 
...
"Extranjera", "E":U
     ...
     gn-clie.NomCli AT ROW 4.5 COL 12.86 WIDGET-ID 28
          ...
          SIZE 80 BY .81
          BGCOLOR 14 FGCOLOR 0 
     gn-clie.E-Mail AT ROW 5.31 COL 17 COLON-ALIGNED WIDGET-ID 22 FORMAT "X(100)"
          VIEW-AS FILL-IN 
          SIZE 22 BY .81
     gn-clie.Transporte[4] AT ROW 5.31 COL 53 COLON-ALIGNED WIDGET-ID 60
          LABEL "eMail Fact. Electr." FORMAT "X(150)"
          VIEW-AS FILL-IN 
          SIZE 44 BY .81
...
"Activo en SUNAT", no
          SIZE 17 BY 1.62
          BGCOLOR 14 FGCOLOR 0 
     gn-clie.Libre_F01 AT ROW 8.27 COL 81 COLON-ALIGNED WIDGET-ID 128
          LABEL "Fecha Inscripción SUNAT" FORMAT "99/99/9999"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 14 FGCOLOR 0 
...
/* SETTINGS FOR FILL-IN gn-clie.JfeLog[5] IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN gn-clie.Libre_F01 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
...
DO:
  ...
  IF gn-clie.Libre_C01:SCREEN-VALUE = "J" THEN
      ...
      pDateInscription @ INTEGRAL.gn-clie.Libre_F01
