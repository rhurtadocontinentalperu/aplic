...
&Scoped-define FIELDS-IN-QUERY-BROWSE-7 VtaCDocu.CodTer VtaCDocu.CodPed ~
VtaCDocu.NroPed VtaCDocu.NomCli VtaCDocu.FchEnt VtaCDocu.Items ~
VtaCDocu.Peso VtaCDocu.Volumen 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-7 
&Scoped-define QUERY-STRING-BROWSE-7 FOR EACH VtaCDocu ~
      WHERE vtacdocu.codcia = s-codcia AND  ~
vtacdocu.coddiv = s-coddiv AND ~
vtacdocu.codped = x-coddoc AND ~
vtacdocu.flgest = 'P' AND  ~
vtacdocu.flgsit = 'PR' NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-7 OPEN QUERY BROWSE-7 FOR EACH VtaCDocu ~
      WHERE vtacdocu.codcia = s-codcia AND  ~
vtacdocu.coddiv = s-coddiv AND ~
vtacdocu.codped = x-coddoc AND ~
vtacdocu.flgest = 'P' AND  ~
vtacdocu.flgsit = 'PR' NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-7 VtaCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-7 VtaCDocu
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-7 W-Win _STRUCTURED
  QUERY BROWSE-7 NO-LOCK DISPLAY
      VtaCDocu.CodTer COLUMN-LABEL "Tipo" FORMAT "x(12)":U
      VtaCDocu.CodPed FORMAT "x(3)":U
      VtaCDocu.NroPed COLUMN-LABEL "Numero" FORMAT "X(12)":U WIDTH 10
      VtaCDocu.NomCli COLUMN-LABEL "Cliente" FORMAT "x(60)":U
      VtaCDocu.FchEnt FORMAT "99/99/99":U
      VtaCDocu.Items FORMAT ">>>,>>9":U
      VtaCDocu.Peso FORMAT "->>>,>>9.99":U
      VtaCDocu.Volumen FORMAT "->>>,>>9.99":U WIDTH 19.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ASIGNACION DE HPK A MESAS"
         HEIGHT             = 25.38
         WIDTH              = 144.29
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 144.29
...
/* Query rebuild information for BROWSE BROWSE-7
     ...
     _Where[1]         = "vtacdocu.codcia = s-codcia AND 
vtacdocu.coddiv = s-coddiv AND
vtacdocu.codped = x-coddoc AND
vtacdocu.flgest = 'P' AND 
vtacdocu.flgsit = 'PR'"
     _FldNameList[1]   > INTEGRAL.VtaCDocu.CodTer
"VtaCDocu.CodTer" "Tipo" "x(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = INTEGRAL.VtaCDocu.CodPed
     _FldNameList[3]   > INTEGRAL.VtaCDocu.NroPed
"VtaCDocu.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaCDocu.NomCli
"VtaCDocu.NomCli" "Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = INTEGRAL.VtaCDocu.FchEnt
     _FldNameList[6]   = INTEGRAL.VtaCDocu.Items
     _FldNameList[7]   = INTEGRAL.VtaCDocu.Peso
     _FldNameList[8]   > INTEGRAL.VtaCDocu.Volumen
"VtaCDocu.Volumen" ? ? "decimal" ? ? ? ? ? ? no ? no no "19.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-7 */
&ANALYZE-RESUME
...
ON END-ERROR OF W-Win /* ASIGNACION DE HPK A MESAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ASIGNACION DE HPK A MESAS */
DO:
...
DO:
  IF NOT AVAILABLE VtaCDocu THEN RETURN NO-APPLY.
    ...
    MESSAGE 'Seguro de asignar la orden ' + VtaCdocu.codped + "  " + VtaCdocu.nroped VIEW-AS ALERT-BOX QUESTION
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    {lib/lock-genericov3.i ~
        ...
        ChkControl.CodDoc = VtaCdocu.codped AND ~
        ChkControl.NroPed = VtaCdocu.nroped" ~
