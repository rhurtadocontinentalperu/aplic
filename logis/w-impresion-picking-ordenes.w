...
DEFINE NEW SHARED VAR pOrdenCompra AS CHAR INIT ''.  /* Supermercados Peruanos SOLO POR COMPATIBILIDAD */
...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-3 RADIO-SET-CodDoc BtnDone ~
BUTTON-14 txtDesde txtHasta ChkChequeo BUTTON-13 RADIO-SET-1 BtnExcel ~
chbxImpresos BROWSE-5 BUTTON-PorZona BUTTON-Alfabeticamente 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-CodDoc txtDesde txtHasta ~
ChkChequeo RADIO-SET-1 chbxImpresos txtcodref txtNroRef txtArtSinPeso 
...
DEFINE FRAME F-Main
     RADIO-SET-CodDoc AT ROW 1.27 COL 14 NO-LABEL WIDGET-ID 52
     BtnDone AT ROW 1.27 COL 137 WIDGET-ID 10
     BUTTON-14 AT ROW 1.81 COL 114 WIDGET-ID 58
     txtDesde AT ROW 2.58 COL 9.57 COLON-ALIGNED WIDGET-ID 16
     txtHasta AT ROW 2.58 COL 31 COLON-ALIGNED WIDGET-ID 20
     ChkChequeo AT ROW 2.69 COL 54 WIDGET-ID 22
     BUTTON-13 AT ROW 2.88 COL 81 WIDGET-ID 4
     RADIO-SET-1 AT ROW 3.12 COL 129 NO-LABEL WIDGET-ID 28
     BtnExcel AT ROW 3.15 COL 114 WIDGET-ID 34
     chbxImpresos AT ROW 3.58 COL 54 WIDGET-ID 50
     ...
     "Filtrar por:" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 1.46 COL 5 WIDGET-ID 40
     ...
     RECT-3 AT ROW 1 COL 2 WIDGET-ID 60
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 145.86 BY 26.15 WIDGET-ID 100.
...
DO:
    ASSIGN txtDesde txtHasta chkchequeo chbxImpresos.
    ltxtDesde = txtDesde.
    ltxtHasta = txtHasta.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/b-listado-picking-ordenes-todos-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = FchPed':U ,
             OUTPUT h_b-picking-ordenes-todos ).
       RUN set-position IN h_b-picking-ordenes-todos ( 4.50 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-dimprime-od ( 12.31 , 2.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-CodDoc txtDesde txtHasta ChkChequeo RADIO-SET-1 chbxImpresos 
          txtcodref txtNroRef txtArtSinPeso 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-1 RECT-3 RADIO-SET-CodDoc BtnDone BUTTON-14 txtDesde txtHasta 
         ChkChequeo BUTTON-13 RADIO-SET-1 BtnExcel chbxImpresos BROWSE-5 
         BUTTON-PorZona BUTTON-Alfabeticamente 
      WITH FRAME F-Main IN WINDOW W-Win.
