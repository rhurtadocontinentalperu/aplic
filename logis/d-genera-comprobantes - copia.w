...
/* SETTINGS FOR COMBO-BOX cboCobranza IN FRAME bgDialog
   NO-ENABLE ALIGN-L                                                    */
...
/* SETTINGS FOR FILL-IN FILL-IN-NroPed IN FRAME bgDialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN txtMecanismo IN FRAME bgDialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN txtMetodoPago IN FRAME bgDialog
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cboCobranza bgDialog
ON VALUE-CHANGED OF cboCobranza IN FRAME bgDialog /* Courier */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Generacion-Canc-Auto bgDialog 
...
------------------------------------------------------------------------------*/    
    ...
    DEFINE VAR xComision AS DEC NO-UNDO.
        ...
        FOR EACH Reporte NO-LOCK WHERE LOOKUP(Reporte.CodDoc, 'FAC,BOL') > 0,
            ...
            BUFFER-COPY Ccbcdocu TO B-CDOCU
                ASSIGN 
                    ...
                    B-CDOCU.NroOrd = Ccbcdocu.NroOrd    /* Pedido Cliente */
            ...
            /* RHC 26/04/19 Se va a cancelar con LIQUIDACION DE COBRANZA */
            ...
            RUN LF_Comision IN hProc (INPUT B-CDOCU.CodCli,
            ...
            /* Marcamos su origen Lista Express (LF) */
            ASSIGN
                B-CDOCU.TpoFac = "LF".
            /* ************************************* */
            RELEASE B-CDOCU.
...
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION ON ERROR UNDO trloop, RETURN 'ADM-ERROR' ON STOP UNDO trloop, RETURN 'ADM-ERROR':
        ...
        FOR EACH Reporte NO-LOCK WHERE LOOKUP(Reporte.CodDoc, 'FAC,BOL,FAI') > 0, 
            ...
            FIRST Almtfami OF Almmmatg NO-LOCK WHERE Almtfami.Libre_c01 <> "SV"     /* OJO */
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    FOR EACH T-CDOCU NO-LOCK:
        ...
        /*
        Suspendido por que Erick Cruz, indico otras consideraciones
...
/*         END.                                                                       */
        ...
        /* Descuentos por PRONTO PAGO (A/C) */
