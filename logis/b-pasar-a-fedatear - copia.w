...
DEFINE QUERY br_table FOR 
    ...
    FIELDS(), 
      DI-RutaC
    FIELDS(DI-RutaC.CodDoc
      DI-RutaC.NroDoc
      DI-RutaC.FchDoc
      DI-RutaC.Observ) SCROLLING.
&ANALYZE-RESUME
...
/* Solo cuyas OTR u O/D sean (FlgEst = 'P' and FlgSit = 'C') o (FlgEst = 'C' and FlgSIt = 'C') */
ON FIND OF Di-RutaC DO:
    IF CAN-FIND(FIRST VtaCDocu WHERE VtaCDocu.CodCia = Di-RutaC.CodCia AND
                VtaCDocu.CodDiv = Di-RutaC.CodDiv AND
                VtaCDocu.CodPed = "HPK" AND
                VtaCDocu.CodOri = Di-RutaC.CodDoc AND      /* PHR */
...
/*
ON FIND OF Di-RutaC DO:
    IF CAN-FIND(FIRST Di-RutaD WHERE DI-RutaD.CodCia = DI-RutaC.CodCia AND
                DI-RutaD.CodDiv = Di-RutaC.CodDiv AND
                DI-RutaD.CodDoc = Di-RutaC.CodDoc AND
                DI-RutaD.NroDoc = Di-RutaC.NroDoc AND
                CAN-FIND(FIRST Faccpedi WHERE Faccpedi.codcia = Di-RutaD.CodCia AND
                         Faccpedi.coddoc = Di-RutaD.CodRef AND
                         Faccpedi.nroped = Di-RutaC.nroref AND
                         NOT ((Faccpedi.FlgEst = "P" OR Faccpedi.FlgEst = "C") AND
                              Faccpedi.FlgSit = "C")
                         NO-LOCK)
                NO-LOCK)
        THEN RETURN ERROR.
