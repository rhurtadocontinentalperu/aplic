...
&Scoped-define INTERNAL-TABLES tt-rut-pers-turno rut-pers-turno t-VtaCDocu ~
VtaCDocu
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-PHK VtaCDocu.NroPed VtaCDocu.FecSac ~
VtaCDocu.HorSac t-VtaCDocu.Nombre @ x-Nombre t-VtaCDocu.Origen @ x-Origen ~
VtaCDocu.Items VtaCDocu.ZonaPickeo VtaCDocu.CodOri VtaCDocu.NroOri 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-PHK 
&Scoped-define QUERY-STRING-BROWSE-PHK FOR EACH t-VtaCDocu NO-LOCK, ~
      FIRST VtaCDocu WHERE VtaCDocu.CodCia = t-VtaCDocu.CodCia ~
  AND VtaCDocu.CodPed = t-VtaCDocu.CodPed ~
  AND VtaCDocu.NroPed = t-VtaCDocu.NroPed NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-PHK OPEN QUERY BROWSE-PHK FOR EACH t-VtaCDocu NO-LOCK, ~
      FIRST VtaCDocu WHERE VtaCDocu.CodCia = t-VtaCDocu.CodCia ~
  AND VtaCDocu.CodPed = t-VtaCDocu.CodPed ~
  AND VtaCDocu.NroPed = t-VtaCDocu.NroPed NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-PHK t-VtaCDocu VtaCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-PHK t-VtaCDocu
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-PHK VtaCDocu
...
&Scoped-Define ENABLED-OBJECTS BUTTON-Refrescar BUTTON-15 BROWSE-PHK ~
BROWSE-PERSONAL 
...
DEFINE QUERY BROWSE-PHK FOR 
      t-VtaCDocu
    FIELDS(t-VtaCDocu.Nombre
      t-VtaCDocu.Origen), 
      VtaCDocu
    FIELDS(VtaCDocu.NroPed
      VtaCDocu.FecSac
      VtaCDocu.HorSac
      VtaCDocu.Items
      VtaCDocu.ZonaPickeo
      VtaCDocu.CodOri
      VtaCDocu.NroOri) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-PHK W-Win _STRUCTURED
  QUERY BROWSE-PHK NO-LOCK DISPLAY
      ...
      t-VtaCDocu.Nombre @ x-Nombre COLUMN-LABEL "Nombre" FORMAT "x(30)":U
            WIDTH 30
...
DEFINE FRAME F-Main
     ...
     BUTTON-15 AT ROW 1.27 COL 107 WIDGET-ID 6
     BROWSE-PHK AT ROW 2.62 COL 2 WIDGET-ID 200
     BROWSE-PERSONAL AT ROW 2.62 COL 107 WIDGET-ID 400
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-PHK BUTTON-15 F-Main */
...
"tt-rut-pers-turno.items @ x-col-total-item-asig" "#Items" ">>>9" ? ? ? ? ? ? ? no ? no no "17.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
"VtaCDocu.NroPed" "Numero" ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaCDocu.FecSac
"VtaCDocu.FecSac" ? "99/99/9999" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCDocu.HorSac
"VtaCDocu.HorSac" ? ? "character" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"t-VtaCDocu.Nombre @ x-Nombre" "Nombre" "x(30)" ? ? ? ? ? ? ? no ? no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"t-VtaCDocu.Origen @ x-Origen" "Origen" "x(10)" ? ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH VtaCDocu NO-LOCK WHERE VtaCDocu.CodCia = s-codcia
    ...
    IF VtaCDocu.FlgSit <> "TI" THEN NEXT.
    CREATE t-Vtacdocu.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-Refrescar BUTTON-15 BROWSE-PHK BROWSE-PERSONAL 
