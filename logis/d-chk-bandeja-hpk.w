...
FILL-IN-chequeador FILL-IN-embalado FILL-IN-crossdocking FILL-IN-prioridad 
...
DEFINE VARIABLE h_b-chk-bandeja-hpk AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     Btn_Cancel AT ROW 2.77 COL 124
     FILL-IN-tiempo AT ROW 3.42 COL 83.57 COLON-ALIGNED NO-LABEL WIDGET-ID 16
...
DO:
  RUN Cerra-Orden IN h_b-chk-bandeja-hpk.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/b-chk-bandeja-hpk.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chk-bandeja-hpk ).
       RUN set-position IN h_b-chk-bandeja-hpk ( 5.31 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-chk-bandeja-hpk ( 18.04 , 160.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-chk-bandeja-hpk. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chk-bandeja-hpk ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chk-bandeja-hpk ,
             FILL-IN-prioridad:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_b-chk-bandeja-hpk , 'AFTER':U ).
    END. /* Page 0 */
...
OCXFile = SEARCH( "d-chk-bandeja-hpk.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "d-chk-bandeja-hpk.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  ...
  RUN Captura-Parametros IN h_b-chk-bandeja-hpk
