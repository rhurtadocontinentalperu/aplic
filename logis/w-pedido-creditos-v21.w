...
DEFINE FRAME F-Main
     ...
     btn-margen AT ROW 7.46 COL 128 WIDGET-ID 2
     BTN-CCTE AT ROW 8.42 COL 128 WIDGET-ID 22
     B-AGTRANS AT ROW 9.38 COL 128 WIDGET-ID 24
     BUTTON-REDONDEO AT ROW 10.35 COL 128 WIDGET-ID 26
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/v-pedido-credito-v21.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
