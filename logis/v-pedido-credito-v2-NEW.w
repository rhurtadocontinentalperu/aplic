...
FacCPedi.NCmpbnte FacCPedi.Libre_c03 FacCPedi.CodAlm FacCPedi.NroRef ~
FacCPedi.ordcmp FacCPedi.Sede FacCPedi.CodOrigen FacCPedi.NroOrigen ~
FacCPedi.CodPos FacCPedi.Glosa FacCPedi.TipVta 
...
FacCPedi.FlgIgv FacCPedi.CodMon FacCPedi.NCmpbnte FacCPedi.Libre_c03 ~
FacCPedi.TpoLic FacCPedi.CodAlm FacCPedi.NroRef FacCPedi.DT ~
FacCPedi.AlmacenDT FacCPedi.ordcmp FacCPedi.Sede FacCPedi.CodOrigen ~
FacCPedi.NroOrigen FacCPedi.CodPos FacCPedi.Glosa FacCPedi.TipVta 
...
"Dolares", 2
          SIZE 15 BY .81
     FacCPedi.NCmpbnte AT ROW 5.31 COL 2 NO-LABEL WIDGET-ID 164 FORMAT "X(9)"
          ...
          SIZE 12 BY 1
          FONT 4
     FacCPedi.Libre_c03 AT ROW 5.31 COL 12 COLON-ALIGNED NO-LABEL WIDGET-ID 130 FORMAT "x(12)"
          VIEW-AS FILL-IN 
          SIZE 16 BY .81
          BGCOLOR 14 FGCOLOR 0 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.CodOrigen AT ROW 8.27 COL 91 COLON-ALIGNED NO-LABEL WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 14 FGCOLOR 0 
     FacCPedi.NroOrigen AT ROW 8.27 COL 96 COLON-ALIGNED NO-LABEL WIDGET-ID 146
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          BGCOLOR 14 FGCOLOR 0 
...
/* SETTINGS FOR FILL-IN FacCPedi.Libre_f02 IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR COMBO-BOX FacCPedi.NCmpbnte IN FRAME F-Main
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF s-FmaPgo = '002' /*AND LOOKUP(s-CodDiv, '00018,00024,00030') > 0 */
          THEN ASSIGN FacCPedi.Libre_c03:SENSITIVE = YES FacCPedi.NCmpbnte:SENSITIVE = YES FacCPedi.NCmpbnte:SCREEN-VALUE = 'BD'.
          ELSE ASSIGN FacCPedi.Libre_c03:SENSITIVE = NO FacCPedi.NCmpbnte:SENSITIVE = NO FacCPedi.NCmpbnte:SCREEN-VALUE = ''.
      /* **************************************************** */
    ...
    DO WITH FRAME {&FRAME-NAME}:
        CASE HANDLE-CAMPO:name:
            ...
            WHEN 'Libre_c03' THEN DO:
                ASSIGN
                    /*input-var-1 = 'BD'*/
                    input-var-1 = FacCPedi.NCmpbnte:SCREEN-VALUE
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF s-FmaPgo = '002' THEN DO:
        FIND Ccbcdocu WHERE Ccbcdocu.codcia = s-codcia
            ...
            AND Ccbcdocu.coddoc = FacCPedi.NCmpbnte:SCREEN-VALUE
        ...
        IF NOT AVAILABLE Ccbcdocu OR Ccbcdocu.flgest <> 'P' OR Ccbcdocu.SdoAct <= 0
            ...
            RETURN 'ADM-ERROR'.
        END.
        IF FacCPedi.NCmpbnte:SCREEN-VALUE = "BD" AND Ccbcdocu.FmaPgo <> s-FmaPgo THEN DO:
        ...
        */
        IF INPUT FacCPedi.CodMon = Ccbcdocu.CodMon THEN DO:
            IF Ccbcdocu.sdoact < f-Tot THEN DO:
                MESSAGE 'El saldo del Depósito NO cubre el monto total' SKIP
                        'El pedido va ir obligatoriamente a evaluación de créditos y cobranzas'
        ...
        END.
    END.
    ELSE ASSIGN FacCPedi.Libre_c03:SCREEN-VALUE = '' FacCPedi.NCmpbnte:SCREEN-VALUE = ''.
