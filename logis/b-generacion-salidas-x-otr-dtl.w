...
FOR EACH T-RUTAD OF B-RutaC NO-LOCK,
    ...
    AND FacCPedi.CodDoc = "OTR" /*T-RUTAD.CodRef*/
...
FOR EACH DI-RutaD OF B-RutaC NO-LOCK, 
    FIRST Faccpedi NO-LOCK WHERE Faccpedi.codcia = Di-RutaD.codcia
        AND Faccpedi.coddoc = 'OTR' /*Di-RutaD.codref*/
...
DO WITH FRAME {&FRAME-NAME}:
    COMBO-BOX_FmaPgo:DELETE(COMBO-BOX_FmaPgo:LIST-ITEM-PAIRS) NO-ERROR.
