...
DEF VAR s-tabla AS CHAR INIT 'REPROG_OD' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacTabla.Codigo COLUMN-LABEL "Canal de Venta" FORMAT "x(8)":U
            WIDTH 11.43
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 48.72
  ENABLE
      FacTabla.Codigo
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 14.54
         FONT 4
         TITLE "EXCLUYENTES" FIT-LAST-COLUMN.
...
"FacTabla.Codigo" "Canal de Venta" ? "character" ? ? ? ? ? ? yes ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.GN-DIVI.DesDiv
"GN-DIVI.DesDiv" ? ? "character" ? ? ? ? ? ? no ? no no "48.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* EXCLUYENTES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* EXCLUYENTES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* EXCLUYENTES */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      FacTabla.Campo-C[1] = s-User-Id
      FacTabla.Campo-D[1] = TODAY
      FacTabla.Campo-C[2] = STRING(TIME,'HH:MM:SS')
      NO-ERROR.
...
IF NOT CAN-FIND(FIRST gn-divi WHERE GN-DIVI.CodCia = s-codcia
                AND GN-DIVI.CodDiv = FacTabla.Codigo:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} NO-LOCK)
    THEN DO:
