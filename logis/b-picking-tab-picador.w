...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rut-pers-turno.dni COLUMN-LABEL "DNI" FORMAT "x(8)":U WIDTH 10.43
      fNombre(rut-pers-turno.dni) @ x-Nombre COLUMN-LABEL "Nombre" FORMAT "x(50)":U
            WIDTH 48.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 63 BY 17.77
         FONT 11
         TITLE "SELECCIONE EL PICADOR" FIT-LAST-COLUMN.
...
"rut-pers-turno.dni" "DNI" ? "character" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"fNombre(rut-pers-turno.dni) @ x-Nombre" "Nombre" "x(50)" ? ? ? ? ? ? ? no ? no no "48.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* SELECCIONE EL PICADOR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* SELECCIONE EL PICADOR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* SELECCIONE EL PICADOR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Devuelve-Picador B-table-Win 
PROCEDURE Devuelve-Picador :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
pDni = ''.
IF AVAILABLE rut-pers-turn THEN pDni = rut-pers-turno.dni.
