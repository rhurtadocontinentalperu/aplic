...
&Scoped-Define ENABLED-OBJECTS BROWSE-14 BROWSE-18 BUTTON-35 ~
TOGGLE-packing-zebra FILL-IN-codtrab BUTTON-6 BUTTON-4 FILL-IN-desde ~
FILL-IN-hasta BUTTON-1 BUTTON-2 BUTTON-3 BROWSE-16 FILL-IN-phr FILL-IN-hpk ~
BUTTON-7 BUTTON-8 BUTTON-9 BUTTON-10 BUTTON-11 BUTTON-34 RECT-4 
&Scoped-Define DISPLAYED-OBJECTS TOGGLE-packing-zebra FILL-IN-codtrab ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 162 BY 11.15
         FONT 4
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 79 BY 10.23
         FONT 4
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 66 BY 10.08
         FONT 4
...
DEFINE FRAME F-Main
     ...
     BROWSE-18 AT ROW 13.42 COL 82 WIDGET-ID 400
     BUTTON-35 AT ROW 18.31 COL 150 WIDGET-ID 52
     TOGGLE-packing-zebra AT ROW 16.58 COL 149.43 WIDGET-ID 48
     FILL-IN-codtrab AT ROW 1.12 COL 11.29 COLON-ALIGNED WIDGET-ID 30
     FILL-IN-copias AT ROW 6.96 COL 143 COLON-ALIGNED WIDGET-ID 28
     BUTTON-6 AT ROW 24.31 COL 51.29 WIDGET-ID 26
     BUTTON-5 AT ROW 5.42 COL 122 WIDGET-ID 24
     BUTTON-4 AT ROW 24.27 COL 2.43 WIDGET-ID 20
     FILL-IN-desde AT ROW 1.08 COL 101 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-hasta AT ROW 1.08 COL 121 COLON-ALIGNED WIDGET-ID 14
     BUTTON-1 AT ROW 24.27 COL 39.14 WIDGET-ID 8
     BUTTON-2 AT ROW 24.27 COL 25 WIDGET-ID 10
     BUTTON-3 AT ROW 1.08 COL 136 WIDGET-ID 16
     BROWSE-16 AT ROW 13.38 COL 2 WIDGET-ID 300
     FILL-IN-phr AT ROW 1.15 COL 33 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-hpk AT ROW 1.15 COL 54 COLON-ALIGNED WIDGET-ID 34
     BUTTON-7 AT ROW 23.85 COL 134.29 WIDGET-ID 36
     BUTTON-8 AT ROW 23.88 COL 96 WIDGET-ID 38
     BUTTON-9 AT ROW 23.88 COL 82.72 WIDGET-ID 40
     BUTTON-10 AT ROW 14.08 COL 149.43 WIDGET-ID 42
     BUTTON-11 AT ROW 15.42 COL 149.43 WIDGET-ID 44
     BUTTON-34 AT ROW 23.88 COL 109.29 WIDGET-ID 46
     "Considera documentos HPK" VIEW-AS TEXT
          SIZE 36 BY .96 AT ROW 8.5 COL 114 WIDGET-ID 6
          BGCOLOR 15 FGCOLOR 4 FONT 9
     "Ordenes terminadas" VIEW-AS TEXT
          SIZE 20.57 BY .62 AT ROW 1.31 COL 74 WIDGET-ID 18
          FGCOLOR 9 FONT 10
     RECT-4 AT ROW 13.85 COL 148.43 WIDGET-ID 50
...
"tiempo-observado(chktareas.fechafin, chktareas.horafin) @ x-tiempo-observado-col" "Hora Terminado" "x(25)" ? ? ? ? ? ? ? no ? no no "20.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-14 */
&ANALYZE-RESUME
...
"tt-w-report.Campo-C[4]" "Cliente" "X(50)" "character" ? ? ? ? ? ? no ? no no "30.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-16 */
&ANALYZE-RESUME
...
"tmp-w-report.Campo-C[4]" "Cliente" "X(50)" "character" ? ? ? ? ? ? no ? no no "14.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-18 */
&ANALYZE-RESUME
...
FOR EACH logisdchequeo NO-LOCK WHERE logisdchequeo.CodCia = s-CodCia AND
    ...
    ASSIGN
        ...
        w-report.Campo-F[3] = (logisdchequeo.CanPed * Almmmatg.PesMat)
...
------------------------------------------------------------------------------*/
  DISPLAY TOGGLE-packing-zebra FILL-IN-codtrab FILL-IN-desde FILL-IN-hasta 
          FILL-IN-phr FILL-IN-hpk 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE BROWSE-14 BROWSE-18 BUTTON-35 TOGGLE-packing-zebra FILL-IN-codtrab 
         BUTTON-6 BUTTON-4 FILL-IN-desde FILL-IN-hasta BUTTON-1 BUTTON-2 
         BUTTON-3 BROWSE-16 FILL-IN-phr FILL-IN-hpk BUTTON-7 BUTTON-8 BUTTON-9 
         BUTTON-10 BUTTON-11 BUTTON-34 RECT-4 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*
^FO100,75^GB1,50,3^FS
^FO200,75^GB1,50,3^FS
^FO640,75^GB1,50,3^FS
^FO730,75^GB1,50,3^FS

^FT20,110
^APN^FDMATERIAL^FS
^FT105,110
^APN^FDCOD.ANTIGUO^FS
^FT320,110
^AQN^FDDESCRIPCION DEL ITEM^FS
^FT660,110
^AQN^FDCANT.^FS
^FT740,110
^AQN^FDU.M.^FS
...
^FO10,122^GB790,40,3^FS

^FO100,122^GB1,40,3^FS
^FO200,122^GB1,40,3^FS
^FO640,122^GB1,40,3^FS
^FO730,122^GB1,40,3^FS
...
^FT215,150
^AQN^FDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX^FS
^FT660,150
^APN^FD99,999.99^FS
^FT740,150
^APN^FDXXXXXX^FS
