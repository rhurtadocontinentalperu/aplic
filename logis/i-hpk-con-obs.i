...
&ELSE
DEF VAR pError AS CHAR INITIAL "" NO-UNDO.
&SCOPED-DEFINE txtMensaje pError
&ENDIF
    ...
    CASE ORDEN.CodDoc:
        ...
        WHEN "O/D" OR WHEN "O/M" THEN DO:
            ...
            IF NOT AVAILABLE PEDIDO THEN DO:
                {&txtMensaje} = "NO se pudo bloquear el " + ORDEN.codref + " " + ORDEN.nroref +
            ...
            IF ORDEN.CodDoc = 'O/D' THEN DO:
                ...
                IF NOT AVAILABLE COTIZACION THEN DO:
                    {&txtMensaje} = "NO se pudo bloquear la cotización " + PEDIDO.codref + " " + PEDIDO.nroref +
                        CHR(10) + ERROR-STATUS:GET-MESSAGE(1).
                    UNDO CICLO, RETURN 'ADM-ERROR'.
                END.
            END.
            ...
            CASE ORDEN.CodRef:
                ...
                WHEN "R/A" THEN DO:
                    ...
                    IF NOT AVAILABLE Almcrepo THEN DO:
                        {&txtMensaje} = "NO se pudo bloquear la R/A " + ORDEN.nroref +
                            CHR(10) + ERROR-STATUS:GET-MESSAGE(1).
                        UNDO CICLO, RETURN 'ADM-ERROR'.
                    END.
