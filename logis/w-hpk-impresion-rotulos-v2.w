...
DO:
  IF AVAILABLE tchktareas THEN DO:
      ...
      ELSE DO:
          ...
          IF tchktareas.tcodclie = "20112273922" THEN DO:
              /* SODIMAC - TIENDAS DEL MEJORAMIENTO DEL HOGAR S.A. */
              /*RUN logis/d-rotulo-sodimac.r(tchktareas.tcoddoc, tchktareas.tnrodoc).*/
              RUN logis/d-rotulo-sodimac.r(tchktareas.tcoddoc, tchktareas.tnrodoc).
          END.
