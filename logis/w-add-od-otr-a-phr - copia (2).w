...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 T-FacCPedi.Cliente_Recoge ~
T-FacCPedi.EmpaqEspec T-FacCPedi.Libre_c02 T-FacCPedi.Libre_c01 ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 96 BY 20.46
         FONT 4
...
"T-FacCPedi.Libre_d01" "Peso kg" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   = Temp-Tables.T-FacCPedi.ImpTot
     _FldNameList[12]   > Temp-Tables.T-FacCPedi.Libre_d02
"T-FacCPedi.Libre_d02" "Volumen m3" "->>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   = Temp-Tables.T-FacCPedi.FchPed
     _FldNameList[14]   > Temp-Tables.T-FacCPedi.Glosa
"T-FacCPedi.Glosa" "Observaciones" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   = Temp-Tables.T-FacCPedi.LugEnt
     _FldNameList[16]   > Temp-Tables.T-FacCPedi.FlgEst
"T-FacCPedi.FlgEst" ? "X(2)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > Temp-Tables.T-FacCPedi.FlgSit
