...
DEFINE VARIABLE h_q-hpk-unico AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 14.46 COL 2
     Btn_Cancel AT ROW 14.46 COL 17
     SPACE(114.42) SKIP(0.30)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "LOG DE CHECKING"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* LOG DE CHECKING */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-consulta-picking-det ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-consulta-picking-det ( 12.92 , 132.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/q-hpk-unico.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-hpk-unico ).
       RUN set-position IN h_q-hpk-unico ( 1.81 , 136.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-consulta-picking-det. */
       RUN add-link IN adm-broker-hdl ( h_q-hpk-unico , 'Record':U , h_b-consulta-picking-det ).
