...
DEFINE TEMP-TABLE tt-seguimiento NO-UNDO
        /* PEDIDO */
        FIELDS tt-codped    LIKE faccpedi.coddoc    COLUMN-LABEL "Cod.Pedido"
        FIELDS tt-nroped    LIKE faccpedi.nroped    COLUMN-LABEL "Nro.Pedido"
        FIELDS tt-fchped    LIKE faccpedi.fchped    COLUMN-LABEL "F.Emision Pedido"
        FIELDS tt-horped    AS CHAR                 COLUMN-LABEL "H.Emision Pedido"        FORMAT 'x(20)'
        FIELDS tt-divped    LIKE faccpedi.coddiv    COLUMN-LABEL "Div.Pedido Pedido"
        FIELDS tt-lprecio   AS CHAR                 COLUMN-LABEL "Lista de Precio"          FORMAT 'x(6)'
        /* Orden */
        FIELDS tt-codord    LIKE faccpedi.coddoc    COLUMN-LABEL "Cod.Orden"
        FIELDS tt-nroord    LIKE faccpedi.nroped    COLUMN-LABEL "Nro.Orden"
        FIELDS tt-fchord    AS DATE                 COLUMN-LABEL "Fecha Emision Orden"
        FIELDS tt-horord    AS CHAR                 COLUMN-LABEL "Hora Emision Orden"         FORMAT 'x(20)'
        FIELDS tt-fchentord AS DATE                 COLUMN-LABEL "Fecha Entrega Orden"
        FIELDS tt-fchaprord AS DATE                 COLUMN-LABEL "Fecha Aprob. orden"
        FIELDS tt-usrasgord AS CHAR                 COLUMN-LABEL "Usuario Asigando Orden"  FORMAT 'x(20)'
        FIELDS tt-fchasgord AS DATE                 COLUMN-LABEL "Fecha Asignacion Orden"
        FIELDS tt-horasgord AS CHAR                 COLUMN-LABEL "Hora Asiganacion Orden"  FORMAT 'x(20)'
        /* PreChequeo */
        FIELDS tt-finiprechq AS DATE                COLUMN-LABEL "Fecha Inicio PreChecking"
        FIELDS tt-Hiniprechq AS CHAR                COLUMN-LABEL "Hora Inicio PreChecking"
        FIELDS tt-ffinprechq AS CHAR                COLUMN-LABEL "Fecha/Hora Fin PreChecking" FORMAT 'x(25)'
        FIELDS tt-Hfinprechq AS CHAR                COLUMN-LABEL "Hora Fin PreChecking"
        FIELDS tt-volumen   AS DEC                  COLUMN-LABEL "Volumen(m3) de la O/D"      FORMAT "->>,>>>,>>9.9999"
        FIELDS tt-qitms     AS INT                  COLUMN-LABEL "Items de la O/D"
        FIELDS tt-peso      AS DEC                  COLUMN-LABEL "Peso de la O/D"
        FIELDS tt-imptot    LIKE faccpedi.imptot    COLUMN-LABEL "S/. Importe Venta Con IGV (O/D)"
        FIELDS tt-imprepo   LIKE faccpedi.imptot    COLUMN-LABEL "S/. Importe Reposicion con IGV (O/D)"
        FIELDS tt-impkard   LIKE faccpedi.imptot    COLUMN-LABEL "S/. Costo Promedio Kardex (O/D)"
        /* Envio a Distribucion */
        FIELDS tt-fhimp     LIKE faccpedi.fchimpod  COLUMN-LABEL "Fecha/Hora Impresion" FORMAT '99/99/9999 HH:MM:SS.SSS'
        FIELDS tt-fdistr    AS DATETIME             COLUMN-LABEL "Fecha/Hora Distribucion" FORMAT '99/99/9999 HH:MM:SS.SSS'
        /* Chequeo */
        FIELDS tt-nrohpk    AS CHAR FORMAT 'x(15)'  COLUMN-LABEL "HPK"
        FIELDS tt-finicheq  LIKE ccbcbult.dte_01    COLUMN-LABEL "Dia inicio Chequeo"
        FIELDS tt-hinicheq  LIKE ccbcbult.CHR_03    COLUMN-LABEL "Hora inicio Chequeo"
        FIELDS tt-ffincheq  LIKE ccbcbult.dte_01    COLUMN-LABEL "Dia fin Chequeo"
        FIELDS tt-hfincheq  LIKE ccbcbult.CHR_03    COLUMN-LABEL "Hora fin de chequeo" FORMAT 'x(6)'
        FIELDS tt-bultos    LIKE ccbcbult.bultos    COLUMN-LABEL "Bultos" FORMAT '>>>>9'
        FIELDS tt-frotula   AS DATE                 COLUMN-LABEL "Fecha Rotulado"
        /* Generacion del Comprobante */
        FIELDS tt-cdoc      LIKE faccpedi.coddoc    COLUMN-LABEL "Doc"
        FIELDS tt-ndoc      LIKE faccpedi.nroped    COLUMN-LABEL "Nro Dcto"                
        FIELDS tt-xfemi     AS DATE                 COLUMN-LABEL "Dcto Fecha Emision"
        FIELDS tt-xhemi     AS CHAR                 COLUMN-LABEL "Dcto Hora Emision"       FORMAT 'x(20)'
        FIELDS tt-origen    LIKE gn-div.desdiv      COLUMN-LABEL "Division Emision"        
        FIELDS tt-codcli    LIKE faccpedi.codcli    COLUMN-LABEL "CodCliente"
        FIELDS tt-nomcli    LIKE faccpedi.nomcli    COLUMN-LABEL "Nombre del Cliente"
        FIELDS tt-docremi   LIKE faccpedi.coddoc    COLUMN-LABEL "Doc.Remision"
        FIELDS tt-nroremi   LIKE faccpedi.nroped    COLUMN-LABEL "Nro Remision"                
        /* Ruta */
        FIELDS tt-hruta         LIKE di-rutac.nrodoc    COLUMN-LABEL "Numero H/R"        
        FIELDS tt-fsalidaHR     AS DATE                 COLUMN-LABEL "Fecha Salida H/R"
        FIELDS tt-hsalidaHR     LIKE di-rutaC.horsal    COLUMN-LABEL "Hora Salida H/R" FORMAT 'x(6)'
        FIELDS tt-hretornoHR    LIKE di-rutac.horret    COLUMN-LABEL "Hora Retorno H/R" FORMAT 'x(6)'        
        /* Transportista */
        FIELDS tt-placa     LIKE di-rutaC.codveh    COLUMN-LABEL "Placa"       FORMAT 'x(25)'
        FIELDS tt-gtranspo  LIKE di-rutaC.guiatransportista COLUMN-LABEL "Guia Transp."
        FIELDS tt-transpo   AS CHAR                 COLUMN-LABEL "Transportista" FORMAT 'x(60)'
        FIELDS tt-tipomov   AS CHAR                 COLUMN-LABEL "Tipo Movim." FORMAT 'x(15)'
        FIELDS tt-divori    AS CHAR FORMAT 'x(6)'   COLUMN-LABEL "Division DESPACHO"
        FIELDS tt-almacen       AS CHAR     FORMAT 'x(6)'   COLUMN-LABEL "Almacen Despacho"
        /* Salida/dev mercaderia segun vigilancia */
        FIELDS tt-fchsalvig AS DATE                 COLUMN-LABEL "Fecha Salida Vigilancia"
        FIELDS tt-horsalvig AS CHAR                 COLUMN-LABEL "Hora Salida Vigilancia" FORMAT 'x(20)'
        FIELDS tt-fchdevvig AS DATE                 COLUMN-LABEL "Fecha Devolucion Vigilancia"
        FIELDS tt-hordevvig AS CHAR                 COLUMN-LABEL "Hora Devolucion Vigilancia" FORMAT 'x(20)'
        /* Entrega al cliente */
        FIELDS tt-hllegada  LIKE di-rutaD.horlle    COLUMN-LABEL "Hora Llegada"    FORMAT 'x(6)'
        FIELDS tt-hpartida  LIKE di-rutaD.horpar    COLUMN-LABEL "Hora Partida"    FORMAT 'x(6)'
        /*  */
        FIELDS tt-dpto      AS CHAR                 COLUMN-LABEL "Dpto"        FORMAT 'x(60)'
        FIELDS tt-prov      AS CHAR                 COLUMN-LABEL "Provincia"   FORMAT 'x(60)'
        FIELDS tt-dist      AS CHAR                 COLUMN-LABEL "Distrito"    FORMAT 'x(60)'
        FIELDS tt-destino   AS CHAR                 COLUMN-LABEL "Destino"     FORMAT 'x(60)'  
        /**/
        FIELDS tt-dircli    AS CHAR                 COLUMN-LABEL "Direccion Cliente"    FORMAT 'x(120)'
        FIELDS tt-lugent    AS CHAR                 COLUMN-LABEL "Lugar de Entrega"     FORMAT 'x(100)'
        FIELDS tt-codpos    AS CHAR                 COLUMN-LABEL "Cod.Postal"   FORMAT 'x(5)'
        FIELDS tt-despos    AS CHAR                 COLUMN-LABEL "Postal"   FORMAT 'x(60)'
        FIELDS tt-glosa     AS CHAR                 COLUMN-LABEL "Observa"     FORMAT 'x(100)'
        FIELDS tt-estado    AS CHAR                 COLUMN-LABEL "Estado" FORMAT 'x(20)'
        FIELDS tt-transportista    AS CHAR                 COLUMN-LABEL "Transportista" FORMAT 'x(60)'
        FIELDS tt-transporte    AS CHAR                 COLUMN-LABEL "Transporte - Tramo 01" FORMAT 'x(60)'
        FIELDS tt-direccTransporte    AS CHAR                 COLUMN-LABEL "Direcc.Transporte" FORMAT 'x(60)'
        FIELDS tt-lugarentrega    AS CHAR                 COLUMN-LABEL "Lugar de entrega - Tramo 02" FORMAT 'x(60)'
        /* */
        FIELDS tt-situacion AS CHAR                 COLUMN-LABEL "Situacion" FORMAT 'x(50)'
        /* Pasa por aprobar Créditos */
        FIELD tt-fchingcre AS DATE COLUMN-LABEL "Fecha Ing. a Créditos"
        FIELD tt-horingcre AS CHAR COLUMN-LABEL "Hora Ing. a Créditos"
    .
...
&Scoped-Define ENABLED-OBJECTS RECT-1 txtCoddivi txtDesde txtHasta ~
TOGGLE_Solo-HR txtProcesar ChkbxResumen 
&Scoped-Define DISPLAYED-OBJECTS txtCoddivi txtDesDivi txtDesde txtHasta ~
TOGGLE_Solo-HR FILL-IN_FchHRD FILL-IN_FchHRH ChkbxGenTxt ChkbxResumen 
...
DEFINE VARIABLE FILL-IN_FchHRD AS DATE FORMAT "99/99/9999":U 
     LABEL "Fecha Salida HR Desde" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE FILL-IN_FchHRH AS DATE FORMAT "99/99/9999":U 
     LABEL "Hasta" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE txtCoddivi AS CHARACTER FORMAT "X(5)":U 
     LABEL "Alguna division de despacho?" 
     VIEW-AS FILL-IN 
     SIZE 8 BY 1 NO-UNDO.
...
DEFINE VARIABLE TOGGLE_Solo-HR AS LOGICAL INITIAL no 
     LABEL "Solo con H/R" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fMain
     txtCoddivi AT ROW 2.08 COL 28.14 COLON-ALIGNED WIDGET-ID 2
     txtDesDivi AT ROW 2.08 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     txtDesde AT ROW 5.04 COL 23 COLON-ALIGNED WIDGET-ID 4
     txtHasta AT ROW 5.04 COL 45.14 COLON-ALIGNED WIDGET-ID 6
     TOGGLE_Solo-HR AT ROW 7.46 COL 25 WIDGET-ID 32
     FILL-IN_FchHRD AT ROW 8.54 COL 23 COLON-ALIGNED WIDGET-ID 28
     FILL-IN_FchHRH AT ROW 8.54 COL 45 COLON-ALIGNED WIDGET-ID 30
     ChkbxGenTxt AT ROW 10.69 COL 18 WIDGET-ID 22
     txtProcesar AT ROW 11.08 COL 61 WIDGET-ID 8
     ChkbxResumen AT ROW 11.46 COL 18 WIDGET-ID 26
     "(valido solo para PEDIDOS)" VIEW-AS TEXT
          SIZE 27 BY .62 AT ROW 3.12 COL 24.29 WIDGET-ID 24
     "PED, R/A  y TRA que esten emitidos en este rango de fechas" VIEW-AS TEXT
          SIZE 51.86 BY .62 AT ROW 4.23 COL 23 WIDGET-ID 20
     RECT-1 AT ROW 6.92 COL 2 WIDGET-ID 34
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 96.14 BY 12.73 WIDGET-ID 100.
...
/* SETTINGS FOR FILL-IN FILL-IN_FchHRD IN FRAME fMain
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN_FchHRH IN FRAME fMain
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME TOGGLE_Solo-HR
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL TOGGLE_Solo-HR wWin
ON VALUE-CHANGED OF TOGGLE_Solo-HR IN FRAME fMain /* Solo con H/R */
DO:
  ASSIGN TOGGLE_Solo-HR. 
  FILL-IN_FchHRD:SENSITIVE = TOGGLE_Solo-HR.
  FILL-IN_FchHRH:SENSITIVE = TOGGLE_Solo-HR.
END.
...
ON LEAVE OF txtCoddivi IN FRAME fMain /* Alguna division de despacho? */
DO:
...
DO:
  ...
  ASSIGN FILL-IN_FchHRD FILL-IN_FchHRH TOGGLE_Solo-HR.

  IF TOGGLE_Solo-HR = NO THEN
      ASSIGN FILL-IN_FchHRD = ? FILL-IN_FchHRH = ?.
  DISPLAY FILL-IN_FchHRD FILL-IN_FchHRH.
  IF TOGGLE_Solo-HR = YES AND 
      (FILL-IN_FchHRD = ? OR FILL-IN_FchHRH = ?)
      THEN DO:
      MESSAGE 'Debe ingresar ambas fechas' VIEW-AS ALERT-BOX ERROR.
      APPLY 'ENTRY':U TO FILL-IN_FchHRD.
      RETURN NO-APPLY.
  END.
...
------------------------------------------------------------------------------*/
  DISPLAY txtCoddivi txtDesDivi txtDesde txtHasta TOGGLE_Solo-HR FILL-IN_FchHRD 
          FILL-IN_FchHRH ChkbxGenTxt ChkbxResumen 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE RECT-1 txtCoddivi txtDesde txtHasta TOGGLE_Solo-HR txtProcesar 
         ChkbxResumen 
      WITH FRAME fMain IN WINDOW wWin.
...
DEFINE VAR cLugEnt AS CHAR NO-UNDO.
...
ASSIGN 
    tt-seguimiento.tt-situacion = lSituacion.

/* RUN lib/limpiar-texto-abc (tt-seguimiento.tt-dircli, ' ', OUTPUT cLugEnt).           */
/* tt-seguimiento.tt-dircli = cLugEnt.                                                  */
/* RUN lib/limpiar-texto-abc (tt-seguimiento.tt-lugent, ' ', OUTPUT cLugEnt).           */
/* tt-seguimiento.tt-lugent = cLugEnt.                                                  */
/* RUN lib/limpiar-texto-abc (tt-seguimiento.tt-lugarentrega, ' ', OUTPUT cLugEnt).     */
/* tt-seguimiento.tt-lugarentrega = cLugEnt.                                            */
/* RUN lib/limpiar-texto-abc (tt-seguimiento.tt-direccTransporte, ' ', OUTPUT cLugEnt). */
/* tt-seguimiento.tt-direccTransporte = cLugEnt.                                        */
...
IF p-Fase = 'DOCUMENTO' THEN DO:
    ...
    ASSIGN tt-seguimiento.tt-cdoc     = "ALM"
        tt-seguimiento.tt-ndoc     = String(almcmov.nroser,"999") + String(almcmov.nrodoc,"9999999")
...
IF AVAILABLE od_faccpedi THEN DO:
    pqItems = od_faccpedi.Items.
    pqPeso  = od_faccpedi.Peso.
    pqVolumen = od_faccpedi.Volumen.
END.
IF pTipo = "DOC" THEN DO:
    DEFINE BUFFER b-ccbddocu FOR ccbddocu.
    FOR EACH b-ccbddocu OF ccbcdocu NO-LOCK, FIRST almmmatg OF b-ccbddocu NO-LOCK :
        i = i + 1.
        IF almmmatg.pesmat <> ? AND almmmatg.pesmat > 0 THEN lPeso = lPeso + ( (b-ccbddocu.candes * b-ccbddocu.factor ) * almmmatg.pesmat).
...
FOR EACH almcrepo WHERE almcrepo.codcia = s-codcia AND 
    ...
    FOR EACH od_faccpedi USE-INDEX llave07 WHERE od_faccpedi.codcia = almcrepo.codcia AND 
        ...
        FOR EACH almcmov WHERE almcmov.codcia = s-codcia AND 
            ...
            FOR EACH di-RutaG USE-INDEX llave02 WHERE di-RutaG.codcia = s-codcia AND 
                ...
                IF FILL-IN_FchHRD <> ? AND Di-RutaC.FchSal < FILL-IN_FchHRD THEN NEXT.
                IF FILL-IN_FchHRH <> ? AND Di-RutaC.FchSal > FILL-IN_FchHRH THEN NEXT.
                ...
                FIND FIRST gn-prov WHERE gn-prov.codcia = pv-codcia AND 
                    gn-prov.codpro = lCodPro NO-LOCK NO-ERROR.
                IF AVAILABLE gn-prov THEN lDesPro = gn-prov.nompro.
                /* Adiciono registro */
            ...
            END.
            /* No tiene HR */
            IF lTieneHRs = NO AND TOGGLE_Solo-HR = NO THEN DO:
                /* Adiciono registro */
                CREATE tt-seguimiento.
                RUN ue-grabar-mov-otr(INPUT "PEDIDO").
                RUN ue-grabar-mov-otr(INPUT "ORDEN").
        ...
        IF lTieneGRs = NO AND TOGGLE_Solo-HR = NO THEN DO:            
            /* Adiciono registro */
            CREATE tt-seguimiento.
            RUN ue-grabar-mov-otr(INPUT "PEDIDO").
            RUN ue-grabar-mov-otr(INPUT "ORDEN").
    ...
    IF lTieneODs = NO AND TOGGLE_Solo-HR = NO THEN DO:
        /* Adiciono registro */
        CREATE tt-seguimiento.
        RUN ue-grabar-mov-otr(INPUT "PEDIDO").
    END.
...
FOR EACH almacen WHERE almacen.codcia = s-codcia NO-LOCK, 
    FIRST gn-divi OF almacen NO-LOCK WHERE gn-divi.campo-log[5] = YES : /* Solo los de CD */
    FOR EACH almcmov WHERE almcmov.codcia = s-codcia AND
...
FOR EACH B-DIVI NO-LOCK WHERE B-DIVI.codcia = s-codcia AND
        (TRUE <> (txtCodDivi > '') OR B-DIVI.coddiv = txtCodDivi),
    EACH faccpedi NO-LOCK WHERE faccpedi.codcia = s-codcia AND 
        faccpedi.coddiv = B-DIVI.coddiv AND
    ...
    FOR EACH od_faccpedi WHERE od_faccpedi.codcia = faccpedi.codcia AND 
        ...
        od_faccpedi.flgest <> 'A' NO-LOCK,
        EACH Vtacdocu NO-LOCK USE-INDEX llave12  WHERE VtaCDocu.CodCia = od_faccpedi.codcia AND
        ...
        VtaCDocu.FlgEst <> "A",
        EACH CcbCBult NO-LOCK WHERE CcbCBult.CodCia = 1 AND
        CcbCBult.CodDoc = od_faccpedi.coddoc AND
        ...
        FOR EACH ccbcdocu USE-INDEX llave15 WHERE ccbcdocu.codcia = s-codcia AND 
            ...
            IF lTieneGRs = NO THEN DO:
                ...
                /* 28/02/2022 */
                IF lTieneGRs = NO AND lTieneHRs = NO AND TOGGLE_Solo-HR = NO THEN DO:
                    /* Adiciono registro */
                    CREATE tt-seguimiento.
                    RUN ue-grabar-mov(INPUT "PEDIDO").
                    RUN ue-grabar-mov(INPUT "ORDEN").
...
DEF VAR cLugEnt AS CHAR NO-UNDO.

FOR EACH tt-seguimiento:
    RUN lib/limpiar-texto-abc (tt-seguimiento.tt-nomcli, ' ', OUTPUT cLugEnt).
    tt-seguimiento.tt-nomcli = cLugEnt.
    RUN lib/limpiar-texto-abc (tt-seguimiento.tt-dircli, ' ', OUTPUT cLugEnt).
    tt-seguimiento.tt-dircli = cLugEnt.
    RUN lib/limpiar-texto-abc (tt-seguimiento.tt-lugent, ' ', OUTPUT cLugEnt).
    tt-seguimiento.tt-lugent = cLugEnt.
