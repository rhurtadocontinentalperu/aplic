...
&Scoped-define QUERY-STRING-Query-Main FOR EACH lg-cincid-chk WHERE ~{&KEY-PHRASE} ~
      AND lg-cincid-chk.CodCia = s-codcia ~
 AND lg-cincid-chk.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH lg-cincid-chk WHERE ~{&KEY-PHRASE} ~
      AND lg-cincid-chk.CodCia = s-codcia ~
 AND lg-cincid-chk.CodDiv = s-coddiv NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main lg-cincid-chk
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main lg-cincid-chk
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "lg-cincid-chk.CodCia = s-codcia
 AND lg-cincid-chk.CodDiv = s-coddiv"
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-lg-cincid-chk.w ('INCIDENCIAS DE CHEQUEO').
