...
DEFINE FRAME F-Main
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 160.29 BY 25.85 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "GENERACION DE SALIDAS x OTR"
         HEIGHT             = 25.85
         WIDTH              = 160.29
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 160.86
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* SETTINGS FOR BUTTON BUTTON-Reprogramadas IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       BUTTON-Reprogramadas:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR BUTTON BUTTON_Reasignar IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       BUTTON_Reasignar:HIDDEN IN FRAME F-Main           = TRUE.
...
ON END-ERROR OF W-Win /* GENERACION DE SALIDAS x OTR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* GENERACION DE SALIDAS x OTR */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/b-generacion-salidas-x-otr-cab.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/b-generacion-salidas-x-otr-dtl.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-TEXTO BUTTON-Print 
