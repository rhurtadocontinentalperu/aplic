...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 15 COL 2
     Btn_Cancel AT ROW 15 COL 17
     SPACE(147.42) SKIP(0.30)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'logis/bd-info-pick-pick.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consulta-de-ordenes ).
       RUN set-position IN h_b-consulta-de-ordenes ( 1.54 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-consulta-de-ordenes ( 13.69 , 176.14 ) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Captura-Filtros D-Dialog 
...
RUN Captura-Filtros IN h_b-consulta-de-ordenes
    ( INPUT TABLE t-VtaCDocu,
      INPUT pDNI /* CHARACTER */).
