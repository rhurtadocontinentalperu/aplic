...
"INTEGRAL.GN-DIVI.DesDiv" "Canal" "X(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"INTEGRAL.FacCPedi.FchEnt" ? ? "date" 11 0 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Temp-Tables.T-RUTAD.ImpCob" "Importe" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-RUTAD.Libre_d01
"Temp-Tables.T-RUTAD.Libre_d01" "Peso" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "6.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.T-RUTAD.Libre_d02
"Temp-Tables.T-RUTAD.Libre_d02" "M3" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH Di-RutaD OF Di-RutaC NO-LOCK, FIRST Faccpedi NO-LOCK WHERE Faccpedi.codcia = Di-RutaD.codcia
    ...
    IF CAN-FIND(FIRST AlmCDocu WHERE AlmCDocu.CodCia = T-RUTAD.codcia AND
