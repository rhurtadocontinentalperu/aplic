...
fDistrito() @ x-Distrito T-RUTAD.CodRef T-RUTAD.NroRef FacCPedi.FchEnt ~
FacCPedi.NomCli T-RUTAD.Estado @ x-Estado T-RUTAD.SKU @ x-SKU ~
T-RUTAD.Libre_c01 T-RUTAD.ImpCob T-RUTAD.Libre_d01 T-RUTAD.Libre_d02 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-RUTAD.Libre_d01 COLUMN-LABEL "Peso" FORMAT ">>>,>>9.99":U
            WIDTH 6.57
      T-RUTAD.Libre_d02 COLUMN-LABEL "M3" FORMAT ">>>,>>9.99":U
            WIDTH 5.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DO:
  IF AVAILABLE di-rutaC THEN DO:
      ...
      IF NOT ( (Faccpedi.FlgEst = 'P' AND Faccpedi.FlgSit = 'TG') OR
          ...
          RETURN NO-APPLY.
      END.
      /*IF NOT LOOKUP(Di-RutaC.FlgEst, 'PX,PK') > 0 THEN DO:*/
      IF NOT LOOKUP(Di-RutaC.FlgEst, 'PK') > 0 THEN DO:
          MESSAGE 'Habilitado solo para PHR GENERADAS o CON HPK' VIEW-AS ALERT-BOX WARNING.
          RETURN NO-APPLY.
      END.
...
FOR EACH Di-RutaD OF Di-RutaC NO-LOCK, FIRST Faccpedi NO-LOCK WHERE Faccpedi.codcia = Di-RutaD.codcia
    ...
    T-RUTAD.Libre_d01 = 0.
    T-RUTAD.Libre_d02 = 0.
    T-RUTAD.ImpCob = Faccpedi.ImpTot.
