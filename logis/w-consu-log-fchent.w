...
entry(3,logtabla.ValorLlave,"|") @ x-FchOld ~
entry(4,logtabla.ValorLlave,"|") @ x-FchNew 
...
&Scoped-Define ENABLED-OBJECTS pDia BUTTON-3 BUTTON-4 BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS pDia 
...
DEFINE VARIABLE pDia AS DATE FORMAT "99/99/9999":U 
     LABEL "Dia" 
     VIEW-AS FILL-IN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      entry(3,logtabla.ValorLlave,"|") @ x-FchOld COLUMN-LABEL "Antes"
            WIDTH 11.43
      entry(4,logtabla.ValorLlave,"|") @ x-FchNew COLUMN-LABEL "Despues"
            WIDTH 8.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     pDia AT ROW 1.27 COL 19 COLON-ALIGNED WIDGET-ID 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CONSULTA LOG DE CAMBIOS DE FECHA DE ENTREGA"
         HEIGHT             = 24.35
         WIDTH              = 83.29
         MAX-HEIGHT         = 29.54
         MAX-WIDTH          = 144.29
...
"entry(3,logtabla.ValorLlave,""|"") @ x-FchOld" "Antes" ? ? ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"entry(4,logtabla.ValorLlave,""|"") @ x-FchNew" "Despues" ? ? ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON END-ERROR OF W-Win /* CONSULTA LOG DE CAMBIOS DE FECHA DE ENTREGA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CONSULTA LOG DE CAMBIOS DE FECHA DE ENTREGA */
DO:
...
DO:
  ASSIGN
      pDia = ?.
  DISPLAY pDia WITH FRAME {&FRAME-NAME}.
  {&OPEN-QUERY-{&BROWSE-NAME}}
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE pDia BUTTON-3 BUTTON-4 BROWSE-2 
      WITH FRAME F-Main IN WINDOW W-Win.
