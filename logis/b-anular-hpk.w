...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    ...
    END.
    /* ************************************************************************ */
    /* 18/02/2026: Que pasa si otra HPK de la mis OTR u O/D ya se ha chequeado? */
    /* ************************************************************************ */
    DEF BUFFER dVtacdocu FOR Vtacdocu.
    FOR EACH dVtacdocu NO-LOCK WHERE dVtacdocu.codcia = s-codcia AND
        dVtacdocu.codref = Vtacdocu.codref AND
        dVtacdocu.nroref = Vtacdocu.nroref AND
        dVtacdocu.coddiv = s-coddiv AND
        dVtacdocu.flgest <> "A" AND
        ROWID(dVtacdocu) <> ROWID(Vtacdocu):
        IF NOT (dVtaCDocu.FlgEst = "P" AND LOOKUP(dVtaCDocu.FlgSit, "PC,C") = 0) THEN DO:
            pMensaje = "La HPK " + dVtacdocu.nroped + " relacionada con la " + dVtacdocu.codref + " " +
                dVtacdocu.nroref + " ya ha pasado por chequeo" + CHR(10) +
                "Proceso abortado".
