...
&Scoped-define INTERNAL-TABLES gn-vehic

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH gn-vehic WHERE ~{&KEY-PHRASE} ~
      AND gn-vehic.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-vehic WHERE ~{&KEY-PHRASE} ~
      AND gn-vehic.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-vehic
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-vehic
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    */
    RUN lkup/c-vehic ('Maestro de Vehículos').
