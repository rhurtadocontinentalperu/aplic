...
t-report.Campo-C[2] t-report.Campo-F[3] 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      t-report.Campo-C[1] COLUMN-LABEL "Nombre" FORMAT "X(30)":U
      t-report.Campo-C[2] COLUMN-LABEL "Situación" FORMAT "X(8)":U
      t-report.Campo-F[3] COLUMN-LABEL "Pendiente" FORMAT "->>>,>>>,>>9":U
            WIDTH 7.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 50 BY 9.69
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 2.08 COL 59 WIDGET-ID 4
...
"Campo-C[1]" "Nombre" "X(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-report.Campo-C[2]
"Campo-C[2]" "Situación" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.t-report.Campo-F[3]
"Campo-F[3]" "Pendiente" "->>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH Vtacdocu NO-LOCK WHERE VtaCDocu.CodCia = s-codcia
      ...
      FIND t-report WHERE Campo-C[2] = VtaCDocu.FlgSit NO-ERROR.
      IF NOT AVAILABLE t-report THEN CREATE t-report.
      ASSIGN
          Campo-C[2] = VtaCDocu.FlgSit.
      /*
      ASSIGN
      ...
      */
      ...
      FOR EACH Vtaddocu OF Vtacdocu NO-LOCK,FIRST Almmmatg OF Vtaddocu NO-LOCK:
          t-report.Campo-F[3] = t-report.Campo-F[3] + 1.
      END.
  ...
  FOR EACH t-report EXCLUSIVE-LOCK:
      RUN Estado-Logistico IN hProc (INPUT "HPK",
                                     INPUT "P",
                                     INPUT Campo-C[2],
                                     INPUT "S",
                                     OUTPUT pRetorno).
      ASSIGN
          t-report.Campo-C[1] = pRetorno.
  END.
