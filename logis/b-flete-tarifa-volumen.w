...
DEF VAR x-Tipo AS CHAR INIT 'Volumen' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      flete_tarifario.Minimo COLUMN-LABEL "Minimo en m3!>=" FORMAT ">>>,>>9.99":U
      flete_tarifario.Maximo COLUMN-LABEL "Maximo en m3!<" FORMAT ">>>,>>9.99":U
      flete_tarifario.Flete_Unitario COLUMN-LABEL "Flete Unitario!S/. con IGV!por m3" FORMAT ">>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"flete_tarifario.Minimo" "Minimo en m3!>=" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.flete_tarifario.Maximo
"flete_tarifario.Maximo" "Maximo en m3!<" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.flete_tarifario.Flete_Unitario
"flete_tarifario.Flete_Unitario" "Flete Unitario!S/. con IGV!por m3" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
