...
&Scoped-Define ENABLED-OBJECTS FILL-IN-Barra 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Barra 
...
DEFINE VARIABLE h_q-hpk-unica AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     FILL-IN-Barra AT ROW 1.54 COL 11 COLON-ALIGNED WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 117.29 BY 11.65 WIDGET-ID 100.
...
ON END-ERROR OF W-Win /* CONSULTA DE HPK */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CONSULTA DE HPK */
DO:
...
DO:
    ...
    IF NOT AVAILABLE vtacdocu THEN DO:
        ...
        RETURN NO-APPLY.
    END.
    RUN Captura-HPK IN h_q-hpk-unica
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-hpk-tracking ( 4.23 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-tracking ( 6.69 , 110.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/q-hpk-unica.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-hpk-unica ).
       RUN set-position IN h_q-hpk-unica ( 1.81 , 104.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-hpk-tracking. */
       RUN add-link IN adm-broker-hdl ( h_q-hpk-unica , 'Record':U , h_b-hpk-tracking ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-hpk-tracking ,
             FILL-IN-Barra:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-Barra 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE FILL-IN-Barra 
      WITH FRAME F-Main IN WINDOW W-Win.
