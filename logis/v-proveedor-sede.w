...
gn-provd.DirPro gn-provd.CodDept gn-provd.CodProv gn-provd.CodDist ~
gn-provd.Codpos gn-provd.Longitud gn-provd.Latitud gn-provd.Referencias 
...
"NO", no
          SIZE 12 BY .81
     gn-provd.DirPro AT ROW 2.62 COL 12 COLON-ALIGNED WIDGET-ID 124 FORMAT "x(200)"
          VIEW-AS FILL-IN 
          SIZE 107 BY .81
     ...
     gn-provd.Longitud AT ROW 6.65 COL 12 COLON-ALIGNED WIDGET-ID 58
          VIEW-AS FILL-IN 
          SIZE 10.72 BY .81
     FILL-IN-Cuadrante AT ROW 6.65 COL 32 COLON-ALIGNED WIDGET-ID 128
     gn-provd.Latitud AT ROW 7.46 COL 12 COLON-ALIGNED WIDGET-ID 56
          VIEW-AS FILL-IN 
          SIZE 10.72 BY .81
...
------------------------------------------------------------------------------*/
    ...
    CASE HANDLE-CAMPO:name:
        WHEN "CodProv" THEN DO:
            input-var-1 = Gn-ProvD.CodDept:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
        END.
        WHEN "CodDist" THEN DO:
            input-var-1 = Gn-ProvD.CodDept:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
            input-var-2 = Gn-ProvD.CodProv:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
        END.
        WHEN "CodPos" THEN DO:
            input-var-1 = "CP".
        END.
