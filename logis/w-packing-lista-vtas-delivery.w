...
DEFINE TEMP-TABLE T-CcbCDocu NO-UNDO LIKE CcbCDocu
       field tfechaentrega as date
       field tlugarentrega as char.
...
DEFINE TEMP-TABLE ttPacking
    ...
    FIELD   treceptor    AS  CHAR    FORMAT 'x(3)'   COLUMN-LABEL "Empresa/Centro de negocio"
    ...
    FIELD   temail   AS  CHAR    FORMAT 'x(15)'  COLUMN-LABEL "Email"
    .
...
DEFINE TEMP-TABLE ttScharff
    ...
    FIELD   tdnicontacto2   AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "DNI 2"
    FIELD   tcontacto2      AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "Personal de contacto 2"
    FIELD   tcellcontacto2   AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "Celular 2"
...
DEFINE TEMP-TABLE ttFilly
    FIELD   tnroguia        AS  CHAR    FORMAT 'x(25)'  COLUMN-LABEL "CODIGO"
    FIELD   tnomcli         AS  CHAR    FORMAT 'x(100)' COLUMN-LABEL "NOMBRE"
    FIELD   temailcli       AS  CHAR    FORMAT 'x(100)' COLUMN-LABEL "EMAIL"
    FIELD   tcelular        AS  CHAR    FORMAT 'x(100)' COLUMN-LABEL "CELULAR"
    FIELD   tdnicli         AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "DNI"
    FIELD   torigen        AS  CHAR    FORMAT 'x(100)' COLUMN-LABEL "ORIGEN"
    FIELD   tdireccion1     AS  CHAR    FORMAT 'x(150)' COLUMN-LABEL "DIRECCION"
    FIELD   treferencia1     AS  CHAR    FORMAT 'x(150)' COLUMN-LABEL "REFERENCIA"
    FIELD   tlatitud         AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "LATITUD"
    FIELD   tlongitud         AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "LONGITUD"
    FIELD   tindicaciones   AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "INDICACIONES"
    FIELD   tcoditem        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "CODIGO_ITEM"
    FIELD   tdesitem        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "DESCRIPCION_ITEM"
    FIELD   tbultos        AS  INT    FORMAT '>,>>>,>>9'   COLUMN-LABEL "BULTOS"
    FIELD   ttalla        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "TALLA"
    FIELD   tnombre_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "NOMBRE_2"
    FIELD   temail_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "EMAIL_2"
    FIELD   tcelular_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "CELULAR_2"
    FIELD   tdni_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "DNI_2"
    FIELD   tdireccion_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "DIRECCION_2"
    FIELD   treferencia_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "REFERENCIA_2"
    FIELD   tlatitud_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "LATITUD_2"
    FIELD   tlongitud_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "LONGITUD_2"
    FIELD   tindicaciones_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "INDICACIONES_2"
    .

DEFINE BUFFER x-faccpedi FOR faccpedi.
DEFINE BUFFER y-faccpedi FOR faccpedi.
DEFINE BUFFER t-faccpedi FOR faccpedi.
...
/**/
DEFINE VAR x-col-fecha-entrega AS DATE.
DEFINE VAR x-col-lugar-entrega AS CHAR.

/**/
DEFINE VAR x-vtatabla AS CHAR.
DEFINE VAR x-llave_c1 AS CHAR.
DEFINE VAR x-llave_c2 AS CHAR.

x-vtatabla = "VTAS-B2C".
x-llave_c1 = "COURIER".
x-llave_c2 = "2DO-RECEPTOR".

DEFINE VAR y-llave_c2 AS CHAR.
DEFINE VAR y-llave_c3 AS CHAR.
...
T-ccbcdocu.tfechaentrega  @  x-col-fentrega T-CcbCDocu.CodCli ~
T-CcbCDocu.NomCli T-CcbCDocu.Libre_c01 T-CcbCDocu.Libre_c02 ~
T-CcbCDocu.ImpTot tlugarentrega @ x-col-lugent T-CcbCDocu.CodDiv ~
T-CcbCDocu.CodPed T-CcbCDocu.NroPed 
...
RADIO-SET-cliente BUTTON-refrescar BROWSE-20 ContaBUTTON-generar 
...
DEFINE BUTTON ContaBUTTON-generar 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-20 W-Win _STRUCTURED
  QUERY BROWSE-20 NO-LOCK DISPLAY
      ...
      T-CcbCDocu.FchDoc COLUMN-LABEL "Fecha!Emision" FORMAT "99/99/9999":U
            WIDTH 8.43
      T-ccbcdocu.tfechaentrega  @  x-col-fentrega COLUMN-LABEL "Fecha!Entrega" FORMAT "99/99/9999":U
            WIDTH 9.72
      ...
      tlugarentrega @ x-col-lugent COLUMN-LABEL "Lugar de entrega" FORMAT "x(120)":U
            WIDTH 24.43
...
DEFINE FRAME F-Main
     ...
     ContaBUTTON-generar AT ROW 22.92 COL 134 WIDGET-ID 10
...
ASSIGN 
       BROWSE-20:PRIVATE-DATA IN FRAME F-Main           = 
                "tfechaentrega@x-col-fentrega @ tlugarentrega@x-col-lugent"
...
"T-ccbcdocu.tfechaentrega  @  x-col-fentrega" "Fecha!Entrega" "99/99/9999" ? ? ? ? ? ? ? no "Ayudaaaaaaaaaaaaa" no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tlugarentrega @ x-col-lugent" "Lugar de entrega" "x(120)" ? ? ? ? ? ? ? no ? no no "24.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"T-CcbCDocu.NroPed" "Nro!Pedido" ? "character" ? ? ? ? ? ? no ? no no "1.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-20 */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME ContaBUTTON-generar
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ContaBUTTON-generar W-Win
ON CHOOSE OF ContaBUTTON-generar IN FRAME F-Main /* Generar Packing */
DO:
...
FOR EACH ccbcdocu WHERE ccbcdocu.codcia = s-codcia and
    ...
    ASSIGN 
            T-ccbcdocu.tfechaentrega = get-fentrega(T-CcbCDocu.codped, T-ccbcdocu.nroped)
            T-ccbcdocu.tlugarentrega = lugar-entrega(t-CcbCDocu.codped, t-ccbcdocu.nroped)
            .
    /*
    x-col-fentrega
    x-col-lugent
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RADIO-SET-aquien FILL-IN-divi-ori FILL-IN-desde FILL-IN-hasta 
         FILL-IN-entrega-desde FILL-IN-entrega-hasta TOGGLE-pendientes 
         FILL-IN-divi-despacho FILL-IN-OD FILL-IN-nomcli RADIO-SET-cliente 
         BUTTON-refrescar BROWSE-20 ContaBUTTON-generar 
      WITH FRAME F-Main IN WINDOW W-Win.
...
IF radio-set-aquien = 1 THEN DO:
    RUN procesar-urbano.
END.
IF radio-set-aquien = 2 THEN DO:
    RUN procesar-scharff.
END.
IF radio-set-aquien = 3 THEN DO:
    RUN procesar-filly.
END.
...
END.
IF radio-set-aquien = 3 THEN DO:
    c-xls-file = lDirectorio + "\Filly-" + x-tiempo + ".xlsx".

    run pi-crea-archivo-csv IN hProc (input  buffer ttFilly:handle,
                            /*input  session:temp-directory + "file"*/ c-xls-file,
                            output c-csv-file) .

    run pi-crea-archivo-xls  IN hProc (input  buffer ttFilly:handle,
                            input  c-csv-file,
                            output c-xls-file) .
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE procesar-filly W-Win 
PROCEDURE procesar-filly :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE VAR x-contacto AS CHAR.
DEFINE VAR x-email AS CHAR.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    DO x-Cont = 1 TO x-totregs :
        IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(x-cont) THEN DO:
            ...
            x-email = "".
            FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = s-codcia AND
                                x-faccpedi.coddoc = x-codorden AND          /* O/D */
            ...
            IF AVAILABLE x-faccpedi THEN DO:
                ...
                x-contacto = x-faccpedi.ContactReceptorName.
                x-codped = x-faccpedi.codref.       /* PED */
                x-nroped = x-faccpedi.nroref.
                /* Pedido logistico */
                FIND FIRST y-faccpedi WHERE y-faccpedi.codcia = s-codcia AND
                                    y-faccpedi.coddoc = x-faccpedi.codref AND          /* PED */
                                    y-faccpedi.nroped = x-faccpedi.nroref NO-LOCK NO-ERROR.
                IF AVAILABLE y-faccpedi THEN DO:
                    x-codcot = y-faccpedi.codref.
                    x-nrocot = y-faccpedi.nroref.
                    /* Pedido Comercial */
                    FIND FIRST y-faccpedi WHERE y-faccpedi.codcia = s-codcia AND
                                        y-faccpedi.coddoc = x-codcot AND          /* COT */
                                        y-faccpedi.nroped = x-nrocot NO-LOCK NO-ERROR.
                    IF AVAILABLE y-faccpedi THEN DO:
                        x-email = y-faccpedi.e-mail.
                    END.
                END.
            END.
            ...
            IF NOT LOCKED vtatabla THEN DO:
                ...
                CREATE ttFilly.
                    ...
                    ASSIGN  ttFilly.tnroguia = x-nroorden
                            ttFilly.tnomcli = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.nomcli
                            ttFilly.temailcli = x-email
                            ttFilly.tcelular = x-telf
                            ttFilly.tdnicli = x-dni
                            ttFilly.torigen = "CD CONTINENTAL"
                            ttFilly.tdireccion1 = x-lugent
                            ttFilly.treferencia1 = x-referencia
                            ttFilly.tindicaciones = ""
                            ttFilly.ttalla = ""
                            ttFilly.tcoditem = x-nroorden
                            ttFilly.tdesitem = "PAQUETE"
                            ttFilly.tbultos = x-piezas
                            .

                /* Talla *x-peso */
                COURIER_TALLAS:
                FOR EACH y-vtatabla WHERE y-vtatabla.codcia = s-codcia AND
                                            y-vtatabla.tabla = x-vtatabla AND
                                            y-vtatabla.llave_c1 = x-llave_c1 AND
                                            y-vtatabla.llave_c2 = y-llave_c2 AND
                                            y-vtatabla.llave_c3 = y-llave_c3 NO-LOCK:
                    IF (x-peso >= y-vtatabla.rango_valor[1] AND x-peso <= y-vtatabla.rango_valor[2]) THEN DO:
                        ASSIGN ttFilly.ttalla = TRIM(y-vtatabla.llave_c4).
                        LEAVE COURIER_TALLAS.
                    END.
                END.                    

                /* 2do receptor a pedido Fernan - 26Ago2021 */
                FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = s-codcia AND
                                  x-faccpedi.coddoc = x-codped AND          /* PED */
                                  x-faccpedi.nroped = x-nroped NO-LOCK NO-ERROR.
                IF AVAILABLE x-faccpedi THEN DO:
                    FIND FIRST x-vtatabla WHERE x-vtatabla.codcia = s-codcia AND
                                                x-vtatabla.tabla = x-vtatabla AND
                                                x-vtatabla.llave_c1 = x-llave_c1 AND
                                                x-vtatabla.llave_c2 = x-llave_c2 AND
                                                x-vtatabla.llave_c3 = x-faccpedi.nroref NO-LOCK NO-ERROR. /* COT */
                    IF AVAILABLE x-vtatabla THEN DO:
                        ASSIGN ttFilly.tindicaciones  = TRIM(x-vtatabla.llave_c5) + " " + TRIM(x-vtatabla.libre_c02) + " " + TRIM(x-vtatabla.libre_c01) + " " + TRIM(x-vtatabla.libre_c03).
                    END.
                END.
            END.
        END.
...
/*
    ...
    FIELD   tlongitud         AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "Longitud"
    FIELD   tindicaciones   AS  CHAR    FORMAT 'x(12)'  COLUMN-LABEL "Indicaciones"
    FIELD   tcoditem        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Codigo Item"
    FIELD   tdesitem        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Descripcion Item"
    FIELD   tbultos        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Bultos"
    FIELD   ttalla        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Talla"
    FIELD   tnombre_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Nombre 2"
    FIELD   temail_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Email 2"
    FIELD   tcelular_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Celular 2"
    FIELD   tdni_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "DNI 2"
    FIELD   treferencia_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Referencia 2"
    FIELD   tlatitud_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "Latitud 2"
    FIELD   tlongitud_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "longitud 2"
    FIELD   tindicaciones_2        AS  CHAR    FORMAT 'x(15)'   COLUMN-LABEL "indicaciones 2"
*/
            ...
            IF NOT LOCKED vtatabla THEN DO:
                ...
                CREATE ttScharff.
                    ASSIGN  ttScharff.tcodclie = x-codconti
                            ...
                            ttScharff.tcontacto = x-contacto
                ...
                IF AVAILABLE x-faccpedi THEN DO:
                    FIND FIRST x-vtatabla WHERE x-vtatabla.codcia = s-codcia AND
                                                ...
                                                x-vtatabla.llave_c3 = x-faccpedi.nroref NO-LOCK NO-ERROR. /* COT */
                    IF AVAILABLE x-vtatabla THEN DO:
                        ASSIGN ttScharff.tdnicontacto2  = TRIM(x-vtatabla.llave_c4) + " " + TRIM(x-vtatabla.llave_c5)
                                ttScharff.tcontacto2    = TRIM(x-vtatabla.libre_c02) + " " + TRIM(x-vtatabla.libre_c01)
                                ttScharff.tcellcontacto2 = TRIM(x-vtatabla.libre_c03).
                    END.
                END.
            END.
        END.
    ...
    DO x-Cont = 1 TO x-totregs :
        IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(x-cont) THEN DO:
            FIND ORDENES WHERE ORDENES.codcia = s-codcia AND
                ORDENES.coddoc = T-CcbCDocu.Libre_c01 AND       /* O/D */
                ORDENES.nroped = T-CcbCDocu.Libre_c02
                NO-LOCK NO-ERROR.

            FIND FIRST t-faccpedi WHERE t-faccpedi.codcia = s-codcia AND
                                        t-faccpedi.coddoc = Ordenes.codref AND      /* PED */
                                        t-faccpedi.nroped = Ordenes.nroref NO-LOCK NO-ERROR.

            x-codCot = "".
            x-codCot = "".
            IF AVAILABLE t-faccpedi THEN DO:
                x-codCot = t-faccpedi.codref.       /* COT */
                x-nroCot = t-faccpedi.nroref.
                FIND FIRST t-faccpedi WHERE t-faccpedi.codcia = s-codcia AND
                                            t-faccpedi.coddoc = x-codCot AND      /* COT */
                                            t-faccpedi.nroped = x-nroCot NO-LOCK NO-ERROR.
            END.
            ELSE DO:
                /**/
            END.
            ...
            IF NOT LOCKED vtatabla THEN DO:
                ...
                CREATE ttPacking.
                    ...
                    ttelefono   = t-faccpedi.TelephoneContactReceptor               /*gn-clie.telfnos[1]*/
                    treceptor   = ""    /*t-faccpedi.ContactReceptorName*/
                    temail      = t-faccpedi.e-mail
                        .
                IF AVAILABLE ORDENES THEN
                    ASSIGN
                    tcodsegui = ORDENES.nroped
                    tdocref   = ORDENES.nroped.
                /*
                IF AVAILABLE t-faccpedi THEN DO:
                    ASSIGN ttPacking.treceptor = 
                END.
                */
                /* 2do receptor a pedido Fernan - 31Mar2022 */
                IF AVAILABLE t-faccpedi THEN DO:
                    FIND FIRST x-vtatabla WHERE x-vtatabla.codcia = s-codcia AND
                                                x-vtatabla.tabla = x-vtatabla AND
                                                x-vtatabla.llave_c1 = x-llave_c1 AND
                                                x-vtatabla.llave_c2 = x-llave_c2 AND
                                                x-vtatabla.llave_c3 = t-faccpedi.nroped NO-LOCK NO-ERROR. /* COT */
                    IF AVAILABLE x-vtatabla THEN DO:
                        /*ASSIGN ttFilly.tindicaciones  = TRIM(x-vtatabla.llave_c5) + " " + TRIM(x-vtatabla.libre_c02) + " " + TRIM(x-vtatabla.libre_c01) + " " + TRIM(x-vtatabla.libre_c03).*/
                        ASSIGN ttPacking.treceptor = TRIM(x-vtatabla.llave_c5) + " " + TRIM(x-vtatabla.libre_c02) + " " + TRIM(x-vtatabla.libre_c01) + " " + TRIM(x-vtatabla.libre_c03).
                    END.
                END.
            END.
        END.
