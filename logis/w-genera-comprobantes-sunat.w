...
BUTTON_Limpiar-Filtro BUTTON_Fraccionar BUTTON-1 BUTTON-create BUTTON-exit 
...
DEFINE FRAME F-Main
     ...
     BUTTON_Limpiar-Filtro AT ROW 1.54 COL 71.14 WIDGET-ID 38
     BUTTON_Fraccionar AT ROW 1 COL 121 WIDGET-ID 22
     BUTTON-1 AT ROW 5.58 COL 122 WIDGET-ID 20
     BUTTON-create-2 AT ROW 6.65 COL 122 WIDGET-ID 26
     BUTTON-create AT ROW 7.73 COL 122 WIDGET-ID 24
     BUTTON-exit AT ROW 8.88 COL 122 WIDGET-ID 28
     "# de PHR:" VIEW-AS TEXT
          SIZE 17 BY 1.35 AT ROW 1.54 COL 15.86 WIDGET-ID 32
          FONT 8
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-size IN h_b-genera-comprobantes-cab ( 9.19 , 119.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 FILL-IN_NroPHR BUTTON_Filtro BUTTON_Limpiar-Filtro 
         BUTTON_Fraccionar BUTTON-1 BUTTON-create BUTTON-exit 
      WITH FRAME F-Main IN WINDOW W-Win.
