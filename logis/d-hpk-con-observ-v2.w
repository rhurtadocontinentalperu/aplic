...
DEFINE VARIABLE h_t-hpk-con-obs-det-v2 AS HANDLE NO-UNDO.

/* Definitions of the field level widgets                               */
DEFINE BUTTON Btn_Cancel AUTO-END-KEY 
     LABEL "SALIR SIN CERRAR" 
     SIZE 26 BY 1.15
     BGCOLOR 8 .
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 22 COL 29
     Btn_Cancel AT ROW 22 COL 56
     SPACE(57.56) SKIP(0.42)
...
DO:  
  /* Add Trigger to equate WINDOW-CLOSE to END-ERROR. */
    MESSAGE 'Salimos sin cerrar?' VIEW-AS ALERT-BOX QUESTION
...
ON CHOOSE OF Btn_Cancel IN FRAME D-Dialog /* SALIR SIN CERRAR */
DO:
    MESSAGE 'Salimos sin cerrar?' VIEW-AS ALERT-BOX QUESTION
        BUTTONS YES-NO UPDATE rpta AS LOG.
    IF rpta = NO THEN RETURN NO-APPLY.
...
ON CHOOSE OF Btn_OK IN FRAME D-Dialog /* CERRAR TAREA */
DO:
  ...
  RUN Cerrar-Tarea IN h_t-hpk-con-obs-det-v2 ( OUTPUT pMensaje /* CHARACTER */).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/logis/t-hpk-con-obs-det-v2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-hpk-con-obs-det-v2 ).
       RUN set-position IN h_t-hpk-con-obs-det-v2 ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-hpk-con-obs-det-v2 ( 20.46 , 136.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv96 ).
       RUN set-position IN h_p-updv96 ( 21.73 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96 ( 1.54 , 26.14 ) NO-ERROR.

       /* Links to SmartBrowser h_t-hpk-con-obs-det-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv96 , 'TableIO':U , h_t-hpk-con-obs-det-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv96 ,
             h_t-hpk-con-obs-det-v2 , 'AFTER':U ).
    END. /* Page 0 */
...
END.
RUN Carga-Temporal IN h_t-hpk-con-obs-det-v2
