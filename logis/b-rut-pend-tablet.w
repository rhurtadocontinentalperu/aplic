...
&Scoped-define INTERNAL-TABLES t-VtaCDocu DI-RutaC

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table t-VtaCDocu.NroPed DI-RutaC.Observ ~
t-VtaCDocu.Items 
...
&Scoped-define QUERY-STRING-br_table FOR EACH t-VtaCDocu WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND DI-RutaC.NroDoc = t-VtaCDocu.NroPed OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH t-VtaCDocu WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND DI-RutaC.NroDoc = t-VtaCDocu.NroPed OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table t-VtaCDocu DI-RutaC
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DI-RutaC.Observ COLUMN-LABEL "Observaciones" FORMAT "x(60)":U
            WIDTH 41.86
      t-VtaCDocu.Items FORMAT ">>>,>>9":U WIDTH 5.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 64 BY 21.81
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 1 WIDGET-ID 4
...
"t-VtaCDocu.NroPed" "NroOri" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.DI-RutaC.Observ
"DI-RutaC.Observ" "Observaciones" ? "character" ? ? ? ? ? ? no ? no no "41.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.t-VtaCDocu.Items
"t-VtaCDocu.Items" ? ? "integer" ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Second-Process B-table-Win 
...
/*           THEN t-vtacdocu.libre_d01 = t-vtacdocu.libre_d01 + 1. */
      t-vtacdocu.libre_d01 = t-vtacdocu.libre_d01 + 1.
  END.
