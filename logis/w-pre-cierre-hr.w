...
/* RHC 04/06/2019 */
/* 06/05/2023 */
s-FlgEst = "P".     /* Despacho por Sectores */
FIND gn-divi WHERE gn-divi.codcia = s-codcia AND gn-divi.coddiv = s-coddiv NO-LOCK.
CASE gn-divi.Campo-Char[6]:
    WHEN "PR" THEN s-FlgEst = "PR".     /* Despacho por Rutas */
END CASE.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CIERRE 1 DE HOJAS DE RUTA"
         HEIGHT             = 25.12
         WIDTH              = 161.86
         MAX-HEIGHT         = 25.35
         MAX-WIDTH          = 161.86
...
ON END-ERROR OF W-Win /* CIERRE 1 DE HOJAS DE RUTA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CIERRE 1 DE HOJAS DE RUTA */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-precierre-hr-det-d ( 9.88 , 3.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-size IN h_b-cierre-hr-det-dg ( 15.88 , 107.00 ) NO-ERROR.
