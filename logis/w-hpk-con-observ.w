...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1.27 COL 74 WIDGET-ID 2
     BUTTON-2 AT ROW 2.62 COL 74 WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-hpk-con-obs-acum-2 ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-con-obs-acum-2 ( 6.69 , 67.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-hpk-con-obs-det-2 ( 8.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-hpk-con-obs-det-2 ( 15.08 , 90.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv97-2 ).
       RUN set-position IN h_p-updv97-2 ( 23.62 , 2.00 ) NO-ERROR.
