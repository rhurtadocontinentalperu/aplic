...
&Scoped-define INTERNAL-TABLES DI-RutaD FacCPedi
...
FacCPedi.Hora FacCPedi.Items FacCPedi.Peso FacCPedi.Volumen ~
FacCPedi.AcuBon[8] fEstado() @ x-Estado FacCPedi.AcuBon[9] FacCPedi.NomCli ~
FacCPedi.FchEnt 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH DI-RutaD OF DI-RutaC  WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND FacCPedi.NroPed = DI-RutaD.NroRef NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table DI-RutaD FacCPedi
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fCuentaHPK B-table-Win 
FUNCTION fCuentaHPK RETURNS INTEGER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DI-RutaD.NroRef FORMAT "X(9)":U WIDTH 8.57
      FacCPedi.Hora FORMAT "X(5)":U WIDTH 6.43
      FacCPedi.Items FORMAT "->,>>>,>>9":U WIDTH 4.86
      FacCPedi.Peso FORMAT "->>,>>9.9999":U WIDTH 7.43
      FacCPedi.Volumen FORMAT "->>,>>9.9999":U WIDTH 8.43
      ...
      FacCPedi.AcuBon[9] COLUMN-LABEL "Bultos" FORMAT ">>>,>>9":U
            WIDTH 4.72
      FacCPedi.NomCli FORMAT "x(100)":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.DI-RutaD OF INTEGRAL.DI-RutaC ,INTEGRAL.FacCPedi WHERE INTEGRAL.DI-RutaD ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _JoinCode[2]      = "FacCPedi.CodCia = DI-RutaD.CodCia
  AND FacCPedi.CodDoc = DI-RutaD.CodRef
  AND FacCPedi.NroPed = DI-RutaD.NroRef"
     _FldNameList[1]   = INTEGRAL.DI-RutaD.CodRef
     _FldNameList[2]   > INTEGRAL.DI-RutaD.NroRef
"DI-RutaD.NroRef" ? ? "character" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.FacCPedi.Hora
"FacCPedi.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.FacCPedi.Items
"FacCPedi.Items" ? ? "integer" ? ? ? ? ? ? no ? no no "4.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.FacCPedi.Peso
"FacCPedi.Peso" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacCPedi.Volumen
"FacCPedi.Volumen" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.FacCPedi.AcuBon[8]
"FacCPedi.AcuBon[8]" "Importe" ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"fEstado() @ x-Estado" "Estado" "x(20)" ? ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.FacCPedi.AcuBon[9]
"FacCPedi.AcuBon[9]" "Bultos" ">>>,>>9" "decimal" ? ? ? ? ? ? no ? no no "4.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fCuentaHPK B-table-Win 
FUNCTION fCuentaHPK RETURNS INTEGER
...
DEF VAR x-CuentaHPK AS INT NO-UNDO.
  ...
  RETURN x-CuentaHPK.   /* Function return value. */
