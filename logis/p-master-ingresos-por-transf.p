...
CASE TRUE:
    WHEN x-Sloting = YES AND x-BarrCode = YES THEN RUN alm/w-chk-ing-tra-otr-v2.w ("BC").
    WHEN x-Sloting = YES AND x-BarrCode = NO  THEN RUN alm/w-chk-ing-tra-otr-v2.w ("M").
    WHEN x-Sloting = NO  AND x-BarrCode = YES THEN RUN alm/w-chk-ing-tra-otr.w ("BC").
    WHEN x-Sloting = NO  AND x-BarrCode = NO  THEN RUN alm/w-chk-ing-tra-otr.w ("M").
END CASE.
