...
DEFINE TEMP-TABLE t-vtacdocu LIKE vtacdocu.
...
tt-VtaCDocu.FchEnt tt-VtaCDocu.ZonaPickeo tt-VtaCDocu.Items ~
...
f-total-hpk-asig() @ x-col-total-hpk-asig ~
f-total-item-asig() @ x-col-total-item-asig ~
...
&Scoped-Define ENABLED-OBJECTS RECT-1 FILL-IN-phr FILL-IN-FchEnt-1 ~
FILL-IN-FchEnt-2 BUTTON-3 FILL-IN-Nombre-Picador BUTTON-4 BUTTON-2 ~
COMBO-BOX-Tipo COMBO-BOX-Sector BROWSE-5 BROWSE-3 BROWSE-6 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-desde FILL-IN-hasta FILL-IN-phr ~
FILL-IN-FchEnt-1 FILL-IN-FchEnt-2 FILL-IN-Nombre-Picador COMBO-BOX-Tipo ~
COMBO-BOX-Sector FILL-IN-Items 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 81.72 BY 16.12
         FONT 4
         TITLE "HPK para asignar" FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-5 W-Win _STRUCTURED
  QUERY BROWSE-5 NO-LOCK DISPLAY
      ...
      tt-rut-pers-turno.turno COLUMN-LABEL "TURNO" FORMAT "x(15)":U
            WIDTH 9.14
      f-total-hpk-asig() @ x-col-total-hpk-asig COLUMN-LABEL "#HPK" FORMAT ">>9":U
            WIDTH 5.43
      f-total-item-asig() @ x-col-total-item-asig COLUMN-LABEL "#Items" FORMAT ">>>9":U
...
DEFINE FRAME F-Main
     ...
     FILL-IN-FchEnt-1 AT ROW 2.08 COL 29 COLON-ALIGNED WIDGET-ID 40
     FILL-IN-FchEnt-2 AT ROW 2.08 COL 50 COLON-ALIGNED WIDGET-ID 42
     ...
     BUTTON-2 AT ROW 2.88 COL 10 WIDGET-ID 6
     COMBO-BOX-Tipo AT ROW 3.15 COL 29 COLON-ALIGNED WIDGET-ID 36
     COMBO-BOX-Sector AT ROW 3.15 COL 60 COLON-ALIGNED WIDGET-ID 38
     BROWSE-5 AT ROW 3.31 COL 84.86 WIDGET-ID 300
     BROWSE-3 AT ROW 4.23 COL 2 WIDGET-ID 200
     ...
     RECT-1 AT ROW 1 COL 3 WIDGET-ID 34
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-5 COMBO-BOX-Sector F-Main */
...
/* Query rebuild information for BROWSE BROWSE-3
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-VtaCDocu.CodRef|yes,Temp-Tables.tt-VtaCDocu.NroRef|yes,Temp-Tables.tt-VtaCDocu.CodPed|yes,Temp-Tables.tt-VtaCDocu.NroPed|yes"
...
"tt-VtaCDocu.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-VtaCDocu.FchEnt
...
"tt-rut-pers-turno.rol" "ROL" ? "character" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"f-total-hpk-asig() @ x-col-total-hpk-asig" "#HPK" ">>9" ? ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"f-total-item-asig() @ x-col-total-item-asig" "#Items" ">>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"tt-rut-pers-turno.hinicio @ x-hora-inicio-col" "Inicio" ? ? ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"tt-rut-pers-turno.htermino @ x-hora-termino-col" "Termino" ? ? ? ? ? ? ? ? no ? no no "5.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-5 */
&ANALYZE-RESUME
...
ON MOUSE-SELECT-DBLCLICK OF BROWSE-3 IN FRAME F-Main /* HPK para asignar */
DO:
...
DO:
  ...
  ASSIGN fill-in-phr COMBO-BOX-Sector COMBO-BOX-Tipo fill-in-desde fill-in-hasta.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-desde FILL-IN-hasta FILL-IN-phr FILL-IN-FchEnt-1 
          FILL-IN-FchEnt-2 FILL-IN-Nombre-Picador COMBO-BOX-Tipo 
          COMBO-BOX-Sector FILL-IN-Items 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-1 FILL-IN-phr FILL-IN-FchEnt-1 FILL-IN-FchEnt-2 BUTTON-3 
         FILL-IN-Nombre-Picador BUTTON-4 BUTTON-2 COMBO-BOX-Tipo 
         COMBO-BOX-Sector BROWSE-5 BROWSE-3 BROWSE-6 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH vtacdocu WHERE vtacdocu.codcia = s-codcia AND 
    ...
    /*tt-Vtacdocu.Items = Vtacdocu.Items.*/
...
FOR EACH x-vtacdocu USE-INDEX llave07 WHERE x-vtacdocu.codcia = s-codcia AND
    ...
    x-vtacdocu.codped = 'HPK' NO-LOCK:
    CREATE t-vtacdocu.
    BUFFER-COPY x-vtacdocu TO t-vtacdocu.
END.
