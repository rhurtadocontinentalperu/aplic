...
&Scoped-Define ENABLED-FIELDS VtaTabla.Llave_c1 VtaTabla.Llave_c2 
&Scoped-define ENABLED-TABLES VtaTabla
&Scoped-define FIRST-ENABLED-TABLE VtaTabla
&Scoped-Define DISPLAYED-FIELDS VtaTabla.Llave_c1 VtaTabla.Llave_c2 
...
DEFINE FRAME F-Main
     VtaTabla.Llave_c1 AT ROW 2 COL 17 COLON-ALIGNED WIDGET-ID 2
          LABEL "Dirección URL" FORMAT "x(256)"
          VIEW-AS FILL-IN 
          SIZE 81 BY 1
     VtaTabla.Llave_c2 AT ROW 3.15 COL 19 NO-LABEL WIDGET-ID 4
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 81 BY 12.92
     "Validador:" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 3.15 COL 9 WIDGET-ID 6
