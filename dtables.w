...
&Scoped-Define DATA-FIELD-DEFS "dtables.i"
&Scoped-Define DATA-TABLE-NO-UNDO NO-UNDO
&Scoped-define QUERY-STRING-Query-Main FOR EACH Almacen ~
      WHERE Almacen.CodCia = 1 NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Almacen ~
      WHERE Almacen.CodCia = 1 NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
...
"CodCia" "CodCia" ? ? "integer" ? ? ? ? ? ? yes ? no 3.43 yes ?
     _FldNameList[2]   > INTEGRAL.Almacen.CodAlm
"CodAlm" "CodAlm" ? ? "character" ? ? ? ? ? ? yes ? no 7.86 yes ?
