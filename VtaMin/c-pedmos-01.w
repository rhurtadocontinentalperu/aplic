...
&SCOPED-DEFINE l-lookup h_l-pedmos-01
...
DEFINE VARIABLE h_l-pedmos-01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamin/l-pedmos-01.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pedmos-01 ).
       RUN set-position IN h_l-pedmos-01 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-pedmos-01 ( 10.96 , 70.72 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pedmos-01. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pedmos-01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pedmos-01 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-pedmos-01 , 'AFTER':U ).
    END. /* Page 0 */
