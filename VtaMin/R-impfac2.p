...
DEFINE FRAME F-HdrFac
    HEADER
    "Especialistas en utiles escolares y de oficina" AT 20 SKIP
    SKIP(6)
    /*"N.I.T. 20100038146" AT 92 FORMAT "X(20)" SKIP*/
   ...
   /* 'NUEVO R.U.C 20100038146' AT 92  FORMAT "X(20)" SKIP*/
    ...
    CcbCDocu.NroRef AT 38 FORMAT "X(20)" SKIP(2)
...
DEFINE FRAME F-Ftrfac
    ...
    /*"Despues de su compra Usted tiene 07 días para efectuar su devolución" SKIP*/
    " " SKIP
    /*{&PRN6A} + C-INTERE + {&PRN6B} FORMAT "X(100)" AT 7  SKIP(1)*/
    /*"Almacen : " AT 7 C-DESALM SKIP */    /****   Add by C.Q. 17/03/2000  *****/
    'O.Compra: ' AT 3 CcbCDocu.NroOrd 
     CcbCDocu.ImpBrt AT 65 FORMAT ">>>,>>9.99"
    /*CcbCDocu.PorDto AT 76 FORMAT "->9.99"
    "%" FORMAT "X(1)"*/
    CcbCDocu.ImpDto AT 85 FORMAT ">>>,>>9.99"
    ccbcdocu.impvta AT 120 FORMAT ">>>,>>9.99" SKIP
    CcbCDocu.Glosa FORMAT "X(60)" AT 3
    ccbcdocu.PorIgv AT 73  FORMAT ">>9.99" "%" SKIP(1)
    ccbcdocu.impigv AT 65 FORMAT ">>>,>>9.99"
    imptotfac AT 85 FORMAT ">>>,>>9.99"
    IF ccbcdocu.codmon = 1 THEN "S/."  ELSE "US$" AT 102 FORMAT "XXX"
    {&PRN2} + {&PRN6A} ccbcdocu.imptot {&PRN6B} + {&PRN3} AT 106 SKIP
    WITH PAGE-BOTTOM NO-LABELS NO-BOX STREAM-IO WIDTH 200.
    
/*IF S-CODDIV = "00000" THEN DO:*/
 /*OUTPUT STREAM Reporte TO PRINTER VALUE(s-port-name) PAGE-SIZE 44.*/
 {lib/_printer-stream-to.i 44 REPORTE}

 PUT STREAM Reporte CONTROL {&PRN0} + {&PRN5A} + CHR(48) + {&PRN3}.    
/*
END.
ELSE DO:
...
FOR EACH ccbddocu OF ccbcdocu NO-LOCK ,
        ...
        BREAK BY ccbddocu.nrodoc 
              BY ccbddocu.NroItm:
    VIEW STREAM Reporte FRAME F-HdrFac.
    VIEW STREAM Reporte FRAME F-FtrFac.
    N-Item = N-Item + 1.
