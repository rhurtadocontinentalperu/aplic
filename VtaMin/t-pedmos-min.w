...
DEFINE VARIABLE T-DSCTOS AS DECI NO-UNDO.
...
DO:
   ...
   IF x-CanPed > 0 AND X-CanPed <> F-CanPed THEN F-CanPed = X-CanPed.
    RUN vtamin/PrecioListaMinorista (
                        s-CodDiv,
                        s-CodMon,
                        s-TpoCmb,
                        OUTPUT s-UndVta,
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
    ...
    {vtamin/i-pedmos-min.i &Tabla = "PEDI"}
