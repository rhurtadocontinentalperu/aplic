...
&Scoped-Define ENABLED-FIELDS CcbCDocu.FchDoc CcbCDocu.TpoCmb ~
CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.CodAnt CcbCDocu.CodCob ~
CcbCDocu.Libre_c01 CcbCDocu.Libre_c02 CcbCDocu.CodMon CcbCDocu.ImpTot 
&Scoped-define ENABLED-TABLES CcbCDocu
&Scoped-define FIRST-ENABLED-TABLE CcbCDocu
&Scoped-Define ENABLED-OBJECTS RECT-41 RECT-42 RECT-43 
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.NroDoc CcbCDocu.FchDoc ~
CcbCDocu.TpoCmb CcbCDocu.CodCli CcbCDocu.NomCli CcbCDocu.CodAnt ~
CcbCDocu.CodCob CcbCDocu.Libre_c01 CcbCDocu.Libre_c02 CcbCDocu.CodMon ~
CcbCDocu.ImpTot CcbCDocu.SdoAct CcbCDocu.usuario CcbCDocu.FlgUbi ~
CcbCDocu.FchUbi 
&Scoped-define DISPLAYED-TABLES CcbCDocu
&Scoped-define FIRST-DISPLAYED-TABLE CcbCDocu
&Scoped-Define DISPLAYED-OBJECTS F-Estado FILL-IN_NomOper 
...
DEFINE FRAME F-Main
     CcbCDocu.NroDoc AT ROW 1.54 COL 9 COLON-ALIGNED WIDGET-ID 36 FORMAT "XXX-XXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 13.72 BY 1
          FONT 0
     F-Estado AT ROW 1.54 COL 34 COLON-ALIGNED WIDGET-ID 20
     CcbCDocu.FchDoc AT ROW 1.54 COL 73 COLON-ALIGNED WIDGET-ID 24
          LABEL "Fecha de Registro"
          VIEW-AS FILL-IN 
          SIZE 11 BY 1
     CcbCDocu.TpoCmb AT ROW 2.62 COL 73 COLON-ALIGNED WIDGET-ID 52
          VIEW-AS FILL-IN 
          SIZE 8.57 BY 1
     CcbCDocu.CodCli AT ROW 4.23 COL 14 COLON-ALIGNED WIDGET-ID 14
          LABEL "Cliente" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 15 BY 1
     CcbCDocu.NomCli AT ROW 4.23 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 56 BY 1
     CcbCDocu.CodAnt AT ROW 5.58 COL 14 COLON-ALIGNED WIDGET-ID 72
          LABEL "DNI" FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 14.43 BY 1
     CcbCDocu.CodCob AT ROW 6.92 COL 14 COLON-ALIGNED WIDGET-ID 2
          LABEL "Operador" FORMAT "X(15)"
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     FILL-IN_NomOper AT ROW 8.27 COL 14 COLON-ALIGNED WIDGET-ID 6
     CcbCDocu.Libre_c01 AT ROW 9.62 COL 14 COLON-ALIGNED WIDGET-ID 8
          LABEL "ID Contrato" FORMAT "x(25)"
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
     CcbCDocu.Libre_c02 AT ROW 10.96 COL 14 COLON-ALIGNED WIDGET-ID 60
          LABEL "Pedido Venta" FORMAT "x(25)"
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
     CcbCDocu.CodMon AT ROW 12.31 COL 14 COLON-ALIGNED WIDGET-ID 64
          LABEL "Moneda"
          ...
          DROP-DOWN-LIST
          SIZE 8 BY 1
     CcbCDocu.ImpTot AT ROW 13.65 COL 14 COLON-ALIGNED WIDGET-ID 32
          LABEL "Importe" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11.43 BY 1
     CcbCDocu.SdoAct AT ROW 15.27 COL 14 COLON-ALIGNED WIDGET-ID 46
          LABEL "Saldo Actual"
          VIEW-AS FILL-IN 
          SIZE 11.43 BY 1
     CcbCDocu.usuario AT ROW 15.27 COL 71 COLON-ALIGNED WIDGET-ID 58
          LABEL "Solicitante"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     CcbCDocu.FlgUbi AT ROW 16.35 COL 71 COLON-ALIGNED WIDGET-ID 30
          LABEL "Autorizó" FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     CcbCDocu.FchUbi AT ROW 17.42 COL 71 COLON-ALIGNED WIDGET-ID 26
          LABEL "Fecha Autorizacion"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     RECT-41 AT ROW 1 COL 1 WIDGET-ID 66
     RECT-42 AT ROW 3.96 COL 1 WIDGET-ID 68
     RECT-43 AT ROW 15 COL 1 WIDGET-ID 70
...
/* SETTINGS FOR FILL-IN CcbCDocu.CodCob IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR COMBO-BOX CcbCDocu.CodMon IN FRAME F-Main
   EXP-LABEL                                                            */
