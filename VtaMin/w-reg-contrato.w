...
DEFINE VARIABLE h_v-reg-contrato AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90.86 BY 19.73 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'VtaMin/v-reg-contrato.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-reg-contrato ).
       RUN set-position IN h_v-reg-contrato ( 2.62 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.77 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/ccb/q-docmto-02.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-docmto-02 ).
       RUN set-position IN h_q-docmto-02 ( 1.27 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.15 , 16.00 ) */

       /* Links to SmartViewer h_v-reg-contrato. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_v-reg-contrato ).
       RUN add-link IN adm-broker-hdl ( h_q-docmto-02 , 'Record':U , h_v-reg-contrato ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv10 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-reg-contrato ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_q-docmto-02 ,
             h_v-reg-contrato , 'AFTER':U ).
    END. /* Page 0 */
