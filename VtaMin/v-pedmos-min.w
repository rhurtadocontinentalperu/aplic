...
FacCPedi.FlgIgv FacCPedi.FmaPgo FacCPedi.Libre_c03 FacCPedi.NroCard ~
FacCPedi.Libre_c04 FacCPedi.NroRef 
...
FacCPedi.CodMon FacCPedi.CodVen FacCPedi.FlgIgv FacCPedi.FmaPgo ~
FacCPedi.Libre_c03 FacCPedi.NroCard FacCPedi.Libre_c04 FacCPedi.NroRef 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.FlgSit AT ROW 1 COL 87 NO-LABEL
          VIEW-AS RADIO-SET VERTICAL
          RADIO-BUTTONS 
                    "Efectivo", "",
"Tarjeta de Crédito", "T":U,
"Vales Otros", "V":U,
"Vales Continental", "X":U,
"Vales MAESTRO", "M":U,
"Cupones", "C":U
          SIZE 17 BY 5.65
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.FchPed AT ROW 1 COL 115 COLON-ALIGNED
          LABEL "Fecha"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.NomCli AT ROW 1.81 COL 22 COLON-ALIGNED NO-LABEL
          ...
          SIZE 48 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.TpoCmb AT ROW 1.81 COL 115 COLON-ALIGNED
          LABEL "T/  Cambio"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ...
     FacCPedi.fchven AT ROW 2.62 COL 115 COLON-ALIGNED
     ...
     FacCPedi.Atencion AT ROW 3.42 COL 29 COLON-ALIGNED WIDGET-ID 4
          ...
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.ordcmp AT ROW 3.42 COL 115 COLON-ALIGNED WIDGET-ID 32
          LABEL "O/Compra"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.LugEnt AT ROW 4.23 COL 9 COLON-ALIGNED WIDGET-ID 20
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Cmpbnte AT ROW 4.23 COL 115 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
     ...
     FacCPedi.Glosa AT ROW 5.04 COL 6.28
          ...
          SIZE 62 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodMon AT ROW 5.04 COL 117 NO-LABEL
...
"US$", 2
     ...
     FacCPedi.FlgIgv AT ROW 5.85 COL 117 NO-LABEL WIDGET-ID 28
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", yes,
"No", no
...
DEFINE FRAME F-Main
     ...
     FacCPedi.Libre_c03 AT ROW 6.65 COL 85 COLON-ALIGNED HELP
          "" WIDGET-ID 6
          LABEL "Banco" FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-4 AT ROW 6.65 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     ...
     FacCPedi.Libre_c04 AT ROW 7.46 COL 85 COLON-ALIGNED WIDGET-ID 38
          LABEL "Tarjeta" FORMAT "x(2)"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FILL-IN-5 AT ROW 7.46 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     FacCPedi.NroRef AT ROW 8.27 COL 9 COLON-ALIGNED WIDGET-ID 10
          LABEL "Vitrinas" FORMAT "X(254)"
          VIEW-AS FILL-IN 
          SIZE 60 BY .81
          BGCOLOR 15 FGCOLOR 12 
     COMBO-BOX-Proveedor AT ROW 8.27 COL 85 COLON-ALIGNED WIDGET-ID 48
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.04 COL 110
     "Con IGV:" VIEW-AS TEXT
          SIZE 6.43 BY .81 AT ROW 5.85 COL 110 WIDGET-ID 26
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 1.27 COL 77
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
{vtamin/graba-totales-pedmos-min.i}
...
/*     END.                                                                                                  */
    ...
    * ****************** */
    /* CONTROL DE TARJETAS DE CREDITO */
    IF LOOKUP (FacCPedi.FlgSit:SCREEN-VALUE, 'V,X,M') > 0 AND FacCPedi.Atencion:SCREEN-VALUE = '' THEN DO:
