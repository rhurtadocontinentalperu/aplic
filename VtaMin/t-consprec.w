...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 106 BY 11.73
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 14.27 COL 8 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 14.27 COL 21.86 NO-LABEL
     F-ImpExo AT ROW 14.27 COL 33.86 NO-LABEL
     F-ImpDes AT ROW 14.31 COL 43.86 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 14.27 COL 56 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 14.27 COL 68.72 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 14.27 COL 81.29 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 14.27 COL 93.86 COLON-ALIGNED NO-LABEL
     RECT-1 AT ROW 1 COL 1
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.69 COL 74.43
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.69 COL 96
     "F11 => Ingresar Cantidad" VIEW-AS TEXT
          SIZE 18 BY .5 AT ROW 13.12 COL 3
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.69 COL 11.86
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.73 COL 46.43
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.69 COL 23.72
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.69 COL 34.29
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.73 COL 59.72
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.69 COL 86
...
/* BROWSE-TAB br_table TEXT-6 F-Main */
ASSIGN 
...
"PEDM.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" 14 ? ? ? ? ? no ?
