...
/* ***************************  Main Block  *************************** */
  ...
  IF Faccpedi.ImpDto2 > 0 THEN DO:
      CASE FacCPedi.FlgSit:
          ...
          END.
          WHEN "CD" THEN DO:
              CASE FacCPedi.Libre_c05:
                  WHEN "00755631" THEN DO:  /* Las restricciones están en vta2/i-pedido-utilex.i */
                      Faccpedi.ImpDto2 = MINIMUM(Faccpedi.ImpDto2, 500).   /* TOPE DE S/.500 (antes 25) */
                      IF x-ImpDto2 <> Faccpedi.ImpDto2 THEN DO:
                          FOR EACH Facdpedi OF Faccpedi WHERE Facdpedi.PorDto2 > 0:
                              Facdpedi.ImpDto2 = ROUND (Facdpedi.ImpDto2 * ( Faccpedi.ImpDto2 / x-ImpDto2 ), 2).
                          END.
                  ...
                  WHEN "4122" THEN DO:
                  END.
                  WHEN "2413" THEN DO:  /* UNIQUE */
                      Faccpedi.ImpDto2 = MINIMUM(Faccpedi.ImpDto2, 500).   /* TOPE DE S/.500 */
                      IF x-ImpDto2 <> Faccpedi.ImpDto2 THEN DO:
                          FOR EACH Facdpedi OF Faccpedi WHERE Facdpedi.PorDto2 > 0:
                              Facdpedi.ImpDto2 = ROUND (Facdpedi.ImpDto2 * ( Faccpedi.ImpDto2 / x-ImpDto2 ), 2).
                          END.
                      END.
                  END.
                  WHEN "45781" THEN DO:  /* ENCARTE */
                      Faccpedi.ImpDto2 = MINIMUM(Faccpedi.ImpDto2, 100).   /* TOPE DE S/.100 */
                      IF x-ImpDto2 <> Faccpedi.ImpDto2 THEN DO:
                          FOR EACH Facdpedi OF Faccpedi WHERE Facdpedi.PorDto2 > 0:
                              Facdpedi.ImpDto2 = ROUND (Facdpedi.ImpDto2 * ( Faccpedi.ImpDto2 / x-ImpDto2 ), 2).
                          END.
