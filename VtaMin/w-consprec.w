...
DEFINE NEW SHARED TEMP-TABLE PEDM LIKE INTEGRAL.Facdpedm
...
DEFINE VARIABLE h_t-consprec AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtamin/t-consprec.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-consprec ).
       RUN set-position IN h_t-consprec ( 1.19 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.23 , 108.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 15.42 , 2.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12 ( 1.42 , 34.14 ) NO-ERROR.

       /* Links to SmartBrowser h_t-consprec. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_t-consprec ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_t-consprec , 'AFTER':U ).
    END. /* Page 0 */
