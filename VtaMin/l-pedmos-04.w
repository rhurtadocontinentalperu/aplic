...
&SCOPED-DEFINE CONDICION ( FacCPedi.CodCia = S-CODCIA AND ~
                           ...
                           FacCPedi.NroPed BEGINS STRING(s-NroSer, '999') AND ~
                           FacCPedi.Usuario = input-var-2 AND ~
                           FacCPedi.FlgEst BEGINS input-var-3 )
...
<SORTBY-OPTIONS>
Código|y||integral.FacCPedi.CodCia|yes,integral.FacCPedi.CodDoc|yes,integral.FacCPedi.FchPed|no,integral.FacCPedi.NroPed|yes
Cliente|||integral.FacCPedi.CodCia|yes,integral.FacCPedi.NomCli|yes,integral.FacCPedi.FchPed|no
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Documento No." FORMAT "XXX-XXXXXXXX":U
...
"FacCPedi.NroPed" "Documento No." "XXX-XXXXXXXX" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY FacCPedi.CodCia BY FacCPedi.CodDoc BY FacCPedi.FchPed DESCENDING BY FacCPedi.NroPed
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Cliente':U THEN DO:
           &Scope SORTBY-PHRASE BY FacCPedi.CodCia BY FacCPedi.NomCli BY FacCPedi.FchPed DESCENDING
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
