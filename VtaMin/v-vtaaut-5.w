...
Faccpedm.NomCli Faccpedm.RucCli Faccpedm.Atencion Faccpedm.NroCard ~
Faccpedm.Cmpbnte Faccpedm.DirCli Faccpedm.TpoCmb Faccpedm.FmaPgo ~
Faccpedm.CodMon Faccpedm.CodVen Faccpedm.Glosa 
...
Faccpedm.FchPed Faccpedm.CodCli Faccpedm.NomCli Faccpedm.RucCli ~
Faccpedm.Atencion Faccpedm.NroCard Faccpedm.Cmpbnte Faccpedm.DirCli ~
Faccpedm.TpoCmb Faccpedm.FmaPgo Faccpedm.CodMon Faccpedm.CodVen ~
Faccpedm.Glosa 
&Scoped-define DISPLAYED-TABLES Faccpedm
&Scoped-define FIRST-DISPLAYED-TABLE Faccpedm
&Scoped-Define DISPLAYED-OBJECTS F-Estado F-Nomtar F-CndVta F-nomVen 
...
DEFINE FRAME F-Main
     Faccpedm.NroPed AT ROW 1 COL 9 COLON-ALIGNED
          LABEL "Pedido" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          FONT 0
     Faccpedm.FlgSit AT ROW 1 COL 42 NO-LABEL WIDGET-ID 14
...
"Tarjeta de Crédito", "T":U
     ...
     F-Estado AT ROW 1 COL 70.43 COLON-ALIGNED NO-LABEL
     Faccpedm.FchPed AT ROW 1 COL 97 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     Faccpedm.CodCli AT ROW 1.81 COL 9 COLON-ALIGNED HELP
          ""
          LABEL "Cliente"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.NomCli AT ROW 1.81 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 56 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.RucCli AT ROW 2.62 COL 9 COLON-ALIGNED
          LABEL "Ruc" FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.Atencion AT ROW 2.62 COL 29 COLON-ALIGNED WIDGET-ID 4
          LABEL "DNI" FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.NroCard AT ROW 3.42 COL 9 COLON-ALIGNED WIDGET-ID 8
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 3.42 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     Faccpedm.Cmpbnte AT ROW 3.42 COL 97 COLON-ALIGNED
          LABEL "Comprobante"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "FAC","TCK" 
          DROP-DOWN-LIST
          SIZE 6.72 BY 1
     Faccpedm.DirCli AT ROW 4.23 COL 9 COLON-ALIGNED
          LABEL "Direccion"
          VIEW-AS FILL-IN 
          SIZE 70 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.TpoCmb AT ROW 4.23 COL 97 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     Faccpedm.FmaPgo AT ROW 5.04 COL 3.86
          LABEL "Cond.Vta"
          VIEW-AS COMBO-BOX INNER-LINES 2
          LIST-ITEMS "000" 
          DROP-DOWN-LIST
          SIZE 6.86 BY 1
     F-CndVta AT ROW 5.04 COL 16 COLON-ALIGNED NO-LABEL
     Faccpedm.CodMon AT ROW 5.04 COL 99 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     Faccpedm.CodVen AT ROW 5.85 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 6.29 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-nomVen AT ROW 5.85 COL 16 COLON-ALIGNED NO-LABEL
     Faccpedm.Glosa AT ROW 6.65 COL 6.28
          LABEL "Glosa" FORMAT "X(100)"
          VIEW-AS FILL-IN 
          SIZE 70 BY .81
          BGCOLOR 11 FGCOLOR 9 
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 5.31 COL 92
     "Cancela con:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 1.12 COL 32 WIDGET-ID 18
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
    /*Verifica si existe correlativo para doc venta*/
    FIND FIRST ccbdterm WHERE
        CcbDTerm.CodCia = s-codcia AND
        CcbDTerm.CodDiv = s-coddiv AND
        CcbDTerm.CodDoc = Faccpedm.Cmpbnte AND
        CcbDTerm.CodTer = s-codter NO-LOCK NO-ERROR.
    IF NOT AVAILABLE ccbdterm THEN DO:
        MESSAGE
            "DOCUMENTO ' " Faccpedm.Cmpbnte " ' NO ESTA CONFIGURADO EN ESTE TERMINAL" SKIP
            "       COMUNIQUESE CON UN ENCARGADO DE SISTEMAS        "
...
------------------------------------------------------------------------------*/
  ...
  RUN vtamin/cancelar-pedido-mostrador-04 (ROWID(FacCPedm)).
...
/***
    IF AVAIL FacCorre THEN
        DISPLAY
            STRING(FacCorre.NroSer, '999') + STRING(FacCorre.Correlativo, '999999') @ FacCPedm.NroPed.
    ELSE DO:
        MESSAGE "       Correlativo no Disponible    " SKIP
                "Contactar a un encargado de sistemas"
...
DO WITH FRAME {&FRAME-NAME} :
    FIND FIRST PEDM NO-LOCK NO-ERROR.
    IF NOT AVAILABLE PEDM THEN DO:
