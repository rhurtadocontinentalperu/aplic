...
&Scoped-Define ENABLED-OBJECTS RECT-33 Btn_Done txtDniVale txtPassVale 
...
DEFINE VARIABLE h_b-tticketsv3 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vtamin/b-tticketsv3.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tticketsv3 ).
       RUN set-position IN h_b-tticketsv3 ( 2.58 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-tticketsv3 ( 17.69 , 43.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-tticketsv3. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-tticketsv3 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_Done:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-tticketsv3 ,
...
------------------------------------------------------------------------------*/
  DISPLAY txtDniVale txtPassVale 
      WITH FRAME D-Dialog.
  ENABLE RECT-33 Btn_Done txtDniVale txtPassVale 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  RUN Captura-Valores IN h_b-tticketsv3
