...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-3 br_table 
&Scoped-Define DISPLAYED-OBJECTS F-PorDes F-TotBrt F-ImpExo F-ValVta ~
F-ImpIsc F-ImpIgv F-ImpTot F-ImpDes F-ImpTot-S F-ImpTot-D 
...
DEFINE VARIABLE F-ImpTot-D AS DECIMAL FORMAT "Z,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 17 BY 1.08
     BGCOLOR 0 FGCOLOR 14 FONT 30 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PEDM.NroItm COLUMN-LABEL "No" FORMAT ">>>9":U
      PEDM.codmat COLUMN-LABEL "Articulo" FORMAT "X(17)":U
      Almmmatg.DesMat FORMAT "X(45)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)":U
      PEDM.UndVta COLUMN-LABEL "Undidad" FORMAT "x(10)":U
      PEDM.AlmDes COLUMN-LABEL "Alm!Des" FORMAT "x(3)":U
      PEDM.CanPed FORMAT ">>,>>9.99":U
      PEDM.PorDto FORMAT "->>9.99":U
      PEDM.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999":U
      PEDM.ImpLin FORMAT ">,>>>,>>9.99":U
  ENABLE
      PEDM.codmat
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 9.96 COL 7 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 9.96 COL 20.86 NO-LABEL
     F-ImpExo AT ROW 9.96 COL 32.86 NO-LABEL
     F-ValVta AT ROW 9.96 COL 55 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 9.96 COL 67.72 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 9.96 COL 80.29 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 9.96 COL 92.86 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 10 COL 42.86 COLON-ALIGNED NO-LABEL
     F-ImpTot-S AT ROW 11.38 COL 104.43 RIGHT-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpTot-D AT ROW 12.81 COL 86.43 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.42 COL 58.72
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.42 COL 45.43
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.38 COL 33.29
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.38 COL 10.86
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 9.38 COL 95
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 9.38 COL 73.43
     "F11 => Para Cantidades Mayor a 1" VIEW-AS TEXT
          SIZE 30 BY .5 AT ROW 8.73 COL 2
          FONT 6
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 9.38 COL 85
     "TOTAL A PAGAR" VIEW-AS TEXT
          SIZE 27 BY 1.35 AT ROW 11.23 COL 54 WIDGET-ID 50
          BGCOLOR 0 FGCOLOR 14 FONT 30
     "   $" VIEW-AS TEXT
          SIZE 5 BY 1.35 AT ROW 12.58 COL 82 WIDGET-ID 52
          BGCOLOR 0 FGCOLOR 14 FONT 30
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.38 COL 22.72
     " S/." VIEW-AS TEXT
          SIZE 4 BY 1.35 AT ROW 11.23 COL 83 WIDGET-ID 6
          BGCOLOR 0 FGCOLOR 14 FONT 30
     RECT-1 AT ROW 1 COL 1
     RECT-3 AT ROW 10.96 COL 1 WIDGET-ID 2
...
"PEDM.NroItm" "No" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.PEDM.codmat
"PEDM.codmat" "Articulo" "X(17)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PEDM.UndVta" "Undidad" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.PEDM.AlmDes
"PEDM.AlmDes" "Alm!Des" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.PEDM.CanPed
"PEDM.CanPed" ? ">>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.PEDM.PorDto
"PEDM.PorDto" ? "->>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.PEDM.PreUni
"PEDM.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.PEDM.ImpLin
"PEDM.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/* /* /*     IF pReturnValue = "OK" THEN RUN dispatch ('open-query'). */  */  */
...
DO:
   ...
   FIND Almmmate WHERE Almmmate.CodCia = S-CODCIA 
       ...
       AND Almmmate.CodMat = trim(SELF:SCREEN-VALUE) NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    RUN lib/_clavemin (OUTPUT x-rep).
    MESSAGE x-rep.
    IF x-rep = 'OK' THEN DO:
