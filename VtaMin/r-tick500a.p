...
FIND Gn-Divi WHERE Gn-Divi.codcia = Ccbcdocu.codcia
    ...
    NO-LOCK NO-ERROR.
IF AVAILABLE Gn-Divi THEN x-Tienda = GN-DIVI.DesDiv.
...
DISPLAY 
    ...
    "Telf: 427-6474     R.U.C. 20100038146" AT 1 FORMAT "X(40)" SKIP
...
PUT "GRACIAS POR SU COMPRA" AT 11 SKIP.
PUT "STANDFORD - CONTI" AT 13 SKIP(5).
