...
&Scoped-define QUERY-STRING-br_table FOR EACH T-VVALE WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      T-VVALE.NroSer FORMAT "999":U
      T-VVALE.NroDoc COLUMN-LABEL "Numero" FORMAT "999999":U
      T-VVALE.Valor FORMAT "->>,>>9.99":U
  ENABLE
      T-VVALE.NroSer
      T-VVALE.NroDoc
/* _UIB-CODE-BLOCK-END */
...
"T-VVALE.NroSer" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-VVALE.NroDoc
"T-VVALE.NroDoc" "Numero" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
    MESSAGE 'El número del vale de compra no es válido' VIEW-AS ALERT-BOX ERROR.
    APPLY 'ENTRY' TO T-VVALE.NroDoc IN BROWSE {&BROWSE-NAME}.
    RETURN 'ADM-ERROR'.
  END.
  ...
  THEN DO:
    MESSAGE 'El Vale de Compra ya ha sido registrado el día' VtaVVale.Fecha VtaVVale.Hora
