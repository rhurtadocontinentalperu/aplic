...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDM.codmat COLUMN-LABEL "Articulo" FORMAT "X(17)":U WIDTH 7
      Almmmatg.DesMat FORMAT "X(45)":U WIDTH 37.43
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 107 BY 9.04
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 11.23 COL 7 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 11.23 COL 20.86 NO-LABEL
     F-ImpExo AT ROW 11.23 COL 32.86 NO-LABEL
     F-ValVta AT ROW 11.23 COL 55 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 11.23 COL 67.72 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 11.23 COL 80.29 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 11.23 COL 92.86 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 11.27 COL 42.86 COLON-ALIGNED NO-LABEL
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.46 COL 22.72
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.46 COL 10.86
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.5 COL 45.43
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 10.46 COL 73.43
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 10.46 COL 85
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.46 COL 33.29
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 10.46 COL 95
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.5 COL 58.72
...
"Temp-Tables.PEDM.NroItm" "No" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.PEDM.codmat
"Temp-Tables.PEDM.codmat" "Articulo" "X(17)" "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > integral.Almmmatg.DesMat
"integral.Almmmatg.DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "37.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > integral.Almmmatg.DesMar
"integral.Almmmatg.DesMar" "Marca" "X(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.PEDM.UndVta
"Temp-Tables.PEDM.UndVta" "Undidad" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.PEDM.AlmDes
"Temp-Tables.PEDM.AlmDes" "Alm!Des" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.PEDM.CanPed
"Temp-Tables.PEDM.CanPed" ? ">>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.PEDM.PorDto
"Temp-Tables.PEDM.PorDto" ? "->>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.PEDM.PreUni
"Temp-Tables.PEDM.PreUni" "Precio!Unitario" ">>,>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.PEDM.ImpLin
"Temp-Tables.PEDM.ImpLin" ? ">,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
 RUN vtamin/D-VTAAUT-4 (OUTPUT x-codmat, OUTPUT x-canped).
...
------------------------------------------------------------------------------*/
  ...
  /* 01.09.10 NO control de stocks
  DEFINE VARIABLE S-StkComprometido AS DECIMAL NO-UNDO.
  RUN gn/Stock-Comprometido (PEDM.CodMat:SCREEN-VALUE IN BROWSE {&BROWSE-NAME},
