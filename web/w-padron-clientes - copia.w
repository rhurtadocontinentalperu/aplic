...
&Scoped-define INTERNAL-TABLES tgn-clie gn-clie GN-DIVI gn-ven

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 gn-clie.CodCli gn-clie.NomCli ~
gn-clie.CodDiv gn-clie.CodVen GN-DIVI.DesDiv gn-ven.NomVen gn-clie.Canal ~
gn-clie.GirCli gn-clie.ClfCom gn-clie.Telfnos[1] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH tgn-clie NO-LOCK, ~
      FIRST gn-clie OF tgn-clie NO-LOCK, ~
      EACH GN-DIVI WHERE GN-DIVI.CodDiv = tgn-clie.CodDiv ~
      AND GN-DIVI.CodCia = s-codcia NO-LOCK, ~
      EACH gn-ven WHERE gn-ven.CodVen = tgn-clie.CodVen ~
      AND gn-ven.CodCia = s-codcia NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH tgn-clie NO-LOCK, ~
      FIRST gn-clie OF tgn-clie NO-LOCK, ~
      EACH GN-DIVI WHERE GN-DIVI.CodDiv = tgn-clie.CodDiv ~
      AND GN-DIVI.CodCia = s-codcia NO-LOCK, ~
      EACH gn-ven WHERE gn-ven.CodVen = tgn-clie.CodVen ~
      AND gn-ven.CodCia = s-codcia NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 tgn-clie gn-clie GN-DIVI gn-ven
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 tgn-clie
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      gn-clie.CodCli FORMAT "x(11)":U WIDTH 12.43
      gn-clie.NomCli FORMAT "x(100)":U WIDTH 45.43
      ...
      gn-clie.Canal COLUMN-LABEL "Grupo de Cliente" FORMAT "x(8)":U
      gn-clie.GirCli COLUMN-LABEL "Giro" FORMAT "X(8)":U
      gn-clie.ClfCom COLUMN-LABEL "Sector Económico" FORMAT "x(8)":U
      gn-clie.Telfnos[1] COLUMN-LABEL "Telefono" FORMAT "X(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-2
     _TblList          = "Temp-Tables.tgn-clie,INTEGRAL.gn-clie OF Temp-Tables.tgn-clie,INTEGRAL.GN-DIVI WHERE Temp-Tables.tgn-clie ...,INTEGRAL.gn-ven WHERE Temp-Tables.tgn-clie ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = "USED, FIRST USED,,"
     _JoinCode[3]      = "INTEGRAL.GN-DIVI.CodDiv = Temp-Tables.tgn-clie.CodDiv"
     _Where[3]         = "INTEGRAL.GN-DIVI.CodCia = s-codcia"
     _JoinCode[4]      = "INTEGRAL.gn-ven.CodVen = Temp-Tables.tgn-clie.CodVen"
     _Where[4]         = "INTEGRAL.gn-ven.CodCia = s-codcia"
     _FldNameList[1]   > INTEGRAL.gn-clie.CodCli
"gn-clie.CodCli" ? ? "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.gn-clie.NomCli
"gn-clie.NomCli" ? "x(100)" "character" ? ? ? ? ? ? no ? no no "45.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.gn-clie.CodDiv
"gn-clie.CodDiv" ? "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.gn-clie.CodVen
"gn-clie.CodVen" "Vendedor" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[7]   > INTEGRAL.gn-clie.Canal
"gn-clie.Canal" "Grupo de Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.gn-clie.GirCli
"gn-clie.GirCli" "Giro" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.gn-clie.ClfCom
"gn-clie.ClfCom" "Sector Económico" "x(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > INTEGRAL.gn-clie.Telfnos[1]
"gn-clie.Telfnos[1]" "Telefono" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON END-ERROR OF W-Win /* PADRON DE CLIENTES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PADRON DE CLIENTES */
DO:
...
/*         NO-LOCK NO-ERROR.                                                      */
/*     IF AVAILABLE Ccbcdocu THEN RETURN ERROR.                                   */
/*     RETURN.                                                                    */
/* END.                                                                           */
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tgn-clie"}
