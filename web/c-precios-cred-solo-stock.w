...
&SCOPED-DEFINE l-lookup h_l-precios-cred-solo-stock
...
DEFINE VARIABLE h_l-precios-cred-solo-stock AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/l-precios-cred-solo-stock.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Codigo':U ,
             OUTPUT h_l-precios-cred-solo-stock ).
       RUN set-position IN h_l-precios-cred-solo-stock ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_l-precios-cred-solo-stock ( 15.50 , 117.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_l-precios-cred-solo-stock , 'Record':U , h_v-detart ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-precios-cred-solo-stock ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-detart ,
             h_l-precios-cred-solo-stock , 'AFTER':U ).
    END. /* Page 0 */
