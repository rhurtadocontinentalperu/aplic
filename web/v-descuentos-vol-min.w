...
DEFINE FRAME F-Main
     ...
     VtaListaMinGn.DtoVolD[9] AT ROW 10.69 COL 17.72 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
     VtaListaMinGn.DtoVolR[10] AT ROW 11.5 COL 3 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     VtaListaMinGn.DtoVolD[10] AT ROW 11.5 COL 17.72 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.29 BY .81
...
DO x-Orden = 1 TO 10 WITH FRAME {&FRAME-NAME}:
    x-PorDto =  INPUT VtaListaMinGn.DtoVolD[x-Orden].
