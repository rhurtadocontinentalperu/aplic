...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PREPARAR PLANTILLA DESCUENTOS POR VOLUMEN  - POR DIVISION"
         HEIGHT             = 25.62
         WIDTH              = 107.43
         MAX-HEIGHT         = 25.62
         MAX-WIDTH          = 111.14
...
ON END-ERROR OF W-Win /* PREPARAR PLANTILLA DESCUENTOS POR VOLUMEN  - POR DIVISION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PREPARAR PLANTILLA DESCUENTOS POR VOLUMEN  - POR DIVISION */
DO:
...
DO:
  ...
  IF SELF:SCREEN-VALUE <> 'Todas' THEN DO:
      FOR EACH almsfami NO-LOCK WHERE almsfami.codcia = s-codcia
          ...
          COMBO-BOX-SubFam:ADD-LAST(AlmSFami.subfam + ' - ' + AlmSFami.dessub, AlmSFami.subfam).
      END.
  END.
  ASSIGN
...
------------------------------------------------------------------------------*/
  ...
  ENABLE COMBO-BOX-CodFam COMBO-BOX-SubFam x-CodPro x-DesMar BUTTON-1 BROWSE-2 
      WITH FRAME F-Main IN WINDOW W-Win.
...
/*     chWorkSheet:Range("G2"):Value = "PRECIO LISTA S/."   */
    ...
    chWorkSheet:Range("S2"):Value = "MINIMO 6"
    chWorkSheet:Range("T2"):Value = "DESCUENTO 6"
    chWorkSheet:Range("U2"):Value = "MINIMO 7"
    chWorkSheet:Range("V2"):Value = "DESCUENTO 7"
    chWorkSheet:Range("W2"):Value = "MINIMO 8"
    chWorkSheet:Range("X2"):Value = "DESCUENTO 8"
    chWorkSheet:Range("Y2"):Value = "MINIMO 9"
    chWorkSheet:Range("Z2"):Value = "DESCUENTO 9"
    chWorkSheet:Range("AA2"):Value = "MINIMO 10"
    chWorkSheet:Range("AB2"):Value = "DESCUENTO 10".
...
/*     x-CtoTot = x-Ctotot * f-Factor.                         */
    ...
    ASSIGN
        t-Column = t-Column + 1
        chWorkSheet:Cells(t-Row, t-Column):VALUE = (IF AVAILABLE VtaListamay THEN VtaListaMay.Chr__01 ELSE Almmmatg.CHR__01).
    /* DESCUENTOS */
