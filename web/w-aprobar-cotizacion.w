...
DEFINE FRAME F-Main
     BUTTON-4 AT ROW 1.27 COL 125 WIDGET-ID 2
     BUTTON-5 AT ROW 1.27 COL 140 WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-aprobar-cotizacion ( 1.27 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-aprobar-cotizacion ( 8.04 , 161.00 ) NO-ERROR.
