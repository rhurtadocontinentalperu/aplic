...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'LABEL-FONT = 4,
                     ...
                     LABELS = Mayorista|Eventos|Por División':U ,
             OUTPUT h_tab95 ).
       RUN set-position IN h_tab95 ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_tab95 ( 26.38 , 92.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/b-descuentos-vol-prom-may.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listas-mayorista-gral ).
       RUN set-position IN h_b-listas-mayorista-gral ( 2.08 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-listas-mayorista-gral ( 23.15 , 88.00 ) NO-ERROR.
