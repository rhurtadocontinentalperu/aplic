...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCDocu WHERE ~{&KEY-PHRASE} ~
 ...
 AND VtaCDocu.FchPed >= (TODAY - s-DiasVtoPed) NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND VtaCDocu.NroPed BEGINS string(s-nroser,'999')
 AND VtaCDocu.Usuario = s-user-id
 AND VtaCDocu.FchPed >= (TODAY - s-DiasVtoPed)"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN  input-var-1 = s-coddoc
          ...
          input-var-3 = STRING(s-DiasVtoPed )
          output-var-1 = ?
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    */
    RUN lkup/c-prepedido-terceros-v2.w ('Seleccione...').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Update-Filters q-tables 
