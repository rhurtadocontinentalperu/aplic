...
/* Capturamos divisiones Mayoristas - Lista General */
...
DEFINE VARIABLE h_b-descuento-prom-may AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 1 COL 66
     BUTTON-2 AT ROW 1.27 COL 37 WIDGET-ID 2
     SPACE(23.28) SKIP(17.41)
...
DO:
    ...
    RUN Replica-Plantilla IN h_b-descuento-prom-may ( INPUT pDivisiones /* CHARACTER */).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/b-descuento-prom-may.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-descuento-prom-may ).
       RUN set-position IN h_b-descuento-prom-may ( 2.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-descuento-prom-may ( 16.96 , 71.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-lima-dtopromv2 ( 1.00 , 58.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartBrowser h_b-descuento-prom-may. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-descuento-prom-may ).
       RUN add-link IN adm-broker-hdl ( h_q-lima-dtopromv2 , 'Record':U , h_b-descuento-prom-may ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-descuento-prom-may ,
