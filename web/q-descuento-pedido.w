...
DEFINE SHARED VARIABLE S-FLGEST  AS CHAR.
DEFINE SHARED VARIABLE S-CODDIV  AS CHAR.
DEFINE SHARED VARIABLE S-NROSER AS INT.

DEF SHARED VARIABLE s-CodOrigen AS CHAR.
DEF SHARED VARIABLE s-NroOrigen AS CHAR.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.CodOrigen = s-CodOrigen ~
 AND FacCPedi.NroOrigen = s-NroOrigen ~
/* AND FacCPedi.NroPed BEGINS STRING(s-NroSer,'999')*/ NO-LOCK ~
    BY FacCPedi.CodCia ~
       BY FacCPedi.CodDiv ~
        BY FacCPedi.CodDoc ~
...
DEFINE FRAME FRAME-A
     F-Numero AT ROW 1 COL 1 NO-LABEL WIDGET-ID 2
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "INTEGRAL.FacCPedi.CodCia|yes,INTEGRAL.FacCPedi.CodDiv|yes,INTEGRAL.FacCPedi.CodDoc|yes,INTEGRAL.FacCPedi.NroPed|no"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Send-Document q-tables 
