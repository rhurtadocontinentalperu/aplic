...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ITEM.codmat COLUMN-LABEL "Articulo" FORMAT "X(15)":U
      Almmmatg.DesMat FORMAT "x(60)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U
      ITEM.UndVta COLUMN-LABEL "Unidad" FORMAT "x(8)":U
      ITEM.CanPed FORMAT ">,>>>,>>9.9999":U
      ITEM.Libre_d05 COLUMN-LABEL "Stock!Disponible" FORMAT "->>,>>9.99":U
            WIDTH 9.72
      ITEM.AlmDes COLUMN-LABEL "Almacén" FORMAT "x(6)":U
...
"ITEM.codmat" "Articulo" "X(15)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.UndVta" "Unidad" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.ITEM.CanPed
"ITEM.CanPed" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.ITEM.Libre_d05
"ITEM.Libre_d05" "Stock!Disponible" ? "decimal" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.ITEM.AlmDes
"ITEM.AlmDes" "Almacén" "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.ITEM.PreBas
"ITEM.PreBas" "Precio!Peldaño Bruto" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.ITEM.Libre_d02
"ITEM.Libre_d02" "Flete!Unitario" ? "decimal" ? ? ? ? ? ? no ? no no "8.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.Por_Dsctos[1]" "% Dscto.!Admins" ? "decimal" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ITEM.ImpLin" "Importe!con IGV" ? "decimal" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    IF x-Delta <> 0 THEN DO:
        MESSAGE 'Usted a modificando el precio unitario' SKIP
            'Necesito confirmación' VIEW-AS ALERT-BOX WARNING
