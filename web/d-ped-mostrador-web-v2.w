...
&Scoped-Define ENABLED-OBJECTS RECT-4 RADIO-SET_FlgSit BUTTON-Shopping_Cart ~
Btn_OK Btn_Cancel FILL-IN_CodCli RADIO-SET_Cmpbte FILL-IN_NomCli ~
FILL-IN_DirCli FILL-IN_LugEnt FILL-IN_Glosa 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET_FlgSit FILL-IN_CodCli ~
FILL-IN_RucCli FILL-IN_Atencion RADIO-SET_Cmpbte FILL-IN_NomCli ~
FILL-IN_DirCli FILL-IN_LugEnt FILL-IN_Glosa 
...
DEFINE FRAME D-Dialog
     ...
     RADIO-SET_Cmpbte AT ROW 2.08 COL 101 NO-LABEL WIDGET-ID 156
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/b-ped-mostrador-web-1-v2.r':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ped-mostrador-web-1 ).
       RUN set-position IN h_b-ped-mostrador-web-1 ( 6.38 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-ped-mostrador-web-1 ( 19.08 , 185.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv96-2 ).
       RUN set-position IN h_p-updv96-2 ( 25.50 , 3.00 ) NO-ERROR.
       RUN set-size IN h_p-updv96-2 ( 1.54 , 26.14 ) NO-ERROR.

       /* Links to SmartBrowser h_b-ped-mostrador-web-1. */
       RUN add-link IN adm-broker-hdl ( h_p-updv96-2 , 'TableIO':U , h_b-ped-mostrador-web-1 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-ped-mostrador-web-1 ,
             FILL-IN_Glosa:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv96-2 ,
             h_b-ped-mostrador-web-1 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET_FlgSit FILL-IN_CodCli FILL-IN_RucCli FILL-IN_Atencion 
          RADIO-SET_Cmpbte FILL-IN_NomCli FILL-IN_DirCli FILL-IN_LugEnt 
          FILL-IN_Glosa 
      WITH FRAME D-Dialog.
  ENABLE RECT-4 RADIO-SET_FlgSit BUTTON-Shopping_Cart Btn_OK Btn_Cancel 
         FILL-IN_CodCli RADIO-SET_Cmpbte FILL-IN_NomCli FILL-IN_DirCli 
         FILL-IN_LugEnt FILL-IN_Glosa 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
