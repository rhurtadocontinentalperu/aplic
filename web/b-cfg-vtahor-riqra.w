...
DEF VAR s-Tabla AS CHAR INIT 'CFG_VTAHOR_RIQRA' NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      GN-DIVI.DesDiv FORMAT "X(40)":U WIDTH 52.14
  ENABLE
      FacTabla.Codigo
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 10.77
...
"GN-DIVI.DesDiv" ? ? "character" ? ? ? ? ? ? no ? no no "52.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR pEvento AS CHAR INIT 'CREATE'.
  RUN lib/logtabla.r (INPUT 'FACTABLA',
                      INPUT TRIM(FacTabla.Tabla) + '|' + TRIM(FacTabla.Codigo),
                      INPUT pEvento).
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  DEF VAR pEvento AS CHAR INIT 'DELETE'.
  RUN lib/logtabla.r (INPUT 'FACTABLA',
                      INPUT TRIM(FacTabla.Tabla) + '|' + TRIM(FacTabla.Codigo),
                      INPUT pEvento).
