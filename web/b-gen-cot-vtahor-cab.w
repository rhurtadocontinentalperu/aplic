...
DEF VAR cCodVen AS CHAR INIT "*" NO-UNDO.   /* Valor falso */
/*
&SCOPED-DEFINE Condicion ( VtaCDocu.CodCia = s-CodCia ~
    ...
    AND VtaCDocu.CodVen = cCodVen )
*/
&SCOPED-DEFINE Condicion ( VtaCDocu.CodCia = s-CodCia ~
    AND VtaCDocu.FlgEst = "P" ~
    AND VtaCDocu.CodPed = "PET" ~
    AND VtaCDocu.ordcmp BEGINS "P" ~
    AND VtaCDocu.FlgSit <> 'T' ~
    AND VtaCDocu.FchPed >= (TODAY - s-Dias-Vcto) ~
    AND VtaCDocu.CodVen = cCodVen )
...
&Scoped-define FIELDS-IN-QUERY-br_table VtaCDocu.FchPed VtaCDocu.NroPed ~
VtaCDocu.ordcmp VtaCDocu.CodCli VtaCDocu.NomCli 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaCDocu.NroPed COLUMN-LABEL "Numero" FORMAT "X(15)":U WIDTH 10.72
            COLUMN-FONT 6
      VtaCDocu.ordcmp COLUMN-LABEL "Pedido!RIQRA" FORMAT "X(15)":U
            WIDTH 10.43 COLUMN-FGCOLOR 9 COLUMN-FONT 11
      VtaCDocu.CodCli COLUMN-LABEL "Cliente" FORMAT "x(15)":U
      VtaCDocu.NomCli FORMAT "x(60)":U WIDTH 52.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 103 BY 6.69
         FONT 4
         TITLE "PRE-PEDIDOS PENDIENTES" FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "INTEGRAL.VtaCDocu.NomCli|yes,INTEGRAL.VtaCDocu.FchPed|no"
     _Where[1]         = "{&Condicion}"
...
"VtaCDocu.NroPed" "Numero" "X(15)" "character" ? ? 6 ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.VtaCDocu.ordcmp
"VtaCDocu.ordcmp" "Pedido!RIQRA" "X(15)" "character" ? 9 11 ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaCDocu.CodCli
"VtaCDocu.CodCli" "Cliente" "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.VtaCDocu.NomCli
"VtaCDocu.NomCli" ? ? "character" ? ? ? ? ? ? no ? no no "52.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* PRE-PEDIDOS PENDIENTES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* PRE-PEDIDOS PENDIENTES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* PRE-PEDIDOS PENDIENTES */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Captura-Vendedor B-table-Win 
PROCEDURE Captura-Vendedor :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
ASSIGN
    pCodDoc = VtaCDocu.CodPed 
    pNroDoc = VtaCDocu.NroPed. 
