...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    ...
    RUN PED_Despachar-Pedido-v2 IN hProc (INPUT ROWID(Faccpedi), OUTPUT pMensaje).
    /*RUN PED_Despachar-Pedido IN hProc (INPUT ROWID(Faccpedi), OUTPUT pMensaje).*/
    DELETE PROCEDURE hProc.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    ***************************************************************************** */
    ...
    IF B-CPEDI.TpoPed <> 'M' THEN DO:       /*** No valida LC para Contratos Marco ***/
        /* Verifica LC siempre y cuando no sea A/C */      
