...
IF NOT AVAILABLE ccbdterm THEN DO:
    MESSAGE "EL DOCUMENTO INGRESO DE CAJA NO ESTA CONFIGURADO EN ESTE TERMINAL"
...
CASE s-TpoPed:
    ...
    OTHERWISE DO:
         ...
         */
        /* Ic - 08Feb2025 20:30pm Susana Leon que no valide la division del almacen . mientras se analize */
        /* 19/03/2026: Susana León reactivar control */
        /* 19/03/2026: Susana León desactivar de nuevo - Por que hay mas de una division que despachan por el mismo almacen  */
        FOR EACH VtaAlmDiv NO-LOCK WHERE Vtaalmdiv.codcia = s-codcia
            AND Vtaalmdiv.coddiv = s-coddiv,
            FIRST Almacen OF Vtaalmdiv NO-LOCK WHERE Almacen.Campo-C[3] <> 'Si'
...
&Scoped-Define ENABLED-OBJECTS RECT-29 COMBO-NroSer 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/v-retail-mostrador-mayorista.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
