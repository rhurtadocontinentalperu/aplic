...
------------------------------------------------------------------------------*/
  ...
  FOR EACH PEDI EXCLUSIVE-LOCK, FIRST Almmmatg OF PEDI NO-LOCK, FIRST Almtfami OF Almmmatg NO-LOCK:
      ...
      /* RHC 15/03/2021 Decidimos cuándo verificamos el stock */
      LocalVerificaStock = NO.
      IF pEvento = "YES" THEN LocalVerificaStock = YES.
  ...
  RUN {&Promocion} (COTIZACION.Libre_c01, s-CodCli, INPUT-OUTPUT TABLE PEDI, OUTPUT pMensaje).
/*   FOR EACH pedi WHERE pedi.libre_c05 = "OF": */
/*       MESSAGE pedi.codmat pedi.canped.       */
/*   END.                                       */
  IF RETURN-VALUE = "ADM-ERROR" THEN RETURN "ADM-ERROR".
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      /*ASSIGN Faccpedi.TpoLic:SCREEN-VALUE = "NO".*/
      ...
      /*ASSIGN Faccpedi.TpoLic:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES".*/
      pTpoLic = YES.
      /*MESSAGE 'fin'.*/
  END.
