...
DEFINE VARIABLE h_b-captura-productos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     BtnOK AT ROW 20.38 COL 2 WIDGET-ID 22
     BtnCancel AT ROW 20.38 COL 17 WIDGET-ID 24
     SPACE(69.85) SKIP(0.42)
...
DO:
  RUN Aceptar IN h_b-captura-productos.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/b-captura-productos.r':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = DesMat':U ,
             OUTPUT h_b-captura-productos ).
       RUN set-position IN h_b-captura-productos ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-captura-productos ( 19.15 , 98.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-captura-productos ,
