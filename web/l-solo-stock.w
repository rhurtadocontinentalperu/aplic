...
DEFINE FRAME F-Main
     ...
     FILL-IN-flgcomercial AT ROW 4.81 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     F-totstk AT ROW 5.04 COL 14 COLON-ALIGNED
     "Indicador comercial" VIEW-AS TEXT
          SIZE 16.14 BY .5 AT ROW 4.23 COL 28.29 WIDGET-ID 6
          FGCOLOR 4 FONT 6
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF AVAILABLE B-Almmmatg THEN DO:
          ...
          FIND almmmate WHERE Almmmate.CodCia = B-Almmmatg.CodCia
              ...
              NO-LOCK NO-ERROR.
          IF AVAILABLE almmmate THEN ASSIGN F-totstk    = Almmmate.StkAct.
      END.
      DISPLAY 
          F-totstk 
          F-CODIGO 
