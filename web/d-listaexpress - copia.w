...
DEFINE FRAME D-Dialog
     COMBO-BOX_Categoria AT ROW 1.27 COL 19 COLON-ALIGNED WIDGET-ID 2
     BUTTON_Limpiar AT ROW 1.27 COL 91 WIDGET-ID 10
     COMBO-BOX_SubCategoria AT ROW 2.35 COL 19 COLON-ALIGNED WIDGET-ID 4
     COMBO-BOX_EtapaEscolar AT ROW 3.42 COL 19 COLON-ALIGNED WIDGET-ID 6
     FILL-IN_Producto AT ROW 4.5 COL 19 COLON-ALIGNED WIDGET-ID 8
     Btn_OK AT ROW 25.23 COL 3
     Btn_Cancel AT ROW 25.23 COL 19
     SPACE(158.42) SKIP(0.22)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-listaexpress ( 19.65 , 189.00 ) NO-ERROR.
