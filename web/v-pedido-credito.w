...
RUN gn/genera-od-otr-hpk-phr PERSISTENT SET hProc.
    ...
    CASE TRUE:
        ...
        OTHERWISE DO:
            ...
            IF NOT AVAILABLE gn-convt OR gn-ConVt.Libre_l03 = NO THEN DO:
                RUN verificar-linea-de-credito(f-Importe).
                IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
                    APPLY "ENTRY" TO FacCPedi.Glosa.
                    RETURN "ADM-ERROR".
                END.
...
DEFINE INPUT PARAMETER fImporte AS DEC NO-UNDO.
        ...
        /*
            vta2/linea-de-credito-disponible : El nuevo calculo pedido por CYC (Gina Condor)
            RUN vta2/linea-de-credito-v2 : Calculo anterior
        */
        /* RUN vta2/linea-de-credito-v2 por vta2/linea-de-credito-disponible */
        RUN vta2/linea-de-credito-v2 (
        /*RUN vta2/linea-de-credito-disponible (*/
                                      s-CodDiv,
                                      s-CodCli,
                                      s-FmaPgo,
                                      s-CodMon,
