...
&Scoped-define QUERY-STRING-Query-Main FOR EACH gn-cliente-potencial WHERE ~{&KEY-PHRASE} ~
      AND gn-cliente-potencial.CodCia = cl-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gn-cliente-potencial WHERE ~{&KEY-PHRASE} ~
      AND gn-cliente-potencial.CodCia = cl-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main gn-cliente-potencial
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gn-cliente-potencial
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "gn-cliente-potencial.CodCia = cl-codcia"
