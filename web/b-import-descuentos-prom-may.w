...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MATG.DesMat FORMAT "X(60)":U WIDTH 66.43
      T-MATG.Chr__01 COLUMN-LABEL "Unid." FORMAT "x(6)":U WIDTH 7.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"T-MATG.DesMat" ? "X(60)" "character" ? ? ? ? ? ? no ? no no "66.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-MATG.Chr__01
"T-MATG.Chr__01" "Unid." "x(6)" "character" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
