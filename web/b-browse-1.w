...
&Scoped-define FIELDS-IN-QUERY-br_table t-report.Llave-C t-report.Task-No 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      t-report.Llave-C FORMAT "x(8)":U
      t-report.Task-No FORMAT "999999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = Temp-Tables.t-report.Task-No
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Recibe-temporal B-table-Win 
PROCEDURE Recibe-temporal :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEF INPUT PARAMETER TABLE FOR t-report.
    MESSAGE 'sip'.
