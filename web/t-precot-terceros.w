...
DEFINE TEMP-TABLE PPT-DDOCU LIKE VtaDDocu.
...
&Scoped-define QUERY-STRING-br_table FOR EACH PPT-DDOCU WHERE TRUE NO-LOCK, ~
      FIRST Almmmatg OF PPT-DDOCU NO-LOCK ~
    BY PPT-DDOCU.Libre_c01 ~
       BY PPT-DDOCU.Libre_c02
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PPT-DDOCU WHERE TRUE NO-LOCK, ~
      FIRST Almmmatg OF PPT-DDOCU NO-LOCK ~
    BY PPT-DDOCU.Libre_c01 ~
       BY PPT-DDOCU.Libre_c02.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: PPT-DDOCU T "?" ? INTEGRAL VtaDDocu
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.PPT-DDOCU WHERE INTEGRAL.VtaCDocu ...,INTEGRAL.Almmmatg OF Temp-Tables.PPT-DDOCU"
...
"PPT-DDOCU.Libre_c04" "Grupo" "x(50)" "character" ? ? ? ? ? ? no ? no no "32.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Capture-Temp B-table-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Export-Temp B-table-Win 
PROCEDURE Export-Temp :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
