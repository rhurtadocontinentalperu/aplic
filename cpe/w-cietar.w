...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 131 BY 14.27
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CIERRE DE TAREAS PENDIENTES"
         HEIGHT             = 17
         WIDTH              = 135.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 135.14
...
ON END-ERROR OF W-Win /* CIERRE DE TAREAS PENDIENTES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CIERRE DE TAREAS PENDIENTES */
DO:
...
ON CHOOSE OF BUTTON-2 IN FRAME F-Main /* CIERRE DE TAREA */
DO:
