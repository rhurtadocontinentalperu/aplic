...
DEF VAR s-Tabla AS CHAR INIT 'CPEMOTREA'.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaTabla.Llave_c2 COLUMN-LABEL "Descripcion" FORMAT "x(40)":U
            WIDTH 42.57
  ENABLE
      VtaTabla.Llave_c1
      VtaTabla.Llave_c2
...
"Llave_c1" "Codigo" "x(3)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.VtaTabla.Llave_c2
"Llave_c2" "Descripcion" "x(40)" "character" ? ? ? ? ? ? yes ? no no "42.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
