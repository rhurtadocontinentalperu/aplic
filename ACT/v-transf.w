...
DEF SHARED VAR s-Ccosto_Origen LIKE ac-cpape.Ccosto_Origen.
...
&Scoped-Define ENABLED-FIELDS ac-cpape.CCosto_Origen ~
ac-cpape.Responsable_Origen ac-cpape.CCosto_Destino ~
...
ac-cpape.FchDoc ac-cpape.CCosto_Origen ac-cpape.Usuario ~
ac-cpape.Responsable_Origen ac-cpape.CCosto_Destino ~
ac-cpape.Responsable_Destino ac-cpape.Observaciones 
&Scoped-define DISPLAYED-TABLES ac-cpape
&Scoped-define FIRST-DISPLAYED-TABLE ac-cpape
&Scoped-Define DISPLAYED-OBJECTS x-Estado x-CcoOrigen x-NomPer-Origen ~
x-CcoDestino x-NomPer-Destino 
...
DEFINE VARIABLE x-CcoDestino AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 63 BY .81 NO-UNDO.

DEFINE VARIABLE x-CcoOrigen AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 63 BY .81 NO-UNDO.
...
DEFINE VARIABLE x-NomPer-Destino AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 59 BY .81 NO-UNDO.

DEFINE VARIABLE x-NomPer-Origen AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 59 BY .81 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     ac-cpape.FchDoc AT ROW 1.27 COL 87 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ac-cpape.CCosto_Origen AT ROW 2.08 COL 11 COLON-ALIGNED WIDGET-ID 26
          LABEL "Origen"
          VIEW-AS FILL-IN 
          SIZE 4 BY .81
     x-CcoOrigen AT ROW 2.08 COL 16 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     ac-cpape.Usuario AT ROW 2.08 COL 87 COLON-ALIGNED WIDGET-ID 10
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ac-cpape.Responsable_Origen AT ROW 2.88 COL 11 COLON-ALIGNED WIDGET-ID 30
          LABEL "Responsable"
          VIEW-AS FILL-IN 
          SIZE 8 BY .81
     x-NomPer-Origen AT ROW 2.88 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     ac-cpape.CCosto_Destino AT ROW 3.69 COL 11 COLON-ALIGNED WIDGET-ID 2
          LABEL "Destino"
          VIEW-AS FILL-IN 
          SIZE 4 BY .81
     x-CcoDestino AT ROW 3.69 COL 16 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     ac-cpape.Responsable_Destino AT ROW 4.5 COL 11 COLON-ALIGNED WIDGET-ID 8
          LABEL "Responsable"
          VIEW-AS FILL-IN 
          SIZE 8 BY .81
     x-NomPer-Destino AT ROW 4.5 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     ac-cpape.Observaciones AT ROW 5.31 COL 13 NO-LABEL WIDGET-ID 12
          VIEW-AS EDITOR NO-WORD-WRAP SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
          SIZE 70 BY 3
     "Observaciones:" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 5.58 COL 2 WIDGET-ID 18
...
/* SETTINGS FOR FILL-IN ac-cpape.CCosto_Destino IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN ac-cpape.CCosto_Origen IN FRAME F-Main
   EXP-LABEL                                                            */
...
/* SETTINGS FOR FILL-IN ac-cpape.Responsable_Destino IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN ac-cpape.Responsable_Origen IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN ac-cpape.Usuario IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN x-CcoDestino IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-CcoOrigen IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-Estado IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-NomPer-Destino IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN x-NomPer-Origen IN FRAME F-Main
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME ac-cpape.CCosto_Origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ac-cpape.CCosto_Origen V-table-Win
ON LEAVE OF ac-cpape.CCosto_Origen IN FRAME F-Main /* Origen */
DO:
    x-CcoOrigen:SCREEN-VALUE = ''.
    FIND ac-tabl WHERE ac-tabl.codcia = s-codcia
        AND ac-tabl.ctabla = 'CC'
        AND ac-tabl.ccodigo = ac-cpape.CCosto_Origen:SCREEN-VALUE
        NO-LOCK NO-ERROR.
    IF AVAILABLE ac-tabl THEN x-CcoOrigen:SCREEN-VALUE = AC-TABL.cDescri.
    s-Ccosto_Origen = ac-cpape.Ccosto_Origen:SCREEN-VALUE.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ac-cpape.CCosto_Origen V-table-Win
ON LEFT-MOUSE-DBLCLICK OF ac-cpape.CCosto_Origen IN FRAME F-Main /* Origen */
OR F8 OF ac-cpape.Ccosto_Origen
DO:
  ASSIGN
      input-var-1 = ''
      input-var-2 = ''
  ...
  APPLY 'entry':U TO ac-cpape.ccosto_Origen.
END.
...
DO:
    ...
    ASSIGN
        ...
        NO-ERROR.
    x-NomPer-Destino:SCREEN-VALUE = ''.
    FIND pl-pers WHERE pl-pers.codcia = s-codcia
        AND pl-pers.codper = ac-cpape.Responsable_Destino:SCREEN-VALUE
        NO-LOCK NO-ERROR.
    IF AVAILABLE pl-pers THEN x-NomPer-Destino:SCREEN-VALUE = TRIM(pl-pers.patper) + ' ' +
                                                        TRIM(pl-pers.matper) + ', ' +
                                                        pl-pers.nomper.
END.
...
&Scoped-define SELF-NAME ac-cpape.Responsable_Origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ac-cpape.Responsable_Origen V-table-Win
ON LEAVE OF ac-cpape.Responsable_Origen IN FRAME F-Main /* Responsable */
DO:
    IF SELF:SCREEN-VALUE = '' THEN RETURN.
    ASSIGN
        SELF:SCREEN-VALUE = STRING(INTEGER(SELF:SCREEN-VALUE), '999999')
        NO-ERROR.
    x-NomPer-Origen:SCREEN-VALUE = ''.
    FIND pl-pers WHERE pl-pers.codcia = s-codcia
        AND pl-pers.codper = ac-cpape.Responsable_Origen:SCREEN-VALUE
        NO-LOCK NO-ERROR.
    IF AVAILABLE pl-pers THEN x-NomPer-Origen:SCREEN-VALUE = TRIM(pl-pers.patper) + ' ' +
                                                        TRIM(pl-pers.matper) + ', ' +
                                                        pl-pers.nomper.
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      x-NomPer-Origen:SCREEN-VALUE = ''.
      FIND pl-pers WHERE pl-pers.codcia = s-codcia
          AND pl-pers.codper = ac-cpape.Responsable_Origen
          NO-LOCK NO-ERROR.
      IF AVAILABLE pl-pers THEN x-NomPer-Origen:SCREEN-VALUE = TRIM(pl-pers.patper) + ' ' +
                                                          TRIM(pl-pers.matper) + ', ' +
                                                          pl-pers.nomper.
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Desplazamiento Interno'.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF NOT AVAILABLE ac-tabl THEN DO:
        MESSAGE 'Origen (centro de costo) NO registrado'
    ...
    IF NOT AVAILABLE pl-pers THEN DO:
        MESSAGE 'Responsable Origen (código del personal) NO registrado'
            VIEW-AS ALERT-BOX ERROR.
        RETURN 'ADM-ERROR'.
    END.
    FIND pl-pers WHERE pl-pers.codcia = s-codcia
        ...
        NO-LOCK NO-ERROR.
    IF NOT AVAILABLE pl-pers THEN DO:
        MESSAGE 'Responsable Destino (código del personal) NO registrado'
            VIEW-AS ALERT-BOX ERROR.
        RETURN 'ADM-ERROR'.
    END.
END.
...
s-Ccosto_Origen = ac-cpape.Ccosto_Origen.
RUN Carga-Temporal.
RUN Procesa-Handle IN lh_handle('pagina2').
