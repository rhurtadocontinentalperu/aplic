...
ac-cpape.Responsable_Origen ac-cpape.CCosto_Destino ac-cpape.NroG_R ~
ac-cpape.Observaciones 
...
&Scoped-Define DISPLAYED-OBJECTS x-Estado x-CcoOrigen x-NomPer x-CcoDestino 
...
DEFINE FRAME F-Main
     ...
     ac-cpape.Usuario AT ROW 2.08 COL 87 COLON-ALIGNED WIDGET-ID 10
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ac-cpape.Responsable_Origen AT ROW 2.88 COL 11 COLON-ALIGNED WIDGET-ID 8
          LABEL "Responsable"
          VIEW-AS FILL-IN 
          SIZE 8 BY .81
     ...
     ac-cpape.NroG_R AT ROW 4.5 COL 11 COLON-ALIGNED WIDGET-ID 30
          LABEL "G/Remision"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
/* SETTINGS FOR FILL-IN ac-cpape.NroDoc IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ac-cpape.NroG_R IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  IF RETURN-VALUE = 'YES' THEN DO:
      ...
      ASSIGN
          ...
          ac-cpape.CCosto_Destino = '@@'.       /* EN TRANSITO */
      ASSIGN
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DO WITH FRAME {&FRAME-NAME}:
      ac-cpape.CCosto_Destino:SENSITIVE = NO.
  END.
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Salida del Activo'.
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF NOT AVAILABLE pl-pers THEN DO:
        MESSAGE 'Responsable (código del personal) NO registrado'
            VIEW-AS ALERT-BOX ERROR.
        RETURN 'ADM-ERROR'.
    END.
END.
