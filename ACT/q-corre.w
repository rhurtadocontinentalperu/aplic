...
&Scoped-define INTERNAL-TABLES ac-corre

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH ac-corre WHERE ~{&KEY-PHRASE} ~
      AND ac-corre.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ac-corre WHERE ~{&KEY-PHRASE} ~
      AND ac-corre.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main ac-corre
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ac-corre
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.ac-corre"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "ac-corre.CodCia = s-codcia"
