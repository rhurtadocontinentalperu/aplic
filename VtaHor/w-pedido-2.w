...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "PEDIDOS AL CREDITO HORIZONTAL"
         HEIGHT             = 19.92
         WIDTH              = 112.72
         MAX-HEIGHT         = 32.81
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF W-Win /* PEDIDOS AL CREDITO HORIZONTAL */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* PEDIDOS AL CREDITO HORIZONTAL */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv95 , 'TableIO':U , h_t-pedido-2 ).
