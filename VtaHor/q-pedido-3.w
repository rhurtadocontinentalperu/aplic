...
DEFINE SHARED VARIABLE S-TIPO   AS CHAR.    /* ALL: todos los usuarios   USER: el mismo usuario */
DEFINE        VARIABLE I-NroSer  AS INTEGER NO-UNDO.
DEFINE        VARIABLE x-User-Id LIKE s-User-Id.
...
IF S-TIPO = 'ALL' THEN x-User-Id = ''.
ELSE x-User-Id = s-USer-Id.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.usuario BEGINS x-USer-Id ~
...
AND integral.FacCPedi.TpoPed = s-TpoPed
"
...
FIND FacCPedi WHERE FacCPedi.CodCia = S-CODCIA AND
     ...
     FacCPedi.NroPed = STRING(I-NroSer,"999") + STRING(F-Numero,"999999") 
     NO-LOCK NO-ERROR.
