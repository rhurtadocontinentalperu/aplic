...
&SCOPED-DEFINE l-lookup h_l-provee
...
DEFINE VARIABLE h_l-provee AS HANDLE NO-UNDO.

/* ************************  Frame Definitions  *********************** */

DEFINE FRAME C-Dialog
     SPACE(105.86) SKIP(16.23)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ges/l-prove.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-provee ).
       RUN set-position IN h_l-provee ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.15 , 105.57 ) */
