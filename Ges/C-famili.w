...
&SCOPED-DEFINE l-lookup h_l-famili
...
DEFINE VARIABLE h_l-famili AS HANDLE NO-UNDO.

/* ************************  Frame Definitions  *********************** */

DEFINE FRAME C-Dialog
     SPACE(99.86) SKIP(16.38)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ges/l-famili.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-famili ).
       RUN set-position IN h_l-famili ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.19 , 99.72 ) */
