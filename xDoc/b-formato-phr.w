...
DI-RutaC.FchDoc DI-RutaC.FlgEst 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH DI-RutaC WHERE ~{&KEY-PHRASE} ~
      AND DI-RutaC.CodCia = 1 ~
/* AND DI-RutaC.CodDiv = "00040"*/ ~
 AND DI-RutaC.CodDoc = "PHR" ~
 AND LOOKUP(DI-RutaC.FlgEst, 'A') = 0 ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DI-RutaC.NroDoc FORMAT "X(9)":U WIDTH 11.57
      DI-RutaC.FchDoc FORMAT "99/99/9999":U
      DI-RutaC.FlgEst FORMAT "x(5)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"NroDoc" ? ? "character" ? ? ? ? ? ? no ? no no "11.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  RUN lib/logtabla (INPUT "MRC-00",
                    INPUT "DI-RUTAC," + DI-RutaC.CodDoc + ',' + DI-RutaC.NroDoc,
                    INPUT 'UPDATE').
