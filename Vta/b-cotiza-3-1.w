...
FacDPedi.PreUni FacDPedi.PorDto FacDPedi.Por_Dsctos[1] ~
FacDPedi.Por_Dsctos[3] FacDPedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)":U
      Almmmatg.DesMat FORMAT "X(50)":U
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(20)":U
      FacDPedi.UndVta COLUMN-LABEL "Unidad" FORMAT "X(10)":U
      FacDPedi.CanPed FORMAT ">,>>>,>>>.99":U WIDTH 7.72
      ...
      FacDPedi.Por_Dsctos[3] COLUMN-LABEL "% Dscto!Prom." FORMAT ">>9.99":U
...
"FacDPedi.NroItm" "No" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.FacDPedi.codmat
"FacDPedi.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.UndVta" "Unidad" "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > integral.FacDPedi.CanPed
"FacDPedi.CanPed" ? ">,>>>,>>>.99" "decimal" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > integral.FacDPedi.PreUni
"FacDPedi.PreUni" "Precio!Unitario" ">>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.FacDPedi.PorDto
"FacDPedi.PorDto" "% Dscto.!Incluido" "(>>9.99)" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.Por_Dsctos[1]" "% Dscto!Manual" ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.FacDPedi.Por_Dsctos[3]
"FacDPedi.Por_Dsctos[3]" "% Dscto!Prom." ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > integral.FacDPedi.ImpLin
...
/*         IF ((dStkAct * 100) / INPUT BROWSE {&browse-NAME} FacDPedi.CanPed) < 95 THEN */
/*             dStkAct:BGCOLOR = 12.                                                    */
...
IF AVAILABLE FacCPedi THEN DO:
   ...
   DISPLAY FacCPedi.ImpDto @ F-ImpDes
           ...
           FacCPedi.ImpVta @ F-ValVta 
           /*FacCPedi.PorDto @ F-PorDes */
           F-PesMat
...
------------------------------------------------------------------------------*/
    ...
    IF FacCPedi.Sede <> "" THEN DO:
        FOR FIRST supmmate
            FIELDS (supmmate.CodCia supmmate.CodCli supmmate.Sede supmmate.CodMat supmmate.StkAct)
            WHERE supmmate.CodCia = FacDPedi.CodCia
            AND supmmate.CodCli = FacCPedi.CodCli
            AND supmmate.Sede = FacCPedi.Sede
            AND supmmate.CodMat = FacDPedi.CodMat
            NO-LOCK:
        END.
