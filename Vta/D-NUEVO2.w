...
&Scoped-Define ENABLED-OBJECTS RECT-51 RECT-5 RECT-49 RECT-48 RECT-50 ~
...
DEFINE FRAME D-Dialog
     ...
     SPACE(43.00) SKIP(6.75)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "Reporte de Cierre Por Division".
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Reporte de Cierre Por Division */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY R-S-TipImp RADIO-SET-1 FILL-IN-CodDiv FILL-IN-efesol FILL-IN-efedol 
          ...
          RB-END-PAGE 
      WITH FRAME D-Dialog.
  ENABLE RECT-51 RECT-5 RECT-49 RECT-48 RECT-50 R-S-TipImp RADIO-SET-1 
