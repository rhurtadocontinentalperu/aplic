  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/v-dtocot-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-dtocot-1 ).
       RUN set-position IN h_v-dtocot-1 ( 1.00 , 1.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-dtocot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-dtocot ).
       RUN set-position IN h_b-dtocot ( 6.19 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-dtocot ( 7.92 , 88.86 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/b-tdtoco-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tdtoCo-1 ).
       RUN set-position IN h_b-tdtoCo-1 ( 6.04 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-tdtoCo-1 ( 8.65 , 91.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96 ).
       RUN set-position IN h_p-updv96 ( 14.85 , 56.00 ) NO-ERROR.
