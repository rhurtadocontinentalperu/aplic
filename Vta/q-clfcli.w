...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ClfClie WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ClfClie WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ClfClie
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ClfClie


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BUTTON-1 RECT-12 
...
DEFINE FRAME FRAME-A
     BUTTON-1 AT ROW 1.15 COL 1.86
     RECT-12 AT ROW 1 COL 1.29
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.15 , 1 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    ...
    RUN lkup\c-clfcli.r("CLASIFICACION DE CLIENTES").
