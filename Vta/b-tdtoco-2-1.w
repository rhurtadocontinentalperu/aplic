...
&Scoped-define FIELDS-IN-QUERY-br_table PEDI.codmat Almmmatg.DesMat Almmmatg.DesMar PEDI.UndVta PEDI.CanPed PEDI.PreUni PEDI.PorDto PEDI.Por_DSCTOS[1] PEDI.Por_DSCTOS[2] Pedi.Por_DSCTOS[3] Pedi.Libre_d01 PEDI.ImpLin   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI.PorDto COLUMN-LABEL "% Dscto.!Incluido" FORMAT "->>9.99" 
      PEDI.Por_DSCTOS[1] COLUMN-LABEL "% Dscto.!Manual" FORMAT "->>9.9999" 
      PEDI.Por_DSCTOS[2] COLUMN-LABEL "% Dscto.!Evento" FORMAT "->>9.9999" 
      Pedi.Por_DSCTOS[3] COLUMN-LABEL  "% Dscto.!Vol. o Prom." FORMAT "->>9.99"
      Pedi.Libre_d01 COLUMN-LABEL  "%Margen" FORMAT "->>9.99"
      PEDI.ImpLin COLUMN-LABEL "Importe" FORMAT ">,>>>,>>9.99"
  ENABLE
        PEDI.PreUni
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 129 BY 7.81
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 9.42 COL 12.57 NO-LABEL
     F-ImpExo AT ROW 9.42 COL 23.29 NO-LABEL
     F-ImpDes AT ROW 9.42 COL 32.14 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 9.42 COL 43.29 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 9.42 COL 54.29 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 9.42 COL 65.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 9.42 COL 76.72 COLON-ALIGNED NO-LABEL
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 8.88 COL 70.57
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 8.92 COL 59.43
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.92 COL 14.29
     "Total Importe" VIEW-AS TEXT
          SIZE 9.29 BY .5 AT ROW 8.92 COL 79
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.92 COL 23.43
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 8.92 COL 34.57
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.92 COL 46.86
     RECT-11 AT ROW 8.81 COL 1
...
DO:
    ...
    x-NewPre = DECIMAL(SELF:SCREEN-VALUE).
    x-OldPre = PEDI.PreBas.     /* Directo de la tabla */
    F-DSCTO = ( 1 - ( x-NewPre / x-OldPre ) ) * 100.
    PEDI.PorDto:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = STRING(F-DSCTO).
    /* CALCULO DEL MARGEN */
    ...
    x-NewPre = DECIMAL ( PEDI.PreUni:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} ) *
    ...
    PEDI.Libre_d01:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = STRING(x-margen).
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
      ...
      PEDI.PorDto = DEC(PEDI.PorDto:SCREEN-VALUE IN BROWSE {&BROWSE-NAME})    /* Add by C.Q. 23/03/2000 */
      PEDI.Libre_d01 = DEC(PEDI.Libre_d01:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}).    /* Add by C.Q. 23/03/2000 */
  ASSIGN
