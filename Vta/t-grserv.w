...
almmserv.DesMat DETA.UndVta DETA.CanDes 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      DETA.NroItm FORMAT ">>9":U
      DETA.codmat COLUMN-LABEL "Codigo Servicio" FORMAT "X(6)":U
      almmserv.DesMat FORMAT "X(45)":U
      DETA.UndVta COLUMN-LABEL "Unid." FORMAT "x(8)":U
      DETA.CanDes FORMAT ">,>>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"DETA.codmat" "Codigo Servicio" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.almmserv.DesMat
     _FldNameList[4]   > Temp-Tables.DETA.UndVta
"DETA.UndVta" "Unid." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
