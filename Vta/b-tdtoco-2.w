...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 100 BY 7.81
         FONT 4.
...
/*ML01* Inicio de bloque ***/
    ...
    IF AVAILABLE gn-clieds THEN DO:
        ...
        IF DECIMAL(SELF:SCREEN-VALUE) > f-DtoMax THEN DO:
            ...
            MESSAGE
                "Máximo Descuento Permitido es : " f-DtoMax " %"
  ...
  /***RD01 - Permite márgenes menor que 0 ****
...
DO:
    ...
    x-OldPre = PEDI.PreUni.     /* Directo de la tabla */

    F-DSCTO = ROUND( ( 1 - (1 - PEDI.Por_Dsctos[1] / 100) * (x-NewPre / x-OldPre) ) * 100, 4 ).

    PEDI.Por_DSCTOS[1]:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} = STRING(F-DSCTO).
    /* CALCULO DEL MARGEN */
