...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      facdpedi.UndVta COLUMN-LABEL "Unidad" FORMAT "XXXXXXXX":U
      facdpedi.AlmDes COLUMN-LABEL "Alm!Des" FORMAT "x(3)":U
      facdpedi.CanPed FORMAT ">>>,>>>.9999":U
      facdpedi.PreUni COLUMN-LABEL "Precio !Unitario" FORMAT ">>,>>9.9999":U
      facdpedi.PorDto COLUMN-LABEL "Dsct.!1" FORMAT "->9.99":U
      facdpedi.Por_Dsctos[1] COLUMN-LABEL "Dsct.!2" FORMAT "->9.99":U
      facdpedi.ImpLin FORMAT ">,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 104 BY 7.92
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 9.15 COL 25.29 COLON-ALIGNED WIDGET-ID 14
     F-ValVta AT ROW 10.27 COL 45.43 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     F-ImpExo AT ROW 10.31 COL 17.43 NO-LABEL WIDGET-ID 4
     F-ImpIsc AT ROW 10.31 COL 59.43 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     F-ImpIgv AT ROW 10.31 COL 73.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     F-ImpTot AT ROW 10.31 COL 88.43 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     F-TotBrt AT ROW 10.35 COL 3.72 NO-LABEL WIDGET-ID 16
     F-ImpDes AT ROW 10.58 COL 31.43 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     f-PesMat AT ROW 11.23 COL 88.43 COLON-ALIGNED WIDGET-ID 12
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.85 COL 5.14 WIDGET-ID 34
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.81 COL 17.72 WIDGET-ID 32
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.08 COL 33.86 WIDGET-ID 30
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 9.81 COL 90.43 WIDGET-ID 28
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 9.81 COL 78 WIDGET-ID 26
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.81 COL 49 WIDGET-ID 24
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 9.81 COL 65 WIDGET-ID 22
     RECT-11 AT ROW 9.08 COL 1 WIDGET-ID 20
...
"facdpedi.UndVta" "Unidad" "XXXXXXXX" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"facdpedi.CanPed" ? ">>>,>>>.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"facdpedi.PorDto" "Dsct.!1" "->9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.facdpedi.Por_Dsctos[1]
"facdpedi.Por_Dsctos[1]" "Dsct.!2" "->9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
