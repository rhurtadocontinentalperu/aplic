...
DEFINE VAR X-TITU    AS CHAR INIT "PROYECCION SUGERIDA DE COMPRA".
...
DEFINE FRAME F-Main
     ...
     Btn_OK AT ROW 11 COL 39.29
     Btn_Cancel AT ROW 11 COL 50.57
     Btn_Help AT ROW 11 COL 62
     " Criterio de Selección" VIEW-AS TEXT
          SIZE 17.57 BY .5 AT ROW 1.35 COL 4.43
          FONT 6
...
ON END-ERROR OF W-Win /* Proyeccion Sugerida */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proyeccion Sugerida */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  IF F-DIVISION = "Lima" THEN DO:
        X-CODDIV  = "00001,00002,00003,00004,00005,00006,00008".
        X-ALMACEN = "03,04,05,83,89,18,19".
  END.
  ...
  IF F-DIVISION = "Total" THEN DO:
        X-CODDIV  = "00000,00001,00002,00003,00004,00005,00006,00008".
        X-ALMACEN = "11,03,04,05,83,89,18,19".
  END.
  IF F-DIVISION-2 <> "" THEN DO:
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DESDEF-3 = DATE(MONTH(TODAY),DAY(TODAY),YEAR(TODAY)) - 365.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-58 RECT-62 RECT-63 RECT-61 C-tipo F-Division F-DIVISION-2 
