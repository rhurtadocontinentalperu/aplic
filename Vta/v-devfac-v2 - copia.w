...
/*    END.                                                                                */
   ...
   x-cuantas-nc = 0.
   FOR EACH x-almcmov WHERE x-almcmov.codcia = s-codcia AND almcmov.tipmov = 'I' AND
                           x-almcmov.codmov = 9 AND almcmov.codref = ccbcdocu.coddoc AND
                           x-almcmov.nroref = ccbcdocu.nrodoc AND almcmov.flgest = 'P' NO-LOCK:
       x-cuantas-nc = x-cuantas-nc + 1.
   END.
   IF x-cuantas-nc > 0 THEN DO:
       MESSAGE "El documento " + ccbcdocu.coddoc + "-" + ccbcdocu.nrodoc SKIP
