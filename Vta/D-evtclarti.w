...
F-DIVISION BUTTON-5 C-tipo-2 F-clien BUTTON-4 DesdeC F-DIVISION-1 DesdeF ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-1 codW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-2 codW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-3 codW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-4 codW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-5 codW-Win
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-DIVISION-6 codW-Win
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-62 RECT-58 RECT-63 RECT-61 C-tipo F-DIVISION BUTTON-5 C-tipo-2 
         F-clien BUTTON-4 DesdeC F-DIVISION-1 DesdeF HastaF F-DIVISION-2 
...
------------------------------------------------------------------------------*/
    ...
    IF F-CLIEN <> "" AND DesdeC <> "" THEN RUN Carga-Temporal-1.
    IF F-CLIEN <> "" AND DesdeC = "" THEN RUN Carga-Temporal-2.
    IF F-CLIEN = "" AND DesdeC <> "" THEN RUN Carga-Temporal-3.
