...
DEFINE FRAME F-HdrOD
    ...
    /***************/
    /*RDP - 26.08.2010 Modifica Cabecera ***
    "O/COMPRA  : " AT 70 FacCPedi.OrdCmp SKIP
    ****/    
    /*RDP - 26.08.2010 Agrega Campos Impresión ****/    
    "TIPO VENTA : " C-NomCon FORMAT "X(50)" 
    "O/COMPRA  : " AT 70 FacCPedi.OrdCmp SKIP
    /*********************************/
    "DIRECCION : " FacCPedi.Dircli FORMAT "x(60)" SKIP 
    "RUC       : " FacCPedi.Ruccli FORMAT "x(11)" 
    "FCH ENTR. : " AT 70 FacCPedi.FchEnt AT 85 SKIP
...
FOR EACH FacDPedi NO-LOCK WHERE FacDPedi.CodCia = FacCPedi.CodCia 
      ...
      IF Facdpedi.Libre_c05 <> '' AND Facdpedi.Libre_c05 <> 'OF' 
          THEN x-desmat = Facdpedi.Libre_c05 + ' - ' + Almmmatg.desmat.
      VIEW FRAME F-HdrOD.
      VIEW FRAME F-FtrOD.
