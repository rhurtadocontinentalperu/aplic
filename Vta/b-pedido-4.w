...
Facdpedi.CanPed FacDPedi.canate Facdpedi.PorDto Facdpedi.PreUni ~
Facdpedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Facdpedi.CanPed COLUMN-LABEL "Cantidad!Solicitada" FORMAT ">>>,>>9.99":U
      FacDPedi.canate COLUMN-LABEL "Cantidad!Aprobada" FORMAT ">>>,>>9.99":U
      Facdpedi.PorDto FORMAT "->9.99":U
      Facdpedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>>.9999":U
      Facdpedi.ImpLin FORMAT ">,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 109 BY 9.96
         BGCOLOR 15 FONT 4.
...
"Facdpedi.CanPed" "Cantidad!Solicitada" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > integral.FacDPedi.canate
"FacDPedi.canate" "Cantidad!Aprobada" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > integral.Facdpedi.PorDto
"Facdpedi.PorDto" ? "->9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
