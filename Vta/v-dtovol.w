...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[1]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[1]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[10]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[2]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[2]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[3]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[4]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[5]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[6]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[7]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[8]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    IF INTEGER(Almmmatg.DtoVolR[9]:SCREEN-VALUE) = 0 AND DECI(SELF:SCREEN-VALUE) <> 0 THEN DO:
       ...
       RETURN NO-APPLY.
    END.    
    Almmmatg.DtoVolD[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1] ) * 100, 4 ) ).
