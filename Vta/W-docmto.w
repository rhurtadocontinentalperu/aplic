...
&Scoped-Define ENABLED-OBJECTS C-CodDoc C-NroSer Btn-Guias Btn-Pedido 
...
DEFINE FRAME F-Main
     C-CodDoc AT ROW 6.62 COL 3 NO-LABEL
     C-NroSer AT ROW 6.62 COL 10.57 NO-LABEL
     Btn-Guias AT ROW 8 COL 80.86
     Btn-Pedido AT ROW 8.96 COL 80.86
...
ON END-ERROR OF W-Win /* Consulta Comprobantes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consulta Comprobantes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-faccre ).
       RUN set-position IN h_v-faccre ( 1.12 , 2.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 6.50 , 27.14 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 1.27 , 16.29 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/q-docume':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-docmto ).
       RUN set-position IN h_q-docmto ( 6.50 , 17.72 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-docmto ).
       RUN set-position IN h_b-docmto ( 7.77 , 2.14 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpdoc ).
       RUN set-position IN h_b-tmpdoc ( 7.73 , 2.14 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE C-CodDoc C-NroSer Btn-Guias Btn-Pedido 
      WITH FRAME F-Main IN WINDOW W-Win.
