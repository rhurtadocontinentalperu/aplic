...
FacCPedi.CodCli FacCPedi.fchven FacCPedi.RucCli FacCPedi.NomCli ~
...
FacCPedi.FchPed FacCPedi.CodCli FacCPedi.fchven FacCPedi.RucCli ~
FacCPedi.NomCli FacCPedi.DirCli FacCPedi.TpoCmb FacCPedi.CodVen ~
...
"Normal", ""
     ...
     FacCPedi.RucCli AT ROW 2.54 COL 73 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .69
     FacCPedi.NomCli AT ROW 2.58 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 51 BY .69
...
------------------------------------------------------------------------------*/
  ...
  IF x-tipo = - 1  THEN DO:
      MESSAGE "eliminado " VIEW-AS ALERT-BOX.
  END.
