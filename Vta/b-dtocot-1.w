...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      facdpedi.PorDto COLUMN-LABEL "Dsct.!Incluido" FORMAT ">>9.99":U
      facdpedi.Por_Dsctos[1] COLUMN-LABEL "Dsct.!Manual" FORMAT "->>9.99":U
...
"facdpedi.PorDto" "Dsct.!Incluido" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > integral.facdpedi.Por_Dsctos[1]
"facdpedi.Por_Dsctos[1]" "Dsct.!Manual" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
 ...
 * END.*/
/*MESSAGE "PRUEBA" VIEW-AS ALERT-BOX.*/
END PROCEDURE.
