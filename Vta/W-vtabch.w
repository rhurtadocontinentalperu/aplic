...
IF AVAIL FacUsers THEN S-CodVen = FacUsers.CodVen.
...
&Scoped-Define ENABLED-OBJECTS Btn-Asigna Btn-Cotiza 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/v-vtabch.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-vtabch ).
       RUN set-position IN h_v-vtabch ( 1.00 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/q-vtamos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-vtamos ).
       RUN set-position IN h_q-vtamos ( 6.62 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 8.29 ) */
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-vtamos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-vtamos ).
       RUN set-position IN h_b-vtamos ( 8.00 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-vtamo1 ).
       RUN set-position IN h_v-vtamo1 ( 16.00 , 1.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-tmpvtm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpvtm ).
       RUN set-position IN h_b-tmpvtm ( 7.96 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.27 , 89.00 ) */
