...
&Scoped-Define DISPLAYED-OBJECTS F-TotBrt F-ImpExo F-PorDes F-ImpDes ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacDPedi.NroItm COLUMN-LABEL "Item"
      ...
      FacDPedi.UndVta COLUMN-LABEL "Unidad" FORMAT "X(6)"
      FacDPedi.AlmDes COLUMN-LABEL "Alm!Des"
      FacDPedi.CanPed FORMAT ">>,>>>.99"
      FacDPedi.PorDto
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">,>>>.9999"
      FacDPedi.ImpLin FORMAT ">>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 110 BY 7.54
         BGCOLOR 15 FONT 2.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 10.62 COL 4 NO-LABEL
     F-ImpExo AT ROW 10.62 COL 18 NO-LABEL
     F-PorDes AT ROW 8.88 COL 29 COLON-ALIGNED
     F-ImpDes AT ROW 10.65 COL 29.57 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 10.62 COL 46 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 10.62 COL 62 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 10.62 COL 78 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 10.62 COL 94 COLON-ALIGNED NO-LABEL
...
"FacDPedi.NroItm" "Item" ? "integer" ? ? ? ? ? ? no ?
...
"FacDPedi.UndVta" "Unidad" "X(6)" "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > integral.FacDPedi.AlmDes
"FacDPedi.AlmDes" "Alm!Des" ? "character" ? ? ? ? ? ? no ?
...
"FacDPedi.PreUni" "Precio!Unitario" ">,>>>.9999" "decimal" ? ? ? ? ? ? no ?
...
IF AVAILABLE FacCPedi THEN DO:
   DISPLAY FacCPedi.ImpDto @ F-ImpDes
           ...
           FacCPedi.PorDto @ F-PorDes WITH FRAME {&FRAME-NAME}.
END.
END PROCEDURE.
