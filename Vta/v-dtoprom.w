...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[1]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
   DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[10]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[2]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[3]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[4]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[5]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[6]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[7]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
   DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[8]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
DO:
 DO WITH FRAME {&FRAME-NAME}:
    ...
    IF DECIMAL(SELF:SCREEN-VALUE) = 0 THEN DO:
        ...
        RETURN.
    END.
    PromDto[9]:SCREEN-VALUE = STRING ( ROUND ( ( 1 -  DECIMAL(SELF:SCREEN-VALUE) / Almmmatg.PreVta[1]  ) * 100, 4 ) ).
 END.
...
/*                ? @ Almmmatg.PromFchH[10]. */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-10 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[10]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-10.
...
/*                ? @ Almmmatg.PromFchH[2].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-2 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[2]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-2.
...
/*                ? @ Almmmatg.PromFchH[3].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-3 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[3]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-3.
...
/*                ? @ Almmmatg.PromFchH[4].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-4 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[4]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-4.
...
/*                                          */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-5 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[5]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-5.
...
/*                ? @ Almmmatg.PromFchH[6].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-6 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[6]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-6.
...
/*                ? @ Almmmatg.PromFchH[7].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-7 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[7]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-7.
...
/*        RETURN.                           */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-8 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[8]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-8.
...
/*                ? @ Almmmatg.PromFchH[9].  */
    ...
    IF SELF:SCREEN-VALUE <> "" THEN DO:        
       ...
       IF NOT AVAILABLE Gn-Divi THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       F-PRECIO-9 = ROUND(Almmmatg.Prevta[1] * ( 1 - ( DECI(Almmmatg.PromDto[9]:SCREEN-VALUE) / 100 ) ),4).
       DISPLAY F-PRECIO-9.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Almmmatg THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     F-PRECIO-1 = IF PromDivi[1] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[1] / 100 ) ),4) ELSE 0.     
     F-PRECIO-2 = IF PromDivi[2] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[2] / 100 ) ),4) ELSE 0.
     F-PRECIO-3 = IF PromDivi[3] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[3] / 100 ) ),4) ELSE 0.
     F-PRECIO-4 = IF PromDivi[4] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[4] / 100 ) ),4) ELSE 0.
     F-PRECIO-5 = IF PromDivi[5] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[5] / 100 ) ),4) ELSE 0.
     F-PRECIO-6 = IF PromDivi[6] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[6] / 100 ) ),4) ELSE 0.
     F-PRECIO-7 = IF PromDivi[7] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[7] / 100 ) ),4) ELSE 0.
     F-PRECIO-8 = IF PromDivi[8] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[8] / 100 ) ),4) ELSE 0.
     F-PRECIO-9 = IF PromDivi[9] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[9] / 100 ) ),4) ELSE 0.
     F-PRECIO-10 = IF PromDivi[10] <> "" THEN ROUND(Almmmatg.Prevta[1] * ( 1 - ( PromDto[10] / 100 ) ),4) ELSE 0.
