...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Gn-ClieL.MonLC FORMAT "9":U WIDTH 10 VIEW-AS COMBO-BOX INNER-LINES 2
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114.72 BY 6.65
         FONT 2.
...
"Gn-ClieL.FchIni" ? ? "date" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Gn-ClieL.FchFin
"Gn-ClieL.FchFin" ? ? "date" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Gn-ClieL.MonLC
"Gn-ClieL.MonLC" ? ? "integer" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "DROP-DOWN-LIST" "," ? "Soles,1,Dolares,2" 2 no 0 no no
     _FldNameList[4]   > INTEGRAL.Gn-ClieL.ImpLC
"Gn-ClieL.ImpLC" ? ">,>>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Gn-ClieL.LCImpDiv[1]" "Div. 00150!ATLAS" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.Gn-ClieL.LCImpDiv[2]
"Gn-ClieL.LCImpDiv[2]" "Div. 00070!PERU COMPRAS" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > INTEGRAL.Gn-ClieL.LCSdoDiv
"Gn-ClieL.LCSdoDiv" "OTROS" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  DEF VAR s-LogTabla AS LOG INIT FALSE NO-UNDO.
