...
&Scoped-Define ENABLED-FIELDS gn-clie.CodCli gn-clie.NomCli gn-clie.Ruc ~
gn-clie.Rucold 
...
DEFINE FRAME F-Main
     gn-clie.CodCli AT ROW 1.38 COL 7 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 1 
     gn-clie.NomCli AT ROW 1.38 COL 19 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 47 BY .81
     gn-clie.Ruc AT ROW 2.15 COL 7 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 4 
     gn-clie.Rucold AT ROW 2.35 COL 53 NO-LABEL
...
"No", "No":U
     ...
     "Agente Retenedor:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 2.42 COL 39
