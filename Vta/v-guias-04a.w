...
&Scoped-Define ENABLED-OBJECTS RECT-67 
...
DEFINE FRAME F-Main
     ...
     CcbCDocu.NroRef AT ROW 6.92 COL 18 NO-LABEL FORMAT "XXX-XXXXXX"
          ...
          SIZE 11.29 BY .81
          FONT 0
     RECT-67 AT ROW 1 COL 1 WIDGET-ID 8
...
/*       AND Faccpedi.coddoc = Ccbcdocu.codref */
/*       AND Faccpedi.nroped = Ccbcdocu.nroref */
      NO-LOCK NO-ERROR.
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    IF AVAILABLE CcbCDocu THEN DO WITH FRAME {&FRAME-NAME}:
        CASE CcbCDocu.FlgEst:
            ...
            WHEN "P" THEN DISPLAY "CHEQUEADA" @ F-Estado.
