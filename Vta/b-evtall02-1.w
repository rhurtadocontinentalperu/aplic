...
DEFINE TEMP-TABLE ttevt-all02
    ...
    FIELDS ttevt-Canal           LIKE evtall01.Canal
    FIELDS ttevt-NroFch          LIKE EvtALL02.NroFch    
    FIELDS ttevt-AmountMesAct    LIKE EvtALL02.VtaxMesMn EXTENT 20
    FIELDS ttevt-AmountMesAnt    LIKE EvtALL02.VtaxMesMn EXTENT 20
    FIELDS ttevt-AmountMesVta    LIKE EvtALL02.VtaxMesMn EXTENT 20
    FIELDS ttevt-AmountMesCto    LIKE EvtALL02.VtaxMesMn EXTENT 20
    FIELDS ttevt-AmountMesMrg    LIKE EvtALL02.VtaxMesMn EXTENT 20
...
DEFINE VARIABLE cb-criterio AS CHARACTER FORMAT "X(256)":U INITIAL "División" 
     ...
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "División","Cliente","Familia","División - Cliente","División - Familia","Familia - Cliente","Canal" 
     DROP-DOWN-LIST
...
DO:
  ...
  CASE cb-criterio:
      ...
      WHEN "Canal  "  THEN RUN Carga-Canales. 
  END CASE.
  /*
  RUN Carga-Detalle.  */
  RUN Carga-Totales.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Canal B-table-Win 
PROCEDURE Carga-Canal :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    iInt = 0.
    FOR EACH almtabla WHERE almtabla.Tabla = "CN" NO-LOCK:
        FIND FIRST ttevt-all02 WHERE ttevt-all02.ttevt-CodCia = s-CodCia
            AND ttevt-all02.ttevt-Canal = almtabla.codigo NO-LOCK NO-ERROR.
        IF NOT AVAILABLE ttevt-all02 THEN DO:
            ...
            ASSIGN
                ...
                ttevt-all02.ttevt-Canal    = almtabla.Codigo
                ttevt-all02.ttevt-Criterio = almtabla.Codigo + " - " + almtabla.Nombre.
        END.
    END.
    ...
    FOR EACH ttevt-all02 NO-LOCK:
        FOR EACH evtcan NO-LOCK USE-INDEX Llave01 WHERE 
            evtcan.CodCia = ttevt-CodCia AND 
            evtcan.Canal  = ttevt-Canal  AND 
            ((evtcan.NroFch >= ((cb-anio - 1) * 100 + 01) AND
             evtcan.NroFch <= x-NroFchR) OR 
             (evtcan.NroFch >= (cb-anio * 100 + 01) AND
             evtcan.NroFch <= x-NroFchE)): 

            IF evtcan.NroFch = x-NroFchR THEN DO:
                ttevt-AmountMesAnt[1] = ttevt-AmountMesAnt[1] + evtcan.VtaxMesMn.
                ttevt-AmountMesAnt[2] = ttevt-AmountMesAnt[2] + evtcan.CtoxMesMn.
                ttevt-AmountMesAnt[3] = ttevt-AmountMesAnt[3] + (evtcan.VtaxMesMn - evtcan.CtoxMesMn).

                ttevt-AmountMesAnt[11] = ttevt-AmountMesAnt[11] + evtcan.VtaxMesMe.
                ttevt-AmountMesAnt[12] = ttevt-AmountMesAnt[12] + evtcan.CtoxMesMe.
                ttevt-AmountMesAnt[13] = ttevt-AmountMesAnt[13] + (evtcan.VtaxMesMe - evtcan.CtoxMesMe).
            END.

            IF evtcan.NroFch = x-NroFchE THEN DO:                    
                ttevt-AmountMesAct[1] = ttevt-AmountMesAct[1] + evtcan.VtaxMesMn.
                ttevt-AmountMesAct[2] = ttevt-AmountMesAct[2] + evtcan.CtoxMesMn.
                ttevt-AmountMesAct[3] = ttevt-AmountMesAct[3] +(evtcan.VtaxMesMn - evtcan.CtoxMesMn).

                ttevt-AmountMesAct[11] = ttevt-AmountMesAct[11] + evtcan.VtaxMesMe.
                ttevt-AmountMesAct[12] = ttevt-AmountMesAct[12] + evtcan.CtoxMesMe.
                ttevt-AmountMesAct[13] = ttevt-AmountMesAct[13] +(evtcan.VtaxMesMe - evtcan.CtoxMesMe).
            END.

            IF (evtcan.NroFch >= ((cb-anio - 1) * 100 + 01) AND evtcan.NroFch <= x-NroFchR) THEN DO:
                ttevt-AccumAnt[1] = ttevt-AccumAnt[1] + evtcan.VtaxMesMn.
                ttevt-AccumAnt[2] = ttevt-AccumAnt[2] + evtcan.CtoxMesMn.
                ttevt-AccumAnt[3] = ttevt-AccumAnt[3] + (evtcan.VtaxMesMn - evtcan.CtoxMesMn).

                ttevt-AccumAnt[11] = ttevt-AccumAnt[11] + evtcan.VtaxMesMe.
                ttevt-AccumAnt[12] = ttevt-AccumAnt[12] + evtcan.CtoxMesMe.
                ttevt-AccumAnt[13] = ttevt-AccumAnt[13] + (evtcan.VtaxMesMe - evtcan.CtoxMesMe).
            END.                    

            IF (evtcan.NroFch >= (cb-anio * 100 + 01) AND evtcan.NroFch <= x-NroFchE) THEN DO:
                ttevt-AccumAct[1] = ttevt-AccumAct[1] + evtcan.VtaxMesMn.
                ttevt-AccumAct[2] = ttevt-AccumAct[2] + evtcan.CtoxMesMn.
                ttevt-AccumAct[3] = ttevt-AccumAct[3] + (evtcan.VtaxMesMn - evtcan.CtoxMesMn).

                ttevt-AccumAct[11] = ttevt-AccumAct[11] + evtcan.VtaxMesMe.
                ttevt-AccumAct[12] = ttevt-AccumAct[12] + evtcan.CtoxMesMe.
                ttevt-AccumAct[13] = ttevt-AccumAct[13] + (evtcan.VtaxMesMe - evtcan.CtoxMesMe).
            END.                    
            PAUSE 0.
        END.
        DISPLAY
            'Espere un momento por favor...' SKIP
            'Procesando Información Canal: ' ttevt-all02.ttevt-Canal NO-LABEL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Canales B-table-Win 
PROCEDURE Carga-Canales :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
------------------------------------------------------------------------------*/    
    ...
    iInt    = 0.
    Clientes:
    FOR EACH evtall03 NO-LOCK USE-INDEX Indice02 WHERE evtall03.Codcia = s-codcia 
        BY EvtALL03.VtaxMesMe DESC:        
        FIND FIRST gn-cliex WHERE gn-cliex.CodCia = cl-codcia
            AND gn-cliex.CodUnico = evtall03.CodUnico NO-LOCK NO-ERROR.
        ...
        FIND FIRST ttevt-all02 WHERE ttevt-all02.ttevt-CodCia = evtall03.CodCia
            AND ttevt-all02.ttevt-CodUnico = evtall03.CodUnico NO-LOCK NO-ERROR.       
        IF NOT AVAILABLE ttevt-all02 THEN DO:
            iInt =  iInt + 1.
            CREATE ttevt-all02.
            ASSIGN
                ttevt-all02.ttevt-CodCia   = evtall03.Codcia
                ttevt-all02.ttevt-Indice   = iInt
                ttevt-all02.ttevt-CodUnico = evtall03.CodUnico
                ttevt-all02.ttevt-Criterio = evtall03.CodUnico + " - " + cName.  
        END.
    ...
    FOR EACH ttevt-all02 NO-LOCK:
        ...
        FOR EACH evtall02 NO-LOCK USE-INDEX Indice03 WHERE 
            evtall02.CodCia = ttevt-all02.ttevt-CodCia AND 
            evtall02.CodUnico = ttevt-all02.ttevt-CodUnico AND 
            ((evtall02.NroFch  >= x-NroFchI AND
            evtall02.NroFch   <= ((cb-anio - 1) * 100 + cb-mes)) OR
            ( evtall02.NroFch >= (cb-anio * 100 + 01) AND 
            evtall02.NroFch   <= x-NroFchE)):  

            IF evtall02.NroFch = x-NroFchR THEN DO:
                dVtaAnt[1] = dVtaAnt[1] + evtall02.VtaxMesMn.
                dVtaAnt[2] = dVtaAnt[2] + evtall02.CtoxMesMn.
                dVtaAnt[3] = dVtaAnt[3] + (evtall02.VtaxMesMn - evtall02.CtoxMesMn).

                dVtaAnt[11] = dVtaAnt[11] + evtall02.VtaxMesMe.
                dVtaAnt[12] = dVtaAnt[12] + evtall02.CtoxMesMe.
                dVtaAnt[13] = dVtaAnt[13] + (evtall02.VtaxMesMe - evtall02.CtoxMesMe).
            END.

            IF evtall02.NroFch = x-NroFchE THEN DO:                    
                dVtaAct[1] = dVtaAct[1] + evtall02.VtaxMesMn.
                dVtaAct[2] = dVtaAct[2] + evtall02.CtoxMesMn.
                dVtaAct[3] = dVtaAct[3] +(evtall02.VtaxMesMn - evtall02.CtoxMesMn).

                dVtaAct[11] = dVtaAct[11] + evtall02.VtaxMesMe.
                dVtaAct[12] = dVtaAct[12] + evtall02.CtoxMesMe.
                dVtaAct[13] = dVtaAct[13] +(evtall02.VtaxMesMe - evtall02.CtoxMesMe).
            END.

            IF (evtall02.NroFch >= ((cb-anio - 1) * 100 + 01) AND evtall02.NroFch <= x-NroFchR) THEN DO:
                dAcumAnt[1] = dAcumAnt[1] + evtall02.VtaxMesMn.
                dAcumAnt[2] = dAcumAnt[2] + evtall02.CtoxMesMn.
                dAcumAnt[3] = dAcumAnt[3] + (evtall02.VtaxMesMn - evtall02.CtoxMesMn).

                dAcumAnt[11] = dAcumAnt[11] + evtall02.VtaxMesMe.
                dAcumAnt[12] = dAcumAnt[12] + evtall02.CtoxMesMe.
                dAcumAnt[13] = dAcumAnt[13] + (evtall02.VtaxMesMe - evtall02.CtoxMesMe).
            END.                    

            IF (evtall02.NroFch >= (cb-anio * 100 + 01) AND evtall02.NroFch <= x-NroFchE) THEN DO:
                dAcumAct[1] = dAcumAct[1] + evtall02.VtaxMesMn.
                dAcumAct[2] = dAcumAct[2] + evtall02.CtoxMesMn.
                dAcumAct[3] = dAcumAct[3] + (evtall02.VtaxMesMn - evtall02.CtoxMesMn).

                dAcumAct[11] = dAcumAct[11] + evtall02.VtaxMesMe.
                dAcumAct[12] = dAcumAct[12] + evtall02.CtoxMesMe.
                dAcumAct[13] = dAcumAct[13] + (evtall02.VtaxMesMe - evtall02.CtoxMesMe).
            END.                    
            PAUSE 0.
            ASSIGN
...
------------------------------------------------------------------------------*/
    ...
    x-NroFchE = (cb-anio  * 100) + cb-mes.
    FOR EACH ttevt-all02 NO-LOCK:
        FOR EACH evtdivi NO-LOCK USE-INDEX Llave01 WHERE 
            evtdivi.CodCia = ttevt-CodCia AND 
            evtdivi.CodDiv = ttevt-CodDiv AND 
            ((evtdivi.NroFch >= ((cb-anio - 1) * 100 + 01) AND
             evtdivi.NroFch <= x-NroFchR) OR 
             (evtdivi.NroFch >= (cb-anio * 100 + 01) AND
             evtdivi.NroFch <= x-NroFchE)): 

            IF evtdivi.NroFch = x-NroFchR THEN DO:
                ttevt-AmountMesAnt[1] = ttevt-AmountMesAnt[1] + evtdivi.VtaxMesMn.
                ttevt-AmountMesAnt[2] = ttevt-AmountMesAnt[2] + evtdivi.CtoxMesMn.
                ttevt-AmountMesAnt[3] = ttevt-AmountMesAnt[3] + (evtdivi.VtaxMesMn - evtdivi.CtoxMesMn).

                ttevt-AmountMesAnt[11] = ttevt-AmountMesAnt[11] + evtdivi.VtaxMesMe.
                ttevt-AmountMesAnt[12] = ttevt-AmountMesAnt[12] + evtdivi.CtoxMesMe.
                ttevt-AmountMesAnt[13] = ttevt-AmountMesAnt[13] + (evtdivi.VtaxMesMe - evtdivi.CtoxMesMe).
            END.

            IF evtdivi.NroFch = x-NroFchE THEN DO:                    
                ttevt-AmountMesAct[1] = ttevt-AmountMesAct[1] + evtdivi.VtaxMesMn.
                ttevt-AmountMesAct[2] = ttevt-AmountMesAct[2] + evtdivi.CtoxMesMn.
                ttevt-AmountMesAct[3] = ttevt-AmountMesAct[3] +(evtdivi.VtaxMesMn - evtdivi.CtoxMesMn).

                ttevt-AmountMesAct[11] = ttevt-AmountMesAct[11] + evtdivi.VtaxMesMe.
                ttevt-AmountMesAct[12] = ttevt-AmountMesAct[12] + evtdivi.CtoxMesMe.
                ttevt-AmountMesAct[13] = ttevt-AmountMesAct[13] +(evtdivi.VtaxMesMe - evtdivi.CtoxMesMe).
            END.

            IF (evtdivi.NroFch >= ((cb-anio - 1) * 100 + 01) AND evtdivi.NroFch <= x-NroFchR) THEN DO:
                ttevt-AccumAnt[1] = ttevt-AccumAnt[1] + evtdivi.VtaxMesMn.
                ttevt-AccumAnt[2] = ttevt-AccumAnt[2] + evtdivi.CtoxMesMn.
                ttevt-AccumAnt[3] = ttevt-AccumAnt[3] + (evtdivi.VtaxMesMn - evtdivi.CtoxMesMn).

                ttevt-AccumAnt[11] = ttevt-AccumAnt[11] + evtdivi.VtaxMesMe.
                ttevt-AccumAnt[12] = ttevt-AccumAnt[12] + evtdivi.CtoxMesMe.
                ttevt-AccumAnt[13] = ttevt-AccumAnt[13] + (evtdivi.VtaxMesMe - evtdivi.CtoxMesMe).
            END.                    

            IF (evtdivi.NroFch >= (cb-anio * 100 + 01) AND evtdivi.NroFch <= x-NroFchE) THEN DO:
                ttevt-AccumAct[1] = ttevt-AccumAct[1] + evtdivi.VtaxMesMn.
                ttevt-AccumAct[2] = ttevt-AccumAct[2] + evtdivi.CtoxMesMn.
                ttevt-AccumAct[3] = ttevt-AccumAct[3] + (evtdivi.VtaxMesMn - evtdivi.CtoxMesMn).

                ttevt-AccumAct[11] = ttevt-AccumAct[11] + evtdivi.VtaxMesMe.
                ttevt-AccumAct[12] = ttevt-AccumAct[12] + evtdivi.CtoxMesMe.
                ttevt-AccumAct[13] = ttevt-AccumAct[13] + (evtdivi.VtaxMesMe - evtdivi.CtoxMesMe).
            END.                    
            PAUSE 0.
        END.
        DISPLAY
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH gn-divi WHERE gn-divi.CodCia = s-CodCia NO-LOCK:
        iCount = 0.
        Clientes:
        FOR EACH evtall03 NO-LOCK USE-INDEX Indice02 WHERE evtall03.Codcia = gn-divi.CodCia
            BY EvtALL03.VtaxMesMe DESC:
    ...
    FOR EACH ttevt-all02 NO-LOCK USE-INDEX Indx01:
        ...
        dAcumAct = 0.
        dAcumAnt = 0.
        FOR EACH evtall02 NO-LOCK USE-INDEX Indice05 WHERE 
            evtall02.CodCia   = ttevt-CodCia   AND 
            evtall02.CodDiv   = ttevt-CodDiv   AND 
            evtall02.CodUnico = ttevt-CodUnico AND 
            ((evtall02.NroFch >= x-NroFchI AND
            evtall02.NroFch  <= ((cb-anio - 1) * 100 + cb-mes)) OR
            (evtall02.NroFch >= (cb-anio * 100 + 01) AND 
            evtall02.NroFch  <= x-NroFchE)): 
...
------------------------------------------------------------------------------*/
    ...
    x-NroFchE = (cb-anio  * 100) + cb-mes.
    FOR EACH ttevt-all02 NO-LOCK USE-INDEX Indx01:
        FOR EACH evtline NO-LOCK WHERE 
            evtline.CodCia = ttevt-CodCia AND 
            evtline.CodDiv = ttevt-CodDiv AND 
            evtline.CodFam = ttevt-CodFam AND 
            ((evtline.NroFch >= ((cb-anio - 1) * 100 + 01) AND
             evtline.NroFch <= x-NroFchR) OR 
             (evtline.NroFch >= (cb-anio * 100 + 01) AND
             evtline.NroFch <= x-NroFchE)): 

            IF evtline.NroFch = x-NroFchR THEN DO:
                ttevt-AmountMesAnt[1] = ttevt-AmountMesAnt[1] + evtline.VtaxMesMn.
                ttevt-AmountMesAnt[2] = ttevt-AmountMesAnt[2] + evtline.CtoxMesMn.
                ttevt-AmountMesAnt[3] = ttevt-AmountMesAnt[3] + (evtline.VtaxMesMn - evtline.CtoxMesMn).

                ttevt-AmountMesAnt[11] = ttevt-AmountMesAnt[11] + evtline.VtaxMesMe.
                ttevt-AmountMesAnt[12] = ttevt-AmountMesAnt[12] + evtline.CtoxMesMe.
                ttevt-AmountMesAnt[13] = ttevt-AmountMesAnt[13] + (evtline.VtaxMesMe - evtline.CtoxMesMe).
            END.

            IF evtline.NroFch = x-NroFchE THEN DO:                    
                ttevt-AmountMesAct[1] = ttevt-AmountMesAct[1] + evtline.VtaxMesMn.
                ttevt-AmountMesAct[2] = ttevt-AmountMesAct[2] + evtline.CtoxMesMn.
                ttevt-AmountMesAct[3] = ttevt-AmountMesAct[3] +(evtline.VtaxMesMn - evtline.CtoxMesMn).

                ttevt-AmountMesAct[11] = ttevt-AmountMesAct[11] + evtline.VtaxMesMe.
                ttevt-AmountMesAct[12] = ttevt-AmountMesAct[12] + evtline.CtoxMesMe.
                ttevt-AmountMesAct[13] = ttevt-AmountMesAct[13] +(evtline.VtaxMesMe - evtline.CtoxMesMe).
            END.

            IF (evtline.NroFch >= ((cb-anio - 1) * 100 + 01) AND evtline.NroFch <= x-NroFchR) THEN DO:
                ttevt-AccumAnt[1] = ttevt-AccumAnt[1] + evtline.VtaxMesMn.
                ttevt-AccumAnt[2] = ttevt-AccumAnt[2] + evtline.CtoxMesMn.
                ttevt-AccumAnt[3] = ttevt-AccumAnt[3] + (evtline.VtaxMesMn - evtline.CtoxMesMn).

                ttevt-AccumAnt[11] = ttevt-AccumAnt[11] + evtline.VtaxMesMe.
                ttevt-AccumAnt[12] = ttevt-AccumAnt[12] + evtline.CtoxMesMe.
                ttevt-AccumAnt[13] = ttevt-AccumAnt[13] + (evtline.VtaxMesMe - evtline.CtoxMesMe).
            END.                    

            IF (evtline.NroFch >= (cb-anio * 100 + 01) AND evtline.NroFch <= x-NroFchE) THEN DO:
                ttevt-AccumAct[1] = ttevt-AccumAct[1] + evtline.VtaxMesMn.
                ttevt-AccumAct[2] = ttevt-AccumAct[2] + evtline.CtoxMesMn.
                ttevt-AccumAct[3] = ttevt-AccumAct[3] + (evtline.VtaxMesMn - evtline.CtoxMesMn).

                ttevt-AccumAct[11] = ttevt-AccumAct[11] + evtline.VtaxMesMe.
                ttevt-AccumAct[12] = ttevt-AccumAct[12] + evtline.CtoxMesMe.
                ttevt-AccumAct[13] = ttevt-AccumAct[13] + (evtline.VtaxMesMe - evtline.CtoxMesMe).
            END.                    
            PAUSE 0.
        END.
        DISPLAY
            'Espere un momento por favor...' SKIP
            'Procesando Información Linea: ' ttevt-all02.ttevt-CodFam NO-LABEL
            WITH FRAME F-Mensaje TITLE 'Procesando informacion' CENTERED OVERLAY VIEW-AS DIALOG-BOX.
    END.
    HIDE FRAME f-Mensaje.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH AlmtFami WHERE AlmtFami.CodCia = s-CodCia NO-LOCK:
        iCount = 0.
        Clientes:
        FOR EACH evtall03 NO-LOCK USE-INDEX Indice02 WHERE evtall03.Codcia = AlmtFami.CodCia
            BY EvtALL03.VtaxMesMe DESC:
    ...
    FOR EACH ttevt-all02 NO-LOCK USE-INDEX Indx01:
        ...
        FOR EACH evtall02 NO-LOCK USE-INDEX Indice03 WHERE 
            evtall02.CodCia   = ttevt-CodCia   AND 
            evtall02.CodFam   = ttevt-CodFam   AND 
            evtall02.CodUnico = ttevt-CodUnico AND 
            ((evtall02.NroFch >= x-NroFchI AND
            evtall02.NroFch  <= ((cb-anio - 1) * 100 + cb-mes)) OR
            (evtall02.NroFch >= (cb-anio * 100 + 01) AND 
