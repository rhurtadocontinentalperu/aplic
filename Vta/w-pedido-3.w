...
&Scoped-Define ENABLED-OBJECTS btn-margen BTN-COTIZA BTN-CCTE Btn-Excel 
...
DEFINE FRAME F-Main
     ...
     BTN-CCTE AT ROW 2.62 COL 103 WIDGET-ID 4
     Btn-Excel AT ROW 7.73 COL 106 WIDGET-ID 20
...
DO:
  ...
  RUN dispatch IN h_t-pedido-3 ('open-query':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/t-pedido-3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedido-3 ).
       RUN set-position IN h_t-pedido-3 ( 12.85 , 2.00 ) NO-ERROR.
       RUN set-size IN h_t-pedido-3 ( 10.69 , 108.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_t-pedido-3 ).
       RUN add-link IN adm-broker-hdl ( h_q-pedido , 'Record':U , h_t-pedido-3 ).
...
------------------------------------------------------------------------------*/
  ENABLE btn-margen BTN-COTIZA BTN-CCTE Btn-Excel 
