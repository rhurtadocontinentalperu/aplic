...
Facdpedi.CanPed FacDPedi.Libre_d02 Facdpedi.PreUni Facdpedi.PorDto ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.Libre_d02 COLUMN-LABEL "Cantidad!Solicitada" FORMAT ">>>,>>9.99":U
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 11.04 COL 11 COLON-ALIGNED
     F-TotBrt AT ROW 12.38 COL 13 NO-LABEL
     F-ImpExo AT ROW 12.38 COL 25 NO-LABEL
     F-ValVta AT ROW 12.38 COL 47.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 12.38 COL 59.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 12.38 COL 72.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 12.38 COL 85 COLON-ALIGNED NO-LABEL
     F-ImpDes AT ROW 12.42 COL 35 COLON-ALIGNED NO-LABEL
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 11.81 COL 77.14
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.81 COL 25.57
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 11.81 COL 87.14
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 11.85 COL 37.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.85 COL 50.86
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 11.81 COL 65.57
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 11.81 COL 15
...
"FacDPedi.Libre_d02" "Cantidad!Solicitada" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
