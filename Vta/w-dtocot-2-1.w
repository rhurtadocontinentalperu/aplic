  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-dtocot-2 ).
       RUN set-position IN h_b-dtocot-2 ( 6.38 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-dtocot-2 ( 10.50 , 127.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-tdtoco-2-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tdtoco-2 ).
       RUN set-position IN h_b-tdtoco-2 ( 6.38 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-tdtoco-2 ( 9.42 , 129.00 ) NO-ERROR.
