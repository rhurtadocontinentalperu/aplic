...
Almmmatg.DesMar 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table VtaDList.codmat 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table VtaDList
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table VtaDList
&Scoped-define QUERY-STRING-br_table FOR EACH VtaDList OF VtaCList WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
&Scoped-Define ENABLED-OBJECTS BUTTON-4 BUTTON-5 FILL-IN-DesMat br_table 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaDList.codmat COLUMN-LABEL "Codigo" FORMAT "X(6)":U
...
"VtaDList.codmat" "Codigo" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
