...
gn-ven.Libre_c01 gn-ven.CodAnt gn-ven.Libre_c03 
...
gn-ven.flgest gn-ven.Libre_c01 gn-ven.CodAnt gn-ven.Libre_c03 
...
DEFINE FRAME F-Main
     gn-ven.CodVen AT ROW 1.19 COL 13 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     gn-ven.Libre_c04 AT ROW 2.08 COL 13 COLON-ALIGNED WIDGET-ID 32
          LABEL "Código de Planilla" FORMAT "x(6)"
          VIEW-AS FILL-IN 
          SIZE 8 BY .81
     gn-ven.NomVen AT ROW 2.96 COL 13 COLON-ALIGNED
          LABEL "Nombre"
          VIEW-AS FILL-IN 
          SIZE 49 BY .81
     gn-ven.CCo AT ROW 3.85 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-Cco AT ROW 3.85 COL 19 COLON-ALIGNED NO-LABEL
     gn-ven.PtoVta AT ROW 4.73 COL 13 COLON-ALIGNED
          LABEL "Canal de venta"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-Canal AT ROW 4.73 COL 19 COLON-ALIGNED NO-LABEL
     gn-ven.ComPor AT ROW 5.65 COL 13 COLON-ALIGNED
          LABEL "% de Comision"
          VIEW-AS FILL-IN 
          SIZE 5.72 BY .81
     gn-ven.Libre_c02 AT ROW 6.35 COL 46 NO-LABEL WIDGET-ID 18
...
"Sur", "S":U
          SIZE 16 BY 3.46
     gn-ven.flgest AT ROW 6.54 COL 15 NO-LABEL WIDGET-ID 2
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Activo", "A":U,
"Cesado", "C":U
          SIZE 17 BY 1.08
     gn-ven.Libre_c01 AT ROW 7.46 COL 15 NO-LABEL WIDGET-ID 8
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Todos", "",
"A", "A":U,
"A y B", "B":U
          SIZE 23 BY 1.04
     gn-ven.CodAnt AT ROW 8.77 COL 13 COLON-ALIGNED WIDGET-ID 36
     ...
     "Digite ~"999999~" (sin comillas) para un vendedor genérico" VIEW-AS TEXT
          SIZE 40 BY .5 AT ROW 2.27 COL 24 WIDGET-ID 34
          BGCOLOR 14 FGCOLOR 0 
     "Zona Asignada" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 5.69 COL 45.86 WIDGET-ID 24
          FGCOLOR 4 FONT 6
