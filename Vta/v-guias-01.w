...
DEFINE FRAME F-Main
     ...
     CcbCDocu.NroRef AT ROW 1.12 COL 53.72 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .69
     F-Estado AT ROW 1.12 COL 69 COLON-ALIGNED NO-LABEL
  ...
  IF L-CREA THEN DO WITH FRAME {&FRAME-NAME}:
     ...
     ASSIGN CcbCDocu.CodCia = S-CODCIA
         ...
         /* CcbCDocu.FchDoc = TODAY */
            ...
            CcbCDocu.FlgEst = "X"       /* EStado: "Por chequear" */
            CcbCDocu.FlgSit = "P"
         /* CcbCDocu.FlgAte = "P" */
 ...
 *     END.*/
    CASE CcbCDocu.FlgEst:
         ...
         WHEN "P" THEN DISPLAY "CHEQUEADO" @ F-Estado WITH FRAME {&FRAME-NAME}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Papel-Blanco V-table-Win 
...
------------------------------------------------------------------------------*/
  ...
  RB-REPORT-NAME = 'Guia de Remision'.
  RB-INCLUDE-RECORDS = "O".
  RB-FILTER = "ccbcdocu.codcia = " + STRING(ccbcdocu.codcia) +
                " AND ccbcdocu.coddoc = '" + ccbcdocu.coddoc + "'" +
