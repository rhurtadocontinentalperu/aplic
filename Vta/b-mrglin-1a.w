...
DEF VAR s-Tabla AS CHAR INIT "MMLL" NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VtaTabla.Valor[1] COLUMN-LABEL "Productos!de Terceros!% Margen Mínimo" FORMAT "->>>,>>>,>>9.999999":U
            WIDTH 13.43
      VtaTabla.Valor[2] COLUMN-LABEL "Productos Propios!% Margen Mínimo" FORMAT "->>>,>>9.9999":U
            WIDTH 10.72
  ENABLE
      VtaTabla.Llave_c2
      VtaTabla.Valor[1]
...
"VtaTabla.Valor[1]" "Productos!de Terceros!% Margen Mínimo" ? "decimal" ? ? ? ? ? ? yes ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.VtaTabla.Valor[2]
"VtaTabla.Valor[2]" "Productos Propios!% Margen Mínimo" "->>>,>>9.9999" "decimal" ? ? ? ? ? ? yes ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
FOR EACH B-Tabla NO-LOCK WHERE B-Tabla.CodCia = s-codcia
    ...
    CREATE T-Tabla.
    ASSIGN
        T-Tabla.CodCia = B-Tabla.CodCia 
        T-Tabla.Libre_c01 = B-Tabla.Libre_c01 
        T-Tabla.Libre_c02 = B-Tabla.Libre_c02 
        T-Tabla.Libre_c03 = B-Tabla.Libre_c03 
        T-Tabla.Llave_c1 = B-Tabla.Llave_c1 
        T-Tabla.Llave_c2 = B-Tabla.Llave_c2 
        T-Tabla.LLave_c3 = B-Tabla.LLave_c3 
        T-Tabla.Llave_c4 = B-Tabla.Llave_c4 
        T-Tabla.Llave_c5 = B-Tabla.Llave_c5 
        T-Tabla.Llave_c6 = B-Tabla.Llave_c6 
        T-Tabla.Llave_c7 = B-Tabla.Llave_c7 
        T-Tabla.Llave_c8 = B-Tabla.Llave_c8 
        T-Tabla.Rango_fecha[1] = B-Tabla.Rango_fecha[1] 
        T-Tabla.Rango_fecha[2] = B-Tabla.Rango_fecha[2] 
        T-Tabla.Rango_valor[1] = B-Tabla.Rango_valor[1] 
        T-Tabla.Rango_valor[2] = B-Tabla.Rango_valor[2] 
        T-Tabla.Tabla = B-Tabla.Tabla 
        T-Tabla.Valor[1] = B-Tabla.Valor[1] 
        T-Tabla.Valor[2] = B-Tabla.Valor[2] 
        T-Tabla.Valor[3] = B-Tabla.Valor[3] 
        T-Tabla.Valor[4] = B-Tabla.Valor[4] 
        T-Tabla.Valor[5] = B-Tabla.Valor[5] 
        T-Tabla.Valor[6] = B-Tabla.Valor[6] 
        T-Tabla.Valor[7] = B-Tabla.Valor[7] 
        T-Tabla.Valor[8] = B-Tabla.Valor[8] 
        T-Tabla.Valor[9] = B-Tabla.Valor[9] 
        T-Tabla.Valor[10] = B-Tabla.Valor[10] 
        T-Tabla.Valor[11] = B-Tabla.Valor[11] 
        T-Tabla.Valor[12] = B-Tabla.Valor[12] 
        T-Tabla.Valor[13] = B-Tabla.Valor[13] 
        T-Tabla.Valor[14] = B-Tabla.Valor[14] 
        T-Tabla.Valor[15] = B-Tabla.Valor[15] 
        T-Tabla.Valor[16] = B-Tabla.Valor[16] 
        T-Tabla.Valor[17] = B-Tabla.Valor[17] 
        T-Tabla.Valor[18] = B-Tabla.Valor[18] 
        T-Tabla.Valor[19] = B-Tabla.Valor[19] 
        T-Tabla.Valor[20] = B-Tabla.Valor[20].
