...
FacCPedi.RucCli FacCPedi.ordcmp FacCPedi.Cmpbnte FacCPedi.CodVen ~
FacCPedi.CodMon FacCPedi.FmaPgo FacCPedi.FlgIgv FacCPedi.NroCard ~
FacCPedi.Glosa 
&Scoped-define ENABLED-TABLES FacCPedi
&Scoped-define FIRST-ENABLED-TABLE FacCPedi
&Scoped-Define ENABLED-OBJECTS RECT-20 F-NRODEC 
...
FacCPedi.fchven FacCPedi.RucCli FacCPedi.ordcmp FacCPedi.Sede ~
FacCPedi.Cmpbnte FacCPedi.CodVen FacCPedi.CodMon FacCPedi.FmaPgo ~
FacCPedi.FlgIgv FacCPedi.NroCard FacCPedi.Glosa 
...
DEFINE FRAME F-Main
     ...
     FacCPedi.ordcmp AT ROW 3.69 COL 88 COLON-ALIGNED
          ...
          SIZE 10.14 BY .81
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.Sede AT ROW 4.5 COL 9 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     ...
     FacCPedi.Cmpbnte AT ROW 4.5 COL 88 COLON-ALIGNED WIDGET-ID 2
          ...
          SIZE 8 BY 1
          BGCOLOR 11 FGCOLOR 9 
     FacCPedi.CodVen AT ROW 5.31 COL 9 COLON-ALIGNED FORMAT "x(3)"
          VIEW-AS FILL-IN 
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     f-NomVen AT ROW 5.31 COL 15 COLON-ALIGNED NO-LABEL
...
"US$", 2
     ...
     FacCPedi.FmaPgo AT ROW 6.12 COL 9 COLON-ALIGNED
          ...
          SIZE 4.86 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-CndVta AT ROW 6.12 COL 15 COLON-ALIGNED NO-LABEL
...
"No", no
          SIZE 11.57 BY .81
     FacCPedi.NroCard AT ROW 6.92 COL 9 COLON-ALIGNED
          LABEL "Nro.Tarjeta"
          VIEW-AS FILL-IN 
          SIZE 11.57 BY .81
          BGCOLOR 11 FGCOLOR 9 
     F-Nomtar AT ROW 6.92 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 4
...
/*ML01* Inicio de bloque */
    IF x-Linea BEGINS 'DPGR' AND NUM-ENTRIES(x-Linea) > 1 THEN DO:
        ...
        FOR FIRST GN-ClieD
            FIELDS (GN-ClieD.CodCia GN-ClieD.CodCli GN-ClieD.dircli
                GN-ClieD.Libre_c01 GN-ClieD.sede)
...
/*ML01* Inicio de bloque ***/
        FOR FIRST GN-ClieD
            FIELDS (GN-ClieD.CodCia GN-ClieD.CodCli GN-ClieD.dircli GN-ClieD.sede)
            WHERE GN-ClieD.CodCia = CL-CODCIA
        ...
        END.
        IF AVAILABLE GN-ClieD THEN
            ASSIGN FILL-IN-sede = GN-ClieD.dircli.
