...
&SCOPED-DEFINE l-lookup h_l-mserv.
...
DEFINE VARIABLE h_l-mserv AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* Servicios */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/l-mserv.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-mserv ).
       RUN set-position IN h_l-mserv ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-mserv. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-mserv ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-mserv ,
