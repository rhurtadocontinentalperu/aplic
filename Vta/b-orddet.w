...
DEFINE VARIABLE x-canpen LIKE FacDPedi.CanAte.
...
FacDPedi.canate x-canpen @ x-canpen FacDPedi.PreUni FacDPedi.PorDto ~
FacDPedi.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(41)"
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(13)"
      FacDPedi.UndVta COLUMN-LABEL "Unidad"
      FacDPedi.CanPed COLUMN-LABEL "Cantidad!Pedido" COLUMN-FGCOLOR 15 COLUMN-BGCOLOR 12
      FacDPedi.canate COLUMN-LABEL "Cantidad!Atendida" COLUMN-BGCOLOR 14
      x-canpen @ x-canpen COLUMN-LABEL "Cantidad!por Despachar" FORMAT ">,>>>,>>9.99"
            COLUMN-BGCOLOR 10
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 87.72 BY 6.31
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-TotBrt AT ROW 8.12 COL 3.72 NO-LABEL
     F-ImpExo AT ROW 8.12 COL 15.72 NO-LABEL
     F-ImpDes AT ROW 8.15 COL 25.72 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 8.12 COL 37.86 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 8.12 COL 50.57 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 8.12 COL 63.14 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 8.12 COL 75.72 COLON-ALIGNED NO-LABEL
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 7.65 COL 28.14
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 7.62 COL 16
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 7.62 COL 5.43
     RECT-11 AT ROW 7.65 COL 1
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 7.62 COL 77.72
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 7.62 COL 67.72
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 7.65 COL 41.43
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 7.62 COL 56.14
...
"Almmmatg.DesMat" ? "X(41)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > integral.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" "X(13)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > integral.FacDPedi.UndVta
"FacDPedi.UndVta" "Unidad" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > integral.FacDPedi.CanPed
"FacDPedi.CanPed" "Cantidad!Pedido" ? "decimal" 12 15 ? ? ? ? no ?
     _FldNameList[7]   > integral.FacDPedi.canate
"FacDPedi.canate" "Cantidad!Atendida" ? "decimal" 14 ? ? ? ? ? no ?
     _FldNameList[8]   > "_<CALC>"
"x-canpen @ x-canpen" "Cantidad!por Despachar" ">,>>>,>>9.99" ? 10 ? ? ? ? ? no ?
...
ON FIND OF FacDPedi DO:
    x-canpen = FacDPedi.CanPed - FacDPedi.canate.
END.
