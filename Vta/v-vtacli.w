...
gn-clie.Ruc gn-clie.CodDiv gn-clie.ApePat gn-clie.ApeMat gn-clie.Nombre ~
gn-clie.CodIBC gn-clie.NomCli gn-clie.Telfnos[1] gn-clie.DirCli ~
gn-clie.Telfnos[2] gn-clie.DirEnt gn-clie.FaxCli gn-clie.CodDept ~
gn-clie.E-Mail gn-clie.CodProv gn-clie.Transporte[4] gn-clie.CodDist ~
gn-clie.Codpos gn-clie.NroCard gn-clie.Canal gn-clie.CodVen gn-clie.GirCli ~
gn-clie.CndVta gn-clie.Aval1[5] gn-clie.Aval2[5] gn-clie.RepLeg[1] 
&Scoped-define ENABLED-TABLES gn-clie
&Scoped-define FIRST-ENABLED-TABLE gn-clie
&Scoped-Define ENABLED-OBJECTS RECT-29 RECT-28 
&Scoped-Define DISPLAYED-FIELDS gn-clie.CodCli gn-clie.Flgsit ~
gn-clie.Rucold gn-clie.Ruc gn-clie.CodUnico gn-clie.CodDiv gn-clie.ApePat ~
gn-clie.ApeMat gn-clie.Nombre gn-clie.CodIBC gn-clie.NomCli ~
...
gn-clie.Transporte[4] gn-clie.CodDist gn-clie.Codpos gn-clie.Fching ~
gn-clie.FchAct gn-clie.FchCes gn-clie.NroCard gn-clie.Canal gn-clie.CodVen ~
gn-clie.GirCli gn-clie.CndVta gn-clie.Aval1[5] gn-clie.Aval2[5] ~
gn-clie.RepLeg[1] gn-clie.clfCli gn-clie.ClfCli2 
...
FILL-IN-1 FILL-IN-POS FILL-IN-NomCli f-Canal F-NomVen f-Giro f-ConVta ~
f-ClfCli f-ClfCli-2 
...
DEFINE FRAME F-Main
     gn-clie.CodCli AT ROW 1.54 COL 15 COLON-ALIGNED
          LABEL "Código"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 1 
     gn-clie.Flgsit AT ROW 1.54 COL 31 NO-LABEL
...
"Cesado", "C":U
          SIZE 27 BY .77
     gn-clie.Rucold AT ROW 1.58 COL 75 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Si", "Si":U,
"No", "No":U
          SIZE 12 BY .77
     gn-clie.Ruc AT ROW 2.31 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 FGCOLOR 4 
     gn-clie.CodUnico AT ROW 2.35 COL 42 COLON-ALIGNED WIDGET-ID 6
          LABEL "Codigo Unificador"
          VIEW-AS FILL-IN 
          SIZE 11.72 BY .81
          BGCOLOR 14 
     gn-clie.CodDiv AT ROW 2.35 COL 73 COLON-ALIGNED FORMAT "x(5)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     gn-clie.ApePat AT ROW 3.12 COL 15 COLON-ALIGNED WIDGET-ID 14
          LABEL "Ap. Paterno" FORMAT "X(50)"
          VIEW-AS FILL-IN 
          SIZE 27 BY .81
          BGCOLOR 11 FGCOLOR 7 
     gn-clie.ApeMat AT ROW 3.15 COL 52 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
          BGCOLOR 11 FGCOLOR 7 
     gn-clie.Nombre AT ROW 3.96 COL 15 COLON-ALIGNED WIDGET-ID 16
          LABEL "Nombre/Razón Social" FORMAT "X(60)"
          VIEW-AS FILL-IN 
          SIZE 44 BY .81
          BGCOLOR 11 FGCOLOR 7 
     gn-clie.CodIBC AT ROW 3.96 COL 69 COLON-ALIGNED WIDGET-ID 18
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
          BGCOLOR 11 FGCOLOR 9 
     gn-clie.NomCli AT ROW 4.73 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 44 BY .81
     gn-clie.Telfnos[1] AT ROW 4.77 COL 69 COLON-ALIGNED
          LABEL "Telefono 1"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     gn-clie.DirCli AT ROW 5.5 COL 15 COLON-ALIGNED
          LABEL "Dirección"
          VIEW-AS FILL-IN 
          SIZE 44.29 BY .81
     gn-clie.Telfnos[2] AT ROW 5.54 COL 69 COLON-ALIGNED
          LABEL "Telefono 2"
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     gn-clie.DirEnt AT ROW 6.27 COL 15 COLON-ALIGNED
          LABEL "Entregar en"
          VIEW-AS FILL-IN 
          SIZE 37.14 BY .81
     gn-clie.FaxCli AT ROW 6.31 COL 69 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13 BY .81
     gn-clie.CodDept AT ROW 7.04 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-DEP AT ROW 7.04 COL 20 COLON-ALIGNED NO-LABEL
     gn-clie.E-Mail AT ROW 7.08 COL 69 COLON-ALIGNED FORMAT "X(50)"
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     gn-clie.CodProv AT ROW 7.81 COL 15 COLON-ALIGNED
          LABEL "Provincia"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-PROV AT ROW 7.81 COL 20 COLON-ALIGNED NO-LABEL
     gn-clie.Transporte[4] AT ROW 7.88 COL 69 COLON-ALIGNED WIDGET-ID 24
          LABEL "eMail facturacion electronica" FORMAT "X(150)"
          VIEW-AS FILL-IN 
          SIZE 30 BY .81
     gn-clie.CodDist AT ROW 8.58 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
...
DEFINE FRAME F-Main
     FILL-IN-DIS AT ROW 8.58 COL 20 COLON-ALIGNED NO-LABEL
     FILL-IN-1 AT ROW 8.69 COL 57.14 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     gn-clie.Codpos AT ROW 9.35 COL 15 COLON-ALIGNED
          LABEL "Codigo Postal"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     FILL-IN-POS AT ROW 9.35 COL 20 COLON-ALIGNED NO-LABEL
     gn-clie.Fching AT ROW 9.46 COL 69 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     gn-clie.FchAct AT ROW 10.27 COL 69 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     gn-clie.FchCes AT ROW 10.27 COL 89 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     gn-clie.NroCard AT ROW 11.35 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     FILL-IN-NomCli AT ROW 11.35 COL 24 COLON-ALIGNED NO-LABEL
     gn-clie.Canal AT ROW 11.46 COL 70 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .81
     f-Canal AT ROW 11.46 COL 77 COLON-ALIGNED NO-LABEL
     gn-clie.CodVen AT ROW 12.12 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6 BY .81
     F-NomVen AT ROW 12.12 COL 22 COLON-ALIGNED NO-LABEL
     gn-clie.GirCli AT ROW 12.23 COL 70 COLON-ALIGNED
          LABEL "Giro" FORMAT "X(4)"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     f-Giro AT ROW 12.23 COL 77 COLON-ALIGNED NO-LABEL
     gn-clie.CndVta AT ROW 13 COL 15 COLON-ALIGNED FORMAT "X(256)"
          VIEW-AS FILL-IN 
          SIZE 41 BY .81
     BUTTON-1 AT ROW 13 COL 58 WIDGET-ID 2
     f-ConVta AT ROW 13.85 COL 15 COLON-ALIGNED NO-LABEL
     gn-clie.Aval1[5] AT ROW 14.62 COL 15 COLON-ALIGNED
          LABEL "Características" FORMAT "X(30)"
          VIEW-AS FILL-IN 
          SIZE 22.86 BY .81
     gn-clie.Aval2[5] AT ROW 14.77 COL 70 COLON-ALIGNED WIDGET-ID 8
          LABEL "Cargo"
          VIEW-AS FILL-IN 
          SIZE 22.86 BY .81
     gn-clie.RepLeg[1] AT ROW 15.42 COL 15 COLON-ALIGNED WIDGET-ID 10
          LABEL "Representante"
          VIEW-AS FILL-IN 
          SIZE 22.86 BY .81
     gn-clie.clfCli AT ROW 15.5 COL 70 COLON-ALIGNED
          LABEL "Clasificacion productos PROPIOS"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     f-ClfCli AT ROW 15.5 COL 76 COLON-ALIGNED NO-LABEL
     gn-clie.ClfCli2 AT ROW 16.31 COL 70 COLON-ALIGNED WIDGET-ID 20
          LABEL "Clasificacion productos TERCEROS"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     f-ClfCli-2 AT ROW 16.31 COL 76 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     "Agente Retenedor:" VIEW-AS TEXT
          SIZE 13 BY .5 AT ROW 1.69 COL 61.72
     "Informacion General" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 1 COL 2
          BGCOLOR 1 FGCOLOR 15 
     "Informacion de Ventas" VIEW-AS TEXT
          SIZE 16 BY .5 AT ROW 10.92 COL 2
          BGCOLOR 1 FGCOLOR 15 
     RECT-29 AT ROW 11.27 COL 1
