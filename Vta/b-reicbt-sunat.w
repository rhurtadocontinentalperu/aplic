...
------------------------------------------------------------------------------*/
  IF AVAILABLE CcbCDocu THEN  DO:
      IF Ccbcdocu.coddiv = '00005' THEN RUN vtamay/r-odesp-001a (ROWID(Ccbcdocu), ENTRY(1, Ccbcdocu.codalm), 'DUPLICADO',NO).
      ELSE RUN vtamay/r-odesp-001a (ROWID(Ccbcdocu), ENTRY(1, Ccbcdocu.codalm), 'DUPLICADO',YES).
  END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE CcbCDocu THEN  DO:
      IF s-Sunat-Activo = YES THEN DO:
          ...
          CASE pFormato:
              WHEN 1 THEN RUN sunat\r-tickets-sunat ( ROWID(Ccbcdocu), "C", YES ).
              WHEN 2 THEN DO:
                  /*
                  IF Ccbcdocu.coddiv = '00005' 
                      THEN RUN sunat\r-impresion-documentos-sunat ( ROWID(Ccbcdocu), "C", NO ).
                  ELSE RUN sunat\r-impresion-documentos-sunat ( ROWID(Ccbcdocu), "C", YES ).
                  */
                  ...
                  ELSE DO:
                      /* Matricial sin QR */                      
                      RUN sunat\r-impresion-documentos-sunat ( ROWID(Ccbcdocu), "C", YES ).
                  END.
      ...
      ELSE DO:
          CASE Ccbcdocu.CodDoc:
                 WHEN "TCK" THEN DO:
                     ...
                     RUN lib/clave-generico ('REIMPRESION DE TICKETS',
                                             'Clave:',
                                             'abc123',
                                             OUTPUT pRep).
                     IF pRep = 'ERROR' THEN RETURN.
                     RUN ccb/r-tick500 (ROWID(ccbcdocu), "C").
                 END.
                 WHEN "FAC" THEN DO:
