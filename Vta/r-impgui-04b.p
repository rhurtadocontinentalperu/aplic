...
IF AVAILABLE Ccbadocu THEN DO:
    /* TRANSPORTISTA */
    ASSIGN
        c-Placa = Ccbadocu.Libre_c[1]
        c-Marca = Ccbadocu.Libre_c[2]
    ...
    /* TRAMOS */
    ASSIGN
        x-Nombre = Ccbadocu.Libre_c[10]
        x-Ruc    = Ccbadocu.Libre_c[11]
...
DEFINE FRAME F-FtrGui
    HEADER
    "Obs: UNA VEZ RECIBIDA LA MERCADERIA, NO HAY LUGAR A DEVOLUCIONES Y/O RECLAMOS" skip(2)
