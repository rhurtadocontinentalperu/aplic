...
IF ccbcdocu.acubon[5] > 0 THEN DO : 
    IF (CcbCDocu.FmaPgo = '000' /*OR CcbCDocu.FmaPgo = '001'*/ OR CcbCDocu.FmaPgo = '002') THEN DO:
        /* Venta al Contado */
...
DEFINE FRAME F-HdrFac
    ...
    x-UsrRef
    CcbCDocu.NroRef AT 50 FORMAT "X(20)" SKIP
...
DEFINE FRAME F-Ftrfac
    ...
    "Moneda Nacional  191-1532467-0-63 Moneda Extranjera 191-1524222-1-91" SKIP
    ...
    /*
    "PERCEPCION" AT 105 ccbcdocu.acubon[4] FORMAT ">9.99" "%" 
        WHEN Ccbcdocu.AcuBon[4] > 0 AND (ccbcdocu.FmaPgo = '000' OR ccbcdocu.FmaPgo = '001' OR 
                                         ccbcdocu.FmaPgo = '002') SKIP
    */
    "PERCEPCION" AT 105 ccbcdocu.acubon[4] FORMAT ">9.99" "%" WHEN Ccbcdocu.AcuBon[4] > 0 AND (ccbcdocu.FmaPgo = '000' OR ccbcdocu.FmaPgo = '001' OR ccbcdocu.FmaPgo = '002')
    ...
    /*Ccbcdocu.AcuBon[5] AT 102 FORMAT ">>>>>,>>9.99" WHEN Ccbcdocu.AcuBon[5] > 0*/
    Ccbcdocu.AcuBon[5] AT 102 FORMAT ">>>>>,>>9.99" WHEN Ccbcdocu.AcuBon[5] > 0 AND 
