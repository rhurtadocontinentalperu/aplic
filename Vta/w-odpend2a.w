...
&Scoped-Define ENABLED-OBJECTS BUTTON-6 BUTTON-7 cb-tipo txt-nom txt-pedido ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 79 BY 9.42
         FONT 1
...
DEFINE FRAME F-Main
     BUTTON-6 AT ROW 1.81 COL 53 WIDGET-ID 14
     BUTTON-7 AT ROW 1.81 COL 75 WIDGET-ID 20
     FILL-IN-Division AT ROW 1.88 COL 7 COLON-ALIGNED WIDGET-ID 18
     cb-tipo AT ROW 3.15 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     txt-nom AT ROW 3.15 COL 23.57 COLON-ALIGNED WIDGET-ID 16
     txt-pedido AT ROW 3.15 COL 26.14 COLON-ALIGNED WIDGET-ID 6
     BROWSE-5 AT ROW 4.77 COL 3 WIDGET-ID 200
     b-print AT ROW 14.73 COL 63 WIDGET-ID 2
     b-cancel AT ROW 14.73 COL 72 WIDGET-ID 4
     rs-alm AT ROW 15.27 COL 24 NO-LABEL WIDGET-ID 8
...
DO:
  ...
  IF txt-pedido:SCREEN-VALUE <> "" THEN DO:
      FOR EACH FacCPedi WHERE FacCPedi.CodCia = s-CodCia
          ...
          AND FacCPedi.NroPed = txt-pedido 
          AND FacCPedi.FlgEst = "P"
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-6 BUTTON-7 cb-tipo txt-nom txt-pedido BROWSE-5 b-print b-cancel 
         rs-alm 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  cDivi = s-CodDiv.
  ASSIGN FILL-IN-Division = s-coddiv.
