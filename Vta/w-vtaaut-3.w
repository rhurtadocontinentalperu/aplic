...
THEN DO:
    MESSAGE "EL Documento I/Caja no esta configurado en este terminal" VIEW-AS ALERT-BOX ERROR.
    RETURN "ADM-ERROR".
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/v-vtaaut-3.w':U ,
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-pedmos-3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedmos-3 ).
       RUN set-position IN h_b-pedmos-3 ( 8.12 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.15 , 100.00 ) */
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/t-vtaaut-3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-vtaaut-3 ).
       RUN set-position IN h_t-vtaaut-3 ( 8.12 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.62 , 108.00 ) */
