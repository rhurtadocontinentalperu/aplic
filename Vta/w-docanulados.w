...
------------------------------------------------------------------------------*/
    ...
    FOR EACH ccbaudit WHERE ccbaudit.codcia = s-codcia
        AND LOOKUP(ccbaudit.coddiv,cDiv) > 0
...
chWorkSheet:Range("B2"):Value = "RESUMEN DE DOCUMENTOS ANULADOS POR VENDEDOR".
...
FOR EACH tt-tempo NO-LOCK,
    ...
    BREAK BY tt-coddiv BY tt-codven:
    t-column = t-column + 1.                                                                                                                               
