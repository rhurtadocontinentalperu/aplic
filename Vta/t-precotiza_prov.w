...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 128 BY 11.85
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     BUTTON-7 AT ROW 2.08 COL 130 WIDGET-ID 2
     btn-elimina AT ROW 5.31 COL 130 WIDGET-ID 6
     F-TotBrt AT ROW 13.65 COL 27 NO-LABEL WIDGET-ID 36
     F-ImpExo AT ROW 13.65 COL 39 NO-LABEL WIDGET-ID 28
     F-ImpDes AT ROW 13.65 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     F-ValVta AT ROW 13.65 COL 61.14 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     F-ImpIsc AT ROW 13.65 COL 73.86 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     F-ImpIgv AT ROW 13.65 COL 86.43 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     F-ImpTot AT ROW 13.65 COL 99 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.12 COL 51 WIDGET-ID 50
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 13.12 COL 91 WIDGET-ID 48
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 13.12 COL 78 WIDGET-ID 44
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.12 COL 28 WIDGET-ID 42
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 13.12 COL 101 WIDGET-ID 40
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.12 COL 64 WIDGET-ID 46
     "Agregar" VIEW-AS TEXT
          SIZE 7 BY .81 AT ROW 4.23 COL 131.14 WIDGET-ID 8
          FONT 6
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 13.12 COL 39 WIDGET-ID 52
