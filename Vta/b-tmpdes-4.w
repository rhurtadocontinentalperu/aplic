...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 100 BY 8.35
...
DEFINE FRAME F-Main
     ...
     FILL-IN-Total AT ROW 9.62 COL 9 COLON-ALIGNED WIDGET-ID 6
     F-dispo AT ROW 9.62 COL 38.57 COLON-ALIGNED WIDGET-ID 2
     F-totstk AT ROW 9.62 COL 59.57 COLON-ALIGNED WIDGET-ID 4
...
"PEDI.NroItm" "No" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"PEDI.PreUni" "Precio!Unitario" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    IF AVAILABLE almmmate THEN DO:
        DISPLAY Almmmate.StkAct @ F-totstk
                (Almmmate.stkact - pCOmprometido) @ F-dispo
...
/*       FILL-IN-Total = FILL-IN-Total * ( 1 + FacCfgGn.PorIgv / 100). */
