...
DEFINE BUFFER b-CcbCDocu FOR INTEGRAL.CcbCDocu.
...
&Scoped-define INTERNAL-TABLES INTEGRAL.CcbCDocu

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table integral.CcbCDocu.CodDoc ~
integral.CcbCDocu.NroDoc integral.CcbCDocu.NomCli integral.CcbCDocu.FmaPgo ~
integral.CcbCDocu.CodVen integral.CcbCDocu.FchDoc integral.CcbCDocu.FchVto ~
X-MON @ X-MON integral.CcbCDocu.ImpTot integral.CcbCDocu.SdoAct ~
integral.CcbCDocu.PorDto X-EST @ X-EST 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH INTEGRAL.CcbCDocu WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} USE-INDEX LLAVE10 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH INTEGRAL.CcbCDocu WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} USE-INDEX LLAVE10 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table INTEGRAL.CcbCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-br_table INTEGRAL.CcbCDocu
...
CMB-filtro FILL-IN-filtro C-CMPBTE x-CodDiv c-Serie F-FMAPGO COMBO-BOX-5 ~
f-desde f-hasta xcodmod f-codven x-FchVto-1 x-FchVto-2 br_table BUTTON-3 
...
DEFINE VARIABLE FILL-IN-codigo AS CHARACTER FORMAT "XXX-XXXXXX":U INITIAL "0" 
     LABEL "Código" 
     VIEW-AS FILL-IN 
     SIZE 10.29 BY .81
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      integral.CcbCDocu.CodDoc COLUMN-LABEL "Tipo" FORMAT "x(3)":U
      integral.CcbCDocu.NroDoc FORMAT "XXX-XXXXXXXX":U
      integral.CcbCDocu.NomCli FORMAT "x(40)":U
      integral.CcbCDocu.FmaPgo COLUMN-LABEL "Cnd.!Venta" FORMAT "XXX":U
      integral.CcbCDocu.CodVen COLUMN-LABEL "Ven." FORMAT "x(5)":U
      integral.CcbCDocu.FchDoc COLUMN-LABEL "     Fecha    !    Emision" FORMAT "99/99/9999":U
      integral.CcbCDocu.FchVto FORMAT "99/99/9999":U
      X-MON @ X-MON COLUMN-LABEL "Mon." FORMAT "XXXX":U
      integral.CcbCDocu.ImpTot FORMAT "->>>,>>9.99":U
      integral.CcbCDocu.SdoAct COLUMN-LABEL "Saldo" FORMAT "->>>,>>9.99":U
      integral.CcbCDocu.PorDto FORMAT ">>9.99":U
...
DEFINE FRAME F-Main
     ...
     BUTTON-3 AT ROW 16.96 COL 61 WIDGET-ID 4
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-3 L-table-Win
ON CHOOSE OF BUTTON-3 IN FRAME F-Main /* Excel */
DO:
  RUN Xcel.
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "INTEGRAL.CcbCDocu"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Xcel L-table-Win 
PROCEDURE Xcel :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
    ...
    /* get the active Worksheet */
        ...
        chWorkSheet:Range("A1"):Value = "Comprobantes - 1".

        chWorkSheet:Range("A1"):Value = "Tipo".
        chWorkSheet:Range("B1"):Value = "Numero".
        chWorkSheet:Range("C1"):Value = "Nombre".
        chWorkSheet:Range("D1"):Value = "Cnd Vta".
        chWorkSheet:Range("E1"):Value = "Vendedor".
        chWorkSheet:Range("F1"):Value = "Fech. Emision".
        chWorkSheet:Range("G1"):Value = "Fech. Vcto".
        chWorkSheet:Range("H1"):Value = "Mone".
        chWorkSheet:Range("I1"):Value = "Imp. Total".
        chWorkSheet:Range("J1"):Value = "Saldo".
        chWorkSheet:Range("K1"):Value = "%Dscto".
        chWorkSheet:Range("L1"):Value = "Estado".
            
    iColumn = 1.
    /*FOR EACH ccbCDocu WHERE {&CONDICION} USE-INDEX LLAVE10 NO-LOCK :*/
    GET FIRST {&BROWSE-NAME}.
    DO  WHILE AVAILABLE ccbcdocu:
             ...
             cRange = "K" + cColumn.
             chWorkSheet:Range(cRange):Value = CcbCDocu.pordto.
             cRange = "L" + cColumn.
             chWorkSheet:Range(cRange):Value = CcbCDocu.FlgSit.

             GET NEXT {&BROWSE-NAME}.
    END.
/*
        chWorkSheet:SaveAs("d:\ciman\file.xls",6,,,,0,,,).
