...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 COMBO-BOX-1 DesdeC HastaC ~
BUTTON-12 BUTTON-13 BUTTON-14 
&Scoped-Define DISPLAYED-OBJECTS EDITOR-2 FILL-IN-1 COMBO-BOX-1 DesdeC ~
HastaC 
...
DEFINE FRAME F-Main
     ...
     DesdeC AT ROW 5.85 COL 7.29 COLON-ALIGNED
     HastaC AT ROW 5.81 COL 19.86 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportar Catalogo de Materiales Web"
         HEIGHT             = 7.77
         WIDTH              = 48.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 91.43
...
ON END-ERROR OF W-Win /* Exportar Catalogo de Materiales Web */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportar Catalogo de Materiales Web */
DO:
...
DO:
  ...
  CASE wresp:
       ...
       WHEN no  THEN 
            RETURN.
  END CASE.
  DISPLAY DesdeC HAstaC WITH FRAME {&FRAME-NAME}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY EDITOR-2 FILL-IN-1 COMBO-BOX-1 DesdeC HastaC 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-2 RECT-1 COMBO-BOX-1 DesdeC HastaC BUTTON-12 BUTTON-13 BUTTON-14 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH Almmmatg where Almmmatg.codcia = s-codcia and 
                        ...
                        Almmmatg.TpoArt = "A":
    export delimiter "|" Almmmatg.Codfam
                         Almmmatg.Subfam
                         Almmmatg.Codmar
                         Almmmatg.desmar
                         Almmmatg.codmat
...
------------------------------------------------------------------------------*/
  ...
  la WEB de la empresa. La ruta y nombre del archivo a ser generado es el
