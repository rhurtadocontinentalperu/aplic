...
&Scoped-Define ENABLED-OBJECTS RECT-64 Btn-Pendientes BUTTON-1 BUTTON-6 ~
BUTTON-7 
...
DEFINE VARIABLE h_v-devfac-1 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     Btn-Pendientes AT ROW 7.27 COL 76.29
     BUTTON-1 AT ROW 12.92 COL 78
     BUTTON-6 AT ROW 14.04 COL 78
     BUTTON-7 AT ROW 15.12 COL 78
     RECT-64 AT ROW 12.73 COL 76.86
...
DO:
  RUN Asigna-Documento IN h_v-devfac-1.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/v-devfac-1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-devfac-1 ).
       RUN set-position IN h_v-devfac-1 ( 1.00 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 4.85 , 85.72 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv05 ).
       RUN set-position IN h_p-updv05 ( 5.85 , 33.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 5.88 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-devfac ).
       RUN set-position IN h_q-devfac ( 5.85 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 12.14 ) */

       /* Links to SmartViewer h_v-devfac-1. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-devfac-1 ).
       RUN add-link IN adm-broker-hdl ( h_q-devfac , 'Record':U , h_v-devfac-1 ).

       /* Links to SmartQuery h_q-devfac. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_q-devfac ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-devfac-1 ,
             Btn-Pendientes:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv05 ,
             h_v-devfac-1 , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-devolu ).
       RUN set-position IN h_b-devolu ( 7.19 , 1.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpdev-1 ).
       RUN set-position IN h_b-tmpdev-1 ( 7.27 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 8.77 , 76.86 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-64 Btn-Pendientes BUTTON-1 BUTTON-6 BUTTON-7 
