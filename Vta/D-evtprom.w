...
DEFINE TEMP-TABLE tmp-tempo 
    ...
    INDEX LLAVE01 t-codcia t-coddiv t-codmat .
...
&Scoped-Define ENABLED-OBJECTS F-DIVISION BUTTON-5 F-CodFam BUTTON-1 ~
F-SubFam BUTTON-2 F-Marca BUTTON-3 F-prov1 BUTTON-4 DesdeC HastaC DesdeF ~
HastaF nCodMon Btn_OK Btn_Cancel Btn_Help RECT-61 RECT-64 
&Scoped-Define DISPLAYED-OBJECTS F-DIVISION F-CodFam F-SubFam F-Marca ~
F-prov1 DesdeC HastaC DesdeF HastaF nCodMon txt-msj 
...
DEFINE FRAME F-Main
     ...
     nCodMon AT ROW 9.5 COL 11.57 NO-LABEL
     Btn_OK AT ROW 11.96 COL 13.72
     Btn_Cancel AT ROW 11.96 COL 25
     Btn_Help AT ROW 11.96 COL 36.43
     txt-msj AT ROW 10.96 COL 1.86 NO-LABEL WIDGET-ID 2
     "Moneda" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 8.81 COL 11.43
          FONT 6
...
------------------------------------------------------------------------------*/
  DISPLAY F-DIVISION F-CodFam F-SubFam F-Marca F-prov1 DesdeC HastaC DesdeF 
          HastaF nCodMon txt-msj 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE F-DIVISION BUTTON-5 F-CodFam BUTTON-1 F-SubFam BUTTON-2 F-Marca 
         BUTTON-3 F-prov1 BUTTON-4 DesdeC HastaC DesdeF HastaF nCodMon Btn_OK 
         Btn_Cancel Btn_Help RECT-61 RECT-64 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tmp-tempo  /* WHERE t-canti[10] > 0  */
      ...
      */
      ...
      IF FIRST-OF(t-CodDiv) THEN DO:
         FIND Gn-Divi WHERE Gn-Divi.Codcia = S-CODCIA AND
                            Gn-Divi.Coddiv = t-coddiv
                            NO-LOCK NO-ERROR.
         IF AVAILABLE Gn-Divi THEN DO:
             PUT STREAM REPORT  " " SKIP.
             PUT STREAM REPORT   {&PRN6A} + "DIVISION : "  FORMAT "X(15)" AT 1 
                                 {&PRN6A} + t-coddiv       FORMAT "X(7)" AT 17
                                 {&PRN6A} + Gn-Divi.Desdiv + {&PRN6B} FORMAT "X(40)" AT 25 SKIP.
      ...
      ACCUM  t-venta[10]  (SUB-TOTAL BY t-coddiv) .
      ...
      IF LAST-OF(t-CodFam) THEN DO:  
            ...
            (ACCUM SUB-TOTAL BY t-codfam t-venta[10]) @ t-venta[10] 
             WITH FRAME F-REPORTE.
      END.
      IF LAST-OF(t-Coddiv) THEN DO:  
            UNDERLINE STREAM REPORT
            t-venta[10]
            WITH FRAME F-REPORTE.
            DISPLAY STREAM REPORT 
            {&PRN6A} + ("TOTAL   : " + T-coddiv ) @ t-desmat
            (ACCUM SUB-TOTAL BY t-coddiv t-venta[10]) @ t-venta[10] 
             WITH FRAME F-REPORTE.
      END.
