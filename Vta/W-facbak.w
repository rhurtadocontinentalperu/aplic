...
&Scoped-Define ENABLED-OBJECTS C-CodDoc C-NroSer RECT-20 Btn-Print 
...
DEFINE FRAME F-Main
     C-CodDoc AT ROW 8.31 COL 1 NO-LABEL
     C-NroSer AT ROW 8.31 COL 8.57 NO-LABEL
     Btn-Print AT ROW 8.46 COL 79.57
     RECT-20 AT ROW 8.19 COL 78.86
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 8.19 , 25.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 8.19 , 41.72 ) NO-ERROR.
       RUN set-size IN h_p-updv10 ( 1.31 , 37.57 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/q-docbak.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-docmto ).
       RUN set-position IN h_q-docmto ( 8.19 , 15.72 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE C-CodDoc C-NroSer RECT-20 Btn-Print 
      WITH FRAME F-Main IN WINDOW W-Win.
