...
&Scoped-Define ENABLED-FIELDS FacCPedi.Glosa FacCPedi.PorDto 
...
FacCPedi.CodVen FacCPedi.Glosa FacCPedi.NomCli FacCPedi.usuario ~
FacCPedi.PorDto FacCPedi.FchPed FacCPedi.CodMon FacCPedi.TpoCmb 
...
IF FacCPedi.FlgEst <> "A" THEN DO:
   ...
   RUN vta/d-mrgped-c (ROWID(FacCPedi)).
