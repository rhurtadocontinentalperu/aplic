...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Almmmate.CodAlm Almmmate.StkAct 
...
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH Almmmate ~
      WHERE Almmmate.StkAct > 0 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Almmmate
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 30 BY 4.5
         FONT 4.
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _Where[1]         = "INTEGRAL.Almmmate.StkAct > 0"
     _FldNameList[1]   = INTEGRAL.Almmmate.CodAlm
     _FldNameList[2]   = INTEGRAL.Almmmate.StkAct
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
