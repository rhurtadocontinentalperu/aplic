...
DO:
  ASSIGN RADIO-SET-1.
  CASE RADIO-SET-1:
    /*WHEN 1 THEN RUN vta/r-ImpGui-01 (x-Rowid).*/
    WHEN 1 THEN DO: 
        /*IF LOOKUP(s-coddiv,'00000,00015') > 0 THEN RUN vta/r-ImpGui-01a (x-Rowid).*/
        RUN vta/r-ImpGui-01 (x-Rowid).
    END.
    WHEN 2 THEN RUN vta/r-ImpGui2-01 (x-Rowid).
    WHEN 3 THEN DO:
/*         RUN vta/r-ImpGui3 (x-Rowid). */
