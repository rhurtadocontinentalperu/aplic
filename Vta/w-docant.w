...
&Scoped-Define ENABLED-OBJECTS C-NroSer Btn-Genera 
...
DEFINE VARIABLE h_b-docant AS HANDLE NO-UNDO.

/* Definitions of the field level widgets                               */
DEFINE BUTTON Btn-Genera 
     LABEL "Generar Guias" 
     SIZE 15 BY 1.12
     FONT 6.

DEFINE VARIABLE C-NroSer AS CHARACTER FORMAT "X(3)":U INITIAL "0" 
     LABEL "Serie de Guias" 
...
DEFINE FRAME F-Main
     C-NroSer AT ROW 12.12 COL 45.28
     Btn-Genera AT ROW 12 COL 70.14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ventas  Anticipadas pendientes de Entrega"
         HEIGHT             = 12.38
         WIDTH              = 86.43
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Ventas  Anticipadas pendientes de Entrega */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ventas  Anticipadas pendientes de Entrega */
DO:
...
&Scoped-define SELF-NAME Btn-Genera
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-Genera W-Win
ON CHOOSE OF Btn-Genera IN FRAME F-Main /* Generar Guias */
DO:
  MESSAGE "ESTA SEGURO DE GENEREAR LA GUIA" VIEW-AS ALERT-BOX QUESTION
         BUTTONS YES-NO UPDATE RPTA AS LOGICAL.
  IF RPTA THEN RUN Genera-Guia IN h_b-docant.
END.
...
ON VALUE-CHANGED OF C-NroSer IN FRAME F-Main /* Serie de Guias */
DO:
  ASSIGN C-NroSer.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/b-docant.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-docant ).
       RUN set-position IN h_b-docant ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.92 , 84.86 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-docant ,
