...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 72 BY 8.62
         FONT 1
...
DEFINE FRAME F-Main
     ...
     b-print AT ROW 10.08 COL 44 WIDGET-ID 2
     b-cancel AT ROW 10.08 COL 59 WIDGET-ID 4
...
/*RD01*/             Reporte.CodAlm = FacDPedi.AlmDes
...
DEFINE FRAME f-cab
        ...
        "-----------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
        "Alm Código  Descripción                                                    Marca                  Unidad      Cantidad Ubicación  Observaciones            " SKIP
        "-----------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
 ...
 */
 FOR EACH Reporte BREAK BY Reporte.CodAlm BY Reporte.CodUbi BY Reporte.CodMat:
