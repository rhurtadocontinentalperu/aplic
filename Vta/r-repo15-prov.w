...
------------------------------------------------------------------------------*/
    ...
    FOR EACH FacCPedi USE-INDEX Llave10 NO-LOCK WHERE FacCPedi.CodCia = S-CODCIA
        AND FacCPedi.CodDiv = S-CODDIV
        AND FacCPedi.CodDoc = S-CODDOC
        AND FacCPedi.FlgEst = "P"
        AND faccpedi.fchped >= DesdeF
        AND faccpedi.fchped <= HastaF:
        IF txt-cliente > '' AND faccpedi.codcli <> txt-cliente THEN NEXT.
        IF txt-cotiza > '' AND faccpedi.nroped <> txt-cotiza THEN NEXT.
