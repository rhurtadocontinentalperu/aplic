...
almmserv.DesMat CcbDDocu.UndVta CcbDDocu.CanDes 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbDDocu.codmat COLUMN-LABEL "Codigo Servicio" FORMAT "X(6)":U
      almmserv.DesMat FORMAT "X(45)":U
      CcbDDocu.UndVta COLUMN-LABEL "Unid." FORMAT "XXXX":U
...
"CcbDDocu.codmat" "Codigo Servicio" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = INTEGRAL.almmserv.DesMat
     _FldNameList[4]   > INTEGRAL.CcbDDocu.UndVta
"CcbDDocu.UndVta" "Unid." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
