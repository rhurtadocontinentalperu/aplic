...
FacDPedm.CanPed FacDPedm.PorDto FacDPedm.PreUni FacDPedm.ImpLin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacDPedm.NroItm COLUMN-LABEL "No" FORMAT ">>>9"
      FacDPedm.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)"
      Almmmatg.DesMat
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(12)"
      FacDPedm.UndVta COLUMN-LABEL "Unidad" FORMAT "X(10)"
      FacDPedm.AlmDes COLUMN-LABEL "Alm!Des"
      FacDPedm.CanPed FORMAT ">>,>>>.99"
      FacDPedm.PorDto FORMAT "->9.99"
      FacDPedm.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>>.9999"
      FacDPedm.ImpLin FORMAT ">,>>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 98 BY 9.12
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 11.19 COL 2 COLON-ALIGNED NO-LABEL
     F-TotBrt AT ROW 11.19 COL 16 NO-LABEL
     F-ImpExo AT ROW 11.19 COL 28 NO-LABEL
     F-ImpDes AT ROW 11.23 COL 38 COLON-ALIGNED NO-LABEL
     F-ValVta AT ROW 11.19 COL 50.14 COLON-ALIGNED NO-LABEL
     F-ImpIsc AT ROW 11.19 COL 62.86 COLON-ALIGNED NO-LABEL
     F-ImpIgv AT ROW 11.19 COL 75.43 COLON-ALIGNED NO-LABEL
     F-ImpTot AT ROW 11.19 COL 88 COLON-ALIGNED NO-LABEL
     "T.Exonerado" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.62 COL 28.57
     RECT-11 AT ROW 1 COL 1
     "Total Importe" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 10.62 COL 90.14
     "% Dscto" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 10.62 COL 6
     "I.G.V." VIEW-AS TEXT
          SIZE 5.14 BY .5 AT ROW 10.62 COL 80.14
     "I.S.C." VIEW-AS TEXT
          SIZE 4.57 BY .5 AT ROW 10.62 COL 68.57
     "Total Bruto" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.62 COL 18
     "Valor Venta" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 10.65 COL 53.86
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 10.65 COL 40.72
...
"FacDPedm.NroItm" "No" ">>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > integral.FacDPedm.codmat
"FacDPedm.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   = integral.Almmmatg.DesMat
     _FldNameList[4]   > integral.Almmmatg.DesMar
"Almmmatg.DesMar" "Marca" "X(12)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > integral.FacDPedm.UndVta
"FacDPedm.UndVta" "Unidad" "X(10)" "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > integral.FacDPedm.AlmDes
"FacDPedm.AlmDes" "Alm!Des" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[7]   > integral.FacDPedm.CanPed
"FacDPedm.CanPed" ? ">>,>>>.99" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[8]   > integral.FacDPedm.PorDto
"FacDPedm.PorDto" ? "->9.99" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[9]   > integral.FacDPedm.PreUni
"FacDPedm.PreUni" "Precio!Unitario" ">>,>>>.9999" "decimal" ? ? ? ? ? ? no ?
