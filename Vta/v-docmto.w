...
&Scoped-Define ENABLED-FIELDS CcbCDocu.PorDto CcbCDocu.ImpBrt ~
CcbCDocu.ImpExo CcbCDocu.ImpDto CcbCDocu.ImpVta CcbCDocu.ImpIsc ~
CcbCDocu.ImpIgv CcbCDocu.ImpTot 
&Scoped-define ENABLED-TABLES CcbCDocu
&Scoped-define FIRST-ENABLED-TABLE CcbCDocu
&Scoped-Define ENABLED-OBJECTS RECT-12 
&Scoped-Define DISPLAYED-FIELDS CcbCDocu.PorDto CcbCDocu.ImpDto2 ~
CcbCDocu.ImpBrt CcbCDocu.ImpExo CcbCDocu.ImpDto CcbCDocu.ImpVta ~
CcbCDocu.ImpIsc CcbCDocu.ImpIgv CcbCDocu.ImpTot 
...
DEFINE FRAME F-Main
     CcbCDocu.PorDto AT ROW 1.23 COL 29.14 COLON-ALIGNED
          ...
          SIZE 5.72 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpDto2 AT ROW 2.62 COL 73 COLON-ALIGNED NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ...
     CcbCDocu.ImpIgv AT ROW 2.65 COL 62.29 COLON-ALIGNED NO-LABEL FORMAT "Z,ZZZ,ZZ9.99"
          ...
          SIZE 10 BY .81
          BGCOLOR 15 
     CcbCDocu.ImpTot AT ROW 2.69 COL 83 COLON-ALIGNED NO-LABEL FORMAT "Z,ZZZ,ZZ9.99"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
          BGCOLOR 15 
     "Otros Dctos." VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 2.08 COL 75 WIDGET-ID 4
     "T.Exonerado" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 2.04 COL 14.14
     "Total Imp" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 2.08 COL 85
...
/* SETTINGS FOR FILL-IN CcbCDocu.ImpDto IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN CcbCDocu.ImpDto2 IN FRAME F-Main
   NO-ENABLE                                                            */
