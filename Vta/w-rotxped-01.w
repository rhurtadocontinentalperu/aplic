...
DEFINE VARIABLE rs-coddoc AS CHARACTER INITIAL "PED" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Pedido Crédito", "PED",
"Pedido Mostrador", "P/M",
"Transferencia", "TRA"
     SIZE 71.72 BY 1.08 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     txt-nroped AT ROW 2.85 COL 17 COLON-ALIGNED WIDGET-ID 2
     txt-nomcli AT ROW 3.92 COL 17 COLON-ALIGNED WIDGET-ID 6
     txt-bultos AT ROW 5 COL 17 COLON-ALIGNED WIDGET-ID 4
     BtnDone-2 AT ROW 6.12 COL 84 WIDGET-ID 28
     BtnDone AT ROW 6.12 COL 92 WIDGET-ID 22
     "Documento:" VIEW-AS TEXT
          SIZE 11 BY .96 AT ROW 1.81 COL 8 WIDGET-ID 30
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 100 BY 7.12 WIDGET-ID 100.
