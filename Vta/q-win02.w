...
&Scoped-define INTERNAL-TABLES SlsDocS

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH SlsDocS OF SlsDocP WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main SlsDocS
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main SlsDocS
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.SlsDocS OF INTEGRAL.SlsDocP"
