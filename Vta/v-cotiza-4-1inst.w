...
DEFINE SHARED VARIABLE s-Canal    AS CHAR.
...
FacCPedi.RucCli FacCPedi.ordcmp FacCPedi.Sede FacCPedi.Cmpbnte ~
FacCPedi.LugEnt FacCPedi.CodMon FacCPedi.Glosa FacCPedi.CodVen ~
...
FacCPedi.FlgIgv FacCPedi.CodVen FacCPedi.FmaPgo FacCPedi.NroCard 
...
------------------------------------------------------------------------------*/
    ...
    */
    DO WITH FRAME {&FRAME-NAME}:
        CASE HANDLE-CAMPO:name:
            WHEN "codcli" THEN ASSIGN input-var-1 = s-canal.
...
DO WITH FRAME {&FRAME-NAME} :
   ...
   /* Chequeo del canal de venta */
   IF gn-clie.canal <> s-canal THEN DO:
