...
&Scoped-Define ENABLED-OBJECTS RECT-61 RECT-58 RECT-62 RECT-63 C-tipo ~
C-tipo-2 F-DIVISION BUTTON-5 DesdeC DesdeF HastaF F-PERIODO-1 F-PERIODO-2 ~
F-PERIODO-3 F-PERIODO-4 F-PERIODO-5 nCodMon Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-OBJECTS C-tipo C-tipo-2 F-DIVISION DesdeC DesdeF ~
HastaF F-PERIODO-1 F-PERIODO-2 F-PERIODO-3 F-PERIODO-4 F-PERIODO-5 nCodMon ~
txt-msj 
...
DEFINE VARIABLE C-tipo-2 AS CHARACTER FORMAT "X(20)":U INITIAL "Venta" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "Venta","Costo","Margen","Utilidad" 
     DROP-DOWN-LIST
     SIZE 16 BY 1 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     F-DIVISION AT ROW 3.12 COL 12 COLON-ALIGNED
     BUTTON-5 AT ROW 3.12 COL 25.29
     DesdeC AT ROW 3.88 COL 12 COLON-ALIGNED
     DesdeF AT ROW 4.65 COL 12 COLON-ALIGNED HELP
          "Solo fechas del mismo Año"
     HastaF AT ROW 4.65 COL 32 COLON-ALIGNED HELP
          "Solo fechas del mismo Año"
     F-PERIODO-1 AT ROW 4.81 COL 49.43 COLON-ALIGNED
     F-PERIODO-2 AT ROW 5.54 COL 49.43 COLON-ALIGNED
     F-PERIODO-3 AT ROW 6.35 COL 49.43 COLON-ALIGNED
     F-PERIODO-4 AT ROW 7.04 COL 49.43 COLON-ALIGNED
     F-PERIODO-5 AT ROW 7.85 COL 49.43 COLON-ALIGNED
     nCodMon AT ROW 10.23 COL 52.72 NO-LABEL
     Btn_OK AT ROW 11.38 COL 39
     Btn_Cancel AT ROW 11.38 COL 50.29
     Btn_Help AT ROW 11.38 COL 61.72
     txt-msj AT ROW 11.81 COL 2.72 NO-LABEL WIDGET-ID 2
     " Desplegar Periodos" VIEW-AS TEXT
          SIZE 16.72 BY .5 AT ROW 4.15 COL 49.29
          FONT 6
     " Moneda" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.65 COL 49.86
          FONT 6
     ...
     RECT-46 AT ROW 11.19 COL 1.86
     RECT-62 AT ROW 4.23 COL 47.57
     RECT-63 AT ROW 9.73 COL 47.57
       ...
       DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
            ...
            IF X-FECHA >= X-DESDE AND X-FECHA <= X-HASTA THEN DO:
                ...
                IF AVAILABLE Gn-tcmb THEN DO: 
                 ...
                 T-Ctomn   = Evtarti.Ctoxdiamn[I] + Evtarti.Ctoxdiame[I] * Gn-Tcmb.Venta.
                 T-Ctome   = Evtarti.Ctoxdiame[I] + Evtarti.Ctoxdiamn[I] / Gn-Tcmb.Compra.
                END.
       ...
       DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
            ...
            IF X-FECHA >= X-DESDE AND X-FECHA <= X-HASTA THEN DO:
                ...
                IF AVAILABLE Gn-tcmb THEN DO: 
                 ...
                 T-Ctomn   = EvtDivi.Ctoxdiamn[I] + EvtDivi.Ctoxdiame[I] * Gn-Tcmb.Venta.
                 T-Ctome   = EvtDivi.Ctoxdiame[I] + EvtDivi.Ctoxdiamn[I] / Gn-Tcmb.Compra.
                END.
       ...
       DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
            ...
            IF X-FECHA >= X-DESDE AND X-FECHA <= X-HASTA THEN DO:
                ...
                IF AVAILABLE Gn-tcmb THEN DO: 
                 ...
                 T-Ctomn   = T-Ctomn   + EvtDivi.Ctoxdiamn[I] + EvtDivi.Ctoxdiame[I] * Gn-Tcmb.Venta.
                 T-Ctome   = T-Ctome   + EvtDivi.Ctoxdiame[I] + EvtDivi.Ctoxdiamn[I] / Gn-Tcmb.Compra.
                END.
            END.
...
------------------------------------------------------------------------------*/
  DISPLAY C-tipo C-tipo-2 F-DIVISION DesdeC DesdeF HastaF F-PERIODO-1 
          F-PERIODO-2 F-PERIODO-3 F-PERIODO-4 F-PERIODO-5 nCodMon txt-msj 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-61 RECT-58 RECT-62 RECT-63 C-tipo C-tipo-2 F-DIVISION BUTTON-5 
         DesdeC DesdeF HastaF F-PERIODO-1 F-PERIODO-2 F-PERIODO-3 F-PERIODO-4 
         F-PERIODO-5 nCodMon Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
        ...
        "                            CANTIDAD   VENTA        CANTIDAD   VENTA        CANTIDAD   VENTA        CANTIDAD   VENTA         CANTIDAD   VENTA      " SKIP
        "------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
  ...
  FOR EACH tmp-tempo  /*WHERE t-canti[10] > 0 */
      ...
      IF FIRST-OF(t-codmat) THEN DO:
         ...
         PUT STREAM REPORT   "ARTICULO : "  FORMAT "X(10)" AT 1 
                             t-codmat       FORMAT "X(8)"  AT 15
                             t-desmat       FORMAT "X(40)" AT 25 
                             t-desmar       FORMAT "X(15)" AT 70 
                             t-undbas       FORMAT "X(8)" AT  90 SKIP.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
        ...
        STRING(F-PERIODO-4,"9999") AT  110 
        STRING(F-PERIODO-5,"9999") AT  135 SKIP
        "                            CANTIDAD   Costo        CANTIDAD   Costo        CANTIDAD   Costo        CANTIDAD   Costo         CANTIDAD   Costo      " SKIP
        "------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
        ...
        STRING(F-PERIODO-4,"9999") AT  110 
        STRING(F-PERIODO-5,"9999") AT  135 SKIP
        "                            CANTIDAD   Marge        CANTIDAD   Marge        CANTIDAD   Marge        CANTIDAD   Marge         CANTIDAD   Marge      " SKIP
        "------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
        ...
        STRING(F-PERIODO-4,"9999") AT  110 
        STRING(F-PERIODO-5,"9999") AT  135 SKIP
        "                            CANTIDAD   Utili        CANTIDAD   Utili        CANTIDAD   Utili        CANTIDAD   Utili         CANTIDAD   Utili      " SKIP
        "------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
