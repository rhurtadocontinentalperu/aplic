...
FacCPedi.DirCli FacCPedi.Sede FacCPedi.CodVen FacCPedi.FmaPgo ~
FacCPedi.CodAlm FacCPedi.Glosa FacCPedi.CodMon FacCPedi.LugEnt ~
FacCPedi.LugEnt2 FacCPedi.CodTrans FacCPedi.Atencion FacCPedi.Ubigeo[3] ~
FacCPedi.Ubigeo[2] FacCPedi.Ubigeo[1] FacCPedi.TpoLic FacCPedi.ordcmp 
...
FacCPedi.CodVen FacCPedi.NroRef FacCPedi.FmaPgo FacCPedi.CodAlm ~
FacCPedi.Glosa FacCPedi.CodMon FacCPedi.LugEnt FacCPedi.LugEnt2 ~
FacCPedi.CodTrans FacCPedi.Atencion FacCPedi.Hora FacCPedi.Ubigeo[3] ~
FacCPedi.Ubigeo[2] FacCPedi.Ubigeo[1] FacCPedi.TpoLic FacCPedi.ordcmp 
...
"Normal", ""
     ...
     FacCPedi.TpoCmb AT ROW 3.31 COL 73 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     FacCPedi.Sede AT ROW 4 COL 9 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 5 BY .69
     FacCPedi.CodVen AT ROW 4.77 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .69
     F-nOMvEN AT ROW 4.77 COL 14.14 COLON-ALIGNED NO-LABEL
     FacCPedi.NroRef AT ROW 4.77 COL 73 COLON-ALIGNED
          LABEL "No. Pedido"
          VIEW-AS FILL-IN 
          SIZE 11.86 BY .69
     FacCPedi.FmaPgo AT ROW 5.42 COL 9 COLON-ALIGNED
          LABEL "Cond.Vta."
          VIEW-AS FILL-IN 
          SIZE 5 BY .69
     F-CndVta AT ROW 5.42 COL 14.14 COLON-ALIGNED NO-LABEL
     FacCPedi.CodAlm AT ROW 5.42 COL 73 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .69
     FacCPedi.Glosa AT ROW 6.15 COL 6.28
          VIEW-AS FILL-IN 
          SIZE 51.43 BY .69
     FacCPedi.CodMon AT ROW 6.15 COL 74.86 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 12.29 BY .62
     FacCPedi.LugEnt AT ROW 6.88 COL 13.14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 47.29 BY .69
          FGCOLOR 4 
     C-TipVta AT ROW 6.88 COL 73 COLON-ALIGNED
     FacCPedi.LugEnt2 AT ROW 7.58 COL 13.14 COLON-ALIGNED
          LABEL "2do. Lugar Entrega"
          VIEW-AS FILL-IN 
          SIZE 47.29 BY .69
     FacCPedi.CodTrans AT ROW 7.58 COL 73 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.14 BY .69
     FacCPedi.Atencion AT ROW 8.27 COL 13.14 COLON-ALIGNED
          LABEL "Contacto"
          VIEW-AS FILL-IN 
          SIZE 47.43 BY .69
     FacCPedi.Hora AT ROW 8.27 COL 73 COLON-ALIGNED FORMAT "X(8)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
     FacCPedi.Ubigeo[3] AT ROW 9.12 COL 13.14 COLON-ALIGNED
          LABEL "Dpto"
          VIEW-AS FILL-IN 
          SIZE 3 BY .69
     F-Departamento AT ROW 9.12 COL 16.29 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME F-Main
     FacCPedi.Ubigeo[2] AT ROW 9.12 COL 30 COLON-ALIGNED
          LABEL "Prov"
          VIEW-AS FILL-IN 
          SIZE 3 BY .69
     F-Provincia AT ROW 9.12 COL 33.14 COLON-ALIGNED NO-LABEL
     FacCPedi.Ubigeo[1] AT ROW 9.12 COL 48.57 COLON-ALIGNED
          LABEL "Distrito"
          VIEW-AS FILL-IN 
          SIZE 3 BY .69
     F-Distrito AT ROW 9.12 COL 51.57 COLON-ALIGNED NO-LABEL
     F-Situac AT ROW 9.12 COL 73 COLON-ALIGNED NO-LABEL
     FacCPedi.TpoLic AT ROW 9.81 COL 29 RIGHT-ALIGNED
          LABEL "Para despachar"
          VIEW-AS TOGGLE-BOX
          SIZE 15 BY .65
     FacCPedi.ordcmp AT ROW 9.81 COL 73 COLON-ALIGNED
          LABEL "O/ Compra" FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 11.86 BY .69
     "Moneda  :" VIEW-AS TEXT
          SIZE 7.57 BY .5 AT ROW 6.15 COL 67
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH facdPedi OF faccPedi NO-LOCK
      ...
      FIND B-DPedi WHERE 
           ...
           B-DPedi.NroPed = FacCPedi.NroRef:SCREEN-VALUE IN FRAME {&FRAME-NAME} AND
 ...
 *      Faccpedi.RucCli:SCREEN-VALUE = B-CPedi.ruc.
 *    End.*/
  ASSIGN
    Faccpedi.NomCli:SCREEN-VALUE = B-CPedi.nomcli
    Faccpedi.DirCli:SCREEN-VALUE = B-CPedi.dircli
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE Almacen THEN DO:
     MESSAGE
          "Almacen Despacho no existe" VIEW-AS ALERT-BOX ERROR.
     RETURN .        
  END.
  ...
  DO WITH FRAME {&FRAME-NAME}:
     ...
     DISPLAY TODAY @ FacCPedi.FchPed
             ...
             /*S-CODALM @ integral.FacCPedi.CodAlm*/
