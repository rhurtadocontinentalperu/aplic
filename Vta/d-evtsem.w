...
DEFINE TEMP-TABLE T-EvtSemanas NO-UNDO LIKE EvtSemanas.
...
T-EvtSemanas.NroSem T-EvtSemanas.FecIni T-EvtSemanas.FecFin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 gDialog _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      T-EvtSemanas.NroSem FORMAT "99":U
...
DEFINE FRAME gDialog
     ...
     BUTTON-2 AT ROW 2.08 COL 51 WIDGET-ID 14
     BROWSE-2 AT ROW 5.31 COL 13 WIDGET-ID 200
     Btn_OK AT ROW 9.62 COL 53
     Btn_Cancel AT ROW 10.85 COL 53
     SPACE(1.71) SKIP(6.99)
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: T-EvtSemanas T "?" NO-UNDO INTEGRAL EvtSemanas
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _FldNameList[2]   = Temp-Tables.T-EvtSemanas.NroSem
...
DO:
  ...
  FOR EACH Evtsemanas WHERE Evtsemanas.codcia = s-codcia
      AND Evtsemanas.periodo = Fill-in-Periodo:
      DELETE evtsemanas.
  END.
  FOR EACH T-Evtsemanas:
      CREATE Evtsemanas.
      BUFFER-COPY T-Evtsemanas TO Evtsemanas
          ASSIGN
            Evtsemanas.codcia = s-codcia
            Evtsemanas.periodo = FILL-IN-Periodo
          NO-ERROR.
  END.
END.
...
DO i = 1 TO 53:
    ...
    IF T-EvtSemanas.NroSem = 1 AND YEAR(T-EvtSemanas.FecIni) < FILL-IN-Periodo 
