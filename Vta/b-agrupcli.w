...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tc-gn-clie.CodUnico COLUMN-LABEL "Cod Único Sugerido" FORMAT "x(11)":U
            WIDTH 14
      gn-clie.DirCli COLUMN-LABEL "Dirección" FORMAT "x(100)":U
...
"tc-gn-clie.CodUnico" "Cod Único Sugerido" ? "character" ? ? ? ? ? ? no ? no no "14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.gn-clie.DirCli
"gn-clie.DirCli" "Dirección" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  MESSAGE "¿La información es correcta?" SKIP
          "Usted Actualizará el registro"
      VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO 
      TITLE "" UPDATE lChoice AS LOGICAL.
  
  CASE lChoice:
      WHEN YES THEN DO: 
          MESSAGE "Se grabara como código unico: " tc-gn-clie.codunico:SCREEN-VALUE IN BROWSE {&BROWSE-NAME} SKIP
