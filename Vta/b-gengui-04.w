...
&Scoped-define INTERNAL-TABLES FacCPedi FacDPedi Almacen
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
      ...
      EACH Almacen WHERE Almacen.CodCia = FacDPedi.CodCia ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
  ...
  AND Almacen.CodAlm = FacDPedi.AlmDes ~
    ...
    BY FacCPedi.FchPed DESCENDING ~
       BY FacCPedi.NroPed DESCENDING.
&Scoped-define TABLES-IN-QUERY-br_table FacCPedi FacDPedi Almacen
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 73 BY 7.81
         FONT 4.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacCPedi,INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.Almacen WHERE INTEGRAL.FacDPedi ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", FIRST,"
     _OrdList          = "INTEGRAL.FacCPedi.FchPed|no,INTEGRAL.FacCPedi.NroPed|no"
     _Where[1]         = "{&CONDICION}"
     _JoinCode[3]      = "INTEGRAL.Almacen.CodCia = INTEGRAL.FacDPedi.CodCia
  AND INTEGRAL.Almacen.CodAlm = INTEGRAL.FacDPedi.AlmDes"
     _Where[3]         = "INTEGRAL.Almacen.CodDiv = s-coddiv"
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAILABLE FacCPedi OR
        ...
        RETURN.
    END.
    RUN vta\gGenGuia4 (ROWID(FacCPedi), 'A', 'G/R').       /* GUIA AUTOMATICA */
...
------------------------------------------------------------------------------*/
    ...
    RUN vta\gGenGuia4 (ROWID(FacCPedi), 'M', 'G/R').       /* GUIA MANUAL */
    RUN dispatch IN THIS-PROCEDURE ('open-query').
