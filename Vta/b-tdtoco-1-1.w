...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      Almmmatg.DesMat FORMAT "X(52)"
      Almmmatg.DesMar FORMAT "X(10)"
      PEDI.UndVta COLUMN-LABEL "Unidad" FORMAT "X(5)"
      PEDI.CanPed COLUMN-LABEL "Cantidad" FORMAT ">>>,>>>.99"
      PEDI.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>9.9999"
      ...
      PEDI.Por_DSCTOS[3] COLUMN-LABEL "% Dscto.!Vol. o Prom." FORMAT "->>9.9999" 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 126 BY 7.19
         FONT 4.
