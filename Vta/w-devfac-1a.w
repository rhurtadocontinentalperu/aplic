...
&Scoped-Define ENABLED-OBJECTS RECT-64 RECT-65 Btn-Pendientes BUTTON-1 ~
BUTTON-6 BUTTON-7 
...
DEFINE VARIABLE h_v-devfac-1a AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     Btn-Pendientes AT ROW 9.46 COL 77.29
     BUTTON-1 AT ROW 15.12 COL 79
     BUTTON-6 AT ROW 16.23 COL 79
     BUTTON-7 AT ROW 17.31 COL 79
     RECT-64 AT ROW 14.92 COL 77.86
     RECT-65 AT ROW 1 COL 2 WIDGET-ID 2
...
ON CHOOSE OF Btn-Pendientes IN FRAME F-Main /* Documentos */
DO:
  RUN Asigna-Documento IN h_v-devfac-1a.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/v-devfac-1a.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-devfac-1a ).
       RUN set-position IN h_v-devfac-1a ( 1.19 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.58 , 84.14 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv05 ).
       RUN set-position IN h_p-updv05 ( 8.12 , 33.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 8.15 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-devfac ).
       RUN set-position IN h_q-devfac ( 8.12 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.08 , 12.14 ) */

       /* Links to SmartViewer h_v-devfac-1a. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-devfac-1a ).
       RUN add-link IN adm-broker-hdl ( h_q-devfac , 'Record':U , h_v-devfac-1a ).

       /* Links to SmartQuery h_q-devfac. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_q-devfac ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-devfac-1a ,
             Btn-Pendientes:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv05 ,
             h_v-devfac-1a , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-devolu ).
       RUN set-position IN h_b-devolu ( 9.46 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tmpdev-1 ).
       RUN set-position IN h_b-tmpdev-1 ( 9.46 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv95 ).
       RUN set-position IN h_p-updv95 ( 10.96 , 77.86 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-64 RECT-65 Btn-Pendientes BUTTON-1 BUTTON-6 BUTTON-7 
