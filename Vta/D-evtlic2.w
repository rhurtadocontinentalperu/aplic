...
DEFINE VAR ddate1 AS DATE NO-UNDO.
DEFINE VAR ddate2 AS DATE NO-UNDO.
...
DEFINE TEMP-TABLE tmp-tempo 
    ...
    FIELD t-licen   LIKE Almmmatg.Licencia[1].
...
&Scoped-Define ENABLED-OBJECTS F-DIVISION BUTTON-5 F-CodCli BUTTON-7 DesdeF ~
HastaF C-tipo C-tipo-2 F-DIVISION-1 F-DIVISION-2 F-DIVISION-3 F-DIVISION-4 ~
F-DIVISION-5 F-DIVISION-6 nCodMon Btn_OK Btn_Cancel Btn_Help RECT-58 ~
RECT-61 RECT-63 RECT-62 
&Scoped-Define DISPLAYED-OBJECTS F-DIVISION F-Licenciatario F-CodCli DesdeF ~
HastaF C-tipo C-tipo-2 F-DIVISION-1 F-NOMDIV-1 F-DIVISION-2 F-NOMDIV-2 ~
...
DEFINE VARIABLE C-tipo AS CHARACTER FORMAT "X(20)":U INITIAL "Licen-Articulo" 
     VIEW-AS COMBO-BOX INNER-LINES 1
     LIST-ITEMS "Licen-Articulo" 
     DROP-DOWN-LIST
...
DEFINE VARIABLE F-Licenciatario AS CHARACTER FORMAT "X(50)":U INITIAL "018" 
     LABEL "Licenciatario" 
     VIEW-AS FILL-IN 
     SIZE 10.14 BY .73 NO-UNDO.
...
DEFINE FRAME F-Main
     F-DIVISION AT ROW 3.12 COL 11 COLON-ALIGNED
     BUTTON-5 AT ROW 3.12 COL 25.29
     F-Licenciatario AT ROW 4.08 COL 11 COLON-ALIGNED
     BUTTON-6 AT ROW 4.04 COL 25.29
     F-CodCli AT ROW 5.04 COL 11 COLON-ALIGNED
     BUTTON-7 AT ROW 5.04 COL 25.72
     DesdeF AT ROW 6.38 COL 11 COLON-ALIGNED
     HastaF AT ROW 6.35 COL 30.43 COLON-ALIGNED
...
/* SETTINGS FOR FILL-IN F-Licenciatario IN FRAME F-Main
   NO-ENABLE                                                            */
...
DO:
  DO WITH FRAME {&FRAME-NAME}:
    input-var-1 = "LC".
    output-var-2 = "".
    RUN lkup\C-ALMTAB02.r("Licenciatario").
    IF output-var-2 <> ? THEN DO:
        F-Licenciatario = output-var-2.
        DISPLAY F-Licenciatario.
        APPLY "ENTRY" TO F-Licenciatario.
        RETURN NO-APPLY.        
    END.
  END.
...
&Scoped-define SELF-NAME F-Licenciatario
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-Licenciatario W-Win
ON LEAVE OF F-Licenciatario IN FRAME F-Main /* Licenciatario */
DO:
   ASSIGN F-Licenciatario.
   IF SELF:SCREEN-VALUE = "" THEN RETURN.
   IF F-Licenciatario = "" THEN DO:
      SELF:SCREEN-VALUE = "".
      RETURN.
   END.
   ...
   IF NOT AVAILABLE AlmTabla THEN DO:
      MESSAGE "Codigo de Licenciatario no Existe" VIEW-AS ALERT-BOX ERROR.
      RETURN NO-APPLY.
   END.
...
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN C-tipo
         ...
         f-CodCli.
  X-ARTI        = "ARTICULOS    : " .
  X-LICENCIA    = "LICENCIATARIO: "  + F-licenciatario.
  ...
  */
  ...
  IF DesdeF < 10/01/2006 AND HastaF >= 10/01/2006 THEN dDate1 = 10/01/2006.
  ELSE IF DesdeF < 10/01/2006 AND HastaF < 10/01/2006 THEN dDate1 = 01/01/2000.
  ELSE IF DesdeF > 08/31/2008 THEN dDate1 = 01/01/2000.

  IF HastaF > 08/31/2008 AND DesdeF > 08/31/2008 THEN dDate2 = 01/01/2000. 
  ELSE IF HastaF > 08/31/2008 THEN dDate2 = 08/31/2008.
  ELSE IF HastaF < 10/01/2006 THEN dDate2 = 01/01/2000.  
...
/*   X-CODDIV = SUBSTRING(Gn-Divi.Desdiv,1,20) + "," . */
  ...
  IF F-Licenciatario = "" THEN DO:
    X-LICENCIA = "LICENCIATARIO: ".
    FOR EACH Almtabla NO-LOCK WHERE AlmTabla.Tabla = 'LC':
        X-LICENCIA = X-LICENCIA + AlmTabla.Codigo + "," .
    END.
  END.
  ELSE DO:
   FIND Gn-Divi WHERE Gn-Divi.Codcia = S-CODCIA AND
...
FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = S-CODCIA
                           AND  Almmmatg.Licencia[1] BEGINS F-Licenciatario
  ...
  FOR EACH Gn-Divi WHERE Gn-Divi.Codcia = S-CODCIA 
    ...
    FOR EACH EvtClArti NO-LOCK WHERE EvtClArti.CodCia = S-CODCIA
                         ...
                         AND   EvtClArti.CodCli BEGINS f-CodCli
                         AND   (EvtClArti.Nrofch >= INTEGER(STRING(YEAR(dDate1),"9999") + STRING(MONTH(dDate1),"99"))
                         AND   EvtClArti.Nrofch <= INTEGER(STRING(YEAR(dDate2),"9999") + STRING(MONTH(dDate2),"99")) ):
      ...
      */
      ...
      /*********************** Calculo Para Obtener los datos diarios ************/
       DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
            ...
            IF X-FECHA >= dDate1 AND X-FECHA <= dDate2 THEN DO:
...
------------------------------------------------------------------------------*/
  DISPLAY F-DIVISION F-Licenciatario F-CodCli DesdeF HastaF C-tipo C-tipo-2 
          F-DIVISION-1 F-NOMDIV-1 F-DIVISION-2 F-NOMDIV-2 F-NOMDIV-3 
          F-DIVISION-3 F-DIVISION-4 F-NOMDIV-4 F-DIVISION-5 F-NOMDIV-5 
          F-DIVISION-6 F-NOMDIV-6 nCodMon txt-msj 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE F-DIVISION BUTTON-5 F-CodCli BUTTON-7 DesdeF HastaF C-tipo C-tipo-2 
         F-DIVISION-1 F-DIVISION-2 F-DIVISION-3 F-DIVISION-4 F-DIVISION-5 
         F-DIVISION-6 nCodMon Btn_OK Btn_Cancel Btn_Help RECT-58 RECT-61 
         RECT-63 RECT-62 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-HEADER
         ...
         X-LICENCIA AT 1 FORMAT "X(60)" SKIP
  ...
  FOR EACH tmp-tempo  /*WHERE t-canti[10] > 0 */
      ...
      */
      ...
      IF FIRST-OF(t-licen) THEN DO:
         FIND AlmTabla WHERE AlmTabla.Tabla = "LC" 
                       AND  AlmTabla.codigo = t-licen 
                      NO-LOCK NO-ERROR.
         IF AVAILABLE AlmTabla THEN DO:
             PUT STREAM REPORT  " " SKIP.
             PUT STREAM REPORT   "LICENCIATARIO : "  FORMAT "X(20)" AT 1 
                                 t-licen         FORMAT "X(15)" AT 25
                                 AlmTabla.Nombre  FORMAT "X(40)" AT 45 SKIP.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tmp-tempo  /*WHERE t-venta[10] > 0 */
      ...
      */
      ...
      ACCUM  t-venta[1]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[2]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[3]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[4]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[5]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[6]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[7]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-venta[10]  (SUB-TOTAL BY t-licen) .
      ...
      IF LAST-OF(t-licen) THEN DO:
        ...
        WITH FRAME F-REPORTE.
        DISPLAY STREAM REPORT 
            ("TOTAL LICENCIATARIO : " + t-licen) @ t-desmat
            (ACCUM SUB-TOTAL BY t-licen t-venta[1]) @ t-venta[1] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[2]) @ t-venta[2] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[3]) @ t-venta[3] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[4]) @ t-venta[4] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[5]) @ t-venta[5] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[6]) @ t-venta[6] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[7]) @ t-venta[7] 
            (ACCUM SUB-TOTAL BY t-licen t-venta[10]) @ t-venta[10] 
            WITH FRAME F-REPORTE.
      END.
...
/*
  ...
  FOR EACH tmp-tempo  /*WHERE t-COSTO[10] > 0 */
      ...
      ACCUM  t-costo[1]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[2]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[3]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[4]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[5]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[6]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[7]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-costo[10]  (SUB-TOTAL BY t-licen) .
      ...
      IF LAST-OF(t-prove) THEN DO:
        ...
        DISPLAY STREAM REPORT 
            ("TOTAL LICENCIATARIO : " + t-licen) @ t-desmat
            (ACCUM SUB-TOTAL BY t-licen t-costo[1]) @ t-costo[1] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[2]) @ t-costo[2] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[3]) @ t-costo[3] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[4]) @ t-costo[4] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[5]) @ t-costo[5] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[6]) @ t-costo[6] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[7]) @ t-costo[7] 
            (ACCUM SUB-TOTAL BY t-licen t-costo[10]) @ t-costo[10] 
            WITH FRAME F-REPORTE.
      END.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tmp-tempo /* WHERE t-Marge[10] > 0 */
      ...
      */
      ...
      ACCUM  t-Marge[1]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[2]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[3]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[4]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[5]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[6]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[7]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Marge[10]  (SUB-TOTAL BY t-licen) .
      ...
      IF LAST-OF(t-licen) THEN DO:
        ...
        DISPLAY STREAM REPORT 
            ("TOTAL LICENCIATARIO : " + t-licen) @ t-desmat
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[1]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[1])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[1]) @ t-Marge[1] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[2]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[2])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[2]) @ t-Marge[2] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[3]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[3])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[3]) @ t-Marge[3] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[4]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[4])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[4]) @ t-Marge[4] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[5]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[5])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[5]) @ t-Marge[5] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[6]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[6])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[6]) @ t-Marge[6] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[7]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[7])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[7]) @ t-Marge[7] 
            ((ACCUM SUB-TOTAL BY t-licen t-Venta[10]) - (ACCUM SUB-TOTAL BY t-licen t-Costo[10])) / (ACCUM SUB-TOTAL BY t-licen t-Venta[10]) @ t-Marge[10] 
            WITH FRAME F-REPORTE.
      END.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tmp-tempo  /*WHERE t-Utili[10] > 0 */
      ...
      */
      ...
      ACCUM  t-Utili[1]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[2]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[3]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[4]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[5]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[6]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[7]  (SUB-TOTAL BY t-licen) .
      ACCUM  t-Utili[10]  (SUB-TOTAL BY t-licen) .
      ...
      IF LAST-OF(t-licen) THEN DO:
        ...
        DISPLAY STREAM REPORT 
            ("TOTAL LICENCIATARIO : " + t-licen) @ t-desmat
            (ACCUM SUB-TOTAL BY t-licen t-Utili[1]) @ t-Utili[1] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[2]) @ t-Utili[2] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[3]) @ t-Utili[3] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[4]) @ t-Utili[4] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[5]) @ t-Utili[5] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[6]) @ t-Utili[6] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[7]) @ t-Utili[7] 
            (ACCUM SUB-TOTAL BY t-licen t-Utili[10]) @ t-Utili[10] 
            WITH FRAME F-REPORTE.
      END.
...
------------------------------------------------------------------------------*/
    ...
    DO c-Copias = 1 TO s-nro-copias ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
        ...
        END CASE.
        CASE C-Tipo:
            WHEN "licen-Articulo"    THEN RUN Formato1.
            /*
...
IF F-Licenciatario <> "" THEN DO:
        DO I = 1 TO NUM-ENTRIES(F-Licenciatario):
          FIND AlmTabla WHERE AlmTabla.Tabla = 'LC' AND
                              AlmTabla.Codigo = ENTRY(I,F-Licenciatario) NO-LOCK NO-ERROR.
          IF NOT AVAILABLE AlmTabla THEN DO:
            MESSAGE "Licenciatario " + ENTRY(I,F-Licenciatario) + " No Existe " SKIP
                    "Verifique Por Favor ....."  VIEW-AS ALERT-BOX ERROR.
            APPLY "ENTRY" TO F-Licenciatario IN FRAME {&FRAME-NAME}.
            RETURN "ADM-ERROR".
          END.                             
        END.
END.
