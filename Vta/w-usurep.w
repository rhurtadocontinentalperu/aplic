...
&Scoped-Define ENABLED-OBJECTS f-desde f-hasta Btn_OK B-cancela 
...
DEFINE FRAME F-Main
     f-desde AT ROW 2.73 COL 12 COLON-ALIGNED
     f-hasta AT ROW 2.73 COL 28 COLON-ALIGNED
     Btn_OK AT ROW 1.58 COL 50
     B-cancela AT ROW 2.92 COL 50
     "Rango de Fechas:" VIEW-AS TEXT
          SIZE 16 BY .62 AT ROW 1.77 COL 19
          FONT 6
...
ON END-ERROR OF W-Win /* Productos Actualizados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Productos Actualizados */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE f-desde f-hasta Btn_OK B-cancela 
      WITH FRAME F-Main IN WINDOW W-Win.
...
DEFINE FRAME f-cab
        ...
        "PRODUCTOS ACTUALIZADOS POR LOS USUARIOS"  AT 13 FORMAT "X(35)"
        "Pag.  : " AT 62 FORMAT "X(10)" PAGE-NUMBER(REPORT) FORMAT "ZZ9" SKIP
        
        "Desde : " AT 20 FORMAT "X(10)" STRING(F-DESDE,"99/99/9999") FORMAT "X(10)" "Al" STRING(F-HASTA,"99/99/9999") FORMAT "X(12)" SKIP
        "------------------------------------------------------------------------------"SKIP
        "Codigo                                                          Fecha         " SKIP
        "Producto        Descripcion                          Usuario    Actualizacion " SKIP
        "------------------------------------------------------------------------------"SKIP
         
         WITH WIDTH 100 NO-BOX NO-LABELS NO-UNDERLINE STREAM-IO DOWN PAGE-TOP.
         VIEW STREAM REPORT FRAME H-REP.

FOR EACH almmmatg NO-LOCK WHERE
                 almmmatg.codcia = s-codcia and   
                 almmmatg.fchact >= f-desde and
                 almmmatg.fchact <= f-hasta.
