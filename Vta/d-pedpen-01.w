...
DEF OUTPUT PARAMETER p-NroPed LIKE Ccbcdocu.nroped.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 FacCPedi.FchPed FacCPedi.NroPed ~
FacCPedi.CodCli FacCPedi.NomCli FacCPedi.ImpTot 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH FacCPedi ~
      WHERE FacCPedi.CodCia = s-codcia ~
 AND FacCPedi.CodDoc = s-codref ~
 AND FacCPedi.CodDiv = s-coddiv ~
 AND FacCPedi.FlgEst = "P" ~
 NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH FacCPedi ~
      WHERE FacCPedi.CodCia = s-codcia ~
 AND FacCPedi.CodDoc = s-codref ~
 AND FacCPedi.CodDiv = s-coddiv ~
 AND FacCPedi.FlgEst = "P" ~
 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 FacCPedi
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 FacCPedi
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 84 BY 10
         FONT 4.
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 1.19 COL 90
     Btn_Cancel AT ROW 2.38 COL 90
     SPACE(3.28) SKIP(8.53)
