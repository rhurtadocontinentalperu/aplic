...
DEFINE VARIABLE h_b-repo10 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-repo10.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-repo10 ).
       RUN set-position IN h_b-repo10 ( 1.04 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-repo10 ( 18.62 , 90.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-repo10. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_b-repo10 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-repo10 ,
