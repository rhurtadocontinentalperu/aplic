...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      facdpedm.codmat COLUMN-LABEL "Articulo"
      Almmmatg.DesMat FORMAT "X(31)"
      Almmmatg.DesMar COLUMN-LABEL "Marca" FORMAT "X(10)"
      facdpedm.UndVta COLUMN-LABEL "Unidad" FORMAT "XXXXXXXX"
      Facdpedm.AlmDes COLUMN-LABEL "Alm!Des"
      facdpedm.CanPed FORMAT ">>>,>>>.9999"
      facdpedm.PreUni COLUMN-LABEL "Precio !Unitario" FORMAT ">>,>>9.9999"
      facdpedm.PorDto COLUMN-LABEL "Dsct.!1" FORMAT "->9.99"
      Facdpedm.Por_Dsctos[1] COLUMN-LABEL "Dsct.!2" FORMAT "->9.99"
