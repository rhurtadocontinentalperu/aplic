...
&Scoped-define FIELDS-IN-QUERY-br_table DETA.codmat Almmmatg.DesMat Almmmatg.DesMar DETA.UndVta DETA.CanDes DETA.PreUni DETA.PorDto DETA.Por_Dsctos[1] DETA.Por_Dsctos[3] DETA.ImpLin   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      DETA.PorDto COLUMN-LABEL '%Dcto!Incluido' FORMAT '->>9.99'
      DETA.Por_Dsctos[1] COLUMN-LABEL '%Dcto!Manual' FORMAT '->>9.99'
      DETA.Por_Dsctos[3] COLUMN-LABEL '%Dcto!Vol/Prom' FORMAT '->>9.99'
      DETA.ImpLin COLUMN-LABEL "Importe" FORMAT ">>>,>>>.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 7.81
         FONT 4.
