...
DEFINE FRAME F-Main
     rs-coddoc AT ROW 1.46 COL 18 NO-LABEL WIDGET-ID 32
     txt-nroped AT ROW 5.31 COL 16 COLON-ALIGNED WIDGET-ID 2
     txt-nomcli AT ROW 6.38 COL 16 COLON-ALIGNED WIDGET-ID 6
     txt-bultos AT ROW 7.46 COL 16 COLON-ALIGNED WIDGET-ID 4
     BtnDone-2 AT ROW 8.54 COL 60 WIDGET-ID 28
     BtnDone AT ROW 8.54 COL 68 WIDGET-ID 22
     "Documento:" VIEW-AS TEXT
          SIZE 11 BY .96 AT ROW 1.38 COL 5.86 WIDGET-ID 30
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 81.43 BY 9.62 WIDGET-ID 100.
    ...
    CASE rs-coddoc:
        ...
        WHEN "P/M" THEN DO:
            FIND FIRST faccpedm WHERE faccpedm.codcia = s-codcia
                ...
                AND faccpedm.nroped = txt-nroped 
                /*AND faccpedm.divdes = s-coddiv */
                NO-LOCK NO-ERROR.
    ...
    CASE rs-coddoc:
        ...
        WHEN "P/M" THEN DO:
            ...
            FOR EACH facdpedm OF faccpedm NO-LOCK,
              ...
              dPeso = dPeso + (facdpedm.canped * almmmatg.pesmat).
            END.
