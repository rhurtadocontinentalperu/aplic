...
almmserv.DesMat almmserv.UndBas almmserv.AftIgv almmserv.MonVta ~
almmserv.CtoLis almmserv.CtoTot almmserv.PreOfi 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      almmserv.Estado FORMAT "X(1)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      almmserv.DesMat FORMAT "X(45)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      almmserv.UndBas FORMAT "X(4)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      ...
      almmserv.AftIgv FORMAT "Si/No":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
            VIEW-AS TOGGLE-BOX
      almmserv.AftDetraccion COLUMN-LABEL "Detraccion" FORMAT "yes/no":U
            VIEW-AS TOGGLE-BOX
      almmserv.MonVta FORMAT "9":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      ...
      almmserv.CtoTot COLUMN-LABEL "Precio Costo Lista!Total" FORMAT "->>>,>>9.9999":U
            COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
      almmserv.PreOfi FORMAT ">,>>>,>>9.9999":U WIDTH 14.14 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
  ENABLE
...
"codmat" "Cuenta" ? "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.almmserv.Estado
"Estado" ? ? "character" 11 0 ? ? ? ? yes "A: Activado  D: Desactivado" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.almmserv.DesMat
"DesMat" ? ? "character" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > INTEGRAL.almmserv.UndBas
"UndBas" ? ? "character" 11 0 ? ? ? ? yes "Unidad Base" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = INTEGRAL.almmserv.FchIng
     _FldNameList[6]   > INTEGRAL.almmserv.FchAct
"FchAct" "Fecha Act." ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"AftIgv" ? ? "logical" 11 0 ? ? ? ? yes "Incluido IGV" no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[9]   > INTEGRAL.almmserv.AftDetraccion
"AftDetraccion" "Detraccion" ? "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[10]   > INTEGRAL.almmserv.MonVta
"MonVta" ? ? "integer" 11 0 ? ? ? ? yes "1: Soles   2: Dólares" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > INTEGRAL.almmserv.CtoLis
"CtoLis" "Precio Costo Lista!S/IGV" ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.almmserv.CtoTot
"CtoTot" "Precio Costo Lista!Total" ? "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.almmserv.PreOfi
"PreOfi" ? ? "decimal" 11 0 ? ? ? ? yes ? no no "14.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
