...
Gn-ClieL.ImpLC Gn-ClieL.UsrLC Gn-ClieL.FchAut[1] 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 61.72 BY 6.35
         FONT 2.
...
"Gn-ClieL.FchFin" ? ? "date" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Gn-ClieL.ImpLC
"Gn-ClieL.ImpLC" ? ">,>>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = INTEGRAL.Gn-ClieL.UsrLC
     _FldNameList[5]   = INTEGRAL.Gn-ClieL.FchAut[1]
