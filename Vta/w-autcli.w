...
DEFINE VARIABLE h_v-autcli AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 1.00 , 20.86 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv97 ).
       RUN set-position IN h_p-updv97 ( 1.00 , 38.86 ) NO-ERROR.
       RUN set-size IN h_p-updv97 ( 1.54 , 34.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/v-autcli.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-autcli ).
       RUN set-position IN h_v-autcli ( 2.73 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.00 , 100.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Obs Creditos|Obs Ventas|Ca Banco|Campaña|Mensajes|Relacionados' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 16.88 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.23 , 99.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-autcli. */
       RUN add-link IN adm-broker-hdl ( h_p-updv97 , 'TableIO':U , h_v-autcli ).
       RUN add-link IN adm-broker-hdl ( h_q-client , 'Record':U , h_v-autcli ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv97 ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-autcli ,
             h_p-updv97 , 'AFTER':U ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-obscre ).
       RUN set-position IN h_v-obscre ( 19.04 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv96 ).
       RUN set-position IN h_p-updv96 ( 19.04 , 74.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-bcocli ).
       RUN set-position IN h_b-bcocli ( 19.58 , 16.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 20.15 , 58.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-gncliel ).
       RUN set-position IN h_b-gncliel ( 19.04 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b-gncliel ( 6.42 , 50.29 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-2 ).
       RUN set-position IN h_p-updv12-2 ( 20.38 , 58.00 ) NO-ERROR.
       RUN set-size IN h_p-updv12-2 ( 4.04 , 14.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-gncliel. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12-2 , 'TableIO':U , h_b-gncliel ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN set-position IN h_b-gn-cliem-1 ( 18.23 , 4.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-gn-cliem-1 ( 18.23 , 30.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12-3 ).
       RUN set-position IN h_p-updv12-3 ( 25.50 , 30.00 ) NO-ERROR.
    ...
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-codunico ).
       RUN set-position IN h_b-codunico ( 18.77 , 5.00 ) NO-ERROR.
