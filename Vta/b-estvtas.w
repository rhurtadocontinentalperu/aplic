...
&Scoped-define INTERNAL-TABLES tm-Clientes

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tm-CodCli tm-Amount[1] tm-Amount[2] tm-Amount[3] tm-Amount[4]   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH tm-Clientes
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH tm-Clientes.
&Scoped-define TABLES-IN-QUERY-br_table tm-Clientes
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tm-Clientes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      tm-CodCli       COLUMN-LABEL "Cliente" FORMAT "X(13)"
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH EvtAll99 WHERE EvtAll99.CodCia = s-CodCia
        ...
        IF NOT AVAILABLE tm-Clientes THEN DO:
            CREATE tm-Clientes.
            ASSIGN tm-codcli  = evtall99.codcli.
            /*
