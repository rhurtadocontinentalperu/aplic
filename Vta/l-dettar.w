...
&SCOPED-DEFINE CONDICION ( CcbcDocu.CodCia = S-CODCIA ~
                           ...
                           AND CcbcDocu.FmaPgo BEGINS F-CONDI ~
...
&Scoped-define FIELDS-IN-QUERY-br_table CcbCDocu.NroCard CcbCDocu.CodDoc ~
CcbCDocu.NroDoc CcbCDocu.NomCli CcbCDocu.FmaPgo CcbCDocu.CodVen ~
CcbCDocu.FchDoc X-MON @ X-MON CcbCDocu.ImpTot X-EST @ X-EST 
...
&Scoped-Define ENABLED-OBJECTS RECT-1 br_table FILL-IN-codigo C-CMPBTE ~
f-desde f-nrocard CMB-filtro F-FMAPGO f-hasta FILL-IN-filtro COMBO-BOX-5 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-codigo C-CMPBTE f-desde f-nrocard ~
CMB-filtro f-nomcard F-FMAPGO f-hasta FILL-IN-filtro F-CndVta COMBO-BOX-5 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CcbCDocu.NroCard COLUMN-LABEL "Tarjeta"
      CcbCDocu.CodDoc COLUMN-LABEL "Tipo"
      CcbCDocu.NroDoc FORMAT "XXX-XXXXXXXX"
      CcbCDocu.NomCli FORMAT "x(45)"
      CcbCDocu.FmaPgo COLUMN-LABEL "Cnd.!Venta" FORMAT "XXX"
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 93.43 BY 10.58
...
DEFINE FRAME F-Main
     br_table AT ROW 5.15 COL 1.86
     FILL-IN-codigo AT ROW 1.35 COL 14.29 COLON-ALIGNED
     C-CMPBTE AT ROW 2.27 COL 23.29 COLON-ALIGNED
     f-desde AT ROW 3.27 COL 23.29 COLON-ALIGNED
     f-nrocard AT ROW 4.23 COL 23.43 COLON-ALIGNED
     CMB-filtro AT ROW 1.27 COL 27.57 NO-LABEL
     f-nomcard AT ROW 4.23 COL 34.14 NO-LABEL
     F-FMAPGO AT ROW 2.35 COL 40.43 COLON-ALIGNED
     f-hasta AT ROW 3.19 COL 40.43 COLON-ALIGNED
     FILL-IN-filtro AT ROW 1.35 COL 49.43 NO-LABEL
     F-CndVta AT ROW 2.35 COL 47 COLON-ALIGNED NO-LABEL
     COMBO-BOX-5 AT ROW 3.23 COL 73.72 COLON-ALIGNED
     RECT-1 AT ROW 1 COL 1
     "Buscar x" VIEW-AS TEXT
          SIZE 7.86 BY .62 AT ROW 1.46 COL 2.14
          FONT 6
     "Filtrar x" VIEW-AS TEXT
          SIZE 6.72 BY .65 AT ROW 2.38 COL 6.14
          FONT 6
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > integral.CcbCDocu.NroCard
"CcbCDocu.NroCard" "Tarjeta" ? "character" ? ? ? ? ? ? no ?
...
"CcbCDocu.NomCli" ? "x(45)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > integral.CcbCDocu.FmaPgo
"CcbCDocu.FmaPgo" "Cnd.!Venta" "XXX" "character" ? ? ? ? ? ? no ?
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL f-nrocard L-table-Win
ON LEAVE OF f-nrocard IN FRAME F-Main /* NroCard */
DO:
