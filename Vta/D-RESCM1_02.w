...
FILL-IN-Serie f-tipo f-clien f-vende f-desde f-hasta FILL-IN-CndVta ~
RADIO-SET-1 RB-NUMBER-COPIES B-impresoras RB-BEGIN-PAGE RB-END-PAGE ~
B-imprime B-cancela btn-excel BUTTON-3 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fAdelanto D-Dialog 
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-Serie AT ROW 2.15 COL 9 COLON-ALIGNED
     f-tipo AT ROW 2.69 COL 49.86 COLON-ALIGNED
     x-CodDiv AT ROW 3.12 COL 9 COLON-ALIGNED
     f-clien AT ROW 4.04 COL 9 COLON-ALIGNED
     f-nomcli AT ROW 4.04 COL 20.29 COLON-ALIGNED NO-LABEL
     f-vende AT ROW 4.77 COL 9 COLON-ALIGNED
     f-nomven AT ROW 4.77 COL 20.29 COLON-ALIGNED NO-LABEL
     f-desde AT ROW 4.85 COL 52 COLON-ALIGNED
     f-hasta AT ROW 4.85 COL 69.29 COLON-ALIGNED
     FILL-IN-CndVta AT ROW 5.62 COL 9 COLON-ALIGNED
     FILL-IN-Descripcion AT ROW 5.62 COL 19 COLON-ALIGNED NO-LABEL
     RADIO-SET-1 AT ROW 7.92 COL 2.57 NO-LABEL
     RB-NUMBER-COPIES AT ROW 8.08 COL 70 COLON-ALIGNED
     B-impresoras AT ROW 8.92 COL 15.57
     RB-BEGIN-PAGE AT ROW 9.08 COL 70 COLON-ALIGNED
     b-archivo AT ROW 9.92 COL 15.57
     RB-END-PAGE AT ROW 10.08 COL 70 COLON-ALIGNED
     RB-OUTPUT-FILE AT ROW 10.15 COL 19.86 COLON-ALIGNED NO-LABEL
     B-imprime AT ROW 11.77 COL 11
     B-cancela AT ROW 11.77 COL 25
     btn-excel AT ROW 11.77 COL 39 WIDGET-ID 10
     BUTTON-3 AT ROW 11.77 COL 53
     " Configuración de Impresión" VIEW-AS TEXT
          SIZE 83.43 BY .62 AT ROW 6.77 COL 1.29
...
ON CHOOSE OF btn-excel IN FRAME D-Dialog /* Button 6 */
DO:
    RUN Asigna-Variables.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN-CndVta D-Dialog
ON LEAVE OF FILL-IN-CndVta IN FRAME D-Dialog /* Cond. Venta */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY r-sortea R-Condic R-Estado FILL-IN-Serie f-tipo x-CodDiv f-clien 
          ...
          RB-END-PAGE 
      WITH FRAME D-Dialog.
  ENABLE RECT-48 RECT-5 r-sortea R-Condic R-Estado FILL-IN-Serie f-tipo f-clien 
         f-vende f-desde f-hasta FILL-IN-CndVta RADIO-SET-1 RB-NUMBER-COPIES 
         B-impresoras RB-BEGIN-PAGE RB-END-PAGE B-imprime B-cancela btn-excel 
         BUTTON-3 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Excel-Doc D-Dialog 
PROCEDURE Excel-Doc :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fAdelanto D-Dialog 
FUNCTION fAdelanto RETURNS DECIMAL
