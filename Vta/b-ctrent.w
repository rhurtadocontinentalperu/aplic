...
&SCOPED-DEFINE CONDICION ( T-DOCU.CodDoc BEGINS CB-CodDoc )
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH T-DOCU NO-LOCK INDEXED-REPOSITION.
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH T-DOCU NO-LOCK INDEXED-REPOSITION.
     _END_FREEFORM
...
DO I = 1 TO 2:
    ...
    FIND FIRST CcbCDocu WHERE 
               ...
               CcbCDocu.Flgcon = "E"       AND  
               CcbCDocu.CodDoc = C-DOC NO-LOCK NO-ERROR.
    IF AVAILABLE CcbCDocu THEN DO:
       REPEAT WHILE 
              ...
              ccbCDocu.TpoFac = "C"       AND
              CcbCDocu.Flgcon = "E"       AND
              CcbCDocu.CodDoc = C-DOC :
            IF CcbCDocu.FlgCon = "E" AND CcbCDocu.FlgEst = "P" THEN DO:
                CREATE T-DOCU.
