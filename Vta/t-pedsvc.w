...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 92 BY 5.65
...
DEFINE FRAME F-Main
     ...
     FILL-IN_ImpBrt AT ROW 6.77 COL 8 COLON-ALIGNED WIDGET-ID 2
     FILL-IN_PorDto AT ROW 6.77 COL 31 COLON-ALIGNED WIDGET-ID 14
     FILL-IN_ImpDto AT ROW 6.77 COL 46 COLON-ALIGNED WIDGET-ID 4
     FILL-IN_PorIgv AT ROW 6.77 COL 69 COLON-ALIGNED WIDGET-ID 16
     FILL-IN_ImpIgv AT ROW 6.77 COL 84 COLON-ALIGNED WIDGET-ID 8
     FILL-IN_ImpExo AT ROW 7.54 COL 8 COLON-ALIGNED WIDGET-ID 6
     FILL-IN_ImpVta AT ROW 7.58 COL 46 COLON-ALIGNED WIDGET-ID 12
     FILL-IN_ImpTot AT ROW 7.58 COL 84 COLON-ALIGNED WIDGET-ID 10
     RECT-22 AT ROW 6.58 COL 1 WIDGET-ID 18
...
ON RETURN OF PEDI.CanPed, PEDI.codmat, PEDI.UndVta, PEDI.PreUni
DO:
    APPLY "TAB":U.
    RETURN NO-APPLY.
END.
