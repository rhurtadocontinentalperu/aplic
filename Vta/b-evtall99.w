...
DEFINE TEMP-TABLE tmp-EvtAll99 NO-UNDO
    ...
    FIELDS tmp-Amount    AS DECIMAL EXTENT 4
    FIELDS tmp-AmountMn1 AS DECIMAL EXTENT 3
    FIELDS tmp-AmountMn2 AS DECIMAL EXTENT 3
    FIELDS tmp-AmountMn3 AS DECIMAL EXTENT 3
    FIELDS tmp-AmountMn4 AS DECIMAL EXTENT 3
    FIELDS tmp-AmountMe  AS DECIMAL EXTENT 40
    FIELDS tmp-PorcenMn  AS DECIMAL EXTENT 40
    FIELDS tmp-PorcenMe  AS DECIMAL EXTENT 40.
...
&Scoped-define INTERNAL-TABLES tmp-EvtAll99

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tmp-CodMes tmp-Amount[1] tmp-Amount[2] tmp-Amount[3] tmp-Amount[4]   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH tmp-EvtAll99
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH tmp-EvtAll99.
&Scoped-define TABLES-IN-QUERY-br_table tmp-EvtAll99
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tmp-EvtAll99


/* Definitions for FRAME F-Main                                         */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS txt-cliente br_table 
&Scoped-Define DISPLAYED-OBJECTS txt-cliente 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 61 BY 6.69
         FONT 4.
...
DEFINE FRAME F-Main
     txt-cliente AT ROW 1.27 COL 6 COLON-ALIGNED WIDGET-ID 4
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tmp-EvtAll99.
     _END_FREEFORM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL txt-cliente B-table-Win
ON LEAVE OF txt-cliente IN FRAME F-Main /* Cliente */
DO:
    ASSIGN txt-cliente.
    s-codcli = txt-cliente.
/*     RUN Carga-Temporal.                               */
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH EvtAll99 WHERE EvtAll99.CodCia = s-CodCia
        ...
        IF NOT AVAILABLE tmp-EvtAll99 THEN DO:
            CREATE tmp-EvtAll99.
            ASSIGN tmp-codmes  = evtall99.codmes.
        ...
        /*ELSE DO:*/
            CASE (EvtAll99.CodAno):
                WHEN (PeriodoInicio) 
                    THEN ASSIGN tmp-Amount[1] = tmp-Amount[1] + EvtAll99.VtaxMesMn.                
                WHEN (PeriodoInicio + 1 ) 
                    THEN ASSIGN tmp-Amount[2] = tmp-Amount[2] + EvtAll99.VtaxMesMn.                
                WHEN (PeriodoInicio + 2 ) 
                    THEN ASSIGN tmp-Amount[3] = tmp-Amount[3] + EvtAll99.VtaxMesMn.
                WHEN (PeriodoInicio + 3 ) 
                    THEN ASSIGN tmp-Amount[4] = tmp-Amount[4] + EvtAll99.VtaxMesMn.
            END CASE.
        /*END.*/
    END. 
END PROCEDURE.
