...
&Scoped-define QUERY-STRING-br_table FOR EACH Ccbddocu OF ccbcdocu WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      FIRST Almmmate WHERE TRUE /* Join to ccbcdocu incomplete */ ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Ccbddocu.codmat COLUMN-LABEL "Articulo" FORMAT "X(8)":U WIDTH 6
      ...
      Ccbddocu.CanDes COLUMN-LABEL "Cantidad!Pedida" FORMAT ">,>>>,>>9.99<<":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.Ccbddocu OF INTEGRAL.ccbcdocu,INTEGRAL.Almmmatg OF INTEGRAL.Ccbddocu,INTEGRAL.Almmmate WHERE INTEGRAL.ccbcdocu ..."
...
"Ccbddocu.codmat" "Articulo" "X(8)" "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Ccbddocu.CanDes" "Cantidad!Pedida" ">,>>>,>>9.99<<" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
