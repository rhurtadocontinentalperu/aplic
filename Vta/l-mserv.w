...
&Scoped-define INTERNAL-TABLES almlserv

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table almlserv.codmat almlserv.DesMat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH almlserv WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table almlserv
&Scoped-define FIRST-TABLE-IN-QUERY-br_table almlserv
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.almlserv.DesMat
Nombres que contengan|y||INTEGRAL.almlserv.DesMat
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almlserv.codmat|yes
Descripción|||INTEGRAL.almlserv.DesMat|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.almlserv"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.almlserv.codmat
     _FldNameList[2]   = INTEGRAL.almlserv.DesMat
...
ON LEAVE OF FILL-IN-codigo IN FRAME F-Main /* Servicios */
DO:
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY almlserv.codmat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY almlserv.DesMat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "almlserv"}
