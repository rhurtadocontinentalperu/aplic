...
DEFINE VAR f-Division AS CHAR INIT '00000' NO-UNDO.
...
&Scoped-define QUERY-STRING-br_table FOR EACH CcbDDocu WHERE ~{&KEY-PHRASE} ~
 ...
 AND LOOKUP(integral.CcbDDocu.CodDiv, F-DIVISION) > 0 ~
...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 COMBO-BOX-1 BUTTON-4 DesdeC f-hasta ~
f-desde br_table 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-Division COMBO-BOX-1 DesdeC ~
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 74 WIDGET-ID 4
     FILL-IN-Division AT ROW 1.12 COL 15 COLON-ALIGNED WIDGET-ID 6
     COMBO-BOX-1 AT ROW 1.19 COL 96.43 COLON-ALIGNED
     BUTTON-4 AT ROW 1.38 COL 127
     DesdeC AT ROW 2.15 COL 15 COLON-ALIGNED
     F-DESMAT AT ROW 2.15 COL 24 COLON-ALIGNED NO-LABEL
     COMBO-BOX-2 AT ROW 2.15 COL 94.43 COLON-ALIGNED
     f-hasta AT ROW 2.92 COL 31.43 COLON-ALIGNED
     f-desde AT ROW 2.96 COL 15 COLON-ALIGNED
