...
F-DIVISION-5 F-NOMDIV-5 F-DIVISION-6 F-NOMDIV-6 x-mensaje nCodMon 
...
DEFINE FRAME F-Main
     ...
     x-mensaje AT ROW 10.15 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     nCodMon AT ROW 10.5 COL 52.43 NO-LABEL
     Btn_OK AT ROW 11.5 COL 39.57
     Btn_Cancel AT ROW 11.5 COL 50.86
     Btn_Help AT ROW 11.5 COL 62.29
...
FOR EACH Almmmatg NO-LOCK WHERE Almmmatg.codcia = S-CODCIA
    ...
    AND  (Almmmatg.codmat >= DesdeC
          AND   Almmmatg.CodMat <= HastaC)
    AND  (Almmmatg.CodPr1 BEGINS F-prov1
          OR Almmmatg.CodPr2 BEGINS F-prov1)
    AND  Almmmatg.Codmar BEGINS F-Marca
    USE-INDEX matg09:
...
------------------------------------------------------------------------------*/
  DISPLAY C-tipo F-DIVISION C-tipo-2 F-CodFam F-SubFam F-DIVISION-1 F-NOMDIV-1 
          ...
          F-DIVISION-6 F-NOMDIV-6 x-mensaje nCodMon 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-58 RECT-62 RECT-61 RECT-63 C-tipo F-DIVISION BUTTON-5 C-tipo-2 
         ...
         DesdeF HastaF F-DIVISION-5 F-DIVISION-6 nCodMon Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME F-Main IN WINDOW W-Win.
  ...
  FOR EACH tmp-tempo /* WHERE t-Marge[10] > 0 */
      ...
      */
      ...
      IF LAST-OF(t-prove) THEN DO:
        ...
        DISPLAY STREAM REPORT 
            ("TOTAL PROVEEDOR : " + t-prove) @ t-desmat
            (ACCUM SUB-TOTAL BY t-prove t-Marge[1]) @ t-Marge[1] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[2]) @ t-Marge[2] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[3]) @ t-Marge[3] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[4]) @ t-Marge[4] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[5]) @ t-Marge[5] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[6]) @ t-Marge[6] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[7]) @ t-Marge[7] 
            (ACCUM SUB-TOTAL BY t-prove t-Marge[10]) @ t-Marge[10] 
            WITH FRAME F-REPORTE.
      END.
  ...
  FOR EACH tmp-tempo   /* WHERE t-Marge[10] <> 0 */
      ...
      */
      ...
      IF LAST-OF(t-SubFam) THEN DO:
        ...
        DISPLAY STREAM REPORT 
            ("TOTAL SUB-FAMILIA: " + t-subfam) @ t-desmat
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[1]) @ t-Marge[1] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[2]) @ t-Marge[2] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[3]) @ t-Marge[3] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[4]) @ t-Marge[4] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[5]) @ t-Marge[5] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[6]) @ t-Marge[6] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[7]) @ t-Marge[7] 
            (ACCUM SUB-TOTAL BY t-subfam t-Marge[10]) @ t-Marge[10] 
            WITH FRAME F-REPORTE.
