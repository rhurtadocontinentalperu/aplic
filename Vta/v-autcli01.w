...
gn-clie.CndVta gn-clie.clfCli gn-clie.ClfCli2 gn-clie.ClfCom 
...
DEFINE FRAME F-Main
     ...
     gn-clie.clfCli AT ROW 12.85 COL 36 COLON-ALIGNED
          LABEL "Clasificacion Productos Propios"
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     f-ClfCli AT ROW 12.85 COL 42 COLON-ALIGNED NO-LABEL
     gn-clie.ClfCli2 AT ROW 13.65 COL 38 NO-LABEL WIDGET-ID 12
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "A++", "A++":U,
"A+", "A+":U,
...
"Sin clasificación", ""
          SIZE 36 BY .81
     gn-clie.ClfCom AT ROW 14.46 COL 38 NO-LABEL WIDGET-ID 20
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "A", "A":U,
"B", "B":U,
...
"Sin clasificación", " ":U
     ...
     "Clasificación o Segmentación:" VIEW-AS TEXT
          SIZE 21 BY .5 AT ROW 14.73 COL 17 WIDGET-ID 26
     "Clasificación Productos de Terceros:" VIEW-AS TEXT
          SIZE 25 BY .5 AT ROW 13.92 COL 13 WIDGET-ID 18
