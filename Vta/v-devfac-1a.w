...
&Scoped-Define ENABLED-FIELDS Almcmov.Libre_c01 Almcmov.CodRef ~
Almcmov.NroRf1 Almcmov.CodCli Almcmov.Observ 
...
Almcmov.NroDoc Almcmov.Libre_c01 Almcmov.CodRef Almcmov.NroRf1 ~
Almcmov.CodCli Almcmov.CodMon Almcmov.Observ 
...
DEFINE FRAME F-Main
     Almcmov.NroRf2 AT ROW 1.19 COL 12 COLON-ALIGNED
          LABEL "Devolucion No" FORMAT "XXX-XXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12.29 BY .69
          FONT 1
     FILL-IN-Estado AT ROW 1.19 COL 27 COLON-ALIGNED NO-LABEL
     Almcmov.FchDoc AT ROW 1.19 COL 71 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
     Almcmov.NroDoc AT ROW 1.96 COL 12 COLON-ALIGNED
          LABEL "No. Ingreso"
          VIEW-AS FILL-IN 
          SIZE 10 BY .69
          FONT 0
     Almcmov.Libre_c01 AT ROW 2.73 COL 12 COLON-ALIGNED WIDGET-ID 4
          LABEL "Código de Barra" FORMAT "x(14)"
          VIEW-AS FILL-IN 
          SIZE 14 BY .69
     Almcmov.CodRef AT ROW 3.5 COL 5.71
          LABEL "Referencia"
          VIEW-AS COMBO-BOX INNER-LINES 3
          LIST-ITEMS "FAC","BOL","TCK" 
          DROP-DOWN-LIST
          SIZE 7.86 BY 1
     Almcmov.NroRf1 AT ROW 3.5 COL 20.14 COLON-ALIGNED NO-LABEL FORMAT "x(12)"
          VIEW-AS FILL-IN 
          SIZE 13.86 BY .69
          FONT 0
     Almcmov.CodCli AT ROW 4.46 COL 12 COLON-ALIGNED FORMAT "x(11)"
          VIEW-AS FILL-IN 
          SIZE 11 BY .69
     FILL-IN_NomCli AT ROW 4.46 COL 23 COLON-ALIGNED NO-LABEL
     FILL-IN_RucCli AT ROW 4.46 COL 71 COLON-ALIGNED
     FILL-IN_DirCli AT ROW 5.23 COL 12 COLON-ALIGNED
     Almcmov.CodMon AT ROW 5.38 COL 73.14 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "S/.", 1,
"US$", 2
          SIZE 11.43 BY .58
     Almcmov.Observ AT ROW 6 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 49.29 BY .69
     FILL-IN-MotDev AT ROW 6.77 COL 12 COLON-ALIGNED WIDGET-ID 2
     "Moneda" VIEW-AS TEXT
          SIZE 6.14 BY .58 AT ROW 5.42 COL 66.14
     RECT-21 AT ROW 5.27 COL 72.57
...
ON LEAVE OF Almcmov.Libre_c01 IN FRAME F-Main /* Código de Barra */
DO:
    IF SELF:SCREEN-VALUE = "" THEN RETURN.
    ...
    CASE SUBSTRING(SELF:SCREEN-VALUE,1,1):
      WHEN '1' THEN DO:           /* FACTURA */
          ASSIGN
              ...
              Almcmov.NroRf1:SCREEN-VALUE = SUBSTRING(SELF:SCREEN-VALUE,2,3) +
                                            SUBSTRING(SELF:SCREEN-VALUE,6,6).
      END.
      WHEN '9' THEN DO:           /* G/R */
          ASSIGN
              Almcmov.CodRef:SCREEN-VALUE = "G/R"
              Almcmov.NroRf1:SCREEN-VALUE = SUBSTRING(SELF:SCREEN-VALUE,2,3) +
                                            SUBSTRING(SELF:SCREEN-VALUE,6,6).
      END.
      WHEN '3' THEN DO:           /* BOL */
          ASSIGN
              Almcmov.CodRef:SCREEN-VALUE = "BOL"
              Almcmov.NroRf1:SCREEN-VALUE = SUBSTRING(SELF:SCREEN-VALUE,2,3) +
                                            SUBSTRING(SELF:SCREEN-VALUE,6,6).
      END.
    END CASE.
    ...
    IF AVAILABLE Ccbcdocu THEN
        ASSIGN
        Almcmov.codcli:SCREEN-VALUE = Ccbcdocu.codcli
        FILL-IN_DirCli:SCREEN-VALUE = Ccbcdocu.dircli
        FILL-IN_NomCli:SCREEN-VALUE = Ccbcdocu.nomcli
        FILL-IN_RucCli:SCREEN-VALUE = Ccbcdocu.ruccli
        Almcmov.CodRef:SENSITIVE = NO
        Almcmov.NroRf1:SENSITIVE = NO.
    APPLY "LEAVE" TO Almcmov.NroRf1.
END.
