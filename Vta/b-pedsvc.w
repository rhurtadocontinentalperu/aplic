...
&Scoped-define INTERNAL-TABLES FacDPedi almmserv
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.UndVta COLUMN-LABEL "Unid." FORMAT "x(8)":U
      FacDPedi.PreUni FORMAT ">,>>>,>>9.999999":U
      FacCPedi.PorDto FORMAT ">>9.99":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.FacDPedi OF INTEGRAL.FacCPedi,INTEGRAL.almmserv OF INTEGRAL.FacDPedi"
...
"FacDPedi.UndVta" "Unid." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = INTEGRAL.FacDPedi.PreUni
     _FldNameList[7]   = INTEGRAL.FacCPedi.PorDto
