...
&Scoped-Define ENABLED-OBJECTS TOGGLE-CodCli BUTTON-5 TOGGLE-CodMat ~
BUTTON-6 TOGGLE-CodPro TOGGLE-CodVen TOGGLE-FmaPgo TOGGLE-NroCard DesdeF ~
HastaF RADIO-SET-Tipo BUTTON-1 BtnDone 
...
DEFINE VARIABLE COMBO-BOX-CodDiv AS CHARACTER FORMAT "X(256)":U INITIAL "00023 - Utilex (Surquillo)" 
     LABEL "Division" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "00023 - Utilex (Surquillo)" 
     DROP-DOWN-LIST
     SIZE 70 BY .92 NO-UNDO.
...
DEFINE VARIABLE TOGGLE-CodDiv AS LOGICAL INITIAL yes 
     LABEL "Division" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.29 BY .77 NO-UNDO.
...
/* SETTINGS FOR FILL-IN FILL-IN-NroCard IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX TOGGLE-CodDiv IN FRAME F-Main
   NO-ENABLE                                                            */
...
IF (TOGGLE-CodMat AND TOGGLE-CodVen) = YES 
    AND (TOGGLE-CodDiv OR 
         ...
         TOGGLE-FmaPgo OR 
         TOGGLE-NroCard) = NO THEN DO:
    /*RDP-01 *** RUN Carga-Articulos-Vendedores.***/
...
IF (TOGGLE-CodMat AND TOGGLE-CodVen AND TOGGLE-CodDiv) = YES 
    AND (TOGGLE-CodPro OR 
         ...
         TOGGLE-FmaPgo OR 
         TOGGLE-NroCard) = NO THEN DO:
    /*RD01 - ***RUN Carga-Articulos-Vendedores.**/
    RUN Carga-Articulos-Vendedores2.
    RETURN.
END.
IF (TOGGLE-CodCli AND TOGGLE-CodVen) = YES 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE TOGGLE-CodCli BUTTON-5 TOGGLE-CodMat BUTTON-6 TOGGLE-CodPro 
         TOGGLE-CodVen TOGGLE-FmaPgo TOGGLE-NroCard DesdeF HastaF 
