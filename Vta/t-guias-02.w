...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI.CanPed COLUMN-LABEL "Cantidad Pedida" FORMAT ">,>>>,>>9.9999":U
      PEDI.canate COLUMN-LABEL "Cantidad Atendida" FORMAT ">,>>>,>>9.9999":U
  ENABLE
      PEDI.canate
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"PEDI.CanPed" "Cantidad Pedida" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.PEDI.canate
"PEDI.canate" "Cantidad Atendida" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
