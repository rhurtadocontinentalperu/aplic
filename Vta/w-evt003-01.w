...
FOR EACH estavtas.EvtProvArti NO-LOCK WHERE estavtas.EvtProvArti.codcia = s-codcia
    AND estavtas.EvtProvArti.nrofch >= x-NroFchR
    AND estavtas.EvtProvArti.nrofch <= x-NroFchE
    ...
    /*********************** Calculo Para Obtener los datos diarios ************/
     DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
          ...
          /* PERIODO ACTUAL */
          IF X-FECHA >= DesdeF AND X-FECHA <= HastaF THEN DO:
              F-Salida[1]  = F-Salida[1]  + estavtas.EvtProvArti.CanxDia[I].
              T-Vtamn[1]   = T-Vtamn[1]   + estavtas.EvtProvArti.Vtaxdiamn[I].
              T-Vtame[1]   = T-Vtame[1]   + estavtas.EvtProvArti.Vtaxdiame[I].
              T-Ctomn[1]   = T-Ctomn[1]   + estavtas.EvtProvArti.Ctoxdiamn[I].
              T-Ctome[1]   = T-Ctome[1]   + estavtas.EvtProvArti.Ctoxdiame[I].
              T-Promn[1]   = T-Promn[1]   + estavtas.EvtProvArti.Proxdiamn[I].
              T-Prome[1]   = T-Prome[1]   + estavtas.EvtProvArti.Proxdiame[I].
          END.
          /* ACUMULADO PERIODO ACTUAL */
          IF X-FECHA >= DATE(01,01,YEAR(DesdeF)) AND X-FECHA <= HastaF THEN DO:
              F-Salida[2]  = F-Salida[2]  + estavtas.EvtProvArti.CanxDia[I].
              T-Vtamn[2]   = T-Vtamn[2]   + estavtas.EvtProvArti.Vtaxdiamn[I].
              T-Vtame[2]   = T-Vtame[2]   + estavtas.EvtProvArti.Vtaxdiame[I].
              T-Ctomn[2]   = T-Ctomn[2]   + estavtas.EvtProvArti.Ctoxdiamn[I].
              T-Ctome[2]   = T-Ctome[2]   + estavtas.EvtProvArti.Ctoxdiame[I].
              T-Promn[2]   = T-Promn[2]   + estavtas.EvtProvArti.Proxdiamn[I].
              T-Prome[2]   = T-Prome[2]   + estavtas.EvtProvArti.Proxdiame[I].
          END.
          /* PERIODO ANTERIOR */
          IF X-FECHA >= DATE(MONTH(DesdeF),DAY(DesdeF),YEAR(DesdeF) - 1) AND X-FECHA <= DATE(MONTH(HastaF),DAY(HastaF),YEAR(HastaF) - 1) THEN DO:
              F-Salida[3]  = F-Salida[3]  + estavtas.EvtProvArti.CanxDia[I].
              T-Vtamn[3]   = T-Vtamn[3]   + estavtas.EvtProvArti.Vtaxdiamn[I].
              T-Vtame[3]   = T-Vtame[3]   + estavtas.EvtProvArti.Vtaxdiame[I].
              T-Ctomn[3]   = T-Ctomn[3]   + estavtas.EvtProvArti.Ctoxdiamn[I].
              T-Ctome[3]   = T-Ctome[3]   + estavtas.EvtProvArti.Ctoxdiame[I].
              T-Promn[3]   = T-Promn[3]   + estavtas.EvtProvArti.Proxdiamn[I].
              T-Prome[3]   = T-Prome[3]   + estavtas.EvtProvArti.Proxdiame[I].
          END.
          /* ACUMULADO PERIODO ANTERIOR */
          IF X-FECHA >= DATE(01,01,YEAR(DesdeF) - 1) AND X-FECHA <= DATE(MONTH(HastaF),DAY(HastaF),YEAR(HastaF) - 1) THEN DO:
              F-Salida[4]  = F-Salida[4]  + estavtas.EvtProvArti.CanxDia[I].
              T-Vtamn[4]   = T-Vtamn[4]   + estavtas.EvtProvArti.Vtaxdiamn[I].
              T-Vtame[4]   = T-Vtame[4]   + estavtas.EvtProvArti.Vtaxdiame[I].
              T-Ctomn[4]   = T-Ctomn[4]   + estavtas.EvtProvArti.Ctoxdiamn[I].
              T-Ctome[4]   = T-Ctome[4]   + estavtas.EvtProvArti.Ctoxdiame[I].
              T-Promn[4]   = T-Promn[4]   + estavtas.EvtProvArti.Proxdiamn[I].
              T-Prome[4]   = T-Prome[4]   + estavtas.EvtProvArti.Proxdiame[I].
          END.
     END.     
     /* FILTRO DE CANTIDADES */
     IF F-Salida[1] = 0 AND F-Salida[2] = 0 AND F-Salida[3] = 0 AND F-Salida[4] = 0
...
FOR EACH estavtas.evtall04 NO-LOCK WHERE estavtas.evtall04.codcia = s-codcia
    AND estavtas.evtall04.nrofch >= x-NroFchR
    AND estavtas.evtall04.nrofch <= x-NroFchE
    ...
    /*********************** Calculo Para Obtener los datos diarios ************/
     DO I = 1 TO DAY( DATE(STRING(X-CODDIA,"99") + "/" + STRING(X-CODMES,"99") + "/" + STRING(X-CODANO,"9999")) - 1 ) :        
          ...
          /* PERIODO ACTUAL */
          IF X-FECHA >= DesdeF AND X-FECHA <= HastaF THEN DO:
              F-Salida[1]  = F-Salida[1]  + estavtas.evtall04.CanxDia[I].
              T-Vtamn[1]   = T-Vtamn[1]   + estavtas.evtall04.Vtaxdiamn[I].
              T-Vtame[1]   = T-Vtame[1]   + estavtas.evtall04.Vtaxdiame[I].
              T-Ctomn[1]   = T-Ctomn[1]   + estavtas.evtall04.Ctoxdiamn[I].
              T-Ctome[1]   = T-Ctome[1]   + estavtas.evtall04.Ctoxdiame[I].
              T-Promn[1]   = T-Promn[1]   + estavtas.evtall04.Proxdiamn[I].
              T-Prome[1]   = T-Prome[1]   + estavtas.evtall04.Proxdiame[I].
          END.
          /* ACUMULADO PERIODO ACTUAL */
          IF X-FECHA >= DATE(01,01,YEAR(DesdeF)) AND X-FECHA <= HastaF THEN DO:
              F-Salida[2]  = F-Salida[2]  + estavtas.evtall04.CanxDia[I].
              T-Vtamn[2]   = T-Vtamn[2]   + estavtas.evtall04.Vtaxdiamn[I].
              T-Vtame[2]   = T-Vtame[2]   + estavtas.evtall04.Vtaxdiame[I].
              T-Ctomn[2]   = T-Ctomn[2]   + estavtas.evtall04.Ctoxdiamn[I].
              T-Ctome[2]   = T-Ctome[2]   + estavtas.evtall04.Ctoxdiame[I].
              T-Promn[2]   = T-Promn[2]   + estavtas.evtall04.Proxdiamn[I].
              T-Prome[2]   = T-Prome[2]   + estavtas.evtall04.Proxdiame[I].
          END.
          /* PERIODO ANTERIOR */
          IF X-FECHA >= DATE(MONTH(DesdeF),DAY(DesdeF),YEAR(DesdeF) - 1) AND X-FECHA <= DATE(MONTH(HastaF),DAY(HastaF),YEAR(HastaF) - 1) THEN DO:
              F-Salida[3]  = F-Salida[3]  + estavtas.evtall04.CanxDia[I].
              T-Vtamn[3]   = T-Vtamn[3]   + estavtas.evtall04.Vtaxdiamn[I].
              T-Vtame[3]   = T-Vtame[3]   + estavtas.evtall04.Vtaxdiame[I].
              T-Ctomn[3]   = T-Ctomn[3]   + estavtas.evtall04.Ctoxdiamn[I].
              T-Ctome[3]   = T-Ctome[3]   + estavtas.evtall04.Ctoxdiame[I].
              T-Promn[3]   = T-Promn[3]   + estavtas.evtall04.Proxdiamn[I].
              T-Prome[3]   = T-Prome[3]   + estavtas.evtall04.Proxdiame[I].
          END.
          /* ACUMULADO PERIODO ANTERIOR */
          IF X-FECHA >= DATE(01,01,YEAR(DesdeF) - 1) AND X-FECHA <= DATE(MONTH(HastaF),DAY(HastaF),YEAR(HastaF) - 1) THEN DO:
              F-Salida[4]  = F-Salida[4]  + estavtas.evtall04.CanxDia[I].
              T-Vtamn[4]   = T-Vtamn[4]   + estavtas.evtall04.Vtaxdiamn[I].
              T-Vtame[4]   = T-Vtame[4]   + estavtas.evtall04.Vtaxdiame[I].
              T-Ctomn[4]   = T-Ctomn[4]   + estavtas.evtall04.Ctoxdiamn[I].
              T-Ctome[4]   = T-Ctome[4]   + estavtas.evtall04.Ctoxdiame[I].
              T-Promn[4]   = T-Promn[4]   + estavtas.evtall04.Proxdiamn[I].
              T-Prome[4]   = T-Prome[4]   + estavtas.evtall04.Proxdiame[I].
          END.
     END.     
     /* FILTRO DE CANTIDADES */
     IF F-Salida[1] = 0 AND F-Salida[2] = 0 AND F-Salida[3] = 0 AND F-Salida[4] = 0
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Rutina-General W-Win 
