...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES DETA
&Scoped-define FIRST-EXTERNAL-TABLE DETA


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR DETA.
/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES T-GLOSA

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH T-GLOSA OF DETA WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main T-GLOSA
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main T-GLOSA
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: Temp-Tables.DETA
   Allow: Basic,Query
   Frames: 1
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "Temp-Tables.T-GLOSA OF Temp-Tables.DETA"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "DETA"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "DETA"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "T-GLOSA"}
