...
&Scoped-define INTERNAL-TABLES Vtacomprov

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Vtacomprov WHERE ~{&KEY-PHRASE} ~
      AND Vtacomprov.Codcia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Vtacomprov WHERE ~{&KEY-PHRASE} ~
      AND Vtacomprov.Codcia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Vtacomprov
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Vtacomprov
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.Vtacomprov"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "Vtacomprov.Codcia = s-codcia"
     _Design-Parent    is WINDOW q-tables @ ( 1.27 , 9.72 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
