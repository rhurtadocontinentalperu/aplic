...
&Scoped-Define ENABLED-OBJECTS RADIO-SET-FileType RADIO-SET-Grid ~
RADIO-SET-Labels RADIO-SET-ExcelVisible Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS RADIO-SET-FileType RADIO-SET-Grid ~
RADIO-SET-Labels RADIO-SET-ExcelVisible 
...
DEFINE VARIABLE RADIO-SET-ExcelVisible AS CHARACTER INITIAL "yes" 
...
"SYLK", "SLK",
"XML", "XML"
     SIZE 10 BY 4.04 NO-UNDO.

DEFINE VARIABLE RADIO-SET-Grid AS CHARACTER INITIAL "No" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "No", "No",
"Horizontal", "hor",
...
DEFINE FRAME gDialog
     ...
     RADIO-SET-ExcelVisible AT ROW 5.85 COL 57 NO-LABEL WIDGET-ID 24
     ...
     "Visible:" VIEW-AS TEXT
          SIZE 7 BY .62 AT ROW 5.85 COL 50 WIDGET-ID 28
     "Opciones solo para formato XLS" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 5.04 COL 45 WIDGET-ID 30
          BGCOLOR 1 FGCOLOR 15 
     "Etiquetas:" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 3.42 COL 48 WIDGET-ID 36
     SPACE(44.13) SKIP(4.95)
...
DO:
  ASSIGN
       RADIO-SET-ExcelVisible RADIO-SET-FileType RADIO-SET-Grid RADIO-SET-Labels.
  pOptions = "FileType:" + TRIM(RADIO-SET-FileType) + CHR(1) + ~
            "Grid:" + TRIM(RADIO-SET-Grid) + CHR(1) + ~ 
            "Labels:" + TRIM(RADIO-SET-Labels) + CHR(1) + ~
            "ExcelVisible:" + TRIM(RADIO-SET-ExcelVisible).
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-FileType RADIO-SET-Grid RADIO-SET-Labels 
          RADIO-SET-ExcelVisible 
      WITH FRAME gDialog.
  ENABLE RADIO-SET-FileType RADIO-SET-Grid RADIO-SET-Labels 
         RADIO-SET-ExcelVisible Btn_OK Btn_Cancel 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
