...
&Scoped-define FIELDS-IN-QUERY-br_table VtaCRecl.CodDoc VtaCRecl.NroDoc ~
VtaCRecl.CodCli VtaCRecl.codref VtaCRecl.NroRef VtaCRecl.FchCie ~
VtaCRecl.FchRcl VtaCRecl.HorRcl 
...
FILL-IN-NomCli br_table RADIO-SET-Estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VtaCRecl.CodDoc FORMAT "x(3)":U
      VtaCRecl.NroDoc FORMAT "x(9)":U
      VtaCRecl.CodCli FORMAT "x(11)":U
      VtaCRecl.codref COLUMN-LABEL "Doc" FORMAT "x(3)":U
      VtaCRecl.NroRef FORMAT "X(9)":U
      VtaCRecl.FchCie FORMAT "99/99/99":U
      VtaCRecl.FchRcl COLUMN-LABEL "Fch Reclamo" FORMAT "99/99/99":U
      VtaCRecl.HorRcl COLUMN-LABEL "Hora Reclamo" FORMAT "x(5)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75 BY 8.08
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     RADIO-SET-Estado AT ROW 4.23 COL 79 NO-LABEL WIDGET-ID 8
...
/* Query rebuild information for BROWSE br_table
 ...
 AND VtaCRecl.FlgEst BEGINS RADIO-SET-Estado"
     _FldNameList[1]   = INTEGRAL.VtaCRecl.CodDoc
     _FldNameList[2]   = INTEGRAL.VtaCRecl.NroDoc
     _FldNameList[3]   = INTEGRAL.VtaCRecl.CodCli
     _FldNameList[4]   > INTEGRAL.VtaCRecl.codref
"codref" "Doc" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = INTEGRAL.VtaCRecl.NroRef
     _FldNameList[6]   = INTEGRAL.VtaCRecl.FchCie
