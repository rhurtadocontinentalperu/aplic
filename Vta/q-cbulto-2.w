...
&Scoped-define QUERY-STRING-Query-Main FOR EACH CcbCDocu WHERE CcbCDocu.CodCia = CcbCBult.CodCia ~
  AND CcbCDocu.CodDiv = CcbCBult.CodDiv ~
  AND CcbCDocu.CodDoc = CcbCBult.CodDoc ~
  AND CcbCDocu.NroDoc = CcbCBult.NroDoc NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCDocu WHERE CcbCDocu.CodCia = CcbCBult.CodCia ~
  AND CcbCDocu.CodDiv = CcbCBult.CodDiv ~
  AND CcbCDocu.CodDoc = CcbCBult.CodDoc ~
  AND CcbCDocu.NroDoc = CcbCBult.NroDoc NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.CcbCDocu WHERE INTEGRAL.CcbCBult ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "INTEGRAL.CcbCDocu.CodCia = INTEGRAL.CcbCBult.CodCia
  AND INTEGRAL.CcbCDocu.CodDiv = INTEGRAL.CcbCBult.CodDiv
  AND INTEGRAL.CcbCDocu.CodDoc = INTEGRAL.CcbCBult.CodDoc
  AND INTEGRAL.CcbCDocu.NroDoc = INTEGRAL.CcbCBult.NroDoc"
