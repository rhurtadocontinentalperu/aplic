...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 62 BY 8.35
         FONT 4
         TITLE "GUIAS PENDIENTES POR CHEQUEAR" ROW-HEIGHT-CHARS .31.
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* GUIAS PENDIENTES POR CHEQUEAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* GUIAS PENDIENTES POR CHEQUEAR */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* GUIAS PENDIENTES POR CHEQUEAR */
DO:
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  MESSAGE 'Procedemos a APROBAR EL REQUERIMIENTO DE COMPRA' STRING(LG-CREQU.NroReq, '999999') '?'
  ...
  ASSIGN
    LG-CREQU.flgsit       = 'A'
    LG-CREQU.FchApro      = TODAY
    LG-CREQU.Userid-aprob = S-USER-ID
    LG-CREQU.HorAte       = STRING(TIME, "HH:MM").
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    MESSAGE 'Procedemos a RECHAZAR EL REQUERIMIENTO DE COMPRA' STRING(LG-CREQU.NroReq, '999999') '?'
