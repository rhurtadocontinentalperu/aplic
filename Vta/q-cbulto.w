...
&Scoped-define QUERY-STRING-Query-Main FOR EACH CcbCBult WHERE ~{&KEY-PHRASE} ~
      AND CcbCBult.CodCia = s-codcia ~
 AND CcbCBult.CodDiv = s-coddiv ~
 AND CcbCBult.CodDoc = s-coddoc NO-LOCK ~
    BY CcbCBult.NroDoc DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH CcbCBult WHERE ~{&KEY-PHRASE} ~
      AND CcbCBult.CodCia = s-codcia ~
 AND CcbCBult.CodDiv = s-coddiv ~
 AND CcbCBult.CodDoc = s-coddoc NO-LOCK ~
    BY CcbCBult.NroDoc DESCENDING.
&Scoped-define TABLES-IN-QUERY-Query-Main CcbCBult
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main CcbCBult
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-cbulto ("Guias de Remision").
