...
DEFINE VARIABLE h_b-chqgui AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CHEQUEO DE GUIAS DE REMISION"
         HEIGHT             = 14.81
         WIDTH              = 97.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 116.86
...
ON END-ERROR OF W-Win /* CHEQUEO DE GUIAS DE REMISION */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CHEQUEO DE GUIAS DE REMISION */
DO:
...
DO:
  RUN Cierre-de-guia IN h_b-chqgui.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-chqgui.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-chqgui ).
       RUN set-position IN h_b-chqgui ( 2.54 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-chqgui ( 12.96 , 95.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-chqgui. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_b-chqgui ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-chqgui ,
