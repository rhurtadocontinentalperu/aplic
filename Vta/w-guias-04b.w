...
&Scoped-Define ENABLED-OBJECTS RECT-20 COMBO-NroSer BUTTON-11 BUTTON-delete ~
...
DEFINE VARIABLE h_v-guias-04b AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     COMBO-NroSer AT ROW 8.42 COL 5 NO-LABEL
     BUTTON-11 AT ROW 8.5 COL 73 WIDGET-ID 6
     BUTTON-delete AT ROW 8.54 COL 46 WIDGET-ID 2
     BUTTON-Print AT ROW 8.54 COL 54
     BUTTON-Exit AT ROW 8.54 COL 62 WIDGET-ID 4
     RECT-20 AT ROW 8.27 COL 44
...
DO:
  RUN Asigna-Transportista IN h_v-guias-04b.
END.
...
DO:
    RUN dispatch IN h_v-guias-04b ('delete-record':U).
END.
...
DO:
    RUN dispatch IN h_v-guias-04b ('imprime':U).
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/v-guias-04b.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-guias-04b ).
       RUN set-position IN h_v-guias-04b ( 1.15 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 7.00 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 8.27 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-guias ).
       RUN set-position IN h_b-guias ( 9.62 , 5.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-guias ).
       RUN set-position IN h_q-guias ( 8.35 , 12.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.04 , 8.29 ) */

       /* Links to SmartViewer h_v-guias-04b. */
       RUN add-link IN adm-broker-hdl ( h_q-guias , 'Record':U , h_v-guias-04b ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-guias-04b ,
             COMBO-NroSer:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-guias-04b , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-20 COMBO-NroSer BUTTON-11 BUTTON-delete BUTTON-Print BUTTON-Exit 
      WITH FRAME F-Main IN WINDOW W-Win.
