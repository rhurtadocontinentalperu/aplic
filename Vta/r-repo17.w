...
DEFINE VARIABLE h_b-repo17 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1.54 COL 84 WIDGET-ID 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REPORTE DE PEDIDOS CONSOLIDADOS vs STOCKS"
         HEIGHT             = 19.46
         WIDTH              = 95.57
         MAX-HEIGHT         = 19.46
         MAX-WIDTH          = 95.57
...
ON END-ERROR OF W-Win /* REPORTE DE PEDIDOS CONSOLIDADOS vs STOCKS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REPORTE DE PEDIDOS CONSOLIDADOS vs STOCKS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-repo17.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-repo17 ).
       RUN set-position IN h_b-repo17 ( 1.19 , 2.14 ) NO-ERROR.
       RUN set-size IN h_b-repo17 ( 18.81 , 90.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv10 ).
       RUN set-position IN h_p-updv10 ( 3.42 , 2.14 ) NO-ERROR.
       RUN set-size IN h_p-updv10 ( 1.42 , 41.72 ) NO-ERROR.

       /* Links to SmartBrowser h_b-repo17. */
       RUN add-link IN adm-broker-hdl ( h_p-updv10 , 'TableIO':U , h_b-repo17 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-repo17 ,
