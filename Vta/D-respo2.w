...
&Scoped-Define ENABLED-OBJECTS f-clien f-vende f-desde f-hasta RADIO-SET-1 ~
B-impresoras RB-NUMBER-COPIES RB-BEGIN-PAGE Btn_OK RB-END-PAGE Btn_Cancel ~
Btn_Help RECT-41 RECT-43 RECT-5 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-3 f-clien f-vende f-desde f-hasta ~
...
DEFINE FRAME D-Dialog
     ...
     f-clien AT ROW 1.35 COL 21.29 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-3 f-clien f-vende f-desde f-hasta RADIO-SET-1 f-nomcli 
          f-nomven RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME D-Dialog.
  ENABLE f-clien f-vende f-desde f-hasta RADIO-SET-1 B-impresoras 
