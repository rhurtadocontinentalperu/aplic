...
&Scoped-Define ENABLED-OBJECTS F-CODMAT F-CANPED Btn_OK Btn_Cancel 
...
DEFINE VARIABLE F-CANPED AS DECIMAL FORMAT ">>>,>>9":U INITIAL 0 
     LABEL "Cantidad" 
     VIEW-AS FILL-IN 
     SIZE 12.86 BY .69 NO-UNDO.

DEFINE VARIABLE F-CODMAT AS CHARACTER FORMAT "X(13)":U 
     LABEL "Articulo" 
     VIEW-AS FILL-IN 
     SIZE 12.86 BY .69 NO-UNDO.
...
DEFINE FRAME D-Dialog
     F-CODMAT AT ROW 1.15 COL 3.28
     F-CANPED AT ROW 1.92 COL 2.28
     Btn_OK AT ROW 1.15 COL 43.72
     Btn_Cancel AT ROW 2.35 COL 43.72
     SPACE(0.56) SKIP(0.02)
...
------------------------------------------------------------------------------*/
  DISPLAY F-CODMAT F-CANPED 
      WITH FRAME D-Dialog.
  ENABLE F-CODMAT F-CANPED Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
