...
&Scoped-Define ENABLED-OBJECTS RECT-70 RECT-71 x-CodDiv f-clien f-vende ~
f-hasta f-desde BUTTON-3 BUTTON-4 
&Scoped-Define DISPLAYED-OBJECTS x-CodDiv f-clien f-nomcli f-vende f-nomven ~
f-hasta f-desde txt-msj 
...
DEFINE FRAME F-Main
     ...
     f-vende AT ROW 3.42 COL 9 COLON-ALIGNED WIDGET-ID 14
     f-nomven AT ROW 3.42 COL 13.86 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     f-hasta AT ROW 5.31 COL 29 COLON-ALIGNED WIDGET-ID 8
     f-desde AT ROW 5.42 COL 9 COLON-ALIGNED WIDGET-ID 6
     txt-msj AT ROW 7.46 COL 3 NO-LABEL WIDGET-ID 30
     BUTTON-3 AT ROW 8.58 COL 41 WIDGET-ID 24
     BUTTON-4 AT ROW 8.58 COL 56 WIDGET-ID 26
     "Rango de Fechas :" VIEW-AS TEXT
          SIZE 17.14 BY .62 AT ROW 4.5 COL 11 WIDGET-ID 16
          FONT 6
     RECT-70 AT ROW 1.23 COL 1.57 WIDGET-ID 20
     RECT-71 AT ROW 8.54 COL 1.57 WIDGET-ID 28
...
------------------------------------------------------------------------------*/
 ...
 DEFINE VARIABLE X-SIT  AS CHARACTER NO-UNDO.  
 DEFINE VARIABLE DesAlm AS CHARACTER   NO-UNDO.
 ...
 FOR EACH CcbcDocu NO-LOCK WHERE
     ...
     ASSIGN
         ...
         tmp-Ccbcdocu.ImpVta = CcbcDocu.ImpVta   
         tmp-Ccbcdocu.ImpDto = CcbcDocu.ImpDto   
         tmp-Ccbcdocu.ImpBrt = CcbcDocu.ImpBrt   
         tmp-Ccbcdocu.ImpIgv = CcbcDocu.ImpIgv   
         tmp-Ccbcdocu.ImpTot = CcbcDocu.ImpTot   
         tmp-Ccbcdocu.FlgEst = X-EST. 
 END.

 FOR EACH Almacen WHERE Almacen.CodCia = s-CodCia
     AND Almacen.CodDiv = x-CodDiv NO-LOCK:
     FOR EACH AlmcMov WHERE AlmcMov.CodCia = Almacen.CodCia
          ...
          ASSIGN
              ...
              tmp-Ccbcdocu.CodMon = X-MON             
              tmp-Ccbcdocu.ImpVta = 0
              tmp-Ccbcdocu.ImpDto = 0
              tmp-Ccbcdocu.ImpBrt = 0
              tmp-Ccbcdocu.ImpIgv = 0
              tmp-Ccbcdocu.ImpTot = 0
              tmp-Ccbcdocu.FlgEst = X-EST
...
------------------------------------------------------------------------------*/
  DISPLAY x-CodDiv f-clien f-nomcli f-vende f-nomven f-hasta f-desde txt-msj 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-70 RECT-71 x-CodDiv f-clien f-vende f-hasta f-desde BUTTON-3 
         BUTTON-4 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
 DEFINE FRAME f-cab
        ...
        tmp-CcbcDocu.ImpBrt FORMAT "->,>>>,>>9.99"             
        tmp-CcbcDocu.ImpDto FORMAT "->,>>9.99"                 
        tmp-CcbcDocu.ImpVta FORMAT "->,>>>,>>9.99"             
        tmp-CcbcDocu.ImpIgv FORMAT "->,>>9.99"                 
        tmp-CcbcDocu.ImpTot FORMAT "->,>>>,>>9.99"             
        ...
        "   GUIA     EMISION   C L I E N T E                   R.U.C.  VEND MON.    BRUTO        DSCTO.      VENTA      I.G.V.     V E N T A   EST    SIT           " SKIP
        "-----------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
