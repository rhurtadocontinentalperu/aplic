...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 9.31 COL 42.86 WIDGET-ID 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pedsvc ).
       RUN set-position IN h_v-pedsvc ( 2.65 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 97.29 ) */
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 9.19 , 2.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_t-pedsvc ).
       RUN set-position IN h_t-pedsvc ( 10.54 , 2.43 ) NO-ERROR.
