...
DEFINE VARIABLE h_b-cfgtarjcred AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 103.57 BY 9 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "CONFIGURACION DE TARJETAS DE CREDITO"
         HEIGHT             = 9
         WIDTH              = 103.57
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 105.14
...
ON END-ERROR OF W-Win /* CONFIGURACION DE TARJETAS DE CREDITO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* CONFIGURACION DE TARJETAS DE CREDITO */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta/b-cfgtarjcred.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cfgtarjcred ).
       RUN set-position IN h_b-cfgtarjcred ( 1.38 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-cfgtarjcred ( 8.08 , 101.00 ) NO-ERROR.
