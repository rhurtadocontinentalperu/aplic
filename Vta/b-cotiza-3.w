...
f-StockCal() @ dStkAct FacDPedi.PorDto FacDPedi.PreUni FacDPedi.ImpLin 
...
&Scoped-Define DISPLAYED-OBJECTS F-PorDes F-ValVta F-ImpExo F-ImpIsc ~
F-ImpIgv F-ImpTot F-TotBrt F-ImpDes f-PesMat 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      f-StockCal() @ dStkAct COLUMN-LABEL "Stock" FORMAT ">,>>>,>>>.99":U
      FacDPedi.PorDto FORMAT ">>9.99":U
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">>,>>>.9999":U
      FacDPedi.ImpLin FORMAT ">,>>>,>>9.99":U WIDTH 7.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 105 BY 7.54
         BGCOLOR 15 FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-PorDes AT ROW 8.69 COL 25.86 COLON-ALIGNED
     F-ValVta AT ROW 9.81 COL 46 COLON-ALIGNED NO-LABEL
     ...
     F-ImpDes AT ROW 10.12 COL 32 COLON-ALIGNED NO-LABEL
     ...
     "T.Descuento" VIEW-AS TEXT
          SIZE 9.43 BY .5 AT ROW 9.62 COL 34.43
...
"f-StockCal() @ dStkAct" "Stock" ">,>>>,>>>.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
