...
FacDPedi.PorDto FacDPedi.PreUni FacDPedi.ImpLin 
...
&Scoped-Define ENABLED-OBJECTS br_table RECT-23 
&Scoped-Define DISPLAYED-OBJECTS F-TotBrt F-ImpExo F-ImpDes F-PorDes ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacDPedi.PorDto
      FacDPedi.PreUni COLUMN-LABEL "Precio!Unitario" FORMAT ">,>>9.9999"
...
DEFINE FRAME F-Main
     ...
     F-ImpExo AT ROW 10.62 COL 16 NO-LABEL
     F-ImpDes AT ROW 10.62 COL 28 COLON-ALIGNED NO-LABEL
...
"Almmmatg.DesMat" ? "X(35)" "character" ? ? ? ? ? ? no ?
...
"FacDPedi.PreUni" "Precio!Unitario" ">,>>9.9999" "decimal" ? ? ? ? ? ? no ?
