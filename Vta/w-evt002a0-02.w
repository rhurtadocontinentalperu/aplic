...
BUTTON-5 TOGGLE-CodMat BUTTON-6 TOGGLE-CodPro TOGGLE-CodVen TOGGLE-FmaPgo ~
TOGGLE-NroCard BROWSE-1 RADIO-SET-Tipo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 W-Win _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      VtaTabla.Llave_c1 COLUMN-LABEL "CAMPAÑAS" FORMAT "x(15)":U
      VtaTabla.Rango_fecha[1] COLUMN-LABEL "Inicio" FORMAT "99/99/9999":U
      VtaTabla.Rango_fecha[2] COLUMN-LABEL "Término" FORMAT "99/99/9999":U
            WIDTH 13
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 118 WIDGET-ID 24
     BtnDone AT ROW 1 COL 124 WIDGET-ID 28
     ...
     BROWSE-1 AT ROW 14.46 COL 28 WIDGET-ID 200
     RADIO-SET-Tipo AT ROW 20.38 COL 28 NO-LABEL WIDGET-ID 56
     FILL-IN-Mensaje AT ROW 21.73 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 22
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 129.72 BY 23.19 WIDGET-ID 100.
...
/* Query rebuild information for BROWSE BROWSE-1
 ...
 AND INTEGRAL.VtaTabla.Tabla = ""CAMPAÑAS"""
     _FldNameList[1]   > INTEGRAL.VtaTabla.Llave_c1
"VtaTabla.Llave_c1" "CAMPAÑAS" "x(15)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"VtaTabla.Rango_fecha[2]" "Término" ? "date" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BUTTON-1 BtnDone TOGGLE-CodDiv TOGGLE-CodCli BUTTON-5 TOGGLE-CodMat 
         BUTTON-6 TOGGLE-CodPro TOGGLE-CodVen TOGGLE-FmaPgo TOGGLE-NroCard 
...
FOR EACH tmp-detalle:
    /*Funcionará???*/
    x-campania = 'NO CAMPAÑA'.
    FIND FIRST vtatabla WHERE vtatabla.codcia = s-codcia
        AND vtatabla.tabla = 'CAMPAÑAS' /*
        AND VtaTabla.Rango_fecha[1] <= tmp-detalle.nrofch
        AND VtaTabla.Rango_fecha[2] */ NO-LOCK NO-ERROR.
    IF AVAIL vtatabla THEN x-campania = "CAMPAÑA".
