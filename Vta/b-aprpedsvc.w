...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Numero de Pedido" FORMAT "X(12)":U
  ...
  DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
      ...
      FOR EACH Facdpedi OF Faccpedi NO-LOCK:
          FIND Almmserv WHERE almmserv.CodCia = s-codcia AND 
              almmserv.codmat = Facdpedi.codmat NO-LOCK NO-ERROR.
              ...
              IF AVAILABLE Factabla AND Factabla.valor[1] > 0 AND Factabla.valor[2] > 0 
                  ...
                  ELSE DO:
                      IF (x-Minimo <> Factabla.valor[2] AND
                          ...
                          pMensaje = 'No se puede ofrecer servicios con diferente importe mínimo, % de aplicación y código de SUNAT' +
                              CHR(10) + CHR(10) +
                              'Base código detracción SUNAT: ' + x-Codigo +
