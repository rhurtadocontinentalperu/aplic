...
FacCPedi.NomCli FacCPedi.CodVen FacCPedi.ImpTot ~
_FlgEst(FacCPedi.FlgEst) @ x-Estado 
...
&Scoped-define QUERY-STRING-br_table FOR EACH FacCPedi WHERE ~{&KEY-PHRASE} ~
 ...
 AND FacCPedi.FlgEst BEGINS RADIO-SET-Estado NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      _FlgEst(FacCPedi.FlgEst) @ x-Estado COLUMN-LABEL "Estado" FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     RADIO-SET-Estado AT ROW 5.58 COL 126 NO-LABEL WIDGET-ID 8
     "Haga doble clic sobre cualquier registro para ver el detalle" VIEW-AS TEXT
          SIZE 40 BY .5 AT ROW 11.5 COL 2 WIDGET-ID 16
...
/* Query rebuild information for BROWSE br_table
 ...
 AND FacCPedi.CodDoc = s-coddoc
 AND FacCPedi.CodDiv = x-coddiv
 AND FacCPedi.FlgEst BEGINS RADIO-SET-Estado"
...
"_FlgEst(FacCPedi.FlgEst) @ x-Estado" "Estado" "x(15)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
