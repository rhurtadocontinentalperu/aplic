...
&Scoped-define QUERY-STRING-Query-Main FOR EACH VtaCList WHERE ~{&KEY-PHRASE} ~
      AND VtaCList.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH VtaCList WHERE ~{&KEY-PHRASE} ~
      AND VtaCList.CodCia = s-codcia NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main VtaCList
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main VtaCList
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "INTEGRAL.VtaCList.CodCia = s-codcia"
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN lkup/c-clista ("Lista por Eventos").
