...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DETA.codmat COLUMN-LABEL "Servicio" FORMAT "X(6)":U
      almmserv.DesMat FORMAT "X(45)":U
      DETA.CanDes FORMAT ">,>>>,>>9.9999":U
      DETA.UndVta COLUMN-LABEL "Unidad" FORMAT "x(8)":U
      DETA.PreUni FORMAT ">,>>>,>>9.999999":U
      DETA.PorDto FORMAT ">>9.99":U
...
"DETA.codmat" "Servicio" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
