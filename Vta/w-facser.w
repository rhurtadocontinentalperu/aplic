...
DEFINE NEW SHARED VARIABLE S-TPOFAC   AS CHAR INITIAL "S".
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "REGISTRO FACTURAS SERVICIOS"
         HEIGHT             = 16.12
         WIDTH              = 89.72
         MAX-HEIGHT         = 27.73
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF W-Win /* REGISTRO FACTURAS SERVICIOS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* REGISTRO FACTURAS SERVICIOS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-docmto ).
       RUN set-position IN h_b-docmto ( 7.77 , 1.29 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-size IN h_b-tmpdoc ( 7.77 , 85.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 15.69 , 50.57 ) NO-ERROR.
