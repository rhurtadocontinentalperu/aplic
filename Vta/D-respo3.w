...
&Scoped-Define ENABLED-OBJECTS f-clien f-desde f-hasta RADIO-SET-1 ~
B-impresoras RB-NUMBER-COPIES RB-BEGIN-PAGE Btn_OK RB-END-PAGE Btn_Cancel ~
Btn_Help RECT-41 RECT-43 RECT-5 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-3 f-clien f-desde f-hasta ~
RADIO-SET-1 f-nomcli RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
...
DEFINE FRAME D-Dialog
     ...
     f-nomcli AT ROW 1.35 COL 35.72 COLON-ALIGNED NO-LABEL
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* O/D Por Atender Oficina */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-3 f-clien f-desde f-hasta RADIO-SET-1 f-nomcli 
          RB-NUMBER-COPIES RB-BEGIN-PAGE RB-END-PAGE 
      WITH FRAME D-Dialog.
  ENABLE f-clien f-desde f-hasta RADIO-SET-1 B-impresoras RB-NUMBER-COPIES 
         RB-BEGIN-PAGE Btn_OK RB-END-PAGE Btn_Cancel Btn_Help RECT-41 RECT-43 
         RECT-5 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
