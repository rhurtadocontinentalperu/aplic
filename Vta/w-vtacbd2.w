...
&Scoped-Define ENABLED-OBJECTS FILL-IN-fchast F-DIVISION B-filtro RECT-16 
...
DEFINE FRAME F-Main
     FILL-IN-fchast AT ROW 3.62 COL 2.43 COLON-ALIGNED NO-LABEL
     F-DIVISION AT ROW 3.62 COL 20.14 NO-LABEL
     B-filtro AT ROW 2.42 COL 64
     B-Transferir AT ROW 2.42 COL 72.14
     B-Imprimir AT ROW 2.42 COL 80.29
     FILL-IN-Tpocmb AT ROW 3.62 COL 29.72 COLON-ALIGNED NO-LABEL
     FILL-IN-TcCompra AT ROW 3.62 COL 42.14 COLON-ALIGNED NO-LABEL
     "Division" VIEW-AS TEXT
          SIZE 6.29 BY .5 AT ROW 3.15 COL 21.43
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generacion de Asiento Contable Diario por Centro de Costo"
         HEIGHT             = 14.23
         WIDTH              = 92.43
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 95.57
...
ON END-ERROR OF W-Win /* Generacion de Asiento Contable Diario por Centro de Costo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Generacion de Asiento Contable Diario por Centro de Costo */
DO:
...
DO:
  ASSIGN
     FILL-IN-fchast FILL-IN-Tpocmb FILL-IN-TcCompra F-Division.
  ...
  IF AVAILABLE cb-peri THEN
     s-NroMesCie = cb-peri.MesCie[MONTH(FILL-IN-fchast) + 1].
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-fchast F-DIVISION B-filtro RECT-16 
      WITH FRAME F-Main IN WINDOW W-Win.
