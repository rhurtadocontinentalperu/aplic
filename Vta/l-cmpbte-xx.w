...
&SCOPED-DEFINE CONDICION ( CcbcDocu.CodCia = S-CODCIA ~
                           ...
                           AND LOOKUP(TRIM(CcbcDocu.CodDoc), 'BOL,FAC,N/C,N/D,CHQ,CHC,LET,TCK,BD,A/R') > 0 ~
                           AND CcbcDocu.CodDoc BEGINS C-CMPBTE ~
...
CcbCDocu.FchCbd CcbCDocu.FchVto X-MON @ X-MON CcbCDocu.ImpTot ~
...
fNombre() @ x-Nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table CcbCDocu.ImpDto 
...
B-Imprimir FILL-IN-CodCli CMB-filtro FILL-IN-filtro C-CMPBTE x-CodDiv ~
c-Serie F-FMAPGO COMBO-BOX-5 f-desde f-hasta xcodmod f-codven x-FchVto-1 ~
x-FchVto-2 br_table BUTTON-1 
...
DEFINE VARIABLE C-CMPBTE AS CHARACTER FORMAT "X(256)":U 
     LABEL "Tipo Cmpbte." 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "","Fac","Bol","N/C","N/D","CHQ","CHC","LET","TCK","BD","A/R" 
     DROP-DOWN-LIST
     SIZE 9.43 BY 1
     BGCOLOR 15  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      CcbCDocu.FchCbd COLUMN-LABEL "Fecha!Entrega" FORMAT "99/99/9999":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 122 BY 9.12
...
"CcbCDocu.FchCbd" "Fecha!Entrega" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"CcbCDocu.SdoAct" "Saldo" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > integral.CcbCDocu.ImpDto
"CcbCDocu.ImpDto" "Imp. Descuento" "->>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
chWorkSheet:Range("D2"):Value = "Cond. Vta.".
chWorkSheet:Range("E2"):Value = "Vendedor".
chWorkSheet:Range("F2"):Value = "Emision".
chWorkSheet:Range("G2"):Value = "Entrega".
chWorkSheet:Range("H2"):Value = "Vencimiento".
CASE xcodmod:
    WHEN 1 THEN DO:
        chWorkSheet:Range("I2"):Value = "Importe S/.".
        chWorkSheet:Range("J2"):Value = "Importe S/. SIN Adelanto".
        chWorkSheet:Range("K2"):Value = "Saldo S/.".
        chWorkSheet:Range("L2"):Value = "Estado".
        chWorkSheet:Range("M2"):Value = "Usuario anulación".
        chWorkSheet:Range("N2"):Value = "Fecha".
        chWorkSheet:Range("O2"):Value = "Hora".
        chWorkSheet:Range("P2"):Value = "Motivo anulación".
        chWorkSheet:Range("Q2"):Value = "División".
        chWorkSheet:Range("R2"):Value = "Fecha Reporte".
    END.
    WHEN 2 THEN DO:
        chWorkSheet:Range("I2"):Value = "Importe US$".
        chWorkSheet:Range("J2"):Value = "Importe US$ SIN Adelanto".
        chWorkSheet:Range("K2"):Value = "Saldo US$".
        chWorkSheet:Range("L2"):Value = "Estado".
        chWorkSheet:Range("M2"):Value = "Usuario anulación".
        chWorkSheet:Range("N2"):Value = "Fecha".
        chWorkSheet:Range("O2"):Value = "Hora".
    ...
    WHEN 3 THEN DO:
        ...
        chWorkSheet:Range("P2"):Value = "Usuario anulación".
        chWorkSheet:Range("Q2"):Value = "Fecha".
        chWorkSheet:Range("R2"):Value = "Hora".
        chWorkSheet:Range("S2"):Value = "Motivo anulación".
        chWorkSheet:Range("T2"):Value = "División".
...
DEFINE FRAME F-HdrConsulta
    ...
    "-------------------------------------------------------------------------------------------------------------------------------" SKIP
    "             COND. COD. FECHA DE   FECHA DE   FECHA DE                                                     " SKIP
    "DOC.NUMERO   VENTA VEN. EMISION    ENTREGA    VENCMTO.           MONEDA      IMPORTE         SALDO  ESTADO " SKIP
    "-------------------------------------------------------------------------------------------------------------------------------" SKIP
...
/* NUEVA RUTINA */
  DEFINE FRAME F-DetaCon
    ...
    t-Ccbcdocu.FchCbd FORMAT '99/99/9999'
