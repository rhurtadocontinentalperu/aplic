...
fFlgSit(vtadtrkped.FlgSit) @ x-Situacion 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH vtadtrkped WHERE vtadtrkped.CodCia = FacCPedi.CodCia ~
  ...
  AND TabGener.Codigo = vtadtrkped.CodUbic ~
      AND TabGener.Clave = "TRKPED" OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table vtadtrkped TabGener
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 100 BY 8.08
         FONT 4
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.vtadtrkped WHERE INTEGRAL.FacCPedi ...,INTEGRAL.TabGener WHERE INTEGRAL.vtadtrkped ..."
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* CONTROL DE TRACKING */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* CONTROL DE TRACKING */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* CONTROL DE TRACKING */
DO:
