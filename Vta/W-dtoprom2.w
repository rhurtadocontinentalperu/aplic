  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'c:/sie/v-dtoprom.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-dtoprom ).
       RUN set-position IN h_v-dtoprom ( 3.08 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.92 , 36.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'h:/aplic/lgc/q-detart.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-detart ).
       /* Position in UIB:  ( 1.12 , 30.14 ) */
       /* Size in UIB:  ( 1.65 , 8.29 ) */

       /* Links to SmartViewer h_v-dtoprom. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-dtoprom ).

       /* Links to SmartPanel h_p-updv05. */
       RUN add-link IN adm-broker-hdl ( h_q-detart , 'State':U , h_p-updv05 ).
