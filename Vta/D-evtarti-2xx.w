...
F-DIVISION-5 F-NOMDIV-5 F-DIVISION-6 F-NOMDIV-6 nCodMon txt-msj 
...
DEFINE FRAME F-Main
     ...
     Btn_OK AT ROW 9.08 COL 8
     nCodMon AT ROW 10.23 COL 52 NO-LABEL
     BUTTON-6 AT ROW 11.5 COL 42 WIDGET-ID 4
     Btn_Cancel AT ROW 11.58 COL 49
     Btn_Help AT ROW 11.58 COL 60
     txt-msj AT ROW 11.88 COL 2.72 NO-LABEL WIDGET-ID 2
     ...
     " Tipo de Reporte" VIEW-AS TEXT
          ...
          FONT 6
     " Moneda" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.85 COL 50
          FONT 6
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-61 RECT-62 RECT-63 RECT-58 C-tipo F-DIVISION BUTTON-5 C-tipo-2 
         ...
         DesdeF HastaF F-DIVISION-5 F-DIVISION-6 nCodMon BUTTON-6 Btn_Cancel 
         Btn_Help 
      WITH FRAME F-Main IN WINDOW W-Win.
...
cRange = "F" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-1.
cRange = "G" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-2.
cRange = "H" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-3.
cRange = "I" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-4.
cRange = "J" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-5.
cRange = "K" + cColumn.
chWorkSheet:Range(cRange):Value = "Cantidad div " + F-Division-6.

  FOR EACH tmp-tempo BREAK BY t-codcia BY t-canti[10] DESCENDING :      
      t-column = t-column + 1.
      cColumn = STRING(t-Column).
      cRange = "B" + cColumn.
...
/*------------------------------------------------------------------------------
  ...
  Parameters:  <none>
  Notes:       
  Modifico  :   Rosa Diaz P. RD01
  Fecha     :   10/12/2009
  Objetivo  :   Cambio de mensaje de espera.
------------------------------------------------------------------------------*/
  DEFINE FRAME F-REPORTE
         t-codmat    AT 1
         t-DesMat    FORMAT "X(40)"
