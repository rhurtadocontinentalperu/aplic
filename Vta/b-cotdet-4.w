...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FacDPedi.codmat COLUMN-LABEL "Codigo" FORMAT "X(6)":U WIDTH 8.43
      Almmmatg.DesMat FORMAT "X(45)":U
      List @ List COLUMN-LABEL "Lista" FORMAT "X(3)":U
      FacDPedi.UndVta FORMAT "XXXX":U
      FacDPedi.CanPed FORMAT ">,>>>,>>9.9999":U WIDTH 8.57
...
"FacDPedi.codmat" "Codigo" ? "character" ? ? ? ? ? ? no ? no no "8.43" yes yes no "U" "" "" "" "" "" "" 0 no 0 no no
...
"FacDPedi.CanPed" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"dPriceList @ dPriceList" "Precio Lista" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"Price @ Price" "Precio Unit." "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"dNewPrice @ dNewPrice" "Precio Calc" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"dTotDif @ dTotDif" "Diferencia" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > "_<CALC>"
"dMargen @ dMargen" "% Margen" "->>,>>>,>>9.9999" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
