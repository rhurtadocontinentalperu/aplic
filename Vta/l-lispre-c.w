...
&SCOPED-DEFINE CONDICION almmmatp.codcia = s-codcia
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH almmmatp WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almmmatp.codmat|yes
Descripción|||INTEGRAL.Almmmatg.Detalle|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 70.14 BY 15.81
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY almmmatp.codmat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY Almmmatg.Detalle
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
