...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CPedi.NroPed COLUMN-LABEL "Pedido" FORMAT "X(9)":U
...
"CPedi.NroPed" "Pedido" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  FIND integral.Faccpedi WHERE integral.Faccpedi.codcia = s-codcia 
  ...
  IF NOT AVAILABLE integral.Faccpedi THEN DO:
      MESSAGE 'Pedido NO registrado' VIEW-AS ALERT-BOX WARNING.
      RETURN 'ADM-ERROR'.
  END.
  IF integral.Faccpedi.flgest <> 'P' THEN DO:
      MESSAGE 'Pedido NO esta pendiente de atender' VIEW-AS ALERT-BOX WARNING.
      RETURN 'ADM-ERROR'.
  END.
  RETURN "OK".
