...
&Scoped-Define ENABLED-FIELDS LG-CRequ.HorAte 
&Scoped-define ENABLED-TABLES LG-CRequ
&Scoped-define FIRST-ENABLED-TABLE LG-CRequ
&Scoped-Define ENABLED-OBJECTS RECT-24 
&Scoped-Define DISPLAYED-FIELDS LG-CRequ.NroReq LG-CRequ.Userid-aprob ~
LG-CRequ.FchApro LG-CRequ.Observ LG-CRequ.HorAte 
...
DEFINE FRAME F-Main
     LG-CRequ.NroReq AT ROW 1.27 COL 14 COLON-ALIGNED
          ...
          SIZE 8 BY .81
          FONT 6
     LG-CRequ.Userid-aprob AT ROW 1.27 COL 49 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     LG-CRequ.FchApro AT ROW 1.27 COL 75 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     LG-CRequ.Observ AT ROW 2.35 COL 14 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 45 BY .81
     LG-CRequ.HorAte AT ROW 2.35 COL 75 COLON-ALIGNED WIDGET-ID 8
          LABEL "Hora Atencion"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
...
/* SETTINGS FOR FILL-IN LG-CRequ.FchApro IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN LG-CRequ.HorAte IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN LG-CRequ.NroReq IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN LG-CRequ.Observ IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN LG-CRequ.Userid-aprob IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY
        TODAY                    @ LG-CREQU.FchApro
        /*Usuario                  @ LG-CRequ.Solicita*/
        S-USER-ID                @ LG-CREQU.Userid-aprob
        STRING(TIME, "HH:MM")    @ LG-CREQU.HorAte WITH FRAME {&FRAME-NAME}.
