...
&Scoped-define INTERNAL-TABLES ImCCst

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH ImCCst WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY ImCCst.NroCst INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ImCCst WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY ImCCst.NroCst INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ImCCst
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ImCCst
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.ImCCst"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _OrdList          = "INTEGRAL.ImCCst.NroCst|yes"
