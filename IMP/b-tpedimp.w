...
DCMP.CstTot 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table DCMP.Tolerancia 
...
"Temp-Tables.DCMP.Codmat" "<Codigo>" "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.Almmmatg.DesMat
"INTEGRAL.Almmmatg.DesMat" ? "X(50)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"INTEGRAL.Almmmatg.DesMar" ? "X(22)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = Temp-Tables.DCMP.UndCmp
     _FldNameList[5]   = Temp-Tables.DCMP.CanPedi
     _FldNameList[6]   > Temp-Tables.DCMP.Tolerancia
"Temp-Tables.DCMP.Tolerancia" "%     !Toleranc" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON "RETURN":U OF DCMP.Tolerancia
DO:
   APPLY "TAB":U.
   RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN DCMP.CodCia = S-CODCIA 
         ...
         DCMP.CstTot = ROUND(DCmp.CanPedi * DCMP.PreUni,2).
