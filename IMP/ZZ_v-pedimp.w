...
DEFINE FRAME F-Main
     ...
     ImCOCmp.NroCon AT ROW 10.42 COL 64 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 2.86 BY .81
...
/*    MESSAGE INTEGER(ImCOCmp.NroImp:SCREEN-VALUE IN FRAME {&FRAME-NAME}) VIEW-AS ALERT-BOX.                         */
/*    FOR EACH LG-DREQU WHERE                                                                                        */
/*        LG-DREQU.CodCia  = S-CodCia AND                                                                            */
/*        LG-DREQU.NroReq  = INTEGER(ImCOCmp.NroReq:SCREEN-VALUE IN FRAME {&FRAME-NAME}) AND                         */
/*        LG-DREQU.CanApro > 0 NO-LOCK:                                                                              */
...
/*            MESSAGE "NroImp: " B-CCMP.NroImp VIEW-AS ALERT-BOX.                                                    */
/*            MESSAGE "codigo: " B-DCMP.CodMat VIEW-AS ALERT-BOX.                                                    */
/*            MESSAGE "cantidad: " LG-DREQU.CanApro VIEW-AS ALERT-BOX.                                               */
/*                ACCUMULATE B-DCMP.canpedi (SUB-TOTAL BY B-DCMP.CodMat).                                            */
/*                MESSAGE B-DCMP.CodMat SKIP "cant mat en orden"                                                     */
/*                ACCUM SUB-TOTAL BY B-DCMP.CodMat B-DCMP.canpedi                                                    */
/*                VIEW-AS ALERT-BOX.                                                                                 */
...
------------------------------------------------------------------------------*/
    ...
    IF RETURN-VALUE = 'YES' THEN DO WITH FRAME {&FRAME-NAME}:  
       ...
       ASSIGN
             ...
             ImCOCmp.CodDoc = "O/C"
             ImCOCmp.NroPed = "CO" + "-" +
                     STRING(ImCOCmp.periodo, "9999") + "-" + /*"001"*/
