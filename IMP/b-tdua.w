...
DEFINE SHARED TEMP-TABLE DDUA LIKE INTEGRAL.ImDDua.
...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table DDUA.Codmat DDUA.UndCmp ~
DDUA.CanDua 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table~
 ~{&FP1}Codmat ~{&FP2}Codmat ~{&FP3}~
 ~{&FP1}UndCmp ~{&FP2}UndCmp ~{&FP3}~
 ~{&FP1}CanDua ~{&FP2}CanDua ~{&FP3}
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75 BY 7.69
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     F-ImpTot AT ROW 8.88 COL 63 COLON-ALIGNED NO-LABEL
     "Total Importe:" VIEW-AS TEXT
          SIZE 10 BY .5 AT ROW 9.08 COL 54
...
"DDUA.Codmat" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[2]   = INTEGRAL.Almmmatg.DesMat
     _FldNameList[3]   > INTEGRAL.Almmmatg.DesMar
"Almmmatg.DesMar" ? "X(23)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > Temp-Tables.DDUA.UndCmp
"DDUA.UndCmp" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[5]   > Temp-Tables.DDUA.CanDua
"DDUA.CanDua" ? ? "decimal" ? ? ? ? ? ? yes ?
