...
&SCOPED-DEFINE CONDICION ( lg-tabla.CodCia = s-CodCia AND lg-tabla.Tabla = input-var-2)
&SCOPED-DEFINE CODIGO lg-tabla.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( lg-tabla.Nombre BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( lg-tabla.Nombre , FILL-IN-filtro ) <> 0 )
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.lg-tabla.Nombre
Nombres que contengan|y||INTEGRAL.lg-tabla.Nombre
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.lg-tabla.Codigo|yes
Descripción|||INTEGRAL.lg-tabla.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lg-tabla.Codigo
      lg-tabla.Nombre FORMAT "x(38)"
      lg-tabla.Valor[1] COLUMN-LABEL "Moneda" FORMAT "9"
      lg-tabla.Valor[2] COLUMN-LABEL "Monto" FORMAT "->>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Nombre" ? "x(38)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > INTEGRAL.lg-tabla.Valor[1]
"Valor[1]" "Moneda" "9" "decimal" ? ? ? ? ? ? no ?
     _FldNameList[4]   > INTEGRAL.lg-tabla.Valor[2]
"Valor[2]" "Monto" "->>>,>>9.99" "decimal" ? ? ? ? ? ? no ?
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY lg-tabla.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY lg-tabla.Nombre
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
