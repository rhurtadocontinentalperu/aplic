...
&Scoped-Define ENABLED-FIELDS ImCCst.NroEmbq ImCCst.TpoCmb ~
ImCCst.Observaciones ImCCst.Codmon 
...
ImCCst.Fchdoc ImCCst.NroEmbq ImCCst.TpoCmb ImCCst.Hora ImCCst.Observaciones ~
ImCCst.Codmon ImCCst.Userid-com 
...
DEFINE FRAME F-Main
     ...
     ImCCst.Fchdoc AT ROW 2.08 COL 98 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCCst.NroEmbq AT ROW 2.19 COL 14 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 3.57 BY .81
     ...
     ImCCst.Hora AT ROW 2.88 COL 98 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 5.72 BY .81
     ImCCst.Observaciones AT ROW 3.15 COL 16 NO-LABEL WIDGET-ID 30
          VIEW-AS EDITOR
          SIZE 49 BY 1.35
     ImCCst.Codmon AT ROW 3.31 COL 76 NO-LABEL WIDGET-ID 2
...
"Dólares", 2
     ...
     "Observaciones:" VIEW-AS TEXT
          SIZE 11 BY .5 AT ROW 3.15 COL 5 WIDGET-ID 32
