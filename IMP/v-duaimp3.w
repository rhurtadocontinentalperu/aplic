...
&Scoped-Define ENABLED-FIELDS ImCDua.NroDua ImCDua.NroPed ImCDua.NroFac ~
ImCDua.CodPro ImCDua.FchDua ImCDua.FchVto ImCDua.ImpFob ImCDua.AjValor ~
...
DEFINE FRAME F-Main
     ImCDua.NroDua AT ROW 1.35 COL 10 COLON-ALIGNED WIDGET-ID 30
          LABEL "Nº DUA"
          VIEW-AS FILL-IN 
          SIZE 7 BY .81
     ImCDua.NroCon AT ROW 1.35 COL 19.57 COLON-ALIGNED NO-LABEL WIDGET-ID 28
          VIEW-AS FILL-IN 
          SIZE 4.29 BY .81
     x-estado AT ROW 1.38 COL 66 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     ImCDua.NroPed AT ROW 2.15 COL 10 COLON-ALIGNED WIDGET-ID 34
          LABEL "Nº Pedido"
          VIEW-AS FILL-IN 
          SIZE 22 BY .81
     ImCDua.FchDoc AT ROW 2.15 COL 75 COLON-ALIGNED WIDGET-ID 16
          LABEL "Fecha Emisión"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCDua.NroFac AT ROW 2.92 COL 10 COLON-ALIGNED WIDGET-ID 32
          VIEW-AS FILL-IN 
          SIZE 9 BY .81
     ImCDua.Hora AT ROW 2.92 COL 75 COLON-ALIGNED WIDGET-ID 22
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCDua.CodPro AT ROW 3.69 COL 10 COLON-ALIGNED WIDGET-ID 14
          LABEL "Proveedor"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     x-prov AT ROW 3.69 COL 23 NO-LABEL WIDGET-ID 50
     ImCDua.Userid-dua AT ROW 3.69 COL 75 COLON-ALIGNED WIDGET-ID 44
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     r-moneda AT ROW 4.5 COL 12 NO-LABEL WIDGET-ID 4
     ImCDua.Codmon AT ROW 4.5 COL 12 NO-LABEL WIDGET-ID 10
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS 
                    "Soles", 1,
"Dólares", 2
          SIZE 16 BY .96
     ImCDua.FchDua AT ROW 4.65 COL 75 COLON-ALIGNED WIDGET-ID 18
          LABEL "Fecha DUA"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCDua.FchVto AT ROW 5.42 COL 75 COLON-ALIGNED WIDGET-ID 20
          LABEL "Fecha Vencimiento"
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCDua.ImpFob AT ROW 5.62 COL 10 COLON-ALIGNED WIDGET-ID 26
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ImCDua.AjValor AT ROW 5.62 COL 37 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ImCDua.TpoCmb AT ROW 6.19 COL 75 COLON-ALIGNED WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 10 BY .81
     ImCDua.ImpFlete AT ROW 6.38 COL 10 COLON-ALIGNED WIDGET-ID 24
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ImCDua.ValAdua AT ROW 6.38 COL 37 COLON-ALIGNED WIDGET-ID 46
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     ImCDua.Seguro AT ROW 7.15 COL 10 COLON-ALIGNED WIDGET-ID 38
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
     "-" VIEW-AS TEXT
          SIZE 1 BY .5 AT ROW 1.54 COL 20 WIDGET-ID 2
     "Moneda:" VIEW-AS TEXT
          SIZE 7 BY .5 AT ROW 4.85 COL 5 WIDGET-ID 40
     RECT-24 AT ROW 1.19 COL 2 WIDGET-ID 36
...
/* SETTINGS FOR RADIO-SET ImCDua.Codmon IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
...
/* SETTINGS FOR FILL-IN ImCDua.NroPed IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR RADIO-SET r-moneda IN FRAME F-Main
   NO-ENABLE                                                            */
