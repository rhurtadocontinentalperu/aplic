...
&Scoped-Define ENABLED-OBJECTS RECT-2 BUTTON-1 F-NroImp 
&Scoped-Define DISPLAYED-OBJECTS F-NroImp 
...
DEFINE VARIABLE F-NroImp AS INTEGER FORMAT "999999":U INITIAL 0 
     VIEW-AS FILL-IN 
...
DEFINE FRAME FRAME-D
     ...
     F-NroImp AT ROW 1.19 COL 1.86 NO-LABEL
...
/* SETTINGS FOR FILL-IN F-NroImp IN FRAME FRAME-D
   ALIGN-L                                                              */
...
&Scoped-define SELF-NAME F-NroImp
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-NroImp q-tables
ON LEAVE OF F-NroImp IN FRAME FRAME-D
OR "RETURN":U OF F-NroImp
DO:
   FIND ImCOCmp WHERE ImCOCmp.codcia = s-codcia
    AND ImCOCmp.coddoc = "O/C"
    AND ImCOCmp.nroimp = INPUT {&SELF-NAME}
    NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
    RUN LKUP/c-pedimp ("Ordenes de Compra - Importaciones").
